...
species(
    ...
    molecularWeight = (26.0373,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.69252,0.00606585,-2.11278e-06,1.63533e-11,1.07666e-13,48174.1,3.96842], Tmin=(100,'K'), Tmax=(1423.26,'K')), NASAPolynomial(coeffs=[4.43042,0.00487757,-1.79374e-06,3.04085e-10,-1.96652e-14,47874.4,-0.167075], Tmin=(1423.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(83.1447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-CdsHH) + group(CdJ2_singlet-Cds)"""),
)
...
This reaction matched rate rule [Ct_rad/Ct;H_rad]
