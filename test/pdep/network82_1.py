...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[CH](154)'],
    products = ['C#C(139)', 'C#C(139)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(7)', '[CH]=CC#C(196)'],
    products = ['[CH]=CC=[CH](154)'],
    transitionState = 'TS2',
