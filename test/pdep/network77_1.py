...
species(
    ...
    E0 = (468.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.434852,'amu*angstrom^2'), symmetry=1, barrier=(9.99811,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=[C]C[CH2](161)',
    structure = SMILES('[CH]=[C]C[CH2]'),
    E0 = (673.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3120,650,792.5,1650,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.277896,'amu*angstrom^2'), symmetry=1, barrier=(6.38938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0203279,'amu*angstrom^2'), symmetry=1, barrier=(9.87333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6422,0.0283978,-1.83267e-05,6.21847e-09,-8.86543e-13,81072.8,17.6148], Tmin=(100,'K'), Tmax=(1566.74,'K')), NASAPolynomial(coeffs=[7.52447,0.0159331,-6.39297e-06,1.14054e-09,-7.62762e-14,79542.9,-8.13153], Tmin=(1566.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(673.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.195095,'amu*angstrom^2'), symmetry=1, barrier=(6.13112,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64476,0.0273129,-1.57902e-05,4.44836e-09,-5.06423e-13,89873.2,17.1161], Tmin=(100,'K'), Tmax=(1964.96,'K')), NASAPolynomial(coeffs=[9.27423,0.0138179,-5.48863e-06,9.53351e-10,-6.17657e-14,87267.8,-19.3454], Tmin=(1964.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(746.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH2](150)'],
    products = ['C#C(139)', 'C=C(16)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(7)', '[CH]=CC=C(153)'],
    products = ['[CH]=CC[CH2](150)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](140)', '[CH2][CH2](20)'],
    products = ['[CH]=CC[CH2](150)'],
