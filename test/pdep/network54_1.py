...
species(
    label = 'C[CH]CC=CC(133)',
    structure = SMILES('C[CH]CC=CC'),
    E0 = (118.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,315.642,1832.88],'cm^-1')),
        HinderedRotor(inertia=(0.0962396,'amu*angstrom^2'), symmetry=1, barrier=(6.79913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0961896,'amu*angstrom^2'), symmetry=1, barrier=(6.80191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.096221,'amu*angstrom^2'), symmetry=1, barrier=(6.80275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0962546,'amu*angstrom^2'), symmetry=1, barrier=(6.79853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-76.3276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,251.44,251.453],'cm^-1')),
        HinderedRotor(inertia=(0.00266621,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210117,'amu*angstrom^2'), symmetry=1, barrier=(9.42702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210105,'amu*angstrom^2'), symmetry=1, barrier=(9.42706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210114,'amu*angstrom^2'), symmetry=1, barrier=(9.42705,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.154676,'amu*angstrom^2'), symmetry=1, barrier=(3.55632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797042,'amu*angstrom^2'), symmetry=1, barrier=(18.3256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.797316,'amu*angstrom^2'), symmetry=1, barrier=(18.3319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0734429,'amu*angstrom^2'), symmetry=1, barrier=(18.3298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
...
species(
    ...
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52451,0.0572407,-3.33592e-05,1.01395e-08,-1.34165e-12,54304.3,25.6028], Tmin=(100,'K'), Tmax=(1561.39,'K')), NASAPolynomial(coeffs=[8.27549,0.039946,-1.67445e-05,3.04554e-09,-2.05813e-13,52196.1,-9.9749], Tmin=(1561.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH][CH]C[CH]C(135)', 'H(7)'],
    products = ['C[CH]CC[CH]C(60)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CC[CH]C(136)', 'H(7)'],
    products = ['C[CH]CC[CH]C(60)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(29)', '[CH2]C[CH]C(34)'],
    products = ['C[CH]CC[CH]C(60)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]CC[CH]C(105)', '[CH3](10)'],
    products = ['C[CH]CC[CH]C(60)'],
