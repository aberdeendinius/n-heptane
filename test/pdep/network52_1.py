...
species(
    ...
    molecularWeight = (51.0666,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56829,0.0268716,-1.66277e-05,-1.63983e-09,3.72209e-12,108195,13.915], Tmin=(100,'K'), Tmax=(950.448,'K')), NASAPolynomial(coeffs=[10.0471,0.00648128,-1.94127e-06,3.292e-10,-2.33762e-14,106273,-24.4196], Tmin=(950.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(899.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[CH](65)'],
    products = ['C#C(50)', 'C#C(50)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(7)', '[CH]=CC#C(77)'],
    products = ['[CH]=CC=[CH](65)'],
    transitionState = 'TS2',
