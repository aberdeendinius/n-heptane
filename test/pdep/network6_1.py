...
species(
    ...
    molecularWeight = (57.1143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5176,0.0284118,2.01476e-06,-1.19583e-08,4.0455e-12,6087.4,17.669], Tmin=(100,'K'), Tmax=(1230.09,'K')), NASAPolynomial(coeffs=[5.03039,0.030084,-1.20274e-05,2.15739e-09,-1.45457e-13,4724.51,1.99887], Tmin=(1230.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.1423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)
...
species(
    ...
    E0 = (303.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,840.073,841.931,2981.31],'cm^-1')),
        HinderedRotor(inertia=(0.0986478,'amu*angstrom^2'), symmetry=1, barrier=(2.26811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0994245,'amu*angstrom^2'), symmetry=1, barrier=(2.28597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923269,'amu*angstrom^2'), symmetry=1, barrier=(21.2278,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2609,0.0314424,7.48722e-07,-1.84873e-08,8.0628e-12,36620.5,16.8513], Tmin=(100,'K'), Tmax=(1038.41,'K')), NASAPolynomial(coeffs=[8.22231,0.0233776,-9.12316e-06,1.66749e-09,-1.15986e-13,34579.2,-16.0015], Tmin=(1038.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
