...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0992986,'amu*angstrom^2'), symmetry=1, barrier=(7.34918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0992756,'amu*angstrom^2'), symmetry=1, barrier=(7.34926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0992211,'amu*angstrom^2'), symmetry=1, barrier=(7.35015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0993532,'amu*angstrom^2'), symmetry=1, barrier=(7.35066,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (7.5235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,3558.59],'cm^-1')),
        HinderedRotor(inertia=(0.627341,'amu*angstrom^2'), symmetry=1, barrier=(14.4238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128574,'amu*angstrom^2'), symmetry=1, barrier=(2.95616,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128483,'amu*angstrom^2'), symmetry=1, barrier=(2.95408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627402,'amu*angstrom^2'), symmetry=1, barrier=(14.4252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139594,'amu*angstrom^2'), symmetry=1, barrier=(84.2862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1674,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['H(7)', 'CC=CCCC(58)'],
    products = ['C[CH]CCCC(44)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH2](5)', '[CH2]C[CH]C(34)'],
    products = ['C[CH]CCCC(44)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC(3)', '[CH2][CH]C(39)'],
    products = ['C[CH]CCCC(44)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC[CH]C(23)', '[CH3](10)'],
    products = ['C[CH]CCCC(44)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(13)', 'C[CH]CCC(17)'],
    products = ['C[CH]CCCC(44)'],
