species(
    ...
    E0 = (-16.5218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,385.408],'cm^-1')),
        HinderedRotor(inertia=(0.106023,'amu*angstrom^2'), symmetry=1, barrier=(11.0709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109772,'amu*angstrom^2'), symmetry=1, barrier=(11.109,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (121.597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680],'cm^-1')),
        HinderedRotor(inertia=(0.46744,'amu*angstrom^2'), symmetry=1, barrier=(10.7474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247288,'amu*angstrom^2'), symmetry=1, barrier=(24.783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64214,0.0215953,2.09689e-05,-3.79216e-08,1.47848e-11,14680.9,14.1266], Tmin=(100,'K'), Tmax=(998.556,'K')), NASAPolynomial(coeffs=[7.82801,0.0208401,-7.96754e-06,1.47338e-09,-1.04526e-13,12647.2,-15.882], Tmin=(998.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)
...
species(
    ...
    E0 = (221.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350.558],'cm^-1')),
        HinderedRotor(inertia=(0.105768,'amu*angstrom^2'), symmetry=1, barrier=(9.20008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105603,'amu*angstrom^2'), symmetry=1, barrier=(9.20021,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59443,0.0251167,5.39473e-06,-1.89574e-08,7.50834e-12,26674.2,15.5986], Tmin=(100,'K'), Tmax=(1056.59,'K')), NASAPolynomial(coeffs=[6.83083,0.0220762,-8.74089e-06,1.60416e-09,-1.11496e-13,25053.4,-8.50606], Tmin=(1056.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.334532,'amu*angstrom^2'), symmetry=1, barrier=(11.7981,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56533,0.0239245,1.38116e-05,-3.10269e-08,1.25444e-11,27790.1,15.6311], Tmin=(100,'K'), Tmax=(999.92,'K')), NASAPolynomial(coeffs=[8.06557,0.0200625,-7.60832e-06,1.39784e-09,-9.86871e-14,25783.2,-15.4388], Tmin=(999.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (284.36,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,659.263],'cm^-1')),
        HinderedRotor(inertia=(0.471279,'amu*angstrom^2'), symmetry=1, barrier=(10.8356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.53643,'amu*angstrom^2'), symmetry=1, barrier=(58.3175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.54137,'amu*angstrom^2'), symmetry=1, barrier=(58.4312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
...
species(
    ...
    E0 = (306.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,320.093,1829.56,1829.91,4000],'cm^-1')),
        HinderedRotor(inertia=(0.13693,'amu*angstrom^2'), symmetry=1, barrier=(9.96304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137285,'amu*angstrom^2'), symmetry=1, barrier=(9.97164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.35039,'amu*angstrom^2'), symmetry=1, barrier=(25.5425,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
