...
species(
    ...
    E0 = (532.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,181.864],'cm^-1')),
        HinderedRotor(inertia=(0.799222,'amu*angstrom^2'), symmetry=1, barrier=(20.4614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00686649,'amu*angstrom^2'), symmetry=1, barrier=(33.8172,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04384,0.0162269,8.19916e-06,-1.95238e-08,7.97714e-12,64136.3,12.4835], Tmin=(100,'K'), Tmax=(994.053,'K')), NASAPolynomial(coeffs=[6.51416,0.0136529,-5.10445e-06,9.25398e-10,-6.47357e-14,62883.6,-7.06874], Tmin=(994.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (522.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,207.241,1480.28,1480.52],'cm^-1')),
        HinderedRotor(inertia=(0.00239794,'amu*angstrom^2'), symmetry=1, barrier=(3.73069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123438,'amu*angstrom^2'), symmetry=1, barrier=(3.71175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.15627,0.0161614,5.77823e-07,-6.36819e-09,2.1663e-12,62816.2,13.7456], Tmin=(100,'K'), Tmax=(1255.22,'K')), NASAPolynomial(coeffs=[4.89163,0.0164622,-6.74962e-06,1.22435e-09,-8.29829e-14,61921.2,3.14928], Tmin=(1255.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(522.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCJC)"""),
)
