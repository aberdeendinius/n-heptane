...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.289032,'amu*angstrom^2'), symmetry=1, barrier=(6.64542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.760588,'amu*angstrom^2'), symmetry=1, barrier=(17.4874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00227978,'amu*angstrom^2'), symmetry=1, barrier=(25.8848,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (231.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1731.94,1732.13],'cm^-1')),
        HinderedRotor(inertia=(0.155154,'amu*angstrom^2'), symmetry=1, barrier=(3.56729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155169,'amu*angstrom^2'), symmetry=1, barrier=(3.56763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154647,'amu*angstrom^2'), symmetry=1, barrier=(3.55563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153767,'amu*angstrom^2'), symmetry=1, barrier=(3.53542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
species(
    ...
    E0 = (231.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2520.03,2520.13],'cm^-1')),
        HinderedRotor(inertia=(0.00289172,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116023,'amu*angstrom^2'), symmetry=1, barrier=(4.79603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3249,'amu*angstrom^2'), symmetry=1, barrier=(54.7442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115804,'amu*angstrom^2'), symmetry=1, barrier=(4.79332,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
species(
    label = '[CH2]C[CH][CH]C(100)',
    structure = SMILES('[CH2]C[CH][CH]C'),
    E0 = (426.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,180,2620.52],'cm^-1')),
        HinderedRotor(inertia=(0.000896112,'amu*angstrom^2'), symmetry=1, barrier=(4.36625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189881,'amu*angstrom^2'), symmetry=1, barrier=(4.36574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0109814,'amu*angstrom^2'), symmetry=1, barrier=(53.5243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0109879,'amu*angstrom^2'), symmetry=1, barrier=(53.5327,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
...
species(
    ...
    E0 = (-40.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,434.444,434.524],'cm^-1')),
        HinderedRotor(inertia=(0.0736988,'amu*angstrom^2'), symmetry=1, barrier=(9.8712,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0737017,'amu*angstrom^2'), symmetry=1, barrier=(9.87112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0736959,'amu*angstrom^2'), symmetry=1, barrier=(9.87093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
...
species(
    label = '[CH2]CC[C]C(104)',
    structure = SMILES('[CH2]CC[C]C'),
    E0 = (485.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,401.792,401.792,1562.6],'cm^-1')),
        HinderedRotor(inertia=(0.0701481,'amu*angstrom^2'), symmetry=1, barrier=(8.03609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0701481,'amu*angstrom^2'), symmetry=1, barrier=(8.03609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0701482,'amu*angstrom^2'), symmetry=1, barrier=(8.03611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275872,'amu*angstrom^2'), symmetry=1, barrier=(31.6036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41696,0.0494527,-3.10384e-05,9.88055e-09,-1.28085e-12,58476.5,22.8325], Tmin=(100,'K'), Tmax=(1767.35,'K')), NASAPolynomial(coeffs=[12.9497,0.0233506,-8.88444e-06,1.52367e-09,-9.87053e-14,54400.1,-39.3737], Tmin=(1767.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]C(23)'],
    products = ['C=C(16)', 'C=CC(37)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC=CC(95)', 'H(7)'],
    products = ['[CH2]CC[CH]C(23)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]C(39)', '[CH2][CH2](20)'],
    products = ['[CH2]CC[CH]C(23)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(7)', '[CH2]C[CH][CH]C(100)'],
    products = ['[CH2]CC[CH]C(23)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(7)', '[CH2][CH]C[CH]C(101)'],
    products = ['[CH2]CC[CH]C(23)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(7)', '[CH2][CH]CC[CH2](102)'],
    products = ['[CH2]CC[CH]C(23)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(29)', '[CH2]C[CH2](19)'],
    products = ['[CH2]CC[CH]C(23)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C[CH]C(34)', 'CH2(T)(26)'],
    products = ['[CH2]CC[CH]C(23)'],
