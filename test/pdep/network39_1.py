...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.20295,'amu*angstrom^2'), symmetry=1, barrier=(50.6501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1999,'amu*angstrom^2'), symmetry=1, barrier=(50.5801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
...
species(
    ...
    E0 = (330.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,940.043,3440.4],'cm^-1')),
        HinderedRotor(inertia=(0.119248,'amu*angstrom^2'), symmetry=1, barrier=(2.74174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120723,'amu*angstrom^2'), symmetry=1, barrier=(2.77566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
...
This reaction matched rate rule [Cd_pri_rad;C_methyl]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['H(7)', '[CH2]C=C(83)'],
    products = ['C=CC(37)'],
    transitionState = 'TS2',
