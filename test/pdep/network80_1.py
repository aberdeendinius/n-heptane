...
species(
    ...
    E0 = (303.427,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.895586,'amu*angstrom^2'), symmetry=1, barrier=(20.5913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.895742,'amu*angstrom^2'), symmetry=1, barrier=(20.5949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C#CC([CH2])C(167)',
    structure = SMILES('C#CC([CH2])C'),
    E0 = (321.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.458577,'amu*angstrom^2'), symmetry=1, barrier=(10.5436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0671708,'amu*angstrom^2'), symmetry=1, barrier=(82.9759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.60625,'amu*angstrom^2'), symmetry=1, barrier=(82.9149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    label = '[CH]C=C(C)C(168)',
    structure = SMILES('[CH]C=C(C)C'),
    E0 = (301.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,324.885,327.383,329.366],'cm^-1')),
        HinderedRotor(inertia=(0.690202,'amu*angstrom^2'), symmetry=1, barrier=(51.9573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.70599,'amu*angstrom^2'), symmetry=1, barrier=(52.0369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.739925,'amu*angstrom^2'), symmetry=1, barrier=(52.0711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]=[C]C(C)C(170)',
    structure = SMILES('[CH]=[C]C(C)C'),
    E0 = (436.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.122329,'amu*angstrom^2'), symmetry=1, barrier=(11.2081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125023,'amu*angstrom^2'), symmetry=1, barrier=(11.1975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123055,'amu*angstrom^2'), symmetry=1, barrier=(11.1934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]C=C([CH2])C(173)',
    structure = SMILES('[CH]C=C([CH2])C'),
    E0 = (453.227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,350,440,435,1725,360.777,361.976,364.658],'cm^-1')),
        HinderedRotor(inertia=(0.548767,'amu*angstrom^2'), symmetry=1, barrier=(51.1024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.553557,'amu*angstrom^2'), symmetry=1, barrier=(51.1112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.555867,'amu*angstrom^2'), symmetry=1, barrier=(51.175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7723,0.0417856,-9.8704e-06,-1.09877e-08,5.66936e-12,54596.9,19.1165], Tmin=(100,'K'), Tmax=(1079.71,'K')), NASAPolynomial(coeffs=[8.99276,0.0290418,-1.16234e-05,2.10864e-09,-1.44755e-13,52221.3,-20.0523], Tmin=(1079.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=[C]C([CH2])C(175)',
    structure = SMILES('[CH]=[C]C([CH2])C'),
    E0 = (641.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3120,650,792.5,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.109915,'amu*angstrom^2'), symmetry=1, barrier=(2.52717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108948,'amu*angstrom^2'), symmetry=1, barrier=(2.50493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.816519,'amu*angstrom^2'), symmetry=1, barrier=(18.7734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71561,0.0445227,-3.37172e-05,1.42736e-08,-2.48876e-12,77271.3,22.9381], Tmin=(100,'K'), Tmax=(1359.87,'K')), NASAPolynomial(coeffs=[9.98115,0.0202101,-6.89932e-06,1.12635e-09,-7.17678e-14,75023.3,-19.4791], Tmin=(1359.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(641.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(C)C=[CH](179)',
    structure = SMILES('[CH]C(C)C=[CH]'),
    E0 = (647.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,738.138],'cm^-1')),
        HinderedRotor(inertia=(0.00665301,'amu*angstrom^2'), symmetry=1, barrier=(2.62333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00630237,'amu*angstrom^2'), symmetry=1, barrier=(2.53246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.636629,'amu*angstrom^2'), symmetry=1, barrier=(14.6374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    label = '[C]=CC([CH2])C(180)',
    structure = SMILES('[C]=CC([CH2])C'),
    E0 = (714.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.655729,'amu*angstrom^2'), symmetry=1, barrier=(15.0765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0380897,'amu*angstrom^2'), symmetry=1, barrier=(9.17294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0143514,'amu*angstrom^2'), symmetry=1, barrier=(79.2584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89792,0.0414957,-2.51727e-05,5.74172e-09,3.73012e-13,86063.6,21.7822], Tmin=(100,'K'), Tmax=(1065.23,'K')), NASAPolynomial(coeffs=[8.93525,0.0222416,-8.15852e-06,1.41349e-09,-9.44241e-14,84157.4,-14.5234], Tmin=(1065.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(714.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])C(152)'],
    products = ['C#C(139)', 'C=CC(37)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(7)', '[CH]=CC(=C)C(166)'],
    products = ['[CH]=CC([CH2])C(152)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C=C[CH2](160)', '[CH3](10)'],
    products = ['[CH]=CC([CH2])C(152)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[CH](140)', '[CH2][CH]C(39)'],
    products = ['[CH]=CC([CH2])C(152)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(7)', '[CH]C=C([CH2])C(173)'],
    products = ['[CH]=CC([CH2])C(152)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(7)', '[CH]=CC([CH2])[CH2](174)'],
    products = ['[CH]=CC([CH2])C(152)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(7)', '[CH]=[C]C([CH2])C(175)'],
    products = ['[CH]=CC([CH2])C(152)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(13)', '[CH]=CC[CH2](150)'],
    products = ['[CH]=CC([CH2])C(152)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C=CC(156)', 'CH2(T)(26)'],
    products = ['[CH]=CC([CH2])C(152)'],
