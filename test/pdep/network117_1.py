...
species(
    label = '[CH]=CC([CH2])=C(310)',
    structure = SMILES('[CH]=CC([CH2])=C'),
    E0 = (454.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3120,650,792.5,1650,350,440,435,1725,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(1.2428,'amu*angstrom^2'), symmetry=1, barrier=(28.5744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24207,'amu*angstrom^2'), symmetry=1, barrier=(28.5577,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]C=C([CH2])[CH2](314)',
    structure = SMILES('[CH]C=C([CH2])[CH2]'),
    E0 = (604.726,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,394.68,394.681,394.681],'cm^-1')),
...
species(
    label = '[CH]=[C]C([CH2])[CH2](315)',
    structure = SMILES('[CH]=[C]C([CH2])[CH2]'),
    E0 = (846.829,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,1380,1390,370,380,2900,435,3120,650,792.5,1650,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.00237442,'amu*angstrom^2'), symmetry=1, barrier=(5.1555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159822,'amu*angstrom^2'), symmetry=1, barrier=(5.12498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.03546,'amu*angstrom^2'), symmetry=1, barrier=(67.3896,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01533,0.0427783,-3.36137e-05,9.28079e-09,2.03046e-12,101922,22.9576], Tmin=(100,'K'), Tmax=(792.168,'K')), NASAPolynomial(coeffs=[8.65034,0.0186874,-5.81895e-06,8.88199e-10,-5.43694e-14,100576,-9.37064], Tmin=(792.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(846.829,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C([CH2])C=[CH](319)',
    structure = SMILES('[CH]C([CH2])C=[CH]'),
    E0 = (852.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,476.985,477.06,477.07],'cm^-1')),
        HinderedRotor(inertia=(0.0117947,'amu*angstrom^2'), symmetry=1, barrier=(1.90494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0117938,'amu*angstrom^2'), symmetry=1, barrier=(1.90463,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0117972,'amu*angstrom^2'), symmetry=1, barrier=(1.9048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88041,0.0408555,-2.12691e-05,-4.24371e-09,5.73755e-12,102568,22.8742], Tmin=(100,'K'), Tmax=(933.714,'K')), NASAPolynomial(coeffs=[10.935,0.0164808,-5.26876e-06,8.66451e-10,-5.7707e-14,100249,-23.553], Tmin=(933.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(852.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P) + radical(Isobutyl)"""),
)

species(
    label = '[C]=CC([CH2])[CH2](320)',
    structure = SMILES('[C]=CC([CH2])[CH2]'),
    E0 = (919.993,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.00100512,'amu*angstrom^2'), symmetry=1, barrier=(2.45589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105401,'amu*angstrom^2'), symmetry=1, barrier=(2.42338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.91108,'amu*angstrom^2'), symmetry=1, barrier=(66.9316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04585,0.0415729,-3.16596e-05,9.78689e-09,7.12336e-13,110721,22.3447], Tmin=(100,'K'), Tmax=(835.392,'K')), NASAPolynomial(coeffs=[8.28467,0.0196221,-6.46943e-06,1.03554e-09,-6.56741e-14,109403,-8.28631], Tmin=(835.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(919.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(7)', '[CH]=CC([CH2])=C(310)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(7)', 'C#CC([CH2])[CH2](311)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=CC=C(153)', 'CH2(T)(26)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(7)', '[CH]C=C([CH2])[CH2](314)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(7)', '[CH]=[C]C([CH2])[CH2](315)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C=C[CH2](160)', 'CH2(T)(26)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(7)', '[CH]C([CH2])C=[CH](319)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(7)', '[C]=CC([CH2])[CH2](320)'],
    products = ['[CH]=CC([CH2])[CH2](174)'],
