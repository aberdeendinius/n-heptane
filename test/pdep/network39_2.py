...
species(
    ...
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.69943,-0.00891673,9.30648e-05,-1.12243e-07,4.17999e-11,5085.2,6.89326], Tmin=(100,'K'), Tmax=(941.898,'K')), NASAPolynomial(coeffs=[8.27141,0.0114864,-2.84087e-06,5.21664e-10,-4.31841e-14,2457.61,-24.2666], Tmin=(941.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.0726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane)"""),
)
...
species(
    ...
    E0 = (532.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,180,1215.04,1215.19],'cm^-1')),
        HinderedRotor(inertia=(0.00311897,'amu*angstrom^2'), symmetry=1, barrier=(3.25824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141237,'amu*angstrom^2'), symmetry=1, barrier=(3.24731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04383,0.016227,8.19879e-06,-1.95233e-08,7.97693e-12,64136.3,13.5822], Tmin=(100,'K'), Tmax=(994.058,'K')), NASAPolynomial(coeffs=[6.5142,0.0136529,-5.10441e-06,9.2539e-10,-6.4735e-14,62883.5,-5.97032], Tmin=(994.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
