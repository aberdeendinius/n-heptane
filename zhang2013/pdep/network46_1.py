...
species(
    ...
    E0 = (188.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,181.531],'cm^-1')),
...
species(
    label = '[CH2][CH]C[CH2](190)',
    structure = SMILES('[CH2][CH]C[CH2]'),
    E0 = (460.635,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2622.45],'cm^-1')),
        HinderedRotor(inertia=(0.000421206,'amu*angstrom^2'), symmetry=1, barrier=(2.05706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.84547,'amu*angstrom^2'), symmetry=1, barrier=(42.431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0245582,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.81947,0.0272005,-9.56979e-06,5.9176e-10,1.83278e-13,55442.9,20.1592], Tmin=(100,'K'), Tmax=(1946.61,'K')), NASAPolynomial(coeffs=[9.19058,0.0193113,-7.49951e-06,1.25569e-09,-7.83162e-14,51976.8,-17.3532], Tmin=(1946.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (509.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300.354,1215.35,1216.37,1217.02],'cm^-1')),
        HinderedRotor(inertia=(0.00186772,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.081396,'amu*angstrom^2'), symmetry=1, barrier=(5.15125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0809786,'amu*angstrom^2'), symmetry=1, barrier=(5.1506,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28697,0.0322908,-1.00184e-05,-5.9628e-09,3.57489e-12,61303.7,18.5453], Tmin=(100,'K'), Tmax=(1088.51,'K')), NASAPolynomial(coeffs=[8.15768,0.0208543,-8.22742e-06,1.4956e-09,-1.02998e-13,59425.1,-13.0339], Tmin=(1088.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC=C(189)', 'H(8)'],
    products = ['[CH2]CC[CH2](29)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]C[CH2](190)', 'H(8)'],
    products = ['[CH2]CC[CH2](29)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(T)(19)', '[CH2]C[CH2](27)'],
    products = ['[CH2]CC[CH2](29)'],
