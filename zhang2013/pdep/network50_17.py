...
species(
    ...
    E0 = (-17.8305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,360,370,350,2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1350,1371.43,1392.86,1414.29,1435.71,1457.14,1478.57,1500,700,733.333,766.667,800,1000,1033.33,1066.67,1100,1350,1366.67,1383.33,1400,900,966.667,1033.33,1100,180],'cm^-1')),
        HinderedRotor(inertia=(0.136358,'amu*angstrom^2'), symmetry=1, barrier=(3.13513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136672,'amu*angstrom^2'), symmetry=1, barrier=(3.14235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136049,'amu*angstrom^2'), symmetry=1, barrier=(3.12804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135831,'amu*angstrom^2'), symmetry=1, barrier=(3.12302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135627,'amu*angstrom^2'), symmetry=1, barrier=(3.11834,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1674,'amu'),
...
species(
    label = 'CC(C)=C(C)C(185)',
    structure = SMILES('CC(C)=C(C)C'),
    E0 = (-108.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1350,1371.43,1392.86,1414.29,1435.71,1457.14,1478.57,1500,700,733.333,766.667,800,1000,1033.33,1066.67,1100,1350,1366.67,1383.33,1400,900,966.667,1033.33,1100,325,375,415,465,420,450,1700,1750],'cm^-1')),
        HinderedRotor(inertia=(0.385264,'amu*angstrom^2'), symmetry=1, barrier=(8.85799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385494,'amu*angstrom^2'), symmetry=1, barrier=(8.86328,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385015,'amu*angstrom^2'), symmetry=1, barrier=(8.85224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.385243,'amu*angstrom^2'), symmetry=1, barrier=(8.85749,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36938,0.0594022,-3.27321e-05,8.8713e-09,-9.96507e-13,-12898.7,18.5228], Tmin=(100,'K'), Tmax=(1875.94,'K')), NASAPolynomial(coeffs=[11.4493,0.0379094,-1.55467e-05,2.76406e-09,-1.82624e-13,-16680.6,-36.4482], Tmin=(1875.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs)"""),
)

species(
    label = 'C[C](C)[C](C)C(186)',
    structure = SMILES('C[C](C)[C](C)C'),
    E0 = (167.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1350,1371.43,1392.86,1414.29,1435.71,1457.14,1478.57,1500,700,733.333,766.667,800,1000,1033.33,1066.67,1100,1350,1366.67,1383.33,1400,900,966.667,1033.33,1100,360,363.333,366.667,370,300,400,4000],'cm^-1')),
        HinderedRotor(inertia=(0.154144,'amu*angstrom^2'), symmetry=1, barrier=(3.54408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154365,'amu*angstrom^2'), symmetry=1, barrier=(3.54915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154436,'amu*angstrom^2'), symmetry=1, barrier=(3.55079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15443,'amu*angstrom^2'), symmetry=1, barrier=(3.55065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154556,'amu*angstrom^2'), symmetry=1, barrier=(3.55355,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35074,0.0662816,-7.65945e-05,7.30663e-08,-2.93897e-11,20244.3,23.2309], Tmin=(100,'K'), Tmax=(816.057,'K')), NASAPolynomial(coeffs=[-0.227928,0.0562941,-2.56554e-05,4.83564e-09,-3.33047e-13,21092.1,34.1424], Tmin=(816.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Tertalkyl)"""),
)
...
species(
    ...
    E0 = (274.437,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.115552,'amu*angstrom^2'), symmetry=1, barrier=(2.65676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.72309,'amu*angstrom^2'), symmetry=1, barrier=(16.6253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0152026,'amu*angstrom^2'), symmetry=1, barrier=(16.6161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.723038,'amu*angstrom^2'), symmetry=1, barrier=(16.6241,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.1329,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57675,0.0443051,-5.15955e-06,-1.99594e-08,9.54331e-12,33102.1,19.4798], Tmin=(100,'K'), Tmax=(1033.91,'K')), NASAPolynomial(coeffs=[10.4344,0.0293104,-1.13681e-05,2.07458e-09,-1.44363e-13,30240.3,-28.5306], Tmin=(1033.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction243',
    reactants = ['H(8)', 'CC(C)=C(C)C(185)'],
    products = ['C[C](C)C(C)C(171)'],
    transitionState = 'TS243',
    kinetics = Arrhenius(A=(1.792e+08,'cm^3/(mol*s)'), n=1.64, Ea=(6.9036,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2569 H + C6H12 <=> C6H13-9 in R_Addition_MultipleBond/training
This reaction matched rate rule [Cds-CsCs_Cds-CsCs;HJ]
family: R_Addition_MultipleBond"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(12700,'cm^3/(mol*s)'), n=2.41, Ea=(26.8194,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 453 CH3 + C5H10 <=> C6H13-6 in R_Addition_MultipleBond/training
This reaction matched rate rule [Cds-CsH_Cds-CsCs;CsJ-HHH]
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction252',
    reactants = ['[CH3](11)', 'C[C]C(C)C(187)'],
    products = ['C[C](C)C(C)C(171)'],
