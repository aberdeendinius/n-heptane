...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01894,0.0389034,-1.36057e-05,-1.10508e-08,8.25788e-12,32791.2,17.1163], Tmin=(100,'K'), Tmax=(886.389,'K')), NASAPolynomial(coeffs=[9.03357,0.0209579,-6.43698e-06,1.00642e-09,-6.41225e-14,31009.1,-18.9172], Tmin=(886.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)
...
species(
    label = '[C]=[C]CC[CH2](18832)',
    structure = SMILES('[C]=[C]CC[CH2]'),
    E0 = (960.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,275.825,1701.91],'cm^-1')),
        HinderedRotor(inertia=(0.00221458,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177281,'amu*angstrom^2'), symmetry=1, barrier=(9.86141,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177182,'amu*angstrom^2'), symmetry=1, barrier=(9.86392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37375,0.0409359,-2.81999e-05,-5.95036e-09,1.68604e-11,115622,20.8602], Tmin=(100,'K'), Tmax=(531.017,'K')), NASAPolynomial(coeffs=[5.17834,0.0276416,-1.27703e-05,2.45338e-09,-1.72312e-13,115213,8.06509], Tmin=(531.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(960.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CdCdJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#CC[CH][CH2](6430)'],
    products = ['[CH]=[C]CC[CH2](6433)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]=[C]C[CH][CH2](6436)'],
    products = ['[CH]=[C]CC[CH2](6433)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[CH2](21)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC[CH2](6433)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]CC[C]=[CH](18831)'],
    products = ['[CH]=[C]CC[CH2](6433)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[C]=[C]CC[CH2](18832)'],
    products = ['[CH]=[C]CC[CH2](6433)'],
