...
species(
    ...
    E0 = (-115.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (-237.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60047,0.0582461,-6.84824e-05,6.0538e-08,-2.39711e-11,-25079.1,23.8906], Tmin=(100,'K'), Tmax=(730.826,'K')), NASAPolynomial(coeffs=[3.39155,0.041648,-2.04685e-05,4.01695e-09,-2.84454e-13,-25159.4,17.0528], Tmin=(730.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16302,0.0757004,-5.15182e-05,-6.25661e-08,9.38253e-11,6240.63,31.9635], Tmin=(100,'K'), Tmax=(469.432,'K')), NASAPolynomial(coeffs=[7.97769,0.0418855,-2.09628e-05,4.09612e-09,-2.87316e-13,5333.61,1.39387], Tmin=(469.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.1529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([O])CC([O])O[O](3944)',
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51725,0.0677587,-2.45101e-05,-1.15319e-07,1.36731e-10,405.374,29.1938], Tmin=(100,'K'), Tmax=(447.319,'K')), NASAPolynomial(coeffs=[7.30793,0.0411849,-1.99277e-05,3.82872e-09,-2.65473e-13,-364.875,3.09672], Tmin=(447.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.74267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0192799,0.0980015,-0.000156523,1.4203e-07,-5.0996e-11,3424.58,32.9653], Tmin=(100,'K'), Tmax=(815.424,'K')), NASAPolynomial(coeffs=[7.49711,0.0429991,-2.1643e-05,4.20261e-09,-2.92269e-13,2814.14,2.14971], Tmin=(815.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.3658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([O])[CH][C](O)OO(3948)',
    structure = SMILES('CC([O])[CH][C](O)OO'),
    E0 = (30.6941,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115521,0.0916248,-0.00012099,8.73382e-08,-2.56128e-11,3826,35.3467], Tmin=(100,'K'), Tmax=(828.527,'K')), NASAPolynomial(coeffs=[12.0782,0.0338709,-1.64295e-05,3.20451e-09,-2.26263e-13,1843.73,-20.1159], Tmin=(828.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.6941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH) + radical(Cs_P)"""),
)

species(
    label = 'CC([O])C[C](O)O[O](3949)',
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301104,0.0866899,-0.000112442,8.12935e-08,-2.39466e-11,-2002.37,33.1308], Tmin=(100,'K'), Tmax=(824.75,'K')), NASAPolynomial(coeffs=[11.286,0.0334153,-1.55524e-05,2.9775e-09,-2.0797e-13,-3814.38,-17.7487], Tmin=(824.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.7161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_P) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.254295,0.100808,-0.000151963,1.25061e-07,-4.12411e-11,977.031,33.7789], Tmin=(100,'K'), Tmax=(788.136,'K')), NASAPolynomial(coeffs=[11.9125,0.0344149,-1.67667e-05,3.22745e-09,-2.24126e-13,-796.602,-21.1076], Tmin=(788.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.90702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    E0 = (207.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,203.265,204.518,1468.67,1468.93],'cm^-1')),
        HinderedRotor(inertia=(0.0042161,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241696,'amu*angstrom^2'), symmetry=1, barrier=(7.39196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252576,'amu*angstrom^2'), symmetry=1, barrier=(7.38979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249602,'amu*angstrom^2'), symmetry=1, barrier=(7.38815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (118.088,'amu'),
...
species(
    ...
    E0 = (232.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,363.333,366.667,370,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (256.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.499058,0.0874597,-0.000136368,1.2866e-07,-4.84164e-11,-38496.6,31.0305], Tmin=(100,'K'), Tmax=(804.164,'K')), NASAPolynomial(coeffs=[4.65172,0.0469591,-2.3806e-05,4.65631e-09,-3.25868e-13,-38522.8,15.891], Tmin=(804.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-321.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.604936,0.0871768,-0.000143409,1.37997e-07,-5.11202e-11,-20990.3,32.7019], Tmin=(100,'K'), Tmax=(848.937,'K')), NASAPolynomial(coeffs=[3.19804,0.0469174,-2.27277e-05,4.31769e-09,-2.95398e-13,-20420.2,26.5677], Tmin=(848.937,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCOJ)"""),
)

species(
    label = 'CC([O])CC(=O)OO(3621)',
    structure = SMILES('CC([O])CC(=O)OO'),
    E0 = (-437.06,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178581,0.0734954,-5.86727e-05,2.15898e-08,-2.68006e-12,-52419.8,31.0655], Tmin=(100,'K'), Tmax=(1183.63,'K')), NASAPolynomial(coeffs=[17.8646,0.02444,-1.00823e-05,1.86887e-09,-1.29871e-13,-57357,-60.411], Tmin=(1183.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-437.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])C[C][O](3860)',
    structure = SMILES('CC([O])C[C][O]'),
    E0 = (440.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,293.203,293.213,293.214,293.218,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00196089,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500839,'amu*angstrom^2'), symmetry=1, barrier=(30.5548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184194,'amu*angstrom^2'), symmetry=1, barrier=(11.2366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68029,0.057868,-6.01125e-05,2.35002e-08,5.53207e-12,53051.1,22.4529], Tmin=(100,'K'), Tmax=(559.451,'K')), NASAPolynomial(coeffs=[6.9788,0.0304594,-1.47097e-05,2.864e-09,-2.01923e-13,52294.4,-1.497], Tmin=(559.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CC(=O)C[C]([O])OO(1329)', 'H(8)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CC([O])[CH]C(=O)OO(3430)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C](CC=O)OO(2668)', '[CH3](11)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'CC([O])CC([O])=O(3649)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction18',
    reactants = ['CC([O])C[C]([O])OO(3630)'],
    products = ['[CH2]C([O])C[C](O)OO(3952)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OH(D)(132)', 'CC([O])C[C]([O])[O](3644)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC([O])C[C]([O])O[O](3424)', 'H(8)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[O][CH]C[C]([O])OO(2680)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[C]([O])C[C]([O])OO(3415)', 'H(8)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC([O])[CH][C]([O])OO(3419)', 'H(8)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[O]CC[C]([O])OO(1278)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]O(16)', 'CC([O])C[C][O](3860)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O(T)(63)', 'C[CH]C[C]([O])OO(1355)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C)[O](442)', '[O][C]OO(1370)'],
    products = ['CC([O])C[C]([O])OO(3630)'],
