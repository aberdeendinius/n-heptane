species(
    label = 'C#CC([O])O[C]([CH2])OO(22388)',
    structure = SMILES('C#CC([O])O[C]([CH2])OO'),
    E0 = (311.401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,750,770,3400,2100,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2175,525,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.439515,0.10922,-0.000186048,1.66712e-07,-5.78083e-11,37601.7,37.211], Tmin=(100,'K'), Tmax=(841.083,'K')), NASAPolynomial(coeffs=[10.1779,0.0371019,-1.88678e-05,3.63327e-09,-2.49797e-13,36580.5,-7.62732], Tmin=(841.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_P) + radical(CCOJ) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH]=C1OC1O[C]([CH2])OO(26929)',
    structure = SMILES('[CH]=C1OC1O[C]([CH2])OO'),
    E0 = (338.139,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.632828,0.0957756,-0.000110991,6.0962e-08,-1.28806e-11,40840.9,33.6934], Tmin=(100,'K'), Tmax=(1166.62,'K')), NASAPolynomial(coeffs=[23.0533,0.0145628,-6.57042e-06,1.29053e-09,-9.33362e-14,35314.3,-84.2287], Tmin=(1166.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(Cds_P) + radical(Cs_P) + radical(CJCOOH)"""),
)
...
species(
    label = 'C#CC(=O)O[C]([CH2])OO(26931)',
    structure = SMILES('C#CC(=O)O[C]([CH2])OO'),
    E0 = (182.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,750,770,3400,2100,3000,3100,440,815,1455,1000,2175,525,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.102761,0.100377,-0.00017092,1.51343e-07,-5.17758e-11,22072.8,36.2155], Tmin=(100,'K'), Tmax=(845.77,'K')), NASAPolynomial(coeffs=[10.446,0.0317621,-1.60208e-05,3.06953e-09,-2.10212e-13,20958.2,-8.94999], Tmin=(845.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)O2s) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJCOOH) + radical(Cs_P)"""),
)
...
species(
    label = '[CH]=C=C(O)O[C]([CH2])OO(26932)',
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32771,0.115045,-0.000160403,1.05856e-07,-2.66019e-11,29407.3,36.3783], Tmin=(100,'K'), Tmax=(989.85,'K')), NASAPolynomial(coeffs=[24.1656,0.0120249,-4.28746e-06,7.11392e-10,-4.59675e-14,24360.4,-86.3521], Tmin=(989.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CJCOOH) + radical(Cs_P) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=C=C([O])OC([CH2])OO(26933)',
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.784307,0.105272,-0.000138972,8.95152e-08,-2.23026e-11,21714.4,34.4622], Tmin=(100,'K'), Tmax=(991.015,'K')), NASAPolynomial(coeffs=[20.6247,0.0188594,-8.17675e-06,1.5272e-09,-1.06055e-13,17471.1,-68.6307], Tmin=(991.015,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=C=CJ) + radical(CJCOOH)"""),
)

species(
    label = 'C#CC([O])OC([CH2])O[O](26934)',
    structure = SMILES('C#CC([O])OC([CH2])O[O]'),
    E0 = (258.16,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.21672,0.104934,-0.000180387,1.63724e-07,-5.70002e-11,31189.6,36.4826], Tmin=(100,'K'), Tmax=(857.011,'K')), NASAPolynomial(coeffs=[8.75195,0.0378125,-1.86905e-05,3.54604e-09,-2.41193e-13,30580,0.0102122], Tmin=(857.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH]=C=C([O])O[C](C)OO(26935)',
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.634219,0.102707,-0.000134156,8.63485e-08,-2.16039e-11,20660.1,32.6176], Tmin=(100,'K'), Tmax=(984.68,'K')), NASAPolynomial(coeffs=[19.5626,0.0206635,-9.17635e-06,1.73272e-09,-1.20965e-13,16682.6,-64.5089], Tmin=(984.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COJ) + radical(C=C=CJ) + radical(Cs_P)"""),
)

species(
    label = 'C#CC([O])O[C](C)O[O](26936)',
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.102088,0.102814,-0.00017726,1.6296e-07,-5.74328e-11,30136.7,34.7635], Tmin=(100,'K'), Tmax=(854.775,'K')), NASAPolynomial(coeffs=[7.76965,0.039477,-1.96079e-05,3.73186e-09,-2.54452e-13,29759.2,3.68512], Tmin=(854.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_P) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = '[C]#CC(O)O[C]([CH2])OO(26937)',
    structure = SMILES('[C]#CC(O)O[C]([CH2])OO'),
    E0 = (422.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2175,525,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.787619,0.115585,-0.000196404,1.68181e-07,-5.50807e-11,51018.5,38.3435], Tmin=(100,'K'), Tmax=(876.6,'K')), NASAPolynomial(coeffs=[13.4799,0.0297716,-1.41249e-05,2.60449e-09,-1.73218e-13,49312.8,-24.0713], Tmin=(876.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_P) + radical(CJCOOH) + radical(Acetyl)"""),
)

species(
    label = '[C]#CC([O])OC([CH2])OO(26938)',
    structure = SMILES('[C]#CC([O])OC([CH2])OO'),
    E0 = (443.299,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2175,525,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.470623,0.112213,-0.000198704,1.8177e-07,-6.31676e-11,53464.2,37.3775], Tmin=(100,'K'), Tmax=(867.086,'K')), NASAPolynomial(coeffs=[8.97116,0.0385248,-1.91031e-05,3.60453e-09,-2.43475e-13,52959.6,-0.295361], Tmin=(867.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ) + radical(Acetyl) + radical(CJCOOH)"""),
)

species(
    label = '[C]#CC([O])O[C](C)OO(26939)',
    structure = SMILES('[C]#CC([O])O[C](C)OO'),
    E0 = (434.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,1380,1390,370,380,2900,435,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.355666,0.110088,-0.000195555,1.80967e-07,-6.35774e-11,52411.4,35.6573], Tmin=(100,'K'), Tmax=(864.754,'K')), NASAPolynomial(coeffs=[7.99032,0.0401868,-2.00191e-05,3.79002e-09,-2.56706e-13,52138.1,3.37133], Tmin=(864.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_P) + radical(CCOJ) + radical(Acetyl)"""),
)

species(
    label = 'C#CC(O)O[C]([CH2])O[O](26940)',
    structure = SMILES('C#CC(O)O[C]([CH2])O[O]'),
    E0 = (237.701,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.530711,0.108267,-0.000177918,1.49869e-07,-4.87728e-11,28743.8,37.4381], Tmin=(100,'K'), Tmax=(863.486,'K')), NASAPolynomial(coeffs=[13.2611,0.029059,-1.37122e-05,2.54602e-09,-1.7094e-13,26933,-23.7682], Tmin=(863.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(Cs_P) + radical(CJCOOH)"""),
)
...
species(
    label = 'C#CC([O])O[C]([CH2])O[O](26941)',
    structure = SMILES('C#CC([O])O[C]([CH2])O[O]'),
    E0 = (463.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,750,770,3400,2100,360,370,350,3000,3100,440,815,1455,1000,2175,525,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18926,0.105783,-0.000191232,1.76445e-07,-6.16041e-11,55872.7,37.0718], Tmin=(100,'K'), Tmax=(866.534,'K')), NASAPolynomial(coeffs=[8.59838,0.0354258,-1.78675e-05,3.39033e-09,-2.29483e-13,55468.3,2.38959], Tmin=(866.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(CCOJ) + radical(CJCOOH) + radical(Cs_P)"""),
)
...
species(
    label = '[CH]=C=C([O])O[C]([CH2])OO(26942)',
    structure = SMILES('[CH]=C=C([O])O[C]([CH2])OO'),
    E0 = (384.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,360,370,350,540,610,2055,350,440,435,1725,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.745856,0.105975,-0.000149242,1.0145e-07,-2.65768e-11,46397.1,35.7065], Tmin=(100,'K'), Tmax=(944.542,'K')), NASAPolynomial(coeffs=[20.3292,0.0167235,-7.50255e-06,1.40736e-09,-9.73676e-14,42415.9,-64.7656], Tmin=(944.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cs_P) + radical(CJCOOH) + radical(C=C=CJ) + radical(C=COJ)"""),
)

species(
    label = '[C]#CC([O])O[C]([CH2])OO(26943)',
    structure = SMILES('[C]#CC([O])O[C]([CH2])OO'),
    E0 = (648.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2175,525,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.440794,0.113033,-0.00020945,1.94369e-07,-6.77255e-11,78147.2,37.9583], Tmin=(100,'K'), Tmax=(874.654,'K')), NASAPolynomial(coeffs=[8.80451,0.036161,-1.82936e-05,3.45205e-09,-2.32036e-13,77853.1,2.15715], Tmin=(874.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(648.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ) + radical(Cs_P) + radical(Acetyl) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.119867,0.0993996,-0.000159605,1.37995e-07,-4.69064e-11,-2610.73,34.8965], Tmin=(100,'K'), Tmax=(827.885,'K')), NASAPolynomial(coeffs=[10.555,0.0342277,-1.68905e-05,3.23652e-09,-2.22872e-13,-3912.33,-11.7734], Tmin=(827.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.8701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)O2s) + group(Ct-CtCs) + group(Ct-CtH) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124197,0.108779,-0.000205878,1.99048e-07,-7.13844e-11,9464.88,35.9859], Tmin=(100,'K'), Tmax=(880.246,'K')), NASAPolynomial(coeffs=[4.80682,0.0434694,-2.14785e-05,4.02175e-09,-2.69181e-13,10258.9,22.2666], Tmin=(880.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.6038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'C#CC([O])OC(=C)OO(22395)',
    ...
    molecularWeight = (129.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.374181,0.104511,-0.000167104,1.41219e-07,-4.67904e-11,9307.39,31.902], Tmin=(100,'K'), Tmax=(834.513,'K')), NASAPolynomial(coeffs=[12.1863,0.0322826,-1.56648e-05,2.97379e-09,-2.03491e-13,7629.68,-23.9144], Tmin=(834.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.1425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
species(
    label = '[CH][C](OO)OC([O])C#C(26947)',
    structure = SMILES('[CH][C](OO)OC([O])C#C'),
    E0 = (545.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,750,770,3400,2100,1380,1390,370,380,2900,435,2175,525,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.426515,0.109557,-0.000192419,1.7383e-07,-6.03048e-11,65774.7,36.1731], Tmin=(100,'K'), Tmax=(846.495,'K')), NASAPolynomial(coeffs=[10.3717,0.0348555,-1.80908e-05,3.49362e-09,-2.39906e-13,64794.8,-9.11189], Tmin=(846.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCOJ) + radical(CCJ2_triplet) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['[CH]=C1OC1O[C]([CH2])OO(26929)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CC(=O)O[C]([CH2])OO(26931)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(275.691,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 274.8 to 275.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2][C](OO)OC=O(2702)', '[C]#C(5143)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', 'C#CC([O])OC([CH2])=O(22415)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['[CH]=C=C(O)O[C]([CH2])OO(26932)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['[CH]=C=C([O])OC([CH2])OO(26933)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['C#CC([O])OC([CH2])O[O](26934)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['[CH]=C=C([O])O[C](C)OO(26935)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['C#CC([O])O[C](C)O[O](26936)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C]#CC(O)O[C]([CH2])OO(26937)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]#CC([O])OC([CH2])OO(26938)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]#CC([O])O[C](C)OO(26939)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['C#CC(O)O[C]([CH2])O[O](26940)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(D)(132)', 'C#CC([O])O[C]([CH2])[O](22432)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', 'C#CC([O])O[C]([CH2])O[O](26941)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C](OO)O[CH][O](2710)', '[C]#C(5143)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]=C=C([O])O[C]([CH2])OO(26942)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[C]#CC([O])O[C]([CH2])OO(26943)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['C#CC(=O)OC([CH2])OO(26945)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C#CC([O])O[C]([CH2])OO(22388)'],
    products = ['C#CC([O])OC([CH2])([O])O(26946)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]OO(1383)', 'C#CC([O])[O](22347)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[O]O(16)', 'C#CC([O])O[C][CH2](24164)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH][C](OO)OC([O])C#C(26947)'],
    products = ['C#CC([O])O[C]([CH2])OO(22388)'],
