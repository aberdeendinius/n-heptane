...
species(
    ...
    molecularWeight = (65.0932,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2841,0.0306599,-2.24143e-06,-1.93352e-08,9.85803e-12,42896.9,14.5041], Tmin=(100,'K'), Tmax=(965.713,'K')), NASAPolynomial(coeffs=[9.8897,0.0159728,-5.54723e-06,9.77561e-10,-6.81561e-14,40643.8,-25.9829], Tmin=(965.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(CTCC=CCJ)"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]=[C]C[C]=[CH](19253)'],
    products = ['[CH]=[C]CC=[CH](17764)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C=C(18735)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC=[CH](17764)'],
