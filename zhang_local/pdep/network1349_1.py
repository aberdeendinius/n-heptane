...
species(
    label = 'C#COC([CH2])[O](4659)',
    structure = SMILES('C#COC([CH2])[O]'),
    E0 = (260.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,1380,1390,370,380,2900,435,2175,525,3000,3100,440,815,1455,1000,339.631,339.671,339.678],'cm^-1')),
        HinderedRotor(inertia=(0.298293,'amu*angstrom^2'), symmetry=1, barrier=(24.4321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298414,'amu*angstrom^2'), symmetry=1, barrier=(24.4329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298451,'amu*angstrom^2'), symmetry=1, barrier=(24.433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21649,0.0590493,-6.65808e-05,3.67522e-08,-7.914e-12,31479.1,20.7875], Tmin=(100,'K'), Tmax=(1137.04,'K')), NASAPolynomial(coeffs=[14.3101,0.0129863,-5.81255e-06,1.12205e-09,-7.98685e-14,28501.5,-44.063], Tmin=(1137.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]=[C]OC(C)[O](4609)',
    structure = SMILES('[CH]=[C]OC(C)[O]'),
    E0 = (326.807,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,1685,370,354.715,354.757,355.239],'cm^-1')),
        HinderedRotor(inertia=(0.00134034,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180274,'amu*angstrom^2'), symmetry=1, barrier=(16.1921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181039,'amu*angstrom^2'), symmetry=1, barrier=(16.1977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58141,0.0525945,-5.10556e-05,2.58e-08,-5.27404e-12,39393.4,24.9192], Tmin=(100,'K'), Tmax=(1170.56,'K')), NASAPolynomial(coeffs=[11.2656,0.0195018,-8.64911e-06,1.64814e-09,-1.15829e-13,37126.3,-23.3265], Tmin=(1170.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO) + radical(CCOJ)"""),
)
...
species(
    label = 'C=[C]OC(C)=O(4232)',
    structure = SMILES('C=[C]OC(C)=O'),
    E0 = (-110.325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69686,0.0377193,1.2452e-05,-5.93425e-08,3.18004e-11,5335.63,20.2866], Tmin=(100,'K'), Tmax=(863.468,'K')), NASAPolynomial(coeffs=[16.9898,0.00501405,3.01258e-06,-9.00763e-10,6.92564e-14,1272.86,-59.481], Tmin=(863.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.5699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]C([O])O[C]=C(4664)',
    structure = SMILES('[CH]C([O])O[C]=C'),
    E0 = (527.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58565,0.0523252,-5.46024e-05,2.90117e-08,-6.14752e-12,63582.5,25.5054], Tmin=(100,'K'), Tmax=(1140.73,'K')), NASAPolynomial(coeffs=[11.8254,0.0164192,-7.3879e-06,1.41853e-09,-1.00238e-13,61246.4,-25.2436], Tmin=(1140.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(527.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=O)O[C]=C(4288)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#COC([CH2])[O](4659)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=[C]OC=O(4555)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', 'C=[C]OC=C(4212)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]OC([CH2])[O](4661)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C]=C(584)', '[CH2]C([O])[O](696)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(28)', '[CH2][C]OC=O(4560)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]C([O])O[C]=C(4664)'],
    products = ['[CH2]C([O])O[C]=C(4218)'],
