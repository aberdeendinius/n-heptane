...
species(
    label = 'CC1([CH]O1)C[O](9581)',
    structure = SMILES('CC1([CH]O1)C[O]'),
    E0 = (104.406,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00673,0.0593675,-6.24472e-05,3.60947e-08,-8.00318e-12,12670.5,21.2701], Tmin=(100,'K'), Tmax=(1278.02,'K')), NASAPolynomial(coeffs=[11.6936,0.0175957,-3.65077e-06,3.28023e-10,-9.78321e-15,10618.6,-30.2499], Tmin=(1278.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCOJ)"""),
)

species(
    label = 'CC1([CH][O])CO1(9582)',
    structure = SMILES('CC1([CH][O])CO1'),
    E0 = (100.981,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60538,0.05556,-4.63955e-05,1.66986e-09,1.55383e-11,12229,18.5326], Tmin=(100,'K'), Tmax=(646.547,'K')), NASAPolynomial(coeffs=[10.049,0.0205879,-5.31829e-06,6.19387e-10,-2.69242e-14,10776.2,-21.3117], Tmin=(646.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C1([CH]O1)CO(9583)',
    structure = SMILES('[CH2]C1([CH]O1)CO'),
    E0 = (89.2106,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229045,0.0757658,-9.74552e-05,6.18044e-08,-1.44077e-11,10871.7,22.9446], Tmin=(100,'K'), Tmax=(1253.84,'K')), NASAPolynomial(coeffs=[15.9515,0.00963877,7.58534e-07,-5.7364e-10,5.50173e-14,8184.28,-51.458], Tmin=(1253.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.2106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)C[O](9584)',
    structure = SMILES('[CH2]C1([CH]O1)C[O]'),
    E0 = (314.916,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27576,0.0635878,-6.87337e-05,1.77748e-08,1.28931e-11,37970.5,20.1267], Tmin=(100,'K'), Tmax=(645.26,'K')), NASAPolynomial(coeffs=[12.7506,0.0136967,-2.13443e-06,-1.603e-11,1.95572e-14,36047.4,-33.6321], Tmin=(645.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical(CCOJ)"""),
)
...
species(
    label = 'CC1(C=O)CO1(9586)',
    structure = SMILES('CC1(C=O)CO1'),
    E0 = (-217.549,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.622906,0.0555628,-5.04322e-05,2.45167e-08,-4.44343e-12,-26027.3,20.6006], Tmin=(100,'K'), Tmax=(1653.26,'K')), NASAPolynomial(coeffs=[11.796,0.015137,-1.60264e-06,-7.35176e-11,1.59653e-14,-27891.4,-33.3851], Tmin=(1653.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide)"""),
)

species(
    label = '[O]C[C]1CCO1(9587)',
    structure = SMILES('[O]C[C]1CCO1'),
    E0 = (113.839,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08065,0.0449169,-4.61006e-05,3.51523e-08,-1.10745e-11,13758.2,20.4629], Tmin=(100,'K'), Tmax=(973.73,'K')), NASAPolynomial(coeffs=[3.33164,0.0309391,-1.09524e-05,1.76581e-09,-1.09286e-13,13933.6,16.6126], Tmin=(973.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29891,0.057135,-6.65359e-05,4.31512e-08,-1.07483e-11,44467.5,21.0251], Tmin=(100,'K'), Tmax=(1147.13,'K')), NASAPolynomial(coeffs=[9.98207,0.0182311,-4.38512e-06,4.76355e-10,-1.93182e-14,43042.9,-19.5842], Tmin=(1147.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(58.7526,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
...
reaction(
    ...
    products = ['[CH2]C1(C[O])CO1(9221)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.67193e+11,'s^-1'), n=-0.0500183, Ea=(86.0977,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_O]
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(C=O)CO1(9311)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][O](357)', 'C=C1CO1(9173)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C[O](9584)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2]C1([CH][O])CO1(9585)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C[O](6285)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(T)(63)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]C1(C[O])CO1(9590)'],
    products = ['[CH2]C1(C[O])CO1(9221)'],
