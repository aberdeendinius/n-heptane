...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21535,0.0577402,-6.25377e-05,3.41781e-08,-7.30562e-12,20093.5,24.737], Tmin=(100,'K'), Tmax=(1146.91,'K')), NASAPolynomial(coeffs=[13.7426,0.01405,-5.39705e-06,9.63922e-10,-6.57243e-14,17220,-37.4168], Tmin=(1146.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CCsJOC(O)H) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH][CH]O[C]=O(6548)',
    structure = SMILES('[CH2][CH][CH]O[C]=O'),
    E0 = (366.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1855,455,950,1169.31,1169.62,1169.69],'cm^-1')),
        HinderedRotor(inertia=(0.35657,'amu*angstrom^2'), symmetry=1, barrier=(18.7688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.816988,'amu*angstrom^2'), symmetry=1, barrier=(18.7842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00165428,'amu*angstrom^2'), symmetry=1, barrier=(18.7828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.816521,'amu*angstrom^2'), symmetry=1, barrier=(18.7734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26927,0.0541846,-5.97133e-05,3.22262e-08,-6.68852e-12,44136.3,27.7329], Tmin=(100,'K'), Tmax=(1192.06,'K')), NASAPolynomial(coeffs=[14.7094,0.0090848,-2.96179e-06,4.8688e-10,-3.19812e-14,40932,-39.4689], Tmin=(1192.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(CCsJOC(O)H) + radical(RCCJ) + radical((O)CJOCC)"""),
)
...
species(
    label = '[CH2][C]CO[C]=O(6550)',
    structure = SMILES('[CH2][C]CO[C]=O'),
    E0 = (419.745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,180,639.463,639.463,639.504],'cm^-1')),
        HinderedRotor(inertia=(0.13125,'amu*angstrom^2'), symmetry=1, barrier=(3.0177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0103969,'amu*angstrom^2'), symmetry=1, barrier=(3.01783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11221,'amu*angstrom^2'), symmetry=1, barrier=(48.564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.781665,'amu*angstrom^2'), symmetry=1, barrier=(17.972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72962,0.0497536,-5.12589e-05,2.75036e-08,-5.94168e-12,50565.6,23.2494], Tmin=(100,'K'), Tmax=(1114.77,'K')), NASAPolynomial(coeffs=[10.7454,0.0174026,-7.7275e-06,1.46997e-09,-1.03221e-13,48555.6,-21.226], Tmin=(1114.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJ2_triplet) + radical(RCCJ) + radical((O)CJOCC)"""),
)

species(
    label = '[CH][CH]CO[C]=O(6551)',
    structure = SMILES('[CH][CH]CO[C]=O'),
    E0 = (414.401,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60734,0.0470779,-4.34766e-05,2.01591e-08,-3.68441e-12,49931.7,25.4977], Tmin=(100,'K'), Tmax=(1327.19,'K')), NASAPolynomial(coeffs=[12.8396,0.0132249,-5.21557e-06,9.39945e-10,-6.41114e-14,46950.2,-31.871], Tmin=(1327.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C[CH]O[C]=O(6545)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][CH]CO[C]=O(3097)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(46.7986,'m^3/(mol*s)'), n=2.021, Ea=(90.2265,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH][CH]O[C]=O(6548)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[C-]#[O+](374)', '[CH2][CH]C[O](429)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=O(1149)', '[CH2][CH]C[O](429)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[C]=O(1735)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]CO[C]=O(6550)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][CH]CO[C]=O(6551)'],
    products = ['[CH2][CH]CO[C]=O(3097)'],
