...
species(
    ...
    E0 = (761.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C1([CH2])OC1[C]=C(20419)',
    structure = SMILES('[CH2]C1([CH2])OC1[C]=C'),
    E0 = (580.91,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.25861,0.0872388,-0.000109329,6.91385e-08,-1.63791e-11,70026.4,26.8535], Tmin=(100,'K'), Tmax=(1197.92,'K')), NASAPolynomial(coeffs=[17.4318,0.0147419,-1.7389e-06,-9.3974e-11,2.19639e-14,66751.4,-57.6663], Tmin=(1197.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(580.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(Cds_S) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]=[C]O[C]([CH2])[CH2](20420)',
    structure = SMILES('[CH2][C]=[C]O[C]([CH2])[CH2]'),
    E0 = (992.365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.414629,0.104199,-0.000173379,1.42224e-07,-4.45329e-11,119506,33.1207], Tmin=(100,'K'), Tmax=(891.951,'K')), NASAPolynomial(coeffs=[14.976,0.0209094,-9.31206e-06,1.66042e-09,-1.07765e-13,117328,-36.1885], Tmin=(891.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(992.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_P) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C=CJO) + radical(C2CsJOC(O))"""),
)

species(
    label = '[CH]C(=C)O[CH][C][CH2](20421)',
    structure = SMILES('[CH]C(=C)O[CH][C][CH2]'),
    E0 = (966.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.259336,0.0860653,-9.30081e-05,5.00374e-08,-1.04644e-11,116462,31.1885], Tmin=(100,'K'), Tmax=(1176.32,'K')), NASAPolynomial(coeffs=[19.6269,0.0184424,-6.77657e-06,1.16587e-09,-7.77207e-14,111784,-67.98], Tmin=(1176.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(966.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCJ2_triplet) + radical(RCCJ) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2][C]=[C]OC([CH2])=C(20422)',
    structure = SMILES('[CH2][C]=[C]OC([CH2])=C'),
    E0 = (679.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,321.667,321.697,321.709],'cm^-1')),
        HinderedRotor(inertia=(0.71326,'amu*angstrom^2'), symmetry=1, barrier=(52.3763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00162891,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00158499,'amu*angstrom^2'), symmetry=1, barrier=(17.9961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.62954,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10228,0.0656609,-7.25826e-05,4.47717e-08,-1.13003e-11,81887.6,29.1379], Tmin=(100,'K'), Tmax=(956.031,'K')), NASAPolynomial(coeffs=[10.4205,0.0266739,-1.14125e-05,2.1161e-09,-1.45898e-13,80106,-15.3979], Tmin=(956.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(679.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=C(O)CJ) + radical(C=CJO) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=[C]O[C]([CH2])[CH2](20423)',
    structure = SMILES('[CH2]C=[C]O[C]([CH2])[CH2]'),
    E0 = (754.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,360,370,350,3010,987.5,1337.5,450,1655,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.238609,0.0977131,-0.000140931,1.01199e-07,-2.75683e-11,90896.8,32.0276], Tmin=(100,'K'), Tmax=(756.888,'K')), NASAPolynomial(coeffs=[15.8782,0.0219278,-9.34619e-06,1.68733e-09,-1.12878e-13,88188.1,-43.014], Tmin=(756.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(754.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(Allyl_P) + radical(C=CJO) + radical(C2CsJOC(O))"""),
)

species(
    label = '[CH2][C]=[C]OC([CH2])[CH2](20424)',
    structure = SMILES('[CH2][C]=[C]OC([CH2])[CH2]'),
    E0 = (792.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,1380,1390,370,380,2900,435,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.270706,0.0951446,-0.00013039,9.01493e-08,-2.42099e-11,95426.3,30.4161], Tmin=(100,'K'), Tmax=(920.263,'K')), NASAPolynomial(coeffs=[17.0247,0.0199649,-7.84324e-06,1.36799e-09,-9.01838e-14,92243.2,-51.5861], Tmin=(920.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_S) + radical(Allyl_P) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(=C)O[C][C]C(20425)',
    structure = SMILES('[CH2]C(=C)O[C][C]C'),
    E0 = (817.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.398123,0.0850669,-9.32753e-05,4.9479e-08,-1.00221e-11,98435.7,27.3546], Tmin=(100,'K'), Tmax=(1263.66,'K')), NASAPolynomial(coeffs=[22.0149,0.0116967,-3.30569e-06,4.96087e-10,-3.11439e-14,92964.7,-85.2547], Tmin=(1263.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(817.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(CCJ2_triplet) + radical(CH2_triplet)"""),
)

species(
    label = '[CH2][C]=[C]O[C]([CH2])C(20426)',
    structure = SMILES('[CH2][C]=[C]O[C]([CH2])C'),
    E0 = (781.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0770217,0.0896862,-0.000123292,8.82644e-08,-2.49143e-11,94173.7,31.6106], Tmin=(100,'K'), Tmax=(870.809,'K')), NASAPolynomial(coeffs=[14.3273,0.0242286,-1.0539e-05,1.9436e-09,-1.32512e-13,91691.8,-35.1673], Tmin=(870.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(781.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S) + radical(C=CJO) + radical(C2CsJOC(O)) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1=COC1([CH2])[CH2](20427)',
    structure = SMILES('[CH2]C1=COC1([CH2])[CH2]'),
    E0 = (447.147,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0797949,0.0700729,-2.25743e-05,-4.66543e-08,3.07813e-11,53944.8,23.4926], Tmin=(100,'K'), Tmax=(904.414,'K')), NASAPolynomial(coeffs=[27.7867,0.000360064,4.25917e-06,-9.8635e-10,6.6476e-14,46714.8,-120.252], Tmin=(904.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(Allyl_P)"""),
)

species(
    label = '[CH2][C]C1OC1([CH2])[CH2](20428)',
    structure = SMILES('[CH2][C]C1OC1([CH2])[CH2]'),
    E0 = (869.084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489558,0.0961249,-0.000131765,9.00471e-08,-2.29973e-11,104691,27.5196], Tmin=(100,'K'), Tmax=(1117.1,'K')), NASAPolynomial(coeffs=[17.5424,0.0156135,-2.24749e-06,-2.37609e-11,1.94115e-14,101657,-57.0181], Tmin=(1117.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(869.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(RCCJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH2])C[C][CH]O1(20429)',
    structure = SMILES('[CH2]C1([CH2])C[C][CH]O1'),
    E0 = (772.942,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.487396,0.0847586,-9.71987e-05,5.57819e-08,-1.18478e-11,93137.1,24.3722], Tmin=(100,'K'), Tmax=(1367.31,'K')), NASAPolynomial(coeffs=[18.5874,0.0125003,1.248e-07,-4.72869e-10,4.72524e-14,89459.1,-67.995], Tmin=(1367.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(772.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CCsJOCs) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH][C]([CH2])OC[C]=C(18333)',
    structure = SMILES('[CH][C]([CH2])OC[C]=C'),
    E0 = (879.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.157586,0.0987031,-0.000177185,1.6667e-07,-5.89623e-11,105859,30.954], Tmin=(100,'K'), Tmax=(876.077,'K')), NASAPolynomial(coeffs=[6.08194,0.0389282,-1.8808e-05,3.51121e-09,-2.35471e-13,106077,10.3237], Tmin=(876.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(879.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)O[CH][C]C(20430)',
    structure = SMILES('[CH]C(=C)O[CH][C]C'),
    E0 = (761.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.439243,0.0869699,-8.80696e-05,4.46141e-08,-8.80003e-12,91786,29.3571], Tmin=(100,'K'), Tmax=(1245.29,'K')), NASAPolynomial(coeffs=[20.5399,0.0195826,-6.89884e-06,1.15918e-09,-7.61528e-14,86561,-76.4573], Tmin=(1245.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(761.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(CCsJOC(O)) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704163,0.0744307,-8.37978e-05,5.12019e-08,-1.26732e-11,101584,27.6053], Tmin=(100,'K'), Tmax=(977.736,'K')), NASAPolynomial(coeffs=[12.1434,0.0276319,-1.20014e-05,2.2479e-09,-1.56073e-13,99346.8,-27.3252], Tmin=(977.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(843.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(RCCJ) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]C1C[C]([CH2])O1(20432)',
    structure = SMILES('[CH2][C]C1C[C]([CH2])O1'),
    E0 = (851.729,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967406,0.0689853,-6.4628e-05,1.89689e-08,7.01172e-12,102547,25.8314], Tmin=(100,'K'), Tmax=(690.785,'K')), NASAPolynomial(coeffs=[11.7259,0.0245909,-7.10331e-06,9.70473e-10,-5.25208e-14,100633,-25.184], Tmin=(690.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(851.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ2_triplet) + radical(RCCJ) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C]1CC[C][CH]O1(20433)',
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.384898,0.0718268,-7.41646e-05,4.21515e-08,-9.26812e-12,89054,23.4202], Tmin=(100,'K'), Tmax=(1265.6,'K')), NASAPolynomial(coeffs=[13.5592,0.0218589,-5.06957e-06,5.54555e-10,-2.39899e-14,86386.4,-40.6055], Tmin=(1265.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(739.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxane) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CCJ2_triplet) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH2][C]C1CC(=C)O1(20434)',
    structure = SMILES('[CH2][C]C1CC(=C)O1'),
    E0 = (538.021,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02313,0.0463318,2.33462e-05,-7.88337e-08,3.86768e-11,64834,21.438], Tmin=(100,'K'), Tmax=(907.393,'K')), NASAPolynomial(coeffs=[20.9769,0.00924146,5.66013e-07,-3.12723e-10,2.06597e-14,59118.6,-84.4285], Tmin=(907.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    ...
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.86749e+08,'m^3/(mol*s)'), n=-0.730906, Ea=(49.4233,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;Y_1centerbirad] + [Od_R;YJ] for rate rule [Od_R;Y_1centerbirad]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 48.7 to 49.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['C=C=C[O](12570)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][C]=COC([CH2])[CH2](20397)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][C]=CO[C]([CH2])C(20398)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2]C1([CH2])OC1[C]=C(20419)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]=C[O](18757)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C]=[C]O[C]([CH2])[CH2](20420)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]C(=C)O[CH][C][CH2](20421)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]=[C]OC([CH2])=C(20422)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C=[C]O[C]([CH2])[CH2](20423)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C]=[C]OC([CH2])[CH2](20424)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=C)O[C][C]C(20425)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C]=[C]O[C]([CH2])C(20426)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2]C1=COC1([CH2])[CH2](20427)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2][C]C1OC1([CH2])[CH2](20428)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(5.17159e+11,'s^-1'), n=-0.0562706, Ea=(116.724,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 115.8 to 116.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2]C1([CH2])C[C][CH]O1(20429)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(9.40382e+09,'s^-1'), n=0.352, Ea=(120.148,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R6;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][C]=C(6078)', '[CH2][C]=C[O](18757)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH][C]([CH2])OC[C]=C(18333)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C(=C)O[CH][C]C(20430)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]=C(6078)', '[CH2][C][CH][O](19530)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2][C][CH]O[C]1CC1(20431)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2][C]C1C[C]([CH2])O1(20432)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2][C]1CC[C][CH]O1(20433)'],
    transitionState = 'TS30',
    kinetics = Arrhenius(A=(6.52344e+08,'s^-1'), n=0.58655, Ea=(80.0039,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R6_linear;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['C=C=C(6077)', '[CH2][C]=C[O](18757)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2][C]C1CC(=C)O1(20434)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(=C)[O](4273)', '[CH][C][CH2](19517)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(28)', '[CH2][C]OC=[C][CH2](19523)'],
    products = ['[CH2][C]([CH2])O[CH][C]=C(18330)'],
