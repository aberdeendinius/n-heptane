species(
    label = '[CH2]OO[C]1CC1(11492)',
    structure = SMILES('[CH2]OO[C]1CC1'),
    E0 = (320.648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,500,795,815,3000,3100,440,815,1455,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6653,0.0445447,-2.35837e-05,3.33347e-09,5.82429e-13,38654.7,20.312], Tmin=(100,'K'), Tmax=(1334.38,'K')), NASAPolynomial(coeffs=[11.7763,0.0235157,-1.03767e-05,1.9471e-09,-1.34303e-13,35130.1,-34.4803], Tmin=(1334.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(C2CsJOOC) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH2]OOC1=CC1(11759)',
    structure = SMILES('[CH2]OOC1=CC1'),
    E0 = (378.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,350,500,795,815,2750,2950,3150,900,1000,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50164,0.0469864,-3.55376e-05,1.31092e-08,-1.91617e-12,45572.6,21.7938], Tmin=(100,'K'), Tmax=(1624.39,'K')), NASAPolynomial(coeffs=[14.2925,0.0154896,-6.45286e-06,1.17263e-09,-7.90998e-14,41417.1,-46.1202], Tmin=(1624.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CsJOOC)"""),
)
...
species(
    label = 'COO[C]1[CH]C1(11761)',
    structure = SMILES('COO[C]1[CH]C1'),
    E0 = (327.466,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09904,0.0421718,-2.37156e-05,5.92653e-09,-5.74021e-13,39452.6,22.0466], Tmin=(100,'K'), Tmax=(2345.39,'K')), NASAPolynomial(coeffs=[16.8085,0.0170856,-7.67192e-06,1.36626e-09,-8.79415e-14,32552.6,-61.4574], Tmin=(2345.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.466,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(C2CsJOOC) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]OO[C]1[CH]C1(11762)',
    structure = SMILES('[CH2]OO[C]1[CH]C1'),
    E0 = (521.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,350,500,795,815,2750,2950,3150,900,1000,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01637,0.0429816,-2.79126e-05,8.5709e-09,-1.06288e-12,62740.7,22.0305], Tmin=(100,'K'), Tmax=(1799.07,'K')), NASAPolynomial(coeffs=[11.8643,0.0210859,-9.65668e-06,1.80589e-09,-1.22801e-13,59197.3,-31.2633], Tmin=(1799.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(521.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CsJOOC) + radical(CCJCOOH) + radical(C2CsJOOC)"""),
)

species(
    label = '[CH2]OOC([CH2])=C(10031)',
    structure = SMILES('[CH2]OOC([CH2])=C'),
    E0 = (268.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,350,500,795,815,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(1.33926,'amu*angstrom^2'), symmetry=1, barrier=(30.7921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144912,'amu*angstrom^2'), symmetry=1, barrier=(3.33181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.33923,'amu*angstrom^2'), symmetry=1, barrier=(30.7915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0205386,'amu*angstrom^2'), symmetry=1, barrier=(94.7065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62832,0.0534556,-4.79417e-05,2.34703e-08,-4.81686e-12,32377.1,21.7303], Tmin=(100,'K'), Tmax=(1140.39,'K')), NASAPolynomial(coeffs=[9.51461,0.0257944,-1.15586e-05,2.20135e-09,-1.54308e-13,30578.4,-17.3526], Tmin=(1140.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsJOOC) + radical(C=C(O)CJ)"""),
)

species(
    label = 'COOC1=CC1(11763)',
    structure = SMILES('COOC1=CC1'),
    E0 = (184.512,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61508,0.0458892,-3.06294e-05,9.85903e-09,-1.26551e-12,22283,21.6937], Tmin=(100,'K'), Tmax=(1806.36,'K')), NASAPolynomial(coeffs=[14.1144,0.0182108,-7.64535e-06,1.37638e-09,-9.15111e-14,17767.3,-45.9991], Tmin=(1806.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]OOC1=CC1(11759)'],
    products = ['[CH2]OO[C]1CC1(11492)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]OOC1[CH]C1(11760)'],
    products = ['[CH2]OO[C]1CC1(11492)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH2]OO[C]1[CH]C1(11762)'],
    products = ['[CH2]OO[C]1CC1(11492)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[O](61)', '[C]1CC1(11616)'],
    products = ['[CH2]OO[C]1CC1(11492)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(28)', '[O]O[C]1CC1(11497)'],
    products = ['[CH2]OO[C]1CC1(11492)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]OO[C]1CC1(11764)'],
    products = ['[CH2]OO[C]1CC1(11492)'],
