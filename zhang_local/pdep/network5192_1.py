...
species(
    label = '[CH2]CC(=O)C([CH2])=CO(27776)',
    structure = SMILES('[CH2]CC(=O)C([CH2])=CO'),
    E0 = (-36.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,375,552.5,462.5,1710,180,927.031],'cm^-1')),
        HinderedRotor(inertia=(0.687484,'amu*angstrom^2'), symmetry=1, barrier=(15.8066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178221,'amu*angstrom^2'), symmetry=1, barrier=(15.8003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.687628,'amu*angstrom^2'), symmetry=1, barrier=(15.8099,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.025467,'amu*angstrom^2'), symmetry=1, barrier=(15.805,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.686337,'amu*angstrom^2'), symmetry=1, barrier=(15.7802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.312326,0.0890568,-9.33035e-05,4.93911e-08,-1.02627e-11,-4182.34,29.5657], Tmin=(100,'K'), Tmax=(1176.1,'K')), NASAPolynomial(coeffs=[19.1074,0.0230089,-9.06592e-06,1.64146e-09,-1.12719e-13,-8750.26,-67.2733], Tmin=(1176.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsOsH) + radical(CJCC=O) + radical(C=C(C=O)CJ)"""),
)
...
species(
    label = '[CH2]C(=CO)C1(O)[CH]C1(29754)',
    structure = SMILES('[CH2]C(=CO)C1(O)[CH]C1'),
    E0 = (28.0013,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0481085,0.0598896,2.57164e-05,-1.02817e-07,5.18094e-11,3535.36,31.006], Tmin=(100,'K'), Tmax=(909.829,'K')), NASAPolynomial(coeffs=[29.8458,0.000599764,5.23408e-06,-1.17642e-09,7.62906e-14,-4854.98,-126.246], Tmin=(909.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.0013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Allyl_P) + radical(CCJCO)"""),
)

species(
    label = 'CC(=[C]O)C1([O])CC1(29755)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.42783,0.063308,-1.62651e-05,-3.36877e-08,2.02896e-11,17635.8,31.2063], Tmin=(100,'K'), Tmax=(944.541,'K')), NASAPolynomial(coeffs=[19.8868,0.0186559,-5.31043e-06,8.9792e-10,-6.50592e-14,12275.7,-70.4767], Tmin=(944.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(C=CJO)"""),
)

species(
    label = 'CC(=CO)C1([O])[CH]C1(29756)',
    structure = SMILES('CC(=CO)C1([O])[CH]C1'),
    E0 = (105.605,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41118,0.0563445,1.92596e-05,-8.20708e-08,4.04538e-11,12851.4,30.6344], Tmin=(100,'K'), Tmax=(926.232,'K')), NASAPolynomial(coeffs=[24.5529,0.0102994,-4.45421e-07,-3.343e-11,-3.59991e-15,5882.21,-97.4651], Tmin=(926.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(=[C]O)C1(O)CC1(29757)',
    structure = SMILES('[CH2]C(=[C]O)C1(O)CC1'),
    E0 = (67.8435,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3580,3650,1210,1345,900,1100,1685,370,350,440,435,1725,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0753703,0.0667319,-9.4128e-06,-5.48836e-08,3.17979e-11,8319.24,31.5396], Tmin=(100,'K'), Tmax=(915.403,'K')), NASAPolynomial(coeffs=[25.106,0.00908138,2.96957e-07,-2.28041e-10,1.34191e-14,1569.43,-98.8436], Tmin=(915.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.8435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CJO) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C(=CO)C1([O])[CH]C1(29758)',
    structure = SMILES('[CH2]C(=CO)C1([O])[CH]C1'),
    E0 = (257.104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.4158,0.0537766,2.81747e-05,-9.61093e-08,4.68704e-11,31074.8,30.899], Tmin=(100,'K'), Tmax=(920.493,'K')), NASAPolynomial(coeffs=[26.7952,0.0043323,2.52035e-06,-5.94477e-10,3.422e-14,23456.7,-109.182], Tmin=(920.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(Allyl_P) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(=[C]O)C1([O])CC1(29759)',
    structure = SMILES('[CH2]C(=[C]O)C1([O])CC1'),
    E0 = (296.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,1685,370,350,440,435,1725,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438248,0.0606734,-7.12922e-06,-4.79842e-08,2.67986e-11,35858.9,31.45], Tmin=(100,'K'), Tmax=(932.414,'K')), NASAPolynomial(coeffs=[22.0908,0.0127538,-2.3821e-06,3.45709e-10,-2.79718e-14,29866.3,-81.9783], Tmin=(932.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = '[O]C1(CC1)[C]1CC1O(29760)',
    structure = SMILES('[O]C1(CC1)[C]1CC1O'),
    E0 = (142.852,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.997379,0.0431886,4.55804e-05,-9.80738e-08,4.27358e-11,17310.1,26.4371], Tmin=(100,'K'), Tmax=(949.161,'K')), NASAPolynomial(coeffs=[20.6072,0.0178122,-4.81352e-06,8.84789e-10,-7.09159e-14,11008,-80.7341], Tmin=(949.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C]1C(O)OC12CC2(29761)',
    structure = SMILES('[CH2][C]1C(O)OC12CC2'),
    E0 = (124.611,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.992513,0.0554271,-1.40447e-05,-1.87603e-08,1.05339e-11,15104.8,26.2215], Tmin=(100,'K'), Tmax=(1013.68,'K')), NASAPolynomial(coeffs=[13.0774,0.0307881,-1.16905e-05,2.12152e-09,-1.47868e-13,11470.6,-38.0864], Tmin=(1013.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](CO)C1([O])[CH]C1(29762)',
    structure = SMILES('[CH2][C](CO)C1([O])[CH]C1'),
    E0 = (397.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,360,370,350,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.570575,0.0632119,-2.4195e-05,-1.95534e-08,1.3945e-11,47988.8,33.0385], Tmin=(100,'K'), Tmax=(951.273,'K')), NASAPolynomial(coeffs=[17.1195,0.0231023,-7.42901e-06,1.27068e-09,-8.83615e-14,43506.6,-52.9838], Tmin=(951.273,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(CCJCO) + radical(CCJ(C)CO) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH]C(=C)C1(CC1)OO(29763)',
    structure = SMILES('[CH]C(=C)C1(CC1)OO'),
    E0 = (327.582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,180,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,1094.14,2223.33],'cm^-1')),
        HinderedRotor(inertia=(0.116565,'amu*angstrom^2'), symmetry=1, barrier=(2.68007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116565,'amu*angstrom^2'), symmetry=1, barrier=(2.68007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116565,'amu*angstrom^2'), symmetry=1, barrier=(2.68007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116565,'amu*angstrom^2'), symmetry=1, barrier=(2.68007,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160269,0.0693601,-2.01961e-05,-2.75639e-08,1.66291e-11,39550.8,29.836], Tmin=(100,'K'), Tmax=(978.518,'K')), NASAPolynomial(coeffs=[18.6853,0.0282695,-1.03023e-05,1.86933e-09,-1.32721e-13,34267.1,-67.6075], Tmin=(978.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[O]C1([C]=CO)CC1(29765)',
    structure = SMILES('[O]C1([C]=CO)CC1'),
    E0 = (182.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02578,0.0461675,1.6393e-05,-7.0441e-08,3.51076e-11,22086.6,25.6493], Tmin=(100,'K'), Tmax=(920.623,'K')), NASAPolynomial(coeffs=[21.9412,0.00539012,1.20684e-06,-3.34698e-10,1.84147e-14,16112.6,-85.0562], Tmin=(920.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Cds_S) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH]C(=CO)C1([O])CC1(29766)',
    structure = SMILES('[CH]C(=CO)C1([O])CC1'),
    E0 = (276.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.23314,0.0612782,1.17957e-05,-7.42794e-08,3.74062e-11,33397.3,29.886], Tmin=(100,'K'), Tmax=(927.717,'K')), NASAPolynomial(coeffs=[23.8318,0.0148558,-2.60212e-06,3.51623e-10,-2.86823e-14,26637.8,-95.0253], Tmin=(927.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = 'C=C(C[O])C1([O])CC1(12378)',
    structure = SMILES('C=C(C[O])C1([O])CC1'),
    E0 = (187.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903134,0.0592823,-3.24573e-05,5.64089e-09,5.77929e-13,22617.4,31.1435], Tmin=(100,'K'), Tmax=(1260.79,'K')), NASAPolynomial(coeffs=[13.0251,0.0319253,-1.31175e-05,2.3983e-09,-1.63895e-13,18678.4,-33.6464], Tmin=(1260.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(CCOJ)"""),
)

species(
    label = '[CH]=C(CO)C1([O])CC1(29767)',
    structure = SMILES('[CH]=C(CO)C1([O])CC1'),
    E0 = (208.456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,350,440,435,1725,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584625,0.064413,-3.40853e-05,-3.6441e-09,6.51502e-12,25203.8,31.8141], Tmin=(100,'K'), Tmax=(1011.53,'K')), NASAPolynomial(coeffs=[15.8276,0.0260768,-9.77292e-06,1.77622e-09,-1.24497e-13,20997.6,-47.4476], Tmin=(1011.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(C=CC(C)2OJ)"""),
)

species(
    label = 'C=C(CO)C1([O])[CH]C1(29768)',
    structure = SMILES('C=C(CO)C1([O])[CH]C1'),
    E0 = (161.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870402,0.0554821,-8.19054e-06,-3.11836e-08,1.64948e-11,19519.9,32.8811], Tmin=(100,'K'), Tmax=(980.044,'K')), NASAPolynomial(coeffs=[15.9556,0.0249414,-8.93787e-06,1.63016e-09,-1.16493e-13,15072.9,-47.1947], Tmin=(980.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH]C(=CO)C1(O)CC1(29769)',
    structure = SMILES('[CH]C(=CO)C1(O)CC1'),
    E0 = (47.2845,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.131075,0.0673514,9.467e-06,-8.11338e-08,4.23942e-11,5857.67,29.9805], Tmin=(100,'K'), Tmax=(914.192,'K')), NASAPolynomial(coeffs=[26.8583,0.0111642,8.79564e-08,-2.24727e-10,1.2924e-14,-1663.81,-111.954], Tmin=(914.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.2845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'O[CH][C]1COC12CC2(29770)',
    structure = SMILES('O[CH][C]1COC12CC2'),
    E0 = (140.23,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.684972,0.0668447,-4.89228e-05,1.87221e-08,-2.94303e-12,16989.9,25.3349], Tmin=(100,'K'), Tmax=(1477.7,'K')), NASAPolynomial(coeffs=[14.0121,0.0307694,-1.23031e-05,2.20107e-09,-1.4797e-13,13051.2,-44.1649], Tmin=(1477.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + radical(CCJ(C)CO) + radical(CCsJOH)"""),
)
...
species(
    label = 'C[C]([CH]O)C1([O])[CH]C1(29771)',
    structure = SMILES('C[C]([CH]O)C1([O])[CH]C1'),
    E0 = (373.099,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.29282,0.07015,-4.24789e-05,-3.14652e-10,6.59896e-12,45017,31.8031], Tmin=(100,'K'), Tmax=(990.794,'K')), NASAPolynomial(coeffs=[17.8961,0.023372,-8.43234e-06,1.5195e-09,-1.06998e-13,40336.5,-58.9762], Tmin=(990.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ) + radical(CCJ(C)CO) + radical(CCsJOH)"""),
)

species(
    label = 'C=[C]C(O)C1([O])CC1(15837)',
    structure = SMILES('C=[C]C(O)C1([O])CC1'),
    E0 = (202.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.334808,0.0680415,-3.61262e-05,-7.15914e-09,8.93032e-12,24439.4,31.2035], Tmin=(100,'K'), Tmax=(996.148,'K')), NASAPolynomial(coeffs=[18.4536,0.0224109,-8.25975e-06,1.52611e-09,-1.09493e-13,19483.8,-62.8941], Tmin=(996.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(CC(C)2OJ)"""),
)
...
species(
    label = 'C=[C]C1([O])CC1(11838)',
    structure = SMILES('C=[C]C1([O])CC1'),
    E0 = (391.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06404,0.0303982,2.08964e-05,-4.92162e-08,2.10605e-11,47154.3,22.0629], Tmin=(100,'K'), Tmax=(969.838,'K')), NASAPolynomial(coeffs=[12.2134,0.0182942,-6.4048e-06,1.18598e-09,-8.67912e-14,43786.2,-33.8054], Tmin=(969.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(C=CC(C)2OJ)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(4.8958e+11,'s^-1'), n=-0.055489, Ea=(140.78,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_D;doublebond_intra_HNd;radadd_intra_O]
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC(=O)C([CH2])=CO(27776)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(93.3079,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_De;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 89.8 to 93.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C]1CC1(9172)', 'C=C=CO(12571)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['[CH2]C(=CO)C1(O)[CH]C1(29754)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['CC(=[C]O)C1([O])CC1(29755)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC(=CO)C1([O])[CH]C1(29756)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=[C]O)C1(O)CC1(29757)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['CC(=C[O])C1([O])CC1(15773)'],
...
reaction(
    label = 'reaction12',
    reactants = ['OH(D)(132)', '[CH]C(=C)C1([O])CC1(18119)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C(=CO)C1([O])[CH]C1(29758)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C(=[C]O)C1([O])CC1(29759)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['[O]C1(CC1)[C]1CC1O(29760)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['[CH2][C]1C(O)OC12CC2(29761)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C](CO)C1([O])[CH]C1(29762)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C(=C)C1(CC1)OO(29763)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(T)(63)', '[CH2]C(=CO)[C]1CC1(29764)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(28)', '[O]C1([C]=CO)CC1(29765)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C(=CO)C1([O])CC1(29766)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=C(C[O])C1([O])CC1(12378)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C(CO)C1([O])CC1(29767)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C=C(CO)C1([O])[CH]C1(29768)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['[CH]C(=CO)C1(O)CC1(29769)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(=CO)C1([O])CC1(15787)'],
    products = ['O[CH][C]1COC12CC2(29770)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C[C]([CH]O)C1([O])[CH]C1(29771)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]C(O)C1([O])CC1(15837)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]O(5471)', 'C=[C]C1([O])CC1(11838)'],
    products = ['[CH2]C(=CO)C1([O])CC1(15787)'],
