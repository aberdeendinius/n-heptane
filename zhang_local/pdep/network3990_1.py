...
species(
    label = '[CH2]OC(=O)[CH][C]=C(19762)',
    structure = SMILES('[CH2]OC(=O)[CH][C]=C'),
    E0 = (215.291,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23052,0.0555727,-3.98112e-05,1.26353e-08,-1.55799e-12,25997.4,22.9277], Tmin=(100,'K'), Tmax=(1893.41,'K')), NASAPolynomial(coeffs=[19.6878,0.0165806,-8.92141e-06,1.75921e-09,-1.21973e-13,19007.8,-77.9013], Tmin=(1893.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(CsJOC(O)C) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C=C([O])C[O](19763)',
    structure = SMILES('C=[C]C=C([O])C[O]'),
    E0 = (252.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,3010,987.5,1337.5,450,1655,180,180,180,3022.18],'cm^-1')),
        HinderedRotor(inertia=(0.648825,'amu*angstrom^2'), symmetry=1, barrier=(14.9178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.15296,'amu*angstrom^2'), symmetry=1, barrier=(72.4928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14161,0.0655189,-8.49555e-05,6.3038e-08,-1.8889e-11,30494,25.8335], Tmin=(100,'K'), Tmax=(855.204,'K')), NASAPolynomial(coeffs=[9.31478,0.0251089,-1.02503e-05,1.8187e-09,-1.20688e-13,29175.9,-11.8524], Tmin=(855.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(CCOJ) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.20786,0.090578,-0.00010211,5.19343e-08,-9.29133e-12,36718.6,31.739], Tmin=(100,'K'), Tmax=(1731.99,'K')), NASAPolynomial(coeffs=[22.5595,-0.00125678,7.41944e-06,-1.77076e-09,1.27129e-13,33334.1,-86.3565], Tmin=(1731.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.819079,0.0746632,-7.48495e-05,3.6134e-08,-6.33222e-12,35952,27.544], Tmin=(100,'K'), Tmax=(1719.84,'K')), NASAPolynomial(coeffs=[18.5186,0.00848057,1.36958e-06,-5.80825e-10,4.69448e-14,32436.9,-67.1162], Tmin=(1719.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(CCsJO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    E0 = (359.77,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,3150,900,1100,180,1049.57,1049.57,1049.57,1049.57,1049.57,1049.57,1049.57,1049.57,1049.57,1049.57,1049.57,2264.32],'cm^-1')),
        HinderedRotor(inertia=(0.075324,'amu*angstrom^2'), symmetry=1, barrier=(1.73185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.075324,'amu*angstrom^2'), symmetry=1, barrier=(1.73185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.075324,'amu*angstrom^2'), symmetry=1, barrier=(1.73185,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    label = 'C=[C]C1CO[C]1[O](19767)',
    structure = SMILES('C=[C]C1CO[C]1[O]'),
    E0 = (444.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97364,0.0402956,-1.28511e-05,-1.21191e-08,8.70205e-12,53537.1,24.6483], Tmin=(100,'K'), Tmax=(873.526,'K')), NASAPolynomial(coeffs=[8.43855,0.0239432,-7.5259e-06,1.18303e-09,-7.51129e-14,51902.1,-8.56082], Tmin=(873.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_S) + radical(Cs_P) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][C][CH]C(=O)O[CH2](19768)',
    structure = SMILES('[CH2][C][CH]C(=O)O[CH2]'),
    E0 = (579.931,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45235,0.0609085,-6.68224e-05,4.22583e-08,-1.13756e-11,69837.2,29.2997], Tmin=(100,'K'), Tmax=(880.31,'K')), NASAPolynomial(coeffs=[8.15896,0.0304358,-1.49005e-05,2.93887e-09,-2.09687e-13,68656.4,-2.20105], Tmin=(880.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(579.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(CCJ2_triplet) + radical(RCCJ) + radical(CsJOC(O)C)"""),
)
...
species(
    label = '[CH2][C]C=C([O])C[O](19769)',
    structure = SMILES('[CH2][C]C=C([O])C[O]'),
    E0 = (596.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,263.122,267.651,270.66,1354.81,1356],'cm^-1')),
        HinderedRotor(inertia=(0.00295593,'amu*angstrom^2'), symmetry=1, barrier=(0.151411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115668,'amu*angstrom^2'), symmetry=1, barrier=(5.79206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115073,'amu*angstrom^2'), symmetry=1, barrier=(5.72706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23721,0.0653669,-8.98981e-05,7.31538e-08,-2.43517e-11,71865.1,30.3614], Tmin=(100,'K'), Tmax=(803.134,'K')), NASAPolynomial(coeffs=[7.66353,0.0288357,-1.3218e-05,2.48776e-09,-1.70989e-13,70978.8,1.67552], Tmin=(803.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(RCCJ) + radical(CCOJ) + radical(CCJ2_triplet) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2][C]=[C]C1([O])CO1(19770)',
    structure = SMILES('[CH2][C]=[C]C1([O])CO1'),
    E0 = (611.473,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,1670,1700,300,440,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0996285,0.0721175,-8.79705e-05,5.17733e-08,-1.10354e-11,73695.5,26.5286], Tmin=(100,'K'), Tmax=(1398.4,'K')), NASAPolynomial(coeffs=[16.7856,0.00592658,2.83306e-06,-9.57095e-10,7.93802e-14,70834,-53.1125], Tmin=(1398.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(611.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(C=CC(C)(O)OJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C#CC1([O])CO1(19771)',
    structure = SMILES('[CH2]C#CC1([O])CO1'),
    E0 = (299.436,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2100,2250,500,550,3000,3100,440,815,1455,1000,305.57,976.212,976.212,976.212,976.212,976.212,976.212,976.212,976.212,976.212,2332.5],'cm^-1')),
    ...
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407461,0.0597954,-5.98237e-05,3.0783e-08,-5.80754e-12,36159.7,24.8913], Tmin=(100,'K'), Tmax=(1599.73,'K')), NASAPolynomial(coeffs=[13.2284,0.0118152,9.51609e-08,-4.0924e-10,3.94085e-14,34095.1,-36.6183], Tmin=(1599.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + ring(Ethylene_oxide) + radical(Propargyl) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C=[C]C1([O])CO1(19772)',
    structure = SMILES('[CH2]C=[C]C1([O])CO1'),
    E0 = (373.631,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294488,0.0723875,-7.94835e-05,4.26833e-08,-8.28514e-12,45111.1,27.4806], Tmin=(100,'K'), Tmax=(1556.02,'K')), NASAPolynomial(coeffs=[16.8967,0.00775255,2.53079e-06,-8.98179e-10,7.34427e-14,42235.9,-55.1055], Tmin=(1556.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=[C]C1(O)CO1(19773)',
    structure = SMILES('[CH2][C]=[C]C1(O)CO1'),
    E0 = (378.427,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1670,1700,300,440,3615,1277.5,1000,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01926,0.0798681,-8.97855e-05,4.72202e-08,-8.85387e-12,45721.3,29.6875], Tmin=(100,'K'), Tmax=(1627.5,'K')), NASAPolynomial(coeffs=[19.7902,0.00291032,4.93424e-06,-1.32488e-09,1.00127e-13,42366.5,-70.3386], Tmin=(1627.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=[C]C1([O])CO1(19774)',
    structure = SMILES('C[C]=[C]C1([O])CO1'),
    E0 = (459.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.313183,0.072074,-8.75487e-05,5.33642e-08,-1.19798e-11,55462.7,25.4837], Tmin=(100,'K'), Tmax=(1306.52,'K')), NASAPolynomial(coeffs=[15.2986,0.010836,3.91615e-07,-5.06039e-10,4.98603e-14,52857.9,-45.8019], Tmin=(1306.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(C=CC(C)(O)OJ) + radical(Cds_S)"""),
)

species(
    label = 'C[C]=CC1([O])[CH]O1(19775)',
    structure = SMILES('C[C]=CC1([O])[CH]O1'),
    E0 = (405.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,1000,180,180,180,180,688.357,1531.2,1600,1800,3000,3200],'cm^-1')),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.259542,0.0757962,-8.86068e-05,4.99851e-08,-1.02053e-11,48981.9,27.2689], Tmin=(100,'K'), Tmax=(1463.58,'K')), NASAPolynomial(coeffs=[17.9697,0.00618225,3.02508e-06,-9.9373e-10,8.09759e-14,45765.8,-60.3776], Tmin=(1463.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(Cds_S) + radical(C=CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)[CH][C]=C(19762)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(136.59,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    ...
    products = ['C=[C][CH]C1([O])CO1(17996)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(71.4418,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-NdNd_O;YJ] for rate rule [CO-NdNd_O;Y_1centerbirad]
...
reaction(
    label = 'reaction6',
    reactants = ['O(T)(63)', 'C=[C]C=C1CO1(19489)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C=[C][CH]C1([O])CO1(17996)'],
    products = ['C=[C][CH]C1(O)[CH]O1(19764)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=[C]CC1([O])[CH]O1(17995)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C][CH]C1([O])CO1(17996)'],
    products = ['C=C[CH]C1([O])[CH]O1(19765)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH][C]=CC1(O)CO1(19714)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C=[C][CH]C1([O])[CH]O1(19766)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(S)(14)', 'C=[C]C=C([O])[O](17934)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(S)(1732)', '[CH2][C]=CC(=C)[O](17897)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=[C]C1CO[C]1[O](19767)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C][CH]C(=O)O[CH2](19768)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C]C=C([O])C[O](19769)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(T)(63)', 'C=[C][CH][C]1CO1(19479)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][C]=[C]C1([O])CO1(19770)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2]C#CC1([O])CO1(19771)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C=[C]C1([O])CO1(19772)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]=[C]C1(O)CO1(19773)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C[C]=[C]C1([O])CO1(19774)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[C]=CC1([O])[CH]O1(19775)'],
    products = ['C=[C][CH]C1([O])CO1(17996)'],
