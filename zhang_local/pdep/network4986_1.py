...
species(
    label = 'CC=CC[C]=CO(27887)',
    structure = SMILES('CC=CC[C]=CO'),
    E0 = (81.7733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.737129,'amu*angstrom^2'), symmetry=1, barrier=(16.948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.737914,'amu*angstrom^2'), symmetry=1, barrier=(16.9661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.736712,'amu*angstrom^2'), symmetry=1, barrier=(16.9385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.73713,'amu*angstrom^2'), symmetry=1, barrier=(16.9481,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.494643,0.0643188,-2.72399e-05,-1.83386e-08,1.39924e-11,9972.87,27.5435], Tmin=(100,'K'), Tmax=(951.351,'K')), NASAPolynomial(coeffs=[18.3554,0.0201094,-6.23451e-06,1.06861e-09,-7.55435e-14,5176.75,-65.0799], Tmin=(951.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.7733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]CC=C=CO(27888)',
    structure = SMILES('C[CH]CC=C=CO'),
    E0 = (85.9303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,540,610,2055,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,256.608,256.608],'cm^-1')),
        HinderedRotor(inertia=(0.331241,'amu*angstrom^2'), symmetry=1, barrier=(15.4779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331241,'amu*angstrom^2'), symmetry=1, barrier=(15.4779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331241,'amu*angstrom^2'), symmetry=1, barrier=(15.4779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331241,'amu*angstrom^2'), symmetry=1, barrier=(15.4779,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.492083,0.067066,-3.96387e-05,-2.06076e-09,7.48702e-12,10470.4,28.3669], Tmin=(100,'K'), Tmax=(957.361,'K')), NASAPolynomial(coeffs=[16.6332,0.0231339,-7.6382e-06,1.30403e-09,-8.93907e-14,6302.55,-54.4278], Tmin=(957.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.9303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CCC#CO(27889)',
    structure = SMILES('C[CH]CCC#CO'),
    E0 = (155.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2100,2250,500,550,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41077,0.0597137,-4.60145e-05,2.21922e-08,-4.90248e-12,18733.3,27.7846], Tmin=(100,'K'), Tmax=(1016.6,'K')), NASAPolynomial(coeffs=[6.41585,0.0400198,-1.69552e-05,3.1352e-09,-2.15907e-13,17715.7,3.55569], Tmin=(1016.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CtH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(RCCJC)"""),
)
...
species(
    label = 'C#CCC[CH]C(17571)',
    structure = SMILES('C#CCC[CH]C'),
    E0 = (296.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,269.981,2397.56],'cm^-1')),
        HinderedRotor(inertia=(1.41995,'amu*angstrom^2'), symmetry=1, barrier=(73.4462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00281329,'amu*angstrom^2'), symmetry=1, barrier=(11.4757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221864,'amu*angstrom^2'), symmetry=1, barrier=(11.4757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41996,'amu*angstrom^2'), symmetry=1, barrier=(73.4462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCC[C]=CO(27890)',
    structure = SMILES('[CH2]CCC[C]=CO'),
    E0 = (170.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160334,0.0729287,-4.38535e-05,-2.35247e-09,8.34766e-12,20620.5,30.467], Tmin=(100,'K'), Tmax=(961.567,'K')), NASAPolynomial(coeffs=[18.5429,0.0230798,-7.61785e-06,1.31557e-09,-9.13575e-14,15854.7,-63.897], Tmin=(961.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = 'CCC[CH][C]=CO(27891)',
    structure = SMILES('CCC[CH][C]=CO'),
    E0 = (106.08,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.326162,0.0669111,-2.42326e-05,-2.33834e-08,1.58868e-11,12903.3,26.9788], Tmin=(100,'K'), Tmax=(956.008,'K')), NASAPolynomial(coeffs=[18.8161,0.0228488,-7.34754e-06,1.27806e-09,-9.04746e-14,7846.2,-69.3516], Tmin=(956.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CCCC[C]=[C]O(27892)',
    structure = SMILES('CCCC[C]=[C]O'),
    E0 = (204.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH]C[C]=CO(27893)',
    structure = SMILES('C[CH][CH]C[C]=CO'),
    E0 = (353.871,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.80751,0.0700842,-6.67514e-05,3.67101e-08,-8.39414e-12,42676,31.6612], Tmin=(100,'K'), Tmax=(1044.51,'K')), NASAPolynomial(coeffs=[10.6157,0.0325232,-1.28107e-05,2.28204e-09,-1.53886e-13,40627,-16.0849], Tmin=(1044.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(Cds_S) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH][C]=CO(27894)',
    structure = SMILES('C[CH]C[CH][C]=CO'),
    E0 = (300.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548106,0.0668509,-4.27899e-05,4.14026e-09,4.51583e-12,36277.3,28.9174], Tmin=(100,'K'), Tmax=(975.727,'K')), NASAPolynomial(coeffs=[15.5531,0.0250066,-8.69919e-06,1.5073e-09,-1.02927e-13,32412.8,-47.9021], Tmin=(975.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(Cds_S) + radical(Allyl_S)"""),
)
...
species(
    label = 'C[CH]CC[C]=[C]O(27895)',
    structure = SMILES('C[CH]CC[C]=[C]O'),
    E0 = (399.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1670,1700,300,440,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785944,0.0710931,-6.86999e-05,3.80438e-08,-8.75213e-12,48123,32.3044], Tmin=(100,'K'), Tmax=(1037.97,'K')), NASAPolynomial(coeffs=[10.7561,0.0326702,-1.31723e-05,2.37852e-09,-1.6174e-13,46053.3,-16.1672], Tmin=(1037.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = 'CCCC=C=CO(27896)',
    structure = SMILES('CCCC=C=CO'),
    E0 = (-108.516,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.262274,0.0672185,-2.13987e-05,-2.9188e-08,1.86986e-11,-12903.2,26.4564], Tmin=(100,'K'), Tmax=(947.641,'K')), NASAPolynomial(coeffs=[19.9392,0.0209034,-6.24482e-06,1.06497e-09,-7.61257e-14,-18282.3,-76.1196], Tmin=(947.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-108.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'C[C]CC[C]=CO(27897)',
    structure = SMILES('C[C]CC[C]=CO'),
    E0 = (413.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0786671,0.0751555,-5.25814e-05,4.63425e-09,6.5944e-12,49845.6,28.8792], Tmin=(100,'K'), Tmax=(951.586,'K')), NASAPolynomial(coeffs=[19.5876,0.0193943,-6.05419e-06,1.02112e-09,-7.07911e-14,44944.4,-70.5155], Tmin=(951.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC=CC[C]=CO(27887)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C[CH]CC=C=CO(27888)'],
    products = ['C[CH]CC[C]=CO(13155)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=CCC[C]=CO(27750)'],
    products = ['C[CH]CC[C]=CO(13155)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C[CH]CCC#CO(27889)'],
    products = ['C[CH]CC[C]=CO(13155)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', 'C#CCC[CH]C(17571)'],
    products = ['C[CH]CC[C]=CO(13155)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction19',
    reactants = ['OH(D)(132)', '[CH]=[C]CC[CH]C(17576)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'C[CH][CH]C[C]=CO(27893)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', 'C[CH]C[CH][C]=CO(27894)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][CH]CC[C]=CO(14172)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'C[CH]CC[C]=[C]O(27895)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C(32)', '[CH2]C[C]=CO(27737)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C[CH]C(38)', '[C]=CO(27807)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH3](11)', '[CH]CC[C]=CO(27808)'],
    products = ['C[CH]CC[C]=CO(13155)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', 'C[C]CC[C]=CO(27897)'],
    products = ['C[CH]CC[C]=CO(13155)'],
