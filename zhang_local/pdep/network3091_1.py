species(
    ...
    E0 = (53.4444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]CC(=O)C[CH]O(11924)',
    structure = SMILES('[CH2]CC(=O)C[CH]O'),
    E0 = (-51.5513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3615,1277.5,1000,375,552.5,462.5,1710,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177317,0.0957017,-0.000159927,1.46165e-07,-5.12612e-11,-6073.68,28.9198], Tmin=(100,'K'), Tmax=(864.552,'K')), NASAPolynomial(coeffs=[6.84718,0.0395847,-1.87412e-05,3.50361e-09,-2.36588e-13,-6283.02,3.17143], Tmin=(864.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.5513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O) + radical(CCsJOH)"""),
)
...
species(
    label = '[O]C1(CC=O)CC1(11505)',
    structure = SMILES('[O]C1(CC=O)CC1'),
    E0 = (-49.8254,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18231,0.0529458,-2.58529e-05,-2.84017e-09,4.36474e-12,-5883.47,23.7374], Tmin=(100,'K'), Tmax=(1070.77,'K')), NASAPolynomial(coeffs=[13.1321,0.0249855,-1.00506e-05,1.86886e-09,-1.31231e-13,-9398.8,-39.1958], Tmin=(1070.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.8254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CC(C)2OJ)"""),
)

species(
    label = '[O]C1(C=CO)CC1(11925)',
    structure = SMILES('[O]C1(C=CO)CC1'),
    E0 = (-55.2422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05267,0.0416376,4.09545e-05,-9.94585e-08,4.59912e-11,-6516.48,25.0791], Tmin=(100,'K'), Tmax=(922.488,'K')), NASAPolynomial(coeffs=[23.154,0.00585081,1.50698e-06,-3.8899e-10,2.01794e-14,-13149.1,-93.6119], Tmin=(922.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.2422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[O]CCC1([O])CC1(11926)',
    structure = SMILES('[O]CCC1([O])CC1'),
    E0 = (98.8517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04768,0.058536,-3.93961e-05,1.33666e-08,-1.8466e-12,12000.5,25.7631], Tmin=(100,'K'), Tmax=(1662.48,'K')), NASAPolynomial(coeffs=[14.1586,0.0269905,-1.09337e-05,1.95297e-09,-1.30247e-13,7641.14,-44.1541], Tmin=(1662.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.8517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCOJ) + radical(CC(C)2OJ)"""),
)

species(
    label = '[O]C1([CH]CO)CC1(11927)',
    structure = SMILES('[O]C1([CH]CO)CC1'),
    E0 = (73.0486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938549,0.055621,-1.81873e-05,-1.95101e-08,1.23939e-11,8906.4,27.7764], Tmin=(100,'K'), Tmax=(978.947,'K')), NASAPolynomial(coeffs=[15.7387,0.021987,-7.77702e-06,1.40719e-09,-1.00143e-13,4722.59,-49.8797], Tmin=(978.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.0486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = 'O[CH]CC1(O)[CH]C1(11928)',
    structure = SMILES('O[CH]CC1(O)[CH]C1'),
    E0 = (24.4305,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500709,0.0677539,-4.95462e-05,8.23083e-09,4.06331e-12,3072.62,28.8356], Tmin=(100,'K'), Tmax=(958.223,'K')), NASAPolynomial(coeffs=[17.2901,0.0188274,-6.07907e-06,1.03352e-09,-7.11214e-14,-1116.37,-56.5156], Tmin=(958.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = 'O[CH][CH]C1(O)CC1(11929)',
    structure = SMILES('O[CH][CH]C1(O)CC1'),
    E0 = (24.4305,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500709,0.0677539,-4.95462e-05,8.23083e-09,4.06331e-12,3072.62,28.8356], Tmin=(100,'K'), Tmax=(958.223,'K')), NASAPolynomial(coeffs=[17.2901,0.0188274,-6.07907e-06,1.03352e-09,-7.11214e-14,-1116.37,-56.5156], Tmin=(958.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = '[O]C1([CH]C1)CCO(11930)',
    structure = SMILES('[O]C1([CH]C1)CCO'),
    E0 = (73.0486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.880782,0.0676635,-6.11913e-05,3.01244e-08,-6.10949e-12,6154.79,25.8385], Tmin=(100,'K'), Tmax=(1169.53,'K')), NASAPolynomial(coeffs=[12.0166,0.0295769,-1.23424e-05,2.27901e-09,-1.57202e-13,3550.06,-29.6292], Tmin=(1169.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.2336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C1([CH]C1)C[CH]O(11932)',
    structure = SMILES('[O]C1([CH]C1)C[CH]O'),
    E0 = (253.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695314,0.0640509,-4.8295e-05,1.13259e-08,1.84318e-12,30597.2,28.1987], Tmin=(100,'K'), Tmax=(992.488,'K')), NASAPolynomial(coeffs=[16.205,0.0190532,-6.75204e-06,1.19749e-09,-8.33186e-14,26656.1,-50.8543], Tmin=(992.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = '[O]C1([CH][CH]O)CC1(11933)',
    structure = SMILES('[O]C1([CH][CH]O)CC1'),
    E0 = (253.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695314,0.0640509,-4.8295e-05,1.13259e-08,1.84318e-12,30597.2,28.1987], Tmin=(100,'K'), Tmax=(992.488,'K')), NASAPolynomial(coeffs=[16.205,0.0190532,-6.75204e-06,1.19749e-09,-8.33186e-14,26656.1,-50.8543], Tmin=(992.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCsJOH) + radical(CC(C)2OJ)"""),
)
...
species(
    label = 'OC=CC1(O)CC1(11934)',
    structure = SMILES('OC=CC1(O)CC1'),
    E0 = (-284.345,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.684353,0.0477593,3.84587e-05,-1.06105e-07,5.08973e-11,-34055.9,25.1882], Tmin=(100,'K'), Tmax=(910.826,'K')), NASAPolynomial(coeffs=[26.2028,0.00212102,4.2192e-06,-9.7059e-10,6.22223e-14,-41459.9,-110.666], Tmin=(910.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-284.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane)"""),
)

species(
    label = 'O=CCC1(O)CC1(11935)',
    structure = SMILES('O=CCC1(O)CC1'),
    E0 = (-278.741,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983536,0.0567334,-2.75806e-05,-5.03246e-09,6.06476e-12,-33407.9,24.3871], Tmin=(100,'K'), Tmax=(1022.84,'K')), NASAPolynomial(coeffs=[14.053,0.0250207,-9.52058e-06,1.7374e-09,-1.21652e-13,-37096.2,-43.9209], Tmin=(1022.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-278.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane)"""),
)

species(
    label = '[CH2]C(O)C1([O])CC1(10651)',
    structure = SMILES('[CH2]C(O)C1([O])CC1'),
    E0 = (72.0927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4376.09,'J/mol'), sigma=(7.39232,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=683.54 K, Pc=24.58 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.590001,0.0638394,-3.56169e-05,-5.52312e-09,8.40252e-12,8803.51,26.8195], Tmin=(100,'K'), Tmax=(975.509,'K')), NASAPolynomial(coeffs=[17.3799,0.0200865,-6.92438e-06,1.23712e-09,-8.76791e-14,4333.82,-59.8854], Tmin=(975.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.0927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CJCO)"""),
)
...
species(
    label = '[O]C1(C[C]O)CC1(11938)',
    structure = SMILES('[O]C1(C[C]O)CC1'),
    E0 = (334.135,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.531684,0.0667616,-5.18074e-05,1.28496e-08,1.57216e-12,40320.4,25.4728], Tmin=(100,'K'), Tmax=(1006.72,'K')), NASAPolynomial(coeffs=[17.5331,0.0177878,-6.51799e-06,1.18912e-09,-8.43243e-14,35955.8,-61.3389], Tmin=(1006.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C[CH]O(11924)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]C1(CC=O)CC1(11505)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(C=CO)CC1(11925)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CO(576)', '[O][C]1CC1(9172)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C1([CH]CO)CC1(11927)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C1(C[CH]O)CC1(10678)'],
    products = ['O[CH]CC1(O)[CH]C1(11928)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C1(C[CH]O)CC1(10678)'],
    products = ['O[CH][CH]C1(O)CC1(11929)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C1([CH]C1)CCO(11930)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[O][CH]CC1([O])CC1(10949)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[O]C1([CH]C1)C[CH]O(11932)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[O]C1([CH][CH]O)CC1(11933)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(O)C1([O])CC1(10651)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction24',
    reactants = ['OH(D)(132)', '[CH]CC1([O])CC1(11628)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', 'O[CH]C[C]1CC1(11937)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]O(5471)', '[CH2]C1([O])CC1(4307)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[O]C1(C[C]O)CC1(11938)'],
    products = ['[O]C1(C[CH]O)CC1(10678)'],
