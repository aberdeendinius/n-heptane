...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.399226,0.0735487,-6.80978e-05,3.37714e-08,-6.72454e-12,43994.2,32.1746], Tmin=(100,'K'), Tmax=(1213.5,'K')), NASAPolynomial(coeffs=[14.7406,0.0262757,-9.6636e-06,1.669e-09,-1.10908e-13,40513.6,-39.7894], Tmin=(1213.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]CC[CH][C]=CO(28534)',
    structure = SMILES('[CH2]CC[CH][C]=CO'),
    E0 = (311.326,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366885,0.0676038,-3.4544e-05,-1.13053e-08,1.15202e-11,37585.8,28.6192], Tmin=(100,'K'), Tmax=(956.245,'K')), NASAPolynomial(coeffs=[18.5822,0.0206008,-6.60552e-06,1.14163e-09,-8.03742e-14,32767.5,-65.423], Tmin=(956.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(Cds_S) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH2]CCC[C]=[C]O(28535)',
    structure = SMILES('[CH2]CCC[C]=[C]O'),
    E0 = (409.957,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.388495,0.0744436,-6.97058e-05,3.47319e-08,-6.9475e-12,49440.7,32.7779], Tmin=(100,'K'), Tmax=(1206.93,'K')), NASAPolynomial(coeffs=[14.8785,0.0264208,-1.00215e-05,1.76415e-09,-1.18622e-13,45943.1,-39.853], Tmin=(1206.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(RCCJ) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH][CH]C[C]=CO(28536)',
    structure = SMILES('[CH2][CH][CH]C[C]=CO'),
    E0 = (559.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848662,0.0707375,-7.67804e-05,4.82544e-08,-1.24765e-11,67358.6,33.3024], Tmin=(100,'K'), Tmax=(934.155,'K')), NASAPolynomial(coeffs=[10.2383,0.0305324,-1.22227e-05,2.18303e-09,-1.46956e-13,65604.3,-11.3575], Tmin=(934.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(559.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(RCCJC) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]C[CH][C]=CO(28537)',
    structure = SMILES('[CH2][CH]C[CH][C]=CO'),
    E0 = (505.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.582878,0.0676146,-5.3352e-05,1.65437e-08,1.15145e-14,60960.1,30.5791], Tmin=(100,'K'), Tmax=(984.204,'K')), NASAPolynomial(coeffs=[15.3461,0.0227129,-7.93085e-06,1.36466e-09,-9.23115e-14,57322.7,-44.1253], Tmin=(984.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_S) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CC[C]=[C]O(28538)',
    structure = SMILES('[CH2][CH]CC[C]=[C]O'),
    E0 = (604.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1670,1700,300,440,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.820288,0.0718234,-7.89838e-05,4.99017e-08,-1.29627e-11,72805.8,33.9703], Tmin=(100,'K'), Tmax=(929.56,'K')), NASAPolynomial(coeffs=[10.3829,0.0306742,-1.25823e-05,2.27919e-09,-1.54794e-13,71028,-11.4651], Tmin=(929.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(604.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.303789,0.0679014,-3.16737e-05,-1.71604e-08,1.43549e-11,11779.3,28.094], Tmin=(100,'K'), Tmax=(946.667,'K')), NASAPolynomial(coeffs=[19.7031,0.0186594,-5.50511e-06,9.29084e-10,-6.60714e-14,6639.88,-72.1784], Tmin=(946.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.7304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.367351,0.0814838,-8.2112e-05,4.09354e-08,-7.80436e-12,74549.4,32.2726], Tmin=(100,'K'), Tmax=(1395.01,'K')), NASAPolynomial(coeffs=[21.0486,0.0143227,-3.70934e-06,5.10646e-10,-2.99586e-14,69134.2,-76.1696], Tmin=(1395.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(618.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CCJ2_triplet) + radical(RCCJ)"""),
)

species(
    label = '[CH][CH]CC[C]=CO(28541)',
    structure = SMILES('[CH][CH]CC[C]=CO'),
    E0 = (607.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.131445,0.0770758,-7.79704e-05,4.08325e-08,-8.37984e-12,73226.9,32.5239], Tmin=(100,'K'), Tmax=(1196.01,'K')), NASAPolynomial(coeffs=[17.1367,0.0202016,-6.63945e-06,1.07147e-09,-6.85377e-14,69159.2,-52.5604], Tmin=(1196.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(607.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C=CC[C]=CO(28531)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2][CH]CC=C=CO(22825)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2][CH]CCC#CO(28532)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C#CCC[CH][CH2](17734)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C[CH]C[C]=CO(28533)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]CC[C]=CO(14172)'],
    products = ['[CH2][CH][CH]CC=CO(14176)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OH(D)(132)', '[CH]=[C]CC[CH][CH2](17740)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2][CH][CH]C[C]=CO(28536)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][CH]C[CH][C]=CO(28537)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2][CH]CC[C]=[C]O(28538)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH][CH2](721)', '[CH2]C[C]=CO(27737)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][CH]C[CH2](103)', '[C]=CO(27807)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH2][C]CC[C]=CO(28540)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH][CH]CC[C]=CO(28541)'],
    products = ['[CH2][CH]CC[C]=CO(14172)'],
