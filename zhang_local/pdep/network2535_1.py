...
species(
    label = '[CH2]OC(=C)C([CH2])[CH2](9921)',
    structure = SMILES('[CH2]OC(=C)C([CH2])[CH2]'),
    E0 = (358.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.609173,0.0644716,-3.19036e-05,-1.25204e-08,1.24527e-11,43191.8,31.2972], Tmin=(100,'K'), Tmax=(914.087,'K')), NASAPolynomial(coeffs=[16.5513,0.0217071,-6.02982e-06,9.19813e-10,-6.00432e-14,39149.4,-50.3516], Tmin=(914.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.352498,0.0736869,-6.53597e-05,3.21225e-08,-5.94874e-12,43587,29.665], Tmin=(100,'K'), Tmax=(1611.58,'K')), NASAPolynomial(coeffs=[13.1923,0.0235224,-3.26814e-06,6.61927e-11,1.23415e-14,41369.9,-35.4784], Tmin=(1611.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C1(C)[CH]O1(9925)',
    structure = SMILES('[CH2]C([CH2])C1(C)[CH]O1'),
    E0 = (392.091,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.739476,0.0830627,-8.37892e-05,4.44346e-08,-8.72232e-12,47346.5,31.0493], Tmin=(100,'K'), Tmax=(1519.86,'K')), NASAPolynomial(coeffs=[16.3026,0.0186458,-9.045e-07,-3.91483e-10,4.42586e-14,44426,-50.8687], Tmin=(1519.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(Isobutyl) + radical(CCsJO)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867888,0.054065,1.01946e-05,-6.58065e-08,3.51199e-11,7807.45,22.5074], Tmin=(100,'K'), Tmax=(871.631,'K')), NASAPolynomial(coeffs=[18.1503,0.0178277,-1.57011e-06,-1.13097e-10,1.65354e-14,3158.43,-67.8821], Tmin=(871.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.8592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C([CH2])[C]1CCO1(9929)',
    structure = SMILES('[CH2]C([CH2])[C]1CCO1'),
    E0 = (401.524,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624989,0.0653082,-5.64149e-05,2.98756e-08,-6.26947e-12,48421.3,29.191], Tmin=(100,'K'), Tmax=(1364,'K')), NASAPolynomial(coeffs=[9.71552,0.0294935,-6.96009e-06,7.82738e-10,-3.51868e-14,46793.2,-14.3652], Tmin=(1364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C1(CO1)C1CC1(9930)',
    structure = SMILES('[CH2]C1(CO1)C1CC1'),
    E0 = (171.31,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.851963,0.0538014,1.16023e-05,-6.83637e-08,3.63173e-11,20732,21.5914], Tmin=(100,'K'), Tmax=(872.905,'K')), NASAPolynomial(coeffs=[18.7549,0.0164112,-8.70133e-07,-2.41471e-10,2.49844e-14,15905.4,-72.09], Tmin=(872.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C([CH2])[CH2](9931)',
    structure = SMILES('[CH2]O[C]([CH2])C([CH2])[CH2]'),
    E0 = (661.552,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342514,0.106417,-0.000174682,1.50871e-07,-4.92504e-11,79712.5,32.8369], Tmin=(100,'K'), Tmax=(920.986,'K')), NASAPolynomial(coeffs=[9.61711,0.0356228,-1.45284e-05,2.47543e-09,-1.55844e-13,79045.9,-8.05219], Tmin=(920.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(661.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(Isobutyl) + radical(CsJOCC2) + radical(Isobutyl) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]C1(CO1)C([CH2])[CH2](9934)',
    structure = SMILES('[CH]C1(CO1)C([CH2])[CH2]'),
    E0 = (656.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,1005.86,1005.86,1005.86,1005.86,1005.86,1005.86,1005.86,1005.86,1005.86,1005.86,1005.86,2316.5],'cm^-1')),
        HinderedRotor(inertia=(0.0756679,'amu*angstrom^2'), symmetry=1, barrier=(1.73975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756679,'amu*angstrom^2'), symmetry=1, barrier=(1.73975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756679,'amu*angstrom^2'), symmetry=1, barrier=(1.73975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756679,'amu*angstrom^2'), symmetry=1, barrier=(1.73975,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.32167,0.0794631,-8.35982e-05,4.66032e-08,-9.65071e-12,79137.8,30.3455], Tmin=(100,'K'), Tmax=(1432.33,'K')), NASAPolynomial(coeffs=[15.1898,0.018498,-1.27213e-06,-3.16495e-10,4.00402e-14,76504.5,-43.7427], Tmin=(1432.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(656.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C([CH2])C1([CH2])CO1(9935)',
    structure = SMILES('[CH]C([CH2])C1([CH2])CO1'),
    E0 = (662.011,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.365017,0.0866853,-0.000101062,6.12137e-08,-1.38733e-11,79786.9,29.1657], Tmin=(100,'K'), Tmax=(1275.66,'K')), NASAPolynomial(coeffs=[16.5566,0.018033,-2.00231e-06,-1.36876e-10,2.77166e-14,76738.3,-51.6187], Tmin=(1275.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(662.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(Isobutyl) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C([CH2])[CH2](9921)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(=C)C1([CH2])CO1(9923)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', '[CH2]C1(C=C)CO1(9227)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2][C](C)C1([CH2])CO1(9391)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2][C]([CH2])C1(C)CO1(9924)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2]C([CH2])C1(C)[CH]O1(9925)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2]C(C)C1([CH2])[CH]O1(9392)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C]([CH2])C1([CH2])CO1(9926)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C([CH2])C1([CH2])[CH]O1(9927)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C([CH2])[CH2](6299)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2]C1(CO1)C(=C)C(9385)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2]C(=C)C1(C)CO1(9928)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2]C([CH2])[C]1CCO1(9929)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
    products = ['[CH2]C1(CO1)C1CC1(9930)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]O[C]([CH2])C([CH2])[CH2](9931)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])[C]1CO1(6513)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', '[CH2][CH]C1([CH2])CO1(9363)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C1(CO1)C([CH2])[CH2](9934)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([CH2])C1([CH2])CO1(9935)'],
    products = ['[CH2]C([CH2])C1([CH2])CO1(9327)'],
