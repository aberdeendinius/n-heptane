species(
    label = '[CH2][C](OO)OO[CH]C(3625)',
    structure = SMILES('[CH2][C](OO)OO[CH]C'),
    E0 = (254.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3025,407.5,1350,352.5,350,500,795,815,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,200],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0430378,0.0968869,-0.000133787,1.04137e-07,-3.33953e-11,30715.5,34.0932], Tmin=(100,'K'), Tmax=(755.991,'K')), NASAPolynomial(coeffs=[10.7683,0.0396789,-2.02693e-05,4.02373e-09,-2.86287e-13,29081,-15.0403], Tmin=(755.991,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(Cs_P) + radical(CJCOOH)"""),
)
...
species(
    ...
    E0 = (210.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,350,500,795,815,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(=O)OO[CH]C(3640)',
    structure = SMILES('[CH2]C(=O)OO[CH]C'),
    E0 = (-85.3474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936736,0.0569851,-3.0978e-05,-1.65591e-09,4.61925e-12,-10145.8,28.3064], Tmin=(100,'K'), Tmax=(1070.1,'K')), NASAPolynomial(coeffs=[15.3589,0.0223728,-9.51063e-06,1.82223e-09,-1.30415e-13,-14337.3,-47.412], Tmin=(1070.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.3474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJCO) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]COO[C]([CH2])OO(3957)',
    structure = SMILES('[CH2]COO[C]([CH2])OO'),
    E0 = (281.756,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0717195,0.0971569,-0.000130256,9.53892e-08,-2.8528e-11,34027.2,35.9014], Tmin=(100,'K'), Tmax=(810.76,'K')), NASAPolynomial(coeffs=[12.1383,0.0369154,-1.88e-05,3.7395e-09,-2.66873e-13,32047.4,-20.4433], Tmin=(810.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CJCOOH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(O[O])OO[CH]C(3958)',
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0445169,0.0944077,-0.000135551,1.12631e-07,-3.84596e-11,24309.2,33.837], Tmin=(100,'K'), Tmax=(753.448,'K')), NASAPolynomial(coeffs=[9.65031,0.0398261,-1.97498e-05,3.85259e-09,-2.70528e-13,22963.5,-9.11075], Tmin=(753.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]OO[C](C)O[O](3959)',
    structure = SMILES('C[CH]OO[C](C)O[O]'),
    E0 = (192.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143999,0.0924911,-0.00013327,1.13195e-07,-3.95828e-11,23257,32.1707], Tmin=(100,'K'), Tmax=(762.088,'K')), NASAPolynomial(coeffs=[8.69255,0.0414451,-2.06394e-05,4.03155e-09,-2.83199e-13,22133.4,-5.57164], Tmin=(762.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCsJOOC) + radical(ROOJ)"""),
)

species(
    label = '[CH2][CH]OOC([CH2])OO(3960)',
    structure = SMILES('[CH2][CH]OOC([CH2])OO'),
    E0 = (262.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1310,387.5,850,1000,350,500,795,815,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.129313,0.0986398,-0.00013545,1.02677e-07,-3.18306e-11,31767.2,35.7126], Tmin=(100,'K'), Tmax=(782.999,'K')), NASAPolynomial(coeffs=[11.7312,0.0380483,-1.93717e-05,3.84262e-09,-2.73421e-13,29909.9,-18.6058], Tmin=(782.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OO[C](C)OO(3961)',
    structure = SMILES('[CH2][CH]OO[C](C)OO'),
    E0 = (254.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3025,407.5,1350,352.5,350,500,795,815,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1310,387.5,850,1000,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0430434,0.096887,-0.000133788,1.04137e-07,-3.33955e-11,30715.5,34.0932], Tmin=(100,'K'), Tmax=(755.969,'K')), NASAPolynomial(coeffs=[10.7683,0.0396789,-2.02694e-05,4.02373e-09,-2.86287e-13,29081,-15.0403], Tmin=(755.969,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(Cs_P)"""),
)

species(
    label = '[CH2][C](O[O])OOCC(3962)',
    structure = SMILES('[CH2][C](O[O])OOCC'),
    E0 = (219.798,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346675,0.0892991,-0.000113197,7.39507e-08,-1.58017e-11,26558.8,33.1898], Tmin=(100,'K'), Tmax=(610.915,'K')), NASAPolynomial(coeffs=[9.8475,0.0391023,-1.94371e-05,3.81487e-09,-2.69674e-13,25173.8,-9.79855], Tmin=(610.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2][C]([O])OO[CH]C(3651)',
    structure = SMILES('[CH2][C]([O])OO[CH]C'),
    E0 = (408.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,350,500,795,815,3025,407.5,1350,352.5,180,1735.28],'cm^-1')),
        HinderedRotor(inertia=(0.0186253,'amu*angstrom^2'), symmetry=1, barrier=(39.7512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324637,'amu*angstrom^2'), symmetry=1, barrier=(7.46404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32412,'amu*angstrom^2'), symmetry=1, barrier=(7.45216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72954,'amu*angstrom^2'), symmetry=1, barrier=(39.7655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0186102,'amu*angstrom^2'), symmetry=1, barrier=(39.7605,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.779493,0.080054,-0.000126392,1.18111e-07,-4.40529e-11,49230.3,31.2202], Tmin=(100,'K'), Tmax=(799.6,'K')), NASAPolynomial(coeffs=[5.40471,0.0403257,-2.07414e-05,4.07583e-09,-2.85914e-13,49021,13.2571], Tmin=(799.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCOJ) + radical(Cs_P) + radical(CCsJOOC)"""),
)
...
species(
    ...
    E0 = (406.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,360,370,350,3025,407.5,1350,352.5,350,500,795,815,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.188835,0.0844741,-8.70499e-05,4.56126e-08,-9.61164e-12,793.948,32.9491], Tmin=(100,'K'), Tmax=(1139.02,'K')), NASAPolynomial(coeffs=[16.0416,0.0288023,-1.37343e-05,2.70107e-09,-1.93096e-13,-2817.38,-45.5951], Tmin=(1139.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.46443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.13071,0.0969519,-0.000158836,1.47375e-07,-5.31972e-11,2871.28,34.7194], Tmin=(100,'K'), Tmax=(839.881,'K')), NASAPolynomial(coeffs=[5.96424,0.04477,-2.20651e-05,4.22163e-09,-2.90158e-13,2751.95,12.717], Tmin=(839.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.8098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = 'C=C(OO)OO[CH]C(3628)',
...
species(
    label = '[CH2][C](OO)OO[C]C(3965)',
    structure = SMILES('[CH2][C](OO)OO[C]C'),
    E0 = (528.782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,360,370,350,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.187751,0.1,-0.000140832,1.04086e-07,-3.09653e-11,63741.5,33.0554], Tmin=(100,'K'), Tmax=(818.841,'K')), NASAPolynomial(coeffs=[13.6206,0.0325466,-1.72665e-05,3.48369e-09,-2.50291e-13,61480.1,-30.8022], Tmin=(818.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Cs_P) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][C](OO)OO[CH]C(3966)',
    structure = SMILES('[CH][C](OO)OO[CH]C'),
    E0 = (488.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0928463,0.0980622,-0.0001436,1.16592e-07,-3.86378e-11,58891.2,33.2746], Tmin=(100,'K'), Tmax=(734.665,'K')), NASAPolynomial(coeffs=[11.0838,0.03721,-1.93573e-05,3.85099e-09,-2.73576e-13,57249,-17.2003], Tmin=(734.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(Cs_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C](OO)OOC=C(1294)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(D)(132)', '[CH2]C(=O)OO[CH]C(3640)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][C](OO)OO[CH]C(3625)'],
    products = ['[CH2]COO[C]([CH2])OO(3957)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C](OO)OO[CH]C(3625)'],
    products = ['[CH2]C(O[O])OO[CH]C(3958)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]OOC([CH2])OO(3960)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH]OO[C](C)OO(3961)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['OH(D)(132)', '[CH2][C]([O])OO[CH]C(3651)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][C](O[O])OO[CH]C(3393)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]OO[C]([CH2])OO(1314)', 'H(8)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C](OO)OO[CH]C(3625)'],
    products = ['[CH2]C([O])(O)OO[CH]C(3964)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C](O[O])OO(1287)', '[CH]C(32)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C]OO(1383)', 'C[CH]O[O](77)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]O(16)', '[CH2][C]OO[CH]C(3815)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]OO[C]([CH2])OO(2690)', '[CH3](11)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C](OO)OO[C]C(3965)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH][C](OO)OO[CH]C(3966)'],
    products = ['[CH2][C](OO)OO[CH]C(3625)'],
