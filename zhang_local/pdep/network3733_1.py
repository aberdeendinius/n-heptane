...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954482,0.0571974,-5.33221e-05,2.81951e-08,-5.74086e-12,40611.9,20.174], Tmin=(100,'K'), Tmax=(1413.55,'K')), NASAPolynomial(coeffs=[11.0104,0.0196663,-3.86536e-06,3.28114e-10,-9.03093e-15,38675.6,-28.6135], Tmin=(1413.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCsJOCs) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH][CH]OC(=C)C(17826)',
    structure = SMILES('[CH][CH]OC(=C)C'),
    E0 = (414.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OC([CH2])=C(6355)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.17159e+11,'s^-1'), n=-0.0562706, Ea=(114.908,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]OC([CH2])=C(6355)'],
    products = ['[CH2][CH]O[C]1CC1(11613)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]OC([CH2])=C(6355)'],
    products = ['[CH2][C]1CC[CH]O1(17825)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH][CH]OC([CH2])=C(10173)'],
    products = ['[CH2][CH]OC([CH2])=C(6355)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(64)', '[CH2]C(=C)[O](4273)'],
    products = ['[CH2][CH]OC([CH2])=C(6355)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(64)', '[CH2][C]([CH2])[O](10271)'],
    products = ['[CH2][CH]OC([CH2])=C(6355)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C[O](594)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][CH]OC([CH2])=C(6355)'],
...
network(
    label = '3733',
    isomers = [
        '[CH2][CH]OC([CH2])=C(6355)',
    ],
    reactants = [
        ('C=C[O](594)', 'C=C=C(6077)'),
        ('[CH]=C(64)', '[CH2]C(=C)[O](4273)'),
    ],
    bathGas = {
        'N2': 0.25,
        'Ne': 0.25,
