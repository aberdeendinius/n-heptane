...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769573,0.0768878,-8.66459e-05,6.98409e-08,-2.49209e-11,69484.2,30.1417], Tmin=(100,'K'), Tmax=(766.668,'K')), NASAPolynomial(coeffs=[4.7786,0.0501051,-2.27681e-05,4.31497e-09,-2.99483e-13,69041.9,12.99], Tmin=(766.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(576.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07882,0.0659639,-4.32578e-05,1.48837e-08,-2.19573e-12,70573.3,30.4392], Tmin=(100,'K'), Tmax=(1474.02,'K')), NASAPolynomial(coeffs=[10.3937,0.0406866,-1.75352e-05,3.25003e-09,-2.22634e-13,67827.2,-18.1138], Tmin=(1474.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(585.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26027,0.0673379,-4.21552e-05,-7.75816e-09,2.13253e-11,65525.4,29.7689], Tmin=(100,'K'), Tmax=(564.807,'K')), NASAPolynomial(coeffs=[5.76762,0.0472866,-2.04276e-05,3.80504e-09,-2.62865e-13,64826.9,8.92236], Tmin=(564.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(544.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74293,0.0674608,-4.58134e-05,1.67186e-08,-2.5669e-12,66650.6,32.9638], Tmin=(100,'K'), Tmax=(1477.15,'K')), NASAPolynomial(coeffs=[12.148,0.0365772,-1.44523e-05,2.56481e-09,-1.71469e-13,63281.2,-26.5084], Tmin=(1477.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cs_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC(C)C[CH2](18942)',
    structure = SMILES('[CH]=[C]CC(C)C[CH2]'),
    E0 = (596.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,278.666,4000],'cm^-1')),
        HinderedRotor(inertia=(0.168703,'amu*angstrom^2'), symmetry=1, barrier=(9.29612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00644531,'amu*angstrom^2'), symmetry=1, barrier=(23.5634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427629,'amu*angstrom^2'), symmetry=1, barrier=(23.5634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168701,'amu*angstrom^2'), symmetry=1, barrier=(9.29611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427655,'amu*angstrom^2'), symmetry=1, barrier=(23.5634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.702639,0.0704398,-5.07797e-05,1.95762e-08,-3.17522e-12,71877.8,31.0276], Tmin=(100,'K'), Tmax=(1403.03,'K')), NASAPolynomial(coeffs=[12.2549,0.0375043,-1.55675e-05,2.84458e-09,-1.93856e-13,68636.2,-28.6175], Tmin=(1403.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377888,0.071837,-5.3099e-05,2.12135e-08,-3.4929e-12,67954.5,33.5096], Tmin=(100,'K'), Tmax=(1422.84,'K')), NASAPolynomial(coeffs=[14.1171,0.0332123,-1.23797e-05,2.13464e-09,-1.40645e-13,64044.7,-37.6191], Tmin=(1422.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(563.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(CC)C[C]=[CH](18952)',
    structure = SMILES('[CH]C(CC)C[C]=[CH]'),
    E0 = (839.596,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.635117,0.0724885,-5.89086e-05,2.59384e-08,-4.76435e-12,101102,30.4895], Tmin=(100,'K'), Tmax=(1268.17,'K')), NASAPolynomial(coeffs=[12.4744,0.0351455,-1.47391e-05,2.71882e-09,-1.86978e-13,98099.5,-29.4411], Tmin=(1268.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(839.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[C]=[C]CC([CH2])CC(18953)',
    structure = SMILES('[C]=[C]CC([CH2])CC'),
    E0 = (907.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.815863,0.0729602,-6.83148e-05,3.88794e-08,-9.56128e-12,109256,30.6047], Tmin=(100,'K'), Tmax=(955.522,'K')), NASAPolynomial(coeffs=[8.60429,0.0403564,-1.71327e-05,3.1698e-09,-2.18338e-13,107767,-6.61562], Tmin=(955.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(907.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CdCdJ2_triplet) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=[C]CC(=C)CC(18934)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH2](6)', 'C#CC[CH][CH2](6430)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]CC([CH2])CC(17602)'],
    products = ['[CH]=CCC([CH2])[CH]C(18941)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]CC(C)C[CH2](18942)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]CC([CH2])CC(17602)'],
    products = ['[CH]=CCC([CH2])C[CH2](18943)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]CC([CH2])CC(17602)'],
    products = ['[CH2]C([CH]C)C[C]=C(17599)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]CC([CH2])CC(17602)'],
    products = ['[CH2]CC([CH2])C[C]=C(17601)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH2](6)', '[CH]=[C]C[CH][CH2](6436)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]C[C]([CH2])CC(18944)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH]=[C]CC([CH2])[CH2](17720)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]=[C]CC([CH2])[CH]C(18945)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]=[C]CC([CH2])C[CH2](18947)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(14)', '[CH]=[C]CC([CH2])C(17551)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C([CH2])CC(112)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C(CC)C[C]=[CH](18952)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[C]=[C]CC([CH2])CC(18953)'],
    products = ['[CH]=[C]CC([CH2])CC(17602)'],
