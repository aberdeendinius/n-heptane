...
species(
    label = '[CH]=COC1=CC1(11825)',
    structure = SMILES('[CH]=COC1=CC1'),
    E0 = (443.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180,180,180,1050.28,1159.59,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.174762,'amu*angstrom^2'), symmetry=1, barrier=(4.01812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174762,'amu*angstrom^2'), symmetry=1, barrier=(4.01812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=[C]OC1CC1(11829)',
    structure = SMILES('[CH]=[C]OC1CC1'),
    E0 = (427.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1685,370,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59946,0.0350908,2.7991e-05,-7.2066e-08,3.31072e-11,51519.9,22.2851], Tmin=(100,'K'), Tmax=(934.53,'K')), NASAPolynomial(coeffs=[18.485,0.00791729,-7.83487e-07,1.01999e-10,-1.34939e-14,46394.5,-68.5716], Tmin=(934.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]=CO[C]1[CH]C1(11831)',
    structure = SMILES('[CH]=CO[C]1[CH]C1'),
    E0 = (587.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,180,180,180,180,999.001,1209.92,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.188175,'amu*angstrom^2'), symmetry=1, barrier=(4.32652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188175,'amu*angstrom^2'), symmetry=1, barrier=(4.32652,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48142,0.0366427,2.26032e-05,-7.13684e-08,3.43751e-11,70813.7,23.5745], Tmin=(100,'K'), Tmax=(926.257,'K')), NASAPolynomial(coeffs=[21.0216,0.00064951,2.52672e-06,-5.16124e-10,2.86288e-14,65118,-80.4044], Tmin=(926.257,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(587.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(CCJCO) + radical(C2CsJOC(O))"""),
)
...
species(
    label = 'C=COC1=CC1(11833)',
    structure = SMILES('C=COC1=CC1'),
    E0 = (196.55,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=COC1=CC1(11825)'],
    products = ['[CH]=CO[C]1CC1(11559)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CO[C]1CC1(11826)'],
    products = ['[CH]=CO[C]1CC1(11559)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]=CO[C]1[CH]C1(11831)'],
    products = ['[CH]=CO[C]1CC1(11559)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]O[C]1CC1(11832)'],
    products = ['[CH]=CO[C]1CC1(11559)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C[O](602)', '[C]1CC1(11616)'],
    products = ['[CH]=CO[C]1CC1(11559)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[C]=CO[C]1CC1(11835)'],
    products = ['[CH]=CO[C]1CC1(11559)'],
