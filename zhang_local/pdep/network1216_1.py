...
species(
    label = '[CH2]CO[C](C)[O](3818)',
    structure = SMILES('[CH2]CO[C](C)[O]'),
    E0 = (168.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,292.597,292.714,292.838,1781.58],'cm^-1')),
        HinderedRotor(inertia=(0.138776,'amu*angstrom^2'), symmetry=1, barrier=(8.42553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00374125,'amu*angstrom^2'), symmetry=1, barrier=(8.42557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.460363,'amu*angstrom^2'), symmetry=1, barrier=(27.9739,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00374024,'amu*angstrom^2'), symmetry=1, barrier=(8.42269,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35409,0.0650321,-9.26011e-05,8.4549e-08,-3.16168e-11,20407,25.823], Tmin=(100,'K'), Tmax=(793.979,'K')), NASAPolynomial(coeffs=[4.49779,0.0374529,-1.83157e-05,3.5496e-09,-2.47944e-13,20277.9,13.7123], Tmin=(793.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P) + radical(CJCO)"""),
)
...
species(
    ...
    E0 = (349.393,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,180,180,814.147,814.148],'cm^-1')),
        HinderedRotor(inertia=(0.127169,'amu*angstrom^2'), symmetry=1, barrier=(2.92386,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12717,'amu*angstrom^2'), symmetry=1, barrier=(2.92388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127167,'amu*angstrom^2'), symmetry=1, barrier=(2.92381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127163,'amu*angstrom^2'), symmetry=1, barrier=(2.92373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][CH]OC(C)=O(1067)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', '[CH2][CH]OC=O(1004)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH2][CH]O[CH][O](1008)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]O[C](C)[O](1062)', 'H(8)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(14)', '[CH2][CH]OC[O](687)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH][CH2](721)', 'CC([O])[O](3601)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]OC(C)[O](3821)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH][CH]OC(C)[O](3822)'],
    products = ['[CH2][CH]OC(C)[O](3612)'],
