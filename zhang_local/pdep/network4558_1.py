...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.05692,'amu*angstrom^2'), symmetry=1, barrier=(47.2926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.05428,'amu*angstrom^2'), symmetry=1, barrier=(47.2318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 8,
    opticalIsomers = 1,
    molecularWeight = (75.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.77128,0.0662969,-7.77214e-05,4.51071e-08,-1.01076e-11,186914,20.4595], Tmin=(100,'K'), Tmax=(1103.8,'K')), NASAPolynomial(coeffs=[15.7118,0.0121543,-4.14437e-06,6.68253e-10,-4.25981e-14,183616,-53.0955], Tmin=(1103.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1553.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(Cds_P) + radical(CJ3)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])C([CH])=[CH](21255)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH](2815)', '[CH]C(=[CH])C#C(21415)'],
    products = ['[CH]C(=[CH])C([CH])=[CH](21255)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.48e+12,'s^-1'), n=-0.305, Ea=(8.28432,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4;Y_rad_out;Ypri_rad_out] for rate rule [R4_DSD;CdsingleH_rad_out;CdsinglepriH_rad_out]
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[C]C(=[CH])C([CH])=[CH](21843)'],
    products = ['[CH]C(=[CH])C([CH])=[CH](21255)'],
    transitionState = 'TS6',
