...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.55801,0.0843487,-0.000142598,1.25083e-07,-4.19178e-11,44015.8,26.4295], Tmin=(100,'K'), Tmax=(878.764,'K')), NASAPolynomial(coeffs=[9.17989,0.0265713,-1.23429e-05,2.26777e-09,-1.50819e-13,43216,-9.98049], Tmin=(878.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]CO[CH][CH][O](1075)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630301,0.0856019,-0.000153047,1.41731e-07,-4.94852e-11,43991.4,26.2731], Tmin=(100,'K'), Tmax=(876.792,'K')), NASAPolynomial(coeffs=[6.87594,0.0310027,-1.49783e-05,2.79252e-09,-1.8699e-13,43899.7,2.68513], Tmin=(876.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(CCsJOCs) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309608,0.0928366,-0.000172884,1.56087e-07,-5.2498e-11,65706.8,26.8703], Tmin=(100,'K'), Tmax=(898.043,'K')), NASAPolynomial(coeffs=[9.69844,0.0235467,-1.12648e-05,2.04537e-09,-1.32934e-13,65128.2,-11.2482], Tmin=(898.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CCsJOH) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC=C[O](1079)',
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.730673,0.0834615,-0.000152784,1.42196e-07,-4.96737e-11,72447.3,26.2832], Tmin=(100,'K'), Tmax=(877.921,'K')), NASAPolynomial(coeffs=[6.94871,0.0287213,-1.4133e-05,2.64417e-09,-1.7702e-13,72373.3,2.89064], Tmin=(877.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(601.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJ2_triplet) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][CH]OC=C[O](1073)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]O[CH]C[O](1074)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]OC[CH][O](710)'],
    products = ['[CH2][CH]O[CH][CH]O(1076)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]O[CH][CH][O](1078)', 'H(8)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]C[O](563)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]O[CH2](417)', '[CH][O](751)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]OC[CH][O](1080)', 'H(8)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]OC[C][O](1081)', 'H(8)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH][CH]OC[CH][O](1082)', 'H(8)'],
    products = ['[CH2][CH]OC[CH][O](710)'],
