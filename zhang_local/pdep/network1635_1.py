species(
    ...
    E0 = (-67.4358,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
...
species(
    ...
    E0 = (-148.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    E0 = (-8.927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1277.5,1000,2950,1000,1380,1390,370,380,2900,435,180,180,180,389.749,739.272,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.153546,'amu*angstrom^2'), symmetry=1, barrier=(3.53031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153546,'amu*angstrom^2'), symmetry=1, barrier=(3.53031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153546,'amu*angstrom^2'), symmetry=1, barrier=(3.53031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153546,'amu*angstrom^2'), symmetry=1, barrier=(3.53031,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189991,0.0750486,-8.48997e-05,4.8796e-08,-1.06446e-11,-10554.7,28.8482], Tmin=(100,'K'), Tmax=(1263.25,'K')), NASAPolynomial(coeffs=[16.8847,0.0139482,-2.56655e-06,1.83331e-10,-2.43205e-15,-14115.3,-52.9936], Tmin=(1263.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-88.9598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](O)OC1CO1(5887)',
    structure = SMILES('[CH2][C](O)OC1CO1'),
    E0 = (-67.4358,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,3615,1277.5,1000,360,370,350,180,988.18,988.18,988.18,988.18,988.18,988.18,988.18,988.18,988.18,2329.08],'cm^-1')),
        HinderedRotor(inertia=(0.0757325,'amu*angstrom^2'), symmetry=1, barrier=(1.74124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0757325,'amu*angstrom^2'), symmetry=1, barrier=(1.74124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0757325,'amu*angstrom^2'), symmetry=1, barrier=(1.74124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0757325,'amu*angstrom^2'), symmetry=1, barrier=(1.74124,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.881445,0.0665899,-6.49534e-05,2.6818e-08,-1.09424e-12,-7996.23,26.8702], Tmin=(100,'K'), Tmax=(815.217,'K')), NASAPolynomial(coeffs=[13.609,0.0191832,-5.40463e-06,7.55908e-10,-4.34393e-14,-10571.2,-34.9984], Tmin=(815.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.4358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(Cs_P)"""),
)
...
species(
    ...
    E0 = (137.811,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,360,370,350,3615,1277.5,1000,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (116.287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.811855,0.0783463,-8.28211e-05,4.21651e-08,-7.78287e-12,-42296.5,25.9479], Tmin=(100,'K'), Tmax=(1625.38,'K')), NASAPolynomial(coeffs=[19.3737,0.00739626,2.28898e-06,-7.96479e-10,6.36524e-14,-46048.2,-72.5962], Tmin=(1625.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-353.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = '[CH]C(O)O[C]1CO1(5889)',
    structure = SMILES('[CH]C(O)O[C]1CO1'),
    E0 = (169.19,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981815,0.0644471,-6.46664e-05,2.72211e-08,-1.23693e-12,20459.6,27.5735], Tmin=(100,'K'), Tmax=(812.598,'K')), NASAPolynomial(coeffs=[13.6884,0.0168904,-4.55272e-06,6.05976e-10,-3.33376e-14,17899.6,-34.1368], Tmin=(812.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(O)O[C]1CO1(2252)', 'H(8)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(O)OC1=CO1(2253)', 'H(8)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(D)(132)', 'C=CO[C]1CO1(1779)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(O)O[C]1CO1(3901)'],
    products = ['[CH2]C(O)OC1[CH]O1(5886)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH2][CH]O[C]1CO1(1830)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](O)O[C]1CO1(2246)', 'H(8)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)O[C]1[CH]O1(2248)', 'H(8)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=O)OC([CH2])O(5549)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C]1CO1(1125)', '[CH2]C([O])O(670)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', 'O[CH]O[C]1CO1(2035)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]C(O)O[C]1CO1(5889)'],
    products = ['[CH2]C(O)O[C]1CO1(3901)'],
