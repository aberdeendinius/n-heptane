...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.839166,0.0741189,-8.24597e-05,5.43469e-08,-1.51388e-11,-9378.55,25.909], Tmin=(100,'K'), Tmax=(857.712,'K')), NASAPolynomial(coeffs=[8.91216,0.0364696,-1.66165e-05,3.16896e-09,-2.21655e-13,-10763.4,-11.7993], Tmin=(857.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.8905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH][C]([CH2])OC(C)[O](10542)',
    structure = SMILES('[CH][C]([CH2])OC(C)[O]'),
    E0 = (557.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,360,370,350,180,180,180,910.181,1600,2570.21,3200],'cm^-1')),
        HinderedRotor(inertia=(0.136449,'amu*angstrom^2'), symmetry=1, barrier=(3.13724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136449,'amu*angstrom^2'), symmetry=1, barrier=(3.13724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136449,'amu*angstrom^2'), symmetry=1, barrier=(3.13724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136449,'amu*angstrom^2'), symmetry=1, barrier=(3.13724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136449,'amu*angstrom^2'), symmetry=1, barrier=(3.13724,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197252,0.0996725,-0.000184045,1.78825e-07,-6.50973e-11,67137.1,31.2548], Tmin=(100,'K'), Tmax=(865.005,'K')), NASAPolynomial(coeffs=[4.39989,0.043146,-2.17006e-05,4.1313e-09,-2.80682e-13,67797.8,19.6103], Tmin=(865.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(557.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([CH2])OC(C)=O(10072)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', '[CH2][C]([CH2])OC=O(6541)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH2][C]([CH2])O[CH][O](10507)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C]([CH2])O[C](C)[O](6727)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]([CH2])OC(C)[O](10156)'],
    products = ['[CH2]C([CH2])OC(C)=O(10541)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(14)', '[CH2][C]([CH2])OC[O](10035)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC([O])[O](3601)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH][C]([CH2])OC(C)[O](10542)'],
    products = ['[CH2][C]([CH2])OC(C)[O](10156)'],
