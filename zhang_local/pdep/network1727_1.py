...
species(
    label = '[CH2]C[CH]C[CH]CC(6252)',
    structure = SMILES('[CH2]C[CH]C[CH]CC'),
    E0 = (378.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,454.745,2279.03,3687.32,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0195873,'amu*angstrom^2'), symmetry=1, barrier=(13.4551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195873,'amu*angstrom^2'), symmetry=1, barrier=(13.4551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195873,'amu*angstrom^2'), symmetry=1, barrier=(13.4551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195873,'amu*angstrom^2'), symmetry=1, barrier=(13.4551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195873,'amu*angstrom^2'), symmetry=1, barrier=(13.4551,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55545,0.0567419,-2.35882e-05,3.62847e-09,-1.39771e-13,45551.6,28.3085], Tmin=(100,'K'), Tmax=(2625.06,'K')), NASAPolynomial(coeffs=[38.1474,0.0144947,-6.29694e-06,9.76632e-10,-5.28844e-14,22735.4,-185.618], Tmin=(2625.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]CCC[CH]C(6253)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14569,0.0598559,-2.76193e-05,5.57224e-09,-4.28387e-13,45567.3,30.1088], Tmin=(100,'K'), Tmax=(2926.07,'K')), NASAPolynomial(coeffs=[24.7968,0.0288912,-1.17457e-05,1.95564e-09,-1.19388e-13,32311.6,-103.489], Tmin=(2926.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]CCCC(6254)',
    structure = SMILES('[CH2][CH][CH]CCCC'),
    E0 = (378.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,405.986,1418.07,2619.55,3831.92],'cm^-1')),
        HinderedRotor(inertia=(0.0522726,'amu*angstrom^2'), symmetry=1, barrier=(5.35924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522726,'amu*angstrom^2'), symmetry=1, barrier=(5.35924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522726,'amu*angstrom^2'), symmetry=1, barrier=(5.35924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522726,'amu*angstrom^2'), symmetry=1, barrier=(5.35924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522726,'amu*angstrom^2'), symmetry=1, barrier=(5.35924,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33664,0.0584014,-2.57863e-05,4.71005e-09,-3.04692e-13,45560.5,29.2647], Tmin=(100,'K'), Tmax=(2817.48,'K')), NASAPolynomial(coeffs=[41.6482,0.0104681,-4.46103e-06,6.56486e-10,-3.30672e-14,20281.8,-206.66], Tmin=(2817.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC[CH][CH]CC(6255)',
...
species(
    label = '[CH2][CH]CCCC[CH2](6256)',
    structure = SMILES('[CH2][CH]CCCC[CH2]'),
    E0 = (389.294,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,215.186,976.149,1365.66,1942.14],'cm^-1')),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14415,0.068678,-4.21076e-05,1.44223e-08,-2.30041e-12,46918.8,32.892], Tmin=(100,'K'), Tmax=(1265.8,'K')), NASAPolynomial(coeffs=[6.29299,0.0524074,-2.28266e-05,4.26748e-09,-2.94807e-13,45615.3,6.83822], Tmin=(1265.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]C[CH]CC(295)',
    structure = SMILES('C[CH][CH]C[CH]CC'),
    E0 = (367.718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1264.38,3038.53,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0520589,'amu*angstrom^2'), symmetry=1, barrier=(6.55256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0520589,'amu*angstrom^2'), symmetry=1, barrier=(6.55256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0520589,'amu*angstrom^2'), symmetry=1, barrier=(6.55256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0520589,'amu*angstrom^2'), symmetry=1, barrier=(6.55256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0520589,'amu*angstrom^2'), symmetry=1, barrier=(6.55256,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13535,0.0733608,-8.7566e-05,8.73422e-08,-3.56412e-11,44319.3,34.4814], Tmin=(100,'K'), Tmax=(831.599,'K')), NASAPolynomial(coeffs=[-2.4495,0.0660174,-2.99721e-05,5.61845e-09,-3.84942e-13,45765.7,56.2268], Tmin=(831.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]C[CH][CH]CC(296)',
...
species(
    label = '[CH2]CCC[CH][CH]C(6257)',
    structure = SMILES('[CH2]CCC[CH][CH]C'),
    E0 = (378.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,405.986,1418.04,2619.55,3831.92],'cm^-1')),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35918,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33664,0.0584014,-2.57863e-05,4.71006e-09,-3.04694e-13,45560.5,29.2647], Tmin=(100,'K'), Tmax=(2817.51,'K')), NASAPolynomial(coeffs=[41.6505,0.0104656,-4.46003e-06,6.56309e-10,-3.30557e-14,20280.2,-206.674], Tmin=(2817.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH][CH]CC[CH]C(297)',
    structure = SMILES('C[CH][CH]CC[CH]C'),
    E0 = (367.706,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,875.63,1946.17,4000,4000],'cm^-1')),
...
species(
    label = '[CH2]C[CH]CC[CH]C(298)',
    structure = SMILES('[CH2]C[CH]CC[CH]C'),
    E0 = (378.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,405.986,1418.04,2619.55,3831.92],'cm^-1')),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0522719,'amu*angstrom^2'), symmetry=1, barrier=(5.35917,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33664,0.0584014,-2.57863e-05,4.71006e-09,-3.04694e-13,45560.5,29.2647], Tmin=(100,'K'), Tmax=(2817.51,'K')), NASAPolynomial(coeffs=[41.6505,0.0104656,-4.46001e-06,6.56305e-10,-3.30554e-14,20280.1,-206.674], Tmin=(2817.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]C[CH][CH]CC(6259)',
    structure = SMILES('[CH2][CH]C[CH][CH]CC'),
    E0 = (572.964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2349.22,2410.66,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0243516,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243516,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243516,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243516,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243516,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15599,0.0742917,-9.86976e-05,1.00415e-07,-4.03739e-11,69002.7,36.1935], Tmin=(100,'K'), Tmax=(843.071,'K')), NASAPolynomial(coeffs=[-2.56559,0.0635646,-2.91101e-05,5.45334e-09,-3.72441e-13,70639,59.4953], Tmin=(843.071,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]C[CH]CC(6260)',
    structure = SMILES('[CH2][CH][CH]C[CH]CC'),
    E0 = (572.964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2349.22,2410.63,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0243515,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243515,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243515,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243515,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0243515,'amu*angstrom^2'), symmetry=1, barrier=(11.4698,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15596,0.0742922,-9.86994e-05,1.00418e-07,-4.03752e-11,69002.7,36.1937], Tmin=(100,'K'), Tmax=(843.066,'K')), NASAPolynomial(coeffs=[-2.56552,0.0635645,-2.911e-05,5.45332e-09,-3.7244e-13,70638.9,59.4949], Tmin=(843.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2][CH]CC[CH][CH]C(6261)',
    structure = SMILES('[CH2][CH]CC[CH][CH]C'),
    E0 = (572.952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2091.51,2338.86,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0255692,'amu*angstrom^2'), symmetry=1, barrier=(11.1195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0255692,'amu*angstrom^2'), symmetry=1, barrier=(11.1195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0255692,'amu*angstrom^2'), symmetry=1, barrier=(11.1195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0255692,'amu*angstrom^2'), symmetry=1, barrier=(11.1195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0255692,'amu*angstrom^2'), symmetry=1, barrier=(11.1195,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.3611,0.0497551,-1.77213e-05,1.52486e-09,1.2314e-13,68896.7,28.2554], Tmin=(100,'K'), Tmax=(2624.34,'K')), NASAPolynomial(coeffs=[40.8409,0.00972152,-4.60907e-06,6.75768e-10,-3.24006e-14,43338.7,-199.939], Tmin=(2624.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJC) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CC[CH]C[CH2](6262)',
    structure = SMILES('[CH2][CH]CC[CH]C[CH2]'),
    E0 = (583.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3000,3050,390,425,1340,1360,335,370,180,180,4000,4000],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79772,0.0549377,-2.43973e-05,4.46585e-09,-2.94266e-13,70221.3,29.3293], Tmin=(100,'K'), Tmax=(3038.13,'K')), NASAPolynomial(coeffs=[51.8446,-0.00204237,-1.46351e-08,-6.16835e-11,1.05837e-14,36914,-267.565], Tmin=(3038.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC=CCC(6263)',
...
species(
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.307848,0.0707335,-4.11951e-05,1.17634e-08,-1.35121e-12,12787.2,31.4565], Tmin=(100,'K'), Tmax=(1980.63,'K')), NASAPolynomial(coeffs=[19.0061,0.0329715,-1.25968e-05,2.13749e-09,-1.36215e-13,5380.24,-71.5307], Tmin=(1980.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.85633,0.0704044,-4.55258e-05,1.70507e-08,-2.88131e-12,46228.5,33.6409], Tmin=(100,'K'), Tmax=(1279,'K')), NASAPolynomial(coeffs=[7.92672,0.0482922,-1.95928e-05,3.53333e-09,-2.39145e-13,44419.9,-2.20949], Tmin=(1279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1CCC1CC(6087)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.934568,0.0721886,-5.4458e-05,2.52108e-08,-5.41284e-12,76150,31.7804], Tmin=(100,'K'), Tmax=(1027.65,'K')), NASAPolynomial(coeffs=[6.64846,0.0499476,-2.19936e-05,4.14987e-09,-2.89181e-13,74975.7,4.05837], Tmin=(1027.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(632.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C]CC[CH]CC(6268)',
    structure = SMILES('[CH2][C]CC[CH]CC'),
    E0 = (632.275,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.918195,0.0731597,-6.07719e-05,3.42971e-08,-9.27855e-12,76151.4,31.6763], Tmin=(100,'K'), Tmax=(831.165,'K')), NASAPolynomial(coeffs=[5.19533,0.052575,-2.36212e-05,4.49779e-09,-3.15048e-13,75440.4,11.8327], Tmin=(831.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(632.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC[CH]CC(6269)',
    structure = SMILES('[CH][CH]CC[CH]CC'),
    E0 = (621.475,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,210.36,1016.96,1092.1,1225.49,1382.97,1635.27,1864.35],'cm^-1')),
        HinderedRotor(inertia=(0.124439,'amu*angstrom^2'), symmetry=1, barrier=(3.34872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124439,'amu*angstrom^2'), symmetry=1, barrier=(3.34872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124439,'amu*angstrom^2'), symmetry=1, barrier=(3.34872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124439,'amu*angstrom^2'), symmetry=1, barrier=(3.34872,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124439,'amu*angstrom^2'), symmetry=1, barrier=(3.34872,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.855288,0.0755911,-8.17285e-05,6.88107e-08,-2.5746e-11,74853.2,33.9299], Tmin=(100,'K'), Tmax=(792.498,'K')), NASAPolynomial(coeffs=[2.66978,0.0560701,-2.51664e-05,4.72983e-09,-3.26257e-13,74891,27.6511], Tmin=(792.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(621.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][CH]CC=CCC(6249)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C=CC[CH]CC(6250)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2][CH]CCC=CC(6251)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction7',
    reactants = ['[CH3](11)', '[CH2][CH]CCC=C(6128)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C[CH]C[CH]CC(6252)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC[CH][CH]CC(6255)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CCCC[CH2](6256)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CCC[CH][CH]C(6257)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C[CH]CCC[CH2](6258)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C[CH]CC[CH]C(298)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][CH]C[CH][CH]CC(6259)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][CH][CH]C[CH]CC(6260)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[CH2][CH]CC[CH][CH2](6130)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][CH]CC[CH][CH]C(6261)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2][CH]CC[CH]C[CH2](6262)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[CH2][CH]CC[CH]C(163)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][CH]CCC([CH2])C(6266)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CC(45)', '[CH2][CH]C[CH2](103)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C[CH]CC(23)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C[CH2](6)', '[CH]CC[CH][CH2](6152)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[CH2][CH]CC[C]CC(6267)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(8)', '[CH2][C]CC[CH]CC(6268)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(8)', '[CH][CH]CC[CH]CC(6269)'],
    products = ['[CH2][CH]CC[CH]CC(299)'],
