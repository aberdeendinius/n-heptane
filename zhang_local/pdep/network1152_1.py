...
species(
    label = '[CH][C]([O])OO[C]=O(3530)',
    structure = SMILES('[CH][C]([O])OO[C]=O'),
    E0 = (447.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,350,500,795,815,1855,455,950,797.592,797.721,797.756,797.94],'cm^-1')),
        HinderedRotor(inertia=(1.1371,'amu*angstrom^2'), symmetry=1, barrier=(47.5719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105319,'amu*angstrom^2'), symmetry=1, barrier=(47.5726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105326,'amu*angstrom^2'), symmetry=1, barrier=(47.5737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.06909,'amu*angstrom^2'), symmetry=1, barrier=(47.5723,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (101.038,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58827,0.054984,-6.16303e-05,3.34767e-08,-7.24819e-12,53952.4,26.3769], Tmin=(100,'K'), Tmax=(1111.75,'K')), NASAPolynomial(coeffs=[12.4533,0.0158922,-8.8863e-06,1.8482e-09,-1.35816e-13,51536.6,-27.1912], Tmin=(1111.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(CCJ2_triplet) + radical((O)CJOC) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C-]#[O+](374)', '[CH2][C]([O])O[O](2122)'],
    products = ['[CH2][C]([O])OO[C]=O(3049)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CO3t2(1168)', '[CH2][C][O](2305)'],
    products = ['[CH2][C]([O])OO[C]=O(3049)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=O(1149)', '[CH2][C]([O])O[O](2122)'],
    products = ['[CH2][C]([O])OO[C]=O(3049)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(43.5839,'m^3/(mol*s)'), n=1.88017, Ea=(5.1666,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH][C]([O])OO[C]=O(3530)'],
    products = ['[CH2][C]([O])OO[C]=O(3049)'],
    transitionState = 'TS8',
