...
species(
    label = '[O][CH]C1COC12CC2(15727)',
    structure = SMILES('[O][CH]C1COC12CC2'),
    E0 = (213.361,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
...
species(
    label = '[O]C=CCOC1=CC1(15728)',
    structure = SMILES('[O]C=CCOC1=CC1'),
    E0 = (83.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.308288,0.0603028,2.03784e-06,-6.21453e-08,3.261e-11,10189.8,27.8991], Tmin=(100,'K'), Tmax=(937.628,'K')), NASAPolynomial(coeffs=[24.6057,0.00945766,-1.10513e-06,1.58801e-10,-1.85405e-14,3312.03,-100.136], Tmin=(937.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(C=COJ)"""),
)

species(
    label = 'O=C=CCO[C]1CC1(15729)',
    structure = SMILES('O=C=CCO[C]1CC1'),
    E0 = (52.5489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744075,0.0763243,-8.97413e-05,6.29778e-08,-1.85548e-11,6433.17,26.2136], Tmin=(100,'K'), Tmax=(816.041,'K')), NASAPolynomial(coeffs=[8.87601,0.0364639,-1.64722e-05,3.12045e-09,-2.17014e-13,5105.97,-11.3651], Tmin=(816.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.5489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cds-(Cdd-O2d)CsH) + ring(Cyclopropane) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    E0 = (94.9313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789568,0.0541377,5.28375e-06,-4.79725e-08,2.25807e-11,848.088,29.2696], Tmin=(100,'K'), Tmax=(986.264,'K')), NASAPolynomial(coeffs=[17.5308,0.0250022,-9.35752e-06,1.77379e-09,-1.30202e-13,-4339.4,-60.8232], Tmin=(986.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.96843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CCJ(O)C) + radical(C=COJ)"""),
)
...
species(
    label = 'O=[C][CH]COC1CC1(15735)',
    structure = SMILES('O=[C][CH]COC1CC1'),
    E0 = (106.083,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561982,0.0671085,-5.06119e-05,1.94847e-08,-3.02743e-12,12889.6,32.3834], Tmin=(100,'K'), Tmax=(1516.14,'K')), NASAPolynomial(coeffs=[15.8854,0.0266812,-1.06153e-05,1.89774e-09,-1.27492e-13,8243.1,-47.9205], Tmin=(1516.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCCJ=O)"""),
)
...
species(
    label = '[O]C=CCO[C]1[CH]C1(15737)',
    structure = SMILES('[O]C=CCO[C]1[CH]C1'),
    E0 = (275.635,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674172,0.0620012,-3.19053e-05,-6.47458e-09,7.79864e-12,33280.8,31.8835], Tmin=(100,'K'), Tmax=(1001.28,'K')), NASAPolynomial(coeffs=[16.4686,0.0226172,-8.42898e-06,1.54721e-09,-1.09882e-13,28929.2,-50.2715], Tmin=(1001.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=COJ) + radical(C2CsJOCs) + radical(CCJCO)"""),
)
...
species(
    label = '[O]C=C[CH]O[C]1CC1(15738)',
    structure = SMILES('[O]C=C[CH]O[C]1CC1'),
    E0 = (186.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.470628,0.0671771,-5.22927e-05,2.05618e-08,-3.22919e-12,22587.3,30.3775], Tmin=(100,'K'), Tmax=(1516.49,'K')), NASAPolynomial(coeffs=[16.9713,0.0236544,-9.24391e-06,1.63725e-09,-1.09446e-13,17582.6,-56.0995], Tmin=(1516.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=COJ) + radical(C2CsJOCs) + radical(C=CCJ(O)C)"""),
)
...
species(
    label = 'O=[C][CH]CO[C]1CC1(15740)',
    structure = SMILES('O=[C][CH]CO[C]1CC1'),
    E0 = (286.787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936941,0.0722404,-8.20022e-05,5.6519e-08,-1.65861e-11,34598.5,30.9856], Tmin=(100,'K'), Tmax=(814.254,'K')), NASAPolynomial(coeffs=[8.12813,0.0369136,-1.69236e-05,3.23578e-09,-2.26482e-13,33427.4,-2.23003], Tmin=(814.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJCO) + radical(C2CsJOCs) + radical(CCCJ=O)"""),
)

species(
    label = '[CH]1OC1CO[C]1CC1(12395)',
    structure = SMILES('[CH]1OC1CO[C]1CC1'),
    E0 = (210.54,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.199296,0.0790885,-7.44892e-05,3.76746e-08,-7.39206e-12,25484.6,29.3], Tmin=(100,'K'), Tmax=(1395.62,'K')), NASAPolynomial(coeffs=[16.6343,0.0229023,-5.56759e-06,6.75699e-10,-3.42083e-14,21559.1,-54.7537], Tmin=(1395.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CCsJO) + radical(C2CsJOCs)"""),
)

species(
    label = '[O]C1[CH]COC12CC2(15741)',
    structure = SMILES('[O]C1[CH]COC12CC2'),
    E0 = (157.193,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0522046,0.0722633,-2.84092e-05,-2.99823e-08,2.10606e-11,-2984.08,29.6006], Tmin=(100,'K'), Tmax=(935.916,'K')), NASAPolynomial(coeffs=[23.5458,0.0139167,-3.02559e-06,4.65964e-10,-3.57694e-14,-9262.98,-92.6295], Tmin=(935.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.1529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=C(O)CJ)"""),
)

species(
    label = 'O=C=CCOC1CC1(15742)',
    structure = SMILES('O=C=CCOC1CC1'),
    E0 = (-128.155,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441827,0.0703807,-5.57191e-05,2.28124e-08,-3.7735e-12,-15278.9,27.3475], Tmin=(100,'K'), Tmax=(1432.09,'K')), NASAPolynomial(coeffs=[15.7616,0.027591,-1.09007e-05,1.94867e-09,-1.31348e-13,-19666.8,-52.0637], Tmin=(1432.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-128.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cds-(Cdd-O2d)CsH) + ring(Cyclopropane)"""),
)
...
species(
    label = '[O][CH]C[CH]O[C]1CC1(15744)',
    structure = SMILES('[O][CH]C[CH]O[C]1CC1'),
    E0 = (436.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0481826,0.0980973,-0.000149414,1.29948e-07,-4.48018e-11,52618.5,31.7186], Tmin=(100,'K'), Tmax=(835.716,'K')), NASAPolynomial(coeffs=[8.45577,0.0415675,-1.9543e-05,3.68627e-09,-2.52132e-13,51749.8,-4.47511], Tmin=(835.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CCsJOH) + radical(CCOJ) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH]=CCO[C]1CC1(15746)',
    structure = SMILES('[CH]=CCO[C]1CC1'),
    E0 = (390.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39704,0.0576748,-4.11441e-05,1.56315e-08,-2.52645e-12,47018.3,25.2288], Tmin=(100,'K'), Tmax=(1386.17,'K')), NASAPolynomial(coeffs=[10.0571,0.032685,-1.41022e-05,2.62592e-09,-1.80859e-13,44617.4,-19.3788], Tmin=(1386.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(C2CsJOCs)"""),
)

species(
    label = 'O=CC=CO[C]1CC1(15747)',
    structure = SMILES('O=CC=CO[C]1CC1'),
    E0 = (17.3939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.29658,0.0661391,-2.99041e-05,-1.59997e-08,1.21958e-11,2238.81,27.3131], Tmin=(100,'K'), Tmax=(1012.37,'K')), NASAPolynomial(coeffs=[20.957,0.017684,-7.26712e-06,1.46495e-09,-1.11081e-13,-3644.51,-81.0123], Tmin=(1012.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.3939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-Cd(CO)H) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + ring(Cyclopropane) + radical(C2CsJOC(O))"""),
)

species(
    label = 'O=CC[CH]O[C]1CC1(15702)',
    structure = SMILES('O=CC[CH]O[C]1CC1'),
    E0 = (107.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.552188,0.0810329,-9.29862e-05,6.29902e-08,-1.79504e-11,13034.4,28.4987], Tmin=(100,'K'), Tmax=(840.963,'K')), NASAPolynomial(coeffs=[9.41216,0.0388925,-1.78243e-05,3.40841e-09,-2.38655e-13,11544.2,-12.7112], Tmin=(840.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = 'O=[C]CCO[C]1CC1(12278)',
    structure = SMILES('O=[C]CCO[C]1CC1'),
    E0 = (86.8851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70236,0.0779929,-9.28777e-05,6.95885e-08,-2.23313e-11,10563.5,29.3269], Tmin=(100,'K'), Tmax=(747.002,'K')), NASAPolynomial(coeffs=[7.57581,0.0411855,-1.8964e-05,3.62043e-09,-2.52619e-13,9536.7,-1.82823], Tmin=(747.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.8851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCCJ=O)"""),
)

species(
    label = 'O=CCCO[C]1[CH]C1(15748)',
    structure = SMILES('O=CCCO[C]1[CH]C1'),
    E0 = (126.827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18931,0.067109,-5.91423e-05,3.17211e-08,-7.65993e-12,15350.5,29.958], Tmin=(100,'K'), Tmax=(944.907,'K')), NASAPolynomial(coeffs=[7.08265,0.0421612,-1.95387e-05,3.77928e-09,-2.67179e-13,14236.7,1.85999], Tmin=(944.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJCO)"""),
)
...
species(
    label = 'O=CC=COC1CC1(15750)',
    structure = SMILES('O=CC=COC1CC1'),
    E0 = (-182.822,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.410336,0.0575125,1.12065e-05,-6.50032e-08,3.08854e-11,-21839.9,26.0985], Tmin=(100,'K'), Tmax=(973.821,'K')), NASAPolynomial(coeffs=[22.8567,0.0169742,-5.92607e-06,1.20139e-09,-9.58127e-14,-28661.2,-94.174], Tmin=(973.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-Cd(CO)H) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + ring(Cyclopropane)"""),
)

species(
    label = 'O=CCCOC1=CC1(15751)',
    structure = SMILES('O=CCCOC1=CC1'),
    E0 = (-65.3506,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.193556,0.0730452,-5.27729e-05,1.28675e-08,1.05036e-12,-7713.64,28.2182], Tmin=(100,'K'), Tmax=(1058.52,'K')), NASAPolynomial(coeffs=[17.7569,0.0246638,-9.70327e-06,1.79582e-09,-1.26371e-13,-12439.6,-62.274], Tmin=(1058.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.3506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=CCO[C]1CC1(12893)'],
    products = ['[O][CH]C1COC12CC2(15727)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(413769,'s^-1'), n=1.87624, Ea=(137.888,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csNdNd]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]C=CCOC1=CC1(15728)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'O=C=CCO[C]1CC1(15729)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[O]C=CCO[C]1CC1(12893)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.000198678,'m^3/(mol*s)'), n=2.77646, Ea=(45.4073,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;CsJ-CdHH] for rate rule [Od_CO-CsCs;CsJ-CdHH]
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C=CCOC1[CH]C1(15468)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O[C]=CCO[C]1CC1(15730)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C=CCO[C]1CC1(12893)'],
    products = ['[O]C=C[CH]OC1CC1(15731)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.28e+07,'s^-1'), n=1.56, Ea=(126.775,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_Cs2;Cs_H_out_H/Cd] for rate rule [R3H_SS_O;C_rad_out_Cs2_cy3;Cs_H_out_H/Cd]
Euclidian distance = 1.41421356237
...
reaction(
    label = 'reaction12',
    reactants = ['O=[C][CH]COC1CC1(15735)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(1.99186e+09,'s^-1'), n=0.575, Ea=(72.1112,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_RSSR;Y_rad_out;Cs_H_out_Cs2] for rate rule [R5H_DSSS;Cd_rad_out;Cs_H_out_Cs2_cy3]
...
reaction(
    label = 'reaction13',
    reactants = ['OC=CCO[C]1[CH]C1(15736)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[O]C=CCO[C]1[CH]C1(15737)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C[O](602)', '[CH2]O[C]1CC1(11545)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[O]C=C[CH]O[C]1CC1(15738)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'O=[C][CH]CO[C]1CC1(15740)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C=CCO[C]1CC1(12893)'],
    products = ['[CH]1OC1CO[C]1CC1(12395)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=CCO[C]1CC1(12893)'],
    products = ['[O]C1[CH]COC12CC2(15741)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.07e+06,'s^-1'), n=1.38, Ea=(81.4599,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra_pri;radadd_intra_csNdNd]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 78.8 to 81.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(=C)OCC=C[O](12867)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O][CH]C[CH]O[C]1CC1(15744)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]C=CC[O](1048)', '[C]1CC1(11616)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH]=CCO[C]1CC1(15746)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', 'O=CC=CO[C]1CC1(15747)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O=CC[CH]O[C]1CC1(15702)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O=[C]CCO[C]1CC1(12278)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O=CCCO[C]1[CH]C1(15748)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]=O(373)', '[CH]CO[C]1CC1(11617)'],
    products = ['[O]C=CCO[C]1CC1(12893)'],
