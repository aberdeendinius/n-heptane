...
species(
    label = '[CH2][CH]C[CH]C(=O)OO(6640)',
    structure = SMILES('[CH2][CH]C[CH]C(=O)OO'),
    E0 = (80.8637,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865799,0.0665943,-5.24598e-05,2.15512e-08,-3.65896e-12,9840.17,35.6864], Tmin=(100,'K'), Tmax=(1366.01,'K')), NASAPolynomial(coeffs=[13.0048,0.0310481,-1.34265e-05,2.50115e-09,-1.72493e-13,6523.81,-26.6632], Tmin=(1366.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.8637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]C[CH]C[C]([O])OO(6641)',
    structure = SMILES('[CH2]C[CH]C[C]([O])OO'),
    E0 = (374.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,241.67,852.571,1282.75,1824.3],'cm^-1')),
        HinderedRotor(inertia=(0.104451,'amu*angstrom^2'), symmetry=1, barrier=(3.50652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104451,'amu*angstrom^2'), symmetry=1, barrier=(3.50652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104451,'amu*angstrom^2'), symmetry=1, barrier=(3.50652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104451,'amu*angstrom^2'), symmetry=1, barrier=(3.50652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104451,'amu*angstrom^2'), symmetry=1, barrier=(3.50652,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373951,0.0929953,-0.000151776,1.47866e-07,-5.6001e-11,45101.7,37.3832], Tmin=(100,'K'), Tmax=(829.827,'K')), NASAPolynomial(coeffs=[2.80801,0.0523956,-2.62082e-05,5.06714e-09,-3.51049e-13,45691.7,32.083], Tmin=(829.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ) + radical(Cs_P) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]C[CH]C([O])OO(6642)',
    structure = SMILES('[CH2][CH]C[CH]C([O])OO'),
    E0 = (369.175,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.317128,0.093903,-0.000152364,1.46817e-07,-5.51083e-11,44521.6,39.376], Tmin=(100,'K'), Tmax=(831.058,'K')), NASAPolynomial(coeffs=[3.38255,0.0514023,-2.55732e-05,4.93233e-09,-3.41223e-13,44970.3,30.9191], Tmin=(831.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCOJ) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CCC([O])O[O](6643)',
    structure = SMILES('[CH2][CH]CCC([O])O[O]'),
    E0 = (320.765,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.55904,0.0882337,-0.000140884,1.36366e-07,-5.12494e-11,38690.8,36.9624], Tmin=(100,'K'), Tmax=(840.428,'K')), NASAPolynomial(coeffs=[2.48093,0.0511443,-2.48149e-05,4.73426e-09,-3.25385e-13,39354.6,33.8953], Tmin=(840.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ) + radical(ROOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC[CH][C]([O])OO(6644)',
    structure = SMILES('[CH2]CC[CH][C]([O])OO'),
    E0 = (379.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158863,0.0943801,-0.000143169,1.3027e-07,-4.77583e-11,45829.2,37.8974], Tmin=(100,'K'), Tmax=(798.798,'K')), NASAPolynomial(coeffs=[6.27024,0.0472497,-2.3631e-05,4.60339e-09,-3.21778e-13,45380.1,13.0869], Tmin=(798.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2][CH][CH]CC([O])OO(6645)',
    structure = SMILES('[CH2][CH][CH]CC([O])OO'),
    E0 = (363.218,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551393,0.0922814,-0.000160107,1.63284e-07,-6.2894e-11,43793.4,38.7939], Tmin=(100,'K'), Tmax=(847.929,'K')), NASAPolynomial(coeffs=[-0.165292,0.0567008,-2.82414e-05,5.4181e-09,-3.72354e-13,45315.5,50.3924], Tmin=(847.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0178836,0.097044,-0.000149139,1.31836e-07,-4.6328e-11,42075.1,40.2796], Tmin=(100,'K'), Tmax=(824.305,'K')), NASAPolynomial(coeffs=[7.86074,0.0427044,-2.06284e-05,3.94045e-09,-2.7166e-13,41335.3,7.31297], Tmin=(824.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJC) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CC[C](O)O[O](6647)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254182,0.0914469,-0.000137941,1.21799e-07,-4.26678e-11,36244.6,37.8857], Tmin=(100,'K'), Tmax=(838.203,'K')), NASAPolynomial(coeffs=[6.9737,0.0424203,-1.98544e-05,3.73857e-09,-2.55499e-13,35714,10.208], Tmin=(838.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(ROOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243134,0.0955387,-0.000157339,1.48978e-07,-5.44402e-11,41347.3,39.7292], Tmin=(100,'K'), Tmax=(848.869,'K')), NASAPolynomial(coeffs=[4.33468,0.0479638,-2.32732e-05,4.42052e-09,-3.02308e-13,41672.1,26.6649], Tmin=(848.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJC) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CCC[C]([O])O[O](6649)',
    structure = SMILES('[CH2]CCC[C]([O])O[O]'),
    E0 = (331.565,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394975,0.08878,-0.000131925,1.20091e-07,-4.39819e-11,39998.6,35.5044], Tmin=(100,'K'), Tmax=(811.41,'K')), NASAPolynomial(coeffs=[5.40329,0.0469299,-2.28359e-05,4.3964e-09,-3.05187e-13,39750.8,15.8699], Tmin=(811.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ) + radical(Cs_P) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2][CH]CC[C]([O])O[O](6650)',
    structure = SMILES('[CH2][CH]CC[C]([O])O[O]'),
    E0 = (526.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,215.212,941.564,1063.75,3616.06],'cm^-1')),
        HinderedRotor(inertia=(0.0451086,'amu*angstrom^2'), symmetry=1, barrier=(1.40132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0451086,'amu*angstrom^2'), symmetry=1, barrier=(1.40132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0451086,'amu*angstrom^2'), symmetry=1, barrier=(1.40132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0451086,'amu*angstrom^2'), symmetry=1, barrier=(1.40132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0451086,'amu*angstrom^2'), symmetry=1, barrier=(1.40132,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584167,0.0891085,-0.000151806,1.49153e-07,-5.58569e-11,63374,37.56], Tmin=(100,'K'), Tmax=(850.456,'K')), NASAPolynomial(coeffs=[2.34767,0.048722,-2.3971e-05,4.57353e-09,-3.13254e-13,64234.6,36.161], Tmin=(850.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ) + radical(CCOJ) + radical(RCCJC) + radical(Cs_P)"""),
)

species(
    label = '[CH2][CH][CH]C[C]([O])OO(6651)',
    structure = SMILES('[CH2][CH][CH]C[C]([O])OO'),
    E0 = (568.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,269.086,965.984,2134.69,3510.27],'cm^-1')),
        HinderedRotor(inertia=(0.0350051,'amu*angstrom^2'), symmetry=1, barrier=(4.39451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0350051,'amu*angstrom^2'), symmetry=1, barrier=(4.39451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0350051,'amu*angstrom^2'), symmetry=1, barrier=(4.39451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0350051,'amu*angstrom^2'), symmetry=1, barrier=(4.39451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0350051,'amu*angstrom^2'), symmetry=1, barrier=(4.39451,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.579725,0.0931164,-0.000170882,1.75872e-07,-6.74153e-11,68476.4,39.3802], Tmin=(100,'K'), Tmax=(855.203,'K')), NASAPolynomial(coeffs=[-0.311209,0.0543009,-2.74109e-05,5.26058e-09,-3.60493e-13,70200.6,52.7288], Tmin=(855.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(Cs_P) + radical(CCOJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]C[CH][C]([O])OO(6652)',
    structure = SMILES('[CH2][CH]C[CH][C]([O])OO'),
    E0 = (574.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,267.003,884.681,1300.77,1956.88],'cm^-1')),
        HinderedRotor(inertia=(0.101445,'amu*angstrom^2'), symmetry=1, barrier=(3.48894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101445,'amu*angstrom^2'), symmetry=1, barrier=(3.48894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101445,'amu*angstrom^2'), symmetry=1, barrier=(3.48894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101445,'amu*angstrom^2'), symmetry=1, barrier=(3.48894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101445,'amu*angstrom^2'), symmetry=1, barrier=(3.48894,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.340509,0.0947979,-0.00016335,1.59668e-07,-5.97288e-11,69204.9,39.9799], Tmin=(100,'K'), Tmax=(841.759,'K')), NASAPolynomial(coeffs=[3.26203,0.0489576,-2.4716e-05,4.7684e-09,-3.28823e-13,69845.2,33.1136], Tmin=(841.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(574.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Cs_P) + radical(RCCJ) + radical(CCJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C=CCC([O])OO(6653)',
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30262,0.0705801,-4.72559e-05,1.0952e-08,6.14179e-13,-13518.7,34.9796], Tmin=(100,'K'), Tmax=(1128.81,'K')), NASAPolynomial(coeffs=[16.6506,0.0282357,-1.16977e-05,2.18312e-09,-1.52704e-13,-18202.4,-50.269], Tmin=(1128.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.728939,0.0897142,-0.000160106,1.65415e-07,-6.34167e-11,17249.4,36.8565], Tmin=(100,'K'), Tmax=(865.196,'K')), NASAPolynomial(coeffs=[-1.51087,0.0566363,-2.74583e-05,5.18297e-09,-3.5176e-13,19262.6,56.7324], Tmin=(865.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41712,0.0660721,-0.00010344,9.99369e-08,-3.76428e-11,91307.4,27.9355], Tmin=(100,'K'), Tmax=(839.385,'K')), NASAPolynomial(coeffs=[2.69553,0.0393876,-1.8955e-05,3.60935e-09,-2.47996e-13,91818.3,26.313], Tmin=(839.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(758.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ) + radical(RCCJ) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0808763,0.0953979,-0.000146642,1.30417e-07,-4.66587e-11,75636.2,35.7787], Tmin=(100,'K'), Tmax=(794.987,'K')), NASAPolynomial(coeffs=[7.94965,0.0424075,-2.13778e-05,4.17245e-09,-2.91848e-13,74808.4,2.2846], Tmin=(794.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet) + radical(RCCJ) + radical(Cs_P)"""),
)

species(
    label = '[CH][CH]CC[C]([O])OO(6657)',
    structure = SMILES('[CH][CH]CC[C]([O])OO'),
    E0 = (616.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.2353,0.094971,-0.000156037,1.47262e-07,-5.41553e-11,74328.8,37.2707], Tmin=(100,'K'), Tmax=(831.784,'K')), NASAPolynomial(coeffs=[5.07096,0.0465438,-2.33102e-05,4.49898e-09,-3.11088e-13,74395.1,20.0667], Tmin=(831.784,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(616.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCJ2_triplet) + radical(CCOJ) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C=CC[C]([O])OO(6639)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2][CH]C[CH]C(=O)OO(6640)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(123.878,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', 'C=CCC[C]([O])[O](2421)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.24379e+07,'m^3/(mol*s)'), n=-0.377333, Ea=(89.3157,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;OJ_pri] for rate rule [Od_R;OJ_pri]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 85.2 to 89.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]C[CH]C[C]([O])OO(6641)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH]C[CH]C([O])OO(6642)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH]CCC([O])O[O](6643)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC[CH][C]([O])OO(6644)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH][CH]CC([O])OO(6645)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['C[CH][CH]C[C]([O])OO(1451)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH]C[CH][C](O)OO(6646)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH]CC[C](O)O[O](6647)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['C[CH]C[CH][C]([O])OO(1452)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH][CH]C[C](O)OO(6648)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(D)(132)', '[CH2][CH]CC[C]([O])[O](2432)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][CH]CC[C]([O])O[O](6650)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][CH][CH]C[C]([O])OO(6651)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2][CH]C[CH][C]([O])OO(6652)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2]CC[CH]C(=O)OO(6654)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH]CCC([O])([O])O(6655)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O]O(16)', '[CH2][CH]CC[C][O](6416)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C[C]([O])OO(1371)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[O][C]OO(1370)', '[CH2][CH]C[CH2](103)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH2][C]CC[C]([O])OO(6656)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH][CH]CC[C]([O])OO(6657)'],
    products = ['[CH2][CH]CC[C]([O])OO(1453)'],
