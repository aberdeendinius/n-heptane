...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928265,0.0747479,-0.000101062,8.84814e-08,-3.15247e-11,3966.15,25.2882], Tmin=(100,'K'), Tmax=(835.602,'K')), NASAPolynomial(coeffs=[4.70527,0.0429377,-1.93127e-05,3.59588e-09,-2.45074e-13,3814.26,10.6128], Tmin=(835.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.1145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(C)[CH]CO(5607)',
    structure = SMILES('[CH2]C(C)[CH]CO'),
    E0 = (71.3783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,180,746.574],'cm^-1')),
        HinderedRotor(inertia=(0.00794195,'amu*angstrom^2'), symmetry=1, barrier=(3.14045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138321,'amu*angstrom^2'), symmetry=1, barrier=(3.18028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13664,'amu*angstrom^2'), symmetry=1, barrier=(3.14162,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138491,'amu*angstrom^2'), symmetry=1, barrier=(3.18419,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](C)CCO(5609)',
    structure = SMILES('[CH2][C](C)CCO'),
    E0 = (56.8989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,2702.57],'cm^-1')),
        HinderedRotor(inertia=(0.139178,'amu*angstrom^2'), symmetry=1, barrier=(3.19997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139174,'amu*angstrom^2'), symmetry=1, barrier=(3.1999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139149,'amu*angstrom^2'), symmetry=1, barrier=(3.19931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139176,'amu*angstrom^2'), symmetry=1, barrier=(3.19993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139038,'amu*angstrom^2'), symmetry=1, barrier=(3.19676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15598,0.0683748,-8.45783e-05,7.11889e-08,-2.47683e-11,6940.16,27.3974], Tmin=(100,'K'), Tmax=(853.283,'K')), NASAPolynomial(coeffs=[4.31779,0.0420066,-1.7928e-05,3.25697e-09,-2.18964e-13,6820.91,15.1082], Tmin=(853.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.8989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2]C([CH2])CCO(5610)',
    structure = SMILES('[CH2]C([CH2])CCO'),
    E0 = (76.5586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1380,1390,370,380,2900,435,298.592,1815.73],'cm^-1')),
        HinderedRotor(inertia=(0.127223,'amu*angstrom^2'), symmetry=1, barrier=(8.04297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00189699,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127525,'amu*angstrom^2'), symmetry=1, barrier=(8.03796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00343691,'amu*angstrom^2'), symmetry=1, barrier=(8.04491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08392,'amu*angstrom^2'), symmetry=1, barrier=(68.3949,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = 'CC(C)C[CH][O](5611)',
    structure = SMILES('CC(C)C[CH][O]'),
    E0 = (72.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,291.721,291.758,1629.74],'cm^-1')),
        HinderedRotor(inertia=(0.00198107,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118605,'amu*angstrom^2'), symmetry=1, barrier=(7.16147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118541,'amu*angstrom^2'), symmetry=1, barrier=(7.16128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118588,'amu*angstrom^2'), symmetry=1, barrier=(7.16176,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8506,0.0548226,-1.85885e-05,-4.15171e-08,4.39257e-11,8777.27,21.8206], Tmin=(100,'K'), Tmax=(500.914,'K')), NASAPolynomial(coeffs=[4.49235,0.0445562,-2.02735e-05,3.88363e-09,-2.73007e-13,8376.75,9.54588], Tmin=(500.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.82111,0.0673149,-6.41419e-05,3.3631e-08,-7.16153e-12,40102.9,26.1959], Tmin=(100,'K'), Tmax=(1130.96,'K')), NASAPolynomial(coeffs=[12.3426,0.0265646,-1.00934e-05,1.77036e-09,-1.18566e-13,37496.9,-30.8065], Tmin=(1130.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CH2_triplet)"""),
)

species(
    label = '[CH]C(C)C[CH]O(5616)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.90739,0.0689043,-6.79812e-05,3.76656e-08,-8.63153e-12,35579.8,25.9308], Tmin=(100,'K'), Tmax=(1042.37,'K')), NASAPolynomial(coeffs=[10.9066,0.0305335,-1.27647e-05,2.35105e-09,-1.61809e-13,33495.2,-22.7246], Tmin=(1042.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C)CC=O(642)', 'H(8)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C(C)C[CH]O(5604)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(C)C=CO(5605)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C=CC[CH]O(5522)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)C[CH][O](638)', 'H(8)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]C[CH]O(747)', '[CH3](11)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][C](C)C[CH]O(811)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C(C)[CH][CH]O(809)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C([CH2])C[CH]O(812)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(14)', '[CH2]CC[CH]O(5497)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction29',
    reactants = ['OH(D)(132)', '[CH]CC([CH2])C(120)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH2])C(118)', '[CH]O(5471)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH2]C(C)C[C]O(5615)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH]C(C)C[CH]O(5616)'],
    products = ['[CH2]C(C)C[CH]O(5501)'],
