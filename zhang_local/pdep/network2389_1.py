...
species(
    label = '[CH2]CC(=C)O[CH2](9357)',
    structure = SMILES('[CH2]CC(=C)O[CH2]'),
    E0 = (184.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,573.169,573.282],'cm^-1')),
        HinderedRotor(inertia=(0.00959152,'amu*angstrom^2'), symmetry=1, barrier=(2.23697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00959772,'amu*angstrom^2'), symmetry=1, barrier=(2.23775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0602133,'amu*angstrom^2'), symmetry=1, barrier=(14.0404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0602285,'amu*angstrom^2'), symmetry=1, barrier=(14.0401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24539,0.0498585,-1.52161e-05,-1.834e-08,1.12221e-11,22342,25.9292], Tmin=(100,'K'), Tmax=(986.568,'K')), NASAPolynomial(coeffs=[14.5013,0.0204183,-7.40881e-06,1.35575e-09,-9.6788e-14,18543.6,-43.8382], Tmin=(986.568,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C1(C)CO1(9360)',
    structure = SMILES('[CH2][CH]C1(C)CO1'),
    E0 = (236.174,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48801,0.0449241,4.84503e-06,-4.90275e-08,2.71478e-11,28505.6,22.3224], Tmin=(100,'K'), Tmax=(854.052,'K')), NASAPolynomial(coeffs=[14.2682,0.0169366,-1.97244e-06,-1.38413e-11,1.08156e-14,25160.3,-44.1227], Tmin=(854.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1(C)[CH]O1(9361)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0880195,0.0676594,-6.23319e-05,3.01167e-08,-5.42594e-12,26625.6,25.6842], Tmin=(100,'K'), Tmax=(1647.51,'K')), NASAPolynomial(coeffs=[14.6308,0.016519,-1.74513e-06,-7.50546e-11,1.66749e-14,23866.3,-46.3296], Tmin=(1647.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1([CH]O1)CC(9362)',
    structure = SMILES('[CH2]C1([CH]O1)CC'),
    E0 = (225.258,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0374183,0.0748105,-7.96158e-05,4.38134e-08,-8.99957e-12,27249.7,23.4471], Tmin=(100,'K'), Tmax=(1414.63,'K')), NASAPolynomial(coeffs=[16.1009,0.0150314,-1.22897e-06,-1.96721e-10,2.7375e-14,24099.2,-55.0057], Tmin=(1414.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]CC1([CH2])[CH]O1(9364)',
    structure = SMILES('[CH2]CC1([CH2])[CH]O1'),
    E0 = (430.504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.141189,0.0739207,-8.45905e-05,4.92423e-08,-1.06462e-11,51926.1,24.5898], Tmin=(100,'K'), Tmax=(1343.58,'K')), NASAPolynomial(coeffs=[15.9214,0.0127766,-5.14195e-07,-3.21822e-10,3.6252e-14,48964.2,-51.4432], Tmin=(1343.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68867,0.036829,3.12468e-05,-7.83034e-08,3.80116e-11,-5746.75,19.2174], Tmin=(100,'K'), Tmax=(865.979,'K')), NASAPolynomial(coeffs=[15.1168,0.0149759,-4.84704e-07,-3.06326e-10,2.98145e-14,-9578.75,-52.3306], Tmin=(865.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = '[CH2]C[C]1CCO1(9366)',
    structure = SMILES('[CH2]C[C]1CCO1'),
    E0 = (229.427,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33336,0.0493248,-3.33019e-05,1.38566e-08,-2.40863e-12,27697.7,23.6149], Tmin=(100,'K'), Tmax=(1533.4,'K')), NASAPolynomial(coeffs=[8.57079,0.0266912,-7.48878e-06,1.03735e-09,-5.83169e-14,25919.5,-12.9563], Tmin=(1533.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJ) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377621,0.0905337,-0.000153082,1.38603e-07,-4.78319e-11,58585.4,27.203], Tmin=(100,'K'), Tmax=(877.49,'K')), NASAPolynomial(coeffs=[7.29966,0.034684,-1.60789e-05,2.9624e-09,-1.97691e-13,58306,0.0425952], Tmin=(877.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(RCCJ) + radical(CsJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.381147,0.0635428,-6.06927e-05,3.08317e-08,-5.88439e-12,58414.4,24.7894], Tmin=(100,'K'), Tmax=(1535.66,'K')), NASAPolynomial(coeffs=[13.6729,0.0162207,-2.0638e-06,-6.08859e-12,1.26528e-14,55829.6,-40.1613], Tmin=(1535.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=C)O[CH2](9357)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(C=C)CO1(9227)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][CH]C1([CH2])CO1(9363)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2]CC1([CH2])[CH]O1(9364)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(=C)[O](725)', 'CH2(S)(14)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(S)(1732)', '[CH2]CC([CH2])=C(6135)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[C]([CH2])O[CH2](9367)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(28)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]C1(C[CH2])CO1(9370)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH]CC1([CH2])CO1(9371)'],
    products = ['[CH2]CC1([CH2])CO1(9193)'],
