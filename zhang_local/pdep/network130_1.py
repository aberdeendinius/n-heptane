...
species(
    ...
    E0 = (191.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,388.606,393.343,2125.92],'cm^-1')),
        HinderedRotor(inertia=(0.043457,'amu*angstrom^2'), symmetry=1, barrier=(4.4664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00115939,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.99077,0.0197032,-1.02211e-05,1.6603e-11,1.34548e-12,23088,12.4445], Tmin=(100,'K'), Tmax=(1002.51,'K')), NASAPolynomial(coeffs=[6.56242,0.0104148,-3.74832e-06,6.49836e-10,-4.37653e-14,22122.5,-6.03935], Tmin=(1002.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
