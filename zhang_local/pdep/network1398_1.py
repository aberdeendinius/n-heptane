...
species(
    label = 'C#COC([CH2])([O])[O](5120)',
    structure = SMILES('C#COC([CH2])([O])[O]'),
    E0 = (306.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3000,3100,440,815,1455,1000,2175,525,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.921304,0.074546,-0.000124418,1.07931e-07,-3.62795e-11,36932.9,23.8695], Tmin=(100,'K'), Tmax=(848.105,'K')), NASAPolynomial(coeffs=[9.38599,0.0225605,-1.11386e-05,2.11601e-09,-1.44265e-13,35930.9,-13.0155], Tmin=(848.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]=[C]OC([CH2])([O])O(5122)',
    structure = SMILES('[CH]=[C]OC([CH2])([O])O'),
    E0 = (358.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,3615,1277.5,1000,3000,3100,440,815,1455,1000,180,180,180,205.536,1552.68,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.14528,'amu*angstrom^2'), symmetry=1, barrier=(3.34028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14528,'amu*angstrom^2'), symmetry=1, barrier=(3.34028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14528,'amu*angstrom^2'), symmetry=1, barrier=(3.34028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14528,'amu*angstrom^2'), symmetry=1, barrier=(3.34028,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695887,0.0769115,-0.000119389,9.48996e-08,-2.9271e-11,43174.7,30.587], Tmin=(100,'K'), Tmax=(874.324,'K')), NASAPolynomial(coeffs=[12.0049,0.018608,-8.09971e-06,1.4538e-09,-9.58808e-14,41448,-21.0184], Tmin=(874.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC(C)([O])[O](5123)',
    structure = SMILES('[CH]=[C]OC(C)([O])[O]'),
    E0 = (372.135,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,180,180,180,298.467,872.713,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21458,0.068944,-0.00011194,1.01083e-07,-3.5485e-11,44850.4,28.258], Tmin=(100,'K'), Tmax=(849.841,'K')), NASAPolynomial(coeffs=[6.39497,0.0289869,-1.39248e-05,2.63042e-09,-1.79271e-13,44532.3,7.41743], Tmin=(849.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.135,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ) + radical(CCOJ) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]=[C]OC([CH2])([O])[O](5124)',
    structure = SMILES('[CH]=[C]OC([CH2])([O])[O]'),
    E0 = (583.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,180,180,201.028,972.824,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.145924,'amu*angstrom^2'), symmetry=1, barrier=(3.35509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145924,'amu*angstrom^2'), symmetry=1, barrier=(3.35509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145924,'amu*angstrom^2'), symmetry=1, barrier=(3.35509,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04196,0.0743692,-0.000132474,1.21144e-07,-4.19431e-11,70303.4,29.5114], Tmin=(100,'K'), Tmax=(872.424,'K')), NASAPolynomial(coeffs=[7.33096,0.0249948,-1.22669e-05,2.30098e-09,-1.54666e-13,69987.7,4.50877], Tmin=(872.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCOJ) + radical(Cds_P) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]C([O])([O])O[C]=C(5125)',
    structure = SMILES('[CH]C([O])([O])O[C]=C'),
    E0 = (573.254,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23135,0.0685294,-0.000114967,1.03556e-07,-3.59919e-11,69038.9,28.7988], Tmin=(100,'K'), Tmax=(854.434,'K')), NASAPolynomial(coeffs=[7.05416,0.0257346,-1.25653e-05,2.37749e-09,-1.6174e-13,68610.9,4.94164], Tmin=(854.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(573.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#COC([CH2])([O])[O](5120)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]C(=O)O[C]=C(4288)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=[C]OC([O])=O(4276)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]OC([CH2])([O])O(5122)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]=[C]OC([CH2])([O])[O](5124)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])([O])O[C]=C(4259)'],
    products = ['[CH2]C1(O[C]=C)OO1(5017)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=C(584)', '[CH2]C([O])([O])[O](2121)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C([O])([O])O[C]=C(5125)'],
    products = ['[CH2]C([O])([O])O[C]=C(4259)'],
