...
species(
    label = '[CH2][C]([O])OC(C)=O(2159)',
    structure = SMILES('[CH2][C]([O])OC(C)=O'),
    E0 = (-21.1779,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75315,0.0544248,-6.45223e-05,5.55028e-08,-2.16336e-11,-2470.94,27.9395], Tmin=(100,'K'), Tmax=(699.289,'K')), NASAPolynomial(coeffs=[4.14697,0.0368469,-1.84834e-05,3.66675e-09,-2.61547e-13,-2710.74,17.9261], Tmin=(699.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.1779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJCO) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22802,0.0728584,-0.000123396,1.26308e-07,-4.98522e-11,22707.6,29.6525], Tmin=(100,'K'), Tmax=(817.688,'K')), NASAPolynomial(coeffs=[1.31627,0.0454578,-2.36586e-05,4.65618e-09,-3.26022e-13,23594.7,34.7575], Tmin=(817.688,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][C]([O])O[C](C)[O](2838)',
    structure = SMILES('[CH2][C]([O])O[C](C)[O]'),
    E0 = (399.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,363.333,366.667,370,300,400,247.516,859.562,1146.08,1491.72,1854.13],'cm^-1')),
        HinderedRotor(inertia=(0.0956105,'amu*angstrom^2'), symmetry=1, barrier=(3.36689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0956105,'amu*angstrom^2'), symmetry=1, barrier=(3.36689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0956105,'amu*angstrom^2'), symmetry=1, barrier=(3.36689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0956105,'amu*angstrom^2'), symmetry=1, barrier=(3.36689,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05478,0.0782766,-0.000143812,1.46014e-07,-5.60295e-11,48160.6,31.602], Tmin=(100,'K'), Tmax=(834.682,'K')), NASAPolynomial(coeffs=[2.30601,0.041372,-2.19456e-05,4.31356e-09,-3.00312e-13,49028.4,32.2413], Tmin=(834.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ) + radical(Cs_P) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92389,0.0508826,-4.23276e-05,2.46784e-08,-7.43214e-12,-27162.4,25.9673], Tmin=(100,'K'), Tmax=(725.456,'K')), NASAPolynomial(coeffs=[3.90394,0.0399648,-1.97526e-05,3.93231e-09,-2.82651e-13,-27449.7,17.0503], Tmin=(725.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-226.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH][C]([O])OC(C)[O](4029)',
    structure = SMILES('[CH][C]([O])OC(C)[O]'),
    E0 = (431.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,360,370,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1279,0.0752926,-0.000132773,1.33957e-07,-5.17694e-11,51933.4,31.0216], Tmin=(100,'K'), Tmax=(823.613,'K')), NASAPolynomial(coeffs=[2.50378,0.0415271,-2.19526e-05,4.32793e-09,-3.0264e-13,52625.3,30.2274], Tmin=(823.613,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCOJ) + radical(Cs_P) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([O])OC(C)=O(2159)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', '[CH2]C(=O)O[CH][O](2592)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.61258,'m^3/(mol*s)'), n=1.485, Ea=(48.9785,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO_O;CsJ-HHH] for rate rule [CO-NdH_O;CsJ-HHH]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 43.6 to 49.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])OC(C)[O](3650)'],
    products = ['[CH2][C](O)OC([CH2])[O](4027)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH2][C]([O])O[CH][O](2597)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C]([O])O[C](C)[O](2838)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(14)', '[CH2][C]([O])OC[O](2112)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C][O](2305)', 'CC([O])[O](3601)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH][C]([O])OC(C)[O](4029)'],
    products = ['[CH2][C]([O])OC(C)[O](3650)'],
