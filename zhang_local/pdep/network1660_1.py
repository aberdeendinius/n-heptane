species(
    label = 'O=[C]OC[CH]O(5566)',
    structure = SMILES('O=[C]OC[CH]O'),
    E0 = (-189.466,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3025,407.5,1350,352.5,180,373.414,647.062],'cm^-1')),
        HinderedRotor(inertia=(0.00183315,'amu*angstrom^2'), symmetry=1, barrier=(13.1051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0439194,'amu*angstrom^2'), symmetry=1, barrier=(13.1053,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570293,'amu*angstrom^2'), symmetry=1, barrier=(13.1122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61534,'amu*angstrom^2'), symmetry=1, barrier=(37.1398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-276.525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,2782.5,750,1395,475,1775,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.00530447,'amu*angstrom^2'), symmetry=1, barrier=(1.97231,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.867557,'amu*angstrom^2'), symmetry=1, barrier=(19.9469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0536463,'amu*angstrom^2'), symmetry=1, barrier=(19.9467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.34305,'amu*angstrom^2'), symmetry=1, barrier=(30.8793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34324,'amu*angstrom^2'), symmetry=1, barrier=(30.8837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34773,'amu*angstrom^2'), symmetry=1, barrier=(30.9869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
...
species(
    label = 'O=[C]O[CH]CO(5867)',
    structure = SMILES('O=[C]O[CH]CO'),
    E0 = (-175.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3025,407.5,1350,352.5,363.427,363.609,363.741],'cm^-1')),
        HinderedRotor(inertia=(0.00127056,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126384,'amu*angstrom^2'), symmetry=1, barrier=(11.864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126762,'amu*angstrom^2'), symmetry=1, barrier=(11.8686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126584,'amu*angstrom^2'), symmetry=1, barrier=(11.8645,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37045,0.060482,-8.02502e-05,5.53789e-08,-1.51675e-11,-23056.3,22.7748], Tmin=(100,'K'), Tmax=(893.725,'K')), NASAPolynomial(coeffs=[10.9781,0.0174811,-8.07804e-06,1.54219e-09,-1.07691e-13,-24773.6,-22.4971], Tmin=(893.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCsJOH) + radical(CCsJOC(O)H)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3852.64,'J/mol'), sigma=(6.2496,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=601.77 K, Pc=35.81 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    E0 = (5.2127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,1855,455,950,348.367,348.382,348.41],'cm^-1')),
        HinderedRotor(inertia=(0.00138902,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14899,'amu*angstrom^2'), symmetry=1, barrier=(12.8327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148983,'amu*angstrom^2'), symmetry=1, barrier=(12.8332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14898,'amu*angstrom^2'), symmetry=1, barrier=(12.8326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
...
species(
    label = 'O=[C]OC[C]O(5871)',
    structure = SMILES('O=[C]OC[C]O'),
    E0 = (91.2248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1855,455,950,248.384,248.41,248.523,248.676],'cm^-1')),
        HinderedRotor(inertia=(0.00273205,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00273015,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391028,'amu*angstrom^2'), symmetry=1, barrier=(17.1217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391242,'amu*angstrom^2'), symmetry=1, barrier=(17.1205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52463,0.0559612,-7.44957e-05,4.92229e-08,-1.27095e-11,11059.7,21.4876], Tmin=(100,'K'), Tmax=(952.045,'K')), NASAPolynomial(coeffs=[11.9013,0.0123644,-5.80746e-06,1.12494e-09,-7.9511e-14,9083.85,-28.0641], Tmin=(952.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(91.2248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=[C]OCC=O(3014)'],
    products = ['O=[C]OC[CH]O(5566)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[O][CH]CO[C]=O(3012)'],
    products = ['O=[C]OC[CH]O(5566)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]O[CH][CH]O(3228)', 'H(8)'],
    products = ['O=[C]OC[CH]O(5566)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C-]#[O+](374)', '[O]C[CH]O(561)'],
    products = ['O=[C]OC[CH]O(5566)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]=O(1149)', '[O]C[CH]O(561)'],
    products = ['O=[C]OC[CH]O(5566)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH]CO[C]=O(3056)'],
    products = ['O=[C]OC[CH]O(5566)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]O[C]=O(1735)', '[CH]O(5471)'],
    products = ['O=[C]OC[CH]O(5566)'],
