species(
    label = 'C=[C]CO[C]1CO1(17472)',
    structure = SMILES('C=[C]CO[C]1CO1'),
    E0 = (268.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,3150,900,1100,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,180,1025.6,1025.6,1025.6,1025.6,1025.6,1025.6,1025.6,1025.6,1025.6,2307.81],'cm^-1')),
        HinderedRotor(inertia=(0.0722186,'amu*angstrom^2'), symmetry=1, barrier=(1.66045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0722186,'amu*angstrom^2'), symmetry=1, barrier=(1.66045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0722186,'amu*angstrom^2'), symmetry=1, barrier=(1.66045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13934,0.0604677,-6.15591e-05,3.67757e-08,-8.88648e-12,32411,26.407], Tmin=(100,'K'), Tmax=(1067.03,'K')), NASAPolynomial(coeffs=[10.0694,0.0246536,-7.92609e-06,1.21312e-09,-7.32421e-14,30638.4,-16.631], Tmin=(1067.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(Cs_P)"""),
)
...
species(
    label = 'C=[C]COC1[CH]O1(17969)',
    structure = SMILES('C=[C]COC1[CH]O1'),
    E0 = (247.083,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10223,0.0607522,-5.0549e-05,1.46886e-08,2.37374e-12,29824.6,25.3731], Tmin=(100,'K'), Tmax=(831.607,'K')), NASAPolynomial(coeffs=[12.5336,0.0209084,-5.99093e-06,8.61195e-10,-5.09873e-14,27399.7,-30.8165], Tmin=(831.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCsJO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.79571,0.0537879,1.97344e-06,-6.29594e-08,3.59059e-11,19031,22.9522], Tmin=(100,'K'), Tmax=(874.149,'K')), NASAPolynomial(coeffs=[22.2316,0.00415095,4.00861e-06,-1.10539e-09,8.24175e-14,13432.3,-88.1685], Tmin=(874.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=[C]COC1CO1(17971)',
    structure = SMILES('[CH]=[C]COC1CO1'),
    E0 = (310.457,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,1685,370,180,1012.1,1012.1,1012.1,1012.1,1012.1,1012.1,1012.1,1012.1,1012.1,2319.92],'cm^-1')),
        HinderedRotor(inertia=(0.0647565,'amu*angstrom^2'), symmetry=1, barrier=(1.48888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0647565,'amu*angstrom^2'), symmetry=1, barrier=(1.48888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0647565,'amu*angstrom^2'), symmetry=1, barrier=(1.48888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02846,0.063258,-6.77814e-05,4.19463e-08,-1.03923e-11,37448.1,25.8269], Tmin=(100,'K'), Tmax=(1059.04,'K')), NASAPolynomial(coeffs=[10.5213,0.0241052,-7.65458e-06,1.15553e-09,-6.88626e-14,35622.4,-19.6417], Tmin=(1059.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = 'C=C=COC1CO1(17975)',
    structure = SMILES('C=C=COC1CO1'),
    E0 = (-55.5956,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864631,0.0513765,8.94113e-06,-7.00711e-08,3.83375e-11,-6556.93,21.0037], Tmin=(100,'K'), Tmax=(877.466,'K')), NASAPolynomial(coeffs=[22.3209,0.00386368,4.18145e-06,-1.12936e-09,8.32892e-14,-12258.7,-90.7391], Tmin=(877.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.5956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Ethylene_oxide)"""),
)

species(
    label = 'C=CCOC1=CO1(17976)',
    structure = SMILES('C=CCOC1=CO1'),
    E0 = (89.2739,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.777566,0.0606442,-3.98547e-05,8.2885e-10,6.00839e-12,10862.3,22.8905], Tmin=(100,'K'), Tmax=(978.263,'K')), NASAPolynomial(coeffs=[17.3421,0.015537,-5.37937e-06,9.7438e-10,-7.00678e-14,6538.92,-62.1927], Tmin=(978.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.2739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]COC1=CO1(17966)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=CO[C]1CO1(17967)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CCO[C]1CO1(17968)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C=[C]CO[C]1CO1(17472)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.0646,'m^3/(mol*s)'), n=2.98, Ea=(36.6473,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdNd;YJ] for rate rule [Od_CO-NdNd;CJ]
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]COC1=CO1(6587)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C=[C]CO[C]1[CH]O1(17972)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C]=CO[C]1CO1(17973)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]CO[C]1CO1(17974)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]1CO1(1125)', 'C=[C]C[O](4571)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C]=C(584)', '[CH2]O[C]1CO1(1832)'],
    products = ['C=[C]CO[C]1CO1(17472)'],
