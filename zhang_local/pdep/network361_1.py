...
species(
    label = '[CH][CH]OO[CH2](1002)',
    structure = SMILES('[CH][CH]OO[CH2]'),
    E0 = (643.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,3000,3100,440,815,1455,1000,442.14,442.164,442.166],'cm^-1')),
        HinderedRotor(inertia=(0.000862272,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000862293,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00086236,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376396,'amu*angstrom^2'), symmetry=1, barrier=(52.2196,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93472,0.0493706,-6.29783e-05,4.71791e-08,-1.48521e-11,77419.1,19.2539], Tmin=(100,'K'), Tmax=(764.46,'K')), NASAPolynomial(coeffs=[6.95329,0.0231121,-1.14563e-05,2.2495e-09,-1.59354e-13,76651.8,-3.61004], Tmin=(764.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CCJ2_triplet) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]O[O](61)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OO[CH2](688)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]O[O](697)', 'CH2(T)(28)'],
    products = ['[CH2][CH]OO[CH2](688)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(43.5839,'m^3/(mol*s)'), n=1.88017, Ea=(5.1666,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]OO[CH2](1001)', 'H(8)'],
    products = ['[CH2][CH]OO[CH2](688)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]OO[CH2](1002)', 'H(8)'],
    products = ['[CH2][CH]OO[CH2](688)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]OO[CH][CH2](1003)'],
    products = ['[CH2][CH]OO[CH2](688)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
