...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC=C=O(5481)'],
    products = ['CC[C]=O(4188)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[C]=O(4188)'],
    products = ['C[CH2](6)', '[C-]#[O+](374)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(8.417e+12,'s^-1'), n=0.428, Ea=(107.978,'kcal/mol'), T0=(1,'K'), comment="""Matched reaction 2 C3H5O <=> CO + C2H5 in R_Addition_COm/training
This reaction matched rate rule [COm;CH2CH3]
family: R_Addition_COm
Ea raised from 62.8 to 451.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['[C]=O(1149)', 'C[CH2](6)'],
    products = ['CC[C]=O(4188)'],
