...
species(
    label = '[CH2]C1OC1O[C]=C(14377)',
    structure = SMILES('[CH2]C1OC1O[C]=C'),
    E0 = (218.736,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.649524,0.0736334,-7.35123e-05,3.59962e-08,-6.42101e-12,26500,30.5581], Tmin=(100,'K'), Tmax=(1686.45,'K')), NASAPolynomial(coeffs=[17.6838,0.0100022,1.00398e-06,-5.44571e-10,4.59488e-14,23181.4,-58.9767], Tmin=(1686.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(CJCO)"""),
)
...
species(
    label = 'C=[C]OC(=O)C=C(14379)',
    structure = SMILES('C=[C]OC(=O)C=C'),
    E0 = (79.4233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,3010,987.5,1337.5,450,1655,1685,370,180,180,180,182.705,1600,1866.67,2648.15,3200],'cm^-1')),
        HinderedRotor(inertia=(0.165292,'amu*angstrom^2'), symmetry=1, barrier=(3.80038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165292,'amu*angstrom^2'), symmetry=1, barrier=(3.80038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165292,'amu*angstrom^2'), symmetry=1, barrier=(3.80038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29275,0.0659348,-9.92542e-05,8.83456e-08,-3.17376e-11,9643.73,26.8858], Tmin=(100,'K'), Tmax=(797.041,'K')), NASAPolynomial(coeffs=[6.34699,0.0309461,-1.52953e-05,2.9712e-09,-2.07479e-13,9143.73,5.56619], Tmin=(797.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.4233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)

species(
    label = 'C#COC([O])C=C(14380)',
    structure = SMILES('C#COC([O])C=C'),
    E0 = (152.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,750,770,3400,2100,1380,1390,370,380,2900,435,2175,525,3010,987.5,1337.5,450,1655,245.283,245.316,245.32,245.342],'cm^-1')),
        HinderedRotor(inertia=(0.585148,'amu*angstrom^2'), symmetry=1, barrier=(24.9868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58509,'amu*angstrom^2'), symmetry=1, barrier=(24.9857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58496,'amu*angstrom^2'), symmetry=1, barrier=(24.9885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988656,0.0643096,-6.45179e-05,3.24835e-08,-6.50902e-12,18410.8,23.0223], Tmin=(100,'K'), Tmax=(1203.27,'K')), NASAPolynomial(coeffs=[14.3732,0.0198164,-9.05336e-06,1.75406e-09,-1.24546e-13,15189.7,-44.0272], Tmin=(1203.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]=CC([O])OC=C(14388)',
    structure = SMILES('[CH]=CC([O])OC=C'),
    E0 = (189.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,283.579,283.595,283.64,283.679],'cm^-1')),
        HinderedRotor(inertia=(0.353597,'amu*angstrom^2'), symmetry=1, barrier=(20.1793,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.616273,0.0657094,-5.73725e-05,2.21849e-08,-2.56756e-12,22972.6,27.3055], Tmin=(100,'K'), Tmax=(1083.82,'K')), NASAPolynomial(coeffs=[16.9853,0.0172455,-6.83525e-06,1.27074e-09,-8.96475e-14,18722.7,-56.2207], Tmin=(1083.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][CH]C(=O)O[C]=C(14389)',
    structure = SMILES('[CH2][CH]C(=O)O[C]=C'),
    E0 = (275.75,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37455,0.0618304,-7.1546e-05,4.70407e-08,-1.28831e-11,33256,29.1579], Tmin=(100,'K'), Tmax=(875.771,'K')), NASAPolynomial(coeffs=[8.84706,0.0276999,-1.30871e-05,2.53911e-09,-1.79389e-13,31947.2,-5.90127], Tmin=(875.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCC=O) + radical(C=CJO) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]=CC([O])O[C]=C(14391)',
    structure = SMILES('[CH]=CC([O])O[C]=C'),
    E0 = (429.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,229.732,229.738,229.759,4000],'cm^-1')),
        HinderedRotor(inertia=(0.636634,'amu*angstrom^2'), symmetry=1, barrier=(23.8439,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.636706,'amu*angstrom^2'), symmetry=1, barrier=(23.844,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.636751,'amu*angstrom^2'), symmetry=1, barrier=(23.8439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25581,0.0623348,-6.60387e-05,3.70296e-08,-8.45682e-12,51775.1,28.1443], Tmin=(100,'K'), Tmax=(1049.72,'K')), NASAPolynomial(coeffs=[11.3371,0.0239195,-1.11447e-05,2.16669e-09,-1.53844e-13,49658.7,-20.981], Tmin=(1049.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=[C]OC([O])C=C(14392)',
    structure = SMILES('[CH]=[C]OC([O])C=C'),
    E0 = (429.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,229.732,229.738,229.759,4000],'cm^-1')),
...
species(
    label = 'C=[C]OC1[CH]CO1(14393)',
    structure = SMILES('C=[C]OC1[CH]CO1'),
    E0 = (214.16,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57498,0.0352265,4.03605e-05,-9.24415e-08,4.36242e-11,25862,25.8309], Tmin=(100,'K'), Tmax=(887.21,'K')), NASAPolynomial(coeffs=[18.4746,0.00851382,1.86921e-06,-6.59072e-10,4.89479e-14,20915.9,-64.652], Tmin=(887.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CCJCO) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33843,0.0610141,-6.04271e-05,3.23541e-08,-7.17668e-12,-19188.3,23.6022], Tmin=(100,'K'), Tmax=(1068.28,'K')), NASAPolynomial(coeffs=[10.461,0.0268558,-1.24642e-05,2.42228e-09,-1.71923e-13,-21137.4,-21.0113], Tmin=(1068.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-160.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=[C]OC(=O)C=C(14379)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#COC([O])C=C(14380)'],
    products = ['C=[C]OC([O])C=C(12763)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C=[C]OC([O])C=C(12763)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(11.6997,'m^3/(mol*s)'), n=2.021, Ea=(151.684,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd;CJ]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from 147.7 to 151.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(64)', 'C=[C]OC=O(4555)'],
    products = ['C=[C]OC([O])C=C(12763)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['C=[C]OC([O])C=C(12763)'],
    products = ['[CH2][CH]C(=O)OC=C(14383)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(64)', '[CH2][C]OC=O(4560)'],
    products = ['C=[C]OC([O])C=C(12763)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][CH]C(=O)O[C]=C(14389)'],
    products = ['C=[C]OC([O])C=C(12763)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=CC([O])O[C]=C(14391)'],
    products = ['C=[C]OC([O])C=C(12763)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]OC([O])C=C(14392)'],
    products = ['C=[C]OC([O])C=C(12763)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[C]=C(584)', 'C=CC([O])[O](12634)'],
    products = ['C=[C]OC([O])C=C(12763)'],
