...
species(
    label = '[CH]=C(C)O[C]=C(17884)',
    structure = SMILES('[CH]=C(C)O[C]=C'),
    E0 = (414.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,395.301,395.367],'cm^-1')),
        HinderedRotor(inertia=(0.0814654,'amu*angstrom^2'), symmetry=1, barrier=(9.03524,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0814806,'amu*angstrom^2'), symmetry=1, barrier=(9.03488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0814226,'amu*angstrom^2'), symmetry=1, barrier=(9.03582,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83061,0.0499528,-4.576e-05,2.41744e-08,-5.46707e-12,49972.7,24.3696], Tmin=(100,'K'), Tmax=(1032.99,'K')), NASAPolynomial(coeffs=[7.87858,0.0265339,-1.17541e-05,2.22822e-09,-1.55821e-13,48723.2,-5.00482], Tmin=(1032.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = 'C#CO[C]([CH2])C(17886)',
    structure = SMILES('C#CO[C]([CH2])C'),
    E0 = (378.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,750,770,3400,2100,3000,3100,440,815,1455,1000,2175,525,360,370,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.799861,'amu*angstrom^2'), symmetry=1, barrier=(18.3904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800164,'amu*angstrom^2'), symmetry=1, barrier=(18.3973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.800519,'amu*angstrom^2'), symmetry=1, barrier=(18.4055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80002,'amu*angstrom^2'), symmetry=1, barrier=(18.394,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481112,0.078948,-0.000108823,7.5956e-08,-2.06435e-11,45661.6,21.0657], Tmin=(100,'K'), Tmax=(908.36,'K')), NASAPolynomial(coeffs=[14.4799,0.0173048,-7.03209e-06,1.25054e-09,-8.34308e-14,43118.4,-45.1253], Tmin=(908.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#COC([CH2])=C(17883)'],
    products = ['[CH2]C(=C)O[C]=C(6487)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C(=C)O[C]=C(17887)'],
    products = ['[CH2]C(=C)O[C]=C(6487)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', 'C=[C]O[C]=C(4760)'],
    products = ['[CH2]C(=C)O[C]=C(6487)'],
