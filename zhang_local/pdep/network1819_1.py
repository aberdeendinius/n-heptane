...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.545463,0.082236,-0.000118937,9.89457e-08,-3.3443e-11,63323.2,34.0138], Tmin=(100,'K'), Tmax=(788.56,'K')), NASAPolynomial(coeffs=[8.99815,0.0337854,-1.61716e-05,3.10155e-09,-2.15343e-13,62163.4,-3.65879], Tmin=(788.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(525.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ) + radical(CJCO) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH2][CH][CH]O[C]([CH2])O(6736)',
    structure = SMILES('[CH2][CH][CH]O[C]([CH2])O'),
    E0 = (505.056,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.328356,0.0843178,-0.000111519,7.76668e-08,-2.15006e-11,60873.2,34.6283], Tmin=(100,'K'), Tmax=(884.32,'K')), NASAPolynomial(coeffs=[13.3894,0.0252421,-1.13186e-05,2.13184e-09,-1.47647e-13,58563.1,-26.7787], Tmin=(884.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(Cs_P) + radical(CJCO) + radical(RCCJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH][CH]O[C](C)[O](6737)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.751883,0.0775835,-0.000108986,9.13055e-08,-3.14968e-11,62553,33.3271], Tmin=(100,'K'), Tmax=(776.09,'K')), NASAPolynomial(coeffs=[7.86642,0.0354659,-1.70514e-05,3.28613e-09,-2.29155e-13,61612.8,1.86418], Tmin=(776.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(519.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJ) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH2][CH][CH]O[C]([CH2])[O](6738)',
    structure = SMILES('[CH2][CH][CH]O[C]([CH2])[O]'),
    E0 = (730.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.542887,0.0834647,-0.000131224,1.13677e-07,-3.89499e-11,88007.6,34.709], Tmin=(100,'K'), Tmax=(822.972,'K')), NASAPolynomial(coeffs=[8.95524,0.031201,-1.52306e-05,2.91724e-09,-2.01215e-13,87008.2,-1.8962], Tmin=(822.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(730.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCOJ) + radical(RCCJ) + radical(CJCO) + radical(Cs_P) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603879,0.0846697,-0.000140228,1.29564e-07,-4.67046e-11,96164.2,32.4516], Tmin=(100,'K'), Tmax=(829.918,'K')), NASAPolynomial(coeffs=[6.49488,0.0368198,-1.85776e-05,3.59427e-09,-2.48758e-13,95856.4,9.16603], Tmin=(829.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(798.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJ) + radical(CJCO) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH][C]([O])OC[CH][CH2](6741)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.974719,0.0739808,-0.000110877,9.97843e-08,-3.63398e-11,94747.7,34.0824], Tmin=(100,'K'), Tmax=(795.329,'K')), NASAPolynomial(coeffs=[6.06578,0.0366201,-1.82427e-05,3.55053e-09,-2.48195e-13,94309.7,13.0243], Tmin=(795.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(786.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJCO)"""),
)

species(
    label = '[CH][CH]CO[C]([CH2])[O](6742)',
    structure = SMILES('[CH][CH]CO[C]([CH2])[O]'),
    E0 = (793.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773236,0.0785684,-0.000120568,1.07037e-07,-3.80969e-11,95517.6,33.6532], Tmin=(100,'K'), Tmax=(804.114,'K')), NASAPolynomial(coeffs=[7.18436,0.0349636,-1.73774e-05,3.36952e-09,-2.34687e-13,94865.3,6.47566], Tmin=(804.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(793.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCOJ) + radical(Cs_P) + radical(CJCO) + radical(CCJCO)"""),
)
...
reaction(
    ...
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.26699,'m^3/(mol*s)'), n=2.00263, Ea=(106.867,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    products = ['[CH2]C[CH]O[C]([CH2])[O](6734)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    products = ['[CH2][CH][CH]OC([CH2])[O](6735)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    products = ['[CH2][C]([O])O[CH][CH]C(2382)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    products = ['[CH2][CH][CH]O[C]([CH2])O(6736)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
    products = ['[CH2][CH][CH]O[C](C)[O](6737)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][CH][CH]O[C]([CH2])[O](6738)'],
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C][O](2305)', '[CH2][CH]C[O](429)'],
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[C]([CH2])[O](1016)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]CO[C]([CH2])[O](6740)'],
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH][C]([O])OC[CH][CH2](6741)'],
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH][CH]CO[C]([CH2])[O](6742)'],
    products = ['[CH2][CH]CO[C]([CH2])[O](2383)'],
