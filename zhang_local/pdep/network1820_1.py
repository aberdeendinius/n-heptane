...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0847164,0.110341,-0.000219214,2.16956e-07,-7.87982e-11,63239.3,31.0101], Tmin=(100,'K'), Tmax=(879.897,'K')), NASAPolynomial(coeffs=[3.64159,0.0441499,-2.24141e-05,4.23316e-09,-2.84118e-13,64490.1,24.3437], Tmin=(879.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(524.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]C([CH2])O[C]([CH2])[O](6731)',
    structure = SMILES('[CH]C([CH2])O[C]([CH2])[O]'),
    E0 = (793.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180874,0.0948732,-0.000163423,1.48458e-07,-5.18757e-11,95542.7,32.69], Tmin=(100,'K'), Tmax=(849.059,'K')), NASAPolynomial(coeffs=[8.52797,0.033764,-1.69763e-05,3.25131e-09,-2.22593e-13,94910.5,-1.58981], Tmin=(849.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(793.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJCO) + radical(CCJ2_triplet) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH][C]([O])OC([CH2])[CH2](6732)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0401277,0.102697,-0.000188002,1.74998e-07,-6.14305e-11,95418.1,31.9087], Tmin=(100,'K'), Tmax=(867.294,'K')), NASAPolynomial(coeffs=[8.05391,0.0347718,-1.76078e-05,3.34619e-09,-2.26565e-13,95164.8,0.64586], Tmin=(867.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(20.6376,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;Y_1centerbirad] for rate rule [Cds-OsH_Cds;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 20.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(112.527,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2][C](C)O[C]([CH2])[O](2367)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2][C]([CH2])O[C]([CH2])O(6726)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2][C]([CH2])O[C](C)[O](6727)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][C]([CH2])O[C]([CH2])[O](6728)'],
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2][C](C)OC([CH2])=O(2359)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2]C(=C)OC([CH2])[O](6729)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2]C(=O)OC([CH2])[CH2](6108)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C][O](2305)', '[CH2]C([CH2])[O](740)'],
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C([CH2])O[C]([CH2])[O](6731)'],
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH][C]([O])OC([CH2])[CH2](6732)'],
    products = ['[CH2][C]([O])OC([CH2])[CH2](2368)'],
