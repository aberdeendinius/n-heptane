...
species(
    label = 'C=C=C(O)O[CH]C(28130)',
    structure = SMILES('C=C=C(O)O[CH]C'),
    E0 = (-8.1376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,540,610,2055,350,440,435,1725,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.879014,'amu*angstrom^2'), symmetry=1, barrier=(20.2103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879437,'amu*angstrom^2'), symmetry=1, barrier=(20.22,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.878975,'amu*angstrom^2'), symmetry=1, barrier=(20.2094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879063,'amu*angstrom^2'), symmetry=1, barrier=(20.2114,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.587602,0.0912165,-0.000108437,6.18223e-08,-1.33895e-11,-805.219,25.2683], Tmin=(100,'K'), Tmax=(1181.73,'K')), NASAPolynomial(coeffs=[22.6911,0.0100526,-2.40768e-06,3.10153e-10,-1.75661e-14,-6141.68,-90.2255], Tmin=(1181.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.1376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C#CC(O)O[CH]C(28131)',
    structure = SMILES('C#CC(O)O[CH]C'),
    E0 = (-24.3306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,3615,1277.5,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.319059,0.0830686,-0.000108402,7.55797e-08,-2.08794e-11,-2795.67,26.4746], Tmin=(100,'K'), Tmax=(888.723,'K')), NASAPolynomial(coeffs=[13.2684,0.0247837,-1.00241e-05,1.78031e-09,-1.18723e-13,-5097.26,-34.4704], Tmin=(888.723,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.3306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537875,0.0820698,-0.000111947,9.04814e-08,-3.02386e-11,9583.79,29.7335], Tmin=(100,'K'), Tmax=(763.278,'K')), NASAPolynomial(coeffs=[8.749,0.0364524,-1.72164e-05,3.30112e-09,-2.29892e-13,8405.66,-7.16871], Tmin=(763.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.6942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0885557,0.0818662,-8.02884e-05,3.57108e-08,-4.94466e-12,1437.87,25.7051], Tmin=(100,'K'), Tmax=(987.243,'K')), NASAPolynomial(coeffs=[19.3731,0.0180379,-6.13643e-06,1.05246e-09,-7.16979e-14,-3136.99,-71.6445], Tmin=(987.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.6717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=[C]C(O)OCC(28134)',
    structure = SMILES('[CH]=[C]C(O)OCC'),
    E0 = (114.201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.616334,0.0804131,-0.000108945,8.89334e-08,-3.01648e-11,13851.4,29.2208], Tmin=(100,'K'), Tmax=(764.052,'K')), NASAPolynomial(coeffs=[8.168,0.0374133,-1.77245e-05,3.4042e-09,-2.37326e-13,12798.6,-4.51747], Tmin=(764.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328771,0.0830101,-8.53026e-05,4.34378e-08,-8.51924e-12,-24136.6,24.8714], Tmin=(100,'K'), Tmax=(1300.64,'K')), NASAPolynomial(coeffs=[20.9188,0.0153567,-4.61688e-06,7.16175e-10,-4.52838e-14,-29468.4,-82.4701], Tmin=(1300.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-202.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    E0 = (-58.3656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,335.897,336.109,336.61],'cm^-1')),
        HinderedRotor(inertia=(0.00149323,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145995,'amu*angstrom^2'), symmetry=1, barrier=(11.7515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146223,'amu*angstrom^2'), symmetry=1, barrier=(11.7503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146636,'amu*angstrom^2'), symmetry=1, barrier=(11.748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]C(O)O[C]C(28139)',
    structure = SMILES('C=[C]C(O)O[C]C'),
    E0 = (328.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.555592,0.0818026,-0.000113226,8.83113e-08,-2.8168e-11,39579,27.7744], Tmin=(100,'K'), Tmax=(762.456,'K')), NASAPolynomial(coeffs=[9.99985,0.0322531,-1.57399e-05,3.0675e-09,-2.15877e-13,38138.9,-15.2268], Tmin=(762.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C=C(O)O[CH]C(28130)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=[C]C(O)OC=C(27713)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CC(O)O[CH]C(28131)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C=[C]C(O)O[CH]C(13668)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4e+09,'cm^3/(mol*s)'), n=1.39, Ea=(38.7953,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 37.2 to 38.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', 'C=C=CO[CH]C(17690)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH2][C]=CO[CH]C(17693)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][C]=C(O)O[CH]C(28135)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][CH]OC(O)[C]=C(14734)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]C(O)O[CH]C(28136)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(32)', 'C=[C]C([O])O(27711)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=C(584)', 'C[CH]O[CH]O(3779)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH3](11)', '[CH]OC(O)[C]=C(28075)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', 'C=[C]C(O)O[C]C(28139)'],
    products = ['C=[C]C(O)O[CH]C(13668)'],
