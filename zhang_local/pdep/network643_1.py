...
species(
    label = 'C=C(C)O[C]1CO1(1867)',
    structure = SMILES('C=C(C)O[C]1CO1'),
    E0 = (-32.7195,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,3150,900,1100,350,440,435,1725,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.913309,0.0552893,-1.01855e-05,-4.03983e-08,2.48715e-11,-3812.1,23.3532], Tmin=(100,'K'), Tmax=(880.03,'K')), NASAPolynomial(coeffs=[18.181,0.0133662,-1.0505e-06,-1.06109e-10,1.31626e-14,-8267.17,-65.791], Tmin=(880.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.7195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cs_P)"""),
)
...
species(
    label = '[CH2]C(C)OC1=CO1(1868)',
    structure = SMILES('[CH2]C(C)OC1=CO1'),
    E0 = (153.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,180,180,410.174,724.756,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.154594,'amu*angstrom^2'), symmetry=1, barrier=(3.55442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154594,'amu*angstrom^2'), symmetry=1, barrier=(3.55442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154594,'amu*angstrom^2'), symmetry=1, barrier=(3.55442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154594,'amu*angstrom^2'), symmetry=1, barrier=(3.55442,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731903,0.0726816,-8.28999e-05,5.6815e-08,-1.57473e-11,8244.68,25.4481], Tmin=(100,'K'), Tmax=(970.282,'K')), NASAPolynomial(coeffs=[9.43359,0.031493,-1.10066e-05,1.77173e-09,-1.10119e-13,6806.29,-14.9806], Tmin=(970.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.5788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOCs) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C(C)OC1[CH]O1(1870)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359972,0.0759949,-6.81129e-05,2.23976e-08,1.90473e-12,9259.13,26.1142], Tmin=(100,'K'), Tmax=(836.355,'K')), NASAPolynomial(coeffs=[15.883,0.0214525,-5.62187e-06,7.47567e-10,-4.18794e-14,5973.61,-50.1204], Tmin=(836.355,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.8611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH2][C](C)OC1CO1(1871)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.335842,0.0847951,-0.000116235,8.9665e-08,-2.68401e-11,8888.94,25.934], Tmin=(100,'K'), Tmax=(963.344,'K')), NASAPolynomial(coeffs=[9.86906,0.0312055,-1.09836e-05,1.73581e-09,-1.04775e-13,7702.07,-16.3292], Tmin=(963.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.8425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2]C([CH2])OC1CO1(1872)',
    structure = SMILES('[CH2]C([CH2])OC1CO1'),
    E0 = (102.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394667,0.0824505,-8.94733e-05,3.95563e-08,4.27649e-13,12473,24.878], Tmin=(100,'K'), Tmax=(696.583,'K')), NASAPolynomial(coeffs=[13.7378,0.0251508,-7.69066e-06,1.10375e-09,-6.23231e-14,10145.4,-38.035], Tmin=(696.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = 'CC(C)O[C]1[CH]O1(1873)',
    structure = SMILES('CC(C)O[C]1[CH]O1'),
    E0 = (70.5973,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00410096,0.0728628,-6.68794e-05,3.25117e-08,-6.09186e-12,8647.6,28.3197], Tmin=(100,'K'), Tmax=(1480.31,'K')), NASAPolynomial(coeffs=[16.3593,0.0200397,-4.61006e-06,5.30532e-10,-2.57521e-14,4750.88,-53.8069], Tmin=(1480.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.5973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
species(
    label = '[CH2][C](C)O[C]1CO1(1874)',
    structure = SMILES('[CH2][C](C)O[C]1CO1'),
    E0 = (278.089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378305,0.0854664,-0.000126468,1.01637e-07,-3.11592e-11,33571.4,27.1627], Tmin=(100,'K'), Tmax=(961.881,'K')), NASAPolynomial(coeffs=[9.62953,0.0289672,-1.02472e-05,1.60073e-09,-9.47871e-14,32625.7,-12.7744], Tmin=(961.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(C)O[C]1[CH]O1(1875)',
    structure = SMILES('[CH2]C(C)O[C]1[CH]O1'),
    E0 = (281.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.428098,0.0762961,-7.66698e-05,3.1487e-08,-7.79494e-13,33940.5,27.2548], Tmin=(100,'K'), Tmax=(806.8,'K')), NASAPolynomial(coeffs=[15.6967,0.0191283,-4.8379e-06,6.01581e-10,-3.10092e-14,30873.6,-46.8674], Tmin=(806.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC) + radical(Cs_P)"""),
)
...
species(
    label = 'C=C(C)OC1CO1(1877)',
    structure = SMILES('C=C(C)OC1CO1'),
    E0 = (-237.966,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868291,0.0546592,-1.59141e-07,-5.19879e-08,2.89648e-11,-28494.5,22.133], Tmin=(100,'K'), Tmax=(887.4,'K')), NASAPolynomial(coeffs=[18.3948,0.0156471,-1.81093e-06,3.4576e-11,2.71551e-15,-33179.6,-69.2001], Tmin=(887.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'CC(C)OC1=CO1(1878)',
    structure = SMILES('CC(C)OC1=CO1'),
    E0 = (-56.7082,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359051,0.0676872,-3.8718e-05,-6.66755e-09,9.70251e-12,-6678.2,22.4966], Tmin=(100,'K'), Tmax=(969.691,'K')), NASAPolynomial(coeffs=[19.2233,0.0182446,-6.12529e-06,1.09892e-09,-7.91113e-14,-11670.6,-74.8099], Tmin=(969.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.7082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene)"""),
)
...
species(
    label = '[CH]C(C)O[C]1CO1(1880)',
    structure = SMILES('[CH]C(C)O[C]1CO1'),
    E0 = (335.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.416911,0.0693241,-6.69073e-05,3.4965e-08,-7.13746e-12,40439.1,28.3268], Tmin=(100,'K'), Tmax=(1319.46,'K')), NASAPolynomial(coeffs=[14.5425,0.0208997,-5.48858e-06,7.14964e-10,-3.83878e-14,37199.2,-41.889], Tmin=(1319.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(C)O[C]1CO1(1867)', 'H(8)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)OC1=CO1(1868)', 'H(8)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CO[C]1CO1(1779)', '[CH3](11)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C)O[C]1CO1(1756)'],
    products = ['[CH2]C(C)OC1[CH]O1(1870)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])OC1CO1(1872)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)O[C]1CO1(1756)'],
    products = ['CC(C)O[C]1[CH]O1(1873)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH2][CH]O[C]1CO1(1830)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C](C)O[C]1CO1(1874)', 'H(8)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C(C)O[C]1[CH]O1(1875)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([CH2])O[C]1CO1(1876)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(=O)OC([CH2])C(1460)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]CO[C]1CO1(1753)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(C)O[C]1CO1(1880)', 'H(8)'],
    products = ['[CH2]C(C)O[C]1CO1(1756)'],
