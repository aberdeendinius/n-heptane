...
species(
    ...
    E0 = (-134.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,995.004,4000],'cm^-1')),
        HinderedRotor(inertia=(0.599014,'amu*angstrom^2'), symmetry=1, barrier=(13.7725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285632,'amu*angstrom^2'), symmetry=1, barrier=(6.56725,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93711,0.0500476,-5.35407e-05,2.53446e-08,5.3248e-14,-5442.52,19.095], Tmin=(100,'K'), Tmax=(608.368,'K')), NASAPolynomial(coeffs=[7.28514,0.0237171,-1.03976e-05,1.93182e-09,-1.3246e-13,-6256.68,-5.39163], Tmin=(608.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.8331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    E0 = (179.872,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,2458.31],'cm^-1')),
        HinderedRotor(inertia=(0.129439,'amu*angstrom^2'), symmetry=1, barrier=(2.97605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129476,'amu*angstrom^2'), symmetry=1, barrier=(2.9769,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC(=O)C[O](1042)'],
    products = ['CC([O])C[O](3594)'],
    transitionState = 'TS2',
