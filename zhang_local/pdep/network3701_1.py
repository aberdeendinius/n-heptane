...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.806807,'amu*angstrom^2'), symmetry=1, barrier=(18.5501,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275186,'amu*angstrom^2'), symmetry=1, barrier=(6.32706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144405,'amu*angstrom^2'), symmetry=1, barrier=(18.5272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.86349,'amu*angstrom^2'), symmetry=1, barrier=(42.8454,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.889054,0.0597985,-3.35785e-05,4.73206e-09,1.53685e-12,23570.7,22.2173], Tmin=(100,'K'), Tmax=(1127.35,'K')), NASAPolynomial(coeffs=[12.6999,0.030786,-1.21322e-05,2.19515e-09,-1.50418e-13,20088.3,-39.8132], Tmin=(1127.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C)=C([CH2])C(17559)',
    structure = SMILES('[CH2]C(C)=C([CH2])C'),
    E0 = (194.986,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH]=C(C)C([CH2])C(17560)',
    structure = SMILES('[CH]=C(C)C([CH2])C'),
    E0 = (369.034,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3120,650,792.5,1650,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.0932298,'amu*angstrom^2'), symmetry=1, barrier=(5.2088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0942909,'amu*angstrom^2'), symmetry=1, barrier=(5.24798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0907281,'amu*angstrom^2'), symmetry=1, barrier=(5.22211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390068,'amu*angstrom^2'), symmetry=1, barrier=(21.6434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01977,0.0586177,-3.51249e-05,6.72518e-09,1.23188e-12,44497.7,25.7157], Tmin=(100,'K'), Tmax=(1046.42,'K')), NASAPolynomial(coeffs=[11.4005,0.0304179,-1.11593e-05,1.94213e-09,-1.30434e-13,41696.6,-27.8399], Tmin=(1046.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C(=C)C(C)C(17561)',
    structure = SMILES('[CH]C(=C)C(C)C'),
    E0 = (287.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,441.397,441.399,441.399,441.399],'cm^-1')),
        HinderedRotor(inertia=(0.375706,'amu*angstrom^2'), symmetry=1, barrier=(51.9443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375701,'amu*angstrom^2'), symmetry=1, barrier=(51.9443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375707,'amu*angstrom^2'), symmetry=1, barrier=(51.9444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375705,'amu*angstrom^2'), symmetry=1, barrier=(51.9443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10219,0.0529931,-4.25268e-06,-2.56608e-08,1.19336e-11,34696.6,23.6522], Tmin=(100,'K'), Tmax=(1031.51,'K')), NASAPolynomial(coeffs=[11.2091,0.0368954,-1.4428e-05,2.62101e-09,-1.81463e-13,31382.9,-31.3771], Tmin=(1031.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2]C([CH2])=CC(17537)',
    structure = SMILES('[CH2]C([CH2])=CC'),
    E0 = (234.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(0.0177534,'amu*angstrom^2'), symmetry=1, barrier=(20.205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.879149,'amu*angstrom^2'), symmetry=1, barrier=(20.2134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.61154,'amu*angstrom^2'), symmetry=1, barrier=(106.028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]C(C)C([CH2])=C(17568)',
    structure = SMILES('[CH]C(C)C([CH2])=C'),
    E0 = (516.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,180,927.109,927.217,927.278],'cm^-1')),
        HinderedRotor(inertia=(0.0209696,'amu*angstrom^2'), symmetry=1, barrier=(12.7937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143314,'amu*angstrom^2'), symmetry=1, barrier=(3.29507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556546,'amu*angstrom^2'), symmetry=1, barrier=(12.7961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0578435,'amu*angstrom^2'), symmetry=1, barrier=(35.2807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07392,0.0533695,-1.48385e-05,-1.95022e-08,1.14929e-11,62244,23.9281], Tmin=(100,'K'), Tmax=(992.664,'K')), NASAPolynomial(coeffs=[14.1728,0.0251405,-9.28463e-06,1.68579e-09,-1.18726e-13,58433.7,-45.2634], Tmin=(992.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(516.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)C(=C)C(17557)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', '[CH2]C(=C)C=C(6424)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])=C(C)C(17558)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)C([CH2])C(6155)'],
    products = ['[CH2]C(C)=C([CH2])C(17559)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C)C([CH2])C(17560)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])C(=C)C(6154)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH2]C=C([CH2])[CH2](6421)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C([CH2])=C([CH2])C(17562)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C(=C)C([CH2])C(17563)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C](C)C([CH2])[CH2](6158)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(14)', '[CH2]CC([CH2])=C(6135)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])=CC(17537)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', '[CH2]C(C)[C]=C(4359)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C(C)C([CH2])=C(17568)'],
    products = ['[CH2]C(=C)C([CH2])C(6155)'],
