species(
    label = '[CH2][C]([CH2])OO[C]=O(10150)',
    structure = SMILES('[CH2][C]([CH2])OO[C]=O'),
    E0 = (346.463,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,360,370,350,350,500,795,815,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100],'cm^-1')),
        HinderedRotor(inertia=(1.32943,'amu*angstrom^2'), symmetry=1, barrier=(49.3323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186815,'amu*angstrom^2'), symmetry=1, barrier=(39.4196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185452,'amu*angstrom^2'), symmetry=1, barrier=(39.4017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185635,'amu*angstrom^2'), symmetry=1, barrier=(39.4396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184772,'amu*angstrom^2'), symmetry=1, barrier=(39.4397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.916875,0.0650879,-6.61156e-05,3.32012e-08,-6.59881e-12,41783.1,28.1949], Tmin=(100,'K'), Tmax=(1216.63,'K')), NASAPolynomial(coeffs=[15.1161,0.0184044,-8.5592e-06,1.66268e-09,-1.18148e-13,38328.1,-43.0925], Tmin=(1216.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCOOH) + radical(CJCOOH) + radical(C2CsJOOC) + radical((O)CJOC)"""),
)
...
species(
    label = '[CH][C]([CH2])OO[C]=O(10812)',
    structure = SMILES('[CH][C]([CH2])OO[C]=O'),
    E0 = (580.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,360,370,350,350,500,795,815,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991416,0.0646913,-6.99071e-05,3.70177e-08,-7.72969e-12,69953.6,27.6303], Tmin=(100,'K'), Tmax=(1162.42,'K')), NASAPolynomial(coeffs=[14.8923,0.0168567,-8.18062e-06,1.61639e-09,-1.15955e-13,66721.8,-41.5257], Tmin=(1162.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(580.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(212.019,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCOOH) + radical((O)CJOC) + radical(C2CsJOOC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])OO[C]=O(10150)'],
...
reaction(
    ...
    products = ['[CH2][C]([CH2])OO[C]=O(10150)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C-]#[O+](374)', '[CH2][C]([CH2])O[O](10040)'],
    products = ['[CH2][C]([CH2])OO[C]=O(10150)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CO3t2(1168)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OO[C]=O(10150)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=O(1149)', '[CH2][C]([CH2])O[O](10040)'],
    products = ['[CH2][C]([CH2])OO[C]=O(10150)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(43.5839,'m^3/(mol*s)'), n=1.88017, Ea=(5.1666,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH][C]([CH2])OO[C]=O(10812)'],
    products = ['[CH2][C]([CH2])OO[C]=O(10150)'],
    transitionState = 'TS7',
