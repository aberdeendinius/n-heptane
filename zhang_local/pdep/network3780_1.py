...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C=CC[C]=O(17857)'],
    products = ['C=[C]CC[C]=O(17487)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=[C]CC=C=O(17858)'],
    products = ['C=[C]CC[C]=O(17487)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C]=CC[C]=O(17860)'],
    products = ['C=[C]CC[C]=O(17487)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', 'C=[C]C[CH][C]=O(17861)'],
    products = ['C=[C]CC[C]=O(17487)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=[C]CC[C]=O(17862)'],
    products = ['C=[C]CC[C]=O(17487)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C-]#[O+](374)', '[CH2]C[C]=C(4316)'],
    products = ['C=[C]CC[C]=O(17487)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[C]=C(584)', '[CH2]C[C]=O(3064)'],
    products = ['C=[C]CC[C]=O(17487)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[C]=O(1149)', '[CH2]C[C]=C(4316)'],
    products = ['C=[C]CC[C]=O(17487)'],
