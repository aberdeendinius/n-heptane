...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23981,0.0386485,4.06862e-05,-1.09725e-07,5.54342e-11,8030.97,23.031], Tmin=(100,'K'), Tmax=(866.512,'K')), NASAPolynomial(coeffs=[24.917,-0.0073754,1.08232e-05,-2.47765e-09,1.78445e-13,1552.17,-101.513], Tmin=(866.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.7706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1(O)[CH]O1(1838)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86201,0.0472113,2.35968e-05,-9.69349e-08,5.20716e-11,6098.41,22.0935], Tmin=(100,'K'), Tmax=(864.762,'K')), NASAPolynomial(coeffs=[26.9383,-0.00970217,1.18182e-05,-2.66751e-09,1.91909e-13,-793.49,-113.693], Tmin=(864.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.5909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(RCCJ)"""),
)

species(
    label = 'CCC1([O])[CH]O1(1839)',
    structure = SMILES('CCC1([O])[CH]O1'),
    E0 = (76.3348,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40453,0.0443018,4.35204e-06,-5.3195e-08,2.97992e-11,9286.71,19.6256], Tmin=(100,'K'), Tmax=(866.066,'K')), NASAPolynomial(coeffs=[17.4855,0.00792166,1.73479e-06,-6.63326e-10,5.298e-14,5080.21,-63.8476], Tmin=(866.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.3348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCsJO)"""),
)
...
species(
    label = '[CH2]CC1([O])[CH]O1(1841)',
    structure = SMILES('[CH2]CC1([O])[CH]O1'),
    E0 = (281.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.134186,0.0603831,-5.97962e-05,2.94121e-08,-5.25614e-12,34026.9,25.9783], Tmin=(100,'K'), Tmax=(1699.71,'K')), NASAPolynomial(coeffs=[14.315,0.00933801,8.47664e-07,-4.91134e-10,4.19074e-14,31759.1,-42.4485], Tmin=(1699.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(RCCJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26494,0.0389065,3.82462e-05,-1.04984e-07,5.30363e-11,-25466.7,18.4634], Tmin=(100,'K'), Tmax=(867.771,'K')), NASAPolynomial(coeffs=[24.0769,-0.00540665,9.68021e-06,-2.24606e-09,1.6211e-13,-31716.4,-101.554], Tmin=(867.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(135.922,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 134.5 to 135.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C=CC1([O])CO1(1780)', 'H(8)'],
    products = ['[CH2]CC1([O])CO1(1401)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(18)', '[O][C]1CO1(1828)'],
    products = ['[CH2]CC1([O])CO1(1401)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][CH]C1([O])CO1(1840)'],
    products = ['[CH2]CC1([O])CO1(1401)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]CC1([O])[CH]O1(1841)', 'H(8)'],
    products = ['[CH2]CC1([O])CO1(1401)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(=C)[O](725)', 'O(S)(1732)'],
    products = ['[CH2]CC1([O])CO1(1401)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]CC1([O])CO1(1848)'],
    products = ['[CH2]CC1([O])CO1(1401)'],
