...
species(
    label = '[CH]=[C]OC=O(5350)',
    structure = SMILES('[CH]=[C]OC=O'),
    E0 = (192.641,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.126957,'amu*angstrom^2'), symmetry=1, barrier=(23.4882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02364,'amu*angstrom^2'), symmetry=1, barrier=(23.5356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#CO[C]=O(5349)'],
    products = ['[CH]=CO[C]=O(5176)'],
    transitionState = 'TS2',
