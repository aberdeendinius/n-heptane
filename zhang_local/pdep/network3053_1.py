...
species(
    label = '[CH2]CC(=O)C([CH2])([O])[O](12232)',
    structure = SMILES('[CH2]CC(=O)C([CH2])([O])[O]'),
    E0 = (248.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,180,470.398,674.694,1600,1828.57,2971.43,3200],'cm^-1')),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.357194,0.0954685,-0.000126494,8.31735e-08,-2.11498e-11,30102.6,32.7905], Tmin=(100,'K'), Tmax=(972.516,'K')), NASAPolynomial(coeffs=[18.4886,0.0179545,-6.93612e-06,1.21523e-09,-8.10201e-14,26437.1,-57.604], Tmin=(972.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(C=OCOJ) + radical(CJC(O)2C) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]C([O])([O])C1(O)[CH]C1(12558)',
    structure = SMILES('[CH2]C([O])([O])C1(O)[CH]C1'),
    E0 = (299.686,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.978435,0.0705581,-7.24943e-05,4.14665e-08,-9.94489e-12,36149.2,29.184], Tmin=(100,'K'), Tmax=(987.682,'K')), NASAPolynomial(coeffs=[10.2377,0.0330588,-1.55433e-05,3.02539e-09,-2.14667e-13,34320.2,-15.3719], Tmin=(987.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])(O)C1([O])[CH]C1(12559)',
    structure = SMILES('[CH2]C([O])(O)C1([O])[CH]C1'),
    E0 = (296.611,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124282,0.0748261,-6.31138e-05,1.8562e-08,7.6328e-13,35822.9,31.7204], Tmin=(100,'K'), Tmax=(996.959,'K')), NASAPolynomial(coeffs=[19.9623,0.0159616,-5.73676e-06,1.05014e-09,-7.53581e-14,30837.1,-69.0927], Tmin=(996.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CC([O])([O])C1([O])[CH]C1(12560)',
    structure = SMILES('CC([O])([O])C1([O])[CH]C1'),
    E0 = (312.219,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04323,0.061046,-4.58849e-05,1.73229e-08,-2.66207e-12,37660.7,28.7336], Tmin=(100,'K'), Tmax=(1507.66,'K')), NASAPolynomial(coeffs=[14.0271,0.0265986,-1.16128e-05,2.16844e-09,-1.49186e-13,33745.6,-39.2371], Tmin=(1507.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C([O])([O])C1([O])[CH]C1(12561)',
    structure = SMILES('[CH2]C([O])([O])C1([O])[CH]C1'),
    E0 = (528.602,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24712,0.0659154,-6.76718e-05,3.95867e-08,-9.91865e-12,63670.7,28.2859], Tmin=(100,'K'), Tmax=(936.956,'K')), NASAPolynomial(coeffs=[8.70877,0.0340599,-1.66724e-05,3.29872e-09,-2.36037e-13,62272.5,-7.22617], Tmin=(936.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CC(C)2OJ) + radical(CJC(O)2C) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4922.52,'J/mol'), sigma=(8.07949,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=768.89 K, Pc=21.18 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[O][C]([O])C1([O])CC1(12564)',
    structure = SMILES('[O][C]([O])C1([O])CC1'),
    E0 = (353.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91349,0.0507894,-5.47702e-05,3.81949e-08,-1.20419e-11,42569.2,24.4301], Tmin=(100,'K'), Tmax=(741.524,'K')), NASAPolynomial(coeffs=[5.48518,0.0315216,-1.5792e-05,3.14981e-09,-2.2609e-13,42039.5,8.26705], Tmin=(741.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCOJ) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH]C([O])([O])C1([O])CC1(12565)',
    structure = SMILES('[CH]C([O])([O])C1([O])CC1'),
    E0 = (560.532,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1195,0.0655205,-6.09708e-05,3.00706e-08,-6.15659e-12,67518.3,26.9688], Tmin=(100,'K'), Tmax=(1146.91,'K')), NASAPolynomial(coeffs=[11.4399,0.0295272,-1.3897e-05,2.70815e-09,-1.92263e-13,65151,-24.2356], Tmin=(1146.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(560.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C([CH2])([O])[O](12232)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(79.7197,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 76.9 to 79.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', 'C=C([O])C1([O])CC1(10788)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(8.86875,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;O_atom_triplet] for rate rule [CO_O;O_atom_triplet]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from -5.8 to 8.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[O]C(=O)C1([O])CC1(10836)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(92.9635,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 89.5 to 93.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    products = ['[CH2]C([O])([O])C1(O)[CH]C1(12558)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    products = ['[CH2]C([O])(O)C1([O])[CH]C1(12559)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    products = ['CC([O])([O])C1([O])[CH]C1(12560)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C([O])([O])C1([O])[CH]C1(12561)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(S)(14)', '[CH2]C([O])([O])C(=C)[O](2808)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
    products = ['[CH2]C1(OO1)C1([O])CC1(12504)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(T)(63)', '[CH2]C([O])([O])[C]1CC1(12563)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', '[CH2][C]([O])C1([O])CC1(12065)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', '[O][C]([O])C1([O])CC1(12564)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]C([O])([O])C1([O])CC1(12565)'],
    products = ['[CH2]C([O])([O])C1([O])CC1(11533)'],
