...
species(
    label = '[CH2]C([O])([O])OC1=CO1(2774)',
    structure = SMILES('[CH2]C([O])([O])OC1=CO1'),
    E0 = (366.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.396922,0.0985122,-0.000203744,2.03868e-07,-7.44801e-11,44137.1,28.4898], Tmin=(100,'K'), Tmax=(876.615,'K')), NASAPolynomial(coeffs=[3.68307,0.0372661,-1.98018e-05,3.79182e-09,-2.56014e-13,45338,23.205], Tmin=(876.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(oxirene) + radical(CCOJ) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]C([O])([O])OC1[CH]O1(2775)',
    structure = SMILES('[CH2]C([O])([O])OC1[CH]O1'),
    E0 = (182.073,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.655281,0.0829252,-0.000137011,1.19958e-07,-3.94818e-11,22010,30.0724], Tmin=(100,'K'), Tmax=(928.303,'K')), NASAPolynomial(coeffs=[7.31127,0.0299326,-1.20979e-05,2.03742e-09,-1.26923e-13,21821.8,4.09857], Tmin=(928.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJCO) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C([O])(O)O[C]1[CH]O1(2776)',
    structure = SMILES('[CH2]C([O])(O)O[C]1[CH]O1'),
    E0 = (161.614,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.307391,0.0867159,-0.000136469,1.09171e-07,-3.28725e-11,19565.6,32.5323], Tmin=(100,'K'), Tmax=(971.541,'K')), NASAPolynomial(coeffs=[11.749,0.0212937,-7.18295e-06,1.05188e-09,-5.78406e-14,18206.7,-17.8881], Tmin=(971.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCOJ) + radical(CCsJO) + radical(Cs_P)"""),
)

species(
    label = 'CC([O])([O])O[C]1[CH]O1(2777)',
    structure = SMILES('CC([O])([O])O[C]1[CH]O1'),
    E0 = (175.73,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854935,0.0783469,-0.000127271,1.12465e-07,-3.75097e-11,21240.1,30.1033], Tmin=(100,'K'), Tmax=(922.048,'K')), NASAPolynomial(coeffs=[6.25576,0.0314798,-1.28992e-05,2.20317e-09,-1.39155e-13,21240.4,9.88834], Tmin=(922.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]C([O])([O])O[C]1[CH]O1(2778)',
    structure = SMILES('[CH2]C([O])([O])O[C]1[CH]O1'),
    E0 = (387.319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (115.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692785,0.0836569,-0.000147463,1.32222e-07,-4.39287e-11,46692.6,31.3188], Tmin=(100,'K'), Tmax=(931.259,'K')), NASAPolynomial(coeffs=[7.09111,0.027661,-1.13422e-05,1.89774e-09,-1.16551e-13,46737.3,7.54452], Tmin=(931.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C([O])([O])OC(=C)[O](2206)',
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17884,0.075454,-0.000135266,1.37371e-07,-5.25371e-11,3755.97,31.9657], Tmin=(100,'K'), Tmax=(847.292,'K')), NASAPolynomial(coeffs=[1.3901,0.0429258,-2.18592e-05,4.21898e-09,-2.90528e-13,4851.98,37.6604], Tmin=(847.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJCO) + radical(CCOJ) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])(O)OC1=CO1(2779)',
    structure = SMILES('[CH2]C([O])(O)OC1=CO1'),
    E0 = (36.4002,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197861,0.0868756,-0.000126372,9.2721e-08,-2.65286e-11,4511.88,28.3857], Tmin=(100,'K'), Tmax=(862.557,'K')), NASAPolynomial(coeffs=[14.8309,0.0190239,-8.38955e-06,1.54226e-09,-1.04451e-13,1987.26,-40.048], Tmin=(862.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'CC([O])([O])OC1=CO1(2780)',
    structure = SMILES('CC([O])([O])OC1=CO1'),
    E0 = (50.5163,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.673778,0.0794657,-0.000121156,1.02289e-07,-3.44491e-11,6189.43,26.2069], Tmin=(100,'K'), Tmax=(813.152,'K')), NASAPolynomial(coeffs=[9.27805,0.0292996,-1.41526e-05,2.70375e-09,-1.86559e-13,5049.33,-11.9302], Tmin=(813.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.5163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]C([O])([O])O[C]1CO1(2783)',
    structure = SMILES('[CH]C([O])([O])O[C]1CO1'),
    E0 = (440.223,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (115.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.999309,0.0778835,-0.000137676,1.27909e-07,-4.39221e-11,53043.5,30.3868], Tmin=(100,'K'), Tmax=(921.68,'K')), NASAPolynomial(coeffs=[4.54944,0.032054,-1.35785e-05,2.33526e-09,-1.47151e-13,53681.2,20.5589], Tmin=(921.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(Cs_P) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])([O])OC1=CO1(2774)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]C(=O)O[C]1CO1(2244)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[O]C(=O)O[C]1CO1(2345)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    products = ['[CH2]C([O])([O])OC1[CH]O1(2775)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    products = ['[CH2]C([O])(O)O[C]1[CH]O1(2776)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    products = ['CC([O])([O])O[C]1[CH]O1(2777)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2]C([O])([O])O[C]1[CH]O1(2778)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])([O])OC(=C)[O](2206)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    products = ['[CH2]C([O])(O)OC1=CO1(2779)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    products = ['[CH2]C1(OO1)O[C]1CO1(2781)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[C]1CO1(1125)', '[CH2]C([O])([O])[O](2121)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(28)', '[O][C]([O])O[C]1CO1(2782)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C([O])([O])O[C]1CO1(2783)'],
    products = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
