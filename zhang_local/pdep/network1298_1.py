...
species(
    label = '[CH2]C([O])=C(C)C(4346)',
    structure = SMILES('[CH2]C([O])=C(C)C'),
    E0 = (13.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,245.123],'cm^-1')),
        HinderedRotor(inertia=(0.152642,'amu*angstrom^2'), symmetry=1, barrier=(6.50835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152637,'amu*angstrom^2'), symmetry=1, barrier=(6.50834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152636,'amu*angstrom^2'), symmetry=1, barrier=(6.50834,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.451147,'amu*angstrom^2'), symmetry=1, barrier=(16.341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45211,'amu*angstrom^2'), symmetry=1, barrier=(16.3418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00330691,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.451293,'amu*angstrom^2'), symmetry=1, barrier=(16.3417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH]=C([O])C(C)C(4350)',
    structure = SMILES('[CH]=C([O])C(C)C'),
    E0 = (122.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,350,440,435,1725,410.338],'cm^-1')),
        HinderedRotor(inertia=(0.0836493,'amu*angstrom^2'), symmetry=1, barrier=(9.9967,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0836438,'amu*angstrom^2'), symmetry=1, barrier=(9.99675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0836717,'amu*angstrom^2'), symmetry=1, barrier=(9.99716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25054,0.0512363,-2.07227e-05,-1.25265e-08,9.50073e-12,14788.7,23.2136], Tmin=(100,'K'), Tmax=(963.769,'K')), NASAPolynomial(coeffs=[13.7471,0.0209185,-7.07295e-06,1.22983e-09,-8.51935e-14,11379.2,-41.8058], Tmin=(963.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH]=C([O])C([CH2])C(4353)',
    structure = SMILES('[CH]=C([O])C([CH2])C'),
    E0 = (327.151,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3120,650,792.5,1650,350,440,435,1725,537.791],'cm^-1')),
        HinderedRotor(inertia=(0.0409336,'amu*angstrom^2'), symmetry=1, barrier=(8.63188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0411367,'amu*angstrom^2'), symmetry=1, barrier=(8.59798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0410899,'amu*angstrom^2'), symmetry=1, barrier=(8.60089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769184,0.0587136,-5.30514e-05,2.51056e-08,-4.5903e-12,39474,27.422], Tmin=(100,'K'), Tmax=(1496.11,'K')), NASAPolynomial(coeffs=[14.5954,0.0157064,-3.87542e-06,4.93797e-10,-2.66579e-14,36013,-42.5923], Tmin=(1496.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=C(C)OJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C(C)C(=C)[O](4360)',
    structure = SMILES('[CH]C(C)C(=C)[O]'),
    E0 = (323.187,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,180,385.513,879.21,879.32,3669.61],'cm^-1')),
        HinderedRotor(inertia=(0.0273719,'amu*angstrom^2'), symmetry=1, barrier=(15.0187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653213,'amu*angstrom^2'), symmetry=1, barrier=(15.0187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.027364,'amu*angstrom^2'), symmetry=1, barrier=(15.0188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2805,0.0506674,-2.32274e-05,-1.06828e-08,9.22752e-12,38976.7,24.4002], Tmin=(100,'K'), Tmax=(955.28,'K')), NASAPolynomial(coeffs=[14.3257,0.0178043,-5.7935e-06,9.95883e-10,-6.92417e-14,35491.4,-43.1352], Tmin=(955.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2]C(C)=C(C)[O](4361)',
    structure = SMILES('[CH2]C(C)=C(C)[O]'),
    E0 = (5.7885,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C=C([CH2])OC(4366)',
    structure = SMILES('[CH2]C=C([CH2])OC'),
    E0 = (84.6395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,989.922,990.268],'cm^-1')),
        HinderedRotor(inertia=(0.0785201,'amu*angstrom^2'), symmetry=1, barrier=(17.3835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755757,'amu*angstrom^2'), symmetry=1, barrier=(17.3763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755793,'amu*angstrom^2'), symmetry=1, barrier=(17.3772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755611,'amu*angstrom^2'), symmetry=1, barrier=(17.373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C(C)C(=C)[O](4345)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', 'C=CC(=C)[O](4214)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])C(=C)O(4349)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH2]C=C([CH2])[O](4312)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C(C)=C([CH2])[O](4351)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=C([O])C([CH2])C(4353)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH2])[C](C)[O](4356)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH2]C([O])=CC(4308)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH2]C(C)[C]=C(4359)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C(C)C(=C)[O](4360)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH2])C(C)=O(4362)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(T)(28)', '[CH2]C(C)[C]=O(3089)'],
    products = ['[CH2]C(C)C(=C)[O](782)'],
