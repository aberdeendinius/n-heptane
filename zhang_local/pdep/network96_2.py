...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00322944,'amu*angstrom^2'), symmetry=1, barrier=(6.49244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0032293,'amu*angstrom^2'), symmetry=1, barrier=(6.49106,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00322892,'amu*angstrom^2'), symmetry=1, barrier=(6.49105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.1236,0.0238473,-9.09909e-07,-4.52e-09,1.14171e-12,29444.7,17.5352], Tmin=(100,'K'), Tmax=(1813.47,'K')), NASAPolynomial(coeffs=[6.29322,0.0260791,-1.03848e-05,1.76764e-09,-1.11707e-13,26778.5,-3.82454], Tmin=(1813.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJC)"""),
)
...
species(
    ...
    E0 = (51.7368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.0915689,'amu*angstrom^2'), symmetry=1, barrier=(15.4264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.357375,'amu*angstrom^2'), symmetry=1, barrier=(8.21676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0111696,'amu*angstrom^2'), symmetry=1, barrier=(80.7497,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.1143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40258,0.0268744,2.01404e-05,-4.09395e-08,1.68977e-11,6287.47,16.1461], Tmin=(100,'K'), Tmax=(953.317,'K')), NASAPolynomial(coeffs=[7.79056,0.024645,-8.41518e-06,1.45216e-09,-9.93169e-14,4334.19,-14.4469], Tmin=(953.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.7368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    E0 = (303.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,976.126],'cm^-1')),
        HinderedRotor(inertia=(0.72353,'amu*angstrom^2'), symmetry=1, barrier=(16.6354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.730551,'amu*angstrom^2'), symmetry=1, barrier=(16.7968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220847,'amu*angstrom^2'), symmetry=1, barrier=(5.07771,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2609,0.0314424,7.48722e-07,-1.84873e-08,8.0628e-12,36620.5,15.7527], Tmin=(100,'K'), Tmax=(1038.41,'K')), NASAPolynomial(coeffs=[8.22231,0.0233776,-9.12316e-06,1.66749e-09,-1.15986e-13,34579.2,-17.1001], Tmin=(1038.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
