...
species(
    label = '[CH2]C[C]([O])OC([CH2])=O(12236)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07618,0.0707859,-9.20206e-05,8.03714e-08,-3.03328e-11,19377.3,34.3986], Tmin=(100,'K'), Tmax=(731.483,'K')), NASAPolynomial(coeffs=[5.09284,0.042557,-2.12875e-05,4.1982e-09,-2.97669e-13,18957.3,17.422], Tmin=(731.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CJCO) + radical(Cs_P) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][C]([O])OC1(O)[CH]C1(12519)',
    structure = SMILES('[CH2][C]([O])OC1(O)[CH]C1'),
    E0 = (282.845,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133773,0.0673838,-2.75217e-05,-2.99305e-08,2.08665e-11,34173.7,33.982], Tmin=(100,'K'), Tmax=(945.414,'K')), NASAPolynomial(coeffs=[24.7718,0.00684921,-8.24007e-07,1.43952e-10,-1.72882e-14,27561.8,-93.8297], Tmin=(945.414,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCOJ) + radical(CCJCO) + radical(CJCO) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C([O])OC1([O])[CH]C1(12520)',
    structure = SMILES('[CH2]C([O])OC1([O])[CH]C1'),
    E0 = (309.589,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553401,0.0657018,-4.98492e-05,1.57093e-08,-1.12984e-12,37367.5,33.0666], Tmin=(100,'K'), Tmax=(1166.23,'K')), NASAPolynomial(coeffs=[17.0868,0.0215784,-9.28299e-06,1.77206e-09,-1.25494e-13,32655.4,-52.9087], Tmin=(1166.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCOJ) + radical(CC(C)(O)OJ) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)OC1([O])[CH]C1(12521)',
    structure = SMILES('[CH2][C](O)OC1([O])[CH]C1'),
    E0 = (289.13,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.336853,0.0680633,-4.49424e-05,3.1388e-10,6.93263e-12,34917.3,33.6619], Tmin=(100,'K'), Tmax=(994.221,'K')), NASAPolynomial(coeffs=[20.1423,0.0151936,-5.62928e-06,1.07789e-09,-8.01761e-14,29653.9,-68.4375], Tmin=(994.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = 'C[C]([O])OC1([O])[CH]C1(12522)',
    structure = SMILES('C[C]([O])OC1([O])[CH]C1'),
    E0 = (303.246,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769717,0.0609291,-3.9434e-05,7.33442e-09,1.22893e-12,36596.8,32.3444], Tmin=(100,'K'), Tmax=(1146,'K')), NASAPolynomial(coeffs=[15.945,0.0232621,-1.01589e-05,1.95474e-09,-1.39087e-13,32113.9,-47.3191], Tmin=(1146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(Cs_P) + radical(CCOJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2][C]([O])OC1([O])[CH]C1(12523)',
    structure = SMILES('[CH2][C]([O])OC1([O])[CH]C1'),
    E0 = (514.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,360,370,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.635257,0.0658876,-5.8262e-05,2.51135e-08,-4.2603e-12,62048.2,33.462], Tmin=(100,'K'), Tmax=(1420.2,'K')), NASAPolynomial(coeffs=[17.5388,0.0182793,-7.97934e-06,1.5103e-09,-1.0544e-13,57246.8,-54.0178], Tmin=(1420.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCOJ) + radical(CJCO) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(Cs_P)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3937.49,'J/mol'), sigma=(6.42507,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=615.03 K, Pc=33.68 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH2][C]([O])OC([CH2])([CH2])[O](10137)',
    structure = SMILES('[CH2][C]([O])OC([CH2])([CH2])[O]'),
    E0 = (575.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,180,180,180,884.135,1345.43,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.158461,'amu*angstrom^2'), symmetry=1, barrier=(3.64334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158461,'amu*angstrom^2'), symmetry=1, barrier=(3.64334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158461,'amu*angstrom^2'), symmetry=1, barrier=(3.64334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158461,'amu*angstrom^2'), symmetry=1, barrier=(3.64334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158461,'amu*angstrom^2'), symmetry=1, barrier=(3.64334,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.736626,0.116225,-0.00020381,1.80552e-07,-6.11619e-11,69369.6,35.1364], Tmin=(100,'K'), Tmax=(858.998,'K')), NASAPolynomial(coeffs=[12.1672,0.032527,-1.64269e-05,3.12766e-09,-2.12453e-13,68023.7,-20.0856], Tmin=(858.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)(O)OJ) + radical(CJC(C)OC) + radical(Cs_P) + radical(CJC(C)OC) + radical(CJCO)"""),
)
...
species(
    label = '[CH][C]([O])OC1([O])CC1(12525)',
    structure = SMILES('[CH][C]([O])OC1([O])CC1'),
    E0 = (551.559,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,360,370,350,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735975,0.0667407,-5.91826e-05,2.58005e-08,-4.47515e-12,66458.8,30.9689], Tmin=(100,'K'), Tmax=(1376.68,'K')), NASAPolynomial(coeffs=[16.3306,0.0214291,-9.8111e-06,1.89158e-09,-1.333e-13,62165.1,-49.2511], Tmin=(1376.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_P) + radical(CCOJ) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC1([O])CC1(11541)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C[C]([O])OC([CH2])=O(12236)'],
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(154.656,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
...
reaction(
    ...
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(79.1971,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 74.9 to 79.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    products = ['[CH2][C]([O])OC1(O)[CH]C1(12519)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    products = ['[CH2]C([O])OC1([O])[CH]C1(12520)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    products = ['[CH2][C](O)OC1([O])[CH]C1(12521)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    products = ['C[C]([O])OC1([O])[CH]C1(12522)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][C]([O])OC1([O])[CH]C1(12523)'],
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(S)(14)', '[CH2][C]([O])OC([CH2])=O(2758)'],
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])OC([CH2])([CH2])[O](10137)'],
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([O])OC1([O])CC1(11541)'],
    products = ['[CH2]C(=O)OC1([O])CC1(11532)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C][O](2305)', '[O]C1([O])CC1(3057)'],
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH][C]([O])OC1([O])CC1(12525)'],
    products = ['[CH2][C]([O])OC1([O])CC1(11541)'],
