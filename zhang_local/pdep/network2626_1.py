...
species(
    label = '[CH2]C([CH2])([O])C(=C)CC(10408)',
    structure = SMILES('[CH2]C([CH2])([O])C(=C)CC'),
    E0 = (360.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.119132,0.0861733,-7.62251e-05,3.73718e-08,-7.67588e-12,43476,33.7473], Tmin=(100,'K'), Tmax=(1142.94,'K')), NASAPolynomial(coeffs=[12.8224,0.041715,-1.78776e-05,3.33807e-09,-2.31508e-13,40572.3,-29.2356], Tmin=(1142.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])[C](C)CC(10409)',
    structure = SMILES('[CH2]C([CH2])([O])[C](C)CC'),
    E0 = (400.423,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.381309,0.0989237,-9.76862e-05,5.37393e-08,-1.2277e-11,48315.5,31.1601], Tmin=(100,'K'), Tmax=(1041.4,'K')), NASAPolynomial(coeffs=[13.7586,0.0446126,-1.94582e-05,3.66063e-09,-2.55003e-13,45370.4,-37.6304], Tmin=(1041.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH2])([O])C(C)[CH]C(10410)',
    structure = SMILES('[CH2]C([CH2])([O])C(C)[CH]C'),
    E0 = (442.392,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.454112,0.10412,-0.000119011,7.91285e-08,-2.19807e-11,53362.4,33.7921], Tmin=(100,'K'), Tmax=(864.098,'K')), NASAPolynomial(coeffs=[11.6384,0.0481429,-2.18396e-05,4.15894e-09,-2.90641e-13,51272.6,-22.7808], Tmin=(864.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(Cs_S) + radical(CJC(C)2O) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2][C](CC)C([CH2])([CH2])O(10411)',
    structure = SMILES('[CH2][C](CC)C([CH2])([CH2])O'),
    E0 = (376.59,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.805203,0.107257,-0.000121864,7.68386e-08,-1.95862e-11,45465,34.3992], Tmin=(100,'K'), Tmax=(953.402,'K')), NASAPolynomial(coeffs=[15.22,0.040026,-1.60945e-05,2.88259e-09,-1.94506e-13,42409.1,-42.1494], Tmin=(953.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CJC(C)2O) + radical(Isobutyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2][C](CC)C([CH2])(C)[O](10412)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.306094,0.0931276,-8.47644e-05,4.29574e-08,-9.00047e-12,47482.3,33.5179], Tmin=(100,'K'), Tmax=(1134.91,'K')), NASAPolynomial(coeffs=[14.2821,0.0417109,-1.68071e-05,3.03772e-09,-2.06838e-13,44171,-38.7079], Tmin=(1134.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(393.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CCJ(C)CO) + radical(CC(C)2OJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]C)C([CH2])([CH2])O(10413)',
    structure = SMILES('[CH2]C([CH]C)C([CH2])([CH2])O'),
    E0 = (418.558,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.920193,0.113101,-0.000146135,1.06954e-07,-3.16785e-11,50513.5,37.1723], Tmin=(100,'K'), Tmax=(824.047,'K')), NASAPolynomial(coeffs=[13.5897,0.0426729,-1.79444e-05,3.2514e-09,-2.1915e-13,48122,-30.0222], Tmin=(824.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(418.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CJC(C)2O) + radical(Isobutyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]C([CH]C)C([CH2])(C)[O](10414)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.231081,0.0965669,-9.99012e-05,6.02679e-08,-1.52292e-11,52522.9,35.621], Tmin=(100,'K'), Tmax=(945.306,'K')), NASAPolynomial(coeffs=[11.7292,0.0459569,-1.95922e-05,3.62977e-09,-2.50144e-13,50261.7,-21.4074], Tmin=(945.306,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C([CH2])([CH2])[O](10415)',
    structure = SMILES('[CH2]CC(C)C([CH2])([CH2])[O]'),
    E0 = (453.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,219.731,1527.61,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.147816,'amu*angstrom^2'), symmetry=1, barrier=(3.39858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147816,'amu*angstrom^2'), symmetry=1, barrier=(3.39858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147816,'amu*angstrom^2'), symmetry=1, barrier=(3.39858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147816,'amu*angstrom^2'), symmetry=1, barrier=(3.39858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147816,'amu*angstrom^2'), symmetry=1, barrier=(3.39858,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63775,0.106482,-0.000119737,7.56171e-08,-1.96338e-11,54658,33.6776], Tmin=(100,'K'), Tmax=(927.961,'K')), NASAPolynomial(coeffs=[13.7303,0.0445477,-1.96235e-05,3.69282e-09,-2.56697e-13,51991.5,-34.5655], Tmin=(927.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]CC([CH2])C([CH2])([CH2])O(10416)',
    structure = SMILES('[CH2]CC([CH2])C([CH2])([CH2])O'),
    E0 = (429.262,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08902,0.115229,-0.000145758,1.01598e-07,-2.83595e-11,51808.6,37.0085], Tmin=(100,'K'), Tmax=(876.521,'K')), NASAPolynomial(coeffs=[15.5424,0.0393346,-1.58852e-05,2.82395e-09,-1.88514e-13,48892.9,-41.0372], Tmin=(876.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(RCCJ) + radical(Isobutyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]CC([CH2])C([CH2])(C)[O](10417)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.474393,0.0996519,-0.000103247,6.02936e-08,-1.44617e-11,53821,35.7192], Tmin=(100,'K'), Tmax=(1002.9,'K')), NASAPolynomial(coeffs=[13.9397,0.0421628,-1.72628e-05,3.13714e-09,-2.14021e-13,50929.8,-33.8621], Tmin=(1002.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
species(
    label = '[CH2][C](CC)C([CH2])([CH2])[O](10418)',
    structure = SMILES('[CH2][C](CC)C([CH2])([CH2])[O]'),
    E0 = (605.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.525868,0.102513,-0.000116797,7.47692e-08,-1.95236e-11,72985.9,33.4612], Tmin=(100,'K'), Tmax=(927.44,'K')), NASAPolynomial(coeffs=[13.7599,0.0408993,-1.71451e-05,3.1365e-09,-2.1421e-13,70336.1,-34.3831], Tmin=(927.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(605.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CCJ(C)CO) + radical(CJC(C)2O)"""),
)
...
species(
    label = '[CH2]C([CH]C)C([CH2])([CH2])[O](10419)',
    structure = SMILES('[CH2]C([CH]C)C([CH2])([CH2])[O]'),
    E0 = (647.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.701094,0.109133,-0.000144109,1.09355e-07,-3.3789e-11,78037,36.4463], Tmin=(100,'K'), Tmax=(803.46,'K')), NASAPolynomial(coeffs=[12.2708,0.0432945,-1.88451e-05,3.46907e-09,-2.35794e-13,75993.2,-23.0442], Tmin=(803.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(647.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(Cs_S) + radical(Isobutyl) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]CC([CH2])C([CH2])([CH2])[O](10420)',
    structure = SMILES('[CH2]CC([CH2])C([CH2])([CH2])[O]'),
    E0 = (658.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3014.29,3028.57,3042.86,3057.14,3071.43,3085.71,3100,415,431.667,448.333,465,780,803.333,826.667,850,1435,1448.33,1461.67,1475,900,966.667,1033.33,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.840434,0.110873,-0.000142169,1.01633e-07,-2.92844e-11,79330.8,36.1792], Tmin=(100,'K'), Tmax=(847.512,'K')), NASAPolynomial(coeffs=[14.1613,0.040069,-1.68539e-05,3.0582e-09,-2.06569e-13,76788,-33.7135], Tmin=(847.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(658.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(RCCJ) + radical(CC(C)2OJ) + radical(Isobutyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]C([CH2])(O)C(=C)CC(10421)',
    structure = SMILES('[CH2]C([CH2])(O)C(=C)CC'),
    E0 = (131.222,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.509823,0.0954277,-8.99759e-05,4.58104e-08,-9.45409e-12,15947.9,34.7876], Tmin=(100,'K'), Tmax=(1164.32,'K')), NASAPolynomial(coeffs=[16.5391,0.0368561,-1.45174e-05,2.60397e-09,-1.76855e-13,11977.8,-50.0571], Tmin=(1164.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C(C)([O])C(=C)CC(10422)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0723461,0.0839107,-6.34878e-05,2.54481e-08,-4.21139e-12,17816.7,34.2504], Tmin=(100,'K'), Tmax=(1405.11,'K')), NASAPolynomial(coeffs=[15.5841,0.03934,-1.59065e-05,2.87238e-09,-1.94606e-13,13417,-46.6076], Tmin=(1405.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])[CH]CC(10320)',
    structure = SMILES('[CH2]C([CH2])([O])[CH]CC'),
    E0 = (473.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,1584.58,1600,2918.5,3200],'cm^-1')),
        HinderedRotor(inertia=(0.14845,'amu*angstrom^2'), symmetry=1, barrier=(3.41317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14845,'amu*angstrom^2'), symmetry=1, barrier=(3.41317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14845,'amu*angstrom^2'), symmetry=1, barrier=(3.41317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14845,'amu*angstrom^2'), symmetry=1, barrier=(3.41317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14845,'amu*angstrom^2'), symmetry=1, barrier=(3.41317,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1007,0.0889428,-9.94441e-05,6.1749e-08,-1.56872e-11,57132.2,29.7684], Tmin=(100,'K'), Tmax=(949.532,'K')), NASAPolynomial(coeffs=[12.6867,0.0359229,-1.56873e-05,2.94339e-09,-2.04394e-13,54742,-30.3001], Tmin=(949.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2][C]([CH2])C([CH2])CC(6206)',
...
species(
    label = '[CH]C([CH2])([O])C([CH2])CC(10425)',
    structure = SMILES('[CH]C([CH2])([O])C([CH2])CC'),
    E0 = (689.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.600354,0.102405,-0.000113839,6.97394e-08,-1.72868e-11,83047.9,35.3886], Tmin=(100,'K'), Tmax=(978.628,'K')), NASAPolynomial(coeffs=[15.0784,0.0383195,-1.56092e-05,2.82167e-09,-1.91723e-13,79979.3,-39.9133], Tmin=(978.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)2OJ) + radical(CCJ2_triplet) + radical(Isobutyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH]C(CC)C([CH2])([CH2])[O](10426)',
    structure = SMILES('[CH]C(CC)C([CH2])([CH2])[O]'),
    E0 = (696.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.773194,0.10936,-0.000130821,8.57691e-08,-2.27864e-11,83885.4,33.3802], Tmin=(100,'K'), Tmax=(913.445,'K')), NASAPolynomial(coeffs=[14.9299,0.0405973,-1.79066e-05,3.36211e-09,-2.33118e-13,81016.5,-40.9572], Tmin=(913.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(696.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C(=C)CC(10408)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(CC)C(=C)[O](899)', 'CH2(T)(28)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(15.2874,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 15.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)C([CH2])CC(6200)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH2](6)', '[CH2]C([CH2])([O])C=C(10039)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(109.257,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 108.6 to 109.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]C([CH2])([O])[C](C)CC(10409)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]C([CH2])([O])C(C)[CH]C(10410)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2][C](CC)C([CH2])([CH2])O(10411)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2][C](CC)C([CH2])(C)[O](10412)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]C([CH]C)C([CH2])([CH2])O(10413)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]C([CH]C)C([CH2])(C)[O](10414)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(C)C([CH2])([CH2])[O](10415)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]CC([CH2])C([CH2])([CH2])O(10416)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]CC([CH2])C([CH2])(C)[O](10417)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH2](6)', '[CH2][CH]C([CH2])([CH2])[O](10278)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][C](CC)C([CH2])([CH2])[O](10418)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](11)', '[CH2]C([CH2])C([CH2])([CH2])[O](9932)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C([CH]C)C([CH2])([CH2])[O](10419)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2]CC([CH2])C([CH2])([CH2])[O](10420)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]C([CH2])(O)C(=C)CC(10421)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
    products = ['[CH2]C(C)([O])C(=C)CC(10422)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(14)', '[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])[CH]CC(10320)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C([CH2])CC(6206)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2][C]([O])C([CH2])CC(914)', 'CH2(T)(28)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH]C([CH2])([O])C([CH2])CC(10425)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH]C(CC)C([CH2])([CH2])[O](10426)'],
    products = ['[CH2]C(CC)C([CH2])([CH2])[O](9471)'],
