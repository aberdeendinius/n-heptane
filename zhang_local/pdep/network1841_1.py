...
species(
    ...
    E0 = (199.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.837164,'amu*angstrom^2'), symmetry=1, barrier=(19.2481,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.837277,'amu*angstrom^2'), symmetry=1, barrier=(19.2506,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.837348,'amu*angstrom^2'), symmetry=1, barrier=(19.2523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.83715,'amu*angstrom^2'), symmetry=1, barrier=(19.2477,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2][C](C)O[CH]C(757)',
    structure = SMILES('[CH2][C](C)O[CH]C'),
    E0 = (263.966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,360,370,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.237219,0.0916936,-0.000144912,1.26028e-07,-4.2481e-11,31874.7,25.5352], Tmin=(100,'K'), Tmax=(873.527,'K')), NASAPolynomial(coeffs=[8.44604,0.0353149,-1.58344e-05,2.89338e-09,-1.93008e-13,31157.5,-8.85434], Tmin=(873.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CCsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]COC([CH2])[CH2](758)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.13102,0.0919353,-0.000138295,1.14679e-07,-3.74771e-11,39209.8,26.2182], Tmin=(100,'K'), Tmax=(855.853,'K')), NASAPolynomial(coeffs=[10.3007,0.0329071,-1.4688e-05,2.69793e-09,-1.81411e-13,37890.2,-18.8016], Tmin=(855.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJCO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH2])OCC(6322)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.17367,0.0976052,-0.000169885,1.5802e-07,-5.54664e-11,35487.4,25.376], Tmin=(100,'K'), Tmax=(881.596,'K')), NASAPolynomial(coeffs=[5.9971,0.03994,-1.86112e-05,3.42741e-09,-2.28224e-13,35674.7,4.90115], Tmin=(881.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=C(C)O[CH]C(3676)',
    structure = SMILES('C=C(C)O[CH]C'),
    E0 = (-33.3711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,284.789,284.789,284.792],'cm^-1')),
        HinderedRotor(inertia=(0.253605,'amu*angstrom^2'), symmetry=1, barrier=(14.5959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253607,'amu*angstrom^2'), symmetry=1, barrier=(14.5959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253607,'amu*angstrom^2'), symmetry=1, barrier=(14.5959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.253607,'amu*angstrom^2'), symmetry=1, barrier=(14.5959,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    label = '[CH2]C(C)OC=C(634)',
    structure = SMILES('[CH2]C(C)OC=C'),
    E0 = (-11.4201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.839291,'amu*angstrom^2'), symmetry=1, barrier=(19.2969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838162,'amu*angstrom^2'), symmetry=1, barrier=(19.271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838321,'amu*angstrom^2'), symmetry=1, barrier=(19.2746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838952,'amu*angstrom^2'), symmetry=1, barrier=(19.2892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2294,0.0480209,2.66143e-07,-3.62359e-08,1.77288e-11,4111.11,21.8289], Tmin=(100,'K'), Tmax=(976.844,'K')), NASAPolynomial(coeffs=[14.7787,0.0230354,-8.19593e-06,1.49848e-09,-1.07603e-13,8.99109,-50.6687], Tmin=(976.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.2563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0903782,0.0924494,-0.000142796,1.17512e-07,-3.79757e-11,69207.5,24.4627], Tmin=(100,'K'), Tmax=(845.479,'K')), NASAPolynomial(coeffs=[11.6808,0.0284709,-1.30674e-05,2.42895e-09,-1.64379e-13,67574.4,-27.5763], Tmin=(845.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(574.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CH2_triplet) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]C([CH2])O[CH]C(6327)',
    structure = SMILES('[CH]C([CH2])O[CH]C'),
    E0 = (531.477,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378955,0.0828082,-0.000108875,7.70548e-08,-2.17465e-11,64049.5,26.0914], Tmin=(100,'K'), Tmax=(867.694,'K')), NASAPolynomial(coeffs=[12.6257,0.026351,-1.12748e-05,2.06607e-09,-1.40491e-13,61924.2,-31.2541], Tmin=(867.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=C)O[CH]C(6321)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([CH2])OC=C(4335)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=CO[CH]C(3600)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][C]([CH2])O[CH]C(6323)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][CH]OC([CH2])[CH2](761)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(32)', '[CH2]C([CH2])[O](740)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH2][CH]O[CH]C(718)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](11)', '[CH]OC([CH2])[CH2](6276)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C([CH2])O[C]C(6326)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C([CH2])O[CH]C(6327)'],
    products = ['[CH2]C([CH2])O[CH]C(759)'],
