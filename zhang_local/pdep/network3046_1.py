...
species(
    label = '[CH2]OC(=O)O[C]1CC1(12110)',
    structure = SMILES('[CH2]OC(=O)O[C]1CC1'),
    E0 = (-98.2789,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705574,0.0584107,-2.16275e-05,-1.83458e-08,1.17734e-11,-11689.3,28.9339], Tmin=(100,'K'), Tmax=(1024.69,'K')), NASAPolynomial(coeffs=[18.568,0.0189121,-8.05888e-06,1.61659e-09,-1.20988e-13,-16937.1,-65.4216], Tmin=(1024.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.2789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + group(Cds-OdOsOs) + ring(Cyclopropane) + radical(CsJOC(O)) + radical(C2CsJOC(O))"""),
)

species(
    label = '[O]CC(=O)O[C]1CC1(12111)',
    structure = SMILES('[O]CC(=O)O[C]1CC1'),
    E0 = (-38.0462,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29444,0.0558267,-3.68898e-05,1.15109e-08,-1.43587e-12,-4475.98,28.4186], Tmin=(100,'K'), Tmax=(1824.11,'K')), NASAPolynomial(coeffs=[15.6599,0.0243258,-1.09864e-05,2.04397e-09,-1.38419e-13,-9716.89,-49.5217], Tmin=(1824.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.0462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + ring(Cyclopropane) + radical(C2CsJOC(O)C) + radical(C=OCOJ)"""),
)
...
species(
    label = '[O]C1(CO1)OC1=CC1(12112)',
    structure = SMILES('[O]C1(CO1)OC1=CC1'),
    E0 = (75.8889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.019509,0.0690994,-6.70681e-05,3.34755e-08,-6.25453e-12,9286.49,27.4827], Tmin=(100,'K'), Tmax=(1556.6,'K')), NASAPolynomial(coeffs=[16.0435,0.0145755,-1.66501e-06,-4.40528e-11,1.36152e-14,5914.92,-51.7203], Tmin=(1556.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.8889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + ring(Ethylene_oxide) + radical(CCOJ)"""),
)
...
species(
    label = 'OC1([CH]O1)O[C]1CC1(12114)',
    structure = SMILES('OC1([CH]O1)O[C]1CC1'),
    E0 = (26.1812,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.232526,0.0753854,-8.32208e-05,4.88659e-08,-1.0969e-11,3291.01,28.1558], Tmin=(100,'K'), Tmax=(1243.98,'K')), NASAPolynomial(coeffs=[14.8953,0.0189288,-3.92082e-06,3.5265e-10,-1.0574e-14,363.222,-42.8897], Tmin=(1243.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJOCs)"""),
)

species(
    label = '[O]C1([CH]O1)OC1CC1(12115)',
    structure = SMILES('[O]C1([CH]O1)OC1CC1'),
    E0 = (71.1826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34896,0.0657621,-5.71408e-05,2.68964e-08,-4.91512e-12,8705.17,28.6673], Tmin=(100,'K'), Tmax=(1524.1,'K')), NASAPolynomial(coeffs=[14.3972,0.0208134,-4.95153e-06,5.89944e-10,-2.95331e-14,5361.3,-41.9493], Tmin=(1524.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.1826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCOJ)"""),
)

species(
    label = 'OC1(CO1)O[C]1[CH]C1(12116)',
    structure = SMILES('OC1(CO1)O[C]1[CH]C1'),
    E0 = (42.3609,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576641,0.0671906,-6.72721e-05,3.73211e-08,-8.02145e-12,5225.07,29.9091], Tmin=(100,'K'), Tmax=(1297.97,'K')), NASAPolynomial(coeffs=[12.9252,0.0211585,-4.85635e-06,5.27993e-10,-2.2806e-14,2691.4,-30.2978], Tmin=(1297.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.3609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJCO)"""),
)
...
species(
    label = '[O]C1(CO1)O[C]1[CH]C1(12117)',
    structure = SMILES('[O]C1(CO1)O[C]1[CH]C1'),
    E0 = (268.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23639,0.0608277,-6.63624e-05,4.43707e-08,-1.19818e-11,32340.3,28.4089], Tmin=(100,'K'), Tmax=(1018.39,'K')), NASAPolynomial(coeffs=[8.22433,0.0276765,-9.13184e-06,1.40608e-09,-8.44736e-14,31212.8,-3.97896], Tmin=(1018.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(C2CsJOCs) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = '[O]C1([CH]O1)O[C]1CC1(12118)',
    structure = SMILES('[O]C1([CH]O1)O[C]1CC1'),
    E0 = (251.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24886,0.0639285,-5.93004e-05,1.59112e-08,8.41009e-12,30391.1,25.4272], Tmin=(100,'K'), Tmax=(658.97,'K')), NASAPolynomial(coeffs=[10.2491,0.0253816,-8.17147e-06,1.22722e-09,-7.21038e-14,28855.6,-16.8898], Tmin=(658.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(C2CsJOCs) + radical(CCOJ) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C(=C)OC1([O])CO1(10104)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0743241,0.0763458,-8.18196e-05,4.63022e-08,-9.96196e-12,-3905.84,27.6811], Tmin=(100,'K'), Tmax=(1312.04,'K')), NASAPolynomial(coeffs=[15.6043,0.0183388,-3.31426e-06,2.19371e-10,-1.15878e-15,-7063.4,-47.9626], Tmin=(1312.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(O)CJ) + radical(CCOJ)"""),
)
...
species(
    label = 'OC1(CO1)OC1=CC1(12119)',
    structure = SMILES('OC1(CO1)OC1=CC1'),
    E0 = (-149.816,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.955095,0.07888,-7.86897e-05,3.87693e-08,-6.96205e-12,-17814.3,30.1342], Tmin=(100,'K'), Tmax=(1676.8,'K')), NASAPolynomial(coeffs=[18.2914,0.0113857,9.94601e-07,-5.87778e-10,5.02786e-14,-21234.7,-63.62], Tmin=(1676.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + ring(Cyclopropene)"""),
)

species(
    label = 'C1CC12OC1(CO1)O2(11530)',
    structure = SMILES('C1CC12OC1(CO1)O2'),
    E0 = (-183.831,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11749,0.051723,-1.1638e-05,-2.3302e-08,1.29501e-11,-21995.6,18.5082], Tmin=(100,'K'), Tmax=(991.326,'K')), NASAPolynomial(coeffs=[14.7174,0.0232925,-8.63409e-06,1.58791e-09,-1.13242e-13,-25991.4,-53.539], Tmin=(991.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + polycyclic(s1_3_4_ane) - ring(Cyclobutane)"""),
)

species(
    label = '[CH2]O[C]([O])O[C]1CC1(12120)',
    structure = SMILES('[CH2]O[C]([O])O[C]1CC1'),
    E0 = (330.632,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,360,370,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09352,0.0825279,-0.000157807,1.74066e-07,-7.082e-11,39852.4,29.9736], Tmin=(100,'K'), Tmax=(832.502,'K')), NASAPolynomial(coeffs=[-3.45558,0.0583077,-3.11441e-05,6.15071e-09,-4.29736e-13,42206.6,60.6764], Tmin=(832.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(Cs_P) + radical(CsJOCH3) + radical(OCOJ)"""),
)
...
species(
    label = '[O]C[C]([O])O[C]1CC1(12121)',
    structure = SMILES('[O]C[C]([O])O[C]1CC1'),
    E0 = (330.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,360,370,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.933637,0.0800647,-0.000133994,1.34675e-07,-5.21931e-11,39800.3,31.6585], Tmin=(100,'K'), Tmax=(826.93,'K')), NASAPolynomial(coeffs=[1.63606,0.0481909,-2.45229e-05,4.77652e-09,-3.32261e-13,40657.7,34.2901], Tmin=(826.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ) + radical(C2CsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)O[C]1CC1(12110)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(167.044,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction3',
    reactants = ['[O]CC(=O)O[C]1CC1(12111)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.785e+11,'s^-1'), n=0.342, Ea=(107.245,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_O] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(CO1)OC1=CC1(12112)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C1(CO1)OC1[CH]C1(12113)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C1(CO1)O[C]1CC1(11527)'],
    products = ['OC1([CH]O1)O[C]1CC1(12114)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C1([CH]O1)OC1CC1(12115)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C1(CO1)O[C]1CC1(11527)'],
    products = ['OC1(CO1)O[C]1[CH]C1(12116)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[O]C1(CO1)O[C]1[CH]C1(12117)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[O]C1([CH]O1)O[C]1CC1(12118)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=C)OC1([O])CO1(10104)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', '[O]C(=O)O[C]1CC1(11548)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(S)(1732)', '[CH2]C(=O)O[C]1CC1(11554)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C1(CO1)O[C]1CC1(11527)'],
    products = ['OC1(CO1)OC1=CC1(12119)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C1(CO1)O[C]1CC1(11527)'],
    products = ['C1CC12OC1(CO1)O2(11530)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]O[C]([O])O[C]1CC1(12120)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C[C]([O])O[C]1CC1(12121)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C1([O])CO1(1782)', '[C]1CC1(11616)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(T)(63)', 'C1C[C]1O[C]1CO1(11985)'],
    products = ['[O]C1(CO1)O[C]1CC1(11527)'],
