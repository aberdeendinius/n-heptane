species(
    label = '[CH2]C(CC)C[CH]C(193)',
    structure = SMILES('[CH2]C(CC)C[CH]C'),
    E0 = (181.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,208.447,816.894,1667.58],'cm^-1')),
...
species(
    label = '[CH2]C(C=CC)CC(270)',
    structure = SMILES('[CH2]C(C=CC)CC'),
    E0 = (97.0026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,295.168,305.788],'cm^-1')),
        HinderedRotor(inertia=(0.0777649,'amu*angstrom^2'), symmetry=1, barrier=(6.07605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00149974,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0945182,'amu*angstrom^2'), symmetry=1, barrier=(6.06675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0780678,'amu*angstrom^2'), symmetry=1, barrier=(6.10269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189428,'amu*angstrom^2'), symmetry=1, barrier=(16.398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
...
species(
    label = '[CH2]C([CH]CC)CC(244)',
    structure = SMILES('[CH2]C([CH]CC)CC'),
    E0 = (181.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C)C[CH]C(278)',
    structure = SMILES('[CH2]CC(C)C[CH]C'),
    E0 = (181.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,221.825,821.825,1746.16],'cm^-1')),
...
species(
    label = '[CH2]C(C)C[CH]C(98)',
    structure = SMILES('[CH2]C(C)C[CH]C'),
    E0 = (201.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,1489.26],'cm^-1')),
        HinderedRotor(inertia=(0.0785989,'amu*angstrom^2'), symmetry=1, barrier=(1.80714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.077127,'amu*angstrom^2'), symmetry=1, barrier=(1.7733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0780883,'amu*angstrom^2'), symmetry=1, barrier=(1.7954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.077773,'amu*angstrom^2'), symmetry=1, barrier=(1.78815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0773859,'amu*angstrom^2'), symmetry=1, barrier=(1.77925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]C[CH]CCC(168)',
    structure = SMILES('C[CH]C[CH]CCC'),
    E0 = (173.26,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,209.055,308.932,1269.19,3466.82],'cm^-1')),
        HinderedRotor(inertia=(0.0559874,'amu*angstrom^2'), symmetry=1, barrier=(1.65534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0559874,'amu*angstrom^2'), symmetry=1, barrier=(1.65534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0559874,'amu*angstrom^2'), symmetry=1, barrier=(1.65534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0559874,'amu*angstrom^2'), symmetry=1, barrier=(1.65534,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0559874,'amu*angstrom^2'), symmetry=1, barrier=(1.65534,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.817149,0.0623276,-3.69711e-05,7.70864e-09,7.63423e-13,55336.3,28.0243], Tmin=(100,'K'), Tmax=(1089.05,'K')), NASAPolynomial(coeffs=[11.8024,0.0332416,-1.24214e-05,2.17597e-09,-1.4628e-13,52275.8,-28.9765], Tmin=(1089.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)C[C]C(289)',
    structure = SMILES('[CH2]C(CC)C[C]C'),
    E0 = (435.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.036672,0.0785993,-5.55477e-05,2.1162e-08,-3.34056e-12,52504.8,31.9777], Tmin=(100,'K'), Tmax=(1470.25,'K')), NASAPolynomial(coeffs=[14.886,0.0382,-1.4331e-05,2.47285e-09,-1.62676e-13,48138.4,-45.385], Tmin=(1470.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(CC)C[CH]C(290)',
    structure = SMILES('[CH]C(CC)C[CH]C'),
    E0 = (424.67,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704884,0.0715913,-4.39825e-05,1.41325e-08,-1.933e-12,51194.5,31.6153], Tmin=(100,'K'), Tmax=(1586.44,'K')), NASAPolynomial(coeffs=[11.5692,0.0441987,-1.80828e-05,3.24881e-09,-2.17911e-13,47747.4,-25.8127], Tmin=(1586.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)C[CH]C(193)'],
    products = ['C=CCC(36)', 'C=CC(42)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(CC)C[CH]C(269)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(C=CC)CC(270)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(CC)CC=C(271)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]C(122)', 'C[CH2](6)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CCC(36)', '[CH2][CH]C(44)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]CC(39)', 'C=CC(42)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]C[CH]C(127)', 'C[CH2](6)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]C(44)', '[CH2][CH]CC(39)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C](CC)C[CH]C(281)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH2])C[CH]C(153)', '[CH3](11)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2]C([CH]C)C[CH]C(282)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2]C([CH][CH]C)CC(283)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]CC([CH2])C[CH]C(284)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2][CH]CC([CH2])CC(285)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[CH2]C(C)C[CH]C(98)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(C)C([CH2])CC(195)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]C[CH]CC(80)', 'CH2(T)(28)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C([CH2])CC(112)', '[CH]C(32)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH3](11)', '[CH]CC([CH2])CC(213)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH2]C(CC)C[C]C(289)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[CH]C(CC)C[CH]C(290)'],
    products = ['[CH2]C(CC)C[CH]C(193)'],
