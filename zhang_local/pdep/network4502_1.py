...
species(
    label = '[CH]C([CH])=CC(=C)[O](22104)',
    structure = SMILES('[CH]C([CH])=CC(=C)[O]'),
    E0 = (684.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,325,375,415,465,420,450,1700,1750,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344341,0.073111,-6.54837e-05,3.14567e-08,-6.09624e-12,82418.5,26.6412], Tmin=(100,'K'), Tmax=(1243.83,'K')), NASAPolynomial(coeffs=[14.677,0.0270186,-9.8979e-06,1.66356e-09,-1.08002e-13,78853.1,-45.6327], Tmin=(1243.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(684.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.472373,0.0714072,-5.54918e-05,2.26154e-08,-3.78993e-12,110651,31.2325], Tmin=(100,'K'), Tmax=(1396.09,'K')), NASAPolynomial(coeffs=[14.2777,0.0318529,-1.29936e-05,2.32155e-09,-1.55889e-13,106797,-39.977], Tmin=(1396.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(918.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(CC(C)OJ) + radical(AllylJ2_triplet) + radical(CJCO)"""),
)

species(
    label = '[CH]C([CH])=C[C]([CH2])O(22106)',
    structure = SMILES('[CH]C([CH])=C[C]([CH2])O'),
    E0 = (865.177,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497527,0.0800189,-8.38231e-05,5.08612e-08,-1.29625e-11,104180,31.4596], Tmin=(100,'K'), Tmax=(936.397,'K')), NASAPolynomial(coeffs=[10.299,0.0381499,-1.67535e-05,3.1109e-09,-2.14095e-13,102345,-15.1828], Tmin=(936.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(865.177,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(C2CsJOH) + radical(CJCO) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]([CH])C=C(C)[O](22107)',
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70009,0.0657614,-6.4238e-05,3.27485e-08,-6.58677e-12,104444,27.5475], Tmin=(100,'K'), Tmax=(1215,'K')), NASAPolynomial(coeffs=[14.9016,0.0190069,-6.51544e-06,1.07576e-09,-6.96508e-14,100993,-43.7318], Tmin=(1215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(867.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(CCJ2_triplet) + radical(Allyl_T) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C]([CH])C=C([CH2])[O](22108)',
    structure = SMILES('[CH][C]([CH])C=C([CH2])[O]'),
    E0 = (1026.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,360,370,350,3010,987.5,1337.5,450,1655,350,440,435,1725,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.524761,0.0679904,-7.3562e-05,4.02158e-08,-8.44181e-12,123565,28.8635], Tmin=(100,'K'), Tmax=(1258.9,'K')), NASAPolynomial(coeffs=[16.4644,0.0132097,-3.36365e-06,4.32587e-10,-2.33517e-14,119879,-50.4049], Tmin=(1258.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1026.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCJ2_triplet) + radical(C=C(C)OJ) + radical(Allyl_T) + radical(C=C(O)CJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C]([O])CC([CH])=[CH](22109)',
    structure = SMILES('[CH][C]([O])CC([CH])=[CH]'),
    E0 = (1221.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,360,370,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.466329,0.0819982,-0.000108043,7.94832e-08,-2.37287e-11,146995,29.1839], Tmin=(100,'K'), Tmax=(816.315,'K')), NASAPolynomial(coeffs=[10.919,0.030773,-1.39036e-05,2.59233e-09,-1.7761e-13,145288,-19.1215], Tmin=(816.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1221.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCJ2_triplet) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[C]C(=[CH])C[C]([CH2])[O](22110)',
    structure = SMILES('[C]C(=[CH])C[C]([CH2])[O]'),
    E0 = (1283.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,360,370,350,180.92,193.94,3212.72],'cm^-1')),
        HinderedRotor(inertia=(0.822672,'amu*angstrom^2'), symmetry=1, barrier=(19.2492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729602,'amu*angstrom^2'), symmetry=1, barrier=(19.2487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.726612,'amu*angstrom^2'), symmetry=1, barrier=(19.2542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 8,
    opticalIsomers = 1,
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.231212,0.0873713,-0.0001328,1.0357e-07,-3.16586e-11,154480,27.6899], Tmin=(100,'K'), Tmax=(821.428,'K')), NASAPolynomial(coeffs=[13.5646,0.0211959,-9.67995e-06,1.79787e-09,-1.21881e-13,152331,-33.7572], Tmin=(821.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1283.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_P) + radical(CC(C)OJ) + radical(CJCO) + radical(CJ3)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C([CH])=CC(=C)[O](22104)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', '[CH]=[C]CC(=C)[O](17899)'],
    products = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
    products = ['[CH]C([CH])=CC([CH2])[O](22105)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
    products = ['[CH]C([CH])=C[C]([CH2])O(22106)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
    products = ['[CH][C]([CH])C=C(C)[O](22107)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
    products = ['[CH][C]([CH2])C=C([CH2])[O](20489)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH][C]([CH])C=C([CH2])[O](22108)'],
    products = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
    products = ['[CH]C([CH2])=CC(=C)[O](20482)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C][O](2305)', '[CH]C([CH])=C(19930)'],
    products = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH][C]([O])CC([CH])=[CH](22109)'],
    products = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[C]C(=[CH])C[C]([CH2])[O](22110)'],
    products = ['[CH]C(=[CH])C[C]([CH2])[O](20490)'],
