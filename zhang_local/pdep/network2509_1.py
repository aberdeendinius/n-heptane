...
species(
    label = '[CH2]C1([O])CC12CO2(9811)',
    structure = SMILES('[CH2]C1([O])CC12CO2'),
    E0 = (267.184,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867223,0.0670466,-6.78879e-05,3.63402e-08,-7.80541e-12,32249.2,19.2487], Tmin=(100,'K'), Tmax=(1125.91,'K')), NASAPolynomial(coeffs=[13.2209,0.0231581,-9.41733e-06,1.71907e-09,-1.18051e-13,29467.4,-41.8155], Tmin=(1125.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s1_3_3_ane) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]OC(=C)C(=C)[O](9812)',
    structure = SMILES('[CH2]OC(=C)C(=C)[O]'),
    E0 = (14.6319,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,397.766,397.983,398.035,398.036],'cm^-1')),
        HinderedRotor(inertia=(0.134385,'amu*angstrom^2'), symmetry=1, barrier=(15.0847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133947,'amu*angstrom^2'), symmetry=1, barrier=(15.0882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134116,'amu*angstrom^2'), symmetry=1, barrier=(15.0864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0522125,0.0740477,-7.86743e-05,4.07921e-08,-8.01708e-12,1912.86,26.2735], Tmin=(100,'K'), Tmax=(1371.75,'K')), NASAPolynomial(coeffs=[19.7092,0.0103931,-2.14072e-06,2.30212e-10,-1.11169e-14,-2883.98,-72.6007], Tmin=(1371.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.6319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=COCJ) + radical(C=C(C)OJ)"""),
)
...
species(
    label = 'C=C([O])C1(C)[CH]O1(9814)',
    structure = SMILES('C=C([O])C1(C)[CH]O1'),
    E0 = (58.3837,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.816613,0.0748357,-7.7361e-05,3.92309e-08,-7.15177e-12,7222.29,29.9727], Tmin=(100,'K'), Tmax=(1682.66,'K')), NASAPolynomial(coeffs=[16.679,0.00922149,2.54622e-06,-9.13063e-10,7.32084e-14,4735.44,-53.432], Tmin=(1682.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.3837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=C(O)C1([CH2])CO1(9815)',
    structure = SMILES('[CH]=C(O)C1([CH2])CO1'),
    E0 = (194.463,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,3615,1277.5,1000,3120,650,792.5,1650,350,440,435,1725,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.867474,0.0855866,-0.000101734,5.74249e-08,-1.16644e-11,23582.3,28.577], Tmin=(100,'K'), Tmax=(1477.43,'K')), NASAPolynomial(coeffs=[20.335,0.00458379,4.46651e-06,-1.30779e-09,1.03408e-13,19892.9,-73.2713], Tmin=(1477.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH]O1)C(=C)O(9816)',
    structure = SMILES('[CH2]C1([CH]O1)C(=C)O'),
    E0 = (131.089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3615,1277.5,1000,350,440,435,1725,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2632,0.0887296,-0.000104915,5.78687e-08,-1.13989e-11,15979.2,29.8013], Tmin=(100,'K'), Tmax=(1536.8,'K')), NASAPolynomial(coeffs=[21.7092,0.00207786,5.87743e-06,-1.56566e-09,1.19621e-13,12090.1,-80.5795], Tmin=(1536.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]=C([O])C1(C)CO1(9817)',
    structure = SMILES('[CH]=C([O])C1(C)CO1'),
    E0 = (121.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,3150,900,1100,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.3747,0.0712319,-7.29045e-05,3.75254e-08,-7.01573e-12,14823.1,28.5763], Tmin=(100,'K'), Tmax=(1624.1,'K')), NASAPolynomial(coeffs=[15.6556,0.0113132,1.31178e-06,-6.87541e-10,5.91575e-14,12311.6,-48.2365], Tmin=(1624.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C1([CH]O1)C(=C)[O](9818)',
    structure = SMILES('[CH2]C1([CH]O1)C(=C)[O]'),
    E0 = (268.894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2950,1000,180,180,180,180,540.776,1600,1672.32,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.13152,'amu*angstrom^2'), symmetry=1, barrier=(3.0239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13152,'amu*angstrom^2'), symmetry=1, barrier=(3.0239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.510033,0.0802984,-9.72997e-05,5.59269e-08,-1.15502e-11,32519.2,28.5922], Tmin=(100,'K'), Tmax=(1455.41,'K')), NASAPolynomial(coeffs=[19.0404,0.00407567,4.43823e-06,-1.2931e-09,1.0253e-13,29210.5,-64.8811], Tmin=(1455.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(C=C(C)OJ) + radical(CCsJO)"""),
)

species(
    label = '[CH]=C([O])C1([CH2])CO1(9819)',
    structure = SMILES('[CH]=C([O])C1([CH2])CO1'),
    E0 = (332.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,3150,900,1100,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.150546,0.0775323,-9.52227e-05,5.66488e-08,-1.22127e-11,40124,27.5016], Tmin=(100,'K'), Tmax=(1382.25,'K')), NASAPolynomial(coeffs=[17.4599,0.00683398,2.91637e-06,-1.01432e-09,8.48832e-14,37141,-56.339], Tmin=(1382.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(Cds_P) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[O][C]1CCC12CO2(9821)',
    structure = SMILES('[O][C]1CCC12CO2'),
    E0 = (234.525,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49758,0.0530858,-3.90459e-05,1.51864e-08,-2.46566e-12,28298.3,19.5901], Tmin=(100,'K'), Tmax=(1410.65,'K')), NASAPolynomial(coeffs=[10.7003,0.0269907,-1.12976e-05,2.07258e-09,-1.41557e-13,25702,-27.9737], Tmin=(1410.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C([O])C1([CH2])[CH]O1(9822)',
    structure = SMILES('[CH2]C([O])C1([CH2])[CH]O1'),
    E0 = (494.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2950,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0670154,0.0832915,-8.8733e-05,3.01367e-08,4.94722e-12,59648.4,25.9092], Tmin=(100,'K'), Tmax=(781.181,'K')), NASAPolynomial(coeffs=[20.2257,0.00820283,1.43002e-06,-7.08137e-10,6.479e-14,55640.4,-71.8608], Tmin=(781.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCsJO) + radical(CC(C)OJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH]O1)[C](C)[O](9823)',
    structure = SMILES('[CH2]C1([CH]O1)[C](C)[O]'),
    E0 = (459.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,1000,360,370,350,180,180,180,180,468.467,1600,1756.53,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.13619,'amu*angstrom^2'), symmetry=1, barrier=(3.13129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13619,'amu*angstrom^2'), symmetry=1, barrier=(3.13129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13619,'amu*angstrom^2'), symmetry=1, barrier=(3.13129,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.323882,0.0920181,-0.000127402,8.66668e-08,-2.19217e-11,55456.8,26.0666], Tmin=(100,'K'), Tmax=(1131.43,'K')), NASAPolynomial(coeffs=[17.5904,0.0127212,-1.10924e-06,-2.1849e-10,3.19059e-14,52424.8,-58.056], Tmin=(1131.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJOH) + radical(CJC(C)OC) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])=C1CCO1(9824)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12976,0.0446059,2.16835e-05,-8.07126e-08,4.14894e-11,-973.523,20.663], Tmin=(100,'K'), Tmax=(882.412,'K')), NASAPolynomial(coeffs=[21.7912,0.00281018,4.56949e-06,-1.17613e-09,8.49541e-14,-6639.08,-87.8732], Tmin=(882.412,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.10015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(2methyleneoxetane) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2]OC([CH2])=C([CH2])[O](9825)',
    structure = SMILES('[CH2]OC([CH2])=C([CH2])[O]'),
    E0 = (207.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,668.507,668.522],'cm^-1')),
        HinderedRotor(inertia=(0.0129129,'amu*angstrom^2'), symmetry=1, barrier=(4.09521,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0379996,'amu*angstrom^2'), symmetry=1, barrier=(12.0504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0379978,'amu*angstrom^2'), symmetry=1, barrier=(12.0507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0379979,'amu*angstrom^2'), symmetry=1, barrier=(12.0506,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0466842,0.0751945,-8.24141e-05,4.38728e-08,-8.75164e-12,25091.3,30.6088], Tmin=(100,'K'), Tmax=(1394.11,'K')), NASAPolynomial(coeffs=[19.7221,0.00890984,-8.04688e-07,-7.37349e-11,1.15124e-14,20508.7,-67.9993], Tmin=(1394.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + radical(C=C(O)CJ) + radical(C=C(O)CJ) + radical(C=COCJ) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    E0 = (70.4222,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,350,440,435,1725,3000,3100,440,815,1455,1000,640.302,640.319,640.347,640.365,640.404,640.412,640.43,640.471,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0380029,'amu*angstrom^2'), symmetry=1, barrier=(11.0588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    label = '[CH]C1(CO1)C(=C)[O](9828)',
    structure = SMILES('[CH]C1(CO1)C(=C)[O]'),
    E0 = (322.876,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.33431,0.0705883,-7.53603e-05,3.95884e-08,-7.49657e-12,39010.5,29.0289], Tmin=(100,'K'), Tmax=(1609.13,'K')), NASAPolynomial(coeffs=[16.0726,0.00846357,2.44396e-06,-8.87743e-10,7.23812e-14,36493.1,-49.345], Tmin=(1609.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1([CH]O1)C(C)=O(9829)',
    structure = SMILES('[CH2]C1([CH]O1)C(C)=O'),
    E0 = (121.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480718,0.0743,-7.26877e-05,2.00488e-08,6.7839e-12,14780.9,22.6749], Tmin=(100,'K'), Tmax=(781.331,'K')), NASAPolynomial(coeffs=[17.776,0.0111081,-4.04543e-08,-4.10784e-10,4.32876e-14,11304.4,-61.4491], Tmin=(781.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH2][C]1OCC12CO2(9830)',
    structure = SMILES('[CH2][C]1OCC12CO2'),
    E0 = (249.509,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00187,0.0732781,-0.000109081,9.64442e-08,-3.388e-11,30109.9,20.515], Tmin=(100,'K'), Tmax=(840.935,'K')), NASAPolynomial(coeffs=[6.013,0.0353778,-1.63901e-05,3.07393e-09,-2.09646e-13,29764.4,0.164081], Tmin=(840.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C](O)C1([CH2])[CH]O1(9831)',
    structure = SMILES('[CH2][C](O)C1([CH2])[CH]O1'),
    E0 = (441.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,3615,1277.5,1000,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.599887,0.100737,-0.000151422,1.08736e-07,-2.87801e-11,53206.7,27.8833], Tmin=(100,'K'), Tmax=(1094.52,'K')), NASAPolynomial(coeffs=[18.4016,0.0108562,-2.34292e-07,-4.13141e-10,4.7558e-14,50271.4,-59.9115], Tmin=(1094.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CJCO) + radical(CJC(C)OC) + radical(CCsJO)"""),
)
...
species(
    label = '[CH2]C1COOC=1[CH2](9832)',
    structure = SMILES('[CH2]C1COOC=1[CH2]'),
    E0 = (235.22,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44927,0.0455023,-8.47453e-06,-2.18433e-08,1.15583e-11,28391.6,24.3909], Tmin=(100,'K'), Tmax=(1004.29,'K')), NASAPolynomial(coeffs=[13.3573,0.0217515,-8.36554e-06,1.56046e-09,-1.11655e-13,24805.8,-39.054], Tmin=(1004.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(12dioxolene) + radical(C=C(O)CJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C1OCOC=1[CH2](9833)',
    structure = SMILES('[CH2]C1OCOC=1[CH2]'),
    E0 = (-49.5229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05203,0.0198836,0.00014383,-2.41573e-07,1.06307e-10,-5807.82,20.6297], Tmin=(100,'K'), Tmax=(903.304,'K')), NASAPolynomial(coeffs=[37.5716,-0.0232282,1.84703e-05,-3.69914e-09,2.43681e-13,-17244.3,-178.626], Tmin=(903.304,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.5229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + ring(Cyclopentane) + radical(C=C(O)CJ) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C1(CO1)C(=C)[O](9302)'],
    products = ['[CH2]C1([O])CC12CO2(9811)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(182.127,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]OC(=C)C(=C)[O](9812)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(70.5395,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 0 used for R4_S_D;doublebond_intra_2H_secDe;radadd_intra_cs2H
Exact match found for rate rule [R4_S_D;doublebond_intra_2H_secDe;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 70.3 to 70.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C1(CO1)C(=C)[O](9302)'],
    products = ['C=C([O])C1(C)[CH]O1(9814)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(O)C1([CH2])CO1(9815)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C1([CH]O1)C(=C)O(9816)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C([O])C1(C)CO1(9817)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C(=C)[O](9818)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]=C([O])C1([CH2])CO1(9819)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C1(CO1)C(=C)[O](9302)'],
    products = ['[CH2]C1(CO1)[C]1CO1(9820)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(14)', 'C=C([O])C(=C)[O](4287)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C(=C)[O](6508)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([O])C1([CH2])[CH]O1(9822)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C1([CH]O1)[C](C)[O](9823)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]OC([CH2])=C([CH2])[O](9825)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[CH2]C([O])=C1CO1(4764)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', '[CH2]C1([C]=C)CO1(9671)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH]C1(CO1)C(=C)[O](9828)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C1([CH]O1)C(C)=O(9829)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C](O)C1([CH2])[CH]O1(9831)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C1COOC=1[CH2](9832)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C1OCOC=1[CH2](9833)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH2(T)(28)', '[CH2]C1([C]=O)CO1(9736)'],
    products = ['[CH2]C1(CO1)C(=C)[O](9302)'],
