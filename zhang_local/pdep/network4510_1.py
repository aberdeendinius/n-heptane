...
species(
    label = '[CH]C(=[CH])C(=O)C[CH2](21241)',
    structure = SMILES('[CH]C(=[CH])C(=O)C[CH2]'),
    E0 = (634.116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,3120,650,792.5,1650,350,440,435,1725,466.356,466.358,466.358,466.36],'cm^-1')),
        HinderedRotor(inertia=(0.000775113,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342269,'amu*angstrom^2'), symmetry=1, barrier=(52.8243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342269,'amu*angstrom^2'), symmetry=1, barrier=(52.8242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.342271,'amu*angstrom^2'), symmetry=1, barrier=(52.8242,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.866321,0.0766585,-0.000107612,9.67851e-08,-3.58007e-11,76371.9,26.793], Tmin=(100,'K'), Tmax=(797.19,'K')), NASAPolynomial(coeffs=[4.77741,0.0439484,-2.14422e-05,4.13322e-09,-2.87652e-13,76164.1,11.4187], Tmin=(797.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(634.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(CJCC=O) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(=[CH])C1(O)[CH]C1(22057)',
    structure = SMILES('[CH]C(=[CH])C1(O)[CH]C1'),
    E0 = (703.075,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02689,0.0499201,5.74643e-06,-5.16057e-08,2.60163e-11,84681.7,28.1701], Tmin=(100,'K'), Tmax=(933.416,'K')), NASAPolynomial(coeffs=[17.8309,0.0171127,-4.53227e-06,7.31631e-10,-5.28308e-14,79836.8,-60.8902], Tmin=(933.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(703.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]C(=[CH])C1([O])[CH]C1(22058)',
    structure = SMILES('[CH]C(=[CH])C1([O])[CH]C1'),
    E0 = (932.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2950,3150,900,1000,1100,350,440,435,1725,180,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,1098.69,2243.3],'cm^-1')),
        HinderedRotor(inertia=(0.0253368,'amu*angstrom^2'), symmetry=1, barrier=(0.582542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0253368,'amu*angstrom^2'), symmetry=1, barrier=(0.582542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38664,0.0438834,8.03967e-06,-4.48758e-08,2.1175e-11,112221,28.0926], Tmin=(100,'K'), Tmax=(961.62,'K')), NASAPolynomial(coeffs=[14.8947,0.0206535,-7.13648e-06,1.28789e-09,-9.2783e-14,108100,-44.4711], Tmin=(961.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(932.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(Cds_P) + radical(CCJCO) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])[C]1CC1(21659)',
    structure = SMILES('[CH]C(=[CH])[C]1CC1'),
    E0 = (825.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,3120,650,792.5,1650,600,935.983,935.983,935.983,935.983,935.983,935.983,935.983,935.983,935.983,935.983,2336.41],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99505,0.0292175,4.12243e-05,-7.38784e-08,3.04246e-11,99313.7,19.3493], Tmin=(100,'K'), Tmax=(951.859,'K')), NASAPolynomial(coeffs=[12.2655,0.0231717,-7.73441e-06,1.37421e-09,-9.85997e-14,95677.2,-38.5246], Tmin=(951.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(825.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(Allyl_T) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]C(=[CH])C1([O])CC1(22059)',
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15172,0.051141,-2.05605e-05,-1.72171e-08,1.21682e-11,124122,24.4768], Tmin=(100,'K'), Tmax=(964.879,'K')), NASAPolynomial(coeffs=[16.756,0.0136086,-4.43023e-06,8.07592e-10,-5.9788e-14,119847,-56.7976], Tmin=(964.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1031.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(CJ3) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])C1([O])CC1(20365)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=[CH])C(=O)C[CH2](21241)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC1([O])CC1(11837)'],
    products = ['[CH]C(=[CH])C1([O])CC1(20365)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C(=[CH])C1([O])CC1(20365)'],
    products = ['[CH]C(=[CH])C1(O)[CH]C1(22057)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=[CH])C1([O])CC1(20365)'],
    products = ['[CH]C(=C)C1([O])[CH]C1(20364)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(296800,'s^-1'), n=2.23, Ea=(44.3086,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_DSS;Cd_rad_out_singleH;Cs_H_out_1H] for rate rule [R4H_DSS;Cd_rad_out_singleH;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]C(=[CH])C1([O])[CH]C1(22058)'],
    products = ['[CH]C(=[CH])C1([O])CC1(20365)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(S)(14)', '[CH]C(=[CH])C(=C)[O](19452)'],
    products = ['[CH]C(=[CH])C1([O])CC1(20365)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O(T)(63)', '[CH]C(=[CH])[C]1CC1(21659)'],
    products = ['[CH]C(=[CH])C1([O])CC1(20365)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[C]C(=[CH])C1([O])CC1(22059)'],
    products = ['[CH]C(=[CH])C1([O])CC1(20365)'],
