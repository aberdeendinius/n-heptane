...
species(
    label = '[CH2][CH]C1CC([CH2])O1(14061)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05907,0.0536281,-2.12381e-06,-4.3296e-08,2.43245e-11,50957,27.4183], Tmin=(100,'K'), Tmax=(877.912,'K')), NASAPolynomial(coeffs=[14.7512,0.023322,-5.1531e-06,6.25963e-10,-3.54604e-14,47316.7,-43.8963], Tmin=(877.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)OC) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.564424,0.0969323,-0.000116018,7.02616e-08,-1.65384e-11,48385.3,28.0572], Tmin=(100,'K'), Tmax=(1047.98,'K')), NASAPolynomial(coeffs=[19.2809,0.0211847,-7.59854e-06,1.29052e-09,-8.50211e-14,44225.8,-68.6152], Tmin=(1047.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH2])O[C]=CC(14065)',
    structure = SMILES('[CH2]C([CH2])O[C]=CC'),
    E0 = (402.809,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.177838,0.0923212,-0.000111588,7.08509e-08,-1.77879e-11,48596.8,29.3299], Tmin=(100,'K'), Tmax=(976.014,'K')), NASAPolynomial(coeffs=[15.8469,0.0266471,-1.06565e-05,1.90976e-09,-1.29151e-13,45468.7,-47.5913], Tmin=(976.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(C=CJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C(=C)O[CH][CH]C(10300)',
    structure = SMILES('[CH2]C(=C)O[CH][CH]C'),
    E0 = (301.667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0233884,0.0769749,-5.5716e-05,5.75167e-09,6.717e-12,36437.5,29.3397], Tmin=(100,'K'), Tmax=(948.727,'K')), NASAPolynomial(coeffs=[20.6166,0.0174965,-5.22482e-06,8.72713e-10,-6.1034e-14,31281.6,-75.6828], Tmin=(948.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(CCJCO) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[CH2]C([CH2])OC1[CH]C1(11849)',
    structure = SMILES('[CH2]C([CH2])OC1[CH]C1'),
    E0 = (439.391,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.181004,0.0761347,-6.93079e-05,3.26334e-08,-6.10906e-12,52990.6,29.3568], Tmin=(100,'K'), Tmax=(1292.22,'K')), NASAPolynomial(coeffs=[16.9111,0.0243478,-9.19405e-06,1.62024e-09,-1.09096e-13,48666.9,-55.645], Tmin=(1292.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(CCJCO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C[CH]O[C]([CH2])[CH2](10844)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.809211,0.121005,-0.000216436,1.96124e-07,-6.66888e-11,79050.4,32.3808], Tmin=(100,'K'), Tmax=(893.199,'K')), NASAPolynomial(coeffs=[9.7124,0.038294,-1.77638e-05,3.2271e-09,-2.11614e-13,78590.5,-9.24391], Tmin=(893.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(655.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(RCCJ) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10051,0.0901516,-9.2781e-05,4.54884e-08,-8.34192e-12,66625.1,31.7465], Tmin=(100,'K'), Tmax=(1520.53,'K')), NASAPolynomial(coeffs=[24.9317,0.00945265,-1.11934e-06,1.56246e-11,3.35788e-15,60120.8,-100.109], Tmin=(1520.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(552.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C([CH2])OC[C]=C(14073)',
    structure = SMILES('[CH2]C([CH2])OC[C]=C'),
    E0 = (460.717,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0329893,0.0975666,-0.000149907,1.29402e-07,-4.39391e-11,55548.2,29.7482], Tmin=(100,'K'), Tmax=(850.754,'K')), NASAPolynomial(coeffs=[8.88286,0.039211,-1.80395e-05,3.35919e-09,-2.27604e-13,54625.9,-8.32882], Tmin=(850.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]=CCOC([CH2])[CH2](14074)',
    structure = SMILES('[CH]=CCOC([CH2])[CH2]'),
    E0 = (469.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0613383,0.0963236,-0.000141096,1.16469e-07,-3.83645e-11,56664,29.7806], Tmin=(100,'K'), Tmax=(834.949,'K')), NASAPolynomial(coeffs=[10.291,0.0369197,-1.67539e-05,3.11794e-09,-2.11974e-13,55277.2,-16.2484], Tmin=(834.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.556159,0.0636791,-2.80369e-05,-1.40965e-08,1.14278e-11,5087.26,26.1472], Tmin=(100,'K'), Tmax=(971.93,'K')), NASAPolynomial(coeffs=[17.1816,0.0229458,-7.9053e-06,1.40623e-09,-9.92492e-14,547.705,-60.3153], Tmin=(971.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.1771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2][CH]C1CC([CH2])O1(14061)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)O[CH]C=C(14062)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C([CH2])OC=C=C(14063)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', 'C=C[CH]OC=C(6503)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2][C](C)O[CH]C=C(13025)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2]C([CH2])OC=[C]C(14064)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2]C([CH2])O[C]=CC(14065)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C=[C]OC([CH2])C(13027)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]=COC([CH2])C(13026)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2]C(=C)O[CH][CH]C(10300)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])[O](740)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH][CH]OC([CH2])=C(10843)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]=COC([CH2])[CH2](14066)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C=[C]OC([CH2])[CH2](14067)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2]C([CH2])OC1[CH]C1(11849)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]CO[C]([CH2])[CH2](10194)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C[CH]O[C]([CH2])[CH2](10844)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', '[CH2][CH]OC=C[CH2](6363)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(28)', '[CH]=COC([CH2])[CH2](6489)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([CH2])OC=C[CH2](14071)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C=COC([CH2])[CH2](14072)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C([CH2])OC[C]=C(14073)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C=COC([CH2])[CH2](10848)'],
    products = ['[CH2][CH]COC([CH2])=C(10186)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=CCOC([CH2])[CH2](14074)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]C=COC([CH2])C(13036)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=C(64)', '[CH]OC([CH2])[CH2](6276)'],
    products = ['[CH2]C=COC([CH2])[CH2](10848)'],
