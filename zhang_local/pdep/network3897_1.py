...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03975,0.0699589,-6.0268e-05,3.50597e-08,-9.58285e-12,71246,31.0675], Tmin=(100,'K'), Tmax=(832.823,'K')), NASAPolynomial(coeffs=[5.51116,0.0484815,-2.15823e-05,4.09013e-09,-2.85638e-13,70501.2,10.3138], Tmin=(832.823,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJC) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CCCC[CH2](18960)',
    structure = SMILES('[CH]=[C]CCCC[CH2]'),
    E0 = (602.322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.879056,0.0707352,-5.3169e-05,2.22312e-08,-4.03059e-12,72553,30.676], Tmin=(100,'K'), Tmax=(1241.06,'K')), NASAPolynomial(coeffs=[9.88381,0.0417123,-1.80904e-05,3.38775e-09,-2.34743e-13,70317.9,-14.7114], Tmin=(1241.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC[CH][CH]CC(18961)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72686,0.0523616,-2.34135e-05,4.31212e-09,-2.84522e-13,65946.8,26.7555], Tmin=(100,'K'), Tmax=(2947.48,'K')), NASAPolynomial(coeffs=[44.7632,0.00246523,-1.65993e-06,2.14966e-10,-6.82304e-15,38060.3,-226.754], Tmin=(2947.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14925,0.0681665,-6.88341e-05,5.6234e-08,-2.11271e-11,66023.2,32.7491], Tmin=(100,'K'), Tmax=(777.3,'K')), NASAPolynomial(coeffs=[2.67824,0.0524869,-2.35023e-05,4.42584e-09,-3.06167e-13,66021.5,27.2757], Tmin=(777.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJC) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27569,0.0651109,-4.62444e-05,2.02551e-08,-4.2539e-12,67318.5,31.3577], Tmin=(100,'K'), Tmax=(1018.27,'K')), NASAPolynomial(coeffs=[5.54096,0.0483559,-2.15626e-05,4.09561e-09,-2.86491e-13,66449.8,10.7031], Tmin=(1018.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJCC) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.379432,0.0725985,-5.59384e-05,2.43745e-08,-4.41238e-12,27131.4,27.4884], Tmin=(100,'K'), Tmax=(1304.14,'K')), NASAPolynomial(coeffs=[12.7587,0.0346287,-1.22657e-05,2.04903e-09,-1.3258e-13,23902.6,-35.5216], Tmin=(1304.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH]=CCCC=CC(18970)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.631638,0.0646534,-3.5754e-05,6.75293e-09,4.46624e-13,33176.3,29.3546], Tmin=(100,'K'), Tmax=(1253.1,'K')), NASAPolynomial(coeffs=[13.4643,0.0351536,-1.41636e-05,2.56667e-09,-1.74613e-13,29060.1,-39.0418], Tmin=(1253.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]CC[C]CC(18973)',
    structure = SMILES('[CH]=[C]CC[C]CC'),
    E0 = (845.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760333,0.0733304,-6.29464e-05,3.03836e-08,-6.24903e-12,101780,29.2267], Tmin=(100,'K'), Tmax=(1128.03,'K')), NASAPolynomial(coeffs=[10.5189,0.0387269,-1.69326e-05,3.18961e-09,-2.22194e-13,99578.3,-19.0283], Tmin=(1128.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(845.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[C]=[C]CC[CH]CC(18974)',
    structure = SMILES('[C]=[C]CC[CH]CC'),
    E0 = (902.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.874452,0.0764057,-9.83945e-05,8.80334e-08,-3.28692e-11,108656,31.4451], Tmin=(100,'K'), Tmax=(807.021,'K')), NASAPolynomial(coeffs=[3.39574,0.0499167,-2.31524e-05,4.39309e-09,-3.0358e-13,108704,22.6449], Tmin=(807.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(902.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet) + radical(Cds_S) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=[C]CC=CCC(18954)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]=[C]CCC=CC(18955)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C#CCC[CH][CH2](17734)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]CC[CH]CC(17642)'],
    products = ['[CH]=CCC[CH]C[CH2](18963)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]CC[CH]CC(17642)'],
    products = ['[CH2]C[CH]CC[C]=C(17641)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]C[CH][CH]CC(18964)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH]=[C]CC[CH][CH2](17740)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]=[C]CC[CH][CH]C(18965)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]=[C]CC[CH]C[CH2](18967)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[CH]=[C]CC[CH]C(17576)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=[C]CCC([CH2])C(18971)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CC(45)', '[CH]=[C]C[CH2](5188)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH2](6)', '[CH]CC[C]=[CH](18831)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C[CH]CC(23)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH]=[C]CC[C]CC(18973)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[C]=[C]CC[CH]CC(18974)'],
    products = ['[CH]=[C]CC[CH]CC(17642)'],
