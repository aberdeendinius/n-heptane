species(
    label = '[CH2]C(CC)O[C]=C(4200)',
    structure = SMILES('[CH2]C(CC)O[C]=C'),
    E0 = (204.544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
...
species(
    label = 'C=[C]OC(=C)CC(4427)',
    structure = SMILES('C=[C]OC(=C)CC'),
    E0 = (145.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,343.526,343.528,343.53,343.531],'cm^-1')),
        HinderedRotor(inertia=(0.00142848,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00142848,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136444,'amu*angstrom^2'), symmetry=1, barrier=(11.4262,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C#COC([CH2])CC(4428)',
    structure = SMILES('C#COC([CH2])CC'),
    E0 = (174.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CC)O[C]=C(4436)',
    structure = SMILES('[CH2][C](CC)O[C]=C'),
    E0 = (404.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C([CH]C)O[C]=C(4437)',
    structure = SMILES('[CH2]C([CH]C)O[C]=C'),
    E0 = (404.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1685,370,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.103844,0.0767649,-6.44084e-05,2.19672e-08,-9.05908e-13,48791.8,32.1887], Tmin=(100,'K'), Tmax=(994.36,'K')), NASAPolynomial(coeffs=[17.9886,0.0220067,-7.73142e-06,1.35039e-09,-9.26632e-14,44385.3,-58.2662], Tmin=(994.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJCO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CC([CH2])O[C]=C(4438)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0590206,0.0827517,-8.34632e-05,4.33767e-08,-8.88577e-12,49438.1,32.0646], Tmin=(100,'K'), Tmax=(1191.68,'K')), NASAPolynomial(coeffs=[17.6564,0.023287,-8.61222e-06,1.50185e-09,-1.00788e-13,45215.9,-56.5084], Tmin=(1191.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]=[C]OC([CH2])CC(4439)',
    structure = SMILES('[CH]=[C]OC([CH2])CC'),
    E0 = (451.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.150495,0.0853182,-8.89338e-05,4.76273e-08,-1.00263e-11,54474.3,31.0092], Tmin=(100,'K'), Tmax=(1162.27,'K')), NASAPolynomial(coeffs=[17.9639,0.0229754,-8.47371e-06,1.47508e-09,-9.89281e-14,50263.6,-59.1058], Tmin=(1162.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = 'C=COC(=C)CC(4440)',
...
species(
    ...
    E0 = (224.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,350.594,350.779,350.803,350.914],'cm^-1')),
        HinderedRotor(inertia=(0.169393,'amu*angstrom^2'), symmetry=1, barrier=(14.7874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169258,'amu*angstrom^2'), symmetry=1, barrier=(14.7865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169329,'amu*angstrom^2'), symmetry=1, barrier=(14.7863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169301,'amu*angstrom^2'), symmetry=1, barrier=(14.7885,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.231273,0.071996,-4.8057e-05,5.05829e-09,4.84279e-12,53335.6,30.4872], Tmin=(100,'K'), Tmax=(991.576,'K')), NASAPolynomial(coeffs=[18.072,0.0228412,-8.21072e-06,1.47206e-09,-1.0323e-13,48675.9,-61.0886], Tmin=(991.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OC(=C)CC(4427)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#COC([CH2])CC(4428)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH2](6)', 'C=[C]OC=C(4212)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH2](6)', '[CH2][CH]O[C]=C(4303)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C](CC)O[C]=C(4436)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', '[CH2]C([CH2])O[C]=C(4338)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]C([CH]C)O[C]=C(4437)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]CC([CH2])O[C]=C(4438)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]OC([CH2])CC(4439)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(14)', '[CH2]C(C)O[C]=C(4194)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=C(584)', '[CH2]C([O])CC(497)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', 'C=[C]O[CH]CC(4341)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C(CC)O[C]=C(4443)'],
    products = ['[CH2]C(CC)O[C]=C(4200)'],
