...
species(
    ...
    E0 = (79.7827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2120,512.5,787.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,1170.05],'cm^-1')),
        HinderedRotor(inertia=(0.139826,'amu*angstrom^2'), symmetry=1, barrier=(3.21487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139424,'amu*angstrom^2'), symmetry=1, barrier=(3.20564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.634587,'amu*angstrom^2'), symmetry=1, barrier=(14.5904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH2]CCC=[C]O(12960)',
    structure = SMILES('[CH2]CCC=[C]O'),
    E0 = (195.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,356.89,356.896],'cm^-1')),
        HinderedRotor(inertia=(0.00132326,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144928,'amu*angstrom^2'), symmetry=1, barrier=(13.1007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144925,'amu*angstrom^2'), symmetry=1, barrier=(13.1007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144924,'amu*angstrom^2'), symmetry=1, barrier=(13.1006,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12406,0.0544011,-2.87996e-05,-5.4467e-09,7.30813e-12,23672.3,27.4189], Tmin=(100,'K'), Tmax=(964.539,'K')), NASAPolynomial(coeffs=[14.3837,0.0197894,-6.66202e-06,1.15482e-09,-7.98641e-14,20166.6,-40.9859], Tmin=(964.539,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(RCCJ)"""),
)
...
species(
    label = 'CCC[C]=C[O](12962)',
    structure = SMILES('CCC[C]=C[O]'),
    E0 = (130.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,366.373,367.316,367.842],'cm^-1')),
        HinderedRotor(inertia=(0.15233,'amu*angstrom^2'), symmetry=1, barrier=(14.6492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153995,'amu*angstrom^2'), symmetry=1, barrier=(14.6107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154473,'amu*angstrom^2'), symmetry=1, barrier=(14.6274,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25792,0.0495064,-1.27176e-05,-2.11897e-08,1.23451e-11,15769,23.9073], Tmin=(100,'K'), Tmax=(977.547,'K')), NASAPolynomial(coeffs=[14.2839,0.0211525,-7.48964e-06,1.35078e-09,-9.57893e-14,12030.3,-44.7363], Tmin=(977.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C[CH]C=CO(12963)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12772,0.0472328,7.70936e-06,-5.36271e-08,2.69087e-11,11816.3,23.1709], Tmin=(100,'K'), Tmax=(933.375,'K')), NASAPolynomial(coeffs=[18.5084,0.0132775,-2.85623e-06,4.41761e-10,-3.41997e-14,6806.29,-68.9397], Tmin=(933.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.2644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_S) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][C]=O(4371)',
...
species(
    label = '[CH2]C[CH]C=C[O](12964)',
    structure = SMILES('[CH2]C[CH]C=C[O]'),
    E0 = (238.727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,509.09,509.091,509.156],'cm^-1')),
        HinderedRotor(inertia=(0.000650319,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135458,'amu*angstrom^2'), symmetry=1, barrier=(24.9005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135323,'amu*angstrom^2'), symmetry=1, barrier=(24.9016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54049,0.0402469,1.11686e-05,-4.74757e-08,2.21848e-11,28813.3,23.0994], Tmin=(100,'K'), Tmax=(958.804,'K')), NASAPolynomial(coeffs=[15.2478,0.0169777,-5.4876e-06,9.98448e-10,-7.39602e-14,24625.8,-50.5833], Tmin=(958.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(C=COJ) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH2]CC[C]=C[O](12965)',
    structure = SMILES('[CH2]CC[C]=C[O]'),
    E0 = (335.456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,379.095,381.353,383.174],'cm^-1')),
        HinderedRotor(inertia=(0.00119468,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162435,'amu*angstrom^2'), symmetry=1, barrier=(16.7194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163857,'amu*angstrom^2'), symmetry=1, barrier=(16.7001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2961,0.0502288,-2.31312e-05,-8.98444e-09,7.92741e-12,40451.6,25.5568], Tmin=(100,'K'), Tmax=(983.121,'K')), NASAPolynomial(coeffs=[14.0643,0.0188804,-6.73378e-06,1.21109e-09,-8.54199e-14,36945.5,-40.8886], Tmin=(983.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (281.853,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,2893.27],'cm^-1')),
        HinderedRotor(inertia=(0.00823312,'amu*angstrom^2'), symmetry=1, barrier=(3.55108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155004,'amu*angstrom^2'), symmetry=1, barrier=(3.56384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0301318,'amu*angstrom^2'), symmetry=1, barrier=(13.1389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.44039,'amu*angstrom^2'), symmetry=1, barrier=(79.1013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH2]CCC1[CH]O1(9375)',
    structure = SMILES('[CH2]CCC1[CH]O1'),
    E0 = (237.978,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.217057,0.062177,-5.23385e-05,2.37556e-08,-4.09253e-12,28776.5,26.8305], Tmin=(100,'K'), Tmax=(1702.51,'K')), NASAPolynomial(coeffs=[13.1722,0.0191874,-3.40376e-06,2.63452e-10,-7.03203e-15,26184.3,-37.2218], Tmin=(1702.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ) + radical(CCsJO)"""),
)

species(
    label = '[O]C1[CH]CCC1(12966)',
    structure = SMILES('[O]C1[CH]CCC1'),
    E0 = (166.119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52095,0.0105821,9.76793e-05,-1.339e-07,5.19383e-11,20052.7,21.5795], Tmin=(100,'K'), Tmax=(947.4,'K')), NASAPolynomial(coeffs=[13.4926,0.0200755,-5.72488e-06,1.05007e-09,-8.20757e-14,15468.9,-43.9796], Tmin=(947.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopentane) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = 'C=CCC=CO(12967)',
...
species(
    label = '[CH2]C[CH]C[CH][O](6405)',
    structure = SMILES('[CH2]C[CH]C[CH][O]'),
    E0 = (477.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,180,1836.17,1836.27,1836.38],'cm^-1')),
        HinderedRotor(inertia=(0.118356,'amu*angstrom^2'), symmetry=1, barrier=(2.72123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118261,'amu*angstrom^2'), symmetry=1, barrier=(2.71906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118323,'amu*angstrom^2'), symmetry=1, barrier=(2.72049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118374,'amu*angstrom^2'), symmetry=1, barrier=(2.72166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41965,0.0690775,-0.000113728,1.1605e-07,-4.4834e-11,57546.6,28.5721], Tmin=(100,'K'), Tmax=(855.342,'K')), NASAPolynomial(coeffs=[-0.126994,0.0466259,-2.22972e-05,4.21337e-09,-2.87336e-13,58897.1,42.1397], Tmin=(855.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ) + radical(CCsJOH) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2][CH]C[CH]C[O](6406)',
    structure = SMILES('[CH2][CH]C[CH]C[O]'),
    E0 = (497.388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,180,1464.07,1464.12,1464.56],'cm^-1')),
        HinderedRotor(inertia=(0.188367,'amu*angstrom^2'), symmetry=1, barrier=(4.33092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0028476,'amu*angstrom^2'), symmetry=1, barrier=(4.33396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18851,'amu*angstrom^2'), symmetry=1, barrier=(4.33421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00284429,'amu*angstrom^2'), symmetry=1, barrier=(4.33452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.43238,0.0376808,-1.53664e-05,2.13448e-09,-4.98893e-14,59816.2,24.3233], Tmin=(100,'K'), Tmax=(2719.99,'K')), NASAPolynomial(coeffs=[34.308,0.00287168,-2.01369e-06,2.94018e-10,-1.23708e-14,39100.2,-162.734], Tmin=(2719.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(497.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = 'C1=COCCC1(12952)',
    structure = SMILES('C1=COCCC1'),
    E0 = (-154.386,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28825,0.0133708,0.000101663,-1.48626e-07,6.06053e-11,-18484.2,14.3376], Tmin=(100,'K'), Tmax=(918.948,'K')), NASAPolynomial(coeffs=[16.6006,0.0136833,-1.04771e-06,3.00288e-11,-7.29067e-15,-23758.3,-67.8854], Tmin=(918.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-154.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(3,4-Dihydro-2H-pyran)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.137724,'amu*angstrom^2'), symmetry=1, barrier=(3.16656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142612,'amu*angstrom^2'), symmetry=1, barrier=(3.27892,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0401954,'amu*angstrom^2'), symmetry=1, barrier=(14.3342,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.566874,'amu*angstrom^2'), symmetry=1, barrier=(13.0336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233693,'amu*angstrom^2'), symmetry=1, barrier=(5.37305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0252266,'amu*angstrom^2'), symmetry=1, barrier=(13.0346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH2]C[CH]CC=O(12939)',
    structure = SMILES('[CH2]C[CH]CC=O'),
    E0 = (154.265,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,230.071,1207.64],'cm^-1')),
        HinderedRotor(inertia=(0.125614,'amu*angstrom^2'), symmetry=1, barrier=(4.71825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125612,'amu*angstrom^2'), symmetry=1, barrier=(4.71826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125612,'amu*angstrom^2'), symmetry=1, barrier=(4.71825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000115591,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95662,0.0467262,-2.73659e-05,7.92741e-09,-9.59281e-13,18624.9,25.4833], Tmin=(100,'K'), Tmax=(1750.76,'K')), NASAPolynomial(coeffs=[9.52464,0.0294354,-1.25517e-05,2.28638e-09,-1.53772e-13,15974.9,-15.2665], Tmin=(1750.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCJCC=O)"""),
)

species(
    label = '[CH2]CCC[C]=O(4370)',
    structure = SMILES('[CH2]CCC[C]=O'),
    E0 = (114.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1855,455,950,507.477,2599.61],'cm^-1')),
        HinderedRotor(inertia=(0.388566,'amu*angstrom^2'), symmetry=1, barrier=(8.9339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388842,'amu*angstrom^2'), symmetry=1, barrier=(8.94025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0341617,'amu*angstrom^2'), symmetry=1, barrier=(8.93434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0338989,'amu*angstrom^2'), symmetry=1, barrier=(8.93538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH]1[CH]OCCC1(12958)',
    structure = SMILES('[CH]1[CH]OCCC1'),
    E0 = (136.196,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18693,0.0218743,7.18983e-05,-1.15615e-07,4.9431e-11,16462.8,17.9598], Tmin=(100,'K'), Tmax=(890.339,'K')), NASAPolynomial(coeffs=[13.7558,0.0177778,-1.86388e-06,1.55344e-11,3.13553e-15,12505.1,-47.1667], Tmin=(890.339,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxane) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = 'CCC=CC=O(12970)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62403,0.047159,-2.42335e-05,4.22239e-09,4.11505e-14,-16749.6,21.7174], Tmin=(100,'K'), Tmax=(1595.69,'K')), NASAPolynomial(coeffs=[13.8632,0.0248863,-1.12002e-05,2.07929e-09,-1.4044e-13,-21725.9,-46.403], Tmin=(1595.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-140.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CCC=C[O](6414)'],
    products = ['C=C(18)', 'C=CC=O(5269)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CCC=C[O](6414)'],
    products = ['[O][CH]C1CCC1(12959)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(177207,'s^-1'), n=1.88643, Ea=(129.612,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CCC=C[O](12633)'],
    products = ['[CH2]CCC=C[O](6414)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]CCC=C=O(6484)'],
    products = ['[CH2]CCC=C[O](6414)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C(18)', '[CH2]C=C[O](5266)'],
    products = ['[CH2]CCC=C[O](6414)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH2](22)', '[CH2]C=C[O](5266)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[CH2](21)', '[CH]=C[O](602)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C[CH]C=C[O](12964)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][CH]CC=C[O](6404)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]CC[C]=C[O](12965)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]CC[CH][C]=O(6480)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CCC=C[O](6414)'],
    products = ['[O]C1[CH]CCC1(12966)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.33457e+07,'s^-1'), n=1.02667, Ea=(68.5043,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_CsCs_HH_D;doublebond_intra_pri;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 63.8 to 68.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH2]CCC=C[O](6414)'],
    products = ['C=CCC=CO(12967)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C[CH]C[CH][O](6405)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][CH]C[CH]C[O](6406)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC=C[O](743)', 'CH2(T)(28)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(T)(63)', '[CH]=CCC[CH2](5209)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]CCC=C[O](12968)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH2]CC=CC=O(12969)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][CH2](22)', 'C=CC=O(5269)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC([CH2])C=O(12584)'],
    products = ['[CH2]CCC=C[O](6414)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=O(373)', '[CH]CC[CH2](104)'],
    products = ['[CH2]CCC=C[O](6414)'],
