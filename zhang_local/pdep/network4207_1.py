...
species(
    label = '[CH]C1CCC=1[CH2](19690)',
    structure = SMILES('[CH]C1CCC=1[CH2]'),
    E0 = (588.541,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73675,0.0336541,4.00587e-05,-7.48788e-08,3.07225e-11,70881.1,20.3268], Tmin=(100,'K'), Tmax=(965.861,'K')), NASAPolynomial(coeffs=[13.2872,0.0255694,-9.11852e-06,1.6747e-09,-1.21351e-13,66795.8,-44.5947], Tmin=(965.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(588.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(AllylJ2_triplet) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C1[CH]CC=1[CH2](19694)',
    structure = SMILES('[CH2]C1[CH]CC=1[CH2]'),
    E0 = (533.899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93839,0.0259693,5.73139e-05,-9.63087e-08,3.95084e-11,64305.1,17.6681], Tmin=(100,'K'), Tmax=(952.882,'K')), NASAPolynomial(coeffs=[15.6897,0.0169226,-5.07331e-06,9.51072e-10,-7.45857e-14,59474.4,-59.6067], Tmin=(952.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(533.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.28827,'amu*angstrom^2'), symmetry=1, barrier=(29.6199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29333,'amu*angstrom^2'), symmetry=1, barrier=(29.7362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984538,0.0560446,-3.34438e-05,-6.10413e-09,9.04831e-12,101113,18.0605], Tmin=(100,'K'), Tmax=(947.7,'K')), NASAPolynomial(coeffs=[17.2887,0.0121704,-3.47761e-06,5.86392e-10,-4.23736e-14,96902.2,-65.6313], Tmin=(947.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(839.717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CJ3) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=C)C([CH2])=C(18076)'],
    products = ['[CH]C1([CH2])CC1=C(19669)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.264e+11,'s^-1'), n=0.35, Ea=(234.776,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_(Cd)_D;doublebond_intra_2H;radadd_intra_cs2H]
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH]C(=C)C([CH])=C(18815)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH]C(=[CH])C([CH2])=C(19688)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.15742e+08,'m^3/(mol*s)'), n=0.0433333, Ea=(0.458029,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_rad;H_rad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=C)C([CH])[CH2](19204)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C([CH2])=C([CH])C(19691)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C([CH])=C([CH2])C(19692)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', '[CH]C(=C)[C]=C(19260)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(238.655,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_(Cd)_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 2.0
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', 'C#CC([CH2])=C(17769)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(=C)C([CH2])=C(18076)'],
    products = ['[CH2]C1[CH]CC=1[CH2](19694)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[CH]=C=C([CH2])[CH2](17774)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[C]C(=C)C([CH2])=C(19696)'],
    products = ['[CH]C(=C)C([CH2])=C(18076)'],
