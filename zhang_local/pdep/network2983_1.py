...
species(
    label = 'C[CH]COC1=CC1(11656)',
    structure = SMILES('C[CH]COC1=CC1'),
    E0 = (217.351,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.703996,0.0556209,1.60423e-06,-4.90438e-08,2.46856e-11,26275.2,26.8479], Tmin=(100,'K'), Tmax=(958.223,'K')), NASAPolynomial(coeffs=[19.2213,0.0194391,-6.12054e-06,1.11053e-09,-8.2775e-14,20838.9,-71.5467], Tmin=(958.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCJCO)"""),
)

species(
    label = 'CC=CO[C]1CC1(11657)',
    structure = SMILES('CC=CO[C]1CC1'),
    E0 = (104.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693727,0.054164,9.09229e-06,-5.93908e-08,2.89849e-11,12747.2,24.6143], Tmin=(100,'K'), Tmax=(952.831,'K')), NASAPolynomial(coeffs=[20.3799,0.017316,-4.99203e-06,9.0445e-10,-6.96308e-14,6916.88,-80.3174], Tmin=(952.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C2CsJOC(O))"""),
)
...
species(
    label = '[CH2]CCO[C]1CC1(11659)',
    structure = SMILES('[CH2]CCO[C]1CC1'),
    E0 = (214.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13963,0.0635733,-4.29363e-05,1.53267e-08,-2.33574e-12,25956.8,26.6756], Tmin=(100,'K'), Tmax=(1447.78,'K')), NASAPolynomial(coeffs=[10.5039,0.0377012,-1.6131e-05,2.98352e-09,-2.04329e-13,23245.3,-21.9668], Tmin=(1447.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJ) + radical(C2CsJOCs)"""),
)

species(
    label = 'C[CH][CH]OC1CC1(11660)',
    structure = SMILES('C[CH][CH]OC1CC1'),
    E0 = (209.378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692627,0.0586082,-8.61304e-06,-3.27431e-08,1.72482e-11,25314,28.4963], Tmin=(100,'K'), Tmax=(983.224,'K')), NASAPolynomial(coeffs=[16.6079,0.0265622,-9.61239e-06,1.76111e-09,-1.26011e-13,20603.7,-56.0543], Tmin=(983.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CCCO[C]1[CH]C1(11661)',
    structure = SMILES('CCCO[C]1[CH]C1'),
    E0 = (209.626,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.843897,0.0626515,-4.00905e-05,1.29758e-08,-1.71743e-12,25331.2,29.1623], Tmin=(100,'K'), Tmax=(1718.2,'K')), NASAPolynomial(coeffs=[14.5766,0.0306812,-1.21798e-05,2.14626e-09,-1.41698e-13,20612.1,-44.523], Tmin=(1718.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]COC1CC1(11662)',
    structure = SMILES('[CH2][CH]COC1CC1'),
    E0 = (234.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01804,0.0524469,-1.56898e-07,-3.41348e-08,1.57968e-11,28282.8,29.671], Tmin=(100,'K'), Tmax=(1017.31,'K')), NASAPolynomial(coeffs=[13.9584,0.0310886,-1.2195e-05,2.28067e-09,-1.6245e-13,24122.3,-40.4892], Tmin=(1017.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333917,0.0676976,-2.92625e-05,-1.63207e-08,1.28917e-11,13101.8,28.5835], Tmin=(100,'K'), Tmax=(965.012,'K')), NASAPolynomial(coeffs=[18.1991,0.0238333,-8.00345e-06,1.40878e-09,-9.92627e-14,8248.13,-64.2524], Tmin=(965.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=C(O)CJ)"""),
)

species(
    label = 'CC=COC1CC1(11665)',
    structure = SMILES('CC=COC1CC1'),
    E0 = (-95.3593,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.793003,0.0456786,4.98733e-05,-1.08255e-07,4.77653e-11,-11330.8,23.4534], Tmin=(100,'K'), Tmax=(940.628,'K')), NASAPolynomial(coeffs=[22.4998,0.0162425,-3.44559e-06,5.93129e-10,-5.04478e-14,-18195.8,-94.7256], Tmin=(940.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.3593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane)"""),
)

species(
    label = 'CCCOC1=CC1(11666)',
    structure = SMILES('CCCOC1=CC1'),
    E0 = (17.4488,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506775,0.0608625,-7.0962e-06,-3.94987e-08,2.08379e-11,2238.73,25.0594], Tmin=(100,'K'), Tmax=(969.999,'K')), NASAPolynomial(coeffs=[18.7344,0.0236049,-8.10187e-06,1.48158e-09,-1.07805e-13,-3080.8,-71.5157], Tmin=(969.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.4488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene)"""),
)

species(
    label = 'C=CCOC1CC1(11667)',
    structure = SMILES('C=CCOC1CC1'),
    E0 = (-37.6407,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20647,0.0476504,1.1696e-05,-4.44233e-08,1.88964e-11,-4414.53,25.5698], Tmin=(100,'K'), Tmax=(1017.26,'K')), NASAPolynomial(coeffs=[13.1575,0.0324793,-1.28566e-05,2.41881e-09,-1.72894e-13,-8492.48,-40.3844], Tmin=(1017.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.6407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)

species(
    label = 'CC1COC12CC2(11481)',
    structure = SMILES('CC1COC12CC2'),
    E0 = (-32.8147,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = 'C[C]CO[C]1CC1(11668)',
    structure = SMILES('C[C]CO[C]1CC1'),
    E0 = (457.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05302,0.0657921,-5.14631e-05,2.20156e-08,-4.01164e-12,55182.4,25.1119], Tmin=(100,'K'), Tmax=(1253.44,'K')), NASAPolynomial(coeffs=[10.4562,0.0357846,-1.5553e-05,2.91622e-09,-2.02257e-13,52825.2,-22.3771], Tmin=(1253.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(457.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]COC1=CC1(11656)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CC=CO[C]1CC1(11657)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=CCO[C]1CC1(11566)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]COC1[CH]C1(11658)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CCO[C]1CC1(11659)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH][CH]OC1CC1(11660)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]COC1CC1(11662)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C[CH]CO[C]1[CH]C1(11663)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C[CH][CH]O[C]1CC1(11664)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH]CO[C]1CC1(11568)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(=C)OC[CH]C(10001)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[CH]C[O](425)', '[C]1CC1(11616)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(32)', '[CH2]O[C]1CC1(11545)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[CH]CO[C]1CC1(11617)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[C]CO[C]1CC1(11668)'],
    products = ['C[CH]CO[C]1CC1(11478)'],
