...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774201,0.067491,-7.95743e-05,4.99495e-08,-1.21055e-11,59555.2,26.9395], Tmin=(100,'K'), Tmax=(1121.96,'K')), NASAPolynomial(coeffs=[13.0972,0.0174843,-4.59912e-06,5.75024e-10,-2.86913e-14,57172.2,-32.2265], Tmin=(1121.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(CCsJO) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=CCO[C]1[CH]O1(19702)',
    structure = SMILES('[CH]=CCO[C]1[CH]O1'),
    E0 = (461.584,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.705174,0.0652812,-7.10971e-05,4.06253e-08,-8.89725e-12,55640.5,28.0933], Tmin=(100,'K'), Tmax=(1255.58,'K')), NASAPolynomial(coeffs=[14.1943,0.0154672,-3.41371e-06,3.48742e-10,-1.37762e-14,52792.4,-37.9067], Tmin=(1255.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cs_P) + radical(CCsJO)"""),
)
...
species(
    label = '[CH]=CCOC1=CO1(19706)',
    structure = SMILES('[CH]=CCOC1=CO1'),
    E0 = (440.315,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977209,0.0728154,-9.83099e-05,6.82123e-08,-1.69118e-11,53060.6,23.2643], Tmin=(100,'K'), Tmax=(646.301,'K')), NASAPolynomial(coeffs=[9.96401,0.0265814,-1.27892e-05,2.467e-09,-1.7232e-13,51703,-17.6857], Tmin=(646.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(oxirene) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=[C]CO[C]1CO1(19708)',
    structure = SMILES('[C]=[C]CO[C]1CO1'),
    E0 = (826.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,1685,370,180,1023.88,1023.88,1023.88,1023.88,1023.88,1023.88,1023.88,1023.88,1023.88,2314.81],'cm^-1')),
        HinderedRotor(inertia=(0.0720163,'amu*angstrom^2'), symmetry=1, barrier=(1.6558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0720163,'amu*angstrom^2'), symmetry=1, barrier=(1.6558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0720163,'amu*angstrom^2'), symmetry=1, barrier=(1.6558,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18687,0.0658158,-9.49855e-05,7.50826e-08,-2.27809e-11,99527.7,26.6169], Tmin=(100,'K'), Tmax=(962.364,'K')), NASAPolynomial(coeffs=[8.55688,0.0226037,-8.02601e-06,1.26018e-09,-7.5165e-14,98691.7,-5.62995], Tmin=(962.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(826.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CdCdJ2_triplet) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=[C]COC1=CO1(19697)'],
    products = ['[CH]=[C]CO[C]1CO1(17974)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]1CO1(17974)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.0323,'m^3/(mol*s)'), n=2.98, Ea=(64.5582,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdNd;YJ] for rate rule [Od_CO-NdNd;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 63.0 to 64.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH]=[C]CO[C]1CO1(17974)'],
    products = ['[CH]=[C]COC1[CH]O1(19699)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]CO[C]1CO1(17974)'],
    products = ['[CH]=CCO[C]1[CH]O1(19702)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]CO[C]1CO1(17974)'],
    products = ['C=[C]CO[C]1[CH]O1(17972)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]=[C]CO[C]1[CH]O1(19703)'],
    products = ['[CH]=[C]CO[C]1CO1(17974)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[C]1CO1(1125)', '[CH]=[C]C[O](5268)'],
    products = ['[CH]=[C]CO[C]1CO1(17974)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[C]1CO1(1832)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CO[C]1CO1(17974)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[C]=[C]CO[C]1CO1(19708)'],
    products = ['[CH]=[C]CO[C]1CO1(17974)'],
