...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.27661,0.0768497,-7.86078e-05,4.13324e-08,-8.57435e-12,148.184,29.873], Tmin=(100,'K'), Tmax=(1175.69,'K')), NASAPolynomial(coeffs=[16.4665,0.0217676,-8.33163e-06,1.48279e-09,-1.00707e-13,-3658.68,-50.8544], Tmin=(1175.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.0817134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOH) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C1(C=CO)CO1(9884)',
    structure = SMILES('[CH2]C1(C=CO)CO1'),
    E0 = (-46.8675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.59559,0.0877952,-9.60788e-05,5.01505e-08,-9.33479e-12,-5404.88,30.6124], Tmin=(100,'K'), Tmax=(1649.83,'K')), NASAPolynomial(coeffs=[20.0311,0.00606624,4.86257e-06,-1.40074e-09,1.07658e-13,-8553.95,-72.4686], Tmin=(1649.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.8675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C1(CC[O])CO1(9885)',
    structure = SMILES('[CH2]C1(CC[O])CO1'),
    E0 = (107.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,3150,900,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375082,0.0813124,-0.000103006,7.4127e-08,-2.07997e-11,13047.8,25.3383], Tmin=(100,'K'), Tmax=(1009.4,'K')), NASAPolynomial(coeffs=[10.6506,0.0294637,-9.41814e-06,1.39303e-09,-8.0138e-14,11540.4,-21.5228], Tmin=(1009.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH]CO)CO1(9886)',
    structure = SMILES('[CH2]C1([CH]CO)CO1'),
    E0 = (81.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,3150,900,1100,3000,3100,440,815,1455,1000,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0764155,0.0823597,-9.52249e-05,5.7946e-08,-1.33497e-11,9968.57,28.5838], Tmin=(100,'K'), Tmax=(1231.2,'K')), NASAPolynomial(coeffs=[15.6905,0.0190186,-3.29337e-06,1.7407e-10,4.12193e-15,7004.45,-47.0325], Tmin=(1231.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = 'CC1([CH][CH]O)CO1(9887)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0650382,0.0791595,-8.5748e-05,4.9055e-08,-1.06309e-11,6336.95,28.3405], Tmin=(100,'K'), Tmax=(1311.61,'K')), NASAPolynomial(coeffs=[15.8688,0.0187153,-3.06904e-06,1.42046e-10,5.24054e-15,3176.52,-48.9673], Tmin=(1311.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.3978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'CC1([CH]O1)C[CH]O(9888)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408154,0.0873419,-0.000101652,6.05388e-08,-1.3552e-11,4402.85,27.2768], Tmin=(100,'K'), Tmax=(1267.26,'K')), NASAPolynomial(coeffs=[17.8874,0.0164134,-2.09569e-06,-4.15997e-11,1.81235e-14,824.16,-61.1462], Tmin=(1267.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.2181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C1([CH]O1)CCO(9889)',
    structure = SMILES('[CH2]C1([CH]O1)CCO'),
    E0 = (65.4303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2950,1000,180,180,180,180,522.821,1600,1701.39,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.143441,'amu*angstrom^2'), symmetry=1, barrier=(3.29798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143441,'amu*angstrom^2'), symmetry=1, barrier=(3.29798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143441,'amu*angstrom^2'), symmetry=1, barrier=(3.29798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143441,'amu*angstrom^2'), symmetry=1, barrier=(3.29798,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.436765,0.0907337,-0.000111746,7.01573e-08,-1.65499e-11,8035.23,27.5827], Tmin=(100,'K'), Tmax=(1201.39,'K')), NASAPolynomial(coeffs=[17.696,0.0167271,-2.32178e-06,-9.82098e-12,1.70632e-14,4662.25,-59.1295], Tmin=(1201.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.4303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = 'CC1(C[CH][O])CO1(9890)',
    structure = SMILES('CC1(C[CH][O])CO1'),
    E0 = (77.2009,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.92501,0.0708695,-6.30047e-05,1.55623e-08,9.27263e-12,9393.14,23.2141], Tmin=(100,'K'), Tmax=(670.485,'K')), NASAPolynomial(coeffs=[10.8705,0.029189,-9.2498e-06,1.38089e-09,-8.10764e-14,7662.69,-23.7504], Tmin=(670.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.2009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = 'CC1(C=CO)CO1(9893)',
    structure = SMILES('CC1(C=CO)CO1'),
    E0 = (-257.378,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.633979,0.0527424,2.65347e-05,-9.98261e-08,5.25112e-11,-30813.7,22.8655], Tmin=(100,'K'), Tmax=(864.585,'K')), NASAPolynomial(coeffs=[25.1298,0.0015914,7.40222e-06,-1.89173e-09,1.40369e-13,-37373.4,-105.188], Tmin=(864.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-257.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'CC1(CC=O)CO1(9894)',
    structure = SMILES('CC1(CC=O)CO1'),
    E0 = (-251.774,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.485715,0.0672381,-6.01713e-05,3.04647e-08,-6.08573e-12,-30146.3,23.6551], Tmin=(100,'K'), Tmax=(1368.79,'K')), NASAPolynomial(coeffs=[12.9045,0.0245209,-6.31726e-06,8.05374e-10,-4.22382e-14,-32944.1,-37.958], Tmin=(1368.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717022,0.0722693,-8.30419e-05,5.65261e-08,-1.5253e-11,5488.39,26.2868], Tmin=(100,'K'), Tmax=(1034.12,'K')), NASAPolynomial(coeffs=[9.6495,0.0295762,-9.30494e-06,1.37628e-09,-7.98434e-14,4076.29,-15.0019], Tmin=(1034.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.6513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CCsJOH) + radical(C2CsJOCs)"""),
)
...
species(
    label = 'OC1CC2(CO2)C1(9320)',
    structure = SMILES('OC1CC2(CO2)C1'),
    E0 = (-172.463,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2]O[C]([CH2])C[CH]O(9896)',
    structure = SMILES('[CH2]O[C]([CH2])C[CH]O'),
    E0 = (301.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63,0.117996,-0.000218205,2.00691e-07,-6.87496e-11,36393.4,31.2856], Tmin=(100,'K'), Tmax=(894.926,'K')), NASAPolynomial(coeffs=[9.07032,0.0363491,-1.71781e-05,3.13016e-09,-2.0493e-13,36190.4,-5.86946], Tmin=(894.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]C1(C[C]O)CO1(9899)',
    structure = SMILES('[CH2]C1(C[C]O)CO1'),
    E0 = (342.696,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.331553,0.0916848,-0.000122379,8.17658e-08,-2.04692e-11,41376,25.7377], Tmin=(100,'K'), Tmax=(1131.91,'K')), NASAPolynomial(coeffs=[17.3707,0.0150582,-2.18903e-06,-4.69947e-12,1.65161e-14,38269.9,-57.8773], Tmin=(1131.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CH2_triplet) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]C1(C[CH]O)CO1(9900)',
    structure = SMILES('[CH]C1(C[CH]O)CO1'),
    E0 = (299.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.110586,0.0850464,-0.000105522,6.73178e-08,-1.61819e-11,36199.6,27.0124], Tmin=(100,'K'), Tmax=(1178.76,'K')), NASAPolynomial(coeffs=[16.2028,0.0170097,-2.81018e-06,1.02466e-10,8.91706e-15,33234.5,-50.6372], Tmin=(1178.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C[CH]O(9882)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(CC=O)CO1(9240)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH2]C1(C=CO)CO1(9884)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C1(CC[O])CO1(9885)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C1([CH]CO)CO1(9886)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C1(C[CH]O)CO1(9317)'],
    products = ['CC1([CH]O1)C[CH]O(9888)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C1([CH]O1)CCO(9889)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C1(C[CH][O])CO1(9233)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C1([CH][CH]O)CO1(9891)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C[CH]O(9892)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(14)', 'C=C([O])C[CH]O(5572)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C[CH]O(6450)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]O[C]([CH2])C[CH]O(9896)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction29',
    reactants = ['OH(D)(132)', '[CH]CC1([CH2])CO1(9371)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(28)', 'O[CH]C[C]1CO1(5855)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]O(5471)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH2]C1(C[C]O)CO1(9899)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH]C1(C[CH]O)CO1(9900)'],
    products = ['[CH2]C1(C[CH]O)CO1(9317)'],
