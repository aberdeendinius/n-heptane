species(
    label = '[CH2]C(CO[O])O[C]=C(6950)',
    structure = SMILES('[CH2]C(CO[O])O[C]=C'),
    E0 = (292.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.29681,0.0967943,-0.00012768,8.71413e-08,-2.33907e-11,35273,33.118], Tmin=(100,'K'), Tmax=(915.853,'K')), NASAPolynomial(coeffs=[16.0669,0.0253245,-1.06244e-05,1.93306e-09,-1.31208e-13,32275.7,-44.389], Tmin=(915.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(C=CJO) + radical(ROOJ)"""),
)
...
species(
    label = 'C=[C]OC(=C)CO[O](7606)',
    structure = SMILES('C=[C]OC(=C)CO[O]'),
    E0 = (238.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,261.26,261.302,261.531,1637.33],'cm^-1')),
        HinderedRotor(inertia=(0.00248513,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204138,'amu*angstrom^2'), symmetry=1, barrier=(9.91437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204793,'amu*angstrom^2'), symmetry=1, barrier=(9.91163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205505,'amu*angstrom^2'), symmetry=1, barrier=(9.917,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.768486,0.0764645,-0.000103679,8.39462e-08,-2.8025e-11,28752.9,33.0496], Tmin=(100,'K'), Tmax=(786.374,'K')), NASAPolynomial(coeffs=[8.20596,0.0345645,-1.59951e-05,3.03138e-09,-2.09478e-13,27709,-0.244737], Tmin=(786.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CJO)"""),
)

species(
    label = 'C#COC([CH2])CO[O](7607)',
    structure = SMILES('C#COC([CH2])CO[O]'),
    E0 = (261.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,750,770,3400,2100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.526908,0.100934,-0.000137896,9.34702e-08,-2.45703e-11,31623.7,28.2706], Tmin=(100,'K'), Tmax=(939.672,'K')), NASAPolynomial(coeffs=[18.5488,0.0197314,-8.27039e-06,1.50337e-09,-1.02086e-13,28038.8,-62.5713], Tmin=(939.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0401289,0.091462,-0.00012102,8.58281e-08,-2.43455e-11,34020.8,32.9651], Tmin=(100,'K'), Tmax=(861.707,'K')), NASAPolynomial(coeffs=[13.3689,0.029592,-1.33235e-05,2.50969e-09,-1.73635e-13,31723.7,-29.355], Tmin=(861.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(C=CJO) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.40724,0.097001,-0.000122888,7.83587e-08,-1.94931e-11,30057.4,32.5883], Tmin=(100,'K'), Tmax=(989.56,'K')), NASAPolynomial(coeffs=[18.1755,0.0218851,-9.02432e-06,1.64797e-09,-1.12923e-13,26379.7,-56.8677], Tmin=(989.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJCO) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C([CH]OO)O[C]=C(7611)',
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108416,0.0861927,-9.90304e-05,5.98285e-08,-1.44115e-11,32622.7,32.0599], Tmin=(100,'K'), Tmax=(1011.22,'K')), NASAPolynomial(coeffs=[15.023,0.0271956,-1.15157e-05,2.13205e-09,-1.47239e-13,29606.3,-40.0605], Tmin=(1011.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CJO) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C([CH]O[O])OC=C(7613)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.633866,0.0994009,-0.000123675,7.66479e-08,-1.84013e-11,29136,31.3426], Tmin=(100,'K'), Tmax=(1028.68,'K')), NASAPolynomial(coeffs=[19.8734,0.0196575,-7.39331e-06,1.28658e-09,-8.59495e-14,24917,-68.1726], Tmin=(1028.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](COO)O[C]=C(7614)',
    structure = SMILES('[CH2][C](COO)O[C]=C'),
    E0 = (340.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.568307,0.107567,-0.000157957,1.16931e-07,-3.2945e-11,41076.7,34.8445], Tmin=(100,'K'), Tmax=(711.53,'K')), NASAPolynomial(coeffs=[15.4488,0.0282291,-1.32707e-05,2.51268e-09,-1.72927e-13,38526.4,-38.882], Tmin=(711.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C2CsJOC(O)) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]=[C]OC(C)CO[O](7615)',
    structure = SMILES('[CH]=[C]OC(C)CO[O]'),
    E0 = (328.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0157347,0.087559,-0.000101039,6.02546e-08,-1.41987e-11,39665.9,32.7571], Tmin=(100,'K'), Tmax=(1037.54,'K')), NASAPolynomial(coeffs=[16.2891,0.0246985,-1.01586e-05,1.85881e-09,-1.27733e-13,36282.6,-46.5048], Tmin=(1037.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ) + radical(C=CJO)"""),
)

species(
    label = '[CH]=[C]OC([CH2])COO(7616)',
    structure = SMILES('[CH]=[C]OC([CH2])COO'),
    E0 = (387.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503578,0.106642,-0.000173705,1.43567e-07,-4.57744e-11,59355.6,35.3516], Tmin=(100,'K'), Tmax=(870.357,'K')), NASAPolynomial(coeffs=[14.1579,0.0260227,-1.19475e-05,2.1904e-09,-1.45839e-13,57304.9,-30.4653], Tmin=(870.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(492.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C([CH]O[O])O[C]=C(7618)',
    structure = SMILES('[CH2]C([CH]O[O])O[C]=C'),
    E0 = (480.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.243082,0.098745,-0.000140622,9.99547e-08,-2.65834e-11,57949.4,33.086], Tmin=(100,'K'), Tmax=(727.544,'K')), NASAPolynomial(coeffs=[15.2614,0.0246263,-1.0744e-05,1.96045e-09,-1.32007e-13,55398.9,-38.8058], Tmin=(727.544,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(C=CJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]=[C]OC([CH2])CO[O](7619)',
    structure = SMILES('[CH]=[C]OC([CH2])CO[O]'),
    E0 = (539.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.445021,0.101239,-0.000147771,1.09292e-07,-3.14899e-11,64995.9,34.0501], Tmin=(100,'K'), Tmax=(857.398,'K')), NASAPolynomial(coeffs=[16.5082,0.0221424,-9.386e-06,1.68549e-09,-1.12261e-13,62088.9,-45.1303], Tmin=(857.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(539.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ) + radical(C=CJO) + radical(CJC(C)OC)"""),
)

species(
    label = 'C=COC(=C)CO[O](7620)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.664911,0.0734186,-7.19794e-05,3.80987e-08,-8.24132e-12,-72.8235,30.294], Tmin=(100,'K'), Tmax=(1105.67,'K')), NASAPolynomial(coeffs=[12.7347,0.0297539,-1.27422e-05,2.38172e-09,-1.65497e-13,-2741.88,-29.1482], Tmin=(1105.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.60383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]OC(=C)COO(7621)',
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31436,0.0432112,2.40124e-05,-7.59619e-08,3.78593e-11,5165.44,22.7768], Tmin=(100,'K'), Tmax=(879.614,'K')), NASAPolynomial(coeffs=[17.8095,0.0126973,1.67204e-07,-3.79005e-10,3.21464e-14,542.151,-64.472], Tmin=(879.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.0184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C1COC(=C)O1(7623)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892823,0.0463017,2.91913e-05,-8.6567e-08,4.09625e-11,-7498.97,19.3185], Tmin=(100,'K'), Tmax=(928.409,'K')), NASAPolynomial(coeffs=[23.0205,0.00757751,2.90663e-07,-1.34796e-10,2.22429e-15,-14047.5,-98.931], Tmin=(928.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.4495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(CJC(C)OC)"""),
)

species(
    label = 'C=[C]O[CH]CCO[O](7624)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.290881,0.0953922,-0.000121298,7.88552e-08,-2.01087e-11,34800.1,33.1624], Tmin=(100,'K'), Tmax=(963.754,'K')), NASAPolynomial(coeffs=[16.9517,0.0238294,-9.91871e-06,1.81179e-09,-1.23842e-13,31476.5,-49.3869], Tmin=(963.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=CJO) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.730207,0.0529371,1.89078e-05,-8.03806e-08,4.12113e-11,1809.58,26.3521], Tmin=(100,'K'), Tmax=(888.625,'K')), NASAPolynomial(coeffs=[21.7245,0.0109491,1.13911e-06,-5.46982e-10,4.18252e-14,-3995.04,-84.1206], Tmin=(888.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.9174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C1COOC(=C)O1(7627)',
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.536108,0.0799582,-0.000101198,7.03252e-08,-1.97413e-11,35505.7,29.472], Tmin=(100,'K'), Tmax=(867.441,'K')), NASAPolynomial(coeffs=[11.6181,0.0288551,-1.28266e-05,2.40645e-09,-1.66319e-13,33583.1,-22.4158], Tmin=(867.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CCOJ) + radical(C=CJO)"""),
)
...
species(
    label = 'C=[C]O[CH]CO[O](7629)',
    structure = SMILES('C=[C]O[CH]CO[O]'),
    E0 = (311.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2950,3100,1380,975,1025,1650,1685,370,2750,2850,1437.5,1250,1305,750,350,279.486,279.536,279.541,279.599],'cm^-1')),
        HinderedRotor(inertia=(0.258887,'amu*angstrom^2'), symmetry=1, barrier=(14.3577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258962,'amu*angstrom^2'), symmetry=1, barrier=(14.3579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258964,'amu*angstrom^2'), symmetry=1, barrier=(14.3575,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258928,'amu*angstrom^2'), symmetry=1, barrier=(14.3584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.330978,0.0809255,-0.000108656,7.24452e-08,-1.86974e-11,37638.5,28.6828], Tmin=(100,'K'), Tmax=(957.881,'K')), NASAPolynomial(coeffs=[16.0111,0.0154476,-6.12094e-06,1.0832e-09,-7.25049e-14,34634.5,-46.2899], Tmin=(957.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(ROOJ) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]C(CO[O])O[C]=C(7630)',
    structure = SMILES('[CH]C(CO[O])O[C]=C'),
    E0 = (529.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0147891,0.0873386,-0.000104792,6.3763e-08,-1.52035e-11,63855.1,33.3542], Tmin=(100,'K'), Tmax=(1029.59,'K')), NASAPolynomial(coeffs=[16.9416,0.0214584,-8.80654e-06,1.60773e-09,-1.1036e-13,60363.6,-48.944], Tmin=(1029.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OC(=C)CO[O](7606)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#COC([CH2])CO[O](7607)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]O[O](61)', 'C=[C]OC=C(4212)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=COC([CH2])CO[O](7609)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
    products = ['[CH2][CH]OC(=C)CO[O](7610)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
    products = ['[CH2]C([CH]OO)O[C]=C(7611)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
    products = ['[CH2]C([CH]O[O])OC=C(7613)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](COO)O[C]=C(7614)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]OC([CH2])COO(7616)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O2(2)', '[CH2]C([CH2])O[C]=C(4338)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]O[O](61)', '[CH2][CH]O[C]=C(4303)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][C](CO[O])O[C]=C(7617)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C([CH]O[O])O[C]=C(7618)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]OC([CH2])CO[O](7619)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
    products = ['O(T)(63)', 'C=[C]OC1COC1(7622)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
    products = ['O(T)(63)', '[CH2]C1COC(=C)O1(7623)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CO[O])O[C]=C(6950)'],
    products = ['[O]O(16)', '[CH2]C(=C)O[C]=C(6487)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[C]=C(584)', '[CH2]C([O])CO[O](6846)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(T)(63)', '[CH2]C(C[O])O[C]=C(7628)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(T)(28)', 'C=[C]O[CH]CO[O](7629)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH]C(CO[O])O[C]=C(7630)'],
    products = ['[CH2]C(CO[O])O[C]=C(6950)'],
