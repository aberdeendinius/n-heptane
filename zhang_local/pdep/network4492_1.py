...
species(
    label = '[CH]C(=[CH])C(=C)O[CH2](22127)',
    structure = SMILES('[CH]C(=[CH])C(=C)O[CH2]'),
    E0 = (670.91,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.270763,0.0733531,-6.11137e-05,1.93523e-08,4.45518e-14,80833.8,26.1625], Tmin=(100,'K'), Tmax=(978.844,'K')), NASAPolynomial(coeffs=[17.6045,0.02035,-7.21452e-06,1.25244e-09,-8.56354e-14,76586.2,-61.4555], Tmin=(978.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(670.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(C=COCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(=[CH])C1(C)[CH]O1(22129)',
    structure = SMILES('[CH]C(=[CH])C1(C)[CH]O1'),
    E0 = (713.863,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.640065,0.0782174,-7.58637e-05,3.78144e-08,-7.00109e-12,86045.5,29.3479], Tmin=(100,'K'), Tmax=(1599.49,'K')), NASAPolynomial(coeffs=[16.9194,0.016523,-1.33107e-06,-2.01193e-10,2.70762e-14,82702.9,-56.5032], Tmin=(1599.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(713.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(CCsJO)"""),
)
...
species(
    label = '[CH]C(=[CH])C1([CH2])[CH]O1(22130)',
    structure = SMILES('[CH]C(=[CH])C1([CH2])[CH]O1'),
    E0 = (924.373,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2950,1000,350,440,435,1725,3000,3100,440,815,1455,1000,180,940.637,940.637,940.637,940.637,940.637,940.637,940.637,940.637,940.637,2347.08],'cm^-1')),
        HinderedRotor(inertia=(0.0181741,'amu*angstrom^2'), symmetry=1, barrier=(0.417858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0181741,'amu*angstrom^2'), symmetry=1, barrier=(0.417858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0181741,'amu*angstrom^2'), symmetry=1, barrier=(0.417858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.438078,0.0847532,-9.8893e-05,5.77164e-08,-1.24735e-11,111347,28.3546], Tmin=(100,'K'), Tmax=(1345.76,'K')), NASAPolynomial(coeffs=[18.1166,0.0128761,-1.33884e-07,-4.43126e-10,4.64242e-14,107868,-61.0432], Tmin=(1345.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(924.373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(CJC(C)OC) + radical(CCsJO)"""),
)
...
species(
    label = '[CH]C([CH])=C1CCO1(22131)',
    structure = SMILES('[CH]C([CH])=C1CCO1'),
    E0 = (611.051,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0054,0.048632,2.67755e-05,-7.74293e-08,3.63926e-11,73616.3,21.8325], Tmin=(100,'K'), Tmax=(910.547,'K')), NASAPolynomial(coeffs=[17.1099,0.0230859,-5.60195e-06,7.93542e-10,-5.25455e-14,68809.8,-64.6423], Tmin=(910.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(611.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(2methyleneoxetane) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C([CH])=C([CH2])O[CH2](22133)',
    structure = SMILES('[CH]C([CH])=C([CH2])O[CH2]'),
    E0 = (827.462,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0950286,0.0758991,-6.47067e-05,2.9074e-08,-5.25314e-12,99669.6,30.8347], Tmin=(100,'K'), Tmax=(1331.28,'K')), NASAPolynomial(coeffs=[16.2534,0.0273494,-1.00041e-05,1.68061e-09,-1.08983e-13,95367.3,-51.7439], Tmin=(1331.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(827.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(AllylJ2_triplet) + radical(C=COCJ) + radical(AllylJ2_triplet) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH]C(=[CH])C1([CH])CO1(22134)',
    structure = SMILES('[CH]C(=[CH])C1([CH])CO1'),
    E0 = (978.356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,350,440,435,1725,3120,650,792.5,1650,180,1054,1054,1054,1054,1054,1054,1054,1054,1054,1054,1054,1054,1054,2254.66],'cm^-1')),
        HinderedRotor(inertia=(0.0712795,'amu*angstrom^2'), symmetry=1, barrier=(1.63886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0712795,'amu*angstrom^2'), symmetry=1, barrier=(1.63886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0712795,'amu*angstrom^2'), symmetry=1, barrier=(1.63886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.186573,0.0742565,-7.46523e-05,3.89496e-08,-7.59235e-12,117835,28.5115], Tmin=(100,'K'), Tmax=(1503.58,'K')), NASAPolynomial(coeffs=[15.8787,0.0163173,-1.68685e-06,-1.25866e-10,2.26589e-14,114722,-49.8327], Tmin=(1503.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(978.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]C(=[CH])C1([CH2])CO1(22135)',
    structure = SMILES('[C]C(=[CH])C1([CH2])CO1'),
    E0 = (1039.44,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.144371,0.0816703,-0.000104182,6.44866e-08,-1.46404e-11,125174,25.1351], Tmin=(100,'K'), Tmax=(1283.76,'K')), NASAPolynomial(coeffs=[17.9963,0.00816618,1.54454e-06,-7.21275e-10,6.46717e-14,121915,-61.4649], Tmin=(1283.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1039.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(Cds_P) + radical(CJ3)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=[CH])C(=C)O[CH2](22127)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH](2815)', 'C#CC1([CH2])CO1(9670)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
    products = ['[CH]C(=[CH])C1(C)[CH]O1(22129)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
    products = ['[CH]C(=C)C1([CH2])[CH]O1(20739)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C(=[CH])C1([CH2])[CH]O1(22130)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O(S)(1732)', '[CH]C(=[CH])C([CH2])=C(19688)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C([CH])=C([CH2])O[CH2](22133)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH]C([CH])=C1CO1(21536)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]C(=[CH])C1([CH])CO1(22134)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[C]C(=[CH])C1([CH2])CO1(22135)'],
    products = ['[CH]C(=[CH])C1([CH2])CO1(20740)'],
