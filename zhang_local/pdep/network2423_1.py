species(
    label = '[CH2]OC1([CH2])CO1(9223)',
    structure = SMILES('[CH2]OC1([CH2])CO1'),
    E0 = (103.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13052,0.0780131,-8.62541e-05,4.45592e-08,-8.15828e-12,12666.6,26.8931], Tmin=(100,'K'), Tmax=(1685.7,'K')), NASAPolynomial(coeffs=[18.7821,0.00300452,5.19128e-06,-1.37424e-09,1.02648e-13,9897.11,-67.8739], Tmin=(1685.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CsJOCH3) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]OC(=C)O[CH2](9556)',
    structure = SMILES('[CH2]OC(=C)O[CH2]'),
    E0 = (97.6033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,724.415,727.683,732.674],'cm^-1')),
        HinderedRotor(inertia=(0.0712908,'amu*angstrom^2'), symmetry=1, barrier=(1.63911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653711,'amu*angstrom^2'), symmetry=1, barrier=(15.0301,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0397374,'amu*angstrom^2'), symmetry=1, barrier=(14.9729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0394741,'amu*angstrom^2'), symmetry=1, barrier=(15.0164,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14944,0.0544117,-3.97053e-05,6.25334e-09,3.1977e-12,11849,22.7841], Tmin=(100,'K'), Tmax=(984.615,'K')), NASAPolynomial(coeffs=[15.4745,0.013877,-4.8584e-06,8.76084e-10,-6.23953e-14,8171.96,-50.4512], Tmin=(984.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.6033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]OC1(C)[CH]O1(9558)',
    structure = SMILES('[CH2]OC1(C)[CH]O1'),
    E0 = (76.7416,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86263,0.0470977,2.43834e-05,-9.64527e-08,5.12474e-11,9363.89,20.1866], Tmin=(100,'K'), Tmax=(869.449,'K')), NASAPolynomial(coeffs=[26.6345,-0.0082604,1.08393e-05,-2.45166e-09,1.75664e-13,2493.32,-114.282], Tmin=(869.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.7416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C1([CH]O1)OC(9559)',
    structure = SMILES('[CH2]C1([CH]O1)OC'),
    E0 = (99.3808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19182,0.0797392,-8.94018e-05,4.65257e-08,-8.57851e-12,12169.5,26.5223], Tmin=(100,'K'), Tmax=(1669.95,'K')), NASAPolynomial(coeffs=[19.5681,0.00199281,5.60145e-06,-1.44873e-09,1.07721e-13,9142.99,-72.5797], Tmin=(1669.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.3808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]OC1([CH2])[CH]O1(9560)',
    structure = SMILES('[CH2]OC1([CH2])[CH]O1'),
    E0 = (287.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34725,0.0818851,-9.71248e-05,5.17825e-08,-9.68934e-12,34771.8,27.865], Tmin=(100,'K'), Tmax=(1652.31,'K')), NASAPolynomial(coeffs=[20.9786,-0.00297224,7.88012e-06,-1.86946e-09,1.35848e-13,31599.8,-78.3287], Tmin=(1652.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CsJOCH3) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]O[C]1CCO1(9561)',
    structure = SMILES('[CH2]O[C]1CCO1'),
    E0 = (117.313,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05682,0.0342698,9.48985e-06,-4.08347e-08,2.05259e-11,14187.5,21.1182], Tmin=(100,'K'), Tmax=(879.725,'K')), NASAPolynomial(coeffs=[10.824,0.0183688,-4.25506e-06,5.43636e-10,-3.18432e-14,11717.7,-25.3248], Tmin=(879.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Oxetane) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])O[CH2](9562)',
    structure = SMILES('[CH2]O[C]([CH2])O[CH2]'),
    E0 = (377.267,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2048,0.0661463,-8.67313e-05,6.36929e-08,-1.91636e-11,45471.2,25.9055], Tmin=(100,'K'), Tmax=(805.922,'K')), NASAPolynomial(coeffs=[9.21635,0.0263838,-1.27263e-05,2.47675e-09,-1.74617e-13,44179.8,-11.0172], Tmin=(805.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CsJOCH3) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]OC([CH2])([CH2])[O](9563)',
    structure = SMILES('[CH2]OC([CH2])([CH2])[O]'),
    E0 = (358.558,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,180,180,182.514,1571.26,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.145982,'amu*angstrom^2'), symmetry=1, barrier=(3.35642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145982,'amu*angstrom^2'), symmetry=1, barrier=(3.35642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145982,'amu*angstrom^2'), symmetry=1, barrier=(3.35642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145982,'amu*angstrom^2'), symmetry=1, barrier=(3.35642,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.530342,0.0808361,-0.000115994,8.33635e-08,-2.25749e-11,43245.4,24.222], Tmin=(100,'K'), Tmax=(728.708,'K')), NASAPolynomial(coeffs=[13.1523,0.0201805,-8.89944e-06,1.63516e-09,-1.10588e-13,41176.8,-34.2486], Tmin=(728.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CC(C)(O)OJ) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH]C1(CO1)O[CH2](9565)',
    structure = SMILES('[CH]C1(CO1)O[CH2]'),
    E0 = (341.234,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32952,0.0737277,-7.93919e-05,3.95097e-08,-6.89881e-12,41270.9,28.8924], Tmin=(100,'K'), Tmax=(1799.47,'K')), NASAPolynomial(coeffs=[16.6321,0.0030148,5.2156e-06,-1.34312e-09,9.7726e-14,39791.1,-54.4645], Tmin=(1799.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CsJOCH3) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC1([CH2])CO1(9223)'],
    products = ['C=O(355)', 'C=C1CO1(9173)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)O[CH2](9556)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.264e+11,'s^-1'), n=0.35, Ea=(43.0952,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction4',
    reactants = ['C=O(355)', '[CH2][C]1CO1(9171)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C1([CH]O1)OC(9559)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][O](357)', '[CH2][C]1CO1(9171)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2]OC1([CH2])[CH]O1(9560)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(14)', '[CH2]OC([CH2])=O(1012)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O(S)(1732)', '[CH2]OC([CH2])=C(6270)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[C]([CH2])O[CH2](9562)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC([CH2])([CH2])[O](9563)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', '[CH2]C1([O])CO1(1847)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C1(CO1)O[CH2](9565)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]OC1([CH2])CO1(9566)'],
    products = ['[CH2]OC1([CH2])CO1(9223)'],
...
network(
    label = '2423',
    isomers = [
        '[CH2]OC1([CH2])CO1(9223)',
    ],
    reactants = [
        ('C=O(355)', 'C=C1CO1(9173)'),
    ],
    bathGas = {
        'N2': 0.25,
        'Ne': 0.25,
