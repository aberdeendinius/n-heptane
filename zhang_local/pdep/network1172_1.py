...
species(
    ...
    E0 = (26.0821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,199.224,199.241,199.274],'cm^-1')),
        HinderedRotor(inertia=(0.755739,'amu*angstrom^2'), symmetry=1, barrier=(21.2895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755665,'amu*angstrom^2'), symmetry=1, barrier=(21.2899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755934,'amu*angstrom^2'), symmetry=1, barrier=(21.2897,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
...
species(
    label = '[CH2]COC[CH2](3666)',
    structure = SMILES('[CH2]COC[CH2]'),
    E0 = (149.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,959.553,3004.2],'cm^-1')),
        HinderedRotor(inertia=(0.104592,'amu*angstrom^2'), symmetry=1, barrier=(12.5371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152497,'amu*angstrom^2'), symmetry=1, barrier=(3.50621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.541379,'amu*angstrom^2'), symmetry=1, barrier=(12.4474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48917,'amu*angstrom^2'), symmetry=1, barrier=(34.2389,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
...
species(
    label = '[CH2]CO[C]C(3667)',
    structure = SMILES('[CH2]CO[C]C'),
    E0 = (399.205,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,256.119,256.119,256.12,256.129],'cm^-1')),
        HinderedRotor(inertia=(0.00256991,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00256977,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309471,'amu*angstrom^2'), symmetry=1, barrier=(14.4056,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309477,'amu*angstrom^2'), symmetry=1, barrier=(14.4055,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58044,0.0559384,-5.93964e-05,3.53721e-08,-8.75775e-12,48098.1,19.0463], Tmin=(100,'K'), Tmax=(964.344,'K')), NASAPolynomial(coeffs=[9.02234,0.0250708,-1.13842e-05,2.18117e-09,-1.53396e-13,46662.7,-16.5865], Tmin=(964.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]C(3575)'],
    products = ['C=C(18)', 'CC=O(606)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CO[CH]C(3600)'],
    products = ['[CH2]CO[CH]C(3575)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH][O](605)', '[CH2][CH2](22)'],
    products = ['[CH2]CO[CH]C(3575)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][CH]O[CH]C(718)'],
    products = ['[CH2]CO[CH]C(3575)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]OC[CH2](632)', 'H(8)'],
    products = ['[CH2]CO[CH]C(3575)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]OC[CH2](422)', '[CH3](11)'],
    products = ['[CH2]CO[CH]C(3575)'],
