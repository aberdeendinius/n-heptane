...
species(
    label = '[O][CH][CH]C[CH][O](1120)',
    structure = SMILES('[O][CH][CH]C[CH][O]'),
    E0 = (547.949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,180,180,1733.95,1736.57,1740.85],'cm^-1')),
        HinderedRotor(inertia=(0.116556,'amu*angstrom^2'), symmetry=1, barrier=(2.67985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117027,'amu*angstrom^2'), symmetry=1, barrier=(2.69068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114564,'amu*angstrom^2'), symmetry=1, barrier=(2.63405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3676,0.0732257,-0.000144241,1.48554e-07,-5.59443e-11,65983.2,27.7738], Tmin=(100,'K'), Tmax=(871.475,'K')), NASAPolynomial(coeffs=[0.894843,0.0379896,-1.92081e-05,3.65228e-09,-2.47391e-13,67486,38.1391], Tmin=(871.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(547.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCJCO) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOH) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[O][CH][CH]C[CH][O](1120)'],
    products = ['[O][CH]CC[CH][O](701)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C[CH][O](430)', '[CH][O](751)'],
    products = ['[O][CH]CC[CH][O](701)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[O][C]CC[CH][O](1122)'],
    products = ['[O][CH]CC[CH][O](701)'],
