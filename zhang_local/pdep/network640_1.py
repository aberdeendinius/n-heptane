...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51102,0.0569726,-3.76495e-05,1.25176e-08,-1.75377e-12,-8756.72,26.6744], Tmin=(100,'K'), Tmax=(1551.93,'K')), NASAPolynomial(coeffs=[10.5454,0.0336869,-1.51428e-05,2.84926e-09,-1.96294e-13,-11560.9,-20.882], Tmin=(1551.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.5302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(CsJOC(O)C)"""),
)

species(
    label = 'C[CH]CC(=O)C[O](1915)',
    structure = SMILES('C[CH]CC(=O)C[O]'),
    E0 = (16.4073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,369.103,369.103,3487.89,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00123739,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.339358,'amu*angstrom^2'), symmetry=1, barrier=(32.8081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0909663,'amu*angstrom^2'), symmetry=1, barrier=(8.79434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0909662,'amu*angstrom^2'), symmetry=1, barrier=(8.79435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3212,0.0630598,-5.95519e-05,3.45676e-08,-8.84192e-12,2066.27,28.1007], Tmin=(100,'K'), Tmax=(910.262,'K')), NASAPolynomial(coeffs=[7.23823,0.0370586,-1.67052e-05,3.1873e-09,-2.23513e-13,989.048,0.110689], Tmin=(910.262,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.4073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CCJCC=O) + radical(C=OCOJ)"""),
)

species(
    label = 'CC=CC1([O])CO1(1916)',
    structure = SMILES('CC=CC1([O])CO1'),
    E0 = (-15.7097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.483402,0.072671,-7.06199e-05,3.50883e-08,-6.3957e-12,-1705.62,27.4209], Tmin=(100,'K'), Tmax=(1653.5,'K')), NASAPolynomial(coeffs=[15.7366,0.0141421,-2.43401e-08,-4.30663e-10,4.13676e-14,-4432.43,-51.0136], Tmin=(1653.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]CCC1([O])CO1(1918)',
    structure = SMILES('[CH2]CCC1([O])CO1'),
    E0 = (74.0785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927566,0.0571115,-1.39771e-05,-3.24574e-08,2.08769e-11,9030.2,25.1643], Tmin=(100,'K'), Tmax=(876.499,'K')), NASAPolynomial(coeffs=[15.766,0.0203987,-4.2069e-06,4.67712e-10,-2.48786e-14,5238.09,-51.2601], Tmin=(876.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.0785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'C[CH][CH]C1(O)CO1(1919)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.738994,0.0531178,1.69214e-05,-8.37554e-08,4.50709e-11,3886.65,28.0218], Tmin=(100,'K'), Tmax=(864.719,'K')), NASAPolynomial(coeffs=[22.9133,0.00526099,5.02188e-06,-1.40514e-09,1.0639e-13,-1993.94,-87.562], Tmin=(864.719,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.1902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CC1(O)[CH]O1(1920)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.80354,0.0869347,-8.78557e-05,4.30646e-08,-7.58193e-12,2049.71,34.8761], Tmin=(100,'K'), Tmax=(1744.58,'K')), NASAPolynomial(coeffs=[19.1642,0.0102183,2.7312e-06,-9.62299e-10,7.56718e-14,-907.661,-65.4579], Tmin=(1744.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.0106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(CCsJO)"""),
)

species(
    label = 'CCCC1([O])[CH]O1(1921)',
    structure = SMILES('CCCC1([O])[CH]O1'),
    E0 = (52.5546,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.691103,0.0599212,-1.26948e-05,-4.04583e-08,2.53752e-11,6452.25,24.4291], Tmin=(100,'K'), Tmax=(878.606,'K')), NASAPolynomial(coeffs=[18.5884,0.0160177,-1.89418e-06,2.47026e-11,5.05005e-15,1856.93,-67.8528], Tmin=(878.606,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.5546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCsJO)"""),
)

species(
    label = '[CH2][CH]CC1(O)CO1(1922)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31234,0.0812006,-7.92036e-05,3.84613e-08,-6.77299e-12,4616.32,34.6911], Tmin=(100,'K'), Tmax=(1733.59,'K')), NASAPolynomial(coeffs=[17.4649,0.0131284,1.10867e-06,-6.57649e-10,5.57959e-14,1824.53,-55.504], Tmin=(1733.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.5346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.614987,0.0545527,1.72411e-05,-8.5588e-08,4.5643e-11,-29777.5,22.6009], Tmin=(100,'K'), Tmax=(873.625,'K')), NASAPolynomial(coeffs=[24.0441,0.00446346,5.05953e-06,-1.36749e-09,1.01434e-13,-36053.4,-99.7552], Tmin=(873.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'C=CCC1(O)CO1(1928)',
    structure = SMILES('C=CCC1(O)CO1'),
    E0 = (-235.376,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.608799,0.0508901,3.52745e-05,-1.09559e-07,5.54675e-11,-28164.5,23.7295], Tmin=(100,'K'), Tmax=(877.827,'K')), NASAPolynomial(coeffs=[26.299,0.000524827,7.36634e-06,-1.80912e-09,1.30545e-13,-35244.6,-111.501], Tmin=(877.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = '[CH2]O[C]([O])C[CH]C(1929)',
    structure = SMILES('[CH2]O[C]([O])C[CH]C'),
    E0 = (329.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,198.384,281.507,1208.1,1512.83,3364.86],'cm^-1')),
        HinderedRotor(inertia=(0.0970786,'amu*angstrom^2'), symmetry=1, barrier=(2.76362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970786,'amu*angstrom^2'), symmetry=1, barrier=(2.76362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970786,'amu*angstrom^2'), symmetry=1, barrier=(2.76362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970786,'amu*angstrom^2'), symmetry=1, barrier=(2.76362,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970786,'amu*angstrom^2'), symmetry=1, barrier=(2.76362,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04284,0.0750985,-0.000113149,1.09301e-07,-4.18031e-11,39744.7,32.4894], Tmin=(100,'K'), Tmax=(824.322,'K')), NASAPolynomial(coeffs=[2.31705,0.0472166,-2.29285e-05,4.40155e-09,-3.04615e-13,40271.8,31.06], Tmin=(824.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3) + radical(CCOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[C]([O])C[O](1930)',
    structure = SMILES('C[CH]C[C]([O])C[O]'),
    E0 = (326.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1178.4,1408.38,3200],'cm^-1')),
        HinderedRotor(inertia=(0.121848,'amu*angstrom^2'), symmetry=1, barrier=(2.80152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121848,'amu*angstrom^2'), symmetry=1, barrier=(2.80152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121848,'amu*angstrom^2'), symmetry=1, barrier=(2.80152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121848,'amu*angstrom^2'), symmetry=1, barrier=(2.80152,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856003,0.0819176,-0.000134284,1.31623e-07,-4.93343e-11,39400.8,31.0212], Tmin=(100,'K'), Tmax=(855.705,'K')), NASAPolynomial(coeffs=[1.7344,0.0481111,-2.29609e-05,4.33102e-09,-2.94954e-13,40337.8,33.274], Tmin=(855.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    label = 'C[C]CC1([O])CO1(1932)',
    structure = SMILES('C[C]CC1([O])CO1'),
    E0 = (317.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.22117,0.0718887,-6.66505e-05,3.20006e-08,-5.77825e-12,38302,27.409], Tmin=(100,'K'), Tmax=(1608.5,'K')), NASAPolynomial(coeffs=[16.4443,0.0167407,-2.44235e-06,9.17239e-11,4.42943e-15,34713.6,-55.4024], Tmin=(1608.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C[CH]C(1914)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CC=CC1([O])CO1(1916)', 'H(8)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CCC1([O])CO1(1917)', 'H(8)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]CC1([O])CO1(1547)'],
    products = ['C[CH][CH]C1(O)CO1(1919)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]CC1([O])CO1(1547)'],
    products = ['C[CH]CC1(O)[CH]O1(1920)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]CC1([O])CO1(1547)'],
    products = ['[CH2][CH]CC1(O)CO1(1922)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH][CH]C1([O])CO1(1923)', 'H(8)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH]CC1([O])[CH]O1(1924)', 'H(8)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]CC1([O])CO1(1925)', 'H(8)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C([O])C[CH]C(821)', 'O(S)(1732)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]O[C]([O])C[CH]C(1929)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH3](11)', '[CH]CC1([O])CO1(1848)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[C]CC1([O])CO1(1932)', 'H(8)'],
    products = ['C[CH]CC1([O])CO1(1547)'],
