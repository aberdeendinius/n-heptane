...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC(=O)C(C)[O](3619)'],
    products = ['CC([O])C(C)[O](3660)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', 'CC([O])C=O(1045)'],
    products = ['CC([O])C(C)[O](3660)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH3](11)', 'CC([O])[CH][O](1037)'],
    products = ['CC([O])C(C)[O](3660)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', 'C[C]([O])C(C)[O](3810)'],
    products = ['CC([O])C(C)[O](3660)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', 'CC([O])C[O](3594)'],
    products = ['CC([O])C(C)[O](3660)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(T)(63)', 'C[CH]C(C)[O](3670)'],
    products = ['CC([O])C(C)[O](3660)'],
