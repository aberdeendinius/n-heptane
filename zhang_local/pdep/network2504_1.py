species(
    label = 'C[CH]OC[C]1CO1(9298)',
    structure = SMILES('C[CH]OC[C]1CO1'),
    E0 = (80.5009,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.797897,0.0739938,-7.03105e-05,2.00596e-08,9.01519e-12,9794.3,24.7343], Tmin=(100,'K'), Tmax=(667.129,'K')), NASAPolynomial(coeffs=[11.7998,0.0272158,-8.2757e-06,1.18067e-09,-6.62044e-14,7899.37,-27.0905], Tmin=(667.129,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.5009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(C2CsJO)"""),
)
...
species(
    label = 'C[CH]OCC1=CO1(9614)',
    structure = SMILES('C[CH]OCC1=CO1'),
    E0 = (228.387,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2950,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,994.79,1235.14,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.173996,'amu*angstrom^2'), symmetry=1, barrier=(4.00052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173996,'amu*angstrom^2'), symmetry=1, barrier=(4.00052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173996,'amu*angstrom^2'), symmetry=1, barrier=(4.00052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173996,'amu*angstrom^2'), symmetry=1, barrier=(4.00052,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540222,0.0829287,-0.000123313,1.04781e-07,-3.56617e-11,27586.6,26.4198], Tmin=(100,'K'), Tmax=(819.683,'K')), NASAPolynomial(coeffs=[8.5579,0.0340597,-1.60541e-05,3.04372e-09,-2.09296e-13,26599.6,-8.67002], Tmin=(819.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]OC=C1CO1(9615)',
    structure = SMILES('C[CH]OC=C1CO1'),
    E0 = (-9.44395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2750,3150,900,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'C[CH]OCC1[CH]O1(9616)',
    structure = SMILES('C[CH]OCC1[CH]O1'),
    E0 = (84.1185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.228288,0.0823058,-8.89758e-05,5.01768e-08,-1.07618e-11,10278.6,27.4428], Tmin=(100,'K'), Tmax=(1303.79,'K')), NASAPolynomial(coeffs=[17.1732,0.0184217,-3.40112e-06,2.44878e-10,-3.37655e-15,6633.18,-57.7039], Tmin=(1303.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.1185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCsJOCs)"""),
)

species(
    label = 'C[CH]O[CH]C1CO1(9617)',
    structure = SMILES('C[CH]O[CH]C1CO1'),
    E0 = (80.8521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2950,3150,900,1000,1100,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.282317,0.0852483,-9.72701e-05,5.76228e-08,-1.29207e-11,9886.22,26.8777], Tmin=(100,'K'), Tmax=(1255.66,'K')), NASAPolynomial(coeffs=[17.1108,0.0181031,-3.03684e-06,1.46858e-10,4.86686e-15,6443.62,-57.3091], Tmin=(1255.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.8521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC[C]1CO1(9618)',
    structure = SMILES('[CH2]COC[C]1CO1'),
    E0 = (111.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,3150,900,1100,3000,3100,440,815,1455,1000,180,1020.75,1020.75,1020.75,1020.75,1020.75,1020.75,1020.75,1020.75,1020.75,2320.43],'cm^-1')),
        HinderedRotor(inertia=(0.0920475,'amu*angstrom^2'), symmetry=1, barrier=(2.11635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0920475,'amu*angstrom^2'), symmetry=1, barrier=(2.11635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0920475,'amu*angstrom^2'), symmetry=1, barrier=(2.11635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0920475,'amu*angstrom^2'), symmetry=1, barrier=(2.11635,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.543459,0.077867,-9.63855e-05,6.94972e-08,-1.97768e-11,13549.2,26.7812], Tmin=(100,'K'), Tmax=(987.134,'K')), NASAPolynomial(coeffs=[9.77696,0.0308757,-1.04288e-05,1.61868e-09,-9.71659e-14,12192.8,-15.2824], Tmin=(987.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CJCO)"""),
)

species(
    label = 'CCO[CH][C]1CO1(9619)',
    structure = SMILES('CCO[CH][C]1CO1'),
    E0 = (80.5009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441385,0.0761399,-6.97323e-05,2.20861e-08,3.66971e-12,13599.3,25.5001], Tmin=(100,'K'), Tmax=(787.19,'K')), NASAPolynomial(coeffs=[15.1746,0.0217956,-5.28135e-06,6.18791e-10,-2.96672e-14,10643.9,-46.0923], Tmin=(787.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'CCOC[C]1[CH]O1(9621)',
    structure = SMILES('CCOC[C]1[CH]O1'),
    E0 = (83.7673,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.822738,0.0717944,-6.70647e-05,2.42464e-08,2.89856e-12,10187.9,25.3822], Tmin=(100,'K'), Tmax=(712.762,'K')), NASAPolynomial(coeffs=[11.4093,0.0283157,-9.09442e-06,1.38661e-09,-8.34312e-14,8274.01,-24.946], Tmin=(712.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.7673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)
...
species(
    label = 'CCOC=C1CO1(9625)',
    structure = SMILES('CCOC=C1CO1'),
    E0 = (-203.371,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546507,0.0513064,3.01075e-05,-9.61863e-08,4.65324e-11,-24312.7,21.1929], Tmin=(100,'K'), Tmax=(920.647,'K')), NASAPolynomial(coeffs=[26.1705,0.00409251,2.5683e-06,-5.98903e-10,3.44789e-14,-31748,-115.067], Tmin=(920.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(methyleneoxirane)"""),
)

species(
    label = 'C=COCC1CO1(9313)',
    structure = SMILES('C=COCC1CO1'),
    E0 = (-192.194,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.68505,0.0546141,1.36755e-05,-7.73242e-08,4.12727e-11,-22978.8,22.2326], Tmin=(100,'K'), Tmax=(876.631,'K')), NASAPolynomial(coeffs=[22.1938,0.0087657,2.64607e-06,-8.87618e-10,6.79487e-14,-28759.2,-90.1631], Tmin=(876.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'CCOCC1=CO1(9626)',
    structure = SMILES('CCOCC1=CO1'),
    E0 = (-56.0139,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666633,0.0654713,-5.25184e-05,2.16891e-08,-3.60409e-12,-6610.46,25.8698], Tmin=(100,'K'), Tmax=(1431.01,'K')), NASAPolynomial(coeffs=[15.2929,0.0245873,-9.66301e-06,1.72393e-09,-1.16114e-13,-10796.5,-49.9353], Tmin=(1431.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.0139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497678,0.0784415,-0.000101092,7.25717e-08,-2.03594e-11,43547,25.0441], Tmin=(100,'K'), Tmax=(989.168,'K')), NASAPolynomial(coeffs=[11.1923,0.0263784,-8.7725e-06,1.34117e-09,-7.94198e-14,41862.6,-24.2545], Tmin=(989.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CH2_triplet) + radical(C2CsJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]OCC1=CO1(9614)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C[CH]OC=C1CO1(9615)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=COC[C]1CO1(9231)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]OCC1[CH]O1(9616)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]O[CH]C1CO1(9617)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C[CH]OC[C]1[CH]O1(9622)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C[CH]O[CH][C]1CO1(9623)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH]OC[C]1CO1(9242)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C[C]1CO1(2055)', '[CH]C(32)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[CH]C(415)', '[C]1CO1(1125)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[CH]OC[C]1CO1(9578)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[C]OC[C]1CO1(9627)'],
    products = ['C[CH]OC[C]1CO1(9298)'],
