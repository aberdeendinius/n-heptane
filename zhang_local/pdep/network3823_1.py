...
species(
    label = '[CH2]C1([CH2])OC12CC2(18092)',
    structure = SMILES('[CH2]C1([CH2])OC12CC2'),
    E0 = (383.319,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.206217,0.0825389,-9.42372e-05,5.73152e-08,-1.38391e-11,46240.1,20.7676], Tmin=(100,'K'), Tmax=(1012.87,'K')), NASAPolynomial(coeffs=[14.6484,0.0255017,-9.76457e-06,1.71318e-09,-1.14574e-13,43314.6,-49.0915], Tmin=(1012.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + polycyclic(s1_3_3_ane) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]CC(=O)C([CH2])=C(17521)',
    structure = SMILES('[CH2]CC(=O)C([CH2])=C'),
    E0 = (172.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,375,552.5,462.5,1710,380.469,1699.28],'cm^-1')),
        HinderedRotor(inertia=(0.0579227,'amu*angstrom^2'), symmetry=1, barrier=(6.01492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0694808,'amu*angstrom^2'), symmetry=1, barrier=(5.98605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0557064,'amu*angstrom^2'), symmetry=1, barrier=(6.00457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281337,'amu*angstrom^2'), symmetry=1, barrier=(27.3199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18111,0.0676329,-6.7772e-05,4.1768e-08,-1.13913e-11,20866,23.6735], Tmin=(100,'K'), Tmax=(855.182,'K')), NASAPolynomial(coeffs=[7.13249,0.0397954,-1.89435e-05,3.70225e-09,-2.63034e-13,19848.2,-4.10732], Tmin=(855.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(CJCC=O) + radical(C=C(C=O)CJ)"""),
)
...
species(
    label = '[CH2]C(=C)C1(O)[CH]C1(18114)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0926,0.044071,3.02541e-05,-8.13817e-08,3.75321e-11,28602.7,26.7028], Tmin=(100,'K'), Tmax=(932.334,'K')), NASAPolynomial(coeffs=[19.9831,0.013729,-2.50572e-06,3.74243e-10,-3.13843e-14,22876.6,-74.9277], Tmin=(932.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C(C)C1([O])CC1(18115)',
    structure = SMILES('[CH]=C(C)C1([O])CC1'),
    E0 = (361.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17446,0.0493805,-1.70284e-06,-3.3844e-08,1.66471e-11,43602.5,25.9422], Tmin=(100,'K'), Tmax=(985.345,'K')), NASAPolynomial(coeffs=[14.6315,0.0244478,-8.95383e-06,1.6477e-09,-1.17993e-13,39508.9,-46.0966], Tmin=(985.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(Cds_P)"""),
)

species(
    label = 'C=C(C)C1([O])[CH]C1(18116)',
    structure = SMILES('C=C(C)C1([O])[CH]C1'),
    E0 = (314.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2750,2950,3150,900,1000,1100,350,440,435,1725,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44751,0.0405945,2.3717e-05,-6.08263e-08,2.64205e-11,37919.2,27.0552], Tmin=(100,'K'), Tmax=(968.357,'K')), NASAPolynomial(coeffs=[14.8505,0.0231608,-8.03264e-06,1.48152e-09,-1.08333e-13,33545,-46.3583], Tmin=(968.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH]C(=C)C1(O)CC1(18117)',
    structure = SMILES('[CH]C(=C)C1(O)CC1'),
    E0 = (256.077,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903768,0.0516427,1.36478e-05,-5.92962e-08,2.79824e-11,30925.4,26.4052], Tmin=(100,'K'), Tmax=(946.11,'K')), NASAPolynomial(coeffs=[17.0642,0.0241771,-7.58482e-06,1.31011e-09,-9.34394e-14,26038.9,-60.3282], Tmin=(946.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[O]C1(CC1)[C]1CC1(12304)',
    structure = SMILES('[O]C1(CC1)[C]1CC1'),
    E0 = (315.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73192,0.0255386,8.03607e-05,-1.27293e-07,5.17163e-11,38028.4,21.4426], Tmin=(100,'K'), Tmax=(948.776,'K')), NASAPolynomial(coeffs=[18.1437,0.0178771,-4.80442e-06,9.01983e-10,-7.37032e-14,32144.8,-71.4661], Tmin=(948.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C]1COC12CC2(18120)',
    structure = SMILES('[CH2][C]1COC12CC2'),
    E0 = (324.842,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
...
species(
    label = '[CH2][C](C)C1([O])[CH]C1(18121)',
    structure = SMILES('[CH2][C](C)C1([O])[CH]C1'),
    E0 = (557.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30408,0.0433634,2.16096e-05,-6.35884e-08,2.90282e-11,67188.7,27.7029], Tmin=(100,'K'), Tmax=(942.018,'K')), NASAPolynomial(coeffs=[16.0382,0.0207688,-6.05653e-06,1.03187e-09,-7.45788e-14,62639.3,-51.9133], Tmin=(942.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(557.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(CC(C)2OJ)"""),
)
...
species(
    label = 'C=C1COC12CC2(18091)',
    structure = SMILES('C=C1COC12CC2'),
    E0 = (88.0334,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82257,0.0348734,2.87266e-05,-5.68211e-08,2.27877e-11,10677.9,19.8488], Tmin=(100,'K'), Tmax=(990.895,'K')), NASAPolynomial(coeffs=[10.8559,0.0298389,-1.12317e-05,2.07375e-09,-1.47639e-13,7344.61,-31.4355], Tmin=(990.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.0334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + polycyclic(s1_3_4_ane)"""),
)
...
species(
    ...
    E0 = (358.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C1([O])CC1(11856)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[CH2]C1([CH2])OC12CC2(18092)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(122.593,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC(=O)C([CH2])=C(17521)'],
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[CH2]C(=C)C1(O)[CH]C1(18114)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(C)C1([O])CC1(18115)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C(C)C1([O])[CH]C1(18116)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[CH]C(=C)C1(O)CC1(18117)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C(=C)C1([O])[CH]C1(18118)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C(=C)C1([O])CC1(18119)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[O]C1(CC1)[C]1CC1(12304)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[CH2][C]1COC12CC2(18120)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])C1([O])[CH]C1(11860)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C](C)C1([O])[CH]C1(18121)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(T)(63)', '[CH2]C(=C)[C]1CC1(18077)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(28)', 'C=[C]C1([O])CC1(11838)'],
    products = ['[CH2]C(=C)C1([O])CC1(11856)'],
