...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC[C]=C(17477)'],
...
reaction(
    ...
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(169.619,'m^3/(mol*s)'), n=1.605, Ea=(98.0912,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds_Ca;HJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CCO[C]([CH2])[O](18564)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(7.26699,'m^3/(mol*s)'), n=2.00263, Ea=(161.728,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([O])OC[C]=C(17477)'],
    products = ['[CH2][CH][CH]OC([CH2])=O(6733)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=CCO[C]([CH2])[O](16832)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([O])OC[C]=C(17477)'],
    products = ['[CH2][C]=COC([CH2])[O](14446)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([O])OC[C]=C(17477)'],
    products = ['[CH2][C]=CO[C]([CH2])O(14447)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]([O])OC[C]=C(17477)'],
    products = ['[CH2][C][CH]OC(C)=O(14458)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C][CH]OC([CH2])=O(18568)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]CO[C]([CH2])[O](18569)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C][O](2305)', 'C=[C]C[O](4571)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]=C(584)', '[CH2]O[C]([CH2])[O](1016)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH][C]([O])OC[C]=C(18570)'],
    products = ['[CH2][C]([O])OC[C]=C(17477)'],
