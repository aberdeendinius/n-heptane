species(
    ...
    E0 = (136.172,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3100,440,815,1455,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]OC(=C)O[CH]O[O](11171)',
    structure = SMILES('[CH2]OC(=C)O[CH]O[O]'),
    E0 = (126.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.387525,0.0939571,-0.000123907,7.85388e-08,-1.9059e-11,15327.7,29.7309], Tmin=(100,'K'), Tmax=(1022.45,'K')), NASAPolynomial(coeffs=[20.381,0.012706,-4.70506e-06,8.14822e-10,-5.44981e-14,11080.8,-70.9263], Tmin=(1022.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(OCJO) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C1(CO1)OC=O(11173)',
    structure = SMILES('[CH2]C1(CO1)OC=O'),
    E0 = (-256.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,180,1026.05,1026.05,1026.05,1026.05,1026.05,1026.05,1026.05,1026.05,1026.05,2284.91],'cm^-1')),
        HinderedRotor(inertia=(0.0678095,'amu*angstrom^2'), symmetry=1, barrier=(1.55907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0678095,'amu*angstrom^2'), symmetry=1, barrier=(1.55907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0678095,'amu*angstrom^2'), symmetry=1, barrier=(1.55907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.837949,0.049767,1.46357e-05,-8.07077e-08,4.35533e-11,-30673.1,21.4033], Tmin=(100,'K'), Tmax=(876.918,'K')), NASAPolynomial(coeffs=[24.6051,-0.00225455,7.16244e-06,-1.69509e-09,1.21749e-13,-37009.6,-102.5], Tmin=(876.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-256.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC1([CH]O1)O[CH]O[O](11174)',
    structure = SMILES('CC1([CH]O1)O[CH]O[O]'),
    E0 = (109.384,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.00391,0.101725,-0.000123733,6.80887e-08,-1.33771e-11,13398.2,32.8836], Tmin=(100,'K'), Tmax=(1526.31,'K')), NASAPolynomial(coeffs=[26.6387,-0.00262584,7.59998e-06,-1.84678e-09,1.36946e-13,8066.07,-106.237], Tmin=(1526.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)OCO[O](11175)',
    structure = SMILES('[CH2]C1([CH]O1)OCO[O]'),
    E0 = (130.934,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.61052,0.113053,-0.000137046,7.23448e-08,-1.33197e-11,16068.8,38.6454], Tmin=(100,'K'), Tmax=(1683.23,'K')), NASAPolynomial(coeffs=[29.3275,-0.0101291,1.27472e-05,-2.83364e-09,2.00328e-13,11342.3,-118.515], Tmin=(1683.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C1([CH]O1)O[CH]OO(11176)',
    structure = SMILES('[CH2]C1([CH]O1)O[CH]OO'),
    E0 = (167.889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2950,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.26444,0.114037,-0.000148995,8.6728e-08,-1.81297e-11,20438.6,32.8021], Tmin=(100,'K'), Tmax=(1406.24,'K')), NASAPolynomial(coeffs=[30.0486,-0.00573017,8.46771e-06,-2.00649e-09,1.49422e-13,14104.6,-124.314], Tmin=(1406.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(OCJO) + radical(CJC(C)OC) + radical(CCsJO)"""),
)
...
species(
    label = '[CH2]C1([CH]O1)O[CH]O[O](11177)',
    structure = SMILES('[CH2]C1([CH]O1)O[CH]O[O]'),
    E0 = (319.894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2950,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84523,0.108696,-0.000147978,8.92018e-08,-1.9237e-11,38702.2,32.0514], Tmin=(100,'K'), Tmax=(1369.42,'K')), NASAPolynomial(coeffs=[28.0787,-0.00667284,9.02026e-06,-2.13985e-09,1.60427e-13,33128.4,-112.149], Tmin=(1369.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(OCJO) + radical(CCsJO) + radical(CJC(C)OC) + radical(ROOJ)"""),
)
...
species(
    label = '[O]O[CH]O[C]1CCO1(11178)',
    structure = SMILES('[O]O[CH]O[C]1CCO1'),
    E0 = (149.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748801,0.0700179,-6.98163e-05,2.9508e-08,-1.27e-12,18154.2,28.2532], Tmin=(100,'K'), Tmax=(799.627,'K')), NASAPolynomial(coeffs=[13.9384,0.0199064,-5.57902e-06,7.68157e-10,-4.32754e-14,15537.5,-35.6019], Tmin=(799.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(Oxetane) + radical(Cs_P) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]C1(CO1)OC1OO1(11179)',
    structure = SMILES('[CH2]C1(CO1)OC1OO1'),
    E0 = (-71.8111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.7292,0.0882538,-9.67924e-05,4.96928e-08,-9.08473e-12,-8397.91,31.5074], Tmin=(100,'K'), Tmax=(1677.18,'K')), NASAPolynomial(coeffs=[21.1863,0.00390665,5.20194e-06,-1.40572e-09,1.05577e-13,-11908.2,-78.446], Tmin=(1677.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.8111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(dioxirane) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])O[CH]O[O](11180)',
    structure = SMILES('[CH2]O[C]([CH2])O[CH]O[O]'),
    E0 = (409.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.367395,0.105343,-0.000179822,1.54739e-07,-5.12453e-11,49449.1,34.6606], Tmin=(100,'K'), Tmax=(854.422,'K')), NASAPolynomial(coeffs=[12.9051,0.0268851,-1.3427e-05,2.5495e-09,-1.73173e-13,47776.9,-23.7965], Tmin=(854.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CsJOCH3) + radical(OCJO) + radical(CJCO) + radical(Cs_P)"""),
)
...
species(
    label = '[CH2]C1(CO1)O[CH][O](11182)',
    structure = SMILES('[CH2]C1(CO1)O[CH][O]'),
    E0 = (140.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.351592,0.0761025,-7.86754e-05,2.7148e-08,3.05038e-12,16981,22.9618], Tmin=(100,'K'), Tmax=(810.639,'K')), NASAPolynomial(coeffs=[18.9101,0.00902717,1.0717e-07,-3.60752e-10,3.63676e-14,13167.2,-67.6411], Tmin=(810.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(OCJO) + radical(OCOJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]C1(CO1)O[CH]O[O](11183)',
    structure = SMILES('[CH]C1(CO1)O[CH]O[O]'),
    E0 = (373.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57931,0.0980541,-0.000123333,7.00352e-08,-1.42294e-11,45189.2,32.1547], Tmin=(100,'K'), Tmax=(1466.64,'K')), NASAPolynomial(coeffs=[25.6268,-0.00290855,7.29695e-06,-1.785e-09,1.33705e-13,40087.3,-99.7056], Tmin=(1466.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(OCJO) + radical(CCJ2_triplet) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C1(CO1)O[C]O[O](11184)',
    structure = SMILES('[CH2]C1(CO1)O[C]O[O]'),
    E0 = (408.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,3150,900,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.27736,0.111575,-0.000140279,7.57292e-08,-1.4257e-11,49399.1,35.9637], Tmin=(100,'K'), Tmax=(1636.78,'K')), NASAPolynomial(coeffs=[30.3422,-0.0134838,1.3643e-05,-2.97667e-09,2.10245e-13,44139.9,-125.243], Tmin=(1636.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(ROOJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)O[CH]O[O](11171)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C1(CO1)OC=O(11173)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(43.675,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
    products = ['CC1([CH]O1)O[CH]O[O](11174)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
    products = ['[CH2]C1([CH]O1)OCO[O](11175)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5.67145,'s^-1'), n=3.19634, Ea=(69.5908,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS;C_rad_out_1H;Cs_H_out_1H] for rate rule [R4H_SSS_OCs;C_rad_out_H/NonDeO;Cs_H_out_H/NonDeO]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C1([CH]O1)O[CH]OO(11176)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2]C1([CH]O1)O[CH]O[O](11177)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(S)(14)', '[CH2]C(=O)O[CH]O[O](8147)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O(S)(1732)', '[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]O[CH]O[C]1CCO1(11178)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
    products = ['[CH2]C1(CO1)OC1OO1(11179)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]O[C]([CH2])O[CH]O[O](11180)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C1([O])CO1(1847)', '[CH]O[O](2819)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(T)(63)', '[CH2]C1(CO1)O[CH][O](11182)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH]OC1([CH2])CO1(9566)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', '[O]O[CH]O[C]1CO1(8743)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]C1(CO1)O[CH]O[O](11183)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]C1(CO1)O[C]O[O](11184)'],
    products = ['[CH2]C1(CO1)O[CH]O[O](9345)'],
