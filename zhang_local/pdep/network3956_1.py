...
species(
    label = '[C]=[C]CO[CH][CH2](19503)',
    structure = SMILES('[C]=[C]CO[CH][CH2]'),
    E0 = (1024.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,359.281,359.282,359.282,3031.58],'cm^-1')),
        HinderedRotor(inertia=(0.100212,'amu*angstrom^2'), symmetry=1, barrier=(9.17948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100212,'amu*angstrom^2'), symmetry=1, barrier=(9.17948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100212,'amu*angstrom^2'), symmetry=1, barrier=(9.17948,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.364371,'amu*angstrom^2'), symmetry=1, barrier=(33.3767,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.871534,0.0775062,-0.000134209,1.20074e-07,-4.09213e-11,123284,26.2477], Tmin=(100,'K'), Tmax=(872.851,'K')), NASAPolynomial(coeffs=[8.23463,0.0250865,-1.20286e-05,2.24075e-09,-1.50222e-13,122710,-4.19815], Tmin=(872.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1024.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCsJOCs) + radical(CJCO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CO[CH][CH2](17817)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(123.7,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 121.9 to 123.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][CH2](721)', '[CH]=[C]C[O](5268)'],
    products = ['[CH]=[C]CO[CH][CH2](17817)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]O[CH2](417)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CO[CH][CH2](17817)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]CO[C][CH2](19501)'],
    products = ['[CH]=[C]CO[CH][CH2](17817)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][CH]OC[C]=[CH](19502)'],
    products = ['[CH]=[C]CO[CH][CH2](17817)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[C]=[C]CO[CH][CH2](19503)'],
    products = ['[CH]=[C]CO[CH][CH2](17817)'],
