...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686346,0.0777331,-9.70364e-05,7.54368e-08,-2.45793e-11,6543.96,23.4815], Tmin=(100,'K'), Tmax=(793.014,'K')), NASAPolynomial(coeffs=[7.82199,0.0385892,-1.70343e-05,3.17e-09,-2.17199e-13,5511.32,-8.66425], Tmin=(793.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.4558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC([CH2])C(3678)',
    structure = SMILES('[CH2]COC([CH2])C'),
    E0 = (114.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(C)O[C]C(3685)',
    structure = SMILES('[CH2]C(C)O[C]C'),
    E0 = (363.794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693687,0.0765353,-8.73784e-05,5.59248e-08,-1.47356e-11,43870.2,23.2505], Tmin=(100,'K'), Tmax=(913.958,'K')), NASAPolynomial(coeffs=[10.8414,0.0321239,-1.44907e-05,2.75918e-09,-1.93068e-13,42015.2,-24.7933], Tmin=(913.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CH2_triplet) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]C(C)O[CH]C(3686)',
    structure = SMILES('[CH]C(C)O[CH]C'),
    E0 = (320.967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.727863,0.0701531,-6.60389e-05,3.34271e-08,-6.88684e-12,38722.8,25.0811], Tmin=(100,'K'), Tmax=(1161.65,'K')), NASAPolynomial(coeffs=[13.0055,0.0278758,-1.14469e-05,2.0965e-09,-1.44043e-13,35870.3,-35.991], Tmin=(1161.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(C)O[CH]C(3676)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(C)OC=C(634)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', 'C=CO[CH]C(3600)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH2][CH]O[CH]C(718)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C](C)O[CH]C(757)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C([CH2])O[CH]C(759)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH]OC([CH2])C(645)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(14)', '[CH2]CO[CH]C(3575)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', 'C[CH]O[CH]C(3665)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]OC([CH2])C(444)', '[CH3](11)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]C(C)O[C]C(3685)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]C(C)O[CH]C(3686)'],
    products = ['[CH2]C(C)O[CH]C(3579)'],
