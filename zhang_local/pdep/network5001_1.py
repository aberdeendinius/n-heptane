...
species(
    label = 'C=[C]C(O)C(=C)CC(27947)',
    structure = SMILES('C=[C]C(O)C(=C)CC'),
    E0 = (87.0578,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1380,1390,370,380,2900,435,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.172053,0.0795903,-6.11468e-05,2.45391e-08,-4.0501e-12,10612,33.7848], Tmin=(100,'K'), Tmax=(1409.07,'K')), NASAPolynomial(coeffs=[15.3869,0.0363994,-1.51689e-05,2.78582e-09,-1.90607e-13,6324.2,-44.8356], Tmin=(1409.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(CC)C(O)=C=C(27948)',
    structure = SMILES('[CH2]C(CC)C(O)=C=C'),
    E0 = (59.0483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,540,610,2055,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,267.813,267.864],'cm^-1')),
        HinderedRotor(inertia=(0.00234983,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315456,'amu*angstrom^2'), symmetry=1, barrier=(16.0573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315394,'amu*angstrom^2'), symmetry=1, barrier=(16.0565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315356,'amu*angstrom^2'), symmetry=1, barrier=(16.0568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.315384,'amu*angstrom^2'), symmetry=1, barrier=(16.0568,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.352012,0.0842608,-5.56377e-05,4.5071e-09,6.8844e-12,7268.93,32.6405], Tmin=(100,'K'), Tmax=(952.627,'K')), NASAPolynomial(coeffs=[19.4867,0.0278265,-9.08087e-06,1.53103e-09,-1.03961e-13,2270.07,-68.5056], Tmin=(952.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.0483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)

species(
    label = 'C#CC(O)C([CH2])CC(27949)',
    structure = SMILES('C#CC(O)C([CH2])CC'),
    E0 = (104.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.166386,0.0834929,-6.31509e-05,1.83497e-08,7.79967e-13,12746.1,34.1505], Tmin=(100,'K'), Tmax=(955.175,'K')), NASAPolynomial(coeffs=[16.49,0.0319634,-1.0846e-05,1.8164e-09,-1.20344e-13,8732.85,-49.7944], Tmin=(955.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C=C)CC(17589)',
    structure = SMILES('[CH2]C(C=C=C)CC'),
    E0 = (273.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,540,610,2055,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,180,442.997],'cm^-1')),
        HinderedRotor(inertia=(0.82989,'amu*angstrom^2'), symmetry=1, barrier=(19.0808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00134726,'amu*angstrom^2'), symmetry=1, barrier=(11.6341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828579,'amu*angstrom^2'), symmetry=1, barrier=(19.0507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.67078,'amu*angstrom^2'), symmetry=1, barrier=(84.3983,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0944215,0.0787052,-5.03852e-05,1.36286e-08,-6.91805e-13,15076.8,35.1762], Tmin=(100,'K'), Tmax=(1221.26,'K')), NASAPolynomial(coeffs=[16.4278,0.0371939,-1.48803e-05,2.69779e-09,-1.84135e-13,10101.3,-51.6847], Tmin=(1221.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ(C)CO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.251893,0.0792861,-5.68854e-05,2.12602e-08,-3.30336e-12,20104.7,36.2802], Tmin=(100,'K'), Tmax=(1467.8,'K')), NASAPolynomial(coeffs=[14.5974,0.0401923,-1.69339e-05,3.11447e-09,-2.12716e-13,15893.4,-38.4336], Tmin=(1467.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=C(O)C(C)CC(27952)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.47751,0.0854505,-5.17739e-05,1.38256e-09,7.03989e-12,8195.21,33.0098], Tmin=(100,'K'), Tmax=(992.082,'K')), NASAPolynomial(coeffs=[19.7862,0.0311837,-1.12048e-05,1.99527e-09,-1.38778e-13,2824.45,-71.3943], Tmin=(992.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.7026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.115298,0.0836816,-6.42171e-05,2.5794e-08,-4.23995e-12,21408.6,36.8343], Tmin=(100,'K'), Tmax=(1423.57,'K')), NASAPolynomial(coeffs=[16.5487,0.036858,-1.48791e-05,2.68853e-09,-1.82243e-13,16664.2,-49.4451], Tmin=(1423.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=[C]C(O)C(C)CC(27954)',
    structure = SMILES('[CH]=[C]C(O)C(C)CC'),
    E0 = (218.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,1685,370,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.176594,0.0859219,-6.86869e-05,2.89434e-08,-4.9907e-12,26443.5,35.6687], Tmin=(100,'K'), Tmax=(1363.58,'K')), NASAPolynomial(coeffs=[16.4318,0.0372017,-1.50926e-05,2.74058e-09,-1.86659e-13,21914.1,-49.6079], Tmin=(1363.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2][C](CC)C(O)[C]=C(27955)',
    structure = SMILES('[CH2][C](CC)C(O)[C]=C'),
    E0 = (329.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0396962,0.0800473,-6.20892e-05,2.56366e-08,-4.31838e-12,39738.4,36.7552], Tmin=(100,'K'), Tmax=(1402.71,'K')), NASAPolynomial(coeffs=[16.1012,0.034019,-1.28678e-05,2.2428e-09,-1.48948e-13,35210.3,-46.5773], Tmin=(1402.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ(C)CO) + radical(Cds_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C(O)[C]=C(27956)',
    structure = SMILES('[CH2]C([CH]C)C(O)[C]=C'),
    E0 = (371.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327861,0.0802855,-6.71422e-05,3.13139e-08,-6.14349e-12,44765.9,37.7918], Tmin=(100,'K'), Tmax=(1190.09,'K')), NASAPolynomial(coeffs=[12.2277,0.0402888,-1.67299e-05,3.07382e-09,-2.1112e-13,41933.5,-21.689], Tmin=(1190.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]=C(O)C([CH2])CC(27957)',
    structure = SMILES('[CH2][C]=C(O)C([CH2])CC'),
    E0 = (271.785,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.425585,0.0867357,-6.2874e-05,1.20498e-08,4.22389e-12,32857.1,34.6051], Tmin=(100,'K'), Tmax=(953.31,'K')), NASAPolynomial(coeffs=[19.3916,0.0281228,-9.25851e-06,1.55607e-09,-1.04917e-13,27963.7,-65.9017], Tmin=(953.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC([CH2])C(O)[C]=C(27958)',
    structure = SMILES('[CH2]CC([CH2])C(O)[C]=C'),
    E0 = (381.807,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00835896,0.0843987,-7.37884e-05,3.52546e-08,-6.91154e-12,46068.2,38.228], Tmin=(100,'K'), Tmax=(1213.06,'K')), NASAPolynomial(coeffs=[14.5816,0.0362887,-1.42979e-05,2.55981e-09,-1.73404e-13,42528.5,-34.9779], Tmin=(1213.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=[C]C(O)C([CH2])CC(27959)',
    structure = SMILES('[CH]=[C]C(O)C([CH2])CC'),
    E0 = (423.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.102551,0.0869874,-7.93e-05,3.95232e-08,-8.05049e-12,51104.6,37.1831], Tmin=(100,'K'), Tmax=(1173.46,'K')), NASAPolynomial(coeffs=[14.8351,0.0360692,-1.42126e-05,2.54566e-09,-1.72594e-13,47598.8,-37.2716], Tmin=(1173.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.399231,0.0829206,-4.43488e-05,-6.39583e-09,9.79537e-12,-17393.2,31.0283], Tmin=(100,'K'), Tmax=(987.252,'K')), NASAPolynomial(coeffs=[19.8551,0.0309315,-1.10525e-05,1.97616e-09,-1.38312e-13,-22858,-73.8502], Tmin=(987.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-146.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    E0 = (51.7741,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,342.532,2920.1],'cm^-1')),
        HinderedRotor(inertia=(0.117213,'amu*angstrom^2'), symmetry=1, barrier=(9.71558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115635,'amu*angstrom^2'), symmetry=1, barrier=(9.72173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00143193,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116036,'amu*angstrom^2'), symmetry=1, barrier=(9.71341,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.911744,'amu*angstrom^2'), symmetry=1, barrier=(75.8222,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]C(CC)C(O)[C]=C(27963)',
    structure = SMILES('[CH]C(CC)C(O)[C]=C'),
    E0 = (419.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.156415,0.085475,-7.16701e-05,3.15142e-08,-5.63034e-12,50631.9,36.197], Tmin=(100,'K'), Tmax=(1326.98,'K')), NASAPolynomial(coeffs=[16.7606,0.0344815,-1.40283e-05,2.55547e-09,-1.74636e-13,46142.2,-50.2036], Tmin=(1326.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]C(O)C(=C)CC(27947)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(CC)C(O)=C=C(27948)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CC(O)C([CH2])CC(27949)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH2](6)', 'C=[C]C(O)C=C(27708)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', '[CH2]C(C=C=C)CC(17589)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    products = ['C=[C]C(O)C(C)[CH]C(27951)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C(O)[C]=C(13320)'],
    products = ['[CH2][C]=C(O)C(C)CC(27952)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(C)C(O)[C]=C(27953)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=[C]C(O)C(C)CC(27954)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(D)(132)', '[CH2][C]=CC([CH2])CC(17600)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C[CH2](6)', '[CH2][CH]C(O)[C]=C(27815)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2][C](CC)C(O)[C]=C(27955)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH3](11)', '[CH2]C([CH2])C(O)[C]=C(14106)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH2]C([CH]C)C(O)[C]=C(27956)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH2][C]=C(O)C([CH2])CC(27957)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH2]CC([CH2])C(O)[C]=C(27958)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]=[C]C(O)C([CH2])CC(27959)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(S)(14)', '[CH2]C(C)C(O)[C]=C(13082)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(T)(28)', 'C=[C]C(O)[CH]CC(27858)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[C]=C(584)', '[CH2]C([CH]O)CC(503)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(8)', '[CH]C(CC)C(O)[C]=C(27963)'],
    products = ['[CH2]C(CC)C(O)[C]=C(13320)'],
