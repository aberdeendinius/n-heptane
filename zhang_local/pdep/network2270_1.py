...
species(
    ...
    E0 = (-47.1032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.29033,'amu*angstrom^2'), symmetry=1, barrier=(29.6672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29787,'amu*angstrom^2'), symmetry=1, barrier=(29.8407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=[C]OCO[O](8536)',
    structure = SMILES('[CH]=[C]OCO[O]'),
    E0 = (370.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.992751,'amu*angstrom^2'), symmetry=1, barrier=(22.8253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992945,'amu*angstrom^2'), symmetry=1, barrier=(22.8298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.994284,'amu*angstrom^2'), symmetry=1, barrier=(22.8606,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09199,0.0474407,-1.16752e-05,-4.40109e-08,2.78132e-11,44673.3,24.2567], Tmin=(100,'K'), Tmax=(896.332,'K')), NASAPolynomial(coeffs=[24.2042,-0.00996504,7.85439e-06,-1.60945e-09,1.09043e-13,38692.8,-94.9657], Tmin=(896.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(370.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P) + radical(ROOJ)"""),
)

species(
    label = '[CH]=[C]O[CH]OO(8537)',
    structure = SMILES('[CH]=[C]O[CH]OO'),
    E0 = (407.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,3120,650,792.5,1650,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.02906,'amu*angstrom^2'), symmetry=1, barrier=(23.66,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02907,'amu*angstrom^2'), symmetry=1, barrier=(23.6602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02897,'amu*angstrom^2'), symmetry=1, barrier=(23.658,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02905,'amu*angstrom^2'), symmetry=1, barrier=(23.6598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.742845,0.067848,-8.93391e-05,5.31974e-08,-1.15712e-11,49118.4,24.5384], Tmin=(100,'K'), Tmax=(944.025,'K')), NASAPolynomial(coeffs=[17.8635,0.00371018,-7.83708e-07,9.17284e-11,-5.34917e-15,45511.4,-59.0566], Tmin=(944.025,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=COC1OO1(8539)',
    structure = SMILES('[CH]=COC1OO1'),
    E0 = (111.667,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74862,0.0339855,1.29597e-05,-5.77777e-08,2.96024e-11,13526.1,18.593], Tmin=(100,'K'), Tmax=(907.349,'K')), NASAPolynomial(coeffs=[19.3032,-0.00198441,3.95243e-06,-8.50778e-10,5.59041e-14,8635.54,-73.7859], Tmin=(907.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cds_P)"""),
)
...
species(
    label = '[CH][CH]OC=O(8541)',
    structure = SMILES('[CH][CH]OC=O'),
    E0 = (235.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,423.83,423.833,423.834,423.839,423.842],'cm^-1')),
        HinderedRotor(inertia=(0.000938394,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00093843,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00093844,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
...
species(
    label = '[CH]=CO[C]O[O](8542)',
    structure = SMILES('[CH]=CO[C]O[O]'),
    E0 = (591.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.18558,'amu*angstrom^2'), symmetry=1, barrier=(27.2587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18524,'amu*angstrom^2'), symmetry=1, barrier=(27.251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18504,'amu*angstrom^2'), symmetry=1, barrier=(27.2464,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.50535,0.0766483,-9.50623e-05,4.83799e-08,-8.51879e-12,71399.4,29.2274], Tmin=(100,'K'), Tmax=(1761.64,'K')), NASAPolynomial(coeffs=[24.1063,-0.0142889,1.02829e-05,-2.05007e-09,1.36997e-13,67462.7,-94.3985], Tmin=(1761.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(Cds_P) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#CO[CH]O[O](8534)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH]=COC=O(3004)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]=[C]O[CH]O[O](8538)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C[O](602)', '[CH]O[O](2819)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O(T)(63)', '[CH][CH]OC=O(8541)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=CO[C]O[O](8542)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[C]=CO[CH]O[O](8543)'],
    products = ['[CH]=CO[CH]O[O](8156)'],
