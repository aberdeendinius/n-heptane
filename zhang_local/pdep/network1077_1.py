...
species(
    label = 'C=C(CC)O[C]=O(3108)',
    structure = SMILES('C=C(CC)O[C]=O'),
    E0 = (-162.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,180,487.825,1259.45],'cm^-1')),
        HinderedRotor(inertia=(0.790747,'amu*angstrom^2'), symmetry=1, barrier=(18.1808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790716,'amu*angstrom^2'), symmetry=1, barrier=(18.1801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.79063,'amu*angstrom^2'), symmetry=1, barrier=(18.1781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.790484,'amu*angstrom^2'), symmetry=1, barrier=(18.1748,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984813,0.0687477,-6.95261e-05,3.99739e-08,-9.59308e-12,-8655.84,26.8293], Tmin=(100,'K'), Tmax=(992.452,'K')), NASAPolynomial(coeffs=[10.1154,0.0319476,-1.39066e-05,2.61251e-09,-1.81751e-13,-10468.2,-17.1516], Tmin=(992.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.8547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(C2CsJOC(O)H)"""),
)

species(
    label = '[CH2][C](CC)OC=O(3110)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830214,0.0611029,-4.33878e-05,1.40349e-08,-1.35261e-12,-8618.95,28.9373], Tmin=(100,'K'), Tmax=(1196.48,'K')), NASAPolynomial(coeffs=[14.1749,0.0255422,-1.01547e-05,1.84106e-09,-1.25982e-13,-12460.2,-40.5446], Tmin=(1196.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.6704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical((O)CJOCC2)"""),
)

species(
    label = '[CH2]C([CH]C)OC=O(3112)',
...
species(
    label = '[CH2][C](CC)O[C]=O(3115)',
    structure = SMILES('[CH2][C](CC)O[C]=O'),
    E0 = (137.655,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.406102,0.0843034,-0.000123375,9.90901e-08,-3.15925e-11,16680.5,29.344], Tmin=(100,'K'), Tmax=(842.452,'K')), NASAPolynomial(coeffs=[10.7542,0.0286581,-1.27027e-05,2.33583e-09,-1.57616e-13,15168,-17.4342], Tmin=(842.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(CJC(C)OC) + radical(C2CsJOC(O)H)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.855286,0.0694885,-7.1938e-05,4.00033e-08,-9.02243e-12,16691.3,28.5967], Tmin=(100,'K'), Tmax=(1067.53,'K')), NASAPolynomial(coeffs=[12.3832,0.0262933,-1.12433e-05,2.09945e-09,-1.45824e-13,14230,-27.7722], Tmin=(1067.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJCO) + radical(CJC(C)OC) + radical((O)CJOCC2)"""),
)

species(
    label = '[CH2]CC([CH2])O[C]=O(3117)',
    structure = SMILES('[CH2]CC([CH2])O[C]=O'),
    E0 = (143.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.75817,0.0746292,-8.7777e-05,5.7039e-08,-1.51122e-11,17334.9,28.2422], Tmin=(100,'K'), Tmax=(913.229,'K')), NASAPolynomial(coeffs=[11.1494,0.0291145,-1.30171e-05,2.46274e-09,-1.7158e-13,15437.1,-20.946], Tmin=(913.229,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical((O)CJOCC2) + radical(RCCJ) + radical(CJC(C)OC)"""),
)

species(
    label = 'C=C(CC)OC=O(2984)',
...
species(
    ...
    E0 = (-39.0379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,370.434,370.436,370.444],'cm^-1')),
        HinderedRotor(inertia=(0.00122849,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133234,'amu*angstrom^2'), symmetry=1, barrier=(12.9742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133234,'amu*angstrom^2'), symmetry=1, barrier=(12.9742,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897372,0.0657727,-5.94155e-05,2.81352e-08,-5.40968e-12,21238.6,27.1973], Tmin=(100,'K'), Tmax=(1238.49,'K')), NASAPolynomial(coeffs=[13.2934,0.0257368,-1.0926e-05,2.03384e-09,-1.4091e-13,18168.2,-35.258], Tmin=(1238.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJ2_triplet) + radical((O)CJOCC2)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(CC)O[C]=O(3108)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]C(CC)O[C]=O(2991)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(85.6361,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 84.2 to 85.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['C=CO[C]=O(3002)', 'C[CH2](6)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([CH2])OC=O(3114)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH2](6)', '[CH2][CH]O[C]=O(3054)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C](CC)O[C]=O(3115)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH2]C([CH2])O[C]=O(3071)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([CH]C)O[C]=O(3116)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]CC([CH2])O[C]=O(3117)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(14)', '[CH2]C(C)O[C]=O(2978)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C-]#[O+](374)', '[CH2]C([O])CC(497)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C]=O(1149)', '[CH2]C([O])CC(497)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(28)', 'CC[CH]O[C]=O(3072)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH]C(CC)O[C]=O(3120)'],
    products = ['[CH2]C(CC)O[C]=O(2991)'],
