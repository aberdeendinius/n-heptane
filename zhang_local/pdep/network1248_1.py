...
species(
    ...
    E0 = (38.4042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1267.93,1268.34,3158.56],'cm^-1')),
        HinderedRotor(inertia=(0.00452568,'amu*angstrom^2'), symmetry=1, barrier=(5.16433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224696,'amu*angstrom^2'), symmetry=1, barrier=(5.1662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224529,'amu*angstrom^2'), symmetry=1, barrier=(5.16237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-41.9718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,350,440,435,1725,3010,987.5,1337.5,450,1655,471.827,471.913,472.253,472.266],'cm^-1')),
        HinderedRotor(inertia=(0.0917004,'amu*angstrom^2'), symmetry=1, barrier=(14.5273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0920874,'amu*angstrom^2'), symmetry=1, barrier=(14.5154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41616,0.0642653,-9.16398e-05,8.66802e-08,-3.35877e-11,24722.4,30.4288], Tmin=(100,'K'), Tmax=(788.419,'K')), NASAPolynomial(coeffs=[3.35186,0.0405745,-2.01787e-05,3.94105e-09,-2.7657e-13,24848.2,24.2842], Tmin=(788.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0343,0.0786081,-0.000138658,1.39922e-07,-5.34971e-11,21931.2,28.7265], Tmin=(100,'K'), Tmax=(842.438,'K')), NASAPolynomial(coeffs=[1.69671,0.044445,-2.26003e-05,4.37368e-09,-3.0204e-13,22920.3,32.177], Tmin=(842.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([O])[CH][C]([O])O(4045)',
    structure = SMILES('CC([O])[CH][C]([O])O'),
    E0 = (184.381,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24163,0.0657387,-8.15423e-05,6.10338e-08,-1.93293e-11,22270.6,31.5902], Tmin=(100,'K'), Tmax=(758.614,'K')), NASAPolynomial(coeffs=[7.576,0.0323432,-1.55178e-05,3.0189e-09,-2.1296e-13,21309.4,2.77965], Tmin=(758.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.728056,0.0818394,-0.000135787,1.25461e-07,-4.4967e-11,19485,30.3479], Tmin=(100,'K'), Tmax=(841.301,'K')), NASAPolynomial(coeffs=[6.19259,0.0357154,-1.76364e-05,3.37718e-09,-2.32086e-13,19278.4,9.1655], Tmin=(841.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Cs_P)"""),
)
...
species(
    ...
    E0 = (386.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,363.333,366.667,370,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1813.63,1813.85,1814.03],'cm^-1')),
        HinderedRotor(inertia=(0.177813,'amu*angstrom^2'), symmetry=1, barrier=(4.08826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177968,'amu*angstrom^2'), symmetry=1, barrier=(4.09184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177871,'amu*angstrom^2'), symmetry=1, barrier=(4.08962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
...
species(
    ...
    E0 = (410.087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,180,1524.36,1524.37,1524.4,1524.4],'cm^-1')),
        HinderedRotor(inertia=(0.136397,'amu*angstrom^2'), symmetry=1, barrier=(3.13603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136412,'amu*angstrom^2'), symmetry=1, barrier=(3.13639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136381,'amu*angstrom^2'), symmetry=1, barrier=(3.13566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.62221,0.0347437,-1.35252e-05,9.42978e-10,1.45907e-13,-20139,15.3606], Tmin=(100,'K'), Tmax=(2730.14,'K')), NASAPolynomial(coeffs=[50.7801,-0.0135704,2.40851e-06,-3.56753e-10,2.7656e-14,-52540.1,-266.865], Tmin=(2730.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-166.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC(=O)C[C]([O])[O](2156)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CC([O])C=C([O])[O](2866)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O][CH]CC([O])=O(2298)', '[CH3](11)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2.61258,'m^3/(mol*s)'), n=1.485, Ea=(71.9319,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO_O;CsJ-HHH] for rate rule [CO-CsH_O;CsJ-HHH]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 64.8 to 71.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[O][CH]C[C]([O])[O](2619)', '[CH3](11)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', 'C[C]([O])C[C]([O])[O](2856)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'CC([O])[CH][C]([O])[O](2859)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', '[O]CC[C]([O])[O](2106)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', 'C[CH]C[C]([O])[O](2310)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)[O](442)', '[O][C][O](2319)'],
    products = ['CC([O])C[C]([O])[O](3644)'],
