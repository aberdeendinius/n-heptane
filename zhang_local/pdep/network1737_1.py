...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88827,0.0501962,-5.6643e-05,4.00557e-08,-1.22829e-11,22320.9,20.3511], Tmin=(100,'K'), Tmax=(775.464,'K')), NASAPolynomial(coeffs=[6.26714,0.02761,-1.2956e-05,2.49953e-09,-1.75767e-13,21641.7,0.338896], Tmin=(775.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13501,0.0391197,-2.54829e-05,8.29372e-09,-1.11042e-12,-9013.08,18.3776], Tmin=(100,'K'), Tmax=(1674,'K')), NASAPolynomial(coeffs=[10.0261,0.0202638,-8.58668e-06,1.56477e-09,-1.05492e-13,-11655,-23.7581], Tmin=(1674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.5071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7471,0.0125638,6.69314e-05,-1.02674e-07,4.37849e-11,-14905,12.76], Tmin=(100,'K'), Tmax=(880.571,'K')), NASAPolynomial(coeffs=[11.7988,0.011603,1.63853e-07,-3.37545e-10,2.79594e-14,-18056,-38.5981], Tmin=(880.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane)"""),
)
...
species(
    ...
    E0 = (391.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,353.738,353.74,2644.9,2644.92],'cm^-1')),
        HinderedRotor(inertia=(0.110335,'amu*angstrom^2'), symmetry=1, barrier=(9.79317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.726625,'amu*angstrom^2'), symmetry=1, barrier=(64.4998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110281,'amu*angstrom^2'), symmetry=1, barrier=(9.79308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10497,0.0454174,-4.94409e-05,2.83075e-08,-4.75427e-12,47136.2,19.4126], Tmin=(100,'K'), Tmax=(639.146,'K')), NASAPolynomial(coeffs=[6.68381,0.0227186,-1.015e-05,1.90747e-09,-1.31933e-13,46429.2,-1.57996], Tmin=(639.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CCO[O](6082)'],
    products = ['[CH2]CCO[O](73)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH2](22)', '[CH2]O[O](61)'],
    products = ['[CH2]CCO[O](73)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][CH]CO[O](6081)'],
    products = ['[CH2]CCO[O](73)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C[CH]O[O](6576)'],
    products = ['[CH2]CCO[O](73)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CO[O](66)', 'CH2(T)(28)'],
    products = ['[CH2]CCO[O](73)'],
