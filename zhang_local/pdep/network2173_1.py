...
species(
    label = '[O][CH]COC=O(5869)',
    structure = SMILES('[O][CH]COC=O'),
    E0 = (-161.442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3025,407.5,1350,352.5,180.287,197.892,1633.43,1633.98],'cm^-1')),
        HinderedRotor(inertia=(0.0242106,'amu*angstrom^2'), symmetry=1, barrier=(45.7157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22299,'amu*angstrom^2'), symmetry=1, barrier=(5.85937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.98722,'amu*angstrom^2'), symmetry=1, barrier=(45.6901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0142,0.0502698,-7.54227e-05,7.39202e-08,-2.91302e-11,-19352,21.764], Tmin=(100,'K'), Tmax=(796.126,'K')), NASAPolynomial(coeffs=[2.84496,0.0325552,-1.65339e-05,3.24388e-09,-2.27786e-13,-19055.1,20.6405], Tmin=(796.126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C[CH]O[CH]O[O](8666)',
    structure = SMILES('[O]C[CH]O[CH]O[O]'),
    E0 = (231.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346621,0.0933291,-0.000176544,1.63265e-07,-5.61961e-11,27904.8,28.4991], Tmin=(100,'K'), Tmax=(888.303,'K')), NASAPolynomial(coeffs=[8.38719,0.0268986,-1.33313e-05,2.47271e-09,-1.63491e-13,27668.7,-2.62768], Tmin=(888.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(ROOJ) + radical(OCJO) + radical(CCsJOCs)"""),
)

species(
    label = '[O][CH][CH]OCO[O](8667)',
    structure = SMILES('[O][CH][CH]OCO[O]'),
    E0 = (222.359,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.167181,0.085197,-0.000125169,8.87298e-08,-2.40898e-11,26880.9,28.9046], Tmin=(100,'K'), Tmax=(914.876,'K')), NASAPolynomial(coeffs=[17.0107,0.0115549,-4.42843e-06,7.47477e-10,-4.78001e-14,23798.9,-50.857], Tmin=(914.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(ROOJ) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[O][CH][CH]O[CH]OO(8668)',
    structure = SMILES('[O][CH][CH]O[CH]OO'),
    E0 = (259.315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162304,0.105367,-0.000201986,1.84836e-07,-6.3012e-11,31325.2,29.1163], Tmin=(100,'K'), Tmax=(885.062,'K')), NASAPolynomial(coeffs=[10.5782,0.0253885,-1.31589e-05,2.47065e-09,-1.64027e-13,30655.2,-14.4333], Tmin=(885.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(OCJO) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[O][CH][CH]O[CH]O[O](8669)',
    structure = SMILES('[O][CH][CH]O[CH]O[O]'),
    E0 = (411.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.103958,0.101746,-0.00020657,1.93921e-07,-6.66238e-11,49595.5,28.9195], Tmin=(100,'K'), Tmax=(900.833,'K')), NASAPolynomial(coeffs=[8.88266,0.0239142,-1.22769e-05,2.25598e-09,-1.46081e-13,49590.3,-3.76609], Tmin=(900.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(CCsJOH) + radical(ROOJ) + radical(CCsJOCs) + radical(OCJO)"""),
)

species(
    label = '[O]C=COCO[O](8670)',
    ...
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312786,0.0511421,3.019e-05,-1.14573e-07,5.9069e-11,-21937.3,24.7919], Tmin=(100,'K'), Tmax=(899.409,'K')), NASAPolynomial(coeffs=[34.673,-0.0206341,1.47467e-05,-2.9498e-09,1.97286e-13,-31395.8,-155.554], Tmin=(899.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=COJ)"""),
)

species(
    label = '[O][CH]COC1OO1(8671)',
    ...
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36464,0.0661581,-0.000107303,9.92457e-08,-3.55782e-11,2838.94,24.9815], Tmin=(100,'K'), Tmax=(852.094,'K')), NASAPolynomial(coeffs=[5.05369,0.0312777,-1.49841e-05,2.82719e-09,-1.92568e-13,2847.85,11.5157], Tmin=(852.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.8809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[O][CH]CO[CH][O](8672)',
    structure = SMILES('[O][CH]CO[CH][O]'),
    E0 = (234.752,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,180,180,1318.81,1319.7,1319.99,1320.06],'cm^-1')),
        HinderedRotor(inertia=(0.257768,'amu*angstrom^2'), symmetry=1, barrier=(5.92659,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.258041,'amu*angstrom^2'), symmetry=1, barrier=(5.93288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.257904,'amu*angstrom^2'), symmetry=1, barrier=(5.92972,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41335,0.0780785,-0.000174503,1.90225e-07,-7.37108e-11,28307,23.7254], Tmin=(100,'K'), Tmax=(870.748,'K')), NASAPolynomial(coeffs=[-2.56669,0.0433296,-2.32858e-05,4.50463e-09,-3.06943e-13,31010.6,53.9204], Tmin=(870.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(CCsJOH) + radical(OCOJ) + radical(OCJO)"""),
)
...
species(
    label = '[O][CH]CO[C]O[O](8674)',
    structure = SMILES('[O][CH]CO[C]O[O]'),
    E0 = (502.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.336596,0.0831203,-0.000127393,9.30519e-08,-2.60703e-11,60613.6,27.5862], Tmin=(100,'K'), Tmax=(885.428,'K')), NASAPolynomial(coeffs=[16.3232,0.0109022,-5.05265e-06,9.41764e-10,-6.40521e-14,57782.5,-47.595], Tmin=(885.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(502.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CCOJ) + radical(CCsJOH) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]C=CO[CH]O[O](8665)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[O][CH]COC=O(5869)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]C[CH]O[CH]O[O](8666)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][CH]CO[CH]O[O](8062)'],
    products = ['[O]O[CH]O[CH][CH]O(8597)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH][CH]O[CH]OO(8668)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[O][CH][CH]O[CH]O[O](8669)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][CH]C[O](563)', '[CH]O[O](2819)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(T)(63)', '[O][CH]CO[CH][O](8672)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O2(2)', '[CH]OC[CH][O](1030)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH][O](751)', '[CH2]O[CH]O[O](8127)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[O][C]CO[CH]O[O](8673)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[O][CH]CO[C]O[O](8674)'],
    products = ['[O][CH]CO[CH]O[O](8062)'],
