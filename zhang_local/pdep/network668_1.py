...
species(
    label = '[O]COC1=CO1(2032)',
    structure = SMILES('[O]COC1=CO1'),
    E0 = (52.704,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47659,0.042277,-1.12228e-05,-2.90437e-08,1.7602e-11,6441.81,17.8351], Tmin=(100,'K'), Tmax=(941.604,'K')), NASAPolynomial(coeffs=[18.8391,0.00165181,7.13902e-07,-1.25864e-10,2.57087e-15,1703.32,-72.6836], Tmin=(941.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(OCOJ)"""),
)
...
species(
    label = '[O][CH]OC1CO1(2036)',
    structure = SMILES('[O][CH]OC1CO1'),
    E0 = (-22.0911,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86864,0.0520752,-7.4285e-05,6.35754e-08,-2.10509e-11,-2585.08,19.1819], Tmin=(100,'K'), Tmax=(926.596,'K')), NASAPolynomial(coeffs=[4.7534,0.0260758,-1.02675e-05,1.7387e-09,-1.10204e-13,-2538.16,8.62248], Tmin=(926.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.0911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(OCJO) + radical(OCOJ)"""),
)

species(
    label = 'OCO[C]1[CH]O1(2037)',
    structure = SMILES('OCO[C]1[CH]O1'),
    E0 = (-49.4804,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.986422,0.0681208,-7.55422e-05,3.79854e-08,-6.65854e-12,-5735.23,30.7892], Tmin=(100,'K'), Tmax=(1798.95,'K')), NASAPolynomial(coeffs=[16.052,0.000347433,5.88978e-06,-1.42767e-09,1.02149e-13,-7029.28,-47.9747], Tmin=(1798.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.4804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
species(
    label = '[O]CO[C]1[CH]O1(2038)',
    structure = SMILES('[O]CO[C]1[CH]O1'),
    E0 = (177.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.81356,0.0509768,-5.13126e-05,2.52226e-08,-4.52357e-12,21529.8,24.7722], Tmin=(100,'K'), Tmax=(1670.62,'K')), NASAPolynomial(coeffs=[13.674,0.0066479,6.43293e-07,-3.60716e-10,3.06553e-14,19121.8,-38.2182], Tmin=(1670.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO) + radical(OCOJ)"""),
)
...
species(
    label = 'O=COC1CO1(2041)',
    structure = SMILES('O=COC1CO1'),
    E0 = (-418.285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44074,0.0245736,2.39606e-05,-5.22208e-08,2.36997e-11,-50242.8,17.325], Tmin=(100,'K'), Tmax=(896.088,'K')), NASAPolynomial(coeffs=[10.4655,0.0147783,-3.20878e-06,4.04541e-10,-2.49007e-14,-52725.9,-26.3396], Tmin=(896.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-418.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'OCOC1=CO1(2042)',
    structure = SMILES('OCOC1=CO1'),
    E0 = (-174.694,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939956,0.0449143,1.39054e-05,-7.91094e-08,4.20504e-11,-20879.6,19.288], Tmin=(100,'K'), Tmax=(902.428,'K')), NASAPolynomial(coeffs=[27.6719,-0.0131469,9.97134e-06,-2.00163e-09,1.33167e-13,-28164.9,-120.567], Tmin=(902.428,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]COC1=CO1(2032)'],
    products = ['[O]CO[C]1CO1(1774)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'O=CO[C]1CO1(2033)'],
    products = ['[O]CO[C]1CO1(1774)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[O]CO[C]1[CH]O1(2038)'],
    products = ['[O]CO[C]1CO1(1774)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[O][CH]O[C]1CO1(2039)'],
    products = ['[O]CO[C]1CO1(1774)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]1CO1(1125)', '[O]C[O](558)'],
    products = ['[O]CO[C]1CO1(1774)'],
