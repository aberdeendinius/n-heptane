species(
    label = 'O=[C]OO[C]1CO1(3040)',
    structure = SMILES('O=[C]OO[C]1CO1'),
    E0 = (-36.4802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,350,500,795,815,2750,3150,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46507,0.0432665,-5.32801e-06,-3.98312e-08,2.37029e-11,-4284.43,22.6846], Tmin=(100,'K'), Tmax=(887.29,'K')), NASAPolynomial(coeffs=[18.0355,0.00376892,1.93115e-06,-5.7004e-10,4.1913e-14,-8610.74,-63.0855], Tmin=(887.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.4802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=[C]OOC1=CO1(3250)',
    structure = SMILES('O=[C]OOC1=CO1'),
    E0 = (77.0803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,350,500,795,815,1855,455,950,462.537,462.538,462.538,462.538,462.538,462.539],'cm^-1')),
        HinderedRotor(inertia=(0.290666,'amu*angstrom^2'), symmetry=1, barrier=(44.1282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290666,'amu*angstrom^2'), symmetry=1, barrier=(44.1281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290664,'amu*angstrom^2'), symmetry=1, barrier=(44.1281,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.038,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2901,0.0508257,-4.33979e-05,1.00042e-08,2.03508e-12,9375.96,21.9485], Tmin=(100,'K'), Tmax=(1001.97,'K')), NASAPolynomial(coeffs=[17.1335,0.00547575,-2.30205e-06,4.8914e-10,-3.91067e-14,5302.56,-59.0015], Tmin=(1001.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.0803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclopropene) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OOC1[CH]O1(3251)',
...
species(
    label = 'O=COO[C]1[CH]O1(3252)',
    structure = SMILES('O=COO[C]1[CH]O1'),
    E0 = (-49.2063,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46864,0.0391483,1.31071e-05,-6.29443e-08,3.25826e-11,-5811.45,24.2455], Tmin=(100,'K'), Tmax=(900.39,'K')), NASAPolynomial(coeffs=[20.2621,0.000272924,3.54531e-06,-8.32131e-10,5.657e-14,-11004.2,-74.4927], Tmin=(900.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.2063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)
...
species(
    label = 'O=[C]OO[C]1[CH]O1(3253)',
    structure = SMILES('O=[C]OO[C]1[CH]O1'),
    E0 = (147.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,350,500,795,815,2950,1000,321.699,321.7,321.701,321.701,321.701,321.701],'cm^-1')),
        HinderedRotor(inertia=(0.67946,'amu*angstrom^2'), symmetry=1, barrier=(49.8992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.67946,'amu*angstrom^2'), symmetry=1, barrier=(49.8992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.679469,'amu*angstrom^2'), symmetry=1, barrier=(49.8992,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.038,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0828908,0.0625025,-6.87057e-05,3.43434e-08,-6.1328e-12,17879.8,28.4588], Tmin=(100,'K'), Tmax=(1698.53,'K')), NASAPolynomial(coeffs=[17.7768,0.000592631,3.49859e-06,-8.77221e-10,6.39391e-14,14676.2,-58.7361], Tmin=(1698.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=COOC1=CO1(3254)',
    structure = SMILES('O=COOC1=CO1'),
    E0 = (-119.368,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50256,0.0430173,-1.50979e-05,-1.85845e-08,1.15481e-11,-14256.2,22.559], Tmin=(100,'K'), Tmax=(998.502,'K')), NASAPolynomial(coeffs=[16.8385,0.0084999,-3.68198e-06,7.92526e-10,-6.33428e-14,-18660.7,-58.1244], Tmin=(998.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=[C]OOC1=CO1(3250)'],
    products = ['O=[C]OO[C]1CO1(3040)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', 'O=[C]OO[C]1[CH]O1(3253)'],
    products = ['O=[C]OO[C]1CO1(3040)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]O[C]1CO1(1781)', '[C-]#[O+](374)'],
    products = ['O=[C]OO[C]1CO1(3040)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CO3t2(1168)', '[C]1CO1(1125)'],
    products = ['O=[C]OO[C]1CO1(3040)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]O[C]1CO1(1781)', '[C]=O(1149)'],
    products = ['O=[C]OO[C]1CO1(3040)'],
