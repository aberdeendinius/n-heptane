...
species(
    label = 'C[CH]OC=C([O])[O](4030)',
    structure = SMILES('C[CH]OC=C([O])[O]'),
    E0 = (-74.5837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,3025,407.5,1350,352.5,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.969487,'amu*angstrom^2'), symmetry=1, barrier=(22.2904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.966977,'amu*angstrom^2'), symmetry=1, barrier=(22.2327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.967283,'amu*angstrom^2'), symmetry=1, barrier=(22.2397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.654111,0.0831264,-9.46323e-05,4.91805e-08,-9.42007e-12,-8786.28,27.3343], Tmin=(100,'K'), Tmax=(1467.3,'K')), NASAPolynomial(coeffs=[24.7284,0.00136168,1.80443e-06,-4.738e-10,3.4812e-14,-14881.9,-100.243], Tmin=(1467.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.5837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C[CH]O[CH]C([O])[O](4031)',
    structure = SMILES('C[CH]O[CH]C([O])[O]'),
    E0 = (178.891,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.435534,0.0909256,-0.000160978,1.51826e-07,-5.44499e-11,21631.9,29.5606], Tmin=(100,'K'), Tmax=(856.596,'K')), NASAPolynomial(coeffs=[6.07597,0.0371001,-1.85912e-05,3.55014e-09,-2.4231e-13,21674,9.10804], Tmin=(856.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC[C]([O])[O](4032)',
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.933398,0.0827364,-0.000152865,1.56461e-07,-5.99277e-11,28337.3,30.2015], Tmin=(100,'K'), Tmax=(847.683,'K')), NASAPolynomial(coeffs=[1.10442,0.0458209,-2.36464e-05,4.58522e-09,-3.1627e-13,29605.6,37.0568], Tmin=(847.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'CCO[CH][C]([O])[O](4033)',
    structure = SMILES('CCO[CH][C]([O])[O]'),
    E0 = (203.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.123076,0.0942379,-0.000158431,1.37855e-07,-4.61657e-11,19186,31.2038], Tmin=(100,'K'), Tmax=(862.442,'K')), NASAPolynomial(coeffs=[10.582,0.0283521,-1.36163e-05,2.55093e-09,-1.72125e-13,18028.2,-13.9601], Tmin=(862.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Cs_P) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]OCC([O])[O](4035)',
    structure = SMILES('[CH2][CH]OCC([O])[O]'),
    E0 = (210.024,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58624,0.0890949,-0.000161665,1.57655e-07,-5.8033e-11,25369.5,30.2068], Tmin=(100,'K'), Tmax=(853.971,'K')), NASAPolynomial(coeffs=[4.13424,0.0406593,-2.07023e-05,3.98107e-09,-2.72864e-13,25923.7,20.4424], Tmin=(853.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]OC[C]([O])O(4036)',
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.275607,0.0923833,-0.000159023,1.43538e-07,-4.96755e-11,22923.5,31.8436], Tmin=(100,'K'), Tmax=(857.745,'K')), NASAPolynomial(coeffs=[8.63767,0.0319161,-1.57303e-05,2.98256e-09,-2.0274e-13,22278.9,-2.61107], Tmin=(857.745,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(CCsJOCs) + radical(Cs_P)"""),
)
...
species(
    label = 'C[CH]O[CH][C]([O])[O](2827)',
    structure = SMILES('C[CH]O[CH][C]([O])[O]'),
    E0 = (384.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.46448,0.0917552,-0.000171747,1.64434e-07,-5.89976e-11,46315,30.1446], Tmin=(100,'K'), Tmax=(865.748,'K')), NASAPolynomial(coeffs=[5.91964,0.0347183,-1.77713e-05,3.39515e-09,-2.30662e-13,46563.3,11.5027], Tmin=(865.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCOC=C([O])[O](4037)',
    structure = SMILES('CCOC=C([O])[O]'),
    E0 = (-268.511,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23183,0.062506,-5.86753e-05,2.93032e-08,-6.05384e-12,-11225.9,25.5157], Tmin=(100,'K'), Tmax=(1141.18,'K')), NASAPolynomial(coeffs=[11.2026,0.0275567,-1.27367e-05,2.46616e-09,-1.74572e-13,-13501.6,-23.9043], Tmin=(1141.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.1552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = 'CC1OCC1([O])[O](3647)',
    structure = SMILES('CC1OCC1([O])[O]'),
    E0 = (-53.3996,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8295,0.0435467,-1.54568e-05,-7.3687e-09,5.86947e-12,-6340.51,21.1947], Tmin=(100,'K'), Tmax=(918.163,'K')), NASAPolynomial(coeffs=[7.56712,0.0294282,-1.01622e-05,1.69005e-09,-1.10363e-13,-7852.63,-8.49299], Tmin=(918.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.3996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'C[C]OC[C]([O])[O](4039)',
    structure = SMILES('C[C]OC[C]([O])[O]'),
    E0 = (484.214,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885499,0.0833451,-0.000157744,1.59863e-07,-6.07105e-11,58335.2,28.4715], Tmin=(100,'K'), Tmax=(843.462,'K')), NASAPolynomial(coeffs=[2.49732,0.0413616,-2.2012e-05,4.31285e-09,-2.9895e-13,59284.9,28.2108], Tmin=(843.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.214,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ) + radical(Cs_P) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]OC=C([O])[O](4030)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(66.4603,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
Exact match found for rate rule [Cd_R;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 60.9 to 66.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=COC[C]([O])[O](2125)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]O[CH][C]([O])[O](2827)', 'H(8)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]OC[C]([O])[O](2144)', 'H(8)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(32)', '[O]C[C]([O])[O](2120)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[CH]C(415)', '[O][C][O](2319)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](11)', '[CH]OC[C]([O])[O](2606)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', 'C[C]OC[C]([O])[O](4039)'],
    products = ['C[CH]OC[C]([O])[O](3645)'],
