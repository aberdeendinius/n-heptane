...
species(
    label = '[CH2]CC(=O)C([CH2])C(11642)',
    structure = SMILES('[CH2]CC(=O)C([CH2])C'),
    E0 = (108.948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,231.448,1910.4],'cm^-1')),
        HinderedRotor(inertia=(0.00316893,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237302,'amu*angstrom^2'), symmetry=1, barrier=(9.20496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.238656,'amu*angstrom^2'), symmetry=1, barrier=(9.20052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250637,'amu*angstrom^2'), symmetry=1, barrier=(9.19082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249149,'amu*angstrom^2'), symmetry=1, barrier=(9.19381,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218373,0.0903042,-0.000123991,1.03812e-07,-3.55859e-11,13232.8,28.9797], Tmin=(100,'K'), Tmax=(811.802,'K')), NASAPolynomial(coeffs=[7.71018,0.0437188,-2.00435e-05,3.77381e-09,-2.59313e-13,12335.1,-3.63919], Tmin=(811.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08025,0.0470238,2.50217e-05,-6.59674e-08,2.84979e-11,18489.2,23.5351], Tmin=(100,'K'), Tmax=(974.786,'K')), NASAPolynomial(coeffs=[15.8021,0.0282381,-1.01233e-05,1.87483e-09,-1.36174e-13,13641.5,-57.2573], Tmin=(974.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C](C)C1(O)CC1(11645)',
    structure = SMILES('[CH2][C](C)C1(O)CC1'),
    E0 = (128.893,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.901225,0.0524355,1.12292e-05,-5.66185e-08,2.71999e-11,15628.1,26.5911], Tmin=(100,'K'), Tmax=(939.453,'K')), NASAPolynomial(coeffs=[16.7041,0.0245951,-7.29981e-06,1.22368e-09,-8.61506e-14,10918.3,-57.926], Tmin=(939.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(C)C1(O)[CH]C1(11646)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.823667,0.0538684,8.55881e-06,-5.65239e-08,2.80339e-11,21323.5,29.1711], Tmin=(100,'K'), Tmax=(930.387,'K')), NASAPolynomial(coeffs=[17.711,0.0220462,-5.88532e-06,9.38311e-10,-6.58736e-14,16416.1,-60.5677], Tmin=(930.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(CCJCO)"""),
)

species(
    label = 'CC(C)C1([O])[CH]C1(11647)',
    structure = SMILES('CC(C)C1([O])[CH]C1'),
    E0 = (200.054,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00145,0.0484822,2.22037e-05,-6.55796e-08,2.91537e-11,24184.7,26.119], Tmin=(100,'K'), Tmax=(964.898,'K')), NASAPolynomial(coeffs=[16.7683,0.0257558,-8.74615e-06,1.59811e-09,-1.16603e-13,19157.3,-59.6682], Tmin=(964.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C([CH2])C1(O)CC1(11648)',
    structure = SMILES('[CH2]C([CH2])C1(O)CC1'),
    E0 = (181.401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.670996,0.0604547,-1.12964e-05,-3.6515e-08,2.16037e-11,21949.3,28.3129], Tmin=(100,'K'), Tmax=(909.018,'K')), NASAPolynomial(coeffs=[16.9781,0.0229049,-5.781e-06,8.37717e-10,-5.43801e-14,17571.3,-56.5778], Tmin=(909.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.401,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.890355,0.0518867,1.26098e-05,-5.77511e-08,2.7244e-11,-13657.1,25.3442], Tmin=(100,'K'), Tmax=(951.577,'K')), NASAPolynomial(coeffs=[17.249,0.0238694,-7.45677e-06,1.30722e-09,-9.4303e-14,-18615.3,-62.4586], Tmin=(951.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)
...
species(
    label = '[CH2]C(C)[C]1CC1(11654)',
    structure = SMILES('[CH2]C(C)[C]1CC1'),
    E0 = (343.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71305,0.0416007,4.81048e-06,-2.83776e-08,1.21439e-11,41361.8,24.212], Tmin=(100,'K'), Tmax=(1011.39,'K')), NASAPolynomial(coeffs=[8.62533,0.0338213,-1.2659e-05,2.25778e-09,-1.54926e-13,38963.2,-14.1593], Tmin=(1011.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Tertalkyl)"""),
)
...
species(
    label = '[CH]C(C)C1([O])CC1(11655)',
    structure = SMILES('[CH]C(C)C1([O])CC1'),
    E0 = (448.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.757779,0.0567105,-5.7826e-06,-3.6635e-08,1.9037e-11,54056,26.1944], Tmin=(100,'K'), Tmax=(973.263,'K')), NASAPolynomial(coeffs=[17.1108,0.0239561,-8.40314e-06,1.53385e-09,-1.10596e-13,49240.9,-60.6399], Tmin=(973.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJ2_triplet) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C([CH2])C(11642)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(96.2864,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 91.9 to 96.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C(C)C1([O])CC1(11643)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC(42)', '[O][C]1CC1(9172)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C=CC1([O])CC1(11496)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)C1([O])CC1(10321)'],
    products = ['[CH2][C](C)C1(O)CC1(11645)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C1([O])CC1(10321)'],
    products = ['[CH2]C(C)C1(O)[CH]C1(11646)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C1([O])CC1(10321)'],
    products = ['CC(C)C1([O])[CH]C1(11647)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])C1(O)CC1(11648)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH2][CH]C1([O])CC1(11624)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C](C)C1([O])CC1(11649)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C(C)C1([O])[CH]C1(11650)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C([CH2])C1([O])CC1(10858)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]CC1([O])CC1(10281)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]C1([O])CC1(11652)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', '[CH2]C(C)[C]1CC1(11654)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', 'C[CH]C1([O])CC1(11619)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C(C)C1([O])CC1(11655)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
