...
species(
    label = '[CH2]CC=C([O])[O](2308)',
    structure = SMILES('[CH2]CC=C([O])[O]'),
    E0 = (105.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,180,656.868,660.153],'cm^-1')),
        HinderedRotor(inertia=(0.136443,'amu*angstrom^2'), symmetry=1, barrier=(3.13708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0503694,'amu*angstrom^2'), symmetry=1, barrier=(15.8541,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53906,0.0490094,-4.18356e-05,1.81844e-08,-3.15999e-12,12808,23.1686], Tmin=(100,'K'), Tmax=(1377.04,'K')), NASAPolynomial(coeffs=[12.5953,0.0168938,-6.85285e-06,1.2485e-09,-8.53457e-14,9763,-33.7091], Tmin=(1377.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(RCCJ) + radical(C=COJ) + radical(C=COJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.72552,0.0328483,-1.37035e-05,1.60382e-09,2.95912e-14,42342.1,21.6296], Tmin=(100,'K'), Tmax=(2607.9,'K')), NASAPolynomial(coeffs=[32.2178,0.000965294,-2.1628e-06,3.91355e-10,-2.07611e-14,23462.2,-150.846], Tmin=(2607.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ) + radical(CCJCO) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.72552,0.0328483,-1.37035e-05,1.60382e-09,2.95902e-14,42342.1,20.531], Tmin=(100,'K'), Tmax=(2607.9,'K')), NASAPolynomial(coeffs=[32.2182,0.000964812,-2.1626e-06,3.91318e-10,-2.07586e-14,23461.9,-151.947], Tmin=(2607.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C[CH][C]([O])O(2313)',
    structure = SMILES('[CH2]C[CH][C]([O])O'),
    E0 = (331.737,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42769,0.0428164,-5.04884e-06,-8.63794e-08,9.26801e-11,39946.7,27.1185], Tmin=(100,'K'), Tmax=(440.023,'K')), NASAPolynomial(coeffs=[5.26746,0.0313688,-1.50012e-05,2.90158e-09,-2.03372e-13,39557.7,14.169], Tmin=(440.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH2][CH]C[C]([O])O(2314)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.711,0.0601479,-9.89516e-05,9.8893e-08,-3.77922e-11,39315.6,29.7509], Tmin=(100,'K'), Tmax=(847.491,'K')), NASAPolynomial(coeffs=[1.68284,0.0373876,-1.81482e-05,3.45613e-09,-2.36944e-13,40142.5,34.7326], Tmin=(847.491,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ) + radical(Cs_P) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10471,0.0480118,-6.1831e-05,6.26791e-08,-2.65219e-11,9062.02,23.7679], Tmin=(100,'K'), Tmax=(776.543,'K')), NASAPolynomial(coeffs=[1.0005,0.0399866,-1.98408e-05,3.88978e-09,-2.74217e-13,9646.97,31.478], Tmin=(776.543,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]CC=C([O])[O](2308)'],
...
reaction(
    ...
    products = ['[CH2]CC[C]([O])[O](1363)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(84.5989,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 80.4 to 84.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2]C[CH][C]([O])[O](2315)'],
    products = ['[CH2]CC[C]([O])[O](1363)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]C[C]([O])[O](2316)', 'H(8)'],
    products = ['[CH2]CC[C]([O])[O](1363)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[CH2](21)', '[O][C][O](2319)'],
    products = ['[CH2]CC[C]([O])[O](1363)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CC[C]([O])[O](2321)', 'H(8)'],
    products = ['[CH2]CC[C]([O])[O](1363)'],
