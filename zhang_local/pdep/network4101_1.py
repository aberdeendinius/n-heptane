...
species(
    label = 'C=[C]C=C[CH]CO[O](21071)',
    structure = SMILES('C=[C]C=C[CH]CO[O]'),
    E0 = (414.845,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.2934,'amu*angstrom^2'), symmetry=1, barrier=(29.7378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.61475,'amu*angstrom^2'), symmetry=1, barrier=(37.1263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29258,'amu*angstrom^2'), symmetry=1, barrier=(29.7189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.29274,'amu*angstrom^2'), symmetry=1, barrier=(29.7226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.116585,0.0859543,-9.63642e-05,5.80249e-08,-1.40323e-11,50033.7,27.6781], Tmin=(100,'K'), Tmax=(1004.78,'K')), NASAPolynomial(coeffs=[14.2636,0.0296364,-1.22906e-05,2.24335e-09,-1.53455e-13,47190.7,-40.6408], Tmin=(1004.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJCO) + radical(C=CJC=C)"""),
)

species(
    label = '[CH2][C]=CCC=CO[O](21072)',
    structure = SMILES('[CH2][C]=CCC=CO[O]'),
    E0 = (509.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1685,370,2750,2850,1437.5,1250,1305,750,350,320.32,320.346],'cm^-1')),
        HinderedRotor(inertia=(0.16783,'amu*angstrom^2'), symmetry=1, barrier=(12.2203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167825,'amu*angstrom^2'), symmetry=1, barrier=(12.2204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167833,'amu*angstrom^2'), symmetry=1, barrier=(12.2203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167835,'amu*angstrom^2'), symmetry=1, barrier=(12.2203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.563175,0.0723924,-6.82762e-05,3.40662e-08,-6.85659e-12,61437.8,32.3813], Tmin=(100,'K'), Tmax=(1193.89,'K')), NASAPolynomial(coeffs=[14.2201,0.0266365,-1.07888e-05,1.96541e-09,-1.34727e-13,58176.9,-35.9257], Tmin=(1193.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C#CC[CH]CO[O](21073)',
    structure = SMILES('[CH2]C#CC[CH]CO[O]'),
    E0 = (504.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.559029,0.0806724,-0.000106446,8.41896e-08,-2.72151e-11,60751.3,33.5243], Tmin=(100,'K'), Tmax=(834.122,'K')), NASAPolynomial(coeffs=[8.50094,0.0364276,-1.58041e-05,2.8914e-09,-1.95324e-13,59640.7,-2.06595], Tmin=(834.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704784,0.0812061,-8.43509e-05,3.50551e-08,5.011e-12,68097.6,31.1588], Tmin=(100,'K'), Tmax=(579.602,'K')), NASAPolynomial(coeffs=[8.60351,0.0413476,-1.91192e-05,3.64255e-09,-2.53513e-13,66935.9,-4.76314], Tmin=(579.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(565.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(ROOJ) + radical(Cds_S) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C=[C]C[CH]CO[O](21075)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697552,0.0809948,-8.62605e-05,4.04026e-08,8.36575e-13,69521.4,33.3317], Tmin=(100,'K'), Tmax=(589.83,'K')), NASAPolynomial(coeffs=[8.64481,0.0407965,-1.88645e-05,3.59725e-09,-2.50586e-13,68345.6,-2.83341], Tmin=(589.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJCOOH) + radical(Cds_S) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C]=CC[CH][CH]OO(21076)',
    structure = SMILES('[CH2][C]=CC[CH][CH]OO'),
    E0 = (613.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.110745,0.0921983,-0.00012179,9.49547e-08,-3.08004e-11,73943.5,34.7717], Tmin=(100,'K'), Tmax=(746.349,'K')), NASAPolynomial(coeffs=[9.58021,0.0414409,-1.97659e-05,3.81123e-09,-2.66717e-13,72530.2,-8.1414], Tmin=(746.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(613.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=[C]CCCO[O](21077)',
    structure = SMILES('[CH2][C]=[C]CCCO[O]'),
    E0 = (614.537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22598,0.0895878,-0.000123153,1.01232e-07,-3.41221e-11,74041.4,33.1285], Tmin=(100,'K'), Tmax=(801.035,'K')), NASAPolynomial(coeffs=[8.583,0.0408772,-1.88693e-05,3.56376e-09,-2.45456e-13,72926.4,-3.93761], Tmin=(801.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(614.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(ROOJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]C=C[CH]CO[O](21078)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.602422,0.0758924,-6.70609e-05,3.20259e-08,-6.38725e-12,54456.1,29.7908], Tmin=(100,'K'), Tmax=(1173.18,'K')), NASAPolynomial(coeffs=[12.2967,0.0360202,-1.60812e-05,3.05624e-09,-2.13929e-13,51712.2,-28.4952], Tmin=(1173.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(ROOJ) + radical(Allyl_S) + radical(RCCJ)"""),
)

species(
    label = 'C[C]=[C]C[CH]CO[O](21079)',
    structure = SMILES('C[C]=[C]C[CH]CO[O]'),
    E0 = (663.453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196373,0.0948131,-0.000150357,1.37739e-07,-4.92298e-11,79921.2,35.2557], Tmin=(100,'K'), Tmax=(848.036,'K')), NASAPolynomial(coeffs=[5.77417,0.0452255,-2.14725e-05,4.0506e-09,-2.76312e-13,79812.2,14.2007], Tmin=(848.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(663.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(ROOJ) + radical(CCJCOOH) + radical(Cds_S)"""),
)

species(
    label = 'C[C]C=C[CH]CO[O](21080)',
    structure = SMILES('C[C]C=C[CH]CO[O]'),
    E0 = (553.621,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.325512,0.0832292,-8.40396e-05,4.62968e-08,-1.05265e-11,66715.6,29.3234], Tmin=(100,'K'), Tmax=(1048.2,'K')), NASAPolynomial(coeffs=[12.7727,0.0357292,-1.60649e-05,3.06341e-09,-2.15019e-13,64106.2,-31.3128], Tmin=(1048.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(CCJ2_triplet) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C=CC[CH][CH]O[O](21081)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.467567,0.083218,-9.84891e-05,6.99748e-08,-2.09714e-11,63608,33.7812], Tmin=(100,'K'), Tmax=(801.187,'K')), NASAPolynomial(coeffs=[9.00531,0.0405917,-1.86817e-05,3.56598e-09,-2.49007e-13,62240,-5.51583], Tmin=(801.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(527.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(Allyl_P) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C]=C[CH][CH]COO(21082)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54994,0.0812063,-8.46523e-05,5.04033e-08,-1.27113e-11,68220.1,31.9488], Tmin=(100,'K'), Tmax=(938.377,'K')), NASAPolynomial(coeffs=[10.2046,0.0400514,-1.88661e-05,3.66581e-09,-2.59638e-13,66408.2,-14.0155], Tmin=(938.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(566.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(Allyl_P) + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = 'C[C]=CC[CH][CH]O[O](21083)',
    structure = SMILES('C[C]=CC[CH][CH]O[O]'),
    E0 = (614.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.230415,0.0929774,-0.00014246,1.28494e-07,-4.57746e-11,73996.5,34.8095], Tmin=(100,'K'), Tmax=(838.839,'K')), NASAPolynomial(coeffs=[6.11045,0.0450928,-2.13453e-05,4.03505e-09,-2.76205e-13,73708.2,11.6369], Tmin=(838.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(614.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOOH) + radical(ROOJ) + radical(CCJCOOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=[C]C[CH]COO(21084)',
    structure = SMILES('[CH2][C]=[C]C[CH]COO'),
    E0 = (662.948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00509335,0.0949868,-0.000133584,1.10178e-07,-3.72822e-11,79871.2,35.4681], Tmin=(100,'K'), Tmax=(778.342,'K')), NASAPolynomial(coeffs=[9.4156,0.0412597,-1.97024e-05,3.78006e-09,-2.6284e-13,78568.8,-6.52995], Tmin=(778.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(662.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(Cds_S) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][C]=C[CH][CH]CO[O](21085)',
    structure = SMILES('[CH2][C]=C[CH][CH]CO[O]'),
    E0 = (718.223,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.601469,0.0802263,-9.90407e-05,7.31949e-08,-2.27081e-11,86499.6,32.5155], Tmin=(100,'K'), Tmax=(776.618,'K')), NASAPolynomial(coeffs=[8.77472,0.0381282,-1.77271e-05,3.39087e-09,-2.36724e-13,85230.2,-4.84916], Tmin=(776.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(718.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJCOOH) + radical(Cds_S) + radical(Allyl_S) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C]=CC[CH][CH]O[O](21086)',
    structure = SMILES('[CH2][C]=CC[CH][CH]O[O]'),
    E0 = (765.693,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243598,0.090295,-0.000133076,1.13743e-07,-3.90047e-11,92219.5,35.0443], Tmin=(100,'K'), Tmax=(823.371,'K')), NASAPolynomial(coeffs=[8.3428,0.0391461,-1.83928e-05,3.47738e-09,-2.38682e-13,91285.8,-0.0262058], Tmin=(823.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(765.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(CCJCOOH) + radical(Cds_S) + radical(CCsJOOH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2][C]=[C]C[CH]CO[O](21087)',
    structure = SMILES('[CH2][C]=[C]C[CH]CO[O]'),
    E0 = (814.952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.203562,0.0922066,-0.000141263,1.23395e-07,-4.26455e-11,98144.4,35.5116], Tmin=(100,'K'), Tmax=(838.021,'K')), NASAPolynomial(coeffs=[8.0269,0.0392424,-1.84982e-05,3.48767e-09,-2.38344e-13,97381.8,2.42394], Tmin=(838.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(814.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cds_S) + radical(Allyl_P) + radical(CCJCOOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CC=CCO[O](21088)',
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.390327,0.0702051,-5.18657e-05,1.55998e-08,-4.8217e-13,32843.5,32.5287], Tmin=(100,'K'), Tmax=(1069.79,'K')), NASAPolynomial(coeffs=[15.8645,0.026374,-1.00766e-05,1.8147e-09,-1.25027e-13,28730,-46.9206], Tmin=(1069.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]C=C[CH]COO(21091)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.170827,0.0898535,-9.28268e-05,5.02631e-08,-1.09084e-11,31764.2,27.948], Tmin=(100,'K'), Tmax=(1114.72,'K')), NASAPolynomial(coeffs=[16.4212,0.0303149,-1.27091e-05,2.34765e-09,-1.62191e-13,28065.1,-53.9009], Tmin=(1114.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(C=CJC=C)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.165032,0.065974,-5.36818e-05,2.39442e-08,-4.14008e-12,39856.5,28.0589], Tmin=(100,'K'), Tmax=(1643.88,'K')), NASAPolynomial(coeffs=[13.8397,0.0227531,-5.16741e-06,5.88615e-10,-2.83953e-14,36704.6,-40.6226], Tmin=(1643.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690813,0.0615379,-1.63497e-05,-3.0666e-08,1.96744e-11,46718.9,28.0294], Tmin=(100,'K'), Tmax=(895.591,'K')), NASAPolynomial(coeffs=[16.1201,0.024025,-6.11057e-06,8.59475e-10,-5.3587e-14,42696,-51.7371], Tmin=(895.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(12dioxetane) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C]=CC[C]CO[O](21093)',
    structure = SMILES('[CH2][C]=CC[C]CO[O]'),
    E0 = (824.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.296948,0.0868391,-0.00011294,8.40083e-08,-2.56379e-11,99342.2,32.3141], Tmin=(100,'K'), Tmax=(795.509,'K')), NASAPolynomial(coeffs=[10.4776,0.0356482,-1.64146e-05,3.11617e-09,-2.16259e-13,97722.5,-14.4726], Tmin=(795.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(824.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Allyl_P)"""),
)
...
species(
    ...
    E0 = (595.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3010,987.5,1337.5,450,1655,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (644.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.350948,0.0817919,-8.78153e-05,5.30603e-08,-1.31335e-11,35962.6,29.6391], Tmin=(100,'K'), Tmax=(974.412,'K')), NASAPolynomial(coeffs=[12.0343,0.0338315,-1.39857e-05,2.54818e-09,-1.73933e-13,33685.7,-26.4233], Tmin=(974.412,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CJC=C)"""),
)

species(
    label = 'C=[C]CC=CCO[O](18676)',
    structure = SMILES('C=[C]CC=CCO[O]'),
    E0 = (360.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,278.222,278.222,278.222],'cm^-1')),
        HinderedRotor(inertia=(0.135211,'amu*angstrom^2'), symmetry=1, barrier=(7.42717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135211,'amu*angstrom^2'), symmetry=1, barrier=(7.42717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135211,'amu*angstrom^2'), symmetry=1, barrier=(7.42717,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135211,'amu*angstrom^2'), symmetry=1, barrier=(7.42717,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.966405,0.0715258,-7.09266e-05,4.31476e-08,-1.14701e-11,43516.1,31.2847], Tmin=(100,'K'), Tmax=(882.408,'K')), NASAPolynomial(coeffs=[7.77002,0.0406847,-1.85002e-05,3.53904e-09,-2.48403e-13,42315.4,-0.687644], Tmin=(882.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CCC=CO[O](18678)',
    structure = SMILES('C=[C]CCC=CO[O]'),
    E0 = (369.249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,274.745,274.751,274.754],'cm^-1')),
        HinderedRotor(inertia=(0.173531,'amu*angstrom^2'), symmetry=1, barrier=(9.29559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173527,'amu*angstrom^2'), symmetry=1, barrier=(9.29557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17353,'amu*angstrom^2'), symmetry=1, barrier=(9.2956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173527,'amu*angstrom^2'), symmetry=1, barrier=(9.2956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641754,0.0732887,-6.74759e-05,3.39108e-08,-7.02189e-12,44531.8,32.2315], Tmin=(100,'K'), Tmax=(1147.03,'K')), NASAPolynomial(coeffs=[12.4998,0.0319362,-1.33978e-05,2.47975e-09,-1.71292e-13,41811.5,-26.6031], Tmin=(1147.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]C=C[CH]CO[O](21071)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2][C]=CCC=CO[O](21072)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C#CC[CH]CO[O](21073)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['O2(2)', '[CH2][CH]CC=C=C(17733)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]=C[CH]CCO[O](21035)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['[CH2][C]=CCC[CH]O[O](21074)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C=[C]C[CH]CO[O](21075)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]=CC[CH][CH]OO(21076)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=[C]CCCO[O](21077)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['[CH2][CH]C=C[CH]CO[O](21078)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[C]=[C]C[CH]CO[O](21079)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['C[C]C=C[CH]CO[O](21080)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['[CH2]C=CC[CH][CH]O[O](21081)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['[CH2][C]=C[CH][CH]COO(21082)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[C]=CC[CH][CH]O[O](21083)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C]=[C]C[CH]COO(21084)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O2(2)', '[CH2][C]=CC[CH][CH2](17739)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C]=C[CH][CH]CO[O](21085)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2][C]=CC[CH][CH]O[O](21086)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][C]=[C]C[CH]CO[O](21087)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['O2(S)(5486)', '[CH2][CH]CC=C=C(17733)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(8.54363,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 8.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction30',
    reactants = ['[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['O(T)(63)', '[CH2][C]=CCC1CO1(18542)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(T)(63)', '[CH2][C]=CC[CH]C[O](18245)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CO[O](7037)', '[CH2][C]=C[CH2](18777)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]O[O](61)', '[CH]CC=[C][CH2](18854)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH2][C]=CC[C]CO[O](21093)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]CO[O](7037)', 'C=[C]C=C(18778)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=[C]C[CH][CH]CO[O](18687)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C=[C]CC[CH][CH]O[O](18689)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH][C]=CC[CH]COO(20967)'],
    products = ['[CH2][C]=CC[CH]CO[O](18688)'],
