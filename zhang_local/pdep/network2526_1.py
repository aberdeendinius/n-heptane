...
species(
    label = '[CH2]C(O)[CH]C1CO1(9873)',
    structure = SMILES('[CH2]C(O)[CH]C1CO1'),
    E0 = (88.0297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3615,1277.5,1000,2750,2950,3150,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0207262,0.0723585,-6.87159e-05,3.47168e-08,-6.65934e-12,10746.1,31.1627], Tmin=(100,'K'), Tmax=(1495.46,'K')), NASAPolynomial(coeffs=[15.5158,0.0189228,-3.20251e-06,1.99496e-10,-9.86048e-16,7427.58,-45.603], Tmin=(1495.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.0297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2][C](O)CC1CO1(9875)',
    structure = SMILES('[CH2][C](O)CC1CO1'),
    E0 = (64.7555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,2750,2950,3150,900,1000,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185024,0.0798429,-9.20903e-05,5.78589e-08,-1.40493e-11,7929.18,27.3476], Tmin=(100,'K'), Tmax=(1137.5,'K')), NASAPolynomial(coeffs=[13.9046,0.0230316,-5.87748e-06,7.10453e-10,-3.40362e-14,5362.22,-38.1727], Tmin=(1137.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.7555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800547,0.0557921,-1.45279e-07,-5.71648e-08,3.28558e-11,-28467.6,23.2703], Tmin=(100,'K'), Tmax=(868.37,'K')), NASAPolynomial(coeffs=[19.6908,0.0120156,7.84697e-07,-5.38789e-10,4.55251e-14,-33378.6,-74.5846], Tmin=(868.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = '[CH]C(O)C[C]1CO1(9881)',
    structure = SMILES('[CH]C(O)C[C]1CO1'),
    E0 = (304.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.494443,0.0743544,-8.68749e-05,5.59153e-08,-1.39464e-11,36794.6,28.2983], Tmin=(100,'K'), Tmax=(1111.69,'K')), NASAPolynomial(coeffs=[12.5313,0.022764,-6.09182e-06,7.70806e-10,-3.86454e-14,34630,-28.746], Tmin=(1111.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(O)C[C]1CO1(9870)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(O)C=C1CO1(9871)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(O)CC1=CO1(9872)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C=CC[C]1CO1(9228)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)[CH]C1CO1(9873)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)CC1[CH]O1(9874)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH2][CH]C[C]1CO1(6530)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][C](O)C[C]1CO1(9876)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C(O)[CH][C]1CO1(9877)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C(O)C[C]1[CH]O1(9878)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[C]1CO1(1125)', '[CH2]C([CH2])O(5560)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C(O)C[C]1CO1(9881)'],
    products = ['[CH2]C(O)C[C]1CO1(9318)'],
