...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.18487,'amu*angstrom^2'), symmetry=1, barrier=(27.2426,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19255,'amu*angstrom^2'), symmetry=1, barrier=(27.419,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
...
species(
    ...
    E0 = (308.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1685,370,283.269],'cm^-1')),
        HinderedRotor(inertia=(0.134313,'amu*angstrom^2'), symmetry=1, barrier=(7.61591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132476,'amu*angstrom^2'), symmetry=1, barrier=(7.62959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132252,'amu*angstrom^2'), symmetry=1, barrier=(7.62524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
...
species(
    ...
    E0 = (304.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,460.991,462.515,463.009,463.398],'cm^-1')),
        HinderedRotor(inertia=(0.335426,'amu*angstrom^2'), symmetry=1, barrier=(50.8911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.335346,'amu*angstrom^2'), symmetry=1, barrier=(50.9026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.333955,'amu*angstrom^2'), symmetry=1, barrier=(50.8901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
...
species(
    label = '[CH]=CC[C]O(5800)',
    structure = SMILES('[CH]=CC[C]O'),
    E0 = (531.735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3010,987.5,1337.5,450,1655,266.943,267.392],'cm^-1')),
        HinderedRotor(inertia=(0.240194,'amu*angstrom^2'), symmetry=1, barrier=(12.2568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24128,'amu*angstrom^2'), symmetry=1, barrier=(12.2509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244774,'amu*angstrom^2'), symmetry=1, barrier=(12.2517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76543,0.047968,-5.08828e-05,2.78915e-08,-6.07489e-12,64034.5,19.9387], Tmin=(100,'K'), Tmax=(1115.65,'K')), NASAPolynomial(coeffs=[11.055,0.0146617,-6.10235e-06,1.13266e-09,-7.86592e-14,61961.7,-25.8949], Tmin=(1115.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]C=C[CH]O(5308)'],
    products = ['[CH]=CC[CH]O(5577)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=[C]C[CH]O(5309)'],
    products = ['[CH]=CC[CH]O(5577)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(D)(132)', '[CH]CC=[CH](5190)'],
    products = ['[CH]=CC[CH]O(5577)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C=C(5174)', '[CH]O(5471)'],
    products = ['[CH]=CC[CH]O(5577)'],
