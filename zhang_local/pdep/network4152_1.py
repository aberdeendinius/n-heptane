...
species(
    label = '[CH]C(=[CH])C([CH2])([CH2])O(20463)',
    structure = SMILES('[CH]C(=[CH])C([CH2])([CH2])O'),
    E0 = (771.648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3120,650,792.5,1650,3615,1277.5,1000,350,440,435,1725,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.121097,0.0862807,-0.000101052,6.43734e-08,-1.64582e-11,92946.7,30.4342], Tmin=(100,'K'), Tmax=(953.532,'K')), NASAPolynomial(coeffs=[13.6077,0.0297057,-1.2054e-05,2.15049e-09,-1.44477e-13,90374.7,-33.989], Tmin=(953.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(771.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH]C(=[CH])C([CH2])(C)[O](20464)',
    structure = SMILES('[CH]C(=[CH])C([CH2])(C)[O]'),
    E0 = (787.307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747391,0.0725819,-6.72376e-05,3.50779e-08,-7.68492e-12,94807.4,29.2181], Tmin=(100,'K'), Tmax=(1077.33,'K')), NASAPolynomial(coeffs=[10.8405,0.0351073,-1.50605e-05,2.78998e-09,-1.92334e-13,92632.7,-20.2272], Tmin=(1077.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(787.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH][C]1COC1([CH2])[CH2](20466)',
    structure = SMILES('[CH][C]1COC1([CH2])[CH2]'),
    E0 = (814.481,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.11205,0.0786707,-8.55591e-05,4.83137e-08,-1.02631e-11,98117.7,26.7969], Tmin=(100,'K'), Tmax=(1347.78,'K')), NASAPolynomial(coeffs=[16.474,0.0165865,-2.15118e-06,-2.24653e-11,1.5966e-14,94814.7,-53.8386], Tmin=(1347.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(814.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH][C]1CCC1([CH2])[O](20467)',
    structure = SMILES('[CH][C]1CCC1([CH2])[O]'),
    E0 = (808.538,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02906,0.0513464,-3.87288e-06,-3.50619e-08,1.77987e-11,97364.1,25.2691], Tmin=(100,'K'), Tmax=(982.701,'K')), NASAPolynomial(coeffs=[16.4614,0.0212267,-7.80614e-06,1.46427e-09,-1.07009e-13,92752.3,-56.9466], Tmin=(982.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(808.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJC(C)2O) + radical(CCJ2_triplet) + radical(CCJ(C)CO) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH]C([CH2])=C([CH2])[CH2](19199)',
    structure = SMILES('[CH]C([CH2])=C([CH2])[CH2]'),
    E0 = (717.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,457.373,457.42,457.49],'cm^-1')),
        HinderedRotor(inertia=(0.34168,'amu*angstrom^2'), symmetry=1, barrier=(50.7278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341455,'amu*angstrom^2'), symmetry=1, barrier=(50.7291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341283,'amu*angstrom^2'), symmetry=1, barrier=(50.7299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.341662,'amu*angstrom^2'), symmetry=1, barrier=(50.7285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976316,0.056264,-2.15955e-05,-1.26555e-08,9.05162e-12,86373.5,23.2889], Tmin=(100,'K'), Tmax=(998.136,'K')), NASAPolynomial(coeffs=[13.9159,0.0264994,-1.00626e-05,1.81444e-09,-1.26205e-13,82690,-44.6253], Tmin=(998.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(717.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(Allyl_P) + radical(AllylJ2_triplet) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]C(=C)C([CH])([CH2])[O](20468)',
    structure = SMILES('[CH]C(=C)C([CH])([CH2])[O]'),
    E0 = (988.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,180,1029.08,1029.08,1029.08,1029.08,1029.08,1029.08,1029.08,1029.08,1029.08,1029.08,1029.08,2276.08],'cm^-1')),
        HinderedRotor(inertia=(0.0842065,'amu*angstrom^2'), symmetry=1, barrier=(1.93607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0842065,'amu*angstrom^2'), symmetry=1, barrier=(1.93607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0842065,'amu*angstrom^2'), symmetry=1, barrier=(1.93607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0842065,'amu*angstrom^2'), symmetry=1, barrier=(1.93607,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.746366,0.072377,-7.10144e-05,3.8584e-08,-8.67881e-12,118997,30.516], Tmin=(100,'K'), Tmax=(1059.5,'K')), NASAPolynomial(coeffs=[11.462,0.0319222,-1.37412e-05,2.54682e-09,-1.7563e-13,116726,-21.8004], Tmin=(1059.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(988.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)2OJ) + radical(AllylJ2_triplet) + radical(CCJ2_triplet) + radical(C=CC(C)(O)CJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])C1=CC1(20469)',
    structure = SMILES('[CH2]C([CH2])([O])C1=CC1'),
    E0 = (647.313,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.737963,0.0670902,-6.13705e-05,2.93068e-08,-5.61777e-12,77975.1,28.1999], Tmin=(100,'K'), Tmax=(1254.11,'K')), NASAPolynomial(coeffs=[14.346,0.0236877,-9.45868e-06,1.7116e-09,-1.1687e-13,74561.9,-40.5323], Tmin=(1254.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(647.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[C]C(=C)C([CH2])([CH2])[O](20471)',
    structure = SMILES('[C]C(=C)C([CH2])([CH2])[O]'),
    E0 = (1052.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.6168,0.0774864,-9.72884e-05,6.52576e-08,-1.75375e-11,126699,27.5082], Tmin=(100,'K'), Tmax=(907.366,'K')), NASAPolynomial(coeffs=[12.4031,0.0255276,-1.13928e-05,2.14731e-09,-1.49089e-13,124561,-28.2082], Tmin=(907.366,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1052.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ) + radical(CJ3) + radical(C=CC(C)(O)CJ)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(106.918,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.264e+11,'s^-1'), n=0.35, Ea=(99.6674,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 98.2 to 99.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH]C(=C)C(=C)[O](17908)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', '[CH]C(=C)C([CH2])=C(18076)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=[CH])C([CH2])([CH2])O(20463)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C([CH2])(C)[O](20464)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C(=[CH])C([CH2])([CH2])[O](20465)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
    products = ['[CH][C]1COC1([CH2])[CH2](20466)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
    products = ['[CH][C]1CCC1([CH2])[O](20467)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(T)(63)', '[CH]C([CH2])=C([CH2])[CH2](19199)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(28)', '[CH]C([CH2])=C([CH2])[O](19546)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C(=C)C([CH])([CH2])[O](20468)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', 'C#CC([CH2])([CH2])[O](10603)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
    products = ['[CH2]C([CH2])([O])C1=CC1(20469)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH]=[C]C([CH2])([CH2])[O](10607)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[C]C(=C)C([CH2])([CH2])[O](20471)'],
    products = ['[CH]C(=C)C([CH2])([CH2])[O](18350)'],
