species(
    ...
    E0 = (-81.5588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
...
species(
    ...
    E0 = (-148.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.783137,'amu*angstrom^2'), symmetry=1, barrier=(18.0059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.782748,'amu*angstrom^2'), symmetry=1, barrier=(17.9969,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.783005,'amu*angstrom^2'), symmetry=1, barrier=(18.0028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784356,'amu*angstrom^2'), symmetry=1, barrier=(18.0339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](O)OCC(5709)',
    structure = SMILES('[CH2][C](O)OCC'),
    E0 = (-56.7685,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(O)O[C]C(5711)',
    structure = SMILES('[CH2]C(O)O[C]C'),
    E0 = (198.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975314,0.0700122,-8.33593e-05,5.31802e-08,-1.37467e-11,24037,24.3801], Tmin=(100,'K'), Tmax=(936.157,'K')), NASAPolynomial(coeffs=[11.4078,0.0254366,-1.19365e-05,2.31827e-09,-1.64149e-13,22083.7,-25.2626], Tmin=(936.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH]C(O)O[CH]C(5712)',
    structure = SMILES('[CH]C(O)O[CH]C'),
    E0 = (155.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.887853,0.0701894,-8.18239e-05,5.07106e-08,-1.26134e-11,18760.9,25.7731], Tmin=(100,'K'), Tmax=(976.899,'K')), NASAPolynomial(coeffs=[12.2517,0.0236594,-1.03787e-05,1.95427e-09,-1.36125e-13,16540.7,-28.7851], Tmin=(976.899,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(O)O[CH]C(3825)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(O)OC=C(3826)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(D)(132)', 'C=CO[CH]C(3600)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH2][CH]O[CH]C(718)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C](O)O[CH]C(3824)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][CH]OC([CH2])O(3819)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(32)', '[CH2]C([O])O(670)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', 'C[CH]O[CH]O(3779)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH]OC([CH2])O(5686)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2]C(O)O[C]C(5711)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH]C(O)O[CH]C(5712)'],
    products = ['[CH2]C(O)O[CH]C(3799)'],
