...
species(
    label = '[CH2][CH]CC(=C)OO(6705)',
    structure = SMILES('[CH2][CH]CC(=C)OO'),
    E0 = (269.327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,180,921.33],'cm^-1')),
        HinderedRotor(inertia=(0.0761008,'amu*angstrom^2'), symmetry=1, barrier=(1.74971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761058,'amu*angstrom^2'), symmetry=1, barrier=(1.74982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0760868,'amu*angstrom^2'), symmetry=1, barrier=(1.74938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761569,'amu*angstrom^2'), symmetry=1, barrier=(1.751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761205,'amu*angstrom^2'), symmetry=1, barrier=(1.75016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40088,0.0637884,-5.73509e-05,2.13235e-08,3.68366e-12,32479.9,30.3291], Tmin=(100,'K'), Tmax=(581.634,'K')), NASAPolynomial(coeffs=[6.25373,0.0395314,-1.83057e-05,3.5195e-09,-2.47314e-13,31761.2,8.2211], Tmin=(581.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[CH]C([CH2])([O])OO(6706)',
    structure = SMILES('[CH2]C[CH]C([CH2])([O])OO'),
    E0 = (370.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0171737,0.0906717,-0.000100325,5.84254e-08,-1.37336e-11,44691.3,36.5823], Tmin=(100,'K'), Tmax=(1027.02,'K')), NASAPolynomial(coeffs=[15.0402,0.0320271,-1.46731e-05,2.8265e-09,-1.99652e-13,41598.5,-36.4624], Tmin=(1027.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(370.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH][CH]C([CH2])(O)OO(6707)',
    structure = SMILES('[CH2][CH][CH]C([CH2])(O)OO'),
    E0 = (332.853,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.828334,0.0983606,-0.000109817,5.85395e-08,-1.15028e-11,40213.8,40.9476], Tmin=(100,'K'), Tmax=(999.669,'K')), NASAPolynomial(coeffs=[22.4254,0.017149,-5.71615e-06,9.57866e-10,-6.40896e-14,34973.3,-74.1879], Tmin=(999.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]C(C)([O])OO(6708)',
    structure = SMILES('[CH2][CH][CH]C(C)([O])OO'),
    E0 = (350.881,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.262198,0.0878829,-0.000105259,7.22957e-08,-2.06244e-11,42330.8,36.3267], Tmin=(100,'K'), Tmax=(844.109,'K')), NASAPolynomial(coeffs=[10.6052,0.0388666,-1.81494e-05,3.49179e-09,-2.45154e-13,40584.8,-11.8185], Tmin=(844.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2][CH]CC([CH2])(O)O[O](6709)',
    structure = SMILES('[CH2][CH]CC([CH2])(O)O[O]'),
    E0 = (284.443,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.791633,0.0951365,-0.000107034,5.96568e-08,-1.27563e-11,34391.9,39.2687], Tmin=(100,'K'), Tmax=(1193.55,'K')), NASAPolynomial(coeffs=[22.1469,0.0158538,-4.36929e-06,6.22436e-10,-3.69644e-14,29087.8,-74.7366], Tmin=(1193.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CC(C)([O])O[O](6710)',
    structure = SMILES('[CH2][CH]CC(C)([O])O[O]'),
    E0 = (302.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447092,0.0829543,-9.67248e-05,6.62558e-08,-1.89549e-11,36502.5,34.1134], Tmin=(100,'K'), Tmax=(840.845,'K')), NASAPolynomial(coeffs=[9.80913,0.0384184,-1.72769e-05,3.26597e-09,-2.26963e-13,34928.1,-9.43024], Tmin=(840.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJC) + radical(RCCJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CCC([CH2])([O])O[O](6711)',
    structure = SMILES('[CH2]CCC([CH2])([O])O[O]'),
    E0 = (321.987,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.151372,0.0859262,-9.23871e-05,5.31067e-08,-1.23541e-11,38863.7,34.4282], Tmin=(100,'K'), Tmax=(1037.25,'K')), NASAPolynomial(coeffs=[14.2416,0.0315896,-1.38096e-05,2.6033e-09,-1.81713e-13,35940.7,-34.0645], Tmin=(1037.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCOOH) + radical(ROOJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2][CH]CC([CH2])([O])O[O](6712)',
    structure = SMILES('[CH2][CH]CC([CH2])([O])O[O]'),
    E0 = (516.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.361672,0.0857939,-0.000109569,7.68918e-08,-2.10221e-11,62238.3,36.4213], Tmin=(100,'K'), Tmax=(699.022,'K')), NASAPolynomial(coeffs=[10.718,0.0342356,-1.5463e-05,2.90749e-09,-2.00619e-13,60602.3,-11.18], Tmin=(699.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(516.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJC) + radical(ROOJ) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]C([CH2])([O])OO(6713)',
    structure = SMILES('[CH2][CH][CH]C([CH2])([O])OO'),
    E0 = (564.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0783855,0.0920873,-0.000124041,9.28199e-08,-2.82099e-11,68070.9,38.9757], Tmin=(100,'K'), Tmax=(801.21,'K')), NASAPolynomial(coeffs=[11.6145,0.0344945,-1.62182e-05,3.10419e-09,-2.16301e-13,66222.3,-14.1226], Tmin=(801.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(564.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH) + radical(RCCJC) + radical(CJCOOH) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C(O)([CH]C=C)OO(6714)',
    structure = SMILES('[CH2]C(O)([CH]C=C)OO'),
    E0 = (-22.5553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.981935,0.0913272,-6.12337e-05,-8.61728e-09,1.60355e-11,-2516.64,32.3465], Tmin=(100,'K'), Tmax=(939.234,'K')), NASAPolynomial(coeffs=[29.2589,0.00803206,-8.63754e-07,1.03458e-10,-1.27007e-14,-10203.9,-122.334], Tmin=(939.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.5553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(CJCOOH)"""),
)

species(
    label = 'C=C[CH]C(C)([O])OO(6715)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.471063,0.0877902,-8.12766e-05,3.7165e-08,-6.67718e-12,-374.783,29.7962], Tmin=(100,'K'), Tmax=(1349.8,'K')), NASAPolynomial(coeffs=[21.2845,0.0233184,-9.62911e-06,1.7776e-09,-1.22846e-13,-6247.8,-81.6871], Tmin=(1349.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.52756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)(O)OJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH2][CH]CC1([CH2])OO1(6716)',
    structure = SMILES('[CH2][CH]CC1([CH2])OO1'),
    E0 = (455.144,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615396,0.0524497,1.94099e-05,-8.69973e-08,4.5096e-11,54883.9,30.2532], Tmin=(100,'K'), Tmax=(894.217,'K')), NASAPolynomial(coeffs=[25.6607,0.000607014,5.40842e-06,-1.28627e-09,8.92166e-14,47998.2,-101.231], Tmin=(894.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCOOH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2][CH]CC1(CO1)OO(6717)',
    structure = SMILES('[CH2][CH]CC1(CO1)OO'),
    E0 = (108.04,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55743,0.0933017,-9.44258e-05,4.71747e-08,-8.68303e-12,13219.2,36.3137], Tmin=(100,'K'), Tmax=(1600.1,'K')), NASAPolynomial(coeffs=[21.9941,0.0133965,1.95066e-07,-4.62094e-10,4.30862e-14,8374.37,-79.9672], Tmin=(1600.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]CC([O])([O])CO(6718)',
    structure = SMILES('[CH2][CH]CC([O])([O])CO'),
    E0 = (151.124,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.532098,0.0895344,-0.000145231,1.41676e-07,-5.33458e-11,18288.1,35.5498], Tmin=(100,'K'), Tmax=(843.946,'K')), NASAPolynomial(coeffs=[2.11258,0.0520493,-2.52954e-05,4.82173e-09,-3.30933e-13,19089.5,34.5214], Tmin=(843.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(O)CC([CH2])([O])[O](6719)',
    structure = SMILES('[CH2]C(O)CC([CH2])([O])[O]'),
    E0 = (166.76,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0734191,0.101579,-0.000164329,1.51813e-07,-5.48879e-11,20191.7,33.759], Tmin=(100,'K'), Tmax=(832.348,'K')), NASAPolynomial(coeffs=[6.29835,0.04714,-2.33007e-05,4.4777e-09,-3.08985e-13,19956,9.14436], Tmin=(832.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]C[C]([CH2])OO(6720)',
    structure = SMILES('[CH2][CH]C[C]([CH2])OO'),
    E0 = (531.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,205.983,1839.85],'cm^-1')),
        HinderedRotor(inertia=(0.117965,'amu*angstrom^2'), symmetry=1, barrier=(3.49784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117965,'amu*angstrom^2'), symmetry=1, barrier=(3.49784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117965,'amu*angstrom^2'), symmetry=1, barrier=(3.49784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117965,'amu*angstrom^2'), symmetry=1, barrier=(3.49784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117965,'amu*angstrom^2'), symmetry=1, barrier=(3.49784,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638139,0.0831244,-0.000125316,1.1383e-07,-4.10334e-11,64037.4,33.8454], Tmin=(100,'K'), Tmax=(834.734,'K')), NASAPolynomial(coeffs=[5.22149,0.0429397,-2.03614e-05,3.85655e-09,-2.64526e-13,63907.1,16.3639], Tmin=(834.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJ) + radical(C2CsJOOH) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.164797,0.0925598,-0.000107088,6.32346e-08,-1.48219e-11,74501.3,34.7102], Tmin=(100,'K'), Tmax=(1038.5,'K')), NASAPolynomial(coeffs=[16.8811,0.026904,-1.22553e-05,2.35622e-09,-1.6643e-13,70960.9,-48.17], Tmin=(1038.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(618.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CJCOOH)"""),
)

species(
    label = '[CH]C([O])(C[CH][CH2])OO(6722)',
    structure = SMILES('[CH]C([O])(C[CH][CH2])OO'),
    E0 = (598.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.17408,0.0890602,-0.000109489,7.3725e-08,-2.02139e-11,72138.2,35.3405], Tmin=(100,'K'), Tmax=(883.58,'K')), NASAPolynomial(coeffs=[12.3634,0.0338773,-1.58057e-05,3.03842e-09,-2.13296e-13,69984.3,-21.9567], Tmin=(883.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(598.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC([CH2])([O])OO(6723)',
    structure = SMILES('[CH][CH]CC([CH2])([O])OO'),
    E0 = (607.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0449058,0.0913788,-0.000113443,7.57634e-08,-2.04216e-11,73191.7,36.0114], Tmin=(100,'K'), Tmax=(901.523,'K')), NASAPolynomial(coeffs=[13.404,0.0321064,-1.48237e-05,2.83678e-09,-1.98689e-13,70782.9,-27.0536], Tmin=(901.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(607.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJCOOH) + radical(CC(C)(O)OJ) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])([CH]C=C)OO(6704)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2][CH]CC(=C)OO(6705)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(114.301,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O(16)', '[CH2][CH]CC(=C)[O](4399)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C[CH]C([CH2])([O])OO(6706)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2][CH][CH]C([CH2])(O)OO(6707)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2][CH][CH]C(C)([O])OO(6708)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2]C([O])([CH][CH]C)OO(1540)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2][CH]CC([CH2])(O)O[O](6709)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CC(C)([O])O[O](6710)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2]CCC([CH2])([O])O[O](6711)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2]C([O])(C[CH]C)O[O](1539)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH2][CH]CC([CH2])([O])[O](2445)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]O(16)', '[CH2][CH]C[C]([CH2])[O](6386)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][CH]CC([CH2])([O])O[O](6712)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][CH][CH]C([CH2])([O])OO(6713)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2]C(O)([CH]C=C)OO(6714)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['OH(D)(132)', '[CH2][CH]CC1([CH2])OO1(6716)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['OH(D)(132)', '[CH2][CH]CC1([O])CO1(1925)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['OH(D)(132)', '[CH2]C1CC([CH2])([O])O1(6114)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][CH]CC[C]([O])OO(1453)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2][CH]CC1(CO1)OO(6717)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2][CH]CC([O])([O])CO(6718)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
    products = ['[CH2]C(O)CC([CH2])([O])[O](6719)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(T)(63)', '[CH2][CH]C[C]([CH2])OO(6720)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH][CH2](721)', '[CH2]C([CH2])([O])OO(1407)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH2][C]CC([CH2])([O])OO(6721)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[CH]C([O])(C[CH][CH2])OO(6722)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(8)', '[CH][CH]CC([CH2])([O])OO(6723)'],
    products = ['[CH2][CH]CC([CH2])([O])OO(1541)'],
