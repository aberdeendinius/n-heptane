...
species(
    label = '[CH2][C](C)OC([CH2])=O(2359)',
    structure = SMILES('[CH2][C](C)OC([CH2])=O'),
    E0 = (122.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.797044,0.0778037,-0.00011286,1.00039e-07,-3.63816e-11,14899,29.6626], Tmin=(100,'K'), Tmax=(779.963,'K')), NASAPolynomial(coeffs=[6.36249,0.0392612,-1.95038e-05,3.80557e-09,-2.66938e-13,14335,6.14555], Tmin=(779.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJC(C)OC) + radical(C2CsJOC(O)C) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.515267,0.0894503,-0.000150208,1.44763e-07,-5.36579e-11,38036.1,29.985], Tmin=(100,'K'), Tmax=(843.951,'K')), NASAPolynomial(coeffs=[3.70598,0.0460343,-2.27547e-05,4.35974e-09,-2.99678e-13,38505.1,21.1026], Tmin=(843.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOCs) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.295147,0.0972602,-0.000174713,1.71162e-07,-6.31242e-11,37911.4,30.587], Tmin=(100,'K'), Tmax=(860.006,'K')), NASAPolynomial(coeffs=[3.24058,0.0470272,-2.33775e-05,4.45256e-09,-3.03477e-13,38755.8,24.6759], Tmin=(860.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(Cs_P) + radical(CCOJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0318264,0.0994177,-0.000167758,1.54528e-07,-5.48184e-11,41509.3,30.6462], Tmin=(100,'K'), Tmax=(851.365,'K')), NASAPolynomial(coeffs=[7.04104,0.0410524,-2.0115e-05,3.82494e-09,-2.6122e-13,41237.5,3.37203], Tmin=(851.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    label = '[CH2][C](C)O[C]([CH2])[O](2367)',
    structure = SMILES('[CH2][C](C)O[C]([CH2])[O]'),
    E0 = (525.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,363.333,366.667,370,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.128218,0.102614,-0.000194975,1.9084e-07,-6.94063e-11,63364.2,31.8202], Tmin=(100,'K'), Tmax=(870.912,'K')), NASAPolynomial(coeffs=[4.15854,0.043067,-2.17385e-05,4.12769e-09,-2.79258e-13,64218.4,21.868], Tmin=(870.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(525.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOCs) + radical(CCOJ) + radical(Cs_P) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.743588,0.0703347,-6.33799e-05,2.97967e-08,-5.71123e-12,1292.65,27.0317], Tmin=(100,'K'), Tmax=(1236.08,'K')), NASAPolynomial(coeffs=[13.686,0.0284524,-1.25548e-05,2.38468e-09,-1.67059e-13,-1906.91,-38.1512], Tmin=(1236.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.76471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH]C(C)O[C]([CH2])[O](2371)',
    structure = SMILES('[CH]C(C)O[C]([CH2])[O]'),
    E0 = (582.821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62464,0.0810031,-0.000116038,9.88727e-08,-3.4641e-11,70212.2,31.3472], Tmin=(100,'K'), Tmax=(772.143,'K')), NASAPolynomial(coeffs=[7.8333,0.0371625,-1.82496e-05,3.54556e-09,-2.48267e-13,69292.6,-0.312207], Tmin=(772.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(582.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJ2_triplet) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH][C]([O])OC([CH2])C(2372)',
    structure = SMILES('[CH][C]([O])OC([CH2])C'),
    E0 = (581.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.360675,0.0893639,-0.000142609,1.28087e-07,-4.53267e-11,70089.4,31.411], Tmin=(100,'K'), Tmax=(826.493,'K')), NASAPolynomial(coeffs=[7.54371,0.037841,-1.86844e-05,3.5928e-09,-2.48211e-13,69474.5,1.58858], Tmin=(826.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C](C)OC([CH2])=O(2359)', 'H(8)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(106.924,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 105.6 to 106.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]OC([CH2])=O(1060)', '[CH3](11)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.00590643,'m^3/(mol*s)'), n=2.4779, Ea=(56.116,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;CsJ-HHH] for rate rule [Cds-OsH_Cds;CsJ-HHH]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 51.1 to 56.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([O])OC([CH2])C(1469)'],
    products = ['[CH2][C]([O])O[C](C)C(2360)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])OC([CH2])C(1469)'],
    products = ['[CH2][C](C)OC([CH2])[O](2361)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([O])OC([CH2])C(1469)'],
    products = ['[CH2][C](O)OC([CH2])[CH2](2365)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])O[C](C)[O](2366)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]O[C]([CH2])[O](1065)', '[CH3](11)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C](C)O[C]([CH2])[O](2367)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]([O])OC([CH2])[CH2](2368)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(S)(14)', '[CH2]CO[C]([CH2])[O](1063)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C]([O])OC([CH2])C(1469)'],
    products = ['[CH2]C(=O)OC([CH2])C(1460)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C]([O])O[CH]C(1064)', 'CH2(T)(28)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C(C)O[C]([CH2])[O](2371)', 'H(8)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH][C]([O])OC([CH2])C(2372)', 'H(8)'],
    products = ['[CH2][C]([O])OC([CH2])C(1469)'],
