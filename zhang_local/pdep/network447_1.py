...
species(
    ...
    E0 = (-251.365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,511.901,512.016,512.392,513.137],'cm^-1')),
        HinderedRotor(inertia=(0.000643963,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274853,'amu*angstrom^2'), symmetry=1, barrier=(51.4615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.79827,0.015177,3.2239e-05,-5.54358e-08,2.29998e-11,-30178.7,16.6717], Tmin=(100,'K'), Tmax=(948.455,'K')), NASAPolynomial(coeffs=[11.0367,0.00877294,-2.454e-06,4.54427e-10,-3.63071e-14,-33016.2,-29.3578], Tmin=(948.455,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(C(=O)OOJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.8598,'amu*angstrom^2'), symmetry=1, barrier=(42.7605,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89508,0.0134431,2.20405e-05,-4.65736e-08,2.09118e-11,-23215.1,11.8817], Tmin=(100,'K'), Tmax=(933.888,'K')), NASAPolynomial(coeffs=[12.9023,-0.00168473,1.79152e-06,-3.18166e-10,1.6421e-14,-26293.7,-42.1881], Tmin=(933.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(99.7737,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46591,0.0220069,1.68251e-05,-4.43441e-08,2.0102e-11,361.976,18.1101], Tmin=(100,'K'), Tmax=(953.089,'K')), NASAPolynomial(coeffs=[13.7144,0.00402155,-8.61514e-07,1.98283e-10,-2.02706e-14,-3109.49,-42.5803], Tmin=(953.089,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.46154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=C(O)OO(1178)',
    structure = SMILES('[CH]=C(O)OO'),
    E0 = (47.8109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1310,387.5,850,1000,3615,1277.5,1000,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.732334,'amu*angstrom^2'), symmetry=1, barrier=(16.8378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.734285,'amu*angstrom^2'), symmetry=1, barrier=(16.8826,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
...
species(
    label = 'C[C]([O])O[O](1179)',
    structure = SMILES('C[C]([O])O[O]'),
    E0 = (197.659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2245.01],'cm^-1')),
        HinderedRotor(inertia=(0.262964,'amu*angstrom^2'), symmetry=1, barrier=(6.04605,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264494,'amu*angstrom^2'), symmetry=1, barrier=(6.08124,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40856,0.0423159,-7.46124e-05,7.56397e-08,-2.90275e-11,23823.1,19.7572], Tmin=(100,'K'), Tmax=(842.439,'K')), NASAPolynomial(coeffs=[2.58457,0.0244333,-1.24189e-05,2.40291e-09,-1.65939e-13,24398.4,22.5284], Tmin=(842.439,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ) + radical(ROOJ)"""),
)
...
This reaction matched rate rule [Ck_Cds-HH;OJ-O2s]
...
reaction(
    label = 'reaction3',
    reactants = ['CC(=O)O[O](1151)'],
    products = ['[CH2]C(=O)OO(1167)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['OH(D)(132)', 'C=C([O])[O](1172)'],
    products = ['[CH2]C(=O)OO(1167)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=O)O[O](1169)', 'H(8)'],
    products = ['[CH2]C(=O)OO(1167)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=O)OO(1167)'],
    products = ['OH(D)(132)', 'O=C1CO1(1175)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O=[C]OO(1176)', 'CH2(T)(28)'],
    products = ['[CH2]C(=O)OO(1167)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)OO(1167)'],
    products = ['OH(D)(132)', 'C=C1OO1(1180)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(2.8375e+15,'s^-1'), n=-0.6875, Ea=(453.697,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_S;Y_rad_intra;OOH]
Euclidian distance = 0
family: Cyclic_Ether_Formation"""),
)
