...
species(
    label = '[CH2]C[CH]C[CH]C(6189)',
    structure = SMILES('[CH2]C[CH]C[CH]C'),
    E0 = (402.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,192.456,213.4,3958.53],'cm^-1')),
        HinderedRotor(inertia=(0.00593833,'amu*angstrom^2'), symmetry=1, barrier=(1.75134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00593833,'amu*angstrom^2'), symmetry=1, barrier=(1.75134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00593833,'amu*angstrom^2'), symmetry=1, barrier=(1.75134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00593833,'amu*angstrom^2'), symmetry=1, barrier=(1.75134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00593833,'amu*angstrom^2'), symmetry=1, barrier=(1.75134,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62256,0.0581184,-5.74928e-05,5.14586e-08,-2.07662e-11,48463.8,29.7126], Tmin=(100,'K'), Tmax=(801.706,'K')), NASAPolynomial(coeffs=[0.541522,0.0516169,-2.30724e-05,4.32872e-09,-2.98223e-13,49019.4,37.0732], Tmin=(801.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]CCC[CH2](6190)',
    structure = SMILES('[CH2][CH]CCC[CH2]'),
    E0 = (413.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,264.772,863.73,2646.58],'cm^-1')),
        HinderedRotor(inertia=(0.0167546,'amu*angstrom^2'), symmetry=1, barrier=(0.748889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0167546,'amu*angstrom^2'), symmetry=1, barrier=(0.748889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0167546,'amu*angstrom^2'), symmetry=1, barrier=(0.748889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0167546,'amu*angstrom^2'), symmetry=1, barrier=(0.748889,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0167546,'amu*angstrom^2'), symmetry=1, barrier=(0.748889,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85286,0.0535221,-2.816e-05,7.26177e-09,-7.93667e-13,49751.8,28.0715], Tmin=(100,'K'), Tmax=(1785.63,'K')), NASAPolynomial(coeffs=[7.84494,0.0400992,-1.68843e-05,3.05197e-09,-2.04269e-13,47611.9,-4.31088], Tmin=(1785.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]CCC(6191)',
...
species(
    label = 'C[CH][CH]C[CH]C(162)',
    structure = SMILES('C[CH][CH]C[CH]C'),
    E0 = (391.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,535.999,2986.3,4000],'cm^-1')),
...
species(
    label = '[CH][CH]CC[CH]C(6198)',
    structure = SMILES('[CH][CH]CC[CH]C'),
    E0 = (645.243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,219.965,1116.12,1237.27,1417.8,1713.08,1977.7],'cm^-1')),
        HinderedRotor(inertia=(0.0853055,'amu*angstrom^2'), symmetry=1, barrier=(2.73792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853055,'amu*angstrom^2'), symmetry=1, barrier=(2.73792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853055,'amu*angstrom^2'), symmetry=1, barrier=(2.73792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853055,'amu*angstrom^2'), symmetry=1, barrier=(2.73792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0853055,'amu*angstrom^2'), symmetry=1, barrier=(2.73792,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49013,0.0600117,-6.14172e-05,5.03367e-08,-1.86561e-11,77690.6,29.5784], Tmin=(100,'K'), Tmax=(797.211,'K')), NASAPolynomial(coeffs=[2.79372,0.0457847,-2.01863e-05,3.76348e-09,-2.58511e-13,77727,25.1166], Tmin=(797.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(645.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CC[CH][CH]C(5245)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C=CC[CH]C(6188)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2][CH]CCC=C(6128)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C[CH]C[CH]C(6189)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][CH]C[CH][CH]C(6192)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH][CH]C[CH]C(6193)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][CH]CC[CH][CH2](6130)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C[CH2](103)', '[CH]C(32)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH]C(38)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH3](11)', '[CH]CC[CH][CH2](6152)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH2][CH]CC[C]C(6196)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH2][C]CC[CH]C(6197)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH][CH]CC[CH]C(6198)'],
    products = ['[CH2][CH]CC[CH]C(163)'],
