...
species(
    label = '[O]O[CH]OC=C=CO(28835)',
    structure = SMILES('[O]O[CH]OC=C=CO'),
    E0 = (4.34004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,540,610,2055,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.13654,'amu*angstrom^2'), symmetry=1, barrier=(26.1314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1366,'amu*angstrom^2'), symmetry=1, barrier=(26.1327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13574,'amu*angstrom^2'), symmetry=1, barrier=(26.1129,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84807,0.102729,-0.000129868,7.17208e-08,-1.4239e-11,754.887,31.7763], Tmin=(100,'K'), Tmax=(1468.12,'K')), NASAPolynomial(coeffs=[30.3051,-0.00841,7.73046e-06,-1.68136e-09,1.19682e-13,-6149.68,-127.052], Tmin=(1468.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.34004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[O]O[CH]OCC#CO(28836)',
    structure = SMILES('[O]O[CH]OCC#CO'),
    E0 = (118.731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3615,1277.5,1000,2100,2250,500,550,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.326671,0.0876476,-0.000141993,1.18805e-07,-3.83307e-11,14405.8,29.618], Tmin=(100,'K'), Tmax=(878.268,'K')), NASAPolynomial(coeffs=[11.2716,0.0243844,-1.10333e-05,2.00486e-09,-1.32713e-13,13000.7,-18.8185], Tmin=(878.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-CtH) + group(Cs-CtOsHH) + group(Cs-OsOsHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(OCJO) + radical(ROOJ)"""),
)
...
species(
    label = 'O=COC[C]=CO(28837)',
    structure = SMILES('O=COC[C]=CO'),
    E0 = (-269.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3615,1277.5,1000,3010,987.5,1337.5,450,1655,400.643,400.652,400.655],'cm^-1')),
        HinderedRotor(inertia=(0.17006,'amu*angstrom^2'), symmetry=1, barrier=(19.3723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170062,'amu*angstrom^2'), symmetry=1, barrier=(19.3722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170037,'amu*angstrom^2'), symmetry=1, barrier=(19.3721,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263806,'amu*angstrom^2'), symmetry=1, barrier=(30.0534,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11637,0.0531233,-2.88419e-05,-7.16669e-09,8.21963e-12,-32241.4,25.311], Tmin=(100,'K'), Tmax=(977.806,'K')), NASAPolynomial(coeffs=[16.2749,0.0143632,-5.04911e-06,9.29075e-10,-6.76441e-14,-36317.3,-53.1634], Tmin=(977.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-269.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(Cds_S)"""),
)
...
species(
    label = '[O]OCO[CH][C]=CO(28838)',
    structure = SMILES('[O]OCO[CH][C]=CO'),
    E0 = (45.2752,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06431,0.0886545,-9.95902e-05,5.13553e-08,-9.72015e-12,5647.2,35.1399], Tmin=(100,'K'), Tmax=(1508.19,'K')), NASAPolynomial(coeffs=[25.627,0.0020595,2.25344e-06,-6.10969e-10,4.56217e-14,-606.433,-98.639], Tmin=(1508.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.2752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CCJ(O)C) + radical(ROOJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4414.56,'J/mol'), sigma=(7.08431,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=689.54 K, Pc=28.17 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[O]OCOC[C]=[C]O(28839)',
    structure = SMILES('[O]OCOC[C]=[C]O'),
    E0 = (174.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,492.5,1135,1000,3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.62287,0.0877002,-0.000104409,5.80885e-08,-1.20279e-11,21115.5,35.7385], Tmin=(100,'K'), Tmax=(1329.43,'K')), NASAPolynomial(coeffs=[23.6566,0.00458564,7.22576e-07,-3.24947e-10,2.7413e-14,15549.1,-84.9654], Tmin=(1329.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO) + radical(ROOJ)"""),
)

species(
    label = 'OC=[C][CH]O[CH]OO(28840)',
    structure = SMILES('OC=[C][CH]O[CH]OO'),
    E0 = (82.2306,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.303746,0.0959376,-0.000131069,8.80394e-08,-2.2909e-11,10044,31.4421], Tmin=(100,'K'), Tmax=(949.149,'K')), NASAPolynomial(coeffs=[18.2084,0.0179213,-7.77466e-06,1.43886e-09,-9.88667e-14,6529.85,-56.9022], Tmin=(949.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.2306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CCJ(O)C) + radical(Cds_S) + radical(OCJO)"""),
)
...
species(
    label = 'O[C]=[C]CO[CH]OO(28841)',
    structure = SMILES('O[C]=[C]CO[CH]OO'),
    E0 = (211.036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3615,1277.5,1000,1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.384481,0.101051,-0.000156778,1.21563e-07,-3.65884e-11,25535.3,33.921], Tmin=(100,'K'), Tmax=(846.327,'K')), NASAPolynomial(coeffs=[16.1526,0.0203195,-9.13298e-06,1.66869e-09,-1.11524e-13,22828.2,-42.5576], Tmin=(846.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO) + radical(OCJO)"""),
)
...
species(
    label = '[O]O[CH]O[CH][C]=CO(28842)',
    structure = SMILES('[O]O[CH]O[CH][C]=CO'),
    E0 = (234.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.132644,0.093501,-0.000140107,1.03401e-07,-2.94509e-11,28318.4,31.5828], Tmin=(100,'K'), Tmax=(870.122,'K')), NASAPolynomial(coeffs=[16.6964,0.016127,-6.70486e-06,1.1793e-09,-7.71628e-14,25390.1,-47.2644], Tmin=(870.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CCJ(O)C) + radical(ROOJ) + radical(OCJO) + radical(Cds_S)"""),
)

species(
    label = '[O]O[CH]OC[C]=[C]O(28843)',
    structure = SMILES('[O]O[CH]OC[C]=[C]O'),
    E0 = (363.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3615,1277.5,1000,1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.156335,0.0979106,-0.000163186,1.33223e-07,-4.13939e-11,43807.2,33.859], Tmin=(100,'K'), Tmax=(901.31,'K')), NASAPolynomial(coeffs=[14.5743,0.0186385,-8.1286e-06,1.42456e-09,-9.10988e-14,41716.3,-32.5457], Tmin=(901.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[O]OCOC=C=CO(28844)',
    structure = SMILES('[O]OCOC=C=CO'),
    E0 = (-184.62,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.716439,0.0734377,-3.09399e-06,-9.37689e-08,5.47789e-11,-22006.2,27.9367], Tmin=(100,'K'), Tmax=(894.467,'K')), NASAPolynomial(coeffs=[39.2538,-0.0215748,1.58228e-05,-3.21206e-09,2.17715e-13,-32506.2,-179.163], Tmin=(894.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'OC=[C]COC1OO1(28845)',
    structure = SMILES('OC=[C]COC1OO1'),
    E0 = (-84.6866,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0875684,0.0734959,-7.6588e-05,3.93094e-08,-7.68434e-12,-10033.9,29.8892], Tmin=(100,'K'), Tmax=(1370.87,'K')), NASAPolynomial(coeffs=[19.2548,0.0118015,-2.77158e-06,3.42961e-10,-1.85365e-14,-14747.1,-66.6511], Tmin=(1370.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.6866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(Cs-OsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(dioxirane) + radical(Cds_S)"""),
)
...
species(
    label = '[O][CH]OC[C]=CO(28847)',
    structure = SMILES('[O][CH]OC[C]=CO'),
    E0 = (127.184,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67673,0.0790326,-0.000121444,1.01363e-07,-3.35359e-11,15410.7,26.6954], Tmin=(100,'K'), Tmax=(823.023,'K')), NASAPolynomial(coeffs=[9.903,0.0267987,-1.27709e-05,2.42108e-09,-1.66116e-13,14142.4,-14.4979], Tmin=(823.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCJO) + radical(Cds_S) + radical(OCOJ)"""),
)
...
species(
    label = '[O]O[C]OC[C]=CO(28848)',
    structure = SMILES('[O]O[C]OC[C]=CO'),
    E0 = (395.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.48506,0.0970508,-0.000120673,6.5878e-08,-1.30039e-11,47764.4,34.4376], Tmin=(100,'K'), Tmax=(1460.78,'K')), NASAPolynomial(coeffs=[29.123,-0.00664087,6.21466e-06,-1.34666e-09,9.53689e-14,40942.9,-117.569], Tmin=(1460.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(ROOJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]O[CH]OC=C=CO(28835)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]O[CH]OCC#CO(28836)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', 'O=COC[C]=CO(28837)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[O]O[CH]OC[C]=CO(15118)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(132.12,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', 'C#CCO[CH]O[O](18014)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['[O]O[CH]OC[C]=CO(15118)'],
    products = ['OC=[C][CH]O[CH]OO(28840)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C]=[C]CO[CH]OO(28841)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(8.44313e+09,'s^-1'), n=0.985167, Ea=(177.241,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleNd;XH_out] for rate rule [R7Hall;Cd_rad_out_singleNd;O_H_out]
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH]=[C]CO[CH]O[O](18021)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[O]O[CH]O[CH][C]=CO(28842)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[O]O[CH]OC[C]=[C]O(28843)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]O[O](2819)', '[O]C[C]=CO(27712)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', '[O][CH]OC[C]=CO(28847)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O2(2)', '[CH]OC[C]=CO(28066)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]O[CH]O[O](8127)', '[C]=CO(27807)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[O]O[C]OC[C]=CO(28848)'],
    products = ['[O]O[CH]OC[C]=CO(15118)'],
