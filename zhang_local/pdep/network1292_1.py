...
species(
    label = '[CH2]C[CH][C]=O(4296)',
    structure = SMILES('[CH2]C[CH][C]=O'),
    E0 = (305.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,613.732],'cm^-1')),
        HinderedRotor(inertia=(0.110256,'amu*angstrom^2'), symmetry=1, barrier=(2.535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103826,'amu*angstrom^2'), symmetry=1, barrier=(2.38716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00937681,'amu*angstrom^2'), symmetry=1, barrier=(2.459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2636,0.0363958,-2.85924e-05,1.26616e-08,-2.3543e-12,36823.1,20.2339], Tmin=(100,'K'), Tmax=(1257.08,'K')), NASAPolynomial(coeffs=[7.93573,0.0183472,-7.05604e-06,1.2402e-09,-8.28822e-14,35397.1,-8.42858], Tmin=(1257.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(RCCJ) + radical(CCJCHO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CC[C]=O(4213)'],
    products = ['[CH2]CC[C]=O(4190)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][CH]C[C]=O(4295)'],
    products = ['[CH2]CC[C]=O(4190)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C[CH][C]=O(4296)'],
    products = ['[CH2]CC[C]=O(4190)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH2](21)', '[C-]#[O+](374)'],
    products = ['[CH2]CC[C]=O(4190)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C]=O(1149)', '[CH2]C[CH2](21)'],
    products = ['[CH2]CC[C]=O(4190)'],
