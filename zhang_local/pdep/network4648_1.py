...
species(
    label = '[O][CH]CC1=CC1[O](24218)',
    structure = SMILES('[O][CH]CC1=CC1[O]'),
    E0 = (511.654,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36141,0.0626517,-7.14756e-05,4.63692e-08,-1.26124e-11,61628.8,25.2166], Tmin=(100,'K'), Tmax=(878.215,'K')), NASAPolynomial(coeffs=[8.74701,0.0290121,-1.40182e-05,2.75188e-09,-1.95816e-13,60331.6,-9.45553], Tmin=(878.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.40964,0.0419848,-1.90894e-05,2.7797e-09,-6.13327e-14,33974.4,19.3037], Tmin=(100,'K'), Tmax=(2595.08,'K')), NASAPolynomial(coeffs=[37.6474,0.00194621,-3.30737e-06,6.16348e-10,-3.50955e-14,11916.4,-186.785], Tmin=(2595.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)H) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C(C=C[O])=C[O](24220)',
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.59952,0.0518423,1.39654e-05,-8.01884e-08,4.17521e-11,8944.18,23.6222], Tmin=(100,'K'), Tmax=(911.985,'K')), NASAPolynomial(coeffs=[27.1894,-0.00401639,5.89493e-06,-1.22848e-09,7.91495e-14,1567.28,-116.063], Tmin=(911.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.1697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=COJ) + radical(Allyl_P)"""),
)

species(
    label = 'C=C([C]=O)C[CH][O](24221)',
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02795,0.0760692,-0.000130685,1.27786e-07,-4.85089e-11,31662.3,27.0405], Tmin=(100,'K'), Tmax=(814.988,'K')), NASAPolynomial(coeffs=[4.20425,0.0382702,-2.02382e-05,4.0015e-09,-2.8065e-13,31882.1,16.8916], Tmin=(814.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(CCsJOH) + radical(CCOJ) + radical(C=C(C)CJ=O)"""),
)
...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3156,0.0676959,-9.78339e-05,9.31768e-08,-3.55212e-11,36704.3,26.1751], Tmin=(100,'K'), Tmax=(826.109,'K')), NASAPolynomial(coeffs=[2.32094,0.0441762,-2.12615e-05,4.05273e-09,-2.79376e-13,37174.6,25.3691], Tmin=(826.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(C=C[O])=C[O](24223)',
    structure = SMILES('[CH]C(C=C[O])=C[O]'),
    E0 = (292.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.00065,'amu*angstrom^2'), symmetry=1, barrier=(45.9988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.99433,'amu*angstrom^2'), symmetry=1, barrier=(45.8535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.609154,0.0541522,6.15968e-06,-6.78263e-08,3.61503e-11,35303.3,24.4158], Tmin=(100,'K'), Tmax=(913.057,'K')), NASAPolynomial(coeffs=[24.7743,0.00223866,2.81219e-06,-6.67092e-10,4.24017e-14,28641.6,-102.284], Tmin=(913.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet) + radical(C=COJ) + radical(C=COJ)"""),
)
...
species(
    label = '[CH]C(=C=O)C[CH][O](24224)',
    structure = SMILES('[CH]C(=C=O)C[CH][O]'),
    E0 = (484.741,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,350,440,435,1725,3025,407.5,1350,352.5,576.749,577.255,577.279,577.574,577.66,578.28],'cm^-1')),
        HinderedRotor(inertia=(0.230876,'amu*angstrom^2'), symmetry=1, barrier=(54.7429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231201,'amu*angstrom^2'), symmetry=1, barrier=(54.7387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23133,'amu*angstrom^2'), symmetry=1, barrier=(54.7365,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05339,0.0763382,-0.000128589,1.24608e-07,-4.6157e-11,58395.8,26.6657], Tmin=(100,'K'), Tmax=(855.237,'K')), NASAPolynomial(coeffs=[2.95857,0.040944,-2.00614e-05,3.80116e-09,-2.59046e-13,59038.5,23.4347], Tmin=(855.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(CCOJ) + radical(CCsJOH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[O][CH]CC1[CH]OC=1(24225)',
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00465259,0.0710146,-7.27882e-05,3.53801e-08,-6.45099e-12,46249.2,25.961], Tmin=(100,'K'), Tmax=(1512.28,'K')), NASAPolynomial(coeffs=[20.8797,0.007306,-1.17203e-06,9.52589e-11,-3.97272e-15,40906.7,-80.1722], Tmin=(1512.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.222,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CCsJOC(O)) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07956,0.0514682,-3.99246e-05,1.52113e-08,-2.51777e-12,-10982.3,19.2571], Tmin=(100,'K'), Tmax=(1287.66,'K')), NASAPolynomial(coeffs=[8.28711,0.0321849,-1.74613e-05,3.58122e-09,-2.59769e-13,-12580.9,-12.2601], Tmin=(1287.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.8187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)H) + radical(C=C(C=O)CJ)"""),
)

species(
    label = '[CH][C](C=C[O])C[O](24227)',
    structure = SMILES('[CH][C](C=C[O])C[O]'),
    E0 = (551.063,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10329,0.0561034,-4.38879e-05,1.487e-08,-1.2339e-12,66388.3,28.5099], Tmin=(100,'K'), Tmax=(1102.38,'K')), NASAPolynomial(coeffs=[14.1175,0.0191635,-7.61527e-06,1.39516e-09,-9.68791e-14,62894.2,-38.3785], Tmin=(1102.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCOJ) + radical(CCJ(C)CO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH]O)=C[CH][O](24228)',
    structure = SMILES('[CH]C([CH]O)=C[CH][O]'),
    E0 = (455.751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26987,0.0506508,-1.94487e-05,-8.45042e-09,5.96933e-12,54920.5,30.2056], Tmin=(100,'K'), Tmax=(1072.57,'K')), NASAPolynomial(coeffs=[12.5566,0.0266273,-1.11209e-05,2.07971e-09,-1.45986e-13,51460,-29.8821], Tmin=(1072.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(C=CCJO) + radical(C=CCJO) + radical(CCOJ)"""),
)
...
species(
    label = '[C]=C(C=O)C[CH][O](24230)',
    structure = SMILES('[C]=C(C=O)C[CH][O]'),
    E0 = (656.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,350,440,435,1725,3025,407.5,1350,352.5,180,180,1278.41],'cm^-1')),
        HinderedRotor(inertia=(0.21949,'amu*angstrom^2'), symmetry=1, barrier=(5.04651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224465,'amu*angstrom^2'), symmetry=1, barrier=(5.16088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21742,'amu*angstrom^2'), symmetry=1, barrier=(4.99892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.021,0.0795695,-0.000152497,1.54994e-07,-5.91536e-11,79106.5,26.8814], Tmin=(100,'K'), Tmax=(835.666,'K')), NASAPolynomial(coeffs=[2.92528,0.038382,-2.09974e-05,4.16121e-09,-2.90429e-13,79908.1,24.7367], Tmin=(835.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(656.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(413769,'s^-1'), n=1.87624, Ea=(118.182,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_cs]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH]C(C=O)=CC=O(23702)'],
...
reaction(
    ...
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.123469,'m^3/(mol*s)'), n=2.00579, Ea=(101.25,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 98.9 to 101.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=O(373)', 'C#CC[CH][O](5304)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C=O)C[CH][O](22357)'],
    products = ['[CH2]C(C=C[O])=C[O](24220)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C=O)C[CH][O](22357)'],
    products = ['[CH]C(=C=O)C[CH]O(23497)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C(C=C[O])=C[O](24223)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=O(373)', '[CH]=[C]C[CH][O](5311)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C(=C=O)C[CH][O](24224)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(C=O)C[CH][O](22357)'],
    products = ['[O][CH]CC1[CH]OC=1(24225)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.39512e+11,'s^-1'), n=0.277081, Ea=(132.598,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R6plus;carbonyl_intra_H;radadd_intra] + [R6_linear;multiplebond_intra;radadd_intra] for rate rule [R6_linear;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic
Ea raised from 126.9 to 132.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction22',
    reactants = ['[CH]=C(C=O)C[CH][O](22357)'],
    products = ['[CH2]C(C=O)=CC=O(24226)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH][C](C=C[O])C[O](24227)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C([CH]O)=C[CH][O](24228)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C-]#[O+](374)', '[CH]=CC[CH][O](5158)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH][O](751)', '[CH]C(=C)C=O(18781)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]=C(C=O)C[C][O](24229)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[C]=C(C=O)C[CH][O](24230)'],
    products = ['[CH]=C(C=O)C[CH][O](22357)'],
