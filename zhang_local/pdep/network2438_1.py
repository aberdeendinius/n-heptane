...
species(
    label = '[CH2]C([O])C=C1CO1(10998)',
    structure = SMILES('[CH2]C([O])C=C1CO1'),
    E0 = (234.757,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,180,180,180,180,924.632,1287.14,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.194977,'amu*angstrom^2'), symmetry=1, barrier=(4.48289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194977,'amu*angstrom^2'), symmetry=1, barrier=(4.48289,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([O])CC1=CO1(10999)',
    structure = SMILES('[CH2]C([O])CC1=CO1'),
    E0 = (336.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,1000,180,180,180,444.69,684.835,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.155413,'amu*angstrom^2'), symmetry=1, barrier=(3.57325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155413,'amu*angstrom^2'), symmetry=1, barrier=(3.57325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155413,'amu*angstrom^2'), symmetry=1, barrier=(3.57325,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650832,0.0640754,-4.84623e-05,8.57381e-09,3.60268e-12,40658.2,26.952], Tmin=(100,'K'), Tmax=(975.761,'K')), NASAPolynomial(coeffs=[17.7508,0.014908,-5.05624e-06,9.01892e-10,-6.42939e-14,36324.7,-60.2319], Tmin=(975.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CJCO) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C([O])[CH]C1CO1(11000)',
    structure = SMILES('[CH2]C([O])[CH]C1CO1'),
    E0 = (318.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,180,924.474,924.474,924.474,924.474,924.474,924.474,924.474,924.474,924.474,2367.45],'cm^-1')),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0801905,0.0690476,-6.49971e-05,3.22615e-08,-6.05331e-12,38449.4,30.6119], Tmin=(100,'K'), Tmax=(1539.15,'K')), NASAPolynomial(coeffs=[15.2763,0.0173469,-2.71343e-06,1.3047e-10,2.71973e-15,35217.7,-44.556], Tmin=(1539.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)C[C]1CO1(9876)',
    structure = SMILES('[CH2][C](O)C[C]1CO1'),
    E0 = (244.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344692,0.0839457,-0.000119474,9.12241e-08,-2.64565e-11,29578.3,27.8932], Tmin=(100,'K'), Tmax=(1006.79,'K')), NASAPolynomial(coeffs=[10.98,0.0253132,-7.71665e-06,1.06338e-09,-5.60651e-14,28266.9,-19.3654], Tmin=(1006.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(C2CsJO) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][C]([O])CC1CO1(10067)',
    structure = SMILES('[CH2][C]([O])CC1CO1'),
    E0 = (295.116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,360,370,350,180,996.089,996.089,996.089,996.089,996.089,996.089,996.089,996.089,996.089,2332.59],'cm^-1')),
        HinderedRotor(inertia=(0.0554037,'amu*angstrom^2'), symmetry=1, barrier=(1.27384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0554037,'amu*angstrom^2'), symmetry=1, barrier=(1.27384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0554037,'amu*angstrom^2'), symmetry=1, barrier=(1.27384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333055,0.0760234,-8.67942e-05,5.36158e-08,-1.27819e-11,35630.3,26.6244], Tmin=(100,'K'), Tmax=(1157.09,'K')), NASAPolynomial(coeffs=[13.8527,0.0212141,-5.27672e-06,6.19331e-10,-2.87432e-14,33042.1,-38.2374], Tmin=(1157.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)[CH][C]1CO1(9877)',
    structure = SMILES('[CH2]C(O)[CH][C]1CO1'),
    E0 = (268.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508907,0.0722566,-8.20985e-05,5.08748e-08,-1.21281e-11,32378.8,30.3701], Tmin=(100,'K'), Tmax=(1173.29,'K')), NASAPolynomial(coeffs=[12.9997,0.0207652,-4.88121e-06,5.29071e-10,-2.19207e-14,30060.8,-29.274], Tmin=(1173.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CJCO) + radical(C2CsJO)"""),
)
...
species(
    label = '[CH2]C(O)C[C]1[CH]O1(9878)',
    structure = SMILES('[CH2]C(O)C[C]1[CH]O1'),
    E0 = (251.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.139985,0.0807292,-9.89522e-05,6.34996e-08,-1.54962e-11,30445.8,29.4], Tmin=(100,'K'), Tmax=(1148.12,'K')), NASAPolynomial(coeffs=[14.9852,0.0185008,-3.92263e-06,3.47838e-10,-9.17526e-15,27729.6,-41.2537], Tmin=(1148.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCsJO) + radical(C2CsJO)"""),
)
...
species(
    label = '[CH2]C([O])C[C]1[CH]O1(11002)',
    structure = SMILES('[CH2]C([O])C[C]1[CH]O1'),
    E0 = (482.316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.288681,0.0769027,-9.36359e-05,5.92365e-08,-1.42229e-11,58146.9,28.6743], Tmin=(100,'K'), Tmax=(1166.56,'K')), NASAPolynomial(coeffs=[14.9189,0.0167059,-3.33424e-06,2.59524e-10,-4.10827e-15,55416.1,-41.2366], Tmin=(1166.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCsJO) + radical(C2CsJO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])CC(=C)[O](10041)',
    structure = SMILES('[CH2]C([O])CC(=C)[O]'),
    E0 = (152.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,536.078,536.086,536.11,4000],'cm^-1')),
        HinderedRotor(inertia=(0.407057,'amu*angstrom^2'), symmetry=1, barrier=(16.7729,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729514,'amu*angstrom^2'), symmetry=1, barrier=(16.773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.082249,'amu*angstrom^2'), symmetry=1, barrier=(16.7731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432666,0.0711647,-7.04359e-05,3.57657e-08,-7.13165e-12,18466.9,29.4858], Tmin=(100,'K'), Tmax=(1226.65,'K')), NASAPolynomial(coeffs=[16.4076,0.0190722,-6.73514e-06,1.14535e-09,-7.58009e-14,14547.8,-50.8473], Tmin=(1226.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = 'C=C(O)C[C]1CO1(9870)',
    structure = SMILES('C=C(O)C[C]1CO1'),
    E0 = (-57.6626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.081361,0.072478,-7.31591e-05,3.81678e-08,-7.42505e-12,-6773.4,27.5346], Tmin=(100,'K'), Tmax=(1502.5,'K')), NASAPolynomial(coeffs=[16.0831,0.0149341,-1.2246e-06,-1.77461e-10,2.46797e-14,-9992.91,-51.5799], Tmin=(1502.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.6626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)
...
species(
    label = '[CH2]C(O)C=C1CO1(9871)',
    structure = SMILES('[CH2]C(O)C=C1CO1'),
    E0 = (4.39625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,180,180,180,325.363,810.043,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.173643,'amu*angstrom^2'), symmetry=1, barrier=(3.9924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173643,'amu*angstrom^2'), symmetry=1, barrier=(3.9924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173643,'amu*angstrom^2'), symmetry=1, barrier=(3.9924,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.807138,0.0536233,-4.32305e-06,-4.57995e-08,2.50915e-11,658.968,25.5513], Tmin=(100,'K'), Tmax=(935.959,'K')), NASAPolynomial(coeffs=[20.8808,0.00987203,-1.5762e-06,2.30747e-10,-2.10006e-14,-4939.94,-79.8003], Tmin=(935.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.39625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.488915,0.0680597,-5.43394e-05,1.35769e-08,2.00865e-12,12957.6,27.7249], Tmin=(100,'K'), Tmax=(975.422,'K')), NASAPolynomial(coeffs=[17.814,0.0167034,-5.64319e-06,9.89577e-10,-6.92916e-14,8641.1,-60.2287], Tmin=(975.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CJCO)"""),
)
...
species(
    label = 'C1O[C]1CC1CO1(9246)',
    structure = SMILES('C1O[C]1CC1CO1'),
    E0 = (46.207,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.304124,0.0651022,-6.18886e-05,3.3673e-08,-6.80663e-12,5704.45,25.0045], Tmin=(100,'K'), Tmax=(1516.53,'K')), NASAPolynomial(coeffs=[9.974,0.0221072,-2.06321e-06,-2.30877e-10,3.60373e-14,4782.73,-19.0429], Tmin=(1516.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)
...
species(
    label = '[CH]C([O])C[C]1CO1(11003)',
    structure = SMILES('[CH]C([O])C[C]1CO1'),
    E0 = (535.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645676,0.0704977,-8.14517e-05,5.15118e-08,-1.26127e-11,64495.6,27.5636], Tmin=(100,'K'), Tmax=(1129.21,'K')), NASAPolynomial(coeffs=[12.4782,0.0209495,-5.49311e-06,6.80219e-10,-3.33997e-14,62310.1,-28.8043], Tmin=(1129.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(C2CsJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])C=C1CO1(10998)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C([O])C[C]1CO1(9301)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C([O])CC1=CO1(10999)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', 'O=CC[C]1CO1(9312)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(T)(63)', 'C=CC[C]1CO1(9228)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([O])[CH]C1CO1(11000)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([O])C[C]1CO1(9234)'],
    products = ['[CH2][C](O)C[C]1CO1(9876)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])CC1[CH]O1(11001)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]([O])CC1CO1(10067)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([O])C[C]1CO1(9234)'],
    products = ['[CH2]C(O)[CH][C]1CO1(9877)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])C[C]1CO1(9234)'],
    products = ['[CH2]C(O)C[C]1[CH]O1(9878)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])C[C]1CO1(9234)'],
    products = ['CC([O])C[C]1[CH]O1(9654)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C([O])[CH][C]1CO1(9850)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C]([O])C[C]1CO1(10804)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C([O])C[C]1[CH]O1(11002)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([O])CC(=C)[O](10041)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[C]1CO1(1125)', '[CH2]C([CH2])[O](740)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[CH]C([O])C[C]1CO1(11003)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
