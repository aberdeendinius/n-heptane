...
species(
    label = '[CH2]CCO[C]([CH2])[O](2375)',
    structure = SMILES('[CH2]CCO[C]([CH2])[O]'),
    E0 = (350.403,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694062,0.0811708,-0.000119222,1.08173e-07,-3.97704e-11,42254.6,32.2228], Tmin=(100,'K'), Tmax=(801.896,'K')), NASAPolynomial(coeffs=[5.37942,0.0432819,-2.11927e-05,4.09903e-09,-2.85605e-13,41969.9,13.5634], Tmin=(801.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(Cs_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([O])O[CH][CH]C(2376)',
    structure = SMILES('[CH2]C([O])O[CH][CH]C'),
    E0 = (320.268,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.620546,0.0800334,-0.000102614,7.79108e-08,-2.46778e-11,38635.8,31.967], Tmin=(100,'K'), Tmax=(762.835,'K')), NASAPolynomial(coeffs=[8.89612,0.0366368,-1.72754e-05,3.32591e-09,-2.32893e-13,37373.3,-5.71699], Tmin=(762.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][C](O)O[CH][CH]C(2377)',
    structure = SMILES('[CH2][C](O)O[CH][CH]C'),
    E0 = (299.809,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.33109,0.0831173,-9.94472e-05,6.33046e-08,-1.61467e-11,36188.8,32.8317], Tmin=(100,'K'), Tmax=(954.29,'K')), NASAPolynomial(coeffs=[13.5911,0.0275371,-1.20841e-05,2.27316e-09,-1.5811e-13,33658,-30.5198], Tmin=(954.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(Cs_P) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'C[CH][CH]O[C](C)[O](2378)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.836768,0.075244,-9.20689e-05,6.93021e-08,-2.22116e-11,37865.2,31.2464], Tmin=(100,'K'), Tmax=(748.698,'K')), NASAPolynomial(coeffs=[7.74087,0.0383615,-1.81825e-05,3.51728e-09,-2.4729e-13,36831.3,-0.0643613], Tmin=(748.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.545415,0.0822366,-0.00011894,9.89498e-08,-3.34452e-11,63323.2,32.9153], Tmin=(100,'K'), Tmax=(788.525,'K')), NASAPolynomial(coeffs=[8.99822,0.0337853,-1.61715e-05,3.10153e-09,-2.15341e-13,62163.4,-4.75781], Tmin=(788.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(525.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO) + radical(Cs_P) + radical(CCOJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.588795,0.0836709,-0.000128854,1.16187e-07,-4.1857e-11,71480.6,30.7197], Tmin=(100,'K'), Tmax=(810.784,'K')), NASAPolynomial(coeffs=[6.58285,0.0393226,-1.94694e-05,3.76658e-09,-2.61867e-13,70994.3,6.05431], Tmin=(810.784,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(593.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Cs_P) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])OC[CH]C(2387)',
    structure = SMILES('[CH][C]([O])OC[CH]C'),
    E0 = (581.685,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.985199,0.0726541,-9.82376e-05,8.46208e-08,-3.06861e-11,70063,32.2606], Tmin=(100,'K'), Tmax=(758.678,'K')), NASAPolynomial(coeffs=[6.06422,0.0392851,-1.92323e-05,3.74673e-09,-2.63334e-13,69482,10.41], Tmin=(758.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCJ2_triplet) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=O)O[CH][CH]C(2373)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2][C]([O])OCC=C(2374)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(106.867,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 103.4 to 106.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CCO[C]([CH2])[O](2375)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([O])OC[CH]C(1517)'],
    products = ['[CH2]C([O])O[CH][CH]C(2376)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([O])OC[CH]C(1517)'],
    products = ['[CH2][C](O)O[CH][CH]C(2377)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([O])OC[CH]C(1517)'],
    products = ['[CH2][CH]COC([CH2])[O](2379)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])OC[CH]C(1517)'],
    products = ['[CH2][CH]CO[C]([CH2])O(2380)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([O])O[CH][CH]C(2382)', 'H(8)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CO[C]([CH2])[O](2383)', 'H(8)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C][O](2305)', 'C[CH]C[O](425)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[C]([CH2])[O](1016)', '[CH]C(32)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CO[C]([CH2])[O](2306)', '[CH3](11)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2][C]([O])OC[C]C(2386)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH][C]([O])OC[CH]C(2387)'],
    products = ['[CH2][C]([O])OC[CH]C(1517)'],
