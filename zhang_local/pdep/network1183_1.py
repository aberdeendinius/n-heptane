...
species(
    ...
    E0 = (-105.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (-17.6388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,368.211,368.769,370.024],'cm^-1')),
        HinderedRotor(inertia=(0.00123866,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122614,'amu*angstrom^2'), symmetry=1, barrier=(11.7915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122208,'amu*angstrom^2'), symmetry=1, barrier=(11.7728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1202,'amu*angstrom^2'), symmetry=1, barrier=(11.7726,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    E0 = (-18.4372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,318.575,318.576,318.577],'cm^-1')),
        HinderedRotor(inertia=(0.00166104,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147435,'amu*angstrom^2'), symmetry=1, barrier=(10.6184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147437,'amu*angstrom^2'), symmetry=1, barrier=(10.6184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147439,'amu*angstrom^2'), symmetry=1, barrier=(10.6184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    E0 = (237.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (260.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,263.163,878.47,1253.51,1934.8],'cm^-1')),
...
species(
    ...
    E0 = (254.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,207.461,648.226,1080.49,3237.36],'cm^-1')),
        HinderedRotor(inertia=(0.0490359,'amu*angstrom^2'), symmetry=1, barrier=(1.43107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0490359,'amu*angstrom^2'), symmetry=1, barrier=(1.43107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0490359,'amu*angstrom^2'), symmetry=1, barrier=(1.43107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0490359,'amu*angstrom^2'), symmetry=1, barrier=(1.43107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0490359,'amu*angstrom^2'), symmetry=1, barrier=(1.43107,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (265.731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,214.835,813.537,1216.44,1680.37],'cm^-1')),
...
species(
    label = 'CC[C]CC(C)[O](3769)',
    structure = SMILES('CC[C]CC(C)[O]'),
    E0 = (314.241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374917,0.0749182,-5.66072e-05,2.25343e-08,-3.70193e-12,37928.7,29.1776], Tmin=(100,'K'), Tmax=(1413.35,'K')), NASAPolynomial(coeffs=[14.44,0.0351121,-1.43608e-05,2.60708e-09,-1.77111e-13,33952.9,-43.5442], Tmin=(1413.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CC[CH]CC(C)=O(967)', 'H(8)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH]CC=O(535)', '[CH3](11)'],
    products = ['CC[CH]CC(C)[O](3582)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CCC(C)[O](840)', '[CH3](11)'],
    products = ['CC[CH]CC(C)[O](3582)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]C[CH][O](545)', '[CH3](11)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH]C[C](C)[O](953)', 'H(8)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'CC[CH][CH]C(C)[O](957)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]CC(C)[O](830)', '[CH3](11)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[CH][CH]CC(C)[O](959)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH2]C[CH]CC(C)[O](961)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(14)', 'CC[CH]CC[O](397)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(S)(14)', 'C[CH]CC(C)[O](3576)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O(T)(63)', 'C[CH]C[CH]CC(80)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C)[O](442)', '[CH]CC(45)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C[CH2](6)', '[CH]CC(C)[O](3675)'],
    products = ['CC[CH]CC(C)[O](3582)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CC[C]CC(C)[O](3769)', 'H(8)'],
    products = ['CC[CH]CC(C)[O](3582)'],
