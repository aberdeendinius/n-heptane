...
species(
    label = 'C#COC(C)[O](4603)',
    structure = SMILES('C#COC(C)[O]'),
    E0 = (49.2936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,750,770,3400,2100,1380,1390,370,380,2900,435,2175,525,288.313,288.49,288.689],'cm^-1')),
        HinderedRotor(inertia=(0.404333,'amu*angstrom^2'), symmetry=1, barrier=(23.8555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404769,'amu*angstrom^2'), symmetry=1, barrier=(23.8569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.404394,'amu*angstrom^2'), symmetry=1, barrier=(23.8471,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
...
species(
    ...
    E0 = (127.226,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,404.384,404.392,404.394,404.399],'cm^-1')),
        HinderedRotor(inertia=(0.214782,'amu*angstrom^2'), symmetry=1, barrier=(24.9161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214776,'amu*angstrom^2'), symmetry=1, barrier=(24.9159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13391,0.0277148,1.64977e-05,-5.0006e-08,2.34457e-11,15381.2,19.0661], Tmin=(100,'K'), Tmax=(940.014,'K')), NASAPolynomial(coeffs=[15.4945,0.00455786,-3.18984e-07,5.38188e-11,-9.55342e-15,11380.7,-52.4829], Tmin=(940.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(C=CJO)"""),
)

species(
    label = 'C=C1OC(C)O1(4595)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OC(C)=O(4232)'],
    products = ['C=[C]OC(C)[O](4280)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', 'C=[C]OC=O(4555)'],
    products = ['C=[C]OC(C)[O](4280)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH2][C]OC=O(4560)'],
    products = ['C=[C]OC(C)[O](4280)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C]OC(C)=O(4608)'],
    products = ['C=[C]OC(C)[O](4280)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=[C]OC(C)[O](4609)'],
    products = ['C=[C]OC(C)[O](4280)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(14)', 'C=[C]OC[O](4207)'],
    products = ['C=[C]OC(C)[O](4280)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', 'C=[C]O[CH]C(4300)'],
    products = ['C=[C]OC(C)[O](4280)'],
