species(
    label = 'C=[C]CC[CH]CC(17450)',
    structure = SMILES('C=[C]CC[CH]CC'),
    E0 = (344.438,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760936,0.0694909,-4.43624e-05,1.45969e-08,-2.01519e-12,42841.1,30.6926], Tmin=(100,'K'), Tmax=(1599.67,'K')), NASAPolynomial(coeffs=[12.636,0.0397973,-1.65189e-05,2.99301e-09,-2.01712e-13,39041.9,-32.1764], Tmin=(1599.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=[C]CCCCC(17636)',
    structure = SMILES('[CH]=[C]CCCCC'),
    E0 = (397.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=[C]CC[CH]C(17448)',
    structure = SMILES('C=[C]CC[CH]C'),
    E0 = (368.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,283.544,283.555,1802.79],'cm^-1')),
        HinderedRotor(inertia=(0.00209677,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00209666,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129414,'amu*angstrom^2'), symmetry=1, barrier=(7.38401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129417,'amu*angstrom^2'), symmetry=1, barrier=(7.38391,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]CC[C]CC(17647)',
    structure = SMILES('C=[C]CC[C]CC'),
    E0 = (598.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.72004,0.0712451,-5.15843e-05,1.99834e-08,-3.27366e-12,72064.6,28.9596], Tmin=(100,'K'), Tmax=(1382.29,'K')), NASAPolynomial(coeffs=[11.9136,0.0388538,-1.6435e-05,3.03135e-09,-2.07737e-13,68970,-28.667], Tmin=(1382.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(598.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]CC=CCC(17629)'],
    products = ['C=[C]CC[CH]CC(17450)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=[C]CCC=CC(17630)'],
    products = ['C=[C]CC[CH]CC(17450)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=C=CC[CH]CC(17631)'],
    products = ['C=[C]CC[CH]CC(17450)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CCC[CH]CC(17632)'],
    products = ['C=[C]CC[CH]CC(17450)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH3](11)', 'C=[C]CCC=C(17493)'],
    products = ['C=[C]CC[CH]CC(17450)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', 'C=[C]C[CH][CH]CC(17638)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH3](11)', '[CH2][CH]CC[C]=C(17495)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'C=[C]CC[CH][CH]C(17639)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2][C]=CC[CH]CC(17640)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]C[CH]CC[C]=C(17641)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]=[C]CC[CH]CC(17642)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', 'C=[C]CC[CH]C(17448)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C)CC[C]=C(17646)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CC(45)', '[CH2]C[C]=C(4316)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH2](6)', '[CH]CC[C]=C(17535)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[C]=C(584)', '[CH2]C[CH]CC(23)'],
    products = ['C=[C]CC[CH]CC(17450)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', 'C=[C]CC[C]CC(17647)'],
    products = ['C=[C]CC[CH]CC(17450)'],
