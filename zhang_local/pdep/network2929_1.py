...
species(
    label = '[CH2]OC(=C)C[C]([CH2])[O](11392)',
    structure = SMILES('[CH2]OC(=C)C[C]([CH2])[O]'),
    E0 = (401.938,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.18269,0.0898892,-9.8611e-05,5.5576e-08,-1.23881e-11,48494.5,33.7401], Tmin=(100,'K'), Tmax=(1093.96,'K')), NASAPolynomial(coeffs=[17.3638,0.0257306,-1.06374e-05,1.96337e-09,-1.359e-13,44655.5,-52.4869], Tmin=(1093.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(C=COCJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C1([CH]C(=C)[O])CO1(11394)',
    structure = SMILES('[CH2]C1([CH]C(=C)[O])CO1'),
    E0 = (185.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2750,3150,900,1100,350,440,435,1725,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05678,0.0973547,-0.000114175,6.63495e-08,-1.43381e-11,22528.7,28.3762], Tmin=(100,'K'), Tmax=(1323.41,'K')), NASAPolynomial(coeffs=[21.3214,0.0132939,-2.83372e-07,-4.00298e-10,4.26712e-14,18043.8,-80.4226], Tmin=(1323.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(C=C(C)OJ) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C([O])[CH]C1([CH2])CO1(11395)',
    structure = SMILES('[CH2]C([O])[CH]C1([CH2])CO1'),
    E0 = (487.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,2750,3150,900,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.258732,0.0902678,-8.86545e-05,3.05795e-08,3.31639e-12,58746.1,31.6129], Tmin=(100,'K'), Tmax=(797.415,'K')), NASAPolynomial(coeffs=[19.1651,0.0188737,-3.33956e-06,2.0464e-10,4.73729e-16,54820.4,-62.8897], Tmin=(797.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(487.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCJCO) + radical(CJC(C)OC) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])[CH]C1(C)CO1(11396)',
    structure = SMILES('[CH2][C]([O])[CH]C1(C)CO1'),
    E0 = (453.254,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0497151,0.0861307,-8.19987e-05,2.81317e-08,2.86642e-12,54663,30.5334], Tmin=(100,'K'), Tmax=(797.877,'K')), NASAPolynomial(coeffs=[17.4894,0.0216511,-4.86206e-06,5.14784e-10,-2.18147e-14,51117.8,-54.7996], Tmin=(797.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.254,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])CC1(C)[CH]O1(11397)',
    structure = SMILES('[CH2][C]([O])CC1(C)[CH]O1'),
    E0 = (437.075,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.423494,0.0946337,-9.88061e-05,4.04149e-08,-1.95405e-13,52730.2,29.5822], Tmin=(100,'K'), Tmax=(795.331,'K')), NASAPolynomial(coeffs=[19.5217,0.0193058,-3.85653e-06,3.22423e-10,-8.14492e-15,48767.4,-67.0422], Tmin=(795.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](O)[CH]C1([CH2])CO1(11398)',
    structure = SMILES('[CH2][C](O)[CH]C1([CH2])CO1'),
    E0 = (433.404,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.906773,0.107367,-0.000149409,1.05289e-07,-2.79504e-11,52303.6,33.5263], Tmin=(100,'K'), Tmax=(1067.93,'K')), NASAPolynomial(coeffs=[17.8163,0.0207383,-4.55674e-06,3.95306e-10,-8.1835e-15,49245.5,-53.627], Tmin=(1067.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CJC(C)OC) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C1([CH][C](C)[O])CO1(11399)',
    structure = SMILES('[CH2]C1([CH][C](C)[O])CO1'),
    E0 = (452.175,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.625927,0.098587,-0.000125156,8.28889e-08,-2.09386e-11,54553.5,31.6925], Tmin=(100,'K'), Tmax=(1100.24,'K')), NASAPolynomial(coeffs=[17.0498,0.0225342,-5.39453e-06,5.81632e-10,-2.31723e-14,51377.7,-52.0279], Tmin=(1100.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCJCO) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])CC1([CH2])[CH]O1(11400)',
    structure = SMILES('[CH2]C([O])CC1([CH2])[CH]O1'),
    E0 = (470.957,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.632945,0.0987766,-0.000105486,4.28993e-08,2.35737e-13,56813.3,30.6632], Tmin=(100,'K'), Tmax=(795.199,'K')), NASAPolynomial(coeffs=[21.1982,0.016527,-2.3332e-06,1.20745e-11,1.4161e-14,52469.8,-75.1364], Tmin=(795.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJCO) + radical(CC(C)OJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](O)CC1([CH2])[CH]O1(11401)',
    structure = SMILES('[CH2][C](O)CC1([CH2])[CH]O1'),
    E0 = (417.224,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28935,0.115999,-0.000166814,1.18615e-07,-3.16112e-11,50371.3,32.6053], Tmin=(100,'K'), Tmax=(1063.21,'K')), NASAPolynomial(coeffs=[19.8176,0.0184442,-3.58003e-06,2.09629e-10,4.93963e-15,46908.7,-65.694], Tmin=(1063.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(C2CsJOH) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)C[C](C)[O](11402)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00433,0.10717,-0.000142389,9.59942e-08,-2.4506e-11,52620.9,30.7565], Tmin=(100,'K'), Tmax=(1090.51,'K')), NASAPolynomial(coeffs=[19.0413,0.020257,-4.42765e-06,3.98289e-10,-1.02434e-14,49044.8,-64.0399], Tmin=(1090.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH2][C]([O])[CH]C1([CH2])CO1(11403)',
    structure = SMILES('[CH2][C]([O])[CH]C1([CH2])CO1'),
    E0 = (663.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.748842,0.103431,-0.000143713,1.00534e-07,-2.64691e-11,80004.4,32.7676], Tmin=(100,'K'), Tmax=(1074.53,'K')), NASAPolynomial(coeffs=[17.7515,0.0189444,-3.97014e-06,3.07624e-10,-3.18118e-15,76930.2,-53.6204], Tmin=(1074.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(663.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(C2CsJOH) + radical(CCJCO) + radical(CC(C)OJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([O])CC1([CH2])[CH]O1(11404)',
    structure = SMILES('[CH2][C]([O])CC1([CH2])[CH]O1'),
    E0 = (647.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,2950,1000,360,370,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13087,0.112057,-0.000161094,1.1383e-07,-3.01165e-11,78072,31.8445], Tmin=(100,'K'), Tmax=(1068.94,'K')), NASAPolynomial(coeffs=[19.7523,0.0166513,-2.99412e-06,1.22117e-10,9.92747e-15,74593.5,-65.6841], Tmin=(1068.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(647.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CJCO) + radical(CCsJO) + radical(CJC(C)OC) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C=C([O])[CH]C1(C)CO1(11405)',
    structure = SMILES('C=C([O])[CH]C1(C)CO1'),
    E0 = (-24.8097,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.229,0.0905086,-9.02303e-05,4.54698e-08,-8.52758e-12,-2774.6,29.2596], Tmin=(100,'K'), Tmax=(1554.04,'K')), NASAPolynomial(coeffs=[20.5338,0.0163893,-1.21458e-06,-2.13083e-10,2.73947e-14,-7352.66,-78.2944], Tmin=(1554.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.8097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2][C]([O])C[C]1CCO1(11406)',
    structure = SMILES('[CH2][C]([O])C[C]1CCO1'),
    E0 = (446.508,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.130078,0.0868111,-0.000108257,7.74222e-08,-2.18419e-11,53840.2,30.6117], Tmin=(100,'K'), Tmax=(982.42,'K')), NASAPolynomial(coeffs=[11.1609,0.0325147,-1.1028e-05,1.72063e-09,-1.03825e-13,52125.6,-20.1055], Tmin=(982.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C[C]([CH2])[O](11407)',
    structure = SMILES('[CH2]O[C]([CH2])C[C]([CH2])[O]'),
    E0 = (703.189,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25229,0.13299,-0.000245195,2.24213e-07,-7.66254e-11,84746.7,35.735], Tmin=(100,'K'), Tmax=(890.033,'K')), NASAPolynomial(coeffs=[10.5568,0.0393229,-1.89187e-05,3.47816e-09,-2.29185e-13,84252.5,-10.8286], Tmin=(890.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(703.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CC(C)OJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(C2CsJOH) + radical(CJCO) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH]C1(CO1)C[C]([CH2])[O](11409)',
    structure = SMILES('[CH]C1(CO1)C[C]([CH2])[O]'),
    E0 = (701.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,2750,3150,900,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.656949,0.099088,-0.000128878,8.56284e-08,-2.15881e-11,84549.7,31.193], Tmin=(100,'K'), Tmax=(1102.3,'K')), NASAPolynomial(coeffs=[17.92,0.0196311,-4.36311e-06,4.08718e-10,-1.20314e-14,81186,-56.9203], Tmin=(1102.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(701.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCJ2_triplet) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH][C]([O])CC1([CH2])CO1(11410)',
    structure = SMILES('[CH][C]([O])CC1([CH2])CO1'),
    E0 = (700.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,360,370,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.304988,0.0990453,-0.000119519,5.57793e-08,3.91644e-13,84400.7,29.1132], Tmin=(100,'K'), Tmax=(684.361,'K')), NASAPolynomial(coeffs=[17.6901,0.0202911,-4.82177e-06,4.67578e-10,-1.33145e-14,81318.8,-55.3985], Tmin=(684.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(700.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(C2CsJOH) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C[C]([CH2])[O](11392)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1([CH]C(=C)[O])CO1(11394)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(87.3125,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 86.0 to 87.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([O])[CH]C1([CH2])CO1(11395)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2][C]([O])[CH]C1(C)CO1(11396)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2][C]([O])CC1(C)[CH]O1(11397)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2][C](O)[CH]C1([CH2])CO1(11398)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2]C1([CH][C](C)[O])CO1(11399)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])CC1([CH2])[CH]O1(11400)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2][C](O)CC1([CH2])[CH]O1(11401)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2]C1([CH]O1)C[C](C)[O](11402)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]([O])[CH]C1([CH2])CO1(11403)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][C]([O])CC1([CH2])[CH]O1(11404)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C]([O])CC(=C)[O](10163)', 'CH2(S)(14)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(S)(1732)', '[CH2][C]([O])CC([CH2])=C(10862)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['C=C([O])[CH]C1(C)CO1(11405)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2][C]([O])C[C]1CCO1(11406)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]O[C]([CH2])C[C]([CH2])[O](11407)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
    products = ['[CH2]C1(CO1)CC(=C)[O](10236)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][C][O](2305)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C1(CO1)C[C]([CH2])[O](11409)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH][C]([O])CC1([CH2])CO1(11410)'],
    products = ['[CH2][C]([O])CC1([CH2])CO1(10242)'],
