...
species(
    label = '[CH2][CH]OC1OC1[CH2](14729)',
    structure = SMILES('[CH2][CH]OC1OC1[CH2]'),
    E0 = (283.171,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.175831,0.0830677,-9.66304e-05,5.71988e-08,-1.27916e-11,34215.6,28.082], Tmin=(100,'K'), Tmax=(1248.52,'K')), NASAPolynomial(coeffs=[17.6773,0.0152615,-2.42107e-06,8.87348e-11,6.69846e-15,30584.4,-58.7002], Tmin=(1248.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0371977,0.0773585,-7.79277e-05,3.89445e-08,-7.55733e-12,15291,26.829], Tmin=(100,'K'), Tmax=(1266.13,'K')), NASAPolynomial(coeffs=[19.2846,0.0165518,-5.88984e-06,1.01399e-09,-6.79153e-14,10417.1,-70.5703], Tmin=(1266.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(C=COJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH]=CC([O])OC[CH2](14737)',
    structure = SMILES('[CH]=CC([O])OC[CH2]'),
    E0 = (313.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,265.024,265.13,1764.36,1764.72],'cm^-1')),
        HinderedRotor(inertia=(0.159143,'amu*angstrom^2'), symmetry=1, barrier=(7.95096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158345,'amu*angstrom^2'), symmetry=1, barrier=(7.96052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159083,'amu*angstrom^2'), symmetry=1, barrier=(7.96295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563244,'amu*angstrom^2'), symmetry=1, barrier=(28.2636,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.780616,0.0792571,-0.000120063,1.09465e-07,-4.00876e-11,37831.6,29.6468], Tmin=(100,'K'), Tmax=(805.7,'K')), NASAPolynomial(coeffs=[5.67746,0.0401977,-1.98875e-05,3.85583e-09,-2.68703e-13,37521.2,10.051], Tmin=(805.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][CH]OC([O])=C[CH2](14738)',
    structure = SMILES('[CH2][CH]OC([O])=C[CH2]'),
    E0 = (319.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,350,440,435,1725,378.909,378.909,378.909,378.909],'cm^-1')),
        HinderedRotor(inertia=(0.188181,'amu*angstrom^2'), symmetry=1, barrier=(19.1722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188181,'amu*angstrom^2'), symmetry=1, barrier=(19.1722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188181,'amu*angstrom^2'), symmetry=1, barrier=(19.1722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.188181,'amu*angstrom^2'), symmetry=1, barrier=(19.1722,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.229702,0.0856435,-0.000101275,5.75395e-08,-1.24977e-11,38622.8,27.9493], Tmin=(100,'K'), Tmax=(1142.3,'K')), NASAPolynomial(coeffs=[20.9781,0.0113797,-3.75616e-06,6.25729e-10,-4.1667e-14,33777.7,-77.1878], Tmin=(1142.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(CJCO) + radical(Allyl_P) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[CH]=CC([O])O[CH][CH2](14740)',
    structure = SMILES('[CH]=CC([O])O[CH][CH2]'),
    E0 = (494.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,282.819,282.855,282.926,1945.36],'cm^-1')),
        HinderedRotor(inertia=(0.147413,'amu*angstrom^2'), symmetry=1, barrier=(8.36939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147372,'amu*angstrom^2'), symmetry=1, barrier=(8.36768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00210752,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439864,'amu*angstrom^2'), symmetry=1, barrier=(24.9714,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448159,0.0866145,-0.00014021,1.23934e-07,-4.2955e-11,59547.4,30.287], Tmin=(100,'K'), Tmax=(831.407,'K')), NASAPolynomial(coeffs=[8.63678,0.0325027,-1.60335e-05,3.07501e-09,-2.11823e-13,58694.4,-4.64785], Tmin=(831.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]OC1[CH]CO1(14741)',
    structure = SMILES('[CH2][CH]OC1[CH]CO1'),
    E0 = (278.595,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0660266,0.0676046,-6.13938e-05,2.9243e-08,-5.27197e-12,33665.1,30.502], Tmin=(100,'K'), Tmax=(1600.85,'K')), NASAPolynomial(coeffs=[15.4205,0.0172141,-2.9106e-06,1.95684e-10,-2.97437e-15,30289.9,-45.9869], Tmin=(1600.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21329,0.0675437,-9.08025e-05,7.98331e-08,-2.94044e-11,-7380.64,27.0764], Tmin=(100,'K'), Tmax=(776.806,'K')), NASAPolynomial(coeffs=[5.09025,0.0389068,-1.87572e-05,3.62943e-09,-2.5394e-13,-7721.29,11.0359], Tmin=(776.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.1503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[C]([O])C[CH2](12054)',
    structure = SMILES('[CH2][CH]O[C]([O])C[CH2]'),
    E0 = (530.859,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.359988,0.088548,-0.00013944,1.22734e-07,-4.2672e-11,63970.5,32.8687], Tmin=(100,'K'), Tmax=(826.931,'K')), NASAPolynomial(coeffs=[8.34684,0.0355724,-1.733e-05,3.3161e-09,-2.28547e-13,63139.9,-1.18055], Tmin=(826.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(530.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(RCCJ) + radical(Cs_P) + radical(CJCO)"""),
)
...
species(
    label = '[CH][CH]OC([O])C=C(14746)',
    structure = SMILES('[CH][CH]OC([O])C=C'),
    E0 = (483.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656634,0.0805408,-0.00012186,1.05266e-07,-3.65775e-11,58282.1,29.5066], Tmin=(100,'K'), Tmax=(799.516,'K')), NASAPolynomial(coeffs=[8.26521,0.0334106,-1.64318e-05,3.17564e-09,-2.20931e-13,57355.1,-3.68619], Tmin=(799.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][CH]OC([O])C=C(12653)'],
    products = ['[CH2][CH]OC1OC1[CH2](14729)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH2][CH]C(=O)OC=C(14383)'],
...
reaction(
    ...
    products = ['[CH2][CH]OC([O])C=C(12653)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(181.901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 181.0 to 181.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(64)', '[CH2][CH]OC=O(1004)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]OC([O])C=C(12653)'],
    products = ['[CH2]C=C([O])OC[CH2](14733)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]OC([O])C=C(12653)'],
    products = ['[CH2]C=C([O])O[CH]C(13673)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=CC([O])OC[CH2](14737)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC([O])O[CH]C(13675)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(64)', '[CH2][CH]O[CH][O](1008)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][CH]OC([O])=C[CH2](14738)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=CC([O])O[CH][CH2](14740)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]OC([O])C=C(12653)'],
    products = ['[CH2][CH]OC1[CH]CO1(14741)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][CH]O[C]([O])C[CH2](12054)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH][CH2](721)', 'C=CC([O])[O](12634)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH2][C]OC([O])C=C(14745)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH][CH]OC([O])C=C(14746)'],
    products = ['[CH2][CH]OC([O])C=C(12653)'],
