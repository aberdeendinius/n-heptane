...
species(
    label = '[CH]=C(O)O[CH]C(4592)',
    structure = SMILES('[CH]=C(O)O[CH]C'),
    E0 = (98.3798,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,350,440,435,1725,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.806625,'amu*angstrom^2'), symmetry=1, barrier=(18.5459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.8091,'amu*angstrom^2'), symmetry=1, barrier=(18.6028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.806103,'amu*angstrom^2'), symmetry=1, barrier=(18.5339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808074,'amu*angstrom^2'), symmetry=1, barrier=(18.5792,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.24125e+11,'s^-1'), n=0.295513, Ea=(154.323,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=O)OC=C(2118)'],
    products = ['[CH2]C(=O)O[CH]C(3823)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH]OC([CH2])=O(4544)'],
    products = ['[CH2]C(=O)O[CH]C(3823)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C(=O)O[C]C(4590)'],
    products = ['[CH2]C(=O)O[CH]C(3823)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C(=O)O[CH]C(4591)'],
    products = ['[CH2]C(=O)O[CH]C(3823)'],
