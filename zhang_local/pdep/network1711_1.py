...
species(
    label = '[CH2]C[C]([CH2])[CH2](6139)',
    structure = SMILES('[CH2]C[C]([CH2])[CH2]'),
    E0 = (627.055,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,360,370,350,1588.48],'cm^-1')),
        HinderedRotor(inertia=(0.00249039,'amu*angstrom^2'), symmetry=1, barrier=(4.45507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193241,'amu*angstrom^2'), symmetry=1, barrier=(4.44299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193137,'amu*angstrom^2'), symmetry=1, barrier=(4.44061,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00248695,'amu*angstrom^2'), symmetry=1, barrier=(4.4537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87791,0.0517316,-6.44051e-05,5.51188e-08,-1.89104e-11,75488.9,24.9777], Tmin=(100,'K'), Tmax=(906.511,'K')), NASAPolynomial(coeffs=[3.21679,0.0333249,-1.3266e-05,2.3002e-09,-1.49394e-13,75759.7,21.4823], Tmin=(906.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Isobutyl) + radical(Isobutyl) + radical(Tertalkyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]CC([CH2])=C(6135)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([CH2])C=C(5197)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC=C(102)', 'CH2(T)(28)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C[C]([CH2])[CH2](6139)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][CH]C([CH2])[CH2](6140)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])[CH2](6116)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]CC([CH2])[CH2](6143)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]C([CH2])C[CH2](6144)'],
    products = ['[CH2]CC([CH2])[CH2](115)'],
