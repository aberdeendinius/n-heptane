...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][CH]OC=C(694)'],
    products = ['[CH2][CH]OC[CH2](632)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][CH]OC[CH2](632)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(41.6456,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 41.3 to 41.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]OC[CH2](632)'],
    products = ['[CH2][CH]O[CH]C(718)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH2][CH]O[CH][CH2](720)'],
    products = ['[CH2][CH]OC[CH2](632)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][C]OC[CH2](722)'],
    products = ['[CH2][CH]OC[CH2](632)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]CO[CH][CH2](723)', 'H(8)'],
    products = ['[CH2][CH]OC[CH2](632)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][CH]OC[CH2](724)', 'H(8)'],
    products = ['[CH2][CH]OC[CH2](632)'],
