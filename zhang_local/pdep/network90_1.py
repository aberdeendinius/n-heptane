...
species(
    label = 'CC=CC[CH]CC(291)',
    structure = SMILES('CC=CC[CH]CC'),
    E0 = (94.3504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
...
species(
    label = 'CC[CH]C[CH]CC(176)',
    structure = SMILES('CC[CH]C[CH]CC'),
    E0 = (173.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200.109,396.632,2035.29,4000],'cm^-1')),
...
species(
    label = 'C[CH]CCC[CH]C(169)',
    structure = SMILES('C[CH]CCC[CH]C'),
    E0 = (173.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,185.047,227.748,1091.52,3308.35],'cm^-1')),
...
species(
    ...
    E0 = (-100.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (-87.8625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (178.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,245.271,884.884,1962.17],'cm^-1')),
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.660996,0.0715562,-4.16094e-05,1.29749e-08,-1.74724e-12,21552.3,32.5515], Tmin=(100,'K'), Tmax=(1590.37,'K')), NASAPolynomial(coeffs=[10.4816,0.0468559,-1.83124e-05,3.20899e-09,-2.12055e-13,18428.7,-19.3833], Tmin=(1590.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJC)"""),
)
...
species(
    label = 'C[C]CC[CH]CC(300)',
    structure = SMILES('C[C]CC[CH]CC'),
    E0 = (427.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06232,0.0705689,-4.49716e-05,1.63502e-08,-2.79067e-12,51460.2,29.3524], Tmin=(100,'K'), Tmax=(1201.22,'K')), NASAPolynomial(coeffs=[6.23523,0.0533435,-2.34619e-05,4.41263e-09,-3.06212e-13,50217.4,3.44766], Tmin=(1201.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH]CC[C]CC(301)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.919474,0.0714864,-4.52073e-05,1.55884e-08,-2.39385e-12,51465.4,30.0249], Tmin=(100,'K'), Tmax=(1373.38,'K')), NASAPolynomial(coeffs=[8.48263,0.0494584,-2.11483e-05,3.90961e-09,-2.67918e-13,49388,-8.86251], Tmin=(1373.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['C=CCC[CH]C(161)', '[CH3](11)'],
    products = ['C[CH]CC[CH]CC(167)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'C[CH][CH]C[CH]CC(295)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', 'C[CH]C[CH][CH]CC(296)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]CC[CH]C(163)', '[CH3](11)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'C[CH][CH]CC[CH]C(297)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2]C[CH]CC[CH]C(298)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][CH]CC[CH]CC(299)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(S)(14)', 'C[CH]CC[CH]C(81)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C(32)', '[CH2]C[CH]CC(23)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C[CH]C(38)', '[CH]CC(45)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CC[CH]C(131)', 'C[CH2](6)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH3](11)', '[CH]CC[CH]CC(224)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', 'C[C]CC[CH]CC(300)'],
    products = ['C[CH]CC[CH]CC(167)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', 'C[CH]CC[C]CC(301)'],
    products = ['C[CH]CC[CH]CC(167)'],
