...
species(
    label = 'OC=[C]CC=C1CO1(30125)',
    structure = SMILES('OC=[C]CC=C1CO1'),
    E0 = (99.9346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,3150,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,180,180,180,180,1011.25,1199.03,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.176901,'amu*angstrom^2'), symmetry=1, barrier=(4.06731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176901,'amu*angstrom^2'), symmetry=1, barrier=(4.06731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176901,'amu*angstrom^2'), symmetry=1, barrier=(4.06731,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.171365,0.0620043,2.13678e-06,-6.99282e-08,3.8036e-11,12177.9,27.0122], Tmin=(100,'K'), Tmax=(915.322,'K')), NASAPolynomial(coeffs=[27.0987,0.00288313,3.06863e-06,-7.19627e-10,4.50643e-14,4795.66,-113.913], Tmin=(915.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.9346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(methyleneoxirane) + radical(Cds_S)"""),
)

species(
    label = 'OC=C=CC[C]1CO1(30126)',
    structure = SMILES('OC=C=CC[C]1CO1'),
    E0 = (88.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.894008,0.0867539,-9.19441e-05,4.87192e-08,-9.54083e-12,10860.2,31.111], Tmin=(100,'K'), Tmax=(1493.91,'K')), NASAPolynomial(coeffs=[19.8353,0.0131687,9.65512e-08,-4.56506e-10,4.43859e-14,6684.32,-70.4635], Tmin=(1493.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)

species(
    label = 'OC=[C]CCC1=CO1(30127)',
    structure = SMILES('OC=[C]CCC1=CO1'),
    E0 = (200.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,1000,180,180,180,473.474,655.365,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.156583,'amu*angstrom^2'), symmetry=1, barrier=(3.60015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156583,'amu*angstrom^2'), symmetry=1, barrier=(3.60015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156583,'amu*angstrom^2'), symmetry=1, barrier=(3.60015,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156583,'amu*angstrom^2'), symmetry=1, barrier=(3.60015,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0828021,0.0731732,-3.55111e-05,-2.528e-08,2.05017e-11,24282.9,29.8375], Tmin=(100,'K'), Tmax=(924.261,'K')), NASAPolynomial(coeffs=[24.8731,0.00835768,-4.11841e-07,-4.05103e-11,-9.21517e-17,17825,-98.5741], Tmin=(924.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(Cds_S)"""),
)

species(
    label = 'OC#CCC[C]1CO1(30128)',
    structure = SMILES('OC#CCC[C]1CO1'),
    E0 = (157.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2100,2250,500,550,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.487006,0.07406,-8.00681e-05,4.97628e-08,-1.21915e-11,19102.6,28.8617], Tmin=(100,'K'), Tmax=(1120.01,'K')), NASAPolynomial(coeffs=[11.6376,0.0271447,-7.73739e-06,1.0555e-09,-5.74913e-14,17049.6,-24.2117], Tmin=(1120.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CtH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtOs) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)
...
species(
    label = 'C#CCC[C]1CO1(18540)',
    structure = SMILES('C#CCC[C]1CO1'),
    E0 = (299.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2750,3150,900,1100,2175,525,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736335,0.0663762,-6.89867e-05,4.12104e-08,-9.53466e-12,36109.9,24.6242], Tmin=(100,'K'), Tmax=(1234.16,'K')), NASAPolynomial(coeffs=[10.9212,0.0237385,-5.46315e-06,5.75343e-10,-2.29242e-14,34329.2,-23.684], Tmin=(1234.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Ethylene_oxide) + radical(C2CsJO)"""),
)

species(
    label = 'OC=[C]C[CH]C1CO1(30129)',
    structure = SMILES('OC=[C]C[CH]C1CO1'),
    E0 = (181.962,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,1685,370,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54192,0.0883583,-8.67445e-05,4.23237e-08,-7.5522e-12,22113.5,36.7054], Tmin=(100,'K'), Tmax=(1682.72,'K')), NASAPolynomial(coeffs=[19.9115,0.0138934,5.54219e-07,-5.50738e-10,4.89562e-14,18216,-68.087], Tmin=(1682.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'OC=[C][CH]CC1CO1(30130)',
    structure = SMILES('OC=[C][CH]CC1CO1'),
    E0 = (123.173,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.50365,0.0878954,-8.46367e-05,4.07403e-08,-7.20444e-12,15041.1,32.968], Tmin=(100,'K'), Tmax=(1690.92,'K')), NASAPolynomial(coeffs=[19.7767,0.0151208,-1.77878e-07,-4.04953e-10,3.88878e-14,11051.6,-71.392], Tmin=(1690.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'O[C]=[C]CCC1CO1(30131)',
    structure = SMILES('O[C]=[C]CCC1CO1'),
    E0 = (221.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2950,3150,900,1000,1100,3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.578914,0.0845525,-8.61761e-05,4.57056e-08,-9.14696e-12,26855.6,33.8527], Tmin=(100,'K'), Tmax=(1427.72,'K')), NASAPolynomial(coeffs=[18.1043,0.0186472,-2.68662e-06,6.77428e-11,9.36522e-15,22902.9,-58.0953], Tmin=(1427.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = 'OC=[C]C[CH][C]1CO1(30132)',
    structure = SMILES('OC=[C]C[CH][C]1CO1'),
    E0 = (362.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,1685,370,3010,987.5,1337.5,450,1655,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.745805,0.0854651,-9.1833e-05,4.95379e-08,-9.88694e-12,43733.8,34.9308], Tmin=(100,'K'), Tmax=(1463.27,'K')), NASAPolynomial(coeffs=[19.2596,0.0133357,-1.25619e-08,-4.41948e-10,4.39492e-14,39746.4,-62.8185], Tmin=(1463.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(C2CsJO) + radical(Cds_S)"""),
)

species(
    label = 'OC=[C][CH]C[C]1CO1(30133)',
    structure = SMILES('OC=[C][CH]C[C]1CO1'),
    E0 = (303.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,1685,370,3010,987.5,1337.5,450,1655,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.70031,0.0849318,-8.95375e-05,4.77768e-08,-9.48525e-12,36661,31.1664], Tmin=(100,'K'), Tmax=(1461.67,'K')), NASAPolynomial(coeffs=[19.042,0.0146888,-8.11036e-07,-2.81537e-10,3.27328e-14,32621.9,-65.6472], Tmin=(1461.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Cds_S) + radical(Allyl_S)"""),
)

species(
    label = 'OC=[C]CC[C]1[CH]O1(30134)',
    structure = SMILES('OC=[C]CC[C]1[CH]O1'),
    E0 = (345.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05099,0.0932409,-0.000106491,5.96368e-08,-1.23085e-11,41797.9,33.7281], Tmin=(100,'K'), Tmax=(1407.32,'K')), NASAPolynomial(coeffs=[21.4406,0.010826,1.056e-06,-6.44265e-10,5.81613e-14,37298.1,-75.9614], Tmin=(1407.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJO) + radical(Cds_S)"""),
)

species(
    label = 'O[C]=[C]CC[C]1CO1(30135)',
    structure = SMILES('O[C]=[C]CC[C]1CO1'),
    E0 = (401.909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0998249,0.0849923,-0.000101219,6.37153e-08,-1.52872e-11,48490.7,33.2454], Tmin=(100,'K'), Tmax=(1167.62,'K')), NASAPolynomial(coeffs=[15.5111,0.0205661,-4.39032e-06,4.00328e-10,-1.16558e-14,45591.3,-41.2921], Tmin=(1167.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(C2CsJO) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (15.9954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3010,987.5,1337.5,450,1655,261.62,264.168,264.202,265.042],'cm^-1')),
        HinderedRotor(inertia=(0.307751,'amu*angstrom^2'), symmetry=1, barrier=(15.124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306784,'amu*angstrom^2'), symmetry=1, barrier=(15.1257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.304134,'amu*angstrom^2'), symmetry=1, barrier=(15.1288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305722,'amu*angstrom^2'), symmetry=1, barrier=(15.1318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
...
species(
    label = 'OC=C=CCC1CO1(30136)',
    structure = SMILES('OC=C=CCC1CO1'),
    E0 = (-91.4227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.71891,0.0899328,-8.76411e-05,4.22773e-08,-7.45054e-12,-10758.6,32.9929], Tmin=(100,'K'), Tmax=(1706.86,'K')), NASAPolynomial(coeffs=[20.2993,0.0139436,5.72756e-07,-5.49056e-10,4.8331e-14,-14722.2,-74.5966], Tmin=(1706.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-91.4227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Ethylene_oxide)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'OC=[C]CC=C1CO1(30125)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'OC=C=CC[C]1CO1(30126)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'OC=[C]CCC1=CO1(30127)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'OC#CCC[C]1CO1(30128)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', 'C#CCC[C]1CO1(18540)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['OC=[C]C[CH]C1CO1(30129)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['OC=[C]CCC1[CH]O1(29549)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OC=[C]CC[C]1CO1(16326)'],
    products = ['OC=CC[CH][C]1CO1(16330)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OC=[C]CC[C]1CO1(16326)'],
    products = ['OC=CCC[C]1[CH]O1(16331)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(D)(132)', '[CH]=[C]CC[C]1CO1(18547)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'OC=[C]C[CH][C]1CO1(30132)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', 'OC=[C][CH]C[C]1CO1(30133)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'OC=[C]CC[C]1[CH]O1(30134)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'O[C]=[C]CC[C]1CO1(30135)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[C]1CO1(1125)', '[CH2]C[C]=CO(27737)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C[C]1CO1(1846)', '[C]=CO(27807)'],
    products = ['OC=[C]CC[C]1CO1(16326)'],
