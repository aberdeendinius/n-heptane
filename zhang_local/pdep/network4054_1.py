...
species(
    label = '[CH]C(=[CH])CC=O(19400)',
    structure = SMILES('[CH]C(=[CH])CC=O'),
    E0 = (485.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2782.5,750,1395,475,1775,1000,385.305,385.392,385.471],'cm^-1')),
        HinderedRotor(inertia=(0.465506,'amu*angstrom^2'), symmetry=1, barrier=(49.0941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.465842,'amu*angstrom^2'), symmetry=1, barrier=(49.0916,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.466078,'amu*angstrom^2'), symmetry=1, barrier=(49.0956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64673,0.0444396,-1.8908e-05,-1.86463e-09,2.11765e-12,58493.2,21.7096], Tmin=(100,'K'), Tmax=(1304.23,'K')), NASAPolynomial(coeffs=[12.1565,0.0253237,-1.20085e-05,2.31983e-09,-1.62548e-13,54636.2,-36.0626], Tmin=(1304.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[12.2926,-0.0286143,0.000132933,-1.21537e-07,2.73283e-11,69561.4,-25.3933], Tmin=(100,'K'), Tmax=(1752.61,'K')), NASAPolynomial(coeffs=[77.6368,0.013237,-6.63448e-05,1.64423e-08,-1.22283e-12,17324.5,-460.988], Tmin=(1752.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C([CH2])[CH][C]=O(19403)',
    structure = SMILES('[CH]C([CH2])[CH][C]=O'),
    E0 = (720.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,801.517,801.695,801.872],'cm^-1')),
        HinderedRotor(inertia=(0.00597028,'amu*angstrom^2'), symmetry=1, barrier=(2.72408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00597119,'amu*angstrom^2'), symmetry=1, barrier=(2.72461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118476,'amu*angstrom^2'), symmetry=1, barrier=(2.724,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118396,'amu*angstrom^2'), symmetry=1, barrier=(2.72215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55719,0.0526159,-5.34774e-05,2.72822e-08,-4.55783e-12,86788.8,25.738], Tmin=(100,'K'), Tmax=(845.463,'K')), NASAPolynomial(coeffs=[10.5679,0.0179253,-6.01769e-06,9.674e-10,-6.13048e-14,84981.4,-17.8991], Tmin=(845.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(720.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(CCJCHO) + radical(CCJ2_triplet) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31186,0.0645293,-8.42325e-05,7.0565e-08,-2.53507e-11,45180.1,21.2842], Tmin=(100,'K'), Tmax=(733.846,'K')), NASAPolynomial(coeffs=[5.99488,0.0354621,-1.758e-05,3.43835e-09,-2.42454e-13,44588.1,0.790168], Tmin=(733.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47369,0.0598603,-8.44911e-05,6.93076e-08,-2.30698e-11,28165,20.319], Tmin=(100,'K'), Tmax=(808.309,'K')), NASAPolynomial(coeffs=[7.57373,0.0251157,-1.15564e-05,2.17733e-09,-1.49603e-13,27327.8,-6.89096], Tmin=(808.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CCO)) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69941,0.00767713,8.55736e-05,-1.11503e-07,4.01444e-11,29852.8,15.7245], Tmin=(100,'K'), Tmax=(1025.51,'K')), NASAPolynomial(coeffs=[13.8134,0.0186533,-9.9434e-06,2.24866e-09,-1.7906e-13,24716.7,-52.102], Tmin=(1025.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-OdCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P)"""),
)
...
species(
    label = '[C]C(=C)C[C]=O(19408)',
    structure = SMILES('[C]C(=C)C[C]=O'),
    E0 = (697.245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,320.957,322.338],'cm^-1')),
        HinderedRotor(inertia=(0.239923,'amu*angstrom^2'), symmetry=1, barrier=(17.7585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241958,'amu*angstrom^2'), symmetry=1, barrier=(17.756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61012,0.0459694,-3.77948e-05,1.44394e-08,-2.15326e-12,83950.6,20.2891], Tmin=(100,'K'), Tmax=(1602.98,'K')), NASAPolynomial(coeffs=[15.2869,0.011841,-5.85887e-06,1.15752e-09,-8.18158e-14,79565.9,-52.1468], Tmin=(1602.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(697.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(CJ3)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(197.762,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_CO]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=C)C=C=O(19398)'],
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH]C([CH2])=C[C]=O(19401)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]C(=[CH])C[C]=O(19402)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=C)C[C]=O(17871)'],
    products = ['[CH]=C1C[C]([O])C1(19386)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.03419e+08,'s^-1'), n=1.06803, Ea=(187.968,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_D;doublebond_intra;radadd_intra_CO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C([CH2])[CH][C]=O(19403)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C-]#[O+](374)', '[CH]C([CH2])=C(18776)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C]=O(1149)', '[CH]C([CH2])=C(18776)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(28)', 'C#CC[C]=O(5322)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(=C)C[C]=O(17871)'],
    products = ['[CH2]C([CH2])=C[C]=O(17870)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(28)', '[CH]=[C]C[C]=O(5325)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[C]C(=C)C[C]=O(19408)'],
    products = ['[CH]C(=C)C[C]=O(17871)'],
