species(
    label = 'C=[C]CC(C)[O](17483)',
    structure = SMILES('C=[C]CC(C)[O]'),
    E0 = (255.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,359.625,362.615,363.387],'cm^-1')),
        HinderedRotor(inertia=(0.00127783,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123656,'amu*angstrom^2'), symmetry=1, barrier=(11.4787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121744,'amu*angstrom^2'), symmetry=1, barrier=(11.4812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2723,0.0636712,-7.07617e-05,4.78545e-08,-1.37279e-11,24353.5,24.38], Tmin=(100,'K'), Tmax=(833.964,'K')), NASAPolynomial(coeffs=[7.82441,0.0322466,-1.42433e-05,2.67652e-09,-1.85504e-13,23260.6,-6.0409], Tmin=(833.964,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987951,0.0615872,-5.1203e-05,2.22671e-08,-3.93239e-12,17189.2,23.1667], Tmin=(100,'K'), Tmax=(1342,'K')), NASAPolynomial(coeffs=[13.3382,0.0247756,-1.00571e-05,1.82687e-09,-1.24566e-13,13874.4,-40.0488], Tmin=(1342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CC(C)O(17706)',
    structure = SMILES('[CH]=[C]CC(C)O'),
    E0 = (272.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,1685,370,243.543],'cm^-1')),
        HinderedRotor(inertia=(0.00280498,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256874,'amu*angstrom^2'), symmetry=1, barrier=(10.743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245929,'amu*angstrom^2'), symmetry=1, barrier=(10.727,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25576,'amu*angstrom^2'), symmetry=1, barrier=(10.7389,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33542,0.0587799,-5.19558e-05,2.5552e-08,-5.25384e-12,32829.7,25.1236], Tmin=(100,'K'), Tmax=(1144.3,'K')), NASAPolynomial(coeffs=[10.083,0.0282018,-1.18727e-05,2.19959e-09,-1.5192e-13,30827.8,-18.2575], Tmin=(1144.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29806,0.0506067,-2.33591e-05,-5.16929e-09,5.35176e-12,-5758.36,23.9043], Tmin=(100,'K'), Tmax=(1042.24,'K')), NASAPolynomial(coeffs=[12.8988,0.0234086,-9.14813e-06,1.68877e-09,-1.18664e-13,-9117.43,-37.0562], Tmin=(1042.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-48.7498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'C=[C]CC[O](17453)',
    structure = SMILES('C=[C]CC[O]'),
    E0 = (287.198,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,250.865,250.91,2079.64],'cm^-1')),
        HinderedRotor(inertia=(0.00267859,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195331,'amu*angstrom^2'), symmetry=1, barrier=(8.72722,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]CC(C)=O(17463)'],
    products = ['C=[C]CC(C)[O](17483)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=CC(C)[O](17702)'],
    products = ['C=[C]CC(C)[O](17483)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C=[C]CC=O(17489)'],
    products = ['C=[C]CC(C)[O](17483)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH][O](605)', 'C=C=C(6077)'],
    products = ['C=[C]CC(C)[O](17483)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', 'C=[C]C[CH][O](4712)'],
    products = ['C=[C]CC(C)[O](17483)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', 'C=[C]C[C](C)[O](17707)'],
    products = ['C=[C]CC(C)[O](17483)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'C=[C][CH]C(C)[O](17708)'],
    products = ['C=[C]CC(C)[O](17483)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C([O])C[C]=C(17458)'],
    products = ['C=[C]CC(C)[O](17483)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]CC(C)[O](17709)'],
    products = ['C=[C]CC(C)[O](17483)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(14)', 'C=[C]CC[O](17453)'],
    products = ['C=[C]CC(C)[O](17483)'],
