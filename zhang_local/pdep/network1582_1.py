species(
    ...
    E0 = (-233.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.349936,'amu*angstrom^2'), symmetry=1, barrier=(8.04572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349611,'amu*angstrom^2'), symmetry=1, barrier=(8.03824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.350306,'amu*angstrom^2'), symmetry=1, barrier=(8.05422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0928643,'amu*angstrom^2'), symmetry=1, barrier=(2.13513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0921307,'amu*angstrom^2'), symmetry=1, barrier=(2.11827,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (-76.2731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3025,407.5,1350,352.5],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84826,0.0245051,-1.87841e-05,8.47778e-09,-1.63794e-12,-9131.41,11.5011], Tmin=(100,'K'), Tmax=(1201.61,'K')), NASAPolynomial(coeffs=[6.13968,0.0135484,-5.10655e-06,8.89341e-10,-5.91286e-14,-9922.41,-4.98253], Tmin=(1201.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.2731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.80004,'amu*angstrom^2'), symmetry=1, barrier=(18.3945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.799242,'amu*angstrom^2'), symmetry=1, barrier=(18.3761,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45409,0.0211275,1.84372e-05,-5.46893e-08,2.73841e-11,-22479.6,14.9696], Tmin=(100,'K'), Tmax=(892.985,'K')), NASAPolynomial(coeffs=[16.4525,-0.00645889,5.78717e-06,-1.20687e-09,8.21355e-14,-26379.8,-58.8198], Tmin=(892.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-187.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-OsOsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (-231.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2389.19],'cm^-1')),
        HinderedRotor(inertia=(0.139473,'amu*angstrom^2'), symmetry=1, barrier=(3.20677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471654,'amu*angstrom^2'), symmetry=1, barrier=(10.8442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['CC([O])OO(3589)'],
    products = ['CC(O)O[O](3590)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', 'C[CH]O[O](77)'],
    products = ['CC(O)O[O](3590)'],
    transitionState = 'TS6',
