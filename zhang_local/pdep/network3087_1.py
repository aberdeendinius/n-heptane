...
species(
    label = '[CH]=CC(=O)C[CH2](11836)',
    structure = SMILES('[CH]=CC(=O)C[CH2]'),
    E0 = (306.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.203273,'amu*angstrom^2'), symmetry=1, barrier=(4.67364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20215,'amu*angstrom^2'), symmetry=1, barrier=(4.64783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201645,'amu*angstrom^2'), symmetry=1, barrier=(4.63623,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54156,0.0603721,-8.66957e-05,7.92828e-08,-2.97652e-11,36978.9,22.5989], Tmin=(100,'K'), Tmax=(784.548,'K')), NASAPolynomial(coeffs=[4.66365,0.0341721,-1.69445e-05,3.30709e-09,-2.32037e-13,36805.4,10.3109], Tmin=(784.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH]=CC1(O)[CH]C1(11839)',
    structure = SMILES('[CH]=CC1(O)[CH]C1'),
    E0 = (371.446,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84844,0.0302555,3.4989e-05,-7.68908e-08,3.46444e-11,44767.9,24.0491], Tmin=(100,'K'), Tmax=(925.353,'K')), NASAPolynomial(coeffs=[17.1427,0.00812552,-4.33473e-07,-6.54009e-12,-4.17221e-15,40054.3,-58.7251], Tmin=(925.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C1(O)CC1(11840)',
    structure = SMILES('[CH]=[C]C1(O)CC1'),
    E0 = (409.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,1685,370,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62987,0.0399695,1.88146e-06,-3.84416e-08,1.99137e-11,49334.2,22.8105], Tmin=(100,'K'), Tmax=(932.783,'K')), NASAPolynomial(coeffs=[15.379,0.0119378,-2.77597e-06,4.33093e-10,-3.2144e-14,45423.8,-49.7769], Tmin=(932.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = 'C=CC1([O])[CH]C1(11841)',
    structure = SMILES('C=CC1([O])[CH]C1'),
    E0 = (353.452,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2889,0.020618,5.41876e-05,-8.78139e-08,3.58047e-11,42587.6,23.2785], Tmin=(100,'K'), Tmax=(949.417,'K')), NASAPolynomial(coeffs=[13.9074,0.0145986,-4.12882e-06,7.61936e-10,-6.01044e-14,38446.6,-42.3606], Tmin=(949.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH]=CC1([O])[CH]C1(11842)',
    structure = SMILES('[CH]=CC1([O])[CH]C1'),
    E0 = (600.549,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21615,0.0241288,3.75712e-05,-7.04828e-08,2.99096e-11,72307.3,23.9428], Tmin=(100,'K'), Tmax=(946.94,'K')), NASAPolynomial(coeffs=[14.1465,0.0117675,-3.09575e-06,5.63382e-10,-4.5254e-14,68342.6,-41.9678], Tmin=(946.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(600.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(CCJCO) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = 'C1=CC2(CC2)O1(11834)',
    structure = SMILES('C1=CC2(CC2)O1'),
    E0 = (85.4006,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88695,0.0229854,7.07681e-05,-1.22726e-07,5.31504e-11,10369.3,14.6857], Tmin=(100,'K'), Tmax=(916.605,'K')), NASAPolynomial(coeffs=[20.3502,0.00345747,2.82785e-06,-6.53752e-10,3.88512e-14,4420.22,-86.7692], Tmin=(916.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.4006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + polycyclic(s1_3_4_ene)"""),
)
...
species(
    label = '[CH]=C[C]1CC1(11845)',
    structure = SMILES('[CH]=C[C]1CC1'),
    E0 = (493.399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,441.89,990.179,990.256,990.282,990.364,991.64,991.775,992.015],'cm^-1')),
        HinderedRotor(inertia=(0.00542558,'amu*angstrom^2'), symmetry=1, barrier=(3.76901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.82074,0.00950687,7.061e-05,-9.93131e-08,3.90958e-11,59399.7,14.5201], Tmin=(100,'K'), Tmax=(940.433,'K')), NASAPolynomial(coeffs=[11.5428,0.0142426,-3.66894e-06,6.43879e-10,-5.05893e-14,55909.3,-36.8585], Tmin=(940.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Allyl_T) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC1([O])CC1(10608)'],
    products = ['C#C(582)', 'O=C1CC1(9174)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CC1([O])CC1(11837)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=[CH](583)', 'O=C1CC1(9174)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C#C(582)', '[O][C]1CC1(9172)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](583)', '[O][C]1CC1(9172)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=CC1([O])[CH]C1(11842)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]=[C]C1([O])CC1(11843)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(14)', '[CH]=CC(=C)[O](5179)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(T)(63)', '[CH]=C[C]1CC1(11845)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[C]=CC1([O])CC1(11846)'],
    products = ['[CH]=CC1([O])CC1(10608)'],
