...
species(
    label = 'C=[C]CO[C]=CC(18179)',
    structure = SMILES('C=[C]CO[C]=CC'),
    E0 = (365.612,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.77124,0.059358,-2.47971e-05,-1.42771e-08,1.08093e-11,33715,28.5901], Tmin=(100,'K'), Tmax=(982.567,'K')), NASAPolynomial(coeffs=[16.3792,0.0220535,-7.89862e-06,1.43179e-09,-1.01749e-13,29381.4,-52.8794], Tmin=(982.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Allyl_P)"""),
)
...
species(
    label = 'C=[C]COC1[CH]C1(18083)',
    structure = SMILES('C=[C]COC1[CH]C1'),
    E0 = (400.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36131,0.0471156,-4.74827e-06,-2.42618e-08,1.16026e-11,48225.7,27.9843], Tmin=(100,'K'), Tmax=(1034.1,'K')), NASAPolynomial(coeffs=[12.5456,0.0276629,-1.10676e-05,2.07686e-09,-1.47557e-13,44639.5,-32.504], Tmin=(1034.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2][C]=CO[CH]C[CH2](18189)',
    structure = SMILES('[CH2][C]=CO[CH]C[CH2]'),
    E0 = (543.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.77719,0.0880366,-9.20086e-05,4.6353e-08,-8.83038e-12,65518.6,31.902], Tmin=(100,'K'), Tmax=(1419.14,'K')), NASAPolynomial(coeffs=[23.6728,0.0111516,-2.3185e-06,2.62002e-10,-1.37079e-14,59381.6,-91.786], Tmin=(1419.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(Cds_S) + radical(CCsJOC(O)) + radical(Allyl_P)"""),
)
...
species(
    label = 'C=[C]COC[C]=C(18192)',
    structure = SMILES('C=[C]COC[C]=C'),
    E0 = (421.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15044,0.0684875,-8.50925e-05,7.23052e-08,-2.63304e-11,50783.2,27.6733], Tmin=(100,'K'), Tmax=(774.827,'K')), NASAPolynomial(coeffs=[4.84633,0.0420515,-1.96735e-05,3.76503e-09,-2.62213e-13,50431.3,12.2106], Tmin=(774.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCOC[C]=C(18193)',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=CO[CH]C=C(18175)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=[C]COC=C=C(18176)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CCOC=C[CH2](18177)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C=COC[C]=C(17524)'],
    products = ['[CH2]C=CO[CH]C=C(14145)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]C[O](4571)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C=CO[CH][C]=C(18183)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][C]=COC[C]=C(18184)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C=[C]OC[C]=C(18185)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]COC=C[CH2](18186)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C]=COC[CH][CH2](14153)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][C]=CO[CH]C[CH2](18189)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[C]=C(584)', '[CH2]C=CO[CH2](6277)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(28)', '[CH]=COC[C]=C(13820)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C=COC[C]=C(18191)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=[C]COC[C]=C(18192)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(3.78195e+10,'s^-1'), n=0.9884, Ea=(139.355,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R2H_S;Cd_rad_out_Cd;Cs_H_out_1H] for rate rule [R2H_S;Cd_rad_out_Cd;Cs_H_out_H/NonDeO]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=C(64)', '[CH]OC[C]=C(17674)'],
    products = ['[CH2]C=COC[C]=C(17524)'],
