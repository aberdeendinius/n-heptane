...
species(
    label = '[CH2]CC1=CC1[O](22656)',
    structure = SMILES('[CH2]CC1=CC1[O]'),
    E0 = (470.725,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61273,0.0428071,-1.20987e-05,-1.60646e-08,9.29966e-12,56709.6,22.9719], Tmin=(100,'K'), Tmax=(1013.23,'K')), NASAPolynomial(coeffs=[13.2026,0.0182675,-7.17631e-06,1.36079e-09,-9.83404e-14,53271.9,-38.4689], Tmin=(1013.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96518,0.0474154,-2.86776e-05,8.98317e-09,-1.23006e-12,28763.1,20.2688], Tmin=(100,'K'), Tmax=(1512.44,'K')), NASAPolynomial(coeffs=[7.46997,0.0328569,-1.4239e-05,2.61887e-09,-1.78085e-13,27098,-8.56614], Tmin=(1512.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=C=O)C[CH2](22661)',
    structure = SMILES('[CH]C(=C=O)C[CH2]'),
    E0 = (441.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,350,440,435,1725,3000,3100,440,815,1455,1000,575.602,575.608,575.611,575.611],'cm^-1')),
        HinderedRotor(inertia=(0.227606,'amu*angstrom^2'), symmetry=1, barrier=(53.5129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227602,'amu*angstrom^2'), symmetry=1, barrier=(53.513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227603,'amu*angstrom^2'), symmetry=1, barrier=(53.513,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96612,0.0481588,-3.80633e-05,1.87787e-08,-4.34331e-12,53126,22.7564], Tmin=(100,'K'), Tmax=(959.241,'K')), NASAPolynomial(coeffs=[5.47237,0.0335377,-1.51994e-05,2.88821e-09,-2.01847e-13,52453.3,5.98667], Tmin=(959.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(CJCC=C=O) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]CC1[CH]OC=1(22662)',
    structure = SMILES('[CH2]CC1[CH]OC=1'),
    E0 = (342.293,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29047,0.0389402,2.95004e-05,-8.28764e-08,3.93485e-11,41285,20.0072], Tmin=(100,'K'), Tmax=(922.974,'K')), NASAPolynomial(coeffs=[22.1502,0.00205297,2.47754e-06,-5.38024e-10,3.04457e-14,35155,-91.305], Tmin=(922.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(RCCJ) + radical(CCsJOC(O))"""),
)
...
species(
    label = '[C]=C(C=O)C[CH2](22668)',
    structure = SMILES('[C]=C(C=O)C[CH2]'),
    E0 = (616.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,350,440,435,1725,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.20458,'amu*angstrom^2'), symmetry=1, barrier=(4.7037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204656,'amu*angstrom^2'), symmetry=1, barrier=(4.70545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0201488,'amu*angstrom^2'), symmetry=1, barrier=(14.5258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32642,0.044617,-2.25544e-05,-4.10857e-08,5.32526e-11,74142.4,21.0009], Tmin=(100,'K'), Tmax=(456.139,'K')), NASAPolynomial(coeffs=[5.05602,0.0317415,-1.65879e-05,3.35647e-09,-2.42339e-13,73778.3,8.71342], Tmin=(456.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(616.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH]=C(C=C)C=O(22345)'],
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=O(373)', 'C#CC[CH2](5183)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]C(C=C)=C[O](22660)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=O(373)', '[CH]=[C]C[CH2](5188)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]C(=C=O)C[CH2](22661)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(C=O)C[CH2](22301)'],
    products = ['[CH2]CC1[CH]OC=1(22662)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C(=C[CH2])C[O](22664)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C([CH]O)=C[CH2](22665)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]CC(=[CH])C=O(22667)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[C]=C(C=O)C[CH2](22668)'],
    products = ['[CH]=C(C=O)C[CH2](22301)'],
