...
species(
    label = '[CH][CH]OC([CH])=[CH](21609)',
    structure = SMILES('[CH][CH]OC([CH])=[CH]'),
    E0 = (1032.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.440652,0.072133,-7.86176e-05,3.84295e-08,-6.15301e-12,124330,24.7599], Tmin=(100,'K'), Tmax=(956.111,'K')), NASAPolynomial(coeffs=[18.1823,0.0111219,-3.62928e-06,5.96431e-10,-3.99169e-14,120333,-63.1952], Tmin=(956.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1032.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(AllylJ2_triplet) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C][C]([CH])OC=C(21610)',
    structure = SMILES('[C][C]([CH])OC=C'),
    E0 = (1095.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.13528,0.0704838,-8.34129e-05,4.46182e-08,-8.79385e-12,131967,24.7184], Tmin=(100,'K'), Tmax=(1414.37,'K')), NASAPolynomial(coeffs=[21.6962,-0.000222712,1.89332e-06,-4.54889e-10,3.28472e-14,126842,-83.3349], Tmin=(1414.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1095.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJ3) + radical(C2CsJOC(O)) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1([CH])OC1[CH2](21611)',
    structure = SMILES('[CH]C1([CH])OC1[CH2]'),
    E0 = (926.402,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158195,0.0687786,-7.89478e-05,4.42439e-08,-9.02535e-12,111572,24.3922], Tmin=(100,'K'), Tmax=(1457.99,'K')), NASAPolynomial(coeffs=[16.4025,0.00718506,1.93843e-06,-7.5153e-10,6.34535e-14,108645,-53.8958], Tmin=(1457.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(926.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([CH])O[C]=C(21612)',
    structure = SMILES('[CH]C([CH])O[C]=C'),
    E0 = (914.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,1685,370,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.465796,0.0643868,-6.75689e-05,3.38346e-08,-6.37959e-12,110097,27.7184], Tmin=(100,'K'), Tmax=(1446.37,'K')), NASAPolynomial(coeffs=[18.788,0.00709695,-1.29037e-06,1.21225e-10,-5.47014e-15,105489,-65.044], Tmin=(1446.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(914.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH])OC=[CH](21613)',
    structure = SMILES('[CH]C([CH])OC=[CH]'),
    E0 = (921.596,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.341403,0.0721686,-7.77728e-05,3.8256e-08,-6.87167e-12,111019,27.9014], Tmin=(100,'K'), Tmax=(1613.44,'K')), NASAPolynomial(coeffs=[22.0289,0.00155677,1.96092e-06,-5.10095e-10,3.695e-14,105772,-84.6118], Tmin=(1613.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(921.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C1([CH])C[CH]O1(21615)',
    structure = SMILES('[CH]C1([CH])C[CH]O1'),
    E0 = (902.38,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00329392,0.0644389,-6.79162e-05,3.52403e-08,-6.59779e-12,108695,25.1817], Tmin=(100,'K'), Tmax=(1627.58,'K')), NASAPolynomial(coeffs=[15.0285,0.00802735,2.03113e-06,-7.66091e-10,6.26898e-14,106385,-46.6965], Tmin=(1627.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(902.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])O[CH][CH2](19507)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH](2815)', 'C#CO[CH][CH2](5291)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][CH2](721)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH]C(=[CH])O[C][CH2](21608)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH][CH]OC([CH])=[CH](21609)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[C][C]([CH])OC=C(21610)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=[CH])O[CH][CH2](19507)'],
    products = ['[CH]C1([CH])OC1[CH2](21611)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(130.403,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H_pri;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 128.1 to 130.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(64)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(64)', '[CH][C]([CH])[O](21614)'],
    products = ['[CH]C(=[CH])O[CH][CH2](19507)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(=[CH])O[CH][CH2](19507)'],
    products = ['[CH]C1([CH])C[CH]O1(21615)'],
