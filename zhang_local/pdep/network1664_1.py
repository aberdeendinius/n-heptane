species(
    label = 'C[CH]OC[CH]O(5568)',
    structure = SMILES('C[CH]OC[CH]O'),
    E0 = (-72.4465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
...
species(
    label = 'C[CH]OCC=O(3610)',
    structure = SMILES('C[CH]OCC=O'),
    E0 = (-159.506,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,659.075],'cm^-1')),
        HinderedRotor(inertia=(0.01216,'amu*angstrom^2'), symmetry=1, barrier=(3.74952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0452292,'amu*angstrom^2'), symmetry=1, barrier=(13.9532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60686,'amu*angstrom^2'), symmetry=1, barrier=(13.9529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.60692,'amu*angstrom^2'), symmetry=1, barrier=(13.9543,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]OC=CO(5713)',
    structure = SMILES('C[CH]OC=CO'),
    E0 = (-200.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.03684,'amu*angstrom^2'), symmetry=1, barrier=(23.8389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03725,'amu*angstrom^2'), symmetry=1, barrier=(23.8483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0329,'amu*angstrom^2'), symmetry=1, barrier=(23.7485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03294,'amu*angstrom^2'), symmetry=1, barrier=(23.7492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.469258,0.082558,-0.00011879,9.44748e-08,-2.98847e-11,-8590.83,25.3587], Tmin=(100,'K'), Tmax=(846.637,'K')), NASAPolynomial(coeffs=[10.591,0.0286492,-1.24937e-05,2.28079e-09,-1.53319e-13,-10086.5,-20.4995], Tmin=(846.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.4465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]OCCO(5718)',
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12624,0.0729236,-0.000112694,1.07512e-07,-4.02075e-11,-3177.01,24.4124], Tmin=(100,'K'), Tmax=(837.485,'K')), NASAPolynomial(coeffs=[3.05217,0.0425637,-2.04155e-05,3.88479e-09,-2.66961e-13,-2757.5,19.893], Tmin=(837.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.1974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C[CH]OC[C]O(5722)',
    structure = SMILES('C[CH]OC[C]O'),
    E0 = (208.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576466,0.0790894,-0.000109979,8.12279e-08,-2.38252e-11,25165.8,24.1617], Tmin=(100,'K'), Tmax=(836.469,'K')), NASAPolynomial(coeffs=[12.1753,0.0236248,-1.05191e-05,1.95934e-09,-1.34172e-13,23225.3,-29.7249], Tmin=(836.469,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CH2_triplet)"""),
)

species(
    label = 'C[C]OC[CH]O(5723)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580772,0.0812243,-0.000123922,1.03074e-07,-3.39485e-11,25144.3,24.2442], Tmin=(100,'K'), Tmax=(830.142,'K')), NASAPolynomial(coeffs=[10.0189,0.0277908,-1.29953e-05,2.4454e-09,-1.67065e-13,23851.5,-17.881], Tmin=(830.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]OCC=O(3610)'],
    products = ['C[CH]OC[CH]O(5568)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C[CH]OC[CH][O](3605)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C[CH]O[CH][CH]O(3842)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH]OC[CH]O(3844)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(32)', '[O]C[CH]O(561)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction21',
    reactants = ['OH(D)(132)', '[CH]CO[CH]C(3668)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[CH]C(415)', '[CH]O(5471)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[CH]OC[CH]O(5693)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[CH]OC[C]O(5722)'],
    products = ['C[CH]OC[CH]O(5568)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'C[C]OC[CH]O(5723)'],
    products = ['C[CH]OC[CH]O(5568)'],
