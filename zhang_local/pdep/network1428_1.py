species(
    label = 'C=[C]OO[CH]C(4282)',
    structure = SMILES('C=[C]OO[CH]C'),
    E0 = (346.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,500,795,815,3025,407.5,1350,352.5,260.41],'cm^-1')),
        HinderedRotor(inertia=(0.207398,'amu*angstrom^2'), symmetry=1, barrier=(9.98101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0032617,'amu*angstrom^2'), symmetry=1, barrier=(9.97953,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.905078,'amu*angstrom^2'), symmetry=1, barrier=(43.5748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.905185,'amu*angstrom^2'), symmetry=1, barrier=(43.5756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C#COO[CH]C(4581)',
    structure = SMILES('C#COO[CH]C'),
    E0 = (338.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,750,770,3400,2100,350,500,795,815,2175,525,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(1.5405,'amu*angstrom^2'), symmetry=1, barrier=(35.4192,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54017,'amu*angstrom^2'), symmetry=1, barrier=(35.4115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.53945,'amu*angstrom^2'), symmetry=1, barrier=(35.395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.54094,'amu*angstrom^2'), symmetry=1, barrier=(35.4291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
...
species(
    label = '[CH]=[C]OOCC(4584)',
    structure = SMILES('[CH]=[C]OOCC'),
    E0 = (407.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,350,500,795,815,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.237767,'amu*angstrom^2'), symmetry=1, barrier=(7.01365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.457978,'amu*angstrom^2'), symmetry=1, barrier=(13.5072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2377,'amu*angstrom^2'), symmetry=1, barrier=(7.01333,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.599,'amu*angstrom^2'), symmetry=1, barrier=(47.1587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64905,0.0561343,-6.20517e-05,4.21083e-08,-1.23865e-11,49039.7,25.3326], Tmin=(100,'K'), Tmax=(805.548,'K')), NASAPolynomial(coeffs=[6.78052,0.0306543,-1.46069e-05,2.84424e-09,-2.01289e-13,48213,1.68562], Tmin=(805.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = 'C=[C]OO[C]C(4587)',
    structure = SMILES('C=[C]OO[C]C'),
    E0 = (620.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,2950,3100,1380,975,1025,1650,278.276,278.365],'cm^-1')),
        HinderedRotor(inertia=(0.183874,'amu*angstrom^2'), symmetry=1, barrier=(9.9603,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.490657,'amu*angstrom^2'), symmetry=1, barrier=(28.5072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.344618,'amu*angstrom^2'), symmetry=1, barrier=(18.9927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168448,'amu*angstrom^2'), symmetry=1, barrier=(9.97168,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5672,0.0578712,-6.80606e-05,4.45591e-08,-1.21252e-11,74768.2,23.9559], Tmin=(100,'K'), Tmax=(880.696,'K')), NASAPolynomial(coeffs=[8.75556,0.0252225,-1.24532e-05,2.46535e-09,-1.76196e-13,73502,-9.81052], Tmin=(880.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OOC=C(2654)'],
    products = ['C=[C]OO[CH]C(4282)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OO[CH]C(4282)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.9789e+07,'m^3/(mol*s)'), n=-0.126319, Ea=(36.1166,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Y_rad]
Euclidian distance = 0
family: R_Recombination
Ea raised from -15.6 to -15.6 kJ/mol.
Ea raised from -15.6 to 36.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][CH]OO[C]=C(4225)'],
    products = ['C=[C]OO[CH]C(4282)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]=[C]OO[CH]C(4585)'],
    products = ['C=[C]OO[CH]C(4282)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH3](11)', '[CH]OO[C]=C(4541)'],
    products = ['C=[C]OO[CH]C(4282)'],
