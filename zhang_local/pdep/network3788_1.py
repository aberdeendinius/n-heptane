...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33668,0.0585435,-5.56078e-05,2.88855e-08,-6.17322e-12,57018.9,25.7206], Tmin=(100,'K'), Tmax=(1114.69,'K')), NASAPolynomial(coeffs=[10.6578,0.0250957,-1.05987e-05,1.96711e-09,-1.36101e-13,54940.9,-20.2604], Tmin=(1114.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]CC(=C)O(17778)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(O)C=C=C(17779)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CCC([CH2])O(17780)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C=[C]CC=C(17455)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH2][CH]C[C]=C(6432)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][C](O)C[C]=C(17781)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C(O)[CH][C]=C(17782)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]CC([CH2])O(17783)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[C]=C(584)', '[CH2]C([CH2])O(5560)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C(O)C[C]=C(17785)'],
    products = ['[CH2]C(O)C[C]=C(17492)'],
