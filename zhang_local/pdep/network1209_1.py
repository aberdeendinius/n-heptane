...
species(
    label = 'C[CH]O[CH]C[O](3839)',
    structure = SMILES('C[CH]O[CH]C[O]'),
    E0 = (153.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.733899,0.0788795,-0.000121881,1.04731e-07,-3.53051e-11,18562.6,25.1647], Tmin=(100,'K'), Tmax=(855.147,'K')), NASAPolynomial(coeffs=[8.24446,0.0305629,-1.40007e-05,2.5972e-09,-1.75425e-13,17760.2,-7.07523], Tmin=(855.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800539,0.0802048,-0.000132609,1.21783e-07,-4.30652e-11,18538.5,25.0282], Tmin=(100,'K'), Tmax=(859.98,'K')), NASAPolynomial(coeffs=[5.95476,0.0349689,-1.6621e-05,3.1183e-09,-2.11288e-13,18438.3,5.51085], Tmin=(859.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47588,0.087483,-0.000152572,1.36244e-07,-4.60846e-11,40254,25.6399], Tmin=(100,'K'), Tmax=(884.092,'K')), NASAPolynomial(coeffs=[8.81547,0.0274468,-1.28689e-05,2.36196e-09,-1.56463e-13,39651.1,-8.63666], Tmin=(884.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(333.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.919702,0.0464607,2.16945e-05,-8.02594e-08,3.96378e-11,-30278.6,21.0103], Tmin=(100,'K'), Tmax=(918.62,'K')), NASAPolynomial(coeffs=[23.7825,0.00249401,2.72108e-06,-6.18742e-10,3.71181e-14,-36824.4,-100.115], Tmin=(918.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-252.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0404,0.02996,3.7042e-05,-7.61377e-08,3.47974e-11,-8919.61,17.8827], Tmin=(100,'K'), Tmax=(881.423,'K')), NASAPolynomial(coeffs=[12.8198,0.017103,-2.44668e-06,1.45994e-10,-4.33505e-15,-12220.7,-40.7073], Tmin=(881.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-74.8522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.90584,0.0789493,-0.000138036,1.30792e-07,-4.73139e-11,52273.9,23.9357], Tmin=(100,'K'), Tmax=(850.961,'K')), NASAPolynomial(coeffs=[5.40512,0.0340705,-1.70987e-05,3.27716e-09,-2.24548e-13,52367.4,8.00366], Tmin=(850.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]OC=C[O](3838)'],
    products = ['C[CH]OC[CH][O](3605)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]O[CH][CH][O](1077)', 'H(8)'],
    products = ['C[CH]OC[CH][O](3605)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[O][CH]C[O](563)', '[CH]C(32)'],
    products = ['C[CH]OC[CH][O](3605)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[CH]C(415)', '[CH][O](751)'],
    products = ['C[CH]OC[CH][O](3605)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](11)', '[CH]OC[CH][O](1030)'],
    products = ['C[CH]OC[CH][O](3605)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', 'C[C]OC[CH][O](3847)'],
    products = ['C[CH]OC[CH][O](3605)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'C[CH]OC[C][O](3848)'],
    products = ['C[CH]OC[CH][O](3605)'],
