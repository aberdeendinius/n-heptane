...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5854,0.0477981,-4.91852e-05,2.48148e-08,-4.85874e-12,51602.5,20.6599], Tmin=(100,'K'), Tmax=(1253.66,'K')), NASAPolynomial(coeffs=[13.4706,0.00987648,-3.81223e-06,6.86524e-10,-4.71717e-14,48622.5,-39.3661], Tmin=(1253.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJ2_triplet) + radical(OCOJ) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][CH]OC=O(1004)'],
    products = ['[CH2][CH]OC[O](687)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][CH]OC[O](687)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(31.3419,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 29.8 to 31.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]OC[O](687)'],
    products = ['[CH2][CH]O[CH]O(1005)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH]O[CH][O](1008)'],
    products = ['[CH2][CH]OC[O](687)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH][CH2](721)', '[O]C[O](558)'],
    products = ['[CH2][CH]OC[O](687)'],
