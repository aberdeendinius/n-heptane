...
species(
    label = '[CH2]CC=C1CO1(9372)',
    structure = SMILES('[CH2]CC=C1CO1'),
    E0 = (170.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,3010,987.5,1337.5,450,1655,180,180,180,294.91,841.556,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.1849,'amu*angstrom^2'), symmetry=1, barrier=(4.25121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1849,'amu*angstrom^2'), symmetry=1, barrier=(4.25121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCC1=CO1(9373)',
    structure = SMILES('[CH2]CCC1=CO1'),
    E0 = (376.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,1000,180,180,180,254.855,1600,1866.67,2567.12,3200],'cm^-1')),
        HinderedRotor(inertia=(0.168664,'amu*angstrom^2'), symmetry=1, barrier=(3.87792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168664,'amu*angstrom^2'), symmetry=1, barrier=(3.87792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168664,'amu*angstrom^2'), symmetry=1, barrier=(3.87792,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70894,0.0545772,-5.35427e-05,3.28241e-08,-8.93708e-12,45384.1,22.8156], Tmin=(100,'K'), Tmax=(856.101,'K')), NASAPolynomial(coeffs=[6.39822,0.032667,-1.51526e-05,2.92839e-09,-2.06769e-13,44581.2,0.921122], Tmin=(856.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[CH]C1CO1(9374)',
    structure = SMILES('[CH2]C[CH]C1CO1'),
    E0 = (254.157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72497,0.0404085,1.06759e-05,-4.88098e-08,2.512e-11,30659.2,23.702], Tmin=(100,'K'), Tmax=(865.781,'K')), NASAPolynomial(coeffs=[12.1384,0.0206419,-4.186e-06,4.48362e-10,-2.26931e-14,27793.8,-31.171], Tmin=(865.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = 'CC[CH][C]1CO1(9376)',
    structure = SMILES('CC[CH][C]1CO1'),
    E0 = (229.016,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05569,0.0532662,-4.03177e-05,1.80834e-08,-3.25172e-12,27660.1,25.4265], Tmin=(100,'K'), Tmax=(1550.34,'K')), NASAPolynomial(coeffs=[9.92608,0.024132,-6.08451e-06,7.63258e-10,-3.95812e-14,25660.5,-18.8359], Tmin=(1550.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(C2CsJO)"""),
)

species(
    label = 'CCC[C]1[CH]O1(9377)',
    structure = SMILES('CCC[C]1[CH]O1'),
    E0 = (212.836,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774485,0.060799,-5.42902e-05,2.74893e-08,-5.44779e-12,25723.1,24.1348], Tmin=(100,'K'), Tmax=(1409.7,'K')), NASAPolynomial(coeffs=[11.8995,0.0219417,-5.18644e-06,5.98888e-10,-2.8373e-14,23310.9,-30.7876], Tmin=(1409.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C[CH][C]1CO1(9378)',
    structure = SMILES('[CH2]C[CH][C]1CO1'),
    E0 = (434.262,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27835,0.0519223,-4.39778e-05,2.21426e-08,-4.43729e-12,52334.4,26.4064], Tmin=(100,'K'), Tmax=(1392.74,'K')), NASAPolynomial(coeffs=[9.5648,0.022177,-5.53731e-06,6.76664e-10,-3.38241e-14,50603,-14.2456], Tmin=(1392.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954386,0.0598994,-5.92531e-05,3.29293e-08,-7.10744e-12,50399.5,25.2725], Tmin=(100,'K'), Tmax=(1297.71,'K')), NASAPolynomial(coeffs=[11.5303,0.0199657,-4.6159e-06,5.05181e-10,-2.19409e-14,48272.2,-26.1265], Tmin=(1297.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(418.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJ) + radical(CCsJO)"""),
)
...
species(
    label = 'CCC=C1CO1(9380)',
    structure = SMILES('CCC=C1CO1'),
    E0 = (-34.3861,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65004,0.0339361,3.80611e-05,-7.95026e-08,3.46119e-11,-4034.85,18.6251], Tmin=(100,'K'), Tmax=(942.217,'K')), NASAPolynomial(coeffs=[16.5394,0.0155251,-3.94845e-06,6.8367e-10,-5.3316e-14,-8829.22,-62.874], Tmin=(942.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.3861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane)"""),
)

species(
    label = 'C=CCC1CO1(6097)',
    structure = SMILES('C=CCC1CO1'),
    E0 = (-23.2088,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79632,0.0371726,2.1758e-05,-6.05729e-08,2.91878e-11,-2701.27,19.6361], Tmin=(100,'K'), Tmax=(876.487,'K')), NASAPolynomial(coeffs=[12.4425,0.0204014,-3.98732e-06,4.22423e-10,-2.21192e-14,-5789.57,-37.2936], Tmin=(876.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.2088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'CCCC1=CO1(9381)',
    structure = SMILES('CCCC1=CO1'),
    E0 = (171.443,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7639,0.0529,-4.03853e-05,1.77152e-08,-3.48278e-12,20697.2,20.8217], Tmin=(100,'K'), Tmax=(1126.91,'K')), NASAPolynomial(coeffs=[7.0468,0.0341481,-1.54251e-05,2.94898e-09,-2.06945e-13,19506.5,-5.2964], Tmin=(1126.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene)"""),
)
...
species(
    label = 'C1CC2(C1)CO2(9194)',
    structure = SMILES('C1CC2(C1)CO2'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[C]1CO1(9192)'],
    products = ['C=C(18)', 'C=C1CO1(9173)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]CC=C1CO1(9372)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CC[C]1CO1(9228)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]CCC1=CO1(9373)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH2](22)', 'C=C1CO1(9173)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=C(18)', '[CH2][C]1CO1(9171)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH2](22)', '[CH2][C]1CO1(9171)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C[CH][C]1CO1(9378)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH]C[C]1CO1(6530)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]CC[C]1[CH]O1(9379)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC1([CH2])CO1(9193)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH2](21)', '[C]1CO1(1125)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(28)', '[CH2]C[C]1CO1(1846)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]CC[C]1CO1(9382)'],
    products = ['[CH2]CC[C]1CO1(9192)'],
