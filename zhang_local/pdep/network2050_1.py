...
species(
    label = '[O]OCC=CC[C]=O(7583)',
    structure = SMILES('[O]OCC=CC[C]=O'),
    E0 = (101.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,287.192,297.167],'cm^-1')),
        HinderedRotor(inertia=(0.00199421,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166486,'amu*angstrom^2'), symmetry=1, barrier=(10.3636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162971,'amu*angstrom^2'), symmetry=1, barrier=(10.3414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160132,'amu*angstrom^2'), symmetry=1, barrier=(10.3148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59236,0.0593756,-4.75666e-05,2.00744e-08,-3.69025e-12,12249.1,28.2105], Tmin=(100,'K'), Tmax=(1203.16,'K')), NASAPolynomial(coeffs=[8.79456,0.0354315,-1.77152e-05,3.53391e-09,-2.5339e-13,10516,-7.86808], Tmin=(1203.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]OC[CH]CC=C=O(7584)',
    structure = SMILES('[O]OC[CH]CC=C=O'),
    E0 = (138.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,253.385,253.387,1137],'cm^-1')),
        HinderedRotor(inertia=(0.160386,'amu*angstrom^2'), symmetry=1, barrier=(7.30531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159968,'amu*angstrom^2'), symmetry=1, barrier=(7.30208,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160101,'amu*angstrom^2'), symmetry=1, barrier=(7.3065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160165,'amu*angstrom^2'), symmetry=1, barrier=(7.30572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586436,0.0822614,-0.000121504,1.04622e-07,-3.61931e-11,16789.8,31.8396], Tmin=(100,'K'), Tmax=(818.549,'K')), NASAPolynomial(coeffs=[7.73037,0.0363523,-1.72195e-05,3.27147e-09,-2.25275e-13,15988.7,1.05537], Tmin=(818.549,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-(Cdd-O2d)CsH) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[O]OC=CCC[C]=O(7585)',
    structure = SMILES('[O]OC=CCC[C]=O'),
    E0 = (104.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.331072,'amu*angstrom^2'), symmetry=1, barrier=(7.61199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33115,'amu*angstrom^2'), symmetry=1, barrier=(7.61378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331036,'amu*angstrom^2'), symmetry=1, barrier=(7.61116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.331203,'amu*angstrom^2'), symmetry=1, barrier=(7.61501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736655,0.0754831,-9.41708e-05,6.62026e-08,-1.89569e-11,12690.6,31.5565], Tmin=(100,'K'), Tmax=(848.643,'K')), NASAPolynomial(coeffs=[10.4808,0.0295528,-1.29834e-05,2.4211e-09,-1.66652e-13,11036.8,-13.8536], Tmin=(848.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.248619,0.0930581,-0.000149344,1.35151e-07,-4.75423e-11,19529.9,32.5366], Tmin=(100,'K'), Tmax=(854.132,'K')), NASAPolynomial(coeffs=[6.68176,0.0409919,-1.93779e-05,3.63765e-09,-2.47067e-13,19231.2,7.19939], Tmin=(854.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOOH) + radical(ROOJ) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]CC[CH][CH]OO(7588)',
    structure = SMILES('O=[C]CC[CH][CH]OO'),
    E0 = (209.752,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1855,455,950,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00864135,0.0986993,-0.000160694,1.45372e-07,-5.12659e-11,25360.5,34.9435], Tmin=(100,'K'), Tmax=(842.028,'K')), NASAPolynomial(coeffs=[7.59029,0.041238,-2.01293e-05,3.83409e-09,-2.62769e-13,24844,4.18443], Tmin=(842.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOOH) + radical(CCCJ=O) + radical(CCJCOOH)"""),
)

species(
    label = '[O]OCCC[CH][C]=O(7589)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.442487,0.0835276,-0.000113378,9.02571e-08,-2.92388e-11,16995.9,31.455], Tmin=(100,'K'), Tmax=(822.905,'K')), NASAPolynomial(coeffs=[9.16609,0.0355415,-1.57329e-05,2.90797e-09,-1.97633e-13,15749.1,-7.78258], Tmin=(822.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O) + radical(ROOJ)"""),
)

species(
    label = '[O]OC[CH][CH]CC=O(7590)',
    structure = SMILES('[O]OC[CH][CH]CC=O'),
    E0 = (213.116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2782.5,750,1395,475,1775,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560041,0.0839118,-0.000123963,1.09834e-07,-3.90507e-11,25747.8,35.252], Tmin=(100,'K'), Tmax=(822.226,'K')), NASAPolynomial(coeffs=[6.34935,0.0412244,-1.95929e-05,3.72747e-09,-2.56807e-13,25286.7,11.4406], Tmin=(822.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCOOH) + radical(ROOJ) + radical(CCJCC=O)"""),
)

species(
    label = '[O]O[CH][CH]CCC=O(7591)',
    structure = SMILES('[O]O[CH][CH]CCC=O'),
    E0 = (201.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2782.5,750,1395,475,1775,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346068,0.0921494,-0.000150464,1.40702e-07,-5.09967e-11,24390.7,33.6719], Tmin=(100,'K'), Tmax=(846.623,'K')), NASAPolynomial(coeffs=[5.06512,0.0446518,-2.16592e-05,4.11568e-09,-2.81655e-13,24494.8,17.025], Tmin=(846.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCOOH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = 'O=[C]C[CH][CH]COO(7592)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.232637,0.0903338,-0.000133701,1.13801e-07,-3.89933e-11,26717.2,36.4884], Tmin=(100,'K'), Tmax=(809.486,'K')), NASAPolynomial(coeffs=[8.84278,0.0378674,-1.80971e-05,3.45413e-09,-2.38619e-13,25648.3,-1.22326], Tmin=(809.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCOOH) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C][CH]C[CH]COO(7593)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224543,0.088886,-0.000123629,9.88956e-08,-3.22197e-11,22825.6,33.7845], Tmin=(100,'K'), Tmax=(793.973,'K')), NASAPolynomial(coeffs=[10.0046,0.0359134,-1.65596e-05,3.12271e-09,-2.14885e-13,21389.3,-10.4079], Tmin=(793.973,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O) + radical(CCJCOOH)"""),
)
...
species(
    label = '[O]OC[CH][CH]C[C]=O(7594)',
    structure = SMILES('[O]OC[CH][CH]C[C]=O'),
    E0 = (373.076,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,1855,455,950,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459825,0.087186,-0.000139962,1.25003e-07,-4.34312e-11,44989.2,36.4307], Tmin=(100,'K'), Tmax=(854.316,'K')), NASAPolynomial(coeffs=[7.35442,0.0360294,-1.70004e-05,3.1879e-09,-2.16341e-13,44500,8.28524], Tmin=(854.316,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CCJCOOH) + radical(ROOJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]OC[CH]C[CH][C]=O(7595)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.428535,0.0860418,-0.000131107,1.1193e-07,-3.75689e-11,41098.6,33.8082], Tmin=(100,'K'), Tmax=(857.918,'K')), NASAPolynomial(coeffs=[8.56563,0.0339859,-1.5409e-05,2.84331e-09,-1.91488e-13,40221.9,-1.17376], Tmin=(857.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCHO) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[O]O[CH][CH]CC[C]=O(7596)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258713,0.0952661,-0.000165893,1.55134e-07,-5.50798e-11,43631.6,34.8049], Tmin=(100,'K'), Tmax=(867.651,'K')), NASAPolynomial(coeffs=[6.00897,0.0395651,-1.91309e-05,3.59158e-09,-2.42492e-13,43732.5,14.2116], Tmin=(867.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.757,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOOH) + radical(ROOJ) + radical(CCCJ=O) + radical(CCJCOOH)"""),
)

species(
    label = '[O]OCC=CCC=O(7597)',
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.992359,0.0740137,-7.69347e-05,3.40057e-08,2.48257e-12,-7329.71,28.1421], Tmin=(100,'K'), Tmax=(582.692,'K')), NASAPolynomial(coeffs=[7.98151,0.0385687,-1.79538e-05,3.43841e-09,-2.40246e-13,-8356.99,-3.62745], Tmin=(582.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.7814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-(Cdd-O2d)CsH) + radical(ROOJ)"""),
)

species(
    label = 'O=[C]CCC=COO(7599)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.589377,0.0776774,-8.44532e-05,5.01504e-08,-1.21826e-11,-5584.92,31.3277], Tmin=(100,'K'), Tmax=(989.881,'K')), NASAPolynomial(coeffs=[12.1083,0.0311306,-1.39195e-05,2.64747e-09,-1.855e-13,-7865.41,-24.1276], Tmin=(989.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.4386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCCJ=O)"""),
)

species(
    label = '[O]OC=CCCC=O(7600)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947974,0.070831,-7.29748e-05,4.35857e-08,-1.0994e-11,-6555.65,29.9833], Tmin=(100,'K'), Tmax=(941.324,'K')), NASAPolynomial(coeffs=[9.4175,0.0348421,-1.56279e-05,2.9725e-09,-2.08067e-13,-8150.21,-10.3654], Tmin=(941.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-55.3945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(ROOJ)"""),
)

species(
    label = 'O=[C]CC=CCOO(7601)',
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301289,0.0713657,-6.66267e-05,3.42343e-08,-6.91087e-12,-1851.48,29.2366], Tmin=(100,'K'), Tmax=(1333.06,'K')), NASAPolynomial(coeffs=[14.4033,0.0233645,-6.21574e-06,8.22623e-10,-4.47835e-14,-5105.99,-40.9563], Tmin=(1333.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.5721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(12dioxetane) + radical(CCCJ=O)"""),
)
...
species(
    label = '[O]C[CH]CC[C]=O(7604)',
    structure = SMILES('[O]C[CH]CC[C]=O'),
    E0 = (174.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1855,455,950,3025,407.5,1350,352.5,307.846,307.847,2163.78,2163.78],'cm^-1')),
        HinderedRotor(inertia=(0.0762314,'amu*angstrom^2'), symmetry=1, barrier=(5.12661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0762316,'amu*angstrom^2'), symmetry=1, barrier=(5.12661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0762317,'amu*angstrom^2'), symmetry=1, barrier=(5.12661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0762314,'amu*angstrom^2'), symmetry=1, barrier=(5.12661,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23557,0.0687694,-9.94978e-05,9.21506e-08,-3.42471e-11,21122.2,30.6807], Tmin=(100,'K'), Tmax=(824.754,'K')), NASAPolynomial(coeffs=[3.68325,0.0407953,-1.93336e-05,3.67893e-09,-2.53605e-13,21266.1,22.664], Tmin=(824.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCOJ) + radical(CCJCO)"""),
)
...
species(
    label = '[O]OC[C]CC[C]=O(7605)',
    structure = SMILES('[O]OC[C]CC[C]=O'),
    E0 = (420.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1855,455,950,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.195826,0.0933293,-0.000151827,1.34487e-07,-4.62022e-11,50759.2,32.4825], Tmin=(100,'K'), Tmax=(857.192,'K')), NASAPolynomial(coeffs=[8.42743,0.0355546,-1.68442e-05,3.15518e-09,-2.13686e-13,50059.4,-1.81239], Tmin=(857.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]OCC=CC[C]=O(7583)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]OC[CH]CC=C=O(7584)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]OC=CCC[C]=O(7585)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]CC[CH][CH]OO(7588)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC[CH][CH]CC=O(7590)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]O[CH][CH]CCC=O(7591)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O=[C]C[CH][CH]COO(7592)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O=[C][CH]C[CH]COO(7593)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O2(2)', '[CH2][CH]CC[C]=O(4374)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[O]OC[CH][CH]C[C]=O(7594)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[O]OC[CH]C[CH][C]=O(7595)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[O]O[CH][CH]CC[C]=O(7596)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]OC[CH]CC[C]=O(6951)'],
    products = ['C=CCC[C]=O(4369)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]OC[CH]CC[C]=O(6951)'],
    products = ['O(T)(63)', 'O=[C]CCC1CO1(7602)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[C-]#[O+](374)', '[CH2]C[CH]CO[O](6922)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O(T)(63)', '[O]C[CH]CC[C]=O(7604)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C[C]=O(3064)', '[CH]CO[O](7037)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[C]=O(1149)', '[CH2]C[CH]CO[O](6922)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]O[O](61)', '[CH]CC[C]=O(4298)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[O]OC[C]CC[C]=O(7605)'],
    products = ['[O]OC[CH]CC[C]=O(6951)'],
