...
species(
    label = '[CH2]CC(=O)C([CH2])O(11899)',
    structure = SMILES('[CH2]CC(=O)C([CH2])O'),
    E0 = (-30.3142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,375,552.5,462.5,1710,1380,1390,370,380,2900,435,340.903,340.987],'cm^-1')),
        HinderedRotor(inertia=(0.00145047,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00145021,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00145096,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115076,'amu*angstrom^2'), symmetry=1, barrier=(9.4908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115092,'amu*angstrom^2'), symmetry=1, barrier=(9.49083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2]C(O)C1(O)[CH]C1(11901)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.585897,0.062372,-2.83713e-05,-1.79815e-08,1.44366e-11,5315.75,29.2695], Tmin=(100,'K'), Tmax=(940.123,'K')), NASAPolynomial(coeffs=[19.0214,0.0155794,-4.20449e-06,6.86797e-10,-4.91941e-14,450.923,-65.9708], Tmin=(940.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.0788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](O)C1(O)CC1(11902)',
    structure = SMILES('[CH2][C](O)C1(O)CC1'),
    E0 = (19.8046,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0608016,0.078387,-8.11874e-05,4.28154e-08,-8.79482e-12,2530.79,28.0823], Tmin=(100,'K'), Tmax=(1197.86,'K')), NASAPolynomial(coeffs=[18.0367,0.0183595,-6.01786e-06,9.7931e-10,-6.3265e-14,-1775.66,-61.886], Tmin=(1197.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.8046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = 'CC([O])C1([O])CC1(10573)',
    structure = SMILES('CC([O])C1([O])CC1'),
    E0 = (90.8644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.904584,0.0546558,-9.92396e-06,-2.9824e-08,1.62385e-11,11051.9,24.8652], Tmin=(100,'K'), Tmax=(978.315,'K')), NASAPolynomial(coeffs=[16.5412,0.0220085,-7.83612e-06,1.44111e-09,-1.04144e-13,6495.23,-57.8814], Tmin=(978.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.8644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC(O)C1([O])[CH]C1(11818)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.942323,0.053371,-7.01189e-06,-3.44668e-08,1.85272e-11,7387.74,27.4178], Tmin=(100,'K'), Tmax=(962.302,'K')), NASAPolynomial(coeffs=[17.0728,0.019669,-6.45932e-06,1.16186e-09,-8.44513e-14,2739.24,-57.8052], Tmin=(962.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.4057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C([O])C1(O)CC1(11819)',
    structure = SMILES('[CH2]C([O])C1(O)CC1'),
    E0 = (73.5375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.547394,0.0636743,-3.13908e-05,-1.31201e-08,1.20138e-11,8979.94,26.7191], Tmin=(100,'K'), Tmax=(955.36,'K')), NASAPolynomial(coeffs=[18.4561,0.017974,-5.61209e-06,9.7316e-10,-6.94669e-14,4221.8,-65.8559], Tmin=(955.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.5375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.732254,0.0505974,2.08029e-05,-8.05835e-08,3.98273e-11,-34754.8,25.2138], Tmin=(100,'K'), Tmax=(918.083,'K')), NASAPolynomial(coeffs=[23.494,0.00702303,1.16073e-06,-3.5985e-10,2.04342e-14,-41277.3,-95.4137], Tmin=(918.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-290.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)
...
species(
    label = '[CH2][CH]C1(CC1)OO(11907)',
    structure = SMILES('[CH2][CH]C1(CC1)OO'),
    E0 = (281.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.566524,0.0655505,-4.36254e-05,7.19323e-09,2.5043e-12,33955.7,28.7062], Tmin=(100,'K'), Tmax=(1044.94,'K')), NASAPolynomial(coeffs=[16.219,0.0236066,-9.21555e-06,1.70016e-09,-1.19566e-13,29703.3,-52.191], Tmin=(1044.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH]C(O)C1([O])CC1(11909)',
    structure = SMILES('[CH]C(O)C1([O])CC1'),
    E0 = (308.719,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697022,0.0616194,-3.5073e-05,-5.41891e-09,8.36354e-12,37259.1,26.8059], Tmin=(100,'K'), Tmax=(973.336,'K')), NASAPolynomial(coeffs=[17.4197,0.0178617,-6.11191e-06,1.09655e-09,-7.83559e-14,32821.2,-59.4941], Tmin=(973.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJ2_triplet) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C([CH2])O(11899)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(102.407,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 100.9 to 102.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C(O)C1([O])CC1(11900)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', 'C=CC1([O])CC1(11496)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)C1([O])CC1(10651)'],
    products = ['[CH2]C(O)C1(O)[CH]C1(11901)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C1([O])CC1(10651)'],
    products = ['[CH2][C](O)C1(O)CC1(11902)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)C1([O])CC1(10651)'],
    products = ['CC(O)C1([O])[CH]C1(11818)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])C1(O)CC1(11819)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH2][CH]C1([O])CC1(11624)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C([O])C1([O])CC1(10934)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C(O)C1([O])[CH]C1(11903)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][C](O)C1([O])CC1(11904)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C1(CC1)OO(11907)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', '[CH2]C(O)[C]1CC1(11908)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[O]C1([CH]O)CC1(11778)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C(O)C1([O])CC1(11909)'],
    products = ['[CH2]C(O)C1([O])CC1(10651)'],
