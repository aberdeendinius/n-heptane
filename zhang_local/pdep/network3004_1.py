...
species(
    label = '[O]COC1=CC1(11769)',
    structure = SMILES('[O]COC1=CC1'),
    E0 = (114.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61688,0.0333344,3.11159e-05,-7.62516e-08,3.46338e-11,13840.6,19.3863], Tmin=(100,'K'), Tmax=(942.193,'K')), NASAPolynomial(coeffs=[19.7437,0.00459351,1.12817e-07,-2.1559e-12,-9.30341e-15,8284.69,-78.3426], Tmin=(942.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(OCOJ)"""),
)
...
species(
    label = '[O][CH]OC1CC1(11772)',
    structure = SMILES('[O][CH]OC1CC1'),
    E0 = (114.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29615,0.040501,-2.21255e-05,5.29357e-09,-4.86889e-13,13859,18.8941], Tmin=(100,'K'), Tmax=(2473.48,'K')), NASAPolynomial(coeffs=[17.4207,0.016043,-7.29384e-06,1.29618e-09,-8.28768e-14,6376.65,-67.771], Tmin=(2473.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'OCO[C]1[CH]C1(11773)',
    structure = SMILES('OCO[C]1[CH]C1'),
    E0 = (78.9973,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48249,0.0372824,2.34117e-05,-7.16204e-08,3.44256e-11,9608.63,24.6908], Tmin=(100,'K'), Tmax=(920.727,'K')), NASAPolynomial(coeffs=[20.0685,0.00357621,1.69142e-06,-4.0629e-10,2.30869e-14,4192.29,-74.2681], Tmin=(920.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.9973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[O]CO[C]1[CH]C1(11774)',
    structure = SMILES('[O]CO[C]1[CH]C1'),
    E0 = (306.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99685,0.0348454,-2.06278e-06,-2.17477e-08,1.04061e-11,36931,23.3215], Tmin=(100,'K'), Tmax=(1021.08,'K')), NASAPolynomial(coeffs=[11.6364,0.0177089,-7.18828e-06,1.38134e-09,-1.00266e-13,33887.2,-28.65], Tmin=(1021.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(OCOJ) + radical(C2CsJOCs) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]C(=C)OC[O](10032)',
    structure = SMILES('[CH2]C(=C)OC[O]'),
    E0 = (4.6072,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,359.618,360.091,360.377,361.804],'cm^-1')),
        HinderedRotor(inertia=(0.00128498,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292309,'amu*angstrom^2'), symmetry=1, barrier=(26.8838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.292847,'amu*angstrom^2'), symmetry=1, barrier=(26.8706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25464,0.0453166,5.87408e-07,-4.39747e-08,2.3032e-11,666.766,21.0939], Tmin=(100,'K'), Tmax=(941.791,'K')), NASAPolynomial(coeffs=[18.6885,0.00904432,-1.80282e-06,3.03852e-10,-2.64354e-14,-4292.22,-70.8623], Tmin=(941.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.6072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCOJ) + radical(C=C(O)CJ)"""),
)

species(
    label = 'O=COC1CC1(11776)',
    structure = SMILES('O=COC1CC1'),
    E0 = (-281.445,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42754,0.0181922,5.7567e-05,-8.52585e-08,3.27803e-11,-33778.7,18.6243], Tmin=(100,'K'), Tmax=(982.538,'K')), NASAPolynomial(coeffs=[12.0841,0.0199104,-7.69652e-06,1.52623e-09,-1.15961e-13,-37656.9,-37.8717], Tmin=(982.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane)"""),
)

species(
    label = 'OCOC1=CC1(11777)',
    structure = SMILES('OCOC1=CC1'),
    E0 = (-113.18,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07695,0.036021,5.6014e-05,-1.25916e-07,5.88551e-11,-13480.7,20.8503], Tmin=(100,'K'), Tmax=(910.54,'K')), NASAPolynomial(coeffs=[28.553,-0.0101666,9.34854e-06,-1.87289e-09,1.20881e-13,-21573.2,-126.093], Tmin=(910.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene)"""),
)

species(
    label = 'C1OC2(CC2)O1(11494)',
    structure = SMILES('C1OC2(CC2)O1'),
    E0 = (-157.999,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70829,0.0136593,0.000126536,-2.00137e-07,8.51484e-11,-18886.1,14.6687], Tmin=(100,'K'), Tmax=(916.571,'K')), NASAPolynomial(coeffs=[29.1791,-0.0107859,1.03509e-05,-2.02461e-09,1.25815e-13,-27930.9,-137.338], Tmin=(916.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + polycyclic(s1_3_4_ane)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]COC1=CC1(11769)'],
    products = ['[O]CO[C]1CC1(11491)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'O=CO[C]1CC1(11560)'],
    products = ['[O]CO[C]1CC1(11491)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[O]CO[C]1[CH]C1(11774)'],
    products = ['[O]CO[C]1CC1(11491)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[O][CH]O[C]1CC1(11775)'],
    products = ['[O]CO[C]1CC1(11491)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C[O](558)', '[C]1CC1(11616)'],
    products = ['[O]CO[C]1CC1(11491)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(T)(63)', '[CH2]O[C]1CC1(11545)'],
    products = ['[O]CO[C]1CC1(11491)'],
