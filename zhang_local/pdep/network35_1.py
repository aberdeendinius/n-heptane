species(
    ...
    E0 = (2.58175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1600],'cm^-1')),
...
species(
    ...
    E0 = (2.59378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200.549,803.991,1611.32],'cm^-1')),
...
species(
    ...
    E0 = (13.3818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]CC[CH]C(81)',
    structure = SMILES('C[CH]CC[CH]C'),
    E0 = (197.028,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200.056,728.032,3621.78],'cm^-1')),
...
species(
    ...
    E0 = (26.362,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1583.68,1584.64],'cm^-1')),
        HinderedRotor(inertia=(0.00422957,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289177,'amu*angstrom^2'), symmetry=1, barrier=(8.10244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.294994,'amu*angstrom^2'), symmetry=1, barrier=(8.10632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286917,'amu*angstrom^2'), symmetry=1, barrier=(8.10783,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(C)CCC(83)',
    structure = SMILES('[CH2]C(C)CCC'),
    E0 = (7.5235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,922.511,3557.91],'cm^-1')),
        HinderedRotor(inertia=(0.628491,'amu*angstrom^2'), symmetry=1, barrier=(14.4502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626326,'amu*angstrom^2'), symmetry=1, barrier=(14.4005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129706,'amu*angstrom^2'), symmetry=1, barrier=(2.98219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127397,'amu*angstrom^2'), symmetry=1, barrier=(2.9291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.6695,'amu*angstrom^2'), symmetry=1, barrier=(84.3691,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1674,'amu'),
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[CH]C(38)', 'C[CH2](6)'],
    products = ['C[CH]CCCC(49)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC(4)', '[CH2][CH]C(44)'],
    products = ['C[CH]CCCC(49)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH3](11)', '[CH2]CC[CH]C(25)'],
    products = ['C[CH]CCCC(49)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', 'C[CH]CCC(19)'],
    products = ['C[CH]CCCC(49)'],
