...
species(
    label = '[CH2][CH]C1OCO1(13557)',
    structure = SMILES('[CH2][CH]C1OCO1'),
    E0 = (102.119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99768,0.0162053,9.3815e-05,-1.46634e-07,6.06593e-11,12379.7,23.4825], Tmin=(100,'K'), Tmax=(936.874,'K')), NASAPolynomial(coeffs=[21.8842,0.00239927,2.08381e-06,-3.54957e-10,1.01019e-14,5533.18,-87.8144], Tmin=(936.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = 'C=C=COC[O](13558)',
    structure = SMILES('C=C=COC[O]'),
    E0 = (28.0608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.36478,'amu*angstrom^2'), symmetry=1, barrier=(31.379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37569,'amu*angstrom^2'), symmetry=1, barrier=(31.6299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30504,0.0413164,1.32735e-05,-6.12804e-08,3.03154e-11,3488.5,19.7721], Tmin=(100,'K'), Tmax=(935.006,'K')), NASAPolynomial(coeffs=[20.8602,0.00334925,8.8319e-07,-1.826e-10,5.12481e-15,-2165.54,-83.9361], Tmin=(935.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.0608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(OCOJ)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22524,0.0463732,-2.89927e-06,-3.97234e-08,2.12776e-11,10853.4,21.4781], Tmin=(100,'K'), Tmax=(946.828,'K')), NASAPolynomial(coeffs=[18.5515,0.00956443,-2.23271e-06,3.97043e-10,-3.31196e-14,5941.33,-69.7775], Tmin=(946.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.2983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(OCOJ)"""),
)

species(
    label = 'CC=[C]OC[O](13561)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46072,0.0436107,-5.2258e-06,-2.99929e-08,1.5976e-11,11071.4,23.2882], Tmin=(100,'K'), Tmax=(967.698,'K')), NASAPolynomial(coeffs=[15.6858,0.0140482,-4.72112e-06,8.80845e-10,-6.59594e-14,6949.31,-51.9455], Tmin=(967.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(91.2007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(OCOJ)"""),
)

species(
    label = '[CH2]C=[C]OCO(13562)',
    structure = SMILES('[CH2]C=[C]OCO'),
    E0 = (15.3019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,186.649,247.537,251.027],'cm^-1')),
        HinderedRotor(inertia=(0.501934,'amu*angstrom^2'), symmetry=1, barrier=(22.0101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.499974,'amu*angstrom^2'), symmetry=1, barrier=(21.9929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483515,'amu*angstrom^2'), symmetry=1, barrier=(21.9786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500791,'amu*angstrom^2'), symmetry=1, barrier=(22.0081,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.938681,0.0435783,2.90798e-05,-9.42585e-08,4.68093e-11,1972.89,24.969], Tmin=(100,'K'), Tmax=(907.318,'K')), NASAPolynomial(coeffs=[26.6406,-0.00651557,7.38657e-06,-1.52886e-09,1.00219e-13,-5293.1,-110.867], Tmin=(907.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.3019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C]=COCO(13563)',
    structure = SMILES('[CH2][C]=COCO'),
    E0 = (13.3995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.06184,'amu*angstrom^2'), symmetry=1, barrier=(24.4138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06227,'amu*angstrom^2'), symmetry=1, barrier=(24.4237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06118,'amu*angstrom^2'), symmetry=1, barrier=(24.3987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06162,'amu*angstrom^2'), symmetry=1, barrier=(24.4087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695347,0.0464196,3.12127e-05,-1.03893e-07,5.2157e-11,1755.27,23.1878], Tmin=(100,'K'), Tmax=(903.684,'K')), NASAPolynomial(coeffs=[29.6071,-0.0111685,9.97166e-06,-2.03534e-09,1.3493e-13,-6344.13,-129.268], Tmin=(903.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.3995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][C]=COC[O](13564)',
    structure = SMILES('[CH2][C]=COC[O]'),
    E0 = (240.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,295.48,295.482,295.482,295.485],'cm^-1')),
        HinderedRotor(inertia=(0.469459,'amu*angstrom^2'), symmetry=1, barrier=(29.0863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.469462,'amu*angstrom^2'), symmetry=1, barrier=(29.0863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.46947,'amu*angstrom^2'), symmetry=1, barrier=(29.0863,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23287,0.0437739,6.10194e-06,-5.38273e-08,2.76958e-11,29076.6,21.7317], Tmin=(100,'K'), Tmax=(934.287,'K')), NASAPolynomial(coeffs=[20.761,0.00365258,7.01419e-07,-1.5657e-10,4.08617e-15,23529.8,-81.3095], Tmin=(934.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(OCOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=[C]OC[O](13565)',
    structure = SMILES('[CH2]C=[C]OC[O]'),
    E0 = (242.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,451.494,452.377,453.657,454.327],'cm^-1')),
        HinderedRotor(inertia=(0.17754,'amu*angstrom^2'), symmetry=1, barrier=(25.7888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177718,'amu*angstrom^2'), symmetry=1, barrier=(25.8178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176934,'amu*angstrom^2'), symmetry=1, barrier=(25.8484,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47225,0.0409707,3.88577e-06,-4.41811e-08,2.23979e-11,29294.4,23.5275], Tmin=(100,'K'), Tmax=(947.674,'K')), NASAPolynomial(coeffs=[17.8504,0.00821131,-1.82971e-06,3.37233e-10,-2.95774e-14,24557,-63.2241], Tmin=(947.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCOJ) + radical(C=CJO) + radical(Allyl_P)"""),
)

species(
    label = '[O]COC1[CH]C1(11770)',
    structure = SMILES('[O]COC1[CH]C1'),
    E0 = (125.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10618,0.0240339,4.88781e-05,-8.33448e-08,3.39729e-11,15201.3,22.2885], Tmin=(100,'K'), Tmax=(965.392,'K')), NASAPolynomial(coeffs=[14.9615,0.0147223,-4.94669e-06,9.8558e-10,-7.83313e-14,10671,-49.886], Tmin=(965.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(OCOJ)"""),
)
...
species(
    label = 'C=C=COCO(13566)',
    structure = SMILES('C=C=COCO'),
    E0 = (-199.337,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.766412,0.0439776,3.83172e-05,-1.11236e-07,5.47174e-11,-23832.8,21.232], Tmin=(100,'K'), Tmax=(905.09,'K')), NASAPolynomial(coeffs=[29.703,-0.0114665,1.01504e-05,-2.06069e-09,1.35914e-13,-32037.9,-131.876], Tmin=(905.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06713,0.0756821,-0.000131928,1.2723e-07,-4.6753e-11,42250.1,25.3329], Tmin=(100,'K'), Tmax=(850.78,'K')), NASAPolynomial(coeffs=[4.1786,0.0360649,-1.8022e-05,3.45157e-09,-2.36559e-13,42625,16.1396], Tmin=(850.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCsJOCs) + radical(OCJO) + radical(RCCJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.30615,'amu*angstrom^2'), symmetry=1, barrier=(30.031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.30849,'amu*angstrom^2'), symmetry=1, barrier=(30.0848,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26705,0.0415798,2.27785e-05,-7.04034e-08,3.29576e-11,26832.8,21.9636], Tmin=(100,'K'), Tmax=(938.641,'K')), NASAPolynomial(coeffs=[19.5788,0.010334,-2.06147e-06,3.45879e-10,-3.05121e-14,21334,-76.2003], Tmin=(938.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet) + radical(OCOJ)"""),
)

species(
    label = 'C=[C]COC[O](13569)',
    structure = SMILES('C=[C]COC[O]'),
    E0 = (147.017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,180,180,681.096,686.977,687.495],'cm^-1')),
        HinderedRotor(inertia=(0.0103082,'amu*angstrom^2'), symmetry=1, barrier=(3.40674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15138,'amu*angstrom^2'), symmetry=1, barrier=(3.48052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15493,'amu*angstrom^2'), symmetry=1, barrier=(26.5542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88598,0.0454513,-3.08585e-05,1.03981e-08,-1.44182e-12,17758.5,22.7032], Tmin=(100,'K'), Tmax=(1617.96,'K')), NASAPolynomial(coeffs=[10.8687,0.0232437,-1.027e-05,1.91475e-09,-1.31012e-13,14851.8,-24.9555], Tmin=(1617.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(OCOJ)"""),
)
...
species(
    label = '[CH]=CCOC[O](13570)',
    structure = SMILES('[CH]=CCOC[O]'),
    E0 = (156.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,301.713,301.716,301.723,1307.99],'cm^-1')),
        HinderedRotor(inertia=(0.107329,'amu*angstrom^2'), symmetry=1, barrier=(6.93549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0187594,'amu*angstrom^2'), symmetry=1, barrier=(22.775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352512,'amu*angstrom^2'), symmetry=1, barrier=(22.7747,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52898,0.0478515,-3.38774e-05,1.17948e-08,-1.64618e-12,18889.4,23.9326], Tmin=(100,'K'), Tmax=(1671.76,'K')), NASAPolynomial(coeffs=[13.6364,0.018882,-7.88408e-06,1.42908e-09,-9.60415e-14,14841.3,-40.7002], Tmin=(1671.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(OCOJ)"""),
)

species(
    label = '[CH]C=COCO(13571)',
    structure = SMILES('[CH]C=COCO'),
    E0 = (-5.25699,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731798,0.0442032,4.79406e-05,-1.20484e-07,5.7395e-11,-488.657,23.4114], Tmin=(100,'K'), Tmax=(907.449,'K')), NASAPolynomial(coeffs=[28.3948,-0.00443606,7.1795e-06,-1.52601e-09,9.97622e-14,-8527.14,-123.989], Tmin=(907.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.25699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C[CH]OC=O(6118)'],
    products = ['[CH2]C=COC[O](12621)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[O](558)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC[O](12621)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][CH][CH]OC=O(6547)'],
    products = ['[CH2]C=COC[O](12621)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]=COC[O](13564)'],
    products = ['[CH2]C=COC[O](12621)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C=[C]OC[O](13565)'],
    products = ['[CH2]C=COC[O](12621)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[CH]O[CH][O](13567)'],
    products = ['[CH2]C=COC[O](12621)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[CH]=COC[O](4558)'],
    products = ['[CH2]C=COC[O](12621)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C=COC[O](13568)'],
    products = ['[CH2]C=COC[O](12621)'],
