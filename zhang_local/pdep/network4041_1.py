...
species(
    label = '[CH]C(=C)OC[CH2](17823)',
    structure = SMILES('[CH]C(=C)OC[CH2]'),
    E0 = (354.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.758721,0.0616193,-3.62574e-05,-9.07927e-10,5.90725e-12,42818.9,24.0643], Tmin=(100,'K'), Tmax=(986.085,'K')), NASAPolynomial(coeffs=[15.5302,0.0224409,-8.21154e-06,1.46184e-09,-1.01513e-13,38897.3,-52.1058], Tmin=(986.085,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])OCC(19138)',
    structure = SMILES('[CH]C(=[CH])OCC'),
    E0 = (390.482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834517,0.05998,-3.32325e-05,-2.64661e-09,6.15658e-12,47086.6,22.8688], Tmin=(100,'K'), Tmax=(993.248,'K')), NASAPolynomial(coeffs=[15.0123,0.0232958,-8.65916e-06,1.55071e-09,-1.07774e-13,43263.3,-50.5034], Tmin=(993.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01926,0.0520461,-4.03066e-05,1.80116e-08,-3.16728e-12,55414.5,22.9246], Tmin=(100,'K'), Tmax=(1619.99,'K')), NASAPolynomial(coeffs=[10.2724,0.0215629,-5.01094e-06,5.76882e-10,-2.77019e-14,53418.4,-23.0877], Tmin=(1619.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C](C)OC=C(17822)',
    structure = SMILES('[CH][C](C)OC=C'),
    E0 = (426.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.669584,0.0627363,-4.38258e-05,1.39636e-09,6.90718e-12,51425.6,24.3455], Tmin=(100,'K'), Tmax=(954.38,'K')), NASAPolynomial(coeffs=[18.647,0.0122696,-3.61173e-06,6.21313e-10,-4.51787e-14,46861.1,-67.4823], Tmin=(954.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C2CsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27191,0.0523935,-3.39304e-05,5.39583e-09,2.01979e-12,21166.7,23.2396], Tmin=(100,'K'), Tmax=(1039.02,'K')), NASAPolynomial(coeffs=[13.1428,0.0204942,-7.80273e-06,1.41552e-09,-9.84468e-14,17954.9,-38.0702], Tmin=(1039.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (86.9389,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,350,440,435,1725,3010,987.5,1337.5,450,1655,287.373,647.378,647.378],'cm^-1')),
        HinderedRotor(inertia=(0.0564075,'amu*angstrom^2'), symmetry=1, barrier=(16.7744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729607,'amu*angstrom^2'), symmetry=1, barrier=(16.7751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729581,'amu*angstrom^2'), symmetry=1, barrier=(16.7745,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.874416,0.0544138,-1.63063e-05,-3.0076e-08,1.88531e-11,28408.5,20.9692], Tmin=(100,'K'), Tmax=(940.098,'K')), NASAPolynomial(coeffs=[19.8744,0.00946651,-1.86316e-06,2.97216e-10,-2.49321e-14,23249.9,-77.9575], Tmin=(940.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=C1CC(C)O1(19135)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67263,0.0305303,5.32847e-05,-1.05339e-07,4.753e-11,18797.8,16.267], Tmin=(100,'K'), Tmax=(903.822,'K')), NASAPolynomial(coeffs=[19.4156,0.0066999,2.06309e-06,-6.04369e-10,4.03854e-14,13356.5,-79.8969], Tmin=(903.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(Cds_P)"""),
)
...
species(
    label = '[C]C(=C)O[CH]C(19145)',
    structure = SMILES('[C]C(=C)O[CH]C'),
    E0 = (636.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.807946,'amu*angstrom^2'), symmetry=1, barrier=(18.5763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.809088,'amu*angstrom^2'), symmetry=1, barrier=(18.6025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807452,'amu*angstrom^2'), symmetry=1, barrier=(18.5649,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0966995,0.0725895,-7.95069e-05,4.11703e-08,-8.01857e-12,76657.8,22.6291], Tmin=(100,'K'), Tmax=(1383.99,'K')), NASAPolynomial(coeffs=[20.809,0.00644325,-1.00577e-06,7.58293e-11,-2.79716e-15,71526.5,-81.8527], Tmin=(1383.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJ3) + radical(CCsJOC(O))"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(139.794,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=C)OC=C(17885)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH]C(=C)O[CH][CH2](17824)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]C(=[CH])O[CH]C(19139)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(32)', '[CH]C(=C)[O](9170)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH3](11)', '[CH]OC([CH])=C(19086)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]C(=C)O[C]C(19141)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(28)', 'C#CO[CH]C(5271)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', '[CH]=[C]O[CH]C(5272)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[C]C(=C)O[CH]C(19145)'],
    products = ['[CH]C(=C)O[CH]C(17700)'],
