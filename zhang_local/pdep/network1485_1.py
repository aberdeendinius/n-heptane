...
species(
    ...
    E0 = (426.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,750,770,3400,2100,3010,987.5,1337.5,450,1655,2175,525,180],'cm^-1')),
        HinderedRotor(inertia=(1.42865,'amu*angstrom^2'), symmetry=1, barrier=(32.8474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42126,'amu*angstrom^2'), symmetry=1, barrier=(32.6777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
...
species(
    label = '[CH][CH]OC#C(5333)',
    structure = SMILES('[CH][CH]OC#C'),
    E0 = (652.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2175,525,750,770,3400,2100,375.751,375.771,375.778,375.815,375.998],'cm^-1')),
        HinderedRotor(inertia=(0.251544,'amu*angstrom^2'), symmetry=1, barrier=(25.2246,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251471,'amu*angstrom^2'), symmetry=1, barrier=(25.2309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251568,'amu*angstrom^2'), symmetry=1, barrier=(25.2242,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674695,0.0595197,-7.36985e-05,4.03562e-08,-8.02263e-12,78608,18.5234], Tmin=(100,'K'), Tmax=(1441.58,'K')), NASAPolynomial(coeffs=[19.1597,-0.0031408,3.33175e-06,-7.3795e-10,5.27477e-14,74459.8,-73.3193], Tmin=(1441.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(652.491,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#CO[C]=C(5329)'],
    products = ['[CH]=CO[C]=C(5180)'],
    transitionState = 'TS2',
