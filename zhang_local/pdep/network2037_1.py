...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370194,0.0894571,-0.000134593,1.21673e-07,-4.37648e-11,-2028.7,32.7839], Tmin=(100,'K'), Tmax=(830.282,'K')), NASAPolynomial(coeffs=[5.67089,0.0454163,-2.15984e-05,4.10279e-09,-2.82065e-13,-2271.11,12.0379], Tmin=(830.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = 'CC([O])C=CCO[O](7449)',
    structure = SMILES('CC([O])C=CCO[O]'),
    E0 = (75.3806,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,276.129,276.129,4000],'cm^-1')),
        HinderedRotor(inertia=(0.180937,'amu*angstrom^2'), symmetry=1, barrier=(9.79,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180939,'amu*angstrom^2'), symmetry=1, barrier=(9.79,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324044,'amu*angstrom^2'), symmetry=1, barrier=(17.5327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.397713,'amu*angstrom^2'), symmetry=1, barrier=(21.5191,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.82176,0.0706111,-6.01268e-05,2.77548e-08,-5.36619e-12,9179.93,31.6437], Tmin=(100,'K'), Tmax=(1204.53,'K')), NASAPolynomial(coeffs=[11.6965,0.0344973,-1.51531e-05,2.86268e-09,-1.99699e-13,6560.21,-22.8439], Tmin=(1204.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.3806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'CC([O])CC=CO[O](7450)',
    structure = SMILES('CC([O])CC=CO[O]'),
    E0 = (85.2952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,319.11,319.229,322.303],'cm^-1')),
        HinderedRotor(inertia=(0.127857,'amu*angstrom^2'), symmetry=1, barrier=(9.51393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130239,'amu*angstrom^2'), symmetry=1, barrier=(9.52307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129245,'amu*angstrom^2'), symmetry=1, barrier=(9.52719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129562,'amu*angstrom^2'), symmetry=1, barrier=(9.52145,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.352289,0.0763991,-7.09103e-05,3.48386e-08,-6.90797e-12,10393.2,32.2428], Tmin=(100,'K'), Tmax=(1210.76,'K')), NASAPolynomial(coeffs=[14.8934,0.0283594,-1.13944e-05,2.06809e-09,-1.41458e-13,6872.01,-40.6907], Tmin=(1210.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.2952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.174822,0.0900188,-0.000110951,8.24837e-08,-2.57335e-11,17219.5,32.1291], Tmin=(100,'K'), Tmax=(772.929,'K')), NASAPolynomial(coeffs=[9.26424,0.0429766,-1.96509e-05,3.72982e-09,-2.59141e-13,15814.5,-9.38031], Tmin=(772.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(CC(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'CC([O])C[CH][CH]OO(7453)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0109141,0.0949468,-0.000119429,8.83666e-08,-2.72953e-11,23047.9,34.346], Tmin=(100,'K'), Tmax=(781.056,'K')), NASAPolynomial(coeffs=[10.0424,0.0434593,-2.05452e-05,3.96112e-09,-2.77807e-13,21477.5,-11.6706], Tmin=(781.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(CCJCOOH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.100124,0.0975536,-0.000137357,1.14009e-07,-3.84122e-11,15789.9,32.3808], Tmin=(100,'K'), Tmax=(815.422,'K')), NASAPolynomial(coeffs=[9.08773,0.0430627,-1.97891e-05,3.72091e-09,-2.5521e-13,14604.7,-8.15006], Tmin=(815.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.116,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321025,0.0853314,-8.8103e-05,5.10088e-08,-1.23573e-11,24399.8,35.5018], Tmin=(100,'K'), Tmax=(980.548,'K')), NASAPolynomial(coeffs=[11.5133,0.0396722,-1.82525e-05,3.51598e-09,-2.48011e-13,22205,-18.2741], Tmin=(980.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)

species(
    label = 'C[C]([O])C[CH]COO(7459)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.325987,0.103017,-0.000148042,1.23322e-07,-4.17425e-11,21620,34.7379], Tmin=(100,'K'), Tmax=(796.174,'K')), NASAPolynomial(coeffs=[9.93792,0.0434131,-2.06028e-05,3.93246e-09,-2.72191e-13,20240.4,-10.84], Tmin=(796.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.114243,0.100066,-0.000155059,1.35597e-07,-4.66726e-11,39892.7,34.7347], Tmin=(100,'K'), Tmax=(844.755,'K')), NASAPolynomial(coeffs=[8.50245,0.0414803,-1.94494e-05,3.65244e-09,-2.48745e-13,39071.4,-1.62606], Tmin=(844.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CCJCOOH) + radical(CC(C)OJ) + radical(ROOJ)"""),
)

species(
    label = 'CC([O])[CH][CH]CO[O](7462)',
    structure = SMILES('CC([O])[CH][CH]CO[O]'),
    E0 = (353.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432271,0.0835577,-9.92779e-05,6.89598e-08,-1.99612e-11,42676.9,35.8601], Tmin=(100,'K'), Tmax=(831.993,'K')), NASAPolynomial(coeffs=[9.88752,0.0381002,-1.73238e-05,3.29208e-09,-2.29418e-13,41103.5,-8.01709], Tmin=(831.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCO) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([O])C[CH][CH]O[O](7463)',
    structure = SMILES('CC([O])C[CH][CH]O[O]'),
    E0 = (342.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0676194,0.093765,-0.00013367,1.11732e-07,-3.7856e-11,41326.1,34.8085], Tmin=(100,'K'), Tmax=(812.601,'K')), NASAPolynomial(coeffs=[8.8928,0.041004,-1.90748e-05,3.60347e-09,-2.47744e-13,40199.6,-4.04327], Tmin=(812.601,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61551,0.0661126,1.82664e-06,-1.74586e-07,1.86006e-10,-26183.2,26.3385], Tmin=(100,'K'), Tmax=(431.047,'K')), NASAPolynomial(coeffs=[6.60028,0.046339,-2.15244e-05,4.06745e-09,-2.79526e-13,-26858.9,3.63083], Tmin=(431.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-218.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0728548,0.0818205,-7.22214e-05,3.2711e-08,-5.92019e-12,-7870.25,33.0137], Tmin=(100,'K'), Tmax=(1327.06,'K')), NASAPolynomial(coeffs=[17.8616,0.0277632,-1.11196e-05,2.01581e-09,-1.3765e-13,-12630.3,-58.5844], Tmin=(1327.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.7095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.492856,0.0652836,-1.79823e-05,-3.12338e-08,2.01708e-11,-4173.51,27.8714], Tmin=(100,'K'), Tmax=(899.048,'K')), NASAPolynomial(coeffs=[16.7475,0.0257461,-6.71143e-06,9.65992e-10,-6.1001e-14,-8421.12,-56.1863], Tmin=(899.048,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.8429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])C[CH]C[O](7471)',
    structure = SMILES('CC([O])C[CH]C[O]'),
    E0 = (155.586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35104,0.0633857,-5.22842e-05,2.68907e-08,-6.40846e-12,18803.7,29.6012], Tmin=(100,'K'), Tmax=(940.271,'K')), NASAPolynomial(coeffs=[6.15075,0.0429669,-1.971e-05,3.79465e-09,-2.67573e-13,17901.1,6.74099], Tmin=(940.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.155154,0.0898697,-0.000111804,7.9419e-08,-2.32072e-11,48447.4,31.958], Tmin=(100,'K'), Tmax=(828.569,'K')), NASAPolynomial(coeffs=[10.9872,0.0375777,-1.71391e-05,3.25247e-09,-2.2618e-13,46652.4,-18.2635], Tmin=(828.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC(=O)C[CH]CO[O](6872)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CC([O])C=CCO[O](7449)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'CC([O])CC=CO[O](7450)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', '[O]OC[CH]CC=O(6959)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['CC([O])C[CH][CH]OO(7453)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH2][CH]CC(C)[O](830)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[O][CH]C[CH]CO[O](7367)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[C]([O])C[CH]CO[O](7461)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'CC([O])[CH][CH]CO[O](7462)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', 'CC([O])C[CH][CH]O[O](7463)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CC([O])C[CH]CO[O](6938)'],
    products = ['C=CCC(C)[O](840)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(S)(14)', '[O]CC[CH]CO[O](6835)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CC([O])C[CH]CO[O](6938)'],
    products = ['O(T)(63)', 'CC([O])CC1CO1(7469)'],
...
reaction(
    label = 'reaction39',
    reactants = ['O(T)(63)', 'CC([O])C[CH]C[O](7471)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction40',
    reactants = ['O(T)(63)', 'C[CH]C[CH]CO[O](7018)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(C)[O](442)', '[CH]CO[O](7037)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]O[O](61)', '[CH]CC(C)[O](3675)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(8)', 'CC([O])C[C]CO[O](7472)'],
    products = ['CC([O])C[CH]CO[O](6938)'],
