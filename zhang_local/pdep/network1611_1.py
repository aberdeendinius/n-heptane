species(
    ...
    E0 = (130.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9499,0.0714874,-9.39042e-05,6.89301e-08,-2.05944e-11,18726.4,27.058], Tmin=(100,'K'), Tmax=(814.03,'K')), NASAPolynomial(coeffs=[9.91751,0.0274207,-1.27005e-05,2.42434e-09,-1.68925e-13,17266.5,-14.3601], Tmin=(814.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO) + radical(CJCO)"""),
)
...
species(
    ...
    E0 = (123.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3615,1277.5,1000,360,370,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (335.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.036259,0.0740683,-7.94089e-05,4.1171e-08,-8.0673e-12,-15608.3,23.3336], Tmin=(100,'K'), Tmax=(1379.05,'K')), NASAPolynomial(coeffs=[20.1191,0.00924161,-1.74445e-06,1.68554e-10,-7.4196e-15,-20522.1,-77.742], Tmin=(1379.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-131.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
species(
    ...
    E0 = (-174.149,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,301.417,301.429,301.429],'cm^-1')),
        HinderedRotor(inertia=(0.289987,'amu*angstrom^2'), symmetry=1, barrier=(18.697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289988,'amu*angstrom^2'), symmetry=1, barrier=(18.6971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289985,'amu*angstrom^2'), symmetry=1, barrier=(18.697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289985,'amu*angstrom^2'), symmetry=1, barrier=(18.697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]C(O)O[CH][CH2](5743)',
    structure = SMILES('[CH]C(O)O[CH][CH2]'),
    E0 = (366.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.664119,0.0762294,-0.000104596,7.38846e-08,-2.05384e-11,44216.2,27.2092], Tmin=(100,'K'), Tmax=(884.289,'K')), NASAPolynomial(coeffs=[13.1535,0.0197344,-8.76351e-06,1.63568e-09,-1.12469e-13,42007.3,-31.5087], Tmin=(884.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJCO) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.664113,0.0762294,-0.000104596,7.38848e-08,-2.05385e-11,44216.2,27.2092], Tmin=(100,'K'), Tmax=(884.249,'K')), NASAPolynomial(coeffs=[13.1534,0.0197344,-8.76353e-06,1.63569e-09,-1.12469e-13,42007.3,-31.5086], Tmin=(884.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJ2_triplet) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C](O)OC=C(1066)', 'H(8)'],
...
reaction(
    label = 'reaction4',
    reactants = ['OH(D)(132)', '[CH2][CH]OC=C(694)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1862.47,'m^3/(mol*s)'), n=1.015, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;OJ_pri] for rate rule [Cds-OsH_Cds;OJ_pri]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction12',
    reactants = ['OH(D)(132)', '[CH2][CH]O[CH][CH2](720)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]O[C]([CH2])O(1061)', 'H(8)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([O])O(670)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]O[CH]O(1005)', 'CH2(T)(28)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]C(O)O[CH][CH2](5743)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]OC([CH2])O(5744)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH][CH]OC([CH2])O(5745)'],
    products = ['[CH2][CH]OC([CH2])O(3819)'],
