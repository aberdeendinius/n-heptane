...
species(
    label = '[CH2]OC(=C)C[C]=O(9749)',
    structure = SMILES('[CH2]OC(=C)C[C]=O'),
    E0 = (62.9549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,1855,455,950,2950,3100,1380,975,1025,1650,508.324,508.637,509.172],'cm^-1')),
        HinderedRotor(inertia=(0.000650333,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0820574,'amu*angstrom^2'), symmetry=1, barrier=(15.0773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0820915,'amu*angstrom^2'), symmetry=1, barrier=(15.0746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0822279,'amu*angstrom^2'), symmetry=1, barrier=(15.0818,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0592,0.0529566,-2.46077e-05,-8.86445e-09,7.27971e-12,7687.69,27.2216], Tmin=(100,'K'), Tmax=(1061.13,'K')), NASAPolynomial(coeffs=[16.6803,0.0176346,-7.98541e-06,1.61899e-09,-1.2046e-13,3045.9,-55.3191], Tmin=(1061.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.9549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=COCJ) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH2]C1(C=C=O)CO1(9751)',
    structure = SMILES('[CH2]C1(C=C=O)CO1'),
    E0 = (64.737,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2120,512.5,787.5,2750,3150,900,1100,3010,987.5,1337.5,450,1655,180,180,180,180,396.949,1600,1800,1847.45,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.121656,'amu*angstrom^2'), symmetry=1, barrier=(2.7971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121656,'amu*angstrom^2'), symmetry=1, barrier=(2.7971,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160165,0.0871652,-0.000132624,1.00231e-07,-2.80755e-11,7921.98,20.4611], Tmin=(100,'K'), Tmax=(1050.68,'K')), NASAPolynomial(coeffs=[13.5339,0.016408,-3.27932e-06,1.86194e-10,6.10602e-15,6206.95,-39.5082], Tmin=(1050.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cdd-O2d)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC1([CH]O1)C[C]=O(9753)',
    structure = SMILES('CC1([CH]O1)C[C]=O'),
    E0 = (91.909,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.251406,0.0734397,-8.39882e-05,4.94909e-08,-1.09353e-11,11196.9,25.5084], Tmin=(100,'K'), Tmax=(1296.83,'K')), NASAPolynomial(coeffs=[15.4288,0.0144362,-1.64136e-06,-8.95679e-11,2.00008e-14,8285.42,-47.7067], Tmin=(1296.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(91.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCCJ=O) + radical(CCsJO)"""),
)

species(
    label = 'CC1([CH][C]=O)CO1(9754)',
    structure = SMILES('CC1([CH][C]=O)CO1'),
    E0 = (108.089,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586742,0.0653427,-6.83549e-05,3.83192e-08,-8.13128e-12,13131.4,26.6005], Tmin=(100,'K'), Tmax=(1354.95,'K')), NASAPolynomial(coeffs=[13.3734,0.0167879,-2.6387e-06,9.89994e-11,6.75306e-15,10658.3,-35.3113], Tmin=(1354.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C1([CH]O1)CC=O(9755)',
    structure = SMILES('[CH2]C1([CH]O1)CC=O'),
    E0 = (142.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2950,1000,3000,3100,440,815,1455,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169315,0.0808674,-0.000103908,6.85315e-08,-1.70534e-11,17274.7,24.7404], Tmin=(100,'K'), Tmax=(1136.31,'K')), NASAPolynomial(coeffs=[15.14,0.016319,-3.05811e-06,1.86684e-10,2.16704e-15,14637.5,-46.0313], Tmin=(1136.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH]O1)C[C]=O(9756)',
    structure = SMILES('[CH2]C1([CH]O1)C[C]=O'),
    E0 = (302.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.113511,0.0836608,-0.0001185,8.24437e-08,-2.12389e-11,36514.3,25.7575], Tmin=(100,'K'), Tmax=(1123.91,'K')), NASAPolynomial(coeffs=[15.6799,0.0119095,-9.16586e-07,-2.46701e-10,3.38449e-14,34047.9,-46.5657], Tmin=(1123.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C1([CH][C]=O)CO1(9757)',
    structure = SMILES('[CH2]C1([CH][C]=O)CO1'),
    E0 = (318.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,3150,900,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.491133,0.0750887,-0.000101313,6.94105e-08,-1.77073e-11,38446.8,26.6963], Tmin=(100,'K'), Tmax=(1138.26,'K')), NASAPolynomial(coeffs=[13.6648,0.0142238,-1.90351e-06,-5.88355e-11,2.05537e-14,36391.8,-34.4184], Tmin=(1138.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CJC(C)OC) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.422594,0.0754923,-9.312e-05,6.094e-08,-1.51386e-11,-17400.8,19.7642], Tmin=(100,'K'), Tmax=(1144.7,'K')), NASAPolynomial(coeffs=[13.3804,0.0188375,-3.97386e-06,3.40324e-10,-7.73323e-15,-19622.1,-41.2452], Tmin=(1144.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cdd-O2d)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'O=[C]C[C]1CCO1(9759)',
    structure = SMILES('O=[C]C[C]1CCO1'),
    E0 = (101.342,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38137,0.058311,-6.51824e-05,4.52233e-08,-1.25281e-11,12282.2,24.5013], Tmin=(100,'K'), Tmax=(1030.51,'K')), NASAPolynomial(coeffs=[7.31483,0.0274109,-8.75074e-06,1.30613e-09,-7.62093e-14,11477.1,-2.27534], Tmin=(1030.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Oxetane) + radical(CCCJ=O) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0119927,0.104315,-0.000201388,1.90851e-07,-6.67017e-11,43188.2,29.5793], Tmin=(100,'K'), Tmax=(893.813,'K')), NASAPolynomial(coeffs=[6.78398,0.034099,-1.65739e-05,3.04802e-09,-2.00291e-13,43571.8,6.58664], Tmin=(893.813,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH]C1(C[C]=O)CO1(9763)',
    structure = SMILES('[CH]C1(C[C]=O)CO1'),
    E0 = (356.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1855,455,950,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557589,0.0710458,-8.75298e-05,5.58649e-08,-1.34028e-11,42993.3,25.2129], Tmin=(100,'K'), Tmax=(1193.41,'K')), NASAPolynomial(coeffs=[13.8042,0.0149462,-2.31189e-06,4.50559e-11,1.15217e-14,40664.8,-37.5457], Tmin=(1193.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C[C]=O(9749)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(59.1679,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(C=C=O)CO1(9751)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C1(C[C]=O)CO1(9306)'],
    products = ['[CH2]C1(C=C[O])CO1(9752)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C1([CH]O1)CC=O(9755)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C[C]=O(9756)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2]C1([CH][C]=O)CO1(9757)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C[C]=O(6470)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[C]([CH2])C[C]=O(9760)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[C-]#[O+](374)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[C]=O(1149)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C1(C[C]=O)CO1(9763)'],
    products = ['[CH2]C1(C[C]=O)CO1(9306)'],
