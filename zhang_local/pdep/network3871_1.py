...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14117,0.0245946,4.37012e-05,-7.70617e-08,3.18214e-11,75447.1,18.5115], Tmin=(100,'K'), Tmax=(958.486,'K')), NASAPolynomial(coeffs=[14.2489,0.01478,-4.65527e-06,8.89157e-10,-6.95205e-14,71255.9,-49.1437], Tmin=(958.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(626.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJ2_triplet) + radical(Neopentyl)"""),
)
...
species(
    label = '[CH]C(=[CH])CC(18835)',
    structure = SMILES('[CH]C(=[CH])CC'),
    E0 = (562.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,366.525,366.526,366.526],'cm^-1')),
        HinderedRotor(inertia=(0.538501,'amu*angstrom^2'), symmetry=1, barrier=(51.336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538501,'amu*angstrom^2'), symmetry=1, barrier=(51.336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538499,'amu*angstrom^2'), symmetry=1, barrier=(51.336,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68231,0.0442599,-1.74827e-05,-3.58488e-09,3.25005e-12,67706.6,19.9758], Tmin=(100,'K'), Tmax=(1106.98,'K')), NASAPolynomial(coeffs=[9.35357,0.0280645,-1.1153e-05,2.0075e-09,-1.36834e-13,65302.1,-21.0025], Tmin=(1106.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(562.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62893,0.0208917,3.07859e-05,-4.67258e-08,1.70607e-11,73987.4,18.1983], Tmin=(100,'K'), Tmax=(1024.83,'K')), NASAPolynomial(coeffs=[7.11538,0.0262745,-1.06015e-05,1.99526e-09,-1.41875e-13,71865.6,-9.42188], Tmin=(1024.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(614.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCJ2_triplet) + radical(Tertalkyl)"""),
)

species(
    label = '[CH]C([CH2])[CH][CH2](18839)',
    structure = SMILES('[CH]C([CH2])[CH][CH2]'),
    E0 = (879.307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1119.31,1119.31,1119.35,1119.36],'cm^-1')),
        HinderedRotor(inertia=(0.00501328,'amu*angstrom^2'), symmetry=1, barrier=(4.45595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193754,'amu*angstrom^2'), symmetry=1, barrier=(4.45479,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193762,'amu*angstrom^2'), symmetry=1, barrier=(4.45498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00501654,'amu*angstrom^2'), symmetry=1, barrier=(4.45746,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9938,0.0435134,-3.26328e-05,1.41522e-08,-2.65241e-12,105829,25.8975], Tmin=(100,'K'), Tmax=(1221.13,'K')), NASAPolynomial(coeffs=[7.62383,0.0250715,-9.97927e-06,1.78472e-09,-1.20429e-13,104454,-2.38886], Tmin=(1221.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(879.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(Cs_S) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16559,0.0296292,1.69728e-05,-4.23228e-08,1.80765e-11,50373.1,18.7944], Tmin=(100,'K'), Tmax=(975.303,'K')), NASAPolynomial(coeffs=[11.044,0.0191738,-6.86961e-06,1.26368e-09,-9.10987e-14,47406.7,-30.1461], Tmin=(975.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(418.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C1CCC1(18829)',
    ...
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[11.888,-0.0385642,0.000159085,-1.40995e-07,3.203e-11,41386.5,-25.468], Tmin=(100,'K'), Tmax=(1697.17,'K')), NASAPolynomial(coeffs=[66.2673,0.0283083,-7.23974e-05,1.76463e-08,-1.31294e-12,-5160.63,-399.334], Tmin=(1697.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Cds_P)"""),
)
...
species(
    label = '[C]C(=C)C[CH2](18845)',
    structure = SMILES('[C]C(=C)C[CH2]'),
    E0 = (819.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,796.657,799.306],'cm^-1')),
        HinderedRotor(inertia=(0.599956,'amu*angstrom^2'), symmetry=1, barrier=(13.7942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600728,'amu*angstrom^2'), symmetry=1, barrier=(13.8119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75745,0.0434769,-3.12039e-05,9.53761e-09,-5.40112e-13,98606.3,19.1262], Tmin=(100,'K'), Tmax=(1115.15,'K')), NASAPolynomial(coeffs=[11.1627,0.0175433,-6.81546e-06,1.23181e-09,-8.46575e-14,96023.5,-29.4488], Tmin=(1115.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(819.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(CJ3)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C(=C)C[CH2](17540)'],
    products = ['[CH]C1([CH2])CC1(18833)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(106.27,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=C)C=C(17773)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH]C([CH2])=C[CH2](18836)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]C(=[CH])C[CH2](18837)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C([CH2])[CH][CH2](18839)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(28)', '[CH]C([CH2])=C(18776)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]CC([CH])=C(18840)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(28)', 'C#CC[CH2](5183)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(28)', '[CH]=[C]C[CH2](5188)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[C]C(=C)C[CH2](18845)'],
    products = ['[CH]C(=C)C[CH2](17540)'],
