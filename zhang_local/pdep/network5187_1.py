...
species(
    label = '[CH2]C([CH2])([O])C(O)=C=C(29918)',
    structure = SMILES('[CH2]C([CH2])([O])C(O)=C=C'),
    E0 = (343.861,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,540,610,2055,3615,1277.5,1000,350,440,435,1725,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294611,0.0917923,-0.000108,6.41916e-08,-1.4892e-11,41513.9,32.4782], Tmin=(100,'K'), Tmax=(1059.92,'K')), NASAPolynomial(coeffs=[18.3744,0.0213384,-8.29445e-06,1.47961e-09,-1.00489e-13,37556.4,-58.6757], Tmin=(1059.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = 'C#CC(O)C([CH2])([CH2])[O](29919)',
    structure = SMILES('C#CC(O)C([CH2])([CH2])[O]'),
    E0 = (391.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,750,770,3400,2100,3615,1277.5,1000,2175,525,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.68776,0.105981,-0.000148026,1.03405e-07,-2.75989e-11,47259.5,31.4564], Tmin=(100,'K'), Tmax=(804.664,'K')), NASAPolynomial(coeffs=[17.7896,0.0227663,-9.00355e-06,1.56426e-09,-1.0243e-13,44006.3,-55.4078], Tmin=(804.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CJC(C)2O)"""),
)
...
species(
    label = '[CH2][C]=C(O)C([CH2])([CH2])O(29920)',
    structure = SMILES('[CH2][C]=C(O)C([CH2])([CH2])O'),
    E0 = (327.495,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.847576,0.101754,-0.000122797,7.21503e-08,-1.59146e-11,39567.5,34.9469], Tmin=(100,'K'), Tmax=(948.534,'K')), NASAPolynomial(coeffs=[21.455,0.0176826,-5.62922e-06,8.91796e-10,-5.67871e-14,34887.6,-73.8381], Tmin=(948.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=C(O)C([CH2])(C)[O](29921)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.40234,0.0901733,-9.62976e-05,5.21918e-08,-1.10573e-11,41436.1,34.3812], Tmin=(100,'K'), Tmax=(1158.39,'K')), NASAPolynomial(coeffs=[19.3385,0.0220055,-8.02546e-06,1.38919e-09,-9.29884e-14,36862.7,-63.7591], Tmin=(1158.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(Allyl_P) + radical(C=CC(C)2OJ) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]C(O)C([CH2])([CH2])O(29922)',
    structure = SMILES('[CH]=[C]C(O)C([CH2])([CH2])O'),
    E0 = (481.627,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,3580,3650,1210,1345,900,1100,3120,650,792.5,1650,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01676,0.115635,-0.000174712,1.34825e-07,-4.06242e-11,58102,35.8304], Tmin=(100,'K'), Tmax=(841.985,'K')), NASAPolynomial(coeffs=[17.1477,0.0267511,-1.17509e-05,2.14116e-09,-1.43381e-13,55135,-48.1334], Tmin=(841.985,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]C(O)C([CH2])(C)[O](29923)',
    structure = SMILES('[CH]=[C]C(O)C([CH2])(C)[O]'),
    E0 = (498.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.323403,0.0990076,-0.000127948,8.71733e-08,-2.36462e-11,60111.2,34.2667], Tmin=(100,'K'), Tmax=(901.43,'K')), NASAPolynomial(coeffs=[15.1718,0.0302482,-1.35291e-05,2.55165e-09,-1.77125e-13,57317.7,-38.8804], Tmin=(901.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)2OJ) + radical(Cds_P) + radical(Cds_S) + radical(CJC(C)2O)"""),
)
...
species(
    label = '[CH2][C]=C(O)C([CH2])([CH2])[O](29924)',
    structure = SMILES('[CH2][C]=C(O)C([CH2])([CH2])[O]'),
    E0 = (556.598,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.339577,0.0939149,-0.000113945,6.99933e-08,-1.67881e-11,67100.9,34.3412], Tmin=(100,'K'), Tmax=(1025.75,'K')), NASAPolynomial(coeffs=[18.13,0.0218912,-8.62117e-06,1.54007e-09,-1.04397e-13,63311.9,-55.2333], Tmin=(1025.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(556.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ) + radical(Allyl_P) + radical(C=CC(C)(O)CJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]C(O)C([CH2])([CH2])[O](29925)',
    structure = SMILES('[CH]=[C]C(O)C([CH2])([CH2])[O]'),
    E0 = (710.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,3615,1277.5,1000,3120,650,792.5,1650,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.789758,0.111564,-0.000172271,1.36594e-07,-4.24143e-11,85625.2,35.0766], Tmin=(100,'K'), Tmax=(828.759,'K')), NASAPolynomial(coeffs=[15.8187,0.0273911,-1.26626e-05,2.3615e-09,-1.60253e-13,83010.1,-41.0988], Tmin=(828.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(710.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([CH2])(O)C(O)=C=C(29926)',
    structure = SMILES('[CH2]C([CH2])(O)C(O)=C=C'),
    E0 = (114.758,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.774367,0.0992835,-0.000115577,6.4629e-08,-1.32635e-11,13979.3,32.9836], Tmin=(100,'K'), Tmax=(948.119,'K')), NASAPolynomial(coeffs=[21.5515,0.017384,-5.45021e-06,8.66427e-10,-5.5804e-14,9193.39,-76.4497], Tmin=(948.119,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C(C)([O])C(O)=C=C(29927)',
    structure = SMILES('[CH2]C(C)([O])C(O)=C=C'),
    E0 = (130.418,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.401689,0.0885453,-9.19531e-05,4.82873e-08,-9.89675e-12,15851.1,32.679], Tmin=(100,'K'), Tmax=(1197.59,'K')), NASAPolynomial(coeffs=[19.7796,0.0211393,-7.52663e-06,1.28956e-09,-8.59263e-14,11017.3,-68.3233], Tmin=(1197.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([CH][C]=C)OO(29929)',
    structure = SMILES('[CH2]C([CH2])([CH][C]=C)OO'),
    E0 = (599.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.528316,0.101175,-0.000121099,7.45844e-08,-1.82145e-11,72283.3,32.6878], Tmin=(100,'K'), Tmax=(999.342,'K')), NASAPolynomial(coeffs=[17.4664,0.0291483,-1.29881e-05,2.46331e-09,-1.72431e-13,68686.8,-54.1147], Tmin=(999.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(599.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(CJCOOH) + radical(Cds_S) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C]([O])C(O)[C]=C(28667)',
    structure = SMILES('[CH2][C]([O])C(O)[C]=C'),
    E0 = (470.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,268.743,268.75,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00233408,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311045,'amu*angstrom^2'), symmetry=1, barrier=(15.942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419988,'amu*angstrom^2'), symmetry=1, barrier=(21.5257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311053,'amu*angstrom^2'), symmetry=1, barrier=(15.9421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.547209,0.0799303,-0.000109383,7.95329e-08,-2.30278e-11,56749.7,30.6891], Tmin=(100,'K'), Tmax=(846.005,'K')), NASAPolynomial(coeffs=[12.2707,0.0245022,-1.11091e-05,2.0938e-09,-1.44648e-13,54766.1,-23.9096], Tmin=(846.005,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO) + radical(Cds_S) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C(O)[C]=C(29930)',
    structure = SMILES('[CH]C([CH2])([O])C(O)[C]=C'),
    E0 = (699.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,1685,370,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.32315,0.0988037,-0.000131794,9.0843e-08,-2.4734e-11,84300.4,34.8657], Tmin=(100,'K'), Tmax=(900.835,'K')), NASAPolynomial(coeffs=[15.8602,0.026944,-1.21387e-05,2.29126e-09,-1.58966e-13,81384.7,-41.5196], Tmin=(900.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(699.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)2OJ) + radical(CCJ2_triplet) + radical(Cds_S) + radical(CJC(C)2O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C(O)=C=C(29918)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CC(O)C([CH2])([CH2])[O](29919)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=[C]C(O)C(=C)[O](14497)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', '[CH2]C(=C)C(O)[C]=C(18301)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(188.488,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 186.9 to 188.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', '[CH2]C([CH2])([O])C=C=C(18334)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    products = ['[CH2][C]=C(O)C([CH2])([CH2])O(29920)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    products = ['[CH2][C]=C(O)C([CH2])(C)[O](29921)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    products = ['[CH2]C(C)([O])C([O])[C]=C(16016)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(O)C([CH2])([CH2])O(29922)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]C(O)C([CH2])(C)[O](29923)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(D)(132)', '[CH2]C([CH2])([O])[CH][C]=C(18340)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]=C(O)C([CH2])([CH2])[O](29924)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]=[C]C(O)C([CH2])([CH2])[O](29925)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    products = ['[CH2]C([CH2])(O)C(O)=C=C(29926)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    products = ['[CH2]C(C)([O])C(O)=C=C(29927)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH2])([CH][C]=C)OO(29929)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C(O)[C]=C(28508)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(T)(28)', '[CH2][C]([O])C(O)[C]=C(28667)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[C]=C(584)', '[CH2]C([CH2])([O])[CH]O(10521)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C([CH2])([O])C(O)[C]=C(29930)'],
    products = ['[CH2]C([CH2])([O])C(O)[C]=C(16014)'],
