...
species(
    ...
    E0 = (-25.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,273.346],'cm^-1')),
        HinderedRotor(inertia=(0.302901,'amu*angstrom^2'), symmetry=1, barrier=(16.1042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0022418,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.30458,'amu*angstrom^2'), symmetry=1, barrier=(16.1115,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74737,0.0520372,-4.94714e-05,2.87643e-08,-7.24981e-12,7908.68,21.2672], Tmin=(100,'K'), Tmax=(932.158,'K')), NASAPolynomial(coeffs=[7.09925,0.0290718,-1.25165e-05,2.33486e-09,-1.61613e-13,6910.91,-4.17653], Tmin=(932.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.0998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79499,0.0417469,-1.70399e-05,-5.22695e-09,4.43754e-12,10714.1,24.1601], Tmin=(100,'K'), Tmax=(1041.52,'K')), NASAPolynomial(coeffs=[10.1682,0.022764,-8.67518e-06,1.56437e-09,-1.07963e-13,8255.38,-20.0069], Tmin=(1041.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)CC(5588)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51533,0.0570083,-6.06377e-05,3.81914e-08,-1.00899e-11,8679.97,20.9463], Tmin=(100,'K'), Tmax=(906.279,'K')), NASAPolynomial(coeffs=[8.22021,0.0274132,-1.1651e-05,2.15397e-09,-1.48128e-13,7464.75,-10.7405], Tmin=(906.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.4425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOH)"""),
)
...
species(
    ...
    E0 = (276.689,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,360,370,350,1715.08],'cm^-1')),
        HinderedRotor(inertia=(0.00169829,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124411,'amu*angstrom^2'), symmetry=1, barrier=(8.76344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124411,'amu*angstrom^2'), symmetry=1, barrier=(8.76344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124411,'amu*angstrom^2'), symmetry=1, barrier=(8.76344,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    label = '[CH]C(O)C[CH2](5590)',
    structure = SMILES('[CH]C(O)C[CH2]'),
    E0 = (336.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1380,1390,370,380,2900,435,359.754,364.204,1235.98,1239.87],'cm^-1')),
        HinderedRotor(inertia=(0.0664836,'amu*angstrom^2'), symmetry=1, barrier=(6.1452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00130424,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00128759,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0660671,'amu*angstrom^2'), symmetry=1, barrier=(6.14091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64305,0.0488955,-4.12241e-05,1.86858e-08,-3.46631e-12,40581.4,23.2128], Tmin=(100,'K'), Tmax=(1277.91,'K')), NASAPolynomial(coeffs=[10.6202,0.0207964,-8.24214e-06,1.47993e-09,-1.00346e-13,38286.9,-22.2985], Tmin=(1277.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=C)O(734)', 'H(8)'],
    products = ['[CH2]CC([CH2])O(3672)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', '[CH2]CC=C(102)'],
    products = ['[CH2]CC([CH2])O(3672)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH2][CH]C[CH2](103)'],
    products = ['[CH2]CC([CH2])O(3672)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]CC([CH2])[O](629)'],
    products = ['[CH2]CC([CH2])O(3672)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[C]([CH2])O(726)', 'H(8)'],
    products = ['[CH2]CC([CH2])O(3672)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][CH]C([CH2])O(729)'],
    products = ['[CH2]CC([CH2])O(3672)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])O(5560)'],
    products = ['[CH2]CC([CH2])O(3672)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH]C(O)C[CH2](5590)'],
    products = ['[CH2]CC([CH2])O(3672)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]CC([CH2])O(5591)'],
    products = ['[CH2]CC([CH2])O(3672)'],
