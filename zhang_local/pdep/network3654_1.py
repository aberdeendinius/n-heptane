...
species(
    label = '[CH2]C1OC1O[C]1CC1(15752)',
    structure = SMILES('[CH2]C1OC1O[C]1CC1'),
    E0 = (198.003,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.160338,0.0765199,-6.8459e-05,3.28051e-08,-6.11427e-12,23976.8,29.3601], Tmin=(100,'K'), Tmax=(1467.23,'K')), NASAPolynomial(coeffs=[16.677,0.022904,-5.75991e-06,7.33433e-10,-3.91132e-14,19866.2,-55.496], Tmin=(1467.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(C2CsJOCs) + radical(CJCO)"""),
)
...
species(
    label = 'C=CC([O])OC1=CC1(15754)',
    structure = SMILES('C=CC([O])OC1=CC1'),
    E0 = (169.57,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.352204,0.0698371,-5.34824e-05,1.72788e-08,-1.32032e-12,20534.7,29.4486], Tmin=(100,'K'), Tmax=(1148.25,'K')), NASAPolynomial(coeffs=[17.532,0.0231481,-9.67941e-06,1.82652e-09,-1.28739e-13,15721.9,-59.5859], Tmin=(1148.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.57,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(CCOJ)"""),
)

species(
    label = 'C=CC(=O)O[C]1CC1(15755)',
    structure = SMILES('C=CC(=O)O[C]1CC1'),
    E0 = (53.2224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08281,0.053564,-3.31451e-05,9.72453e-09,-1.22171e-12,6459.19,25.3995], Tmin=(100,'K'), Tmax=(1560.83,'K')), NASAPolynomial(coeffs=[7.77705,0.0389711,-1.91209e-05,3.73448e-09,-2.62279e-13,4681.65,-4.60711], Tmin=(1560.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.2224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)C)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302188,0.0620791,-1.98363e-06,-5.22571e-08,2.70799e-11,5017.48,26.693], Tmin=(100,'K'), Tmax=(959.062,'K')), NASAPolynomial(coeffs=[22.2554,0.0173644,-5.31765e-06,9.91501e-10,-7.67354e-14,-1347.88,-89.533], Tmin=(959.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.4657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + ring(Cyclopropane) + radical(Allyl_P) + radical(C=COJ)"""),
)
...
species(
    label = '[CH]=CC([O])OC1CC1(15762)',
    structure = SMILES('[CH]=CC([O])OC1CC1'),
    E0 = (228.238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00101,0.0643214,-4.38623e-05,1.46802e-08,-2.00953e-12,27559.2,29.6759], Tmin=(100,'K'), Tmax=(1644,'K')), NASAPolynomial(coeffs=[14.3438,0.031857,-1.42414e-05,2.66841e-09,-1.82922e-13,23172.1,-41.3285], Tmin=(1644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    label = 'C=CC([O])O[C]1[CH]C1(15763)',
    structure = SMILES('C=CC([O])O[C]1[CH]C1'),
    E0 = (361.748,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40262,0.0632502,-5.76013e-05,3.33962e-08,-9.00459e-12,43596.4,30.9931], Tmin=(100,'K'), Tmax=(841.722,'K')), NASAPolynomial(coeffs=[5.77687,0.0424627,-2.05562e-05,4.05506e-09,-2.89828e-13,42860.1,10.6436], Tmin=(841.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCOJ) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C=C([O])O[C]1CC1(15764)',
    structure = SMILES('[CH2]C=C([O])O[C]1CC1'),
    E0 = (240.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.186284,0.0707476,-4.33285e-05,-2.80486e-09,8.12689e-12,29096.2,27.9142], Tmin=(100,'K'), Tmax=(994.297,'K')), NASAPolynomial(coeffs=[20.2834,0.0181908,-6.72346e-06,1.26992e-09,-9.32093e-14,23701.2,-75.9604], Tmin=(994.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(Allyl_P) + radical(C=COJ)"""),
)
...
species(
    label = '[CH]=CC([O])O[C]1CC1(15766)',
    structure = SMILES('[CH]=CC([O])O[C]1CC1'),
    E0 = (408.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69787,0.061768,-2.14801e-05,-8.53525e-08,9.86112e-11,49255.6,27.3308], Tmin=(100,'K'), Tmax=(453.796,'K')), NASAPolynomial(coeffs=[5.91836,0.0431091,-2.10971e-05,4.12957e-09,-2.91774e-13,48681.7,8.20029], Tmin=(453.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(Cds_P) + radical(CCOJ)"""),
)

species(
    label = '[CH]1COC1O[C]1CC1(15767)',
    structure = SMILES('[CH]1COC1O[C]1CC1'),
    E0 = (193.427,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26731,0.0473732,1.33837e-05,-5.40851e-08,2.59991e-11,23374.1,27.5042], Tmin=(100,'K'), Tmax=(913.238,'K')), NASAPolynomial(coeffs=[13.605,0.0267038,-7.4772e-06,1.15528e-09,-7.63146e-14,19729.1,-38.5171], Tmin=(913.238,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Oxetane) + radical(CCJCO) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.306069,0.0781866,-7.17268e-05,3.41757e-08,-6.57939e-12,7346.95,30.0156], Tmin=(100,'K'), Tmax=(1240.3,'K')), NASAPolynomial(coeffs=[15.4914,0.0292143,-1.25013e-05,2.34216e-09,-1.62979e-13,3580.04,-46.5151], Tmin=(1240.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.9595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=C(O)CJ)"""),
)

species(
    label = 'C=CC(=O)OC1CC1(15769)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988149,0.0575782,-3.09105e-05,5.04323e-09,5.29601e-13,-17632.6,28.7264], Tmin=(100,'K'), Tmax=(1330.43,'K')), NASAPolynomial(coeffs=[13.6861,0.0305858,-1.3088e-05,2.43137e-09,-1.66987e-13,-22001.2,-39.8792], Tmin=(1330.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)
...
species(
    label = '[CH2]C[C]([O])O[C]1CC1(12298)',
    structure = SMILES('[CH2]C[C]([O])O[C]1CC1'),
    E0 = (445.691,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69421,0.0622477,-1.22186e-05,-1.06867e-07,1.15975e-10,53675.2,29.6327], Tmin=(100,'K'), Tmax=(445.496,'K')), NASAPolynomial(coeffs=[5.59928,0.0462322,-2.24259e-05,4.37859e-09,-3.09174e-13,53138.2,11.8291], Tmin=(445.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(RCCJ) + radical(Cs_P) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C=CC([O])O[C]1CC1(12892)'],
    products = ['[CH2]C1OC1O[C]1CC1(15752)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=CC([O])OC1=CC1(15754)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C=CC(=O)O[C]1CC1(15755)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['C=CC([O])O[C]1CC1(12892)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(32300,'cm^3/(mol*s)'), n=2.98, Ea=(69.7549,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-CsCs;YJ] for rate rule [Od_CO-CsCs;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 66.3 to 69.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=C(64)', 'O=CO[C]1CC1(11560)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=CC([O])OC1[CH]C1(15595)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C=CC([O])O[C]1CC1(12892)'],
    products = ['[CH2]C=C([O])OC1CC1(15757)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=CC([O])OC1CC1(15762)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.99186e+09,'s^-1'), n=0.575, Ea=(72.1112,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_RSSR;Y_rad_out;Cs_H_out_Cs2] for rate rule [R5H_DSSS;Cd_rad_out_singleH;Cs_H_out_Cs2_cy3]
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', 'C=CC([O])O[C]1[CH]C1(15763)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(64)', '[O][CH]O[C]1CC1(11775)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C=C([O])O[C]1CC1(15764)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=CC([O])O[C]1CC1(15766)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=CC([O])O[C]1CC1(12892)'],
    products = ['[CH]1COC1O[C]1CC1(15767)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(=C)OC([O])C=C(12866)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[C]([O])O[C]1CC1(12298)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[C]1CC1(11616)', 'C=CC([O])[O](12634)'],
    products = ['C=CC([O])O[C]1CC1(12892)'],
