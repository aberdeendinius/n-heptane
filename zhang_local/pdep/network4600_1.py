species(
    ...
    E0 = (330.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,200,800,1200,1600],'cm^-1')),
...
species(
    label = '[CH]=C1OC1C[CH]CC(23097)',
    structure = SMILES('[CH]=C1OC1C[CH]CC'),
    E0 = (352.182,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.208827,0.0688869,-2.34094e-05,-2.31174e-08,1.49297e-11,42507.2,30.512], Tmin=(100,'K'), Tmax=(981.77,'K')), NASAPolynomial(coeffs=[18.6441,0.0267995,-9.56034e-06,1.73924e-09,-1.24115e-13,37295.8,-66.1937], Tmin=(981.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(Cds_P) + radical(RCCJCC)"""),
)
...
species(
    label = 'C#CC([O])C=CCC(23098)',
    structure = SMILES('C#CC([O])C=CCC'),
    E0 = (248.556,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,263.608,263.657,263.724],'cm^-1')),
        HinderedRotor(inertia=(0.00242174,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424959,'amu*angstrom^2'), symmetry=1, barrier=(20.9338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.423872,'amu*angstrom^2'), symmetry=1, barrier=(20.9342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424457,'amu*angstrom^2'), symmetry=1, barrier=(20.9302,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263021,0.0727421,-5.12332e-05,1.44179e-08,-1.57477e-13,30037,31.4587], Tmin=(100,'K'), Tmax=(1075.99,'K')), NASAPolynomial(coeffs=[15.6098,0.029931,-1.14044e-05,2.04105e-09,-1.39766e-13,25910.1,-47.5353], Tmin=(1075.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C#CC([O])CC=CC(23099)',
    structure = SMILES('C#CC([O])CC=CC'),
    E0 = (251.179,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,631.058,631.339],'cm^-1')),
        HinderedRotor(inertia=(0.63974,'amu*angstrom^2'), symmetry=1, barrier=(14.7089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18544,'amu*angstrom^2'), symmetry=1, barrier=(27.2555,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.639489,'amu*angstrom^2'), symmetry=1, barrier=(14.7031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117311,'amu*angstrom^2'), symmetry=1, barrier=(14.706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.219422,0.0739468,-5.39033e-05,1.62398e-08,-5.08376e-13,30353.8,31.1091], Tmin=(100,'K'), Tmax=(1059.54,'K')), NASAPolynomial(coeffs=[15.7877,0.029421,-1.10387e-05,1.9609e-09,-1.33863e-13,26255,-48.6735], Tmin=(1059.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)

species(
    label = 'C#CC(=O)C[CH]CC(23100)',
    structure = SMILES('C#CC(=O)C[CH]CC'),
    E0 = (166.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782647,0.0760486,-7.66623e-05,4.89418e-08,-1.3796e-11,20084.1,29.0441], Tmin=(100,'K'), Tmax=(832.755,'K')), NASAPolynomial(coeffs=[7.28669,0.0448083,-2.0392e-05,3.8953e-09,-2.72952e-13,19000.8,-1.1439], Tmin=(832.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCJCC=O)"""),
)
...
species(
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.347327,0.0783808,-6.6668e-05,3.183e-08,-6.34532e-12,39833.5,33.3495], Tmin=(100,'K'), Tmax=(1181.87,'K')), NASAPolynomial(coeffs=[12.37,0.0376897,-1.50229e-05,2.69754e-09,-1.82829e-13,36991.7,-26.6614], Tmin=(1181.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH]=C=C(O)C[CH]CC(23102)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.059743,0.086176,-8.415e-05,4.52501e-08,-9.85573e-12,25511,33.2465], Tmin=(100,'K'), Tmax=(1108.88,'K')), NASAPolynomial(coeffs=[14.6214,0.0332171,-1.2511e-05,2.17996e-09,-1.45363e-13,22255.1,-39.0987], Tmin=(1108.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=C=C([O])CCCC(23103)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.152372,0.0841531,-7.62415e-05,3.72927e-08,-7.34164e-12,18703.8,32.5153], Tmin=(100,'K'), Tmax=(1226.22,'K')), NASAPolynomial(coeffs=[16.1634,0.0309296,-1.1134e-05,1.89488e-09,-1.24688e-13,14702.6,-49.5258], Tmin=(1226.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C#CC([O])CCC[CH2](23104)',
    structure = SMILES('C#CC([O])CCC[CH2]'),
    E0 = (340.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,750,770,3400,2100,1380,1390,370,380,2900,435,2175,525,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.149157,0.0827951,-7.09385e-05,3.217e-08,-5.87626e-12,41155.8,34.1856], Tmin=(100,'K'), Tmax=(1313.15,'K')), NASAPolynomial(coeffs=[16.9252,0.0307843,-1.15265e-05,2.0071e-09,-1.33748e-13,36671.6,-52.8397], Tmin=(1313.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(CC(C)OJ)"""),
)

species(
    label = 'C#CC(O)[CH][CH]CC(23105)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444572,0.0772782,-6.77836e-05,3.38732e-08,-7.0891e-12,36167.3,35.5189], Tmin=(100,'K'), Tmax=(1128.5,'K')), NASAPolynomial(coeffs=[11.6445,0.0375795,-1.50158e-05,2.70018e-09,-1.83198e-13,33639.5,-19.8681], Tmin=(1128.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCJCO) + radical(RCCJCC)"""),
)

species(
    label = '[C]#CC(O)C[CH]CC(23106)',
    structure = SMILES('[C]#CC(O)C[CH]CC'),
    E0 = (436.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.228099,0.0865375,-0.000100695,7.25755e-08,-2.18469e-11,52677.3,34.544], Tmin=(100,'K'), Tmax=(836.875,'K')), NASAPolynomial(coeffs=[9.13047,0.0419393,-1.70879e-05,3.04901e-09,-2.03781e-13,51259,-6.39111], Tmin=(836.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(RCCJCC)"""),
)

species(
    label = 'C#CC(O)C[CH][CH]C(23107)',
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447162,0.0827038,-9.59284e-05,7.23979e-08,-2.31863e-11,35505.9,35.7506], Tmin=(100,'K'), Tmax=(822.241,'K')), NASAPolynomial(coeffs=[7.30349,0.0449281,-1.89489e-05,3.44392e-09,-2.32688e-13,34527.9,4.92361], Tmin=(822.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[C]#CC([O])CCCC(23108)',
    structure = SMILES('[C]#CC([O])CCCC'),
    E0 = (472.785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0211651,0.0834961,-7.60513e-05,3.82957e-08,-7.87553e-12,57009.6,32.5262], Tmin=(100,'K'), Tmax=(1165.69,'K')), NASAPolynomial(coeffs=[14.2809,0.0345643,-1.3086e-05,2.28527e-09,-1.52518e-13,53685.1,-38.4551], Tmin=(1165.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(CC(C)OJ)"""),
)

species(
    label = 'C#CC(O)C[CH]C[CH2](23109)',
    structure = SMILES('C#CC(O)C[CH]C[CH2]'),
    E0 = (304.985,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.392487,0.0818733,-8.16656e-05,4.83301e-08,-1.20702e-11,36809,35.0041], Tmin=(100,'K'), Tmax=(953.386,'K')), NASAPolynomial(coeffs=[10.1874,0.0407767,-1.70049e-05,3.11405e-09,-2.13133e-13,34941.4,-11.783], Tmin=(953.386,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'C#CC([O])[CH][CH]CC(23110)',
    structure = SMILES('C#CC([O])[CH][CH]CC'),
    E0 = (530.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.585363,0.073557,-6.28717e-05,3.01498e-08,-6.04012e-12,63868.7,34.8205], Tmin=(100,'K'), Tmax=(1175.67,'K')), NASAPolynomial(coeffs=[11.792,0.0354286,-1.42248e-05,2.56443e-09,-1.74223e-13,61233.7,-21.0585], Tmin=(1175.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(530.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(RCCJCC) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625663,0.0785118,-8.92717e-05,6.63219e-08,-2.11149e-11,63205.8,34.919], Tmin=(100,'K'), Tmax=(803.391,'K')), NASAPolynomial(coeffs=[7.1637,0.0432676,-1.84418e-05,3.37544e-09,-2.29306e-13,62242.1,5.34871], Tmin=(803.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(524.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(CC(C)OJ) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]=C=C([O])C[CH]CC(23112)',
    structure = SMILES('[CH]=C=C([O])C[CH]CC'),
    E0 = (348.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,540,610,2055,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,299.987,300.027,1954.85],'cm^-1')),
        HinderedRotor(inertia=(0.00187322,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13079,'amu*angstrom^2'), symmetry=1, barrier=(8.35336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130808,'amu*angstrom^2'), symmetry=1, barrier=(8.35336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130777,'amu*angstrom^2'), symmetry=1, barrier=(8.35333,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432789,0.0806217,-8.5768e-05,5.42792e-08,-1.43131e-11,42062.8,32.9867], Tmin=(100,'K'), Tmax=(912.079,'K')), NASAPolynomial(coeffs=[10.2087,0.0377468,-1.52533e-05,2.73573e-09,-1.84521e-13,40279.6,-13.2765], Tmin=(912.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJCC) + radical(C=C(C)OJ) + radical(C=C=CJ)"""),
)

species(
    label = 'C#CC([O])C[CH]C[CH2](23113)',
    structure = SMILES('C#CC([O])C[CH]C[CH2]'),
    E0 = (535.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2175,525,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567267,0.0777508,-7.53631e-05,4.28425e-08,-1.02918e-11,64509,34.184], Tmin=(100,'K'), Tmax=(987.242,'K')), NASAPolynomial(coeffs=[10.1476,0.038935,-1.63883e-05,3.01885e-09,-2.07478e-13,62617.3,-11.9129], Tmin=(987.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[C]#CC([O])C[CH]CC(23114)',
    structure = SMILES('[C]#CC([O])C[CH]CC'),
    E0 = (667.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.414737,0.0822384,-9.36052e-05,6.58349e-08,-1.94361e-11,80376.8,33.6838], Tmin=(100,'K'), Tmax=(816.663,'K')), NASAPolynomial(coeffs=[8.97948,0.0402991,-1.6593e-05,2.98353e-09,-2.00654e-13,78977.5,-5.90366], Tmin=(816.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(667.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl) + radical(CC(C)OJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0871919,0.0788108,-6.37533e-05,2.7103e-08,-4.63027e-12,2344.82,32.9161], Tmin=(100,'K'), Tmax=(1402.14,'K')), NASAPolynomial(coeffs=[17.3533,0.0290565,-1.05259e-05,1.79502e-09,-1.17845e-13,-2545.92,-57.1187], Tmin=(1402.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.1955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(=O)CCCC(23116)',
    structure = SMILES('C#CC(=O)CCCC'),
    E0 = (-33.8383,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.545457,0.0818128,-8.74795e-05,6.17792e-08,-1.9365e-11,-3950.74,27.396], Tmin=(100,'K'), Tmax=(753.85,'K')), NASAPolynomial(coeffs=[6.70284,0.0491415,-2.24712e-05,4.28975e-09,-2.99942e-13,-4879.1,-0.570021], Tmin=(753.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-33.8383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = 'C#CC(O)CC=CC(23117)',
    structure = SMILES('C#CC(O)CC=CC'),
    E0 = (20.8177,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.130353,0.0800306,-6.65627e-05,2.9213e-08,-5.14273e-12,2661.54,32.5635], Tmin=(100,'K'), Tmax=(1365.69,'K')), NASAPolynomial(coeffs=[17.362,0.0287966,-1.02898e-05,1.74308e-09,-1.14136e-13,-2116.28,-57.2788], Tmin=(1365.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.8177,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)
...
species(
    label = 'C#CC([O])CC([CH2])C(23118)',
    structure = SMILES('C#CC([O])CC([CH2])C'),
    E0 = (335.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C#CC([O])C[C]CC(23119)',
    structure = SMILES('C#CC([O])C[C]CC'),
    E0 = (583.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,1380,1390,370,380,2900,435,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.146,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.205612,0.0847611,-7.89409e-05,3.8507e-08,-7.4859e-12,70379.7,32.5051], Tmin=(100,'K'), Tmax=(1245.94,'K')), NASAPolynomial(coeffs=[17.5451,0.0277737,-1.03332e-05,1.79698e-09,-1.19982e-13,65956.4,-57.0353], Tmin=(1245.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CCJ2_triplet) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C#CC([O])C[CH]CC(22313)'],
    products = ['[CH]=C1OC1C[CH]CC(23097)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CC([O])C=CCC(23098)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CC([O])CC=CC(23099)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', 'C#CC(=O)C[CH]CC(23100)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['C#CC([O])C[CH]CC(22313)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.0172287,'m^3/(mol*s)'), n=2.32603, Ea=(76.747,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-CsH;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 72.9 to 76.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH3](11)', 'C#CC([O])CC=C(22487)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]CC=O(535)', '[C]#C(5143)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C#CC([O])C[CH]CC(22313)'],
    products = ['[CH]=C=C(O)C[CH]CC(23102)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C#CC([O])CCC[CH2](23104)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C#CC([O])C[CH]CC(22313)'],
    products = ['C#CC(O)[CH][CH]CC(23105)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[C]#CC(O)C[CH]CC(23106)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C#CC([O])C[CH]CC(22313)'],
    products = ['C#CC(O)C[CH][CH]C(23107)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C#CC([O])C[CH]CC(22313)'],
    products = ['C#CC(O)C[CH]C[CH2](23109)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', 'C#CC([O])[CH][CH]CC(23110)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', 'C#CC([O])C[CH][CH2](22490)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C#CC([O])C[CH][CH]C(23111)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CC[CH]C[CH][O](545)', '[C]#C(5143)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH]=C=C([O])C[CH]CC(23112)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', 'C#CC([O])C[CH]C[CH2](23113)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[C]#CC([O])C[CH]CC(23114)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(S)(14)', 'C#CC([O])C[CH]C(22303)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C#CC([O])CC([CH2])C(23118)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]CC(45)', 'C#CC([CH2])[O](5294)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C[CH2](6)', '[CH]CC([O])C#C(22715)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(8)', 'C#CC([O])C[C]CC(23119)'],
    products = ['C#CC([O])C[CH]CC(22313)'],
