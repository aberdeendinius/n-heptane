...
species(
    ...
    E0 = (444.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,352.511],'cm^-1')),
        HinderedRotor(inertia=(0.102149,'amu*angstrom^2'), symmetry=1, barrier=(9.00813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102002,'amu*angstrom^2'), symmetry=1, barrier=(9.00669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10209,'amu*angstrom^2'), symmetry=1, barrier=(9.00526,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]C=C[CH]C(5213)',
    structure = SMILES('[CH]C=C[CH]C'),
    E0 = (459.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,484.725,484.964,485.013,485.486],'cm^-1')),
        HinderedRotor(inertia=(0.309517,'amu*angstrom^2'), symmetry=1, barrier=(51.5703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308429,'amu*angstrom^2'), symmetry=1, barrier=(51.5981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.308008,'amu*angstrom^2'), symmetry=1, barrier=(51.6036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
...
species(
    label = '[CH]=CC[C]C(5218)',
    structure = SMILES('[CH]=CC[C]C'),
    E0 = (655.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,180,759.24],'cm^-1')),
        HinderedRotor(inertia=(0.845517,'amu*angstrom^2'), symmetry=1, barrier=(19.4401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386806,'amu*angstrom^2'), symmetry=1, barrier=(8.89342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84592,'amu*angstrom^2'), symmetry=1, barrier=(19.4494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74879,0.0431293,-2.42218e-05,2.60574e-09,1.59294e-12,78865.9,20.714], Tmin=(100,'K'), Tmax=(1098.68,'K')), NASAPolynomial(coeffs=[10.6138,0.0211745,-8.33721e-06,1.51654e-09,-1.04587e-13,76295,-25.7233], Tmin=(1098.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(655.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]C=C[CH]C(5213)'],
    products = ['[CH]=CC[CH]C(5149)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=CC[CH][CH2](5214)'],
    products = ['[CH]=CC[CH]C(5149)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=[C]C[CH]C(5215)'],
    products = ['[CH]=CC[CH]C(5149)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH]CC=[CH](5190)'],
    products = ['[CH]=CC[CH]C(5149)'],
