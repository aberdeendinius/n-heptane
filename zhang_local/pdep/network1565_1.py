...
species(
    label = '[CH]C(O)C([CH2])C(5602)',
    structure = SMILES('[CH]C(O)C([CH2])C'),
    E0 = (307.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.76357,0.0647814,-5.6413e-05,2.68325e-08,-5.16027e-12,37051.3,28.3294], Tmin=(100,'K'), Tmax=(1252.14,'K')), NASAPolynomial(coeffs=[13.2152,0.0250045,-8.76241e-06,1.46232e-09,-9.49125e-14,33933.1,-34.5421], Tmin=(1252.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(C)C([CH2])O(5603)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696224,0.0670638,-5.93449e-05,2.78219e-08,-5.25353e-12,37835.6,27.4238], Tmin=(100,'K'), Tmax=(1271.76,'K')), NASAPolynomial(coeffs=[14.1458,0.0247616,-9.45077e-06,1.66703e-09,-1.12071e-13,34414.7,-40.696], Tmin=(1271.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(O)C(=C)C(796)', 'H(8)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C(=C)O(794)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(O)C=C(737)', '[CH3](11)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH2]C(C)C=C(107)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['OH(D)(132)', '[CH2][CH]C([CH2])C(114)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH3](11)', '[CH2][CH]C([CH2])O(729)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](C)C([CH2])O(787)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C](O)C([CH2])C(784)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH2])C([CH2])O(789)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(14)', '[CH2]CC([CH2])O(3672)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(28)', '[CH2]C(O)[CH]C(5587)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(C)[CH]O(448)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C(O)C([CH2])C(5602)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH]C(C)C([CH2])O(5603)'],
    products = ['[CH2]C(C)C([CH2])O(3691)'],
