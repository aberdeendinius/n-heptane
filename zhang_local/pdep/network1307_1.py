...
species(
    label = 'C=[C]OCC=CC(4490)',
    structure = SMILES('C=[C]OCC=CC'),
    E0 = (127.771,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,265.481,265.487,265.489,265.49],'cm^-1')),
        HinderedRotor(inertia=(0.00239189,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310068,'amu*angstrom^2'), symmetry=1, barrier=(15.5078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310051,'amu*angstrom^2'), symmetry=1, barrier=(15.5078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.310069,'amu*angstrom^2'), symmetry=1, barrier=(15.5078,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]OC=CCC(4491)',
    structure = SMILES('C=[C]OC=CCC'),
    E0 = (150.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,314.026,314.027,314.028,314.031],'cm^-1')),
        HinderedRotor(inertia=(0.00170954,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C#COC[CH]CC(4492)',
    structure = SMILES('C#COC[CH]CC'),
    E0 = (176.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,750,770,3400,2100,2175,525,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.272388,0.0724187,-5.17161e-05,1.4284e-08,8.50355e-14,25630.9,31.469], Tmin=(100,'K'), Tmax=(1065.31,'K')), NASAPolynomial(coeffs=[16.0443,0.0282678,-1.07674e-05,1.93653e-09,-1.33329e-13,21415.4,-49.6325], Tmin=(1065.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH]=[C]OCCCC(4496)',
...
species(
    label = 'C=[C]OC[CH][CH]C(4498)',
    structure = SMILES('C=[C]OC[CH][CH]C'),
    E0 = (401.025,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.574833,0.0672412,-5.37232e-05,2.27767e-08,-3.91167e-12,48362.2,33.8333], Tmin=(100,'K'), Tmax=(1386.37,'K')), NASAPolynomial(coeffs=[14.6064,0.0267566,-9.91999e-06,1.71281e-09,-1.13253e-13,44471.6,-38.4446], Tmin=(1386.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = 'C=[C]O[CH][CH]CC(4499)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.113429,0.0753079,-5.77863e-05,1.33252e-08,2.5382e-12,48318.8,32.2209], Tmin=(100,'K'), Tmax=(980.611,'K')), NASAPolynomial(coeffs=[18.7807,0.0206745,-7.12194e-06,1.25228e-09,-8.72457e-14,43623.4,-62.7461], Tmin=(980.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[CH]CO[C]=C(4500)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506957,0.066764,-4.17199e-05,3.31422e-09,4.41194e-12,49665.7,33.1219], Tmin=(100,'K'), Tmax=(1007.41,'K')), NASAPolynomial(coeffs=[16.2082,0.0246337,-9.08575e-06,1.63505e-09,-1.13995e-13,45476.5,-47.834], Tmin=(1007.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH]=[C]OC[CH]CC(4501)',
    structure = SMILES('[CH]=[C]OC[CH]CC'),
    E0 = (453.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391642,0.0696063,-4.81224e-05,8.71453e-09,2.81038e-12,54703,32.1523], Tmin=(100,'K'), Tmax=(1006.79,'K')), NASAPolynomial(coeffs=[16.6788,0.024054,-8.79637e-06,1.57327e-09,-1.0927e-13,50452.5,-51.3559], Tmin=(1006.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_P) + radical(C=CJO)"""),
)

species(
    label = 'C=COC=CCC(4502)',
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.3746,0.0695935,-3.94397e-05,-3.12631e-09,7.91996e-12,24521,30.8155], Tmin=(100,'K'), Tmax=(955.125,'K')), NASAPolynomial(coeffs=[16.3804,0.0263089,-8.75606e-06,1.48744e-09,-1.01077e-13,20380.3,-51.3388], Tmin=(955.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=[C]OC[C]CC(4505)',
    structure = SMILES('C=[C]OC[C]CC'),
    E0 = (454.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189989,0.0746697,-6.06085e-05,2.16124e-08,-1.8759e-12,54855.9,29.8829], Tmin=(100,'K'), Tmax=(1053.59,'K')), NASAPolynomial(coeffs=[17.0157,0.0246994,-9.26833e-06,1.65682e-09,-1.13952e-13,50538.4,-55.8337], Tmin=(1053.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(454.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OCC=CC(4490)'],
    products = ['C=[C]OC[CH]CC(4198)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#COC[CH]CC(4492)'],
    products = ['C=[C]OC[CH]CC(4198)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C=[C]OCC=C(4380)'],
    products = ['C=[C]OC[CH]CC(4198)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH3](11)', '[CH2][CH]CO[C]=C(4386)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', 'C=[C]OC[CH][CH]C(4498)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', 'C=[C]O[CH][CH]CC(4499)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C[CH]CO[C]=C(4500)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]OC[CH]CC(4501)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', 'C=[C]OC[CH]C(4192)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[C]=C(584)', 'CC[CH]C[O](457)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C[CH2](6)', '[CH]CO[C]=C(4306)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]CC(45)', '[CH2]O[C]=C(4272)'],
    products = ['C=[C]OC[CH]CC(4198)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', 'C=[C]OC[C]CC(4505)'],
    products = ['C=[C]OC[CH]CC(4198)'],
