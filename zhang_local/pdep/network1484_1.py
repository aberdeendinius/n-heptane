...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975312,0.0521159,-5.9084e-05,3.16215e-08,-6.13984e-12,29652.6,20.2511], Tmin=(100,'K'), Tmax=(1523.02,'K')), NASAPolynomial(coeffs=[14.951,0.0027298,2.04472e-06,-6.02973e-10,4.70924e-14,26866.3,-48.2249], Tmin=(1523.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=CC(=[CH])O(5339)',
    structure = SMILES('[CH]=CC(=[CH])O'),
    E0 = (374.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725],'cm^-1')),
...
species(
    label = '[CH]=C([O])C=C(5340)',
    structure = SMILES('[CH]=C([O])C=C'),
    E0 = (264.929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,350,440,435,1725,180],'cm^-1')),
        HinderedRotor(inertia=(0.979636,'amu*angstrom^2'), symmetry=1, barrier=(22.5238,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55546,0.0463589,-5.45812e-05,3.05614e-08,-6.36539e-12,61676.8,18.3157], Tmin=(100,'K'), Tmax=(1338.59,'K')), NASAPolynomial(coeffs=[13.831,0.00353992,2.77859e-07,-1.85422e-10,1.66488e-14,58940.3,-42.4325], Tmin=(1338.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95496,0.00615229,6.95873e-05,-9.95349e-08,3.99667e-11,27987.2,13.5031], Tmin=(100,'K'), Tmax=(932.573,'K')), NASAPolynomial(coeffs=[12.8993,0.00658552,-4.12578e-07,4.83538e-11,-1.02168e-14,24258.8,-43.824], Tmin=(932.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72365,0.0133649,4.80157e-05,-7.79913e-08,3.26198e-11,13139.7,11.0333], Tmin=(100,'K'), Tmax=(930.837,'K')), NASAPolynomial(coeffs=[13.3083,0.00556436,-1.39893e-07,-1.03221e-11,-4.84682e-15,9536.58,-48.0422], Tmin=(930.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetene)"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=C=C([CH2])[O](5341)'],
    products = ['[CH]=CC(=C)[O](5179)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(T)(63)', '[CH]C=C=C(5316)'],
    products = ['[CH]=CC(=C)[O](5179)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(28)', '[CH]C=C=O(5348)'],
    products = ['[CH]=CC(=C)[O](5179)'],
