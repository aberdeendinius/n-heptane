...
species(
    ...
    E0 = (152.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
...
species(
    label = '[CH2]CC[C]C(130)',
    structure = SMILES('[CH2]CC[C]C'),
    E0 = (485.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,400.857,404.082,1562.6],'cm^-1')),
        HinderedRotor(inertia=(0.0705089,'amu*angstrom^2'), symmetry=1, barrier=(8.04088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0701278,'amu*angstrom^2'), symmetry=1, barrier=(8.03183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0701173,'amu*angstrom^2'), symmetry=1, barrier=(8.03566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276523,'amu*angstrom^2'), symmetry=1, barrier=(31.6036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.125,'amu'),
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C[CH][CH]C(126)', 'H(8)'],
    products = ['[CH2]CC[CH]C(25)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]C[CH]C(127)', 'H(8)'],
    products = ['[CH2]CC[CH]C(25)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CC[CH2](128)', 'H(8)'],
    products = ['[CH2]CC[CH]C(25)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[CH2](21)', '[CH]C(32)'],
    products = ['[CH2]CC[CH]C(25)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]CC[CH2](104)', '[CH3](11)'],
    products = ['[CH2]CC[CH]C(25)'],
