...
species(
    label = '[CH]C([CH2])O[CH][CH2](6361)',
    structure = SMILES('[CH]C([CH2])O[CH][CH2]'),
    E0 = (743.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124696,0.0892815,-0.000133507,1.03127e-07,-3.11191e-11,89505.9,27.6323], Tmin=(100,'K'), Tmax=(861.724,'K')), NASAPolynomial(coeffs=[13.7398,0.0220408,-9.42698e-06,1.69065e-09,-1.12001e-13,87309.5,-35.1561], Tmin=(861.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(743.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(CJCO)"""),
)

species(
    label = '[CH][CH]OC([CH2])[CH2](6362)',
...
reaction(
    ...
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', '[CH2][CH]OC=C(694)'],
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(48.4328,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', '[CH2][CH]O[CH][CH2](720)'],
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][C]OC([CH2])[CH2](6360)'],
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C([CH2])O[CH][CH2](6361)'],
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH][CH]OC([CH2])[CH2](6362)'],
    products = ['[CH2][CH]OC([CH2])[CH2](761)'],
