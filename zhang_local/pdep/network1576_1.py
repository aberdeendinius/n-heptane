...
species(
    ...
    E0 = (-75.2759,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,324.944,325.704],'cm^-1')),
        HinderedRotor(inertia=(0.00159025,'amu*angstrom^2'), symmetry=1, barrier=(7.92743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104908,'amu*angstrom^2'), symmetry=1, barrier=(7.92609,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0015885,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105224,'amu*angstrom^2'), symmetry=1, barrier=(7.92475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.975403,'amu*angstrom^2'), symmetry=1, barrier=(74.2234,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(C=CO)CC(5642)',
    structure = SMILES('[CH2]C(C=CO)CC'),
    E0 = (-75.7645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,373.295,373.297],'cm^-1')),
        HinderedRotor(inertia=(0.157949,'amu*angstrom^2'), symmetry=1, barrier=(15.6189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157945,'amu*angstrom^2'), symmetry=1, barrier=(15.6189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157948,'amu*angstrom^2'), symmetry=1, barrier=(15.6189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157949,'amu*angstrom^2'), symmetry=1, barrier=(15.6189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157946,'amu*angstrom^2'), symmetry=1, barrier=(15.6189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344586,0.077428,-6.10038e-05,2.62771e-08,-4.72516e-12,3280.32,31.6815], Tmin=(100,'K'), Tmax=(1294.95,'K')), NASAPolynomial(coeffs=[13.0996,0.0380287,-1.53657e-05,2.78166e-09,-1.89193e-13,-23.1042,-33.1511], Tmin=(1294.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](CC)CCO(5648)',
    structure = SMILES('[CH2][C](CC)CCO'),
    E0 = (36.4659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,230.437,820.309,1681.24],'cm^-1')),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.79149,0.0762857,-6.7974e-05,4.12159e-08,-1.17563e-11,6360.29,28.4647], Tmin=(100,'K'), Tmax=(800.894,'K')), NASAPolynomial(coeffs=[5.49653,0.0527873,-2.39649e-05,4.58346e-09,-3.21722e-13,5606.62,6.81013], Tmin=(800.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.9639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    ...
    E0 = (216.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (225.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (236.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211995,0.0816545,-7.64363e-05,3.97024e-08,-8.466e-12,37666.5,30.6281], Tmin=(100,'K'), Tmax=(1121.38,'K')), NASAPolynomial(coeffs=[13.3323,0.0348539,-1.38339e-05,2.48471e-09,-1.68677e-13,34724,-34.1725], Tmin=(1121.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CH2_triplet)"""),
)

species(
    label = '[CH]C(CC)C[CH]O(5658)',
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.290102,0.0833283,-8.05207e-05,4.39974e-08,-1.00276e-11,33143.8,30.3932], Tmin=(100,'K'), Tmax=(1042.42,'K')), NASAPolynomial(coeffs=[11.8803,0.0388546,-1.65255e-05,3.07056e-09,-2.1237e-13,30727.4,-26.0044], Tmin=(1042.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(CC)CC=O(656)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C(CC)C[CH]O(5641)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(C=CO)CC(5642)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH2](6)', 'C=CC[CH]O(5522)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC(C)C[CH]O(5650)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]C(CC)C[CH][O](652)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]C[CH]O(747)', 'C[CH2](6)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C](CC)C[CH]O(935)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH2]C([CH2])C[CH]O(812)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2]C([CH]C)C[CH]O(937)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]C([CH][CH]O)CC(932)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2]CC([CH2])C[CH]O(938)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[CH2]C(C)C[CH]O(5501)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction34',
    reactants = ['OH(D)(132)', '[CH]CC([CH2])CC(213)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C([CH2])CC(112)', '[CH]O(5471)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH2]C(CC)C[C]O(5657)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(8)', '[CH]C(CC)C[CH]O(5658)'],
    products = ['[CH2]C(CC)C[CH]O(5507)'],
