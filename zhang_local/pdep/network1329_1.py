...
species(
    label = '[CH]=C(O)O[CH2](4545)',
    structure = SMILES('[CH]=C(O)O[CH2]'),
    E0 = (134.008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,3615,1277.5,1000,350,440,435,1725,305.1],'cm^-1')),
        HinderedRotor(inertia=(0.246033,'amu*angstrom^2'), symmetry=1, barrier=(16.2508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245997,'amu*angstrom^2'), symmetry=1, barrier=(16.2509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.246008,'amu*angstrom^2'), symmetry=1, barrier=(16.251,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(146.13,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]O[C]=O(1735)', 'CH2(T)(28)'],
    products = ['[CH2]OC([CH2])=O(1012)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C(=O)O[CH2](4543)'],
    products = ['[CH2]OC([CH2])=O(1012)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]OC([CH2])=O(4544)'],
    products = ['[CH2]OC([CH2])=O(1012)'],
