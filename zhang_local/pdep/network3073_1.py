...
species(
    label = '[CH2]CC(=O)C(C)[O](11814)',
    structure = SMILES('[CH2]CC(=O)C(C)[O]'),
    E0 = (1.82978,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,180,748.101,4000],'cm^-1')),
        HinderedRotor(inertia=(0.122949,'amu*angstrom^2'), symmetry=1, barrier=(2.82683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123367,'amu*angstrom^2'), symmetry=1, barrier=(2.83646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.568655,'amu*angstrom^2'), symmetry=1, barrier=(13.0745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0327398,'amu*angstrom^2'), symmetry=1, barrier=(13.0766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.894083,0.0532711,-3.00446e-06,-4.18002e-08,2.20377e-11,7564.42,27.3376], Tmin=(100,'K'), Tmax=(948.943,'K')), NASAPolynomial(coeffs=[18.1845,0.0174967,-5.11284e-06,8.89862e-10,-6.55752e-14,2612.12,-63.9757], Tmin=(948.943,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.8505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = 'C[C]([O])C1(O)CC1(11817)',
    structure = SMILES('C[C]([O])C1(O)CC1'),
    E0 = (38.5763,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.523736,0.0674758,-4.95817e-05,1.10784e-08,2.09631e-12,4772.76,25.5945], Tmin=(100,'K'), Tmax=(993.047,'K')), NASAPolynomial(coeffs=[16.4397,0.021538,-7.64082e-06,1.349e-09,-9.33314e-14,715.714,-55.5909], Tmin=(993.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.5763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960907,0.0546529,-1.50494e-05,-2.39628e-08,1.43903e-11,-35887.5,23.4872], Tmin=(100,'K'), Tmax=(966.646,'K')), NASAPolynomial(coeffs=[16.1178,0.0206913,-6.97479e-06,1.24515e-09,-8.88723e-14,-40161.4,-56.0717], Tmin=(966.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-299.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Cyclopropane)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4219.42,'J/mol'), sigma=(7.04978,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=659.06 K, Pc=27.33 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'CC([O])[C]1CC1(11824)',
    structure = SMILES('CC([O])[C]1CC1'),
    E0 = (195.935,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00041,0.0265643,5.27542e-05,-8.70171e-08,3.49658e-11,23653.2,20.6604], Tmin=(100,'K'), Tmax=(963.716,'K')), NASAPolynomial(coeffs=[13.6215,0.0217776,-7.42106e-06,1.3912e-09,-1.0406e-13,19395.7,-45.4432], Tmin=(963.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = 'C[CH]C1([O])CC1(11619)',
    structure = SMILES('C[CH]C1([O])CC1'),
    E0 = (232.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67979,0.0356857,2.78948e-05,-6.38533e-08,2.75798e-11,28105.9,22.4129], Tmin=(100,'K'), Tmax=(959.639,'K')), NASAPolynomial(coeffs=[14.597,0.0197547,-6.46231e-06,1.18192e-09,-8.74766e-14,23881.1,-48.4685], Tmin=(959.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C(C)[O](11814)'],
    products = ['CC([O])C1([O])CC1(10573)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CC(=O)C1([O])CC1(11512)'],
    products = ['CC([O])C1([O])CC1(10573)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CC=O(606)', '[O][C]1CC1(9172)'],
    products = ['CC([O])C1([O])CC1(10573)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', '[O]C1(C=O)CC1(11561)'],
    products = ['CC([O])C1([O])CC1(10573)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CC([O])C1([O])CC1(10573)'],
    products = ['CC([O])C1(O)[CH]C1(11816)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'CC([O])C1([O])[CH]C1(11820)'],
    products = ['CC([O])C1([O])CC1(10573)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH3](11)', '[O][CH]C1([O])CC1(11783)'],
    products = ['CC([O])C1([O])CC1(10573)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', 'C[C]([O])C1([O])CC1(11821)'],
    products = ['CC([O])C1([O])CC1(10573)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(14)', '[O]CC1([O])CC1(10527)'],
    products = ['CC([O])C1([O])CC1(10573)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(T)(63)', 'CC([O])[C]1CC1(11824)'],
    products = ['CC([O])C1([O])CC1(10573)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', 'C[CH]C1([O])CC1(11619)'],
    products = ['CC([O])C1([O])CC1(10573)'],
