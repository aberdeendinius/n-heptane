...
species(
    ...
    E0 = (-39.4399,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,423.014,423.902],'cm^-1')),
        HinderedRotor(inertia=(0.000941633,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0893221,'amu*angstrom^2'), symmetry=1, barrier=(11.3395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0890877,'amu*angstrom^2'), symmetry=1, barrier=(11.3502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0896201,'amu*angstrom^2'), symmetry=1, barrier=(11.3394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885235,'amu*angstrom^2'), symmetry=1, barrier=(11.35,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-81.5304,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,423.192,3137.67],'cm^-1')),
        HinderedRotor(inertia=(0.724999,'amu*angstrom^2'), symmetry=1, barrier=(16.6692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131161,'amu*angstrom^2'), symmetry=1, barrier=(16.6692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131166,'amu*angstrom^2'), symmetry=1, barrier=(16.6692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131164,'amu*angstrom^2'), symmetry=1, barrier=(16.6691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131157,'amu*angstrom^2'), symmetry=1, barrier=(16.6692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.277398,0.0835969,-7.68587e-05,4.04043e-08,-8.95288e-12,2722.67,29.5976], Tmin=(100,'K'), Tmax=(1063.98,'K')), NASAPolynomial(coeffs=[11.4628,0.0415462,-1.75763e-05,3.2596e-09,-2.25202e-13,342.437,-25.0593], Tmin=(1063.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.5349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)C(C)[CH]C(5635)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169272,0.0791852,-6.29527e-05,2.68825e-08,-4.72919e-12,6174.03,32.3418], Tmin=(100,'K'), Tmax=(1334.55,'K')), NASAPolynomial(coeffs=[14.6196,0.0358736,-1.42714e-05,2.56395e-09,-1.7361e-13,2317.11,-41.5429], Tmin=(1334.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.1534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]CC([CH2])C(C)O(3740)',
...
species(
    ...
    E0 = (202.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,201.376,860.248],'cm^-1')),
        HinderedRotor(inertia=(0.151637,'amu*angstrom^2'), symmetry=1, barrier=(3.57419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151637,'amu*angstrom^2'), symmetry=1, barrier=(3.57419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151637,'amu*angstrom^2'), symmetry=1, barrier=(3.57419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151637,'amu*angstrom^2'), symmetry=1, barrier=(3.57419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151637,'amu*angstrom^2'), symmetry=1, barrier=(3.57419,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (226.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (244.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,192.774,1694.51],'cm^-1')),
...
species(
    ...
    E0 = (255.236,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,203.778,911.527],'cm^-1')),
        HinderedRotor(inertia=(0.147525,'amu*angstrom^2'), symmetry=1, barrier=(3.53957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147525,'amu*angstrom^2'), symmetry=1, barrier=(3.53957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147525,'amu*angstrom^2'), symmetry=1, barrier=(3.53957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147525,'amu*angstrom^2'), symmetry=1, barrier=(3.53957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147525,'amu*angstrom^2'), symmetry=1, barrier=(3.53957,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C(O)C([CH2])CC(5639)',
    structure = SMILES('[CH]C(O)C([CH2])CC'),
    E0 = (286.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.171725,0.0789454,-6.82072e-05,3.23855e-08,-6.28808e-12,34614.1,32.6976], Tmin=(100,'K'), Tmax=(1229.5,'K')), NASAPolynomial(coeffs=[14.2105,0.0332721,-1.24854e-05,2.17168e-09,-1.44555e-13,31161.9,-37.9321], Tmin=(1229.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(CC)C([CH2])O(5640)',
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.106052,0.0812102,-7.10861e-05,3.33176e-08,-6.36129e-12,35398.3,31.7859], Tmin=(100,'K'), Tmax=(1247.66,'K')), NASAPolynomial(coeffs=[15.1282,0.0330491,-1.31843e-05,2.37873e-09,-1.61899e-13,31649.8,-44.0112], Tmin=(1247.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(O)C(=C)CC(918)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(CC)C(=C)O(916)', 'H(8)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(O)C=C(737)', 'C[CH2](6)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH2]C(C=C)CC(199)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)C([CH2])CC(3736)'],
    products = ['[CH2]C(O)C(C)[CH]C(5635)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)C([CH2])CC(3736)'],
    products = ['[CH2]C([CH]C)C(C)O(3737)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC(C)C([CH2])O(5636)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(O)C([CH2])CC(3736)'],
    products = ['[CH2]CC([CH2])C(C)O(3740)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(D)(132)', '[CH2][CH]C([CH2])CC(208)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([O])C([CH2])CC(653)', 'H(8)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C[CH2](6)', '[CH2][CH]C([CH2])O(729)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C](CC)C([CH2])O(905)', 'H(8)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][C](O)C([CH2])CC(901)', 'H(8)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])C([CH2])O(789)', '[CH3](11)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(O)C([CH2])[CH]C(907)', 'H(8)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC([CH2])C([CH2])O(910)', 'H(8)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[CH2]C(C)C([CH2])O(3691)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(28)', '[CH2]C(O)[CH]CC(5601)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(T)(28)', '[CH2]C([CH]O)CC(503)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH]C(O)C([CH2])CC(5639)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH]C(CC)C([CH2])O(5640)'],
    products = ['[CH2]C(O)C([CH2])CC(3736)'],
