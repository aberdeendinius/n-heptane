...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243891,0.0937386,-0.000155788,1.44797e-07,-5.2633e-11,70147.3,36.4682], Tmin=(100,'K'), Tmax=(822.28,'K')), NASAPolynomial(coeffs=[6.66546,0.0412065,-2.11145e-05,4.11631e-09,-2.86326e-13,69811.1,11.1219], Tmin=(822.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(582.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CCOJ) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.484377,0.088086,-0.000144363,1.34407e-07,-4.87905e-11,64316.6,34.0597], Tmin=(100,'K'), Tmax=(833.79,'K')), NASAPolynomial(coeffs=[5.77307,0.0409322,-2.03465e-05,3.9159e-09,-2.70291e-13,64191.8,14.0466], Tmin=(833.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(533.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCOJ) + radical(Cds_P) + radical(ROOJ)"""),
)
...
species(
    label = '[CH]=CC[CH][C]([O])OO(20523)',
    structure = SMILES('[CH]=CC[CH][C]([O])OO'),
    E0 = (549.607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.338618,0.0895727,-0.000140374,1.264e-07,-4.55619e-11,66225.6,36.3434], Tmin=(100,'K'), Tmax=(797.073,'K')), NASAPolynomial(coeffs=[7.50628,0.0396632,-2.0217e-05,3.96045e-09,-2.77397e-13,65525.7,6.16696], Tmin=(797.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(CCJCOOH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C[CH][C](O)OO(20524)',
    structure = SMILES('[CH]=[C]C[CH][C](O)OO'),
    E0 = (561.744,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0450469,0.0967461,-0.000152037,1.29044e-07,-4.34797e-11,67700.4,37.3357], Tmin=(100,'K'), Tmax=(805.736,'K')), NASAPolynomial(coeffs=[11.1167,0.0325573,-1.61989e-05,3.13154e-09,-2.17366e-13,66186.6,-12.3344], Tmin=(805.736,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(561.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_P) + radical(CCJCOOH) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185085,0.0912273,-0.000141137,1.19421e-07,-4.00054e-11,61870.1,34.9636], Tmin=(100,'K'), Tmax=(825.958,'K')), NASAPolynomial(coeffs=[10.2524,0.0322323,-1.54005e-05,2.92373e-09,-2.00703e-13,60556.4,-9.5661], Tmin=(825.958,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(513.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_S) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.574268,0.0839786,-0.000129153,1.16254e-07,-4.1802e-11,60395.1,33.952], Tmin=(100,'K'), Tmax=(811.713,'K')), NASAPolynomial(coeffs=[6.6406,0.0393411,-1.94204e-05,3.75312e-09,-2.60777e-13,59895.9,8.94286], Tmin=(811.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(501.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P) + radical(ROOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.550909,0.0650444,-4.23481e-05,5.09349e-09,3.27184e-12,6874.69,33.175], Tmin=(100,'K'), Tmax=(1054.19,'K')), NASAPolynomial(coeffs=[17.0902,0.0219532,-9.0156e-06,1.70964e-09,-1.22168e-13,2294.87,-52.673], Tmin=(1054.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.0495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCO)"""),
)

species(
    label = 'C#C[CH]CC([O])OO(20532)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327168,0.0875175,-0.000128844,1.07324e-07,-3.5476e-11,25282.3,30.6729], Tmin=(100,'K'), Tmax=(852.949,'K')), NASAPolynomial(coeffs=[9.12543,0.0346775,-1.55557e-05,2.86126e-09,-1.92711e-13,24202.6,-7.905], Tmin=(852.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651211,0.0896037,-0.000163718,1.63623e-07,-6.10227e-11,42875.3,33.9647], Tmin=(100,'K'), Tmax=(864.477,'K')), NASAPolynomial(coeffs=[1.79663,0.0463971,-2.29739e-05,4.36075e-09,-2.96341e-13,44093.6,36.7979], Tmin=(864.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]=[C]CC[C][O](19543)',
    structure = SMILES('[CH]=[C]CC[C][O]'),
    E0 = (971.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,283.924,283.924,283.924,4000],'cm^-1')),
        HinderedRotor(inertia=(0.545418,'amu*angstrom^2'), symmetry=1, barrier=(31.2002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159461,'amu*angstrom^2'), symmetry=1, barrier=(9.1219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159461,'amu*angstrom^2'), symmetry=1, barrier=(9.12192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34343,0.0659121,-0.000106872,9.79121e-08,-3.51541e-11,116933,25.0294], Tmin=(100,'K'), Tmax=(829.345,'K')), NASAPolynomial(coeffs=[5.98434,0.0291814,-1.44901e-05,2.79185e-09,-1.92974e-13,116657,6.48278], Tmin=(829.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(971.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CH2_triplet) + radical(Cds_P) + radical(CCOJ)"""),
)
...
species(
    label = '[C]=[C]CC[C]([O])OO(20535)',
    structure = SMILES('[C]=[C]CC[C]([O])OO'),
    E0 = (898.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,360,370,350,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.273279,0.0955429,-0.000171753,1.65103e-07,-6.0622e-11,108130,34.7197], Tmin=(100,'K'), Tmax=(837.704,'K')), NASAPolynomial(coeffs=[5.74319,0.0404872,-2.13544e-05,4.17641e-09,-2.89613e-13,108229,15.3594], Tmin=(837.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(898.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(CCOJ) + radical(CdCdJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=[C]C[CH]C(=O)OO(20517)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.123469,'m^3/(mol*s)'), n=2.00579, Ea=(206.548,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', 'C#CCC[C]([O])[O](18573)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.24379e+07,'m^3/(mol*s)'), n=-0.377333, Ea=(136.24,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;OJ_pri] for rate rule [Od_R;OJ_pri]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 131.8 to 136.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['[CH]=[C]C[CH]C([O])OO(20519)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['[CH]=CC[CH][C]([O])OO(20523)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['[CH]=[C]C[CH][C](O)OO(20524)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['[CH]=[C]CC[C](O)O[O](20525)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['C=[C]C[CH][C]([O])OO(18403)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(D)(132)', '[CH]=[C]CC[C]([O])[O](18582)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]CC[C]([O])O[O](20528)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]=[C]C[CH][C]([O])OO(20529)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['[CH]=CC[CH]C(=O)OO(20531)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[O]O(16)', '[CH]=[C]CC[C][O](19543)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[O][C]OO(1370)', '[CH]=[C]C[CH2](5188)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C[C]([O])OO(1371)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[C]=[C]CC[C]([O])OO(20535)'],
    products = ['[CH]=[C]CC[C]([O])OO(18405)'],
