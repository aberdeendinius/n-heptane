...
species(
    label = '[CH2]C([O])([O])C=CC(2437)',
    structure = SMILES('[CH2]C([O])([O])C=CC'),
    E0 = (241.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,180,180,180,194.276,1600,1866.67,2631.15,3200],'cm^-1')),
        HinderedRotor(inertia=(0.16569,'amu*angstrom^2'), symmetry=1, barrier=(3.80955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16569,'amu*angstrom^2'), symmetry=1, barrier=(3.80955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16569,'amu*angstrom^2'), symmetry=1, barrier=(3.80955,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.485872,0.0772466,-9.39103e-05,6.11933e-08,-1.57693e-11,29148.6,28.0074], Tmin=(100,'K'), Tmax=(952.841,'K')), NASAPolynomial(coeffs=[13.4062,0.0230074,-8.52459e-06,1.45208e-09,-9.47784e-14,26686.4,-33.7014], Tmin=(952.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]CCC([CH2])([O])[O](2439)',
    structure = SMILES('[CH2]CCC([CH2])([O])[O]'),
    E0 = (332.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.861748,0.0793688,-0.000120064,1.15828e-07,-4.44914e-11,40140.1,29.1958], Tmin=(100,'K'), Tmax=(813.725,'K')), NASAPolynomial(coeffs=[2.65227,0.0489712,-2.42206e-05,4.69106e-09,-3.26543e-13,40563.6,25.32], Tmin=(813.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])(O)[CH][CH]C(2440)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848524,0.073114,-8.02345e-05,5.11957e-08,-1.36713e-11,34989.1,32.1293], Tmin=(100,'K'), Tmax=(896.684,'K')), NASAPolynomial(coeffs=[9.55608,0.0342694,-1.52523e-05,2.8813e-09,-2.00606e-13,33427.5,-8.92977], Tmin=(896.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(RCCJC) + radical(CC(C)(O)OJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH][CH]C(C)([O])[O](2441)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.19546,0.0447616,-2.04327e-05,3.62124e-09,-2.14773e-13,36756.2,23.8348], Tmin=(100,'K'), Tmax=(2871.49,'K')), NASAPolynomial(coeffs=[43.1317,-0.00203626,-6.01018e-07,8.82925e-11,-4.56546e-16,10179.1,-217.302], Tmin=(2871.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CC([CH2])([O])O(2442)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.880513,0.0760517,-8.39546e-05,4.28085e-08,-2.21267e-12,35627,31.3473], Tmin=(100,'K'), Tmax=(602.628,'K')), NASAPolynomial(coeffs=[8.77238,0.0363279,-1.6588e-05,3.14153e-09,-2.17844e-13,34446,-4.63664], Tmin=(602.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(RCCJ) + radical(RCCJC) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][CH]CC(C)([O])[O](2443)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.68439,0.0440602,-1.97452e-05,3.27301e-09,-1.67647e-13,37370.2,21.2899], Tmin=(100,'K'), Tmax=(2951.47,'K')), NASAPolynomial(coeffs=[54.1806,-0.0124958,2.96042e-06,-4.91964e-10,3.57491e-14,2388.49,-285.743], Tmin=(2951.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(RCCJC) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])([O])[CH][CH]C(2444)',
    structure = SMILES('[CH2]C([O])([O])[CH][CH]C'),
    E0 = (521.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21268,0.0736866,-0.000120592,1.22715e-07,-4.78667e-11,62869.2,31.3816], Tmin=(100,'K'), Tmax=(838.309,'K')), NASAPolynomial(coeffs=[0.332495,0.0488249,-2.41068e-05,4.63164e-09,-3.19543e-13,64037.9,41.5634], Tmin=(838.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(521.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.299337,0.0813703,-8.43219e-05,4.34171e-08,-8.54328e-12,1159.09,30.6396], Tmin=(100,'K'), Tmax=(1351.5,'K')), NASAPolynomial(coeffs=[20.5101,0.0141511,-3.46816e-06,4.51299e-10,-2.53142e-14,-3951.53,-74.1198], Tmin=(1351.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.25667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ)"""),
)

species(
    label = 'CC=CC(C)([O])[O](2447)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.687684,0.073289,-8.15597e-05,5.12753e-08,-1.30534e-11,3459.19,26.3594], Tmin=(100,'K'), Tmax=(955.182,'K')), NASAPolynomial(coeffs=[11.4489,0.0282235,-1.07879e-05,1.87914e-09,-1.246e-13,1403.46,-25.0633], Tmin=(955.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.7729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])(O)CC=C(2448)',
    structure = SMILES('[CH2]C([O])(O)CC=C'),
    E0 = (23.4332,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605222,0.0723427,-6.7414e-05,3.28996e-08,-6.49711e-12,2942.5,28.2332], Tmin=(100,'K'), Tmax=(1210.56,'K')), NASAPolynomial(coeffs=[14.234,0.0273094,-1.16129e-05,2.16914e-09,-1.50738e-13,-357.163,-40.1219], Tmin=(1210.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.4332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(O)2C) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'C=CCC(C)([O])[O](2449)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73313,0.0558857,-4.01373e-05,1.8239e-08,-4.23401e-12,4772.07,24.5147], Tmin=(100,'K'), Tmax=(893.134,'K')), NASAPolynomial(coeffs=[4.23785,0.044668,-2.12974e-05,4.17627e-09,-2.97655e-13,4324.66,12.7139], Tmin=(893.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C([O])([O])C[C]C(2450)',
    structure = SMILES('[CH2]C([O])([O])C[C]C'),
    E0 = (575.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759387,0.081832,-0.000129555,1.23644e-07,-4.64894e-11,69366,27.6825], Tmin=(100,'K'), Tmax=(820.569,'K')), NASAPolynomial(coeffs=[3.8456,0.0450301,-2.25083e-05,4.36127e-09,-3.0303e-13,69592,17.867], Tmin=(820.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])([O])C[CH]C(2451)',
    structure = SMILES('[CH]C([O])([O])C[CH]C'),
    E0 = (553.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17039,0.0720775,-0.000108761,1.05483e-07,-4.04267e-11,66713.5,29.7733], Tmin=(100,'K'), Tmax=(826.586,'K')), NASAPolynomial(coeffs=[2.12442,0.0459505,-2.23145e-05,4.2781e-09,-2.95736e-13,67290.7,29.7973], Tmin=(826.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])([O])C=CC(2437)', 'H(8)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([O])([O])CC=C(2438)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C([O])C[CH]C(821)', 'O(T)(63)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]CC([O])=O(1926)', 'CH2(T)(28)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(7.90002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
...
reaction(
    ...
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(83.8961,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 80.6 to 83.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])([O])[CH]CC(2415)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CCC([CH2])([O])[O](2439)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([O])([O])C[CH]C(1538)'],
    products = ['[CH2]C([O])(O)[CH][CH]C(2440)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])([O])C[CH]C(1538)'],
    products = ['[CH2][CH]CC([CH2])([O])O(2442)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([O])([O])[CH][CH]C(2444)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]CC([CH2])([O])[O](2445)', 'H(8)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([O])([O])C[CH]C(1538)'],
    products = ['[CH2]C1(C[CH]C)OO1(1546)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C(32)', '[CH2]C([CH2])([O])[O](2328)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH3](11)', '[CH]CC([CH2])([O])[O](2330)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([O])([O])C[C]C(2450)', 'H(8)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C([O])([O])C[CH]C(2451)', 'H(8)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
