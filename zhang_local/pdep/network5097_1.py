...
species(
    label = 'O=[C]OC=C=CO(28439)',
    structure = SMILES('O=[C]OC=C=CO'),
    E0 = (-165.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,540,610,2055,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.37744,'amu*angstrom^2'), symmetry=1, barrier=(31.67,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38008,'amu*angstrom^2'), symmetry=1, barrier=(31.7307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.38026,'amu*angstrom^2'), symmetry=1, barrier=(31.735,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.509882,0.0769618,-9.07161e-05,4.73172e-08,-8.93151e-12,-19779.5,24.666], Tmin=(100,'K'), Tmax=(1536.53,'K')), NASAPolynomial(coeffs=[24.0693,-0.00366548,4.23977e-06,-9.30664e-10,6.54442e-14,-25368.4,-98.0795], Tmin=(1536.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + group(Cdd-CdsCds) + radical((O)CJOC)"""),
)

species(
    label = 'O=[C]OCC#CO(28440)',
    structure = SMILES('O=[C]OCC#CO'),
    E0 = (-75.8928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2100,2250,500,550,398.589,399.77,400.277],'cm^-1')),
        HinderedRotor(inertia=(0.00104014,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0989674,'amu*angstrom^2'), symmetry=1, barrier=(11.2434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289388,'amu*angstrom^2'), symmetry=1, barrier=(32.8343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.741625,'amu*angstrom^2'), symmetry=1, barrier=(84.4251,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65436,0.050147,-5.19935e-05,2.81576e-08,-6.09e-12,-9042.08,23.6378], Tmin=(100,'K'), Tmax=(1120.98,'K')), NASAPolynomial(coeffs=[11.1368,0.0163107,-6.71612e-06,1.23011e-09,-8.46125e-14,-11168,-23.1922], Tmin=(1120.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.8928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CtH) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtOs) + radical((O)CJOCC)"""),
)
...
species(
    label = 'C#CCO[C]=O(17919)',
    structure = SMILES('C#CCO[C]=O'),
    E0 = (65.5729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,750,770,3400,2100,2175,525,1855,455,950,418.404,418.593],'cm^-1')),
        HinderedRotor(inertia=(0.100671,'amu*angstrom^2'), symmetry=1, barrier=(12.5092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793273,'amu*angstrom^2'), symmetry=1, barrier=(98.5399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.793533,'amu*angstrom^2'), symmetry=1, barrier=(98.5416,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93584,0.0420327,-3.91632e-05,1.69871e-08,-2.16736e-12,7963.95,19.2884], Tmin=(100,'K'), Tmax=(951.374,'K')), NASAPolynomial(coeffs=[10.7529,0.0124026,-4.17746e-06,6.91663e-10,-4.54654e-14,5949.57,-24.5787], Tmin=(951.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.5729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CtOsHH) + group(Cds-OdOsH) + group(Ct-CtCs) + group(Ct-CtH) + radical((O)CJOCC)"""),
)
...
species(
    label = 'O=CO[CH][C]=CO(28441)',
    structure = SMILES('O=CO[CH][C]=CO'),
    E0 = (-158.071,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29555,0.0511183,-3.49182e-05,4.7312e-09,2.70552e-12,-18906.9,25.6046], Tmin=(100,'K'), Tmax=(1029.69,'K')), NASAPolynomial(coeffs=[14.6016,0.0153952,-6.13796e-06,1.15681e-09,-8.29185e-14,-22493.5,-43.0888], Tmin=(1029.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-158.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(Cds_S) + radical(C=CCJ(O)C)"""),
)
...
species(
    label = 'O=COC[C]=[C]O(28442)',
    structure = SMILES('O=COC[C]=[C]O'),
    E0 = (-29.2657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2782.5,750,1395,475,1775,1000,279.346,281.029,973.845],'cm^-1')),
        HinderedRotor(inertia=(0.0105178,'amu*angstrom^2'), symmetry=1, barrier=(16.545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291337,'amu*angstrom^2'), symmetry=1, barrier=(16.5466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282357,'amu*angstrom^2'), symmetry=1, barrier=(16.5373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.50288,'amu*angstrom^2'), symmetry=1, barrier=(84.2211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44252,0.0534795,-5.06231e-05,2.46021e-08,-4.7883e-12,-3425.48,27.2705], Tmin=(100,'K'), Tmax=(1235.28,'K')), NASAPolynomial(coeffs=[12.3594,0.018129,-7.6967e-06,1.43506e-09,-9.96557e-14,-6122.55,-27.7038], Tmin=(1235.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.2657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = 'O=[C]O[CH][C]=CO(28443)',
    structure = SMILES('O=[C]O[CH][C]=CO'),
    E0 = (39.6111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,3615,1277.5,1000,1855,455,950,3010,987.5,1337.5,450,1655,429.636,429.637,429.642],'cm^-1')),
        HinderedRotor(inertia=(0.145138,'amu*angstrom^2'), symmetry=1, barrier=(19.0118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14514,'amu*angstrom^2'), symmetry=1, barrier=(19.0118,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.913268,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145138,'amu*angstrom^2'), symmetry=1, barrier=(19.0119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.777988,0.0609326,-6.74554e-05,3.54827e-08,-7.0546e-12,4888.61,27.098], Tmin=(100,'K'), Tmax=(1335.55,'K')), NASAPolynomial(coeffs=[17.6893,0.00615904,-1.30601e-06,1.50997e-10,-8.16006e-15,739.202,-58.0057], Tmin=(1335.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.6111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(C=CCJ(O)C) + radical(Cds_S) + radical((O)CJOCC)"""),
)

species(
    label = 'O=[C]OC[C]=[C]O(28444)',
    structure = SMILES('O=[C]OC[C]=[C]O'),
    E0 = (168.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1670,1700,300,440,325.675,325.724,325.981],'cm^-1')),
        HinderedRotor(inertia=(0.00158736,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203947,'amu*angstrom^2'), symmetry=1, barrier=(15.3695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204007,'amu*angstrom^2'), symmetry=1, barrier=(15.37,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203987,'amu*angstrom^2'), symmetry=1, barrier=(15.3696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11294,0.0611191,-7.57958e-05,4.62272e-08,-1.0867e-11,20361.8,28.0873], Tmin=(100,'K'), Tmax=(1052.53,'K')), NASAPolynomial(coeffs=[14.3962,0.0106383,-3.85405e-06,6.59955e-10,-4.38454e-14,17565.6,-36.6767], Tmin=(1052.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(C=CJO) + radical(Cds_S)"""),
)

species(
    label = 'O=COC=C=CO(27739)',
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.610314,0.058555,-2.57587e-05,-2.83881e-08,2.05547e-11,-43451.4,22.012], Tmin=(100,'K'), Tmax=(926.524,'K')), NASAPolynomial(coeffs=[23.8108,-0.000241055,2.46054e-06,-5.0645e-10,2.96486e-14,-49526.1,-97.728], Tmin=(926.524,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-362.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=[C]OC=C=CO(28439)'],
    products = ['O=[C]OC[C]=CO(14562)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'O=[C]OCC#CO(28440)'],
    products = ['O=[C]OC[C]=CO(14562)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['O=[C]OC[C]=CO(14562)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(145.087,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
...
reaction(
    label = 'reaction5',
    reactants = ['OH(D)(132)', 'C#CCO[C]=O(17919)'],
    products = ['O=[C]OC[C]=CO(14562)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH]=[C]CO[C]=O(17923)'],
    products = ['O=[C]OC[C]=CO(14562)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', 'O=[C]O[CH][C]=CO(28443)'],
    products = ['O=[C]OC[C]=CO(14562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', 'O=[C]OC[C]=[C]O(28444)'],
    products = ['O=[C]OC[C]=CO(14562)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C-]#[O+](374)', '[O]C[C]=CO(27712)'],
    products = ['O=[C]OC[C]=CO(14562)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]=O(1149)', '[O]C[C]=CO(27712)'],
    products = ['O=[C]OC[C]=CO(14562)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[C]=O(1735)', '[C]=CO(27807)'],
    products = ['O=[C]OC[C]=CO(14562)'],
