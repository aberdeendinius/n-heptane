...
species(
    label = '[CH2]CO[C]=CC(12946)',
    structure = SMILES('[CH2]CO[C]=CC'),
    E0 = (229.801,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888828,0.0610037,-4.73153e-05,1.4974e-08,-4.70199e-13,27757.1,25.419], Tmin=(100,'K'), Tmax=(1027.85,'K')), NASAPolynomial(coeffs=[14.3974,0.0211682,-7.76491e-06,1.37495e-09,-9.42627e-14,24307.5,-43.3952], Tmin=(1027.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CJCO)"""),
)

species(
    label = '[CH2]C=[C]OCC(12947)',
    structure = SMILES('[CH2]C=[C]OCC'),
    E0 = (169.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,286.666,286.668,286.679],'cm^-1')),
        HinderedRotor(inertia=(0.0020513,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363464,'amu*angstrom^2'), symmetry=1, barrier=(21.1935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.363451,'amu*angstrom^2'), symmetry=1, barrier=(21.1934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.36336,'amu*angstrom^2'), symmetry=1, barrier=(21.1938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08598,0.0527867,-1.71348e-05,-2.00053e-08,1.27583e-11,20526.6,24.3582], Tmin=(100,'K'), Tmax=(966.295,'K')), NASAPolynomial(coeffs=[15.5667,0.0194159,-6.58125e-06,1.17194e-09,-8.33729e-14,16487.5,-51.4254], Tmin=(966.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2]C=[C]OC[CH2](12950)',
    structure = SMILES('[CH2]C=[C]OC[CH2]'),
    E0 = (381.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,241.824,754.746,754.746],'cm^-1')),
        HinderedRotor(inertia=(0.0462731,'amu*angstrom^2'), symmetry=1, barrier=(18.7047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813522,'amu*angstrom^2'), symmetry=1, barrier=(18.7045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813524,'amu*angstrom^2'), symmetry=1, barrier=(18.7045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.813523,'amu*angstrom^2'), symmetry=1, barrier=(18.7045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936079,0.0579513,-3.68187e-05,-8.94426e-10,6.60364e-12,45978.6,25.5298], Tmin=(100,'K'), Tmax=(959.822,'K')), NASAPolynomial(coeffs=[16.3375,0.015707,-5.08771e-06,8.81522e-10,-6.20166e-14,42011.5,-53.4062], Tmin=(959.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Allyl_P) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C1[CH]OCC1(12934)',
    structure = SMILES('[CH2]C1[CH]OCC1'),
    E0 = (154.155,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03012,0.0277805,5.46497e-05,-1.01282e-07,4.62125e-11,18626.4,17.7875], Tmin=(100,'K'), Tmax=(863.461,'K')), NASAPolynomial(coeffs=[14.1074,0.0155438,-2.79469e-08,-4.37139e-10,3.98301e-14,14911.2,-48.1411], Tmin=(863.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(Isobutyl) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH2][CH]CO[CH][CH2](775)',
    structure = SMILES('[CH2][CH]CO[CH][CH2]'),
    E0 = (500.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.930016,0.0691146,-7.57241e-05,4.57977e-08,-1.12837e-11,60250.2,28.6189], Tmin=(100,'K'), Tmax=(980.16,'K')), NASAPolynomial(coeffs=[11.2088,0.0271676,-1.15303e-05,2.13586e-09,-1.47349e-13,58235.2,-20.7641], Tmin=(980.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(500.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJ) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]O[CH]C[CH2](6364)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353277,0.0823215,-0.000107031,7.36973e-08,-2.00816e-11,57931.6,27.6366], Tmin=(100,'K'), Tmax=(900.743,'K')), NASAPolynomial(coeffs=[13.4954,0.0239619,-9.84778e-06,1.77166e-09,-1.19322e-13,55564,-34.3932], Tmin=(900.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJCO) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.738302,0.0584714,-1.76105e-05,-2.75273e-08,1.73371e-11,43516.7,23.9394], Tmin=(100,'K'), Tmax=(941.493,'K')), NASAPolynomial(coeffs=[18.0321,0.0178875,-5.35285e-06,8.98068e-10,-6.36076e-14,38802.6,-66.1921], Tmin=(941.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet) + radical(CJCO)"""),
)
...
species(
    label = '[CH]=CCOC[CH2](12956)',
    structure = SMILES('[CH]=CCOC[CH2]'),
    E0 = (294.871,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,180,245.372,399],'cm^-1')),
        HinderedRotor(inertia=(0.517128,'amu*angstrom^2'), symmetry=1, barrier=(11.8898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0184754,'amu*angstrom^2'), symmetry=1, barrier=(2.08751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.517123,'amu*angstrom^2'), symmetry=1, barrier=(11.8897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00543221,'amu*angstrom^2'), symmetry=1, barrier=(31.9077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46979,0.0592871,-5.56485e-05,3.13331e-08,-7.69488e-12,35552.9,24.2195], Tmin=(100,'K'), Tmax=(949.034,'K')), NASAPolynomial(coeffs=[7.54776,0.03367,-1.516e-05,2.89173e-09,-2.02808e-13,34399.2,-4.78532], Tmin=(949.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C=COCC(12957)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.887169,0.0533222,2.00229e-06,-4.65169e-08,2.34251e-11,18064.7,22.7713], Tmin=(100,'K'), Tmax=(948.407,'K')), NASAPolynomial(coeffs=[17.253,0.0216097,-6.85379e-06,1.19018e-09,-8.51011e-14,13282.3,-64.164], Tmin=(948.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C[CH]OC=C(6503)'],
    products = ['[CH2]C=COC[CH2](6367)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]COC=C=C(12944)'],
    products = ['[CH2]C=COC[CH2](6367)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C[O](419)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][CH]OC=C[CH2](6363)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]=COC[CH2](12949)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C=[C]OC[CH2](12950)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]CO[CH][CH2](775)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]O[CH]C[CH2](6364)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(28)', '[CH2]C=CO[CH2](6277)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[CH]=COC[CH2](4301)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]COC=C[CH2](12953)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH]C=COC[CH2](12954)'],
    products = ['[CH2]C=COC[CH2](6367)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]OC[CH2](422)', '[CH]=C(64)'],
    products = ['[CH2]C=COC[CH2](6367)'],
