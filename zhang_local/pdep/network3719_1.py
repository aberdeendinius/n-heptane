...
species(
    label = '[CH]=C(C)O[CH2](17675)',
    structure = SMILES('[CH]=C(C)O[CH2]'),
    E0 = (249.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,358.904],'cm^-1')),
        HinderedRotor(inertia=(0.00130859,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15358,'amu*angstrom^2'), symmetry=1, barrier=(13.9464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153229,'amu*angstrom^2'), symmetry=1, barrier=(13.9438,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80037,0.0405773,-1.83222e-05,-8.4625e-09,7.04245e-12,30076.4,19.6413], Tmin=(100,'K'), Tmax=(978.436,'K')), NASAPolynomial(coeffs=[12.5714,0.0142086,-4.97867e-06,8.97797e-10,-6.38719e-14,27123.1,-36.4088], Tmin=(978.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=COCJ)"""),
)

species(
    label = '[CH]C(=C)OC(17676)',
    structure = SMILES('[CH]C(=C)OC'),
    E0 = (180.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,354.335,354.336,354.357,354.359,354.359],'cm^-1')),
        HinderedRotor(inertia=(0.561744,'amu*angstrom^2'), symmetry=1, barrier=(50.0651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561948,'amu*angstrom^2'), symmetry=1, barrier=(50.0654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561938,'amu*angstrom^2'), symmetry=1, barrier=(50.0652,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76993,0.0389257,9.75774e-07,-2.99825e-08,1.45949e-11,21850.7,17.9709], Tmin=(100,'K'), Tmax=(968.796,'K')), NASAPolynomial(coeffs=[12.1417,0.0201619,-7.22398e-06,1.29456e-09,-9.12754e-14,18712,-37.5653], Tmin=(968.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC([CH2])=C(6270)'],
    products = ['[CH2]C1([CH2])CO1(9287)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(117.869,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH]C(=C)O[CH2](17677)'],
    products = ['[CH2]OC([CH2])=C(6270)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(28)', '[CH2]C(=C)[O](4273)'],
    products = ['[CH2]OC([CH2])=C(6270)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(28)', '[CH2]O[C]=C(4272)'],
    products = ['[CH2]OC([CH2])=C(6270)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]OC([CH2])=C(17678)'],
    products = ['[CH2]OC([CH2])=C(6270)'],
