species(
    label = '[CH2]C1(CO1)O[C]=C(9304)',
    structure = SMILES('[CH2]C1(CO1)O[C]=C'),
    E0 = (205.721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,2750,3150,900,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.58845,0.0942234,-0.000105669,5.376e-08,-9.5862e-12,25023.8,34.0194], Tmin=(100,'K'), Tmax=(1750.48,'K')), NASAPolynomial(coeffs=[22.1733,-0.000375576,7.96998e-06,-1.92574e-09,1.38601e-13,22179.3,-82.6692], Tmin=(1750.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2]OC(=C)O[C]=C(9780)',
    structure = SMILES('[CH2]OC(=C)O[C]=C'),
    E0 = (263.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1934,0.0636157,-6.65037e-05,3.80149e-08,-8.92239e-12,31744.7,28.157], Tmin=(100,'K'), Tmax=(1020.64,'K')), NASAPolynomial(coeffs=[10.7068,0.026332,-1.17096e-05,2.2246e-09,-1.55857e-13,29802.7,-17.9343], Tmin=(1020.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=COCJ) + radical(C=CJO)"""),
)
...
species(
    label = 'C#COC1([CH2])CO1(9782)',
    structure = SMILES('C#COC1([CH2])CO1'),
    E0 = (175.303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,750,770,3400,2100,3000,3100,440,815,1455,1000,2175,525,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.78761,0.0980906,-0.000115311,5.9811e-08,-1.08204e-11,21373,29.054], Tmin=(100,'K'), Tmax=(1722.47,'K')), NASAPolynomial(coeffs=[24.6468,-0.00582927,1.02033e-05,-2.32119e-09,1.64581e-13,17887,-100.904], Tmin=(1722.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'C=[C]OC1(C)[CH]O1(9784)',
    structure = SMILES('C=[C]OC1(C)[CH]O1'),
    E0 = (178.933,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238311,0.053827,3.67784e-05,-1.27066e-07,6.63591e-11,21683.8,24.2954], Tmin=(100,'K'), Tmax=(874.215,'K')), NASAPolynomial(coeffs=[33.4704,-0.0160383,1.56326e-05,-3.39813e-09,2.39734e-13,12732.7,-149.526], Tmin=(874.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)OC=C(9785)',
    structure = SMILES('[CH2]C1([CH]O1)OC=C'),
    E0 = (149.699,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.91865,0.1064,-0.000122451,6.19208e-08,-1.08421e-11,18349,35.9027], Tmin=(100,'K'), Tmax=(1803.88,'K')), NASAPolynomial(coeffs=[24.4291,-0.00542999,1.12605e-05,-2.54444e-09,1.77811e-13,16089.2,-95.4986], Tmin=(1803.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH]=[C]OC1(C)CO1(9786)',
    structure = SMILES('[CH]=[C]OC1(C)CO1'),
    E0 = (242.307,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,3150,900,1100,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.361927,0.053821,2.92825e-05,-1.14007e-07,6.04589e-11,29298.9,24.0526], Tmin=(100,'K'), Tmax=(871.446,'K')), NASAPolynomial(coeffs=[31.1441,-0.0122793,1.36331e-05,-3.02244e-09,2.14984e-13,21078.8,-136.599], Tmin=(871.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C1([CH]O1)O[C]=C(9787)',
    structure = SMILES('[CH2]C1([CH]O1)O[C]=C'),
    E0 = (389.443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,2950,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.79101,0.0979599,-0.000116186,6.06573e-08,-1.10209e-11,47128.4,34.938], Tmin=(100,'K'), Tmax=(1718.8,'K')), NASAPolynomial(coeffs=[24.4686,-0.00645486,1.06965e-05,-2.42678e-09,1.72119e-13,43810.3,-93.7309], Tmin=(1718.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH]=[C]OC1([CH2])CO1(9788)',
    structure = SMILES('[CH]=[C]OC1([CH2])CO1'),
    E0 = (452.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,3150,900,1100,3000,3100,440,815,1455,1000,1685,370,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.33919,0.0942598,-0.000111474,5.87087e-08,-1.0811e-11,54728.7,33.5045], Tmin=(100,'K'), Tmax=(1686.88,'K')), NASAPolynomial(coeffs=[23.6474,-0.00461618,9.57662e-06,-2.22359e-09,1.59655e-13,51262.1,-89.7424], Tmin=(1686.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(CJC(C)OC) + radical(C=CJO)"""),
)
...
species(
    label = 'C=[C]O[C]1CCO1(9789)',
    structure = SMILES('C=[C]O[C]1CCO1'),
    E0 = (219.504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43195,0.0410037,2.18812e-05,-7.14682e-08,3.56616e-11,26507.4,25.229], Tmin=(100,'K'), Tmax=(884.425,'K')), NASAPolynomial(coeffs=[17.6692,0.0105749,5.47549e-07,-4.05043e-10,3.2411e-14,21953.2,-60.6214], Tmin=(884.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cs_P) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])O[C]=C(9791)',
    structure = SMILES('[CH2]O[C]([CH2])O[C]=C'),
    E0 = (479.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.384209,0.0753477,-8.3657e-05,4.59745e-08,-9.84033e-12,57799.3,32.0935], Tmin=(100,'K'), Tmax=(1146.56,'K')), NASAPolynomial(coeffs=[17.2394,0.0165439,-6.72473e-06,1.24141e-09,-8.63651e-14,53934.3,-51.528], Tmin=(1146.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsJOCH3) + radical(C=CJO) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([CH2])([O])O[C]=C(9792)',
    structure = SMILES('[CH2]C([CH2])([O])O[C]=C'),
    E0 = (458.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,180,180,180,369.202,767.588,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.15319,'amu*angstrom^2'), symmetry=1, barrier=(3.52213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15319,'amu*angstrom^2'), symmetry=1, barrier=(3.52213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15319,'amu*angstrom^2'), symmetry=1, barrier=(3.52213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15319,'amu*angstrom^2'), symmetry=1, barrier=(3.52213,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.352875,0.0908865,-0.000116616,7.20022e-08,-1.69559e-11,55324.7,29.2429], Tmin=(100,'K'), Tmax=(1056.02,'K')), NASAPolynomial(coeffs=[20.6943,0.0111638,-3.37546e-06,5.13206e-10,-3.17799e-14,50879.5,-73.4447], Tmin=(1056.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CC(C)(O)OJ) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]C1(CO1)O[C]=C(9794)',
    structure = SMILES('[CH]C1(CO1)O[C]=C'),
    E0 = (443.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,3150,900,1100,1685,370,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.383906,0.0533409,2.65026e-05,-1.11881e-07,6.01103e-11,53487.2,24.5749], Tmin=(100,'K'), Tmax=(870.045,'K')), NASAPolynomial(coeffs=[31.7864,-0.0155017,1.49749e-05,-3.27111e-09,2.32156e-13,45164.1,-138.981], Tmin=(870.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)O[C]=C(9780)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#COC1([CH2])CO1(9782)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=COC1([CH2])CO1(9783)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C1(CO1)O[C]=C(9304)'],
    products = ['[CH2]C1([CH]O1)OC=C(9785)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C1([CH]O1)O[C]=C(9787)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]=[C]OC1([CH2])CO1(9788)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(14)', '[CH2]C(=O)O[C]=C(4288)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O(S)(1732)', '[CH2]C(=C)O[C]=C(6487)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]O[C]([CH2])O[C]=C(9791)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])([O])O[C]=C(9792)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C1(CO1)O[C]=C(9794)'],
    products = ['[CH2]C1(CO1)O[C]=C(9304)'],
