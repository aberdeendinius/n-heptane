species(
    ...
    E0 = (-2.98751,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
...
species(
    label = '[O]C1([O])C[CH]COO1(7537)',
    structure = SMILES('[O]C1([O])C[CH]COO1'),
    E0 = (114.761,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60004,0.0511982,-3.88892e-05,1.90448e-08,-4.12276e-12,13890.2,26.2641], Tmin=(100,'K'), Tmax=(1072.43,'K')), NASAPolynomial(coeffs=[6.89376,0.0314535,-1.12727e-05,1.87733e-09,-1.20798e-13,12754.8,0.35471], Tmin=(1072.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCJCOOH) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    label = '[O]OCC=CC([O])=O(7538)',
    structure = SMILES('[O]OCC=CC([O])=O'),
    E0 = (6.20883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,180,180,180,858.063,1600,2661.56,3200],'cm^-1')),
        HinderedRotor(inertia=(0.121104,'amu*angstrom^2'), symmetry=1, barrier=(2.78441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121104,'amu*angstrom^2'), symmetry=1, barrier=(2.78441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121104,'amu*angstrom^2'), symmetry=1, barrier=(2.78441,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25921,0.0761278,-0.000146288,1.5403e-07,-5.98906e-11,830.133,29.0542], Tmin=(100,'K'), Tmax=(850.144,'K')), NASAPolynomial(coeffs=[-0.254894,0.0448645,-2.33964e-05,4.54758e-09,-3.13729e-13,2474.79,44.2718], Tmin=(850.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.20883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = '[O]OC=CCC([O])=O(7539)',
    structure = SMILES('[O]OC=CCC([O])=O'),
    E0 = (-65.4131,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09062,0.0480321,-3.01971e-05,8.12517e-09,-8.47006e-13,-7805.57,24.6313], Tmin=(100,'K'), Tmax=(2135.72,'K')), NASAPolynomial(coeffs=[16.6835,0.020701,-1.10015e-05,2.13328e-09,-1.45618e-13,-14038.9,-56.8443], Tmin=(2135.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.4131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCOJ)"""),
)
...
species(
    label = '[O]O[CH]CCC([O])=O(7540)',
    structure = SMILES('[O]O[CH]CCC([O])=O'),
    E0 = (-14.82,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900748,0.0820859,-0.000143671,1.45039e-07,-5.55889e-11,-1684.31,28.6051], Tmin=(100,'K'), Tmax=(841.421,'K')), NASAPolynomial(coeffs=[1.4194,0.0473132,-2.4088e-05,4.66022e-09,-3.21846e-13,-627.937,32.9884], Tmin=(841.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[O]C(=O)C[CH][CH]OO(7541)',
    structure = SMILES('[O]C(=O)C[CH][CH]OO'),
    E0 = (33.5903,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656666,0.0877831,-0.000155261,1.5565e-07,-5.95246e-11,4146.54,31.0263], Tmin=(100,'K'), Tmax=(832.976,'K')), NASAPolynomial(coeffs=[2.32656,0.0475612,-2.48404e-05,4.85685e-09,-3.37562e-13,4985.55,29.9813], Tmin=(832.976,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.5903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCsJOOH) + radical(CCJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[O]OC[CH]C=C([O])O(7542)',
    structure = SMILES('[O]OC[CH]C=C([O])O'),
    E0 = (-60.3896,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0606314,0.0898684,-0.000115421,7.40629e-08,-1.85364e-11,-7117.36,27.1385], Tmin=(100,'K'), Tmax=(983.348,'K')), NASAPolynomial(coeffs=[17.17,0.0197795,-8.5087e-06,1.58137e-09,-1.09358e-13,-10506.1,-55.6999], Tmin=(983.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.3896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=CCJCO) + radical(C=COJ) + radical(ROOJ)"""),
)

species(
    label = '[O]O[CH][CH]CC(=O)O(7543)',
    structure = SMILES('[O]O[CH][CH]CC(=O)O'),
    E0 = (-40.1102,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576835,0.0866785,-0.000146504,1.37822e-07,-4.99732e-11,-4711.85,31.9068], Tmin=(100,'K'), Tmax=(845.217,'K')), NASAPolynomial(coeffs=[5.40238,0.0395325,-1.96936e-05,3.77181e-09,-2.58896e-13,-4659.27,14.5744], Tmin=(845.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.1102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(ROOJ) + radical(CCsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = '[O]C([O])=C[CH]COO(7544)',
    structure = SMILES('[O]C([O])=C[CH]COO'),
    E0 = (-70.9317,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.297234,0.0839306,-9.79785e-05,5.82913e-08,-1.38467e-11,-8399.76,26.5108], Tmin=(100,'K'), Tmax=(1020.99,'K')), NASAPolynomial(coeffs=[15.154,0.0257266,-1.24697e-05,2.45875e-09,-1.75877e-13,-11433.6,-45.4736], Tmin=(1020.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.9317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=CCJCO) + radical(C=COJ) + radical(C=COJ)"""),
)
...
species(
    label = '[O]OC[CH]C=C([O])[O](7545)',
    structure = SMILES('[O]OC[CH]C=C([O])[O]'),
    E0 = (81.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,310.866,310.868,310.869,310.871],'cm^-1')),
        HinderedRotor(inertia=(0.266013,'amu*angstrom^2'), symmetry=1, barrier=(18.2429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.412792,'amu*angstrom^2'), symmetry=1, barrier=(28.3085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.967732,'amu*angstrom^2'), symmetry=1, barrier=(66.3648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.487445,0.0811835,-0.000105552,7.1274e-08,-1.91871e-11,9873.95,26.5887], Tmin=(100,'K'), Tmax=(906.596,'K')), NASAPolynomial(coeffs=[13.3397,0.0244769,-1.17273e-05,2.27894e-09,-1.60941e-13,7543.61,-34.1557], Tmin=(906.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=CCJCO) + radical(C=COJ) + radical(C=COJ) + radical(ROOJ)"""),
)

species(
    label = '[O]O[CH][CH]CC([O])=O(7546)',
    structure = SMILES('[O]O[CH][CH]CC([O])=O'),
    E0 = (185.595,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.912612,0.0842661,-0.000160083,1.64763e-07,-6.29673e-11,22417.3,30.8675], Tmin=(100,'K'), Tmax=(853.401,'K')), NASAPolynomial(coeffs=[0.760228,0.045863,-2.38274e-05,4.61092e-09,-3.17002e-13,23867.8,39.9242], Tmin=(853.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH) + radical(CCOJ)"""),
)

species(
    label = '[O]OC[CH]C[C]1OO1(7547)',
    structure = SMILES('[O]OC[CH]C[C]1OO1'),
    E0 = (359.192,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.571571,0.0727638,-8.11419e-05,4.73932e-08,-1.09179e-11,43326.6,32.538], Tmin=(100,'K'), Tmax=(1063.8,'K')), NASAPolynomial(coeffs=[14.4431,0.0206049,-7.59483e-06,1.30182e-09,-8.59796e-14,40375.3,-35.2417], Tmin=(1063.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(dioxirane) + radical(Cs_P) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[O]OCC1C[C]([O])O1(7548)',
    structure = SMILES('[O]OCC1C[C]([O])O1'),
    E0 = (161.66,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14479,0.0630223,-6.81072e-05,4.46596e-08,-1.20412e-11,19545.7,28.5515], Tmin=(100,'K'), Tmax=(948.041,'K')), NASAPolynomial(coeffs=[8.83625,0.0285147,-1.02564e-05,1.69156e-09,-1.07369e-13,18179.7,-7.65772], Tmin=(948.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = '[O][C]1C[CH]COOO1(7549)',
    structure = SMILES('[O][C]1C[CH]COOO1'),
    E0 = (324.588,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48387,0.00821419,0.000172314,-2.65644e-07,1.12995e-10,39173.6,32.0827], Tmin=(100,'K'), Tmax=(910.474,'K')), NASAPolynomial(coeffs=[35.9703,-0.020294,1.66369e-05,-3.27399e-09,2.09974e-13,27795.6,-159.057], Tmin=(910.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cycloheptane) + radical(Cs_P) + radical(CCOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[O]OCC=CC(=O)O(6931)',
    structure = SMILES('[O]OCC=CC(=O)O'),
    E0 = (-219.496,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924593,0.0785262,-0.000132661,1.27029e-07,-4.68744e-11,-26299.1,30.0894], Tmin=(100,'K'), Tmax=(840.066,'K')), NASAPolynomial(coeffs=[4.38112,0.0385448,-1.92691e-05,3.71001e-09,-2.55752e-13,-26049.8,18.9562], Tmin=(840.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(ROOJ)"""),
)

species(
    label = '[O]C(=O)CC=COO(7550)',
    structure = SMILES('[O]C(=O)CC=COO'),
    E0 = (-217.418,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4805,0.0551923,-3.59654e-05,1.01036e-08,-1.09402e-12,-26059.3,26.1018], Tmin=(100,'K'), Tmax=(2122.23,'K')), NASAPolynomial(coeffs=[21.0055,0.0183916,-9.95473e-06,1.93277e-09,-1.31504e-13,-34346.6,-82.7871], Tmin=(2122.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-217.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(CCOJ)"""),
)

species(
    label = '[O]OC=CCC(=O)O(7551)',
    structure = SMILES('[O]OC=CCC(=O)O'),
    E0 = (-291.118,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.986582,0.0589662,-4.45619e-05,1.57385e-08,-2.18982e-12,-34899.1,28.4721], Tmin=(100,'K'), Tmax=(1690.83,'K')), NASAPolynomial(coeffs=[17.8942,0.0189681,-9.07812e-06,1.74793e-09,-1.21222e-13,-40616.7,-61.9776], Tmin=(1690.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-291.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[O]C(=O)C=CCOO(7552)',
    structure = SMILES('[O]C(=O)C=CCOO'),
    E0 = (-145.796,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00247,0.0796578,-0.000141534,1.4505e-07,-5.65323e-11,-17440.6,29.2157], Tmin=(100,'K'), Tmax=(828.768,'K')), NASAPolynomial(coeffs=[1.3042,0.0465753,-2.44167e-05,4.79525e-09,-3.34434e-13,-16404.5,34.3694], Tmin=(828.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-145.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + radical(CCOJ)"""),
)

species(
    label = '[O]OC[CH][CH]C([O])[O](7553)',
    structure = SMILES('[O]OC[CH][CH]C([O])[O]'),
    E0 = (411.047,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,375.167,414.853,442.012,2102.76,3387.26],'cm^-1')),
        HinderedRotor(inertia=(0.00401127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401127,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804426,0.0865652,-0.000162855,1.66327e-07,-6.32526e-11,49536.9,36.9864], Tmin=(100,'K'), Tmax=(853.227,'K')), NASAPolynomial(coeffs=[1.19591,0.0460959,-2.3789e-05,4.59893e-09,-3.16125e-13,50876.4,43.4007], Tmin=(853.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCJCOOH) + radical(CCJCO) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09938,0.0444537,-2.2877e-05,-7.60804e-09,1.19946e-11,-30000.9,19.3722], Tmin=(100,'K'), Tmax=(637.934,'K')), NASAPolynomial(coeffs=[5.63061,0.0309955,-1.16496e-05,1.99609e-09,-1.30975e-13,-30628.1,2.53852], Tmin=(637.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-249.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(Ethylene_oxide) + radical(CCOJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4716.67,'J/mol'), sigma=(7.16528,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=736.73 K, Pc=29.09 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[O]C(=O)CC1COO1(7554)',
    structure = SMILES('[O]C(=O)CC1COO1'),
    E0 = (-192.734,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35743,0.0555185,-4.32482e-05,1.99021e-08,-3.91276e-12,-23083.2,23.8619], Tmin=(100,'K'), Tmax=(1187.3,'K')), NASAPolynomial(coeffs=[8.88375,0.0301627,-1.12148e-05,1.91558e-09,-1.2552e-13,-24870.4,-13.7405], Tmin=(1187.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(12dioxetane) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87628,0.0579514,-9.4473e-05,1.03076e-07,-4.28474e-11,-91.4699,26.7891], Tmin=(100,'K'), Tmax=(820.254,'K')), NASAPolynomial(coeffs=[-1.57473,0.0471077,-2.40379e-05,4.70002e-09,-3.28254e-13,1405.6,48.4291], Tmin=(820.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.30495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(CCOJ) + radical(CCJCO)"""),
)
...
species(
    label = '[O]OC[C]CC([O])=O(7557)',
    structure = SMILES('[O]OC[C]CC([O])=O'),
    E0 = (244.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849351,0.0823384,-0.000146077,1.44254e-07,-5.41851e-11,29545,28.5462], Tmin=(100,'K'), Tmax=(842.376,'K')), NASAPolynomial(coeffs=[3.1643,0.0418774,-2.15552e-05,4.17799e-09,-2.88485e-13,30200.5,23.9808], Tmin=(842.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + radical(CCOJ) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.24125e+11,'s^-1'), n=0.295513, Ea=(155.264,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Exocyclic
Ea raised from 153.1 to 155.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['[O]C1([O])C[CH]COO1(7537)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]OCC=CC([O])=O(7538)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[O]OC=CCC([O])=O(7539)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'C=CCC([O])=O(2119)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(552,'cm^3/(mol*s)'), n=2.78, Ea=(138.759,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-CsH;O2b]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 137.9 to 138.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C(=O)C[CH][CH]OO(7541)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['[O]O[CH][CH]CC(=O)O(7543)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O2(2)', 'C=CC[C]([O])[O](2116)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[O]OC[CH]C=C([O])[O](7545)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[O]O[CH][CH]CC([O])=O(7546)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['[O]OC[CH]C[C]1OO1(7547)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['[O]OCC1C[C]([O])O1(7548)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(9.46839e+08,'s^-1'), n=0.920995, Ea=(164.648,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHCs] for rate rule [R4_S_CO;carbonyl_intra;radadd_intra_csHCs]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction21',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['[O][C]1C[CH]COOO1(7549)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(1.1298e+13,'s^-1'), n=0.287, Ea=(327.576,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7_linear;carbonyl_intra;radadd_intra] for rate rule [R7_linear;carbonyl_intra;radadd_intra_O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
Ea raised from 319.3 to 327.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction22',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['[O]OCC=CC(=O)O(6931)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]OC[CH][CH]C([O])[O](7553)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['C=CCC([O])=O(2119)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O]OC[CH]CC([O])=O(6932)'],
    products = ['O(T)(63)', '[O]C(=O)CC1CO1(2155)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(T)(63)', '[O]C[CH]CC([O])=O(7555)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=C([O])[O](1172)', '[CH]CO[O](7037)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]O[O](61)', '[CH]CC([O])=O(3065)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O(T)(63)', '[O]OC[CH]C[C]=O(7556)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[O]OC[C]CC([O])=O(7557)'],
    products = ['[O]OC[CH]CC([O])=O(6932)'],
