...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560805,0.0764785,-8.49753e-05,5.14948e-08,-1.25915e-11,32477,26.2582], Tmin=(100,'K'), Tmax=(992.289,'K')), NASAPolynomial(coeffs=[12.6308,0.0278239,-1.14266e-05,2.08169e-09,-1.4227e-13,30081.6,-31.879], Tmin=(992.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]COC[CH2](772)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36897,0.060483,-5.09247e-05,2.4738e-08,-5.21794e-12,38529.7,27.597], Tmin=(100,'K'), Tmax=(1089.72,'K')), NASAPolynomial(coeffs=[8.44539,0.0345079,-1.51702e-05,2.86432e-09,-1.99771e-13,36987.4,-7.15072], Tmin=(1089.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]OCC(6330)',
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567169,0.0723822,-7.26657e-05,3.8874e-08,-8.32311e-12,31837.4,26.9398], Tmin=(100,'K'), Tmax=(1132.72,'K')), NASAPolynomial(coeffs=[14.0832,0.0246531,-9.46091e-06,1.67478e-09,-1.13005e-13,28775.4,-39.9515], Tmin=(1132.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]OCC[CH2](769)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785367,0.0736895,-8.18885e-05,5.1799e-08,-1.35232e-11,36211.5,26.6451], Tmin=(100,'K'), Tmax=(922.079,'K')), NASAPolynomial(coeffs=[10.4326,0.0318399,-1.38101e-05,2.57854e-09,-1.78392e-13,34432.4,-19.1147], Tmin=(922.079,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884815,0.0509269,1.01e-05,-5.92384e-08,2.9167e-11,-8294.8,21.9516], Tmin=(100,'K'), Tmax=(940.323,'K')), NASAPolynomial(coeffs=[19.6262,0.0154259,-3.81218e-06,6.38518e-10,-4.91606e-14,-13774.5,-77.7076], Tmin=(940.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.0334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CCOC=C(6333)',
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.879997,0.0716182,-8.18758e-05,5.26072e-08,-1.38692e-11,64667.6,25.5771], Tmin=(100,'K'), Tmax=(915.604,'K')), NASAPolynomial(coeffs=[10.5084,0.0295539,-1.29624e-05,2.42967e-09,-1.68383e-13,62904.5,-20.0255], Tmin=(915.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(536.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][CH]CO[C]C(6335)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31547,0.0611556,-5.60002e-05,2.83172e-08,-6.02241e-12,68527.8,25.887], Tmin=(100,'K'), Tmax=(1101.8,'K')), NASAPolynomial(coeffs=[9.92474,0.0299007,-1.345e-05,2.57161e-09,-1.80759e-13,66630.7,-16.4824], Tmin=(1101.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CH2_triplet) + radical(CCJCO)"""),
)

species(
    label = '[CH][CH]CO[CH]C(6336)',
    structure = SMILES('[CH][CH]CO[CH]C'),
    E0 = (531.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967936,0.0665867,-6.64205e-05,3.60691e-08,-7.99084e-12,64024.4,27.063], Tmin=(100,'K'), Tmax=(1083.3,'K')), NASAPolynomial(coeffs=[11.7769,0.026675,-1.11559e-05,2.05874e-09,-1.41999e-13,61682.5,-25.9489], Tmin=(1083.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C=CO[CH]C(6328)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2][CH]OCC=C(768)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][CH][CH]O[CH]C(6331)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][CH]CO[CH][CH2](775)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]C[O](429)', '[CH]C(32)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[CH]C(415)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](11)', '[CH]OC[CH][CH2](6284)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]CO[CH]C(6334)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][CH]CO[C]C(6335)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH][CH]CO[CH]C(6336)'],
    products = ['[CH2][CH]CO[CH]C(773)'],
