...
species(
    label = '[CH]C(C)C[C]=O(4330)',
    structure = SMILES('[CH]C(C)C[C]=O'),
    E0 = (348.251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,376.186,376.188,1976.29,1976.31],'cm^-1')),
        HinderedRotor(inertia=(0.114477,'amu*angstrom^2'), symmetry=1, barrier=(11.4965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00119116,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114501,'amu*angstrom^2'), symmetry=1, barrier=(11.4964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114495,'amu*angstrom^2'), symmetry=1, barrier=(11.4965,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57879,0.054869,-4.98782e-05,2.60777e-08,-5.79588e-12,41970.7,24.1195], Tmin=(100,'K'), Tmax=(1055.29,'K')), NASAPolynomial(coeffs=[8.56983,0.0283691,-1.221e-05,2.28055e-09,-1.58133e-13,40495.2,-9.98424], Tmin=(1055.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(C)C[C]=O(4320)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(C)C=C=O(4321)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', 'C=CC[C]=O(4213)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH2][CH]C[C]=O(4295)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C](C)C[C]=O(4325)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C(C)[CH][C]=O(4326)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C([CH2])C[C]=O(4327)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]CC[C]=O(4190)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])C(118)', '[C-]#[O+](374)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[C]=O(1149)', '[CH2]C([CH2])C(118)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C(C)C[C]=O(4330)'],
    products = ['[CH2]C(C)C[C]=O(4195)'],
