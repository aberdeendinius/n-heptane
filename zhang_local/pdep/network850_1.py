...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615749,0.0899165,-0.000172398,1.70201e-07,-6.25456e-11,50052.5,31.482], Tmin=(100,'K'), Tmax=(862.331,'K')), NASAPolynomial(coeffs=[3.97947,0.0382749,-1.98808e-05,3.82573e-09,-2.61187e-13,50812.3,23.5215], Tmin=(862.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO) + radical(CCsJOCs) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C([O])O[CH][CH][O](2845)',
    structure = SMILES('[CH2]C([O])O[CH][CH][O]'),
    E0 = (390.322,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.337773,0.0975718,-0.000191839,1.88366e-07,-6.83987e-11,47060.5,31.3416], Tmin=(100,'K'), Tmax=(870.756,'K')), NASAPolynomial(coeffs=[4.6991,0.0375552,-1.9578e-05,3.74771e-09,-2.54066e-13,47816.7,19.6079], Tmin=(870.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOH) + radical(CCOJ) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0235288,0.10091,-0.000189409,1.74597e-07,-6.02298e-11,44614.6,32.2978], Tmin=(100,'K'), Tmax=(878.973,'K')), NASAPolynomial(coeffs=[9.19859,0.0288182,-1.46094e-05,2.74999e-09,-1.84004e-13,44173.7,-4.11635], Tmin=(878.973,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO) + radical(Cs_P) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = 'C[C]([O])O[CH][CH][O](2848)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.534483,0.0930377,-0.00018231,1.81249e-07,-6.66452e-11,46290.7,30.6894], Tmin=(100,'K'), Tmax=(866.693,'K')), NASAPolynomial(coeffs=[3.62083,0.0391406,-2.04012e-05,3.91859e-09,-2.66721e-13,47245,24.8328], Tmin=(866.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ) + radical(Cs_P) + radical(CCsJOCs) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][C]([O])O[CH][CH][O](2849)',
    structure = SMILES('[CH2][C]([O])O[CH][CH][O]'),
    E0 = (595.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370357,0.0983577,-0.000202455,2.00781e-07,-7.28721e-11,71743.4,31.9127], Tmin=(100,'K'), Tmax=(876.689,'K')), NASAPolynomial(coeffs=[4.52371,0.0352068,-1.87777e-05,3.59743e-09,-2.42812e-13,72713.7,22.1093], Tmin=(876.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(595.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOCs) + radical(Cs_P) + radical(CCsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])OC=C[O](2850)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.452723,0.0638665,-3.76092e-05,-1.37008e-08,1.4381e-11,-1756.42,27.3393], Tmin=(100,'K'), Tmax=(938.286,'K')), NASAPolynomial(coeffs=[22.587,0.00497937,-1.78364e-07,-2.84922e-12,-4.54525e-15,-7471.58,-86.3568], Tmin=(938.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.7738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCOJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.718486,0.0886933,-0.000177947,1.79382e-07,-6.68728e-11,83788,30.3985], Tmin=(100,'K'), Tmax=(856.206,'K')), NASAPolynomial(coeffs=[3.43816,0.0373618,-2.03498e-05,3.98247e-09,-2.74269e-13,84738.1,25.9678], Tmin=(856.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(695.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CH2_triplet) + radical(CJCO) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH][C]([O])OC[CH][O](2852)',
    structure = SMILES('[CH][C]([O])OC[CH][O]'),
    E0 = (651.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785154,0.0890705,-0.000182741,1.87539e-07,-7.04071e-11,78484.2,31.3471], Tmin=(100,'K'), Tmax=(864.394,'K')), NASAPolynomial(coeffs=[1.75742,0.0404088,-2.16614e-05,4.19982e-09,-2.87193e-13,79965.9,36.3417], Tmin=(864.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(651.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOH) + radical(CCOJ) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC[CH][O](2137)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=O)O[CH][CH][O](2843)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(15.103,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][C]([O])O[CH]C[O](2844)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([O])OC[CH][O](2137)'],
    products = ['[CH2]C([O])O[CH][CH][O](2845)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])OC[CH][O](2137)'],
    products = ['[CH2][C]([O])O[CH][CH]O(2846)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([O])OC[CH][O](2137)'],
    products = ['[CH2][C](O)O[CH][CH][O](2847)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][C]([O])O[CH][CH][O](2849)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][CH]C[O](563)', '[CH2][C][O](2305)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[C]([CH2])[O](1016)', '[CH][O](751)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]([O])OC[C][O](2851)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH][C]([O])OC[CH][O](2852)'],
    products = ['[CH2][C]([O])OC[CH][O](2137)'],
