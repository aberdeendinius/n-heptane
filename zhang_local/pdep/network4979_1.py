...
species(
    label = '[CH2]CC=C=CO(27797)',
    structure = SMILES('[CH2]CC=C=CO'),
    E0 = (120.511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,540,610,2055,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.940863,'amu*angstrom^2'), symmetry=1, barrier=(21.6323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.926971,'amu*angstrom^2'), symmetry=1, barrier=(21.3129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927234,'amu*angstrom^2'), symmetry=1, barrier=(21.3189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03264,0.0521196,-1.41823e-05,-3.02213e-08,1.87664e-11,14613.1,23.2342], Tmin=(100,'K'), Tmax=(927.875,'K')), NASAPolynomial(coeffs=[18.4473,0.0108232,-2.02595e-06,2.76435e-10,-2.10755e-14,9927.34,-67.3128], Tmin=(927.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCC#CO(27798)',
    structure = SMILES('[CH2]CCC#CO'),
    E0 = (189.582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2100,2250,500,550,3000,3100,440,815,1455,1000,180,280.487],'cm^-1')),
        HinderedRotor(inertia=(0.00851091,'amu*angstrom^2'), symmetry=1, barrier=(2.41875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00189737,'amu*angstrom^2'), symmetry=1, barrier=(21.5429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.02745,'amu*angstrom^2'), symmetry=1, barrier=(46.615,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.41509,'amu*angstrom^2'), symmetry=1, barrier=(101.512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59633,0.0490462,-3.58676e-05,1.42347e-08,-2.35338e-12,22891,23.918], Tmin=(100,'K'), Tmax=(1401.83,'K')), NASAPolynomial(coeffs=[10.2572,0.0243331,-9.42401e-06,1.65894e-09,-1.10659e-13,20462.8,-20.7913], Tmin=(1401.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CtH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(RCCJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00933695,'amu*angstrom^2'), symmetry=1, barrier=(83.4484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.74928,'amu*angstrom^2'), symmetry=1, barrier=(83.4411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC[CH][C]=CO(27800)',
    structure = SMILES('CC[CH][C]=CO'),
    E0 = (129.86,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05727,0.0511061,-6.67968e-06,-3.64869e-08,2.02959e-11,15737,22.1107], Tmin=(100,'K'), Tmax=(936.73,'K')), NASAPolynomial(coeffs=[17.5343,0.0150562,-3.8932e-06,6.31226e-10,-4.5958e-14,11144.8,-64.3393], Tmin=(936.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'CCC[C]=[C]O(27801)',
    structure = SMILES('CCC[C]=[C]O'),
    E0 = (228.491,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,331.908,335.946],'cm^-1')),
        HinderedRotor(inertia=(0.149709,'amu*angstrom^2'), symmetry=1, barrier=(11.6493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14688,'amu*angstrom^2'), symmetry=1, barrier=(11.6711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151468,'amu*angstrom^2'), symmetry=1, barrier=(11.6856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148286,'amu*angstrom^2'), symmetry=1, barrier=(11.6866,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]C[CH][C]=CO(27803)',
    structure = SMILES('[CH2]C[CH][C]=CO'),
    E0 = (335.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,373.925,373.93],'cm^-1')),
        HinderedRotor(inertia=(0.00120569,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207033,'amu*angstrom^2'), symmetry=1, barrier=(20.5419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207035,'amu*angstrom^2'), symmetry=1, barrier=(20.5421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20704,'amu*angstrom^2'), symmetry=1, barrier=(20.542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0994,0.0517809,-1.69219e-05,-2.45092e-08,1.59773e-11,40419.4,23.7461], Tmin=(100,'K'), Tmax=(934.151,'K')), NASAPolynomial(coeffs=[17.2984,0.0128118,-3.1534e-06,4.95336e-10,-3.59037e-14,36066.8,-60.3996], Tmin=(934.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(RCCJ) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]CC[C]=[C]O(27804)',
    structure = SMILES('[CH2]CC[C]=[C]O'),
    E0 = (433.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,355.657,356.858],'cm^-1')),
        HinderedRotor(inertia=(0.00132888,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132948,'amu*angstrom^2'), symmetry=1, barrier=(11.976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132719,'amu*angstrom^2'), symmetry=1, barrier=(11.9599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13298,'amu*angstrom^2'), symmetry=1, barrier=(11.9718,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983771,0.0602448,-5.78126e-05,2.90769e-08,-5.78528e-12,52280.3,28.397], Tmin=(100,'K'), Tmax=(1225.53,'K')), NASAPolynomial(coeffs=[13.8782,0.0181584,-6.30038e-06,1.05502e-09,-6.89853e-14,49119.8,-36.4337], Tmin=(1225.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = 'CCC=C=CO(27805)',
    structure = SMILES('CCC=C=CO'),
    E0 = (-84.7357,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.990421,0.0514464,-3.94836e-06,-4.21831e-08,2.30755e-11,-10069.4,21.5991], Tmin=(100,'K'), Tmax=(930.873,'K')), NASAPolynomial(coeffs=[18.6816,0.0130701,-2.76722e-06,4.12667e-10,-3.11577e-14,-14994,-71.2434], Tmin=(930.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.7357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CC[C]=CO(27709)'],
    products = ['[CH2]CC[C]=CO(12961)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]CC=C=CO(27797)'],
    products = ['[CH2]CC[C]=CO(12961)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]CCC#CO(27798)'],
    products = ['[CH2]CC[C]=CO(12961)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C#CCC[CH2](17530)'],
    products = ['[CH2]CC[C]=CO(12961)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH]=[C]CC[CH2](6433)'],
    products = ['[CH2]CC[C]=CO(12961)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][CH]C[C]=CO(27802)'],
    products = ['[CH2]CC[C]=CO(12961)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C[CH][C]=CO(27803)'],
    products = ['[CH2]CC[C]=CO(12961)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]CC[C]=[C]O(27804)'],
    products = ['[CH2]CC[C]=CO(12961)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH2](21)', '[C]=CO(27807)'],
    products = ['[CH2]CC[C]=CO(12961)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH]CC[C]=CO(27808)'],
    products = ['[CH2]CC[C]=CO(12961)'],
