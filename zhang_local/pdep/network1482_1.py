...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=CC(C)=O(5163)'],
    products = ['[CH]=CC(C)[O](5177)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH]C=C[O](5267)'],
    products = ['[CH]=CC(C)[O](5177)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH]=CC[O](5154)'],
    products = ['[CH]=CC(C)[O](5177)'],
