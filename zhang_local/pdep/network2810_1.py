...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.580846,0.108119,-0.000171333,1.40323e-07,-4.44907e-11,36643.7,28.9917], Tmin=(100,'K'), Tmax=(875.832,'K')), NASAPolynomial(coeffs=[13.8744,0.0288178,-1.27673e-05,2.30934e-09,-1.52803e-13,34621.1,-35.9213], Tmin=(875.832,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(C)([O])[C](C)[O](10567)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.193651,0.0902218,-0.000118292,8.09584e-08,-2.03115e-11,38649.4,27.1546], Tmin=(100,'K'), Tmax=(679.073,'K')), NASAPolynomial(coeffs=[11.85,0.032425,-1.46214e-05,2.74001e-09,-1.88368e-13,36815.8,-26.4135], Tmin=(679.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)2OJ) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CJC(C)2O)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.473813,0.0969653,-0.000125725,8.15219e-08,-2.04387e-11,-4499.44,27.6257], Tmin=(100,'K'), Tmax=(986.909,'K')), NASAPolynomial(coeffs=[18.8425,0.0186721,-6.72285e-06,1.13138e-09,-7.36087e-14,-8311.97,-65.309], Tmin=(986.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.7605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJC(C)(C=O)O) + radical(CJC(C)(C=O)O)"""),
)

species(
    label = '[CH2]C(C)([O])C(C)=O(10572)',
    structure = SMILES('[CH2]C(C)([O])C(C)=O'),
    E0 = (-8.38923,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.446957,0.0816739,-0.000103291,7.3109e-08,-2.09356e-11,-884.251,27.819], Tmin=(100,'K'), Tmax=(851.131,'K')), NASAPolynomial(coeffs=[11.348,0.0304427,-1.30027e-05,2.38788e-09,-1.62733e-13,-2739.87,-23.0149], Tmin=(851.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.38923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CC(C)(C=O)OJ) + radical(CJC(C)(C=O)O)"""),
)
...
species(
    label = '[CH2]C1([CH2])OOC1C(10158)',
    structure = SMILES('[CH2]C1([CH2])OOC1C'),
    E0 = (303.565,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.826132,0.0770938,-7.14232e-05,3.36616e-08,-5.87062e-12,36709.4,31.1793], Tmin=(100,'K'), Tmax=(1708.15,'K')), NASAPolynomial(coeffs=[17.2827,0.0159214,-1.22511e-06,-1.67595e-10,2.18705e-14,33260.7,-57.8667], Tmin=(1708.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211174,0.085856,-0.000107203,7.0343e-08,-1.83664e-11,71317,28.653], Tmin=(100,'K'), Tmax=(935.819,'K')), NASAPolynomial(coeffs=[14.1832,0.026135,-1.14776e-05,2.14965e-09,-1.48887e-13,68701.9,-37.8272], Tmin=(935.819,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CC(C)OJ) + radical(CC(C)2OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C(C)=O(10068)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(C)[O](1092)', 'CH2(T)(28)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)C(C)[O](6337)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH3](11)', '[CH2]C([CH2])([O])C=O(10174)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    products = ['[CH2]C([CH2])(O)[C](C)[O](10566)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    products = ['[CH2]C(C)([O])[C](C)[O](10567)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH3](11)', '[CH2]C([CH2])([O])[CH][O](10524)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C([CH2])([O])[C](C)[O](10570)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    products = ['[CH2]C([CH2])(O)C(C)=O(10571)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    products = ['[CH2]C(C)([O])C(C)=O(10572)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(14)', '[CH2]C([CH2])([O])C[O](9588)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
    products = ['[CH2]C1([CH2])OOC1C(10158)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C(C)[O](6340)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]([O])C(C)[O](1087)', 'CH2(T)(28)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH2]C([CH2])([O])[CH]C(10275)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C([CH2])([O])C(C)[O](10574)'],
    products = ['[CH2]C([CH2])([O])C(C)[O](9640)'],
