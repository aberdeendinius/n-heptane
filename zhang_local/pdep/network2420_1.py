...
species(
    label = '[O]CC=C1CO1(9591)',
    structure = SMILES('[O]CC=C1CO1'),
    E0 = (60.8287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,180,180,180,507.227,905.489,905.58,905.713,905.725,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0477158,'amu*angstrom^2'), symmetry=1, barrier=(27.7676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06742,0.034377,-4.1697e-06,-1.88831e-08,9.57329e-12,7392.75,18.8309], Tmin=(100,'K'), Tmax=(998.358,'K')), NASAPolynomial(coeffs=[10.8541,0.0175861,-6.608e-06,1.21948e-09,-8.68035e-14,4720.63,-28.1413], Tmin=(998.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.8287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(CCOJ)"""),
)

species(
    label = '[O]CCC1=CO1(9592)',
    structure = SMILES('[O]CCC1=CO1'),
    E0 = (157.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,180,180,180,567.293,583.914,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.165981,'amu*angstrom^2'), symmetry=1, barrier=(3.81622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165981,'amu*angstrom^2'), symmetry=1, barrier=(3.81622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[O]C[CH]C1CO1(9593)',
    structure = SMILES('[O]C[CH]C1CO1'),
    E0 = (138.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,483.319,918.682,918.682,918.682,918.682,918.682,918.682,918.682,918.682,918.682,2438.53],'cm^-1')),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6812,0.0454507,-3.58981e-05,1.76609e-08,-3.5826e-12,16754.2,23.3813], Tmin=(100,'K'), Tmax=(1327.81,'K')), NASAPolynomial(coeffs=[7.98669,0.0229345,-6.48412e-06,8.95654e-10,-5.00074e-14,15390.1,-7.65796], Tmin=(1327.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CCOJ)"""),
)
...
species(
    ...
    E0 = (118.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,279.69,971.418,971.418,971.418,971.418,971.418,971.418,971.418,971.418,971.418,2377.77],'cm^-1')),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = 'OC[CH][C]1CO1(9595)',
    structure = SMILES('OC[CH][C]1CO1'),
    E0 = (92.9685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38378,0.0535838,-5.63036e-05,3.41389e-08,-8.0083e-12,11279.2,24.6964], Tmin=(100,'K'), Tmax=(1221.95,'K')), NASAPolynomial(coeffs=[9.3832,0.0193659,-4.43993e-06,4.64079e-10,-1.81797e-14,9923.86,-13.0459], Tmin=(1221.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.9685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(C2CsJO)"""),
)

species(
    label = 'OCC[C]1[CH]O1(9596)',
    structure = SMILES('OCC[C]1[CH]O1'),
    E0 = (76.7889,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01989,0.0619979,-7.29565e-05,4.65092e-08,-1.1271e-11,9346,23.7082], Tmin=(100,'K'), Tmax=(1182.06,'K')), NASAPolynomial(coeffs=[11.3913,0.0170687,-3.46463e-06,2.79244e-10,-5.15642e-15,7581.06,-25.1567], Tmin=(1182.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.7889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = '[O]C[CH][C]1CO1(9597)',
    structure = SMILES('[O]C[CH][C]1CO1'),
    E0 = (318.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,3150,900,1100,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93273,0.0485038,-5.97663e-05,4.66887e-08,-1.42369e-11,38399.2,23.5952], Tmin=(100,'K'), Tmax=(998.836,'K')), NASAPolynomial(coeffs=[4.88541,0.0255235,-8.50247e-06,1.29112e-09,-7.55739e-14,38365.9,12.1394], Tmin=(998.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[O]CC[C]1[CH]O1(9598)',
    structure = SMILES('[O]CC[C]1[CH]O1'),
    E0 = (302.494,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54712,0.0571725,-7.73012e-05,6.01884e-08,-1.79733e-11,36467,22.6849], Tmin=(100,'K'), Tmax=(1000.16,'K')), NASAPolynomial(coeffs=[6.89269,0.0232188,-7.51954e-06,1.10395e-09,-6.23255e-14,36026.7,0.0390103], Tmin=(1000.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCOJ) + radical(CCsJO)"""),
)
...
species(
    label = 'OCC=C1CO1(9599)',
    structure = SMILES('OCC=C1CO1'),
    E0 = (-164.876,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7472,0.0366507,9.6369e-06,-4.56457e-08,2.22302e-11,-19737.1,19.1188], Tmin=(100,'K'), Tmax=(936.122,'K')), NASAPolynomial(coeffs=[15.234,0.0116933,-2.7232e-06,4.38592e-10,-3.34897e-14,-23693.7,-52.7031], Tmin=(936.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-164.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane)"""),
)

species(
    label = 'O=CCC1CO1(1139)',
...
species(
    label = 'OCCC1=CO1(9600)',
    structure = SMILES('OCCC1=CO1'),
    E0 = (-68.5492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37544,0.0492387,-2.79707e-05,-3.99037e-09,6.52263e-12,-8142.45,22.0101], Tmin=(100,'K'), Tmax=(968.916,'K')), NASAPolynomial(coeffs=[14.3431,0.0150782,-5.08015e-06,8.97224e-10,-6.3366e-14,-11564.8,-44.8351], Tmin=(968.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.5492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'O=CC[C]1CO1(9312)'],
    products = ['[O]CC[C]1CO1(9220)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[O]C[CH][C]1CO1(9597)'],
    products = ['[O]CC[C]1CO1(9220)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[O]CC[C]1[CH]O1(9598)'],
    products = ['[O]CC[C]1CO1(9220)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O][CH]C[C]1CO1(2302)', 'H(8)'],
    products = ['[O]CC[C]1CO1(9220)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(T)(63)', '[CH2]C[C]1CO1(1846)'],
    products = ['[O]CC[C]1CO1(9220)'],
