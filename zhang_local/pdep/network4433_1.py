...
species(
    label = '[C]C(=[CH])C(C)[O](21405)',
    structure = SMILES('[C]C(=[CH])C(C)[O]'),
    E0 = (918.551,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,350,440,435,1725,269.011,269.045],'cm^-1')),
        HinderedRotor(inertia=(0.326758,'amu*angstrom^2'), symmetry=1, barrier=(16.7826,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326743,'amu*angstrom^2'), symmetry=1, barrier=(16.7827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03682,0.0577067,-5.72711e-05,2.80252e-08,-5.32711e-12,110589,23.4062], Tmin=(100,'K'), Tmax=(1290.42,'K')), NASAPolynomial(coeffs=[15.6548,0.0123946,-4.60015e-06,8.14148e-10,-5.53951e-14,106816,-50.8444], Tmin=(1290.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(918.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJ3) + radical(Cds_P) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C(=[CH])C(C)=O(19460)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC(C)[O](5276)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', '[CH]C(=[CH])C=O(21223)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH3](11)', '[CH]C([CH])=C[O](21383)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]C([CH])=C(C)[O](19458)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(14)', '[CH]C(=[CH])C[O](19101)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(T)(63)', '[CH]C([CH])=CC(21257)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[C]C(=[CH])C(C)[O](21405)'],
    products = ['[CH]C(=[CH])C(C)[O](19157)'],
