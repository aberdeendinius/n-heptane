...
species(
    label = '[CH]=[C]CC(=[CH])O(19382)',
    structure = SMILES('[CH]=[C]CC(=[CH])O'),
    E0 = (606.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3115,3125,620,680,785,800,1600,1700,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.727582,'amu*angstrom^2'), symmetry=1, barrier=(16.7285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.727609,'amu*angstrom^2'), symmetry=1, barrier=(16.7292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.728184,'amu*angstrom^2'), symmetry=1, barrier=(16.7424,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788373,0.061571,-6.77091e-05,3.61504e-08,-7.33173e-12,73035.4,25.6887], Tmin=(100,'K'), Tmax=(1302.93,'K')), NASAPolynomial(coeffs=[16.9724,0.00811682,-1.83074e-06,2.22336e-10,-1.20313e-14,69138,-55.4448], Tmin=(1302.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(606.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=CCC(=[CH])[O](19383)',
    structure = SMILES('[CH]=CCC(=[CH])[O]'),
    E0 = (506.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,248.537],'cm^-1')),
        HinderedRotor(inertia=(0.277856,'amu*angstrom^2'), symmetry=1, barrier=(11.5673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.295378,'amu*angstrom^2'), symmetry=1, barrier=(11.6205,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44633,0.0499692,-3.99718e-05,1.06058e-08,1.20661e-12,60977.9,24.3537], Tmin=(100,'K'), Tmax=(965.039,'K')), NASAPolynomial(coeffs=[13.5735,0.0134006,-4.42238e-06,7.55594e-10,-5.18357e-14,57999.4,-37.0262], Tmin=(965.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(506.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18954,0.0302974,8.99961e-06,-3.15308e-08,1.35655e-11,61896.1,19.2282], Tmin=(100,'K'), Tmax=(1005.48,'K')), NASAPolynomial(coeffs=[10.6079,0.0190736,-7.47362e-06,1.41562e-09,-1.02255e-13,59077.7,-27.0283], Tmin=(1005.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(C2CsJOH) + radical(cyclopentene-vinyl) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH]=C=CC(=C)O(19388)',
    structure = SMILES('[CH]=C=CC(=C)O'),
    E0 = (175.084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243731,0.0653122,-7.12938e-05,3.69554e-08,-7.03183e-12,21207.8,22.2072], Tmin=(100,'K'), Tmax=(1523.97,'K')), NASAPolynomial(coeffs=[18.2789,0.00478955,1.25492e-06,-4.58594e-10,3.70859e-14,17241.9,-67.3771], Tmin=(1523.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66195,0.0410767,-6.40692e-06,-3.39425e-08,2.07186e-11,58260.2,18.3579], Tmin=(100,'K'), Tmax=(877.892,'K')), NASAPolynomial(coeffs=[15.8327,0.0066475,9.2519e-07,-4.05491e-10,3.21062e-14,54610.7,-54.7768], Tmin=(877.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.621,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(Cds_S) + radical(CJC(C)OC) + radical(C2CsJOC(O))"""),
)

species(
    label = 'C#CC=C(C)[O](19395)',
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51042,0.0473066,-3.04015e-05,5.45381e-10,4.66702e-12,19090.7,19.1888], Tmin=(100,'K'), Tmax=(967.64,'K')), NASAPolynomial(coeffs=[13.6941,0.0138131,-4.63413e-06,8.1099e-10,-5.68323e-14,15942.9,-43.2709], Tmin=(967.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(C=C(C)OJ)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(158.026,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra]
Euclidian distance = 0
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]CC(=[CH])[O](19385)'],
    products = ['[CH]=[C]CC(=C)[O](17899)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(=C)[O](4273)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC(=C)[O](17899)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(T)(63)', '[CH]=[C]C[C]=C(17763)'],
    products = ['[CH]=[C]CC(=C)[O](17899)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[C]=[C]CC(=C)[O](19391)'],
    products = ['[CH]=[C]CC(=C)[O](17899)'],
