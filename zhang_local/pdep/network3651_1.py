...
species(
    label = '[O][CH]C1CC2(CC2)O1(15809)',
    structure = SMILES('[O][CH]C1CC2(CC2)O1'),
    E0 = (209.759,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29672,0.0647109,-4.9239e-05,2.20094e-08,-4.50535e-12,25321.1,23.0527], Tmin=(100,'K'), Tmax=(1072.34,'K')), NASAPolynomial(coeffs=[6.89652,0.0438228,-2.00206e-05,3.84454e-09,-2.70499e-13,24120.2,-4.35421], Tmin=(1072.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CC(=O)CC=C[O](12907)',
    structure = SMILES('[CH2]CC(=O)CC=C[O]'),
    E0 = (-29.1674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,2995,3025,975,1000,1300,1375,400,500,1630,1680,385.52,385.745,386.017,386.544],'cm^-1')),
        HinderedRotor(inertia=(0.00113475,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170804,'amu*angstrom^2'), symmetry=1, barrier=(17.9702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16981,'amu*angstrom^2'), symmetry=1, barrier=(17.9703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170355,'amu*angstrom^2'), symmetry=1, barrier=(17.967,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.042547,0.0760913,-6.14331e-05,2.38683e-08,-3.65546e-12,-3356.53,30.7178], Tmin=(100,'K'), Tmax=(1557.83,'K')), NASAPolynomial(coeffs=[20.791,0.0228169,-1.01372e-05,1.91682e-09,-1.32754e-13,-9821.16,-78.5796], Tmin=(1557.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.1674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJCC=O)"""),
)
...
species(
    label = '[O]C1(CC=C=O)CC1(15810)',
    structure = SMILES('[O]C1(CC=C=O)CC1'),
    E0 = (51.8144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.698566,0.0616164,-3.16077e-05,-4.94998e-09,6.65812e-12,6360.27,26.8942], Tmin=(100,'K'), Tmax=(1025.51,'K')), NASAPolynomial(coeffs=[15.9722,0.0242504,-9.43772e-06,1.75545e-09,-1.24658e-13,2059.79,-52.8711], Tmin=(1025.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.8144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsH) + ring(Cyclopropane) + radical(CC(C)2OJ)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.250102,0.0662499,-1.9412e-05,-3.41106e-08,2.12834e-11,20346.9,30.7544], Tmin=(100,'K'), Tmax=(941.771,'K')), NASAPolynomial(coeffs=[21.5229,0.016307,-4.22757e-06,7.01488e-10,-5.21874e-14,14548,-80.1124], Tmin=(941.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CJO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[O]C=CCC1(O)[CH]C1(15812)',
    structure = SMILES('[O]C=CCC1(O)[CH]C1'),
    E0 = (40.6321,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.436865,0.0561756,1.77328e-05,-7.87076e-08,3.86522e-11,5035.66,30.801], Tmin=(100,'K'), Tmax=(931.815,'K')), NASAPolynomial(coeffs=[24.0988,0.0112815,-1.23884e-06,1.43571e-10,-1.66987e-14,-1834.74,-94.887], Tmin=(931.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.6321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=COJ) + radical(CCJCO)"""),
)

species(
    label = '[O]C=C[CH]C1(O)CC1(15813)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0294555,0.0652789,1.59461e-06,-6.56938e-08,3.45548e-11,-4930.69,26.9659], Tmin=(100,'K'), Tmax=(936.598,'K')), NASAPolynomial(coeffs=[25.678,0.0115348,-1.69026e-06,2.49196e-10,-2.45441e-14,-12182.4,-108.158], Tmin=(936.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.3533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=COJ) + radical(C=CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.215986,0.0659166,-1.54656e-05,-4.01488e-08,2.38801e-11,9602.12,29.5707], Tmin=(100,'K'), Tmax=(939.422,'K')), NASAPolynomial(coeffs=[22.3493,0.0150698,-3.56752e-06,5.79938e-10,-4.43997e-14,3528.77,-86.0181], Tmin=(939.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.5718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Cds_S) + radical(C=COJ)"""),
)

species(
    label = '[O]C1([CH]C=CO)CC1(15816)',
    structure = SMILES('[O]C1([CH]C=CO)CC1'),
    E0 = (45.1001,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.174685,0.068399,-6.14314e-08,-6.94272e-08,3.73247e-11,5596.23,26.35], Tmin=(100,'K'), Tmax=(929.605,'K')), NASAPolynomial(coeffs=[27.7693,0.0082019,1.87142e-07,-1.24509e-10,1.44961e-15,-2193.5,-120.378], Tmin=(929.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.1001,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = 'O=[C][CH]CC1(O)CC1(15817)',
    structure = SMILES('O=[C][CH]CC1(O)CC1'),
    E0 = (24.9684,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.400802,0.0684998,-4.06633e-05,-2.44011e-09,7.84813e-12,3142.21,29.3011], Tmin=(100,'K'), Tmax=(960.382,'K')), NASAPolynomial(coeffs=[17.3557,0.0225673,-7.4771e-06,1.28661e-09,-8.88869e-14,-1252.81,-57.7379], Tmin=(960.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.9684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCCJ=O) + radical(CCJCHO)"""),
)

species(
    label = '[O]C1([CH]C1)CC=CO(15818)',
    structure = SMILES('[O]C1([CH]C1)CC=CO'),
    E0 = (128.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.232044,0.0593027,1.60582e-05,-8.24286e-08,4.14234e-11,15562.6,30.1875], Tmin=(100,'K'), Tmax=(925.35,'K')), NASAPolynomial(coeffs=[26.1979,0.0079354,6.46123e-07,-2.3191e-10,9.44166e-15,8150.84,-107.151], Tmin=(925.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[O]C=CCC1([O])[CH]C1(15819)',
    structure = SMILES('[O]C=CCC1([O])[CH]C1'),
    E0 = (269.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.6484,0.0522816,1.95993e-05,-7.63065e-08,3.66697e-11,32559.5,30.1029], Tmin=(100,'K'), Tmax=(939.599,'K')), NASAPolynomial(coeffs=[22.8878,0.0117184,-2.03244e-06,3.35832e-10,-3.12299e-14,25991.6,-88.5152], Tmin=(939.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=COJ) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[O]C=C[CH]C1([O])CC1(15820)',
    structure = SMILES('[O]C=C[CH]C1([O])CC1'),
    E0 = (186.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.240456,0.0613897,3.45233e-06,-6.32966e-08,3.25823e-11,22593.1,26.2698], Tmin=(100,'K'), Tmax=(944.857,'K')), NASAPolynomial(coeffs=[24.476,0.0119568,-2.47537e-06,4.39468e-10,-3.89114e-14,15640.1,-101.837], Tmin=(944.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CCJCO) + radical(CC(C)2OJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C=[C]CC1([O])CC1(15821)',
    structure = SMILES('[O]C=[C]CC1([O])CC1'),
    E0 = (307.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.424922,0.0620513,-1.36879e-05,-3.7656e-08,2.1872e-11,37126,28.882], Tmin=(100,'K'), Tmax=(950.748,'K')), NASAPolynomial(coeffs=[21.1604,0.0154695,-4.33981e-06,7.6719e-10,-5.85169e-14,31345.7,-79.7708], Tmin=(950.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(Cds_S) + radical(C=COJ)"""),
)

species(
    label = '[O]C1(C[CH][C]=O)CC1(15822)',
    structure = SMILES('[O]C1(C[CH][C]=O)CC1'),
    E0 = (253.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598989,0.0647539,-3.92588e-05,4.53214e-10,5.71487e-12,30666.6,28.6513], Tmin=(100,'K'), Tmax=(987.933,'K')), NASAPolynomial(coeffs=[16.2556,0.0228186,-8.1648e-06,1.45406e-09,-1.01372e-13,26526,-51.9919], Tmin=(987.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCCJ=O) + radical(CC(C)2OJ) + radical(CCJCHO)"""),
)

species(
    label = '[O]C1(CC1)CC1[CH]O1(12409)',
    structure = SMILES('[O]C1(CC1)CC1[CH]O1'),
    E0 = (210.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444209,0.0611953,1.48562e-06,-6.24501e-08,3.46174e-11,25402.4,26.2021], Tmin=(100,'K'), Tmax=(887.619,'K')), NASAPolynomial(coeffs=[21.3439,0.0147531,-7.09341e-07,-2.06249e-10,1.94093e-14,19811.6,-82.7293], Tmin=(887.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCsJO)"""),
)

species(
    label = '[O]C1[CH]CC2(CC2)O1(15768)',
    structure = SMILES('[O]C1[CH]CC2(CC2)O1'),
    E0 = (124.777,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49901,0.0459636,-1.39477e-06,-1.96486e-08,7.61328e-12,15104.5,24.6759], Tmin=(100,'K'), Tmax=(1182.2,'K')), NASAPolynomial(coeffs=[9.78595,0.0378717,-1.6437e-05,3.10667e-09,-2.17017e-13,11751.3,-22.5862], Tmin=(1182.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + polycyclic(s1_3_5_ane) + radical(CCJCO) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497202,0.0654172,-3.32939e-05,-7.3325e-09,8.50263e-12,-21164,27.5542], Tmin=(100,'K'), Tmax=(994.639,'K')), NASAPolynomial(coeffs=[17.0038,0.0241086,-8.81025e-06,1.60174e-09,-1.13281e-13,-25687.9,-58.2267], Tmin=(994.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-177.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsH) + ring(Cyclopropane)"""),
)

species(
    label = '[O][CH]C[CH]C1([O])CC1(15824)',
    structure = SMILES('[O][CH]C[CH]C1([O])CC1'),
    E0 = (455.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67117,0.0729908,-6.3376e-05,2.96051e-08,-5.73797e-12,54876.4,31.3928], Tmin=(100,'K'), Tmax=(1210.55,'K')), NASAPolynomial(coeffs=[12.5829,0.0336311,-1.46052e-05,2.74636e-09,-1.91174e-13,51992.5,-28.3506], Tmin=(1210.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCsJOH) + radical(CCOJ) + radical(CC(C)2OJ)"""),
)

species(
    label = '[O][CH]CCC1([O])[CH]C1(15825)',
    structure = SMILES('[O][CH]CCC1([O])[CH]C1'),
    E0 = (455.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.671175,0.0729908,-6.33759e-05,2.9605e-08,-5.73794e-12,54876.4,31.3928], Tmin=(100,'K'), Tmax=(1210.57,'K')), NASAPolynomial(coeffs=[12.583,0.033631,-1.46051e-05,2.74635e-09,-1.91173e-13,51992.5,-28.3507], Tmin=(1210.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCsJOH) + radical(CCOJ) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[O]C[CH]CC1([O])[CH]C1(15826)',
    structure = SMILES('[O]C[CH]CC1([O])[CH]C1'),
    E0 = (474.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.608726,0.0650802,-4.39281e-05,1.32347e-08,-1.12619e-12,57244.3,34.5745], Tmin=(100,'K'), Tmax=(1240.82,'K')), NASAPolynomial(coeffs=[14.8787,0.028703,-1.15875e-05,2.11011e-09,-1.44322e-13,52962.1,-40.3344], Tmin=(1240.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCOJ) + radical(CCJCO) + radical(CCJCO)"""),
)
...
species(
    label = '[O]C1(C=CC=O)CC1(15829)',
    structure = SMILES('[O]C1(C=CC=O)CC1'),
    E0 = (30.0624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01467,0.0537102,-1.46488e-05,-1.64514e-08,8.77652e-12,3733.24,28.441], Tmin=(100,'K'), Tmax=(1093.82,'K')), NASAPolynomial(coeffs=[14.7773,0.0276758,-1.2263e-05,2.40032e-09,-1.73248e-13,-730.855,-45.8333], Tmin=(1093.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.0624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + ring(Cyclopropane) + radical(C=CC(C)2OJ)"""),
)
...
species(
    ...
    E0 = (126.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[O]C1(CC[C]=O)CC1(12280)',
    structure = SMILES('[O]C1(CC[C]=O)CC1'),
    E0 = (86.355,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327405,0.0722321,-5.98123e-05,2.55846e-08,-4.38992e-12,10525.4,29.8735], Tmin=(100,'K'), Tmax=(1393.26,'K')), NASAPolynomial(coeffs=[16.415,0.0260452,-1.00871e-05,1.79147e-09,-1.20595e-13,6042.53,-53.0754], Tmin=(1393.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C1([CH]C1)CCC=O(15830)',
    structure = SMILES('[O]C1([CH]C1)CCC=O'),
    E0 = (126.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'O=CC=CC1(O)CC1(15831)',
    structure = SMILES('O=CC=CC1(O)CC1'),
    E0 = (-199.04,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654123,0.0598556,-1.78358e-05,-2.11905e-08,1.23651e-11,-23806.6,28.5152], Tmin=(100,'K'), Tmax=(1025.27,'K')), NASAPolynomial(coeffs=[17.1708,0.0250066,-1.01406e-05,1.95435e-09,-1.42226e-13,-28748.6,-59.1646], Tmin=(1025.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + ring(Cyclopropane)"""),
)
...
species(
    label = 'O=CC1CC2(CC2)O1(12898)',
    structure = SMILES('O=CC1CC2(CC2)O1'),
    E0 = (-116.627,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31664,0.0435213,2.27837e-05,-5.69528e-08,2.35383e-11,-13916.7,24.3455], Tmin=(100,'K'), Tmax=(1006.87,'K')), NASAPolynomial(coeffs=[13.9352,0.0301207,-1.19699e-05,2.28717e-09,-1.66045e-13,-18319.6,-45.8634], Tmin=(1006.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-OdCsH) + polycyclic(s1_3_4_ane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['[O][CH]C1CC2(CC2)O1(15809)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.724e+10,'s^-1','*|/',3), n=0.478, Ea=(141.315,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_O]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC(=O)CC=C[O](12907)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(CC=C=O)CC1(15810)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[O]C=CCC1([O])CC1(12889)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5.43214e-05,'m^3/(mol*s)'), n=3.00879, Ea=(27.5684,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO_O;CsJ-OneDeHH] for rate rule [CO-CsCs_O;CsJ-CdHH]
Euclidian distance = 2.2360679775
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C1(CC=[C]O)CC1(15811)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['[O]C=CCC1(O)[CH]C1(15812)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['[O]C=C[CH]C1(O)CC1(15813)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C1(C[C]=CO)CC1(15814)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C=[C]CC1(O)CC1(15815)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['[O]C1([CH]C=CO)CC1(15816)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(2e+10,'s^-1'), n=0, Ea=(418.4,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [R4H_SDS;Y_rad_out;Cs_H_out_H/(NonDeC/Cs)] for rate rule [R4H_SDS;O_rad_out;Cs_H_out_H/(NonDeC/Cs/Cs)]
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['O=[C][CH]CC1(O)CC1(15817)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C1([CH]C1)CC=CO(15818)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[O]C=CCC1([O])[CH]C1(15819)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C[O](602)', '[CH2]C1([O])CC1(4307)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[O]C=C[CH]C1([O])CC1(15820)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[O]C=[C]CC1([O])CC1(15821)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[O]C1(C[CH][C]=O)CC1(15822)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['[O]C1(CC1)CC1[CH]O1(12409)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['[O]C1[CH]CC2(CC2)O1(15768)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[O][CH]C[CH]C1([O])CC1(15824)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[O][CH]CCC1([O])[CH]C1(15825)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C[CH]CC1([O])[CH]C1(15826)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(T)(63)', '[O]C=CC[C]1CC1(15827)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(T)(63)', '[CH]=CCC1([O])CC1(15828)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[O]C1(C=CC=O)CC1(15829)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O]C1([CH]CC=O)CC1(15786)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[O]C1(CC[C]=O)CC1(12280)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[O]C1([CH]C1)CCC=O(15830)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.39512e+11,'s^-1'), n=0.277081, Ea=(238.505,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R6plus;carbonyl_intra_H;radadd_intra] + [R6_linear;multiplebond_intra;radadd_intra] for rate rule [R6_linear;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic
Ea raised from 237.2 to 238.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction38',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['O=CC=CC1(O)CC1(15831)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[O]C=CCC1([O])CC1(12889)'],
    products = ['O=CC1CC2(CC2)O1(12898)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=O(373)', '[CH]CC1([O])CC1(11628)'],
    products = ['[O]C=CCC1([O])CC1(12889)'],
