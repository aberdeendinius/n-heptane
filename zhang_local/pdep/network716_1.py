...
species(
    label = '[CH2]OC(=O)O[C]1CO1(2336)',
    structure = SMILES('[CH2]OC(=O)O[C]1CO1'),
    E0 = (-230.089,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884141,0.0567376,-2.40597e-05,-2.26325e-08,1.71378e-11,-27550.1,27.6155], Tmin=(100,'K'), Tmax=(904.95,'K')), NASAPolynomial(coeffs=[18.5185,0.0109834,-1.57967e-06,1.16322e-10,-6.32171e-15,-32059.9,-62.9819], Tmin=(904.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-OdOsOs) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CsJOC(O))"""),
)

species(
    label = '[O]CC(=O)O[C]1CO1(2337)',
    structure = SMILES('[O]CC(=O)O[C]1CO1'),
    E0 = (-170.429,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977308,0.0594316,-5.70081e-05,3.00678e-08,-6.25754e-12,-20383,29.0107], Tmin=(100,'K'), Tmax=(1272.25,'K')), NASAPolynomial(coeffs=[12.473,0.0195277,-5.52641e-06,7.67399e-10,-4.3339e-14,-23003.7,-28.0209], Tmin=(1272.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-170.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + ring(Ethylene_oxide) + radical(C=OCOJ) + radical(Cs_P)"""),
)
...
species(
    label = '[O]C1(CO1)OC1=CO1(2338)',
    structure = SMILES('[O]C1(CO1)OC1=CO1'),
    E0 = (14.3748,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885932,0.0658822,-6.51337e-05,1.98677e-08,4.62387e-12,1843.9,22.3355], Tmin=(100,'K'), Tmax=(785.482,'K')), NASAPolynomial(coeffs=[15.8567,0.010933,-8.52116e-07,-1.87131e-10,2.52981e-14,-1164.66,-50.4551], Tmin=(785.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.3748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + ring(Ethylene_oxide) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C1(CO1)OC1[CH]O1(2339)',
    structure = SMILES('[O]C1(CO1)OC1[CH]O1'),
    E0 = (-65.658,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584748,0.0699247,-8.49223e-05,5.52366e-08,-1.32816e-11,-7769.2,26.5425], Tmin=(100,'K'), Tmax=(1249.2,'K')), NASAPolynomial(coeffs=[11.4199,0.01794,-1.73958e-06,-2.3564e-10,3.7322e-14,-9127.19,-22.7419], Tmin=(1249.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CCOJ)"""),
)

species(
    label = 'OC1([CH]O1)O[C]1CO1(2340)',
    structure = SMILES('OC1([CH]O1)O[C]1CO1'),
    E0 = (-86.1168,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00350571,0.0766477,-9.51208e-05,5.91304e-08,-1.32742e-11,-10203.3,29.1652], Tmin=(100,'K'), Tmax=(1352.38,'K')), NASAPolynomial(coeffs=[14.6651,0.0110501,2.27334e-06,-1.02553e-09,9.12185e-14,-12139.6,-38.5206], Tmin=(1352.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.1168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)

species(
    label = '[O]C1([CH]O1)OC1CO1(2341)',
    structure = SMILES('[O]C1([CH]O1)OC1CO1'),
    E0 = (-65.658,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
...
species(
    label = 'OC1(CO1)O[C]1[CH]O1(2342)',
    structure = SMILES('OC1(CO1)O[C]1[CH]O1'),
    E0 = (-86.1168,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00350571,0.0766477,-9.51208e-05,5.91304e-08,-1.32742e-11,-10203.3,29.1652], Tmin=(100,'K'), Tmax=(1352.38,'K')), NASAPolynomial(coeffs=[14.6651,0.0110501,2.27334e-06,-1.02553e-09,9.12185e-14,-12139.6,-38.5206], Tmin=(1352.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.1168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(CCsJO) + radical(Cs_P)"""),
)

species(
    label = '[O]C1([CH]O1)O[C]1CO1(2343)',
    structure = SMILES('[O]C1([CH]O1)O[C]1CO1'),
    E0 = (139.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697477,0.0697556,-9.21646e-05,6.32633e-08,-1.58947e-11,16910.2,27.52], Tmin=(100,'K'), Tmax=(1204.29,'K')), NASAPolynomial(coeffs=[11.2491,0.0156261,-9.75333e-07,-3.74746e-10,4.74904e-14,15752.6,-19.6018], Tmin=(1204.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CCsJO) + radical(Cs_P)"""),
)

species(
    label = '[O]C1(CO1)O[C]1[CH]O1(2344)',
    structure = SMILES('[O]C1(CO1)O[C]1[CH]O1'),
    E0 = (139.588,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697477,0.0697556,-9.21646e-05,6.32633e-08,-1.58947e-11,16910.2,27.52], Tmin=(100,'K'), Tmax=(1204.29,'K')), NASAPolynomial(coeffs=[11.2491,0.0156261,-9.75333e-07,-3.74746e-10,4.74904e-14,15752.6,-19.6018], Tmin=(1204.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(CCOJ) + radical(Cs_P) + radical(CCsJO)"""),
)
...
species(
    label = 'OC1(CO1)OC1=CO1(2346)',
    structure = SMILES('OC1(CO1)OC1=CO1'),
    E0 = (-107.385,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.2442,0.0846635,-0.000125268,9.3277e-08,-2.60618e-11,-12782.1,24.4131], Tmin=(100,'K'), Tmax=(1031.17,'K')), NASAPolynomial(coeffs=[13.6806,0.0170138,-4.27197e-06,4.46941e-10,-1.51155e-14,-14727.5,-36.8191], Tmin=(1031.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + ring(oxirene)"""),
)

species(
    label = 'C1OC12OC1(CO1)O2(1823)',
    structure = SMILES('C1OC12OC1(CO1)O2'),
    E0 = (-285.091,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93015,0.055917,-8.70165e-05,9.23003e-08,-3.74036e-11,-34224.1,18.2485], Tmin=(100,'K'), Tmax=(837.801,'K')), NASAPolynomial(coeffs=[-1.1072,0.0449668,-2.18427e-05,4.17887e-09,-2.88057e-13,-32821.9,37.6953], Tmin=(837.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsOs) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + polycyclic(s1_3_4_ane) - ring(Cyclobutane)"""),
)

species(
    label = '[CH2]O[C]([O])O[C]1CO1(2347)',
    structure = SMILES('[CH2]O[C]([O])O[C]1CO1'),
    E0 = (218.334,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,3150,900,1100,3000,3100,440,815,1455,1000,180,1047.52,1047.52,1047.52,1047.52,1047.52,1047.52,1047.52,1047.52,1047.52,1047.52,1047.52,2314.65],'cm^-1')),
        HinderedRotor(inertia=(0.101943,'amu*angstrom^2'), symmetry=1, barrier=(2.34388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101943,'amu*angstrom^2'), symmetry=1, barrier=(2.34388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101943,'amu*angstrom^2'), symmetry=1, barrier=(2.34388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101943,'amu*angstrom^2'), symmetry=1, barrier=(2.34388,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15408,0.0798458,-0.000153498,1.59125e-07,-6.01809e-11,26345.6,29.9459], Tmin=(100,'K'), Tmax=(877.81,'K')), NASAPolynomial(coeffs=[-0.75771,0.0458649,-2.24784e-05,4.21517e-09,-2.83308e-13,28326,48.289], Tmin=(877.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(OCOJ) + radical(Cs_P) + radical(CsJOCH3) + radical(Cs_P)"""),
)
...
species(
    label = '[O]C[C]([O])O[C]1CO1(2348)',
    structure = SMILES('[O]C[C]([O])O[C]1CO1'),
    E0 = (217.804,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970274,0.0777019,-0.000131003,1.21797e-07,-4.26264e-11,26294.4,31.7144], Tmin=(100,'K'), Tmax=(897.699,'K')), NASAPolynomial(coeffs=[4.3426,0.0357294,-1.58447e-05,2.83772e-09,-1.85543e-13,26774.7,21.8561], Tmin=(897.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCOJ) + radical(Cs_P) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)O[C]1CO1(2336)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[O]CC(=O)O[C]1CO1(2337)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(CO1)OC1=CO1(2338)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C1(CO1)O[C]1CO1(1820)'],
    products = ['[O]C1(CO1)OC1[CH]O1(2339)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C1(CO1)O[C]1CO1(1820)'],
    products = ['OC1([CH]O1)O[C]1CO1(2340)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O]C1(CO1)O[C]1CO1(1820)'],
    products = ['[O]C1([CH]O1)OC1CO1(2341)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C1(CO1)O[C]1CO1(1820)'],
    products = ['OC1(CO1)O[C]1[CH]O1(2342)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[O]C1([CH]O1)O[C]1CO1(2343)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C1(CO1)O[C]1[CH]O1(2344)', 'H(8)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=O)OC1([O])CO1(2190)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', '[O]C(=O)O[C]1CO1(2345)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)O[C]1CO1(2244)', 'O(S)(1732)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]C1(CO1)O[C]1CO1(1820)'],
    products = ['C1OC12OC1(CO1)O2(1823)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]O[C]([O])O[C]1CO1(2347)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([O])([O])O[C]1CO1(2193)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]C[C]([O])O[C]1CO1(2348)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]C1([O])CO1(1782)', '[C]1CO1(1125)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(T)(63)', 'C1O[C]1O[C]1CO1(2349)'],
    products = ['[O]C1(CO1)O[C]1CO1(1820)'],
