...
species(
    label = 'C[CH]CCC=O(643)',
    structure = SMILES('C[CH]CCC=O'),
    E0 = (-56.4374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,2037.23],'cm^-1')),
        HinderedRotor(inertia=(0.140396,'amu*angstrom^2'), symmetry=1, barrier=(3.22799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141026,'amu*angstrom^2'), symmetry=1, barrier=(3.24247,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140722,'amu*angstrom^2'), symmetry=1, barrier=(3.23547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140943,'amu*angstrom^2'), symmetry=1, barrier=(3.24057,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'CC=CC[CH]O(5622)',
    structure = SMILES('CC=CC[CH]O'),
    E0 = (-32.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,313.414,313.604],'cm^-1')),
        HinderedRotor(inertia=(0.121205,'amu*angstrom^2'), symmetry=1, barrier=(8.45282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121114,'amu*angstrom^2'), symmetry=1, barrier=(8.44594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12145,'amu*angstrom^2'), symmetry=1, barrier=(8.45135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122119,'amu*angstrom^2'), symmetry=1, barrier=(8.45023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = 'C[CH]CC=CO(5623)',
    structure = SMILES('C[CH]CC=CO'),
    E0 = (-54.6484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,286.754,288.142],'cm^-1')),
        HinderedRotor(inertia=(0.26064,'amu*angstrom^2'), symmetry=1, barrier=(15.1749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00206184,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254809,'amu*angstrom^2'), symmetry=1, barrier=(15.1898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256827,'amu*angstrom^2'), symmetry=1, barrier=(15.1935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = 'C[CH]CCC[O](536)',
    structure = SMILES('C[CH]CCC[O]'),
    E0 = (92.2397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1732.72,1732.78,1732.92],'cm^-1')),
...
species(
    label = 'C[CH]C[CH]CO(5625)',
    structure = SMILES('C[CH]C[CH]CO'),
    E0 = (66.4366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,266.099,448.053,3395.11],'cm^-1')),
...
species(
    label = '[CH2]CCC[CH]O(5626)',
    structure = SMILES('[CH2]CCC[CH]O'),
    E0 = (57.6325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0414,0.0683482,-6.59992e-05,3.83063e-08,-9.56151e-12,7035.34,26.5185], Tmin=(100,'K'), Tmax=(943.587,'K')), NASAPolynomial(coeffs=[8.45623,0.0369161,-1.6033e-05,3.00441e-09,-2.08539e-13,5636.01,-8.82327], Tmin=(943.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(57.6325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][CH]O(5627)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09988,0.0637158,-5.21322e-05,2.40123e-08,-4.68837e-12,6393.22,27.0075], Tmin=(100,'K'), Tmax=(1189.28,'K')), NASAPolynomial(coeffs=[10.1301,0.0333434,-1.38242e-05,2.53805e-09,-1.74213e-13,4245.34,-18.1235], Tmin=(1189.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.2882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = 'C[CH][CH]CCO(541)',
    structure = SMILES('C[CH][CH]CCO'),
    E0 = (60.9928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,688.083,1870.7,3947.35],'cm^-1')),
        HinderedRotor(inertia=(0.0456951,'amu*angstrom^2'), symmetry=1, barrier=(5.29941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0456951,'amu*angstrom^2'), symmetry=1, barrier=(5.29941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0456951,'amu*angstrom^2'), symmetry=1, barrier=(5.29941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0456951,'amu*angstrom^2'), symmetry=1, barrier=(5.29941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0456951,'amu*angstrom^2'), symmetry=1, barrier=(5.29941,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.39272,0.0424971,-1.74238e-05,2.72256e-09,-1.27068e-13,7326.03,21.8304], Tmin=(100,'K'), Tmax=(2935.94,'K')), NASAPolynomial(coeffs=[44.8613,-0.00361347,8.27641e-07,-2.1675e-10,2.06072e-14,-21500.6,-230.519], Tmin=(2935.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.9928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]CCCO(5628)',
    structure = SMILES('[CH2][CH]CCCO'),
    E0 = (71.7809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3025,407.5,1350,352.5,232.335,429.209,3053.67],'cm^-1')),
...
species(
    ...
    E0 = (78.0912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,230.394,230.443,230.474,2080.78],'cm^-1')),
        HinderedRotor(inertia=(0.00317451,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00317621,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180224,'amu*angstrom^2'), symmetry=1, barrier=(6.79796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180345,'amu*angstrom^2'), symmetry=1, barrier=(6.79841,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = 'C[C]CC[CH]O(5631)',
    structure = SMILES('C[C]CC[CH]O'),
    E0 = (300.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903377,0.0712514,-7.71475e-05,4.85136e-08,-1.27276e-11,36262.8,25.1321], Tmin=(100,'K'), Tmax=(913.62,'K')), NASAPolynomial(coeffs=[9.64221,0.0329915,-1.43321e-05,2.67767e-09,-1.85302e-13,34666,-16.2384], Tmin=(913.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOH)"""),
)

species(
    label = 'C[CH]CC[C]O(5632)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19407,0.0658073,-7.17302e-05,4.93949e-08,-1.46867e-11,39489.2,26.1019], Tmin=(100,'K'), Tmax=(800.927,'K')), NASAPolynomial(coeffs=[7.15018,0.0360595,-1.60145e-05,3.01614e-09,-2.09252e-13,38535.2,-1.31041], Tmin=(800.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', 'C[CH]CC[CH][O](636)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH][CH]C[CH]O(851)', 'H(8)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]C[CH][CH]O(850)', 'H(8)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CC[CH]O(853)', 'H(8)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction28',
    reactants = ['OH(D)(132)', '[CH]CC[CH]C(131)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C[CH]O(426)', '[CH]C(32)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH]C(38)', '[CH]O(5471)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH3](11)', '[CH]CC[CH]O(5597)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', 'C[C]CC[CH]O(5631)'],
    products = ['C[CH]CC[CH]O(5500)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', 'C[CH]CC[C]O(5632)'],
    products = ['C[CH]CC[CH]O(5500)'],
