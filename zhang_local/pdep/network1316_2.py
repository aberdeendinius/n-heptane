...
species(
    label = '[CH]=C(O)O[O](5137)',
    structure = SMILES('[CH]=C(O)O[O]'),
    E0 = (199.816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,3615,1277.5,1000,350,440,435,1725],'cm^-1')),
...
species(
    ...
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4239,0.0359186,-3.25355e-05,1.53665e-08,-2.61609e-12,-458.43,20.538], Tmin=(100,'K'), Tmax=(1849.52,'K')), NASAPolynomial(coeffs=[7.60912,0.00918303,-1.82518e-08,-2.59633e-10,2.39776e-14,-461.566,-6.9288], Tmin=(1849.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.7343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C=[C]O[O](591)'],
    products = ['C=C(O)O[O](1171)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction13',
    reactants = ['O(T)(63)', '[CH2]C(=O)O(2061)'],
    products = ['C=C(O)O[O](1171)'],
