species(
    label = 'C[CH]OO[C]1CO1(3637)',
    structure = SMILES('C[CH]OO[C]1CO1'),
    E0 = (158.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,2750,3150,900,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972509,0.0649138,-6.21919e-05,3.12078e-08,-5.46348e-12,19153.3,25.4123], Tmin=(100,'K'), Tmax=(869.401,'K')), NASAPolynomial(coeffs=[11.3037,0.0257369,-9.01521e-06,1.48576e-09,-9.55528e-14,17041.2,-24.8], Tmin=(869.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOOC) + radical(Cs_P)"""),
)
...
species(
    label = 'C[CH]OOC1=CO1(3890)',
    structure = SMILES('C[CH]OOC1=CO1'),
    E0 = (375.835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,1000,350,500,795,815,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801141,0.0848623,-0.000158325,1.58154e-07,-5.93281e-11,45303.8,25.3175], Tmin=(100,'K'), Tmax=(848.479,'K')), NASAPolynomial(coeffs=[3.07144,0.0407704,-2.13485e-05,4.15044e-09,-2.86271e-13,46120.4,21.8201], Tmin=(848.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(375.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(oxirene) + radical(CCsJOOC)"""),
)
...
species(
    ...
    E0 = (114.807,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,350,500,795,815,2750,3150,900,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH2]COO[C]1CO1(3892)',
    structure = SMILES('[CH2]COO[C]1CO1'),
    E0 = (185.852,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.876863,0.0660431,-6.20384e-05,2.74989e-08,-3.1107e-12,22467.9,27.4564], Tmin=(100,'K'), Tmax=(862.983,'K')), NASAPolynomial(coeffs=[12.7366,0.0228637,-7.48158e-06,1.1862e-09,-7.48582e-14,19981.8,-30.5564], Tmin=(862.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CJCOOH)"""),
)

species(
    label = 'CCOO[C]1[CH]O1(3893)',
    structure = SMILES('CCOO[C]1[CH]O1'),
    E0 = (155.612,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736215,0.0669719,-5.85534e-05,2.00677e-08,3.20947e-13,18837.9,26.1671], Tmin=(100,'K'), Tmax=(883.292,'K')), NASAPolynomial(coeffs=[14.6245,0.0200625,-6.03592e-06,9.16852e-10,-5.71629e-14,15760.8,-42.642], Tmin=(883.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)

species(
    label = '[CH2][CH]OOC1CO1(3894)',
    structure = SMILES('[CH2][CH]OOC1CO1'),
    E0 = (167.046,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.875659,0.0668056,-6.44254e-05,3.06613e-08,-4.39623e-12,20205.4,26.3756], Tmin=(100,'K'), Tmax=(853.112,'K')), NASAPolynomial(coeffs=[12.2457,0.0241444,-8.14076e-06,1.31034e-09,-8.31735e-14,17877.9,-28.9434], Tmin=(853.112,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOOC) + radical(CJCOOH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3535,'J/mol'), sigma=(6.15499,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=552.16 K, Pc=34.4 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = 'CCOOC1=CO1(3895)',
    structure = SMILES('CCOOC1=CO1'),
    E0 = (189.395,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.787343,0.0830966,-0.000144524,1.41506e-07,-5.31092e-11,22882.6,25.0717], Tmin=(100,'K'), Tmax=(835.396,'K')), NASAPolynomial(coeffs=[3.66637,0.0419639,-2.15641e-05,4.1945e-09,-2.90716e-13,23355.8,17.4113], Tmin=(835.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(oxirene)"""),
)

species(
    label = 'C=COOC1CO1(3896)',
    structure = SMILES('C=COOC1CO1'),
    E0 = (-90.4395,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12788,0.0532762,-1.77487e-05,-2.44727e-08,1.69353e-11,-10764.6,23.8593], Tmin=(100,'K'), Tmax=(890.477,'K')), NASAPolynomial(coeffs=[15.5359,0.0167114,-3.58388e-06,4.30388e-10,-2.49565e-14,-14446.9,-50.2479], Tmin=(890.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.4395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = 'C[C]OO[C]1CO1(3897)',
    structure = SMILES('C[C]OO[C]1CO1'),
    E0 = (432.878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.740524,0.0691435,-7.36037e-05,3.76277e-08,-6.23598e-12,52183,24.6821], Tmin=(100,'K'), Tmax=(868.842,'K')), NASAPolynomial(coeffs=[14.2526,0.0184357,-5.91322e-06,9.22014e-10,-5.75736e-14,49401,-41.104], Tmin=(868.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CH2_triplet) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]OOC1=CO1(3890)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=COO[C]1CO1(1783)', 'H(8)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', 'C[CH]OO[C]1[CH]O1(2227)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][CH]OO[C]1CO1(1796)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=O)OO[CH]C(3640)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]OO[C]1CO1(3637)'],
    products = ['CCOOC1=CO1(3895)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(6.42e+09,'s^-1'), n=0.137, Ea=(32.8438,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R5;Y_rad_NDe;XH_Rrad_NDe] for rate rule [R5radEndo;Y_rad_NDe;XH_Rrad_NDe]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction15',
    reactants = ['[C]1CO1(1125)', 'C[CH]O[O](77)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]O[C]1CO1(1781)', '[CH]C(32)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]OO[C]1CO1(2021)', '[CH3](11)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', 'C[C]OO[C]1CO1(3897)'],
    products = ['C[CH]OO[C]1CO1(3637)'],
