...
species(
    label = '[CH]=CC(=C)O(5299)',
    structure = SMILES('[CH]=CC(=C)O'),
    E0 = (127.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725],'cm^-1')),
...
species(
    label = '[CH]=[C]C(C)O(5279)',
    structure = SMILES('[CH]=[C]C(C)O'),
    E0 = (295.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3120,650,792.5,1650,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.142259,'amu*angstrom^2'), symmetry=1, barrier=(10.7863,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142657,'amu*angstrom^2'), symmetry=1, barrier=(10.7908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145034,'amu*angstrom^2'), symmetry=1, barrier=(10.7817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
...
species(
    label = '[CH]C=C([CH2])O(5295)',
    structure = SMILES('[CH]C=C([CH2])O'),
    E0 = (285.141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,227.705,227.731,227.734],'cm^-1')),
        HinderedRotor(inertia=(1.36325,'amu*angstrom^2'), symmetry=1, barrier=(50.1639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36316,'amu*angstrom^2'), symmetry=1, barrier=(50.1641,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.36333,'amu*angstrom^2'), symmetry=1, barrier=(50.1641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62187,0.0430872,-1.22508e-05,-2.21469e-08,1.41121e-11,34388.7,19.3642], Tmin=(100,'K'), Tmax=(914.562,'K')), NASAPolynomial(coeffs=[13.9913,0.0133324,-3.37804e-06,4.91293e-10,-3.24696e-14,31108,-44.7725], Tmin=(914.562,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH]C(O)C=[CH](5790)',
    structure = SMILES('[CH]C(O)C=[CH]'),
    E0 = (505.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.329821,'amu*angstrom^2'), symmetry=1, barrier=(18.9088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0205358,'amu*angstrom^2'), symmetry=1, barrier=(18.9087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.020536,'amu*angstrom^2'), symmetry=1, barrier=(18.9086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81967,0.0415178,-2.85241e-05,3.51075e-09,2.63019e-12,60939.9,22.5781], Tmin=(100,'K'), Tmax=(996.506,'K')), NASAPolynomial(coeffs=[12.4483,0.0121793,-4.41948e-06,8.03186e-10,-5.69411e-14,58160,-31.9813], Tmin=(996.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])O(5278)'],
    products = ['C=CO(576)', 'C#C(582)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=CC(=C)O(5299)'],
    products = ['[CH]=CC([CH2])O(5278)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['C#C(582)', '[CH2][CH]O(578)'],
    products = ['[CH]=CC([CH2])O(5278)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', '[CH]=CC=C(5156)'],
    products = ['[CH]=CC([CH2])O(5278)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH]C=C[CH2](5187)'],
    products = ['[CH]=CC([CH2])O(5278)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]=CC([CH2])[O](5159)'],
    products = ['[CH]=CC([CH2])O(5278)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[CH](583)', '[CH2][CH]O(578)'],
    products = ['[CH]=CC([CH2])O(5278)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C=C([CH2])O(5295)'],
    products = ['[CH]=CC([CH2])O(5278)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]=[C]C([CH2])O(5296)'],
    products = ['[CH]=CC([CH2])O(5278)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', '[CH]C=CO(5264)'],
    products = ['[CH]=CC([CH2])O(5278)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C(O)C=[CH](5790)'],
    products = ['[CH]=CC([CH2])O(5278)'],
