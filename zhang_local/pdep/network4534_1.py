...
species(
    label = '[CH]C1[CH]CC=1[CH2](21660)',
    structure = SMILES('[CH]C1[CH]CC=1[CH2]'),
    E0 = (753.084,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94122,0.0283551,4.9271e-05,-8.36955e-08,3.38321e-11,90664.5,18.4863], Tmin=(100,'K'), Tmax=(962.22,'K')), NASAPolynomial(coeffs=[13.3313,0.0230821,-8.1013e-06,1.49958e-09,-1.10268e-13,86524.7,-46.147], Tmin=(962.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(753.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(Allyl_P) + radical(cyclobutene-allyl) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C1=CCC1=C(21655)',
    structure = SMILES('[CH]C1=CCC1=C'),
    E0 = (552.818,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82591,0.0290655,5.2497e-05,-9.31467e-08,3.90344e-11,66584.1,17.333], Tmin=(100,'K'), Tmax=(942.147,'K')), NASAPolynomial(coeffs=[15.6196,0.017843,-5.00679e-06,8.76127e-10,-6.66027e-14,61883.9,-59.5422], Tmin=(942.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(552.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.32885,'amu*angstrom^2'), symmetry=1, barrier=(30.5529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.32756,'amu*angstrom^2'), symmetry=1, barrier=(30.5232,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (77.1039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447018,0.0649449,-6.84937e-05,3.45636e-08,-6.56578e-12,130853,20.3983], Tmin=(100,'K'), Tmax=(1437.27,'K')), NASAPolynomial(coeffs=[18.7575,0.00724341,-1.23717e-06,1.03236e-10,-3.97203e-15,126286,-72.1586], Tmin=(1437.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1086.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P) + radical(CJ3)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.08e+10,'s^-1'), n=0.69, Ea=(132.672,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra_2H;radadd_intra_cdsingleH]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC([CH2])=C(17769)'],
    products = ['[CH]C(=[CH])C([CH2])=C(19688)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=[CH])C([CH2])=C(19688)'],
    products = ['[CH]C1[CH]CC=1[CH2](21660)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(7.812e+11,'s^-1'), n=0.387, Ea=(138.055,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra;radadd_intra_cdsingleH]
Euclidian distance = 0
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(28)', '[CH]C([CH])=C=C(21416)'],
    products = ['[CH]C(=[CH])C([CH2])=C(19688)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[C]C(=[CH])C([CH2])=C(21661)'],
    products = ['[CH]C(=[CH])C([CH2])=C(19688)'],
