...
species(
    ...
    E0 = (42.6675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,180,2508.35],'cm^-1')),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33226,0.0390924,-2.22696e-05,7.06369e-09,-1.03683e-12,10908.3,23.5189], Tmin=(100,'K'), Tmax=(1355.36,'K')), NASAPolynomial(coeffs=[5.30811,0.0303099,-1.25499e-05,2.28284e-09,-1.54992e-13,10101.6,8.25723], Tmin=(1355.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.2168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO)"""),
)
...
species(
    ...
    E0 = (369.789,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,699.447,699.56],'cm^-1')),
        HinderedRotor(inertia=(0.170706,'amu*angstrom^2'), symmetry=1, barrier=(3.92486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170518,'amu*angstrom^2'), symmetry=1, barrier=(3.92054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170548,'amu*angstrom^2'), symmetry=1, barrier=(3.92123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06603,0.0464742,-5.03243e-05,4.22359e-08,-1.60797e-11,44541.2,20.0167], Tmin=(100,'K'), Tmax=(756.607,'K')), NASAPolynomial(coeffs=[3.44534,0.0341325,-1.58452e-05,3.03441e-09,-2.11962e-13,44477,14.7022], Tmin=(756.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH]C(38)', 'O(T)(63)'],
    products = ['C[CH]CC[O](391)'],
