...
species(
    label = 'C=C([O])C(=C)CC(4445)',
    structure = SMILES('C=C([O])C(=C)CC'),
    E0 = (-42.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,325,375,415,465,420,450,1700,1750,2750,2800,2850,1350,1500,750,1050,1375,1000,285.481,285.662,285.72],'cm^-1')),
        HinderedRotor(inertia=(0.236469,'amu*angstrom^2'), symmetry=1, barrier=(13.688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.236217,'amu*angstrom^2'), symmetry=1, barrier=(13.6877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23632,'amu*angstrom^2'), symmetry=1, barrier=(13.687,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([O])=C(C)CC(4446)',
    structure = SMILES('[CH2]C([O])=C(C)CC'),
    E0 = (-9.43951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,325,375,415,465,420,450,1700,1750,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,314.403,314.65],'cm^-1')),
        HinderedRotor(inertia=(0.00170459,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113062,'amu*angstrom^2'), symmetry=1, barrier=(7.94562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113204,'amu*angstrom^2'), symmetry=1, barrier=(7.94476,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113094,'amu*angstrom^2'), symmetry=1, barrier=(7.9459,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH]=C(O)C([CH2])CC(4449)',
    structure = SMILES('[CH]=C(O)C([CH2])CC'),
    E0 = (165.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,207.772],'cm^-1')),
        HinderedRotor(inertia=(0.00393964,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00394915,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.540582,'amu*angstrom^2'), symmetry=1, barrier=(16.4431,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543752,'amu*angstrom^2'), symmetry=1, barrier=(16.4492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.534788,'amu*angstrom^2'), symmetry=1, barrier=(16.4409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209814,0.0722178,-4.14123e-05,-6.71595e-09,1.08325e-11,20059.7,30.1683], Tmin=(100,'K'), Tmax=(929.866,'K')), NASAPolynomial(coeffs=[18.4305,0.0221982,-6.47277e-06,1.03372e-09,-6.94423e-14,15445,-63.0037], Tmin=(929.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([CH]C)C(=C)O(4450)',
    structure = SMILES('[CH2]C([CH]C)C(=C)O'),
    E0 = (113.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,1211.37,1211.43],'cm^-1')),
        HinderedRotor(inertia=(0.692098,'amu*angstrom^2'), symmetry=1, barrier=(15.9127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692086,'amu*angstrom^2'), symmetry=1, barrier=(15.9124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692086,'amu*angstrom^2'), symmetry=1, barrier=(15.9124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0542855,'amu*angstrom^2'), symmetry=1, barrier=(15.9127,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00272088,'amu*angstrom^2'), symmetry=1, barrier=(15.9132,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456001,0.067707,-3.70287e-05,-4.63308e-09,8.23313e-12,13729,31.4369], Tmin=(100,'K'), Tmax=(958.982,'K')), NASAPolynomial(coeffs=[16.2161,0.0257542,-8.60957e-06,1.47243e-09,-1.00578e-13,9612.63,-49.6384], Tmin=(958.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C(=C)[O](4451)',
    structure = SMILES('[CH2]CC(C)C(=C)[O]'),
    E0 = (56.4384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,402.948,402.952,402.953],'cm^-1')),
        HinderedRotor(inertia=(0.00103825,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00103828,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0781594,'amu*angstrom^2'), symmetry=1, barrier=(9.00518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0781552,'amu*angstrom^2'), symmetry=1, barrier=(9.00501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.61324,0.06444,-3.264e-05,-3.97161e-09,6.4078e-12,6918.72,29.8223], Tmin=(100,'K'), Tmax=(1006,'K')), NASAPolynomial(coeffs=[14.7265,0.0290099,-1.06567e-05,1.90102e-09,-1.31353e-13,3032.37,-43.5531], Tmin=(1006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.4384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH]=C([O])C(C)CC(4452)',
    structure = SMILES('[CH]=C([O])C(C)CC'),
    E0 = (98.2882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,350,440,435,1725,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,346.723,346.724],'cm^-1')),
        HinderedRotor(inertia=(0.00140213,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118936,'amu*angstrom^2'), symmetry=1, barrier=(10.1457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118923,'amu*angstrom^2'), symmetry=1, barrier=(10.1457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118922,'amu*angstrom^2'), symmetry=1, barrier=(10.1456,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH2]CC([CH2])C(=C)O(4453)',
    structure = SMILES('[CH2]CC([CH2])C(=C)O'),
    E0 = (123.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,303.559,303.559],'cm^-1')),
        HinderedRotor(inertia=(0.00182944,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00182947,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00182943,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289935,'amu*angstrom^2'), symmetry=1, barrier=(18.9589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289925,'amu*angstrom^2'), symmetry=1, barrier=(18.9588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH2]C([O])=C([CH2])CC(4454)',
    structure = SMILES('[CH2]C([O])=C([CH2])CC'),
    E0 = (142.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,325,375,415,465,420,450,1700,1750,2750,2800,2850,1350,1500,750,1050,1375,1000,180,518.961],'cm^-1')),
        HinderedRotor(inertia=(0.132857,'amu*angstrom^2'), symmetry=1, barrier=(3.05464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0148045,'amu*angstrom^2'), symmetry=1, barrier=(2.63708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879044,'amu*angstrom^2'), symmetry=1, barrier=(16.6869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0895361,'amu*angstrom^2'), symmetry=1, barrier=(16.5884,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.451197,0.0691216,-4.66883e-05,6.69167e-09,4.00455e-12,17221.6,27.9061], Tmin=(100,'K'), Tmax=(967.358,'K')), NASAPolynomial(coeffs=[15.9799,0.0246774,-8.42262e-06,1.44341e-09,-9.80525e-14,13292.4,-51.2759], Tmin=(967.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Allyl_P) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2]C([CH]C)C(=C)[O](4455)',
    structure = SMILES('[CH2]C([CH]C)C(=C)[O]'),
    E0 = (250.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,180.319,664.495,1963.32],'cm^-1')),
        HinderedRotor(inertia=(0.00648945,'amu*angstrom^2'), symmetry=1, barrier=(2.13139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0338416,'amu*angstrom^2'), symmetry=1, barrier=(10.2385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0201599,'amu*angstrom^2'), symmetry=1, barrier=(2.11919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.430719,'amu*angstrom^2'), symmetry=1, barrier=(10.1308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586634,0.0664197,-5.34853e-05,2.33575e-08,-4.13471e-12,30296.4,32.4745], Tmin=(100,'K'), Tmax=(1352.09,'K')), NASAPolynomial(coeffs=[14.0751,0.0265156,-9.2158e-06,1.52979e-09,-9.87714e-14,26648.9,-36.6682], Tmin=(1352.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=C(C)OJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC([CH2])C(=C)[O](4456)',
    structure = SMILES('[CH2]CC([CH2])C(=C)[O]'),
    E0 = (261.521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,405.405,406.143,407.165],'cm^-1')),
        HinderedRotor(inertia=(0.00459726,'amu*angstrom^2'), symmetry=1, barrier=(0.537652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00679595,'amu*angstrom^2'), symmetry=1, barrier=(0.792811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00694912,'amu*angstrom^2'), symmetry=1, barrier=(0.814109,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0584157,'amu*angstrom^2'), symmetry=1, barrier=(6.80877,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.667791,0.0656986,-4.36721e-05,6.64954e-09,3.5901e-12,31580.5,31.408], Tmin=(100,'K'), Tmax=(953.372,'K')), NASAPolynomial(coeffs=[14.2975,0.0260055,-8.74218e-06,1.46919e-09,-9.80947e-14,28186.7,-37.866], Tmin=(953.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C([O])C([CH2])CC(4457)',
    structure = SMILES('[CH]=C([O])C([CH2])CC'),
    E0 = (303.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,345.844,358.772],'cm^-1')),
        HinderedRotor(inertia=(0.00130215,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00133827,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110769,'amu*angstrom^2'), symmetry=1, barrier=(9.81812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110008,'amu*angstrom^2'), symmetry=1, barrier=(9.83329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.558139,0.0684701,-4.98067e-05,1.1672e-08,2.16388e-12,36617.5,30.4183], Tmin=(100,'K'), Tmax=(947.729,'K')), NASAPolynomial(coeffs=[14.757,0.0254457,-8.46468e-06,1.41029e-09,-9.36134e-14,33167,-41.3259], Tmin=(947.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=C(C)OJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C([CH]C)[C](C)[O](4460)',
    structure = SMILES('[CH2]C([CH]C)[C](C)[O]'),
    E0 = (439.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,206.199,818.639,1674.55],'cm^-1')),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.741088,0.0755035,-7.69011e-05,4.87981e-08,-1.33615e-11,53025.5,31.4514], Tmin=(100,'K'), Tmax=(865.91,'K')), NASAPolynomial(coeffs=[8.12465,0.0413956,-1.78163e-05,3.30833e-09,-2.27943e-13,51746.8,-3.10692], Tmin=(865.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.541429,0.0780626,-7.83569e-05,4.62929e-08,-1.14729e-11,54321.7,31.3939], Tmin=(100,'K'), Tmax=(963.195,'K')), NASAPolynomial(coeffs=[10.2509,0.0377417,-1.55663e-05,2.8342e-09,-1.93335e-13,52451.3,-15.0849], Tmin=(963.195,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C(CC)C(=C)[O](4465)',
    structure = SMILES('[CH]C(CC)C(=C)[O]'),
    E0 = (299.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.532059,0.0666688,-4.14165e-05,3.14747e-09,4.56317e-12,36143.7,29.3309], Tmin=(100,'K'), Tmax=(994.094,'K')), NASAPolynomial(coeffs=[15.7335,0.0253858,-9.12731e-06,1.61446e-09,-1.11429e-13,32138.9,-48.8589], Tmin=(994.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=C(C)OJ)"""),
)

species(
    label = '[CH2]C(CC)=C(C)[O](4466)',
    structure = SMILES('[CH2]C(CC)=C(C)[O]'),
    E0 = (-16.857,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CC([CH2])C(C)=O(4468)',
    structure = SMILES('[CH2]CC([CH2])C(C)=O'),
    E0 = (104.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,298.197,2005.93],'cm^-1')),
        HinderedRotor(inertia=(0.00346229,'amu*angstrom^2'), symmetry=1, barrier=(0.21851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00346452,'amu*angstrom^2'), symmetry=1, barrier=(0.21862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140962,'amu*angstrom^2'), symmetry=1, barrier=(8.89462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140951,'amu*angstrom^2'), symmetry=1, barrier=(8.89459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140958,'amu*angstrom^2'), symmetry=1, barrier=(8.8946,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH2][C](O)C([CH2])[CH]C(4471)',
    structure = SMILES('[CH2][C](O)C([CH2])[CH]C'),
    E0 = (421.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,202.936,1767.63],'cm^-1')),
        HinderedRotor(inertia=(0.118935,'amu*angstrom^2'), symmetry=1, barrier=(3.34071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118935,'amu*angstrom^2'), symmetry=1, barrier=(3.34071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118935,'amu*angstrom^2'), symmetry=1, barrier=(3.34071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118935,'amu*angstrom^2'), symmetry=1, barrier=(3.34071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118935,'amu*angstrom^2'), symmetry=1, barrier=(3.34071,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266054,0.0867124,-0.000110327,8.41162e-08,-2.63692e-11,50783.9,33.9727], Tmin=(100,'K'), Tmax=(826.058,'K')), NASAPolynomial(coeffs=[9.44478,0.0386278,-1.64052e-05,2.98437e-09,-2.01398e-13,49391.6,-7.8039], Tmin=(826.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]CC([CH2])[C]([CH2])O(4472)',
    structure = SMILES('[CH2]CC([CH2])[C]([CH2])O'),
    E0 = (431.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,1380,1390,370,380,2900,435,226.88,985.711],'cm^-1')),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115619,0.0885949,-0.000108947,7.72279e-08,-2.22793e-11,52078.1,33.7448], Tmin=(100,'K'), Tmax=(844.273,'K')), NASAPolynomial(coeffs=[11.3471,0.0353815,-1.44019e-05,2.57056e-09,-1.71926e-13,50181.7,-18.5389], Tmin=(844.273,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Isobutyl) + radical(RCCJ) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C=C([CH2])OCC(4473)',
    structure = SMILES('[CH2]C=C([CH2])OCC'),
    E0 = (47.0917,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(=C)CC(4445)', 'H(8)'],
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH2](6)', 'C=CC(=C)[O](4214)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C(=C)[O](899)'],
    products = ['[CH2]C(O)=C([CH2])CC(4448)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(O)C([CH2])CC(4449)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH]C)C(=C)O(4450)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC([CH2])C(=C)O(4453)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH2](6)', '[CH2]C=C([CH2])[O](4312)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C([O])=C([CH2])CC(4454)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH3](11)', '[CH2]C([CH2])C(=C)[O](4352)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([CH]C)C(=C)[O](4455)', 'H(8)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]CC([CH2])C(=C)[O](4456)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=C([O])C([CH2])CC(4457)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C](CC)C([CH2])[O](912)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([O])C([CH2])[CH]C(913)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([CH]C)[C](C)[O](4460)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC([CH2])C([CH2])[O](915)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]CC([CH2])[C](C)[O](4461)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(28)', '[CH2]C([O])=CCC(4357)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O(T)(63)', '[CH2]C([C]=C)CC(4464)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH]C(CC)C(=C)[O](4465)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(CC)C(=C)[O](899)'],
    products = ['[CH2]C([CH]C)C(C)=O(4467)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]CC([CH2])C(C)=O(4468)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2][C](O)C([CH2])[CH]C(4471)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CC([CH2])[C]([CH2])O(4472)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C=C([CH2])OCC(4473)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
...
reaction(
    label = 'reaction47',
    reactants = ['CH2(T)(28)', '[CH2]C([C]=O)CC(3141)'],
    products = ['[CH2]C(CC)C(=C)[O](899)'],
