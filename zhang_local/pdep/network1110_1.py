...
species(
    label = '[CH]C([O])O[C]=O(3210)',
    structure = SMILES('[CH]C([O])O[C]=O'),
    E0 = (262.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,1855,455,950,180,180,1270.66,1271.18,1273.06,1274.03],'cm^-1')),
        HinderedRotor(inertia=(0.218374,'amu*angstrom^2'), symmetry=1, barrier=(5.02086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.30434,'amu*angstrom^2'), symmetry=1, barrier=(52.9813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0461075,'amu*angstrom^2'), symmetry=1, barrier=(52.9821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06914,0.04756,-7.35714e-05,6.81592e-08,-2.56952e-11,31638.4,22.106], Tmin=(100,'K'), Tmax=(768.748,'K')), NASAPolynomial(coeffs=[5.15005,0.0239449,-1.26945e-05,2.53254e-09,-1.79599e-13,31388.8,9.5102], Tmin=(768.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCOJ) + radical(CCJ2_triplet) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=O)O[C]=O(3204)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', 'O=[C]OC=O(3175)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', 'C=CO[C]=O(3002)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][C]([O])O[C]=O(3207)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])[O](696)', '[C-]#[O+](374)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[C]=O(1149)', '[CH2]C([O])[O](696)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(28)', '[O][CH]O[C]=O(3178)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C([O])O[C]=O(3210)'],
    products = ['[CH2]C([O])O[C]=O(3013)'],
