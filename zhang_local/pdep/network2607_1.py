...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.236033,0.0844992,-8.51452e-05,4.74059e-08,-1.08804e-11,50751.5,26.0044], Tmin=(100,'K'), Tmax=(1041.24,'K')), NASAPolynomial(coeffs=[12.7851,0.0362911,-1.56972e-05,2.94107e-09,-2.04437e-13,48138.2,-35.0448], Tmin=(1041.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C](C)C([CH2])([CH2])O(10313)',
    structure = SMILES('[CH2][C](C)C([CH2])([CH2])O'),
    E0 = (397.023,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.183447,0.0927925,-0.000109237,7.04535e-08,-1.8188e-11,47900.8,29.9198], Tmin=(100,'K'), Tmax=(946.247,'K')), NASAPolynomial(coeffs=[14.284,0.0316358,-1.22917e-05,2.15276e-09,-1.43063e-13,45162.8,-39.0782], Tmin=(946.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CJC(C)2O) + radical(Isobutyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2][C](C)C([CH2])(C)[O](10314)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301805,0.0788008,-7.25088e-05,3.69286e-08,-7.71144e-12,49918.7,29.0902], Tmin=(100,'K'), Tmax=(1145.16,'K')), NASAPolynomial(coeffs=[13.2938,0.03342,-1.3066e-05,2.32329e-09,-1.56724e-13,46943.1,-35.3497], Tmin=(1145.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C([CH2])([CH2])O(10315)',
    structure = SMILES('[CH2]C([CH2])C([CH2])([CH2])O'),
    E0 = (449.531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3014.29,3028.57,3042.86,3057.14,3071.43,3085.71,3100,415,431.667,448.333,465,780,803.333,826.667,850,1435,1448.33,1461.67,1475,900,966.667,1033.33,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.207703,0.0977253,-0.000117089,6.3909e-08,-7.72751e-12,54213.1,30.9399], Tmin=(100,'K'), Tmax=(686.666,'K')), NASAPolynomial(coeffs=[14.848,0.0294803,-1.05167e-05,1.70851e-09,-1.06601e-13,51686.7,-39.3761], Tmin=(686.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(Isobutyl) + radical(CJC(C)2O) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C([CH2])(C)[O](10316)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0172107,0.0878928,-9.89685e-05,6.25288e-08,-1.58852e-11,56243.7,31.1294], Tmin=(100,'K'), Tmax=(960.763,'K')), NASAPolynomial(coeffs=[13.4081,0.0319978,-1.17008e-05,1.97348e-09,-1.27948e-13,53664.1,-33.1023], Tmin=(960.763,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(466.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(Isobutyl) + radical(CC(C)2OJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211722,0.0826691,-8.4359e-05,4.72227e-08,-1.07323e-11,18643,29.2881], Tmin=(100,'K'), Tmax=(1061.56,'K')), NASAPolynomial(coeffs=[13.6402,0.0320701,-1.28622e-05,2.32236e-09,-1.58158e-13,15791.9,-36.2989], Tmin=(1061.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C(C)([O])C(=C)C(10319)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749943,0.0700571,-5.44727e-05,2.304e-08,-4.0951e-12,20507.3,28.3833], Tmin=(100,'K'), Tmax=(1298.71,'K')), NASAPolynomial(coeffs=[11.8649,0.0358235,-1.49333e-05,2.74341e-09,-1.88051e-13,17620.3,-28.1451], Tmin=(1298.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])[CH]C(10275)',
    structure = SMILES('[CH2]C([CH2])([O])[CH]C'),
    E0 = (497.659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.720794,0.074497,-8.68754e-05,5.5434e-08,-1.4317e-11,59970.6,25.2951], Tmin=(100,'K'), Tmax=(939.365,'K')), NASAPolynomial(coeffs=[11.7489,0.0275365,-1.1887e-05,2.21421e-09,-1.5301e-13,57898.8,-27.2192], Tmin=(939.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(497.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C([CH2])C(10322)',
    structure = SMILES('[CH]C([CH2])([O])C([CH2])C'),
    E0 = (709.564,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0206175,0.0879464,-0.000101213,6.33353e-08,-1.58733e-11,85483.8,30.9124], Tmin=(100,'K'), Tmax=(973.088,'K')), NASAPolynomial(coeffs=[14.1293,0.0299532,-1.18209e-05,2.09539e-09,-1.40584e-13,82737.9,-36.7698], Tmin=(973.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(709.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C(C)C([CH2])([CH2])[O](10323)',
    structure = SMILES('[CH]C(C)C([CH2])([CH2])[O]'),
    E0 = (716.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,180,180,860.898,1359.2,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.157376,'amu*angstrom^2'), symmetry=1, barrier=(3.61839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157376,'amu*angstrom^2'), symmetry=1, barrier=(3.61839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157376,'amu*angstrom^2'), symmetry=1, barrier=(3.61839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157376,'amu*angstrom^2'), symmetry=1, barrier=(3.61839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157376,'amu*angstrom^2'), symmetry=1, barrier=(3.61839,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.153653,0.0949273,-0.000118328,7.9591e-08,-2.14895e-11,86321.2,28.9084], Tmin=(100,'K'), Tmax=(902.982,'K')), NASAPolynomial(coeffs=[14.0127,0.0321734,-1.40836e-05,2.62736e-09,-1.81259e-13,83762.8,-37.9903], Tmin=(902.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(716.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CCJ2_triplet) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C(=C)C(10311)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C(=C)[O](782)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)C([CH2])C(6155)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', '[CH2]C([CH2])([O])C=C(10039)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(106.032,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 105.2 to 106.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C([CH2])([O])[C](C)C(10312)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2][C](C)C([CH2])([CH2])O(10313)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2][C](C)C([CH2])(C)[O](10314)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])C([CH2])([CH2])O(10315)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C([CH2])C([CH2])(C)[O](10316)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH2][CH]C([CH2])([CH2])[O](10278)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C](C)C([CH2])([CH2])[O](10317)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C([CH2])C([CH2])([CH2])[O](9932)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C([CH2])(O)C(=C)C(10318)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C(C)([O])C(=C)C(10319)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]CC([CH2])([CH2])[O](9368)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C([CH2])([O])[CH]CC(10320)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
    products = ['[CH2]C(C)C1([O])CC1(10321)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])[CH]C(10275)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C([CH2])C(6159)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C]([O])C([CH2])C(792)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([CH2])([O])C([CH2])C(10322)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C(C)C([CH2])([CH2])[O](10323)'],
    products = ['[CH2]C(C)C([CH2])([CH2])[O](9397)'],
