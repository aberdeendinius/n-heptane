species(
    ...
    E0 = (-219.023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2827.61,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0249357,'amu*angstrom^2'), symmetry=1, barrier=(4.12319,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (32.0419,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.89495,-0.000771179,2.64749e-05,-2.91785e-08,1.00831e-11,-26335.9,6.36481], Tmin=(100,'K'), Tmax=(952.15,'K')), NASAPolynomial(coeffs=[3.13813,0.0103541,-3.56953e-06,6.22275e-10,-4.27796e-14,-26551.9,8.08751], Tmin=(952.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-219.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-OsHHH)"""),
)
