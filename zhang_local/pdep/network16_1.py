...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CC(4)', '[CH2]C[CH2](21)'],
    products = ['[CH2]CCCCC(10)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH2](6)', '[CH2]CC[CH2](24)'],
    products = ['[CH2]CCCCC(10)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.746e+15,'cm^3/(mol*s)'), n=-0.699, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(200,'K'), Tmax=(2000,'K'), comment="""From training reaction 11 used for C_rad/H2/Cs;C_rad/H2/Cs
Exact match found for rate rule [C_rad/H2/Cs;C_rad/H2/Cs]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH2](22)', '[CH2]CCC(3)'],
    products = ['[CH2]CCCCC(10)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH3](11)', '[CH2]CCC[CH2](27)'],
    products = ['[CH2]CCCCC(10)'],
