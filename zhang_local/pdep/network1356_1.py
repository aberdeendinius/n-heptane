...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7141,0.0399019,-8.79518e-06,-1.81109e-08,9.49165e-12,36576.2,23.0113], Tmin=(100,'K'), Tmax=(1044.65,'K')), NASAPolynomial(coeffs=[13.6994,0.0164272,-7.27709e-06,1.46234e-09,-1.08514e-13,32848.9,-41.1892], Tmin=(1044.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_P) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]1O[CH]CO1(4638)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.172311,0.0577341,-6.64779e-05,3.65842e-08,-7.00628e-12,27278.5,23.8161], Tmin=(100,'K'), Tmax=(1655.47,'K')), NASAPolynomial(coeffs=[12.4509,0.00318932,5.48518e-06,-1.47299e-09,1.1172e-13,26622,-31.3145], Tmin=(1655.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(1,3-Dioxolane) + radical(CJCO) + radical(CCsJOCs) + radical(Cs_P)"""),
)
...
species(
    label = '[CH][C](O)OC=C(4642)',
    structure = SMILES('[CH][C](O)OC=C'),
    E0 = (267.724,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2950,3100,1380,975,1025,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.890742,0.0559874,-3.29674e-05,-1.28409e-08,1.32648e-11,32323.1,24.6952], Tmin=(100,'K'), Tmax=(930.467,'K')), NASAPolynomial(coeffs=[20.4691,0.00354421,4.36245e-07,-1.33159e-10,5.74398e-15,27306.5,-75.7275], Tmin=(930.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cs_P)"""),
)

species(
    label = '[CH]C(=O)OC[CH2](4643)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98976,0.0444155,-3.32827e-05,1.29902e-08,-2.13025e-12,23683.4,22.6883], Tmin=(100,'K'), Tmax=(1381.84,'K')), NASAPolynomial(coeffs=[9.25796,0.0233762,-1.04443e-05,1.97171e-09,-1.36799e-13,21674.7,-14.7272], Tmin=(1381.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(CJCO)"""),
)

species(
    label = '[CH]C(=O)O[CH]C(4591)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71685,0.0492694,-4.25577e-05,1.91731e-08,-3.54465e-12,21570.1,22.5108], Tmin=(100,'K'), Tmax=(1271.42,'K')), NASAPolynomial(coeffs=[10.6557,0.0211472,-9.38016e-06,1.77678e-09,-1.24045e-13,19297.1,-22.7609], Tmin=(1271.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(CCsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40392,0.026429,2.17767e-05,-5.02007e-08,2.32987e-11,25637.3,18.0959], Tmin=(100,'K'), Tmax=(878.142,'K')), NASAPolynomial(coeffs=[9.71477,0.0172473,-3.73974e-06,4.49167e-10,-2.55304e-14,23423.4,-21.5199], Tmin=(878.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Tetrahydrofuran) + radical(Cs_P) + radical(CCsJOCs) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C1OC(=C)O1(4646)',
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82041,0.0473794,-3.90288e-05,1.65016e-08,-2.87159e-12,25226.4,21.7195], Tmin=(100,'K'), Tmax=(1335.67,'K')), NASAPolynomial(coeffs=[10.5467,0.0212465,-9.68112e-06,1.85357e-09,-1.2992e-13,22895.3,-22.9058], Tmin=(1335.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CH2_triplet) + radical(CJCO)"""),
)
...
species(
    label = '[CH]=CO[C]([CH2])O(4649)',
    structure = SMILES('[CH]=CO[C]([CH2])O'),
    E0 = (278.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,360,370,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3000,3100,440,815,1455,1000,324.894,326.076],'cm^-1')),
        HinderedRotor(inertia=(0.244409,'amu*angstrom^2'), symmetry=1, barrier=(18.3273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244706,'amu*angstrom^2'), symmetry=1, barrier=(18.3267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247529,'amu*angstrom^2'), symmetry=1, barrier=(18.3269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24605,'amu*angstrom^2'), symmetry=1, barrier=(18.3307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0182472,0.0697742,-7.78291e-05,3.97375e-08,-7.46168e-12,33617.6,28.5595], Tmin=(100,'K'), Tmax=(1510.32,'K')), NASAPolynomial(coeffs=[21.4036,0.00148351,1.56804e-06,-4.17512e-10,3.06803e-14,28486.9,-79.0304], Tmin=(1510.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P) + radical(Cs_P)"""),
)

species(
    label = '[CH][CH]OC(C)=O(4650)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OC([CH2])=O(1060)'],
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(9.1388e+07,'s^-1'), n=1.18372, Ea=(124.429,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]OC([CH2])=O(1060)'],
    products = ['[CH2][C]1OC([CH2])O1(4637)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH]OC([CH2])=O(1060)'],
    products = ['[CH2][C]1O[CH]CO1(4638)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.19156e+09,'s^-1'), n=0.64013, Ea=(71.8519,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_linear;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_linear;carbonyl_intra;radadd_intra_cs2H]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction11',
    reactants = ['C=C([O])[O](1172)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC([CH2])=O(1060)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C]OC([CH2])=O(4639)'],
    products = ['[CH2][CH]OC([CH2])=O(1060)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]C(=O)O[CH][CH2](4640)'],
    products = ['[CH2][CH]OC([CH2])=O(1060)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH][CH]OC([CH2])=O(4641)'],
    products = ['[CH2][CH]OC([CH2])=O(1060)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(T)(63)', '[CH2][CH]O[C]=C(4303)'],
    products = ['[CH2][CH]OC([CH2])=O(1060)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C][O](2305)', 'C=C[O](594)'],
    products = ['[CH2][CH]OC([CH2])=O(1060)'],
