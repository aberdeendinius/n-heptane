...
species(
    label = '[CH2]O[CH]C[O](1024)',
    structure = SMILES('[CH2]O[CH]C[O]'),
    E0 = (198.28,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,1509.12,1509.14],'cm^-1')),
        HinderedRotor(inertia=(0.138103,'amu*angstrom^2'), symmetry=1, barrier=(3.17526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138361,'amu*angstrom^2'), symmetry=1, barrier=(3.1812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138789,'amu*angstrom^2'), symmetry=1, barrier=(3.19104,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89691,0.0518032,-7.92944e-05,7.05751e-08,-2.45621e-11,23918,21.4037], Tmin=(100,'K'), Tmax=(863.253,'K')), NASAPolynomial(coeffs=[5.30171,0.0242576,-1.09808e-05,2.02537e-09,-1.36298e-13,23768.7,8.01808], Tmin=(863.253,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCOJ) + radical(CCsJOCs)"""),
)

species(
    label = 'CO[CH][CH][O](1025)',
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61202,0.0632608,-0.000117059,1.14268e-07,-4.14738e-11,23024.5,20.2851], Tmin=(100,'K'), Tmax=(877.206,'K')), NASAPolynomial(coeffs=[3.63068,0.0284796,-1.38496e-05,2.59187e-09,-1.7398e-13,23654.3,16.4196], Tmin=(877.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCsJOCs) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]O[CH][CH][O](1027)',
    structure = SMILES('[CH2]O[CH][CH][O]'),
    E0 = (378.578,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,180,180,1357.7,1364.12],'cm^-1')),
        HinderedRotor(inertia=(0.146457,'amu*angstrom^2'), symmetry=1, barrier=(3.36733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14589,'amu*angstrom^2'), symmetry=1, barrier=(3.35429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148162,'amu*angstrom^2'), symmetry=1, barrier=(3.40653,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64545,0.0603268,-0.000109698,1.01713e-07,-3.51852e-11,45609.1,21.8555], Tmin=(100,'K'), Tmax=(893.904,'K')), NASAPolynomial(coeffs=[5.8417,0.0211958,-9.88091e-06,1.79778e-09,-1.17978e-13,45672.1,6.63021], Tmin=(893.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CCsJOH) + radical(CCsJOCs) + radical(CsJOCC)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75861,0.0291862,3.84169e-05,-8.92823e-08,4.18462e-11,-25793.8,16.1693], Tmin=(100,'K'), Tmax=(910.426,'K')), NASAPolynomial(coeffs=[21.325,-0.0037639,5.35706e-06,-1.11286e-09,7.17244e-14,-31553.7,-88.458], Tmin=(910.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC=C[O](1023)', 'H(8)'],
    products = ['[CH2]OC[CH][O](681)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(9.59892,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2]O[CH][CH][O](1027)'],
    products = ['[CH2]OC[CH][O](681)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[CH2](420)', '[CH][O](751)'],
    products = ['[CH2]OC[CH][O](681)'],
