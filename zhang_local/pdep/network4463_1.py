...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05259,0.0577913,-3.29904e-05,9.28509e-09,-1.06935e-12,102946,27.2468], Tmin=(100,'K'), Tmax=(1928.68,'K')), NASAPolynomial(coeffs=[14.0543,0.0308261,-1.20185e-05,2.03588e-09,-1.29681e-13,97931,-44.0188], Tmin=(1928.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(855.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet) + radical(RCCJ)"""),
)

species(
    label = '[CH]C([CH])=C[CH]C(21293)',
    structure = SMILES('[CH]C([CH])=C[CH]C'),
    E0 = (790.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28582,0.0512246,-1.25507e-05,-1.13444e-08,5.72899e-12,95225.5,23.4998], Tmin=(100,'K'), Tmax=(1122.41,'K')), NASAPolynomial(coeffs=[9.47712,0.0377017,-1.54186e-05,2.79642e-09,-1.9091e-13,92399.7,-21.3611], Tmin=(1122.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(790.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27876,0.0523873,-2.40678e-05,1.6745e-09,1.22267e-12,119910,26.0109], Tmin=(100,'K'), Tmax=(1259.7,'K')), NASAPolynomial(coeffs=[10.1545,0.0340271,-1.39024e-05,2.48526e-09,-1.66813e-13,116895,-21.9519], Tmin=(1259.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(996.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(Allyl_S) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25194,0.0601556,-5.21958e-05,2.50111e-08,-5.0266e-12,143450,25.4553], Tmin=(100,'K'), Tmax=(1166.35,'K')), NASAPolynomial(coeffs=[10.2631,0.0292525,-1.24531e-05,2.29531e-09,-1.57682e-13,141348,-19.4049], Tmin=(1166.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1191.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(RCCJ) + radical(Cds_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC([CH])=[CH](21451)',
    structure = SMILES('[CH][CH]CC([CH])=[CH]'),
    E0 = (1181.08,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46654,0.0588846,-5.81277e-05,3.69283e-08,-1.03741e-11,142140,26.7416], Tmin=(100,'K'), Tmax=(837.067,'K')), NASAPolynomial(coeffs=[6.46198,0.0350118,-1.53455e-05,2.85295e-09,-1.9637e-13,141304,3.53023], Tmin=(837.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1181.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(RCCJC) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]C(=[CH])C[CH][CH2](21452)',
    structure = SMILES('[C]C(=[CH])C[CH][CH2]'),
    E0 = (1236.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,3025,407.5,1350,352.5,180,762.485],'cm^-1')),
        HinderedRotor(inertia=(0.1679,'amu*angstrom^2'), symmetry=1, barrier=(3.86036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166689,'amu*angstrom^2'), symmetry=1, barrier=(3.8325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00917424,'amu*angstrom^2'), symmetry=1, barrier=(3.88297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4535,0.0593878,-7.19967e-05,5.18545e-08,-1.55436e-11,148854,25.6053], Tmin=(100,'K'), Tmax=(805.798,'K')), NASAPolynomial(coeffs=[7.94251,0.0271777,-1.20402e-05,2.25261e-09,-1.55273e-13,147809,-4.29965], Tmin=(805.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1236.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJ3) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])C[CH][CH2](19224)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C(=[CH])C=C[CH2](19933)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC[CH][CH2](6430)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C[CH][CH2](19224)'],
    products = ['[CH]C([CH2])=C[CH][CH2](19223)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C([CH])=C[CH][CH2](21449)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C(=[CH])C([CH2])[CH2](19200)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH][CH2](721)', '[CH]C([CH])=C(19930)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C(=[CH])C[C][CH2](21450)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH][CH]CC([CH])=[CH](21451)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[C]C(=[CH])C[CH][CH2](21452)'],
    products = ['[CH]C(=[CH])C[CH][CH2](19224)'],
