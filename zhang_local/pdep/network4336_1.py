...
species(
    label = '[CH]=C=C[CH][CH]C(21296)',
    structure = SMILES('[CH]=C=C[CH][CH]C'),
    E0 = (590.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,540,610,2055,3010,987.5,1337.5,450,1655,3000,3050,390,425,1340,1360,335,370,2320.13],'cm^-1')),
        HinderedRotor(inertia=(0.00635854,'amu*angstrom^2'), symmetry=1, barrier=(11.4129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.07838,'amu*angstrom^2'), symmetry=1, barrier=(70.778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.07424,'amu*angstrom^2'), symmetry=1, barrier=(70.6829,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82406,0.0460903,-3.05443e-05,1.14605e-08,-1.86766e-12,71077.8,23.2455], Tmin=(100,'K'), Tmax=(1371.4,'K')), NASAPolynomial(coeffs=[7.98035,0.0281341,-1.09042e-05,1.91299e-09,-1.27192e-13,69389.3,-8.39942], Tmin=(1371.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(590.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(Allyl_S) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]=C=[C]C[CH]C(21297)',
    structure = SMILES('[CH]=C=[C]C[CH]C'),
    E0 = (687.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,540,610,2055,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.134683,'amu*angstrom^2'), symmetry=1, barrier=(3.09663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132341,'amu*angstrom^2'), symmetry=1, barrier=(3.04278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326401,'amu*angstrom^2'), symmetry=1, barrier=(7.50461,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61336,0.0556388,-6.32953e-05,4.81633e-08,-1.55674e-11,82714.9,25.5859], Tmin=(100,'K'), Tmax=(843.839,'K')), NASAPolynomial(coeffs=[5.68931,0.0318897,-1.3208e-05,2.3737e-09,-1.59125e-13,82184.7,7.54807], Tmin=(843.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(687.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S) + radical(RCCJC) + radical(C=C=CJ)"""),
)
...
species(
    label = '[CH][C]=[C]CCC(21299)',
    structure = SMILES('[CH][C]=[C]CCC'),
    E0 = (770.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68046,0.0551284,-3.63295e-05,1.39862e-08,-2.55401e-12,92694.4,24.5148], Tmin=(100,'K'), Tmax=(1138.99,'K')), NASAPolynomial(coeffs=[5.57802,0.0414404,-1.83029e-05,3.43491e-09,-2.38045e-13,91806.6,5.20408], Tmin=(1138.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(770.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH][CH]C(21300)',
    structure = SMILES('[CH]C=C[CH][CH]C'),
    E0 = (629.916,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61483,0.0468719,-1.68364e-05,-7.93596e-10,1.19856e-12,75851.7,25.4492], Tmin=(100,'K'), Tmax=(1432.99,'K')), NASAPolynomial(coeffs=[9.10973,0.0352012,-1.43029e-05,2.53256e-09,-1.67634e-13,72754,-16.7197], Tmin=(1432.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(629.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(RCCJC) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49351,0.0556601,-3.86696e-05,1.45763e-08,-2.38139e-12,118006,24.6089], Tmin=(100,'K'), Tmax=(1354.3,'K')), NASAPolynomial(coeffs=[8.89351,0.033804,-1.44623e-05,2.66022e-09,-1.81731e-13,116002,-13.3362], Tmin=(1354.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(980.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    label = '[C][C]=CC[CH]C(21307)',
    structure = SMILES('[C][C]=CC[CH]C'),
    E0 = (1025.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,360.754,361.518,1974.77],'cm^-1')),
        HinderedRotor(inertia=(0.0978606,'amu*angstrom^2'), symmetry=1, barrier=(8.99235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0994501,'amu*angstrom^2'), symmetry=1, barrier=(8.99349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0977495,'amu*angstrom^2'), symmetry=1, barrier=(8.99553,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95217,0.0507857,-3.75798e-05,5.53101e-10,1.40581e-11,123400,23.2045], Tmin=(100,'K'), Tmax=(555.553,'K')), NASAPolynomial(coeffs=[5.63345,0.0333512,-1.49976e-05,2.84404e-09,-1.98283e-13,122851,6.34844], Tmin=(555.553,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1025.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(CJ3) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=C=C[CH][CH]C(21296)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH]=C=[C]C[CH]C(21297)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH][C]=C[CH][CH]C(21301)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][C]=[C]C[CH]C(21302)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(32)', '[CH][C]=C[CH2](21221)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH][C]=CC[CH](21268)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH][C]=CC[C]C(21305)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(32)', '[CH]=C=C[CH2](5317)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]C[CH][CH]C(18873)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[C][C]=CC[CH]C(21307)'],
    products = ['[CH][C]=CC[CH]C(18874)'],
