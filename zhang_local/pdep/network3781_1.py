...
species(
    ...
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86161,0.0421255,-2.62288e-05,3.06719e-09,2.46316e-12,49828.8,17.3639], Tmin=(100,'K'), Tmax=(963.094,'K')), NASAPolynomial(coeffs=[10.1781,0.0184852,-6.3863e-06,1.08359e-09,-7.24216e-14,47721.3,-25.0699], Tmin=(963.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CC(=[CH])C(17772)',
    structure = SMILES('[CH]=CC(=[CH])C'),
    E0 = (550.523,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655],'cm^-1')),
...
species(
    ...
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.76862,0.00862715,7.87005e-05,-1.09156e-07,4.24977e-11,50750.4,13.6509], Tmin=(100,'K'), Tmax=(950.514,'K')), NASAPolynomial(coeffs=[12.5863,0.0141902,-4.05695e-06,7.74187e-10,-6.26646e-14,46766.4,-44.3553], Tmin=(950.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Allyl_P) + radical(cyclobutene-allyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=CC([CH2])=C(6418)'],
    products = ['[CH2]C1([CH2])C=C1(17768)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CC([CH2])=C(17769)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=C=C([CH2])[CH2](17774)'],
    products = ['[CH]=CC([CH2])=C(6418)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C(=C)C=[CH](17775)'],
    products = ['[CH]=CC([CH2])=C(6418)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(28)', '[CH]C=C=C(5316)'],
    products = ['[CH]=CC([CH2])=C(6418)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[C]=CC([CH2])=C(17777)'],
    products = ['[CH]=CC([CH2])=C(6418)'],
