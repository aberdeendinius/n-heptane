...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26916,0.0730417,-0.000142415,1.42337e-07,-5.29148e-11,24763.4,25.611], Tmin=(100,'K'), Tmax=(855.139,'K')), NASAPolynomial(coeffs=[3.69678,0.0315773,-1.68676e-05,3.2858e-09,-2.26069e-13,25449.1,20.7159], Tmin=(855.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCO) + radical(Cs_P) + radical(OCOJ) + radical(OCJO)"""),
)

species(
    label = 'C[C]([O])O[CH][O](2596)',
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77362,0.0652593,-0.000135702,1.49625e-07,-5.96785e-11,26439.7,24.0251], Tmin=(100,'K'), Tmax=(848.698,'K')), NASAPolynomial(coeffs=[-1.88874,0.0419121,-2.26662e-05,4.45597e-09,-3.08912e-13,28523.8,49.709], Tmin=(848.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCOJ) + radical(Cs_P) + radical(OCOJ) + radical(OCJO)"""),
)
...
species(
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99458,0.0490112,-6.28067e-05,4.77172e-08,-1.5518e-11,57624.2,24.4658], Tmin=(100,'K'), Tmax=(734.8,'K')), NASAPolynomial(coeffs=[6.46193,0.0246923,-1.31625e-05,2.67584e-09,-1.93532e-13,56967.7,4.29016], Tmin=(734.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(Cs_P) + radical(CCOJ) + radical(CCJ2_triplet) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=O)O[CH][O](2592)'],
    products = ['[CH2][C]([O])OC[O](2112)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(9.6e+09,'cm^3/(mol*s)'), n=0.935, Ea=(20.0703,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [CO-NdH_O;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 17.4 to 20.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2][C]([O])OC[O](2112)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(97.2805,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][C]([O])O[CH][O](2597)'],
    products = ['[CH2][C]([O])OC[O](2112)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C][O](2305)', '[O]C[O](558)'],
    products = ['[CH2][C]([O])OC[O](2112)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH][C]([O])OC[O](2599)'],
    products = ['[CH2][C]([O])OC[O](2112)'],
