...
species(
    label = 'C=C([O])C=C1CO1(9834)',
    structure = SMILES('C=C([O])C=C1CO1'),
    E0 = (-0.0312287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,350,440,435,1725,367.042,367.146,367.37,368.438,368.489,368.729,368.8,369.291,369.612,2918.51],'cm^-1')),
        HinderedRotor(inertia=(0.00124415,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.986774,0.0495432,-1.65997e-06,-5.16412e-08,2.8976e-11,120.398,19.6685], Tmin=(100,'K'), Tmax=(908.866,'K')), NASAPolynomial(coeffs=[21.9319,0.00212905,2.70857e-06,-6.50547e-10,4.27335e-14,-5535.84,-89.5501], Tmin=(908.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.0312287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C=C([O])CC1=CO1(9835)',
    structure = SMILES('C=C([O])CC1=CO1'),
    E0 = (119.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2950,1000,180,180,180,423.152,713.749,1600,1828.57,2971.43,3200],'cm^-1')),
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.325148,0.0707887,-6.8237e-05,3.33759e-08,-6.02526e-12,2215.85,26.0125], Tmin=(100,'K'), Tmax=(1650.29,'K')), NASAPolynomial(coeffs=[16.1945,0.0135463,-5.72349e-07,-2.74805e-10,2.92688e-14,-894.188,-54.8638], Tmin=(1650.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.9542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ) + radical(C=CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328427,0.076787,-8.22105e-05,4.37833e-08,-8.60534e-12,7298.31,25.6193], Tmin=(100,'K'), Tmax=(1489.78,'K')), NASAPolynomial(coeffs=[18.1148,0.0110555,2.95256e-07,-4.42087e-10,4.18929e-14,3602.15,-64.6724], Tmin=(1489.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.2541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(C2CsJO)"""),
)

species(
    label = '[CH]=C(O)C[C]1CO1(9839)',
    structure = SMILES('[CH]=C(O)C[C]1CO1'),
    E0 = (189.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,350,440,435,1725,2750,3150,900,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0503876,0.0736863,-8.2207e-05,4.63314e-08,-9.67667e-12,22937.2,27.4575], Tmin=(100,'K'), Tmax=(1394.12,'K')), NASAPolynomial(coeffs=[16.4955,0.0119741,-1.76603e-07,-3.70325e-10,3.853e-14,19763.7,-52.2814], Tmin=(1394.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(C2CsJO)"""),
)

species(
    label = '[CH]=C([O])CC1CO1(9840)',
    structure = SMILES('[CH]=C([O])CC1CO1'),
    E0 = (147.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2950,3150,900,1000,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118,0.0670361,-6.63888e-05,3.40499e-08,-6.4826e-12,17851.6,27.6119], Tmin=(100,'K'), Tmax=(1553.15,'K')), NASAPolynomial(coeffs=[14.9061,0.0140802,-8.83347e-07,-2.31883e-10,2.7787e-14,15051.6,-44.469], Tmin=(1553.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(C=C(C)OJ)"""),
)

species(
    label = 'C=C(O)C[C]1[CH]O1(9841)',
    structure = SMILES('C=C(O)C[C]1[CH]O1'),
    E0 = (126.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.324674,0.0766131,-8.47496e-05,4.60938e-08,-9.1766e-12,15333.2,28.6057], Tmin=(100,'K'), Tmax=(1483.54,'K')), NASAPolynomial(coeffs=[18.1649,0.00907277,1.42404e-06,-6.67035e-10,5.76208e-14,11793.6,-61.3288], Tmin=(1483.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(CCsJO)"""),
)

species(
    label = 'C=C([O])[CH][C]1CO1(9842)',
    structure = SMILES('C=C([O])[CH][C]1CO1'),
    E0 = (197.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397435,0.0686444,-7.54614e-05,4.27817e-08,-9.08631e-12,23839.6,24.5106], Tmin=(100,'K'), Tmax=(1355.58,'K')), NASAPolynomial(coeffs=[14.9804,0.0136872,-1.45238e-06,-1.05636e-10,2.00213e-14,20981.7,-46.2388], Tmin=(1355.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ) + radical(C=CCJCO) + radical(C2CsJO)"""),
)

species(
    label = 'C=C([O])C[C]1[CH]O1(9843)',
    structure = SMILES('C=C([O])C[C]1[CH]O1'),
    E0 = (263.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.395265,0.0685309,-7.81711e-05,4.52649e-08,-9.71365e-12,31874.7,27.5189], Tmin=(100,'K'), Tmax=(1358.52,'K')), NASAPolynomial(coeffs=[15.1163,0.0115755,-2.55699e-07,-3.45545e-10,3.69253e-14,29130.9,-43.3893], Tmin=(1358.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.865,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ) + radical(CCsJO) + radical(C2CsJO)"""),
)

species(
    label = '[CH]=C([O])C[C]1CO1(9844)',
    structure = SMILES('[CH]=C([O])C[C]1CO1'),
    E0 = (327.238,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.709023,0.0662629,-7.76529e-05,4.77614e-08,-1.1031e-11,39481.6,26.5953], Tmin=(100,'K'), Tmax=(1249.06,'K')), NASAPolynomial(coeffs=[13.1462,0.0148651,-2.03595e-06,-1.33166e-11,1.52862e-14,37277.1,-32.5602], Tmin=(1249.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ) + radical(Cds_P) + radical(C2CsJO)"""),
)
...
species(
    label = '[O][C]1CC2(CO2)C1(9846)',
    structure = SMILES('[O][C]1CC2(CO2)C1'),
    E0 = (234.525,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49758,0.0530859,-3.9046e-05,1.51865e-08,-2.46568e-12,28298.3,19.5901], Tmin=(100,'K'), Tmax=(1410.63,'K')), NASAPolynomial(coeffs=[10.7002,0.0269907,-1.12977e-05,2.07259e-09,-1.41558e-13,25702,-27.9735], Tmin=(1410.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.623275,0.053475,6.07021e-06,-6.91462e-08,3.72617e-11,-16436.8,19.4725], Tmin=(100,'K'), Tmax=(909.092,'K')), NASAPolynomial(coeffs=[25.6666,-0.00122381,4.76176e-06,-1.04168e-09,6.81184e-14,-23283.2,-111.572], Tmin=(909.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(methyleneoxirane)"""),
)

species(
    label = 'C=C(O)CC1=CO1(9849)',
    structure = SMILES('C=C(O)CC1=CO1'),
    E0 = (85.9362,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.597785,0.0693613,-7.27939e-05,3.83766e-08,-7.90336e-12,10462.9,25.561], Tmin=(100,'K'), Tmax=(1189.92,'K')), NASAPolynomial(coeffs=[16.289,0.0166146,-6.30231e-06,1.12408e-09,-7.67138e-14,6728.62,-52.8684], Tmin=(1189.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.9362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(oxirene)"""),
)

species(
    label = '[CH2]C([O])[CH][C]1CO1(9850)',
    structure = SMILES('[CH2]C([O])[CH][C]1CO1'),
    E0 = (498.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.653762,0.0684741,-7.69299e-05,4.67942e-08,-1.09285e-11,60080.1,29.6583], Tmin=(100,'K'), Tmax=(1197.65,'K')), NASAPolynomial(coeffs=[12.9343,0.0189675,-4.29064e-06,4.40166e-10,-1.68001e-14,57747.5,-29.261], Tmin=(1197.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(C2CsJO) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.679062,0.0620395,-6.09803e-05,3.25183e-08,-6.60221e-12,8254.68,26.7744], Tmin=(100,'K'), Tmax=(1413,'K')), NASAPolynomial(coeffs=[12.9318,0.0174008,-3.02731e-06,1.90432e-10,-4.92349e-16,5785.67,-33.0578], Tmin=(1413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.5606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(C=C(C)OJ)"""),
)

species(
    label = 'CC(=O)C[C]1[CH]O1(9852)',
    structure = SMILES('CC(=O)C[C]1[CH]O1'),
    E0 = (98.9462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928826,0.0678663,-8.29787e-05,5.76656e-08,-1.56819e-11,12010.7,24.9626], Tmin=(100,'K'), Tmax=(1027.85,'K')), NASAPolynomial(coeffs=[10.0518,0.024278,-7.56898e-06,1.10173e-09,-6.27749e-14,10562.4,-17.2238], Tmin=(1027.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.9462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49254,0.0436602,-4.96613e-06,-2.55824e-08,1.27887e-11,-17261.9,20.5238], Tmin=(100,'K'), Tmax=(1013,'K')), NASAPolynomial(coeffs=[14.0641,0.01984,-7.92815e-06,1.52882e-09,-1.11796e-13,-21133.7,-46.8282], Tmin=(1013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-CdsCsOs) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + ring(methyleneoxirane)"""),
)

species(
    label = 'CC(=O)CC1=CO1(9855)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29899,0.0464567,-6.61781e-06,-2.51917e-08,1.23124e-11,-4727.69,22.7659], Tmin=(100,'K'), Tmax=(1054.2,'K')), NASAPolynomial(coeffs=[15.7274,0.0199859,-9.18557e-06,1.87478e-09,-1.39973e-13,-9340.97,-55.0565], Tmin=(1054.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.2095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3751.66,'J/mol'), sigma=(6.30767,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=586.00 K, Pc=33.92 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06542,0.0470624,-3.29539e-05,1.49345e-08,-3.48637e-12,-13828,16.4458], Tmin=(100,'K'), Tmax=(887.953,'K')), NASAPolynomial(coeffs=[4.08295,0.0379741,-1.76014e-05,3.40819e-09,-2.41221e-13,-14186.3,6.95209], Tmin=(887.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsCs) + polycyclic(s1_3_4_ane)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.17159e+11,'s^-1'), n=-0.0562706, Ea=(188.352,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csNdNd]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C([O])C=C1CO1(9834)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=C([O])CC1=CO1(9835)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['C=C([O])CC1[CH]O1(9837)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(O)C[C]1CO1(9839)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=C(O)C[C]1[CH]O1(9841)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C=C([O])[CH][C]1CO1(9842)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', 'C=C([O])C[C]1[CH]O1(9843)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=C([O])C[C]1CO1(9844)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C[C]1CO1(9301)'],
    products = ['[O][C]1CC2(CO2)C1(9846)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2.02e+06,'s^-1'), n=1.58, Ea=(154.383,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_Cs_HH_D;doublebond_intra;radadd_intra_csNdNd]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction19',
    reactants = ['C=C([O])CC(=C)[O](9847)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(6.946e+12,'s^-1'), n=0.247, Ea=(231.216,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_D;doublebond_intra_secNd_2H;radadd_intra] for rate rule [R3_D;doublebond_intra_secNd_2H;radadd_intra_O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([O])[CH][C]1CO1(9850)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC(=O)C[C]1[CH]O1(9852)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(28)', 'O=[C]C[C]1CO1(4738)'],
    products = ['C=C([O])C[C]1CO1(9301)'],
