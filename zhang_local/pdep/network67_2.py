...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.453917,'amu*angstrom^2'), symmetry=1, barrier=(10.4364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107084,'amu*angstrom^2'), symmetry=1, barrier=(21.3308,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (42.0797,'amu'),
