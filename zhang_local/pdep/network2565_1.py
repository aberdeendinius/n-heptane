...
species(
    ...
    E0 = (162.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.13123,'amu*angstrom^2'), symmetry=1, barrier=(49.0011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12989,'amu*angstrom^2'), symmetry=1, barrier=(48.9704,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3279,0.0266934,1.24786e-05,-4.10014e-08,1.95447e-11,19583.7,14.3342], Tmin=(100,'K'), Tmax=(920.712,'K')), NASAPolynomial(coeffs=[12.2815,0.0095319,-2.05351e-06,2.87902e-10,-2.0622e-14,16645.3,-38.8671], Tmin=(920.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    ...
    products = ['[CH2][C]1CO1(9171)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.31909e+12,'s^-1'), n=0.400725, Ea=(200.246,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_D;doublebond_intra;radadd_intra] for rate rule [R3_D;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)[O](4273)'],
    products = ['[O][C]1CC1(9172)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2.03537e+13,'s^-1'), n=-0.296394, Ea=(188.304,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""From training reaction 135 used for R3_D;doublebond_intra;radadd_intra_cs2H
Exact match found for rate rule [R3_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 186.9 to 188.3 kJ/mol to match endothermicity of reaction."""),
)
