...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752945,0.0584142,-7.21598e-06,-4.40265e-08,2.58282e-11,24923.6,21.6171], Tmin=(100,'K'), Tmax=(885.485,'K')), NASAPolynomial(coeffs=[17.6226,0.0192042,-3.4643e-06,3.31706e-10,-1.6679e-14,20485.7,-65.9072], Tmin=(885.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.385427,0.0714535,-6.68198e-05,3.52363e-08,-7.38625e-12,28371.8,23.7595], Tmin=(100,'K'), Tmax=(1264.78,'K')), NASAPolynomial(coeffs=[13.3489,0.0258776,-7.33896e-06,1.02235e-09,-5.77902e-14,25458.7,-40.3796], Tmin=(1264.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=C(C)C[C]1CO1(18555)',
    structure = SMILES('[CH]=C(C)C[C]1CO1'),
    E0 = (364.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676882,0.0693062,-6.98185e-05,4.12464e-08,-9.76032e-12,44014.7,25.9167], Tmin=(100,'K'), Tmax=(1128.02,'K')), NASAPolynomial(coeffs=[11.099,0.0276769,-8.24856e-06,1.18643e-09,-6.81644e-14,41960.6,-24.3022], Tmin=(1128.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(C2CsJO)"""),
)
...
species(
    label = 'C=C(C)C[C]1[CH]O1(18557)',
    structure = SMILES('C=C(C)C[C]1[CH]O1'),
    E0 = (301.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378235,0.0713921,-6.96808e-05,3.78753e-08,-8.06474e-12,36407.2,26.7864], Tmin=(100,'K'), Tmax=(1279.46,'K')), NASAPolynomial(coeffs=[13.5886,0.0236081,-6.05855e-06,7.63859e-10,-3.94165e-14,33557.5,-38.1276], Tmin=(1279.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJO)"""),
)
...
species(
    label = '[CH2][C]1CC2(CO2)C1(18561)',
    structure = SMILES('[CH2][C]1CC2(CO2)C1'),
    E0 = (357.69,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89718,0.049723,-2.83856e-05,9.18829e-09,-1.41312e-12,43092.7,21.4438], Tmin=(100,'K'), Tmax=(1273.37,'K')), NASAPolynomial(coeffs=[5.06511,0.0397715,-1.6663e-05,3.05091e-09,-2.08157e-13,42285.9,5.39478], Tmin=(1273.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    E0 = (124.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,409.839,410.981,413.802],'cm^-1')),
        HinderedRotor(inertia=(0.000980093,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144581,'amu*angstrom^2'), symmetry=1, barrier=(17.5335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145944,'amu*angstrom^2'), symmetry=1, barrier=(17.518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
...
species(
    label = 'C=C(C)C=C1CO1(18562)',
    structure = SMILES('C=C(C)C=C1CO1'),
    E0 = (38.4663,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.84936,0.0504564,1.45115e-05,-6.69118e-08,3.2815e-11,4757.21,20.017], Tmin=(100,'K'), Tmax=(932.425,'K')), NASAPolynomial(coeffs=[20.8162,0.012839,-2.25272e-06,3.27809e-10,-2.7694e-14,-1054.57,-86.1127], Tmin=(932.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.4663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(methyleneoxirane)"""),
)

species(
    label = 'C=C(C)CC1=CO1(18563)',
    structure = SMILES('C=C(C)CC1=CO1'),
    E0 = (157.495,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.852589,0.0571651,-1.96685e-05,-1.89079e-08,1.22663e-11,19066.3,24.6862], Tmin=(100,'K'), Tmax=(983.476,'K')), NASAPolynomial(coeffs=[16.2036,0.022105,-7.94854e-06,1.45102e-09,-1.03688e-13,14722.9,-55.8488], Tmin=(983.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene)"""),
)
...
species(
    ...
    E0 = (370.958,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,3150,900,1100,2950,3100,1380,975,1025,1650,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.17159e+11,'s^-1'), n=-0.0562706, Ea=(112.48,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csNdNd]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)C=C1CO1(18551)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(=C)CC1=CO1(18552)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)C[C]1CO1(9936)'],
    products = ['[CH2]C(=C)[CH]C1CO1(18553)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)CC1[CH]O1(18265)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=C)C[C]1CO1(9936)'],
    products = ['C=C(C)[CH][C]1CO1(18554)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C)C[C]1CO1(18555)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=C(C)C[C]1[CH]O1(18557)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2]C(=C)[CH][C]1CO1(18558)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C(=C)C[C]1[CH]O1(18559)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C(=C)C[C]1CO1(18560)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=C)C[C]1CO1(9936)'],
    products = ['C1C[C]1C[C]1CO1(12420)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=C)C[C]1CO1(9936)'],
    products = ['[CH2][C]1CC2(CO2)C1(18561)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(4.04e+06,'s^-1'), n=1.58, Ea=(124.265,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_Cs_HH_D;doublebond_intra;radadd_intra_csNdNd]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(=C)CC(=C)[O](17510)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH2])[CH][C]1CO1(9943)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[C]1CO1(1125)', '[CH2]C([CH2])=C(17478)'],
    products = ['[CH2]C(=C)C[C]1CO1(9936)'],
