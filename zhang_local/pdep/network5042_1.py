...
species(
    ...
    E0 = (64.0403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.1467,'amu*angstrom^2'), symmetry=1, barrier=(26.3648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14785,'amu*angstrom^2'), symmetry=1, barrier=(26.3913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14669,'amu*angstrom^2'), symmetry=1, barrier=(26.3647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14536,'amu*angstrom^2'), symmetry=1, barrier=(26.3341,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CO[CH][C]=CO(28619)',
    structure = SMILES('[CH2]CO[CH][C]=CO'),
    E0 = (187.763,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.430062,0.0769202,-8.49705e-05,4.88693e-08,-1.11411e-11,22712.7,28.8059], Tmin=(100,'K'), Tmax=(1070.16,'K')), NASAPolynomial(coeffs=[14.8929,0.0228615,-9.19815e-06,1.66594e-09,-1.13885e-13,19617.2,-41.9494], Tmin=(1070.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO) + radical(C=CCJ(O)C) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]COC[C]=[C]O(28620)',
    structure = SMILES('[CH2]COC[C]=[C]O'),
    E0 = (316.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481392,0.0803513,-0.000104215,7.31971e-08,-2.05404e-11,38198.4,30.8195], Tmin=(100,'K'), Tmax=(872,'K')), NASAPolynomial(coeffs=[12.2772,0.0262416,-1.11356e-05,2.03483e-09,-1.38221e-13,36141.3,-24.4727], Tmin=(872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH]O[CH][C]=CO(28621)',
    structure = SMILES('[CH2][CH]O[CH][C]=CO'),
    E0 = (368.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0234989,0.0852117,-0.000108755,6.8813e-08,-1.67977e-11,44431.8,30.4018], Tmin=(100,'K'), Tmax=(1014.11,'K')), NASAPolynomial(coeffs=[17.7265,0.015385,-5.47249e-06,9.15892e-10,-5.95884e-14,40841.2,-55.2531], Tmin=(1014.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO) + radical(CCsJOCs) + radical(C=CCJ(O)C) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]OC[C]=[C]O(28622)',
    structure = SMILES('[CH2][CH]OC[C]=[C]O'),
    E0 = (497.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1670,1700,300,440,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187315,0.0871682,-0.000121985,8.37076e-08,-2.12199e-11,59912.6,31.3271], Tmin=(100,'K'), Tmax=(758.792,'K')), NASAPolynomial(coeffs=[15.1818,0.0186509,-7.34659e-06,1.27026e-09,-8.27452e-14,57334.1,-38.8704], Tmin=(758.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(497.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CCsJOCs) + radical(CJCO) + radical(C=CJO)"""),
)

species(
    label = '[CH2]COC=C=CO(28623)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.07811,0.0948862,-0.000102723,5.03076e-08,-8.85969e-12,-4814.85,31.888], Tmin=(100,'K'), Tmax=(1695.14,'K')), NASAPolynomial(coeffs=[26.908,5.55116e-05,4.58114e-06,-1.09184e-09,7.7368e-14,-10844.3,-112.049], Tmin=(1695.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.1318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][C]OC[C]=CO(28625)',
    structure = SMILES('[CH2][C]OC[C]=CO'),
    E0 = (537.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0969326,0.0864714,-0.000109648,6.74431e-08,-1.5904e-11,64834.7,28.4915], Tmin=(100,'K'), Tmax=(1051.69,'K')), NASAPolynomial(coeffs=[19.299,0.0127008,-4.43053e-06,7.45885e-10,-4.92263e-14,60755,-66.0602], Tmin=(1051.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(537.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CH2_triplet) + radical(CJCO)"""),
)

species(
    label = '[CH][CH]OC[C]=CO(28626)',
    structure = SMILES('[CH][CH]OC[C]=CO'),
    E0 = (493.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.081623,0.0853602,-0.000103266,5.82433e-08,-1.172e-11,59554.3,29.5211], Tmin=(100,'K'), Tmax=(917.648,'K')), NASAPolynomial(coeffs=[19.6747,0.0117395,-3.3517e-06,4.96557e-10,-3.08093e-14,55402.2,-66.961], Tmin=(917.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOCs) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CO[CH][C]=CO(23249)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=COC[C]=[C]O(28280)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][CH]OC[C]=CO(14711)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(95.7889,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction5',
    reactants = ['OH(D)(132)', 'C#CCO[CH][CH2](17814)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH]=[C]CO[CH][CH2](17817)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][CH]O[CH][C]=CO(28621)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][CH]OC[C]=[C]O(28622)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH][CH2](721)', '[O]C[C]=CO(27712)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]O[CH2](417)', '[C]=CO(27807)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2][C]OC[C]=CO(28625)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH][CH]OC[C]=CO(28626)'],
    products = ['[CH2][CH]OC[C]=CO(14711)'],
