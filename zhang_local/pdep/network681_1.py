...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06451,0.0762102,-0.000132254,1.30156e-07,-4.90544e-11,-323.701,26.658], Tmin=(100,'K'), Tmax=(836.567,'K')), NASAPolynomial(coeffs=[3.27614,0.0397196,-2.03568e-05,3.95303e-09,-2.73709e-13,213.114,21.8029], Tmin=(836.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.47648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCsJOH) + radical(CCOJ) + radical(CsJOC(O)C)"""),
)

species(
    label = '[O][CH]CC(=O)C[O](2288)',
    structure = SMILES('[O][CH]CC(=O)C[O]'),
    E0 = (86.461,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,3025,407.5,1350,352.5,180,180,180,2379.9,2380.15],'cm^-1')),
        HinderedRotor(inertia=(0.171898,'amu*angstrom^2'), symmetry=1, barrier=(3.95228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171784,'amu*angstrom^2'), symmetry=1, barrier=(3.94965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171854,'amu*angstrom^2'), symmetry=1, barrier=(3.95126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927697,0.0819641,-0.000153884,1.52263e-07,-5.6008e-11,10495.7,27.8687], Tmin=(100,'K'), Tmax=(868.825,'K')), NASAPolynomial(coeffs=[3.10339,0.0378792,-1.89554e-05,3.59746e-09,-2.43771e-13,11403.5,25.078], Tmin=(868.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(86.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + radical(CCOJ) + radical(C=OCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = '[O]C[CH]C1([O])CO1(2290)',
    structure = SMILES('[O]C[CH]C1([O])CO1'),
    E0 = (158.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,3025,407.5,1350,352.5,180,1058.91,1058.91,1058.91,1058.91,1058.91,1058.91,1058.91,1058.91,1058.91,1058.91,1058.91,2275.24],'cm^-1')),
        HinderedRotor(inertia=(0.0511072,'amu*angstrom^2'), symmetry=1, barrier=(1.17505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0511072,'amu*angstrom^2'), symmetry=1, barrier=(1.17505,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983117,0.0580628,-5.58385e-05,2.95469e-08,-6.0797e-12,19165.9,26.9833], Tmin=(100,'K'), Tmax=(1343.76,'K')), NASAPolynomial(coeffs=[12.2069,0.018312,-4.38809e-06,5.09902e-10,-2.42196e-14,16721.9,-28.3514], Tmin=(1343.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(CCOJ)"""),
)

species(
    label = '[O][CH][CH]C1(O)CO1(2291)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.600166,0.0777511,-8.87609e-05,4.80293e-08,-9.35313e-12,13018.9,30.9423], Tmin=(100,'K'), Tmax=(1544.32,'K')), NASAPolynomial(coeffs=[19.3206,0.00428358,3.84032e-06,-1.11566e-09,8.7084e-14,9473.95,-65.3777], Tmin=(1544.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCsJOH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = '[O][CH]CC1(O)[CH]O1(2292)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.884202,0.0853074,-0.000102777,5.74508e-08,-1.15441e-11,11082,29.6616], Tmin=(100,'K'), Tmax=(1485.06,'K')), NASAPolynomial(coeffs=[21.734,0.00146825,5.05321e-06,-1.34712e-09,1.03429e-13,6891.24,-79.8942], Tmin=(1485.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.5201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCsJOH) + radical(CCOJ) + radical(CCsJO)"""),
)
...
species(
    label = '[O]CCC1([O])[CH]O1(2294)',
    structure = SMILES('[O]CCC1([O])[CH]O1'),
    E0 = (142.212,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650184,0.0661365,-7.14118e-05,4.06683e-08,-8.8721e-12,17231.3,25.8823], Tmin=(100,'K'), Tmax=(1268.39,'K')), NASAPolynomial(coeffs=[14.1488,0.0161305,-3.48023e-06,3.41047e-10,-1.25217e-14,14405.2,-40.0919], Tmin=(1268.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CC(C)(O)OJ) + radical(CCsJO)"""),
)
...
species(
    label = '[O][CH][CH]C1([O])CO1(2296)',
    structure = SMILES('[O][CH][CH]C1([O])CO1'),
    E0 = (338.69,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,3150,900,1100,180,1059.62,1059.62,1059.62,1059.62,1059.62,1059.62,1059.62,1059.62,1059.62,1059.62,1059.62,2274.41],'cm^-1')),
        HinderedRotor(inertia=(0.0515441,'amu*angstrom^2'), symmetry=1, barrier=(1.1851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0515441,'amu*angstrom^2'), symmetry=1, barrier=(1.1851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.944931,0.0641003,-7.77017e-05,4.98711e-08,-1.22293e-11,40847.7,26.6683], Tmin=(100,'K'), Tmax=(1140.08,'K')), NASAPolynomial(coeffs=[12.3734,0.0159264,-3.69299e-06,3.8023e-10,-1.41528e-14,38766.7,-27.6637], Tmin=(1140.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.69,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]CC1([O])[CH]O1(2297)',
    structure = SMILES('[O][CH]CC1([O])[CH]O1'),
    E0 = (322.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.570666,0.0726346,-9.47652e-05,6.27585e-08,-1.57048e-11,38915,25.7174], Tmin=(100,'K'), Tmax=(1119.01,'K')), NASAPolynomial(coeffs=[14.3636,0.0136526,-2.72852e-06,1.9753e-10,-1.28149e-15,36434,-39.6693], Tmin=(1119.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCsJOH) + radical(CCOJ) + radical(CCsJO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629379,0.0477952,3.6916e-05,-1.1985e-07,6.23649e-11,-33536.8,22.0152], Tmin=(100,'K'), Tmax=(870.118,'K')), NASAPolynomial(coeffs=[30.6567,-0.0148004,1.47694e-05,-3.23569e-09,2.29676e-13,-41618.2,-135.082], Tmin=(870.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=COJ)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.866776,0.0857165,-0.000168077,1.72042e-07,-6.50199e-11,48826.3,31.2542], Tmin=(100,'K'), Tmax=(858.169,'K')), NASAPolynomial(coeffs=[1.56194,0.0423804,-2.22458e-05,4.30864e-09,-2.95624e-13,50183.5,36.609], Tmin=(858.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CsJOCH3) + radical(Cs_P) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = '[O][CH]C[C]([O])C[O](2301)',
    structure = SMILES('[O][CH]C[C]([O])C[O]'),
    E0 = (402.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,180,180,180,1777.82,1778.05,1778.37],'cm^-1')),
        HinderedRotor(inertia=(0.217109,'amu*angstrom^2'), symmetry=1, barrier=(4.99176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.216708,'amu*angstrom^2'), symmetry=1, barrier=(4.98254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.215987,'amu*angstrom^2'), symmetry=1, barrier=(4.96598,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697118,0.0923324,-0.000188522,1.93558e-07,-7.22826e-11,48481.7,29.7246], Tmin=(100,'K'), Tmax=(875.193,'K')), NASAPolynomial(coeffs=[0.876153,0.0434561,-2.23851e-05,4.26377e-09,-2.88119e-13,50290.9,39.3997], Tmin=(875.193,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH) + radical(C2CsJOH) + radical(CCOJ) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C[CH][O](2287)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C=CC1([O])CO1(2289)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C[CH]C1([O])CO1(2290)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]CC1([O])CO1(1785)'],
    products = ['[O][CH][CH]C1(O)CO1(2291)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]CC1([O])CO1(1785)'],
    products = ['[O][CH]CC1(O)[CH]O1(2292)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O][CH]CC1([O])CO1(1785)'],
    products = ['[O]C1([CH][CH]O)CO1(2293)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O][CH]CC1([O])CO1(1785)'],
    products = ['[O]C1([CH]O1)C[CH]O(2295)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[O][CH][CH]C1([O])CO1(2296)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O][CH]CC1([O])[CH]O1(2297)', 'H(8)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(14)', '[O][CH]CC([O])=O(2298)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C([O])C[CH][O](1095)', 'O(S)(1732)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[C]([O])C[CH][O](2300)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', '[O][CH]C[C]1CO1(2302)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH][O](751)', '[CH2]C1([O])CO1(1847)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O][C]CC1([O])CO1(2303)', 'H(8)'],
    products = ['[O][CH]CC1([O])CO1(1785)'],
