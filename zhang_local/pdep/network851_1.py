...
species(
    label = '[CH2][C]([O])O[C]([CH2])[O](2839)',
    structure = SMILES('[CH2][C]([O])O[C]([CH2])[O]'),
    E0 = (611.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,363.333,366.667,370,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,211.692,885.034,1180.05,1561.43,1962.81],'cm^-1')),
        HinderedRotor(inertia=(0.113076,'amu*angstrom^2'), symmetry=1, barrier=(3.1819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113076,'amu*angstrom^2'), symmetry=1, barrier=(3.1819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113076,'amu*angstrom^2'), symmetry=1, barrier=(3.1819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113076,'amu*angstrom^2'), symmetry=1, barrier=(3.1819,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.886035,0.0836436,-0.000164069,1.6557e-07,-6.21861e-11,73613.5,32.149], Tmin=(100,'K'), Tmax=(849.117,'K')), NASAPolynomial(coeffs=[3.26248,0.0373448,-2.02674e-05,3.9793e-09,-2.75307e-13,74475.4,28.5246], Tmin=(849.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(611.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Cs_P) + radical(Cs_P) + radical(CCOJ) + radical(CJCO) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]C([O])O[C]([CH2])[O](2841)',
    structure = SMILES('[CH]C([O])O[C]([CH2])[O]'),
    E0 = (642.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.956429,0.0806905,-0.000153125,1.536e-07,-5.79361e-11,77386.3,32.2716], Tmin=(100,'K'), Tmax=(840.324,'K')), NASAPolynomial(coeffs=[3.48102,0.0374634,-2.02527e-05,3.98847e-09,-2.77196e-13,78064,27.0878], Tmin=(840.324,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJ2_triplet) + radical(CCOJ) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH][C]([O])OC([CH2])[O](2842)',
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.956474,0.0806899,-0.000153122,1.53596e-07,-5.79344e-11,77386.3,32.2715], Tmin=(100,'K'), Tmax=(840.33,'K')), NASAPolynomial(coeffs=[3.48093,0.0374636,-2.02528e-05,3.98849e-09,-2.77198e-13,78064,27.0883], Tmin=(840.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCOJ) + radical(CCOJ) + radical(CJCO) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OC([CH2])[O](2138)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([O])OC([CH2])=O(2758)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', '[CH2]C(=O)O[CH][O](2592)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(9.34775,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;O_atom_triplet] for rate rule [Cds-OsH_Cds;O_atom_triplet]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from -5.8 to 9.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    products = ['[CH2][C]([O])O[C]([CH2])O(2837)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][C]([O])O[C]([CH2])[O](2839)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    products = ['[CH2][C](O)OC([CH2])=O(2840)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])OC([CH2])[O](2138)'],
    products = ['[CH2]C(=O)OC([CH2])[O](2123)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])[O](696)', '[CH2][C][O](2305)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(28)', '[CH2][C]([O])O[CH][O](2597)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]C([O])O[C]([CH2])[O](2841)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH][C]([O])OC([CH2])[O](2842)'],
    products = ['[CH2][C]([O])OC([CH2])[O](2138)'],
