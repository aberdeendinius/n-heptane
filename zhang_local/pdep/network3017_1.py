species(
    ...
    E0 = (302.453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]CC(=O)C([CH2])[O](12062)',
    structure = SMILES('[CH2]CC(=O)C([CH2])[O]'),
    E0 = (213.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,375,552.5,462.5,1710,519.16,519.199,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0985238,'amu*angstrom^2'), symmetry=1, barrier=(2.26526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0985442,'amu*angstrom^2'), symmetry=1, barrier=(2.26572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0985318,'amu*angstrom^2'), symmetry=1, barrier=(2.26544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.822517,'amu*angstrom^2'), symmetry=1, barrier=(18.9113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.944454,0.0706603,-8.00762e-05,5.09555e-08,-1.33605e-11,25775.4,30.1542], Tmin=(100,'K'), Tmax=(917.979,'K')), NASAPolynomial(coeffs=[10.3043,0.0298749,-1.34303e-05,2.55388e-09,-1.78595e-13,24057.1,-14.2002], Tmin=(917.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O) + radical(CJCO) + radical(C=OCOJ)"""),
)
...
species(
    label = '[CH2][C](O)C1([O])CC1(11904)',
    structure = SMILES('[CH2][C](O)C1([O])CC1'),
    E0 = (248.721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,360,370,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.392202,0.0730668,-7.42595e-05,3.85126e-08,-7.83963e-12,30049.4,26.9549], Tmin=(100,'K'), Tmax=(1201.55,'K')), NASAPolynomial(coeffs=[16.5599,0.0192439,-7.06743e-06,1.23164e-09,-8.27531e-14,26164.2,-54.0133], Tmin=(1201.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'C[C]([O])C1([O])CC1(11821)',
    structure = SMILES('C[C]([O])C1([O])CC1'),
    E0 = (267.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.709195,0.0638596,-4.85229e-05,1.42397e-08,-6.20757e-14,32297.7,24.9917], Tmin=(100,'K'), Tmax=(1047.04,'K')), NASAPolynomial(coeffs=[15.5007,0.0215257,-8.18085e-06,1.4823e-09,-1.03031e-13,28423.3,-50.7591], Tmin=(1047.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])C1(O)[CH]C1(12063)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744701,0.0584267,-2.26416e-05,-2.27763e-08,1.59337e-11,33016.4,28.5075], Tmin=(100,'K'), Tmax=(942.151,'K')), NASAPolynomial(coeffs=[18.9648,0.0137723,-3.61064e-06,5.97448e-10,-4.40563e-14,28131.9,-66.0106], Tmin=(942.151,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJCO) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C]([O])C1(O)CC1(12064)',
    structure = SMILES('[CH2][C]([O])C1(O)CC1'),
    E0 = (250.165,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.367084,0.0727233,-6.95713e-05,3.06081e-08,-4.24712e-12,30225.1,26.7902], Tmin=(100,'K'), Tmax=(995.714,'K')), NASAPolynomial(coeffs=[17.2296,0.017796,-6.12792e-06,1.05396e-09,-7.1589e-14,26231.9,-57.6787], Tmin=(995.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOH) + radical(CJCO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(O)C1([O])[CH]C1(11903)',
    structure = SMILES('[CH2]C(O)C1([O])[CH]C1'),
    E0 = (271.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2950,3150,900,1000,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791852,0.0585421,-2.67173e-05,-1.53307e-08,1.23633e-11,32839.8,28.5915], Tmin=(100,'K'), Tmax=(956.847,'K')), NASAPolynomial(coeffs=[17.8475,0.0159536,-4.96208e-06,8.70576e-10,-6.30232e-14,28261.6,-59.8077], Tmin=(956.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = 'CC([O])C1([O])[CH]C1(11820)',
    structure = SMILES('CC([O])C1([O])[CH]C1'),
    E0 = (290.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10319,0.0493996,-1.18253e-06,-3.94043e-08,2.00916e-11,35088.3,26.6485], Tmin=(100,'K'), Tmax=(963.158,'K')), NASAPolynomial(coeffs=[17.0126,0.0178683,-5.86931e-06,1.07345e-09,-7.93925e-14,30421.6,-57.8252], Tmin=(963.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    label = 'C=C(O)C1([O])CC1(11900)',
    structure = SMILES('C=C(O)C1([O])CC1'),
    E0 = (-61.0082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09862,0.0444941,2.32612e-05,-7.39401e-08,3.4952e-11,-7215.33,25.1119], Tmin=(100,'K'), Tmax=(933.672,'K')), NASAPolynomial(coeffs=[20.4739,0.0107045,-1.52383e-06,2.15248e-10,-2.10713e-14,-12978.6,-78.5207], Tmin=(933.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.0082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CC(C)2OJ)"""),
)

species(
    label = 'CC(=O)C1([O])CC1(11512)',
    structure = SMILES('CC(=O)C1([O])CC1'),
    E0 = (-57.4042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,375,552.5,462.5,1710,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2611,0.0525442,-3.0225e-05,2.82311e-09,2.44943e-12,-6798.94,24.8269], Tmin=(100,'K'), Tmax=(1059.87,'K')), NASAPolynomial(coeffs=[12.331,0.0242652,-9.30773e-06,1.68315e-09,-1.16251e-13,-9903.68,-32.7995], Tmin=(1059.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.4042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Cyclopropane) + radical(CC(C)(C=O)OJ)"""),
)

species(
    label = 'C=C([O])C1(O)CC1(12066)',
    structure = SMILES('C=C([O])C1(O)CC1'),
    E0 = (-152.306,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09448,0.0466812,1.30163e-05,-6.30031e-08,3.15087e-11,-18197.6,25.4143], Tmin=(100,'K'), Tmax=(920.184,'K')), NASAPolynomial(coeffs=[19.7645,0.010367,-8.87292e-07,3.00502e-11,-4.8479e-15,-23532.1,-73.4206], Tmin=(920.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    E0 = (279.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    label = '[O]C1(CC1)C1CO1(11510)',
    structure = SMILES('[O]C1(CC1)C1CO1'),
    E0 = (50.0673,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34969,0.0421344,2.72499e-05,-7.86759e-08,3.8555e-11,6132.48,20.5056], Tmin=(100,'K'), Tmax=(882.638,'K')), NASAPolynomial(coeffs=[17.6119,0.0133536,-1.73593e-07,-3.05834e-10,2.65692e-14,1512.1,-65.8315], Tmin=(882.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.0673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C1OOC12CC2(11507)',
    structure = SMILES('[CH2]C1OOC12CC2'),
    E0 = (252.01,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24951,0.0495949,-1.07298e-05,-1.90036e-08,9.86541e-12,30418.2,21.5312], Tmin=(100,'K'), Tmax=(1048.42,'K')), NASAPolynomial(coeffs=[13.2401,0.0268248,-1.10261e-05,2.08882e-09,-1.48852e-13,26641.2,-42.9057], Tmin=(1048.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane) + radical(CJCOOH)"""),
)

species(
    label = '[O]C1COC12CC2(11503)',
...
species(
    label = '[CH]C([O])C1([O])CC1(12069)',
    structure = SMILES('[CH]C([O])C1([O])CC1'),
    E0 = (539.08,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.858839,0.0576364,-2.92003e-05,-1.0416e-08,9.95486e-12,64959.7,26.0332], Tmin=(100,'K'), Tmax=(973.73,'K')), NASAPolynomial(coeffs=[17.3568,0.0160657,-5.52465e-06,1.00879e-09,-7.33521e-14,60504.6,-59.499], Tmin=(973.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(539.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CC(C)2OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C([O])C1([O])CC1(10934)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C([CH2])[O](12062)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(89.0346,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 87.5 to 89.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C([O])C1([O])CC1(10788)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[O]C1(C=O)CC1(11561)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', 'C=CC1([O])CC1(11496)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['C=C[O](594)', '[O][C]1CC1(9172)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])C1([O])CC1(10934)'],
    products = ['[CH2][C](O)C1([O])CC1(11904)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([O])C1([O])CC1(10934)'],
    products = ['[CH2]C([O])C1(O)[CH]C1(12063)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])C1([O])CC1(10934)'],
    products = ['[CH2][C]([O])C1(O)CC1(12064)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])C1([O])CC1(10934)'],
    products = ['[CH2]C(O)C1([O])[CH]C1(11903)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([O])C1([O])CC1(10934)'],
    products = ['CC([O])C1([O])[CH]C1(11820)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([O])C1([O])[CH]C1(12004)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]([O])C1([O])CC1(12065)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', '[CH2]C([O])[C]1CC1(12068)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH2][CH]C1([O])CC1(11624)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(28)', '[O][CH]C1([O])CC1(11783)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([O])C1([O])CC1(12069)'],
    products = ['[CH2]C([O])C1([O])CC1(10934)'],
