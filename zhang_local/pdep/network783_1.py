...
species(
    label = '[CH2]C([O])([O])C(=C)CC(2523)',
    structure = SMILES('[CH2]C([O])([O])C(=C)CC'),
    E0 = (215.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,402.175,745.267,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.167402,'amu*angstrom^2'), symmetry=1, barrier=(3.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167402,'amu*angstrom^2'), symmetry=1, barrier=(3.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167402,'amu*angstrom^2'), symmetry=1, barrier=(3.8489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167402,'amu*angstrom^2'), symmetry=1, barrier=(3.8489,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.348371,0.0934167,-0.00010591,6.3734e-08,-1.51661e-11,26092.6,32.8639], Tmin=(100,'K'), Tmax=(1029.76,'K')), NASAPolynomial(coeffs=[16.577,0.0276719,-1.01429e-05,1.73467e-09,-1.14254e-13,22606.8,-49.2878], Tmin=(1029.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561302,0.0830329,-9.7687e-05,8.41172e-08,-3.22177e-11,30676.4,30.6526], Tmin=(100,'K'), Tmax=(740.061,'K')), NASAPolynomial(coeffs=[3.83958,0.0568374,-2.74117e-05,5.33454e-09,-3.75888e-13,30423.3,17.3919], Tmin=(740.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CCJ(C)CO) + radical(CJC(O)2C) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])([O])C(C)[CH]C(2525)',
    structure = SMILES('[CH2]C([O])([O])C(C)[CH]C'),
    E0 = (296.056,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.403178,0.0894515,-0.000124223,1.17362e-07,-4.56149e-11,35726.8,33.5758], Tmin=(100,'K'), Tmax=(791.84,'K')), NASAPolynomial(coeffs=[2.54993,0.0588658,-2.88878e-05,5.61201e-09,-3.92761e-13,36005.7,27.628], Tmin=(791.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)

species(
    label = '[CH2][C](CC)C([CH2])([O])O(2526)',
    structure = SMILES('[CH2][C](CC)C([CH2])([O])O'),
    E0 = (227.18,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0838078,0.08787,-8.35292e-05,4.31536e-08,-9.0948e-12,27472.1,34.1743], Tmin=(100,'K'), Tmax=(1136.51,'K')), NASAPolynomial(coeffs=[14.7902,0.0355201,-1.4436e-05,2.62401e-09,-1.79414e-13,24091.3,-39.4873], Tmin=(1136.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CJC(O)2C) + radical(Isobutyl) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][C](CC)C(C)([O])[O](2527)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.961341,0.0724069,-5.97798e-05,3.31007e-08,-8.80333e-12,29305.2,30.7509], Tmin=(100,'K'), Tmax=(841.575,'K')), NASAPolynomial(coeffs=[5.21747,0.0521777,-2.37242e-05,4.53892e-09,-3.18771e-13,28588.8,10.9516], Tmin=(841.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([CH]C)C([CH2])([O])O(2528)',
    structure = SMILES('[CH2]C([CH]C)C([CH2])([O])O'),
    E0 = (269.148,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00297101,0.0911802,-9.82552e-05,5.99794e-08,-1.51332e-11,32512.2,36.2345], Tmin=(100,'K'), Tmax=(951.727,'K')), NASAPolynomial(coeffs=[12.2375,0.039761,-1.72162e-05,3.21453e-09,-2.2257e-13,30183.4,-22.1852], Tmin=(951.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)

species(
    label = '[CH2]C([CH]C)C(C)([O])[O](2529)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.623121,0.081203,-9.60334e-05,8.15022e-08,-3.01288e-11,34363.2,34.305], Tmin=(100,'K'), Tmax=(775.132,'K')), NASAPolynomial(coeffs=[4.08745,0.053918,-2.50274e-05,4.77435e-09,-3.32082e-13,34108.7,20.2971], Tmin=(775.132,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(C)C([CH2])([O])[O](2530)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.261292,0.0912224,-0.000122402,1.09828e-07,-4.1219e-11,37020.7,33.3178], Tmin=(100,'K'), Tmax=(782.787,'K')), NASAPolynomial(coeffs=[4.42491,0.0556691,-2.69145e-05,5.20554e-09,-3.63913e-13,36806.2,17.0444], Tmin=(782.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])C([CH2])([O])O(2531)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.244989,0.0943182,-0.000101779,6.02271e-08,-1.44577e-11,33810.6,36.3495], Tmin=(100,'K'), Tmax=(1007.36,'K')), NASAPolynomial(coeffs=[14.4516,0.0359621,-1.48846e-05,2.72148e-09,-1.86418e-13,30849.6,-34.6607], Tmin=(1007.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)

species(
    label = '[CH2]CC([CH2])C(C)([O])[O](2532)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29808,0.0700727,-2.71603e-05,-6.49231e-08,7.36023e-11,35622.1,31.2902], Tmin=(100,'K'), Tmax=(487.003,'K')), NASAPolynomial(coeffs=[5.75975,0.0511252,-2.33135e-05,4.43403e-09,-3.09036e-13,34977.7,10.8205], Tmin=(487.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(Isobutyl) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2][C](CC)C([CH2])([O])[O](2533)',
    structure = SMILES('[CH2][C](CC)C([CH2])([O])[O]'),
    E0 = (459.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.469373,0.0860159,-0.000114564,1.016e-07,-3.73792e-11,55344.4,32.7625], Tmin=(100,'K'), Tmax=(804.441,'K')), NASAPolynomial(coeffs=[4.3747,0.0521613,-2.4519e-05,4.66914e-09,-3.23096e-13,55183.2,17.6746], Tmin=(804.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C([CH2])([O])[O](2534)',
    structure = SMILES('[CH2]C([CH]C)C([CH2])([O])[O]'),
    E0 = (501.138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.360222,0.091807,-0.000138689,1.31481e-07,-4.92933e-11,60392.7,35.5134], Tmin=(100,'K'), Tmax=(831.172,'K')), NASAPolynomial(coeffs=[2.9039,0.0545187,-2.6194e-05,4.9952e-09,-3.44102e-13,60835,28.9166], Tmin=(831.172,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(501.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(Cs_S) + radical(CC(C)(O)OJ) + radical(Isobutyl) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]CC([CH2])C([CH2])([O])[O](2535)',
    structure = SMILES('[CH2]CC([CH2])C([CH2])([O])[O]'),
    E0 = (511.843,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.204557,0.0937572,-0.000137578,1.24995e-07,-4.54041e-11,61687.2,35.3038], Tmin=(100,'K'), Tmax=(830.757,'K')), NASAPolynomial(coeffs=[4.8146,0.0512573,-2.41816e-05,4.57919e-09,-3.14444e-13,61621.8,18.1345], Tmin=(830.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.843,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])(O)C(=C)CC(2536)',
    structure = SMILES('[CH2]C([O])(O)C(=C)CC'),
    E0 = (-17.4182,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23856,0.0987258,-0.000100227,5.06935e-08,-9.82506e-12,-1892.28,35.8763], Tmin=(100,'K'), Tmax=(1365.8,'K')), NASAPolynomial(coeffs=[24.093,0.0181491,-4.71644e-06,6.48958e-10,-3.79008e-14,-8215.99,-92.0495], Tmin=(1365.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.4182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ)"""),
)

species(
    label = 'C=C(CC)C(C)([O])[O](2537)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.14761,0.0894805,-9.36708e-05,5.40015e-08,-1.25424e-11,403.202,31.2191], Tmin=(100,'K'), Tmax=(1045.45,'K')), NASAPolynomial(coeffs=[14.6639,0.0328098,-1.23598e-05,2.15051e-09,-1.43129e-13,-2693.72,-40.8962], Tmin=(1045.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.09797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03573,0.0732133,-0.000100227,9.31207e-08,-3.58486e-11,39493.3,29.2824], Tmin=(100,'K'), Tmax=(787.909,'K')), NASAPolynomial(coeffs=[3.31024,0.0471714,-2.30542e-05,4.47449e-09,-3.13164e-13,39584.8,21.7065], Tmin=(787.909,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)
...
species(
    label = '[CH2]C(CC)[C]([O])[O](2539)',
    structure = SMILES('[CH2]C(CC)[C]([O])[O]'),
    E0 = (327.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1597.48,1598.39,1598.91],'cm^-1')),
        HinderedRotor(inertia=(0.12061,'amu*angstrom^2'), symmetry=1, barrier=(2.77306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120927,'amu*angstrom^2'), symmetry=1, barrier=(2.78034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121389,'amu*angstrom^2'), symmetry=1, barrier=(2.79098,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121557,'amu*angstrom^2'), symmetry=1, barrier=(2.79483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16489,0.0710567,-9.9789e-05,9.39854e-08,-3.56367e-11,39531.1,31.1041], Tmin=(100,'K'), Tmax=(826.169,'K')), NASAPolynomial(coeffs=[2.40986,0.0466018,-2.19319e-05,4.16219e-09,-2.86607e-13,39954.3,29.1416], Tmin=(826.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C([O])([O])C([CH2])CC(2540)',
    structure = SMILES('[CH]C([O])([O])C([CH2])CC'),
    E0 = (538.429,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02355,0.0754889,-5.36469e-05,-1.7745e-08,4.01289e-11,64855.3,31.4458], Tmin=(100,'K'), Tmax=(523.08,'K')), NASAPolynomial(coeffs=[6.97387,0.0471463,-2.15783e-05,4.09863e-09,-2.85045e-13,63998.1,4.35088], Tmin=(523.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH]C(CC)C([CH2])([O])[O](2541)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.153653,0.093752,-0.00013214,1.17975e-07,-4.33543e-11,66246.8,32.9217], Tmin=(100,'K'), Tmax=(790.384,'K')), NASAPolynomial(coeffs=[5.64026,0.0516883,-2.51783e-05,4.86994e-09,-3.39907e-13,65826,10.5677], Tmin=(790.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(CJC(O)2C)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])([O])C(=C)CC(2523)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(CC)C(=C)[O](899)', 'O(T)(63)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(7.28768,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;O_atom_triplet] for rate rule [CO_O;O_atom_triplet]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from -5.8 to 7.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(CC)C([O])=O(1966)', 'CH2(T)(28)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(11.3408,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 11.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([O])([O])C=C(2117)', 'C[CH2](6)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(92.0623,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 89.0 to 92.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]C([O])([O])[C](C)CC(2524)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]C([O])([O])C(C)[CH]C(2525)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2][C](CC)C([CH2])([O])O(2526)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2][C](CC)C(C)([O])[O](2527)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]C([CH]C)C([CH2])([O])O(2528)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]C([CH]C)C(C)([O])[O](2529)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(C)C([CH2])([O])[O](2530)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]CC([CH2])C([CH2])([O])O(2531)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]CC([CH2])C(C)([O])[O](2532)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH2](6)', '[CH2][CH]C([CH2])([O])[O](2325)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][C](CC)C([CH2])([O])[O](2533)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH2])C([CH2])([O])[O](2412)', '[CH3](11)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH]C)C([CH2])([O])[O](2534)', 'H(8)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([CH2])C([CH2])([O])[O](2535)', 'H(8)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]C([O])(O)C(=C)CC(2536)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(14)', '[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
    products = ['[CH2]C(CC)C1([CH2])OO1(1660)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C([O])([O])[CH]CC(2415)', 'CH2(T)(28)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][C]([O])C([CH2])CC(914)', 'O(T)(63)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(CC)[C]([O])[O](2539)', 'CH2(T)(28)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]C([O])([O])C([CH2])CC(2540)', 'H(8)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH]C(CC)C([CH2])([O])[O](2541)'],
    products = ['[CH2]C(CC)C([CH2])([O])[O](1653)'],
