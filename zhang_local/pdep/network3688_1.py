...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C=C=C(6077)'],
    products = ['[CH2]C(=C)O[O](9229)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(83220,'cm^3/(mol*s)'), n=2.487, Ea=(52.8801,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ca_Cds-HH;OJ] for rate rule [Ca_Cds-HH;O2b]
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)O[O](9229)'],
    products = ['[CH2]C1([CH2])OO1(18727)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(89.9936,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 89.1 to 90.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.06838e+08,'s^-1'), n=1.06803, Ea=(127.432,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_D;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
Ea raised from 126.2 to 127.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=C)O[O](9229)'],
    products = ['O2(S)(5486)', 'C=C=C(6077)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(41.4315,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission
Ea raised from 0.0 to 41.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=C)O[O](9229)'],
    products = ['O(T)(63)', 'C=C1CO1(9173)'],
