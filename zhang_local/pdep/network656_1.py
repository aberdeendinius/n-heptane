...
species(
    ...
    molecularWeight = (91.0428,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63806,0.0456356,-4.27257e-05,1.95041e-08,-3.47687e-12,-9193.87,23.1449], Tmin=(100,'K'), Tmax=(1365.62,'K')), NASAPolynomial(coeffs=[13.5332,0.0107942,-4.45608e-06,8.21827e-10,-5.67881e-14,-12442.7,-37.9489], Tmin=(1365.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.1931,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(OCJC=O)"""),
)

species(
    label = '[O]OOCC=O(2586)',
    structure = SMILES('[O]OOCC=O'),
    E0 = (-63.6733,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (91.0428,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01553,0.0380993,-2.81495e-05,6.46665e-09,9.417e-13,-7581.84,22.786], Tmin=(100,'K'), Tmax=(1026.07,'K')), NASAPolynomial(coeffs=[11.4415,0.0116195,-4.44687e-06,8.17369e-10,-5.76815e-14,-10056.6,-25.5648], Tmin=(1026.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.6733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=C=COOO(1866)'],
    products = ['O=[C]COOO(1765)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', '[O]OC[C]=O(1145)'],
    products = ['O=[C]COOO(1765)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=O(1149)', '[CH2]OOO(403)'],
    products = ['O=[C]COOO(1765)'],
