...
species(
    ...
    E0 = (-67.0073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,398.986,1082.96,1083.09,1083.1,1083.19,1083.32,1083.42],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63614,0.000199619,5.27967e-05,-7.53825e-08,3.31857e-11,-8038.33,6.17608], Tmin=(100,'K'), Tmax=(815.425,'K')), NASAPolynomial(coeffs=[7.14623,0.00524158,2.57324e-06,-8.43025e-10,6.86613e-14,-9350.83,-14.5797], Tmin=(815.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.0073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    E0 = (116.715,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,772.905,772.906,772.906,772.906,772.906,772.906],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (43.0446,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3625.11,'J/mol'), sigma=(3.97,'angstroms'), dipoleMoment=(0,'De'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=2.0, comment="""NOx2018"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.43609,0.0037428,4.36889e-05,-7.13369e-08,3.34124e-11,14066.4,7.79041], Tmin=(100,'K'), Tmax=(816.581,'K')), NASAPolynomial(coeffs=[9.79737,-0.00149439,5.68999e-06,-1.43717e-09,1.09913e-13,12163.2,-26.9022], Tmin=(816.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCsJO)"""),
)
...
species(
    ...
    E0 = (417.349,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,180,1646.02,1646.1,1646.25],'cm^-1')),
        HinderedRotor(inertia=(0.0961627,'amu*angstrom^2'), symmetry=1, barrier=(2.21097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (43.0446,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.91305,0.010652,-1.49829e-06,-1.27498e-09,3.21214e-13,50190.5,9.97049], Tmin=(100,'K'), Tmax=(2201.55,'K')), NASAPolynomial(coeffs=[9.18487,0.00727936,-3.42854e-06,5.89897e-10,-3.59472e-14,46365.3,-23.0388], Tmin=(2201.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.0099,'amu*angstrom^2'), symmetry=1, barrier=(23.2195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (43.0446,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14401,0.0100191,2.3782e-05,-4.60907e-08,2.11221e-11,8831.15,11.4216], Tmin=(100,'K'), Tmax=(892.432,'K')), NASAPolynomial(coeffs=[10.9393,-0.00120295,2.78005e-06,-6.22589e-10,4.27619e-14,6495.34,-30.5904], Tmin=(892.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.1009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
species(
    ...
    E0 = (80.4528,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,391.39,391.432],'cm^-1')),
        HinderedRotor(inertia=(0.137906,'amu*angstrom^2'), symmetry=1, barrier=(14.9935,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (43.0446,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85279,0.0118604,3.38224e-05,-6.74199e-08,3.14942e-11,9730.22,9.74207], Tmin=(100,'K'), Tmax=(889.849,'K')), NASAPolynomial(coeffs=[15.389,-0.00827915,6.72865e-06,-1.38905e-09,9.46778e-14,6065.44,-57.3307], Tmin=(889.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.4528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (253.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1996.02,1996.4,3399.85],'cm^-1')),
        HinderedRotor(inertia=(0.203078,'amu*angstrom^2'), symmetry=1, barrier=(4.66915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
...
species(
    ...
    E0 = (194.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,236.103,1681.12,3288.67],'cm^-1')),
        HinderedRotor(inertia=(0.241566,'amu*angstrom^2'), symmetry=1, barrier=(9.56347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00302913,'amu*angstrom^2'), symmetry=1, barrier=(0.119817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['O(T)(63)', 'C=C(18)'],
    products = ['[CH2]C[O](419)'],
    transitionState = 'TS1',
...
This reaction matched rate rule [Cds-OJH_Cds-HH;HJ]
family: R_Addition_MultipleBond"""),
)

reaction(
    label = 'reaction3',
    reactants = ['C=O(355)', 'CH2(T)(28)'],
    products = ['[CH2]C[O](419)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C[O](419)'],
    products = ['[CH2][CH]O(578)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH]=C(64)'],
    products = ['C=CO(576)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(3.44289e+07,'m^3/(mol*s)'), n=0.0225, Ea=(0.0523,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Y_rad;O_pri_rad] + [Cd_pri_rad;Y_rad] for rate rule [Cd_pri_rad;O_pri_rad]
Euclidian distance = 2.0
family: R_Recombination"""),
)
