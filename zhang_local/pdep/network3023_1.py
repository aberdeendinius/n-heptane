...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.63556,0.0792467,-0.000102979,7.65732e-08,-2.34256e-11,15535.4,28.6894], Tmin=(100,'K'), Tmax=(792.548,'K')), NASAPolynomial(coeffs=[9.79668,0.0330107,-1.54716e-05,2.96547e-09,-2.07066e-13,14083.3,-13.3777], Tmin=(792.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJCO) + radical(CCsJOC(O)) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2][CH]OC1(O)[CH]C1(12051)',
    structure = SMILES('[CH2][CH]OC1(O)[CH]C1'),
    E0 = (232.58,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115489,0.0613728,3.66806e-06,-7.64904e-08,4.18817e-11,28135.3,28.787], Tmin=(100,'K'), Tmax=(911.017,'K')), NASAPolynomial(coeffs=[29.6622,-0.00432429,6.40694e-06,-1.34125e-09,8.70304e-14,20094.6,-125.589], Tmin=(911.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2]COC1([O])[CH]C1(12052)',
    structure = SMILES('[CH2]COC1([O])[CH]C1'),
    E0 = (284.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.960397,0.052568,-7.98809e-06,-3.31963e-08,1.78834e-11,34293.4,27.5764], Tmin=(100,'K'), Tmax=(973.451,'K')), NASAPolynomial(coeffs=[17.6833,0.0176067,-6.12863e-06,1.15102e-09,-8.56852e-14,29438.3,-60.8664], Tmin=(973.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]OC1([O])[CH]C1(12053)',
    structure = SMILES('[CH2][CH]OC1([O])[CH]C1'),
    E0 = (464.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.672238,0.0594385,-2.66826e-05,-2.00423e-08,1.52143e-11,56007.3,28.0561], Tmin=(100,'K'), Tmax=(948.826,'K')), NASAPolynomial(coeffs=[20.2366,0.0106074,-2.67817e-06,4.65954e-10,-3.67747e-14,50780.1,-73.2842], Tmin=(948.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCsJOCs) + radical(CC(C)(O)OJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH][CH]OC1([O])CC1(12056)',
    structure = SMILES('[CH][CH]OC1([O])CC1'),
    E0 = (501.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580923,0.0624761,-3.49093e-05,-1.02775e-08,1.1266e-11,60426.4,26.2578], Tmin=(100,'K'), Tmax=(960.801,'K')), NASAPolynomial(coeffs=[19.7829,0.0125588,-3.85272e-06,6.97725e-10,-5.25858e-14,55350.7,-72.8249], Tmin=(960.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(501.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OC1([O])CC1(10907)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][CH]OC(=O)C[CH2](12050)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]OC1([O])CC1(10907)'],
    products = ['[CH2][CH]OC1(O)[CH]C1(12051)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]COC1([O])[CH]C1(12052)'],
    products = ['[CH2][CH]OC1([O])CC1(10907)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]OC1([O])CC1(10907)'],
    products = ['C[CH]OC1([O])[CH]C1(11800)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH]OC1([O])[CH]C1(12053)'],
    products = ['[CH2][CH]OC1([O])CC1(10907)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH][CH2](721)', '[O]C1([O])CC1(3057)'],
    products = ['[CH2][CH]OC1([O])CC1(10907)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]OC1([O])CC1(12055)'],
    products = ['[CH2][CH]OC1([O])CC1(10907)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH][CH]OC1([O])CC1(12056)'],
    products = ['[CH2][CH]OC1([O])CC1(10907)'],
