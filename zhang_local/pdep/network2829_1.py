...
species(
    label = '[CH2]C([O])=CC[C]=O(10743)',
    structure = SMILES('[CH2]C([O])=CC[C]=O'),
    E0 = (112.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1855,455,950,350,440,435,1725,412.505,412.511],'cm^-1')),
        HinderedRotor(inertia=(0.000990679,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103149,'amu*angstrom^2'), symmetry=1, barrier=(12.4558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103149,'amu*angstrom^2'), symmetry=1, barrier=(12.4558,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([O])[CH]C[C]=O(10745)',
    structure = SMILES('[CH2]C([O])[CH]C[C]=O'),
    E0 = (378.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,1855,455,950,3025,407.5,1350,352.5,180,709.058,2831.18],'cm^-1')),
        HinderedRotor(inertia=(0.0782725,'amu*angstrom^2'), symmetry=1, barrier=(1.79964,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0776467,'amu*angstrom^2'), symmetry=1, barrier=(1.78525,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0396857,'amu*angstrom^2'), symmetry=1, barrier=(14.2937,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.620417,'amu*angstrom^2'), symmetry=1, barrier=(14.2646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02065,0.0687207,-8.28708e-05,5.55916e-08,-1.51898e-11,45622.5,30.6992], Tmin=(100,'K'), Tmax=(887.276,'K')), NASAPolynomial(coeffs=[10.3399,0.0267087,-1.18482e-05,2.22883e-09,-1.54577e-13,43968.7,-13.1464], Tmin=(887.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCO) + radical(CCCJ=O) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.535025,0.0835844,-0.000134019,1.14583e-07,-3.79347e-11,39173.2,32.0487], Tmin=(100,'K'), Tmax=(870.52,'K')), NASAPolynomial(coeffs=[9.51147,0.0277265,-1.25924e-05,2.31039e-09,-1.54347e-13,38164,-6.83278], Tmin=(870.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CJCO) + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = 'C[C]([O])[CH]C[C]=O(10750)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.886665,0.0739642,-0.000106837,8.8493e-08,-2.94446e-11,41420,29.9617], Tmin=(100,'K'), Tmax=(826.16,'K')), NASAPolynomial(coeffs=[8.43033,0.0300668,-1.3748e-05,2.57245e-09,-1.75658e-13,40425.2,-3.4686], Tmin=(826.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)OJ) + radical(CCCJ=O) + radical(C2CsJOH) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2][C]([O])[CH]C[C]=O(10753)',
    structure = SMILES('[CH2][C]([O])[CH]C[C]=O'),
    E0 = (555.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,392.829,392.832,2480.77],'cm^-1')),
        HinderedRotor(inertia=(0.00109242,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0709802,'amu*angstrom^2'), symmetry=1, barrier=(7.77284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0709825,'amu*angstrom^2'), symmetry=1, barrier=(7.77286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0709808,'amu*angstrom^2'), symmetry=1, barrier=(7.77287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.697942,0.0795925,-0.000128142,1.09634e-07,-3.63955e-11,66873.7,31.272], Tmin=(100,'K'), Tmax=(862.875,'K')), NASAPolynomial(coeffs=[9.42145,0.0259768,-1.20319e-05,2.22896e-09,-1.49868e-13,65858.8,-6.68491], Tmin=(862.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(555.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CCCJ=O) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])C[CH][C]=O(10754)',
    structure = SMILES('[CH2][C]([O])C[CH][C]=O'),
    E0 = (522.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,360,370,350,377.716,377.718,377.724],'cm^-1')),
        HinderedRotor(inertia=(0.00118159,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0843101,'amu*angstrom^2'), symmetry=1, barrier=(8.53563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0843077,'amu*angstrom^2'), symmetry=1, barrier=(8.53565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.012263,'amu*angstrom^2'), symmetry=1, barrier=(66.9271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662619,0.0785009,-0.000119497,9.68772e-08,-3.06914e-11,62983.3,28.6636], Tmin=(100,'K'), Tmax=(871.669,'K')), NASAPolynomial(coeffs=[10.6387,0.0239224,-1.04338e-05,1.88277e-09,-1.24879e-13,61578.4,-16.1773], Tmin=(871.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(522.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C2CsJOH) + radical(CJCO) + radical(CCJCHO) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH][C]([O])CC[C]=O(10757)',
    structure = SMILES('[CH][C]([O])CC[C]=O'),
    E0 = (591.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.617057,0.0825137,-0.000136006,1.19022e-07,-4.0239e-11,71292.4,29.4359], Tmin=(100,'K'), Tmax=(862.136,'K')), NASAPolynomial(coeffs=[8.88315,0.0280718,-1.32891e-05,2.48023e-09,-1.67295e-13,70465.1,-5.74895], Tmin=(862.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJ2_triplet) + radical(C2CsJOH) + radical(CCCJ=O) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])=CC[C]=O(10743)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(30.4204,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
Exact match found for rate rule [Cd_R;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 28.3 to 30.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(106.033,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 104.3 to 106.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([O])[CH]C[C]=O(10745)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([O])CC[C]=O(10165)'],
    products = ['[CH2]C([O])C[CH][C]=O(10747)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([O])CC[C]=O(10165)'],
    products = ['[CH2][C](O)[CH]C[C]=O(10749)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])CC[C]=O(10165)'],
    products = ['[CH2][C](O)C[CH][C]=O(10751)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]([O])[CH]C[C]=O(10753)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]([O])C[CH][C]=O(10754)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[C]([CH2])[O](732)', '[C-]#[O+](374)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C][O](2305)', '[CH2]C[C]=O(3064)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=O(1149)', '[CH2]C[C]([CH2])[O](732)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH][C]([O])CC[C]=O(10757)'],
    products = ['[CH2][C]([O])CC[C]=O(10165)'],
