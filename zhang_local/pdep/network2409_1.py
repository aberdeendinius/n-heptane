species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52329,0.0475756,-3.40876e-05,5.49334e-09,2.63757e-12,13440,24.2664], Tmin=(100,'K'), Tmax=(982.326,'K')), NASAPolynomial(coeffs=[13.4597,0.0136786,-4.78593e-06,8.4909e-10,-5.94572e-14,10385.2,-36.719], Tmin=(982.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH]=C(C)OOO(11348)',
    structure = SMILES('[CH]=C(C)OOO'),
    E0 = (199.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50158,0.0503157,-4.64139e-05,2.17347e-08,-4.0388e-12,24044,24.7538], Tmin=(100,'K'), Tmax=(1299.76,'K')), NASAPolynomial(coeffs=[12.8031,0.0155352,-6.27499e-06,1.14672e-09,-7.88232e-14,21106.1,-32.7326], Tmin=(1299.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C=C(C)OO[O](11349)',
    structure = SMILES('C=C(C)OO[O]'),
    E0 = (104.042,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80434,0.0436104,-3.58971e-05,1.55619e-08,-2.7243e-12,12596.2,24.0232], Tmin=(100,'K'), Tmax=(1362.7,'K')), NASAPolynomial(coeffs=[10.9403,0.0167936,-6.37886e-06,1.12107e-09,-7.50351e-14,10106.3,-22.8799], Tmin=(1362.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (322.721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'OOO[C]1CC1(11350)',
    structure = SMILES('OOO[C]1CC1'),
    E0 = (163.708,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97162,0.0334421,7.44115e-06,-3.51692e-08,1.60354e-11,19772.5,21.5342], Tmin=(100,'K'), Tmax=(985.845,'K')), NASAPolynomial(coeffs=[12.8628,0.0157443,-5.94001e-06,1.13819e-09,-8.42844e-14,16337.7,-37.3834], Tmin=(985.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + radical(C2CsJOO)"""),
)

species(
    label = '[CH2]C([CH2])OO[O](11351)',
    structure = SMILES('[CH2]C([CH2])OO[O]'),
    E0 = (394.418,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20991,0.0548805,-5.61336e-05,2.90573e-08,-5.85091e-12,47543.4,28.6654], Tmin=(100,'K'), Tmax=(1222.28,'K')), NASAPolynomial(coeffs=[14.1732,0.0124566,-4.06973e-06,6.59801e-10,-4.25324e-14,44374.5,-36.4768], Tmin=(1222.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](C)OO[O](11352)',
    structure = SMILES('[CH2][C](C)OO[O]'),
    E0 = (367.079,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76326,0.051088,-5.50442e-05,3.37252e-08,-8.55553e-12,44228.3,25.4892], Tmin=(100,'K'), Tmax=(946.163,'K')), NASAPolynomial(coeffs=[8.51839,0.0225296,-9.76857e-06,1.8236e-09,-1.26215e-13,42950,-6.72647], Tmin=(946.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsOs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOO) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=C([O])COO(10021)',
    structure = SMILES('C=C([O])COO'),
    E0 = (-152.261,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53308,0.0535122,-5.4573e-05,2.95359e-08,-6.44188e-12,-18223.3,22.0974], Tmin=(100,'K'), Tmax=(1106.3,'K')), NASAPolynomial(coeffs=[11.0292,0.0191776,-8.01989e-06,1.48263e-09,-1.02478e-13,-20324.4,-24.6753], Tmin=(1106.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)OOO(9210)'],
    products = ['[O]O(16)', 'C=C1CO1(9173)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(7.96e+12,'s^-1','*|/',1.2), n=0, Ea=(63.953,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2 used for R2OO_S;C_pri_rad_intra;OOR
...
reaction(
    label = 'reaction5',
    reactants = ['[O]O(16)', '[CH2]C(=C)[O](4273)'],
    products = ['[CH2]C(=C)OOO(9210)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.81e+12,'cm^3/(mol*s)','*|/',5), n=0, Ea=(30.8631,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using template [O_sec_rad;O_rad/NonDe] for rate rule [O_rad/OneDe;O_rad/NonDe]
Euclidian distance = 1.0
family: R_Recombination
Ea raised from 0.0 to 30.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH2]C(=C)O[O](9229)'],
    products = ['[CH2]C(=C)OOO(9210)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2]C(=C)OO[O](9183)'],
    products = ['[CH2]C(=C)OOO(9210)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])OO[O](11351)'],
    products = ['[CH2]C(=C)OOO(9210)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.94e+11,'s^-1','*|/',1.74), n=0, Ea=(75.8559,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R3OO;C_pri_rad_intra;OOH]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Cyclic_Ether_Formation"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]OOO(2459)', 'CH2(T)(28)'],
    products = ['[CH2]C(=C)OOO(9210)'],
