...
species(
    label = '[CH2]COO[C]([CH2])[O](4014)',
    structure = SMILES('[CH2]COO[C]([CH2])[O]'),
    E0 = (435.956,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.687791,0.0811336,-0.000126054,1.14157e-07,-4.16008e-11,52544.6,33.2504], Tmin=(100,'K'), Tmax=(789.697,'K')), NASAPolynomial(coeffs=[6.81853,0.037487,-1.92285e-05,3.78134e-09,-2.6565e-13,51969,7.60683], Tmin=(789.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P) + radical(CJCOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OOC([CH2])[O](4015)',
    structure = SMILES('[CH2][CH]OOC([CH2])[O]'),
    E0 = (417.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,350,500,795,815,1380,1390,370,380,2900,435,1606,1606.79],'cm^-1')),
        HinderedRotor(inertia=(0.0035716,'amu*angstrom^2'), symmetry=1, barrier=(6.53965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73404,'amu*angstrom^2'), symmetry=1, barrier=(39.869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284206,'amu*angstrom^2'), symmetry=1, barrier=(6.53444,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73373,'amu*angstrom^2'), symmetry=1, barrier=(39.8618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73394,'amu*angstrom^2'), symmetry=1, barrier=(39.8667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668315,0.0821279,-0.000129326,1.18569e-07,-4.3459e-11,50283,32.9273], Tmin=(100,'K'), Tmax=(798.481,'K')), NASAPolynomial(coeffs=[6.38438,0.0386663,-1.98271e-05,3.89079e-09,-2.72723e-13,49842.8,9.59666], Tmin=(798.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2][CH]OO[C]([CH2])O(4016)',
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459181,0.0840693,-0.000121187,9.60195e-08,-3.08239e-11,47832.7,33.516], Tmin=(100,'K'), Tmax=(759.933,'K')), NASAPolynomial(coeffs=[10.6712,0.0303188,-1.50952e-05,2.95112e-09,-2.07613e-13,46280.6,-12.948], Tmin=(759.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CJCOOH) + radical(CCsJOOC) + radical(Cs_P)"""),
)

species(
    label = '[CH2][CH]OO[C](C)[O](4017)',
    structure = SMILES('[CH2][CH]OO[C](C)[O]'),
    E0 = (408.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,350,500,795,815,360,370,350,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.000680916,'amu*angstrom^2'), symmetry=1, barrier=(2.13423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80531,'amu*angstrom^2'), symmetry=1, barrier=(41.5075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927809,'amu*angstrom^2'), symmetry=1, barrier=(2.13321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80576,'amu*angstrom^2'), symmetry=1, barrier=(41.5179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0132395,'amu*angstrom^2'), symmetry=1, barrier=(41.521,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.77941,0.0800551,-0.000126397,1.18118e-07,-4.40566e-11,49230.3,31.2205], Tmin=(100,'K'), Tmax=(799.578,'K')), NASAPolynomial(coeffs=[5.40485,0.0403255,-2.07412e-05,4.07579e-09,-2.85911e-13,49020.9,13.2563], Tmin=(799.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH) + radical(CCOJ) + radical(CCsJOOC)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34856,0.0632322,-6.21604e-05,3.3828e-08,-7.84076e-12,19294.6,28.8949], Tmin=(100,'K'), Tmax=(1007.79,'K')), NASAPolynomial(coeffs=[9.2043,0.032051,-1.57485e-05,3.12488e-09,-2.24027e-13,17711.3,-9.06519], Tmin=(1007.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C]([O])OO[C]C(4019)',
    structure = SMILES('[CH2][C]([O])OO[C]C'),
    E0 = (682.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,360,370,350,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557493,0.0841599,-0.000137351,1.23939e-07,-4.45874e-11,82259.5,30.4547], Tmin=(100,'K'), Tmax=(784.648,'K')), NASAPolynomial(coeffs=[8.30871,0.0331049,-1.76875e-05,3.52374e-09,-2.48921e-13,81398.4,-2.7968], Tmin=(784.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(682.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH) + radical(CH2_triplet) + radical(CCOJ)"""),
)

species(
    label = '[CH][C]([O])OO[CH]C(4020)',
    structure = SMILES('[CH][C]([O])OO[CH]C'),
    E0 = (642.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,350,500,795,815,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.787585,0.0804511,-0.00013297,1.25476e-07,-4.66333e-11,77403.5,30.1997], Tmin=(100,'K'), Tmax=(808.037,'K')), NASAPolynomial(coeffs=[5.62567,0.038031,-1.99356e-05,3.92921e-09,-2.75435e-13,77224.6,11.6212], Tmin=(808.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCsJOOC) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])OO[CH]C(3651)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([O])OOC=C(2135)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]OOC([CH2])[O](4015)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([O])OO[CH]C(3651)'],
    products = ['[CH2][CH]OO[C]([CH2])O(4016)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]OO[C](C)[O](4017)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH]OO[C]([CH2])[O](2148)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(32)', '[CH2][C]([O])O[O](2122)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C][O](2305)', 'C[CH]O[O](77)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH]OO[C]([CH2])[O](2591)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]([O])OO[C]C(4019)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][C]([O])OO[CH]C(4020)'],
    products = ['[CH2][C]([O])OO[CH]C(3651)'],
