...
species(
    label = '[CH2]C1([CH2])OOC1([CH2])[CH2](10269)',
    structure = SMILES('[CH2]C1([CH2])OOC1([CH2])[CH2]'),
    E0 = (689.726,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.52282,0.0986222,-0.000108559,5.83721e-08,-1.15525e-11,83173.5,36.9552], Tmin=(100,'K'), Tmax=(1472.75,'K')), NASAPolynomial(coeffs=[23.2048,0.0111596,1.20022e-06,-6.72561e-10,5.92413e-14,78091.7,-84.4389], Tmin=(1472.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH) + radical(CJCOOH) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C([CH2])([CH2])[O](11325)',
    structure = SMILES('[CH]C([CH2])([O])C([CH2])([CH2])[O]'),
    E0 = (976.017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.45345,0.12905,-0.000214482,1.77205e-07,-5.6205e-11,117575,33.8688], Tmin=(100,'K'), Tmax=(874.076,'K')), NASAPolynomial(coeffs=[17.1498,0.0277713,-1.29715e-05,2.3789e-09,-1.57823e-13,114940,-49.8495], Tmin=(874.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(976.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsOs) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CCJ2_triplet) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])C(=C)[O](9826)'],
    products = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(17.3611,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 17.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]C(=C)C([CH2])([CH2])[O](10852)'],
    products = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(114.56,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
    products = ['[CH2]C1([CH2])OOC1([CH2])[CH2](10269)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C([CH2])([CH2])[O](10855)'],
    products = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(T)(28)', '[CH2][C]([O])C([CH2])([CH2])[O](10931)'],
    products = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]C([CH2])([O])C([CH2])([CH2])[O](11325)'],
    products = ['[CH2]C([CH2])([O])C([CH2])([CH2])[O](10260)'],
