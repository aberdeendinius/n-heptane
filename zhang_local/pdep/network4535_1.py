...
species(
    label = '[CH]=C=[C]C[C]=C(21652)',
    structure = SMILES('[CH]=C=[C]C[C]=C'),
    E0 = (859.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,540,610,2055,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.759596,'amu*angstrom^2'), symmetry=1, barrier=(17.4646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.760111,'amu*angstrom^2'), symmetry=1, barrier=(17.4764,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (77.1039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69342,0.0520407,-5.7968e-05,3.73134e-08,-9.86531e-12,103455,23.5405], Tmin=(100,'K'), Tmax=(914.897,'K')), NASAPolynomial(coeffs=[8.52806,0.0221578,-8.97173e-06,1.6092e-09,-1.08504e-13,102204,-8.82445], Tmin=(914.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(859.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S) + radical(Cds_S) + radical(C=C=CJ)"""),
)
...
species(
    ...
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88044,0.0486308,-3.16094e-05,1.10825e-08,-1.71752e-12,108210,24.2874], Tmin=(100,'K'), Tmax=(1376.51,'K')), NASAPolynomial(coeffs=[7.40561,0.0325751,-1.41134e-05,2.60888e-09,-1.78548e-13,106689,-4.13394], Tmin=(1376.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(899.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]=C=[C]C[C]=C(21652)'],
    products = ['[CH][C]=CC[C]=C(19650)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH][C]=CC[C]=C(19650)'],
    products = ['[CH]=C=[C]C[CH][CH2](21453)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH][C]=[C]C[C]=C(21654)'],
    products = ['[CH][C]=CC[C]=C(19650)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[C]=C(584)', '[CH][C]=C[CH2](21221)'],
    products = ['[CH][C]=CC[C]=C(19650)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C]=C(584)', '[CH]=C=C[CH2](5317)'],
    products = ['[CH][C]=CC[C]=C(19650)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[C][C]=CC[C]=C(21657)'],
    products = ['[CH][C]=CC[C]=C(19650)'],
