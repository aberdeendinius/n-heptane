species(
    label = 'C=[C]OO[C]=O(4278)',
    structure = SMILES('C=[C]OO[C]=O'),
    E0 = (151.603,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2950,3100,1380,975,1025,1650,350,500,795,815,1685,370],'cm^-1')),
        HinderedRotor(inertia=(1.78989,'amu*angstrom^2'), symmetry=1, barrier=(41.1531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79188,'amu*angstrom^2'), symmetry=1, barrier=(41.1988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79182,'amu*angstrom^2'), symmetry=1, barrier=(41.1976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C#COO[C]=O(4777)',
    structure = SMILES('C#COO[C]=O'),
    E0 = (143.375,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,750,770,3400,2100,350,500,795,815,2175,525],'cm^-1')),
...
species(
    label = '[CH]=[C]OOC=O(4779)',
    structure = SMILES('[CH]=[C]OOC=O'),
    E0 = (202.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,350,500,795,815,1685,370],'cm^-1')),
...
species(
    label = '[CH]=[C]OO[C]=O(4780)',
    structure = SMILES('[CH]=[C]OO[C]=O'),
    E0 = (398.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,1685,370,350,500,795,815,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(1.78477,'amu*angstrom^2'), symmetry=1, barrier=(41.0353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.78683,'amu*angstrom^2'), symmetry=1, barrier=(41.0827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0382,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87724,0.0397459,-3.22051e-05,6.27862e-09,2.01238e-12,48034.9,23.8344], Tmin=(100,'K'), Tmax=(1004.21,'K')), NASAPolynomial(coeffs=[14.0057,0.00558787,-2.32306e-06,4.75234e-10,-3.67898e-14,44885.4,-38.2826], Tmin=(1004.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CJO) + radical(Cds_P) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#COO[C]=O(4777)'],
    products = ['C=[C]OO[C]=O(4278)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH]=[C]OO[C]=O(4780)'],
    products = ['C=[C]OO[C]=O(4278)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]=O(1149)', 'C=[C]O[O](591)'],
    products = ['C=[C]OO[C]=O(4278)'],
