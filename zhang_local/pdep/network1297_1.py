...
species(
    label = 'CC=CC[C]=O(4367)',
    structure = SMILES('CC=CC[C]=O'),
    E0 = (30.7963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,386.868],'cm^-1')),
        HinderedRotor(inertia=(0.111632,'amu*angstrom^2'), symmetry=1, barrier=(11.856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111633,'amu*angstrom^2'), symmetry=1, barrier=(11.856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111634,'amu*angstrom^2'), symmetry=1, barrier=(11.856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]CC=C=O(4368)',
    structure = SMILES('C[CH]CC=C=O'),
    E0 = (68.9827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,247.252,1625.9],'cm^-1')),
        HinderedRotor(inertia=(0.115012,'amu*angstrom^2'), symmetry=1, barrier=(4.99004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115021,'amu*angstrom^2'), symmetry=1, barrier=(4.99011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11503,'amu*angstrom^2'), symmetry=1, barrier=(4.9901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = 'C[C]CC[C]=O(4378)',
    structure = SMILES('C[C]CC[C]=O'),
    E0 = (357.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,315.532,315.532,315.532],'cm^-1')),
        ...
        HinderedRotor(inertia=(0.14081,'amu*angstrom^2'), symmetry=1, barrier=(9.94828,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14081,'amu*angstrom^2'), symmetry=1, barrier=(9.94827,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5374,0.0576468,-6.05117e-05,3.88001e-08,-1.0693e-11,43057.9,23.4556], Tmin=(100,'K'), Tmax=(860.74,'K')), NASAPolynomial(coeffs=[7.30741,0.0308332,-1.3785e-05,2.60978e-09,-1.81894e-13,42064.6,-3.51625], Tmin=(860.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJ2_triplet) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC=CC[C]=O(4367)'],
    products = ['C[CH]CC[C]=O(4193)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C[CH]CC=C=O(4368)'],
    products = ['C[CH]CC[C]=O(4193)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C[CH][CH]C[C]=O(4372)'],
    products = ['C[CH]CC[C]=O(4193)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', 'C[CH]C[CH][C]=O(4373)'],
    products = ['C[CH]CC[C]=O(4193)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][CH]CC[C]=O(4374)'],
    products = ['C[CH]CC[C]=O(4193)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH]C(38)', '[C-]#[O+](374)'],
    products = ['C[CH]CC[C]=O(4193)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(32)', '[CH2]C[C]=O(3064)'],
    products = ['C[CH]CC[C]=O(4193)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH]C(38)', '[C]=O(1149)'],
    products = ['C[CH]CC[C]=O(4193)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH3](11)', '[CH]CC[C]=O(4298)'],
    products = ['C[CH]CC[C]=O(4193)'],
