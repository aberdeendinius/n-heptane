...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.115553,'amu*angstrom^2'), symmetry=1, barrier=(13.8752,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115609,'amu*angstrom^2'), symmetry=1, barrier=(13.8743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115599,'amu*angstrom^2'), symmetry=1, barrier=(13.8712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
...
species(
    label = '[CH]=C([O])CC(4311)',
    structure = SMILES('[CH]=C([O])CC'),
    E0 = (153.821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,318.167],'cm^-1')),
        HinderedRotor(inertia=(0.115845,'amu*angstrom^2'), symmetry=1, barrier=(8.26166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.116257,'amu*angstrom^2'), symmetry=1, barrier=(8.266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
...
species(
    label = '[CH]=C([O])C[CH2](4313)',
    structure = SMILES('[CH]=C([O])C[CH2]'),
    E0 = (359.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,267.047],'cm^-1')),
        HinderedRotor(inertia=(0.00236111,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0741614,'amu*angstrom^2'), symmetry=1, barrier=(3.80092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97248,0.0393783,-2.67173e-05,3.31603e-09,2.65783e-12,43263.5,21.103], Tmin=(100,'K'), Tmax=(959.124,'K')), NASAPolynomial(coeffs=[11.1202,0.0131549,-4.359e-06,7.40639e-10,-5.03764e-14,40960.1,-25.5078], Tmin=(959.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=C(C)OJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC(=C)[O](725)'],
    products = ['C=C(18)', 'C=C=O(598)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=C)[O](725)'],
    products = ['[CH2]C1([O])CC1(4307)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(156.975,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CC(=C)[O](4214)'],
    products = ['[CH2]CC(=C)[O](725)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C=O(598)', '[CH2][CH2](22)'],
    products = ['[CH2]CC(=C)[O](725)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(601)', '[CH2][CH2](22)'],
    products = ['[CH2]CC(=C)[O](725)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C=C([CH2])[O](4312)'],
    products = ['[CH2]CC(=C)[O](725)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]=C([O])C[CH2](4313)'],
    products = ['[CH2]CC(=C)[O](725)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(T)(63)', '[CH2]C[C]=C(4316)'],
    products = ['[CH2]CC(=C)[O](725)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[CH2]C[C]=O(3064)'],
    products = ['[CH2]CC(=C)[O](725)'],
