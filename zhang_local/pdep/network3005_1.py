species(
    label = '[CH2]OC1([O])CC1(10509)',
    structure = SMILES('[CH2]OC1([O])CC1'),
    E0 = (98.0422,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67712,0.0365048,1.57895e-05,-5.17586e-08,2.36248e-11,11888.6,20.8336], Tmin=(100,'K'), Tmax=(962.461,'K')), NASAPolynomial(coeffs=[15.7658,0.0137111,-4.41701e-06,8.40726e-10,-6.50609e-14,7520.37,-55.2012], Tmin=(962.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.0422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CsJOCH3)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84475,0.0518356,-4.82461e-05,2.68022e-08,-6.62108e-12,-4504.04,21.3971], Tmin=(100,'K'), Tmax=(931.073,'K')), NASAPolynomial(coeffs=[6.66475,0.0311285,-1.48863e-05,2.91616e-09,-2.07553e-13,-5401.6,-1.5124], Tmin=(931.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.0629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsJOC(O)C) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]OC1(O)[CH]C1(11765)',
    structure = SMILES('[CH2]OC1(O)[CH]C1'),
    E0 = (65.954,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30384,0.0333708,5.41795e-05,-1.16806e-07,5.36922e-11,8053.69,23.4017], Tmin=(100,'K'), Tmax=(915.62,'K')), NASAPolynomial(coeffs=[25.7081,-0.00543877,6.68033e-06,-1.34495e-09,8.43972e-14,742.491,-107.704], Tmin=(915.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CsJOCH3)"""),
)

species(
    label = 'COC1([O])[CH]C1(11766)',
    structure = SMILES('COC1([O])[CH]C1'),
    E0 = (110.073,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96367,0.0299686,2.89151e-05,-6.18468e-08,2.63937e-11,13325.5,21.5114], Tmin=(100,'K'), Tmax=(964.677,'K')), NASAPolynomial(coeffs=[14.3331,0.0152629,-5.10376e-06,9.74957e-10,-7.47193e-14,9236.71,-46.542], Tmin=(964.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]OC1([O])[CH]C1(11767)',
    structure = SMILES('[CH2]OC1([O])[CH]C1'),
    E0 = (297.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87035,0.0313097,2.43328e-05,-6.11118e-08,2.73977e-11,35925.2,22.6364], Tmin=(100,'K'), Tmax=(951.352,'K')), NASAPolynomial(coeffs=[16.277,0.00950422,-2.41213e-06,4.64136e-10,-3.95731e-14,31429.7,-55.3695], Tmin=(951.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CsJOCH3) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3683.95,'J/mol'), sigma=(6.41231,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=575.42 K, Pc=31.7 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)O[CH2](1834)'],
    products = ['[CH2]OC1([O])CC1(10509)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(136.105,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 133.7 to 136.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]OC1([O])CC1(10509)'],
    products = ['[CH2]OC1(O)[CH]C1(11765)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH2]OC1([O])[CH]C1(11767)'],
    products = ['[CH2]OC1([O])CC1(10509)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(28)', '[O]C1([O])CC1(3057)'],
    products = ['[CH2]OC1([O])CC1(10509)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]OC1([O])CC1(11768)'],
    products = ['[CH2]OC1([O])CC1(10509)'],
