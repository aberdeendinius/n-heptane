...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67696,0.0391761,1.58453e-06,-3.01988e-08,1.3824e-11,11893.5,20.3767], Tmin=(100,'K'), Tmax=(1028.37,'K')), NASAPolynomial(coeffs=[13.864,0.018788,-8.08203e-06,1.61328e-09,-1.19795e-13,7958.44,-45.7052], Tmin=(1028.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.1064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJCO) + radical(CJCO)"""),
)
...
species(
    label = '[CH]C([O])O[CH][CH2](1071)',
    structure = SMILES('[CH]C([O])O[CH][CH2]'),
    E0 = (592.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.915115,0.074906,-0.000122444,1.07127e-07,-3.66162e-11,71348.9,27.1616], Tmin=(100,'K'), Tmax=(836.263,'K')), NASAPolynomial(coeffs=[8.66354,0.025793,-1.2735e-05,2.43552e-09,-1.67257e-13,70474.4,-6.3151], Tmin=(836.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCsJOCs) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]OC([CH2])[O](1072)',
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.915062,0.0749067,-0.000122447,1.07131e-07,-3.66183e-11,71348.9,27.1618], Tmin=(100,'K'), Tmax=(836.243,'K')), NASAPolynomial(coeffs=[8.66364,0.0257928,-1.27349e-05,2.43549e-09,-1.67254e-13,70474.3,-6.31567], Tmin=(836.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][CH]OC=O(1004)', 'CH2(T)(28)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2][CH]OC=C(694)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([O])[O](696)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(T)(63)', '[CH2][CH]O[CH][CH2](720)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]O[CH][O](1008)', 'CH2(T)(28)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C]OC([CH2])[O](1070)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C([O])O[CH][CH2](1071)', 'H(8)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH][CH]OC([CH2])[O](1072)', 'H(8)'],
    products = ['[CH2][CH]OC([CH2])[O](711)'],
