...
species(
    label = '[C]C(=[CH])O[C]=O(21570)',
    structure = SMILES('[C]C(=[CH])O[C]=O'),
    E0 = (777.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,350,440,435,1725,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.26654,'amu*angstrom^2'), symmetry=1, barrier=(29.1202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26815,'amu*angstrom^2'), symmetry=1, barrier=(29.1572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0495,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52873,0.0568074,-8.512e-05,6.04958e-08,-1.6593e-11,93542.2,17.4923], Tmin=(100,'K'), Tmax=(901.032,'K')), NASAPolynomial(coeffs=[12.419,0.00845958,-4.62887e-06,9.38227e-10,-6.74604e-14,91579.8,-33.9113], Tmin=(901.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(777.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P) + radical(CJ3) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH](2815)', 'C#CO[C]=O(5349)'],
    products = ['[CH]C(=[CH])O[C]=O(19603)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[C-]#[O+](374)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[C]=O(19603)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=O(1149)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[C]=O(19603)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[C]C(=[CH])O[C]=O(21570)'],
    products = ['[CH]C(=[CH])O[C]=O(19603)'],
    transitionState = 'TS8',
