...
species(
    label = '[CH2]CC[CH][CH][O](6407)',
    structure = SMILES('[CH2]CC[CH][CH][O]'),
    E0 = (483.24,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,180,1421.71,1421.74,1421.75],'cm^-1')),
        HinderedRotor(inertia=(0.140529,'amu*angstrom^2'), symmetry=1, barrier=(3.23105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140534,'amu*angstrom^2'), symmetry=1, barrier=(3.23116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140537,'amu*angstrom^2'), symmetry=1, barrier=(3.23122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140509,'amu*angstrom^2'), symmetry=1, barrier=(3.23058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3849,0.0630734,-7.99678e-05,6.8837e-08,-2.50468e-11,58209.1,28.6318], Tmin=(100,'K'), Tmax=(792.42,'K')), NASAPolynomial(coeffs=[4.59558,0.0385726,-1.78897e-05,3.40219e-09,-2.3576e-13,57960.7,15.5321], Tmin=(792.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH][CH]CC[O](6408)',
    structure = SMILES('[CH2][CH][CH]CC[O]'),
    E0 = (491.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,180,1756.88,1757.36,1757.48],'cm^-1')),
        HinderedRotor(inertia=(0.184963,'amu*angstrom^2'), symmetry=1, barrier=(4.25266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00194086,'amu*angstrom^2'), symmetry=1, barrier=(4.25285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184925,'amu*angstrom^2'), symmetry=1, barrier=(4.25178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00194093,'amu*angstrom^2'), symmetry=1, barrier=(4.25271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88395,0.0606057,-0.000102284,1.12951e-07,-4.57835e-11,59229.9,30.0912], Tmin=(100,'K'), Tmax=(860.322,'K')), NASAPolynomial(coeffs=[-3.88166,0.0517591,-2.4697e-05,4.65768e-09,-3.17049e-13,61541.4,64.7078], Tmin=(860.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C[CH][O](854)',
    structure = SMILES('C[CH][CH]C[CH][O]'),
    E0 = (466.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1832.78,1832.88,1832.91,1833.01],'cm^-1')),
        HinderedRotor(inertia=(0.184694,'amu*angstrom^2'), symmetry=1, barrier=(4.24647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184511,'amu*angstrom^2'), symmetry=1, barrier=(4.24227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184773,'amu*angstrom^2'), symmetry=1, barrier=(4.2483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184669,'amu*angstrom^2'), symmetry=1, barrier=(4.24591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60538,0.0682681,-0.00012175,1.31145e-07,-5.16475e-11,56237.9,28.8543], Tmin=(100,'K'), Tmax=(868.938,'K')), NASAPolynomial(coeffs=[-3.15864,0.0510334,-2.43907e-05,4.57883e-09,-3.09858e-13,58544.4,59.6767], Tmin=(868.938,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(466.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = 'C[CH]C[CH][CH][O](855)',
    structure = SMILES('C[CH]C[CH][CH][O]'),
    E0 = (472.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1752.13,1752.16,1752.67],'cm^-1')),
        HinderedRotor(inertia=(0.10794,'amu*angstrom^2'), symmetry=1, barrier=(2.48175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107874,'amu*angstrom^2'), symmetry=1, barrier=(2.48024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107721,'amu*angstrom^2'), symmetry=1, barrier=(2.47671,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107686,'amu*angstrom^2'), symmetry=1, barrier=(2.47591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53493,0.0627079,-8.96335e-05,8.61382e-08,-3.28002e-11,56901.9,29.0404], Tmin=(100,'K'), Tmax=(840.97,'K')), NASAPolynomial(coeffs=[1.71354,0.0427142,-1.9825e-05,3.7294e-09,-2.55055e-13,57548.8,32.2345], Tmin=(840.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCOJ) + radical(CCsJOH) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2][CH][CH]C[CH][O](6411)',
    structure = SMILES('[CH2][CH][CH]C[CH][O]'),
    E0 = (672.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,180,1701.53,1701.62,1701.88],'cm^-1')),
        HinderedRotor(inertia=(0.19556,'amu*angstrom^2'), symmetry=1, barrier=(4.49631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.002189,'amu*angstrom^2'), symmetry=1, barrier=(4.4983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00218873,'amu*angstrom^2'), symmetry=1, barrier=(4.49708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19557,'amu*angstrom^2'), symmetry=1, barrier=(4.49654,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63773,0.0690567,-0.000132373,1.43569e-07,-5.61222e-11,80920.8,30.5248], Tmin=(100,'K'), Tmax=(875.114,'K')), NASAPolynomial(coeffs=[-3.33207,0.0486816,-2.35884e-05,4.42807e-09,-2.98564e-13,83440.6,63.2657], Tmin=(875.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(672.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ) + radical(RCCJC) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]C[CH][CH][O](6412)',
    structure = SMILES('[CH2][CH]C[CH][CH][O]'),
    E0 = (677.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,1603.08,1603.09,1603.1,1603.25],'cm^-1')),
        HinderedRotor(inertia=(0.118658,'amu*angstrom^2'), symmetry=1, barrier=(2.72819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118654,'amu*angstrom^2'), symmetry=1, barrier=(2.72809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118653,'amu*angstrom^2'), symmetry=1, barrier=(2.72807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118642,'amu*angstrom^2'), symmetry=1, barrier=(2.72782,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55897,0.0635976,-0.000100619,9.90268e-08,-3.74624e-11,81585.1,30.7405], Tmin=(100,'K'), Tmax=(854.609,'K')), NASAPolynomial(coeffs=[1.58011,0.0402921,-1.89812e-05,3.56867e-09,-2.42924e-13,82429,35.5999], Tmin=(854.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(677.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ) + radical(CCJCO) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C=CCC[O](6413)',
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10358,0.0717642,-0.000109629,9.99522e-08,-3.60389e-11,88082,27.049], Tmin=(100,'K'), Tmax=(835.624,'K')), NASAPolynomial(coeffs=[5.11889,0.0364521,-1.73561e-05,3.29189e-09,-2.25872e-13,87972.7,11.7601], Tmin=(835.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(731.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOH) + radical(RCCJ) + radical(CCOJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.142931,'amu*angstrom^2'), symmetry=1, barrier=(3.42473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142931,'amu*angstrom^2'), symmetry=1, barrier=(3.42473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142931,'amu*angstrom^2'), symmetry=1, barrier=(3.42473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142931,'amu*angstrom^2'), symmetry=1, barrier=(3.42473,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27937,0.071077,-0.000118098,1.1564e-07,-4.31022e-11,86773.7,28.4652], Tmin=(100,'K'), Tmax=(860.733,'K')), NASAPolynomial(coeffs=[2.13013,0.040784,-1.94049e-05,3.64657e-09,-2.47487e-13,87602.9,30.1561], Tmin=(860.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(720.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOH) + radical(CCOJ) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C=CC[CH][O](6403)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CC[CH][O](856)'],
    products = ['[CH2][CH]C[CH][CH]O(6409)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CC[CH][O](856)'],
    products = ['[CH2][CH][CH]C[CH]O(6410)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH][CH]C[CH][O](6411)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][CH]C[CH][CH][O](6412)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH][O](430)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C[CH2](103)', '[CH][O](751)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2][C]CC[CH][O](6415)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH2][CH]CC[C][O](6416)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH][CH]CC[CH][O](6417)'],
    products = ['[CH2][CH]CC[CH][O](856)'],
