...
species(
    label = '[CH2]C([O])=CC[CH]O(10681)',
    structure = SMILES('[CH2]C([O])=CC[CH]O'),
    E0 = (50.0859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,395.157,395.177,2966.04],'cm^-1')),
        HinderedRotor(inertia=(0.11185,'amu*angstrom^2'), symmetry=1, barrier=(12.394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111853,'amu*angstrom^2'), symmetry=1, barrier=(12.3942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11185,'amu*angstrom^2'), symmetry=1, barrier=(12.394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111851,'amu*angstrom^2'), symmetry=1, barrier=(12.3941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.39874,0.0789105,-9.70315e-05,6.30622e-08,-1.61328e-11,6153.87,29.312], Tmin=(100,'K'), Tmax=(961.323,'K')), NASAPolynomial(coeffs=[14.0987,0.0219042,-8.07914e-06,1.37296e-09,-8.95317e-14,3519.93,-36.2417], Tmin=(961.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.0859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(CCsJOH) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2][C]([O])CCC[O](10683)',
    structure = SMILES('[CH2][C]([O])CCC[O]'),
    E0 = (343.901,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481416,0.0871633,-0.000135427,1.23147e-07,-4.40556e-11,41479,30.2648], Tmin=(100,'K'), Tmax=(839.83,'K')), NASAPolynomial(coeffs=[5.81444,0.042171,-2.00755e-05,3.80224e-09,-2.60413e-13,41274.1,9.58036], Tmin=(839.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])[CH]C[CH]O(10684)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375108,0.0824588,-9.99645e-05,6.58949e-08,-1.74794e-11,38827.9,32.4172], Tmin=(100,'K'), Tmax=(917.892,'K')), NASAPolynomial(coeffs=[12.6707,0.0288772,-1.24027e-05,2.29877e-09,-1.58174e-13,36570.7,-25.8484], Tmin=(917.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOH) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C]([O])C[CH]CO(10685)',
    structure = SMILES('[CH2][C]([O])C[CH]CO'),
    E0 = (318.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.404835,0.0834972,-0.000109664,8.12083e-08,-2.44029e-11,38383.7,32.1836], Tmin=(100,'K'), Tmax=(811.16,'K')), NASAPolynomial(coeffs=[10.8924,0.0317808,-1.40298e-05,2.60992e-09,-1.7885e-13,36682.3,-16.218], Tmin=(811.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJCO) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([O])C[CH][CH]O(10686)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375108,0.0824588,-9.99645e-05,6.58949e-08,-1.74794e-11,38827.9,32.4172], Tmin=(100,'K'), Tmax=(917.892,'K')), NASAPolynomial(coeffs=[12.6707,0.0288772,-1.24027e-05,2.29877e-09,-1.58174e-13,36570.7,-25.8484], Tmin=(917.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOH) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])[CH]CCO(10687)',
    structure = SMILES('[CH2][C]([O])[CH]CCO'),
    E0 = (318.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.404839,0.0834971,-0.000109664,8.12081e-08,-2.44028e-11,38383.7,32.1835], Tmin=(100,'K'), Tmax=(811.207,'K')), NASAPolynomial(coeffs=[10.8924,0.0317808,-1.40298e-05,2.60992e-09,-1.78849e-13,36682.2,-16.218], Tmin=(811.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)[CH]C[CH]O(10688)',
    structure = SMILES('[CH2][C](O)[CH]C[CH]O'),
    E0 = (268.035,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.103732,0.097223,-0.000150671,1.24181e-07,-3.98636e-11,32378.3,33.7436], Tmin=(100,'K'), Tmax=(871.623,'K')), NASAPolynomial(coeffs=[11.7923,0.0299865,-1.32025e-05,2.39399e-09,-1.5911e-13,30784.8,-19.258], Tmin=(871.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOH) + radical(CJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'C[C]([O])[CH]C[CH]O(10689)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.261871,0.0874219,-0.000122773,9.70259e-08,-3.08508e-11,34624.5,31.6076], Tmin=(100,'K'), Tmax=(820.774,'K')), NASAPolynomial(coeffs=[10.6809,0.0323812,-1.43908e-05,2.66398e-09,-1.81093e-13,33057.8,-15.7254], Tmin=(820.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](O)C[CH][CH]O(10690)',
    structure = SMILES('[CH2][C](O)C[CH][CH]O'),
    E0 = (268.035,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.103628,0.0972217,-0.000150666,1.24173e-07,-3.986e-11,32378.3,33.7433], Tmin=(100,'K'), Tmax=(871.665,'K')), NASAPolynomial(coeffs=[11.792,0.029987,-1.32028e-05,2.39405e-09,-1.59115e-13,30784.9,-19.2566], Tmin=(871.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJCO) + radical(CCsJOH) + radical(C2CsJOH)"""),
)

species(
    label = 'C[C]([O])C[CH][CH]O(10691)',
    structure = SMILES('C[C]([O])C[CH][CH]O'),
    E0 = (286.806,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.261871,0.0874219,-0.000122773,9.70259e-08,-3.08508e-11,34624.5,31.6076], Tmin=(100,'K'), Tmax=(820.774,'K')), NASAPolynomial(coeffs=[10.6809,0.0323812,-1.43908e-05,2.66398e-09,-1.81093e-13,33057.8,-15.7254], Tmin=(820.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CCsJOH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    label = 'C[C]([O])CC[CH][O](10694)',
    structure = SMILES('C[C]([O])CC[CH][O]'),
    E0 = (312.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.394246,0.0903574,-0.000145607,1.34553e-07,-4.83082e-11,37717.4,29.4932], Tmin=(100,'K'), Tmax=(848.896,'K')), NASAPolynomial(coeffs=[5.4805,0.0429931,-2.05701e-05,3.88888e-09,-2.65424e-13,37696.9,10.7537], Tmin=(848.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CCsJOH)"""),
)
...
species(
    label = '[CH2][C]([O])[CH]C[CH]O(10695)',
    structure = SMILES('[CH2][C]([O])[CH]C[CH]O'),
    E0 = (498.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0608899,0.0932092,-0.000144708,1.19105e-07,-3.8263e-11,60078.7,32.9609], Tmin=(100,'K'), Tmax=(863.433,'K')), NASAPolynomial(coeffs=[11.6987,0.0282433,-1.26458e-05,2.31348e-09,-1.54709e-13,58481,-19.0902], Tmin=(863.433,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO) + radical(CCsJOH) + radical(C2CsJOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C]([O])C[CH][CH]O(10696)',
    structure = SMILES('[CH2][C]([O])C[CH][CH]O'),
    E0 = (498.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0608746,0.0932094,-0.000144709,1.19106e-07,-3.82636e-11,60078.7,32.9609], Tmin=(100,'K'), Tmax=(863.426,'K')), NASAPolynomial(coeffs=[11.6987,0.0282432,-1.26458e-05,2.31347e-09,-1.54708e-13,58481,-19.0904], Tmin=(863.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCO) + radical(CC(C)OJ) + radical(CCsJOH) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])=CCCO(10697)',
    structure = SMILES('[CH2]C([O])=CCCO'),
    E0 = (-130.212,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537676,0.0717416,-7.14458e-05,3.81854e-08,-8.14087e-12,-15532.5,29.2615], Tmin=(100,'K'), Tmax=(1141.43,'K')), NASAPolynomial(coeffs=[14.1945,0.0238833,-8.55364e-06,1.45262e-09,-9.55697e-14,-18650.1,-38.4313], Tmin=(1141.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2]C1([O])CCC1O(10180)',
    structure = SMILES('[CH2]C1([O])CCC1O'),
    E0 = (68.1004,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = '[CH2][C]([O])CC[C]O(10700)',
    structure = SMILES('[CH2][C]([O])CC[C]O'),
    E0 = (579.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0650969,0.0954775,-0.000146708,1.18784e-07,-3.78329e-11,69800.3,30.1002], Tmin=(100,'K'), Tmax=(834.471,'K')), NASAPolynomial(coeffs=[12.7841,0.0273929,-1.26522e-05,2.36208e-09,-1.60453e-13,67881.9,-28.21], Tmin=(834.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(579.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO) + radical(CH2_triplet) + radical(C2CsJOH)"""),
)

species(
    label = '[CH][C]([O])CC[CH]O(10701)',
    structure = SMILES('[CH][C]([O])CC[CH]O'),
    E0 = (535.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0197245,0.096127,-0.000152559,1.28473e-07,-4.20968e-11,64497.4,31.1239], Tmin=(100,'K'), Tmax=(862.558,'K')), NASAPolynomial(coeffs=[11.1598,0.0303392,-1.39036e-05,2.5649e-09,-1.72149e-13,63087.5,-18.151], Tmin=(862.558,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C([O])CC[CH][O](10042)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([O])=CC[CH]O(10681)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2][C]([O])CC=CO(10682)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])[CH]C[CH]O(10684)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]([O])C[CH]CO(10685)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([O])C[CH][CH]O(10686)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])[CH]CCO(10687)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])CC[CH]O(10177)'],
    products = ['[CH2][C](O)[CH]C[CH]O(10688)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]([O])CC[CH]O(10177)'],
    products = ['C[C]([O])[CH]C[CH]O(10689)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([O])CC[CH]O(10177)'],
    products = ['[CH2][C](O)C[CH][CH]O(10690)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]([O])CC[CH]O(10177)'],
    products = ['C[C]([O])C[CH][CH]O(10691)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C]([O])CC[CH]O(10177)'],
    products = ['[CH2][C](O)CC[CH][O](10693)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][C]([O])CC[CH][O](10047)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]([O])[CH]C[CH]O(10695)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C]([O])C[CH][CH]O(10696)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OH(D)(132)', '[CH]CC[C]([CH2])[O](10288)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C][O](2305)', '[CH2]C[CH]O(426)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C[C]([CH2])[O](732)', '[CH]O(5471)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH2][C]([O])CC[C]O(10700)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH][C]([O])CC[CH]O(10701)'],
    products = ['[CH2][C]([O])CC[CH]O(10177)'],
