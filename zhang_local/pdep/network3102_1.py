...
species(
    label = '[CH2]C([CH2])OC1=CC1(11847)',
    structure = SMILES('[CH2]C([CH2])OC1=CC1'),
    E0 = (425.826,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503156,0.0877681,-9.54323e-05,5.09414e-08,-1.04253e-11,51386.8,27.1516], Tmin=(100,'K'), Tmax=(1243.22,'K')), NASAPolynomial(coeffs=[21.7753,0.014048,-4.0241e-06,6.04517e-10,-3.76348e-14,46005,-84.5453], Tmin=(1243.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]([CH2])OC1CC1(10840)',
    structure = SMILES('[CH2][C]([CH2])OC1CC1'),
    E0 = (420.193,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C([CH2])O[C]1[CH]C1(11850)',
    structure = SMILES('[CH2]C([CH2])O[C]1[CH]C1'),
    E0 = (620.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.418814,0.0828153,-0.000105755,7.56318e-08,-2.19314e-11,74705.5,29.1483], Tmin=(100,'K'), Tmax=(839.834,'K')), NASAPolynomial(coeffs=[11.2426,0.0312637,-1.36804e-05,2.5428e-09,-1.74519e-13,72887.5,-21.1808], Tmin=(839.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C(=C)OC([CH2])[CH2](10185)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.583741,0.0964653,-0.000114662,6.88694e-08,-1.60458e-11,38200.7,27.8467], Tmin=(100,'K'), Tmax=(1059.9,'K')), NASAPolynomial(coeffs=[19.5705,0.020404,-7.01787e-06,1.16163e-09,-7.53718e-14,33928.5,-70.5581], Tmin=(1059.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(C=C(O)CJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.792696,0.0491862,2.86737e-05,-8.33214e-08,3.85624e-11,7085.76,23.6494], Tmin=(100,'K'), Tmax=(939.244,'K')), NASAPolynomial(coeffs=[21.4351,0.0152427,-3.30484e-06,5.51617e-10,-4.53106e-14,827.677,-87.3165], Tmin=(939.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(57.7914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=C(O)CJ)"""),
)
...
species(
    label = 'C1C[C]1OC1CC1(11853)',
    structure = SMILES('C1C[C]1OC1CC1'),
    E0 = (159.677,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34455,0.0438892,1.74841e-05,-5.1628e-08,2.20553e-11,19313.2,23.37], Tmin=(100,'K'), Tmax=(995.152,'K')), NASAPolynomial(coeffs=[13.792,0.0282447,-1.07683e-05,2.02262e-09,-1.4601e-13,15133,-45.1769], Tmin=(995.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + ring(Cyclopropane) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH]C([CH2])O[C]1CC1(11854)',
    structure = SMILES('[CH]C([CH2])O[C]1CC1'),
    E0 = (657.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.655224,0.07673,-8.46449e-05,5.22945e-08,-1.33062e-11,79244.7,27.0579], Tmin=(100,'K'), Tmax=(945.012,'K')), NASAPolynomial(coeffs=[11.1156,0.0324525,-1.43624e-05,2.71201e-09,-1.89005e-13,77267.7,-22.8158], Tmin=(945.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(657.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C([CH2])O[C]1CC1(11569)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])OC1=CC1(11847)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)O[C]1CC1(11848)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=CO[C]1CC1(11495)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([CH2])OC1[CH]C1(11849)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    products = ['[CH2][C](C)O[C]1CC1(11636)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([CH2])OC1CC1(10840)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    products = ['[CH2]C(C)O[C]1[CH]C1(11637)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C([CH2])O[C]1[CH]C1(11850)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][C]([CH2])O[C]1CC1(11851)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=C)OC([CH2])[CH2](10185)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])O[C]1CC1(11569)'],
    products = ['[CH2]C(C)OC1=CC1(11630)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([CH2])[O](740)', '[C]1CC1(11616)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(28)', '[CH2][CH]O[C]1CC1(11613)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C([CH2])O[C]1CC1(11854)'],
    products = ['[CH2]C([CH2])O[C]1CC1(11569)'],
