...
species(
    label = '[CH]=[C]CC(=C)OO(20596)',
    structure = SMILES('[CH]=[C]CC(=C)OO'),
    E0 = (483.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,3615,1310,387.5,850,1000,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.625555,'amu*angstrom^2'), symmetry=1, barrier=(14.3827,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.626138,'amu*angstrom^2'), symmetry=1, barrier=(14.3961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27742,'amu*angstrom^2'), symmetry=1, barrier=(6.37842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0232792,'amu*angstrom^2'), symmetry=1, barrier=(14.413,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17132,0.0661099,-7.40143e-05,4.61723e-08,-1.19333e-11,58265.1,27.9678], Tmin=(100,'K'), Tmax=(927.018,'K')), NASAPolynomial(coeffs=[9.84805,0.0286707,-1.34345e-05,2.60634e-09,-1.8442e-13,56656.4,-13.2349], Tmin=(927.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00303,0.096631,-0.000116427,6.56732e-08,-1.38606e-11,60023.6,36.8549], Tmin=(100,'K'), Tmax=(1279.3,'K')), NASAPolynomial(coeffs=[25.3817,0.00569987,8.04089e-08,-1.93899e-10,1.81037e-14,53963,-94.2375], Tmin=(1279.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(497.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(CJCOOH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC(C)([O])O[O](20601)',
    structure = SMILES('[CH]=[C]CC(C)([O])O[O]'),
    E0 = (515.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378795,0.0827771,-0.000100309,6.46982e-08,-1.67672e-11,62127.9,31.185], Tmin=(100,'K'), Tmax=(938.16,'K')), NASAPolynomial(coeffs=[13.2372,0.0279533,-1.2653e-05,2.40912e-09,-1.68565e-13,59715.2,-30.0287], Tmin=(938.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(515.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(CC(C)(O)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCC([CH2])([O])O[O](20602)',
    structure = SMILES('[CH]=CCC([CH2])([O])O[O]'),
    E0 = (491.619,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.251677,0.0821036,-9.32803e-05,5.4424e-08,-1.25807e-11,59263.5,33.1562], Tmin=(100,'K'), Tmax=(1054.56,'K')), NASAPolynomial(coeffs=[15.6458,0.0237134,-1.02271e-05,1.92032e-09,-1.33996e-13,56016.7,-41.9294], Tmin=(1054.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(ROOJ) + radical(Cds_P) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.41633,0.100091,-0.000118057,6.43029e-08,-1.29432e-11,21647.4,35.277], Tmin=(100,'K'), Tmax=(1389.79,'K')), NASAPolynomial(coeffs=[27.3896,0.00304462,1.94552e-06,-5.81387e-10,4.52499e-14,15006.1,-108.264], Tmin=(1389.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH]=C=CC(C)([O])OO(20606)',
    structure = SMILES('[CH]=C=CC(C)([O])OO'),
    E0 = (197.313,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.337304,0.0904843,-0.000104455,5.58867e-08,-1.01877e-11,23892,30.2928], Tmin=(100,'K'), Tmax=(905.98,'K')), NASAPolynomial(coeffs=[20.241,0.0147958,-4.25165e-06,6.30226e-10,-3.89936e-14,19540.8,-70.3892], Tmin=(905.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CC(C)(O)OJ) + radical(C=C=CJ)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.77763,0.0949005,-0.000104188,5.3678e-08,-9.99417e-12,38851.2,33.9315], Tmin=(100,'K'), Tmax=(1603.77,'K')), NASAPolynomial(coeffs=[24.1819,0.00476399,3.8637e-06,-1.10936e-09,8.50404e-14,33789.9,-93.3904], Tmin=(1603.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456597,0.0893971,-0.000148748,1.39766e-07,-5.09069e-11,43913.8,32.6501], Tmin=(100,'K'), Tmax=(838.509,'K')), NASAPolynomial(coeffs=[5.4085,0.0418305,-2.0823e-05,4.00241e-09,-2.75758e-13,43925.1,14.6516], Tmin=(838.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH]=C(O)CC([CH2])([O])[O](20612)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0915443,0.0925795,-0.000136756,1.11731e-07,-3.6826e-11,34768.2,31.1155], Tmin=(100,'K'), Tmax=(774.69,'K')), NASAPolynomial(coeffs=[11.0333,0.0331869,-1.61484e-05,3.11473e-09,-2.16885e-13,33159.8,-18.3178], Tmin=(774.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C[C]([CH2])OO(20613)',
    structure = SMILES('[CH]=[C]C[C]([CH2])OO'),
    E0 = (744.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1685,370,285.503],'cm^-1')),
        HinderedRotor(inertia=(0.141644,'amu*angstrom^2'), symmetry=1, barrier=(8.19306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00311499,'amu*angstrom^2'), symmetry=1, barrier=(8.19306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141644,'amu*angstrom^2'), symmetry=1, barrier=(8.19306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.713232,'amu*angstrom^2'), symmetry=1, barrier=(41.2551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.713231,'amu*angstrom^2'), symmetry=1, barrier=(41.2551,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.568459,0.0829129,-0.000128548,1.11515e-07,-3.8407e-11,89662.9,30.9253], Tmin=(100,'K'), Tmax=(822.003,'K')), NASAPolynomial(coeffs=[8.49908,0.0327537,-1.59086e-05,3.04198e-09,-2.09752e-13,88749.9,-3.40377], Tmin=(822.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(744.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C2CsJOOH) + radical(Cds_P) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH]C([O])(C[C]=[CH])OO(20614)',
    structure = SMILES('[CH]C([O])(C[C]=[CH])OO'),
    E0 = (811.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0752311,0.0892648,-0.000114513,7.41951e-08,-1.89701e-11,97764.9,32.5202], Tmin=(100,'K'), Tmax=(956.994,'K')), NASAPolynomial(coeffs=[15.8581,0.0232967,-1.11142e-05,2.1655e-09,-1.53555e-13,94744.1,-42.9294], Tmin=(956.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(811.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = '[C]=[C]CC([CH2])([O])OO(20615)',
    structure = SMILES('[C]=[C]CC([CH2])([O])OO'),
    E0 = (888.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0575201,0.092245,-0.000130176,9.49482e-08,-2.74948e-11,106994,33.5518], Tmin=(100,'K'), Tmax=(845.857,'K')), NASAPolynomial(coeffs=[14.0403,0.0261207,-1.29131e-05,2.52571e-09,-1.78219e-13,104629,-31.5661], Tmin=(845.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(888.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CC(C)(O)OJ) + radical(CJCOOH) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH]=[C]CC(=C)OO(20596)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(196.971,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 194.8 to 197.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[O]O(16)', '[CH]=[C]CC(=C)[O](17899)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH][C]=CC([CH2])(O)OO(20598)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH]=[C]CC([CH2])(O)O[O](20600)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]CC(C)([O])O[O](20601)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH]=CCC([CH2])([O])O[O](20602)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH2]C([O])(C[C]=C)O[O](18476)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH]=[C]CC([CH2])([O])[O](18607)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[O]O(16)', '[CH][C]CC(=C)[O](10625)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]=[C]CC([CH2])([O])O[O](20603)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH]=C=CC([CH2])(O)OO(20605)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['OH(D)(132)', '[CH]=[C]CC1([CH2])OO1(20607)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['OH(D)(132)', '[CH]=[C]CC1([O])CO1(17997)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['OH(D)(132)', '[CH]=C1CC([CH2])([O])O1(20608)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH]=[C]CC1(CO1)OO(20609)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
    products = ['[CH]=C(O)CC([CH2])([O])[O](20612)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(3.95074e+10,'s^-1'), n=0, Ea=(112.549,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3OOH_SS;Y_rad_out] for rate rule [R3OOH_SS;Cd_rad_out]
Euclidian distance = 1.0
family: intra_OH_migration"""),
)
...
reaction(
    label = 'reaction33',
    reactants = ['O(T)(63)', '[CH]=[C]C[C]([CH2])OO(20613)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C([CH2])([O])OO(1407)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH]C([O])(C[C]=[CH])OO(20614)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[C]=[C]CC([CH2])([O])OO(20615)'],
    products = ['[CH]=[C]CC([CH2])([O])OO(18478)'],
