...
species(
    label = '[CH]=C(O)C([CH2])[CH2](6510)',
    structure = SMILES('[CH]=C(O)C([CH2])[CH2]'),
    E0 = (394.428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3120,650,792.5,1650,3615,1277.5,1000,350,440,435,1725,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.108564,'amu*angstrom^2'), symmetry=1, barrier=(11.9519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0010893,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108725,'amu*angstrom^2'), symmetry=1, barrier=(11.9497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.762974,'amu*angstrom^2'), symmetry=1, barrier=(83.6894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.170352,0.0674091,-6.90433e-05,3.53455e-08,-6.73089e-12,47591.1,29.1529], Tmin=(100,'K'), Tmax=(1518.57,'K')), NASAPolynomial(coeffs=[16.8814,0.0107493,-5.89123e-07,-1.88578e-10,2.15346e-14,43973.4,-53.6503], Tmin=(1518.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88735,0.0345257,1.84637e-05,-4.8866e-08,2.14867e-11,50679.6,22.0911], Tmin=(100,'K'), Tmax=(954.849,'K')), NASAPolynomial(coeffs=[12.0687,0.0213196,-7.04673e-06,1.24068e-09,-8.80108e-14,47393,-33.5865], Tmin=(954.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97501,0.0262281,5.13396e-05,-9.14343e-08,3.87802e-11,4608.21,20.4574], Tmin=(100,'K'), Tmax=(935.209,'K')), NASAPolynomial(coeffs=[15.9022,0.013302,-2.73842e-06,4.44216e-10,-3.66476e-14,-36.4512,-56.7054], Tmin=(935.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.5687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18967,0.0582061,-6.16678e-05,3.85909e-08,-9.2938e-12,51909.4,22.8899], Tmin=(100,'K'), Tmax=(1217.77,'K')), NASAPolynomial(coeffs=[8.80486,0.0226902,-4.98449e-06,4.77756e-10,-1.55835e-14,50833.5,-12.152], Tmin=(1217.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.264e+11,'s^-1'), n=0.35, Ea=(155.929,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=CC(=C)[O](4214)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(O)C([CH2])[CH2](6510)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]=C([O])C([CH2])[CH2](6512)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C(=C)[O](4352)'],
    products = ['[CH2]C([CH2])[C]1CO1(6513)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C]([CH2])C([CH2])[O](6374)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', '[CH2]C=C([CH2])[O](4312)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(T)(63)', '[CH2]C([CH2])[C]=C(6420)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH]C([CH2])C(=C)[O](6517)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])[C]=O(6521)'],
    products = ['[CH2]C([CH2])C(=C)[O](4352)'],
