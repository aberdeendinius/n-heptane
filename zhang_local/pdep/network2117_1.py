...
species(
    label = '[CH2]CC(=O)O[O](8207)',
    structure = SMILES('[CH2]CC(=O)O[O]'),
    E0 = (-65.1928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,180,180,180,862.27,862.619],'cm^-1')),
        HinderedRotor(inertia=(0.00756047,'amu*angstrom^2'), symmetry=1, barrier=(3.9971,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.56294,'amu*angstrom^2'), symmetry=1, barrier=(81.919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154967,'amu*angstrom^2'), symmetry=1, barrier=(81.9328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70411,0.0444662,-3.33682e-05,9.63648e-09,-3.85222e-14,-7753.04,22.5639], Tmin=(100,'K'), Tmax=(1057.67,'K')), NASAPolynomial(coeffs=[11.9523,0.0154422,-6.01055e-06,1.09371e-09,-7.59611e-14,-10465.3,-30.0263], Tmin=(1057.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.1928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CJCC=O) + radical(C(=O)OOJ)"""),
)
...
species(
    label = 'CC[C]([O])O[O](8210)',
    structure = SMILES('CC[C]([O])O[O]'),
    E0 = (173.879,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,360,370,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,180,2206.66],'cm^-1')),
        HinderedRotor(inertia=(0.207565,'amu*angstrom^2'), symmetry=1, barrier=(4.77232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207211,'amu*angstrom^2'), symmetry=1, barrier=(4.76419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207671,'amu*angstrom^2'), symmetry=1, barrier=(4.77476,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.727,0.0575384,-9.0181e-05,8.63534e-08,-3.2556e-11,20987.3,24.4478], Tmin=(100,'K'), Tmax=(823.901,'K')), NASAPolynomial(coeffs=[3.57216,0.032733,-1.61685e-05,3.12001e-09,-2.16315e-13,21221.1,19.1675], Tmin=(823.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2][CH]C(O)O[O](8211)',
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40956,0.0620458,-9.26685e-05,7.86063e-08,-2.66712e-11,17959.5,28.1323], Tmin=(100,'K'), Tmax=(820.286,'K')), NASAPolynomial(coeffs=[7.54488,0.024971,-1.17854e-05,2.23437e-09,-1.53601e-13,17193.7,1.21599], Tmin=(820.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2][CH]C([O])OO(8212)',
    structure = SMILES('[CH2][CH]C([O])OO'),
    E0 = (222.289,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.127154,'amu*angstrom^2'), symmetry=1, barrier=(2.92353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00309608,'amu*angstrom^2'), symmetry=1, barrier=(2.94561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00303805,'amu*angstrom^2'), symmetry=1, barrier=(2.89563,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48674,0.0631909,-0.000101623,9.68051e-08,-3.6451e-11,26818,27.954], Tmin=(100,'K'), Tmax=(808.71,'K')), NASAPolynomial(coeffs=[4.45471,0.0330247,-1.69468e-05,3.3229e-09,-2.32559e-13,26844.4,17.3964], Tmin=(808.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2]C[C]([O])O[O](8214)',
    structure = SMILES('[CH2]C[C]([O])O[O]'),
    E0 = (379.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1684.66,1686.74],'cm^-1')),
        HinderedRotor(inertia=(0.225814,'amu*angstrom^2'), symmetry=1, barrier=(5.19191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.225817,'amu*angstrom^2'), symmetry=1, barrier=(5.19197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.226228,'amu*angstrom^2'), symmetry=1, barrier=(5.20143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74956,0.0584432,-0.000101201,9.92429e-08,-3.71885e-11,45670.6,26.1533], Tmin=(100,'K'), Tmax=(842.051,'K')), NASAPolynomial(coeffs=[3.4566,0.0302795,-1.53061e-05,2.95483e-09,-2.03809e-13,46094.1,22.433], Tmin=(842.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCOJ) + radical(Cs_P) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]CC1OO1(8218)',
    structure = SMILES('[CH2]CC1OO1'),
    E0 = (118.875,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40788,0.0219231,3.33702e-05,-6.58141e-08,2.92123e-11,14366.9,18.273], Tmin=(100,'K'), Tmax=(913.628,'K')), NASAPolynomial(coeffs=[13.2718,0.0085299,-7.42334e-07,1.43301e-11,-2.34129e-15,10955.6,-40.9626], Tmin=(913.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC1OOO1(8219)',
    structure = SMILES('[CH2]CC1OOO1'),
    E0 = (160.088,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31938,0.0178817,6.20883e-05,-9.5497e-08,3.77412e-11,19331.8,21.6863], Tmin=(100,'K'), Tmax=(972.365,'K')), NASAPolynomial(coeffs=[15.0057,0.0135177,-4.95365e-06,1.04837e-09,-8.56348e-14,14603.8,-50.7878], Tmin=(972.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJ)"""),
)

species(
    label = '[O]OC1CCO1(8014)',
    structure = SMILES('[O]OC1CCO1'),
    E0 = (-73.0408,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26547,0.0308608,9.89932e-06,-3.95054e-08,2.01865e-11,-8715.29,18.3835], Tmin=(100,'K'), Tmax=(858.915,'K')), NASAPolynomial(coeffs=[9.99593,0.0166622,-3.37986e-06,3.54705e-10,-1.7291e-14,-10847.5,-22.4174], Tmin=(858.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.0408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]CC([O])[O](8221)',
    structure = SMILES('[CH2]CC([O])[O]'),
    E0 = (176.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1714,1714.07],'cm^-1')),
        HinderedRotor(inertia=(0.189024,'amu*angstrom^2'), symmetry=1, barrier=(4.34604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00208405,'amu*angstrom^2'), symmetry=1, barrier=(4.34479,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49637,0.0415377,-6.70563e-05,7.45925e-08,-3.14155e-11,21222.7,21.4298], Tmin=(100,'K'), Tmax=(821.693,'K')), NASAPolynomial(coeffs=[-0.715186,0.0359716,-1.81948e-05,3.55052e-09,-2.47785e-13,22466.2,40.648], Tmin=(821.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]CC(=O)O[O](8207)'],
    products = ['[CH2]CC([O])O[O](8012)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C(18)', '[O][CH]O[O](8201)'],
    products = ['[CH2]CC([O])O[O](8012)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH2](22)', '[O]OC=O(5472)'],
    products = ['[CH2]CC([O])O[O](8012)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]CC([O])O[O](8012)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.0849,'cm^3/(mol*s)'), n=3.486, Ea=(174.24,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Estimated using template [CO-CsH_O;OJ] for rate rule [CO-CsH_O;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 170.3 to 174.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC([O])O[O](8012)'],
    products = ['C[CH]C([O])O[O](8208)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH2](22)', '[O][CH]O[O](8201)'],
    products = ['[CH2]CC([O])O[O](8012)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][CH]C([O])O[O](8213)'],
    products = ['[CH2]CC([O])O[O](8012)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C[C]([O])O[O](8214)'],
    products = ['[CH2]CC([O])O[O](8012)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC([O])O[O](8012)'],
    products = ['[CH2]CC=O(424)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([O])O[O](8012)'],
    products = ['O(T)(63)', '[CH2]CC1OO1(8218)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC([O])O[O](8012)'],
    products = ['[O]O(16)', '[CH2]C=C[O](5266)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH2]CC([O])[O](8221)'],
    products = ['[CH2]CC([O])O[O](8012)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([O])O[O](607)', 'CH2(T)(28)'],
    products = ['[CH2]CC([O])O[O](8012)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(T)(63)', '[CH2]C[CH]O[O](6576)'],
    products = ['[CH2]CC([O])O[O](8012)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]CC([O])O[O](8222)'],
    products = ['[CH2]CC([O])O[O](8012)'],
