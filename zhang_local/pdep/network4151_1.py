...
species(
    ...
    E0 = (776.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C]=[C]C([CH2])([CH2])[O](20473)',
    structure = SMILES('[CH2][C]=[C]C([CH2])([CH2])[O]'),
    E0 = (1009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625791,0.0798529,-0.000116673,9.5751e-08,-3.14789e-11,121471,31.291], Tmin=(100,'K'), Tmax=(822.99,'K')), NASAPolynomial(coeffs=[9.46864,0.0301709,-1.39039e-05,2.60643e-09,-1.78094e-13,120242,-8.26885], Tmin=(822.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]C([CH2])([O])[CH][C]=C(20474)',
    structure = SMILES('[CH]C([CH2])([O])[CH][C]=C'),
    E0 = (989.369,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146625,0.0882912,-0.000117016,8.02728e-08,-2.18105e-11,119129,27.1115], Tmin=(100,'K'), Tmax=(901.503,'K')), NASAPolynomial(coeffs=[14.4543,0.0248095,-1.13922e-05,2.16591e-09,-1.50886e-13,116550,-40.4315], Tmin=(901.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(989.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)2OJ) + radical(CCJ2_triplet) + radical(CJC(C)2O) + radical(C=CCJCO) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C#CC([CH2])([CH2])[O](20475)',
    structure = SMILES('[CH2]C#CC([CH2])([CH2])[O]'),
    E0 = (694.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2100,2250,500,550,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.388526,0.0799092,-0.000102749,6.94772e-08,-1.84567e-11,83715.9,27.9772], Tmin=(100,'K'), Tmax=(926.959,'K')), NASAPolynomial(coeffs=[13.9544,0.0213749,-8.03641e-06,1.36593e-09,-8.86171e-14,81200.7,-36.4423], Tmin=(926.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(694.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(Propargyl) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]C=[C]C([CH2])([CH2])[O](20476)',
    structure = SMILES('[CH2]C=[C]C([CH2])([CH2])[O]'),
    E0 = (771.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.850141,0.0728272,-8.25383e-05,5.29652e-08,-1.40417e-11,92859.1,30.0231], Tmin=(100,'K'), Tmax=(907.629,'K')), NASAPolynomial(coeffs=[10.2536,0.0313855,-1.40496e-05,2.65936e-09,-1.85344e-13,91152.1,-14.4317], Tmin=(907.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(771.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2][C]=[C]C([CH2])([CH2])O(20477)',
    structure = SMILES('[CH2][C]=[C]C([CH2])([CH2])O'),
    E0 = (779.895,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,3615,1277.5,1000,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.389478,0.0841278,-0.000111071,7.55651e-08,-1.90285e-11,93925.5,30.9435], Tmin=(100,'K'), Tmax=(715.934,'K')), NASAPolynomial(coeffs=[12.4806,0.0265297,-1.1254e-05,2.04156e-09,-1.37568e-13,91939.1,-25.1309], Tmin=(715.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(779.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CC(C)(O)CJ) + radical(Cds_S) + radical(Allyl_P) + radical(C=CC(C)(O)CJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=[C]C([CH2])(C)[O](20478)',
    structure = SMILES('[CH2][C]=[C]C([CH2])(C)[O]'),
    E0 = (795.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1670,1700,300,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.920781,0.0716882,-8.25817e-05,5.51727e-08,-1.53427e-11,95790.5,30.0612], Tmin=(100,'K'), Tmax=(864.877,'K')), NASAPolynomial(coeffs=[9.3978,0.0324823,-1.45846e-05,2.75873e-09,-1.9194e-13,94324.2,-9.60493], Tmin=(864.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(795.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([CH2])([O])[C]=[C]C(20479)',
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.610158,0.082568,-0.00012619,1.10712e-07,-3.83582e-11,103248,31.0648], Tmin=(100,'K'), Tmax=(843.284,'K')), NASAPolynomial(coeffs=[7.23883,0.0361129,-1.68536e-05,3.16338e-09,-2.15557e-13,102663,3.38017], Tmin=(843.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(857.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ) + radical(Cds_S)"""),
)
...
reaction(
    ...
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.75465,'m^3/(mol*s)'), n=1.70829, Ea=(50.2339,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cd_R;Y_1centerbirad] + [CO_O;YJ] for rate rule [CO_O;Y_1centerbirad]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 49.2 to 50.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH2][C]=CC(=C)[O](17897)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(34.0953,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 34.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', '[CH2]C([CH2])=C[C]=C(17959)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(56.1888,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;O_atom_triplet]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from -5.8 to 56.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH][C]=CC([CH2])(C)[O](20438)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['O(T)(63)', '[CH2][C]=C[C]([CH2])[CH2](19213)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(28)', '[CH2][C]C=C([CH2])[O](19555)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][C]=[C]C([CH2])([CH2])[O](20473)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]C([CH2])([O])[CH][C]=C(20474)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C#CC([CH2])([CH2])[O](20475)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C=[C]C([CH2])([CH2])[O](20476)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][C]=[C]C([CH2])([CH2])O(20477)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C]=[C]C([CH2])(C)[O](20478)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH2])([O])[C]=[C]C(20479)'],
    products = ['[CH2]C([CH2])([O])[CH][C]=C(18340)'],
