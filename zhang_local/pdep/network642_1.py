...
species(
    label = '[CH2]OC(=O)C([CH2])C(1881)',
    structure = SMILES('[CH2]OC(=O)C([CH2])C'),
    E0 = (-68.6821,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0781,0.0693154,-6.76228e-05,3.87916e-08,-9.65865e-12,-8159.58,25.9751], Tmin=(100,'K'), Tmax=(937.724,'K')), NASAPolynomial(coeffs=[8.35487,0.038275,-1.79696e-05,3.4909e-09,-2.47298e-13,-9524.3,-8.66323], Tmin=(937.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.6821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsJOC(O)C) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C(C)C(=O)C[O](1882)',
    structure = SMILES('[CH2]C(C)C(=O)C[O]'),
    E0 = (21.2554,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2850,1437.5,1250,1305,750,350,247.894,250.693,4000],'cm^-1')),
        HinderedRotor(inertia=(0.247259,'amu*angstrom^2'), symmetry=1, barrier=(10.8812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249772,'amu*angstrom^2'), symmetry=1, barrier=(10.8924,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.634305,'amu*angstrom^2'), symmetry=1, barrier=(28.0326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224973,'amu*angstrom^2'), symmetry=1, barrier=(10.8931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.65298,0.078714,-0.000103293,8.13289e-08,-2.65161e-11,2672.13,28.2049], Tmin=(100,'K'), Tmax=(783.644,'K')), NASAPolynomial(coeffs=[8.56612,0.0357607,-1.61713e-05,3.04018e-09,-2.09382e-13,1510.58,-7.54034], Tmin=(783.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.2554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18905,0.0470503,1.83898e-05,-6.73584e-08,3.34785e-11,1602.29,21.6602], Tmin=(100,'K'), Tmax=(889.179,'K')), NASAPolynomial(coeffs=[16.4546,0.0190912,-3.12601e-06,2.67467e-10,-1.31386e-14,-2721.96,-59.2447], Tmin=(889.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.3646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2][C](C)C1(O)CO1(1885)',
    structure = SMILES('[CH2][C](C)C1(O)CO1'),
    E0 = (-14.5434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.644085,0.050644,3.69228e-05,-1.13345e-07,5.80672e-11,-1606.04,24.8291], Tmin=(100,'K'), Tmax=(865.806,'K')), NASAPolynomial(coeffs=[26.0785,0.000100543,8.47686e-06,-2.11321e-09,1.5562e-13,-8520.12,-108.706], Tmin=(865.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.5434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C1(O)[CH]O1(1886)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.68415,0.0939871,-9.79193e-05,4.83054e-08,-8.42024e-12,2284.15,36.825], Tmin=(100,'K'), Tmax=(1795.96,'K')), NASAPolynomial(coeffs=[19.4079,0.00767463,5.16286e-06,-1.46387e-09,1.09203e-13,333.502,-66.0307], Tmin=(1795.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.6051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C([CH2])C1(O)CO1(1887)',
    structure = SMILES('[CH2]C([CH2])C1(O)CO1'),
    E0 = (37.9651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.20008,0.0892678,-9.241e-05,4.64624e-08,-8.27335e-12,4830.41,35.9525], Tmin=(100,'K'), Tmax=(1761.42,'K')), NASAPolynomial(coeffs=[17.3237,0.0102123,4.4787e-06,-1.39847e-09,1.07834e-13,3338.47,-54.0026], Tmin=(1761.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.9651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)C1([O])[CH]O1(1888)',
    structure = SMILES('CC(C)C1([O])[CH]O1'),
    E0 = (43.5131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.733092,0.0570419,-1.29046e-06,-5.46972e-08,3.11123e-11,5365.15,23.3056], Tmin=(100,'K'), Tmax=(879.889,'K')), NASAPolynomial(coeffs=[19.528,0.01414,-6.7362e-07,-2.17837e-10,2.14316e-14,410.932,-74.3214], Tmin=(879.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.5131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCsJO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.450053,0.0585835,8.73164e-06,-7.90386e-08,4.39754e-11,-30136.3,22.1444], Tmin=(100,'K'), Tmax=(870.289,'K')), NASAPolynomial(coeffs=[24.8178,0.00349901,5.57845e-06,-1.47974e-09,1.10006e-13,-36533,-104.413], Tmin=(870.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = 'CC1COC12CO2(1758)',
    structure = SMILES('CC1COC12CO2'),
    E0 = (-172.459,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19724,0.0394342,4.73779e-05,-9.80332e-08,4.26018e-11,-20620.8,18.845], Tmin=(100,'K'), Tmax=(945.337,'K')), NASAPolynomial(coeffs=[19.9904,0.0158339,-3.90375e-06,7.04496e-10,-5.78438e-14,-26672.7,-83.9805], Tmin=(945.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-172.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane)"""),
)

species(
    label = '[CH2]O[C]([O])C([CH2])C(1895)',
    structure = SMILES('[CH2]O[C]([O])C([CH2])C'),
    E0 = (331.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,360,370,350,217.215,811.671,1250.79,1693.36],'cm^-1')),
        HinderedRotor(inertia=(0.130809,'amu*angstrom^2'), symmetry=1, barrier=(3.54758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130809,'amu*angstrom^2'), symmetry=1, barrier=(3.54758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130809,'amu*angstrom^2'), symmetry=1, barrier=(3.54758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130809,'amu*angstrom^2'), symmetry=1, barrier=(3.54758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130809,'amu*angstrom^2'), symmetry=1, barrier=(3.54758,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.903697,0.0736085,-9.39549e-05,7.69079e-08,-2.6493e-11,39946,31.7607], Tmin=(100,'K'), Tmax=(789.703,'K')), NASAPolynomial(coeffs=[6.46095,0.0395659,-1.80974e-05,3.41802e-09,-2.35982e-13,39252.1,7.42584], Tmin=(789.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Isobutyl) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2]C(C)[C]([O])C[O](1896)',
    structure = SMILES('[CH2]C(C)[C]([O])C[O]'),
    E0 = (331.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,255.167,2639.66,2639.67,2639.67],'cm^-1')),
        HinderedRotor(inertia=(1.21566,'amu*angstrom^2'), symmetry=1, barrier=(56.1638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179006,'amu*angstrom^2'), symmetry=1, barrier=(8.26994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21563,'amu*angstrom^2'), symmetry=1, barrier=(56.1639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17902,'amu*angstrom^2'), symmetry=1, barrier=(8.27031,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676768,0.0809441,-0.000117111,1.02176e-07,-3.54307e-11,40006.4,30.4335], Tmin=(100,'K'), Tmax=(855.692,'K')), NASAPolynomial(coeffs=[5.9888,0.0402618,-1.80107e-05,3.31851e-09,-2.23866e-13,39677.6,9.02476], Tmin=(855.692,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'C[CH]C1([O])CO1(1836)',
    structure = SMILES('C[CH]C1([O])CO1'),
    E0 = (92.5145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,267.344,986.222,986.222,986.222,986.222,986.222,986.222,986.222,986.222,986.222,2325.06],'cm^-1')),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00975557,'amu*angstrom^2'), symmetry=1, barrier=(0.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78105,0.0357552,2.13797e-05,-6.58973e-08,3.31207e-11,11219.3,20.5676], Tmin=(100,'K'), Tmax=(869.215,'K')), NASAPolynomial(coeffs=[15.4678,0.010242,7.43677e-07,-4.74372e-10,3.95928e-14,7424.44,-51.6873], Tmin=(869.215,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.5145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]C(C)C1([O])CO1(1898)',
    structure = SMILES('[CH]C(C)C1([O])CO1'),
    E0 = (308.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.466873,0.0722382,-6.5889e-05,3.0834e-08,-5.37372e-12,37227.9,29.1219], Tmin=(100,'K'), Tmax=(1697.93,'K')), NASAPolynomial(coeffs=[16.3235,0.0162067,-1.83331e-06,-3.16302e-11,1.23708e-14,33901.2,-53.7768], Tmin=(1697.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C1([O])CO1(1496)'],
    products = ['O=C1CO1(1175)', 'C=CC(42)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C([CH2])C(1881)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(133.555,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 131.6 to 133.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C(=O)C[O](1882)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=C(C)C1([O])CO1(1883)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC(42)', '[O][C]1CO1(1828)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=CC1([O])CO1(1780)', '[CH3](11)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O=C1CO1(1175)', '[CH2][CH]C(44)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C1([O])CO1(1496)'],
    products = ['[CH2][C](C)C1(O)CO1(1885)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C1([O])CO1(1496)'],
    products = ['[CH2]C(C)C1(O)[CH]O1(1886)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])C1(O)CO1(1887)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]C(44)', '[O][C]1CO1(1828)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH2][CH]C1([O])CO1(1840)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C](C)C1([O])CO1(1889)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C(C)C1([O])[CH]O1(1890)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C([CH2])C1([O])CO1(1891)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)C(=C)[O](782)', 'O(S)(1732)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(S)(14)', '[CH2]CC1([O])CO1(1401)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]O[C]([O])C([CH2])C(1895)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C)[C]([O])C[O](1896)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', 'C[CH]C1([O])CO1(1836)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(T)(63)', '[CH2]C(C)[C]1CO1(1897)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C(C)C1([O])CO1(1898)'],
    products = ['[CH2]C(C)C1([O])CO1(1496)'],
...
network(
    label = '642',
    isomers = [
        '[CH2]C(C)C1([O])CO1(1496)',
    ],
    reactants = [
        ('O=C1CO1(1175)', 'C=CC(42)'),
    ],
    bathGas = {
        'N2': 0.25,
        'Ne': 0.25,
