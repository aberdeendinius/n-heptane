...
species(
    label = '[CH2]C1([O])O[CH]OO1(8742)',
    structure = SMILES('[CH2]C1([O])O[CH]OO1'),
    E0 = (151.299,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.154325,0.0567731,-5.73445e-05,2.85508e-08,-5.08159e-12,18359.7,29.3819], Tmin=(100,'K'), Tmax=(1747.17,'K')), NASAPolynomial(coeffs=[12.5975,0.00799921,1.94586e-06,-7.18093e-10,5.73544e-14,17108,-28.7312], Tmin=(1747.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(124trioxolane) + radical(OCJO) + radical(CCOJ) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C(=O)OC=O(3008)',
    structure = SMILES('[CH2]C(=O)OC=O'),
    E0 = (-328.968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,211.905,1099.01,1099.01,1099.01,1099.01,4000],'cm^-1')),
        HinderedRotor(inertia=(0.195083,'amu*angstrom^2'), symmetry=1, barrier=(6.21613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.598821,'amu*angstrom^2'), symmetry=1, barrier=(19.0806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195083,'amu*angstrom^2'), symmetry=1, barrier=(6.21613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18192,0.0457849,-4.6663e-05,2.99121e-08,-8.99437e-12,20671.6,22.9565], Tmin=(100,'K'), Tmax=(757.486,'K')), NASAPolynomial(coeffs=[5.0605,0.0305839,-1.6561e-05,3.41881e-09,-2.50385e-13,20235.5,9.86863], Tmin=(757.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_P) + radical(CJCO) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C]1O[CH]OOO1(8745)',
    structure = SMILES('[CH2][C]1O[CH]OOO1'),
    E0 = (307.399,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6475,0.0346029,2.26596e-05,-5.7414e-08,2.41046e-11,37071.4,22.4448], Tmin=(100,'K'), Tmax=(1016.65,'K')), NASAPolynomial(coeffs=[17.354,0.0137124,-6.87202e-06,1.52812e-09,-1.21648e-13,31763.7,-63.9862], Tmin=(1016.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclohexane) + radical(Cs_P) + radical(CJCOOH) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(=O)OC1OO1(8746)',
    ...
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99911,0.0378682,-1.97817e-05,1.09599e-10,2.18399e-12,-24196.1,23.7731], Tmin=(100,'K'), Tmax=(1097.38,'K')), NASAPolynomial(coeffs=[10.2252,0.0183944,-7.53036e-06,1.39491e-09,-9.72161e-14,-26634.5,-19.5612], Tmin=(1097.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-201.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + ring(dioxirane) + radical(CJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38131,0.0614422,-8.97122e-05,6.9147e-08,-2.12397e-11,29291.5,25.6375], Tmin=(100,'K'), Tmax=(798.011,'K')), NASAPolynomial(coeffs=[9.94444,0.0185181,-9.02564e-06,1.73786e-09,-1.20989e-13,27924.8,-13.7421], Tmin=(798.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[CH2]C(=O)O[C]O[O](8749)',
    ...
    molecularWeight = (102.046,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178972,0.0640929,-7.21114e-05,3.59329e-08,-6.51464e-12,33613.4,29.2269], Tmin=(100,'K'), Tmax=(1587.44,'K')), NASAPolynomial(coeffs=[21.3113,-0.00205586,2.58301e-06,-5.55096e-10,3.78972e-14,28529.4,-77.3708], Tmin=(1587.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJCO) + radical(CH2_triplet) + radical(ROOJ)"""),
)

species(
    label = '[CH]=C(O)O[CH]O[O](8750)',
    structure = SMILES('[CH]=C(O)O[CH]O[O]'),
    E0 = (162.513,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3615,1277.5,1000,3120,650,792.5,1650,350,440,435,1725,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.818989,'amu*angstrom^2'), symmetry=1, barrier=(18.8302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.821013,'amu*angstrom^2'), symmetry=1, barrier=(18.8767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.819887,'amu*angstrom^2'), symmetry=1, barrier=(18.8508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.81934,'amu*angstrom^2'), symmetry=1, barrier=(18.8382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0251613,0.0873474,-0.000127053,8.11619e-08,-1.83012e-11,19692.1,24.7177], Tmin=(100,'K'), Tmax=(841.092,'K')), NASAPolynomial(coeffs=[20.8938,0.00183249,5.4058e-07,-2.2411e-10,1.99458e-14,15679,-75.5215], Tmin=(841.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ) + radical(OCJO)"""),
)

species(
    label = '[CH]C(=O)OCO[O](8751)',
    structure = SMILES('[CH]C(=O)OCO[O]'),
    E0 = (53.8285,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28301,0.0469133,-1.59103e-05,-2.54571e-08,1.6471e-11,6583.68,26.1943], Tmin=(100,'K'), Tmax=(939.905,'K')), NASAPolynomial(coeffs=[18.6647,0.00511917,-5.63815e-07,8.20209e-11,-1.03326e-14,1894.92,-64.1462], Tmin=(939.905,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.8285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(ROOJ)"""),
)

species(
    label = '[CH]C(=O)O[CH]OO(8752)',
    structure = SMILES('[CH]C(=O)O[CH]OO'),
    E0 = (90.7839,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28164,0.0630031,-7.74336e-05,4.92582e-08,-1.25869e-11,11014,25.2427], Tmin=(100,'K'), Tmax=(949.234,'K')), NASAPolynomial(coeffs=[11.3839,0.0204331,-1.01636e-05,2.01324e-09,-1.43985e-13,9096.11,-22.9685], Tmin=(949.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.7839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(212.019,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(OCJO)"""),
)

species(
    label = '[O]OC1C[C]([O])O1(8753)',
    structure = SMILES('[O]OC1C[C]([O])O1'),
    E0 = (157.68,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09421,0.0424084,-3.43808e-05,1.12566e-08,1.26944e-12,19032.9,23.7145], Tmin=(100,'K'), Tmax=(747.784,'K')), NASAPolynomial(coeffs=[7.56806,0.0210103,-7.26901e-06,1.18199e-09,-7.50449e-14,17993.8,-2.57635], Tmin=(747.784,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + ring(Oxetane) + radical(CCOJ) + radical(Cs_P) + radical(ROOJ)"""),
)

species(
    label = '[O][C]1COO[CH]O1(8754)',
    structure = SMILES('[O][C]1COO[CH]O1'),
    E0 = (138.041,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14176,0.0593615,-6.14339e-05,3.16782e-08,-5.84588e-12,16763.5,26.4804], Tmin=(100,'K'), Tmax=(1682.14,'K')), NASAPolynomial(coeffs=[12.7887,0.00866591,2.16175e-06,-8.14168e-10,6.62941e-14,15426.3,-32.439], Tmin=(1682.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsOsHH) + ring(124trioxane) + radical(OCJO) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.24125e+11,'s^-1'), n=0.295513, Ea=(150.094,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=O)O[CH]O[O](8147)'],
    products = ['[CH2]C1([O])O[CH]OO1(8742)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.33338e+10,'s^-1'), n=0.45737, Ea=(145.136,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;multiplebond_intra;radadd_intra_O] + [R6;multiplebond_intra;radadd_intra] for rate rule [R6;carbonylbond_intra;radadd_intra_O]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Exocyclic
Ea raised from 142.2 to 145.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=O)OC=O(3008)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(40.7939,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 39.3 to 40.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=O)O[CH]O[O](8147)'],
    products = ['[CH2][C]1OC(O[O])O1(8744)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=O)O[CH]O[O](8147)'],
    products = ['[CH2][C]1O[CH]OOO1(8745)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.41956e+10,'s^-1'), n=0.267163, Ea=(301.237,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;multiplebond_intra;radadd_intra] for rate rule [R6_linear;carbonyl_intra;radadd_intra_O]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Endocyclic
Ea raised from 297.9 to 301.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=O)O[CH]O[O](8147)'],
    products = ['[CH2]C(=O)OC1OO1(8746)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=C([O])[O](1172)', '[CH]O[O](2819)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O(T)(63)', '[CH2]C(=O)O[CH][O](2592)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)', '[CH]OC([CH2])=O(4544)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(28)', '[O]O[CH]O[C]=O(8747)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C(=O)O[CH]O[O](8748)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C(=O)O[C]O[O](8749)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(O)O[CH]O[O](8750)'],
    products = ['[CH2]C(=O)O[CH]O[O](8147)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(=O)O[CH]O[O](8147)'],
    products = ['[O][C]1COO[CH]O1(8754)'],
    transitionState = 'TS22',
    kinetics = Arrhenius(A=(2.49515e+10,'s^-1'), n=0.243684, Ea=(131.879,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra;radadd_intra] for rate rule [R6_linear;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
Ea raised from 129.6 to 131.9 kJ/mol to match endothermicity of reaction."""),
)
