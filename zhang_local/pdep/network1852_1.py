...
species(
    label = '[CH2]C([CH2])C=C=O(6471)',
    structure = SMILES('[CH2]C([CH2])C=C=O'),
    E0 = (287.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2120,512.5,787.5,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.287471,'amu*angstrom^2'), symmetry=1, barrier=(6.60954,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285324,'amu*angstrom^2'), symmetry=1, barrier=(6.56016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.627706,'amu*angstrom^2'), symmetry=1, barrier=(14.4322,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09138,0.0688463,-0.000100077,8.21191e-08,-2.6872e-11,34653.6,23.2113], Tmin=(100,'K'), Tmax=(841.499,'K')), NASAPolynomial(coeffs=[8.52126,0.0264339,-1.18283e-05,2.1857e-09,-1.47944e-13,33654.4,-9.85873], Tmin=(841.499,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(CJC(C)C=C=O) + radical(CJC(C)C=C=O)"""),
)
...
species(
    label = '[CH2][C](C)C[C]=O(4325)',
    structure = SMILES('[CH2][C](C)C[C]=O'),
    E0 = (290.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3036.55],'cm^-1')),
        HinderedRotor(inertia=(0.168847,'amu*angstrom^2'), symmetry=1, barrier=(3.88213,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168889,'amu*angstrom^2'), symmetry=1, barrier=(3.88309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168451,'amu*angstrom^2'), symmetry=1, barrier=(3.87302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1678,'amu*angstrom^2'), symmetry=1, barrier=(3.85806,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53269,0.0633908,-9.8815e-05,9.33882e-08,-3.37522e-11,35024.1,26.1918], Tmin=(100,'K'), Tmax=(882.805,'K')), NASAPolynomial(coeffs=[2.61937,0.0366103,-1.6174e-05,2.93523e-09,-1.94995e-13,35683.9,25.9085], Tmin=(882.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Tertalkyl) + radical(Isobutyl) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH2]C(C)[CH][C]=O(4326)',
    structure = SMILES('[CH2]C(C)[CH][C]=O'),
    E0 = (272.647,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,1855,455,950,3025,407.5,1350,352.5,2592.82],'cm^-1')),
        HinderedRotor(inertia=(0.853665,'amu*angstrom^2'), symmetry=1, barrier=(76.6146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134645,'amu*angstrom^2'), symmetry=1, barrier=(11.8256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00248283,'amu*angstrom^2'), symmetry=1, barrier=(11.8366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.461899,'amu*angstrom^2'), symmetry=1, barrier=(76.6123,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38508,0.0522742,-4.37688e-05,2.08043e-08,-4.04955e-12,32890.4,25.3467], Tmin=(100,'K'), Tmax=(1232.68,'K')), NASAPolynomial(coeffs=[10.557,0.0225114,-7.55133e-06,1.21675e-09,-7.69674e-14,30629.2,-20.8212], Tmin=(1232.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCHO) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C(C)C[C]=O(4320)',
    structure = SMILES('C=C(C)C[C]=O'),
    E0 = (27.7668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,459.58],'cm^-1')),
        HinderedRotor(inertia=(0.0832189,'amu*angstrom^2'), symmetry=1, barrier=(12.473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0832191,'amu*angstrom^2'), symmetry=1, barrier=(12.473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.083219,'amu*angstrom^2'), symmetry=1, barrier=(12.473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH2]C(C)C=C=O(4321)',
    structure = SMILES('[CH2]C(C)C=C=O'),
    E0 = (76.2087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2120,512.5,787.5,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,294.981],'cm^-1')),
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97804,0.0339898,1.18722e-05,-3.75208e-08,1.61966e-11,7614.96,21.2305], Tmin=(100,'K'), Tmax=(988.637,'K')), NASAPolynomial(coeffs=[10.9694,0.0224625,-8.34336e-06,1.53697e-09,-1.09609e-13,4622.65,-28.1868], Tmin=(988.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(62.6318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH]C([CH2])C[C]=O(6476)',
    structure = SMILES('[CH]C([CH2])C[C]=O'),
    E0 = (553.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,265.504,265.504,2838.4,2838.4],'cm^-1')),
        HinderedRotor(inertia=(1.47447,'amu*angstrom^2'), symmetry=1, barrier=(73.7584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0129014,'amu*angstrom^2'), symmetry=1, barrier=(73.7582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0023914,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.334275,'amu*angstrom^2'), symmetry=1, barrier=(16.7214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54162,0.0569827,-6.26093e-05,3.64922e-08,-7.11006e-12,66636.5,26.0472], Tmin=(100,'K'), Tmax=(707.204,'K')), NASAPolynomial(coeffs=[8.57968,0.0246536,-9.90087e-06,1.75834e-09,-1.1756e-13,65454.1,-6.79138], Tmin=(707.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl) + radical(CCCJ=O) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=C)C[C]=O(6470)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([CH2])C=C=O(6471)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=CC[C]=O(4213)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2]C([CH2])[CH][C]=O(6473)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C-]#[O+](374)', '[CH2]C([CH2])[CH2](6116)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[C]=O(1149)', '[CH2]C([CH2])[CH2](6116)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH]C([CH2])C[C]=O(6476)'],
    products = ['[CH2]C([CH2])C[C]=O(4327)'],
