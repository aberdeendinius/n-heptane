...
species(
    label = '[CH][C]([CH2])OC[CH2](10274)',
    structure = SMILES('[CH][C]([CH2])OC[CH2]'),
    E0 = (743.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.32238,0.0930651,-0.000165566,1.51974e-07,-5.25348e-11,89520.9,27.4211], Tmin=(100,'K'), Tmax=(883.448,'K')), NASAPolynomial(coeffs=[7.48484,0.0326502,-1.54716e-05,2.85356e-09,-1.89579e-13,89347.4,-0.0651689], Tmin=(883.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(743.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJ2_triplet) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[C]([CH2])[CH2](6356)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][CH]OC([CH2])=C(6355)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(105.09,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CO[C]([CH2])[CH2](6356)'],
    products = ['[CH2][C]([CH2])O[CH]C(6323)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]OC([CH2])[CH2](761)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH]O[C]([CH2])[CH2](6357)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[O](419)', '[CH2][C][CH2](10272)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(28)', '[CH2]O[C]([CH2])[CH2](6272)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]CO[C]([CH2])[CH2](10273)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH][C]([CH2])OC[CH2](10274)'],
    products = ['[CH2]CO[C]([CH2])[CH2](6356)'],
