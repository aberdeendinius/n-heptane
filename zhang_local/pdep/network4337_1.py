...
species(
    label = '[CH]C(=[CH])C=CC(21292)',
    structure = SMILES('[CH]C(=[CH])C=CC'),
    E0 = (638.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.10428,'amu*angstrom^2'), symmetry=1, barrier=(48.3815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10447,'amu*angstrom^2'), symmetry=1, barrier=(48.3858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.10457,'amu*angstrom^2'), symmetry=1, barrier=(48.3882,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06674,0.0565495,-3.20148e-05,2.09242e-09,3.14288e-12,76856.5,21.7493], Tmin=(100,'K'), Tmax=(1033.33,'K')), NASAPolynomial(coeffs=[12.534,0.0268629,-1.02646e-05,1.83006e-09,-1.25151e-13,73701.6,-37.7479], Tmin=(1033.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(638.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08552,0.0609536,-4.70715e-05,1.95174e-08,-3.37426e-12,118773,24.2644], Tmin=(100,'K'), Tmax=(1341.95,'K')), NASAPolynomial(coeffs=[11.5433,0.0297814,-1.22276e-05,2.20721e-09,-1.49405e-13,115966,-29.2643], Tmin=(1341.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(986.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]C(=[CH])C[CH]C(21295)',
    structure = SMILES('[C]C(=[CH])C[CH]C'),
    E0 = (1031.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,352.936,352.946],'cm^-1')),
        HinderedRotor(inertia=(0.00135354,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.081539,'amu*angstrom^2'), symmetry=1, barrier=(7.20669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0815087,'amu*angstrom^2'), symmetry=1, barrier=(7.20628,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50214,0.057608,-5.77107e-05,3.43209e-08,-8.68617e-12,124168,23.6465], Tmin=(100,'K'), Tmax=(936.298,'K')), NASAPolynomial(coeffs=[8.04893,0.0296393,-1.29037e-05,2.41741e-09,-1.67703e-13,122942,-7.5071], Tmin=(936.298,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1031.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P) + radical(CJ3)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C(=[CH])C=CC(21292)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=[CH])CC=C(19670)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH](2815)', 'C#CC[CH]C(5208)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C([CH])=C[CH]C(21293)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(32)', '[CH]C([CH])=C(19930)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH3](11)', '[CH]CC([CH])=[CH](21260)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]C(=[CH])C[C]C(21294)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[C]C(=[CH])C[CH]C(21295)'],
    products = ['[CH]C(=[CH])C[CH]C(18912)'],
