...
species(
    label = '[CH2]OC(=C)C([CH2])[O](10987)',
    structure = SMILES('[CH2]OC(=C)C([CH2])[O]'),
    E0 = (248.754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,539.462,539.521,539.548,539.596],'cm^-1')),
        HinderedRotor(inertia=(0.000578941,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0696462,'amu*angstrom^2'), symmetry=1, barrier=(14.3936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0696504,'amu*angstrom^2'), symmetry=1, barrier=(14.3939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0696837,'amu*angstrom^2'), symmetry=1, barrier=(14.3944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.521097,0.0649078,-4.15936e-05,-1.40572e-09,7.48993e-12,30053.9,30.4508], Tmin=(100,'K'), Tmax=(977.087,'K')), NASAPolynomial(coeffs=[18.9889,0.0152571,-5.21339e-06,9.56559e-10,-6.99788e-14,25206.1,-64.5573], Tmin=(977.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][C](O)C1([CH2])CO1(9861)',
    structure = SMILES('[CH2][C](O)C1([CH2])CO1'),
    E0 = (257.282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,3615,1277.5,1000,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.15476,0.0892499,-0.000106199,4.12837e-08,8.35445e-12,31078.3,25.0518], Tmin=(100,'K'), Tmax=(661.467,'K')), NASAPolynomial(coeffs=[16.9055,0.0156892,-2.27827e-06,-6.82206e-11,2.67196e-14,28255.5,-53.4241], Tmin=(661.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(C2CsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1(CO1)[C](C)[O](9635)',
    structure = SMILES('[CH2]C1(CO1)[C](C)[O]'),
    E0 = (276.054,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0837215,0.0879436,-0.000116122,7.92644e-08,-2.04346e-11,33350.3,25.0051], Tmin=(100,'K'), Tmax=(1102.41,'K')), NASAPolynomial(coeffs=[15.1465,0.019128,-4.04532e-06,3.34511e-10,-6.02681e-15,30816,-46.2212], Tmin=(1102.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C]([O])C1(C)CO1(10989)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0030518,0.0817339,-9.73223e-05,6.03692e-08,-1.4182e-11,33480.7,25.5726], Tmin=(100,'K'), Tmax=(1199.87,'K')), NASAPolynomial(coeffs=[15.7506,0.0178598,-3.24856e-06,1.98078e-10,1.54186e-15,30520.6,-49.8571], Tmin=(1199.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CJCO) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])C1(C)[CH]O1(10990)',
    structure = SMILES('[CH2]C([O])C1(C)[CH]O1'),
    E0 = (284.227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.536444,0.0823596,-8.97585e-05,4.87854e-08,-9.81326e-12,34363,28.2876], Tmin=(100,'K'), Tmax=(1445.95,'K')), NASAPolynomial(coeffs=[18.9981,0.0120366,8.57079e-08,-4.26498e-10,4.19203e-14,30416,-67.2727], Tmin=(1445.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCsJO) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)C1([CH2])[CH]O1(9862)',
    structure = SMILES('[CH2]C(O)C1([CH2])[CH]O1'),
    E0 = (264.376,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.645923,0.0944352,-0.000123218,7.84718e-08,-1.84884e-11,31971.3,28.6189], Tmin=(100,'K'), Tmax=(1218.14,'K')), NASAPolynomial(coeffs=[19.6754,0.0108741,4.04619e-07,-5.28096e-10,5.28179e-14,28269.3,-68.3039], Tmin=(1218.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CJCO) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)C(C)[O](9636)',
    structure = SMILES('[CH2]C1([CH]O1)C(C)[O]'),
    E0 = (283.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2950,1000,180,180,180,180,481.495,1600,1731.73,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.136366,'amu*angstrom^2'), symmetry=1, barrier=(3.13532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136366,'amu*angstrom^2'), symmetry=1, barrier=(3.13532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136366,'amu*angstrom^2'), symmetry=1, barrier=(3.13532,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.457289,0.0867174,-0.000102555,6.05447e-08,-1.32985e-11,34225.2,27.1176], Tmin=(100,'K'), Tmax=(1304.61,'K')), NASAPolynomial(coeffs=[18.8348,0.0127417,-4.54457e-07,-3.39947e-10,3.78656e-14,30453.1,-66.2502], Tmin=(1304.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CC(C)OJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([O])C1([CH2])CO1(10991)',
    structure = SMILES('[CH2][C]([O])C1([CH2])CO1'),
    E0 = (487.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.278426,0.0858622,-0.000103331,4.21731e-08,6.08744e-12,58780.5,24.4082], Tmin=(100,'K'), Tmax=(671.113,'K')), NASAPolynomial(coeffs=[16.7527,0.01405,-1.78313e-06,-1.33921e-10,2.98749e-14,55975.2,-52.9263], Tmin=(671.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(487.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CJC(C)OC) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C1(CO1)C(=C)O(9858)',
    structure = SMILES('[CH2]C1(CO1)C(=C)O'),
    E0 = (-52.6334,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02567,0.084653,-9.349e-05,5.01104e-08,-9.70203e-12,-6127.07,28.7517], Tmin=(100,'K'), Tmax=(1556.84,'K')), NASAPolynomial(coeffs=[19.6025,0.00796665,3.218e-06,-1.07429e-09,8.65734e-14,-9679.51,-70.6794], Tmin=(1556.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.6334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1(CO1)C(C)=O(9247)',
    structure = SMILES('[CH2]C1(CO1)C(C)=O'),
    E0 = (-61.9095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,375,552.5,462.5,1710,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.182251,0.0771809,-8.8987e-05,5.4087e-08,-1.2462e-11,-7302.61,23.5091], Tmin=(100,'K'), Tmax=(1228.98,'K')), NASAPolynomial(coeffs=[14.9223,0.0180642,-3.2345e-06,1.93258e-10,1.72641e-15,-10084.2,-47.2188], Tmin=(1228.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.9095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)

species(
    label = 'C=C([O])C1(C)CO1(10992)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.609198,0.0710527,-6.67216e-05,3.22205e-08,-5.68344e-12,-14882.5,29.0358], Tmin=(100,'K'), Tmax=(1731.6,'K')), NASAPolynomial(coeffs=[14.5001,0.0151563,-1.15284e-07,-4.24644e-10,4.05855e-14,-16967.7,-43.0652], Tmin=(1731.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[CH2]C([O])[C]1CCO1(10993)',
    structure = SMILES('[CH2]C([O])[C]1CCO1'),
    E0 = (293.66,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19491,0.0598581,-4.35957e-05,6.1921e-09,6.52188e-12,35422.3,25.1394], Tmin=(100,'K'), Tmax=(785.175,'K')), NASAPolynomial(coeffs=[11.2195,0.0247401,-6.97993e-06,9.77068e-10,-5.60219e-14,33356.4,-23.9302], Tmin=(785.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(CJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C1(CO1)C1CO1(9245)',
    structure = SMILES('[CH2]C1(CO1)C1CO1'),
    E0 = (58.6287,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.498723,0.0790211,-8.69495e-05,4.9726e-08,-1.02691e-11,7230.64,24.2832], Tmin=(100,'K'), Tmax=(1490.49,'K')), NASAPolynomial(coeffs=[14.1304,0.0152717,1.85229e-06,-1.01681e-09,9.09999e-14,5589.96,-43.0072], Tmin=(1490.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.6287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C([CH2])[O](10994)',
    structure = SMILES('[CH2]O[C]([CH2])C([CH2])[O]'),
    E0 = (550.342,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.39495,0.108775,-0.000191681,1.70184e-07,-5.70946e-11,66337.6,30.9895], Tmin=(100,'K'), Tmax=(887.207,'K')), NASAPolynomial(coeffs=[10.7832,0.0312294,-1.46725e-05,2.68532e-09,-1.77138e-13,65422.6,-15.5789], Tmin=(887.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(550.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC2) + radical(CJC(C)OC) + radical(CC(C)OJ) + radical(CJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH]C1(CO1)C([CH2])[O](10996)',
    structure = SMILES('[CH]C1(CO1)C([CH2])[O]'),
    E0 = (548.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.149665,0.0790863,-9.054e-05,5.20018e-08,-1.11067e-11,66155.7,27.698], Tmin=(100,'K'), Tmax=(1348.66,'K')), NASAPolynomial(coeffs=[17.6064,0.0122578,-4.56921e-07,-3.16056e-10,3.50995e-14,62654.6,-58.4998], Tmin=(1348.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCJ2_triplet) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH]C([O])C1([CH2])CO1(10997)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142324,0.0842247,-0.000105774,6.65316e-08,-1.56149e-11,66021.2,26.7903], Tmin=(100,'K'), Tmax=(1216.28,'K')), NASAPolynomial(coeffs=[17.2298,0.0132269,-1.11382e-06,-2.07464e-10,2.95351e-14,62821,-56.2053], Tmin=(1216.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(547.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C([CH2])[O](10987)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(64.7727,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(CO1)C(=C)[O](9302)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', '[CH2]C1(C=O)CO1(9311)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(T)(63)', '[CH2]C1(C=C)CO1(9227)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2][C](O)C1([CH2])CO1(9861)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C1(CO1)[C](C)[O](9635)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2][C]([O])C1(C)CO1(10989)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C([O])C1(C)[CH]O1(10990)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C(O)C1([CH2])[CH]O1(9862)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C1([CH]O1)C(C)[O](9636)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2][C]([O])C1([CH2])CO1(10991)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C([O])C1([CH2])[CH]O1(9822)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(14)', '[CH2]C([O])C(=C)[O](1083)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C([CH2])[O](6372)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C1(CO1)C(=C)O(9858)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C1(CO1)C(C)=O(9247)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C([O])C[C]1CO1(9234)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C([O])[C]1CCO1(10993)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C1(CO1)C1CO1(9245)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]O[C]([CH2])C([CH2])[O](10994)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C([O])[C]1CO1(2272)', 'CH2(T)(28)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O(T)(63)', '[CH2][CH]C1([CH2])CO1(9363)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(28)', '[CH2]C1([CH][O])CO1(9585)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C1(CO1)C([CH2])[O](10996)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH]C([O])C1([CH2])CO1(10997)'],
    products = ['[CH2]C([O])C1([CH2])CO1(9235)'],
