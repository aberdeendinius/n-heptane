...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20838,0.066544,-9.68167e-05,8.04833e-08,-2.73124e-11,-19046.5,24.5845], Tmin=(100,'K'), Tmax=(764.266,'K')), NASAPolynomial(coeffs=[8.21338,0.0269354,-1.32959e-05,2.58462e-09,-1.8097e-13,-20031.2,-6.76446], Tmin=(764.266,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CsJOC(O)C) + radical(C=OCCJ=O)"""),
)

species(
    label = '[O]CC(=O)C[C]=O(4843)',
    structure = SMILES('[O]CC(=O)C[C]=O'),
    E0 = (-69.2196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,1855,455,950,230.22,230.228,4000],'cm^-1')),
        HinderedRotor(inertia=(0.247686,'amu*angstrom^2'), symmetry=1, barrier=(9.31657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247685,'amu*angstrom^2'), symmetry=1, barrier=(9.31657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.247691,'amu*angstrom^2'), symmetry=1, barrier=(9.31658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01397,0.0730305,-0.000121254,1.06553e-07,-3.6078e-11,-8224.7,25.9983], Tmin=(100,'K'), Tmax=(864.599,'K')), NASAPolynomial(coeffs=[8.23795,0.0247417,-1.16832e-05,2.17779e-09,-1.46693e-13,-8918.17,-4.5886], Tmin=(864.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.2196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(C=OCCJ=O)"""),
)
...
species(
    label = '[O]C1(C=C=O)CO1(4844)',
    structure = SMILES('[O]C1(C=C=O)CO1'),
    E0 = (-60.5783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,2750,3150,900,1100,3010,987.5,1337.5,450,1655,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.108125,0.0646945,-7.53112e-05,4.16563e-08,-8.20364e-12,-7127.69,24.7003], Tmin=(100,'K'), Tmax=(1554.73,'K')), NASAPolynomial(coeffs=[15.7029,0.00342621,4.20207e-06,-1.18725e-09,9.22976e-14,-9421.11,-49.1982], Tmin=(1554.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.5783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-(Cdd-O2d)CsH) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = 'O=[C]CC1(O)[CH]O1(4845)',
    structure = SMILES('O=[C]CC1(O)[CH]O1'),
    E0 = (-78.4942,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21038,0.0813295,-9.72706e-05,5.23988e-08,-9.92289e-12,-9224.3,30.5835], Tmin=(100,'K'), Tmax=(1627.54,'K')), NASAPolynomial(coeffs=[20.9406,-0.002862,7.74299e-06,-1.8481e-09,1.35009e-13,-12494.3,-74.9663], Tmin=(1627.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.4942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCCJ=O) + radical(CCsJO)"""),
)

species(
    label = 'O=[C][CH]C1(O)CO1(4846)',
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.974243,0.0742504,-8.45718e-05,4.42769e-08,-8.14425e-12,-7285.13,32.0428], Tmin=(100,'K'), Tmax=(1691.66,'K')), NASAPolynomial(coeffs=[18.0359,0.000553597,6.26506e-06,-1.56626e-09,1.15169e-13,-9603.69,-57.5069], Tmin=(1691.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.3146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = '[O]C1([CH]O1)CC=O(4847)',
    structure = SMILES('[O]C1([CH]O1)CC=O'),
    E0 = (-6.46457,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,2782.5,750,1395,475,1775,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.49625,0.0637753,-6.83088e-05,3.67417e-08,-7.35283e-12,-639.923,24.9028], Tmin=(100,'K'), Tmax=(1444.66,'K')), NASAPolynomial(coeffs=[15.5214,0.0103308,-5.20768e-07,-2.14807e-10,2.44823e-14,-3745.36,-48.8349], Tmin=(1444.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.46457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCsJO)"""),
)

species(
    label = '[O]C1([CH]O1)C[C]=O(4848)',
    structure = SMILES('[O]C1([CH]O1)C[C]=O'),
    E0 = (153.496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,1000,1855,455,950,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.538243,0.0654941,-7.94958e-05,4.67176e-08,-1.00568e-11,18595.2,25.5637], Tmin=(100,'K'), Tmax=(1357.34,'K')), NASAPolynomial(coeffs=[15.945,0.00616023,1.46931e-06,-6.10443e-10,5.29231e-14,15696,-48.7452], Tmin=(1357.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCCJ=O) + radical(CCsJO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[O]C1([CH][C]=O)CO1(4849)',
    structure = SMILES('[O]C1([CH][C]=O)CO1'),
    E0 = (169.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1855,455,950,3025,407.5,1350,352.5,180,1003.55,1003.55,1003.55,1003.55,1003.55,1003.55,1003.55,1003.55,1003.55,2319.35],'cm^-1')),
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.859268,0.0575523,-6.43457e-05,3.60927e-08,-7.45345e-12,20530.3,26.7081], Tmin=(100,'K'), Tmax=(1425.63,'K')), NASAPolynomial(coeffs=[13.7706,0.00867489,3.92471e-07,-4.0538e-10,3.84401e-14,18134.6,-35.6512], Tmin=(1425.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CCCJ=O) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16347,0.0739718,-8.13648e-05,4.13162e-08,-7.37061e-12,-35094.5,28.4279], Tmin=(100,'K'), Tmax=(1752.38,'K')), NASAPolynomial(coeffs=[17.3819,0.00199836,5.61564e-06,-1.42688e-09,1.04327e-13,-37043,-58.4607], Tmin=(1752.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-293.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-(Cdd-O2d)CsH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = '[CH2]O[C]([O])C[C]=O(4851)',
    structure = SMILES('[CH2]O[C]([O])C[C]=O'),
    E0 = (236.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,360,370,350,180,180,1767.48,1767.5],'cm^-1')),
        HinderedRotor(inertia=(0.146474,'amu*angstrom^2'), symmetry=1, barrier=(3.36773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146046,'amu*angstrom^2'), symmetry=1, barrier=(3.35788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146275,'amu*angstrom^2'), symmetry=1, barrier=(3.36315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146546,'amu*angstrom^2'), symmetry=1, barrier=(3.36938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16265,0.0745806,-0.000138194,1.36003e-07,-5.03332e-11,28492.4,29.9305], Tmin=(100,'K'), Tmax=(852.518,'K')), NASAPolynomial(coeffs=[3.94264,0.0337555,-1.74814e-05,3.38097e-09,-2.32337e-13,29028,22.8833], Tmin=(852.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(Cs_P) + radical(CsJOCH3) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C[C]([O])C[C]=O(4852)',
    structure = SMILES('[O]C[C]([O])C[C]=O'),
    E0 = (233.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,360,370,350,180,180,2121.45,2121.7],'cm^-1')),
        HinderedRotor(inertia=(0.30578,'amu*angstrom^2'), symmetry=1, barrier=(7.03049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306239,'amu*angstrom^2'), symmetry=1, barrier=(7.04103,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.306078,'amu*angstrom^2'), symmetry=1, barrier=(7.03733,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.989925,0.0812344,-0.000158779,1.57708e-07,-5.76774e-11,28147.9,28.4118], Tmin=(100,'K'), Tmax=(875.989,'K')), NASAPolynomial(coeffs=[3.26895,0.0348098,-1.76081e-05,3.33308e-09,-2.24578e-13,29130.6,25.6064], Tmin=(875.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C[C]=O(4842)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(128.931,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 127.7 to 128.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['[O]CC(=O)C[C]=O(4843)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(C=C=O)CO1(4844)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C1([CH]O1)CC=O(4847)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[O]C1([CH]O1)C[C]=O(4848)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[O]C1([CH][C]=O)CO1(4849)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', '[O]C(=O)C[C]=O(4277)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(S)(1732)', 'C=C([O])C[C]=O(4289)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]O[C]([O])C[C]=O(4851)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C-]#[O+](374)', '[CH2]C1([O])CO1(1847)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[C]=O(1149)', '[CH2]C1([O])CO1(1847)'],
    products = ['[O]C1(C[C]=O)CO1(4252)'],
