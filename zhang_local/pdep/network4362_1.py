...
species(
    label = '[CH]=C=[C]O[CH2](21374)',
    structure = SMILES('[CH]=C=[C]O[CH2]'),
    E0 = (578.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,3000,3100,440,815,1455,1000,540,610,2055,304.253],'cm^-1')),
        HinderedRotor(inertia=(0.22115,'amu*angstrom^2'), symmetry=1, barrier=(14.5263,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.522962,'amu*angstrom^2'), symmetry=1, barrier=(34.3697,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69641,0.0412563,-4.42126e-05,2.31004e-08,-4.48121e-12,69710.3,22.2207], Tmin=(100,'K'), Tmax=(1475.71,'K')), NASAPolynomial(coeffs=[12.4499,0.0049472,-2.68645e-08,-1.49324e-10,1.46206e-14,67316.3,-31.2012], Tmin=(1475.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(578.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJO) + radical(C=COCJ) + radical(C=C=CJ)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0537,0.0356965,-9.82662e-06,-1.39867e-08,8.38645e-12,74459,22.3682], Tmin=(100,'K'), Tmax=(967.204,'K')), NASAPolynomial(coeffs=[10.654,0.0166749,-5.98729e-06,1.05406e-09,-7.29347e-14,72021.4,-22.8371], Tmin=(967.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(618.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet) + radical(C=CJO) + radical(C=COCJ)"""),
)

species(
    label = '[CH][C]=[C]OC(21376)',
    structure = SMILES('[CH][C]=[C]OC'),
    E0 = (664.286,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,349.454,349.456,349.458,349.459,349.46],'cm^-1')),
        HinderedRotor(inertia=(0.589851,'amu*angstrom^2'), symmetry=1, barrier=(51.1153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589831,'amu*angstrom^2'), symmetry=1, barrier=(51.1153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589821,'amu*angstrom^2'), symmetry=1, barrier=(51.1153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82953,0.0432438,-3.573e-05,1.58825e-08,-2.87936e-12,79977,21.1627], Tmin=(100,'K'), Tmax=(1313.91,'K')), NASAPolynomial(coeffs=[10.187,0.0178007,-6.6833e-06,1.14442e-09,-7.51122e-14,77780.8,-21.4387], Tmin=(1313.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(664.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(AllylJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    label = '[CH][C]=[C]O[CH2](21377)',
    structure = SMILES('[CH][C]=[C]O[CH2]'),
    E0 = (856.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,3000,3100,440,815,1455,1000,477.864,477.867,477.868,477.871,477.871],'cm^-1')),
        HinderedRotor(inertia=(0.320114,'amu*angstrom^2'), symmetry=1, barrier=(51.8742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320111,'amu*angstrom^2'), symmetry=1, barrier=(51.8741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.32011,'amu*angstrom^2'), symmetry=1, barrier=(51.8741,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97891,0.0407744,-3.61954e-05,1.71609e-08,-3.29129e-12,103064,23.111], Tmin=(100,'K'), Tmax=(1252.26,'K')), NASAPolynomial(coeffs=[9.9096,0.0154422,-5.85197e-06,1.00713e-09,-6.6404e-14,101078,-16.9341], Tmin=(1252.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(856.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(C=CJO) + radical(AllylJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    label = '[C][C]=CO[CH2](21381)',
    structure = SMILES('[C][C]=CO[CH2]'),
    E0 = (915.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,210.88,211.791,212.077],'cm^-1')),
        HinderedRotor(inertia=(0.678224,'amu*angstrom^2'), symmetry=1, barrier=(21.7485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.681348,'amu*angstrom^2'), symmetry=1, barrier=(21.7374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14341,0.0478416,-5.25489e-05,2.6261e-08,-4.78249e-12,110206,20.3341], Tmin=(100,'K'), Tmax=(1592.57,'K')), NASAPolynomial(coeffs=[15.975,0.000469784,1.60092e-06,-3.96748e-10,2.85711e-14,106765,-54.0924], Tmin=(1592.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(915.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(CJ3) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=C=[C]O[CH2](21374)'],
    products = ['[CH][C]=CO[CH2](19071)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH][C]=[C]O[CH2](21377)'],
    products = ['[CH][C]=CO[CH2](19071)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(28)', '[CH][C]=C[O](21209)'],
    products = ['[CH][C]=CO[CH2](19071)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH][C]=CO[CH](21379)'],
    products = ['[CH][C]=CO[CH2](19071)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(28)', '[CH]=C=C[O](8556)'],
    products = ['[CH][C]=CO[CH2](19071)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[C][C]=CO[CH2](21381)'],
    products = ['[CH][C]=CO[CH2](19071)'],
