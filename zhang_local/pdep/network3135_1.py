...
species(
    label = '[CH2]CC(=O)C([CH2])([CH2])[O](12269)',
    structure = SMILES('[CH2]CC(=O)C([CH2])([CH2])[O]'),
    E0 = (389.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,180,180,180,1600,1789.43,2727.97,3200],'cm^-1')),
        HinderedRotor(inertia=(0.15805,'amu*angstrom^2'), symmetry=1, barrier=(3.63388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15805,'amu*angstrom^2'), symmetry=1, barrier=(3.63388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15805,'amu*angstrom^2'), symmetry=1, barrier=(3.63388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15805,'amu*angstrom^2'), symmetry=1, barrier=(3.63388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15805,'amu*angstrom^2'), symmetry=1, barrier=(3.63388,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15467,0.122879,-0.000202485,1.68947e-07,-5.39606e-11,47009.9,34.4483], Tmin=(100,'K'), Tmax=(889.58,'K')), NASAPolynomial(coeffs=[14.9918,0.0305517,-1.35443e-05,2.4268e-09,-1.58612e-13,44917.7,-37.1734], Tmin=(889.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJC(C)(C=O)O) + radical(CC(C)(C=O)OJ) + radical(CJCC=O) + radical(CJC(C)(C=O)O)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])C1(O)[CH]C1(12326)',
    structure = SMILES('[CH2]C([CH2])([O])C1(O)[CH]C1'),
    E0 = (442.674,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.708381,0.0955996,-0.000106565,5.90898e-08,-1.26719e-11,53417.8,32.3385], Tmin=(100,'K'), Tmax=(1151.06,'K')), NASAPolynomial(coeffs=[21.4134,0.0187258,-6.38775e-06,1.07011e-09,-7.06161e-14,48325,-77.4987], Tmin=(1151.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH2])(O)C1([O])[CH]C1(12327)',
    structure = SMILES('[CH2]C([CH2])(O)C1([O])[CH]C1'),
    E0 = (442.674,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.708381,0.0955996,-0.000106565,5.90898e-08,-1.26719e-11,53417.8,32.3385], Tmin=(100,'K'), Tmax=(1151.06,'K')), NASAPolynomial(coeffs=[21.4134,0.0187258,-6.38775e-06,1.07011e-09,-7.0616e-14,48325,-77.4987], Tmin=(1151.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCJCO) + radical(CJC(C)2O) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]C(C)([O])C1([O])[CH]C1(12328)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.137754,0.0805521,-6.59816e-05,2.04691e-08,-3.15172e-14,55432.1,31.2066], Tmin=(100,'K'), Tmax=(1008.39,'K')), NASAPolynomial(coeffs=[19.5956,0.0219153,-7.97248e-06,1.43212e-09,-1.00166e-13,50453.8,-69.1113], Tmin=(1008.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])C1([O])[CH]C1(12329)',
    structure = SMILES('[CH2]C([CH2])([O])C1([O])[CH]C1'),
    E0 = (671.59,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.380318,0.0903115,-9.97203e-05,5.48647e-08,-1.17404e-11,80936.5,31.2237], Tmin=(100,'K'), Tmax=(1148.87,'K')), NASAPolynomial(coeffs=[19.9157,0.0196474,-7.45949e-06,1.32781e-09,-9.05576e-14,76273,-69.5098], Tmin=(1148.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(671.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
species(
    label = '[O]C1(CC1)C1([O])CC1(11603)',
    structure = SMILES('[O]C1(CC1)C1([O])CC1'),
    E0 = (210.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2807.14,2864.29,2921.43,2978.57,3035.71,3092.86,3150,900,928.571,957.143,985.714,1014.29,1042.86,1071.43,1100,300,800,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4661.2,'J/mol'), sigma=(7.88271,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=728.07 K, Pc=21.59 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645499,0.0535208,1.80522e-05,-7.05511e-08,3.31643e-11,25426.7,24.9205], Tmin=(100,'K'), Tmax=(953.049,'K')), NASAPolynomial(coeffs=[21.0055,0.0182055,-5.27536e-06,9.65026e-10,-7.4873e-14,19268.9,-84.2714], Tmin=(953.049,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C1([CH2])OOC12CC2(11601)',
    structure = SMILES('[CH2]C1([CH2])OOC12CC2'),
    E0 = (424.209,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180315,0.0731061,-4.91939e-05,9.44113e-09,2.06294e-12,51167.4,27.3749], Tmin=(100,'K'), Tmax=(1058.18,'K')), NASAPolynomial(coeffs=[17.311,0.0271477,-1.06914e-05,1.97077e-09,-1.38108e-13,46489.6,-61.2119], Tmin=(1058.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C1([O])CC1(12332)',
    structure = SMILES('[CH]C([CH2])([O])C1([O])CC1'),
    E0 = (707.887,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.406082,0.0890462,-9.47484e-05,5.01528e-08,-1.03226e-11,85304.5,30.6787], Tmin=(100,'K'), Tmax=(1193.8,'K')), NASAPolynomial(coeffs=[20.3845,0.0193842,-7.2188e-06,1.27271e-09,-8.6381e-14,80340.5,-73.307], Tmin=(1193.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(707.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJC(C)2O) + radical(CCJ2_triplet) + radical(CC(C)2OJ) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C([CH2])([CH2])[O](12269)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(82.2937,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 78.9 to 82.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', 'C=C([O])C1([O])CC1(10788)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(13.5213,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 13.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(106.811,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    products = ['[CH2]C([CH2])([O])C1(O)[CH]C1(12326)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    products = ['[CH2]C([CH2])(O)C1([O])[CH]C1(12327)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    products = ['[CH2]C(C)([O])C1([O])[CH]C1(12328)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C1([O])[CH]C1(12329)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    products = ['[O]C1(CC1)C1([O])CC1(11603)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    products = ['[CH2]C1([CH2])OOC12CC2(11601)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(T)(63)', '[CH2]C([CH2])([O])[C]1CC1(12331)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C1([O])CC1(11859)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', '[CH2][C]([O])C1([O])CC1(12065)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]C([CH2])([O])C1([O])CC1(12332)'],
    products = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
