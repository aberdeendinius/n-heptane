...
species(
    label = '[CH]C(=[CH])[CH]C(=O)OO(22173)',
    structure = SMILES('[CH]C(=[CH])[CH]C(=O)OO'),
    E0 = (334.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1310,387.5,850,1000,350,440,435,1725,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.240504,0.0672511,-3.1113e-05,-1.25175e-08,9.82891e-12,40398.5,28.1719], Tmin=(100,'K'), Tmax=(1059.97,'K')), NASAPolynomial(coeffs=[20.6378,0.0214144,-1.03097e-05,2.11081e-09,-1.57373e-13,34325.2,-79.672], Tmin=(1059.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(C=CCJCO)"""),
)
...
species(
    label = '[CH]C(=[CH])CC([O])=O(21220)',
    structure = SMILES('[CH]C(=[CH])CC([O])=O'),
    E0 = (445.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01407,0.0458734,-2.23854e-05,3.10399e-09,1.21991e-13,53663.4,21.8799], Tmin=(100,'K'), Tmax=(1883.41,'K')), NASAPolynomial(coeffs=[18.4978,0.0213781,-1.12494e-05,2.12595e-09,-1.41588e-13,45589.7,-73.0302], Tmin=(1883.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C([CH])=CC([O])OO(22174)',
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.284593,0.0904873,-0.000125677,1.11612e-07,-4.09982e-11,73438.9,32.7665], Tmin=(100,'K'), Tmax=(794.816,'K')), NASAPolynomial(coeffs=[5.20338,0.0515057,-2.52594e-05,4.86363e-09,-3.38186e-13,73106.4,12.9928], Tmin=(794.816,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(609.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])CC([O])O[O](22175)',
    structure = SMILES('[CH]C(=[CH])CC([O])O[O]'),
    E0 = (651.36,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.430781,0.0872779,-0.000130907,1.16655e-07,-4.16621e-11,78460.6,32.708], Tmin=(100,'K'), Tmax=(820.704,'K')), NASAPolynomial(coeffs=[6.39918,0.0425814,-2.06898e-05,3.95314e-09,-2.72711e-13,78006.5,8.29548], Tmin=(820.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(651.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(AllylJ2_triplet) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.091352,0.0922156,-0.000116655,8.7678e-08,-2.76422e-11,70987.9,33.2998], Tmin=(100,'K'), Tmax=(765.053,'K')), NASAPolynomial(coeffs=[9.46441,0.0432057,-2.05565e-05,3.93108e-09,-2.73683e-13,69553.8,-9.40886], Tmin=(765.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(589.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet) + radical(Cs_P)"""),
)

species(
    label = '[CH]C(=[CH])C[C](O)O[O](22177)',
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158665,0.0900632,-0.000126254,9.9526e-08,-3.18136e-11,76013,33.5166], Tmin=(100,'K'), Tmax=(791.339,'K')), NASAPolynomial(coeffs=[10.8171,0.0339929,-1.5811e-05,2.97738e-09,-2.04518e-13,74394.8,-14.9754], Tmin=(791.339,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(630.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cs_P) + radical(Cds_P) + radical(ROOJ)"""),
)
...
species(
    label = '[CH]C(=[CH])C[C]([O])O[O](22178)',
    structure = SMILES('[CH]C(=[CH])C[C]([O])O[O]'),
    E0 = (856.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,360,370,350,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.44698,0.0882646,-0.000142249,1.30017e-07,-4.65225e-11,103144,33.3372], Tmin=(100,'K'), Tmax=(837.841,'K')), NASAPolynomial(coeffs=[6.29971,0.040099,-1.98101e-05,3.78375e-09,-2.59849e-13,102873,10.3728], Tmin=(837.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(856.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCOJ) + radical(Cds_P) + radical(Cs_P) + radical(ROOJ)"""),
)

species(
    label = '[CH][C]([CH])[CH]C(=O)OO(22179)',
    structure = SMILES('[CH][C]([CH])[CH]C(=O)OO'),
    E0 = (753.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,3025,407.5,1350,352.5,180,932.622,932.622,932.622,932.622,932.622,932.622,932.622,932.622,932.622,932.622,2319.43],'cm^-1')),
        HinderedRotor(inertia=(0.0530939,'amu*angstrom^2'), symmetry=1, barrier=(1.22073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0530939,'amu*angstrom^2'), symmetry=1, barrier=(1.22073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0530939,'amu*angstrom^2'), symmetry=1, barrier=(1.22073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0530939,'amu*angstrom^2'), symmetry=1, barrier=(1.22073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0530939,'amu*angstrom^2'), symmetry=1, barrier=(1.22073,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800182,0.074393,-8.97388e-05,5.7791e-08,-1.51077e-11,90795,34.2778], Tmin=(100,'K'), Tmax=(925.126,'K')), NASAPolynomial(coeffs=[11.7333,0.0271205,-1.30905e-05,2.55588e-09,-1.81213e-13,88772.1,-17.6172], Tmin=(925.126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(753.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(Tertalkyl) + radical(CCJ2_triplet) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584524,0.0889595,-0.000150876,1.46716e-07,-5.4268e-11,57019.8,32.6593], Tmin=(100,'K'), Tmax=(860.794,'K')), NASAPolynomial(coeffs=[2.47155,0.0479596,-2.32657e-05,4.38554e-09,-2.97712e-13,57889,30.7745], Tmin=(860.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])CC(=O)OO(21214)',
    structure = SMILES('[CH]C(=[CH])CC(=O)OO'),
    E0 = (217.739,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.453398,0.063348,-2.34858e-05,-1.62952e-08,1.02366e-11,26328.2,29.5163], Tmin=(100,'K'), Tmax=(1071.01,'K')), NASAPolynomial(coeffs=[18.6191,0.0252537,-1.18004e-05,2.36748e-09,-1.73863e-13,20730.8,-67.335], Tmin=(1071.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])C[C][O](21640)',
    structure = SMILES('[CH]C(=[CH])C[C][O]'),
    E0 = (1089.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,439.371,439.373,439.375,439.376,439.377,439.393],'cm^-1')),
        HinderedRotor(inertia=(0.38148,'amu*angstrom^2'), symmetry=1, barrier=(52.2592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381451,'amu*angstrom^2'), symmetry=1, barrier=(52.2587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.381462,'amu*angstrom^2'), symmetry=1, barrier=(52.2595,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29636,0.0650201,-9.30902e-05,7.96907e-08,-2.78046e-11,131077,23.6547], Tmin=(100,'K'), Tmax=(805.703,'K')), NASAPolynomial(coeffs=[6.59099,0.0308657,-1.48545e-05,2.8342e-09,-1.95828e-13,130479,0.840037], Tmin=(805.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1089.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(AllylJ2_triplet) + radical(CH2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]C(=[CH])C[C]([O])OO(22182)',
    structure = SMILES('[C]C(=[CH])C[C]([O])OO'),
    E0 = (1003.4,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1310,387.5,850,1000,360,370,350,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,298.6,298.765,1738.31],'cm^-1')),
        HinderedRotor(inertia=(0.135397,'amu*angstrom^2'), symmetry=1, barrier=(8.55974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13516,'amu*angstrom^2'), symmetry=1, barrier=(8.56289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503123,'amu*angstrom^2'), symmetry=1, barrier=(31.8462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.503485,'amu*angstrom^2'), symmetry=1, barrier=(31.8473,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.132845,0.0940196,-0.000157975,1.39597e-07,-4.833e-11,120811,31.7433], Tmin=(100,'K'), Tmax=(813.15,'K')), NASAPolynomial(coeffs=[10.4008,0.0302699,-1.59532e-05,3.13528e-09,-2.18817e-13,119579,-12.9781], Tmin=(813.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1003.4,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJ3) + radical(Cs_P) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C(=[CH])[CH]C(=O)OO(22173)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC[C]([O])OO(5384)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', '[CH]C(=[CH])CC([O])=O(21220)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C([CH])=CC([O])OO(22174)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C(=[CH])CC([O])O[O](22175)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH][C]([CH2])[CH]C(=O)OO(20546)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C([CH])=C[C](O)OO(22176)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C(=[CH])C[C](O)O[O](22177)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C(=C)C[C]([O])O[O](20545)'],
...
reaction(
    label = 'reaction13',
    reactants = ['OH(D)(132)', '[CH]C(=[CH])C[C]([O])[O](20883)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]C(=[CH])C[C]([O])O[O](22178)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][C]([CH])[CH]C(=O)OO(22179)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C(=C)[CH]C(=O)OO(20538)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C(=[CH])CC([O])([O])O(22181)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
    products = ['[CH]C(=[CH])CC(=O)OO(21214)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]O(16)', '[CH]C(=[CH])C[C][O](21640)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O][C]OO(1370)', '[CH]C([CH])=C(19930)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[C]C(=[CH])C[C]([O])OO(22182)'],
    products = ['[CH]C(=[CH])C[C]([O])OO(20547)'],
