...
species(
    ...
    E0 = (338.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,207.933],'cm^-1')),
        HinderedRotor(inertia=(0.498077,'amu*angstrom^2'), symmetry=1, barrier=(15.8893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502504,'amu*angstrom^2'), symmetry=1, barrier=(15.8892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#CO[CH2](5256)'],
    products = ['[CH]=CO[CH2](5155)'],
    transitionState = 'TS2',
