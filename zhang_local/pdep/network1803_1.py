...
species(
    label = '[CH2]C([CH2])OC1=CO1(6578)',
    structure = SMILES('[CH2]C([CH2])OC1=CO1'),
    E0 = (364.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,180,420.087,718.622,1600,1828.57,2971.43,3200],'cm^-1')),
...
species(
    label = '[CH2]C([CH2])OC1[CH]O1(6579)',
    structure = SMILES('[CH2]C([CH2])OC1[CH]O1'),
    E0 = (286.371,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.240411,0.0919362,-0.000123994,8.52902e-08,-2.2292e-11,34596.3,27.3125], Tmin=(100,'K'), Tmax=(1061.64,'K')), NASAPolynomial(coeffs=[16.3353,0.018447,-4.56772e-06,5.03829e-10,-2.03207e-14,31698.8,-50.7184], Tmin=(1061.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH2])OC1CO1(6580)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0222711,0.097635,-0.000160004,1.3476e-07,-4.23734e-11,34215.8,26.2784], Tmin=(100,'K'), Tmax=(960.017,'K')), NASAPolynomial(coeffs=[10.0798,0.0286543,-1.02094e-05,1.56129e-09,-8.9149e-14,33515.3,-15.5923], Tmin=(960.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C([CH2])O[C]1[CH]O1(6582)',
    structure = SMILES('[CH2]C([CH2])O[C]1[CH]O1'),
    E0 = (491.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2950,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.223866,0.086755,-0.000108666,5.42894e-08,-2.34838e-12,59260.8,27.0784], Tmin=(100,'K'), Tmax=(690.243,'K')), NASAPolynomial(coeffs=[16.3781,0.015774,-3.59951e-06,3.17248e-10,-6.26658e-15,56491.6,-48.7733], Tmin=(690.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.827177,0.0552134,-3.1198e-06,-5.36628e-08,3.14809e-11,-9379.21,22.2798], Tmin=(100,'K'), Tmax=(871.465,'K')), NASAPolynomial(coeffs=[20.1141,0.00962003,1.45943e-06,-6.34291e-10,5.10067e-14,-14371.1,-77.4684], Tmin=(871.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.0492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(O)CJ)"""),
)
...
species(
    label = 'C1O[C]1OC1CC1(6584)',
    structure = SMILES('C1O[C]1OC1CC1'),
    E0 = (47.3793,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5112,0.0400792,2.49345e-05,-6.89601e-08,3.269e-11,5801.78,22.9555], Tmin=(100,'K'), Tmax=(900.198,'K')), NASAPolynomial(coeffs=[15.3986,0.0176597,-3.17505e-06,3.40611e-10,-2.06248e-14,1709.6,-51.4251], Tmin=(900.198,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.3793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(Cs_P)"""),
)
...
species(
    label = '[CH]C([CH2])O[C]1CO1(6585)',
    structure = SMILES('[CH]C([CH2])O[C]1CO1'),
    E0 = (545.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.311962,0.0792034,-0.00010044,6.69515e-08,-1.71524e-11,65755,28.4545], Tmin=(100,'K'), Tmax=(1069.5,'K')), NASAPolynomial(coeffs=[14.203,0.0192967,-5.26476e-06,6.70881e-10,-3.35995e-14,63238.6,-37.3684], Tmin=(1069.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(Cs_P) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C([CH2])O[C]1CO1(1876)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=C)O[C]1CO1(6577)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([CH2])OC1=CO1(6578)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=CO[C]1CO1(1779)', 'CH2(T)(28)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    products = ['[CH2][C](C)O[C]1CO1(1874)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    products = ['[CH2]C([CH2])OC1[CH]O1(6579)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    products = ['[CH2][C]([CH2])OC1CO1(6580)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])O[C]1CO1(1876)'],
    products = ['[CH2]C(C)O[C]1[CH]O1(1875)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][C]([CH2])O[C]1CO1(6581)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C([CH2])O[C]1[CH]O1(6582)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=O)OC([CH2])[CH2](6108)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C([CH2])O[C]1CO1(6585)'],
    products = ['[CH2]C([CH2])O[C]1CO1(1876)'],
