...
species(
    label = '[CH]=C(C)C[CH2](17538)',
    structure = SMILES('[CH]=C(C)C[CH2]'),
    E0 = (396.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000],'cm^-1')),
        HinderedRotor(inertia=(0.135256,'amu*angstrom^2'), symmetry=1, barrier=(3.10981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135251,'amu*angstrom^2'), symmetry=1, barrier=(3.1097,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.574995,'amu*angstrom^2'), symmetry=1, barrier=(13.2203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66998,0.045523,-2.93065e-05,9.70565e-09,-1.3183e-12,47808.4,21.3998], Tmin=(100,'K'), Tmax=(1683.59,'K')), NASAPolynomial(coeffs=[11.4826,0.0222097,-8.53567e-06,1.48091e-09,-9.70041e-14,44504.3,-31.052], Tmin=(1683.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)CC(17539)',
    structure = SMILES('[CH]C(=C)CC'),
    E0 = (315.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,412.025,412.026,412.026,412.026],'cm^-1')),
        HinderedRotor(inertia=(0.427313,'amu*angstrom^2'), symmetry=1, barrier=(51.4784,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427312,'amu*angstrom^2'), symmetry=1, barrier=(51.4786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427313,'amu*angstrom^2'), symmetry=1, barrier=(51.4784,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78355,0.0404358,1.1254e-07,-2.19979e-08,9.51847e-12,37985.6,19.9011], Tmin=(100,'K'), Tmax=(1047.51,'K')), NASAPolynomial(coeffs=[8.84374,0.031336,-1.2432e-05,2.26279e-09,-1.56306e-13,35526.6,-19.1651], Tmin=(1047.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69826,0.0195565,3.75734e-05,-5.34682e-08,1.95833e-11,44742.7,18.7255], Tmin=(100,'K'), Tmax=(992.888,'K')), NASAPolynomial(coeffs=[5.92219,0.0291191,-1.09417e-05,1.98194e-09,-1.38236e-13,42991,-2.40268], Tmin=(992.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[11.6757,-0.0389484,0.000165772,-1.46732e-07,3.34791e-11,11679.8,-25.7859], Tmin=(100,'K'), Tmax=(1682.43,'K')), NASAPolynomial(coeffs=[63.7867,0.0339748,-7.47193e-05,1.80959e-08,-1.34556e-12,-33710.2,-387.084], Tmin=(1682.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])=C(6135)'],
    products = ['C=C(18)', 'C=C=C(6077)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC([CH2])=C(6135)'],
    products = ['[CH2]C1([CH2])CC1(17536)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(82.2381,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)C=C(6424)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH2](22)', 'C=C=C(6077)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH2](22)', '[CH2][C]=C(6078)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C=C([CH2])[CH2](6421)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C(=C)C[CH2](17540)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C([CH2])[CH2](6140)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])=C(17478)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(28)', '[CH2]C[C]=C(4316)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]CC([CH2])=C(17542)'],
    products = ['[CH2]CC([CH2])=C(6135)'],
