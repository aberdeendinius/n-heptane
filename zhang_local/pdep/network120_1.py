species(
    ...
    E0 = (-80.6218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,232.27,232.957],'cm^-1')),
        HinderedRotor(inertia=(0.157963,'amu*angstrom^2'), symmetry=1, barrier=(6.02893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15854,'amu*angstrom^2'), symmetry=1, barrier=(6.03286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15806,'amu*angstrom^2'), symmetry=1, barrier=(6.0258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.157085,'amu*angstrom^2'), symmetry=1, barrier=(6.03012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-32.2116,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,255.505,3395],'cm^-1')),
        HinderedRotor(inertia=(0.262781,'amu*angstrom^2'), symmetry=1, barrier=(12.1744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00258182,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.26273,'amu*angstrom^2'), symmetry=1, barrier=(12.1743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.826247,'amu*angstrom^2'), symmetry=1, barrier=(38.2898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.826389,'amu*angstrom^2'), symmetry=1, barrier=(38.29,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
...
species(
    label = 'CC[CH]CO[O](189)',
    structure = SMILES('CC[CH]CO[O]'),
    E0 = (119.793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,292.388,1859.46],'cm^-1')),
        HinderedRotor(inertia=(0.128105,'amu*angstrom^2'), symmetry=1, barrier=(8.24474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135562,'amu*angstrom^2'), symmetry=1, barrier=(8.24138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133663,'amu*angstrom^2'), symmetry=1, barrier=(8.24689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137909,'amu*angstrom^2'), symmetry=1, barrier=(8.24167,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C[CH]CCO[O](334)',
    structure = SMILES('C[CH]CCO[O]'),
    E0 = (113.824,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,2117.32],'cm^-1')),
        HinderedRotor(inertia=(0.210894,'amu*angstrom^2'), symmetry=1, barrier=(4.84888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210822,'amu*angstrom^2'), symmetry=1, barrier=(4.84722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210867,'amu*angstrom^2'), symmetry=1, barrier=(4.84824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210813,'amu*angstrom^2'), symmetry=1, barrier=(4.847,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = 'CCC[CH]O[O](335)',
    structure = SMILES('CCC[CH]O[O]'),
    E0 = (107.961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.119588,'amu*angstrom^2'), symmetry=1, barrier=(2.74956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120992,'amu*angstrom^2'), symmetry=1, barrier=(2.78184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120135,'amu*angstrom^2'), symmetry=1, barrier=(2.76215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481288,'amu*angstrom^2'), symmetry=1, barrier=(11.0657,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    label = '[CH2]CCCO[O](336)',
    structure = SMILES('[CH2]CCCO[O]'),
    E0 = (124.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,314.654,1633.79],'cm^-1')),
        HinderedRotor(inertia=(0.107752,'amu*angstrom^2'), symmetry=1, barrier=(7.56191,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108633,'amu*angstrom^2'), symmetry=1, barrier=(7.55405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107063,'amu*angstrom^2'), symmetry=1, barrier=(7.55577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107571,'amu*angstrom^2'), symmetry=1, barrier=(7.56266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    ...
    E0 = (-78.4264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,278.536,278.536,1801.63],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45138,0.0394546,-1.63799e-05,2.25414e-09,2.65911e-15,-9381.86,18.7269], Tmin=(100,'K'), Tmax=(2155.3,'K')), NASAPolynomial(coeffs=[16.2689,0.0211673,-8.77245e-06,1.48467e-09,-9.17788e-14,-17046.7,-62.5093], Tmin=(2155.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.4264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
