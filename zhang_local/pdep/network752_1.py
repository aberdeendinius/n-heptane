...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23005,0.0602001,-6.25752e-05,3.40201e-08,-7.41779e-12,39138.3,27.5562], Tmin=(100,'K'), Tmax=(1108.54,'K')), NASAPolynomial(coeffs=[12.2588,0.0204037,-8.72428e-06,1.63399e-09,-1.13851e-13,36693.2,-26.7874], Tmin=(1108.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CJC(O)2C) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][CH]C(C)([O])[O](2324)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99927,0.048334,-5.31906e-05,4.56079e-08,-1.79763e-11,40983,25.1012], Tmin=(100,'K'), Tmax=(725.446,'K')), NASAPolynomial(coeffs=[3.38541,0.0358298,-1.72842e-05,3.37369e-09,-2.38473e-13,40909.8,19.7404], Tmin=(725.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.109101,0.0685641,-7.33143e-05,3.72817e-08,-7.02202e-12,5480.61,27.3702], Tmin=(100,'K'), Tmax=(1510.09,'K')), NASAPolynomial(coeffs=[19.4881,0.00580739,3.71347e-07,-2.58563e-10,2.22978e-14,930.413,-69.7968], Tmin=(1510.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.2823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ)"""),
)

species(
    label = 'C=CC(C)([O])[O](2327)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30231,0.058085,-6.22373e-05,3.42982e-08,-6.81975e-12,7771.55,22.3472], Tmin=(100,'K'), Tmax=(865.312,'K')), NASAPolynomial(coeffs=[11.5179,0.0182903,-6.13029e-06,9.91756e-10,-6.31875e-14,5725.52,-27.0662], Tmin=(865.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.7985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[O]C1([O])CCC1(2089)',
    structure = SMILES('[O]C1([O])CCC1'),
    E0 = (93.216,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48238,0.0247865,2.27185e-05,-3.69516e-08,1.28084e-11,11273.1,18.6594], Tmin=(100,'K'), Tmax=(1104.7,'K')), NASAPolynomial(coeffs=[7.30992,0.0291849,-1.29612e-05,2.50844e-09,-1.78858e-13,8871.51,-11.1536], Tmin=(1104.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68587,0.0574308,-8.43723e-05,7.87439e-08,-2.97818e-11,70857.2,24.7302], Tmin=(100,'K'), Tmax=(799.465,'K')), NASAPolynomial(coeffs=[4.05212,0.0334488,-1.65931e-05,3.2249e-09,-2.25309e-13,70866.9,16.271], Tmin=(799.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(588.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])([O])C=C(2117)', 'H(8)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC(=C)[O](725)', 'O(T)(63)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC([O])=O(1842)', 'CH2(T)(28)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(7.01307,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 7.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(83.7262,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 80.6 to 83.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['C=C(18)', '[CH2][C]([O])[O](2304)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC([CH2])([O])[O](1395)'],
    products = ['[CH2][CH]C([CH2])([O])O(2323)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][CH]C([CH2])([O])[O](2325)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[C]([O])[O](2320)', 'CH2(T)(28)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])[O](2328)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C([O])([O])C[CH2](2329)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]CC([CH2])([O])[O](2330)'],
    products = ['[CH2]CC([CH2])([O])[O](1395)'],
