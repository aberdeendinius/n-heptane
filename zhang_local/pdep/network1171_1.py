...
species(
    ...
    E0 = (-46.6048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,2750,2800,2850,1350,1500,750,1050,1375,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0862051,'amu*angstrom^2'), symmetry=1, barrier=(1.98202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086022,'amu*angstrom^2'), symmetry=1, barrier=(1.97781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0858717,'amu*angstrom^2'), symmetry=1, barrier=(1.97436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8589,0.0476154,-3.47198e-05,1.40984e-08,-2.47519e-12,10926.7,18.8778], Tmin=(100,'K'), Tmax=(1281.49,'K')), NASAPolynomial(coeffs=[8.13139,0.0280367,-1.18029e-05,2.1764e-09,-1.49398e-13,9319.1,-12.9391], Tmin=(1281.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.2142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    E0 = (295.461,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,462.416,1788.46],'cm^-1')),
        HinderedRotor(inertia=(0.442706,'amu*angstrom^2'), symmetry=1, barrier=(10.1787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.578282,'amu*angstrom^2'), symmetry=1, barrier=(13.2958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00585828,'amu*angstrom^2'), symmetry=1, barrier=(13.2956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(C)=O(735)', 'H(8)'],
    products = ['[CH2]CC(C)[O](3574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C[CH][O](430)', '[CH3](11)'],
    products = ['[CH2]CC(C)[O](3574)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C(C)[O](730)', 'H(8)'],
    products = ['[CH2]CC(C)[O](3574)'],
