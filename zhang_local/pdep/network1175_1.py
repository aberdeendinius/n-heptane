...
species(
    label = 'C[CH]CC(C)=O(835)',
    structure = SMILES('C[CH]CC(C)=O'),
    E0 = (-82.0721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,264.946,4000],'cm^-1')),
        HinderedRotor(inertia=(0.168435,'amu*angstrom^2'), symmetry=1, barrier=(8.38455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0043985,'amu*angstrom^2'), symmetry=1, barrier=(8.38544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.554983,'amu*angstrom^2'), symmetry=1, barrier=(27.6086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0024045,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (5.00671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,391.569,392.041],'cm^-1')),
        HinderedRotor(inertia=(0.0981397,'amu*angstrom^2'), symmetry=1, barrier=(10.7584,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.098911,'amu*angstrom^2'), symmetry=1, barrier=(10.7562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979518,'amu*angstrom^2'), symmetry=1, barrier=(10.7486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = '[CH2]CCC(C)[O](3709)',
    structure = SMILES('[CH2]CCC(C)[O]'),
    E0 = (95.0525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,233.598,1583.69,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00311325,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.663903,'amu*angstrom^2'), symmetry=1, barrier=(25.5365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290295,'amu*angstrom^2'), symmetry=1, barrier=(11.1577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.661763,'amu*angstrom^2'), symmetry=1, barrier=(25.5392,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = 'C[C]CC(C)[O](3716)',
    structure = SMILES('C[C]CC(C)[O]'),
    E0 = (338.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,243.826,243.843,243.854,243.868],'cm^-1')),
        HinderedRotor(inertia=(0.000482497,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00283552,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369417,'amu*angstrom^2'), symmetry=1, barrier=(15.5908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.51318,'amu*angstrom^2'), symmetry=1, barrier=(21.6593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.937174,0.0610471,-4.5615e-05,1.77704e-08,-2.82644e-12,40769.9,24.9198], Tmin=(100,'K'), Tmax=(1471.23,'K')), NASAPolynomial(coeffs=[13.5884,0.0266509,-1.0546e-05,1.87935e-09,-1.26144e-13,37047.4,-40.9995], Tmin=(1471.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CC(C)OJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C[CH]CC=O(471)'],
    products = ['C[CH]CC(C)[O](3576)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', 'C[CH]C[CH][O](479)'],
    products = ['C[CH]CC(C)[O](3576)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C[C](C)[O](824)', 'H(8)'],
    products = ['C[CH]CC(C)[O](3576)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH][CH]C(C)[O](828)', 'H(8)'],
    products = ['C[CH]CC(C)[O](3576)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]CC(C)[O](830)', 'H(8)'],
    products = ['C[CH]CC(C)[O](3576)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', 'C[CH]C[CH]C(124)'],
    products = ['C[CH]CC(C)[O](3576)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(187219,'m^3/(mol*s)'), n=1.13083, Ea=(163.847,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H/NonDeC;O_birad]
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)[O](442)', '[CH]C(32)'],
    products = ['C[CH]CC(C)[O](3576)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH3](11)', '[CH]CC(C)[O](3675)'],
    products = ['C[CH]CC(C)[O](3576)'],
