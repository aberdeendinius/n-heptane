...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36545,0.0603672,-2.56063e-05,4.16619e-09,-1.9624e-13,19101.9,24.8044], Tmin=(100,'K'), Tmax=(2638.68,'K')), NASAPolynomial(coeffs=[39.5836,0.0154785,-6.64336e-06,1.03122e-09,-5.61215e-14,-4553.62,-198.47], Tmin=(2638.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Tertalkyl)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1872,0.0651563,-3.07363e-05,6.25725e-09,-4.59667e-13,20262.9,30.5903], Tmin=(100,'K'), Tmax=(2315,'K')), NASAPolynomial(coeffs=[25.488,0.0293969,-1.16022e-05,1.90941e-09,-1.15659e-13,7342.42,-110.651], Tmin=(2315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Cs_S)"""),
)

species(
    label = '[CH2][C](C)CCCC(253)',
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54468,0.0630055,-2.83808e-05,5.50504e-09,-3.88663e-13,20232.5,29.4438], Tmin=(100,'K'), Tmax=(2551.51,'K')), NASAPolynomial(coeffs=[29.8565,0.024679,-9.41048e-06,1.47893e-09,-8.53531e-14,3813.07,-137.528], Tmin=(2551.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)C(257)',
    structure = SMILES('[CH2]C[CH]CC(C)C'),
    E0 = (178.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,215.812,913.351,1830.29],'cm^-1')),
...
species(
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0366722,0.0785993,-5.55477e-05,2.1162e-08,-3.34056e-12,52102.3,31.9777], Tmin=(100,'K'), Tmax=(1470.25,'K')), NASAPolynomial(coeffs=[14.886,0.0382,-1.4331e-05,2.47285e-09,-1.62676e-13,47735.8,-45.385], Tmin=(1470.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C(C)C[CH]CC(268)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.955667,0.069667,-4.12185e-05,1.26299e-08,-1.66836e-12,50781.1,30.5342], Tmin=(100,'K'), Tmax=(1585.25,'K')), NASAPolynomial(coeffs=[9.96028,0.0469456,-1.97185e-05,3.58808e-09,-2.42399e-13,47926.3,-17.0564], Tmin=(1585.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C(C)C[CH]CC(247)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(C)C=CCC(248)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(C)CC=CC(249)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](11)', 'C=CC[CH]CC(216)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)CC=C(144)', '[CH3](11)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction19',
    reactants = ['[CH3](11)', '[CH2][CH]C[CH]CC(220)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C](C)C[CH]CC(258)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C)[CH][CH]CC(259)', 'H(8)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]CC([CH2])C(154)', '[CH3](11)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C)C[CH][CH]C(260)', 'H(8)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])C[CH]CC(261)', 'H(8)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH]CC([CH2])C(262)', 'H(8)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(S)(14)', '[CH2]CC[CH]CC(51)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(C)CC([CH2])C(266)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]CC(45)', '[CH2]C([CH2])C(118)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]CC([CH2])C(120)', 'C[CH2](6)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(8)', '[CH2]C(C)C[C]CC(267)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(8)', '[CH]C(C)C[CH]CC(268)'],
    products = ['[CH2]C(C)C[CH]CC(194)'],
