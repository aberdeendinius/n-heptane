...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504019,0.0709125,-6.46344e-05,3.05945e-08,-5.80398e-12,88877.7,27.6328], Tmin=(100,'K'), Tmax=(1268.77,'K')), NASAPolynomial(coeffs=[15.2409,0.0244524,-9.70739e-06,1.73358e-09,-1.17221e-13,85138.1,-46.9722], Tmin=(1268.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(737.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(AllylJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = '[CH]C(=[CH])OCC=[CH](21915)',
    structure = SMILES('[CH]C(=[CH])OCC=[CH]'),
    E0 = (747.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409476,0.0704898,-5.8921e-05,2.20866e-08,-2.32236e-12,89996.4,27.9005], Tmin=(100,'K'), Tmax=(1056.09,'K')), NASAPolynomial(coeffs=[16.3242,0.0226712,-8.69939e-06,1.55515e-09,-1.06633e-13,85940.1,-53.0372], Tmin=(1056.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(747.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])O[CH][C]=C(21916)',
    structure = SMILES('[CH]C(=[CH])O[CH][C]=C'),
    E0 = (848.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.944402,0.0658629,-6.02568e-05,2.92526e-08,-5.81992e-12,102201,26.9874], Tmin=(100,'K'), Tmax=(1192.98,'K')), NASAPolynomial(coeffs=[12.4235,0.0273744,-1.18635e-05,2.2095e-09,-1.52837e-13,99461.9,-30.4185], Tmin=(1192.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(848.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(C=CCJ(O)C)"""),
)
...
species(
    label = '[CH]C(=[CH])OC1[CH]C1(21918)',
    structure = SMILES('[CH]C(=[CH])OC1[CH]C1'),
    E0 = (716.557,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967931,0.0466538,2.50447e-05,-7.62933e-08,3.54031e-11,86309.5,26.3394], Tmin=(100,'K'), Tmax=(942.176,'K')), NASAPolynomial(coeffs=[20.4593,0.014242,-3.49589e-06,6.08591e-10,-4.91348e-14,80402.3,-78.3911], Tmin=(942.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(716.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(AllylJ2_triplet) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]C(=[CH])O[C]=C[CH2](21921)',
    structure = SMILES('[CH]C(=[CH])O[C]=C[CH2]'),
    E0 = (901.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,350,440,435,1725,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16897,0.0631601,-5.81654e-05,2.96877e-08,-6.34801e-12,108469,29.244], Tmin=(100,'K'), Tmax=(1101.89,'K')), NASAPolynomial(coeffs=[10.2765,0.030099,-1.31599e-05,2.45868e-09,-1.70297e-13,106462,-15.5784], Tmin=(1101.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(901.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(Allyl_P)"""),
)

species(
    label = '[C]C(=[CH])O[CH]C=C(21922)',
    structure = SMILES('[C]C(=[CH])O[CH]C=C'),
    E0 = (909.774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,350,440,435,1725,2950,3100,1380,975,1025,1650,406.794,406.794,406.794,406.794],'cm^-1')),
        HinderedRotor(inertia=(0.19218,'amu*angstrom^2'), symmetry=1, barrier=(22.5675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19218,'amu*angstrom^2'), symmetry=1, barrier=(22.5675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19218,'amu*angstrom^2'), symmetry=1, barrier=(22.5675,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.637349,0.0668047,-6.75058e-05,3.35632e-08,-6.49764e-12,109548,25.6552], Tmin=(100,'K'), Tmax=(1264.52,'K')), NASAPolynomial(coeffs=[17.0623,0.014849,-5.87574e-06,1.07175e-09,-7.40533e-14,105394,-57.441], Tmin=(1264.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(909.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CCJ(O)C) + radical(Cds_P) + radical(CJ3)"""),
)

species(
    label = '[CH]=C1[CH]C([CH][CH2])O1(21923)',
    structure = SMILES('[CH]=C1[CH]C([CH][CH2])O1'),
    E0 = (653.72,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.969435,0.0456359,2.67822e-05,-8.64593e-08,4.24976e-11,78753.2,22.5174], Tmin=(100,'K'), Tmax=(906.225,'K')), NASAPolynomial(coeffs=[23.0618,0.0040921,2.90352e-06,-7.40044e-10,4.89667e-14,72450.8,-94.5706], Tmin=(906.225,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(653.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(RCCJ) + radical(CCJCO) + radical(C=CCJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=[CH])OC=[C]C(21924)',
    structure = SMILES('[CH]C(=[CH])OC=[C]C'),
    E0 = (747.619,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.917429,0.0686077,-6.50766e-05,3.42802e-08,-7.51977e-12,90028.2,27.2115], Tmin=(100,'K'), Tmax=(1080.69,'K')), NASAPolynomial(coeffs=[10.9365,0.0315242,-1.36055e-05,2.52875e-09,-1.74703e-13,87862.6,-21.9024], Tmin=(1080.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(747.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=[CH])O[C]=CC(21925)',
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23277,0.0647712,-6.30783e-05,3.77131e-08,-9.88449e-12,90242.9,28.7444], Tmin=(100,'K'), Tmax=(893.34,'K')), NASAPolynomial(coeffs=[7.38735,0.0372143,-1.68089e-05,3.18488e-09,-2.22057e-13,89143.2,-0.253909], Tmin=(893.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(749.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(C=CJO) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])OC=[CH](21511)',
    structure = SMILES('[CH]C(=[CH])OC=[CH]'),
    E0 = (792.899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,350,440,435,1725,3010,987.5,1337.5,450,1655,225.241,225.409,225.659,227.136],'cm^-1')),
        HinderedRotor(inertia=(1.37976,'amu*angstrom^2'), symmetry=1, barrier=(49.7512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40088,'amu*angstrom^2'), symmetry=1, barrier=(49.7598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39269,'amu*angstrom^2'), symmetry=1, barrier=(49.7632,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12369,0.0566799,-5.2926e-05,2.53772e-08,-4.8194e-12,95472.8,24.5922], Tmin=(100,'K'), Tmax=(1279.12,'K')), NASAPolynomial(coeffs=[13.8325,0.0169375,-6.32063e-06,1.08673e-09,-7.18857e-14,92221.6,-39.8488], Tmin=(1279.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.48452e+10,'s^-1'), n=0.3735, Ea=(13.1942,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R6;doublebond_intra_2H_pri;radadd_intra_cdsingleH]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=[CH])OC=C=C(21913)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH](2815)', 'C#CO[CH]C=C(13819)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C(=[CH])OC[C]=C(21914)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C(=[CH])OCC=[CH](21915)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    products = ['[CH]C(=C)O[CH][C]=C(20144)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.49858e+07,'s^-1'), n=1.719, Ea=(309.087,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleH;Cd_H_out_doubleC] for rate rule [R5HJ_3;Cd_rad_out_singleH;Cd_H_out_doubleC]
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    products = ['[CH]C(=C)O[CH]C=[CH](20145)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]C(=[CH])O[CH][C]=C(21916)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C(=[CH])O[CH]C=[CH](21917)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    products = ['[CH]C(=[CH])OC1[CH]C1(21918)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.33917e+10,'s^-1'), n=0.31, Ea=(12.393,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R6_linear;doublebond_intra_pri_2H;radadd_intra_cdsingleH]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C=C(18735)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(64)', '[CH]OC([CH])=[CH](21372)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]C(=[CH])O[C]=C[CH2](21921)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[C]C(=[CH])O[CH]C=C(21922)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(=[CH])O[CH]C=C(20146)'],
    products = ['[CH]=C1[CH]C([CH][CH2])O1(21923)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C(=C)O[C]=C[CH2](20149)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.06754e+11,'s^-1'), n=0.0685, Ea=(8.20064,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6;Y_rad_out;Cpri_rad_out_2H] for rate rule [R6;CdsingleH_rad_out;Cpri_rad_out_2H]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
family: Birad_recombination"""),
)
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', '[CH]C(=[CH])OC=[CH](21511)'],
    products = ['[CH]C(=[CH])O[CH]C=C(20146)'],
