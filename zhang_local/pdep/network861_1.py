...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.453618,0.0873279,-0.000151999,1.38196e-07,-4.8993e-11,107996,32.8226], Tmin=(100,'K'), Tmax=(809.913,'K')), NASAPolynomial(coeffs=[9.23998,0.0288716,-1.58388e-05,3.15605e-09,-2.21745e-13,107067,-4.66434], Tmin=(809.913,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(896.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CH2_triplet) + radical(CJCOOH) + radical(CJCOOH) + radical(CCOJ)"""),
)

species(
    label = '[CH][C]([O])OO[CH][CH2](2821)',
    structure = SMILES('[CH][C]([O])OO[CH][CH2]'),
    E0 = (856.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,360,370,350,350,500,795,815,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692856,0.0835045,-0.000147191,1.39164e-07,-5.08026e-11,103140,32.5353], Tmin=(100,'K'), Tmax=(825.845,'K')), NASAPolynomial(coeffs=[6.51921,0.0338656,-1.81277e-05,3.57142e-09,-2.49099e-13,102908,9.96351], Tmin=(825.845,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(856.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Cs_P) + radical(CCJ2_triplet) + radical(CCOJ) + radical(CCsJOOC)"""),
)

species(
    label = '[CH][CH]OO[C]([CH2])[O](2822)',
    structure = SMILES('[CH][CH]OO[C]([CH2])[O]'),
    E0 = (856.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,360,370,350,350,500,795,815,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692916,0.0835037,-0.000147188,1.39159e-07,-5.08001e-11,103140,32.5351], Tmin=(100,'K'), Tmax=(825.857,'K')), NASAPolynomial(coeffs=[6.5191,0.0338658,-1.81278e-05,3.57145e-09,-2.49101e-13,102908,9.96413], Tmin=(825.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(856.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCJ2_triplet) + radical(CCOJ) + radical(Cs_P) + radical(CCsJOOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
...
reaction(
    ...
    products = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C][O](2305)', '[CH2][CH]O[O](697)'],
    products = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])O[O](2122)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(43.5839,'m^3/(mol*s)'), n=1.88017, Ea=(5.1666,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH2][C]OO[C]([CH2])[O](2820)'],
    products = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH][C]([O])OO[CH][CH2](2821)'],
    products = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH][CH]OO[C]([CH2])[O](2822)'],
    products = ['[CH2][CH]OO[C]([CH2])[O](2148)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
