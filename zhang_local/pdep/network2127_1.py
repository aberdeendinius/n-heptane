...
species(
    label = 'CC=CO[CH]O[O](8259)',
    structure = SMILES('CC=CO[CH]O[O]'),
    E0 = (36.5284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.820339,'amu*angstrom^2'), symmetry=1, barrier=(18.8612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.819383,'amu*angstrom^2'), symmetry=1, barrier=(18.8392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.819424,'amu*angstrom^2'), symmetry=1, barrier=(18.8402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.819447,'amu*angstrom^2'), symmetry=1, barrier=(18.8407,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.192535,0.0794606,-8.82305e-05,4.70463e-08,-9.46947e-12,4555.21,26.9287], Tmin=(100,'K'), Tmax=(1335.65,'K')), NASAPolynomial(coeffs=[21.2356,0.00877819,-1.54028e-06,1.27415e-10,-4.45654e-15,-588.236,-80.4776], Tmin=(1335.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.5284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(OCJO) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH]COC=O(8260)',
    structure = SMILES('C[CH]COC=O'),
    E0 = (-231.496,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,313.678,313.681,1248],'cm^-1')),
        HinderedRotor(inertia=(0.00418575,'amu*angstrom^2'), symmetry=1, barrier=(4.62642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00418648,'amu*angstrom^2'), symmetry=1, barrier=(4.6275,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437891,'amu*angstrom^2'), symmetry=1, barrier=(30.5989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.438362,'amu*angstrom^2'), symmetry=1, barrier=(30.5987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCO[CH]O[O](8261)',
    structure = SMILES('[CH2]CCO[CH]O[O]'),
    E0 = (166.154,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.419014,0.084629,-0.000123363,1.00866e-07,-3.30223e-11,20107.1,29.2623], Tmin=(100,'K'), Tmax=(824.204,'K')), NASAPolynomial(coeffs=[9.91358,0.0316849,-1.45134e-05,2.71493e-09,-1.85303e-13,18775.2,-13.2932], Tmin=(824.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(RCCJ) + radical(OCJO)"""),
)

species(
    label = 'C[CH][CH]OCO[O](8262)',
    structure = SMILES('C[CH][CH]OCO[O]'),
    E0 = (152.306,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.713226,0.0813848,-8.41141e-05,4.11825e-08,-7.48097e-12,18507,33.7038], Tmin=(100,'K'), Tmax=(1563.34,'K')), NASAPolynomial(coeffs=[22.9823,0.00726598,-5.38689e-08,-1.83882e-10,1.68037e-14,12746.8,-85.9282], Tmin=(1563.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJCO) + radical(CCsJOCs) + radical(ROOJ)"""),
)

species(
    label = '[CH2][CH]COCO[O](8263)',
    structure = SMILES('[CH2][CH]COCO[O]'),
    E0 = (177.096,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.536328,0.0645752,-3.95121e-05,-5.6448e-09,9.86623e-12,21435,31.5455], Tmin=(100,'K'), Tmax=(948.045,'K')), NASAPolynomial(coeffs=[19.1768,0.0140377,-4.02832e-06,6.79112e-10,-4.89403e-14,16637.3,-64.0521], Tmin=(948.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]O[CH]OO(8264)',
    structure = SMILES('C[CH][CH]O[CH]OO'),
    E0 = (189.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.112348,0.0879772,-0.000113512,7.5618e-08,-1.98938e-11,22900.8,29.7673], Tmin=(100,'K'), Tmax=(931.72,'K')), NASAPolynomial(coeffs=[15.0023,0.0240543,-1.06034e-05,1.98676e-09,-1.37553e-13,20126,-41.0156], Tmin=(931.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(OCJO) + radical(CCJCO)"""),
)

species(
    label = '[CH2][CH]CO[CH]OO(8265)',
    structure = SMILES('[CH2][CH]CO[CH]OO'),
    E0 = (214.052,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.533073,0.0806525,-0.000100839,6.8631e-08,-1.89394e-11,25865.5,30.603], Tmin=(100,'K'), Tmax=(879.632,'K')), NASAPolynomial(coeffs=[11.7598,0.0295995,-1.37782e-05,2.6471e-09,-1.85726e-13,23890.4,-22.1194], Tmin=(879.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(RCCJ) + radical(CCJCO) + radical(OCJO)"""),
)
...
species(
    label = 'CC=COCO[O](8267)',
    structure = SMILES('CC=COCO[O]'),
    E0 = (-152.432,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287113,0.0580251,1.01316e-05,-7.99381e-08,4.22674e-11,-18177.5,25.4185], Tmin=(100,'K'), Tmax=(912.478,'K')), NASAPolynomial(coeffs=[28.1509,-0.0015255,5.12699e-06,-1.10301e-09,7.08256e-14,-25868.4,-120.735], Tmin=(912.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-152.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = 'C=CCOCO[O](8268)',
    structure = SMILES('C=CCOCO[O]'),
    E0 = (-94.7131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.718099,0.0598632,-2.79844e-05,-1.54655e-08,1.2744e-11,-11262,27.4678], Tmin=(100,'K'), Tmax=(953.829,'K')), NASAPolynomial(coeffs=[18.3822,0.0154162,-4.68229e-06,8.15337e-10,-5.92189e-14,-15979.6,-63.9817], Tmin=(953.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.7131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]COC1OO1(8269)',
    structure = SMILES('C[CH]COC1OO1'),
    E0 = (-47.1728,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14838,0.0544271,-3.79378e-05,1.3681e-08,-2.00604e-12,-5564.02,27.4016], Tmin=(100,'K'), Tmax=(1593.51,'K')), NASAPolynomial(coeffs=[13.4357,0.0235838,-8.90459e-06,1.53458e-09,-1.00445e-13,-9480.04,-37.6029], Tmin=(1593.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CCJCO)"""),
)
...
species(
    label = 'C[CH]CO[CH][O](8270)',
    structure = SMILES('C[CH]CO[CH][O]'),
    E0 = (164.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55004,0.0624603,-9.30072e-05,9.14388e-08,-3.58007e-11,19888.5,24.8626], Tmin=(100,'K'), Tmax=(813.045,'K')), NASAPolynomial(coeffs=[1.98277,0.0417716,-2.0597e-05,3.98853e-09,-2.77752e-13,20431.5,26.637], Tmin=(813.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CCJCO) + radical(OCJO)"""),
)
...
species(
    label = 'C[C]CO[CH]O[O](8271)',
    structure = SMILES('C[C]CO[CH]O[O]'),
    E0 = (409.123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309127,0.0871929,-0.000133271,1.09339e-07,-3.53659e-11,49333.3,27.7753], Tmin=(100,'K'), Tmax=(840.291,'K')), NASAPolynomial(coeffs=[11.1137,0.027731,-1.27933e-05,2.38322e-09,-1.61626e-13,47801,-20.7838], Tmin=(840.291,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCJ2_triplet) + radical(OCJO) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CO[C]O[O](8272)',
    structure = SMILES('C[CH]CO[C]O[O]'),
    E0 = (432.838,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.437469,0.0781147,-8.23987e-05,4.06373e-08,-7.45673e-12,52234.9,31.9992], Tmin=(100,'K'), Tmax=(1522.01,'K')), NASAPolynomial(coeffs=[23.0266,0.00553897,-1.20415e-07,-1.11602e-10,1.01074e-14,46356,-86.9056], Tmin=(1522.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CH2_triplet) + radical(CCJCO) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC=CO[CH]O[O](8259)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CCO[CH]O[O](8171)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', 'C[CH]COC=O(8260)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C[CH]CO[CH]O[O](8021)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(77.2591,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH][CH]O[CH]OO(8264)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CO[CH]OO(8265)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C[CH][CH]O[CH]O[O](8266)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][CH]CO[CH]O[O](8174)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH]C[O](425)', '[CH]O[O](2819)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(T)(63)', 'C[CH]CO[CH][O](8270)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(32)', '[CH2]O[CH]O[O](8127)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[CH]CO[CH]O[O](8205)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[C]CO[CH]O[O](8271)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'C[CH]CO[C]O[O](8272)'],
    products = ['C[CH]CO[CH]O[O](8021)'],
