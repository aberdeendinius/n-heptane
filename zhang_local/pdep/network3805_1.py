...
species(
    label = '[CH2]C1([CH2])O[CH]OO1(18028)',
    structure = SMILES('[CH2]C1([CH2])O[CH]OO1'),
    E0 = (271.575,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.572227,0.0396428,7.96722e-05,-1.7857e-07,8.69319e-11,32820.5,25.7204], Tmin=(100,'K'), Tmax=(876.465,'K')), NASAPolynomial(coeffs=[36.6943,-0.0256764,2.11156e-05,-4.45985e-09,3.11219e-13,22665.5,-165.594], Tmin=(876.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(124trioxolane) + radical(OCJO) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
species(
    ...
    E0 = (-177.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,350,440,435,1725,3000,3100,440,815,1455,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.0709084,'amu*angstrom^2'), symmetry=1, barrier=(21.9857,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.956194,'amu*angstrom^2'), symmetry=1, barrier=(21.9848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0117539,'amu*angstrom^2'), symmetry=1, barrier=(21.9858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]=C(C)O[CH]O[O](18029)',
    structure = SMILES('[CH]=C(C)O[CH]O[O]'),
    E0 = (277.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,350,440,435,1725,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.653066,'amu*angstrom^2'), symmetry=1, barrier=(15.0153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.65244,'amu*angstrom^2'), symmetry=1, barrier=(15.0009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653703,'amu*angstrom^2'), symmetry=1, barrier=(15.0299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.653363,'amu*angstrom^2'), symmetry=1, barrier=(15.0221,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.246493,0.0803265,-0.000103255,6.47923e-08,-1.56356e-11,33555.8,25.9553], Tmin=(100,'K'), Tmax=(1026.42,'K')), NASAPolynomial(coeffs=[17.5408,0.0129303,-4.76335e-06,8.21872e-10,-5.47573e-14,30005.6,-57.9309], Tmin=(1026.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCJO) + radical(Cds_P) + radical(ROOJ)"""),
)

species(
    label = '[CH]C(=C)OCO[O](18030)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.347055,0.0606303,-6.49562e-06,-5.60039e-08,3.19839e-11,25706.1,26.5102], Tmin=(100,'K'), Tmax=(916.731,'K')), NASAPolynomial(coeffs=[25.2854,0.00363704,1.96737e-06,-4.95665e-10,3.042e-14,18956.3,-103.511], Tmin=(916.731,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(ROOJ)"""),
)

species(
    label = '[CH]C(=C)O[CH]OO(18031)',
    structure = SMILES('[CH]C(=C)O[CH]OO'),
    E0 = (249.442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.146905,0.0826887,-8.95935e-05,4.76103e-08,-9.78579e-12,30157.5,27.3144], Tmin=(100,'K'), Tmax=(1199.25,'K')), NASAPolynomial(coeffs=[19.9586,0.0156287,-5.71618e-06,9.82819e-10,-6.56732e-14,25335.2,-73.3361], Tmin=(1199.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCJO) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983828,0.0692465,-9.61371e-05,7.31567e-08,-2.12606e-11,33992.6,24.5725], Tmin=(100,'K'), Tmax=(1005.29,'K')), NASAPolynomial(coeffs=[9.30575,0.0228684,-7.14245e-06,1.0128e-09,-5.52254e-14,32989.8,-12.286], Tmin=(1005.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)OC) + radical(ROOJ) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH2][C]1COO[CH]O1(18034)',
    structure = SMILES('[CH2][C]1COO[CH]O1'),
    E0 = (262.111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.234404,0.0777205,-9.40498e-05,5.58484e-08,-1.19513e-11,31690.6,24.6888], Tmin=(100,'K'), Tmax=(1413.17,'K')), NASAPolynomial(coeffs=[16.4654,0.00826898,3.21461e-06,-1.14391e-09,9.60765e-14,29185.7,-53.8163], Tmin=(1413.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(124trioxane) + radical(C2CsJOCs) + radical(OCJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(=C)OC1OO1(18035)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15902,0.0497636,-1.30467e-05,-3.03596e-08,1.88017e-11,-2087.33,22.3059], Tmin=(100,'K'), Tmax=(922.35,'K')), NASAPolynomial(coeffs=[18.0592,0.00955799,-1.4682e-06,1.62899e-10,-1.26588e-14,-6612.27,-65.4907], Tmin=(922.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-18.3036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(dioxirane) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2]C(=C)O[C]O[O](18037)',
    structure = SMILES('[CH2]C(=C)O[C]O[O]'),
    E0 = (461.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.962573,'amu*angstrom^2'), symmetry=1, barrier=(22.1314,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961996,'amu*angstrom^2'), symmetry=1, barrier=(22.1182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.962953,'amu*angstrom^2'), symmetry=1, barrier=(22.1402,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.57272,0.0865452,-0.000101545,5.1552e-08,-9.28821e-12,55762.4,31.045], Tmin=(100,'K'), Tmax=(1667.81,'K')), NASAPolynomial(coeffs=[26.6574,-0.00781138,7.28664e-06,-1.53199e-09,1.05113e-13,50052.4,-108.477], Tmin=(1667.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(ROOJ) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)O[CH]O[O](8480)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(110.825,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[CH2]C1([CH2])O[CH]OO1(18028)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)OC=O(6117)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C(C)O[CH]O[O](18029)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=C)O[CH]OO(18031)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C(=C)O[CH]O[O](18032)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[O]O[CH]O[C]1CC1(12154)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[CH2][C]1CC(O[O])O1(18033)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[CH2][C]1COO[CH]O1(18034)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.9903e+10,'s^-1'), n=0.243684, Ea=(72.4323,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra;radadd_intra] for rate rule [R6_linear;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
Ea raised from 71.3 to 72.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[CH2]C(=C)OC1OO1(18035)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]O[O](2819)', '[CH2]C(=C)[O](4273)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])OC=O(6541)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O2(2)', '[CH]OC([CH2])=C(17678)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', 'C=[C]O[CH]O[O](8535)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C(=C)O[C]O[O](18037)'],
    products = ['[CH2]C(=C)O[CH]O[O](8480)'],
