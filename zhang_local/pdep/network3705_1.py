...
species(
    label = '[CH2]CCCC([CH2])=C(17651)',
    structure = SMILES('[CH2]CCCC([CH2])=C'),
    E0 = (253.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.296552,0.0709828,-3.89011e-05,4.89068e-09,1.92729e-12,30644.1,29.9978], Tmin=(100,'K'), Tmax=(1143.78,'K')), NASAPolynomial(coeffs=[14.4405,0.0370443,-1.47537e-05,2.6837e-09,-1.84296e-13,26393,-44.578], Tmin=(1143.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C)=C[CH]CC(17652)',
    structure = SMILES('[CH2]C(C)=C[CH]CC'),
    E0 = (177.229,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH]=C(C)C[CH]CC(17653)',
    structure = SMILES('[CH]=C(C)C[CH]CC'),
    E0 = (338.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,331.398,2237.7],'cm^-1')),
        HinderedRotor(inertia=(0.00153557,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0986532,'amu*angstrom^2'), symmetry=1, barrier=(7.68593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0986421,'amu*angstrom^2'), symmetry=1, barrier=(7.68589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0986586,'amu*angstrom^2'), symmetry=1, barrier=(7.68568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0986278,'amu*angstrom^2'), symmetry=1, barrier=(7.68601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12215,0.0685946,-4.87692e-05,2.18572e-08,-4.75099e-12,40801.3,28.6368], Tmin=(100,'K'), Tmax=(984.674,'K')), NASAPolynomial(coeffs=[5.30322,0.0516097,-2.28949e-05,4.33889e-09,-3.03185e-13,39977.9,8.53019], Tmin=(984.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C)CCCC(17654)',
    structure = SMILES('[CH]C(=C)CCCC'),
    E0 = (267.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.193228,0.0733014,-3.81295e-05,6.37222e-09,6.40034e-13,32324.1,30.1132], Tmin=(100,'K'), Tmax=(1274.74,'K')), NASAPolynomial(coeffs=[13.6843,0.0433101,-1.73617e-05,3.10638e-09,-2.09072e-13,27881.8,-42.1814], Tmin=(1274.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C(C)C[CH][CH]C(17655)',
    structure = SMILES('C=C(C)C[CH][CH]C'),
    E0 = (285.767,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,224.17,454.882,3495.54],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31455,0.0560773,-2.52721e-05,4.84479e-09,-3.43424e-13,34409.9,26.5539], Tmin=(100,'K'), Tmax=(2947.02,'K')), NASAPolynomial(coeffs=[41.0512,0.00850479,-3.60567e-06,5.19758e-10,-2.54111e-14,9405.06,-205.882], Tmin=(2947.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C[CH]CC(=C)C(17656)',
    structure = SMILES('[CH2]C[CH]CC(=C)C'),
    E0 = (296.567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,252.308,898.077,1809.23],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33522,0.0647882,-3.97579e-05,1.39149e-08,-2.33536e-12,35759.4,29.2418], Tmin=(100,'K'), Tmax=(1183.09,'K')), NASAPolynomial(coeffs=[5.32981,0.0512826,-2.26345e-05,4.26599e-09,-2.96432e-13,34814.2,9.2986], Tmin=(1183.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(=C)CC([CH2])C(17664)',
    structure = SMILES('[CH2]C(=C)CC([CH2])C'),
    E0 = (244.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,180,903.66],'cm^-1')),
        HinderedRotor(inertia=(0.170554,'amu*angstrom^2'), symmetry=1, barrier=(3.92136,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00676685,'amu*angstrom^2'), symmetry=1, barrier=(3.92152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.532818,'amu*angstrom^2'), symmetry=1, barrier=(12.2505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888518,'amu*angstrom^2'), symmetry=1, barrier=(20.4288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131927,'amu*angstrom^2'), symmetry=1, barrier=(76.4431,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.404192,0.0681822,-2.71491e-05,-1.11707e-08,8.88142e-12,29533.9,29.3192], Tmin=(100,'K'), Tmax=(1003.31,'K')), NASAPolynomial(coeffs=[14.2471,0.0359225,-1.31994e-05,2.33827e-09,-1.60376e-13,25602.1,-43.2618], Tmin=(1003.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.403,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[10.268,-0.0104782,0.000143514,-1.37401e-07,3.18534e-11,4924.9,-16.5174], Tmin=(100,'K'), Tmax=(1690.55,'K')), NASAPolynomial(coeffs=[70.7806,0.0426867,-7.78724e-05,1.86031e-08,-1.37631e-12,-43592,-423.21], Tmin=(1690.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.7517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
species(
    label = '[CH2]C(=C)C[C]CC(17665)',
    structure = SMILES('[CH2]C(=C)C[C]CC'),
    E0 = (496.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.192627,0.0734799,-4.86148e-05,1.3222e-08,-4.3285e-13,59870.1,28.4894], Tmin=(100,'K'), Tmax=(1157.21,'K')), NASAPolynomial(coeffs=[15.547,0.0332557,-1.31313e-05,2.37551e-09,-1.62597e-13,55456.1,-51.5457], Tmin=(1157.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)CC=CC(17648)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(=C)C=CCC(17649)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', '[CH2]C(=C)CC=C(17494)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)C[CH]CC(6234)'],
    products = ['[CH2]C(=C)CC[CH]C(17650)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCCC([CH2])=C(17651)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=C)C[CH]CC(6234)'],
    products = ['[CH2]C(C)=C[CH]CC(17652)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C)C[CH]CC(17653)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=C(C)C[CH][CH]C(17655)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[CH]CC(=C)C(17656)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH3](11)', '[CH2][CH]CC([CH2])=C(6303)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C(=C)C[CH][CH]C(17657)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C([CH2])=C[CH]CC(17658)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C[CH]CC([CH2])=C(17659)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C(=C)C[CH]CC(17660)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(=C)C[CH]CC(6234)'],
    products = ['[CH2][C]1CC(CC)C1(17661)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([CH2])[CH][CH]CC(6241)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(S)(14)', '[CH2]C(=C)C[CH]C(6179)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(=C)CC([CH2])C(17664)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C[CH2](6)', '[CH]CC([CH2])=C(17542)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]CC(45)', '[CH2]C([CH2])=C(17478)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH2(T)(28)', 'C=[C]C[CH]CC(4523)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH2]C(=C)C[C]CC(17665)'],
    products = ['[CH2]C(=C)C[CH]CC(6234)'],
