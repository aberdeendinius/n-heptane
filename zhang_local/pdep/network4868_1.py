...
species(
    label = '[O]C1C=C1C1([O])CC1(26017)',
    structure = SMILES('[O]C1C=C1C1([O])CC1'),
    E0 = (435.551,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03576,0.0474503,1.36013e-05,-5.83807e-08,2.72707e-11,52507.4,27.8178], Tmin=(100,'K'), Tmax=(966.135,'K')), NASAPolynomial(coeffs=[18.9295,0.016554,-5.48216e-06,1.05599e-09,-8.18591e-14,47034.2,-68.3241], Tmin=(966.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.551,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH]=C(C=O)C(=O)C[CH2](22580)',
    structure = SMILES('[CH]=C(C=O)C(=O)C[CH2]'),
    E0 = (179.623,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,375,552.5,462.5,1710,218.31],'cm^-1')),
        HinderedRotor(inertia=(0.243277,'amu*angstrom^2'), symmetry=1, barrier=(8.22755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00353706,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243269,'amu*angstrom^2'), symmetry=1, barrier=(8.22756,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243267,'amu*angstrom^2'), symmetry=1, barrier=(8.22755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.418727,0.0892437,-0.000145707,1.38244e-07,-5.23841e-11,21722.4,28.9231], Tmin=(100,'K'), Tmax=(780.888,'K')), NASAPolynomial(coeffs=[5.96538,0.0431478,-2.31934e-05,4.65025e-09,-3.30103e-13,21395.3,6.98777], Tmin=(780.888,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CJCC=O) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=O)C1(O)[CH]C1(26018)',
    structure = SMILES('[CH]=C(C=O)C1(O)[CH]C1'),
    E0 = (240.64,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731309,0.0591622,-2.75261e-05,-1.21659e-08,9.97669e-12,29071.2,30.6844], Tmin=(100,'K'), Tmax=(1007.73,'K')), NASAPolynomial(coeffs=[18.0632,0.0178783,-7.02666e-06,1.36448e-09,-1.01011e-13,24181.1,-59.9963], Tmin=(1007.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(=C=O)C1([O])CC1(26019)',
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.589013,0.0786139,-9.11642e-05,5.82613e-08,-1.52128e-11,21920.9,24.7213], Tmin=(100,'K'), Tmax=(924.876,'K')), NASAPolynomial(coeffs=[11.5827,0.0310663,-1.40486e-05,2.67414e-09,-1.87056e-13,19887.4,-27.4584], Tmin=(924.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + ring(Cyclopropane) + radical(CJC=C=O) + radical(C=CC(C)2OJ)"""),
)

species(
    label = 'C=C(C=O)C1([O])[CH]C1(26020)',
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17177,0.0494531,-7.69585e-06,-2.45472e-08,1.20807e-11,26891,29.9182], Tmin=(100,'K'), Tmax=(1052.63,'K')), NASAPolynomial(coeffs=[15.193,0.0237584,-1.03914e-05,2.0568e-09,-1.50747e-13,22410.9,-45.7048], Tmin=(1052.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH]C(=C=O)C1(O)CC1(26021)',
    structure = SMILES('[CH]C(=C=O)C1(O)CC1'),
    E0 = (167.508,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.213349,0.0836478,-9.06709e-05,5.35554e-08,-1.28065e-11,20282.7,25.2078], Tmin=(100,'K'), Tmax=(1012.35,'K')), NASAPolynomial(coeffs=[13.4976,0.0311599,-1.29008e-05,2.3421e-09,-1.59534e-13,17593,-39.0444], Tmin=(1012.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(C=O)C1([O])[CH]C1(26022)',
    structure = SMILES('[CH]=C(C=O)C1([O])[CH]C1'),
    E0 = (469.743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2950,3150,900,1000,1100,350,440,435,1725,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08611,0.0530999,-2.47047e-05,-6.84091e-09,6.08865e-12,56611.3,30.6298], Tmin=(100,'K'), Tmax=(1080.49,'K')), NASAPolynomial(coeffs=[15.5958,0.0206619,-9.21044e-06,1.82419e-09,-1.33125e-13,52233.8,-46.2416], Tmin=(1080.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=CC(C)2OJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(=C=O)C1([O])CC1(26023)',
    structure = SMILES('[CH]C(=C=O)C1([O])CC1'),
    E0 = (396.611,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731254,0.0756265,-8.08989e-05,4.98713e-08,-1.29114e-11,47815.8,24.5712], Tmin=(100,'K'), Tmax=(921.574,'K')), NASAPolynomial(coeffs=[9.88931,0.0358757,-1.61964e-05,3.06411e-09,-2.13388e-13,46127.9,-18.8629], Tmin=(921.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cdd-O2d)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[O]C1(CC1)C1[CH]OC=1(26024)',
    structure = SMILES('[O]C1(CC1)C1[CH]OC=1'),
    E0 = (307.119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694953,0.0437813,5.46283e-05,-1.24668e-07,5.72115e-11,37083.6,24.9208], Tmin=(100,'K'), Tmax=(924.139,'K')), NASAPolynomial(coeffs=[28.0762,8.62135e-06,4.35943e-06,-8.86639e-10,5.0528e-14,28831.2,-122.286], Tmin=(924.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + ring(Cyclopropane) + radical(CCsJOC(O)) + radical(C=CC(C)2OJ)"""),
)
...
species(
    label = '[CH]=C(C[O])C1([O])[CH]C1(26025)',
    structure = SMILES('[CH]=C(C[O])C1([O])[CH]C1'),
    E0 = (634.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,350,440,435,1725,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987384,0.0580001,-4.18451e-05,1.52516e-08,-2.24082e-12,76375.4,33.7425], Tmin=(100,'K'), Tmax=(1595.91,'K')), NASAPolynomial(coeffs=[14.8096,0.0233558,-9.2826e-06,1.64896e-09,-1.09946e-13,71963.7,-39.4026], Tmin=(1595.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(634.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCOJ) + radical(Cds_P) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[CH]C(=CO)C1([O])[CH]C1(26026)',
    structure = SMILES('[CH]C(=CO)C1([O])[CH]C1'),
    E0 = (476.289,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.423811,0.056106,2.02995e-05,-8.3657e-08,4.12308e-11,57434,31.6984], Tmin=(100,'K'), Tmax=(922.654,'K')), NASAPolynomial(coeffs=[24.3876,0.0105745,-5.54897e-07,-3.48708e-11,-2.37925e-15,50527.9,-95.4454], Tmin=(922.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(CCJCO) + radical(C=CC(C)2OJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3817.96,'J/mol'), sigma=(6.4672,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=596.36 K, Pc=32.03 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    E0 = (362.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
...
species(
    label = '[C]=C(C=O)C1([O])CC1(26027)',
    structure = SMILES('[C]=C(C=O)C1([O])CC1'),
    E0 = (580.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11817,0.0588631,-4.53297e-05,1.67226e-08,-2.46362e-12,69966.8,27.9961], Tmin=(100,'K'), Tmax=(1584.37,'K')), NASAPolynomial(coeffs=[15.7679,0.021878,-1.03146e-05,1.98923e-09,-1.38862e-13,65324.6,-49.4223], Tmin=(1584.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(580.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CdCdJ2_triplet) + radical(C=CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    products = ['[O]C1C=C1C1([O])CC1(26017)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(C=O)C(=O)C[CH2](22580)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(90.2181,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_De;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 86.2 to 90.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=O(373)', 'C#CC1([O])CC1(11837)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    products = ['[CH]=C(C=O)C1(O)[CH]C1(26018)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    products = ['[CH2]C(=C=O)C1([O])CC1(26019)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    products = ['C=C(C=O)C1([O])[CH]C1(26020)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    products = ['[CH]C(=C=O)C1(O)CC1(26021)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]=C(C=O)C1([O])[CH]C1(26022)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=O(373)', '[CH]=[C]C1([O])CC1(11843)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]C(=C=O)C1([O])CC1(26023)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(C=O)C1([O])CC1(22567)'],
    products = ['[O]C1(CC1)C1[CH]OC=1(26024)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.81184e+09,'s^-1'), n=0.551229, Ea=(147.538,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra] for rate rule [R5_SS_CO;carbonyl_intra_H;radadd_intra_O]
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(C[O])C1([O])[CH]C1(26025)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(=CO)C1([O])[CH]C1(26026)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C-]#[O+](374)', '[CH]=CC1([O])CC1(10608)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(T)(63)', '[CH]=C(C=O)[C]1CC1(24358)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[C]=C(C=O)C1([O])CC1(26027)'],
    products = ['[CH]=C(C=O)C1([O])CC1(22567)'],
