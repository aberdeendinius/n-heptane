...
species(
    label = '[CH]=C=[C]O[CH]C(21396)',
    structure = SMILES('[CH]=C=[C]O[CH]C'),
    E0 = (543.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,540,610,2055,3120,650,792.5,1650,3025,407.5,1350,352.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.946306,'amu*angstrom^2'), symmetry=1, barrier=(21.7574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.945414,'amu*angstrom^2'), symmetry=1, barrier=(21.7369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94642,'amu*angstrom^2'), symmetry=1, barrier=(21.7601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.472162,0.0689149,-8.24464e-05,4.74608e-08,-1.02514e-11,65468.8,25.4293], Tmin=(100,'K'), Tmax=(1265.43,'K')), NASAPolynomial(coeffs=[17.8704,0.00687079,-5.46221e-07,-8.8378e-11,1.2065e-14,61629.9,-60.3732], Tmin=(1265.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJO) + radical(C=C=CJ) + radical(CCsJOC(O))"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.714551,0.0646557,-5.23782e-05,1.56825e-08,4.66823e-13,70222.5,25.993], Tmin=(100,'K'), Tmax=(975.861,'K')), NASAPolynomial(coeffs=[15.6883,0.0191312,-6.76823e-06,1.16957e-09,-7.9595e-14,66545.3,-49.7481], Tmin=(975.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(582.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet) + radical(C=CJO) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH][C]=[C]OCC(21398)',
    structure = SMILES('[CH][C]=[C]OCC'),
    E0 = (626.738,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01177,0.0602553,-5.14348e-05,2.33746e-08,-4.31179e-12,75491.3,25.9283], Tmin=(100,'K'), Tmax=(1294.5,'K')), NASAPolynomial(coeffs=[12.8203,0.0237668,-9.15372e-06,1.59987e-09,-1.06538e-13,72434,-34.0892], Tmin=(1294.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(626.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CJO) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C1=COC1C(21400)',
    structure = SMILES('[CH]C1=COC1C'),
    E0 = (294.133,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49983,0.0284249,7.62479e-05,-1.33213e-07,5.6977e-11,35490.5,18.6168], Tmin=(100,'K'), Tmax=(929.472,'K')), NASAPolynomial(coeffs=[22.2411,0.00722972,6.0799e-07,-1.72714e-10,2.01653e-15,28694.7,-95.7471], Tmin=(929.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH][C]=CO[C]C(21401)',
    structure = SMILES('[CH][C]=CO[C]C'),
    E0 = (847.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659747,0.0636481,-4.71448e-05,4.9293e-09,5.7072e-12,102118,22.7934], Tmin=(100,'K'), Tmax=(948.332,'K')), NASAPolynomial(coeffs=[18.2549,0.0128946,-3.97631e-06,6.6999e-10,-4.72205e-14,97725.7,-66.7218], Tmin=(948.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(847.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(AllylJ2_triplet) + radical(CH2_triplet)"""),
)
...
species(
    label = '[C][C]=CO[CH]C(21403)',
    structure = SMILES('[C][C]=CO[CH]C'),
    E0 = (879.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.95507,'amu*angstrom^2'), symmetry=1, barrier=(21.959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.954982,'amu*angstrom^2'), symmetry=1, barrier=(21.9569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.953694,'amu*angstrom^2'), symmetry=1, barrier=(21.9273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0146237,0.0748089,-8.87392e-05,4.84334e-08,-9.79275e-12,105961,23.2985], Tmin=(100,'K'), Tmax=(1368.6,'K')), NASAPolynomial(coeffs=[21.7304,0.00196606,1.27785e-06,-3.74474e-10,2.87858e-14,100879,-85.2538], Tmin=(1368.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(879.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJ3) + radical(CCsJOC(O)) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]=C=[C]O[CH]C(21396)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH][C]=[C]O[CH]C(21399)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(32)', '[CH][C]=C[O](21209)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH3](11)', '[CH][C]=CO[CH](21379)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][C]=CO[C]C(21401)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(32)', '[CH]=C=C[O](8556)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[C][C]=CO[CH]C(21403)'],
    products = ['[CH][C]=CO[CH]C(19120)'],
