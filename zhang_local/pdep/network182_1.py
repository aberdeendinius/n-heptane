...
species(
    ...
    E0 = (39.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180,2219.4],'cm^-1')),
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32034,0.0348488,-9.55721e-06,-2.53953e-09,1.19168e-12,7892.53,18.4434], Tmin=(100,'K'), Tmax=(1566.86,'K')), NASAPolynomial(coeffs=[8.47432,0.0281902,-1.18483e-05,2.1223e-09,-1.40417e-13,4852.92,-17.5553], Tmin=(1566.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.77175,0.0345261,3.30603e-05,-1.53973e-07,1.44571e-10,11201.1,16.381], Tmin=(100,'K'), Tmax=(401.406,'K')), NASAPolynomial(coeffs=[3.89244,0.0355145,-1.60592e-05,3.05005e-09,-2.12535e-13,11013.2,10.7774], Tmin=(401.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C](C)CO(450)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92241,0.0402915,-1.5082e-05,-5.64319e-09,4.51227e-12,5429.62,21.4606], Tmin=(100,'K'), Tmax=(998.33,'K')), NASAPolynomial(coeffs=[8.5056,0.0251035,-9.07341e-06,1.57071e-09,-1.05493e-13,3557.6,-13.081], Tmin=(998.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.4832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C([CH2])CO(451)',
    structure = SMILES('[CH2]C([CH2])CO'),
    E0 = (96.9916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.00506597,'amu*angstrom^2'), symmetry=1, barrier=(2.71886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12371,'amu*angstrom^2'), symmetry=1, barrier=(2.84434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117428,'amu*angstrom^2'), symmetry=1, barrier=(2.6999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119619,'amu*angstrom^2'), symmetry=1, barrier=(2.75028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7875,0.0471034,-3.29603e-05,7.73898e-09,2.14143e-12,11746.7,22.8458], Tmin=(100,'K'), Tmax=(825.26,'K')), NASAPolynomial(coeffs=[8.52603,0.0238553,-7.81407e-06,1.24684e-09,-7.89252e-14,10313.9,-10.3116], Tmin=(825.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.9916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](C)C[O](452)',
    structure = SMILES('[CH2][C](C)C[O]'),
    E0 = (270.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1079.67,1083.97],'cm^-1')),
        HinderedRotor(inertia=(0.147423,'amu*angstrom^2'), symmetry=1, barrier=(3.38955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151483,'amu*angstrom^2'), symmetry=1, barrier=(3.4829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00401733,'amu*angstrom^2'), symmetry=1, barrier=(3.36458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59418,0.0339532,-1.48348e-05,2.79738e-09,-1.88111e-13,32543.6,19.9031], Tmin=(100,'K'), Tmax=(2446.27,'K')), NASAPolynomial(coeffs=[15.5822,0.0160577,-5.91081e-06,9.2381e-10,-5.37087e-14,25189.2,-56.4189], Tmin=(2446.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO) + radical(CCOJ)"""),
)
...
species(
    label = '[CH]C(C)C[O](458)',
    structure = SMILES('[CH]C(C)C[O]'),
    E0 = (360.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,180,180,180,1446.19,1447.62],'cm^-1')),
        HinderedRotor(inertia=(0.0133503,'amu*angstrom^2'), symmetry=1, barrier=(0.306949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219979,'amu*angstrom^2'), symmetry=1, barrier=(5.05774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000909954,'amu*angstrom^2'), symmetry=1, barrier=(1.36573,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2733,0.0414403,-3.02932e-05,1.49297e-08,-3.7512e-12,43447.1,20.1046], Tmin=(100,'K'), Tmax=(850.083,'K')), NASAPolynomial(coeffs=[4.12677,0.0327186,-1.49027e-05,2.85939e-09,-2.01296e-13,43132,11.4638], Tmin=(850.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=C(C)C[O](445)', 'H(8)'],
    products = ['[CH2]C(C)C[O](393)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH2][CH]C[O](429)'],
    products = ['[CH2]C(C)C[O](393)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)[CH][O](453)', 'H(8)'],
    products = ['[CH2]C(C)C[O](393)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])C[O](454)', 'H(8)'],
    products = ['[CH2]C(C)C[O](393)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]CC[O](386)'],
    products = ['[CH2]C(C)C[O](393)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C[CH]C[O](425)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C[O](393)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(T)(63)', '[CH2]C([CH2])C(118)'],
    products = ['[CH2]C(C)C[O](393)'],
