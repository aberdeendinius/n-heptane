...
species(
    label = '[CH2]CC(=C)CC(198)',
    structure = SMILES('[CH2]CC(=C)CC'),
    E0 = (127.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,180,619.271],'cm^-1')),
        HinderedRotor(inertia=(0.0102271,'amu*angstrom^2'), symmetry=1, barrier=(2.78392,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50212,'amu*angstrom^2'), symmetry=1, barrier=(11.5447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0102303,'amu*angstrom^2'), symmetry=1, barrier=(2.78551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.502131,'amu*angstrom^2'), symmetry=1, barrier=(11.545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CC(C)C[CH2](205)',
    structure = SMILES('[CH2]CC(C)C[CH2]'),
    E0 = (216.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1163.71],'cm^-1')),
        HinderedRotor(inertia=(0.139055,'amu*angstrom^2'), symmetry=1, barrier=(3.19715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139655,'amu*angstrom^2'), symmetry=1, barrier=(3.21094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0033157,'amu*angstrom^2'), symmetry=1, barrier=(3.18002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139334,'amu*angstrom^2'), symmetry=1, barrier=(3.20356,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[C]([CH2])CC(206)',
    structure = SMILES('[CH2]C[C]([CH2])CC'),
    E0 = (401.54,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1818.46,1818.47],'cm^-1')),
        HinderedRotor(inertia=(0.159489,'amu*angstrom^2'), symmetry=1, barrier=(3.66696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159461,'amu*angstrom^2'), symmetry=1, barrier=(3.66633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15949,'amu*angstrom^2'), symmetry=1, barrier=(3.66699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159494,'amu*angstrom^2'), symmetry=1, barrier=(3.66708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159489,'amu*angstrom^2'), symmetry=1, barrier=(3.66698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27513,0.0640907,-6.32337e-05,4.78047e-08,-1.65242e-11,48388.2,28.3002], Tmin=(100,'K'), Tmax=(797.658,'K')), NASAPolynomial(coeffs=[3.9338,0.0458304,-1.96281e-05,3.61492e-09,-2.46839e-13,48120.8,17.0574], Tmin=(797.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC([CH2])[CH]C(207)',
    structure = SMILES('[CH2]CC([CH2])[CH]C'),
    E0 = (410.659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1746.75,1746.76],'cm^-1')),
        HinderedRotor(inertia=(0.00253467,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.76771,'amu*angstrom^2'), symmetry=1, barrier=(83.4402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202045,'amu*angstrom^2'), symmetry=1, barrier=(9.53629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00253415,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00440433,'amu*angstrom^2'), symmetry=1, barrier=(9.5362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22899,0.0571953,-3.33927e-05,1.01284e-08,-1.29003e-12,49493.3,29.8858], Tmin=(100,'K'), Tmax=(1719.56,'K')), NASAPolynomial(coeffs=[11.2019,0.0339964,-1.31557e-05,2.28254e-09,-1.49341e-13,46063.5,-23.6337], Tmin=(1719.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])C[CH2](209)',
    structure = SMILES('[CH2]CC([CH2])C[CH2]'),
    E0 = (421.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,743.979,744.277],'cm^-1')),
        HinderedRotor(inertia=(0.115027,'amu*angstrom^2'), symmetry=1, barrier=(2.6447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114734,'amu*angstrom^2'), symmetry=1, barrier=(2.63796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00670549,'amu*angstrom^2'), symmetry=1, barrier=(2.63111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114618,'amu*angstrom^2'), symmetry=1, barrier=(2.63529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114171,'amu*angstrom^2'), symmetry=1, barrier=(2.62503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867704,0.0615159,-4.04699e-05,1.4378e-08,-2.13066e-12,50797.1,29.7264], Tmin=(100,'K'), Tmax=(1547.2,'K')), NASAPolynomial(coeffs=[12.3356,0.0318681,-1.1727e-05,1.99327e-09,-1.29539e-13,47248.4,-30.6051], Tmin=(1547.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]CC(=C)CC(198)'],
    products = ['[CH2]CC([CH2])CC(191)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C=C)CC(199)', 'H(8)'],
    products = ['[CH2]CC([CH2])CC(191)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CC=C(102)', 'C[CH2](6)'],
    products = ['[CH2]CC([CH2])CC(191)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]C[CH2](103)', 'C[CH2](6)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[C]([CH2])CC(206)', 'H(8)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC([CH2])[CH2](115)', '[CH3](11)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC([CH2])[CH]C(207)', 'H(8)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]C([CH2])CC(208)', 'H(8)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]CC([CH2])C[CH2](209)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([CH2])CC(112)', 'CH2(T)(28)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]C(C[CH2])CC(212)', 'H(8)'],
    products = ['[CH2]CC([CH2])CC(191)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]CC([CH2])CC(213)'],
    products = ['[CH2]CC([CH2])CC(191)'],
