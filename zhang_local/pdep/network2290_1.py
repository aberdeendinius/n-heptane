...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.484416,0.10292,-0.000163737,1.26929e-07,-3.74832e-11,43830.8,29.3393], Tmin=(100,'K'), Tmax=(921.66,'K')), NASAPolynomial(coeffs=[17.0639,0.0165043,-6.40496e-06,1.05313e-09,-6.4436e-14,41031.7,-51.5268], Tmin=(921.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH2])O[CH]OO(8482)',
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.783111,0.122699,-0.000239045,2.2085e-07,-7.53583e-11,48273.8,29.4422], Tmin=(100,'K'), Tmax=(897.144,'K')), NASAPolynomial(coeffs=[10.5724,0.030443,-1.51979e-05,2.79139e-09,-1.81936e-13,47911.5,-14.7728], Tmin=(897.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(OCJO) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289911,0.0614886,-1.08734e-05,-5.53275e-08,3.32404e-11,238.928,25.6038], Tmin=(100,'K'), Tmax=(906.407,'K')), NASAPolynomial(coeffs=[27.0986,-0.00254532,5.27888e-06,-1.14708e-09,7.617e-14,-6850.47,-113.397], Tmin=(906.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.71898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C([CH2])OC1OO1(8485)',
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.551201,0.0796319,-0.00011196,8.58105e-08,-2.61633e-11,19772.4,25.5014], Tmin=(100,'K'), Tmax=(843.987,'K')), NASAPolynomial(coeffs=[11.3253,0.0256854,-1.09572e-05,1.98005e-09,-1.32489e-13,18056.5,-24.0416], Tmin=(843.987,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[O]O[CH]OC1CC1(8486)',
    structure = SMILES('[O]O[CH]OC1CC1'),
    E0 = (110.861,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706054,0.063968,-5.91024e-05,2.75979e-08,-5.06581e-12,13459.2,25.6581], Tmin=(100,'K'), Tmax=(1326.23,'K')), NASAPolynomial(coeffs=[16.1441,0.0174054,-6.43852e-06,1.12468e-09,-7.5464e-14,9364.4,-53.1803], Tmin=(1326.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(ROOJ) + radical(OCJO)"""),
)
...
species(
    label = '[CH]C([CH2])O[CH]O[O](8488)',
    structure = SMILES('[CH]C([CH2])O[CH]O[O]'),
    E0 = (609.082,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.100813,0.0984406,-0.000168137,1.42286e-07,-4.58562e-11,73395.5,29.7517], Tmin=(100,'K'), Tmax=(886.362,'K')), NASAPolynomial(coeffs=[12.9868,0.0222979,-1.03738e-05,1.88557e-09,-1.23829e-13,71746.4,-28.0247], Tmin=(886.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(609.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(OCJO)"""),
)

species(
    label = '[CH2]C([CH2])O[C]O[O](8489)',
    structure = SMILES('[CH2]C([CH2])O[C]O[O]'),
    E0 = (643.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.572402,0.0978136,-0.000136781,8.64944e-08,-1.9958e-11,77551.1,28.443], Tmin=(100,'K'), Tmax=(890.1,'K')), NASAPolynomial(coeffs=[22.812,0.00492355,-7.95872e-07,3.90661e-11,7.13736e-16,72905,-84.3649], Tmin=(890.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CH2_triplet) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=C)O[CH]O[O](8480)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]C([CH2])OC=O(3069)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'C=CO[CH]O[O](8052)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(85.7745,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    products = ['[CH2][C](C)O[CH]O[O](8229)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([CH2])O[CH]OO(8482)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][C]([CH2])O[CH]O[O](8483)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])O[CH]O[O](8176)'],
    products = ['[CH2]C([CH2])OC1OO1(8485)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])[O](740)', '[CH]O[O](2819)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(T)(63)', '[CH2]C([CH2])O[CH][O](8487)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O2(2)', '[CH]OC([CH2])[CH2](6276)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH2][CH]O[CH]O[O](8202)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]C([CH2])O[CH]O[O](8488)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C([CH2])O[C]O[O](8489)'],
    products = ['[CH2]C([CH2])O[CH]O[O](8176)'],
