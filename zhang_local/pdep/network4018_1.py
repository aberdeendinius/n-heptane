...
species(
    label = '[CH][C]([O])OC[C]=[CH](20813)',
    structure = SMILES('[CH][C]([O])OC[C]=[CH]'),
    E0 = (1000.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00169,0.0779702,-0.000142828,1.39131e-07,-5.12811e-11,120376,31.4359], Tmin=(100,'K'), Tmax=(847.301,'K')), NASAPolynomial(coeffs=[4.60273,0.0341716,-1.78482e-05,3.46674e-09,-2.39027e-13,120727,20.3363], Tmin=(847.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1000.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S) + radical(CCOJ) + radical(Cs_P) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]CO[C]([CH2])[O](20814)',
    structure = SMILES('[C]=[C]CO[C]([CH2])[O]'),
    E0 = (1074.44,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.925771,0.0831203,-0.000164198,1.65485e-07,-6.17001e-11,129321,31.3124], Tmin=(100,'K'), Tmax=(859.159,'K')), NASAPolynomial(coeffs=[3.03655,0.0367855,-1.95638e-05,3.798e-09,-2.60528e-13,130306,29.2909], Tmin=(859.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1074.44,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S) + radical(CdCdJ2_triplet) + radical(Cs_P) + radical(CJCO)"""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(197.535,'m^3/(mol*s)'), n=1.6075, Ea=(117.608,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds_Cdd;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 112.7 to 117.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(189.638,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 186.0 to 189.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
    products = ['[CH][C]=CO[C]([CH2])O(20809)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C][O](2305)', '[CH]=[C]C[O](5268)'],
    products = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[C]([CH2])[O](1016)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][C]([O])OC[C]=[CH](20813)'],
    products = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[C]=[C]CO[C]([CH2])[O](20814)'],
    products = ['[CH]=[C]CO[C]([CH2])[O](18569)'],
