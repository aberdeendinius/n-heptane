...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.331381,0.0822588,-8.41175e-05,4.22771e-08,-8.16089e-12,3494.6,30.3082], Tmin=(100,'K'), Tmax=(1331.85,'K')), NASAPolynomial(coeffs=[21.3541,0.0142311,-4.23612e-06,6.57656e-10,-4.1787e-14,-2024.65,-79.5607], Tmin=(1331.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.6673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.190625,0.0761711,-7.5037e-05,3.74703e-08,-7.34506e-12,3699.99,31.0865], Tmin=(100,'K'), Tmax=(1245.54,'K')), NASAPolynomial(coeffs=[17.6533,0.0200904,-7.49911e-06,1.32115e-09,-8.93241e-14,-650.101,-56.9951], Tmin=(1245.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.5697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][C](O)OC=CC(13879)',
    structure = SMILES('[CH2][C](O)OC=CC'),
    E0 = (-4.92815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]CO[C]([CH2])O(2380)',
    structure = SMILES('[CH2][CH]CO[C]([CH2])O'),
    E0 = (324.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.76068,0.0756769,-8.63179e-05,5.56543e-08,-1.48783e-11,39153.2,33.6364], Tmin=(100,'K'), Tmax=(898.196,'K')), NASAPolynomial(coeffs=[10.31,0.0331508,-1.52997e-05,2.94332e-09,-2.07111e-13,37437.7,-11.4084], Tmin=(898.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(Cs_P) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2]C[CH]O[C]([CH2])O(13885)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147916,0.0893539,-0.000119481,8.62673e-08,-2.49715e-11,36836,32.7802], Tmin=(100,'K'), Tmax=(844.21,'K')), NASAPolynomial(coeffs=[12.7388,0.0296924,-1.34666e-05,2.54274e-09,-1.76014e-13,34710.3,-25.8301], Tmin=(844.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(Cs_P) + radical(RCCJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185984,0.0685822,-3.53965e-05,-1.88964e-08,1.64837e-11,21553.9,28.6231], Tmin=(100,'K'), Tmax=(941.214,'K')), NASAPolynomial(coeffs=[23.057,0.00944829,-1.81774e-06,2.86932e-10,-2.43976e-14,15562.6,-89.2873], Tmin=(941.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJ2_triplet) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.805879,0.0756445,-9.21566e-05,6.71646e-08,-2.06044e-11,10379.7,29.8327], Tmin=(100,'K'), Tmax=(783.846,'K')), NASAPolynomial(coeffs=[8.49775,0.0363933,-1.70451e-05,3.28288e-09,-2.30362e-13,9173.79,-5.40302], Tmin=(783.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.3859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](O)OCC=C(13890)',
    structure = SMILES('[CH2][C](O)OCC=C'),
    E0 = (52.7905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.998905,0.0703023,-7.2483e-05,4.28351e-08,-1.07073e-11,6453.68,29.356], Tmin=(100,'K'), Tmax=(947.241,'K')), NASAPolynomial(coeffs=[9.4431,0.034644,-1.60161e-05,3.09361e-09,-2.1851e-13,4853.96,-10.9246], Tmin=(947.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.7905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(CJCO)"""),
)

species(
    label = '[CH]=CCOC([CH2])O(13891)',
    structure = SMILES('[CH]=CCOC([CH2])O'),
    E0 = (94.6402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.860117,0.0734136,-7.97919e-05,4.9372e-08,-1.27819e-11,11492,29.5696], Tmin=(100,'K'), Tmax=(921.827,'K')), NASAPolynomial(coeffs=[9.9357,0.0340327,-1.57111e-05,3.02863e-09,-2.13551e-13,9818.74,-13.4761], Tmin=(921.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.6402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJCO)"""),
)
...
species(
    ...
    E0 = (-51.0791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315721,0.0702939,-4.95458e-05,5.05523e-09,5.6589e-12,-27891.3,24.7963], Tmin=(100,'K'), Tmax=(965.256,'K')), NASAPolynomial(coeffs=[18.8747,0.0177663,-5.80575e-06,1.01294e-09,-7.14578e-14,-32609.9,-69.9674], Tmin=(965.256,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C=COC([CH2])O(12791)'],
    products = ['[CH2][CH]C1CC(O)O1(13874)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C[CH]OC(=C)O(13875)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(O)OC=C=C(13876)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['OH(D)(132)', 'C=C[CH]OC=C(6503)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])O(670)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH2][CH]OC=C[CH2](6363)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C=CO[C]([CH2])O(13880)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C]=COC([CH2])O(13881)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C=[C]OC([CH2])O(13882)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C=COC([CH2])O(12791)'],
    products = ['[CH2]C(O)OC1[CH]C1(11893)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][CH]CO[C]([CH2])O(2380)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH]O[C]([CH2])O(13885)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(T)(28)', '[CH2]C=CO[CH]O(13559)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(T)(28)', '[CH]=COC([CH2])O(5828)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH]C(O)OC=C[CH2](13887)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C=COC([CH2])O(13888)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(O)OC[C]=C(13889)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=C(64)', '[CH]OC([CH2])O(5686)'],
    products = ['[CH2]C=COC([CH2])O(12791)'],
