...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.544775,0.0860093,-0.000138798,1.28281e-07,-4.65734e-11,14775.7,28.9923], Tmin=(100,'K'), Tmax=(825.101,'K')), NASAPolynomial(coeffs=[6.04998,0.0399817,-1.99641e-05,3.85906e-09,-2.67415e-13,14525.5,7.48037], Tmin=(825.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C2CsJOC(O)C)"""),
)
...
species(
    label = '[CH]C([O])O[C]([CH2])[CH2](10920)',
    structure = SMILES('[CH]C([O])O[C]([CH2])[CH2]'),
    E0 = (767.709,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,180,872.771,1600,2618.54,3200],'cm^-1')),
        HinderedRotor(inertia=(0.135153,'amu*angstrom^2'), symmetry=1, barrier=(3.10742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135153,'amu*angstrom^2'), symmetry=1, barrier=(3.10742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135153,'amu*angstrom^2'), symmetry=1, barrier=(3.10742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135153,'amu*angstrom^2'), symmetry=1, barrier=(3.10742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135153,'amu*angstrom^2'), symmetry=1, barrier=(3.10742,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.180573,0.112731,-0.000228476,2.24554e-07,-8.07602e-11,92464.9,31.6706], Tmin=(100,'K'), Tmax=(883.857,'K')), NASAPolynomial(coeffs=[4.78389,0.0402981,-2.07545e-05,3.91603e-09,-2.61667e-13,93539,19.3733], Tmin=(883.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(767.709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([CH2])OC([CH2])[O](10921)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0314542,0.105013,-0.000204268,1.98466e-07,-7.13729e-11,92589.9,32.484], Tmin=(100,'K'), Tmax=(875.533,'K')), NASAPolynomial(coeffs=[5.30858,0.0392019,-2.0071e-05,3.80869e-09,-2.56651e-13,93264.2,16.8543], Tmin=(875.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(768.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CJCO) + radical(C2CsJOCs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', '[CH2][C]([CH2])OC=O(6541)'],
    products = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
    products = ['[CH2][C](O)OC([CH2])=C(10629)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
    products = ['[CH2][C]([CH2])OC(C)=O(10072)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([O])[O](696)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(28)', '[CH2][C]([CH2])O[CH][O](10507)'],
    products = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C([O])O[C]([CH2])[CH2](10920)'],
    products = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH][C]([CH2])OC([CH2])[O](10921)'],
    products = ['[CH2][C]([CH2])OC([CH2])[O](6725)'],
