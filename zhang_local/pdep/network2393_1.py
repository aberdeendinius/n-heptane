...
species(
    label = '[CH2]OC(=C)C[CH]C(9417)',
    structure = SMILES('[CH2]OC(=C)C[CH]C'),
    E0 = (150.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.592168,0.0660042,-4.41962e-05,1.33049e-08,-1.0221e-12,18204.3,31.474], Tmin=(100,'K'), Tmax=(1182.77,'K')), NASAPolynomial(coeffs=[13.9379,0.0307007,-1.18909e-05,2.1231e-09,-1.43931e-13,14359.7,-38.0586], Tmin=(1182.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C1(C=CC)CO1(9419)',
    structure = SMILES('[CH2]C1(C=CC)CO1'),
    E0 = (125.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.166051,0.0754785,-7.00676e-05,3.53365e-08,-6.80809e-12,15306.1,27.4194], Tmin=(100,'K'), Tmax=(1487.44,'K')), NASAPolynomial(coeffs=[15.2102,0.0220854,-4.0784e-06,3.1682e-10,-7.27698e-15,12064.1,-48.3887], Tmin=(1487.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]CCC1([CH2])CO1(9420)',
    structure = SMILES('[CH2]CCC1([CH2])CO1'),
    E0 = (223.002,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.246561,0.0843773,-8.61207e-05,4.83416e-08,-1.05457e-11,26981.5,28.0297], Tmin=(100,'K'), Tmax=(1259.03,'K')), NASAPolynomial(coeffs=[15.5144,0.0258474,-6.31341e-06,7.48137e-10,-3.60113e-14,23683.1,-48.9763], Tmin=(1259.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ) + radical(CJC(C)OC)"""),
)

species(
    label = 'C[CH][CH]C1(C)CO1(9421)',
    structure = SMILES('C[CH][CH]C1(C)CO1'),
    E0 = (201.593,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1387,0.069495,-5.48956e-05,2.49472e-08,-4.49003e-12,24398.3,30.3528], Tmin=(100,'K'), Tmax=(1551.59,'K')), NASAPolynomial(coeffs=[12.7971,0.0284137,-7.01308e-06,8.64492e-10,-4.42958e-14,21487.1,-33.0002], Tmin=(1551.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CC1(C)[CH]O1(9422)',
    structure = SMILES('C[CH]CC1(C)[CH]O1'),
    E0 = (185.414,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.136453,0.0769662,-6.86921e-05,3.41723e-08,-6.62612e-12,22461,29.0387], Tmin=(100,'K'), Tmax=(1439.58,'K')), NASAPolynomial(coeffs=[14.7752,0.0262219,-6.11631e-06,7.00734e-10,-3.31546e-14,19132.5,-44.9833], Tmin=(1439.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)CCC(9423)',
    structure = SMILES('[CH2]C1([CH]O1)CCC'),
    E0 = (201.478,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.667239,0.0893778,-9.26123e-05,5.06357e-08,-1.05529e-11,24411.6,27.9544], Tmin=(100,'K'), Tmax=(1346.45,'K')), NASAPolynomial(coeffs=[18.1741,0.0216544,-4.07574e-06,3.17488e-10,-6.79072e-15,20402.9,-64.5937], Tmin=(1346.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][CH]CC1(C)CO1(9424)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315002,0.0716376,-6.12022e-05,3.07742e-08,-6.2222e-12,25029.5,29.0011], Tmin=(100,'K'), Tmax=(1334.12,'K')), NASAPolynomial(coeffs=[12.169,0.0303542,-8.32962e-06,1.12725e-09,-6.2124e-14,22377.6,-29.6897], Tmin=(1334.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    label = 'CC=CC1(C)CO1(9427)',
    structure = SMILES('CC=CC1(C)CO1'),
    E0 = (-84.6106,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03403,0.0525352,1.00085e-05,-5.8567e-08,3.04548e-11,-10057.4,23.3715], Tmin=(100,'K'), Tmax=(875.619,'K')), NASAPolynomial(coeffs=[15.0949,0.0248267,-5.09384e-06,5.69447e-10,-3.06255e-14,-13920,-50.592], Tmin=(875.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.6106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'C=CCC1(C)CO1(9428)',
    structure = SMILES('C=CCC1(C)CO1'),
    E0 = (-64.9727,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.84296,0.0573498,-1.30904e-06,-4.77317e-08,2.66105e-11,-7689.23,23.0702], Tmin=(100,'K'), Tmax=(878.631,'K')), NASAPolynomial(coeffs=[15.6691,0.0248021,-5.40828e-06,6.49526e-10,-3.66442e-14,-11643.6,-54.2158], Tmin=(878.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-64.9727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    label = 'C[CH]C[C]1CCO1(9429)',
    structure = SMILES('C[CH]C[C]1CCO1'),
    E0 = (194.847,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6507,0.0534568,-1.68723e-05,-2.0132e-08,1.75466e-11,23517.9,25.7096], Tmin=(100,'K'), Tmax=(671.259,'K')), NASAPolynomial(coeffs=[5.62766,0.0410359,-1.43176e-05,2.35947e-09,-1.51488e-13,22729.9,6.2157], Tmin=(671.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJC) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C[CH]C(9430)',
    structure = SMILES('[CH2]O[C]([CH2])C[CH]C'),
    E0 = (451.528,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.12693,0.105051,-0.000177037,1.64856e-07,-5.83349e-11,54441.3,32.2069], Tmin=(100,'K'), Tmax=(877.024,'K')), NASAPolynomial(coeffs=[5.303,0.0473077,-2.18727e-05,4.03305e-09,-2.69589e-13,54757.1,13.9539], Tmin=(877.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]C1(C[C]C)CO1(9433)',
    structure = SMILES('[CH2]C1(C[C]C)CO1'),
    E0 = (465.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224676,0.0796418,-6.81466e-05,1.66607e-08,6.34204e-12,56182.9,24.4855], Tmin=(100,'K'), Tmax=(798.869,'K')), NASAPolynomial(coeffs=[16.2109,0.0228548,-5.18923e-06,5.642e-10,-2.50183e-14,52886.6,-53.6938], Tmin=(798.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(465.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1(C[CH]C)CO1(9434)',
    structure = SMILES('[CH]C1(C[CH]C)CO1'),
    E0 = (449.907,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254742,0.0736528,-6.93838e-05,3.73318e-08,-7.91504e-12,54253.6,28.4323], Tmin=(100,'K'), Tmax=(1295.53,'K')), NASAPolynomial(coeffs=[13.0227,0.0269733,-6.93323e-06,8.70871e-10,-4.46239e-14,51554.4,-34.1206], Tmin=(1295.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C[CH]C(9417)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(C=CC)CO1(9419)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH2]C1(CC=C)CO1(9322)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CCC1([CH2])CO1(9420)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C1(C[CH]C)CO1(9196)'],
    products = ['C[CH][CH]C1(C)CO1(9421)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C1(C[CH]C)CO1(9196)'],
    products = ['C[CH]CC1(C)[CH]O1(9422)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C1(C[CH]C)CO1(9196)'],
    products = ['[CH2]C1([CH]O1)CCC(9423)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C1(C[CH]C)CO1(9196)'],
    products = ['[CH2][CH]CC1(C)CO1(9424)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C1([CH][CH]C)CO1(9425)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C[CH]C(9426)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][CH]CC1([CH2])CO1(9325)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([O])C[CH]C(821)', 'CH2(S)(14)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C[CH]C(6179)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]O[C]([CH2])C[CH]C(9430)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]C(32)', '[CH2]C1([CH2])CO1(9287)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH3](11)', '[CH]CC1([CH2])CO1(9371)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH2]C1(C[C]C)CO1(9433)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH]C1(C[CH]C)CO1(9434)'],
    products = ['[CH2]C1(C[CH]C)CO1(9196)'],
