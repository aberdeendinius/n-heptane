...
species(
    label = '[CH]C(=[CH])OC1OO1(21714)',
    structure = SMILES('[CH]C(=[CH])OC1OO1'),
    E0 = (440.56,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13971,0.0524515,-2.53602e-05,-1.37017e-08,1.17021e-11,53099.7,23.1973], Tmin=(100,'K'), Tmax=(937.098,'K')), NASAPolynomial(coeffs=[16.5383,0.0128197,-3.69539e-06,6.03711e-10,-4.25634e-14,49067.9,-56.2056], Tmin=(937.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(dioxirane) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH][C]([CH])OC=O(21716)',
    structure = SMILES('[CH][C]([CH])OC=O'),
    E0 = (652.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2782.5,750,1395,475,1775,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84941,0.0501153,-6.03575e-05,3.8804e-08,-1.01334e-11,78505.4,23.4114], Tmin=(100,'K'), Tmax=(925.588,'K')), NASAPolynomial(coeffs=[9.19592,0.0183669,-8.90641e-06,1.74584e-09,-1.24101e-13,77145.4,-11.4632], Tmin=(925.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(652.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCJ2_triplet) + radical(CCJ2_triplet) + radical(C2CsJOC(O)H)"""),
)
...
species(
    label = '[CH]C(=[CH])O[C]O[O](21717)',
    structure = SMILES('[CH]C(=[CH])O[C]O[O]'),
    E0 = (920.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,350,440,435,1725,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2469,0.0853013,-0.000100641,5.16356e-08,-9.49295e-12,110934,30.6875], Tmin=(100,'K'), Tmax=(1607.31,'K')), NASAPolynomial(coeffs=[26.5924,-0.00644336,5.94204e-06,-1.26697e-09,8.79031e-14,104886,-107.806], Tmin=(1607.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(920.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CH2_triplet) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]C(=[CH])O[CH]O[O](21718)',
    structure = SMILES('[C]C(=[CH])O[CH]O[O]'),
    E0 = (947.336,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,350,440,435,1725,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.857105,'amu*angstrom^2'), symmetry=1, barrier=(19.7065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854697,'amu*angstrom^2'), symmetry=1, barrier=(19.6512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.857177,'amu*angstrom^2'), symmetry=1, barrier=(19.7082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (98.0569,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.199628,0.0823525,-0.000122939,8.2321e-08,-2.0412e-11,114076,24.5776], Tmin=(100,'K'), Tmax=(887.547,'K')), NASAPolynomial(coeffs=[19.7749,0.00191119,-1.38744e-07,-4.16103e-11,5.35574e-15,110295,-69.2528], Tmin=(887.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(947.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(OCJO) + radical(ROOJ) + radical(CJ3) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])O[CH]O[O](19810)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH](2815)', 'C#CO[CH]O[O](8534)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH]C(=[CH])OC=O(19602)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]O[O](2819)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O(T)(63)', '[CH][C]([CH])OC=O(21716)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O2(2)', '[CH]OC([CH])=[CH](21372)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]C(=[CH])O[C]O[O](21717)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[C]C(=[CH])O[CH]O[O](21718)'],
    products = ['[CH]C(=[CH])O[CH]O[O](19810)'],
