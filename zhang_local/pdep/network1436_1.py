...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.858605,'amu*angstrom^2'), symmetry=1, barrier=(19.741,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859372,'amu*angstrom^2'), symmetry=1, barrier=(19.7586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859201,'amu*angstrom^2'), symmetry=1, barrier=(19.7547,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.74676,'amu*angstrom^2'), symmetry=1, barrier=(17.1695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.745077,'amu*angstrom^2'), symmetry=1, barrier=(17.1308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.746079,'amu*angstrom^2'), symmetry=1, barrier=(17.1538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    label = '[CH]=C([O])CC=O(4735)',
    structure = SMILES('[CH]=C([O])CC=O'),
    E0 = (77.2036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2782.5,750,1395,475,1775,1000,539.598],'cm^-1')),
        HinderedRotor(inertia=(0.0674137,'amu*angstrom^2'), symmetry=1, barrier=(13.9278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0674155,'amu*angstrom^2'), symmetry=1, barrier=(13.9269,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    label = '[CH2]C([O])=C[C]=O(4736)',
    structure = SMILES('[CH2]C([O])=C[C]=O'),
    E0 = (125.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1855,455,950,350,440,435,1725,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.675908,'amu*angstrom^2'), symmetry=1, barrier=(15.5405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677693,'amu*angstrom^2'), symmetry=1, barrier=(15.5815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36779,0.06122,-9.15024e-05,6.93675e-08,-2.06256e-11,15176.3,21.4686], Tmin=(100,'K'), Tmax=(828.302,'K')), NASAPolynomial(coeffs=[11.0334,0.0145441,-6.97655e-06,1.33711e-09,-9.28001e-14,13575,-23.3417], Tmin=(828.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(C=C(C)OJ) + radical(C=CCJ=O) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C([O])C[C]=O(4737)',
    structure = SMILES('[CH]=C([O])C[C]=O'),
    E0 = (237.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,1855,455,950,456.417],'cm^-1')),
        HinderedRotor(inertia=(0.0818422,'amu*angstrom^2'), symmetry=1, barrier=(11.9938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0808435,'amu*angstrom^2'), symmetry=1, barrier=(11.9663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73345,0.0430518,-3.78901e-05,1.47617e-08,-1.97836e-12,28611.6,22.5881], Tmin=(100,'K'), Tmax=(1203.63,'K')), NASAPolynomial(coeffs=[13.8765,0.00944886,-4.42721e-06,8.87747e-10,-6.46596e-14,25199.4,-40.2772], Tmin=(1203.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(Cds_P) + radical(CCCJ=O)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(264.043,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_CO]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C([O])C=C=O(4732)'],
    products = ['C=C([O])C[C]=O(4289)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2]C([O])=C[C]=O(4736)'],
    products = ['C=C([O])C[C]=O(4289)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=C([O])C[C]=O(4737)'],
    products = ['C=C([O])C[C]=O(4289)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[C-]#[O+](374)', '[CH2]C(=C)[O](4273)'],
    products = ['C=C([O])C[C]=O(4289)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[C]=O(1149)', '[CH2]C(=C)[O](4273)'],
    products = ['C=C([O])C[C]=O(4289)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', 'O=[C]C[C]=O(4746)'],
    products = ['C=C([O])C[C]=O(4289)'],
