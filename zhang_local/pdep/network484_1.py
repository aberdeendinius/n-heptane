...
species(
    label = '[CH2]C[CH]C(=O)OO(1351)',
    structure = SMILES('[CH2]C[CH]C(=O)OO'),
    E0 = (-89.8023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08334,0.0542705,-2.83543e-05,-3.22879e-09,5.16055e-12,-10687.2,29.9286], Tmin=(100,'K'), Tmax=(1050.39,'K')), NASAPolynomial(coeffs=[14.6785,0.0215608,-8.86547e-06,1.6794e-09,-1.19821e-13,-14594.8,-41.3343], Tmin=(1050.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.8023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.818745,0.0782437,-0.00011656,1.06668e-07,-3.96189e-11,23981.6,32.5967], Tmin=(100,'K'), Tmax=(791.487,'K')), NASAPolynomial(coeffs=[5.38784,0.041422,-2.07548e-05,4.05416e-09,-2.84134e-13,23688.4,14.3388], Tmin=(791.487,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.818751,0.0782436,-0.000116559,1.06668e-07,-3.96186e-11,23981.6,31.4981], Tmin=(100,'K'), Tmax=(791.489,'K')), NASAPolynomial(coeffs=[5.38783,0.041422,-2.07548e-05,4.05416e-09,-2.84134e-13,23688.4,13.2402], Tmin=(791.489,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C[CH][C](O)OO(1359)',
    structure = SMILES('[CH2]C[CH][C](O)OO'),
    E0 = (178.05,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.63904,0.0797907,-0.000106787,8.15564e-08,-2.56488e-11,21530.1,33.0827], Tmin=(100,'K'), Tmax=(770.98,'K')), NASAPolynomial(coeffs=[9.62771,0.033161,-1.60755e-05,3.12744e-09,-2.2013e-13,20143.9,-7.94552], Tmin=(770.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Cs_P) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC[C](O)O[O](1360)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.997993,0.0723617,-8.68367e-05,5.53526e-08,-1.19554e-11,15694.3,30.2702], Tmin=(100,'K'), Tmax=(636.022,'K')), NASAPolynomial(coeffs=[8.71527,0.0329375,-1.53444e-05,2.93711e-09,-2.05021e-13,14528.4,-4.91756], Tmin=(636.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.64,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2][CH]C[C](O)OO(1361)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.703404,0.0794432,-0.000116418,1.00392e-07,-3.49823e-11,20808.6,33.2706], Tmin=(100,'K'), Tmax=(808.507,'K')), NASAPolynomial(coeffs=[7.47074,0.0359645,-1.72047e-05,3.28845e-09,-2.27461e-13,20041.1,4.08151], Tmin=(808.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828579,0.0793059,-0.000128155,1.20308e-07,-4.45522e-11,48665.5,33.2486], Tmin=(100,'K'), Tmax=(813.538,'K')), NASAPolynomial(coeffs=[5.32912,0.0388668,-1.98316e-05,3.87423e-09,-2.70382e-13,48539.1,16.189], Tmin=(813.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH) + radical(Cs_P) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20442,0.0743697,-0.000125401,1.26596e-07,-4.83944e-11,-3289.47,30.1702], Tmin=(100,'K'), Tmax=(853.984,'K')), NASAPolynomial(coeffs=[0.637817,0.0464017,-2.24888e-05,4.26833e-09,-2.91596e-13,-2076.08,39.352], Tmin=(853.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.0838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2]CCC(=O)OO(1215)',
    structure = SMILES('[CH2]CCC(=O)OO'),
    E0 = (-289.704,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.852353,0.0598516,-3.79432e-05,6.9938e-09,1.24749e-12,-34722.2,28.2649], Tmin=(100,'K'), Tmax=(1125.14,'K')), NASAPolynomial(coeffs=[14.6943,0.0249155,-1.03965e-05,1.94707e-09,-1.3646e-13,-38740.5,-44.1615], Tmin=(1125.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C[CH]C(=O)OO(1351)', 'H(8)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CC[C]([O])OO(1285)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]CC[C]([O])OO(1220)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(123.708,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 121.6 to 123.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', '[CH2]CCC([O])=O(1353)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH2]CC[C]([O])[O](1363)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC[C]([O])O[O](1364)', 'H(8)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C[CH][C]([O])OO(1365)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]C[C]([O])OO(1366)', 'H(8)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[O]O(16)', '[CH2]CC[C][O](752)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[O][C]OO(1370)', '[CH2]C[CH2](21)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]CC[C]([O])OO(1372)', 'H(8)'],
    products = ['[CH2]CC[C]([O])OO(1220)'],
