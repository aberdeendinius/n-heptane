...
species(
    label = '[O]OC[CH]CC1=CC1[O](27498)',
    structure = SMILES('[O]OC[CH]CC1=CC1[O]'),
    E0 = (505.795,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.215443,0.0871062,-9.49818e-05,5.62425e-08,-1.36647e-11,60966.2,34.9875], Tmin=(100,'K'), Tmax=(987.159,'K')), NASAPolynomial(coeffs=[12.9791,0.0353878,-1.63955e-05,3.17047e-09,-2.24197e-13,58446.2,-26.4248], Tmin=(987.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(ROOJ) + radical(CC(C)OJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH]=C1C[CH]COOC1[O](27499)',
    structure = SMILES('[CH]=C1C[CH]COOC1[O]'),
    E0 = (395.408,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522148,0.034837,0.000118562,-2.10123e-07,9.21247e-11,47720.6,33.9162], Tmin=(100,'K'), Tmax=(916.419,'K')), NASAPolynomial(coeffs=[35.0165,-0.00727823,9.99036e-06,-2.01028e-09,1.24642e-13,36844.6,-154.334], Tmin=(916.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(CCOJ) + radical(CCJCOOH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=O)C=CCO[O](27500)',
    structure = SMILES('[CH]=C(C=O)C=CCO[O]'),
    E0 = (261.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.731492,'amu*angstrom^2'), symmetry=1, barrier=(16.8184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.732125,'amu*angstrom^2'), symmetry=1, barrier=(16.833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.73222,'amu*angstrom^2'), symmetry=1, barrier=(16.8352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.731526,'amu*angstrom^2'), symmetry=1, barrier=(16.8192,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.151528,0.0878833,-9.9623e-05,5.86984e-08,-1.39374e-11,31576.6,30.5439], Tmin=(100,'K'), Tmax=(1016.8,'K')), NASAPolynomial(coeffs=[14.8328,0.0301285,-1.44222e-05,2.8363e-09,-2.02635e-13,28591,-40.5293], Tmin=(1016.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-O2d)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ)"""),
)

species(
    label = '[CH]=C(C=O)CC=CO[O](27501)',
    structure = SMILES('[CH]=C(C=O)CC=CO[O]'),
    E0 = (272.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.520444,'amu*angstrom^2'), symmetry=1, barrier=(11.966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519957,'amu*angstrom^2'), symmetry=1, barrier=(11.9548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520472,'amu*angstrom^2'), symmetry=1, barrier=(11.9667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.520453,'amu*angstrom^2'), symmetry=1, barrier=(11.9662,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.545285,0.0811148,-8.86965e-05,5.23014e-08,-1.27366e-11,32924,32.9303], Tmin=(100,'K'), Tmax=(979.901,'K')), NASAPolynomial(coeffs=[12.0692,0.0340733,-1.66862e-05,3.30935e-09,-2.37272e-13,30665.6,-22.4317], Tmin=(979.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (251.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
...
species(
    label = '[CH]=C(C=O)CC[CH]O[O](27502)',
    structure = SMILES('[CH]=C(C=O)CC[CH]O[O]'),
    E0 = (328.253,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01627,0.0816449,-4.21813e-05,-1.20224e-07,1.54899e-10,39570.2,30.7442], Tmin=(100,'K'), Tmax=(448.131,'K')), NASAPolynomial(coeffs=[8.57538,0.0450084,-2.27658e-05,4.44161e-09,-3.10015e-13,38583.1,-3.11132], Tmin=(448.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C=O)C[CH][CH]OO(27503)',
    structure = SMILES('[CH]=C(C=O)C[CH][CH]OO'),
    E0 = (376.663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668142,0.0894861,-6.86508e-05,-6.85883e-08,1.12758e-10,45405.2,33.4934], Tmin=(100,'K'), Tmax=(465.924,'K')), NASAPolynomial(coeffs=[9.24278,0.0457141,-2.38043e-05,4.7099e-09,-3.31938e-13,44282.3,-4.80153], Tmin=(465.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_P) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C(C=O)=C[CH]CO[O](27504)',
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.127812,0.0920485,-0.000103428,6.36513e-08,-1.63013e-11,18607.1,29.355], Tmin=(100,'K'), Tmax=(931.076,'K')), NASAPolynomial(coeffs=[12.1644,0.0403402,-2.01277e-05,4.00961e-09,-2.8785e-13,16365.6,-27.8557], Tmin=(931.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)H) + radical(C=C(C=O)CJ) + radical(C=CCJCO) + radical(ROOJ)"""),
)

species(
    label = 'C=C([C]=O)C[CH]CO[O](27505)',
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06946,0.0803817,-3.98102e-05,-1.24175e-07,1.58263e-10,30949.7,32.8698], Tmin=(100,'K'), Tmax=(446.14,'K')), NASAPolynomial(coeffs=[8.49877,0.0445054,-2.2519e-05,4.39448e-09,-3.06722e-13,29981,-0.40378], Tmin=(446.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(CCJCOOH) + radical(ROOJ) + radical(C=C(C)CJ=O)"""),
)

species(
    label = '[CH]C(=C=O)CCCO[O](27506)',
    structure = SMILES('[CH]C(=C=O)CCCO[O]'),
    E0 = (278.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122797,0.0987584,-0.000135902,1.14748e-07,-3.97636e-11,33632.5,34.2451], Tmin=(100,'K'), Tmax=(810.689,'K')), NASAPolynomial(coeffs=[7.55965,0.0493024,-2.30238e-05,4.34878e-09,-2.99083e-13,32766.5,1.13494], Tmin=(810.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C(C=O)C[CH][CH]O[O](27507)',
    structure = SMILES('C=C(C=O)C[CH][CH]O[O]'),
    E0 = (281.572,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0936278,0.100435,-0.000155626,1.41373e-07,-5.16282e-11,34002.6,36.3157], Tmin=(100,'K'), Tmax=(792.948,'K')), NASAPolynomial(coeffs=[7.19591,0.0472805,-2.40845e-05,4.72579e-09,-3.31592e-13,33361.6,6.08664], Tmin=(792.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[CH]C(C=O)=C[CH]COO(27508)',
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0492528,0.0956428,-0.000100294,6.01897e-08,-1.56046e-11,26104.7,30.4953], Tmin=(100,'K'), Tmax=(903.456,'K')), NASAPolynomial(coeffs=[10.2004,0.0506993,-2.56755e-05,5.12838e-09,-3.68462e-13,24270.5,-17.4478], Tmin=(903.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]C(=C=O)C[CH]COO(27509)',
    structure = SMILES('[CH]C(=C=O)C[CH]COO'),
    E0 = (326.877,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.350947,0.104253,-0.000146717,1.24269e-07,-4.3205e-11,39462.7,36.6102], Tmin=(100,'K'), Tmax=(794.676,'K')), NASAPolynomial(coeffs=[8.41165,0.0496495,-2.38354e-05,4.55982e-09,-3.16019e-13,38401.5,-1.56507], Tmin=(794.676,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(AllylJ2_triplet) + radical(CCJCOOH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3596.57,'J/mol'), sigma=(6.11769,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=561.78 K, Pc=35.64 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH]C(C=O)=C[CH]CO[O](27510)',
    structure = SMILES('[CH]C(C=O)=C[CH]CO[O]'),
    E0 = (367.93,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0240587,0.0956228,-0.000118328,8.82213e-08,-2.81255e-11,44387.5,31.3336], Tmin=(100,'K'), Tmax=(750.246,'K')), NASAPolynomial(coeffs=[8.8298,0.0486797,-2.44832e-05,4.84132e-09,-3.44574e-13,43066,-8.61968], Tmin=(750.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.93,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet) + radical(ROOJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]=C(C=O)C[CH][CH]O[O](27511)',
    structure = SMILES('[CH]=C(C=O)C[CH][CH]O[O]'),
    E0 = (528.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3120,650,792.5,1650,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,240.201,1399.54],'cm^-1')),
        HinderedRotor(inertia=(0.162542,'amu*angstrom^2'), symmetry=1, barrier=(6.65516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162548,'amu*angstrom^2'), symmetry=1, barrier=(6.65516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162545,'amu*angstrom^2'), symmetry=1, barrier=(6.6552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162545,'amu*angstrom^2'), symmetry=1, barrier=(6.65513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.782764,'amu*angstrom^2'), symmetry=1, barrier=(32.0486,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.202758,0.104374,-0.000173693,1.6039e-07,-5.80813e-11,63723.8,37.11], Tmin=(100,'K'), Tmax=(816.161,'K')), NASAPolynomial(coeffs=[7.66512,0.0440473,-2.28149e-05,4.47054e-09,-3.11987e-13,63164.5,5.1917], Tmin=(816.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(=C=O)C[CH]CO[O](27512)',
    structure = SMILES('[CH]C(=C=O)C[CH]CO[O]'),
    E0 = (478.882,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2120,512.5,787.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.137632,0.101279,-0.00015362,1.36331e-07,-4.80042e-11,57735.3,36.6016], Tmin=(100,'K'), Tmax=(838.033,'K')), NASAPolynomial(coeffs=[6.98435,0.0477024,-2.26736e-05,4.27778e-09,-2.92405e-13,57229.2,7.60325], Tmin=(838.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + radical(ROOJ) + radical(AllylJ2_triplet) + radical(CCJCOOH)"""),
)

species(
    label = '[O]OC[CH]CC1[CH]OC=1(27513)',
    structure = SMILES('[O]OC[CH]CC1[CH]OC=1'),
    E0 = (377.363,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.2246,0.0964546,-9.9731e-05,4.96869e-08,-9.38973e-12,45590.2,36.0299], Tmin=(100,'K'), Tmax=(1416.05,'K')), NASAPolynomial(coeffs=[25.7289,0.0127582,-3.06517e-06,4.07441e-10,-2.40066e-14,38714.6,-100.705], Tmin=(1416.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CCsJOC(O)) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH]=C1[CH]OOOC[CH]C1(27514)',
    structure = SMILES('[CH]=C1[CH]OOOC[CH]C1'),
    E0 = (545.528,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3611,0.0307156,8.67867e-05,-1.35963e-07,5.38048e-11,65731.5,30.8805], Tmin=(100,'K'), Tmax=(972.853,'K')), NASAPolynomial(coeffs=[19.4692,0.0245478,-8.99075e-06,1.82019e-09,-1.43204e-13,58976.7,-72.5905], Tmin=(972.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclooctane) + radical(Cds_P) + radical(CCJCOOH) + radical(C=CCJO)"""),
)

species(
    label = 'C=C(C=O)C=CCO[O](27515)',
    structure = SMILES('C=C(C=O)C=CCO[O]'),
    E0 = (14.316,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.197867,0.0847744,-8.47671e-05,4.40184e-08,-9.27977e-12,1857.79,29.9676], Tmin=(100,'K'), Tmax=(1132.92,'K')), NASAPolynomial(coeffs=[15.1458,0.0319979,-1.48905e-05,2.89962e-09,-2.0615e-13,-1529.17,-44.0128], Tmin=(1132.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(14.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-O2d)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH]=C(C=O)CC=COO(27516)',
    structure = SMILES('[CH]=C(C=O)CC=COO'),
    E0 = (120.742,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315494,0.0844214,-8.34451e-05,4.27224e-08,-8.97139e-12,14651.8,32.9873], Tmin=(100,'K'), Tmax=(1127.2,'K')), NASAPolynomial(coeffs=[14.4086,0.0344101,-1.68933e-05,3.3612e-09,-2.41495e-13,11474.6,-36.6914], Tmin=(1127.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C=C(C=O)CC=CO[O](27517)',
    structure = SMILES('C=C(C=O)CC=CO[O]'),
    E0 = (25.6508,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.636538,0.0775234,-7.2354e-05,3.59308e-08,-7.44034e-12,3203.21,32.1895], Tmin=(100,'K'), Tmax=(1130.84,'K')), NASAPolynomial(coeffs=[12.4122,0.0358705,-1.71037e-05,3.35902e-09,-2.39551e-13,539.918,-26.0694], Tmin=(1130.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.6508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH]=C(C=O)C=CCOO(27518)',
    structure = SMILES('[CH]=C(C=O)C=CCOO'),
    E0 = (109.407,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122553,0.0916662,-9.58414e-05,5.07934e-08,-1.08054e-11,13306.4,30.763], Tmin=(100,'K'), Tmax=(1129.81,'K')), NASAPolynomial(coeffs=[17.1449,0.0305326,-1.46772e-05,2.90105e-09,-2.08031e-13,9404.56,-54.6497], Tmin=(1129.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-O2d)(Cds-Cds)) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=C[CH]CO[O])C[O](27519)',
    structure = SMILES('[CH]C(=C[CH]CO[O])C[O]'),
    E0 = (532.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.247914,0.103067,-0.000146775,1.28508e-07,-4.58009e-11,64158.6,35.0352], Tmin=(100,'K'), Tmax=(812.844,'K')), NASAPolynomial(coeffs=[6.61912,0.0533042,-2.54743e-05,4.85056e-09,-3.34706e-13,63569.8,6.57397], Tmin=(812.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(CCOJ) + radical(AllylJ2_triplet) + radical(ROOJ) + radical(C=CCJCO)"""),
)

species(
    label = '[CH]C([CH]O)=C[CH]CO[O](27520)',
    structure = SMILES('[CH]C([CH]O)=C[CH]CO[O]'),
    E0 = (423.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.330457,0.0938293,-9.06134e-05,4.62858e-08,-9.61963e-12,51133.3,35.0715], Tmin=(100,'K'), Tmax=(1150.59,'K')), NASAPolynomial(coeffs=[16.17,0.0364662,-1.58307e-05,2.95603e-09,-2.04991e-13,47336.3,-46.8483], Tmin=(1150.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(ROOJ) + radical(C=CCJCO) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438274,0.0716717,-6.5167e-05,3.24548e-08,-6.50928e-12,11329,27.5328], Tmin=(100,'K'), Tmax=(1206.87,'K')), NASAPolynomial(coeffs=[14.0437,0.0265776,-9.11959e-06,1.49416e-09,-9.57723e-14,8045.03,-40.6637], Tmin=(1206.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.0816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=O)CC1COO1(27522)',
    structure = SMILES('[CH]=C(C=O)CC1COO1'),
    E0 = (150.339,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140197,0.076825,-6.09874e-05,2.06655e-08,-1.04038e-12,18227.7,30.4697], Tmin=(100,'K'), Tmax=(994.675,'K')), NASAPolynomial(coeffs=[16.0832,0.0278287,-9.89633e-06,1.70172e-09,-1.14336e-13,14308.3,-50.1199], Tmin=(994.675,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + ring(12dioxetane) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=O)C[CH]C[O](27523)',
    structure = SMILES('[CH]=C(C=O)C[CH]C[O]'),
    E0 = (341.768,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,350,440,435,1725,3025,407.5,1350,352.5,180,668.497,4000],'cm^-1')),
        HinderedRotor(inertia=(0.184395,'amu*angstrom^2'), symmetry=1, barrier=(4.2396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0136044,'amu*angstrom^2'), symmetry=1, barrier=(4.26588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.37489,'amu*angstrom^2'), symmetry=1, barrier=(31.6114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185137,'amu*angstrom^2'), symmetry=1, barrier=(4.25666,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.83412,0.0771509,-0.000104763,9.44196e-08,-3.62967e-11,41212,32.7725], Tmin=(100,'K'), Tmax=(734.857,'K')), NASAPolynomial(coeffs=[4.99377,0.0458969,-2.33884e-05,4.64791e-09,-3.30721e-13,40833.2,15.5683], Tmin=(734.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]=C(C=O)C[C]CO[O](27524)',
    structure = SMILES('[CH]=C(C=O)C[C]CO[O]'),
    E0 = (587.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,2782.5,750,1395,475,1775,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.225512,0.101936,-0.000157762,1.37236e-07,-4.81403e-11,70849.8,34.6457], Tmin=(100,'K'), Tmax=(776.902,'K')), NASAPolynomial(coeffs=[9.9156,0.0403369,-2.07074e-05,4.07756e-09,-2.86852e-13,69557.4,-9.89627], Tmin=(776.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(587.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P) + radical(ROOJ)"""),
)

species(
    label = '[C]=C(C=O)C[CH]CO[O](27525)',
    structure = SMILES('[C]=C(C=O)C[CH]CO[O]'),
    E0 = (651.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2782.5,750,1395,475,1775,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.11,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165958,0.104465,-0.000177398,1.66619e-07,-6.10102e-11,78445.8,36.8026], Tmin=(100,'K'), Tmax=(818.838,'K')), NASAPolynomial(coeffs=[6.91508,0.0452038,-2.3647e-05,4.64687e-09,-3.24548e-13,78113.2,9.10624], Tmin=(818.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(651.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[O]OC[CH]CC1=CC1[O](27498)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(966131,'s^-1'), n=1.86605, Ea=(97.755,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]=C1C[CH]COOC1[O](27499)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH]=C(C=O)C=CCO[O](27500)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH]=C(C=O)CC=CO[O](27501)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=O(373)', 'C#CC[CH]CO[O](7755)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O2(2)', '[CH]=C(C=O)CC=C(22488)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(C=O)=CCCO[O](27359)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]=C(C=O)CC[CH]O[O](27502)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(C=O)C[CH][CH]OO(27503)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH2]C(C=O)=C[CH]CO[O](27504)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['C=C([C]=O)C[CH]CO[O](27505)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]C(=C=O)CCCO[O](27506)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['C=C(C=O)C[CH][CH]O[O](27507)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]C(C=O)=C[CH]COO(27508)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]C(=C=O)C[CH]COO(27509)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O2(2)', '[CH]=C(C=O)C[CH][CH2](22492)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C(C=O)=C[CH]CO[O](27510)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]=C(C=O)C[CH][CH]O[O](27511)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=O(373)', '[CH]=[C]C[CH]CO[O](7765)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]C(=C=O)C[CH]CO[O](27512)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[O]OC[CH]CC1[CH]OC=1(27513)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]=C1[CH]OOOC[CH]C1(27514)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(5.649e+12,'s^-1'), n=0.287, Ea=(205.443,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;carbonyl_intra_H;radadd_intra] for rate rule [R8_linear;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic
Ea raised from 196.7 to 205.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction29',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['C=C(C=O)C=CCO[O](27515)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]=C(C=O)CC=COO(27516)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['C=C(C=O)CC=CO[O](27517)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]=C(C=O)C=CCOO(27518)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C(=C[CH]CO[O])C[O](27519)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]C([CH]O)=C[CH]CO[O](27520)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['O2(S)(5486)', '[CH]=C(C=O)CC=C(22488)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[C-]#[O+](374)', '[CH]=CC[CH]CO[O](6956)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['O(T)(63)', '[CH]=C(C=O)CC1CO1(27521)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
    products = ['[CH]=C(C=O)CC1COO1(27522)'],
...
reaction(
    label = 'reaction42',
    reactants = ['O(T)(63)', '[CH]=C(C=O)C[CH]C[O](27523)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]CO[O](7037)', '[CH]C(=C)C=O(18781)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]O[O](61)', '[CH]CC(=[CH])C=O(22667)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(8)', '[CH]=C(C=O)C[C]CO[O](27524)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(8)', '[C]=C(C=O)C[CH]CO[O](27525)'],
    products = ['[CH]=C(C=O)C[CH]CO[O](22505)'],
