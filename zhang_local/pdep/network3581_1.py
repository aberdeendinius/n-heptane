...
species(
    label = '[O]OC[CH]CC1CC1[O](17265)',
    structure = SMILES('[O]OC[CH]CC1CC1[O]'),
    E0 = (283.678,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0433888,0.0832231,-6.96998e-05,3.05034e-08,-5.42335e-12,34268.7,35.8836], Tmin=(100,'K'), Tmax=(1332.44,'K')), NASAPolynomial(coeffs=[16.5086,0.0335342,-1.37626e-05,2.51614e-09,-1.72247e-13,29857.8,-48.7206], Tmin=(1332.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]C1C[CH]COOC1[O](17266)',
    structure = SMILES('[CH2]C1C[CH]COOC1[O]'),
    E0 = (231.845,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.463321,0.0336528,0.00013789,-2.34404e-07,1.01862e-10,28053.1,35.5476], Tmin=(100,'K'), Tmax=(911.77,'K')), NASAPolynomial(coeffs=[35.281,-0.00379807,9.82134e-06,-2.0726e-09,1.31326e-13,16911.5,-155.493], Tmin=(911.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(Isobutyl) + radical(CCJCOOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C=C(C=O)C[CH]CO[O](17267)',
    structure = SMILES('C=C(C=O)C[CH]CO[O]'),
    E0 = (92.9893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.88831,0.0820966,-5.71134e-05,-5.03302e-08,8.12963e-11,11282.1,32.8536], Tmin=(100,'K'), Tmax=(477.51,'K')), NASAPolynomial(coeffs=[7.61764,0.0487076,-2.4419e-05,4.81177e-09,-3.40592e-13,10377.4,2.61919], Tmin=(477.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.9893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=O)C=CCO[O](17268)',
    structure = SMILES('[CH2]C(C=O)C=CCO[O]'),
    E0 = (114.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.28374,'amu*angstrom^2'), symmetry=1, barrier=(6.52374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282629,'amu*angstrom^2'), symmetry=1, barrier=(6.4982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283401,'amu*angstrom^2'), symmetry=1, barrier=(6.51594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283942,'amu*angstrom^2'), symmetry=1, barrier=(6.52839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284119,'amu*angstrom^2'), symmetry=1, barrier=(6.53246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.159015,0.101316,-0.00015273,1.34629e-07,-4.72726e-11,13955,35.9086], Tmin=(100,'K'), Tmax=(829.191,'K')), NASAPolynomial(coeffs=[7.57378,0.0465515,-2.20751e-05,4.18657e-09,-2.87546e-13,13272.9,3.6704], Tmin=(829.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CJC(C)C=O) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=O)CC=CO[O](17269)',
    structure = SMILES('[CH2]C(C=O)CC=CO[O]'),
    E0 = (125.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1380,1390,370,380,2900,435,255.4,255.4],'cm^-1')),
        HinderedRotor(inertia=(0.185932,'amu*angstrom^2'), symmetry=1, barrier=(8.60644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185932,'amu*angstrom^2'), symmetry=1, barrier=(8.60644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185932,'amu*angstrom^2'), symmetry=1, barrier=(8.60644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185932,'amu*angstrom^2'), symmetry=1, barrier=(8.60644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.185932,'amu*angstrom^2'), symmetry=1, barrier=(8.60644,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0827162,0.0948362,-0.000116872,8.11095e-08,-2.30151e-11,15245.8,36.1413], Tmin=(100,'K'), Tmax=(854.367,'K')), NASAPolynomial(coeffs=[12.0621,0.0379773,-1.7048e-05,3.21761e-09,-2.23261e-13,13170.5,-20.5392], Tmin=(854.367,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CJC(C)C=O)"""),
)
...
species(
    label = 'CC(=C[O])C[CH]CO[O](17270)',
    structure = SMILES('CC(=C[O])C[CH]CO[O]'),
    E0 = (117.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.328526,0.095951,-0.000100959,5.71691e-08,-1.31214e-11,14276.5,36.4211], Tmin=(100,'K'), Tmax=(1050.46,'K')), NASAPolynomial(coeffs=[15.405,0.0360393,-1.54073e-05,2.87367e-09,-1.99403e-13,10971,-40.2585], Tmin=(1050.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]C(C=O)CC[CH]O[O](17271)',
    structure = SMILES('[CH2]C(C=O)CC[CH]O[O]'),
    E0 = (182.351,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.636404,0.113259,-0.000175388,1.55014e-07,-5.40334e-11,22087.8,37.3523], Tmin=(100,'K'), Tmax=(839.761,'K')), NASAPolynomial(coeffs=[8.39188,0.0491855,-2.33043e-05,4.40063e-09,-3.00839e-13,21314.4,-0.203953], Tmin=(839.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)C=O) + radical(CCsJOOH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=O)C[CH][CH]OO(17272)',
    structure = SMILES('[CH2]C(C=O)C[CH][CH]OO'),
    E0 = (230.761,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.873508,0.118866,-0.000186622,1.65098e-07,-5.77125e-11,27918.4,39.749], Tmin=(100,'K'), Tmax=(828.321,'K')), NASAPolynomial(coeffs=[9.2827,0.049463,-2.40742e-05,4.60154e-09,-3.16918e-13,26934.3,-3.12006], Tmin=(828.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(230.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)C=O) + radical(CCsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([CH][CH]CO[O])C=O(17273)',
    structure = SMILES('CC([CH][CH]CO[O])C=O'),
    E0 = (183.575,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0725622,0.0965382,-0.000127173,1.03024e-07,-3.4825e-11,22219,39.6336], Tmin=(100,'K'), Tmax=(777.872,'K')), NASAPolynomial(coeffs=[8.53149,0.047099,-2.18199e-05,4.14571e-09,-2.87219e-13,21037.6,1.29561], Tmin=(777.872,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.575,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJCC=O)"""),
)

species(
    label = 'CC([C]=O)C[CH]CO[O](17274)',
    structure = SMILES('CC([C]=O)C[CH]CO[O]'),
    E0 = (142.361,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.231058,0.100697,-0.000138772,1.15014e-07,-3.91249e-11,17267.2,38.861], Tmin=(100,'K'), Tmax=(799.152,'K')), NASAPolynomial(coeffs=[8.84211,0.0468131,-2.17346e-05,4.11754e-09,-2.84116e-13,16087.4,-1.18535], Tmin=(799.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCJCOOH) + radical(CC(C)CJ=O)"""),
)

species(
    label = '[CH2]C(=C[O])CCCO[O](17275)',
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.752004,0.0961719,-9.32102e-05,4.63368e-08,-9.11065e-12,8416.08,35.9114], Tmin=(100,'K'), Tmax=(1236.29,'K')), NASAPolynomial(coeffs=[20.2264,0.0282973,-1.08582e-05,1.92904e-09,-1.30689e-13,3228.97,-69.7471], Tmin=(1236.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.4943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(ROOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([C]=O)CCCO[O](17276)',
    structure = SMILES('[CH2]C([C]=O)CCCO[O]'),
    E0 = (152.457,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.551829,0.108803,-0.000159003,1.33968e-07,-4.53501e-11,18491.9,38.0576], Tmin=(100,'K'), Tmax=(821.725,'K')), NASAPolynomial(coeffs=[9.90327,0.0456229,-2.12435e-05,4.00633e-09,-2.74763e-13,17188.5,-7.80521], Tmin=(821.725,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.457,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CJC(C)C=O) + radical(CC(C)CJ=O)"""),
)

species(
    label = 'CC(C=O)C[CH][CH]O[O](17277)',
    structure = SMILES('CC(C=O)C[CH][CH]O[O]'),
    E0 = (172.255,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329231,0.105327,-0.000155831,1.37024e-07,-4.82558e-11,20863.7,38.2036], Tmin=(100,'K'), Tmax=(826.442,'K')), NASAPolynomial(coeffs=[7.37504,0.050296,-2.37477e-05,4.50021e-09,-3.09207e-13,20196.1,6.16921], Tmin=(826.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCOOH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C([CH][CH]COO)C=O(17278)',
    structure = SMILES('[CH2]C([CH][CH]COO)C=O'),
    E0 = (242.081,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.628785,0.110234,-0.000158595,1.32045e-07,-4.47495e-11,29274.2,41.2209], Tmin=(100,'K'), Tmax=(788.71,'K')), NASAPolynomial(coeffs=[10.4686,0.0462123,-2.2114e-05,4.23911e-09,-2.94254e-13,27764.5,-8.15719], Tmin=(788.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CJC(C)C=O) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(=C[O])C[CH]COO(17279)',
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.888151,0.100573,-0.000100105,5.04966e-08,-1.00663e-11,14242.2,37.9465], Tmin=(100,'K'), Tmax=(1218.57,'K')), NASAPolynomial(coeffs=[20.979,0.0287933,-1.17472e-05,2.15682e-09,-1.48919e-13,8912.92,-71.8722], Tmin=(1218.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CCJCOOH) + radical(C=COJ)"""),
)

species(
    label = '[CH2]C([C]=O)C[CH]COO(17280)',
    structure = SMILES('[CH2]C([C]=O)C[CH]COO'),
    E0 = (200.867,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.780953,0.114309,-0.000169853,1.43518e-07,-4.87908e-11,24322.1,40.4262], Tmin=(100,'K'), Tmax=(805.72,'K')), NASAPolynomial(coeffs=[10.7643,0.0459538,-2.20454e-05,4.21502e-09,-2.91499e-13,22820,-10.5552], Tmin=(805.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)CJ=O) + radical(CJC(C)C=O) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]C(=C[O])C[CH]CO[O](17281)',
    structure = SMILES('[CH2]C(=C[O])C[CH]CO[O]'),
    E0 = (268.909,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.513242,0.0956925,-0.000100452,5.44639e-08,-1.17161e-11,32507.9,37.3594], Tmin=(100,'K'), Tmax=(1130.75,'K')), NASAPolynomial(coeffs=[18.4003,0.0287864,-1.16978e-05,2.13655e-09,-1.46954e-13,28230.6,-56.2118], Tmin=(1130.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=COJ) + radical(CCJCOOH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH][CH]CO[O])C=O(17282)',
    structure = SMILES('[CH2]C([CH][CH]CO[O])C=O'),
    E0 = (394.085,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.424118,0.107373,-0.000165953,1.44789e-07,-4.98865e-11,47547.2,41.2427], Tmin=(100,'K'), Tmax=(837.818,'K')), NASAPolynomial(coeffs=[9.06142,0.0442286,-2.09301e-05,3.95168e-09,-2.70181e-13,46584.5,0.89929], Tmin=(837.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCJCC=O) + radical(CJC(C)C=O) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(C=O)C[CH][CH]O[O](17283)',
    structure = SMILES('[CH2]C(C=O)C[CH][CH]O[O]'),
    E0 = (382.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.633406,0.115554,-0.000192256,1.75417e-07,-6.17471e-11,46189.8,39.6459], Tmin=(100,'K'), Tmax=(855.244,'K')), NASAPolynomial(coeffs=[7.75069,0.047703,-2.30242e-05,4.34661e-09,-2.95596e-13,45803.1,6.63169], Tmin=(855.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOOH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]C([C]=O)C[CH]CO[O](17284)',
    structure = SMILES('[CH2]C([C]=O)C[CH]CO[O]'),
    E0 = (352.872,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.56118,0.111255,-0.000176467,1.55209e-07,-5.34459e-11,42594.4,40.3948], Tmin=(100,'K'), Tmax=(846.1,'K')), NASAPolynomial(coeffs=[9.3042,0.0440653,-2.09186e-05,3.94148e-09,-2.68603e-13,41660.6,-1.20443], Tmin=(846.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)CJ=O) + radical(CCJCOOH) + radical(ROOJ) + radical(CJC(C)C=O)"""),
)

species(
    label = '[O]OC[CH]CC1[CH]OC1(17285)',
    structure = SMILES('[O]OC[CH]CC1[CH]OC1'),
    E0 = (267.851,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0844592,0.0876158,-7.83297e-05,3.04292e-08,-7.41684e-13,32364.6,34.5735], Tmin=(100,'K'), Tmax=(815.747,'K')), NASAPolynomial(coeffs=[14.7186,0.0328263,-1.03073e-05,1.58242e-09,-9.73779e-14,29357.3,-37.4573], Tmin=(815.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CCsJOCs) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]C1[CH]OOOC[CH]C1(17286)',
    structure = SMILES('[CH2]C1[CH]OOOC[CH]C1'),
    E0 = (445.426,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
...
species(
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22361,0.0911411,-0.000104771,7.50789e-08,-2.35026e-11,-12791.6,32.7512], Tmin=(100,'K'), Tmax=(757.203,'K')), NASAPolynomial(coeffs=[7.83032,0.0509543,-2.51545e-05,4.97592e-09,-3.55128e-13,-13943.5,-1.83044], Tmin=(757.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-107.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cd-CdCs(CO)) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(ROOJ)"""),
)

species(
    label = 'CC(C=O)C=CCO[O](17288)',
    structure = SMILES('CC(C=O)C=CCO[O]'),
    E0 = (-95.6484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04049,0.0770145,-4.34635e-05,-5.43198e-08,7.38557e-11,-11409.4,31.441], Tmin=(100,'K'), Tmax=(489.399,'K')), NASAPolynomial(coeffs=[6.91821,0.0496775,-2.31313e-05,4.42339e-09,-3.08359e-13,-12232.6,4.7515], Tmin=(489.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.6484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=O)CC=COO(17289)',
    structure = SMILES('[CH2]C(C=O)CC=COO'),
    E0 = (-26.4293,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.217521,0.0968835,-0.000106643,6.43935e-08,-1.59559e-11,-3030.26,35.8678], Tmin=(100,'K'), Tmax=(969.659,'K')), NASAPolynomial(coeffs=[13.6734,0.0395806,-1.79977e-05,3.447e-09,-2.42346e-13,-5724.12,-30.7197], Tmin=(969.659,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.4293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + radical(CJC(C)C=O)"""),
)

species(
    label = 'CC(C=O)CC=CO[O](17290)',
    structure = SMILES('CC(C=O)CC=CO[O]'),
    E0 = (-84.9353,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.253444,0.0843311,-7.98511e-05,4.22398e-08,-9.33154e-12,-10082,34.5769], Tmin=(100,'K'), Tmax=(1070.96,'K')), NASAPolynomial(coeffs=[12.2342,0.0395839,-1.71783e-05,3.22671e-09,-2.24606e-13,-12648.2,-24.0448], Tmin=(1070.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.9353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=O)C=CCOO(17291)',
    structure = SMILES('[CH2]C(C=O)C=CCOO'),
    E0 = (-37.1424,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.358027,0.104107,-0.00014512,1.2157e-07,-4.20217e-11,-4318.16,35.8668], Tmin=(100,'K'), Tmax=(777.456,'K')), NASAPolynomial(coeffs=[8.94929,0.0485921,-2.32932e-05,4.48232e-09,-3.12324e-13,-5534.81,-5.20993], Tmin=(777.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.1424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2][C](C[O])C[CH]CO[O](17292)',
    structure = SMILES('[CH2][C](C[O])C[CH]CO[O]'),
    E0 = (490.072,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.147892,0.10259,-0.000153902,1.38904e-07,-4.9483e-11,59080.5,40.7706], Tmin=(100,'K'), Tmax=(849.408,'K')), NASAPolynomial(coeffs=[5.39012,0.0528948,-2.44405e-05,4.56438e-09,-3.10109e-13,58991.6,19.9715], Tmin=(849.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Isobutyl) + radical(CCJ(C)CO) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C([CH][CH]CO[O])C[O](17293)',
    structure = SMILES('[CH2]C([CH][CH]CO[O])C[O]'),
    E0 = (532.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,247.018,858.926,1145.24,1490.06,1851.42],'cm^-1')),
        HinderedRotor(inertia=(0.0970726,'amu*angstrom^2'), symmetry=1, barrier=(3.40464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970726,'amu*angstrom^2'), symmetry=1, barrier=(3.40464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970726,'amu*angstrom^2'), symmetry=1, barrier=(3.40464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970726,'amu*angstrom^2'), symmetry=1, barrier=(3.40464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0970726,'amu*angstrom^2'), symmetry=1, barrier=(3.40464,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.235706,0.108116,-0.000177052,1.6749e-07,-6.08541e-11,64127.8,43.4459], Tmin=(100,'K'), Tmax=(860.279,'K')), NASAPolynomial(coeffs=[3.82682,0.0554167,-2.62135e-05,4.91413e-09,-3.33114e-13,64680,31.7294], Tmin=(860.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(CCOJ) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C([CH]O)[CH][CH]CO[O](17294)',
    structure = SMILES('[CH2]C([CH]O)[CH][CH]CO[O]'),
    E0 = (486.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.834217,0.119189,-0.000194367,1.72317e-07,-5.87394e-11,58690.3,44.284], Tmin=(100,'K'), Tmax=(876.498,'K')), NASAPolynomial(coeffs=[9.0644,0.0459273,-2.09227e-05,3.83372e-09,-2.55538e-13,58034,3.98841], Tmin=(876.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(ROOJ) + radical(Isobutyl) + radical(Cs_S) + radical(CCsJOH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0463599,0.0825107,-8.32247e-05,4.81424e-08,-1.12109e-11,-6206.7,29.9232], Tmin=(100,'K'), Tmax=(1085.24,'K')), NASAPolynomial(coeffs=[13.3437,0.0315427,-1.00736e-05,1.54438e-09,-9.37189e-14,-8977.67,-34.7858], Tmin=(1085.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.8205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CJC(C)C=O)"""),
)
...
species(
    label = '[CH2]C(C=O)CC1COO1(17297)',
    structure = SMILES('[CH2]C(C=O)CC1COO1'),
    E0 = (4.43725,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162094,0.0865006,-7.44485e-05,2.9579e-08,-2.46846e-12,688.242,32.5455], Tmin=(100,'K'), Tmax=(898.611,'K')), NASAPolynomial(coeffs=[15.4189,0.0327742,-1.08558e-05,1.75608e-09,-1.12804e-13,-2743.06,-44.4695], Tmin=(898.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.43725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(12dioxetane) + radical(CJC(C)C=O)"""),
)
...
species(
    label = '[CH2]C(=CO)C[CH]CO[O](17298)',
    structure = SMILES('[CH2]C(=CO)C[CH]CO[O]'),
    E0 = (127.447,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19458,0.105883,-0.000115298,6.33589e-08,-1.35477e-11,15522.5,38.3918], Tmin=(100,'K'), Tmax=(1151.14,'K')), NASAPolynomial(coeffs=[22.4313,0.0237868,-8.32192e-06,1.40486e-09,-9.27355e-14,10083.2,-78.9148], Tmin=(1151.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCJCOOH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C=O)C[CH]C[O](17299)',
    structure = SMILES('[CH2]C(C=O)C[CH]C[O]'),
    E0 = (195.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35938,0.0888623,-0.000125157,1.11529e-07,-4.05544e-11,23679.8,35.4651], Tmin=(100,'K'), Tmax=(808.73,'K')), NASAPolynomial(coeffs=[5.3477,0.0490701,-2.33083e-05,4.45359e-09,-3.08363e-13,23367.4,15.5153], Tmin=(808.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCOJ) + radical(CCJCO) + radical(CJC(C)C=O)"""),
)
...
species(
    label = '[CH2]C(C=O)C[C]CO[O](17300)',
    structure = SMILES('[CH2]C(C=O)C[C]CO[O]'),
    E0 = (441.984,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.688495,0.11352,-0.000177829,1.54281e-07,-5.26554e-11,53317.2,37.2958], Tmin=(100,'K'), Tmax=(840.856,'K')), NASAPolynomial(coeffs=[10.1383,0.043747,-2.07698e-05,3.91799e-09,-2.67445e-13,52142.3,-9.22006], Tmin=(840.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH]C(C=O)C[CH]CO[O](17301)',
    structure = SMILES('[CH]C(C=O)C[CH]CO[O]'),
    E0 = (431.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.126,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.379427,0.105564,-0.000158172,1.36141e-07,-4.68019e-11,52092.9,39.2391], Tmin=(100,'K'), Tmax=(825.721,'K')), NASAPolynomial(coeffs=[9.11805,0.0448637,-2.12169e-05,4.01848e-09,-2.7589e-13,51025.3,-1.72922], Tmin=(825.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[O]OC[CH]CC1CC1[O](17265)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(966131,'s^-1'), n=1.86605, Ea=(80.701,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_csHNd]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 75.6 to 80.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C1C[CH]COOC1[O](17266)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C=C(C=O)C[CH]CO[O](17267)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH2]C(C=O)C=CCO[O](17268)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH2]C(C=O)CC=CO[O](17269)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=O(373)', 'C=CC[CH]CO[O](6844)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(532000,'cm^3/(mol*s)'), n=1.85, Ea=(27.393,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-Cs\O2s/H;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 26.2 to 27.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction11',
    reactants = ['O2(2)', '[CH2]C(C=O)CC=C(12798)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC(=C[O])C[CH]CO[O](17270)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH]CCO[O])C=O(17106)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C(C=O)CC[CH]O[O](17271)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C=O)C[CH][CH]OO(17272)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['CC([CH][CH]CO[O])C=O(17273)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['CC([C]=O)C[CH]CO[O](17274)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C(=C[O])CCCO[O](17275)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C([C]=O)CCCO[O](17276)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['CC(C=O)C[CH][CH]O[O](17277)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH][CH]COO)C=O(17278)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C(=C[O])C[CH]COO(17279)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([C]=O)C[CH]COO(17280)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O2(2)', '[CH2][CH]CC([CH2])C=O(12804)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=O(373)', '[CH2][CH]C[CH]CO[O](7027)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH2]C(=C[O])C[CH]CO[O](17281)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH2]C([CH][CH]CO[O])C=O(17282)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH2]C(C=O)C[CH][CH]O[O](17283)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH2]C([C]=O)C[CH]CO[O](17284)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[O]OC[CH]CC1[CH]OC1(17285)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C1[CH]OOOC[CH]C1(17286)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(5.649e+12,'s^-1'), n=0.287, Ea=(251.242,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;carbonyl_intra_H;radadd_intra] for rate rule [R8_linear;carbonyl_intra_H;radadd_intra_O]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Endocyclic
Ea raised from 243.0 to 251.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['C=C(C=O)CCCO[O](17287)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C(C=O)CC=COO(17289)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C(C=O)C=CCOO(17291)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2][C](C[O])C[CH]CO[O](17292)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C([CH][CH]CO[O])C[O](17293)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C([CH]O)[CH][CH]CO[O](17294)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['O2(S)(5486)', '[CH2]C(C=O)CC=C(12798)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[C-]#[O+](374)', '[CH2]CC[CH]CO[O](6803)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['O(T)(63)', '[CH2]C(C=O)CC1CO1(17295)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[O]OC[CH]C[CH]CC=O(17296)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
    products = ['[CH2]C(C=O)CC1COO1(17297)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C(=CO)C[CH]CO[O](17298)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction52',
    reactants = ['O(T)(63)', '[CH2]C(C=O)C[CH]C[O](17299)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C([CH2])C=O(6124)', '[CH]CO[O](7037)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]O[O](61)', '[CH]CC([CH2])C=O(12942)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(8)', '[CH2]C(C=O)C[C]CO[O](17300)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
...
reaction(
    label = 'reaction57',
    reactants = ['H(8)', '[CH]C(C=O)C[CH]CO[O](17301)'],
    products = ['[CH2]C(C=O)C[CH]CO[O](12819)'],
