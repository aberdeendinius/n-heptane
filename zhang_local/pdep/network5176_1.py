...
species(
    label = '[CH2]OC(=C)C[C]=CO(30073)',
    structure = SMILES('[CH2]OC(=C)C[C]=CO'),
    E0 = (113.932,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255708,0.0770402,-4.02811e-05,-2.13086e-08,1.9075e-11,13871.4,32.6091], Tmin=(100,'K'), Tmax=(928.198,'K')), NASAPolynomial(coeffs=[25.1017,0.0103472,-1.31792e-06,1.32046e-10,-1.20664e-14,7329.69,-97.7175], Tmin=(928.198,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C1(C=C=CO)CO1(30074)',
    structure = SMILES('[CH2]C1(C=C=CO)CO1'),
    E0 = (93.7112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,3150,900,1100,180,180,180,180,557.438,1600,1645.12,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.140178,'amu*angstrom^2'), symmetry=1, barrier=(3.22297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140178,'amu*angstrom^2'), symmetry=1, barrier=(3.22297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140178,'amu*angstrom^2'), symmetry=1, barrier=(3.22297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83598,0.0989048,-0.000112206,6.05906e-08,-1.17941e-11,11506.4,32.3194], Tmin=(100,'K'), Tmax=(1542.63,'K')), NASAPolynomial(coeffs=[23.3977,0.00614418,4.56634e-06,-1.35887e-09,1.06688e-13,6973.08,-89.8166], Tmin=(1542.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.7112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1(CC#CO)CO1(30075)',
    structure = SMILES('[CH2]C1(CC#CO)CO1'),
    E0 = (170.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,3615,1277.5,1000,2100,2250,500,550,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.303279,0.0878107,-0.000104457,6.48469e-08,-1.52117e-11,20628.3,28.0968], Tmin=(100,'K'), Tmax=(1209.75,'K')), NASAPolynomial(coeffs=[16.4449,0.0193347,-3.31059e-06,1.57076e-10,6.30584e-15,17534.5,-51.9311], Tmin=(1209.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CtH) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC1([CH]O1)C[C]=CO(30076)',
    structure = SMILES('CC1([CH]O1)C[C]=CO'),
    E0 = (147.799,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.0955,0.101041,-0.000109764,5.71214e-08,-1.07615e-11,18024,34.1461], Tmin=(100,'K'), Tmax=(1589.9,'K')), NASAPolynomial(coeffs=[24.049,0.00809459,3.5605e-06,-1.14549e-09,9.06715e-14,13144.6,-93.3092], Tmin=(1589.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCsJO)"""),
)

species(
    label = 'CC1([CH][C]=CO)CO1(30077)',
    structure = SMILES('CC1([CH][C]=CO)CO1'),
    E0 = (80.9932,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.10635,0.101286,-0.000107419,5.50015e-08,-1.02503e-11,9989.55,31.1862], Tmin=(100,'K'), Tmax=(1599.06,'K')), NASAPolynomial(coeffs=[24.0425,0.0100072,2.47016e-06,-9.29253e-10,7.56411e-14,4934.02,-96.9003], Tmin=(1599.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.9932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'CC1(C[C]=[C]O)CO1(30078)',
    structure = SMILES('CC1(C[C]=[C]O)CO1'),
    E0 = (203.821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.91448,0.0903354,-9.69859e-05,5.28578e-08,-1.07268e-11,24706.2,32.8204], Tmin=(100,'K'), Tmax=(1426.74,'K')), NASAPolynomial(coeffs=[19.6848,0.0157655,-9.055e-07,-2.99309e-10,3.54025e-14,20540,-67.8812], Tmin=(1426.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C1([CH]O1)C[C]=CO(30079)',
    structure = SMILES('[CH2]C1([CH]O1)C[C]=CO'),
    E0 = (358.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,2950,1000,180,180,180,180,655.172,1549.72,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.148331,'amu*angstrom^2'), symmetry=1, barrier=(3.41043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148331,'amu*angstrom^2'), symmetry=1, barrier=(3.41043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148331,'amu*angstrom^2'), symmetry=1, barrier=(3.41043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148331,'amu*angstrom^2'), symmetry=1, barrier=(3.41043,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86267,0.10725,-0.00013181,7.59542e-08,-1.58581e-11,43324.5,33.0396], Tmin=(100,'K'), Tmax=(1410.79,'K')), NASAPolynomial(coeffs=[25.6394,0.0039197,5.01139e-06,-1.43941e-09,1.13873e-13,38087.7,-100.165], Tmin=(1410.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCsJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH][C]=CO)CO1(30080)',
    structure = SMILES('[CH2]C1([CH][C]=CO)CO1'),
    E0 = (291.503,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.86254,0.107385,-0.00012916,7.35309e-08,-1.52502e-11,35289.5,30.0388], Tmin=(100,'K'), Tmax=(1411.6,'K')), NASAPolynomial(coeffs=[25.5419,0.00597397,3.84485e-06,-1.20613e-09,9.74894e-14,29919.4,-103.235], Tmin=(1411.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(291.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(CJC(C)OC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1(C[C]=[C]O)CO1(30081)',
    structure = SMILES('[CH2]C1(C[C]=[C]O)CO1'),
    E0 = (414.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1670,1700,300,440,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262569,0.0906033,-9.31379e-05,2.96653e-08,6.45959e-12,49989.6,30.2738], Tmin=(100,'K'), Tmax=(776,'K')), NASAPolynomial(coeffs=[20.8294,0.0120537,3.75015e-07,-5.66858e-10,5.71578e-14,45807.6,-71.9874], Tmin=(776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(C=CJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = 'CC1(C=C=CO)CO1(30082)',
    structure = SMILES('CC1(C=C=CO)CO1'),
    E0 = (-116.799,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.23485,0.094356,-9.47688e-05,4.63401e-08,-8.16469e-12,-13786,34.0443], Tmin=(100,'K'), Tmax=(1736.48,'K')), NASAPolynomial(coeffs=[20.6275,0.0117071,2.52629e-06,-9.57365e-10,7.63203e-14,-17205.2,-75.8528], Tmin=(1736.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Ethylene_oxide)"""),
)

species(
    label = 'OC=[C]C[C]1CCO1(30083)',
    structure = SMILES('OC=[C]C[C]1CCO1'),
    E0 = (157.232,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.689984,0.082863,-8.11595e-05,4.12741e-08,-7.87278e-12,19096.9,32.136], Tmin=(100,'K'), Tmax=(1521.42,'K')), NASAPolynomial(coeffs=[17.9966,0.0182334,-2.15774e-06,-3.9888e-11,1.62827e-14,15204.9,-59.9619], Tmin=(1521.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Oxetane) + radical(Cds_S) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C[C]=CO(30085)',
    structure = SMILES('[CH2]O[C]([CH2])C[C]=CO'),
    E0 = (413.913,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17038,0.118357,-0.000180348,1.38248e-07,-4.08983e-11,49964.1,34.0252], Tmin=(100,'K'), Tmax=(896.945,'K')), NASAPolynomial(coeffs=[18.1737,0.0242229,-9.76494e-06,1.68074e-09,-1.07779e-13,46810.4,-55.4306], Tmin=(896.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C2CsJOCs) + radical(Cds_S) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH]C1(C[C]=CO)CO1(30086)',
    structure = SMILES('[CH]C1(C[C]=CO)CO1'),
    E0 = (412.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64279,0.0970867,-0.000108565,5.82631e-08,-1.13526e-11,49813.7,33.3128], Tmin=(100,'K'), Tmax=(1526.4,'K')), NASAPolynomial(coeffs=[23.1201,0.00773221,3.28279e-06,-1.08666e-09,8.75082e-14,45103.8,-87.2917], Tmin=(1526.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C[C]=CO(30073)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(C=C=CO)CO1(30074)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH2]C1(CC#CO)CO1(30075)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', 'C#CCC1([CH2])CO1(18509)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    products = ['[CH2]C1(CC=[C]O)CO1(16214)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    products = ['CC1([CH]O1)C[C]=CO(30076)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    products = ['CC1([CH][C]=CO)CO1(30077)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    products = ['[CH2]C1([CH]O1)CC=CO(16221)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CC1(C[C]=[C]O)CO1(30078)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C1(C[C]=CO)CO1(16217)'],
    products = ['CC1(C[C]=C[O])CO1(16218)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH]=[C]CC1([CH2])CO1(18516)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C[C]=CO(30079)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C1([CH][C]=CO)CO1(30080)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2]C1(C[C]=[C]O)CO1(30081)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C[C]=CO(18256)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]O[C]([CH2])C[C]=CO(30085)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C1([CH2])CO1(9287)', '[C]=CO(27807)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C1(C[C]=CO)CO1(30086)'],
    products = ['[CH2]C1(C[C]=CO)CO1(16217)'],
