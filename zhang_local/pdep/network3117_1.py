species(
    ...
    E0 = (130.684,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    label = '[CH2]CC(=O)O[CH]O[O](12145)',
    structure = SMILES('[CH2]CC(=O)O[CH]O[O]'),
    E0 = (-19.2543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34758,0.0876934,-0.000136479,1.16492e-07,-3.93048e-11,-2191.31,30.3022], Tmin=(100,'K'), Tmax=(830.237,'K')), NASAPolynomial(coeffs=[9.61258,0.0318355,-1.52883e-05,2.90058e-09,-1.98858e-13,-3343.04,-10.3435], Tmin=(830.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.2543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + group(Cds-OdCsOs) + radical(OCJO) + radical(CJCC=O) + radical(ROOJ)"""),
)
...
species(
    label = '[O]C1(CC1)OC=O(12146)',
    structure = SMILES('[O]C1(CC1)OC=O'),
    E0 = (-261.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81962,0.0297325,4.14143e-05,-7.83429e-08,3.24278e-11,-31370.9,21.9034], Tmin=(100,'K'), Tmax=(974.854,'K')), NASAPolynomial(coeffs=[16.2776,0.0153673,-5.65891e-06,1.15632e-09,-9.16074e-14,-36326.1,-58.4365], Tmin=(974.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-261.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[O]O[CH]OC1(O)[CH]C1(12147)',
    structure = SMILES('[O]O[CH]OC1(O)[CH]C1'),
    E0 = (98.5963,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0883738,0.0702605,-2.99358e-05,-3.87702e-08,2.7807e-11,12024,30.8299], Tmin=(100,'K'), Tmax=(911.519,'K')), NASAPolynomial(coeffs=[28.8403,-0.00394604,5.38853e-06,-1.12914e-09,7.37571e-14,4559.15,-118.073], Tmin=(911.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.5963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(ROOJ) + radical(OCJO) + radical(CCJCO)"""),
)

species(
    label = '[O]OCOC1([O])[CH]C1(12148)',
    structure = SMILES('[O]OCOC1([O])[CH]C1'),
    E0 = (141.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.527298,0.0518463,2.07674e-05,-8.68753e-08,4.33008e-11,17181.5,30.0983], Tmin=(100,'K'), Tmax=(925.403,'K')), NASAPolynomial(coeffs=[27.4916,-0.0012895,4.10446e-06,-8.19433e-10,4.73323e-14,9475.56,-112.57], Tmin=(925.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)(O)OJ) + radical(ROOJ)"""),
)

species(
    label = '[O]C1([CH]C1)O[CH]OO(12149)',
    structure = SMILES('[O]C1([CH]C1)O[CH]OO'),
    E0 = (178.582,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160041,0.0724245,-5.72461e-05,1.03244e-08,4.17563e-12,21627.4,30.4474], Tmin=(100,'K'), Tmax=(987.81,'K')), NASAPolynomial(coeffs=[21.4248,0.0119275,-4.27254e-06,8.20608e-10,-6.20224e-14,16176.8,-78.2068], Tmin=(987.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(OCJO) + radical(CCJCO)"""),
)
...
species(
    label = '[O]O[CH]OC1([O])[CH]C1(12150)',
    structure = SMILES('[O]O[CH]OC1([O])[CH]C1'),
    E0 = (330.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.449142,0.0685485,-6.10309e-05,1.85679e-08,8.05997e-13,39896.8,30.1681], Tmin=(100,'K'), Tmax=(977.732,'K')), NASAPolynomial(coeffs=[19.537,0.0107788,-3.57776e-06,6.50081e-10,-4.77313e-14,35192.9,-66.4568], Tmin=(977.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(OCJO) + radical(ROOJ) + radical(CC(C)(O)OJ) + radical(CCJCO)"""),
)
...
species(
    label = '[O]C1(CC1)OC1OO1(12151)',
    structure = SMILES('[O]C1(CC1)OC1OO1'),
    E0 = (-77.2982,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20274,0.0453068,1.01686e-05,-5.28615e-08,2.53058e-11,-9181.41,25.0001], Tmin=(100,'K'), Tmax=(957.294,'K')), NASAPolynomial(coeffs=[18.002,0.0149188,-4.58947e-06,8.53557e-10,-6.58669e-14,-14221.7,-64.84], Tmin=(957.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.2982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsOsH) + ring(dioxirane) + ring(Cyclopropane) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[O][CH]OC1([O])CC1(12153)',
    structure = SMILES('[O][CH]OC1([O])CC1'),
    E0 = (134.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63067,0.052714,-4.07597e-05,1.5765e-08,-2.51828e-12,16269.7,22.3828], Tmin=(100,'K'), Tmax=(1426.91,'K')), NASAPolynomial(coeffs=[11.3926,0.0253487,-1.19926e-05,2.32467e-09,-1.63483e-13,13483.8,-28.1834], Tmin=(1426.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(OCJO) + radical(OCOJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[O]O[C]OC1([O])CC1(12155)',
    structure = SMILES('[O]O[C]OC1([O])CC1'),
    E0 = (402.713,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.139794,0.0627654,-1.21219e-05,-5.53766e-08,3.27979e-11,48594.7,27.7249], Tmin=(100,'K'), Tmax=(925.835,'K')), NASAPolynomial(coeffs=[29.1527,-0.00526555,5.23614e-06,-1.00766e-09,6.06894e-14,40765.9,-123.276], Tmin=(925.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsOsHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ) + radical(CH2_triplet) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O]O[CH]OC1([O])CC1(11051)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)O[CH]O[O](12145)'],
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[O]C1(CC1)OC=O(12146)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(49.5891,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 48.2 to 49.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[O]O[CH]OC1([O])CC1(11051)'],
    products = ['[O]O[CH]OC1(O)[CH]C1(12147)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]OCOC1([O])[CH]C1(12148)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O]C1([CH]C1)O[CH]OO(12149)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[O]O[CH]OC1([O])[CH]C1(12150)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[O]O[CH]OC1([O])CC1(11051)'],
    products = ['[O]C1(CC1)OC1OO1(12151)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C1([O])CC1(3057)', '[CH]O[O](2819)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(T)(63)', '[O][CH]OC1([O])CC1(12153)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O2(2)', '[CH]OC1([O])CC1(11768)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[O]O[C]OC1([O])CC1(12155)'],
    products = ['[O]O[CH]OC1([O])CC1(11051)'],
