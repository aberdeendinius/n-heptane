...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15966,0.0512474,-1.8986e-05,-1.71302e-08,1.15323e-11,16715.3,20.8124], Tmin=(100,'K'), Tmax=(976.374,'K')), NASAPolynomial(coeffs=[15.8571,0.016896,-5.94182e-06,1.09074e-09,-7.91016e-14,12612.7,-56.0552], Tmin=(976.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Propargyl)"""),
)
...
species(
    label = 'CC1C[C]=CO1(21194)',
    structure = SMILES('CC1C[C]=CO1'),
    E0 = (72.8949,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0956,0.0200626,7.6889e-05,-1.25991e-07,5.40671e-11,8856.25,14.8565], Tmin=(100,'K'), Tmax=(904.481,'K')), NASAPolynomial(coeffs=[17.7575,0.00809486,1.71656e-06,-5.47102e-10,3.6081e-14,3679.44,-72.0864], Tmin=(904.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.8949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (363.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,3025,407.5,1350,352.5,333.889,333.89,333.89],'cm^-1')),
        HinderedRotor(inertia=(0.231397,'amu*angstrom^2'), symmetry=1, barrier=(18.3059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231396,'amu*angstrom^2'), symmetry=1, barrier=(18.3058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231395,'amu*angstrom^2'), symmetry=1, barrier=(18.3059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.231395,'amu*angstrom^2'), symmetry=1, barrier=(18.3059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    label = '[CH]OC=C=C(21195)',
    structure = SMILES('[CH]OC=C=C'),
    E0 = (453.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,540,610,2055,317.975,317.975,317.975,317.975,317.975],'cm^-1')),
        HinderedRotor(inertia=(0.256205,'amu*angstrom^2'), symmetry=1, barrier=(18.3823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256205,'amu*angstrom^2'), symmetry=1, barrier=(18.3823,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57655,0.0414258,-1.4826e-05,-2.46729e-08,1.64357e-11,54654.7,16.2428], Tmin=(100,'K'), Tmax=(923.078,'K')), NASAPolynomial(coeffs=[18.2256,0.000225225,1.8392e-06,-3.91436e-10,2.35012e-14,50262.7,-69.8877], Tmin=(923.078,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CH2_triplet)"""),
)

species(
    label = 'C=C=CO[C]C(21196)',
    structure = SMILES('C=C=CO[C]C'),
    E0 = (416.06,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.08942,'amu*angstrom^2'), symmetry=1, barrier=(25.0478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08594,'amu*angstrom^2'), symmetry=1, barrier=(24.9679,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08622,'amu*angstrom^2'), symmetry=1, barrier=(24.9742,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.731601,0.0587697,-3.17772e-05,-1.53858e-08,1.4135e-11,50170.2,20.0069], Tmin=(100,'K'), Tmax=(937.152,'K')), NASAPolynomial(coeffs=[20.7235,0.00641439,-7.5709e-07,9.33035e-11,-1.03264e-14,44975.1,-82.8702], Tmin=(937.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC=O(606)', 'C#C[CH2](17441)'],
    products = ['C=C=CO[CH]C(17690)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C=CO[CH]C(17690)'],
    products = ['[CH2]C#COCC(21193)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.37e+07,'s^-1'), n=1.41, Ea=(177.82,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [R3H_SS;C_rad_out_H/NonDeC;Cd_H_out_doubleC] for rate rule [R3H_SS_O;C_rad_out_H/NonDeC;Cd_H_out_doubleC]
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C=[C]O[CH]C(19147)'],
    products = ['C=C=CO[CH]C(17690)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH3](11)', '[CH]OC=C=C(21195)'],
    products = ['C=C=CO[CH]C(17690)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', 'C=C=CO[C]C(21196)'],
    products = ['C=C=CO[CH]C(17690)'],
