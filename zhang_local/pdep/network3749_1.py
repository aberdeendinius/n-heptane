...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3329,0.0638542,-7.37744e-05,5.06587e-08,-1.48346e-11,9535.34,24.0354], Tmin=(100,'K'), Tmax=(813.789,'K')), NASAPolynomial(coeffs=[7.74199,0.0323507,-1.57045e-05,3.08548e-09,-2.19446e-13,8492.25,-5.5639], Tmin=(813.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsHH) + radical(C=C(C=O)CJ) + radical(CsJOC(O)C)"""),
)

species(
    label = '[CH2]C(=C)C(=O)C[O](18002)',
    structure = SMILES('[CH2]C(=C)C(=O)C[O]'),
    E0 = (84.9939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,375,552.5,462.5,1710,288.615,1557.36,4000],'cm^-1')),
        HinderedRotor(inertia=(0.058237,'amu*angstrom^2'), symmetry=1, barrier=(3.44254,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401613,'amu*angstrom^2'), symmetry=1, barrier=(23.7411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401652,'amu*angstrom^2'), symmetry=1, barrier=(23.7411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58559,0.0566326,-5.02062e-05,2.477e-08,-5.24856e-12,10306.4,22.9909], Tmin=(100,'K'), Tmax=(1088.09,'K')), NASAPolynomial(coeffs=[8.66599,0.0306041,-1.43247e-05,2.7859e-09,-1.9754e-13,8765.54,-11.7658], Tmin=(1088.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.9939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(C=OCOJ) + radical(C=C(C=O)CJ)"""),
)
...
species(
    label = '[CH2]C(=C)C1(O)[CH]O1(18003)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.42349,0.090622,-9.85115e-05,4.90628e-08,-8.59402e-12,10310.6,32.2895], Tmin=(100,'K'), Tmax=(1781.37,'K')), NASAPolynomial(coeffs=[20.9523,0.0020102,6.52063e-06,-1.628e-09,1.17526e-13,7713.71,-77.8951], Tmin=(1781.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.4362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Allyl_P) + radical(CCsJO)"""),
)

species(
    label = '[CH]=C(C)C1([O])CO1(18004)',
    structure = SMILES('[CH]=C(C)C1([O])CO1'),
    E0 = (228.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,3150,900,1100,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,180,495.778,1600,1723.35,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.12822,'amu*angstrom^2'), symmetry=1, barrier=(2.94803,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12822,'amu*angstrom^2'), symmetry=1, barrier=(2.94803,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.38794,0.0765876,-8.43908e-05,4.59815e-08,-9.12451e-12,27640.2,26.4118], Tmin=(100,'K'), Tmax=(1505.87,'K')), NASAPolynomial(coeffs=[17.5204,0.00952311,1.8311e-06,-7.86925e-10,6.70748e-14,24457,-59.9778], Tmin=(1505.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = 'C=C(C)C1([O])[CH]O1(18005)',
    structure = SMILES('C=C(C)C1([O])[CH]O1'),
    E0 = (164.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2950,1000,180,180,180,180,644.632,1567.9,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.14035,'amu*angstrom^2'), symmetry=1, barrier=(3.22692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14035,'amu*angstrom^2'), symmetry=1, barrier=(3.22692,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.796932,0.0798647,-8.79502e-05,4.68071e-08,-8.98314e-12,20037.7,27.6854], Tmin=(100,'K'), Tmax=(1573.98,'K')), NASAPolynomial(coeffs=[18.8541,0.00705667,3.22922e-06,-1.04324e-09,8.32399e-14,16684.4,-67.0347], Tmin=(1573.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ) + radical(CCsJO)"""),
)

species(
    label = '[CH]C(=C)C1(O)CO1(18006)',
    structure = SMILES('[CH]C(=C)C1(O)CO1'),
    E0 = (118.899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.464157,0.0583163,9.93702e-06,-8.09619e-08,4.49658e-11,14446.3,23.2038], Tmin=(100,'K'), Tmax=(866.894,'K')), NASAPolynomial(coeffs=[24.6842,0.00372081,5.49939e-06,-1.48831e-09,1.11815e-13,8099.22,-102.573], Tmin=(866.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]1COC12CO2(18009)',
    structure = SMILES('[CH2][C]1COC12CO2'),
    E0 = (185.197,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49391,0.0343768,4.66211e-05,-9.59286e-08,4.24815e-11,22383.4,20.4508], Tmin=(100,'K'), Tmax=(928.309,'K')), NASAPolynomial(coeffs=[19.3312,0.0107282,-1.14649e-06,1.22419e-10,-1.45143e-14,16779,-76.6259], Tmin=(928.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)
...
species(
    label = '[CH2][C](C)C1([O])[CH]O1(18010)',
    structure = SMILES('[CH2][C](C)C1([O])[CH]O1'),
    E0 = (401.169,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.590396,0.070901,-6.77383e-05,3.27122e-08,-5.76375e-12,48440.9,30.7413], Tmin=(100,'K'), Tmax=(1727.19,'K')), NASAPolynomial(coeffs=[15.2765,0.0134328,1.67043e-07,-4.4445e-10,4.09106e-14,46050.7,-45.531], Tmin=(1727.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(CCJ(C)CO) + radical(CCsJO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'C=C1COC12CO2(17977)',
    structure = SMILES('C=C1COC12CO2'),
    E0 = (-45.3533,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45263,0.0373672,3.24717e-05,-7.65617e-08,3.39889e-11,-5346.01,17.5781], Tmin=(100,'K'), Tmax=(948.477,'K')), NASAPolynomial(coeffs=[18.2316,0.0133414,-3.44399e-06,6.34213e-10,-5.18957e-14,-10631.1,-73.5652], Tmin=(948.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.3533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + polycyclic(s1_3_4_ane)"""),
)

species(
    label = '[CH2]OC([O])=C([CH2])[CH2](18011)',
    structure = SMILES('[CH2]OC([O])=C([CH2])[CH2]'),
    E0 = (256.292,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,280.081,970.95],'cm^-1')),
        HinderedRotor(inertia=(0.0291352,'amu*angstrom^2'), symmetry=1, barrier=(19.674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0294285,'amu*angstrom^2'), symmetry=1, barrier=(19.6734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.79032,'amu*angstrom^2'), symmetry=1, barrier=(41.163,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0293741,'amu*angstrom^2'), symmetry=1, barrier=(19.6815,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.491411,0.0681319,-5.79115e-05,1.84302e-08,-1.04259e-13,30959.1,26.2534], Tmin=(100,'K'), Tmax=(1002.82,'K')), NASAPolynomial(coeffs=[17.9241,0.0159513,-5.81831e-06,1.05536e-09,-7.46872e-14,26590.1,-62.249], Tmin=(1002.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(Allyl_P) + radical(C=COCJ) + radical(C=COJ)"""),
)
...
species(
    label = '[CH2]C([CH2])=C([O])C[O](18012)',
    structure = SMILES('[CH2]C([CH2])=C([O])C[O]'),
    E0 = (229.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,325,375,415,465,420,450,1700,1750,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,408.722,408.747,408.772],'cm^-1')),
        HinderedRotor(inertia=(0.0010091,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.001009,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0010091,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2337,0.062536,-6.27198e-05,3.53478e-08,-8.27829e-12,27743.6,26.3999], Tmin=(100,'K'), Tmax=(1017.8,'K')), NASAPolynomial(coeffs=[9.94663,0.0282939,-1.22551e-05,2.29311e-09,-1.59162e-13,25970,-15.7887], Tmin=(1017.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Allyl_P) + radical(Allyl_P) + radical(CCOJ) + radical(C=C(C)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(113.449,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]OC(=O)C([CH2])=C(18001)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=C)C(=O)C[O](18002)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)C1([O])CO1(6600)'],
    products = ['[CH2]C(=C)C1(O)[CH]O1(18003)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=C(C)C1([O])CO1(18004)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=C(C)C1([O])[CH]O1(18005)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=C)C1([O])CO1(6600)'],
    products = ['[CH]C(=C)C1(O)CO1(18006)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C(=C)C1([O])[CH]O1(18007)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]C(=C)C1([O])CO1(18008)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=C)C1([O])CO1(6600)'],
    products = ['[O]C1(CO1)[C]1CC1(12134)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=C)C1([O])CO1(6600)'],
    products = ['[CH2][C]1COC12CO2(18009)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(S)(14)', '[CH2]C(=C)C([O])=O(6553)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])C1([O])[CH]O1(6604)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C](C)C1([O])[CH]O1(18010)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]OC([O])=C([CH2])[CH2](18011)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH2])=C([O])C[O](18012)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', '[CH2]C([CH2])=C1CO1(17910)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', 'C=[C]C1([O])CO1(4876)'],
    products = ['[CH2]C(=C)C1([O])CO1(6600)'],
