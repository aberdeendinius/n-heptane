...
species(
    label = '[CH][CH]OO[C]=O(3190)',
    structure = SMILES('[CH][CH]OO[C]=O'),
    E0 = (403.597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,1855,455,950,392.943,392.946,392.947],'cm^-1')),
        HinderedRotor(inertia=(0.00109179,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439882,'amu*angstrom^2'), symmetry=1, barrier=(48.1959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439857,'amu*angstrom^2'), symmetry=1, barrier=(48.1959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439851,'amu*angstrom^2'), symmetry=1, barrier=(48.1958,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43569,0.0491183,-4.44672e-05,1.59174e-08,-1.18088e-12,48640.1,22.5065], Tmin=(100,'K'), Tmax=(1058.74,'K')), NASAPolynomial(coeffs=[15.1629,0.0088885,-3.95136e-06,7.83129e-10,-5.77023e-14,45081.4,-47.5819], Tmin=(1058.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CCsJOOC) + radical((O)CJOC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C-]#[O+](374)', '[CH2][CH]O[O](697)'],
    products = ['[CH2][CH]OO[C]=O(3016)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CO3t2(1168)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OO[C]=O(3016)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=O(1149)', '[CH2][CH]O[O](697)'],
    products = ['[CH2][CH]OO[C]=O(3016)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(43.5839,'m^3/(mol*s)'), n=1.88017, Ea=(5.1666,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][C]OO[C]=O(3189)'],
    products = ['[CH2][CH]OO[C]=O(3016)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH][CH]OO[C]=O(3190)'],
    products = ['[CH2][CH]OO[C]=O(3016)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
