...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.518987,0.108066,-0.000174858,1.47144e-07,-4.78511e-11,36466.4,29.0227], Tmin=(100,'K'), Tmax=(871.302,'K')), NASAPolynomial(coeffs=[12.6531,0.031176,-1.42209e-05,2.60662e-09,-1.73775e-13,34794.3,-29.1341], Tmin=(871.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.915,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2][C](O)C([CH2])([CH2])O(10646)',
    structure = SMILES('[CH2][C](O)C([CH2])([CH2])O'),
    E0 = (284.588,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.918576,0.117574,-0.000197947,1.65737e-07,-5.27442e-11,34396.2,31.0291], Tmin=(100,'K'), Tmax=(899.621,'K')), NASAPolynomial(coeffs=[14.8643,0.0266371,-1.17057e-05,2.06983e-09,-1.33384e-13,32396.6,-38.7756], Tmin=(899.621,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOH) + radical(CJC(C)2O) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2][C](O)C([CH2])(C)[O](10647)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.375264,0.102844,-0.00015846,1.28546e-07,-4.0737e-11,36411.8,29.9954], Tmin=(100,'K'), Tmax=(861.949,'K')), NASAPolynomial(coeffs=[13.2153,0.029557,-1.31421e-05,2.39803e-09,-1.60207e-13,34448.5,-31.3504], Tmin=(861.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CJCO) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C([O])C([CH2])([CH2])O(10568)',
    structure = SMILES('[CH2]C([O])C([CH2])([CH2])O'),
    E0 = (338.321,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.410393,0.102299,-0.000144508,1.02113e-07,-2.7016e-11,40844.6,29.6067], Tmin=(100,'K'), Tmax=(734.33,'K')), NASAPolynomial(coeffs=[15.793,0.0254572,-1.08718e-05,1.9678e-09,-1.31963e-13,38157,-45.6582], Tmin=(734.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])C([CH2])(C)[O](10569)',
    structure = SMILES('[CH2]C([O])C([CH2])(C)[O]'),
    E0 = (355.22,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115219,0.087943,-0.000107272,6.96102e-08,-1.80537e-11,42860.9,28.6272], Tmin=(100,'K'), Tmax=(940.357,'K')), NASAPolynomial(coeffs=[14.1093,0.0284178,-1.23235e-05,2.2981e-09,-1.58862e-13,40229,-38.0262], Tmin=(940.357,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJC(C)2O) + radical(CC(C)OJ) + radical(CC(C)2OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.133368,0.083647,-8.4411e-05,3.55982e-08,-3.189e-12,-2949.9,29.8245], Tmin=(100,'K'), Tmax=(917.994,'K')), NASAPolynomial(coeffs=[20.248,0.014602,-3.88455e-06,5.69987e-10,-3.63334e-14,-7524.62,-71.2952], Tmin=(917.994,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.8203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C(C)([O])C(=C)O(10650)',
...
species(
    label = '[CH2][CH]C([CH2])([CH2])OO(10652)',
    structure = SMILES('[CH2][CH]C([CH2])([CH2])OO'),
    E0 = (549.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.141345,0.0881407,-0.000109622,7.27801e-08,-1.93568e-11,66273.9,33.9857], Tmin=(100,'K'), Tmax=(916.606,'K')), NASAPolynomial(coeffs=[13.688,0.029026,-1.28853e-05,2.42419e-09,-1.68219e-13,63790.4,-30.19], Tmin=(916.606,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C([CH2])O(10653)',
    structure = SMILES('[CH]C([CH2])([O])C([CH2])O'),
    E0 = (573.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,180,180,180,180,916.362,1305.3,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.159298,'amu*angstrom^2'), symmetry=1, barrier=(3.66258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159298,'amu*angstrom^2'), symmetry=1, barrier=(3.66258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159298,'amu*angstrom^2'), symmetry=1, barrier=(3.66258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159298,'amu*angstrom^2'), symmetry=1, barrier=(3.66258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.159298,'amu*angstrom^2'), symmetry=1, barrier=(3.66258,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.21358,0.0963858,-0.000137827,1.01375e-07,-2.92319e-11,69073.3,30.9994], Tmin=(100,'K'), Tmax=(854.593,'K')), NASAPolynomial(coeffs=[15.3141,0.0237113,-1.02747e-05,1.87658e-09,-1.26674e-13,66419.2,-41.4736], Tmin=(854.593,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(573.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJCO) + radical(CJC(C)2O) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH]C(O)C([CH2])([CH2])[O](10654)',
    structure = SMILES('[CH]C(O)C([CH2])([CH2])[O]'),
    E0 = (573.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,180,180,180,180,895.004,1328.64,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.158639,'amu*angstrom^2'), symmetry=1, barrier=(3.64742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158639,'amu*angstrom^2'), symmetry=1, barrier=(3.64742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158639,'amu*angstrom^2'), symmetry=1, barrier=(3.64742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158639,'amu*angstrom^2'), symmetry=1, barrier=(3.64742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158639,'amu*angstrom^2'), symmetry=1, barrier=(3.64742,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.401476,0.102177,-0.000156455,1.23251e-07,-3.79371e-11,69129.7,30.1821], Tmin=(100,'K'), Tmax=(848.612,'K')), NASAPolynomial(coeffs=[14.853,0.0251494,-1.12453e-05,2.05895e-09,-1.38025e-13,66725.2,-39.821], Tmin=(848.612,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(573.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CCJ2_triplet) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C(=C)O(10645)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(O)C(=C)[O](1091)', 'CH2(T)(28)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)C([CH2])O(6376)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(113.273,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 111.2 to 113.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH2]C([CH2])([O])C=C(10039)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    products = ['[CH2]C([CH2])([O])[C](C)O(10565)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    products = ['[CH2][C](O)C([CH2])([CH2])O(10646)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    products = ['[CH2][C](O)C([CH2])(C)[O](10647)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])C([CH2])([CH2])O(10568)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    products = ['[CH2]C([O])C([CH2])(C)[O](10569)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(D)(132)', '[CH2][CH]C([CH2])([CH2])[O](10278)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([O])C([CH2])([CH2])[O](10050)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][C](O)C([CH2])([CH2])[O](10648)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    products = ['[CH2]C([CH2])(O)C(=C)O(10649)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
    products = ['[CH2]C(C)([O])C(=C)O(10650)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][CH]C([CH2])([CH2])OO(10652)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C([CH2])O(6373)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]([O])C([CH2])O(1086)', 'CH2(T)(28)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])[CH]O(10521)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([CH2])([O])C([CH2])O(10653)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C(O)C([CH2])([CH2])[O](10654)'],
    products = ['[CH2]C(O)C([CH2])([CH2])[O](9866)'],
