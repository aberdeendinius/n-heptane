...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C(=[CH])C=C=C(21246)'],
    products = ['[CH]C(=[CH])C[C]=C(19671)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=[CH])CC#C(21244)'],
    products = ['[CH]C(=[CH])C[C]=C(19671)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH](2815)', 'C#CC[C]=C(17758)'],
    products = ['[CH]C(=[CH])C[C]=C(19671)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[C]C(=[CH])C[C]=C(21651)'],
    products = ['[CH]C(=[CH])C[C]=C(19671)'],
