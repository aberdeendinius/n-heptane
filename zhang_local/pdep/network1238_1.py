...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08905,0.0547656,-4.02497e-05,1.45001e-08,-2.07676e-12,-21031.4,29.0779], Tmin=(100,'K'), Tmax=(1650.75,'K')), NASAPolynomial(coeffs=[15.8075,0.0191008,-7.84189e-06,1.41196e-09,-9.46131e-14,-25890.6,-49.3073], Tmin=(1650.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CsJOC(O)C) + radical(C=OCOJ)"""),
)

species(
    label = 'CC([O])C(=O)C[O](3917)',
    structure = SMILES('CC([O])C(=O)C[O]'),
    E0 = (-85.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,375,552.5,462.5,1710,2750,2850,1437.5,1250,1305,750,350,180,418.997,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0221112,'amu*angstrom^2'), symmetry=1, barrier=(2.74046,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155069,'amu*angstrom^2'), symmetry=1, barrier=(19.1747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154563,'amu*angstrom^2'), symmetry=1, barrier=(19.1744,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33857,0.0563499,-4.91119e-05,2.26947e-08,-4.28343e-12,-10229.4,28.8766], Tmin=(100,'K'), Tmax=(1255.78,'K')), NASAPolynomial(coeffs=[11.6813,0.0234053,-9.76007e-06,1.80351e-09,-1.24408e-13,-12827,-23.3766], Tmin=(1255.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-85.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)
...
species(
    ...
    E0 = (-207.744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,375,552.5,462.5,1710,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43688,0.0858949,-9.56194e-05,4.98388e-08,-9.26659e-12,-12386.8,29.9407], Tmin=(100,'K'), Tmax=(1641.05,'K')), NASAPolynomial(coeffs=[21.0408,0.00339034,5.12762e-06,-1.38086e-09,1.04148e-13,-16032.2,-78.2646], Tmin=(1641.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-104.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = 'CC([O])C1(O)[CH]O1(3920)',
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.3321,0.0901857,-9.86991e-05,4.94378e-08,-8.71149e-12,-11487.6,33.9716], Tmin=(100,'K'), Tmax=(1768.11,'K')), NASAPolynomial(coeffs=[21.148,0.00153442,6.65372e-06,-1.65141e-09,1.19294e-13,-14236.6,-76.9815], Tmin=(1768.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.7651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CCsJO)"""),
)
...
species(
    ...
    E0 = (127.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,360,370,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    ...
    E0 = (134.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.915231,0.0474115,2.37688e-05,-9.12274e-08,4.78681e-11,-54169.5,22.1692], Tmin=(100,'K'), Tmax=(871.916,'K')), NASAPolynomial(coeffs=[24.4362,-0.0018759,7.71816e-06,-1.85129e-09,1.34153e-13,-60499.3,-100.859], Tmin=(871.916,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-451.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide)"""),
)
...
species(
    label = 'CC1OOC12CO2(3638)',
    structure = SMILES('CC1OOC12CO2'),
    E0 = (-101.597,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16764,0.0405002,3.659e-05,-8.69657e-08,3.86871e-11,-12097.5,18.3217], Tmin=(100,'K'), Tmax=(952.175,'K')), NASAPolynomial(coeffs=[21.1504,0.0109802,-2.64534e-06,5.35439e-10,-4.8346e-14,-18370.1,-90.0601], Tmin=(952.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + polycyclic(s1_3_4_ane)"""),
)

species(
    label = '[CH2]O[C]([O])C(C)[O](3925)',
    structure = SMILES('[CH2]O[C]([O])C(C)[O]'),
    E0 = (216.876,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81645,0.0591168,-2.88068e-05,-7.95772e-08,1.00388e-10,26151.2,27.1109], Tmin=(100,'K'), Tmax=(453.963,'K')), NASAPolynomial(coeffs=[6.87634,0.0350924,-1.73588e-05,3.37577e-09,-2.36082e-13,25479.9,4.3625], Tmin=(453.963,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P) + radical(CsJOCH3) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])[C]([O])C[O](3926)',
    structure = SMILES('CC([O])[C]([O])C[O]'),
    E0 = (213.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,227.498,227.631,227.697,1585.77,1585.95],'cm^-1')),
        HinderedRotor(inertia=(0.209457,'amu*angstrom^2'), symmetry=1, barrier=(7.71597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00325407,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20938,'amu*angstrom^2'), symmetry=1, barrier=(7.72097,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.765485,0.080153,-0.000128143,1.16518e-07,-4.14535e-11,25843.9,28.5332], Tmin=(100,'K'), Tmax=(840.27,'K')), NASAPolynomial(coeffs=[6.27071,0.0360393,-1.74275e-05,3.31487e-09,-2.27292e-13,25550.9,6.69344], Tmin=(840.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C(C)[O](3916)'],
    products = ['CC([O])C1([O])CO1(3634)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'CC(=O)C1([O])CO1(1802)'],
    products = ['CC([O])C1([O])CO1(3634)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH3](11)', '[O]C1(C=O)CO1(2044)'],
    products = ['CC([O])C1([O])CO1(3634)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['[O][CH]C1([O])CO1(2050)', '[CH3](11)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[C]([O])C1([O])CO1(2260)', 'H(8)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CC([O])C1([O])[CH]O1(2264)', 'H(8)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', 'CC([O])C([O])=O(3656)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=C([O])C(C)[O](1092)', 'O(S)(1732)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]CC1([O])CO1(1773)', 'CH2(S)(14)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]O[C]([O])C(C)[O](3925)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([O])([O])C(C)[O](3642)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', 'CC([O])[C]1CO1(3927)'],
    products = ['CC([O])C1([O])CO1(3634)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', 'C[CH]C1([O])CO1(1836)'],
    products = ['CC([O])C1([O])CO1(3634)'],
