species(
    ...
    E0 = (-96.7435,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,1141.81,1141.84,1141.86,1141.88,2507.11,3597.27,3597.45],'cm^-1')),
        HinderedRotor(inertia=(0.00422601,'amu*angstrom^2'), symmetry=1, barrier=(3.91008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.78035,-0.00324276,5.52386e-05,-6.38588e-08,2.2864e-11,-11620.3,5.2103], Tmin=(100,'K'), Tmax=(954.511,'K')), NASAPolynomial(coeffs=[4.58979,0.0141508,-4.75966e-06,8.60303e-10,-6.21724e-14,-12721.8,-3.61718], Tmin=(954.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.7435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
species(
    ...
    E0 = (-84.435,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1092.7,1092.7,1649.06,2067.53,2067.53,2067.53,2067.53,3478.74,4000],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
This reaction matched rate rule [H_rad;C_rad/H2/Cs]
family: R_Recombination"""),
)

reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(14)', 'CH4(58)'],
    products = ['CC(33)'],
    transitionState = 'TS3',
