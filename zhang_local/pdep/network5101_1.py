...
species(
    label = '[CH2]COC([CH2])=CO(28141)',
    structure = SMILES('[CH2]COC([CH2])=CO'),
    E0 = (-65.5854,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.74261,0.0945546,-0.000101141,5.01372e-08,-9.05081e-12,-7653.98,32.5021], Tmin=(100,'K'), Tmax=(1623.96,'K')), NASAPolynomial(coeffs=[26.2528,0.00382708,2.77064e-06,-7.75996e-10,5.78831e-14,-13875.8,-107.295], Tmin=(1623.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.5854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(CJCO) + radical(C=C(O)CJ)"""),
)

species(
    label = 'C[CH]OC(C)=[C]O(28142)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.877554,0.0903976,-9.9461e-05,5.22185e-08,-1.02746e-11,-100.94,30.6577], Tmin=(100,'K'), Tmax=(1395.75,'K')), NASAPolynomial(coeffs=[24.1693,0.00860133,-7.91208e-07,-5.1525e-11,8.63905e-15,-6117.18,-95.0355], Tmin=(1395.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.41957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2]C(=[C]O)OCC(28143)',
    structure = SMILES('[CH2]C(=[C]O)OCC'),
    E0 = (-37.4303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.851838,0.0850272,-8.74746e-05,4.33201e-08,-7.99353e-12,-4308.55,31.7898], Tmin=(100,'K'), Tmax=(1534.21,'K')), NASAPolynomial(coeffs=[22.9216,0.00962363,-6.30308e-07,-1.18679e-10,1.39786e-14,-10023.7,-87.9309], Tmin=(1534.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.4303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.72724,0.0995069,-0.000111935,5.78091e-08,-1.09242e-11,-3448.35,31.9107], Tmin=(100,'K'), Tmax=(1520.62,'K')), NASAPolynomial(coeffs=[28.1659,0.00191281,3.03869e-06,-7.96931e-10,5.9091e-14,-10347.5,-117.628], Tmin=(1520.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.5747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(CJCO)"""),
)
...
species(
    label = '[CH]C(=C)O[CH]C(17700)',
    structure = SMILES('[CH]C(=C)O[CH]C'),
    E0 = (337.313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.552543,0.0657227,-4.30228e-05,2.09703e-09,5.84359e-12,40702.6,23.6442], Tmin=(100,'K'), Tmax=(970.758,'K')), NASAPolynomial(coeffs=[17.148,0.0198604,-6.95314e-06,1.22237e-09,-8.51472e-14,36419.5,-61.3918], Tmin=(970.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCsJOC(O))"""),
)
...
species(
    label = 'C[CH]O[C]1CC1O(28146)',
    structure = SMILES('C[CH]O[C]1CC1O'),
    E0 = (41.4898,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.615553,0.073746,-7.5785e-05,4.19134e-08,-9.36294e-12,5112.57,26.3397], Tmin=(100,'K'), Tmax=(1080.88,'K')), NASAPolynomial(coeffs=[13.2024,0.0271646,-1.11393e-05,2.04e-09,-1.40222e-13,2391.68,-35.3632], Tmin=(1080.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.4898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2][C]1OC(C)C1O(28147)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.453894,0.0740716,-8.12273e-05,5.01533e-08,-1.20892e-11,6093.9,25.3537], Tmin=(100,'K'), Tmax=(1144.78,'K')), NASAPolynomial(coeffs=[12.3639,0.0247884,-6.60392e-06,8.44707e-10,-4.32645e-14,3869.51,-31.5208], Tmin=(1144.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.5777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = 'C=COC(C)=CO(28148)',
...
species(
    label = 'C[CH]O[C]=CO(28150)',
    structure = SMILES('C[CH]O[C]=CO'),
    E0 = (39.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.928905,'amu*angstrom^2'), symmetry=1, barrier=(21.3573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931254,'amu*angstrom^2'), symmetry=1, barrier=(21.4114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931798,'amu*angstrom^2'), symmetry=1, barrier=(21.4239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.929363,'amu*angstrom^2'), symmetry=1, barrier=(21.3679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03625,0.0807051,-9.09629e-05,4.60483e-08,-8.36492e-12,4942.64,29.2389], Tmin=(100,'K'), Tmax=(1639.69,'K')), NASAPolynomial(coeffs=[23.7349,-0.00183873,4.77975e-06,-1.10437e-09,7.84796e-14,-207.879,-93.4518], Tmin=(1639.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(=CO)O[C]C(28151)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.78276,0.0950873,-0.000105803,5.32803e-08,-9.70831e-12,22343.6,30.7429], Tmin=(100,'K'), Tmax=(1612.17,'K')), NASAPolynomial(coeffs=[27.5436,-0.000472982,4.31955e-06,-1.02928e-09,7.3692e-14,15850.5,-115.557], Tmin=(1612.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(CH2_triplet) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH]=C(CO)O[CH]C(28153)',
    structure = SMILES('[CH]=C(CO)O[CH]C'),
    E0 = (60.5892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.138128,0.0846766,-9.35941e-05,5.17585e-08,-1.11102e-11,7441.64,29.1722], Tmin=(100,'K'), Tmax=(1147.54,'K')), NASAPolynomial(coeffs=[19.0003,0.0179653,-6.39263e-06,1.09844e-09,-7.34724e-14,3049.23,-65.7934], Tmin=(1147.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.5892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]C(=CO)OCC(28154)',
    structure = SMILES('[CH]C(=CO)OCC'),
    E0 = (-65.4067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.102213,0.0718988,-1.9942e-05,-4.26898e-08,2.67052e-11,-7701.93,26.3809], Tmin=(100,'K'), Tmax=(923.247,'K')), NASAPolynomial(coeffs=[24.348,0.013482,-2.22962e-06,2.63722e-10,-2.03288e-14,-14241.7,-100.592], Tmin=(923.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-65.4067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2][CH]OC(=C)CO(28155)',
    structure = SMILES('[CH2][CH]OC(=C)CO'),
    E0 = (25.0822,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23314,0.0865447,-9.74296e-05,5.4564e-08,-1.18217e-11,3174.75,30.4365], Tmin=(100,'K'), Tmax=(1139.16,'K')), NASAPolynomial(coeffs=[19.5629,0.0170339,-5.90079e-06,9.99102e-10,-6.63425e-14,-1335.43,-67.6472], Tmin=(1139.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.0822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(CCsJOC(O))"""),
)

species(
    label = 'CC1C[C]([CH]O)O1(28156)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630834,0.0711117,-7.58345e-05,4.69285e-08,-1.15004e-11,3973.59,25.5556], Tmin=(100,'K'), Tmax=(1113.24,'K')), NASAPolynomial(coeffs=[11.1664,0.0269371,-7.79811e-06,1.08563e-09,-6.03526e-14,2019.45,-24.6437], Tmin=(1113.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.0084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOH) + radical(C2CsJOCs)"""),
)

species(
    label = 'C=COC(=C)CO(28157)',
    structure = SMILES('C=COC(=C)CO'),
    E0 = (-225.114,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.619507,0.0653914,-5.42808e-05,2.33559e-08,-4.0165e-12,-26945.7,28.9403], Tmin=(100,'K'), Tmax=(1396.68,'K')), NASAPolynomial(coeffs=[15.5353,0.0226737,-8.4032e-06,1.45758e-09,-9.68127e-14,-31112.3,-48.0032], Tmin=(1396.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-225.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(133.095,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra_csHNd] for rate rule [R4_S_D;doublebond_intra_HNd;radadd_intra_csHNd]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=CO)OC=C(27715)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]COC([CH2])=CO(28141)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]OC(C)=CO(28144)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['OH(D)(132)', '[CH]C(=C)O[CH]C(17700)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][CH]OC([CH2])=CO(14683)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C(=[C]O)O[CH]C(28145)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=CO)O[CH]C(13615)'],
    products = ['[CH2][C]1OC(C)C1O(28147)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(5.16207e+08,'s^-1'), n=0.911389, Ea=(132.825,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_csHCs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 130.7 to 132.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(=CO)O[CH]C(13615)'],
    products = ['C=COC(C)=CO(28148)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C(32)', '[CH2]C([O])=CO(4563)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH3](11)', '[CH]OC([CH2])=CO(28083)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(28)', 'C[CH]O[C]=CO(28150)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2]C(=CO)O[C]C(28151)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH]C(=CO)O[CH]C(28152)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=C(CO)O[CH]C(28153)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH]OC(=C)CO(28155)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]O(5471)', 'C=[C]O[CH]C(4300)'],
    products = ['[CH2]C(=CO)O[CH]C(13615)'],
