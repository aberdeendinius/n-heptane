...
species(
    ...
    E0 = (-287.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,522.944,522.959,522.959,522.964,522.967,522.968,522.985,522.985],'cm^-1')),
        HinderedRotor(inertia=(0.0879615,'amu*angstrom^2'), symmetry=1, barrier=(17.071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879621,'amu*angstrom^2'), symmetry=1, barrier=(17.0712,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77009,0.0438493,-4.02004e-05,1.77588e-08,-3.07308e-12,7269.09,19.6689], Tmin=(100,'K'), Tmax=(1397.31,'K')), NASAPolynomial(coeffs=[13.2251,0.011057,-4.99737e-06,9.62799e-10,-6.79553e-14,4067.92,-39.4268], Tmin=(1397.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.7355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CH2_triplet) + radical(OC=OOJ)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.24125e+11,'s^-1'), n=0.295513, Ea=(174.696,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_csHNd] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_csHNd]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=COC([O])=O(3007)'],
    products = ['C[CH]OC([O])=O(3657)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH]OC([O])=O(2238)'],
    products = ['C[CH]OC([O])=O(3657)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH]OC([O])=O(3174)'],
    products = ['C[CH]OC([O])=O(3657)'],
