...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC=[CH](5182)'],
    products = ['C#C(582)', 'C#C(582)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=CC#C(5315)'],
    products = ['[CH]=CC=[CH](5182)'],
    transitionState = 'TS2',
