...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.259377,0.0636439,-6.38738e-05,3.06574e-08,-5.46435e-12,4144.73,27.7716], Tmin=(100,'K'), Tmax=(1601.53,'K')), NASAPolynomial(coeffs=[18.5487,0.00689506,-3.55147e-07,-9.90714e-11,1.04316e-14,-293.872,-64.6453], Tmin=(1601.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.2083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(=[C]O)OC(28077)',
    structure = SMILES('[CH2]C(=[C]O)OC'),
    E0 = (0.117459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1685,370,350,440,435,1725,330.628,330.762],'cm^-1')),
        HinderedRotor(inertia=(0.199474,'amu*angstrom^2'), symmetry=1, barrier=(15.4582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199299,'amu*angstrom^2'), symmetry=1, barrier=(15.4596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199294,'amu*angstrom^2'), symmetry=1, barrier=(15.4568,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199206,'amu*angstrom^2'), symmetry=1, barrier=(15.4587,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0307232,0.0679786,-7.16613e-05,3.57274e-08,-6.53527e-12,177.036,27.0121], Tmin=(100,'K'), Tmax=(1589.79,'K')), NASAPolynomial(coeffs=[19.3265,0.00505759,1.12011e-06,-4.18036e-10,3.3279e-14,-4181.09,-69.6987], Tmin=(1589.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.117459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]C(=C)O[CH2](17677)',
    structure = SMILES('[CH]C(=C)O[CH2]'),
    E0 = (372.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,479.058,479.723,479.971,480.007,480.281],'cm^-1')),
        HinderedRotor(inertia=(0.311112,'amu*angstrom^2'), symmetry=1, barrier=(50.8488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311201,'amu*angstrom^2'), symmetry=1, barrier=(50.8453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.311444,'amu*angstrom^2'), symmetry=1, barrier=(50.8601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    label = '[CH2]OC([CH2])=[C]O(28078)',
    structure = SMILES('[CH2]OC([CH2])=[C]O'),
    E0 = (192.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,3615,1277.5,1000,350,440,435,1725,380.828,380.869],'cm^-1')),
        HinderedRotor(inertia=(0.00116204,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166194,'amu*angstrom^2'), symmetry=1, barrier=(17.1085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166155,'amu*angstrom^2'), symmetry=1, barrier=(17.1086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16616,'amu*angstrom^2'), symmetry=1, barrier=(17.1085,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.136256,0.0653332,-7.16361e-05,3.65115e-08,-6.78505e-12,23263.3,28.8948], Tmin=(100,'K'), Tmax=(1570.72,'K')), NASAPolynomial(coeffs=[19.1506,0.00255558,2.02418e-06,-5.70999e-10,4.32031e-14,19060.9,-65.7871], Tmin=(1570.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(C=C(O)CJ) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]O[C]1CC1O(28079)',
    structure = SMILES('[CH2]O[C]1CC1O'),
    E0 = (82.1664,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39788,0.0566685,-5.81576e-05,3.20391e-08,-7.12538e-12,9976.54,21.6722], Tmin=(100,'K'), Tmax=(1085.58,'K')), NASAPolynomial(coeffs=[11.1435,0.0207586,-8.53862e-06,1.56725e-09,-1.07889e-13,7860.63,-26.1451], Tmin=(1085.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.1664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]O[C]=CO(28081)',
    structure = SMILES('[CH2]O[C]=CO'),
    E0 = (74.9999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1685,370,3615,1277.5,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.888484,'amu*angstrom^2'), symmetry=1, barrier=(20.428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888728,'amu*angstrom^2'), symmetry=1, barrier=(20.4336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.888453,'amu*angstrom^2'), symmetry=1, barrier=(20.4273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    label = '[CH]C(=CO)O[CH2](28082)',
    structure = SMILES('[CH]C(=CO)O[CH2]'),
    E0 = (164.149,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857572,0.0524687,-4.6689e-06,-4.93363e-08,2.8116e-11,19871.2,23.5918], Tmin=(100,'K'), Tmax=(910.742,'K')), NASAPolynomial(coeffs=[21.8811,0.00443555,1.47546e-06,-4.2213e-10,2.73958e-14,14204.5,-85.9559], Tmin=(910.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2]OC(=C)C[O](9557)',
    structure = SMILES('[CH2]OC(=C)C[O]'),
    E0 = (74.8262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,180,628.35,628.415,3604.51],'cm^-1')),
        HinderedRotor(inertia=(0.119077,'amu*angstrom^2'), symmetry=1, barrier=(2.73782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27673,'amu*angstrom^2'), symmetry=1, barrier=(29.3546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00975561,'amu*angstrom^2'), symmetry=1, barrier=(2.73117,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92353,0.0460769,-3.48004e-05,1.40181e-08,-2.389e-12,9073.69,23.4101], Tmin=(100,'K'), Tmax=(1332.11,'K')), NASAPolynomial(coeffs=[8.99989,0.0248282,-1.08736e-05,2.04361e-09,-1.41706e-13,7188.41,-12.7585], Tmin=(1332.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.8262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=COCJ)"""),
)

species(
    label = '[CH]=C(CO)O[CH2](28084)',
    structure = SMILES('[CH]=C(CO)O[CH2]'),
    E0 = (96.2172,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3120,650,792.5,1650,350,440,435,1725,376.631,376.814],'cm^-1')),
        HinderedRotor(inertia=(0.00118741,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00118992,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111457,'amu*angstrom^2'), symmetry=1, barrier=(11.2365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11155,'amu*angstrom^2'), symmetry=1, barrier=(11.2362,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09275,0.0569542,-5.51773e-05,2.71743e-08,-5.24053e-12,11682.8,25.9384], Tmin=(100,'K'), Tmax=(1268.94,'K')), NASAPolynomial(coeffs=[14.532,0.0145907,-5.10001e-06,8.65113e-10,-5.72288e-14,8272.11,-42.099], Tmin=(1268.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.2172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=CO)OC(28085)',
    structure = SMILES('[CH]C(=CO)OC'),
    E0 = (-27.8589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.741297,0.0545683,-3.01656e-06,-5.19835e-08,2.90312e-11,-3217.37,21.5235], Tmin=(100,'K'), Tmax=(913.248,'K')), NASAPolynomial(coeffs=[21.8719,0.0072562,3.87607e-07,-2.25932e-10,1.39047e-14,-8963.41,-88.8307], Tmin=(913.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.8589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'O[CH][C]1CCO1(28086)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39867,0.0570942,-6.79279e-05,4.69608e-08,-1.25343e-11,8324.19,21.5932], Tmin=(100,'K'), Tmax=(1090.55,'K')), NASAPolynomial(coeffs=[8.31706,0.021852,-5.883e-06,7.3591e-10,-3.57894e-14,7401.92,-9.6938], Tmin=(1090.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.4316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CCsJOH) + radical(C2CsJOCs)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(136.056,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_HNd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction9',
    reactants = ['OH(D)(132)', '[CH]C(=C)O[CH2](17677)'],
    products = ['[CH2]OC([CH2])=CO(13485)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]OC([CH2])=[C]O(28078)'],
    products = ['[CH2]OC([CH2])=CO(13485)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.21867e+08,'s^-1'), n=0.926191, Ea=(133.636,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(28)', '[CH2]O[C]=CO(28081)'],
    products = ['[CH2]OC([CH2])=CO(13485)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]C(=CO)O[CH2](28082)'],
    products = ['[CH2]OC([CH2])=CO(13485)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]OC([CH2])=CO(28083)'],
    products = ['[CH2]OC([CH2])=CO(13485)'],
