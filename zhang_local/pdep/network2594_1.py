...
species(
    label = '[CH2][CH]C([CH2])([CH2])O(10276)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.450396,0.0803033,-0.000103532,7.12312e-08,-1.94552e-11,57133.6,27.9878], Tmin=(100,'K'), Tmax=(897.586,'K')), NASAPolynomial(coeffs=[12.9998,0.0243793,-1.00763e-05,1.82009e-09,-1.22924e-13,54880.7,-31.2003], Tmin=(897.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)2O) + radical(RCCJ) + radical(CCJCO) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2][CH]C([CH2])(C)[O](10277)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00638,0.0654718,-6.38506e-05,3.38657e-08,-7.33776e-12,59148.5,26.9049], Tmin=(100,'K'), Tmax=(1105.31,'K')), NASAPolynomial(coeffs=[11.7475,0.0266009,-1.10994e-05,2.04872e-09,-1.41363e-13,56774.1,-25.99], Tmin=(1105.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)2OJ) + radical(RCCJ) + radical(CJC(C)2O)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.831569,0.0653494,-6.33582e-05,3.27236e-08,-6.75227e-12,22817.7,26.3028], Tmin=(100,'K'), Tmax=(1175.83,'K')), NASAPolynomial(coeffs=[13.56,0.0220494,-8.121e-06,1.40561e-09,-9.36176e-14,19824.4,-37.1662], Tmin=(1175.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ)"""),
)

species(
    label = '[CH2]C(C)([O])C=C(10280)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19417,0.0545795,-3.89369e-05,1.44185e-08,-2.17532e-12,24690.2,26.0446], Tmin=(100,'K'), Tmax=(1547.99,'K')), NASAPolynomial(coeffs=[13.0738,0.0238827,-9.19181e-06,1.60826e-09,-1.06483e-13,21012.3,-36.4585], Tmin=(1547.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ)"""),
)
...
species(
    label = '[CH2]C1([CH2])CCO1(9999)',
    structure = SMILES('[CH2]C1([CH2])CCO1'),
    E0 = (246.514,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.350862,0.0694104,-7.14341e-05,3.96416e-08,-8.33207e-12,29789.5,21.9723], Tmin=(100,'K'), Tmax=(1370.71,'K')), NASAPolynomial(coeffs=[13.8414,0.0184086,-2.89059e-06,1.12449e-10,6.86931e-15,27184.1,-43.3789], Tmin=(1370.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C[CH2](10282)',
    structure = SMILES('[CH]C([CH2])([O])C[CH2]'),
    E0 = (739.202,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,180,180,876.159,1347.58,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.158492,'amu*angstrom^2'), symmetry=1, barrier=(3.64404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158492,'amu*angstrom^2'), symmetry=1, barrier=(3.64404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158492,'amu*angstrom^2'), symmetry=1, barrier=(3.64404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.158492,'amu*angstrom^2'), symmetry=1, barrier=(3.64404,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799057,0.0731856,-8.96822e-05,5.96167e-08,-1.59621e-11,89018.4,26.163], Tmin=(100,'K'), Tmax=(908.988,'K')), NASAPolynomial(coeffs=[11.5981,0.0256656,-1.12673e-05,2.10736e-09,-1.45693e-13,87055.1,-24.906], Tmin=(908.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(739.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)2OJ) + radical(RCCJ) + radical(CJC(C)2O) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C=C(10039)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC(=C)[O](725)', 'CH2(T)(28)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]CC([CH2])=C(6135)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(100.92,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 100.1 to 100.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    products = ['[CH2]C([CH2])([O])[CH]C(10275)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    products = ['[CH2][CH]C([CH2])([CH2])O(10276)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    products = ['[CH2][CH]C([CH2])(C)[O](10277)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][CH]C([CH2])([CH2])[O](10278)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC([CH2])([CH2])[O](9368)'],
    products = ['[CH2]C([CH2])(O)C=C(10279)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(T)(63)', '[CH2]C[C]([CH2])[CH2](6139)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([CH2])[O](10143)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C([CH2])([O])C[CH2](10282)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]CC([CH2])([CH2])[O](10283)'],
    products = ['[CH2]CC([CH2])([CH2])[O](9368)'],
