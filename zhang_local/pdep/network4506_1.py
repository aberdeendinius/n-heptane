...
species(
    label = '[CH][C]([CH])OC([CH])=C(22070)',
    structure = SMILES('[CH][C]([CH])OC([CH])=C'),
    E0 = (1203.61,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,350,440,435,1725,2950,3100,1380,975,1025,1650,180,1076.98,1076.98,1076.98,1076.98,1076.98,1076.98,1076.98,1076.98,1076.98,1076.98,2269.02],'cm^-1')),
        HinderedRotor(inertia=(0.0972785,'amu*angstrom^2'), symmetry=1, barrier=(2.23662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0972785,'amu*angstrom^2'), symmetry=1, barrier=(2.23662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0972785,'amu*angstrom^2'), symmetry=1, barrier=(2.23662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0972785,'amu*angstrom^2'), symmetry=1, barrier=(2.23662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0972785,'amu*angstrom^2'), symmetry=1, barrier=(2.23662,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189396,0.082047,-9.3539e-05,5.3959e-08,-1.2258e-11,144900,29.4968], Tmin=(100,'K'), Tmax=(1076.17,'K')), NASAPolynomial(coeffs=[16.473,0.0215222,-9.17712e-06,1.69812e-09,-1.17418e-13,141395,-50.2576], Tmin=(1076.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1203.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet) + radical(CCJ2_triplet) + radical(C2CsJOC(O))"""),
)

species(
    label = '[C][C]([CH])OC([CH2])=C(22071)',
    structure = SMILES('[C][C]([CH])OC([CH2])=C'),
    E0 = (1213.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,360,370,350,350,440,435,1725,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.059254,0.0842797,-0.000106888,6.4524e-08,-1.48408e-11,146053,27.4152], Tmin=(100,'K'), Tmax=(1080.78,'K')), NASAPolynomial(coeffs=[20.1438,0.00950756,-3.11286e-06,5.11102e-10,-3.36464e-14,141686,-71.622], Tmin=(1080.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1213.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CCJ2_triplet) + radical(CJ3) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]C1([CH])OC1([CH2])[CH2](22072)',
    structure = SMILES('[CH]C1([CH])OC1([CH2])[CH2]'),
    E0 = (1094.07,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.89464,0.104004,-0.000150914,1.038e-07,-2.62282e-11,131766,27.0523], Tmin=(100,'K'), Tmax=(1144.62,'K')), NASAPolynomial(coeffs=[20.4414,0.00864638,1.30317e-06,-7.2989e-10,6.94808e-14,128244,-72.8127], Tmin=(1144.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1094.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH][C](C)OC([CH])=[CH](22073)',
    structure = SMILES('[CH][C](C)OC([CH])=[CH]'),
    E0 = (1002.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,360,370,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.186841,0.0822895,-8.98745e-05,5.0576e-08,-1.13088e-11,120710,28.9052], Tmin=(100,'K'), Tmax=(1088.04,'K')), NASAPolynomial(coeffs=[15.8473,0.0247164,-1.05025e-05,1.94286e-09,-1.34261e-13,117303,-47.9688], Tmin=(1088.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1002.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CCJ2_triplet) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)OC([CH])[CH](22074)',
    structure = SMILES('[CH]C(=C)OC([CH])[CH]'),
    E0 = (1003.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,180,1061.51,1061.51,1061.51,1061.51,1061.51,1061.51,1061.51,1061.51,1061.51,1061.51,2273.52],'cm^-1')),
        HinderedRotor(inertia=(0.0905832,'amu*angstrom^2'), symmetry=1, barrier=(2.08269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0905832,'amu*angstrom^2'), symmetry=1, barrier=(2.08269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0905832,'amu*angstrom^2'), symmetry=1, barrier=(2.08269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0905832,'amu*angstrom^2'), symmetry=1, barrier=(2.08269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0905832,'amu*angstrom^2'), symmetry=1, barrier=(2.08269,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0848624,0.0760168,-6.15948e-05,1.69394e-08,1.2858e-12,120830,29.0636], Tmin=(100,'K'), Tmax=(987.4,'K')), NASAPolynomial(coeffs=[19.0875,0.0196045,-7.14285e-06,1.27144e-09,-8.86605e-14,116075,-67.4495], Tmin=(987.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1003.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651682,0.0803132,-0.000121302,1.03113e-07,-3.48382e-11,129564,27.5639], Tmin=(100,'K'), Tmax=(832.602,'K')), NASAPolynomial(coeffs=[8.60421,0.0316612,-1.4831e-05,2.79209e-09,-1.90837e-13,128602,-7.17111], Tmin=(832.602,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1076.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJ2_triplet) + radical(CCJ2_triplet) + radical(C2CsJOCs) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH]C1([CH])C[C]([CH2])O1(22076)',
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.138609,0.0826503,-0.00010854,7.34483e-08,-1.8734e-11,129640,26.8385], Tmin=(100,'K'), Tmax=(1116.97,'K')), NASAPolynomial(coeffs=[14.6784,0.0174921,-3.45925e-06,2.39204e-10,-1.71324e-16,127208,-41.2607], Tmin=(1116.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1076.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.694111,0.053209,8.24711e-06,-7.12366e-08,3.85247e-11,91905.9,20.7043], Tmin=(100,'K'), Tmax=(893.56,'K')), NASAPolynomial(coeffs=[24.1731,0.00181394,4.36435e-06,-1.07435e-09,7.51476e-14,85565.7,-101.924], Tmin=(893.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(763.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH](2815)', '[CH]=[C]OC([CH2])=C(10599)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C][CH2](10272)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH][C]([CH])OC([CH])=C(22070)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[C][C]([CH])OC([CH2])=C(22071)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    products = ['[CH]C1([CH])OC1([CH2])[CH2](22072)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.17159e+11,'s^-1'), n=-0.0562706, Ea=(118.774,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 117.9 to 118.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=C(6078)', '[CH]C(=[CH])[O](21208)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][C](C)OC([CH])=[CH](22073)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(=C)OC([CH])[CH](22074)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=C(6078)', '[CH][C]([CH])[O](21614)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    products = ['[CH][C]([CH])O[C]1CC1(22075)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    products = ['[CH]C1([CH])C[C]([CH2])O1(22076)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    products = ['C=C=C(6077)', '[CH]C(=[CH])[O](21208)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
    products = ['[CH]C1([CH])CC(=C)O1(22077)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH]C(=[CH])O[C][CH2](21608)'],
    products = ['[CH]C(=[CH])O[C]([CH2])[CH2](20408)'],
