...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34072,0.0585895,-6.20696e-06,-6.7216e-08,4.02995e-11,21639.1,24.9094], Tmin=(100,'K'), Tmax=(888.827,'K')), NASAPolynomial(coeffs=[29.9111,-0.0130305,1.09459e-05,-2.29032e-09,1.57567e-13,13955,-127.922], Tmin=(888.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=[C]COC1OO1(19782)',
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71598,0.0533169,-6.05329e-05,4.07038e-08,-1.15039e-11,44724.8,24.5962], Tmin=(100,'K'), Tmax=(848.494,'K')), NASAPolynomial(coeffs=[7.60064,0.0255756,-1.14912e-05,2.17185e-09,-1.50982e-13,43726.2,-2.82716], Tmin=(848.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.202,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-OsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CO[C]O[O](19785)',
    structure = SMILES('[CH]=[C]CO[C]O[O]'),
    E0 = (851.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,240.203,240.203,240.203,240.203],'cm^-1')),
        HinderedRotor(inertia=(0.401202,'amu*angstrom^2'), symmetry=1, barrier=(16.4266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401203,'amu*angstrom^2'), symmetry=1, barrier=(16.4266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401203,'amu*angstrom^2'), symmetry=1, barrier=(16.4266,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401203,'amu*angstrom^2'), symmetry=1, barrier=(16.4266,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.416784,0.0737142,-9.38011e-05,5.3386e-08,-1.09031e-11,102511,28.1582], Tmin=(100,'K'), Tmax=(954.551,'K')), NASAPolynomial(coeffs=[19.6261,0.00386485,-7.68769e-07,9.58797e-11,-6.42809e-15,98358.6,-66.1629], Tmin=(954.551,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(851.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(ROOJ) + radical(CH2_triplet)"""),
)

species(
    label = '[C]=[C]CO[CH]O[O](19786)',
    structure = SMILES('[C]=[C]CO[CH]O[O]'),
    E0 = (890.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,1685,370,2750,2850,1437.5,1250,1305,750,350,302.777,302.836,302.898,302.998],'cm^-1')),
        HinderedRotor(inertia=(0.0965028,'amu*angstrom^2'), symmetry=1, barrier=(6.28276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0965065,'amu*angstrom^2'), symmetry=1, barrier=(6.28307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0965397,'amu*angstrom^2'), symmetry=1, barrier=(6.28239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0965006,'amu*angstrom^2'), symmetry=1, barrier=(6.28193,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659433,0.0864946,-0.000168179,1.58282e-07,-5.52053e-11,107173,28.3198], Tmin=(100,'K'), Tmax=(884.29,'K')), NASAPolynomial(coeffs=[7.4478,0.0254036,-1.30112e-05,2.44428e-09,-1.62776e-13,107161,3.12181], Tmin=(884.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(890.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(OCJO) + radical(ROOJ) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH]=[C]COC=O(17921)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(4000,'m^3/(mol*s)'), n=1.39, Ea=(160.03,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 159.3 to 160.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]O[O](2819)', '[CH]=[C]C[O](5268)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(T)(63)', '[CH]=[C]CO[CH][O](19784)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O2(2)', '[CH]OC[C]=[CH](19074)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]O[CH]O[O](8127)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]=[C]CO[C]O[O](19785)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[C]=[C]CO[CH]O[O](19786)'],
    products = ['[CH]=[C]CO[CH]O[O](18021)'],
