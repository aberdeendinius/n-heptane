...
species(
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80777,0.0472735,-5.41391e-05,3.31243e-08,-8.0301e-12,43985.2,22.4416], Tmin=(100,'K'), Tmax=(1010.74,'K')), NASAPolynomial(coeffs=[10.1277,0.0143477,-5.27559e-06,8.95073e-10,-5.84594e-14,42303.3,-17.7862], Tmin=(1010.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(dioxirane) + radical(CCOJ) + radical(Cs_P) + radical(CCsJOH)"""),
)

species(
    label = '[O][C]1CC([O])O1(3236)',
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.32338,0.0185564,3.38824e-05,-1.05734e-07,8.79598e-11,19248.9,18.7665], Tmin=(100,'K'), Tmax=(411.29,'K')), NASAPolynomial(coeffs=[3.41723,0.0239987,-9.14316e-06,1.57516e-09,-1.03328e-13,19187.4,17.7437], Tmin=(411.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsOsH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ) + radical(CCOJ)"""),
)

species(
    label = '[O][C]1C[CH]OO1(3237)',
    structure = SMILES('[O][C]1C[CH]OO1'),
    E0 = (292.741,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.523,0.0268132,4.72347e-06,-2.83181e-08,1.47584e-11,35267.2,19.2603], Tmin=(100,'K'), Tmax=(865.563,'K')), NASAPolynomial(coeffs=[8.76476,0.0147664,-3.51037e-06,4.45048e-10,-2.52456e-14,33557.4,-13.5864], Tmin=(865.563,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(CCsJOOC) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = 'O=C[CH]C(=O)O(3011)',
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24377,0.0334311,-2.23116e-05,7.11242e-09,-9.00622e-13,-40661.3,22.4685], Tmin=(100,'K'), Tmax=(1836.02,'K')), NASAPolynomial(coeffs=[11.7474,0.0127265,-5.39639e-06,9.70479e-10,-6.43166e-14,-44151.1,-29.1553], Tmin=(1836.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-338.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsOs) + group(Cds-OdCsH) + radical(CCJCO)"""),
)

species(
    label = '[O][CH][CH]C([O])[O](3238)',
    structure = SMILES('[O][CH][CH]C([O])[O]'),
    E0 = (416.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,1380,1390,370,380,2900,435,1644.64,1644.91,1645.11,1645.14,1645.29],'cm^-1')),
        HinderedRotor(inertia=(0.276774,'amu*angstrom^2'), symmetry=1, barrier=(6.36358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276665,'amu*angstrom^2'), symmetry=1, barrier=(6.36107,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01005,0.0614404,-0.00013712,1.5361e-07,-6.09468e-11,50196.8,26.999], Tmin=(100,'K'), Tmax=(863.099,'K')), NASAPolynomial(coeffs=[-2.87579,0.0394191,-2.12254e-05,4.13402e-09,-2.83753e-13,52703.8,59.4885], Tmin=(863.099,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOH) + radical(CCOJ) + radical(CCJCO)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.63927e+10,'s^-1'), n=0.514573, Ea=(176.435,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[O][CH]C=C([O])[O](3234)'],
    products = ['[O][CH]CC([O])=O(2298)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O][CH]CC([O])=O(2298)'],
    products = ['[O][C]1C[CH]OO1(3237)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(1.25858e+10,'s^-1'), n=0.473101, Ea=(289.87,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_linear;multiplebond_intra;radadd_intra] for rate rule [R5_linear;carbonyl_intra;radadd_intra_O]
Euclidian distance = 1.41421356237
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction20',
    reactants = ['C=C([O])[O](1172)', '[CH][O](751)'],
    products = ['[O][CH]CC([O])=O(2298)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', '[O][CH]C[C]=O(3239)'],
    products = ['[O][CH]CC([O])=O(2298)'],
