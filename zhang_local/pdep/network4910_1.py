...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10321,0.0547292,-3.42128e-05,3.7962e-09,2.63398e-12,73308.7,26.2352], Tmin=(100,'K'), Tmax=(1067.68,'K')), NASAPolynomial(coeffs=[14.5253,0.020356,-8.27625e-06,1.55982e-09,-1.10791e-13,69535.6,-43.6449], Tmin=(1067.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(608.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_S) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70097,0.0566381,-5.05477e-05,2.54431e-08,-5.67689e-12,43302.3,24.7527], Tmin=(100,'K'), Tmax=(1014.06,'K')), NASAPolynomial(coeffs=[7.44403,0.0339846,-1.70389e-05,3.41391e-09,-2.46e-13,42137.5,-3.03448], Tmin=(1014.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=C(C)CJ=O)"""),
)

species(
    label = '[CH]C(=C=O)CC=C(24290)',
    structure = SMILES('[CH]C(=C=O)CC=C'),
    E0 = (342.515,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27766,0.0640228,-6.23758e-05,3.86342e-08,-1.06577e-11,41289.4,24.0358], Tmin=(100,'K'), Tmax=(846.679,'K')), NASAPolynomial(coeffs=[6.63569,0.0387098,-1.7531e-05,3.32413e-09,-2.31757e-13,40382.1,-0.92185], Tmin=(846.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-Cd(CCO)HH) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsCs) + other(ketene_1C-C_1C-H) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = 'C=[C]CC1[CH]OC=1(24292)',
    structure = SMILES('C=[C]CC1[CH]OC=1'),
    E0 = (480.16,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.813447,0.0505159,8.39581e-06,-6.39755e-08,3.2914e-11,57882.7,23.1518], Tmin=(100,'K'), Tmax=(928.111,'K')), NASAPolynomial(coeffs=[23.1168,0.00472751,1.04755e-06,-2.62384e-10,1.17245e-14,51574.8,-94.464], Tmin=(928.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(CCsJOC(O)) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726678,0.0620921,-4.67086e-05,1.1959e-08,6.00745e-13,14624.7,21.8459], Tmin=(100,'K'), Tmax=(1085.18,'K')), NASAPolynomial(coeffs=[17.0819,0.0177804,-7.53835e-06,1.4599e-09,-1.05434e-13,10134.4,-62.7294], Tmin=(1085.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-O2d)(Cds-Cds)) + group(Cds-Cds(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = '[CH]C(=C[C]=C)C[O](24295)',
    structure = SMILES('[CH]C(=C[C]=C)C[O]'),
    E0 = (661.09,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,3010,987.5,1337.5,450,1655,376.519,376.529,376.592,376.622,376.666,376.849],'cm^-1')),
        HinderedRotor(inertia=(0.524977,'amu*angstrom^2'), symmetry=1, barrier=(52.7156,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.523559,'amu*angstrom^2'), symmetry=1, barrier=(52.7148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.522795,'amu*angstrom^2'), symmetry=1, barrier=(52.7063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03623,0.0694469,-8.06258e-05,6.19409e-08,-2.04217e-11,79613.4,26.5205], Tmin=(100,'K'), Tmax=(807.706,'K')), NASAPolynomial(coeffs=[6.19131,0.0396535,-1.73779e-05,3.20147e-09,-2.1787e-13,78919.7,3.61208], Tmin=(807.706,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(661.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCOJ) + radical(C=CJC=C)"""),
)
...
species(
    label = '[C]=C(C=O)C[C]=C(24298)',
    structure = SMILES('[C]=C(C=O)C[C]=C'),
    E0 = (753.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2782.5,750,1395,475,1775,1000,365.668,365.735],'cm^-1')),
        HinderedRotor(inertia=(0.110768,'amu*angstrom^2'), symmetry=1, barrier=(10.5095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110745,'amu*angstrom^2'), symmetry=1, barrier=(10.5082,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11073,'amu*angstrom^2'), symmetry=1, barrier=(10.5092,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (93.1033,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91227,0.0552495,-3.90899e-05,-3.07701e-08,5.20873e-11,90737.4,23.9309], Tmin=(100,'K'), Tmax=(471.176,'K')), NASAPolynomial(coeffs=[6.05499,0.0343484,-1.79733e-05,3.62055e-09,-2.60035e-13,90188.6,5.38142], Tmin=(471.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(753.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH]=C(C=O)C=C=C(22622)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH]=C(C=O)CC#C(22611)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]=O(373)', 'C#CC[C]=C(17758)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(C=O)C[C]=C(22608)'],
    products = ['[CH2]C(C=C=C)=C[O](20110)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C(C=O)=C[C]=C(22615)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=O(373)', '[CH]=[C]C[C]=C(17763)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C(=C=O)C[C]=C(24291)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]=[C]CC(=[CH])C=O(22627)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(C=O)C[C]=C(22608)'],
    products = ['C=[C]CC1[CH]OC=1(24292)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C(=C[C]=C)C[O](24295)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(C=[C][CH2])=CO(24296)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C-]#[O+](374)', '[CH]=CC[C]=C(17488)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[C]=C(584)', '[CH]C(=C)C=O(18781)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[C]=C(C=O)C[C]=C(24298)'],
    products = ['[CH]=C(C=O)C[C]=C(22608)'],
