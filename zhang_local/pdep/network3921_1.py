...
species(
    label = '[CH]C(=[CH])OC(19083)',
    structure = SMILES('[CH]C(=[CH])OC'),
    E0 = (428.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,304.152,304.153,304.153,304.156],'cm^-1')),
        HinderedRotor(inertia=(0.76086,'amu*angstrom^2'), symmetry=1, barrier=(49.9483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.760863,'amu*angstrom^2'), symmetry=1, barrier=(49.9483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.760851,'amu*angstrom^2'), symmetry=1, barrier=(49.9483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6961,0.0424503,-1.5695e-05,-1.25716e-08,8.66104e-12,51570.4,17.9459], Tmin=(100,'K'), Tmax=(969.183,'K')), NASAPolynomial(coeffs=[12.3813,0.0173298,-6.19022e-06,1.09583e-09,-7.64089e-14,48607.9,-37.868], Tmin=(969.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90821,0.0367207,-2.83467e-05,1.34592e-08,-2.50794e-12,59759.5,18.519], Tmin=(100,'K'), Tmax=(1585.05,'K')), NASAPolynomial(coeffs=[6.90535,0.0173229,-3.56688e-06,3.3542e-10,-1.19212e-14,59028,-5.20156], Tmin=(1585.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20099,0.0256061,2.57033e-05,-5.90304e-08,2.64649e-11,32645.4,17.3893], Tmin=(100,'K'), Tmax=(938.448,'K')), NASAPolynomial(coeffs=[14.8927,0.00692043,-1.03024e-06,1.69394e-10,-1.72492e-14,28704,-51.3424], Tmin=(938.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(C=COCJ)"""),
)
...
species(
    label = '[C]C(=C)O[CH2](19089)',
    structure = SMILES('[C]C(=C)O[CH2]'),
    E0 = (671.735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,464.772,465.027,465.192],'cm^-1')),
        HinderedRotor(inertia=(0.107038,'amu*angstrom^2'), symmetry=1, barrier=(16.428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1072,'amu*angstrom^2'), symmetry=1, barrier=(16.4337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85196,0.0388018,-2.04393e-05,-9.38798e-09,8.58381e-12,80876.1,17.5064], Tmin=(100,'K'), Tmax=(947.885,'K')), NASAPolynomial(coeffs=[14.4796,0.00616363,-1.46767e-06,2.51541e-10,-2.01356e-14,77554.5,-47.6323], Tmin=(947.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(671.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJ3) + radical(C=COCJ)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(142.173,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH]C(=[CH])O[CH2](19084)'],
    products = ['[CH]C(=C)O[CH2](17677)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(28)', '[CH]C(=C)[O](9170)'],
    products = ['[CH]C(=C)O[CH2](17677)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]OC([CH])=C(19086)'],
    products = ['[CH]C(=C)O[CH2](17677)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(T)(28)', 'C#CO[CH2](5256)'],
    products = ['[CH]C(=C)O[CH2](17677)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(28)', '[CH]=[C]O[CH2](5258)'],
    products = ['[CH]C(=C)O[CH2](17677)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[C]C(=C)O[CH2](19089)'],
    products = ['[CH]C(=C)O[CH2](17677)'],
