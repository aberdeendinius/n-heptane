...
species(
    label = '[CH2]C1([CH]O)CC1CC(27964)',
    structure = SMILES('[CH2]C1([CH]O)CC1CC'),
    E0 = (142.277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.217671,0.0786774,-3.66355e-05,-9.95428e-09,9.691e-12,17276.1,31.7434], Tmin=(100,'K'), Tmax=(1019.56,'K')), NASAPolynomial(coeffs=[18.6873,0.0334978,-1.28162e-05,2.35868e-09,-1.66412e-13,11914.5,-67.2174], Tmin=(1019.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Neopentyl) + radical(CCsJOH)"""),
)
...
species(
    label = '[CH2]C(=CO)C(=C)CC(27965)',
    structure = SMILES('[CH2]C(=CO)C(=C)CC'),
    E0 = (-61.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.948325,'amu*angstrom^2'), symmetry=1, barrier=(21.8039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948321,'amu*angstrom^2'), symmetry=1, barrier=(21.8038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948317,'amu*angstrom^2'), symmetry=1, barrier=(21.8037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948147,'amu*angstrom^2'), symmetry=1, barrier=(21.7998,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.682647,0.0819649,-2.16956e-05,-4.92249e-08,3.0431e-11,-7172.49,29.0564], Tmin=(100,'K'), Tmax=(926.044,'K')), NASAPolynomial(coeffs=[27.1567,0.0159639,-2.661e-06,3.32686e-10,-2.60987e-14,-14654.7,-115.673], Tmin=(926.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C(=CO)[C](C)CC(27966)',
    structure = SMILES('[CH2]C(=CO)[C](C)CC'),
    E0 = (-32.2379,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.341477,0.0762159,-1.09855e-05,-5.11991e-08,2.86047e-11,-3703.34,29.0541], Tmin=(100,'K'), Tmax=(937.07,'K')), NASAPolynomial(coeffs=[22.9414,0.0252809,-7.00888e-06,1.14863e-09,-8.16455e-14,-10194.1,-93.1093], Tmin=(937.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.2379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Allyl_T) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(=CO)C(C)[CH]C(27967)',
    structure = SMILES('[CH2]C(=CO)C(C)[CH]C'),
    E0 = (30.3235,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.440301,0.0805479,-2.84631e-05,-2.9277e-08,1.95441e-11,3822.42,33.711], Tmin=(100,'K'), Tmax=(958.235,'K')), NASAPolynomial(coeffs=[22.158,0.0270907,-8.76848e-06,1.53757e-09,-1.09509e-13,-2385.12,-84.1408], Tmin=(958.235,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.3235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Cs_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(CC)=C(C)[CH]O(27968)',
    structure = SMILES('[CH2]C(CC)=C(C)[CH]O'),
    E0 = (-14.9989,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.164783,0.0784721,-3.84165e-05,-5.47767e-09,7.4742e-12,-1642.66,32.9805], Tmin=(100,'K'), Tmax=(1038.11,'K')), NASAPolynomial(coeffs=[17.511,0.0359533,-1.39535e-05,2.55658e-09,-1.7874e-13,-6691.36,-59.597], Tmin=(1038.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.9989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]C(CC)C(C)=[C]O(27969)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.415946,0.087859,-6.55544e-05,1.78678e-08,1.32996e-12,15695.5,35.697], Tmin=(100,'K'), Tmax=(964.587,'K')), NASAPolynomial(coeffs=[17.7049,0.0328074,-1.11917e-05,1.89099e-09,-1.26284e-13,11264.9,-55.9178], Tmin=(964.587,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C([CH]C)C(C)=CO(27970)',
    structure = SMILES('[CH2]C([CH]C)C(C)=CO'),
    E0 = (83.9066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.418889,0.0846921,-4.94078e-05,-3.53964e-09,9.96941e-12,10262.1,35.1354], Tmin=(100,'K'), Tmax=(949.211,'K')), NASAPolynomial(coeffs=[19.7199,0.0296632,-9.59725e-06,1.61469e-09,-1.09777e-13,5094.75,-68.053], Tmin=(949.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.9066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC(C)C([CH2])=CO(27971)',
    structure = SMILES('[CH2]CC(C)C([CH2])=CO'),
    E0 = (41.0277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.582996,0.0823669,-2.70269e-05,-3.59159e-08,2.33416e-11,5116.34,33.4538], Tmin=(100,'K'), Tmax=(943.131,'K')), NASAPolynomial(coeffs=[23.9169,0.0240863,-6.90382e-06,1.15639e-09,-8.27346e-14,-1534.29,-94.0679], Tmin=(943.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.0277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(=[C]O)C(C)CC(27972)',
    structure = SMILES('[CH2]C(=[C]O)C(C)CC'),
    E0 = (75.5255,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.432711,0.0836558,-4.43824e-05,-8.19707e-09,1.10601e-11,9255.62,34.2563], Tmin=(100,'K'), Tmax=(969.982,'K')), NASAPolynomial(coeffs=[20.1367,0.0302467,-1.03701e-05,1.81564e-09,-1.26167e-13,3787.36,-71.9705], Tmin=(969.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.5255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.55524,0.0864273,-4.76318e-05,-1.06958e-08,1.40263e-11,11555.7,34.856], Tmin=(100,'K'), Tmax=(929.703,'K')), NASAPolynomial(coeffs=[21.4817,0.0266557,-7.73156e-06,1.2334e-09,-8.30018e-14,5943.76,-77.9978], Tmin=(929.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.6108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C([CH]O)=C([CH2])CC(27974)',
    structure = SMILES('[CH2]C([CH]O)=C([CH2])CC'),
    E0 = (136.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,325,375,415,465,420,450,1700,1750,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124284,0.0755207,-2.83826e-05,-2.05716e-08,1.41338e-11,16579.1,33.1141], Tmin=(100,'K'), Tmax=(993.207,'K')), NASAPolynomial(coeffs=[19.377,0.0306091,-1.13401e-05,2.07757e-09,-1.47652e-13,11046.8,-69.1849], Tmin=(993.207,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(Allyl_P) + radical(C=CCJO)"""),
)
...
species(
    label = '[CH2]C(=CO)C([CH2])[CH]C(27975)',
    structure = SMILES('[CH2]C(=CO)C([CH2])[CH]C'),
    E0 = (235.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.399967,0.0819534,-3.98916e-05,-1.83511e-08,1.6707e-11,28484.8,35.3489], Tmin=(100,'K'), Tmax=(932.296,'K')), NASAPolynomial(coeffs=[21.8936,0.0238135,-6.69942e-06,1.06974e-09,-7.3295e-14,22697.8,-79.3842], Tmin=(932.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(Cs_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CC([CH2])C([CH2])=CO(27976)',
    structure = SMILES('[CH2]CC([CH2])C([CH2])=CO'),
    E0 = (246.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.543408,0.08377,-3.83841e-05,-2.51948e-08,2.06523e-11,29778.8,35.095], Tmin=(100,'K'), Tmax=(919.279,'K')), NASAPolynomial(coeffs=[23.7016,0.0207276,-4.78867e-06,6.77824e-10,-4.56399e-14,23527.4,-89.5893], Tmin=(919.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(=[C]O)C([CH2])CC(27977)',
    structure = SMILES('[CH2]C(=[C]O)C([CH2])CC'),
    E0 = (280.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.38229,0.0849433,-5.54073e-05,2.22959e-09,8.42057e-12,33917.6,35.8579], Tmin=(100,'K'), Tmax=(934.67,'K')), NASAPolynomial(coeffs=[19.815,0.0270664,-8.35677e-06,1.36095e-09,-9.10407e-14,28894.6,-66.8908], Tmin=(934.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=CJO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)[C]1CC1O(27978)',
    structure = SMILES('[CH2]C(CC)[C]1CC1O'),
    E0 = (117.402,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.457775,0.0607018,1.16475e-05,-5.89171e-08,2.73266e-11,14263.2,32.3796], Tmin=(100,'K'), Tmax=(963.168,'K')), NASAPolynomial(coeffs=[16.8958,0.0340493,-1.16532e-05,2.06828e-09,-1.45997e-13,9166.41,-56.3279], Tmin=(963.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]1C(O)CC1CC(27979)',
    structure = SMILES('[CH2][C]1C(O)CC1CC'),
    E0 = (109.635,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74939,0.051631,3.81217e-05,-8.50021e-08,3.60522e-11,13321,30.6541], Tmin=(100,'K'), Tmax=(964.053,'K')), NASAPolynomial(coeffs=[16.458,0.0351907,-1.21299e-05,2.18757e-09,-1.56697e-13,8027.38,-56.3021], Tmin=(964.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CC)C(C)=CO(27980)',
    structure = SMILES('C=C(CC)C(C)=CO'),
    E0 = (-212.698,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.692147,0.0845911,-3.08166e-05,-3.49212e-08,2.39042e-11,-25395.6,28.8092], Tmin=(100,'K'), Tmax=(934.626,'K')), NASAPolynomial(coeffs=[24.9377,0.021891,-5.60357e-06,8.88231e-10,-6.34608e-14,-32238.9,-104.087], Tmin=(934.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2][C](CO)C([CH2])[CH]C(27981)',
    structure = SMILES('[CH2][C](CO)C([CH2])[CH]C'),
    E0 = (373.767,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,307.949,937.3,2172.39],'cm^-1')),
        HinderedRotor(inertia=(0.0815128,'amu*angstrom^2'), symmetry=1, barrier=(3.4549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0815128,'amu*angstrom^2'), symmetry=1, barrier=(3.4549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0815128,'amu*angstrom^2'), symmetry=1, barrier=(3.4549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0815128,'amu*angstrom^2'), symmetry=1, barrier=(3.4549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0815128,'amu*angstrom^2'), symmetry=1, barrier=(3.4549,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.275434,0.0817472,-6.75169e-05,3.3125e-08,-6.98733e-12,45088,38.1667], Tmin=(100,'K'), Tmax=(1104.82,'K')), NASAPolynomial(coeffs=[10.3646,0.0452196,-1.79242e-05,3.20002e-09,-2.15916e-13,42858.7,-11.5134], Tmin=(1104.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(Cs_S)"""),
)
...
species(
    label = '[CH2]CC([CH2])[C]([CH2])CO(27982)',
    structure = SMILES('[CH2]CC([CH2])[C]([CH2])CO'),
    E0 = (384.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3615,1277.5,1000,1380,1390,370,380,2900,435,244.235,883.139,1836.06],'cm^-1')),
        HinderedRotor(inertia=(0.11049,'amu*angstrom^2'), symmetry=1, barrier=(3.34528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11049,'amu*angstrom^2'), symmetry=1, barrier=(3.34528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11049,'amu*angstrom^2'), symmetry=1, barrier=(3.34528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11049,'amu*angstrom^2'), symmetry=1, barrier=(3.34528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11049,'amu*angstrom^2'), symmetry=1, barrier=(3.34528,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0400691,0.0856453,-7.35326e-05,3.63914e-08,-7.51827e-12,46389.4,38.5264], Tmin=(100,'K'), Tmax=(1148.04,'K')), NASAPolynomial(coeffs=[12.7106,0.0412193,-1.54863e-05,2.68365e-09,-1.77942e-13,43461.7,-24.7481], Tmin=(1148.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ(C)CO) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.472157,0.0796631,-2.0843e-05,-3.98337e-08,2.39003e-11,-2145.43,30.4079], Tmin=(100,'K'), Tmax=(952.146,'K')), NASAPolynomial(coeffs=[23.1092,0.0260812,-8.08649e-06,1.40603e-09,-1.01078e-13,-8697.79,-93.0293], Tmin=(952.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.3181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Allyl_S)"""),
)
...
species(
    label = 'CCC1CCC1=CO(27984)',
    structure = SMILES('CCC1CCC1=CO'),
    E0 = (-163.971,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[8.4061,0.0146646,0.000106867,-1.17096e-07,2.80748e-11,-19977.6,-9.2427], Tmin=(100,'K'), Tmax=(1689.23,'K')), NASAPolynomial(coeffs=[77.3827,0.0337492,-7.20619e-05,1.74463e-08,-1.29794e-12,-69307.6,-455.214], Tmin=(1689.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(methylenecyclobutane)"""),
)
...
species(
    ...
    E0 = (4.46216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,311.076,311.095],'cm^-1')),
        HinderedRotor(inertia=(0.0017395,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343439,'amu*angstrom^2'), symmetry=1, barrier=(23.5907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343474,'amu*angstrom^2'), symmetry=1, barrier=(23.5895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.343401,'amu*angstrom^2'), symmetry=1, barrier=(23.5917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3437,'amu*angstrom^2'), symmetry=1, barrier=(23.5893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH2]C([C]=CO)CC(27985)',
    structure = SMILES('[CH2]C([C]=CO)CC'),
    E0 = (162.077,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,250.591,250.592],'cm^-1')),
        HinderedRotor(inertia=(0.376677,'amu*angstrom^2'), symmetry=1, barrier=(16.785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00268452,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376666,'amu*angstrom^2'), symmetry=1, barrier=(16.785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376676,'amu*angstrom^2'), symmetry=1, barrier=(16.7851,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37668,'amu*angstrom^2'), symmetry=1, barrier=(16.785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
...
species(
    label = '[CH]C(CC)C([CH2])=CO(27986)',
    structure = SMILES('[CH]C(CC)C([CH2])=CO'),
    E0 = (283.996,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.667656,0.0846272,-3.58607e-05,-2.88139e-08,2.15516e-11,34341.5,32.9754], Tmin=(100,'K'), Tmax=(937.596,'K')), NASAPolynomial(coeffs=[24.9849,0.0203616,-5.31777e-06,8.56695e-10,-6.17343e-14,27545.5,-99.7193], Tmin=(937.596,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(CCJ2_triplet) + radical(Allyl_P)"""),
)

species(
    label = '[CH]C(=CO)C([CH2])CC(27987)',
    structure = SMILES('[CH]C(=CO)C([CH2])CC'),
    E0 = (260.049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.582242,0.0854843,-3.62453e-05,-2.43933e-08,1.91769e-11,31455.7,34.2756], Tmin=(100,'K'), Tmax=(926.647,'K')), NASAPolynomial(coeffs=[21.54,0.0291962,-8.59305e-06,1.37074e-09,-9.20763e-14,25672.6,-79.8485], Tmin=(926.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2]C(CC)C(=C)C[O](9453)',
    structure = SMILES('[CH2]C(CC)C(=C)C[O]'),
    E0 = (170.726,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706127,0.0763266,-5.61199e-05,2.49537e-08,-5.07716e-12,20648.9,33.3069], Tmin=(100,'K'), Tmax=(1086.55,'K')), NASAPolynomial(coeffs=[7.38509,0.0517388,-2.2176e-05,4.12699e-09,-2.85216e-13,19197.5,0.530333], Tmin=(1086.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(CCOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)=C([CH2])CO(27988)',
    structure = SMILES('[CH2]C(CC)=C([CH2])CO'),
    E0 = (19.2051,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.334449,0.0864845,-6.7383e-05,2.76143e-08,-4.6094e-12,2473.11,33.2779], Tmin=(100,'K'), Tmax=(1413.05,'K')), NASAPolynomial(coeffs=[17.3695,0.0363684,-1.41827e-05,2.51456e-09,-1.68662e-13,-2530.18,-58.2547], Tmin=(1413.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.2051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C(CO)C([CH2])CC(27989)',
    structure = SMILES('[CH]=C(CO)C([CH2])CC'),
    E0 = (192.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0457937,0.0864358,-7.44419e-05,3.61217e-08,-7.29386e-12,23254.2,35.5399], Tmin=(100,'K'), Tmax=(1171.46,'K')), NASAPolynomial(coeffs=[13.3302,0.0407637,-1.59616e-05,2.84161e-09,-1.91698e-13,20120.2,-31.1084], Tmin=(1171.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([CH]C)C(=C)CO(27990)',
    structure = SMILES('[CH2]C([CH]C)C(=C)CO'),
    E0 = (139.563,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.38553,0.0797251,-6.22606e-05,2.789e-08,-5.37982e-12,16915.4,36.1452], Tmin=(100,'K'), Tmax=(1190.42,'K')), NASAPolynomial(coeffs=[10.7274,0.0449751,-1.8474e-05,3.36857e-09,-2.30122e-13,14453.2,-15.551], Tmin=(1190.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cs_S)"""),
)

species(
    label = '[CH]C(=CO)C(C)CC(27991)',
    structure = SMILES('[CH]C(=CO)C(C)CC'),
    E0 = (54.9666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.625693,0.0841219,-2.50011e-05,-3.50236e-08,2.18588e-11,6793.47,32.6486], Tmin=(100,'K'), Tmax=(952.37,'K')), NASAPolynomial(coeffs=[21.7953,0.0324877,-1.06698e-05,1.84029e-09,-1.28427e-13,593.871,-84.5529], Tmin=(952.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.9666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]CC([CH2])C(=C)CO(27992)',
    structure = SMILES('[CH2]CC([CH2])C(=C)CO'),
    E0 = (150.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0502055,0.08383,-6.88866e-05,3.18133e-08,-6.14312e-12,18217.7,36.578], Tmin=(100,'K'), Tmax=(1216.64,'K')), NASAPolynomial(coeffs=[13.0896,0.0409604,-1.60334e-05,2.85251e-09,-1.92235e-13,15044.8,-28.8869], Tmin=(1216.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = 'CCC1CC[C]1[CH]O(27993)',
    structure = SMILES('CCC1CC[C]1[CH]O'),
    E0 = (97.4936,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481194,0.060645,9.35692e-06,-5.18432e-08,2.30809e-11,11867.2,30.4237], Tmin=(100,'K'), Tmax=(1001.19,'K')), NASAPolynomial(coeffs=[15.9113,0.0377651,-1.44453e-05,2.68072e-09,-1.90965e-13,6834.52,-53.7395], Tmin=(1001.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.4936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCsJOH) + radical(CCJ(C)CO)"""),
)

species(
    label = 'C=C(CC)C(=C)CO(27994)',
    structure = SMILES('C=C(CC)C(=C)CO'),
    E0 = (-157.041,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.351621,0.0850613,-6.25507e-05,2.08589e-08,-1.8019e-12,-18722,31.4855], Tmin=(100,'K'), Tmax=(1104.89,'K')), NASAPolynomial(coeffs=[17.2722,0.034994,-1.32269e-05,2.34967e-09,-1.59781e-13,-23454.9,-59.0912], Tmin=(1104.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-157.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C([CH]C)[C](C)[CH]O(27995)',
    structure = SMILES('[CH2]C([CH]C)[C](C)[CH]O'),
    E0 = (348.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,206.929,813.857,1637.02],'cm^-1')),
        HinderedRotor(inertia=(0.148246,'amu*angstrom^2'), symmetry=1, barrier=(3.56804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148246,'amu*angstrom^2'), symmetry=1, barrier=(3.56804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148246,'amu*angstrom^2'), symmetry=1, barrier=(3.56804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148246,'amu*angstrom^2'), symmetry=1, barrier=(3.56804,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148246,'amu*angstrom^2'), symmetry=1, barrier=(3.56804,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184151,0.0864002,-7.74475e-05,4.10958e-08,-9.36596e-12,42108.2,36.2686], Tmin=(100,'K'), Tmax=(1027.25,'K')), NASAPolynomial(coeffs=[10.3348,0.046875,-1.97328e-05,3.64014e-09,-2.50487e-13,40022.8,-12.9752], Tmin=(1027.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Cs_S) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC([CH2])[C](C)[CH]O(27996)',
    structure = SMILES('[CH2]CC([CH2])[C](C)[CH]O'),
    E0 = (359.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0979343,0.0899387,-8.23545e-05,4.31064e-08,-9.42739e-12,43408.1,36.506], Tmin=(100,'K'), Tmax=(1084.74,'K')), NASAPolynomial(coeffs=[12.66,0.0428932,-1.72984e-05,3.12331e-09,-2.12394e-13,40640.3,-26.081], Tmin=(1084.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CCsJOH) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C1C(O)CC1CC(27997)',
    structure = SMILES('C=C1C(O)CC1CC'),
    E0 = (-127.985,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.62029,0.00335273,0.000123218,-1.25497e-07,2.93946e-11,-15706.6,-11.5926], Tmin=(100,'K'), Tmax=(1704.42,'K')), NASAPolynomial(coeffs=[76.7966,0.0372921,-7.52625e-05,1.80868e-08,-1.33943e-12,-66435.2,-453.138], Tmin=(1704.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
reaction(
    ...
    products = ['C=CCC(36)', 'C=C=CO(12571)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C1([CH]O)CC1CC(27964)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=CO)C(=C)CC(27965)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH2](6)', '[CH2]C(C=C)=CO(27710)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CCC(36)', '[CH2][C]=CO(18753)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]CC(39)', 'C=C=CO(12571)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=CO)[C](C)CC(27966)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(=CO)C(C)[CH]C(27967)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(CC)=C(C)[CH]O(27968)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(CC)C(C)=[C]O(27969)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH]C)C(C)=CO(27970)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CC(C)C([CH2])=CO(27971)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=[C]O)C(C)CC(27972)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(CC)C(C)=C[O](13201)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC([CH2])C(C)=CO(27973)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH]C(=C)C([CH2])CC(17621)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH2](6)', '[CH2]C=C([CH2])[CH]O(27824)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CC(39)', '[CH2][C]=CO(18753)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C([CH]O)=C([CH2])CC(27974)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH2]C(=CO)C([CH2])[CH2](14058)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2]C(=CO)C([CH2])[CH]C(27975)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]CC([CH2])C([CH2])=CO(27976)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2]C(=[C]O)C([CH2])CC(27977)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(CC)[C]1CC1O(27978)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2][C]1C(O)CC1CC(27979)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][C](CO)C([CH2])[CH]C(27981)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]CC([CH2])[C]([CH2])CO(27982)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(S)(14)', '[CH2]C(=CO)C([CH2])C(13013)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C([CH]CCC)=CO(27983)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH2(T)(28)', '[CH2]C([CH]CC)=CO(27874)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CH2(T)(28)', '[CH2]C([C]=CO)CC(27985)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(8)', '[CH]C(CC)C([CH2])=CO(27986)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(8)', '[CH]C(=CO)C([CH2])CC(27987)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(CC)C(=C)C[O](9453)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['[CH2]C(CC)=C([CH2])CO(27988)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=C(CO)C([CH2])CC(27989)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C([CH]C)C(=C)CO(27990)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]C(=CO)C(C)CC(27991)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]CC([CH2])C(=C)CO(27992)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C(=CO)C([CH2])CC(13227)'],
    products = ['CCC1CC[C]1[CH]O(27993)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]C([CH]C)[C](C)[CH]O(27995)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2]CC([CH2])[C](C)[CH]O(27996)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH2]C([C]=C)CC(4464)', '[CH]O(5471)'],
    products = ['[CH2]C(=CO)C([CH2])CC(13227)'],
...
network(
    label = '5000',
    isomers = [
        '[CH2]C(=CO)C([CH2])CC(13227)',
    ],
    reactants = [
        ('C=CCC(36)', 'C=C=CO(12571)'),
    ],
    bathGas = {
        'N2': 0.25,
        'Ne': 0.25,
