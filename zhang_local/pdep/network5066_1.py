...
species(
    label = '[CH2]OC(=O)C[C]=CO(29030)',
    structure = SMILES('[CH2]OC(=O)C[C]=CO'),
    E0 = (-110.418,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.212593,0.0701097,-4.79952e-05,5.25036e-09,4.07238e-12,-13132.6,29.2168], Tmin=(100,'K'), Tmax=(1063.69,'K')), NASAPolynomial(coeffs=[20.6928,0.0173941,-7.92395e-06,1.61279e-09,-1.20454e-13,-18864.2,-77.3146], Tmin=(1063.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(CsJOC(O)C) + radical(Cds_S)"""),
)

species(
    label = '[O]CC(=O)C[C]=CO(29031)',
    structure = SMILES('[O]CC(=O)C[C]=CO'),
    E0 = (-20.481,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,375,552.5,462.5,1710,287.794,287.794,287.795,287.797],'cm^-1')),
        HinderedRotor(inertia=(0.00203529,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279281,'amu*angstrom^2'), symmetry=1, barrier=(16.4152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279294,'amu*angstrom^2'), symmetry=1, barrier=(16.4153,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27927,'amu*angstrom^2'), symmetry=1, barrier=(16.4153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0572425,0.0761194,-7.07718e-05,2.93932e-08,-4.09626e-12,-2312.32,30.4922], Tmin=(100,'K'), Tmax=(1114.46,'K')), NASAPolynomial(coeffs=[20.4408,0.0157073,-6.61891e-06,1.28131e-09,-9.25959e-14,-7647.32,-73.6074], Tmin=(1114.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=OCOJ) + radical(Cds_S)"""),
)
...
species(
    label = '[O]C1(C=C=CO)CO1(29032)',
    structure = SMILES('[O]C1(C=C=CO)CO1'),
    E0 = (-47.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,540,610,2055,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14917,0.096061,-0.000112679,6.02889e-08,-1.13732e-11,-5505.51,32.305], Tmin=(100,'K'), Tmax=(1632.69,'K')), NASAPolynomial(coeffs=[23.4638,-0.0011543,8.29928e-06,-2.03856e-09,1.5018e-13,-9275.48,-89.7513], Tmin=(1632.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = '[O]C1(CC#CO)CO1(29033)',
    structure = SMILES('[O]C1(CC#CO)CO1'),
    E0 = (21.2521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2100,2250,500,550,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0922021,0.0719872,-7.28664e-05,3.7688e-08,-7.2556e-12,2718.87,28.6818], Tmin=(100,'K'), Tmax=(1518.55,'K')), NASAPolynomial(coeffs=[16.4257,0.0138586,-1.00769e-06,-1.98545e-10,2.53646e-14,-612.257,-52.3583], Tmin=(1518.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.2521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CtH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtOs) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = 'OC=[C]CC1(O)[CH]O1(29034)',
    structure = SMILES('OC=[C]CC1(O)[CH]O1'),
    E0 = (-22.6043,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.79582,0.111348,-0.000129894,6.70059e-08,-1.20454e-11,-2385.68,40.1068], Tmin=(100,'K'), Tmax=(1737.45,'K')), NASAPolynomial(coeffs=[27.014,-0.00599981,1.14899e-05,-2.62004e-09,1.85492e-13,-6085.83,-105.391], Tmin=(1737.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.6043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(Cds_S)"""),
)

species(
    label = 'OC=[C][CH]C1(O)CO1(29035)',
    structure = SMILES('OC=[C][CH]C1(O)CO1'),
    E0 = (-89.41,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.81823,0.111704,-0.000127842,6.51592e-08,-1.1616e-11,-10419.6,37.1903], Tmin=(100,'K'), Tmax=(1747.59,'K')), NASAPolynomial(coeffs=[26.9757,-0.00406669,1.03984e-05,-2.40497e-09,1.70636e-13,-14267.1,-108.777], Tmin=(1747.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'O[C]=[C]CC1(O)CO1(29036)',
    structure = SMILES('O[C]=[C]CC1(O)CO1'),
    E0 = (33.4175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2850,1437.5,1250,1305,750,350,3580,3650,1210,1345,900,1100,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.49713,0.0994711,-0.000113883,5.9548e-08,-1.09947e-11,4290.73,38.3424], Tmin=(100,'K'), Tmax=(1667.86,'K')), NASAPolynomial(coeffs=[24.3071,-0.000419032,7.9764e-06,-1.96048e-09,1.43542e-13,301.989,-89.8374], Tmin=(1667.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.4175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(Cds_S)"""),
)
...
species(
    label = '[O]C1([CH]O1)C[C]=CO(29037)',
    structure = SMILES('[O]C1([CH]O1)C[C]=CO'),
    E0 = (209.386,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8616,0.0936505,-0.000106921,5.61233e-08,-1.05016e-11,25424.8,34.3964], Tmin=(100,'K'), Tmax=(1621.98,'K')), NASAPolynomial(coeffs=[23.8691,0.000748894,6.22562e-06,-1.57526e-09,1.16851e-13,20951.3,-90.2436], Tmin=(1621.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.386,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CCsJO) + radical(Cds_S)"""),
)

species(
    label = '[O]C1([CH][C]=CO)CO1(29038)',
    structure = SMILES('[O]C1([CH][C]=CO)CO1'),
    E0 = (142.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.8747,0.093917,-0.000104636,5.40604e-08,-1.0008e-11,17390.4,31.4449], Tmin=(100,'K'), Tmax=(1632.08,'K')), NASAPolynomial(coeffs=[23.8613,0.00265963,5.13759e-06,-1.35974e-09,1.01888e-13,12743.2,-93.8247], Tmin=(1632.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(C=CCJCO) + radical(Cds_S) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[O]C1(C[C]=[C]O)CO1(29039)',
    structure = SMILES('[O]C1(C[C]=[C]O)CO1'),
    E0 = (265.408,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,3150,900,1100,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.654403,0.0826769,-9.33746e-05,5.10658e-08,-1.02024e-11,32105.7,32.9737], Tmin=(100,'K'), Tmax=(1474.66,'K')), NASAPolynomial(coeffs=[19.951,0.00782957,2.04006e-06,-7.86052e-10,6.57763e-14,28089.6,-67.4511], Tmin=(1474.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CC(C)(O)OJ) + radical(C=CJO)"""),
)
...
species(
    label = 'OC=C=CC1(O)CO1(29040)',
    structure = SMILES('OC=C=CC1(O)CO1'),
    E0 = (-280.944,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-3.45843,0.105705,-0.000119714,6.08816e-08,-1.08247e-11,-33470.4,36.1737], Tmin=(100,'K'), Tmax=(1757.58,'K')), NASAPolynomial(coeffs=[24.8423,-0.00224489,9.57657e-06,-2.25455e-09,1.60718e-13,-36693.3,-97.1887], Tmin=(1757.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-280.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Ethylene_oxide)"""),
)
...
species(
    label = '[CH2]O[C]([O])C[C]=CO(29041)',
    structure = SMILES('[CH2]O[C]([O])C[C]=CO'),
    E0 = (292.037,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200939,0.0858511,-0.000106588,6.82521e-08,-1.73226e-11,35258.9,33.5955], Tmin=(100,'K'), Tmax=(962.859,'K')), NASAPolynomial(coeffs=[14.961,0.0245315,-1.10568e-05,2.10593e-09,-1.47563e-13,32416.6,-37.0539], Tmin=(962.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CCOJ) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
species(
    label = '[O]C[C]([O])C[C]=CO(29042)',
    structure = SMILES('[O]C[C]([O])C[C]=CO'),
    E0 = (289.143,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0969895,0.0940587,-0.000133024,9.829e-08,-2.8629e-11,34919.8,32.5212], Tmin=(100,'K'), Tmax=(844.62,'K')), NASAPolynomial(coeffs=[14.4036,0.0253872,-1.1069e-05,2.03102e-09,-1.37568e-13,32470.2,-34.9871], Tmin=(844.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(Cds_S) + radical(CCOJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C[C]=CO(29030)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(C=C=CO)CO1(29032)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[O]C1(CC#CO)CO1(29033)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', 'C#CCC1([O])CO1(17990)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C1(C[C]=CO)CO1(15022)'],
    products = ['[O]C1(CC=[C]O)CO1(15019)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C1(C[C]=CO)CO1(15022)'],
    products = ['OC=[C]CC1(O)[CH]O1(29034)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[O]C1(C[C]=CO)CO1(15022)'],
    products = ['OC=[C][CH]C1(O)CO1(29035)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[O]C1(C[C]=CO)CO1(15022)'],
    products = ['[O]C1([CH]O1)CC=CO(15026)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O[C]=[C]CC1(O)CO1(29036)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C1(C[C]=CO)CO1(15022)'],
    products = ['[O]C=[C]CC1(O)CO1(15023)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH]=[C]CC1([O])CO1(17997)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[O]C1([CH]O1)C[C]=CO(29037)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[O]C1([CH][C]=CO)CO1(29038)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[O]C1(C[C]=[C]O)CO1(29039)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', '[O]C(=O)C[C]=CO(14634)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(S)(1732)', 'C=C([O])C[C]=CO(14467)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]O[C]([O])C[C]=CO(29041)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[O]C[C]([O])C[C]=CO(29042)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(T)(63)', 'OC=[C]C[C]1CO1(28317)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C1([O])CO1(1847)', '[C]=CO(27807)'],
    products = ['[O]C1(C[C]=CO)CO1(15022)'],
