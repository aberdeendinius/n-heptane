...
species(
    label = '[CH2]C(C)C(=C)OO(1480)',
    structure = SMILES('[CH2]C(C)C(=C)OO'),
    E0 = (66.7447,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(0.692714,'amu*angstrom^2'), symmetry=1, barrier=(15.9268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00398251,'amu*angstrom^2'), symmetry=1, barrier=(15.9249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254873,'amu*angstrom^2'), symmetry=1, barrier=(5.86002,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0121598,'amu*angstrom^2'), symmetry=1, barrier=(15.9243,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.4818,'amu*angstrom^2'), symmetry=1, barrier=(80.0535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0653023,0.0788975,-6.43761e-05,2.64461e-08,-4.33238e-12,18190.2,36.5384], Tmin=(100,'K'), Tmax=(1457.87,'K')), NASAPolynomial(coeffs=[18.9052,0.0268469,-1.08207e-05,1.95558e-09,-1.32635e-13,12658.9,-62.1348], Tmin=(1457.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(CC(C)(O)OJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](C)C([CH2])(O)OO(1482)',
    structure = SMILES('[CH2][C](C)C([CH2])(O)OO'),
    E0 = (123.045,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.424738,0.0806548,-4.13072e-05,-2.22208e-08,1.97729e-11,14973.6,39.0208], Tmin=(100,'K'), Tmax=(924.097,'K')), NASAPolynomial(coeffs=[25.1313,0.0133087,-2.23383e-06,2.65859e-10,-1.98784e-14,8402.62,-92.2524], Tmin=(924.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](C)C(C)([O])OO(1483)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0255043,0.0778547,-6.40583e-05,2.73228e-08,-4.68172e-12,17118.1,36.6868], Tmin=(100,'K'), Tmax=(1394.68,'K')), NASAPolynomial(coeffs=[17.2532,0.0284455,-1.09184e-05,1.9218e-09,-1.28567e-13,12312.6,-52.158], Tmin=(1394.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C([CH2])(O)O[O](1484)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.70619,0.101608,-0.000107912,5.50845e-08,-1.0459e-11,10345.5,39.5377], Tmin=(100,'K'), Tmax=(1491.36,'K')), NASAPolynomial(coeffs=[26.2742,0.0105455,-2.13105e-07,-2.59767e-10,2.55998e-14,3780.78,-100.664], Tmin=(1491.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.1385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Isobutyl) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C)C(C)([O])O[O](1485)',
    structure = SMILES('[CH2]C(C)C(C)([O])O[O]'),
    E0 = (102.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0314649,0.0845701,-8.17792e-05,4.24451e-08,-8.8679e-12,12436.4,32.7972], Tmin=(100,'K'), Tmax=(1156.24,'K')), NASAPolynomial(coeffs=[15.5662,0.0306087,-1.1773e-05,2.07983e-09,-1.40003e-13,8829.54,-44.7167], Tmin=(1156.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C([CH2])C([CH2])(O)OO(1486)',
    structure = SMILES('[CH2]C([CH2])C([CH2])(O)OO'),
    E0 = (137.216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3615,1310,387.5,850,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.00334,0.107553,-0.000118316,6.19956e-08,-1.20206e-11,16740.5,40.929], Tmin=(100,'K'), Tmax=(1469.01,'K')), NASAPolynomial(coeffs=[27.5811,0.0088917,9.12735e-07,-5.02676e-10,4.32738e-14,10002,-106.528], Tmin=(1469.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C(C)([O])OO(1487)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.381318,0.091077,-9.3887e-05,5.1221e-08,-1.10906e-11,18833.8,34.3818], Tmin=(100,'K'), Tmax=(1126.87,'K')), NASAPolynomial(coeffs=[17.3151,0.0282601,-1.02693e-05,1.75156e-09,-1.15489e-13,14845.5,-53.1068], Tmin=(1126.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])(O[O])C(C)C(1488)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0695211,0.085058,-8.04496e-05,3.98068e-08,-7.90935e-12,13506,32.4548], Tmin=(100,'K'), Tmax=(1211.49,'K')), NASAPolynomial(coeffs=[16.6397,0.0298881,-1.21402e-05,2.21652e-09,-1.52189e-13,9457.5,-51.3628], Tmin=(1211.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CC(C)(O)OJ) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.65321,0.103539,-0.000109008,5.47639e-08,-1.03694e-11,-18526.9,35.4105], Tmin=(100,'K'), Tmax=(1432.56,'K')), NASAPolynomial(coeffs=[27.8258,0.0113519,-2.14034e-06,2.19284e-10,-1.09168e-14,-25959.7,-113.869], Tmin=(1432.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)

species(
    label = 'C=C(C)C(C)([O])OO(1494)',
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401107,0.0507266,4.70306e-05,-1.28568e-07,6.33056e-11,30404.1,28.0043], Tmin=(100,'K'), Tmax=(889.679,'K')), NASAPolynomial(coeffs=[30.0807,-0.00487762,9.54906e-06,-2.14634e-09,1.48875e-13,22042.6,-129.025], Tmin=(889.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Isobutyl) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C1([O])OCC1C(1497)',
    structure = SMILES('[CH2]C1([O])OCC1C'),
    E0 = (64.7689,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988103,0.0532174,1.34478e-06,-5.15928e-08,2.86285e-11,7910.76,22.3088], Tmin=(100,'K'), Tmax=(877.658,'K')), NASAPolynomial(coeffs=[16.9857,0.01789,-2.50986e-06,1.26095e-10,-1.5748e-15,3655.21,-61.0288], Tmin=(877.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(64.7689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.68531,0.101953,-0.000101576,4.91404e-08,-8.60116e-12,-11219.6,37.3735], Tmin=(100,'K'), Tmax=(1736.51,'K')), NASAPolynomial(coeffs=[22.6846,0.0127118,2.11897e-06,-8.84113e-10,7.13232e-14,-15386.4,-85.6502], Tmin=(1736.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.6123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1(OO)OCC1C(1229)',
    structure = SMILES('[CH2]C1(OO)OCC1C'),
    E0 = (-92.2639,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0306378,0.0629175,2.76758e-05,-1.07467e-07,5.48373e-11,-10927.3,27.701], Tmin=(100,'K'), Tmax=(891.343,'K')), NASAPolynomial(coeffs=[28.4169,0.00594291,4.59982e-06,-1.23632e-09,8.79512e-14,-18806.6,-122.021], Tmin=(891.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-92.2639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353251,0.0873601,-0.000115874,9.76275e-08,-3.39807e-11,-5790.64,33.1759], Tmin=(100,'K'), Tmax=(815.11,'K')), NASAPolynomial(coeffs=[6.42603,0.0467549,-2.12684e-05,3.98917e-09,-2.73601e-13,-6421.72,7.32139], Tmin=(815.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.1807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])([O])C(C)CO(1501)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1552,0.0953206,-0.000142906,1.31741e-07,-4.86012e-11,-4427.97,32.3699], Tmin=(100,'K'), Tmax=(817.128,'K')), NASAPolynomial(coeffs=[4.83796,0.0517948,-2.51846e-05,4.84049e-09,-3.35442e-13,-4505.43,14.9328], Tmin=(817.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.8806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2][C](OO)C([CH2])C(1502)',
    structure = SMILES('[CH2][C](OO)C([CH2])C'),
    E0 = (331.2,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1310,387.5,850,1000,360,370,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567334,0.0795427,-9.03433e-05,6.13415e-08,-1.74634e-11,39954.1,31.0922], Tmin=(100,'K'), Tmax=(844.269,'K')), NASAPolynomial(coeffs=[9.33505,0.0380059,-1.65511e-05,3.07674e-09,-2.11667e-13,38473.6,-9.72334], Tmin=(844.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(Isobutyl) + radical(C2CsJOOH)"""),
)
...
species(
    label = '[CH]C([O])(OO)C([CH2])C(1504)',
    structure = SMILES('[CH]C([O])(OO)C([CH2])C'),
    E0 = (398.377,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.343915,0.0911572,-9.63105e-05,5.23509e-08,-1.12434e-11,48073.8,34.1647], Tmin=(100,'K'), Tmax=(1135.73,'K')), NASAPolynomial(coeffs=[18.1527,0.0260118,-1.02693e-05,1.84462e-09,-1.257e-13,43872.4,-57.4249], Tmin=(1135.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH]C(C)C([CH2])([O])OO(1505)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.377401,0.0915908,-9.47938e-05,4.94826e-08,-1.01947e-11,49143.3,34.4992], Tmin=(100,'K'), Tmax=(1180.63,'K')), NASAPolynomial(coeffs=[19.1584,0.0254018,-1.06985e-05,1.99564e-09,-1.39055e-13,44530.5,-62.9933], Tmin=(1180.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(OO)C(=C)C(1478)', 'H(8)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C(=O)OO(1479)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(72.9546,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-NdNd_O;YJ] for rate rule [CO-NdNd_O;CH2_triplet]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 71.4 to 73.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C)C(=C)OO(1480)', 'O(T)(63)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([O])(C=C)OO(1283)', '[CH3](11)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(119.242,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 117.5 to 119.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)C(=C)[O](782)', '[O]O(16)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C([O])(OO)[C](C)C(1481)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2][C](C)C([CH2])(O)OO(1482)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2][C](C)C(C)([O])OO(1483)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C(C)C([CH2])(O)O[O](1484)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C)C(C)([O])O[O](1485)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C([CH2])(O)OO(1486)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C([CH2])C(C)([O])OO(1487)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])(O[O])C(C)C(1488)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C]([O])C([CH2])C(792)', '[O]O(16)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C)C([CH2])([O])O[O](1490)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH3](11)', '[CH2][CH]C([CH2])([O])OO(1397)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C](C)C([CH2])([O])OO(1491)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH2])C([CH2])([O])OO(1492)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C(O)(OO)C(=C)C(1493)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(S)(14)', '[CH2]CC([CH2])([O])OO(1216)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['OH(D)(132)', '[CH2]C(C)C1([CH2])OO1(1495)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['OH(D)(132)', '[CH2]C(C)C1([O])CO1(1496)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['OH(D)(132)', '[CH2]C1([O])OCC1C(1497)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C([O])([CH]CC)OO(1498)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C(C)C1(CO1)OO(1499)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C(C)C([O])([O])CO(1500)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
    products = ['[CH2]C([O])([O])C(C)CO(1501)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(T)(28)', '[CH2]C([O])([CH]C)OO(1389)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction39',
    reactants = ['O(T)(63)', '[CH2][C](OO)C([CH2])C(1502)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(C)[C]([O])OO(1503)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]C([O])(OO)C([CH2])C(1504)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]C(C)C([CH2])([O])OO(1505)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])([O])OO(1226)'],
