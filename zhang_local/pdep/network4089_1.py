...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96825,0.0354028,1.23699e-05,-3.54937e-08,1.47569e-11,94729.5,24.3142], Tmin=(100,'K'), Tmax=(996.173,'K')), NASAPolynomial(coeffs=[8.94329,0.0291198,-1.08812e-05,1.95806e-09,-1.35931e-13,92261.9,-14.7199], Tmin=(996.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(786.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([CH2])[C]([CH2])[CH2](19202)',
    structure = SMILES('[CH]C([CH2])[C]([CH2])[CH2]'),
    E0 = (1045.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,1380,1390,370,380,2900,435,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,208.59,741.917,2813.18,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0196057,'amu*angstrom^2'), symmetry=1, barrier=(3.46059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0196057,'amu*angstrom^2'), symmetry=1, barrier=(3.46059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0196057,'amu*angstrom^2'), symmetry=1, barrier=(3.46059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0196057,'amu*angstrom^2'), symmetry=1, barrier=(3.46059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0196057,'amu*angstrom^2'), symmetry=1, barrier=(3.46059,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09429,0.068941,-9.30976e-05,7.51382e-08,-2.36166e-11,125860,30.7531], Tmin=(100,'K'), Tmax=(951.372,'K')), NASAPolynomial(coeffs=[6.40792,0.03195,-1.16764e-05,1.89682e-09,-1.16962e-13,125512,8.86729], Tmin=(951.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1045.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl) + radical(Tertalkyl) + radical(CCJ2_triplet) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78711,0.0311416,5.22206e-05,-8.81938e-08,3.55285e-11,53731.1,21.439], Tmin=(100,'K'), Tmax=(961.245,'K')), NASAPolynomial(coeffs=[13.2497,0.0270337,-9.39193e-06,1.71409e-09,-1.24406e-13,49513.6,-43.8835], Tmin=(961.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09083,0.0574955,-3.56065e-05,5.91819e-09,2.07957e-12,113267,27.1699], Tmin=(100,'K'), Tmax=(993.122,'K')), NASAPolynomial(coeffs=[11.5771,0.0279709,-1.02113e-05,1.75845e-09,-1.17506e-13,110557,-26.5038], Tmin=(993.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(940.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51658,0.0443892,-2.01155e-07,-3.59303e-08,1.90969e-11,71223.5,24.2085], Tmin=(100,'K'), Tmax=(909.416,'K')), NASAPolynomial(coeffs=[13.1793,0.0203187,-5.40818e-06,8.08355e-10,-5.27509e-14,67976.4,-37.1404], Tmin=(909.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=C1CCC1[CH2](19194)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[11.2519,-0.0244619,0.000141925,-1.30772e-07,2.98529e-11,62256.1,-19.4175], Tmin=(100,'K'), Tmax=(1711.24,'K')), NASAPolynomial(coeffs=[70.2839,0.0280793,-7.11387e-05,1.72968e-08,-1.28427e-12,14156.1,-417.435], Tmin=(1711.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(520.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Cds_P) + radical(Isobutyl)"""),
)
...
species(
    label = '[C]C(=C)C([CH2])[CH2](19208)',
    structure = SMILES('[C]C(=C)C([CH2])[CH2]'),
    E0 = (996.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,417.389,3187.09],'cm^-1')),
        HinderedRotor(inertia=(0.0939253,'amu*angstrom^2'), symmetry=1, barrier=(11.6094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.643071,'amu*angstrom^2'), symmetry=1, barrier=(79.5842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.643797,'amu*angstrom^2'), symmetry=1, barrier=(79.5824,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.86133,0.061245,-5.93839e-05,3.09996e-08,-6.34404e-12,119971,25.4209], Tmin=(100,'K'), Tmax=(1286.26,'K')), NASAPolynomial(coeffs=[13.566,0.0181984,-5.05847e-06,7.04522e-10,-4.02129e-14,116995,-37.9322], Tmin=(1286.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(996.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CJ3) + radical(Isobutyl)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.264e+11,'s^-1'), n=0.35, Ea=(101.18,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH]C(=C)C=C(17773)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]C([CH2])=C([CH2])[CH2](19199)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C([CH2])[C]([CH2])[CH2](19202)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', '[CH]C([CH2])=C[CH2](18836)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C(=C)C([CH])[CH2](19204)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(28)', 'C#CC([CH2])[CH2](6419)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(=C)C([CH2])[CH2](17727)'],
    products = ['[CH]C(C)=C([CH2])[CH2](19205)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(=C)C([CH2])[CH2](17727)'],
    products = ['[CH2]C([CH2])=C([CH2])[CH2](17726)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C(=C)C([CH2])[CH2](17727)'],
    products = ['[CH2]C([CH2])C1=CC1(19206)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', '[CH]=[C]C([CH2])[CH2](6423)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[C]C(=C)C([CH2])[CH2](19208)'],
    products = ['[CH]C(=C)C([CH2])[CH2](17727)'],
