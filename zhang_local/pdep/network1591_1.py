species(
    label = '[CH2]OC([CH2])O(3775)',
    structure = SMILES('[CH2]OC([CH2])O'),
    E0 = (-36.5961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,180,685.924],'cm^-1')),
        HinderedRotor(inertia=(0.102773,'amu*angstrom^2'), symmetry=1, barrier=(2.36294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102626,'amu*angstrom^2'), symmetry=1, barrier=(2.35958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102822,'amu*angstrom^2'), symmetry=1, barrier=(2.36409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0409077,'amu*angstrom^2'), symmetry=1, barrier=(13.6442,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-113.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,385.729,385.733],'cm^-1')),
        HinderedRotor(inertia=(0.149713,'amu*angstrom^2'), symmetry=1, barrier=(15.807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149712,'amu*angstrom^2'), symmetry=1, barrier=(15.807,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149711,'amu*angstrom^2'), symmetry=1, barrier=(15.807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](O)OC(5683)',
    structure = SMILES('[CH2][C](O)OC'),
    E0 = (-19.2207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,360,370,350,292.105,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00644897,'amu*angstrom^2'), symmetry=1, barrier=(25.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128648,'amu*angstrom^2'), symmetry=1, barrier=(7.78864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128637,'amu*angstrom^2'), symmetry=1, barrier=(7.78858,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426945,'amu*angstrom^2'), symmetry=1, barrier=(25.851,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
...
species(
    label = '[CH2]OC(C)[O](3596)',
    structure = SMILES('[CH2]OC(C)[O]'),
    E0 = (-22.4801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1122.63,1122.66],'cm^-1')),
...
species(
    label = '[CH2]C([O])OC(672)',
    structure = SMILES('[CH2]C([O])OC'),
    E0 = (1.23808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,887.113,1724.91],'cm^-1')),
        HinderedRotor(inertia=(0.143546,'amu*angstrom^2'), symmetry=1, barrier=(3.30039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160091,'amu*angstrom^2'), symmetry=1, barrier=(3.68081,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147167,'amu*angstrom^2'), symmetry=1, barrier=(3.38367,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
...
species(
    ...
    E0 = (168.65,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,267.586,267.588],'cm^-1')),
        HinderedRotor(inertia=(0.00235435,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00235435,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00235432,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00235435,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91836,0.047453,-5.13711e-05,2.99905e-08,-7.14913e-12,24131.6,21.5873], Tmin=(100,'K'), Tmax=(1007.83,'K')), NASAPolynomial(coeffs=[9.17568,0.0186497,-8.5026e-06,1.63406e-09,-1.15217e-13,22668.8,-13.4819], Tmin=(1007.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJ2_triplet) + radical(CsJOCH3)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)O(1017)', 'H(8)'],
    products = ['[CH2]OC([CH2])O(3775)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['OH(D)(132)', '[CH2]OC=C(414)'],
    products = ['[CH2]OC([CH2])O(3775)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(D)(132)', '[CH2][CH]O[CH2](417)'],
    products = ['[CH2]OC([CH2])O(3775)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OC([CH2])[O](682)', 'H(8)'],
    products = ['[CH2]OC([CH2])O(3775)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]O[C]([CH2])O(1013)', 'H(8)'],
    products = ['[CH2]OC([CH2])O(3775)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(28)', '[CH2]C([O])O(670)'],
    products = ['[CH2]OC([CH2])O(3775)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]O[CH]O(554)', 'CH2(T)(28)'],
    products = ['[CH2]OC([CH2])O(3775)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C(O)O[CH2](5685)'],
    products = ['[CH2]OC([CH2])O(3775)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]OC([CH2])O(5686)'],
    products = ['[CH2]OC([CH2])O(3775)'],
