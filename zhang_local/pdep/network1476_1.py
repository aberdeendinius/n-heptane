...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07821,0.0519703,-8.06229e-05,8.71095e-08,-3.62014e-11,52033.5,23.8653], Tmin=(100,'K'), Tmax=(822.842,'K')), NASAPolynomial(coeffs=[-1.14428,0.0437157,-2.19706e-05,4.26105e-09,-2.96313e-13,53373.6,43.7042], Tmin=(822.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(CCOJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883755,0.057225,-5.99048e-05,2.99959e-08,-5.67457e-12,42017.4,22.2223], Tmin=(100,'K'), Tmax=(1426.97,'K')), NASAPolynomial(coeffs=[17.0799,0.00671345,-1.43526e-06,1.69336e-10,-9.2908e-15,37915.5,-59.8501], Tmin=(1426.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(Allyl_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=[C]C[C]([O])O(5458)',
    structure = SMILES('[CH]=[C]C[C]([O])O'),
    E0 = (539.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3120,650,792.5,1650,360,370,350,298.862,2070.8],'cm^-1')),
        HinderedRotor(inertia=(0.0933115,'amu*angstrom^2'), symmetry=1, barrier=(5.53195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0910934,'amu*angstrom^2'), symmetry=1, barrier=(5.5367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0944321,'amu*angstrom^2'), symmetry=1, barrier=(5.55969,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63484,0.0600186,-0.000102498,9.70227e-08,-3.53703e-11,64941.4,26.8536], Tmin=(100,'K'), Tmax=(840.762,'K')), NASAPolynomial(coeffs=[4.98145,0.0271641,-1.36729e-05,2.63613e-09,-1.81711e-13,64977.1,14.8477], Tmin=(840.762,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(539.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(Cs_P) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=C[CH]C([O])=O(5452)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH][CH]C=C([O])[O](5459)'],
    products = ['[CH]=CC[C]([O])[O](5172)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]=[C]C[C]([O])[O](5460)'],
    products = ['[CH]=CC[C]([O])[O](5172)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[O][C][O](2319)', '[CH]C=C(5174)'],
    products = ['[CH]=CC[C]([O])[O](5172)'],
