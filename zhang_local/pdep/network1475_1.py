...
species(
    label = '[CH]=[C]C([CH2])([O])O(5465)',
    structure = SMILES('[CH]=[C]C([CH2])([O])O'),
    E0 = (529.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,3615,1277.5,1000,3000,3100,440,815,1455,1000,345.282,345.424,345.488,345.645,345.981,346.119],'cm^-1')),
        HinderedRotor(inertia=(0.155504,'amu*angstrom^2'), symmetry=1, barrier=(13.1996,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155928,'amu*angstrom^2'), symmetry=1, barrier=(13.202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155565,'amu*angstrom^2'), symmetry=1, barrier=(13.2027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.751882,0.0678577,-8.38349e-05,4.35638e-08,-6.47502e-12,63771,25.9397], Tmin=(100,'K'), Tmax=(861.044,'K')), NASAPolynomial(coeffs=[17.9893,0.00365452,3.58394e-07,-2.12685e-10,1.88073e-14,60214.1,-58.0591], Tmin=(861.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(O)2CJ) + radical(C=CC(C)(O)OJ) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(C)([O])[O](5466)',
    structure = SMILES('[CH]=[C]C(C)([O])[O]'),
    E0 = (548.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,237.99,237.998,237.999,238.005,238.02,238.028,4000],'cm^-1')),
        HinderedRotor(inertia=(0.19771,'amu*angstrom^2'), symmetry=1, barrier=(7.94703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197723,'amu*angstrom^2'), symmetry=1, barrier=(7.94696,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13919,0.0669271,-0.00010648,8.50307e-08,-2.5668e-11,66097,23.8059], Tmin=(100,'K'), Tmax=(951.276,'K')), NASAPolynomial(coeffs=[10.6973,0.0147284,-5.2375e-06,8.09013e-10,-4.68648e-14,64821.9,-18.9734], Tmin=(951.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=CC(C)(O)OJ) + radical(Cds_P) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[O]C1([O])C=CC1(5462)',
    structure = SMILES('[O]C1([O])C=CC1'),
    E0 = (224.788,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00286,0.0349289,-4.21071e-06,-2.73252e-08,1.57296e-11,27116.1,19.0532], Tmin=(100,'K'), Tmax=(905.831,'K')), NASAPolynomial(coeffs=[13.3982,0.00888469,-1.28246e-06,1.05232e-10,-6.27977e-15,24055.6,-40.2933], Tmin=(905.831,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH]C=C([O])[O](5468)',
    structure = SMILES('[CH]C=C([O])[O]'),
    E0 = (293.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,350,440,435,1725,284.957,285.832,286.081,288.319,288.451],'cm^-1')),
        HinderedRotor(inertia=(0.876213,'amu*angstrom^2'), symmetry=1, barrier=(50.128,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.12361,0.0366344,-2.95933e-05,1.22144e-08,-2.03258e-12,35407.8,17.4811], Tmin=(100,'K'), Tmax=(1427.58,'K')), NASAPolynomial(coeffs=[10.2928,0.0137448,-5.54245e-06,9.82851e-10,-6.56959e-14,33075.4,-24.8387], Tmin=(1427.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C([O])([O])C=[CH](5469)',
    structure = SMILES('[CH]C([O])([O])C=[CH]'),
    E0 = (759.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3010,987.5,1337.5,450,1655,180,180,180,180,840.783,1381.94,1600,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.203943,'amu*angstrom^2'), symmetry=1, barrier=(4.68904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203943,'amu*angstrom^2'), symmetry=1, barrier=(4.68904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09318,0.0657112,-0.000102423,7.71024e-08,-2.1825e-11,91402.9,24.5004], Tmin=(100,'K'), Tmax=(988.14,'K')), NASAPolynomial(coeffs=[12.8048,0.00910932,-2.54587e-06,3.03325e-10,-1.27154e-14,89537.1,-29.5907], Tmin=(988.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(759.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(Cds_P) + radical(C=CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C#CC([CH2])([O])[O](5464)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH]=CC(=C)[O](5179)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH]=CC([O])=O(5175)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([O])[O](2304)', 'C#C(582)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]C([CH2])([O])[O](5467)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(T)(63)', '[CH]C=C([CH2])[O](5297)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(28)', '[CH]C=C([O])[O](5468)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]C([O])([O])C=[CH](5469)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[C]=CC([CH2])([O])[O](5470)'],
    products = ['[CH]=CC([CH2])([O])[O](5171)'],
