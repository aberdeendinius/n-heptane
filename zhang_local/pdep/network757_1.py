...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.534097,0.0799449,-0.000118515,9.02309e-08,-2.69268e-11,40445.8,27.9899], Tmin=(100,'K'), Tmax=(826.053,'K')), NASAPolynomial(coeffs=[13.0299,0.0194469,-8.67779e-06,1.60228e-09,-1.08536e-13,38381,-29.9094], Tmin=(826.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCO) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[C](C)[O](1062)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01923,0.0724179,-0.000112842,9.91187e-08,-3.45071e-11,42123,26.4717], Tmin=(100,'K'), Tmax=(823.804,'K')), NASAPolynomial(coeffs=[7.47337,0.0297287,-1.44442e-05,2.76456e-09,-1.90707e-13,41444.7,-1.07712], Tmin=(823.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(349.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CJCO) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26255,0.0685468,-0.000113658,1.0599e-07,-3.85597e-11,74316.7,27.1552], Tmin=(100,'K'), Tmax=(828.096,'K')), NASAPolynomial(coeffs=[5.62292,0.0309734,-1.56902e-05,3.04233e-09,-2.10885e-13,74160.7,10.3597], Tmin=(828.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(617.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Cs_P) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[C]([CH2])[O](1063)'],
    products = ['C=C([O])[O](1172)', 'C=C(18)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][CH]OC([CH2])=O(1060)', 'H(8)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])[O](1172)', '[CH2][CH2](22)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(7.26699,'m^3/(mol*s)'), n=2.00263, Ea=(107.584,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond
Ea raised from 105.4 to 107.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]CO[C]([CH2])[O](1063)'],
    products = ['[CH2][C]([O])O[CH]C(1064)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CO[C]([CH2])[O](1063)'],
    products = ['[CH2][CH]O[C]([CH2])O(1061)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([O])[O](2304)', '[CH2][CH2](22)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]O[C]([CH2])[O](1065)', 'H(8)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]O[C]([CH2])[O](1016)', 'CH2(T)(28)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]CO[C]([CH2])[O](2306)', 'H(8)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH][C]([O])OC[CH2](2307)', 'H(8)'],
    products = ['[CH2]CO[C]([CH2])[O](1063)'],
