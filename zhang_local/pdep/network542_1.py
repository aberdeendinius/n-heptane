species(
    label = '[CH2]OC([CH2])([O])OO(1272)',
    structure = SMILES('[CH2]OC([CH2])([O])OO'),
    E0 = (82.6095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785451,0.0813789,-0.000140791,1.31769e-07,-4.7235e-11,10041.1,30.1164], Tmin=(100,'K'), Tmax=(851.441,'K')), NASAPolynomial(coeffs=[5.99073,0.0340198,-1.70045e-05,3.25063e-09,-2.22399e-13,9984.97,10.7167], Tmin=(851.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.6095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH) + radical(CCOJ) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2]OC(=C)OO(2692)',
    structure = SMILES('[CH2]OC(=C)OO'),
    E0 = (11.4064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,232.584,232.628],'cm^-1')),
        HinderedRotor(inertia=(0.00311341,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.300515,'amu*angstrom^2'), symmetry=1, barrier=(11.5161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426182,'amu*angstrom^2'), symmetry=1, barrier=(16.3475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0148303,'amu*angstrom^2'), symmetry=1, barrier=(25.8398,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]OC([CH2])(O)O[O](2693)',
    structure = SMILES('[CH2]OC([CH2])(O)O[O]'),
    E0 = (8.90908,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (105.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69566,0.080413,-0.000132641,1.14955e-07,-3.82489e-11,1183.14,30.3382], Tmin=(100,'K'), Tmax=(879.027,'K')), NASAPolynomial(coeffs=[9.05053,0.0260176,-1.18728e-05,2.1691e-09,-1.44022e-13,347.01,-5.29306], Tmin=(879.027,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.90908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]OC(C)([O])O[O](2694)',
    structure = SMILES('[CH2]OC(C)([O])O[O]'),
    E0 = (20.6517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,424.598,1381.6,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.139065,'amu*angstrom^2'), symmetry=1, barrier=(3.19737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139065,'amu*angstrom^2'), symmetry=1, barrier=(3.19737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139065,'amu*angstrom^2'), symmetry=1, barrier=(3.19737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139065,'amu*angstrom^2'), symmetry=1, barrier=(3.19737,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (105.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12705,0.0749226,-0.000131819,1.27779e-07,-4.67626e-11,2576.01,27.654], Tmin=(100,'K'), Tmax=(864.227,'K')), NASAPolynomial(coeffs=[3.56293,0.0364294,-1.7765e-05,3.35414e-09,-2.27468e-13,3171.46,22.1386], Tmin=(864.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.6517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C([O])(OC)O[O](2695)',
    ...
    molecularWeight = (105.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14934,0.0763733,-0.000140675,1.40023e-07,-5.18345e-11,5711.48,28.7788], Tmin=(100,'K'), Tmax=(870.393,'K')), NASAPolynomial(coeffs=[2.29905,0.0383897,-1.88621e-05,3.55789e-09,-2.40506e-13,6749.99,30.5072], Tmin=(870.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.7433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CJCOOH) + radical(CCOJ)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4098.47,'J/mol'), sigma=(6.79314,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=640.17 K, Pc=29.67 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH2]OC([CH2])([O])O[O](2696)',
    structure = SMILES('[CH2]OC([CH2])([O])O[O]'),
    E0 = (234.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04301,0.0778543,-0.00014566,1.41104e-07,-5.08741e-11,28311.8,29.9512], Tmin=(100,'K'), Tmax=(875.759,'K')), NASAPolynomial(coeffs=[4.37425,0.0324086,-1.60425e-05,3.01689e-09,-2.0286e-13,28887.6,20.9404], Tmin=(875.759,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CCOJ) + radical(CJCOOH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]OC1(CO1)OO(2697)',
    structure = SMILES('[CH2]OC1(CO1)OO'),
    E0 = (-167.495,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (105.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.847901,0.0679656,-8.36754e-05,5.59637e-08,-1.44487e-11,-20030.3,24.0727], Tmin=(100,'K'), Tmax=(1078.57,'K')), NASAPolynomial(coeffs=[11.6642,0.0197965,-5.48209e-06,7.07522e-10,-3.58631e-14,-21894.9,-26.7557], Tmin=(1078.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-167.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C1(OO)OCO1(1275)',
    structure = SMILES('[CH2]C1(OO)OCO1'),
    E0 = (-174.16,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (105.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11294,0.042566,2.43201e-05,-7.73057e-08,3.66669e-11,-20823.4,24.7448], Tmin=(100,'K'), Tmax=(937.775,'K')), NASAPolynomial(coeffs=[22.5391,0.00426192,6.73634e-07,-1.29064e-10,-4.70879e-16,-27176.3,-89.6934], Tmin=(937.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]OC([O])([O])CO(2698)',
    structure = SMILES('[CH2]OC([O])([O])CO'),
    E0 = (-136.98,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (105.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17807,0.0785653,-0.000153633,1.58655e-07,-5.99508e-11,-16389.1,28.8202], Tmin=(100,'K'), Tmax=(870.58,'K')), NASAPolynomial(coeffs=[0.365974,0.0419868,-2.11556e-05,4.0216e-09,-2.72571e-13,-14720.2,41.3987], Tmin=(870.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CCOJ) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH]C([O])(O[CH2])OO(2700)',
    structure = SMILES('[CH]C([O])(O[CH2])OO'),
    E0 = (316.862,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (104.061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.80054,0.0816909,-0.000147066,1.38758e-07,-4.96758e-11,38214,29.071], Tmin=(100,'K'), Tmax=(856.447,'K')), NASAPolynomial(coeffs=[6.17606,0.0317884,-1.62364e-05,3.11312e-09,-2.12689e-13,38202.7,9.27944], Tmin=(856.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsOs) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(28)', '[CH2]OC(=O)OO(2691)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(108.173,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-NdNd_O;YJ] for rate rule [CO-NdNd_O;CH2_triplet]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 104.2 to 108.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]OC(=C)OO(2692)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]OC([CH2])=O(1012)', '[O]O(16)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.245e-08,'m^3/(mol*s)'), n=3.486, Ea=(103.452,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;OJ-O2s]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 100.9 to 103.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['[CH2]OC([CH2])([O])OO(1272)'],
    products = ['[CH2]OC([CH2])(O)O[O](2693)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['OH(D)(132)', '[CH2]OC([CH2])([O])[O](2029)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[C]([CH2])[O](1016)', '[O]O(16)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]OC([CH2])([O])O[O](2696)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]OC([CH2])([O])OO(1272)'],
    products = ['OH(D)(132)', '[CH2]OC1([CH2])OO1(2607)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]OC([CH2])([O])OO(1272)'],
    products = ['OH(D)(132)', '[CH2]OC1([O])CO1(1775)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]OC([CH2])([O])OO(1272)'],
    products = ['OH(D)(132)', '[CH2]C1([O])OCO1(2115)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([O])([O])OO(1288)', 'CH2(T)(28)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', '[CH2]O[C]([CH2])OO(1384)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[C]([O])OO(2699)', 'CH2(T)(28)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C([O])(O[CH2])OO(2700)', 'H(8)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]OC([CH2])([O])OO(2701)', 'H(8)'],
    products = ['[CH2]OC([CH2])([O])OO(1272)'],
