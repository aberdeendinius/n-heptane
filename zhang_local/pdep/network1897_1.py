...
species(
    label = '[CH2]CC=CCO[O](7016)',
    structure = SMILES('[CH2]CC=CCO[O]'),
    E0 = (223.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,252.56,4000],'cm^-1')),
        HinderedRotor(inertia=(1.01805,'amu*angstrom^2'), symmetry=1, barrier=(46.0801,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166816,'amu*angstrom^2'), symmetry=1, barrier=(7.55092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166807,'amu*angstrom^2'), symmetry=1, barrier=(7.55087,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166816,'amu*angstrom^2'), symmetry=1, barrier=(7.55096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]CCC=CO[O](7017)',
    structure = SMILES('[CH2]CCC=CO[O]'),
    E0 = (232.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,251.101,251.153],'cm^-1')),
        HinderedRotor(inertia=(0.00267065,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170296,'amu*angstrom^2'), symmetry=1, barrier=(7.62443,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170379,'amu*angstrom^2'), symmetry=1, barrier=(7.62381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170333,'amu*angstrom^2'), symmetry=1, barrier=(7.62366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939017,0.0637409,-5.34084e-05,2.40726e-08,-4.44905e-12,28094.6,29.7569], Tmin=(100,'K'), Tmax=(1280.11,'K')), NASAPolynomial(coeffs=[12.5245,0.0275395,-1.09884e-05,1.98069e-09,-1.34587e-13,25128.5,-28.9971], Tmin=(1280.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35628,0.0678962,-4.39205e-05,-3.12107e-08,5.0128e-11,34895.4,27.6394], Tmin=(100,'K'), Tmax=(506.541,'K')), NASAPolynomial(coeffs=[6.77364,0.04236,-1.93622e-05,3.67023e-09,-2.54594e-13,34125.4,3.00477], Tmin=(506.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]CC[CH][CH]OO(7020)',
    structure = SMILES('[CH2]CC[CH][CH]OO'),
    E0 = (337.837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00248,0.0755712,-6.73976e-05,7.69519e-09,2.33943e-11,40730.9,30.4195], Tmin=(100,'K'), Tmax=(537.268,'K')), NASAPolynomial(coeffs=[7.50507,0.0429327,-2.0313e-05,3.91577e-09,-2.74496e-13,39804.6,0.969359], Tmin=(537.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(RCCJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2][CH]CCCO[O](7021)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.870286,0.0760232,-0.00010115,8.83555e-08,-3.16733e-11,35621,31.828], Tmin=(100,'K'), Tmax=(827.141,'K')), NASAPolynomial(coeffs=[4.61263,0.0446727,-2.02636e-05,3.79082e-09,-2.59303e-13,35455.3,17.224], Tmin=(827.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH][CH]CO[O](7022)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885283,0.0779206,-0.000112287,1.04339e-07,-3.86012e-11,35038.7,32.1201], Tmin=(100,'K'), Tmax=(840.164,'K')), NASAPolynomial(coeffs=[3.03294,0.047527,-2.20154e-05,4.13648e-09,-2.82689e-13,35389.6,26.3691], Tmin=(840.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CCC[CH][CH]O[O](7023)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650702,0.0799721,-0.000104316,8.69528e-08,-3.02576e-11,34343.5,30.5498], Tmin=(100,'K'), Tmax=(798.578,'K')), NASAPolynomial(coeffs=[6.43388,0.042968,-1.97142e-05,3.72318e-09,-2.5678e-13,33676.1,5.55465], Tmin=(798.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C[CH][CH]COO(7024)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668604,0.0821326,-0.000117696,1.07028e-07,-3.93075e-11,41450.5,33.9253], Tmin=(100,'K'), Tmax=(820.087,'K')), NASAPolynomial(coeffs=[4.42292,0.04688,-2.22305e-05,4.23281e-09,-2.92058e-13,41404.4,20.0308], Tmin=(820.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]C[CH]COO(7025)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.637022,0.0815828,-0.000112212,9.8218e-08,-3.52648e-11,41451.4,34.2111], Tmin=(100,'K'), Tmax=(811.07,'K')), NASAPolynomial(coeffs=[5.48475,0.0449835,-2.10534e-05,3.99655e-09,-2.75789e-13,41082.5,14.4121], Tmin=(811.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]C[CH][CH]CO[O](7026)',
    structure = SMILES('[CH2]C[CH][CH]CO[O]'),
    E0 = (495.718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,740.205,3129.04],'cm^-1')),
        HinderedRotor(inertia=(0.0260271,'amu*angstrom^2'), symmetry=1, barrier=(2.72595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260271,'amu*angstrom^2'), symmetry=1, barrier=(2.72595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260271,'amu*angstrom^2'), symmetry=1, barrier=(2.72595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260271,'amu*angstrom^2'), symmetry=1, barrier=(2.72595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260271,'amu*angstrom^2'), symmetry=1, barrier=(2.72595,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.907979,0.0788274,-0.000123338,1.17322e-07,-4.33073e-11,59722,33.8249], Tmin=(100,'K'), Tmax=(853.006,'K')), NASAPolynomial(coeffs=[2.90347,0.0450979,-2.11674e-05,3.97474e-09,-2.70471e-13,60268.2,29.7124], Tmin=(853.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ) + radical(RCCJCC) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH2]CC[CH][CH]O[O](7028)',
    structure = SMILES('[CH2]CC[CH][CH]O[O]'),
    E0 = (489.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652237,0.0811477,-0.000116395,1.01381e-07,-3.56218e-11,59027.7,32.3293], Tmin=(100,'K'), Tmax=(826.146,'K')), NASAPolynomial(coeffs=[6.37792,0.0404072,-1.87874e-05,3.54235e-09,-2.42947e-13,58525.9,8.48839], Tmin=(826.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(ROOJ) + radical(CCsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CCC=CCO[O](7029)',
...
species(
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17857,0.0644379,-5.11308e-05,2.3022e-08,-4.50655e-12,2911.5,26.6766], Tmin=(100,'K'), Tmax=(1161.28,'K')), NASAPolynomial(coeffs=[8.98445,0.0375509,-1.64018e-05,3.08496e-09,-2.14534e-13,1098.52,-12.1494], Tmin=(1161.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CCC=COO(7031)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.476695,0.0695463,-5.58313e-05,2.31024e-08,-3.85112e-12,9832.9,30.665], Tmin=(100,'K'), Tmax=(1425.04,'K')), NASAPolynomial(coeffs=[15.8382,0.0264276,-1.04446e-05,1.86956e-09,-1.26184e-13,5454.71,-48.8867], Tmin=(1425.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.6465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC=CO[O](7032)',
...
species(
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1066,0.0523003,6.75944e-07,-4.35151e-08,2.32827e-11,13526.8,25.2892], Tmin=(100,'K'), Tmax=(894.577,'K')), NASAPolynomial(coeffs=[14.133,0.0253256,-6.52863e-06,9.30092e-10,-5.83284e-14,9944.87,-43.0981], Tmin=(894.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.513,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC[CH]C[O](7036)',
    structure = SMILES('[CH2]CC[CH]C[O]'),
    E0 = (302.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,277.812,2237.77,2237.77,2237.85],'cm^-1')),
        HinderedRotor(inertia=(0.0021852,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00218179,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.648596,'amu*angstrom^2'), symmetry=1, barrier=(35.5186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151855,'amu*angstrom^2'), symmetry=1, barrier=(8.31298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44152,0.0417432,1.81099e-05,-1.06893e-07,9.40923e-11,36483.8,25.4659], Tmin=(100,'K'), Tmax=(431.583,'K')), NASAPolynomial(coeffs=[3.36253,0.0429268,-1.97853e-05,3.8269e-09,-2.71022e-13,36313.8,20.7478], Tmin=(431.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]CC[C]CO[O](7038)',
    structure = SMILES('[CH2]CC[C]CO[O]'),
    E0 = (549.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.899011,0.0748503,-8.29469e-05,4.75376e-08,-7.54489e-12,66142.1,28.9366], Tmin=(100,'K'), Tmax=(625.542,'K')), NASAPolynomial(coeffs=[8.38352,0.0371638,-1.69714e-05,3.22223e-09,-2.24113e-13,65006.7,-5.2515], Tmin=(625.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]CC=CCO[O](7016)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CC[CH]CO[O](6844)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]CCC=CO[O](7017)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC[CH][CH]OO(7020)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[CH][CH]COO(7024)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C[CH]COO(7025)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O2(2)', '[CH2][CH]CC[CH2](128)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C[CH][CH]CO[O](7026)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][CH]C[CH]CO[O](7027)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]CC[CH][CH]O[O](7028)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC[CH]CO[O](6803)'],
    products = ['[CH2]CCC=C(123)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]CC[CH]CO[O](6803)'],
    products = ['O(T)(63)', '[CH2]CCC1CO1(7034)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(T)(63)', '[CH2]CC[CH]C[O](7036)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C[CH2](21)', '[CH]CO[O](7037)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]CC[CH2](104)', '[CH2]O[O](61)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH2]CC[C]CO[O](7038)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(8)', '[CH]CC[CH]CO[O](7039)'],
    products = ['[CH2]CC[CH]CO[O](6803)'],
