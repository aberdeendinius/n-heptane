...
species(
    label = '[CH2]C(=CO)CC=CC(28030)',
    structure = SMILES('[CH2]C(=CO)CC=CC'),
    E0 = (-43.6243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.808172,'amu*angstrom^2'), symmetry=1, barrier=(18.5815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808597,'amu*angstrom^2'), symmetry=1, barrier=(18.5912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808211,'amu*angstrom^2'), symmetry=1, barrier=(18.5824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808189,'amu*angstrom^2'), symmetry=1, barrier=(18.5819,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807534,'amu*angstrom^2'), symmetry=1, barrier=(18.5668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.304217,0.077077,-2.38712e-05,-3.47638e-08,2.19964e-11,-5075.81,30.9745], Tmin=(100,'K'), Tmax=(948.673,'K')), NASAPolynomial(coeffs=[22.652,0.023336,-6.97014e-06,1.1958e-09,-8.60823e-14,-11368.7,-88.7769], Tmin=(948.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.6243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C=CCC)=CO(28031)',
    structure = SMILES('[CH2]C(C=CCC)=CO'),
    E0 = (-59.6339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.934291,'amu*angstrom^2'), symmetry=1, barrier=(21.4812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.932348,'amu*angstrom^2'), symmetry=1, barrier=(21.4365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931971,'amu*angstrom^2'), symmetry=1, barrier=(21.4278,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.935259,'amu*angstrom^2'), symmetry=1, barrier=(21.5034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.93187,'amu*angstrom^2'), symmetry=1, barrier=(21.4255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.51665,0.0779117,-1.3051e-05,-5.60561e-08,3.22794e-11,-6989.91,29.6656], Tmin=(100,'K'), Tmax=(929.115,'K')), NASAPolynomial(coeffs=[26.412,0.0168797,-3.15213e-06,4.38419e-10,-3.41333e-14,-14363.5,-111.022], Tmin=(929.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.6339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.451231,0.0848623,-4.84817e-05,-3.64773e-09,9.47676e-12,4263.09,34.1746], Tmin=(100,'K'), Tmax=(966.811,'K')), NASAPolynomial(coeffs=[19.7791,0.0307652,-1.04776e-05,1.8156e-09,-1.25043e-13,-1032.17,-69.897], Tmin=(966.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.0155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCCC([CH2])=CO(28033)',
    structure = SMILES('[CH2]CCCC([CH2])=CO'),
    E0 = (44.8156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.635995,0.0856569,-4.03799e-05,-1.89118e-08,1.64072e-11,5571.76,33.889], Tmin=(100,'K'), Tmax=(954.974,'K')), NASAPolynomial(coeffs=[22.8269,0.0263277,-8.36577e-06,1.44566e-09,-1.02137e-13,-685.48,-87.5233], Tmin=(954.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.8156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]C=C(C)[CH]O(28034)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143951,0.0715441,-2.48869e-05,-1.4932e-08,9.67643e-12,-1065.83,31.9744], Tmin=(100,'K'), Tmax=(1053.4,'K')), NASAPolynomial(coeffs=[15.864,0.0383171,-1.52589e-05,2.82504e-09,-1.98121e-13,-5846.09,-51.653], Tmin=(1053.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.1106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(Allyl_S)"""),
)

species(
    label = 'CC[CH]CC(C)=[C]O(28035)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.141489,0.0854415,-7.42188e-05,3.69557e-08,-7.78873e-12,14844.4,34.729], Tmin=(100,'K'), Tmax=(1112.36,'K')), NASAPolynomial(coeffs=[11.7198,0.043807,-1.80764e-05,3.30878e-09,-2.26825e-13,12268.5,-22.363], Tmin=(1112.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(=[C]O)CCCC(28036)',
    structure = SMILES('[CH2]C(=[C]O)CCCC'),
    E0 = (79.3134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.506118,0.0871754,-5.84725e-05,9.63811e-09,3.83904e-12,9711.93,34.7652], Tmin=(100,'K'), Tmax=(1002.75,'K')), NASAPolynomial(coeffs=[19.2013,0.03223,-1.16851e-05,2.07053e-09,-1.42739e-13,4569.69,-66.299], Tmin=(1002.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.3134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Allyl_P)"""),
)
...
species(
    label = 'C[CH][CH]CC(C)=CO(28037)',
    structure = SMILES('C[CH][CH]CC(C)=CO'),
    E0 = (76.9746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00579707,0.0855511,-7.28392e-05,3.49607e-08,-6.99582e-12,9404.24,34.8604], Tmin=(100,'K'), Tmax=(1179.86,'K')), NASAPolynomial(coeffs=[13.1779,0.0408551,-1.60154e-05,2.85293e-09,-1.92508e-13,6293.26,-30.9239], Tmin=(1179.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.9746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJC) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.499193,0.0899321,-7.70072e-05,3.51875e-08,-6.48644e-12,10726.4,35.6852], Tmin=(100,'K'), Tmax=(1301.47,'K')), NASAPolynomial(coeffs=[17.6978,0.0340047,-1.25486e-05,2.16917e-09,-1.4396e-13,5989.78,-56.8996], Tmin=(1301.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.7747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJ) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(=CO)C[CH][CH]C(28039)',
    structure = SMILES('[CH2]C(=CO)C[CH][CH]C'),
    E0 = (228.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.275071,0.0862001,-7.5117e-05,3.53786e-08,-6.73866e-12,27639.5,36.1084], Tmin=(100,'K'), Tmax=(1261.18,'K')), NASAPolynomial(coeffs=[16.4275,0.033226,-1.21121e-05,2.07403e-09,-1.36844e-13,23426.5,-48.3478], Tmin=(1261.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJC) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH]O)=C[CH]CC(28040)',
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.181967,0.0686339,-1.50568e-05,-2.9669e-08,1.61408e-11,17156.1,32.1162], Tmin=(100,'K'), Tmax=(1005.88,'K')), NASAPolynomial(coeffs=[17.6752,0.0330592,-1.26924e-05,2.35667e-09,-1.67886e-13,11917.3,-60.9285], Tmin=(1005.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]C[CH]CC([CH2])=CO(28041)',
    structure = SMILES('[CH2]C[CH]CC([CH2])=CO'),
    E0 = (239.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.398197,0.0863103,-6.48714e-05,1.77848e-08,9.5645e-13,28945.5,35.5995], Tmin=(100,'K'), Tmax=(998.221,'K')), NASAPolynomial(coeffs=[18.6548,0.0301283,-1.07507e-05,1.87763e-09,-1.28104e-13,24137,-61.3185], Tmin=(998.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJ) + radical(Allyl_P) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(=[C]O)C[CH]CC(28042)',
    structure = SMILES('[CH2]C(=[C]O)C[CH]CC'),
    E0 = (273.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0847069,0.0856466,-7.52091e-05,3.60144e-08,-7.06056e-12,33077.7,35.8177], Tmin=(100,'K'), Tmax=(1215.08,'K')), NASAPolynomial(coeffs=[14.9335,0.0362073,-1.41769e-05,2.52851e-09,-1.70906e-13,29428,-39.5619], Tmin=(1215.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Allyl_P) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]C[C]1CC1O(28043)',
    structure = SMILES('CC[CH]C[C]1CC1O'),
    E0 = (112.472,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603181,0.0628429,-1.23151e-05,-2.04848e-08,1.01094e-11,13659.6,32.9251], Tmin=(100,'K'), Tmax=(1074.25,'K')), NASAPolynomial(coeffs=[12.6247,0.0420702,-1.6807e-05,3.09074e-09,-2.14809e-13,9692.53,-32.3756], Tmin=(1074.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJ(C)CO) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][C]1CC(CC)C1O(28044)',
    structure = SMILES('[CH2][C]1CC(CC)C1O'),
    E0 = (109.635,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
...
species(
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.526402,0.0805399,-2.21729e-05,-4.17621e-08,2.57628e-11,-25213,29.4194], Tmin=(100,'K'), Tmax=(938.095,'K')), NASAPolynomial(coeffs=[24.1985,0.0227976,-6.08951e-06,9.92747e-10,-7.13952e-14,-31950.1,-99.4671], Tmin=(938.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-211.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH)"""),
)

species(
    label = 'CC=CCC(C)=CO(28046)',
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.322978,0.0798053,-3.33057e-05,-2.01382e-08,1.53801e-11,-23298.6,30.7609], Tmin=(100,'K'), Tmax=(966.508,'K')), NASAPolynomial(coeffs=[20.5121,0.0291301,-9.8367e-06,1.7335e-09,-1.21971e-13,-28986.6,-77.6374], Tmin=(966.508,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-195.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    label = '[CH2]C(=CO)CC([CH2])C(28047)',
    structure = SMILES('[CH2]C(=CO)CC([CH2])C'),
    E0 = (35.6101,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.585792,0.0833841,-2.96986e-05,-3.48431e-08,2.39161e-11,4464.16,33.4256], Tmin=(100,'K'), Tmax=(924.313,'K')), NASAPolynomial(coeffs=[23.7075,0.0234703,-5.84729e-06,8.78695e-10,-6.02267e-14,-1958.31,-92.3122], Tmin=(924.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.6101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(Allyl_P)"""),
)
...
species(
    label = 'CC[CH]CC[C]=CO(13416)',
    structure = SMILES('CC[CH]CC[C]=CO'),
    E0 = (135.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1CC(=CO)C1(27945)',
    structure = SMILES('CCC1CC(=CO)C1'),
    E0 = (-165.041,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[8.45337,0.0144005,0.000107222,-1.17241e-07,2.8083e-11,-20108.7,-9.44782], Tmin=(100,'K'), Tmax=(1690.39,'K')), NASAPolynomial(coeffs=[77.4918,0.0337942,-7.21639e-05,1.7467e-08,-1.29921e-12,-69560.1,-455.995], Tmin=(1690.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(methylenecyclobutane)"""),
)
...
species(
    label = '[CH2]C(=CO)C[C]CC(28048)',
    structure = SMILES('[CH2]C(=CO)C[C]CC'),
    E0 = (287.784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.719476,0.0879049,-4.91804e-05,-1.18351e-08,1.46182e-11,34796.9,32.3077], Tmin=(100,'K'), Tmax=(948.4,'K')), NASAPolynomial(coeffs=[23.8818,0.022625,-6.79219e-06,1.14888e-09,-8.13771e-14,28400,-94.1994], Tmin=(948.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(=CO)C[CH]CC(28049)',
    structure = SMILES('[CH]C(=CO)C[CH]CC'),
    E0 = (253.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.747963,0.0915031,-7.39714e-05,3.17545e-08,-5.50024e-12,30636.2,35.9076], Tmin=(100,'K'), Tmax=(1382.42,'K')), NASAPolynomial(coeffs=[18.8455,0.0348101,-1.24564e-05,2.08915e-09,-1.35492e-13,25219,-64.9644], Tmin=(1382.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = 'C=C(C[O])C[CH]CC(9500)',
    structure = SMILES('C=C(C[O])C[CH]CC'),
    E0 = (163.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,202.091,810.308,1086.95,1391.75,1660.71],'cm^-1')),
        HinderedRotor(inertia=(0.147636,'amu*angstrom^2'), symmetry=1, barrier=(3.48925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147636,'amu*angstrom^2'), symmetry=1, barrier=(3.48925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147636,'amu*angstrom^2'), symmetry=1, barrier=(3.48925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147636,'amu*angstrom^2'), symmetry=1, barrier=(3.48925,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147636,'amu*angstrom^2'), symmetry=1, barrier=(3.48925,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57666,0.0609104,-2.81696e-05,5.37241e-09,-3.73131e-13,19730.5,27.4197], Tmin=(100,'K'), Tmax=(3025.21,'K')), NASAPolynomial(coeffs=[54.7909,-0.00119627,-8.12323e-07,1.01128e-10,-1.15265e-16,-15033.4,-287.527], Tmin=(3025.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(=C[CH]CC)CO(28050)',
    structure = SMILES('[CH2]C(=C[CH]CC)CO'),
    E0 = (24.0934,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0955606,0.0802624,-5.5797e-05,1.99932e-08,-2.92546e-12,3053.19,32.5305], Tmin=(100,'K'), Tmax=(1584.3,'K')), NASAPolynomial(coeffs=[17.2859,0.0363779,-1.42474e-05,2.50922e-09,-1.66491e-13,-2454.26,-59.3227], Tmin=(1584.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.0934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=C(CO)C[CH]CC(28051)',
    structure = SMILES('[CH]=C(CO)C[CH]CC'),
    E0 = (185.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.830546,0.0785803,-5.38586e-05,-4.245e-09,2.3797e-11,22389.9,33.5221], Tmin=(100,'K'), Tmax=(553.604,'K')), NASAPolynomial(coeffs=[6.12834,0.0539632,-2.41741e-05,4.58386e-09,-3.19855e-13,21594,9.20515], Tmin=(553.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJCC)"""),
)

species(
    label = '[CH]C(=CO)CCCC(28052)',
    structure = SMILES('[CH]C(=CO)CCCC'),
    E0 = (58.7545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.683756,0.0874692,-3.85397e-05,-1.78087e-08,1.48514e-11,7249.12,33.102], Tmin=(100,'K'), Tmax=(967.966,'K')), NASAPolynomial(coeffs=[20.7421,0.0346672,-1.20963e-05,2.12126e-09,-1.47144e-13,1426.97,-78.2161], Tmin=(967.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.7545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=C(CO)C[CH][CH]C(28053)',
    structure = SMILES('C=C(CO)C[CH][CH]C'),
    E0 = (132.631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,290.568,401.919,1143.07,3345.3],'cm^-1')),
        HinderedRotor(inertia=(0.0615422,'amu*angstrom^2'), symmetry=1, barrier=(1.66157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615422,'amu*angstrom^2'), symmetry=1, barrier=(1.66157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615422,'amu*angstrom^2'), symmetry=1, barrier=(1.66157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615422,'amu*angstrom^2'), symmetry=1, barrier=(1.66157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615422,'amu*angstrom^2'), symmetry=1, barrier=(1.66157,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.521272,0.0839008,-9.78257e-05,8.36122e-08,-3.06911e-11,16070,36.8652], Tmin=(100,'K'), Tmax=(809.174,'K')), NASAPolynomial(coeffs=[3.21019,0.0578471,-2.58724e-05,4.8406e-09,-3.32397e-13,16052.6,27.0437], Tmin=(809.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C[CH]CC(=C)CO(28054)',
    structure = SMILES('[CH2]C[CH]CC(=C)CO'),
    E0 = (143.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,203.522,825.612,1237.78,1722.68],'cm^-1')),
        HinderedRotor(inertia=(0.141461,'amu*angstrom^2'), symmetry=1, barrier=(3.46406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141461,'amu*angstrom^2'), symmetry=1, barrier=(3.46406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141461,'amu*angstrom^2'), symmetry=1, barrier=(3.46406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141461,'amu*angstrom^2'), symmetry=1, barrier=(3.46406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141461,'amu*angstrom^2'), symmetry=1, barrier=(3.46406,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.962129,0.0755039,-4.63574e-05,-1.17407e-08,2.68403e-11,17351.9,34.4357], Tmin=(100,'K'), Tmax=(546.591,'K')), NASAPolynomial(coeffs=[5.55668,0.0547229,-2.45709e-05,4.67168e-09,-3.26781e-13,16657.8,13.2901], Tmin=(546.591,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC1C[C]([CH]O)C1(28055)',
    structure = SMILES('CCC1C[C]([CH]O)C1'),
    E0 = (97.4936,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
...
species(
    label = 'C=C(C=CCC)CO(28056)',
    structure = SMILES('C=C(C=CCC)CO'),
    E0 = (-155.476,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.162703,0.0807346,-5.29325e-05,1.27363e-08,6.13471e-13,-18540.4,32.0127], Tmin=(100,'K'), Tmax=(1089.82,'K')), NASAPolynomial(coeffs=[16.4313,0.036069,-1.38081e-05,2.47637e-09,-1.69536e-13,-23121.8,-53.8959], Tmin=(1089.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(CO)CC=CC(28057)',
    structure = SMILES('C=C(CO)CC=CC'),
    E0 = (-139.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315285,0.076759,-5.25392e-05,1.88543e-08,-2.82127e-12,-16638.2,32.3672], Tmin=(100,'K'), Tmax=(1515.84,'K')), NASAPolynomial(coeffs=[14.1584,0.0402301,-1.63921e-05,2.95698e-09,-1.99412e-13,-20835,-40.1762], Tmin=(1515.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C=[C]C(O)C[CH]CC(13453)',
    structure = SMILES('C=[C]C(O)C[CH]CC'),
    E0 = (171.631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.627839,0.0794682,-6.47707e-05,3.20005e-08,-7.15073e-12,20759.4,35.2357], Tmin=(100,'K'), Tmax=(1009.46,'K')), NASAPolynomial(coeffs=[7.7359,0.0513024,-2.2918e-05,4.36023e-09,-3.05407e-13,19324.3,0.876494], Tmin=(1009.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJCC)"""),
)

species(
    label = 'C=C1CC(CC)C1O(27962)',
    structure = SMILES('C=C1CC(CC)C1O'),
    E0 = (-129.055,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[9.66791,0.00308513,0.000123584,-1.25652e-07,2.94056e-11,-15837.7,-11.7991], Tmin=(100,'K'), Tmax=(1705.51,'K')), NASAPolynomial(coeffs=[76.9199,0.0373192,-7.53563e-05,1.8106e-08,-1.34059e-12,-66696.3,-454.003], Tmin=(1705.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(108.25,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra_csHNd] for rate rule [R4_S_D;doublebond_intra_HNd;radadd_intra_csHNd]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 107.3 to 108.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=CO)CC=CC(28030)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(C=CCC)=CO(28031)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', '[CH2]C(=CO)CC=C(27751)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=CO)C[CH]CC(13371)'],
    products = ['[CH2]C(=CO)CC[CH]C(28032)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CCCC([CH2])=CO(28033)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=CO)C[CH]CC(13371)'],
    products = ['CC[CH]C=C(C)[CH]O(28034)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=[C]O)CCCC(28036)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH][CH]CC(C)=CO(28037)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH]CC(C)=CO(28038)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(D)(132)', '[CH]C(=C)C[CH]CC(17660)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](11)', '[CH2][CH]CC([CH2])=CO(14139)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C(=CO)C[CH][CH]C(28039)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH2]C([CH]O)=C[CH]CC(28040)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2]C[CH]CC([CH2])=CO(28041)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH2]C(=[C]O)C[CH]CC(28042)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(=CO)C[CH]CC(13371)'],
    products = ['CC[CH]C[C]1CC1O(28043)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(=CO)C[CH]CC(13371)'],
    products = ['[CH2][C]1CC(CC)C1O(28044)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(S)(14)', '[CH2]C(=CO)C[CH]C(13121)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(=CO)CC([CH2])C(28047)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C[CH2](6)', '[CH]CC([CH2])=CO(27828)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]CC(45)', '[CH2]C([CH2])=CO(17684)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CH2(T)(28)', 'CC[CH]C[C]=CO(27845)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(8)', '[CH2]C(=CO)C[C]CC(28048)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(8)', '[CH]C(=CO)C[CH]CC(28049)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C=C(C[O])C[CH]CC(9500)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(=CO)C[CH]CC(13371)'],
    products = ['[CH2]C(=C[CH]CC)CO(28050)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH]=C(CO)C[CH]CC(28051)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction48',
    reactants = ['C=C(CO)C[CH][CH]C(28053)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C[CH]CC(=C)CO(28054)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C(=CO)C[CH]CC(13371)'],
    products = ['CCC1C[C]([CH]O)C1(28055)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=[C]C(O)C[CH]CC(13453)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH]O(5471)', 'C=[C]C[CH]CC(4523)'],
    products = ['[CH2]C(=CO)C[CH]CC(13371)'],
