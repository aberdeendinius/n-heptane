...
species(
    ...
    E0 = (-80.2056,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,251.863,897.243,1807.45],'cm^-1')),
...
species(
    label = 'CCC=CC[CH]O(5666)',
    structure = SMILES('CCC=CC[CH]O'),
    E0 = (-54.7225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCC[O](5669)',
    structure = SMILES('CC[CH]CCC[O]'),
    E0 = (68.4714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,444.943,1800.41,3200],'cm^-1')),
...
species(
    label = 'CC[CH]C[CH]CO(5670)',
    structure = SMILES('CC[CH]C[CH]CO'),
    E0 = (42.6683,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,400,1202.56,3200],'cm^-1')),
...
species(
    label = 'CC[CH][CH]CCO(5673)',
    structure = SMILES('CC[CH][CH]CCO'),
    E0 = (37.2246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1475.56,2091.56,4000],'cm^-1')),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.424157,0.082765,-7.84862e-05,4.45387e-08,-1.09046e-11,4196.77,30.9813], Tmin=(100,'K'), Tmax=(958.406,'K')), NASAPolynomial(coeffs=[9.40524,0.0452813,-1.98201e-05,3.7303e-09,-2.5964e-13,2475.28,-11.9656], Tmin=(958.406,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.8522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]CCCO(5675)',
    structure = SMILES('C[CH][CH]CCCO'),
    E0 = (37.2126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,241.23,408.657,1172.85,3283.69],'cm^-1')),
        HinderedRotor(inertia=(0.0334811,'amu*angstrom^2'), symmetry=1, barrier=(3.23716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0334811,'amu*angstrom^2'), symmetry=1, barrier=(3.23716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0334811,'amu*angstrom^2'), symmetry=1, barrier=(3.23716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0334811,'amu*angstrom^2'), symmetry=1, barrier=(3.23716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0334811,'amu*angstrom^2'), symmetry=1, barrier=(3.23716,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCCC[CH][O](620)',
    structure = SMILES('CCCCC[CH][O]'),
    E0 = (54.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66086,0.0634419,1.14141e-05,-1.55091e-07,1.51212e-10,6603.69,25.8817], Tmin=(100,'K'), Tmax=(435.72,'K')), NASAPolynomial(coeffs=[4.82434,0.054197,-2.49104e-05,4.7602e-09,-3.32597e-13,6140.09,11.0914], Tmin=(435.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C[CH]CCCO(5676)',
...
species(
    ...
    E0 = (217.522,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,340.121,429.389,1247.32,3450.78],'cm^-1')),
        HinderedRotor(inertia=(0.0301802,'amu*angstrom^2'), symmetry=1, barrier=(2.93338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0301802,'amu*angstrom^2'), symmetry=1, barrier=(2.93338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0301802,'amu*angstrom^2'), symmetry=1, barrier=(2.93338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0301802,'amu*angstrom^2'), symmetry=1, barrier=(2.93338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0301802,'amu*angstrom^2'), symmetry=1, barrier=(2.93338,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (222.966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,248.793,860.89,1252.77,1859.8],'cm^-1')),
        HinderedRotor(inertia=(0.108875,'amu*angstrom^2'), symmetry=1, barrier=(3.38217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108875,'amu*angstrom^2'), symmetry=1, barrier=(3.38217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108875,'amu*angstrom^2'), symmetry=1, barrier=(3.38217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108875,'amu*angstrom^2'), symmetry=1, barrier=(3.38217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108875,'amu*angstrom^2'), symmetry=1, barrier=(3.38217,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (217.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,180,400,990.805,3200],'cm^-1')),
        HinderedRotor(inertia=(0.034862,'amu*angstrom^2'), symmetry=1, barrier=(3.20619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.034862,'amu*angstrom^2'), symmetry=1, barrier=(3.20619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.034862,'amu*angstrom^2'), symmetry=1, barrier=(3.20619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.034862,'amu*angstrom^2'), symmetry=1, barrier=(3.20619,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.034862,'amu*angstrom^2'), symmetry=1, barrier=(3.20619,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (228.311,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200.93,830.155,1210.25,1654.09],'cm^-1')),
        HinderedRotor(inertia=(0.152216,'amu*angstrom^2'), symmetry=1, barrier=(3.54293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152216,'amu*angstrom^2'), symmetry=1, barrier=(3.54293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152216,'amu*angstrom^2'), symmetry=1, barrier=(3.54293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152216,'amu*angstrom^2'), symmetry=1, barrier=(3.54293,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152216,'amu*angstrom^2'), symmetry=1, barrier=(3.54293,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[C]CC[CH]O(5681)',
    structure = SMILES('CC[C]CC[CH]O'),
    E0 = (276.821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.285393,0.0856704,-8.96141e-05,5.46847e-08,-1.40316e-11,33424.3,29.5979], Tmin=(100,'K'), Tmax=(929.241,'K')), NASAPolynomial(coeffs=[10.5721,0.0413917,-1.81405e-05,3.40879e-09,-2.3685e-13,31512.4,-19.2749], Tmin=(929.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(276.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CCsJOH)"""),
)

species(
    label = 'CC[CH]CC[C]O(5682)',
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.961825,0.0752744,-6.20743e-05,1.04259e-08,1.56554e-11,36634.6,29.0836], Tmin=(100,'K'), Tmax=(560.911,'K')), NASAPolynomial(coeffs=[6.82018,0.046754,-2.12569e-05,4.04921e-09,-2.82843e-13,35768.9,2.34862], Tmin=(560.911,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CH2_triplet) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CCC=CC[CH]O(5666)'],
    products = ['CC[CH]CC[CH]O(5506)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'CC[CH]CC=CO(5667)'],
    products = ['CC[CH]CC[CH]O(5506)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'CC=CCC[CH]O(5668)'],
    products = ['CC[CH]CC[CH]O(5506)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH3](11)', 'C=CCC[CH]O(5624)'],
    products = ['CC[CH]CC[CH]O(5506)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CC[CH][O](650)', 'H(8)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CC[CH][CH]C[CH]O(986)', 'H(8)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CC[CH]C[CH][CH]O(985)', 'H(8)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]CC[CH]O(853)', '[CH3](11)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH][CH]CC[CH]O(988)', 'H(8)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH]CC[CH]O(990)', 'H(8)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(S)(14)', 'C[CH]CC[CH]O(5500)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C)CC[CH]O(5680)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction35',
    reactants = ['OH(D)(132)', '[CH]CC[CH]CC(224)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]CC(45)', '[CH2]C[CH]O(426)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C[CH]CC(23)', '[CH]O(5471)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C[CH2](6)', '[CH]CC[CH]O(5597)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(8)', 'CC[C]CC[CH]O(5681)'],
    products = ['CC[CH]CC[CH]O(5506)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(8)', 'CC[CH]CC[C]O(5682)'],
    products = ['CC[CH]CC[CH]O(5506)'],
