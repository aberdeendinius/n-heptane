...
species(
    label = 'C=C[CH]OC=C=O(14239)',
    structure = SMILES('C=C[CH]OC=C=O'),
    E0 = (7.6743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2120,512.5,787.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,354.703,354.849,354.898,354.943],'cm^-1')),
        HinderedRotor(inertia=(0.28288,'amu*angstrom^2'), symmetry=1, barrier=(25.2742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283057,'amu*angstrom^2'), symmetry=1, barrier=(25.2777,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282629,'amu*angstrom^2'), symmetry=1, barrier=(25.2722,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05383,0.0549943,-3.33105e-05,-3.00282e-09,6.9135e-12,1037.87,23.9594], Tmin=(100,'K'), Tmax=(974.113,'K')), NASAPolynomial(coeffs=[16.2943,0.0145082,-4.99225e-06,9.02625e-10,-6.50056e-14,-2979.66,-54.5485], Tmin=(974.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.6743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-(Cdd-O2d)OsH) + radical(C=CCJ(O)C)"""),
)

species(
    label = 'C=C=COC[C]=O(14240)',
    structure = SMILES('C=C=COC[C]=O'),
    E0 = (43.1537,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,540,610,2055,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.15118,'amu*angstrom^2'), symmetry=1, barrier=(26.468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.15113,'amu*angstrom^2'), symmetry=1, barrier=(26.4667,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788968,0.0571988,-2.70978e-05,-1.84429e-08,1.45206e-11,5318.05,23.9565], Tmin=(100,'K'), Tmax=(949.101,'K')), NASAPolynomial(coeffs=[20.1432,0.00846143,-1.95873e-06,3.45775e-10,-2.88569e-14,165.533,-76.1952], Tmin=(949.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.1537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696267,0.0624037,-4.37602e-05,3.68984e-09,5.27172e-12,12683.5,25.709], Tmin=(100,'K'), Tmax=(977.595,'K')), NASAPolynomial(coeffs=[17.9216,0.0145298,-4.99053e-06,9.05646e-10,-6.54672e-14,8235.37,-62.5279], Tmin=(977.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(CsCJ=O)"""),
)

species(
    label = 'CC=[C]OC[C]=O(14243)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897062,0.0600215,-4.72574e-05,1.46593e-08,-4.14945e-13,12903,27.6451], Tmin=(100,'K'), Tmax=(1055.26,'K')), NASAPolynomial(coeffs=[15.3726,0.0184903,-7.18348e-06,1.32073e-09,-9.26737e-14,9105.17,-46.4889], Tmin=(1055.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C=[C]OCC=O(14244)',
    structure = SMILES('[CH2]C=[C]OCC=O'),
    E0 = (103.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,2782.5,750,1395,475,1775,1000,425.823,425.823,425.823],'cm^-1')),
        HinderedRotor(inertia=(0.155211,'amu*angstrom^2'), symmetry=1, barrier=(19.9713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155211,'amu*angstrom^2'), symmetry=1, barrier=(19.9713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155211,'amu*angstrom^2'), symmetry=1, barrier=(19.9713,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155211,'amu*angstrom^2'), symmetry=1, barrier=(19.9713,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892554,0.0566387,-2.74492e-05,-1.22541e-08,1.06242e-11,12525.1,27.2617], Tmin=(100,'K'), Tmax=(973.28,'K')), NASAPolynomial(coeffs=[17.492,0.0153337,-5.27289e-06,9.698e-10,-7.10842e-14,8019.06,-58.9208], Tmin=(973.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(C=CJO) + radical(Allyl_P)"""),
)
...
species(
    label = 'CC=CO[CH][C]=O(14246)',
    structure = SMILES('CC=CO[CH][C]=O'),
    E0 = (60.4768,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.889552,'amu*angstrom^2'), symmetry=1, barrier=(20.4526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890097,'amu*angstrom^2'), symmetry=1, barrier=(20.4651,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.890603,'amu*angstrom^2'), symmetry=1, barrier=(20.4767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.889935,'amu*angstrom^2'), symmetry=1, barrier=(20.4614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.373451,0.0670624,-4.53508e-05,-3.62568e-09,1.01261e-11,7415.85,25.8677], Tmin=(100,'K'), Tmax=(946.92,'K')), NASAPolynomial(coeffs=[21.506,0.00873101,-1.95611e-06,3.2572e-10,-2.63372e-14,2026.68,-82.2559], Tmin=(946.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.4768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCsJOC(O)) + radical(CsCJ=O)"""),
)
...
species(
    label = 'C=C[CH]OC=[C][O](14247)',
    structure = SMILES('C=C[CH]OC=[C][O]'),
    E0 = (207.405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,393.815,393.815,393.815,393.815,393.815],'cm^-1')),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0216,0.0525012,-1.81756e-05,-2.43832e-08,1.59443e-11,25064.2,27.8098], Tmin=(100,'K'), Tmax=(947.158,'K')), NASAPolynomial(coeffs=[18.4763,0.0107959,-2.81892e-06,4.87431e-10,-3.77478e-14,20322,-63.0305], Tmin=(947.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CCJ(O)C) + radical(C=CJO) + radical(C=COJ)"""),
)

species(
    label = '[CH2][C]=COC[C]=O(14248)',
    structure = SMILES('[CH2][C]=COC[C]=O'),
    E0 = (255.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1855,455,950,3000,3100,440,815,1455,1000,264.68,264.68,264.68],'cm^-1')),
        HinderedRotor(inertia=(0.481131,'amu*angstrom^2'), symmetry=1, barrier=(23.9184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48113,'amu*angstrom^2'), symmetry=1, barrier=(23.9184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48113,'amu*angstrom^2'), symmetry=1, barrier=(23.9184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.48113,'amu*angstrom^2'), symmetry=1, barrier=(23.9184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716063,0.0596655,-3.43043e-05,-1.09405e-08,1.18779e-11,30906.2,25.9187], Tmin=(100,'K'), Tmax=(949.25,'K')), NASAPolynomial(coeffs=[20.0456,0.00876177,-2.13874e-06,3.71382e-10,-2.98599e-14,25860.2,-73.5781], Tmin=(949.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(CsCJ=O) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=[C]OC[C]=O(14249)',
    structure = SMILES('[CH2]C=[C]OC[C]=O'),
    E0 = (257.793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1855,455,950,3000,3100,440,815,1455,1000,279.145,279.36,279.46],'cm^-1')),
        HinderedRotor(inertia=(0.00216139,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.458208,'amu*angstrom^2'), symmetry=1, barrier=(25.3531,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.457818,'amu*angstrom^2'), symmetry=1, barrier=(25.3549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.45772,'amu*angstrom^2'), symmetry=1, barrier=(25.3504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.945085,0.0569785,-3.68897e-05,-8.88232e-10,6.44793e-12,31124.4,27.7519], Tmin=(100,'K'), Tmax=(978.405,'K')), NASAPolynomial(coeffs=[17.2167,0.0131834,-4.59153e-06,8.46801e-10,-6.20062e-14,26852.5,-55.9533], Tmin=(978.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = 'O=[C]COC1[CH]C1(11941)',
    structure = SMILES('O=[C]COC1[CH]C1'),
    E0 = (140.784,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1855,455,950,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58109,0.0400036,8.3081e-06,-4.04404e-08,1.82505e-11,17031.2,26.5063], Tmin=(100,'K'), Tmax=(996.206,'K')), NASAPolynomial(coeffs=[14.3823,0.019606,-7.65927e-06,1.48381e-09,-1.09839e-13,12942.3,-42.9244], Tmin=(996.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJCO) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952704,0.0586577,-4.14988e-05,6.52099e-09,3.274e-12,-11131.7,24.446], Tmin=(100,'K'), Tmax=(981.023,'K')), NASAPolynomial(coeffs=[15.3906,0.0176687,-6.16449e-06,1.08736e-09,-7.57174e-14,-14824.9,-49.3171], Tmin=(981.023,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.5287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-(Cdd-O2d)OsH)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.6447,0.0593775,-2.40249e-05,-2.6224e-08,1.86254e-11,44427.4,31.6528], Tmin=(100,'K'), Tmax=(928.693,'K')), NASAPolynomial(coeffs=[21.1612,0.00802709,-8.7379e-07,7.64395e-11,-8.34029e-15,39020.4,-74.4042], Tmin=(928.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.275,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO) + radical(RCCJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C[CH]O[CH][C]=O(14254)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447871,0.0803094,-0.000103333,6.86387e-08,-1.80022e-11,43073.7,29.5538], Tmin=(100,'K'), Tmax=(934.573,'K')), NASAPolynomial(coeffs=[14.0891,0.0219278,-9.63546e-06,1.80426e-09,-1.24912e-13,40523.8,-35.3349], Tmin=(934.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07204,'amu*angstrom^2'), symmetry=1, barrier=(24.6483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07193,'amu*angstrom^2'), symmetry=1, barrier=(24.6458,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07141,'amu*angstrom^2'), symmetry=1, barrier=(24.6338,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33738,0.0453209,-1.34823e-05,-2.88295e-08,1.80918e-11,18109.4,21.5319], Tmin=(100,'K'), Tmax=(932.636,'K')), NASAPolynomial(coeffs=[19.1301,0.00275825,6.9312e-07,-1.61964e-10,6.53365e-15,13322.8,-70.9358], Tmin=(932.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CsCJ=O)"""),
)

species(
    label = '[CH]C=COC[C]=O(14256)',
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748389,0.0574921,-1.76929e-05,-2.74465e-08,1.71182e-11,28662.4,26.1573], Tmin=(100,'K'), Tmax=(954.189,'K')), NASAPolynomial(coeffs=[18.8784,0.0154181,-4.88726e-06,8.70452e-10,-6.41789e-14,23658,-68.5529], Tmin=(954.189,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(AllylJ2_triplet) + radical(CsCJ=O)"""),
)

species(
    label = 'C=[C]COC[C]=O(14257)',
    structure = SMILES('C=[C]COC[C]=O'),
    E0 = (162.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,2950,3100,1380,975,1025,1650,315.385,315.39,315.81,316.775],'cm^-1')),
        HinderedRotor(inertia=(0.00168773,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0029721,'amu*angstrom^2'), symmetry=1, barrier=(12.1596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170923,'amu*angstrom^2'), symmetry=1, barrier=(12.1535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441379,'amu*angstrom^2'), symmetry=1, barrier=(31.2022,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53825,0.0591046,-6.25723e-05,4.12974e-08,-1.20174e-11,19581.6,26.3034], Tmin=(100,'K'), Tmax=(807.495,'K')), NASAPolynomial(coeffs=[6.55038,0.0342766,-1.64518e-05,3.2203e-09,-2.28768e-13,18772.1,3.19447], Tmin=(807.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CsCJ=O)"""),
)

species(
    label = 'C=CCOC=[C][O](14258)',
...
species(
    label = '[CH]=CCOC[C]=O(14259)',
    structure = SMILES('[CH]=CCOC[C]=O'),
    E0 = (171.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,1855,455,950,345.643,346.127,4000],'cm^-1')),
        HinderedRotor(inertia=(0.362687,'amu*angstrom^2'), symmetry=1, barrier=(30.4055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120336,'amu*angstrom^2'), symmetry=1, barrier=(10.249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121429,'amu*angstrom^2'), symmetry=1, barrier=(10.2442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.372876,'amu*angstrom^2'), symmetry=1, barrier=(31.5071,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57654,0.0571988,-5.19722e-05,2.66428e-08,-5.89299e-12,20694.4,26.0884], Tmin=(100,'K'), Tmax=(1044.73,'K')), NASAPolynomial(coeffs=[8.35447,0.031248,-1.47127e-05,2.86681e-09,-2.03498e-13,19278.1,-6.90787], Tmin=(1044.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O) + radical(Cds_P)"""),
)

species(
    label = '[CH]C=COCC=O(14260)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69385,0.0571755,-8.33076e-06,-3.87173e-08,2.12576e-11,10063.2,25.6743], Tmin=(100,'K'), Tmax=(953.504,'K')), NASAPolynomial(coeffs=[19.1663,0.0175474,-5.55659e-06,9.90625e-10,-7.30235e-14,4819.2,-71.5909], Tmin=(953.504,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.5629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865457,0.0570872,-2.743e-05,-1.48369e-08,1.24968e-11,-12296.2,23.6999], Tmin=(100,'K'), Tmax=(948.5,'K')), NASAPolynomial(coeffs=[18.114,0.0132361,-3.76848e-06,6.43634e-10,-4.71764e-14,-16867.8,-65.4525], Tmin=(948.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-103.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)OsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.724e+10,'s^-1'), n=0.478, Ea=(138.753,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS_D;doublebond_intra;radadd_intra] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_CO]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 134.5 to 138.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C[CH]OC=C=O(14239)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=C=COC[C]=O(14240)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[C]=O(1736)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C=C[CH]OC=[C][O](14247)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]=COC[C]=O(14248)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C=[C]OC[C]=O(14249)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]COC=[C][O](14253)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C[CH]O[CH][C]=O(14254)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[C-]#[O+](374)', '[CH2]C=CO[CH2](6277)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[C]=O(1149)', '[CH2]C=CO[CH2](6277)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH]=COC[C]=O(4722)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH]C=COC[C]=O(14256)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]=C(64)', '[CH]OC[C]=O(4535)'],
    products = ['[CH2]C=COC[C]=O(12769)'],
