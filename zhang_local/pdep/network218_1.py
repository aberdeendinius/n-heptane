...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07622,'amu*angstrom^2'), symmetry=1, barrier=(24.7444,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51061,0.0278307,-1.78783e-05,-1.15767e-09,3.66281e-12,24707.6,15.0106], Tmin=(100,'K'), Tmax=(957.737,'K')), NASAPolynomial(coeffs=[10.5148,0.00599702,-1.84363e-06,3.22512e-10,-2.34431e-14,22642.6,-26.0356], Tmin=(957.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.23426,0.00897475,3.66757e-05,-6.19891e-08,2.8613e-11,21407.4,10.3998], Tmin=(100,'K'), Tmax=(830.474,'K')), NASAPolynomial(coeffs=[8.89371,0.00488534,2.21337e-06,-7.30137e-10,5.9059e-14,19668.4,-20.6629], Tmin=(830.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxetane) + radical(CCsJOO)"""),
)
...
This reaction matched rate rule [Cd_pri_rad;O2_birad]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['C=CO[O](585)'],
    products = ['[CH2]C1OO1(588)'],
    transitionState = 'TS2',
