...
species(
    label = '[CH]=CC(=C)O[CH2](9668)',
    structure = SMILES('[CH]=CC(=C)O[CH2]'),
    E0 = (337.816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,283.598,283.684],'cm^-1')),
        HinderedRotor(inertia=(0.319427,'amu*angstrom^2'), symmetry=1, barrier=(18.2535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.319106,'amu*angstrom^2'), symmetry=1, barrier=(18.2629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320688,'amu*angstrom^2'), symmetry=1, barrier=(18.2572,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = '[CH]=CC1(C)[CH]O1(9672)',
    structure = SMILES('[CH]=CC1(C)[CH]O1'),
    E0 = (382.234,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.212077,0.062909,-6.07256e-05,2.95377e-08,-5.18995e-12,46149.6,26.6606], Tmin=(100,'K'), Tmax=(1756.91,'K')), NASAPolynomial(coeffs=[13.3013,0.0114296,9.10455e-07,-5.60787e-10,4.77823e-14,44598.1,-37.0511], Tmin=(1756.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(CCsJO)"""),
)

species(
    label = '[CH]=[C]C1(C)CO1(9673)',
    structure = SMILES('[CH]=[C]C1(C)CO1'),
    E0 = (436.353,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,1685,370,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.555499,0.0572023,-5.40071e-05,2.71058e-08,-5.0365e-12,52621.2,24.1528], Tmin=(100,'K'), Tmax=(1621.19,'K')), NASAPolynomial(coeffs=[12.0446,0.0143695,-9.73742e-07,-2.13983e-10,2.63269e-14,50799.5,-30.9557], Tmin=(1621.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1([CH]O1)C=C(9674)',
    structure = SMILES('[CH2]C1([CH]O1)C=C'),
    E0 = (345.648,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.010989,0.0669196,-7.10139e-05,3.75572e-08,-7.20204e-12,41734.6,25.2577], Tmin=(100,'K'), Tmax=(1578.93,'K')), NASAPolynomial(coeffs=[15.2702,0.00929234,1.70153e-06,-7.32148e-10,6.17795e-14,39266.7,-47.9784], Tmin=(1578.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]=CC1([CH2])[CH]O1(9675)',
    structure = SMILES('[CH]=CC1([CH2])[CH]O1'),
    E0 = (592.744,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,2950,1000,3010,987.5,1337.5,450,1655,335.253,335.254,335.256,335.256,335.256,335.258,335.262,1514.73],'cm^-1')),
        HinderedRotor(inertia=(0.923584,'amu*angstrom^2'), symmetry=1, barrier=(73.6663,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923606,'amu*angstrom^2'), symmetry=1, barrier=(73.6663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.151849,0.0678062,-7.91248e-05,4.47374e-08,-9.12057e-12,71443.7,25.0659], Tmin=(100,'K'), Tmax=(1477.68,'K')), NASAPolynomial(coeffs=[16.0451,0.00585651,2.97387e-06,-9.70257e-10,7.89387e-14,68813.1,-50.8237], Tmin=(1477.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82033,0.0290453,5.57503e-05,-1.02384e-07,4.48916e-11,33702.8,17.0421], Tmin=(100,'K'), Tmax=(906.449,'K')), NASAPolynomial(coeffs=[16.4584,0.0140358,-1.46675e-06,4.6744e-11,-3.16946e-15,29012,-63.3769], Tmin=(906.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(2methyleneoxetane) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17055,0.0533454,-2.59069e-05,-7.72875e-09,7.87398e-12,59744.7,25.103], Tmin=(100,'K'), Tmax=(966.467,'K')), NASAPolynomial(coeffs=[13.8632,0.0211353,-7.456e-06,1.3005e-09,-8.95179e-14,56342.2,-40.6088], Tmin=(966.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=COCJ) + radical(AllylJ2_triplet) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH]C1(C=[CH])CO1(9682)',
    structure = SMILES('[CH]C1(C=[CH])CO1'),
    E0 = (646.726,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.292603,0.0584461,-5.8158e-05,2.93658e-08,-5.37633e-12,77936.7,25.6327], Tmin=(100,'K'), Tmax=(1673.33,'K')), NASAPolynomial(coeffs=[12.8773,0.0104698,8.8863e-07,-5.49217e-10,4.78096e-14,76230.1,-34.0746], Tmin=(1673.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(646.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CC1([CH2])CO1(9670)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=CC1([CH2])CO1(9310)'],
    products = ['[CH2]C1([CH]O1)C=C(9674)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]=CC1([CH2])[CH]O1(9675)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]=[C]C1([CH2])CO1(9676)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(S)(1732)', '[CH]=CC([CH2])=C(6418)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C=C([CH2])O[CH2](9679)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(28)', '[CH]C=C1CO1(5343)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH]C1(C=[CH])CO1(9682)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[C]=CC1([CH2])CO1(9683)'],
    products = ['[CH]=CC1([CH2])CO1(9310)'],
