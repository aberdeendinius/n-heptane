species(
    label = '[CH2]OO[C]([CH2])[CH2](10036)',
    structure = SMILES('[CH2]OO[C]([CH2])[CH2]'),
    E0 = (585.977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,350,500,795,815,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100],'cm^-1')),
        HinderedRotor(inertia=(0.221849,'amu*angstrom^2'), symmetry=1, barrier=(5.10075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221837,'amu*angstrom^2'), symmetry=1, barrier=(5.10047,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0291997,'amu*angstrom^2'), symmetry=1, barrier=(48.5705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1112,'amu*angstrom^2'), symmetry=1, barrier=(48.5406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0291937,'amu*angstrom^2'), symmetry=1, barrier=(48.5382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72804,0.0593177,-4.75259e-05,-2.25916e-08,4.75573e-11,70549,23.9456], Tmin=(100,'K'), Tmax=(492.864,'K')), NASAPolynomial(coeffs=[7.11156,0.0322685,-1.58536e-05,3.07888e-09,-2.15619e-13,69816.2,-0.268471], Tmin=(492.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(585.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOOC) + radical(CJCOOH) + radical(CJCOOH) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH][C]([CH2])OO[CH2](10503)',
    structure = SMILES('[CH][C]([CH2])OO[CH2]'),
    E0 = (820.23,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12699,0.0694122,-0.000105035,9.15437e-08,-3.22427e-11,98748.3,25.6706], Tmin=(100,'K'), Tmax=(790.781,'K')), NASAPolynomial(coeffs=[7.36674,0.0298971,-1.49952e-05,2.91829e-09,-2.0388e-13,98010.1,-1.39571], Tmin=(790.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(820.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOOC) + radical(CsJOOC) + radical(CJCOOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OO[C]([CH2])[CH2](10036)'],
...
reaction(
    ...
    products = ['[CH2]OO[C]([CH2])[CH2](10036)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]O[O](61)', '[CH2][C][CH2](10272)'],
    products = ['[CH2]OO[C]([CH2])[CH2](10036)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', '[CH2][C]([CH2])O[O](10040)'],
    products = ['[CH2]OO[C]([CH2])[CH2](10036)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(43.5839,'m^3/(mol*s)'), n=1.88017, Ea=(5.1666,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH][C]([CH2])OO[CH2](10503)'],
    products = ['[CH2]OO[C]([CH2])[CH2](10036)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH]OO[C]([CH2])[CH2](10504)'],
    products = ['[CH2]OO[C]([CH2])[CH2](10036)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
