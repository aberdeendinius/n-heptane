...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH2](5148)'],
    products = ['C=C(18)', 'C#C(582)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=CC=C(5156)'],
    products = ['[CH]=CC[CH2](5148)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[CH](583)', '[CH2][CH2](22)'],
    products = ['[CH]=CC[CH2](5148)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(28)', '[CH]C=C(5174)'],
    products = ['[CH]=CC[CH2](5148)'],
