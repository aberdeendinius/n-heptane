...
species(
    label = '[CH]=C(C)C(C)[O](17712)',
    structure = SMILES('[CH]=C(C)C(C)[O]'),
    E0 = (249.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,350,440,435,1725,403.219],'cm^-1')),
        HinderedRotor(inertia=(0.101732,'amu*angstrom^2'), symmetry=1, barrier=(11.7401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101737,'amu*angstrom^2'), symmetry=1, barrier=(11.7381,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12958,0.0551304,-3.56061e-05,7.81665e-09,6.60061e-13,30066.7,24.6196], Tmin=(100,'K'), Tmax=(1113.85,'K')), NASAPolynomial(coeffs=[13.1363,0.0238704,-9.47756e-06,1.7356e-09,-1.20211e-13,26656.4,-37.9023], Tmin=(1113.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23889,0.0239188,6.00432e-05,-1.0095e-07,4.4201e-11,23180.9,19.6407], Tmin=(100,'K'), Tmax=(872.55,'K')), NASAPolynomial(coeffs=[11.9856,0.0197688,-2.50011e-06,7.30962e-11,3.05962e-15,19937,-34.8942], Tmin=(872.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl) + radical(CCJ(C)CO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)C(C)=O(6520)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH3](11)', '[CH2]C(=C)C=O(17490)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](11)', '[CH2]C([CH2])=C[O](8501)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([CH2])=C(C)[O](6518)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C(=C)C(C)[O](17714)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(14)', '[CH2]C(=C)C[O](6285)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', '[CH2]C([CH2])=CC(17537)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH2(T)(28)', 'C=[C]C(C)[O](4618)'],
    products = ['[CH2]C(=C)C(C)[O](6337)'],
