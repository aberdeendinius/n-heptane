...
species(
    label = '[CH2][CH]C1OCC1O(13960)',
    structure = SMILES('[CH2][CH]C1OCC1O'),
    E0 = (76.1552,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40242,0.0449828,1.28408e-05,-5.67109e-08,2.88525e-11,9264.43,26.8922], Tmin=(100,'K'), Tmax=(879.509,'K')), NASAPolynomial(coeffs=[14.3882,0.020331,-3.79703e-06,3.80936e-10,-1.93905e-14,5649.45,-41.6546], Tmin=(879.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.1552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C=COCC=O(12649)',
    structure = SMILES('[CH2]C=COCC=O'),
    E0 = (-136.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2782.5,750,1395,475,1775,1000,244.117,244.256,244.693],'cm^-1')),
        HinderedRotor(inertia=(0.564078,'amu*angstrom^2'), symmetry=1, barrier=(23.9129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563671,'amu*angstrom^2'), symmetry=1, barrier=(23.9146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562871,'amu*angstrom^2'), symmetry=1, barrier=(23.9181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.562512,'amu*angstrom^2'), symmetry=1, barrier=(23.913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692034,0.0547749,-2.19813e-07,-5.14455e-08,2.69967e-11,-16296.3,24.8526], Tmin=(100,'K'), Tmax=(944.624,'K')), NASAPolynomial(coeffs=[21.5325,0.0113754,-2.52171e-06,4.40539e-10,-3.72128e-14,-22234.6,-85.0945], Tmin=(944.624,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-136.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Allyl_P)"""),
)

species(
    label = 'C=C[CH]OC=CO(13961)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17179,'amu*angstrom^2'), symmetry=1, barrier=(26.9418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17358,'amu*angstrom^2'), symmetry=1, barrier=(26.9829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17158,'amu*angstrom^2'), symmetry=1, barrier=(26.9368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1724,'amu*angstrom^2'), symmetry=1, barrier=(26.9557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.396412,0.0577445,5.28264e-06,-6.9531e-08,3.70733e-11,-20753.7,25.5159], Tmin=(100,'K'), Tmax=(917.552,'K')), NASAPolynomial(coeffs=[25.9224,0.00289442,2.70215e-06,-6.30966e-10,3.85586e-14,-27813.4,-108.38], Tmin=(917.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-173.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CCJ(O)C)"""),
)

species(
    label = 'C=C=COC[CH]O(13962)',
    structure = SMILES('C=C=COC[CH]O'),
    E0 = (-24.4579,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,540,610,2055,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.892754,'amu*angstrom^2'), symmetry=1, barrier=(20.5262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.891772,'amu*angstrom^2'), symmetry=1, barrier=(20.5036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.892399,'amu*angstrom^2'), symmetry=1, barrier=(20.518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.891654,'amu*angstrom^2'), symmetry=1, barrier=(20.5009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.31755,0.0844596,-9.42475e-05,5.13647e-08,-1.0695e-11,-2777.17,27.2924], Tmin=(100,'K'), Tmax=(1235.55,'K')), NASAPolynomial(coeffs=[21.1137,0.0123024,-3.27704e-06,4.61783e-10,-2.75756e-14,-7861.23,-79.777], Tmin=(1235.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.4579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.436677,0.0688973,-5.08026e-05,1.30618e-08,8.78141e-13,-363.31,27.1253], Tmin=(100,'K'), Tmax=(1035.61,'K')), NASAPolynomial(coeffs=[16.5801,0.0232319,-8.83066e-06,1.60243e-09,-1.11668e-13,-4601.84,-55.6426], Tmin=(1035.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.15573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CO[CH]CO(13964)',
    structure = SMILES('[CH2]C=CO[CH]CO'),
    E0 = (-35.9335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.998562,0.0892376,-9.3572e-05,4.66808e-08,-8.70426e-12,-4124.11,30.898], Tmin=(100,'K'), Tmax=(1492.73,'K')), NASAPolynomial(coeffs=[24.643,0.00872909,-8.15949e-07,-3.95871e-11,7.15066e-15,-10464.9,-98.6771], Tmin=(1492.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.9335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Allyl_P)"""),
)

species(
    label = 'C[C]=COC[CH]O(13965)',
    structure = SMILES('C[C]=COC[CH]O'),
    E0 = (36.7796,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0949208,0.0859496,-9.79484e-05,5.67473e-08,-1.28255e-11,4574.59,27.9136], Tmin=(100,'K'), Tmax=(1088.65,'K')), NASAPolynomial(coeffs=[17.8005,0.020196,-7.34828e-06,1.26487e-09,-8.42123e-14,678.288,-59.941], Tmin=(1088.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.7796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CCsJOH)"""),
)

species(
    label = 'CC=[C]OC[CH]O(13966)',
    structure = SMILES('CC=[C]OC[CH]O'),
    E0 = (38.682,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.319523,0.0810141,-9.24069e-05,5.5934e-08,-1.34948e-11,4784.91,29.0862], Tmin=(100,'K'), Tmax=(1010.64,'K')), NASAPolynomial(coeffs=[14.2622,0.0258307,-1.05034e-05,1.90668e-09,-1.3019e-13,1966.7,-38.3269], Tmin=(1010.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C=[C]OCCO(13967)',
    structure = SMILES('[CH2]C=[C]OCCO'),
    E0 = (9.88332,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115493,0.0753424,-7.19578e-05,3.50081e-08,-6.67091e-12,1337.07,30.5493], Tmin=(100,'K'), Tmax=(1284.37,'K')), NASAPolynomial(coeffs=[18.0715,0.0194212,-6.64838e-06,1.10875e-09,-7.2499e-14,-3275.38,-60.5719], Tmin=(1284.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.88332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Allyl_P)"""),
)

species(
    label = '[CH2][C]=COCCO(13968)',
    structure = SMILES('[CH2][C]=COCCO'),
    E0 = (7.98091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1685,370,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117685,0.0753873,-6.05644e-05,1.42155e-08,3.02321e-12,1108.71,27.8814], Tmin=(100,'K'), Tmax=(956.788,'K')), NASAPolynomial(coeffs=[19.5202,0.0172551,-5.45944e-06,9.25595e-10,-6.42061e-14,-3656.09,-70.3649], Tmin=(956.788,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.98091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(Allyl_P)"""),
)

species(
    label = 'C[CH][CH]OC=CO(13969)',
    structure = SMILES('C[CH][CH]OC=CO'),
    E0 = (-24.2504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.474509,0.0764877,-7.77242e-05,4.19568e-08,-9.13241e-12,3091.75,26.2606], Tmin=(100,'K'), Tmax=(1108.1,'K')), NASAPolynomial(coeffs=[14.0202,0.0275897,-1.15314e-05,2.13256e-09,-1.47445e-13,89.7967,-40.4799], Tmin=(1108.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = '[CH2]C=CO[CH][CH]O(13971)',
    structure = SMILES('[CH2]C=CO[CH][CH]O'),
    E0 = (144.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.882387,0.0936117,-0.000110298,6.12225e-08,-1.27337e-11,17550.7,30.018], Tmin=(100,'K'), Tmax=(1300.15,'K')), NASAPolynomial(coeffs=[24.6694,0.0066383,-3.0866e-07,-1.2245e-10,1.32103e-14,11613.2,-97.2435], Tmin=(1300.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH) + radical(Allyl_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH2][C]=COC[CH]O(13972)',
    structure = SMILES('[CH2][C]=COC[CH]O'),
    E0 = (188.279,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113557,0.0836741,-9.01674e-05,4.43966e-08,-7.2504e-12,22799,28.2607], Tmin=(100,'K'), Tmax=(954.598,'K')), NASAPolynomial(coeffs=[19.9312,0.0144148,-4.48832e-06,7.28599e-10,-4.84347e-14,18300.7,-71.0285], Tmin=(954.598,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C=[C]OC[CH]O(13973)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.15134,0.0805548,-9.11833e-05,5.23013e-08,-1.17023e-11,23015.6,29.9658], Tmin=(100,'K'), Tmax=(1099.23,'K')), NASAPolynomial(coeffs=[17.1192,0.0188102,-6.92675e-06,1.20074e-09,-8.03155e-14,19285.4,-53.4994], Tmin=(1099.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = 'O[CH]COC1[CH]C1(11913)',
    structure = SMILES('O[CH]COC1[CH]C1'),
    E0 = (73.1728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.535332,0.0663932,-5.50617e-05,2.3403e-08,-3.9595e-12,8933.58,29.6346], Tmin=(100,'K'), Tmax=(1421.53,'K')), NASAPolynomial(coeffs=[16.3148,0.0219917,-8.2092e-06,1.43012e-09,-9.51983e-14,4447.38,-52.0425], Tmin=(1421.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.1728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCsJOH) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.191549,0.072909,-5.33156e-05,6.65629e-09,5.69081e-12,-24479.5,25.9157], Tmin=(100,'K'), Tmax=(955.673,'K')), NASAPolynomial(coeffs=[19.6141,0.0169609,-5.28299e-06,9.00834e-10,-6.32735e-14,-29349.2,-72.962], Tmin=(955.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-204.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC=COCC=O(13976)',
...
species(
    label = '[CH2][CH]CO[CH][CH]O(13977)',
    structure = SMILES('[CH2][CH]CO[CH][CH]O'),
    E0 = (308.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00751574,0.0936102,-0.000137193,1.09061e-07,-3.43397e-11,37293.8,33.5975], Tmin=(100,'K'), Tmax=(843.934,'K')), NASAPolynomial(coeffs=[12.0748,0.0301181,-1.3278e-05,2.43298e-09,-1.63785e-13,35476.2,-21.3291], Tmin=(843.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C[CH]O[CH][CH]O(13978)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.53503,0.106225,-0.000166345,1.3397e-07,-4.17353e-11,34973,32.4392], Tmin=(100,'K'), Tmax=(883.793,'K')), NASAPolynomial(coeffs=[14.3832,0.0268678,-1.15663e-05,2.06124e-09,-1.3509e-13,32798.4,-35.0744], Tmin=(883.793,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCsJOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C=COC[C]O(13979)',
    structure = SMILES('[CH2]C=COC[C]O'),
    E0 = (231.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.806838,0.0853124,-9.00067e-05,4.46354e-08,-8.25465e-12,27988.8,29.4706], Tmin=(100,'K'), Tmax=(1504.39,'K')), NASAPolynomial(coeffs=[24.4516,0.00681005,-4.23454e-07,-7.52274e-11,8.26117e-15,21672.6,-98.4358], Tmin=(1504.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CH2_triplet)"""),
)

species(
    label = '[CH]C=COC[CH]O(13980)',
    structure = SMILES('[CH]C=COC[CH]O'),
    E0 = (169.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.406825,0.0852884,-8.653e-05,4.42774e-08,-8.79491e-12,20569.4,29.6705], Tmin=(100,'K'), Tmax=(1274.9,'K')), NASAPolynomial(coeffs=[20.1953,0.0187027,-5.89784e-06,9.16003e-10,-5.71913e-14,15474.4,-74.1064], Tmin=(1274.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOH) + radical(AllylJ2_triplet)"""),
)

species(
    label = 'C=[C]COC[CH]O(13981)',
    structure = SMILES('C=[C]COC[CH]O'),
    E0 = (94.4982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45385,0.0863868,-0.000131207,1.15211e-07,-4.00273e-11,11485.1,29.5422], Tmin=(100,'K'), Tmax=(841.432,'K')), NASAPolynomial(coeffs=[7.23217,0.0385109,-1.79554e-05,3.37274e-09,-2.30045e-13,10898.6,1.30377], Tmin=(841.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.4982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCsJOH)"""),
)

species(
    label = 'C=CCO[CH][CH]O(13982)',
    structure = SMILES('C=CCO[CH][CH]O'),
    E0 = (37.1124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,3615,1277.5,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205322,0.0885173,-0.000124277,9.73896e-08,-3.06674e-11,4595.44,29.4094], Tmin=(100,'K'), Tmax=(817.685,'K')), NASAPolynomial(coeffs=[11.1342,0.031751,-1.40813e-05,2.60495e-09,-1.77057e-13,2918.61,-20.4411], Tmin=(817.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.1124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CCsJOH)"""),
)

species(
    label = '[CH]=CCOC[CH]O(13983)',
    structure = SMILES('[CH]=CCOC[CH]O'),
    E0 = (103.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.429059,0.0850995,-0.000122232,1.02059e-07,-3.43601e-11,12600.8,29.562], Tmin=(100,'K'), Tmax=(821.295,'K')), NASAPolynomial(coeffs=[8.62438,0.0362479,-1.66866e-05,3.13557e-09,-2.14759e-13,11556.1,-6.5272], Tmin=(821.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Cds_P)"""),
)

species(
    label = 'C=CCOC[CH][O](13984)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.84351,0.0791288,-0.000119167,1.11919e-07,-4.17367e-11,10010.1,28.5291], Tmin=(100,'K'), Tmax=(826.637,'K')), NASAPolynomial(coeffs=[3.63092,0.045601,-2.19643e-05,4.19948e-09,-2.89895e-13,10233.9,19.7536], Tmin=(826.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.3616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(CCOJ)"""),
)

species(
    label = '[CH]C=COCCO(13985)',
    structure = SMILES('[CH]C=COCCO'),
    E0 = (-10.6756,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147691,0.0732413,-4.40484e-05,-2.16944e-09,8.21379e-12,-1134.94,28.1283], Tmin=(100,'K'), Tmax=(962.734,'K')), NASAPolynomial(coeffs=[18.3649,0.0238913,-8.19636e-06,1.42193e-09,-9.82985e-14,-5863.23,-65.4066], Tmin=(962.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.6756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C=COC[CH]O(12787)'],
    products = ['[CH2][CH]C1OCC1O(13960)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(966131,'s^-1'), n=1.86605, Ea=(125.718,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Exocyclic
Ea raised from 121.0 to 125.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C=COCC=O(12649)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=C[CH]OC=CO(13961)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C=C=COC[CH]O(13962)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=CO[CH]CO(13964)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction16',
    reactants = ['[O]C[CH]O(561)', '[CH]C=C(8168)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C=COC[CH][O](12641)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]C=CO[CH][CH]O(13971)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2][C]=COC[CH]O(13972)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2]C=[C]OC[CH]O(13973)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C=COC[CH]O(12787)'],
    products = ['O[CH]COC1[CH]C1(11913)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][CH]CO[CH][CH]O(13977)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH]O[CH][CH]O(13978)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction30',
    reactants = ['OH(D)(132)', '[CH]COC=C[CH2](12953)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]O(5471)', '[CH2]C=CO[CH2](6277)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(T)(28)', '[CH]=COC[CH]O(5835)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH2]C=COC[C]O(13979)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH]C=COC[CH]O(13980)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=C(64)', '[CH]OC[CH]O(5693)'],
    products = ['[CH2]C=COC[CH]O(12787)'],
