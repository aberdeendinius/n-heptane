...
species(
    label = '[CH]C(=O)O[O](5487)',
    structure = SMILES('[CH]C(=O)O[O]'),
    E0 = (196.85,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,590.096,590.101,590.101,590.106,590.111,590.115,590.119],'cm^-1')),
        HinderedRotor(inertia=(0.000484107,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000484123,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75129,0.0181677,1.29518e-05,-3.60576e-08,1.67521e-11,23729.1,17.8445], Tmin=(100,'K'), Tmax=(937.757,'K')), NASAPolynomial(coeffs=[11.879,0.00278596,-1.17518e-07,1.62833e-11,-5.03745e-15,20981.6,-31.1264], Tmin=(937.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(C(=O)OOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C=C=O(598)'],
    products = ['[CH2]C(=O)O[O](1169)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(=O)O[O](1169)'],
    products = ['[O]O[C]1CO1(1781)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.06515e+11,'s^-1'), n=0.446259, Ea=(202.448,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra_cs2H] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=O)O[O](1169)'],
    products = ['C=C=O(598)', 'O2(S)(5486)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(66.0626,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.03419e+08,'s^-1'), n=1.06803, Ea=(260.747,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra;radadd_intra] for rate rule [R4_S_D;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
Ea raised from 260.6 to 260.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)O[O](1169)'],
    products = ['O(T)(63)', 'C=C1OO1(1180)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(2.30161e+09,'s^-1'), n=1.08, Ea=(472.429,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2OO_S;Y_rad_intra;OOJ]
Euclidian distance = 0
family: Cyclic_Ether_Formation"""),
)
