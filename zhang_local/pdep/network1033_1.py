...
reaction(
    label = 'reaction2',
    reactants = ['C=CO[C]=O(3002)', 'H(8)'],
    products = ['[CH2]CO[C]=O(2955)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2]CO[C]=O(2955)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(46.7986,'m^3/(mol*s)'), n=2.021, Ea=(90.9436,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond
Ea raised from 88.1 to 90.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['[CH2]CO[C]=O(2955)'],
    products = ['C[CH]O[C]=O(3053)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', '[CH2][CH]O[C]=O(3054)'],
    products = ['[CH2]CO[C]=O(2955)'],
    transitionState = 'TS7',
