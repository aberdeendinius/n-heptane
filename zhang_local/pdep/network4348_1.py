...
species(
    label = '[CH]C(=[CH])C(=C)CC(21308)',
    structure = SMILES('[CH]C(=[CH])C(=C)CC'),
    E0 = (613.875,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,325,375,415,465,420,450,1700,1750,2750,2800,2850,1350,1500,750,1050,1375,1000,232.66,232.935,232.936,233.035],'cm^-1')),
        HinderedRotor(inertia=(1.28728,'amu*angstrom^2'), symmetry=1, barrier=(49.5152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28495,'amu*angstrom^2'), symmetry=1, barrier=(49.5182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.287,'amu*angstrom^2'), symmetry=1, barrier=(49.5169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.28478,'amu*angstrom^2'), symmetry=1, barrier=(49.5146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.23079,0.0727309,-4.4019e-05,4.60742e-09,3.76351e-12,73976.7,26.4566], Tmin=(100,'K'), Tmax=(1021.44,'K')), NASAPolynomial(coeffs=[15.6391,0.0316424,-1.19507e-05,2.12891e-09,-1.45993e-13,69824.7,-53.1223], Tmin=(1021.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(613.875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C([CH])=C(C)CC(21309)',
    structure = SMILES('[CH]C([CH])=C(C)CC'),
    E0 = (610.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,325,375,415,465,420,450,1700,1750,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444747,0.0741149,-4.38054e-05,1.3084e-08,-1.63398e-12,73582.3,28.377], Tmin=(100,'K'), Tmax=(1744.74,'K')), NASAPolynomial(coeffs=[13.6997,0.0437269,-1.76802e-05,3.10161e-09,-2.03633e-13,68957,-42.9481], Tmin=(1744.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(610.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])C(C)[CH]C(21310)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605699,0.0696106,-4.39612e-05,1.41261e-08,-1.88299e-12,84965.6,30.6423], Tmin=(100,'K'), Tmax=(1675.87,'K')), NASAPolynomial(coeffs=[14.0434,0.0375375,-1.52543e-05,2.70646e-09,-1.79472e-13,80461.6,-41.1254], Tmin=(1675.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(705.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.244597,0.0739314,-5.10453e-05,1.83866e-08,-2.72777e-12,86269.4,31.1751], Tmin=(100,'K'), Tmax=(1555.46,'K')), NASAPolynomial(coeffs=[15.2859,0.0352515,-1.37448e-05,2.39975e-09,-1.5832e-13,81590.1,-48.0354], Tmin=(1555.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(716.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]C([CH])=C([CH2])CC(21312)',
    structure = SMILES('[CH]C([CH])=C([CH2])CC'),
    E0 = (762.211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,325,375,415,465,420,450,1700,1750,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0590408,0.0758663,-4.8937e-05,1.61717e-08,-2.19837e-12,91823.6,30.0646], Tmin=(100,'K'), Tmax=(1681.08,'K')), NASAPolynomial(coeffs=[16.342,0.0371221,-1.43661e-05,2.46185e-09,-1.59514e-13,86349,-56.9491], Tmin=(1681.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(762.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])C([CH2])[CH]C(21313)',
    structure = SMILES('[CH]C(=[CH])C([CH2])[CH]C'),
    E0 = (910.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.767245,0.069736,-5.17393e-05,2.1671e-08,-3.9054e-12,109623,31.8372], Tmin=(100,'K'), Tmax=(1265.55,'K')), NASAPolynomial(coeffs=[10.2851,0.0396533,-1.60837e-05,2.88845e-09,-1.95057e-13,107214,-16.3223], Tmin=(1265.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(910.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=[CH])C([CH2])C[CH2](21314)',
    structure = SMILES('[CH]C(=[CH])C([CH2])C[CH2]'),
    E0 = (921.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3120,650,792.5,1650,350,440,435,1725,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.41691,0.0739872,-5.87566e-05,2.5972e-08,-4.78831e-12,110926,32.3262], Tmin=(100,'K'), Tmax=(1273.51,'K')), NASAPolynomial(coeffs=[12.5951,0.0357366,-1.37035e-05,2.38733e-09,-1.58451e-13,107824,-29.3707], Tmin=(1273.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(921.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (649.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C(=[CH])C([CH])CC(21317)',
    structure = SMILES('[CH]C(=[CH])C([CH])CC'),
    E0 = (959.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235891,0.0754037,-5.7622e-05,2.32545e-08,-3.8514e-12,115491,30.417], Tmin=(100,'K'), Tmax=(1415.23,'K')), NASAPolynomial(coeffs=[15.06,0.0335046,-1.32131e-05,2.33487e-09,-1.55936e-13,111295,-46.249], Tmin=(1415.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(959.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]C(=[CH])C([CH2])CC(21318)',
    structure = SMILES('[C]C(=[CH])C([CH2])CC'),
    E0 = (1014.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,347.174,347.185],'cm^-1')),
        HinderedRotor(inertia=(0.00139867,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114387,'amu*angstrom^2'), symmetry=1, barrier=(9.78296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114374,'amu*angstrom^2'), symmetry=1, barrier=(9.78284,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289875,'amu*angstrom^2'), symmetry=1, barrier=(24.7913,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.275298,0.0760545,-7.09683e-05,3.5491e-08,-7.12008e-12,122183,29.0857], Tmin=(100,'K'), Tmax=(1205.8,'K')), NASAPolynomial(coeffs=[15.0911,0.0269065,-9.82924e-06,1.68844e-09,-1.11807e-13,118610,-45.1646], Tmin=(1205.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1014.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(CJ3) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]C(=[CH])C(=C)CC(21308)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC([CH2])CC(5221)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH2](6)', '[CH]C(=[CH])C=C(19261)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C([CH])=C(C)CC(21309)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    products = ['[CH]C(=[CH])C(C)[CH]C(21310)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    products = ['[CH]C([CH2])=C([CH2])CC(18981)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    products = ['[CH]C(=C)C([CH2])[CH]C(18982)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=[CH])C(C)C[CH2](21311)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(=[CH])C([CH2])CC(18984)'],
    products = ['[CH]C(=C)C([CH2])C[CH2](18983)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH2](6)', '[CH]C([CH])=C[CH2](21258)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]C([CH])=C([CH2])CC(21312)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH3](11)', '[CH]C(=[CH])C([CH2])[CH2](19200)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C(=[CH])C([CH2])[CH]C(21313)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C(=[CH])C([CH2])C[CH2](21314)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(S)(14)', '[CH]C(=[CH])C([CH2])C(18883)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(28)', '[CH]C([CH])=CCC(21273)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]C(=[CH])C([CH])CC(21317)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[C]C(=[CH])C([CH2])CC(21318)'],
    products = ['[CH]C(=[CH])C([CH2])CC(18984)'],
