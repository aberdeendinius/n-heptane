...
species(
    label = '[CH2]C([CH2])C=C1CO1(9937)',
    structure = SMILES('[CH2]C([CH2])C=C1CO1'),
    E0 = (344.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,3150,900,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03474,0.0494483,1.05009e-05,-6.11811e-08,3.14646e-11,41498.4,25.706], Tmin=(100,'K'), Tmax=(901.974,'K')), NASAPolynomial(coeffs=[18.5759,0.0141966,-1.61668e-06,6.18893e-11,-2.3961e-15,36603.7,-66.7021], Tmin=(901.974,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CC1=CO1(9938)',
    structure = SMILES('[CH2]C([CH2])CC1=CO1'),
    E0 = (548.786,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.993953,0.0701595,-7.25725e-05,3.85726e-08,-5.51123e-12,66108.4,28.4438], Tmin=(100,'K'), Tmax=(684.76,'K')), NASAPolynomial(coeffs=[9.09215,0.0329616,-1.32293e-05,2.35316e-09,-1.57592e-13,64762.3,-9.28894], Tmin=(684.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(oxirene) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])[CH]C1CO1(9939)',
    structure = SMILES('[CH2]C([CH2])[CH]C1CO1'),
    E0 = (429.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2950,3150,900,1000,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.154967,0.070075,-5.99404e-05,2.8832e-08,-5.26204e-12,51837,33.493], Tmin=(100,'K'), Tmax=(1630.82,'K')), NASAPolynomial(coeffs=[12.3408,0.024251,-3.83439e-06,1.90425e-10,3.32363e-15,49779.3,-26.7163], Tmin=(1630.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2][C]([CH2])CC1CO1(9941)',
    structure = SMILES('[CH2][C]([CH2])CC1CO1'),
    E0 = (415.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3956,0.0614671,-3.05219e-05,-3.25179e-08,3.76712e-11,50017.6,26.6587], Tmin=(100,'K'), Tmax=(606.838,'K')), NASAPolynomial(coeffs=[9.25295,0.0310515,-8.17857e-06,9.84129e-10,-4.49184e-14,48670.4,-10.5668], Tmin=(606.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(Isobutyl) + radical(Tertalkyl)"""),
)
...
species(
    label = '[CH2]C([CH2])[CH][C]1CO1(9943)',
    structure = SMILES('[CH2]C([CH2])[CH][C]1CO1'),
    E0 = (609.706,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,3150,900,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526399,0.0683563,-6.84013e-05,3.95342e-08,-8.76283e-12,73462.7,32.1434], Tmin=(100,'K'), Tmax=(1316.37,'K')), NASAPolynomial(coeffs=[10.9849,0.0245479,-4.77516e-06,3.69562e-10,-6.50637e-15,71751.4,-17.229], Tmin=(1316.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(609.706,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Isobutyl) + radical(CCJCO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C[C]1[CH]O1(9944)',
    structure = SMILES('[CH2]C([CH2])C[C]1[CH]O1'),
    E0 = (593.526,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180341,0.0765696,-8.43959e-05,5.1114e-08,-1.17164e-11,71528.8,31.0906], Tmin=(100,'K'), Tmax=(1269.35,'K')), NASAPolynomial(coeffs=[13.0514,0.0221725,-3.76265e-06,1.77185e-10,7.0693e-15,69376,-29.6833], Tmin=(1269.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(593.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(C2CsJO) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = 'C1O[C]1CC1CC1(9947)',
    structure = SMILES('C1O[C]1CC1CC1'),
    E0 = (158.888,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45614,0.0424087,2.68939e-05,-7.02369e-08,3.29894e-11,19214.2,23.0138], Tmin=(100,'K'), Tmax=(890.009,'K')), NASAPolynomial(coeffs=[13.6173,0.024704,-5.54423e-06,7.10184e-10,-4.29123e-14,15586,-42.4614], Tmin=(890.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(C2CsJO)"""),
)
...
species(
    label = '[CH]C([CH2])C[C]1CO1(9948)',
    structure = SMILES('[CH]C([CH2])C[C]1CO1'),
    E0 = (652.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,3150,900,1100,180,1048.69,1048.69,1048.69,1048.69,1048.69,1048.69,1048.69,1048.69,1048.69,1048.69,2328.26],'cm^-1')),
        HinderedRotor(inertia=(0.0780137,'amu*angstrom^2'), symmetry=1, barrier=(1.79369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0780137,'amu*angstrom^2'), symmetry=1, barrier=(1.79369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0780137,'amu*angstrom^2'), symmetry=1, barrier=(1.79369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0780137,'amu*angstrom^2'), symmetry=1, barrier=(1.79369,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437953,0.0727813,-7.61191e-05,4.53883e-08,-1.05304e-11,78663.2,29.8854], Tmin=(100,'K'), Tmax=(1212.57,'K')), NASAPolynomial(coeffs=[11.9954,0.025471,-6.23229e-06,7.17964e-10,-3.2639e-14,76535.6,-25.3159], Tmin=(1212.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(652.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(C2CsJO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=C)C[C]1CO1(9936)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([CH2])C=C1CO1(9937)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C([CH2])CC1=CO1(9938)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', 'C=CC[C]1CO1(9228)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    products = ['[CH2][C](C)C[C]1CO1(9410)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])[CH]C1CO1(9939)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])CC1[CH]O1(9940)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    products = ['[CH2]C(C)[CH][C]1CO1(9411)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([CH2])CC1CO1(9941)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])C[C]1CO1(9326)'],
    products = ['[CH2]C(C)C[C]1[CH]O1(9412)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]([CH2])C[C]1CO1(9942)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C([CH2])[CH][C]1CO1(9943)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2]C([CH2])C[C]1[CH]O1(9944)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])CC(=C)[O](9945)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[C]1CO1(1125)', '[CH2]C([CH2])[CH2](6116)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C([CH2])C[C]1CO1(9948)'],
    products = ['[CH2]C([CH2])C[C]1CO1(9326)'],
