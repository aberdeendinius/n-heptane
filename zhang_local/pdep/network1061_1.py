...
reaction(
    label = 'reaction4',
    reactants = ['[O]C=O(2908)'],
    products = ['[CH]1OO1(7989)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(2.29014e+11,'s^-1'), n=0.514092, Ea=(343.004,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_H;radadd_intra_O]
...
reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', '[CH]=O(373)'],
    products = ['[O]C=O(2908)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(93609.6,'m^3/(mol*s)'), n=1.13083, Ea=(163.847,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [CO_pri_rad;O_birad]
