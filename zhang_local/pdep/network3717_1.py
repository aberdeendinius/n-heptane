...
species(
    label = '[CH]=C(C)C[O](17685)',
    structure = SMILES('[CH]=C(C)C[O]'),
    E0 = (286.734,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,2134.34],'cm^-1')),
        HinderedRotor(inertia=(0.31497,'amu*angstrom^2'), symmetry=1, barrier=(7.24179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.314398,'amu*angstrom^2'), symmetry=1, barrier=(7.22864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.49004,0.0298513,-1.32212e-05,2.25156e-09,-1.23272e-13,34484.7,14.6565], Tmin=(100,'K'), Tmax=(2860.36,'K')), NASAPolynomial(coeffs=[30.1488,-0.00101419,-3.98962e-07,4.7117e-11,8.73086e-16,16609.8,-146.561], Tmin=(2860.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCOJ)"""),
)

species(
    label = '[CH]C(=C)CO(17686)',
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.96236,0.0103816,6.65278e-05,-9.95707e-08,4.2878e-11,27533.4,15.1466], Tmin=(100,'K'), Tmax=(853.51,'K')), NASAPolynomial(coeffs=[9.48299,0.0141011,-2.51892e-07,-3.54806e-10,3.40764e-14,25171.7,-22.5931], Tmin=(853.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C)C=O(17689)',
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4136,0.0342004,-1.65801e-05,2.55563e-09,4.05034e-14,-14938.2,15.5119], Tmin=(100,'K'), Tmax=(1804.45,'K')), NASAPolynomial(coeffs=[12.9922,0.0174459,-8.21847e-06,1.52272e-09,-1.01291e-13,-19845.9,-44.7886], Tmin=(1804.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)H) + group(Cds-CdsHH)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.33596e+11,'s^-1'), n=-0.0500183, Ea=(88.2387,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra] for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_O]
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)C=O(17490)'],
    products = ['[CH2]C(=C)C[O](6285)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][O](357)', 'C=C=C(6077)'],
    products = ['[CH2]C(=C)C[O](6285)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C([CH2])=C[O](8501)'],
    products = ['[CH2]C(=C)C[O](6285)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C(=C)C[O](17687)'],
    products = ['[CH2]C(=C)C[O](6285)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(T)(63)', '[CH2]C([CH2])=C(17478)'],
    products = ['[CH2]C(=C)C[O](6285)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(280829,'m^3/(mol*s)'), n=1.13083, Ea=(163.847,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H2/Cd;O_birad]
