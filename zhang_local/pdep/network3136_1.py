...
species(
    label = '[CH2]C([CH2])([O])OC1=CC1(12318)',
    structure = SMILES('[CH2]C([CH2])([O])OC1=CC1'),
    E0 = (445.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20733,0.100444,-0.000115561,6.30241e-08,-1.29876e-11,53798.8,30.776], Tmin=(100,'K'), Tmax=(1274.78,'K')), NASAPolynomial(coeffs=[26.1365,0.00920975,-1.81285e-06,1.93065e-10,-9.80657e-15,47268.9,-106.048], Tmin=(1274.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CC(C)(O)OJ) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C([CH2])(O)O[C]1[CH]C1(12320)',
    structure = SMILES('[CH2]C([CH2])(O)O[C]1[CH]C1'),
    E0 = (407.928,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.47457,0.105081,-0.000123217,6.84593e-08,-1.42627e-11,49272.7,35.7592], Tmin=(100,'K'), Tmax=(1299.73,'K')), NASAPolynomial(coeffs=[26.8717,0.00830598,-5.24025e-07,-1.18849e-10,1.40775e-14,42709.8,-105.327], Tmin=(1299.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C(C)([O])O[C]1[CH]C1(12321)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.110984,0.0822901,-8.11689e-05,4.1622e-08,-8.54024e-12,51788.7,32.2841], Tmin=(100,'K'), Tmax=(1176.71,'K')), NASAPolynomial(coeffs=[16.2037,0.0275855,-1.14339e-05,2.1132e-09,-1.46234e-13,48001.4,-47.9724], Tmin=(1176.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(CCJCO) + radical(C2CsJOCs) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])O[C]1[CH]C1(12322)',
    structure = SMILES('[CH2]C([CH2])([O])O[C]1[CH]C1'),
    E0 = (639.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145919,0.0938333,-0.000120003,7.99164e-08,-2.10648e-11,77111.4,32.2732], Tmin=(100,'K'), Tmax=(929.346,'K')), NASAPolynomial(coeffs=[15.4556,0.0266825,-1.16186e-05,2.16675e-09,-1.49628e-13,74211.6,-41.8519], Tmin=(929.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(639.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C(=C)OC([CH2])([CH2])[O](10253)',
    structure = SMILES('[CH2]C(=C)OC([CH2])([CH2])[O]'),
    E0 = (336.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,180,180,328.493,804.082,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.152425,'amu*angstrom^2'), symmetry=1, barrier=(3.50455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152425,'amu*angstrom^2'), symmetry=1, barrier=(3.50455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152425,'amu*angstrom^2'), symmetry=1, barrier=(3.50455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152425,'amu*angstrom^2'), symmetry=1, barrier=(3.50455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152425,'amu*angstrom^2'), symmetry=1, barrier=(3.50455,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.20537,0.108168,-0.000131389,7.65474e-08,-1.67354e-11,40609.1,31.175], Tmin=(100,'K'), Tmax=(974.605,'K')), NASAPolynomial(coeffs=[23.7651,0.0158592,-4.9795e-06,7.91592e-10,-5.1011e-14,35258.6,-91.1302], Tmin=(974.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CC(C)(O)OJ) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH2]C([CH2])(O)OC1=CC1(12323)',
    structure = SMILES('[CH2]C([CH2])(O)OC1=CC1'),
    E0 = (213.659,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.95349,0.116234,-0.000133109,6.83398e-08,-1.26816e-11,25979.2,35.7882], Tmin=(100,'K'), Tmax=(1577.06,'K')), NASAPolynomial(coeffs=[33.376,-0.00300328,6.07046e-06,-1.38815e-09,9.86277e-14,17889.5,-145.349], Tmin=(1577.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C(C)([O])OC1=CC1(12324)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458184,0.0830195,-5.5908e-05,-2.41181e-09,1.10981e-11,28454.9,29.0274], Tmin=(100,'K'), Tmax=(953.547,'K')), NASAPolynomial(coeffs=[24.5115,0.014128,-3.9359e-06,6.83333e-10,-5.14382e-14,22063,-98.7959], Tmin=(953.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CJC(C)OC) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4227.64,'J/mol'), sigma=(7.2618,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=660.35 K, Pc=25.05 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH]C([CH2])([O])O[C]1CC1(12325)',
    structure = SMILES('[CH]C([CH2])([O])O[C]1CC1'),
    E0 = (677.721,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0177064,0.0886679,-0.000102393,6.15204e-08,-1.47274e-11,81653.6,30.4397], Tmin=(100,'K'), Tmax=(1016.69,'K')), NASAPolynomial(coeffs=[15.5841,0.027425,-1.20381e-05,2.27307e-09,-1.58843e-13,78488.4,-44.9171], Tmin=(1016.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(677.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([CH2])([O])OC1=CC1(12318)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', '[CH2]C(=O)O[C]1CC1(11554)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(=C)O[C]1CC1(11848)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([CH2])([O])OC1[CH]C1(12319)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    products = ['[CH2]C([CH2])(O)O[C]1[CH]C1(12320)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    products = ['[CH2]C(C)([O])O[C]1[CH]C1(12321)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.048e+06,'s^-1'), n=1.62, Ea=(46.4424,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5Hall;C_rad_out_2H;Cs_H_out_H/NonDeC] for rate rule [R5HJ_3;C_rad_out_2H;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2]C([CH2])([O])O[C]1[CH]C1(12322)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(=C)OC([CH2])([CH2])[O](10253)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    products = ['[CH2]C([CH2])(O)OC1=CC1(12323)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
    products = ['[CH2]C(C)([O])OC1=CC1(12324)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])([O])[O](2328)', '[C]1CC1(11616)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(28)', '[CH2][C]([O])O[C]1CC1(10727)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]C([CH2])([O])O[C]1CC1(12325)'],
    products = ['[CH2]C([CH2])([O])O[C]1CC1(11597)'],
