...
species(
    label = 'CC1OCC1[CH][O](13639)',
    structure = SMILES('CC1OCC1[CH][O]'),
    E0 = (80.6112,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
...
species(
    label = 'C[CH]OCC=C=O(13640)',
    structure = SMILES('C[CH]OCC=C=O'),
    E0 = (-73.8721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,318.05,318.104,318.107,318.253],'cm^-1')),
        HinderedRotor(inertia=(0.189759,'amu*angstrom^2'), symmetry=1, barrier=(13.6276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142519,'amu*angstrom^2'), symmetry=1, barrier=(10.2396,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142727,'amu*angstrom^2'), symmetry=1, barrier=(10.2384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142551,'amu*angstrom^2'), symmetry=1, barrier=(10.2409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.450282,0.0826965,-0.000115422,9.02332e-08,-2.83356e-11,-8761.33,25.3045], Tmin=(100,'K'), Tmax=(826.782,'K')), NASAPolynomial(coeffs=[10.5889,0.0299864,-1.31542e-05,2.41766e-09,-1.63627e-13,-10312.8,-20.9239], Tmin=(826.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.8721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.387065,0.0708934,-6.25347e-05,2.83398e-08,-5.10431e-12,-2214.69,28.9647], Tmin=(100,'K'), Tmax=(1340.76,'K')), NASAPolynomial(coeffs=[16.555,0.0226587,-8.57185e-06,1.50812e-09,-1.01284e-13,-6550.2,-53.7775], Tmin=(1340.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.5549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO) + radical(C=COJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752073,0.0631996,-4.66276e-05,1.74988e-08,-2.65385e-12,-14333.6,27.9646], Tmin=(100,'K'), Tmax=(1547.63,'K')), NASAPolynomial(coeffs=[15.2741,0.0256658,-1.02487e-05,1.82789e-09,-1.22395e-13,-18828.5,-48.4378], Tmin=(1547.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CCJ(O)C) + radical(C=COJ)"""),
)
...
species(
    label = 'CCOC[CH][C]=O(13647)',
    structure = SMILES('CCOC[CH][C]=O'),
    E0 = (-20.0899,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46184,0.0638611,-5.10487e-05,-1.60559e-09,2.36761e-11,-2332.68,27.782], Tmin=(100,'K'), Tmax=(536.769,'K')), NASAPolynomial(coeffs=[6.6449,0.0385912,-1.77503e-05,3.3871e-09,-2.36353e-13,-3081.48,4.20953], Tmin=(536.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.0899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCCJ=O) + radical(CCJCO)"""),
)
...
species(
    label = 'CCOCC=C=O(13653)',
    structure = SMILES('CCOCC=C=O'),
    E0 = (-254.328,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.822527,0.074815,-9.31596e-05,7.25558e-08,-2.38643e-11,-30478.8,24.525], Tmin=(100,'K'), Tmax=(770.305,'K')), NASAPolynomial(coeffs=[7.54128,0.0378423,-1.71056e-05,3.22229e-09,-2.22533e-13,-31452.1,-5.73438], Tmin=(770.305,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-254.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH)"""),
)
...
species(
    label = 'C[CH]O[CH]C[CH][O](13655)',
    structure = SMILES('C[CH]O[CH]C[CH][O]'),
    E0 = (309.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.211757,0.102772,-0.000168328,1.47089e-07,-4.95927e-11,37418.5,30.3525], Tmin=(100,'K'), Tmax=(868.166,'K')), NASAPolynomial(coeffs=[9.86275,0.0356422,-1.65571e-05,3.06434e-09,-2.05606e-13,36449.8,-12.3315], Tmin=(868.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C[C]OCC=C[O](13658)',
    structure = SMILES('C[C]OCC=C[O]'),
    E0 = (229.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.331749,0.0715779,-6.76188e-05,3.19027e-08,-5.89655e-12,27783.6,27.2621], Tmin=(100,'K'), Tmax=(1318.87,'K')), NASAPolynomial(coeffs=[17.9167,0.0182441,-6.96008e-06,1.2406e-09,-8.43363e-14,23145.2,-62.4424], Tmin=(1318.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CH2_triplet) + radical(C=COJ)"""),
)

species(
    label = 'C[CH]OC=CC=O(13659)',
    structure = SMILES('C[CH]OC=CC=O'),
    E0 = (-115.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.870308,'amu*angstrom^2'), symmetry=1, barrier=(20.0101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.869777,'amu*angstrom^2'), symmetry=1, barrier=(19.9979,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870879,'amu*angstrom^2'), symmetry=1, barrier=(20.0232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870802,'amu*angstrom^2'), symmetry=1, barrier=(20.0214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0818785,0.0752607,-6.60279e-05,2.24698e-08,-1.10552e-12,-13688.9,25.2994], Tmin=(100,'K'), Tmax=(1042.9,'K')), NASAPolynomial(coeffs=[20.6245,0.0150111,-6.03833e-06,1.16859e-09,-8.56285e-14,-18982,-79.5038], Tmin=(1042.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cd-Cd(CO)H) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H) + radical(CCsJOC(O))"""),
)
...
species(
    ...
    E0 = (-19.0405,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,2782.5,750,1395,475,1775,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438232,0.0839869,-0.00011708,9.46362e-08,-3.10023e-11,-4632.21,28.3131], Tmin=(100,'K'), Tmax=(817.354,'K')), NASAPolynomial(coeffs=[9.27625,0.0347282,-1.56569e-05,2.9201e-09,-1.99426e-13,-5876.32,-11.3153], Tmin=(817.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.5359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2][CH]OCCC=O(13660)',
    structure = SMILES('[CH2][CH]OCCC=O'),
    E0 = (12.0926,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.360038,0.0862057,-0.000121842,9.97846e-08,-3.31601e-11,1579.6,28.4086], Tmin=(100,'K'), Tmax=(806.98,'K')), NASAPolynomial(coeffs=[9.2435,0.0358674,-1.6554e-05,3.12123e-09,-2.14532e-13,351.146,-11.2719], Tmin=(806.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.0926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJCO) + radical(CCsJOCs)"""),
)
...
species(
    label = 'CCOC=CC=O(13662)',
    structure = SMILES('CCOC=CC=O'),
    E0 = (-308.995,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45763,0.0657472,-3.86549e-05,-9.41234e-10,5.70994e-12,-37025.4,24.4782], Tmin=(100,'K'), Tmax=(1043.58,'K')), NASAPolynomial(coeffs=[18.2063,0.021355,-8.82337e-06,1.70658e-09,-1.24041e-13,-42017,-68.0729], Tmin=(1043.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-308.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cd-Cd(CO)H) + group(Cds-CdsOsH) + group(Cds-O2d(Cds-Cds)H)"""),
)

species(
    label = 'C=COCCC=O(12781)',
    structure = SMILES('C=COCCC=O'),
    E0 = (-292.087,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540898,0.0652397,-3.92599e-05,-8.65504e-10,6.37808e-12,-34995.8,25.3759], Tmin=(100,'K'), Tmax=(992.575,'K')), NASAPolynomial(coeffs=[17.1864,0.0212637,-7.71769e-06,1.3999e-09,-9.90752e-14,-39438.2,-60.5379], Tmin=(992.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-292.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C[CH]OCC=C[O](12752)'],
    products = ['CC1OCC1[CH][O](13639)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(966131,'s^-1'), n=1.86605, Ea=(131.299,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_csHNd] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 1.41421356237
family: Intra_R_Add_Exocyclic
Ea raised from 129.1 to 131.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=COCC=C[O](12638)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C[CH]OCC=C=O(13640)'],
    products = ['C[CH]OCC=C[O](12752)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[CH]C(415)', '[CH]=C[O](602)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', 'C[CH]O[CH]C=C[O](13649)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][CH]OCC=C[O](12654)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'C[CH]OC[CH][C]=O(13651)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.64e+06,'s^-1'), n=1.15, Ea=(73.4952,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra_pri;radadd_intra_csHCs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 68.1 to 73.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction22',
    reactants = ['C[CH]OCC=C[O](12752)'],
    products = ['CCOCC=C=O(13653)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]O[CH]C[CH][O](13655)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[O]C=CC[O](1048)', '[CH]C(32)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH3](11)', '[CH]OCC=C[O](13521)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH]=CCO[CH]C(13657)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', 'C[C]OCC=C[O](13658)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', 'C[CH]OC=CC=O(13659)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C[CH]O[CH]CC=O(13614)'],
    products = ['C[CH]OCC=C[O](12752)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=O(373)', '[CH]CO[CH]C(3668)'],
    products = ['C[CH]OCC=C[O](12752)'],
