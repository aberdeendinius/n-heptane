...
species(
    ...
    E0 = (-98.3388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C(O)C(=C)OO(5977)',
    structure = SMILES('[CH2]C(O)C(=C)OO'),
    E0 = (-67.8031,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,293.158],'cm^-1')),
        HinderedRotor(inertia=(0.00196136,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00196186,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240993,'amu*angstrom^2'), symmetry=1, barrier=(14.6942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241032,'amu*angstrom^2'), symmetry=1, barrier=(14.6943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240931,'amu*angstrom^2'), symmetry=1, barrier=(14.6943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.37489,0.110852,-0.000136849,7.43316e-08,-1.36123e-11,-3134.46,36.2561], Tmin=(100,'K'), Tmax=(918.677,'K')), NASAPolynomial(coeffs=[27.111,0.0072783,-1.13607e-06,8.5963e-11,-3.79249e-15,-9231.55,-103.454], Tmin=(918.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.7274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJCOOH) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C](O)C(C)([O])OO(5979)',
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.451008,0.102439,-0.000139956,9.86031e-08,-2.74478e-11,-1010.33,32.2262], Tmin=(100,'K'), Tmax=(881.281,'K')), NASAPolynomial(coeffs=[16.0029,0.0277574,-1.28433e-05,2.44629e-09,-1.70324e-13,-3910.46,-45.0753], Tmin=(881.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.69975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(C2CsJOH) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C(O)C([CH2])(O)O[O](5980)',
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.49921,0.105008,-0.000127584,7.19671e-08,-1.50847e-11,-6084.57,38.0302], Tmin=(100,'K'), Tmax=(1311.68,'K')), NASAPolynomial(coeffs=[27.6739,0.00415652,1.34034e-06,-4.68371e-10,3.79844e-14,-12715.1,-106.73], Tmin=(1311.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-52.3506,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCO) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(O)C(C)([O])O[O](5981)',
    structure = SMILES('[CH2]C(O)C(C)([O])O[O]'),
    E0 = (-34.3229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0671924,0.0905918,-0.000109615,6.87002e-08,-1.70413e-11,-3982.52,32.178], Tmin=(100,'K'), Tmax=(985.859,'K')), NASAPolynomial(coeffs=[15.8978,0.0258177,-1.10636e-05,2.05871e-09,-1.42492e-13,-7130.47,-44.6172], Tmin=(985.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.3229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJCO) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (179.64,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,492.5,1135,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (204.263,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1310,387.5,850,1000,3615,1277.5,1000,360,370,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.41606,0.109385,-0.00012592,6.49516e-08,-1.21636e-11,-39598.1,37.451], Tmin=(100,'K'), Tmax=(1546.12,'K')), NASAPolynomial(coeffs=[31.996,-0.00264683,5.0877e-06,-1.15997e-09,8.23227e-14,-47489.7,-134.671], Tmin=(1546.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-331.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)

species(
    label = 'C=C(O)C(C)([O])OO(5983)',
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.167972,0.0591773,1.02724e-05,-9.02197e-08,4.97736e-11,14396.1,28.0859], Tmin=(100,'K'), Tmax=(888.721,'K')), NASAPolynomial(coeffs=[31.3588,-0.0112896,1.11983e-05,-2.39039e-09,1.64935e-13,6090.97,-134.246], Tmin=(888.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCOOH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.27452,0.103291,-0.000115416,6.00856e-08,-1.12723e-11,-27256.9,35.1089], Tmin=(100,'K'), Tmax=(1594.1,'K')), NASAPolynomial(coeffs=[26.2159,0.00359955,4.92792e-06,-1.3413e-09,1.01613e-13,-32756.9,-104.387], Tmin=(1594.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0847817,0.0962554,-0.000154314,1.38323e-07,-4.85787e-11,-22199.7,33.3824], Tmin=(100,'K'), Tmax=(837.687,'K')), NASAPolynomial(coeffs=[7.82559,0.0401276,-1.94912e-05,3.71424e-09,-2.54937e-13,-22824.2,1.422], Tmin=(837.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-185.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJCO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])([O])C(O)CO(5987)',
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0460896,0.100789,-0.000174037,1.65015e-07,-5.99144e-11,-21625.4,33.1549], Tmin=(100,'K'), Tmax=(848.697,'K')), NASAPolynomial(coeffs=[5.48712,0.0451113,-2.25492e-05,4.32109e-09,-2.96343e-13,-21467.3,14.1701], Tmin=(848.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-180.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)

species(
    label = '[CH2][CH]C([CH2])(OO)OO(5988)',
    structure = SMILES('[CH2][CH]C([CH2])(OO)OO'),
    E0 = (233.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1300,1320,350,425,825,875,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (119.096,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04779,0.100161,-0.000106976,4.89517e-08,-6.81073e-12,28298.1,36.825], Tmin=(100,'K'), Tmax=(983.935,'K')), NASAPolynomial(coeffs=[25.937,0.0114433,-3.71476e-06,6.61456e-10,-4.80913e-14,21972.2,-98.0857], Tmin=(983.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(233.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C](OO)C([CH2])O(5989)',
    structure = SMILES('[CH2][C](OO)C([CH2])O'),
    E0 = (194.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3615,1310,387.5,850,1000,360,370,350,3615,1277.5,1000,1380,1390,370,380,2900,435,200],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205648,0.0896539,-0.000133647,1.09375e-07,-3.57345e-11,23549,31.6259], Tmin=(100,'K'), Tmax=(813.812,'K')), NASAPolynomial(coeffs=[10.8961,0.0310871,-1.45986e-05,2.75913e-09,-1.89383e-13,22008.4,-16.5214], Tmin=(813.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH]C(O)C([CH2])([O])OO(5991)',
    structure = SMILES('[CH]C(O)C([CH2])([O])OO'),
    E0 = (264.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (118.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.311351,0.0949469,-0.000118456,7.32571e-08,-1.76825e-11,31938.5,34.6604], Tmin=(100,'K'), Tmax=(1017.86,'K')), NASAPolynomial(coeffs=[18.5322,0.0208925,-9.31998e-06,1.77375e-09,-1.24675e-13,28102.6,-56.5819], Tmin=(1017.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])(OO)C([CH2])O(5992)',
    ...
    molecularWeight = (118.088,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.379663,0.0971834,-0.000124177,7.8656e-08,-1.9439e-11,31654.9,33.5452], Tmin=(100,'K'), Tmax=(994.801,'K')), NASAPolynomial(coeffs=[18.5318,0.0211403,-9.51364e-06,1.81256e-09,-1.27281e-13,27892.4,-57.5929], Tmin=(994.801,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.888,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CJCO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])(OO)C(=C)O(3484)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', '[CH2]C(O)C(=O)OO(5976)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(75.7279,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-NdNd_O;YJ] for rate rule [CO-NdNd_O;CH2_triplet]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 73.1 to 75.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]C(O)C(=C)OO(5977)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(126.484,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 123.5 to 126.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH2]C([O])(C=C)OO(1283)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)C(=C)[O](1091)', '[O]O(16)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2][C](O)C([CH2])(O)OO(5978)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2][C](O)C(C)([O])OO(5979)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2]C(O)C([CH2])(O)O[O](5980)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(O)C(C)([O])O[O](5981)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2]C([O])C(C)([O])OO(4004)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])(O[O])C(C)O(4005)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction18',
    reactants = ['OH(D)(132)', '[CH2]C(O)C([CH2])([O])[O](4060)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C]([O])C([CH2])O(1086)', '[O]O(16)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OH(D)(132)', '[CH2][CH]C([CH2])([O])OO(1397)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2]C(O)C([CH2])([O])O[O](3480)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][C](O)C([CH2])([O])OO(3474)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2]C(O)(OO)C(=C)O(5982)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['OH(D)(132)', '[CH2]C(O)C1([CH2])OO1(5984)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['OH(D)(132)', '[CH2]C(O)C1([O])CO1(3921)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['OH(D)(132)', '[CH2]C1([O])OCC1O(5559)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2]C(O)C1(CO1)OO(5985)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2]C(O)C([O])([O])CO(5986)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
    products = ['[CH2]C([O])([O])C(O)CO(5987)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][CH]C([CH2])(OO)OO(5988)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction38',
    reactants = ['O(T)(63)', '[CH2][C](OO)C([CH2])O(5989)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(T)(28)', '[CH2]C(O)[C]([O])OO(5990)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C([O])([CH]O)OO(2716)', 'CH2(T)(28)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(8)', '[CH]C(O)C([CH2])([O])OO(5991)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(8)', '[CH]C([O])(OO)C([CH2])O(5992)'],
    products = ['[CH2]C(O)C([CH2])([O])OO(4000)'],
