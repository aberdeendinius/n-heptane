...
species(
    label = '[CH]=[C]C[CH]CO(19300)',
    structure = SMILES('[CH]=[C]C[CH]CO'),
    E0 = (484.71,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3120,650,792.5,1650,3025,407.5,1350,352.5,299.894,3274.49],'cm^-1')),
        HinderedRotor(inertia=(0.00187073,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.282193,'amu*angstrom^2'), symmetry=1, barrier=(18.0402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.235989,'amu*angstrom^2'), symmetry=1, barrier=(15.0678,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0789003,'amu*angstrom^2'), symmetry=1, barrier=(5.0768,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55035,0.0554842,-5.31725e-05,2.91401e-08,-6.71138e-12,58384.1,27.1976], Tmin=(100,'K'), Tmax=(1027.94,'K')), NASAPolynomial(coeffs=[8.87638,0.0269765,-1.1573e-05,2.16075e-09,-1.49847e-13,56877.9,-8.34814], Tmin=(1027.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28672,0.05997,-6.08951e-05,3.39557e-08,-7.73162e-12,51473.8,27.2173], Tmin=(100,'K'), Tmax=(1055.36,'K')), NASAPolynomial(coeffs=[10.7195,0.0242183,-1.00811e-05,1.85694e-09,-1.27929e-13,49482.8,-18.7989], Tmin=(1055.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98867,0.0465233,-3.10004e-05,1.08979e-08,-1.65955e-12,14983.2,21.9698], Tmin=(100,'K'), Tmax=(1418.07,'K')), NASAPolynomial(coeffs=[8.0179,0.0295162,-1.30105e-05,2.44036e-09,-1.6849e-13,13273.2,-9.22368], Tmin=(1418.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]CC[C]O(19310)',
    structure = SMILES('[CH]=[C]CC[C]O'),
    E0 = (745.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,1685,370,196.808,196.818,4000],'cm^-1')),
        HinderedRotor(inertia=(0.579881,'amu*angstrom^2'), symmetry=1, barrier=(15.9403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.57984,'amu*angstrom^2'), symmetry=1, barrier=(15.9403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.57985,'amu*angstrom^2'), symmetry=1, barrier=(15.9404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.579936,'amu*angstrom^2'), symmetry=1, barrier=(15.9404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12388,0.066818,-8.73248e-05,6.20794e-08,-1.77755e-11,89799,24.9671], Tmin=(100,'K'), Tmax=(851.445,'K')), NASAPolynomial(coeffs=[10.3945,0.0232681,-1.06066e-05,2.01353e-09,-1.40018e-13,88220.3,-18.2676], Tmin=(851.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(745.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(CH2_triplet)"""),
)

species(
    label = '[C]=[C]CC[CH]O(19311)',
    structure = SMILES('[C]=[C]CC[CH]O'),
    E0 = (776.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1277.5,1000,3025,407.5,1350,352.5,319.227,319.227,319.227],'cm^-1')),
        HinderedRotor(inertia=(0.0848782,'amu*angstrom^2'), symmetry=1, barrier=(6.13796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0848786,'amu*angstrom^2'), symmetry=1, barrier=(6.13795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0848784,'amu*angstrom^2'), symmetry=1, barrier=(6.13794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0848786,'amu*angstrom^2'), symmetry=1, barrier=(6.13795,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983667,0.0740353,-0.000120139,1.06412e-07,-3.65208e-11,93446,26.2529], Tmin=(100,'K'), Tmax=(859.874,'K')), NASAPolynomial(coeffs=[7.43574,0.0284126,-1.33245e-05,2.48714e-09,-1.68096e-13,92913.4,-0.545151], Tmin=(859.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(776.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCsJOH) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]=[C]CC=CO(13799)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]=[C]C[CH][CH]O(19304)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
...
reaction(
    label = 'reaction26',
    reactants = ['OH(D)(132)', '[CH]CC[C]=[CH](18831)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]C[CH2](5188)', '[CH]O(5471)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[CH]O(426)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]=[C]CC[C]O(19310)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[C]=[C]CC[CH]O(19311)'],
    products = ['[CH]=[C]CC[CH]O(17801)'],
