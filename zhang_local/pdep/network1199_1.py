species(
    label = '[CH2]OO[CH]C(3597)',
    structure = SMILES('[CH2]OO[CH]C'),
    E0 = (194.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(2.07142,'amu*angstrom^2'), symmetry=1, barrier=(47.626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214191,'amu*angstrom^2'), symmetry=1, barrier=(4.92468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0273287,'amu*angstrom^2'), symmetry=1, barrier=(47.6261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07146,'amu*angstrom^2'), symmetry=1, barrier=(47.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02818,0.0459269,-3.83509e-05,1.76204e-08,-3.48924e-12,26819.5,19.6084], Tmin=(100,'K'), Tmax=(1151.58,'K')), NASAPolynomial(coeffs=[7.88016,0.0256002,-1.18743e-05,2.2928e-09,-1.61743e-13,25471.6,-9.44998], Tmin=(1151.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]OOC(675)',
    structure = SMILES('[CH2][CH]OOC'),
    E0 = (215.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(2.26843,'amu*angstrom^2'), symmetry=1, barrier=(52.1556,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0435694,'amu*angstrom^2'), symmetry=1, barrier=(52.1564,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2492,'amu*angstrom^2'), symmetry=1, barrier=(5.72959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248796,'amu*angstrom^2'), symmetry=1, barrier=(5.72032,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
...
species(
    label = '[CH2][CH]OO[CH2](688)',
    structure = SMILES('[CH2][CH]OO[CH2]'),
    E0 = (408.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,500,795,815,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.366561,'amu*angstrom^2'), symmetry=1, barrier=(8.42797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0417847,'amu*angstrom^2'), symmetry=1, barrier=(50.4499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19415,'amu*angstrom^2'), symmetry=1, barrier=(50.4478,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0417905,'amu*angstrom^2'), symmetry=1, barrier=(50.4512,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97801,0.0483138,-5.38043e-05,3.59305e-08,-1.03266e-11,49243.7,20.0934], Tmin=(100,'K'), Tmax=(825.223,'K')), NASAPolynomial(coeffs=[6.68792,0.0254842,-1.23075e-05,2.40693e-09,-1.70736e-13,48466.4,-1.72443], Tmin=(825.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH2]OO[C]C(3771)',
    structure = SMILES('[CH2]OO[C]C'),
    E0 = (469.443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,500,795,815,3000,3100,440,815,1455,1000,608.254],'cm^-1')),
        HinderedRotor(inertia=(0.962838,'amu*angstrom^2'), symmetry=1, barrier=(22.1375,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60597,'amu*angstrom^2'), symmetry=1, barrier=(36.9244,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366951,'amu*angstrom^2'), symmetry=1, barrier=(8.43693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60557,'amu*angstrom^2'), symmetry=1, barrier=(36.9153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90382,0.0488204,-4.89183e-05,2.61253e-08,-5.79857e-12,56534.2,16.7959], Tmin=(100,'K'), Tmax=(1063.57,'K')), NASAPolynomial(coeffs=[9.13166,0.0216372,-1.05808e-05,2.09472e-09,-1.50017e-13,54996.8,-18.5197], Tmin=(1063.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]OOC=C(677)'],
    products = ['[CH2]OO[CH]C(3597)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', '[CH2][CH]OO[CH2](688)'],
    products = ['[CH2]OO[CH]C(3597)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]OO[CH2](552)', '[CH3](11)'],
    products = ['[CH2]OO[CH]C(3597)'],
