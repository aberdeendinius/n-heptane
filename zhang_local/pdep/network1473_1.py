...
species(
    label = '[CH]=COC1=CO1(5362)',
    structure = SMILES('[CH]=COC1=CO1'),
    E0 = (382.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2950,1000,3010,987.5,1337.5,450,1655,180,180,180,180,727.029,853.182,853.202,853.296],'cm^-1')),
        HinderedRotor(inertia=(0.0337334,'amu*angstrom^2'), symmetry=1, barrier=(17.4295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.758087,'amu*angstrom^2'), symmetry=1, barrier=(17.4299,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25779,0.0522361,-5.70412e-05,2.98931e-08,-5.95226e-12,46065.5,20.8256], Tmin=(100,'K'), Tmax=(1314.87,'K')), NASAPolynomial(coeffs=[15.4549,0.00634321,-1.60254e-06,2.20892e-10,-1.32807e-14,42565.7,-50.6651], Tmin=(1314.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC1CO1(5365)',
    structure = SMILES('[CH]=[C]OC1CO1'),
    E0 = (290.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2950,3150,900,1000,1100,3120,650,792.5,1650,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312279,0.0566729,-5.84105e-05,2.93851e-08,-5.31068e-12,35113,25.6629], Tmin=(100,'K'), Tmax=(1698.78,'K')), NASAPolynomial(coeffs=[13.6761,0.0067704,1.93123e-06,-6.83679e-10,5.45105e-14,33232.7,-38.0619], Tmin=(1698.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = 'C=CO[C]1[CH]O1(5366)',
...
species(
    label = '[CH]=CO[C]1[CH]O1(5367)',
    structure = SMILES('[CH]=CO[C]1[CH]O1'),
    E0 = (439.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,324.701,324.709,324.876,324.917,324.926,324.944,324.972,325.348],'cm^-1')),
        HinderedRotor(inertia=(0.640878,'amu*angstrom^2'), symmetry=1, barrier=(47.9999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.640841,'amu*angstrom^2'), symmetry=1, barrier=(47.9954,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.710993,0.0666785,-7.6615e-05,3.9439e-08,-7.07618e-12,53108.4,27.8052], Tmin=(100,'K'), Tmax=(1747.99,'K')), NASAPolynomial(coeffs=[16.8435,-0.00182698,6.48657e-06,-1.5287e-09,1.09401e-13,51300.2,-54.3063], Tmin=(1747.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cs_P) + radical(CCsJO)"""),
)
...
species(
    label = 'C=COC1=CO1(5369)',
    structure = SMILES('C=COC1=CO1'),
    E0 = (238.981,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58299,0.0581421,-8.78698e-05,7.54811e-08,-2.59554e-11,28825,19.912], Tmin=(100,'K'), Tmax=(812.645,'K')), NASAPolynomial(coeffs=[7.15623,0.0237195,-1.14293e-05,2.18721e-09,-1.51187e-13,28150,-4.39933], Tmin=(812.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(oxirene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=COC1=CO1(5362)', 'H(8)'],
    products = ['[CH]=CO[C]1CO1(5170)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CO[C]1CO1(5363)'],
    products = ['[CH]=CO[C]1CO1(5170)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]=CO[C]1[CH]O1(5367)'],
    products = ['[CH]=CO[C]1CO1(5170)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]O[C]1CO1(5368)'],
    products = ['[CH]=CO[C]1CO1(5170)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]1CO1(1125)', '[CH]=C[O](602)'],
    products = ['[CH]=CO[C]1CO1(5170)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[C]=CO[C]1CO1(5371)'],
    products = ['[CH]=CO[C]1CO1(5170)'],
