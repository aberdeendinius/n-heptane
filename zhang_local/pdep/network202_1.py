...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.178406,'amu*angstrom^2'), symmetry=1, barrier=(4.10189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85389,0.0354437,-7.0279e-05,8.23512e-08,-3.4342e-11,3173.35,13.6113], Tmin=(100,'K'), Tmax=(849.211,'K')), NASAPolynomial(coeffs=[-1.87209,0.0312398,-1.61082e-05,3.12775e-09,-2.16048e-13,4930.27,41.2575], Tmin=(849.211,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCJO) + radical(OCOJ)"""),
)
...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.35817,0.00862364,2.62815e-05,-3.25876e-08,1.07879e-11,-44481.5,12.0042], Tmin=(100,'K'), Tmax=(1079.96,'K')), NASAPolynomial(coeffs=[4.80929,0.0183229,-8.12718e-06,1.57768e-09,-1.12956e-13,-45673.9,0.821908], Tmin=(1079.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-370.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-OsHHH) + group(Cds-OdOsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[O](410)'],
    products = ['C=O(355)', 'C=O(355)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC=O(553)', 'H(8)'],
    products = ['[CH2]OC[O](410)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['O(T)(63)', '[CH2]O[CH2](420)'],
    products = ['[CH2]OC[O](410)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(187219,'m^3/(mol*s)'), n=1.13083, Ea=(163.847,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H2/O;O_birad]
