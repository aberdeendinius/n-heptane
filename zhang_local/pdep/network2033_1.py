species(
    label = '[O]OC[CH]CO[C]=O(6934)',
    structure = SMILES('[O]OC[CH]CO[C]=O'),
    E0 = (30.3808,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.545013,0.0821516,-0.000122578,1.02039e-07,-3.40564e-11,3772.48,32.3366], Tmin=(100,'K'), Tmax=(807.553,'K')), NASAPolynomial(coeffs=[9.60835,0.0306478,-1.46319e-05,2.78774e-09,-1.92314e-13,2524.22,-8.11686], Tmin=(807.553,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.3808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical((O)CJOCC) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[O]OCC=CO[C]=O(7492)',
    structure = SMILES('[O]OCC=CO[C]=O'),
    E0 = (-63.4026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.722188,'amu*angstrom^2'), symmetry=1, barrier=(16.6045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.88783,'amu*angstrom^2'), symmetry=1, barrier=(43.405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.722046,'amu*angstrom^2'), symmetry=1, barrier=(16.6013,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.721459,'amu*angstrom^2'), symmetry=1, barrier=(16.5878,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.692628,0.0756568,-9.52468e-05,6.24429e-08,-1.63159e-11,-7508.93,26.7172], Tmin=(100,'K'), Tmax=(933.617,'K')), NASAPolynomial(coeffs=[12.98,0.0230132,-1.06678e-05,2.0484e-09,-1.43909e-13,-9803.3,-31.7185], Tmin=(933.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-63.4026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOC) + radical(ROOJ)"""),
)

species(
    label = '[O]OC=CCO[C]=O(7493)',
    structure = SMILES('[O]OC=CCO[C]=O'),
    E0 = (-32.6703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,492.5,1135,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2850,1437.5,1250,1305,750,350,304.166,304.17,304.174],'cm^-1')),
        HinderedRotor(inertia=(0.00182209,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170358,'amu*angstrom^2'), symmetry=1, barrier=(11.1846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170361,'amu*angstrom^2'), symmetry=1, barrier=(11.1846,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170352,'amu*angstrom^2'), symmetry=1, barrier=(11.1846,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05669,0.0646991,-7.14939e-05,4.11751e-08,-9.46434e-12,-3823.24,29.4925], Tmin=(100,'K'), Tmax=(1056.67,'K')), NASAPolynomial(coeffs=[12.7108,0.0205822,-8.86683e-06,1.66242e-09,-1.15826e-13,-6286.12,-27.3741], Tmin=(1056.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.6703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(ROOJ) + radical((O)CJOCC)"""),
)
...
species(
    label = '[O]O[CH]CCO[C]=O(7494)',
    structure = SMILES('[O]O[CH]CCO[C]=O'),
    E0 = (18.5483,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.512572,0.0829933,-0.000123949,1.03424e-07,-3.45836e-11,2350.41,30.2973], Tmin=(100,'K'), Tmax=(810.199,'K')), NASAPolynomial(coeffs=[9.55653,0.0312166,-1.48967e-05,2.83539e-09,-1.95434e-13,1118.81,-9.98762], Tmin=(810.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.5483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCsJOOH) + radical(ROOJ) + radical((O)CJOCC)"""),
)

species(
    label = '[O]OC[CH][CH]OC=O(7495)',
    structure = SMILES('[O]OC[CH][CH]OC=O'),
    E0 = (27.3774,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.702652,0.0801839,-0.00010525,6.87698e-08,-1.4246e-11,3404.31,31.7263], Tmin=(100,'K'), Tmax=(621.364,'K')), NASAPolynomial(coeffs=[10.2245,0.0308428,-1.49989e-05,2.90244e-09,-2.03056e-13,1990.22,-11.5372], Tmin=(621.364,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.3774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical(CCsJOC(O)H) + radical(ROOJ)"""),
)

species(
    label = 'O=[C]OC[CH][CH]OO(7496)',
    structure = SMILES('O=[C]OC[CH][CH]OO'),
    E0 = (66.9586,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.288219,0.0884379,-0.000134562,1.12642e-07,-3.78747e-11,8180.43,32.6491], Tmin=(100,'K'), Tmax=(784.892,'K')), NASAPolynomial(coeffs=[10.3993,0.0315806,-1.57186e-05,3.04893e-09,-2.12584e-13,6757.36,-12.6362], Tmin=(784.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.9586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCsJOOH) + radical(CCJCOOH) + radical((O)CJOCC)"""),
)

species(
    label = '[O]O[CH][CH]COC=O(7497)',
    structure = SMILES('[O]O[CH][CH]COC=O'),
    E0 = (21.2814,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.807659,0.0781624,-0.000117938,1.06264e-07,-3.86164e-11,2666.82,31.9055], Tmin=(100,'K'), Tmax=(800.518,'K')), NASAPolynomial(coeffs=[6.1574,0.038437,-1.91533e-05,3.71965e-09,-2.59491e-13,2226.66,9.88687], Tmin=(800.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(21.2814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = 'O=[C]O[CH][CH]COO(7498)',
    structure = SMILES('O=[C]O[CH][CH]COO'),
    E0 = (73.0545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,1855,455,950,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0218707,0.0934986,-0.000136262,1.01502e-07,-2.97732e-11,8926.69,33.1711], Tmin=(100,'K'), Tmax=(838.237,'K')), NASAPolynomial(coeffs=[14.5994,0.0237238,-1.13965e-05,2.18918e-09,-1.52431e-13,6475.57,-34.7876], Tmin=(838.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.0545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical((O)CJOCC) + radical(CCJCOOH)"""),
)
...
species(
    label = '[O]OC[CH][CH]O[C]=O(7499)',
    structure = SMILES('[O]OC[CH][CH]O[C]=O'),
    E0 = (225.059,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.103405,0.091681,-0.000147844,1.20722e-07,-3.82163e-11,27203,33.4711], Tmin=(100,'K'), Tmax=(855.805,'K')), NASAPolynomial(coeffs=[13.3008,0.0215431,-1.00937e-05,1.87275e-09,-1.25893e-13,25253.7,-26.3349], Tmin=(855.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical((O)CJOCC) + radical(CCsJOC(O)H) + radical(ROOJ)"""),
)

species(
    label = '[O]O[CH][CH]CO[C]=O(7500)',
    structure = SMILES('[O]O[CH][CH]CO[C]=O'),
    E0 = (218.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,1855,455,950,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.50009,0.0854847,-0.000141565,1.24877e-07,-4.27746e-11,26453.1,32.6455], Tmin=(100,'K'), Tmax=(846.517,'K')), NASAPolynomial(coeffs=[8.96922,0.0296379,-1.45592e-05,2.76746e-09,-1.89015e-13,25586.3,-3.45232], Tmin=(846.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCJCOOH) + radical((O)CJOCC) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[O]OCC=COC=O(6928)',
    structure = SMILES('[O]OCC=COC=O'),
    E0 = (-259.851,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924395,0.0677253,-6.69326e-05,3.42706e-08,-7.10665e-12,-31142.2,27.2507], Tmin=(100,'K'), Tmax=(1152.94,'K')), NASAPolynomial(coeffs=[13.2037,0.0251234,-1.15064e-05,2.22131e-09,-1.57156e-13,-33973.6,-33.7374], Tmin=(1152.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-259.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(ROOJ)"""),
)

species(
    label = 'O=[C]OCC=COO(7501)',
    structure = SMILES('O=[C]OCC=COO'),
    E0 = (-184.675,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.723077,0.0691313,-6.97495e-05,3.56159e-08,-7.22074e-12,-22090.8,29.9288], Tmin=(100,'K'), Tmax=(1193.77,'K')), NASAPolynomial(coeffs=[15.1438,0.0208112,-9.03374e-06,1.70864e-09,-1.19829e-13,-25533.8,-42.1968], Tmin=(1193.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOCC)"""),
)

species(
    label = '[O]OC=CCOC=O(7502)',
    structure = SMILES('[O]OC=CCOC=O'),
    E0 = (-230.352,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40687,0.0568958,-4.60391e-05,1.94608e-08,-3.42009e-12,-27611.7,28.5955], Tmin=(100,'K'), Tmax=(1314.77,'K')), NASAPolynomial(coeffs=[11.1403,0.0272831,-1.22545e-05,2.33006e-09,-1.62719e-13,-30171.2,-21.0266], Tmin=(1314.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-230.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical(ROOJ)"""),
)

species(
    label = 'O=[C]OC=CCOO(7503)',
    structure = SMILES('O=[C]OC=CCOO'),
    E0 = (-215.407,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.470526,0.0787914,-8.90733e-05,5.13293e-08,-1.17936e-11,-25781.3,26.7527], Tmin=(100,'K'), Tmax=(1055.43,'K')), NASAPolynomial(coeffs=[14.91,0.0240668,-1.12973e-05,2.20163e-09,-1.56644e-13,-28829.2,-43.6881], Tmin=(1055.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=[C]OCC1CO1(7504)',
    structure = SMILES('O=[C]OCC1CO1'),
    E0 = (-216.623,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.618113,0.0590158,-5.54272e-05,2.74135e-08,-5.11425e-12,-25918.8,24.9429], Tmin=(100,'K'), Tmax=(1555.93,'K')), NASAPolynomial(coeffs=[13.5661,0.0147696,-2.20611e-06,8.30297e-11,4.45219e-15,-28621.4,-38.9849], Tmin=(1555.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-216.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical((O)CJOCC)"""),
)
...
species(
    label = 'O=[C]OCC1COO1(7506)',
    structure = SMILES('O=[C]OCC1COO1'),
    E0 = (-159.365,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.000892245,0.0677873,-6.31513e-05,3.0035e-08,-5.36485e-12,-19005.8,29.0427], Tmin=(100,'K'), Tmax=(1620.53,'K')), NASAPolynomial(coeffs=[16.3968,0.0145867,-2.12829e-06,8.49827e-11,3.13057e-15,-22649.4,-52.827], Tmin=(1620.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(12dioxetane) + radical((O)CJOCC)"""),
)
...
species(
    label = '[O]C[CH]CO[C]=O(7507)',
    structure = SMILES('[O]C[CH]CO[C]=O'),
    E0 = (32.0634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1855,455,950,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80268,0.0543101,-5.37821e-05,2.38923e-08,1.0578e-12,3929.81,27.3998], Tmin=(100,'K'), Tmax=(573.532,'K')), NASAPolynomial(coeffs=[6.15797,0.0317682,-1.53137e-05,2.99103e-09,-2.11806e-13,3301.39,7.68622], Tmin=(573.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.0634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCJCO) + radical((O)CJOCC) + radical(CCOJ)"""),
)
...
species(
    label = '[O]OC[C]CO[C]=O(7508)',
    structure = SMILES('[O]OC[C]CO[C]=O'),
    E0 = (278.181,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1855,455,950,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468614,0.083148,-0.00012596,1.02041e-07,-3.28795e-11,33579.4,30.2123], Tmin=(100,'K'), Tmax=(801.78,'K')), NASAPolynomial(coeffs=[11.2864,0.0258083,-1.23804e-05,2.3572e-09,-1.62418e-13,31953.1,-18.9115], Tmin=(801.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + radical(CCJ2_triplet) + radical(ROOJ) + radical((O)CJOCC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]OCC=CO[C]=O(7492)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]OC=CCO[C]=O(7493)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(2.182e+10,'cm^3/(mol*s)'), n=0.859, Ea=(6.76971,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 2821 used for Cds-OsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-OsH_Cds-CsH;HJ]
...
reaction(
    ...
    products = ['[O]OC[CH]CO[C]=O(6934)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(84.6481,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 81.1 to 84.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['O2(2)', 'C=CCO[C]=O(3092)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['O=[C]OC[CH][CH]OO(7496)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['O=[C]O[CH][CH]COO(7498)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O2(2)', '[CH2][CH]CO[C]=O(3097)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[O]OC[CH][CH]O[C]=O(7499)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[O]O[CH][CH]CO[C]=O(7500)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[O]OC[CH]CO[C]=O(6934)'],
    products = ['C=CCO[C]=O(3092)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[O]OC[CH]CO[C]=O(6934)'],
    products = ['O(T)(63)', 'O=[C]OCC1CO1(7504)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[C-]#[O+](374)', '[O]C[CH]CO[O](6847)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C]=O(1149)', '[O]C[CH]CO[O](6847)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(T)(63)', '[O]C[CH]CO[C]=O(7507)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]O[C]=O(1735)', '[CH]CO[O](7037)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]O[O](61)', '[CH]CO[C]=O(3056)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[O]OC[C]CO[C]=O(7508)'],
    products = ['[O]OC[CH]CO[C]=O(6934)'],
