...
species(
    label = 'C#CCC[C]([O])OO(18392)',
    structure = SMILES('C#CCC[C]([O])OO'),
    E0 = (268.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,750,770,3400,2100,2175,525,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.367275,0.0874078,-0.000130904,1.12244e-07,-3.84929e-11,32380.5,31.3778], Tmin=(100,'K'), Tmax=(822.569,'K')), NASAPolynomial(coeffs=[8.4429,0.0366577,-1.7424e-05,3.30586e-09,-2.27221e-13,31440.3,-3.64429], Tmin=(822.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_P) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.349969,0.0898368,-0.000137859,1.25959e-07,-4.62499e-11,40426.2,35.6847], Tmin=(100,'K'), Tmax=(798.726,'K')), NASAPolynomial(coeffs=[6.21019,0.0444147,-2.23691e-05,4.36791e-09,-3.05622e-13,40002.8,11.9392], Tmin=(798.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_S) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586562,0.0842304,-0.000126589,1.1574e-07,-4.24536e-11,34595.6,33.29], Tmin=(100,'K'), Tmax=(811.821,'K')), NASAPolynomial(coeffs=[5.34231,0.0440966,-2.1575e-05,4.16118e-09,-2.89052e-13,34373.8,14.7274], Tmin=(811.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(ROOJ) + radical(CCOJ)"""),
)

species(
    label = '[CH2][C]=CCC([O])OO(18395)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965188,0.0767156,-7.56488e-05,2.07165e-08,1.58515e-11,33047.6,31.1142], Tmin=(100,'K'), Tmax=(536.18,'K')), NASAPolynomial(coeffs=[7.51798,0.042541,-2.11969e-05,4.18179e-09,-2.97063e-13,32133.4,1.61315], Tmin=(536.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35336,0.0886648,-0.000115166,7.70648e-08,-1.752e-11,37966.8,35.5449], Tmin=(100,'K'), Tmax=(623.461,'K')), NASAPolynomial(coeffs=[10.3574,0.0363403,-1.78104e-05,3.47202e-09,-2.44327e-13,36488.9,-9.84063], Tmin=(623.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cs_P) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CC[C](O)O[O](18397)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.323762,0.0868938,-0.00012145,9.78905e-08,-3.22567e-11,32147.6,34.0659], Tmin=(100,'K'), Tmax=(775.076,'K')), NASAPolynomial(coeffs=[9.7333,0.0355571,-1.67258e-05,3.19265e-09,-2.21475e-13,30772.4,-8.39423], Tmin=(775.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(Cds_S) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C]=CC[C](O)OO(18398)',
    structure = SMILES('[CH2][C]=CC[C](O)OO'),
    E0 = (253.486,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.369182,0.08489,-0.000100025,6.41553e-08,-1.68473e-11,30613.9,33.0006], Tmin=(100,'K'), Tmax=(917.674,'K')), NASAPolynomial(coeffs=[12.1584,0.0335016,-1.60252e-05,3.1308e-09,-2.22237e-13,28450.2,-22.8626], Tmin=(917.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P) + radical(Cs_P)"""),
)

species(
    label = '[CH]=[C]CCC([O])OO(18399)',
    structure = SMILES('[CH]=[C]CCC([O])OO'),
    E0 = (381.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.257888,0.0912369,-0.000138191,1.23497e-07,-4.45966e-11,46044.6,34.1143], Tmin=(100,'K'), Tmax=(792.438,'K')), NASAPolynomial(coeffs=[7.21528,0.0428517,-2.14915e-05,4.19378e-09,-2.9355e-13,45358.4,4.79564], Tmin=(792.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(CCOJ)"""),
)

species(
    label = '[CH]=[C]CC[C](O)OO(18400)',
    structure = SMILES('[CH]=[C]CC[C](O)OO'),
    E0 = (361.329,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3615,1310,387.5,850,1000,1685,370,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0793895,0.0927713,-0.000128383,9.83517e-08,-3.06169e-11,43593,34.5959], Tmin=(100,'K'), Tmax=(782.336,'K')), NASAPolynomial(coeffs=[11.4594,0.0345823,-1.68068e-05,3.26569e-09,-2.29426e-13,41812.5,-17.5119], Tmin=(782.336,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(Cs_P)"""),
)

species(
    label = 'C=CCC[C]([O])O[O](18401)',
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69552,0.0798813,-0.000110462,9.63224e-08,-3.4911e-11,30673.3,33.1151], Tmin=(100,'K'), Tmax=(776.69,'K')), NASAPolynomial(coeffs=[6.13758,0.0426357,-2.07272e-05,4.01744e-09,-2.81154e-13,30106,10.0256], Tmin=(776.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCOJ) + radical(Cs_P)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.639304,0.0613577,-2.51631e-05,-1.28952e-08,9.40806e-12,-22845.7,32.4541], Tmin=(100,'K'), Tmax=(1030.7,'K')), NASAPolynomial(coeffs=[16.7252,0.0249915,-1.01654e-05,1.93529e-09,-1.39236e-13,-27545.9,-52.3527], Tmin=(1030.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-191.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CCJCO)"""),
)

species(
    label = 'C=C=CCC([O])OO(18407)',
    structure = SMILES('C=C=CCC([O])OO'),
    E0 = (61.2086,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676539,0.0800243,-9.85822e-05,7.50264e-08,-2.45865e-11,7474.99,30.3686], Tmin=(100,'K'), Tmax=(729.322,'K')), NASAPolynomial(coeffs=[7.54967,0.0423295,-2.10573e-05,4.16369e-09,-2.96549e-13,6472.42,-0.621012], Tmin=(729.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.2086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.738332,0.0859306,-0.000146589,1.45759e-07,-5.4987e-11,13154.9,33.2486], Tmin=(100,'K'), Tmax=(853.789,'K')), NASAPolynomial(coeffs=[1.44418,0.049423,-2.41202e-05,4.58622e-09,-3.13434e-13,14244.5,37.0415], Tmin=(853.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S) + radical(CCOJ)"""),
)

species(
    label = 'C=[C]CCC(=O)OO(17464)',
    structure = SMILES('C=[C]CCC(=O)OO'),
    E0 = (-153.107,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409343,0.0710687,-5.75195e-05,2.33555e-08,-3.80063e-12,-18278.8,31.2643], Tmin=(100,'K'), Tmax=(1457.86,'K')), NASAPolynomial(coeffs=[16.9651,0.0256445,-1.07829e-05,1.98358e-09,-1.35727e-13,-23106.1,-54.8487], Tmin=(1457.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]C[CH]C(=O)OO(18390)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=CC[C]([O])OO(18391)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CCC[C]([O])OO(18392)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['C=[C]CC[C]([O])OO(17470)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(178.638,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C=[C]CCC([O])=O(17475)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=[C]CC[C]([O])OO(17470)'],
    products = ['C=[C]C[CH]C([O])OO(18393)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]CC[C]([O])OO(17470)'],
    products = ['[CH2][CH]C[CH]C(=O)OO(6640)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]CC[C]([O])OO(17470)'],
    products = ['C=[C]C[CH][C](O)OO(18396)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]CC[C]([O])OO(17470)'],
    products = ['[CH2][C]=CC[C](O)OO(18398)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]CC[C](O)OO(18400)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction20',
    reactants = ['OH(D)(132)', 'C=[C]CC[C]([O])[O](17474)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', 'C=[C]CC[C]([O])O[O](18402)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', 'C=[C]C[CH][C]([O])OO(18403)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][C]=CC[C]([O])OO(18404)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]=[C]CC[C]([O])OO(18405)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[O]O(16)', '[CH2][C]CC[C]=O(6485)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[O][C]OO(1370)', '[CH2]C[C]=C(4316)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[C]=C(584)', '[CH2]C[C]([O])OO(1371)'],
    products = ['C=[C]CC[C]([O])OO(17470)'],
