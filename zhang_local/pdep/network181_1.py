...
species(
    ...
    E0 = (8.02273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,365.501,365.956],'cm^-1')),
        HinderedRotor(inertia=(0.171569,'amu*angstrom^2'), symmetry=1, barrier=(16.2932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171455,'amu*angstrom^2'), symmetry=1, barrier=(16.2944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171606,'amu*angstrom^2'), symmetry=1, barrier=(16.2946,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2][CH]COC(463)',
    structure = SMILES('[CH2][CH]COC'),
    E0 = (145.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,252.081,1247.69,1247.69],'cm^-1')),
        HinderedRotor(inertia=(0.00588685,'amu*angstrom^2'), symmetry=1, barrier=(6.5032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144214,'amu*angstrom^2'), symmetry=1, barrier=(6.50312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0026529,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144219,'amu*angstrom^2'), symmetry=1, barrier=(6.50312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22025,0.0398109,-2.10806e-05,5.27397e-09,-5.29628e-13,17567.4,22.0635], Tmin=(100,'K'), Tmax=(2151.22,'K')), NASAPolynomial(coeffs=[11.3375,0.0228583,-9.25991e-06,1.6107e-09,-1.03908e-13,13644.8,-28.9059], Tmin=(2151.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]OC[C]C(468)',
    structure = SMILES('[CH2]OC[C]C'),
    E0 = (376.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,318.828,318.831,1784.87,3003.09],'cm^-1')),
        HinderedRotor(inertia=(0.274503,'amu*angstrom^2'), symmetry=1, barrier=(19.8011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877555,'amu*angstrom^2'), symmetry=1, barrier=(6.33035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.274499,'amu*angstrom^2'), symmetry=1, barrier=(19.8011,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.16551,'amu*angstrom^2'), symmetry=1, barrier=(84.0715,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88316,0.0454008,-3.50165e-05,1.49408e-08,-2.69226e-12,45345.3,20.5923], Tmin=(100,'K'), Tmax=(1281.38,'K')), NASAPolynomial(coeffs=[8.8196,0.0237475,-9.66876e-06,1.75296e-09,-1.19249e-13,43567.7,-14.5918], Tmin=(1281.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC=CC(459)', 'H(8)'],
    products = ['[CH2]OC[CH]C(392)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[CH][CH]C(464)', 'H(8)'],
    products = ['[CH2]OC[CH]C(392)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]CO[CH2](465)', 'H(8)'],
    products = ['[CH2]OC[CH]C(392)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]O[CH2](420)', '[CH]C(32)'],
    products = ['[CH2]OC[CH]C(392)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]CO[CH2](421)', '[CH3](11)'],
    products = ['[CH2]OC[CH]C(392)'],
