...
species(
    ...
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.02921,0.0102586,4.05108e-05,-5.77576e-08,2.17527e-11,40692.2,16.0643], Tmin=(100,'K'), Tmax=(996.024,'K')), NASAPolynomial(coeffs=[9.33866,0.0128333,-5.40364e-06,1.11078e-09,-8.53575e-14,38050.7,-21.3006], Tmin=(996.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=COO(20801)',
    structure = SMILES('[CH]=C=COO'),
    E0 = (252.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,540,610,2055],'cm^-1')),
    ...
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76451,0.0432101,-4.82579e-05,2.66004e-08,-5.56061e-12,30503.3,18.7693], Tmin=(100,'K'), Tmax=(1293.67,'K')), NASAPolynomial(coeffs=[12.4273,0.00645179,-1.24358e-06,1.08414e-10,-3.54198e-15,28061.5,-34.1927], Tmin=(1293.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)
...
species(
    ...
    E0 = (427.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2175,525,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(4.89521,'amu*angstrom^2'), symmetry=1, barrier=(112.55,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.579502,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04366,0.0466548,-7.13892e-05,5.8658e-08,-1.83871e-11,51493.9,17.063], Tmin=(100,'K'), Tmax=(941.848,'K')), NASAPolynomial(coeffs=[6.97636,0.0156303,-5.9327e-06,9.67928e-10,-5.92231e-14,51011.6,-4.06652], Tmin=(941.848,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
species(
    ...
    E0 = (579.591,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2175,525,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.221537,'amu*angstrom^2'), symmetry=1, barrier=(5.09358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.26677,'amu*angstrom^2'), symmetry=1, barrier=(75.1094,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31452,0.0429957,-7.59341e-05,6.78773e-08,-2.21635e-11,69764,16.8489], Tmin=(100,'K'), Tmax=(962.768,'K')), NASAPolynomial(coeffs=[5.17997,0.0143265,-5.14865e-06,7.76341e-10,-4.3187e-14,69989.2,7.16847], Tmin=(962.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(579.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(Acetyl)"""),
)
...
species(
    ...
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59449,0.0215577,1.48572e-05,-4.15126e-08,1.98467e-11,33509.2,16.0967], Tmin=(100,'K'), Tmax=(904.95,'K')), NASAPolynomial(coeffs=[11.8184,0.00568267,-9.57536e-08,-9.63099e-11,6.69225e-15,30820.4,-33.1147], Tmin=(904.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(dioxirane) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C#COO(20926)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22281,'amu*angstrom^2'), symmetry=1, barrier=(36.1184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22646,'amu*angstrom^2'), symmetry=1, barrier=(36.1186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21918,'amu*angstrom^2'), symmetry=1, barrier=(36.1178,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38651,0.0362049,-3.41332e-05,1.67742e-08,-3.38763e-12,36571.4,17.1409], Tmin=(100,'K'), Tmax=(1169.01,'K')), NASAPolynomial(coeffs=[8.5277,0.0151916,-7.17008e-06,1.39762e-09,-9.92307e-14,35135.6,-13.4458], Tmin=(1169.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Propargyl)"""),
)

species(
    label = '[CH2]C#CO[O](20927)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.729882,'amu*angstrom^2'), symmetry=1, barrier=(16.7814,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.62722,'amu*angstrom^2'), symmetry=1, barrier=(60.4051,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57313,0.0334857,-4.17745e-05,2.98771e-08,-8.82427e-12,54845.4,17.2331], Tmin=(100,'K'), Tmax=(818.67,'K')), NASAPolynomial(coeffs=[6.49835,0.0143086,-6.63991e-06,1.26806e-09,-8.84725e-14,54202.6,-0.918729], Tmin=(818.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(ROOJ) + radical(Propargyl)"""),
)

species(
    label = 'C=C1[CH]OO1(20928)',
    ...
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.25148,-0.0036093,9.4615e-05,-1.22356e-07,4.6506e-11,25081.1,15.4599], Tmin=(100,'K'), Tmax=(959.124,'K')), NASAPolynomial(coeffs=[13.0594,0.00678786,-1.8761e-06,4.79814e-10,-4.74468e-14,20840.1,-43.7492], Tmin=(959.124,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]C=[C]O[O](20929)',
    structure = SMILES('[CH2]C=[C]O[O]'),
    E0 = (465.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.276307,'amu*angstrom^2'), symmetry=1, barrier=(6.35285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.276282,'amu*angstrom^2'), symmetry=1, barrier=(6.35228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52105,0.0342047,-3.98426e-05,2.78428e-08,-8.12109e-12,55987.2,20.5482], Tmin=(100,'K'), Tmax=(826.949,'K')), NASAPolynomial(coeffs=[6.2778,0.0160324,-6.87885e-06,1.2673e-09,-8.66154e-14,55365.9,3.13804], Tmin=(826.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(465.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=CJO) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C#C[CH2](17441)'],
    products = ['C#CCO[O](18739)'],
    transitionState = 'TS1',
...
This reaction matched rate rule [C_rad/H2/Ct;O2_birad]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]O[O](61)', '[C]#C(5143)'],
    products = ['C#CCO[O](18739)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4.88087e+06,'m^3/(mol*s)'), n=0.114385, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;C_pri_rad] for rate rule [Ct_rad/Ct;C_rad/H2/O]
Euclidian distance = 2.2360679775
family: R_Recombination
...
This reaction matched rate rule [Cd_allenic;O2_birad]
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH2]C#CO[O](20927)'],
    products = ['C=C=CO[O](18741)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O(T)(63)', 'C=C=C[O](12570)'],
    products = ['C=C=CO[O](18741)'],
