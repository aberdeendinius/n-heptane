species(
    label = '[CH2][CH]OC[CH]O(3844)',
    structure = SMILES('[CH2][CH]OC[CH]O'),
    E0 = (139.143,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281208,0.0881829,-0.000140114,1.1571e-07,-3.69213e-11,16862.8,26.6663], Tmin=(100,'K'), Tmax=(881.61,'K')), NASAPolynomial(coeffs=[11.5559,0.0246051,-1.08046e-05,1.94377e-09,-1.28072e-13,15357.6,-23.5691], Tmin=(881.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885758,0.0770341,-0.000122511,1.10476e-07,-3.88486e-11,22300.2,25.8068], Tmin=(100,'K'), Tmax=(851.093,'K')), NASAPolynomial(coeffs=[6.29974,0.0341274,-1.61149e-05,3.0289e-09,-2.06045e-13,22011,4.27584], Tmin=(851.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[CH]CO(5747)',
    structure = SMILES('[CH2][CH]O[CH]CO'),
    E0 = (139.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.203096,0.087004,-0.000129954,9.94815e-08,-2.95559e-11,16887.4,26.8432], Tmin=(100,'K'), Tmax=(890.259,'K')), NASAPolynomial(coeffs=[13.8725,0.0201512,-8.15584e-06,1.41579e-09,-9.16281e-14,14668.9,-36.3051], Tmin=(890.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]CO[CH][CH]O(5748)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281391,0.0881806,-0.000140105,1.15697e-07,-3.69151e-11,16862.8,26.6656], Tmin=(100,'K'), Tmax=(881.687,'K')), NASAPolynomial(coeffs=[11.5555,0.0246059,-1.08051e-05,1.94389e-09,-1.28081e-13,15357.8,-23.5666], Tmin=(881.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.143,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = 'C[CH]O[CH][CH]O(3842)',
    structure = SMILES('C[CH]O[CH][CH]O'),
    E0 = (108.01,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3615,1277.5,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118665,0.0901682,-0.000140048,1.10824e-07,-3.38133e-11,13125.8,26.0616], Tmin=(100,'K'), Tmax=(897.757,'K')), NASAPolynomial(coeffs=[13.5101,0.021023,-8.67954e-06,1.50941e-09,-9.72242e-14,11103.3,-34.9723], Tmin=(897.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(108.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]COC[CH][O](3840)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952198,0.0783616,-0.000133246,1.27535e-07,-4.66096e-11,22276.1,25.6711], Tmin=(100,'K'), Tmax=(856.286,'K')), NASAPolynomial(coeffs=[4.01174,0.0385305,-1.87335e-05,3.54958e-09,-2.41872e-13,22688.4,16.8524], Tmin=(856.286,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'C[CH]OC[CH][O](3605)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800621,0.0802037,-0.000132604,1.21777e-07,-4.30623e-11,18538.5,25.028], Tmin=(100,'K'), Tmax=(859.999,'K')), NASAPolynomial(coeffs=[5.95458,0.0349693,-1.66211e-05,3.11835e-09,-2.11292e-13,18438.3,5.51185], Tmin=(859.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CCsJOH)"""),
)
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3638.29,'J/mol'), sigma=(6.34008,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=568.29 K, Pc=32.39 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630301,0.0856019,-0.000153047,1.41731e-07,-4.94852e-11,43991.4,26.2731], Tmin=(100,'K'), Tmax=(876.792,'K')), NASAPolynomial(coeffs=[6.87594,0.0310027,-1.49783e-05,2.79252e-09,-1.8699e-13,43899.7,2.68513], Tmin=(876.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CCsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[CH][CH]O(1076)',
    structure = SMILES('[CH2][CH]O[CH][CH]O'),
    E0 = (319.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3615,1277.5,1000,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0533545,0.0955983,-0.000160673,1.31155e-07,-4.04795e-11,38578.8,27.3122], Tmin=(100,'K'), Tmax=(918.246,'K')), NASAPolynomial(coeffs=[14.3896,0.0171278,-7.0779e-06,1.19335e-09,-7.37335e-14,36582.1,-37.5641], Tmin=(918.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]COC=CO(5749)',
    structure = SMILES('[CH2]COC=CO'),
    E0 = (-182.711,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.352244,0.0586364,-1.35766e-06,-6.77477e-08,3.85797e-11,-21823.3,22.2723], Tmin=(100,'K'), Tmax=(900.976,'K')), NASAPolynomial(coeffs=[27.967,-0.00517066,6.99145e-06,-1.49988e-09,1.01037e-13,-29185.6,-121.316], Tmin=(900.976,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)

species(
    label = '[CH2]COCC=O(5750)',
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.327332,0.085503,-0.000134406,1.0703e-07,-3.30787e-11,50622,25.6841], Tmin=(100,'K'), Tmax=(859.712,'K')), NASAPolynomial(coeffs=[13.2932,0.0193064,-8.66584e-06,1.58249e-09,-1.05554e-13,48609.6,-33.647], Tmin=(859.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CH2_triplet) + radical(CJCO)"""),
)
...
species(
    label = '[CH][CH]OC[CH]O(5753)',
    structure = SMILES('[CH][CH]OC[CH]O'),
    E0 = (375.769,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.38103,0.0860496,-0.000139879,1.16217e-07,-3.71306e-11,45318.7,26.6783], Tmin=(100,'K'), Tmax=(883.661,'K')), NASAPolynomial(coeffs=[11.6295,0.0223222,-9.95843e-06,1.79521e-09,-1.18083e-13,43830.9,-23.3682], Tmin=(883.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(375.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJ2_triplet) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=COC[CH][O](699)', 'H(8)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2][CH]OC=CO(5746)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]OC[CH][O](710)', 'H(8)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]O[CH][CH]O(1076)', 'H(8)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH][CH2](721)', '[O]C[CH]O(561)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction19',
    reactants = ['OH(D)(132)', '[CH]CO[CH][CH2](723)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]O[CH2](417)', '[CH]O(5471)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][CH]OC[C]O(5751)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C]OC[CH]O(5752)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH][CH]OC[CH]O(5753)'],
    products = ['[CH2][CH]OC[CH]O(3844)'],
