...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.985431,0.0533115,-2.46078e-05,-2.27188e-08,1.74145e-11,23994.2,24.5368], Tmin=(100,'K'), Tmax=(914.983,'K')), NASAPolynomial(coeffs=[20.4273,0.00288874,1.37978e-06,-3.6016e-10,2.29672e-14,18989.3,-75.4395], Tmin=(914.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJCO) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH]O[CH][C]=O(4624)',
    structure = SMILES('[CH2][CH]O[CH][C]=O'),
    E0 = (387.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1855,455,950,376.086,376.287,376.674],'cm^-1')),
        HinderedRotor(inertia=(0.00119682,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162755,'amu*angstrom^2'), symmetry=1, barrier=(16.355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162454,'amu*angstrom^2'), symmetry=1, barrier=(16.3553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162909,'amu*angstrom^2'), symmetry=1, barrier=(16.3633,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842115,0.0707709,-0.000101749,7.15639e-08,-1.94092e-11,46683.2,25.4299], Tmin=(100,'K'), Tmax=(913.127,'K')), NASAPolynomial(coeffs=[14.2955,0.0118385,-4.94201e-06,8.8729e-10,-5.94446e-14,44226.2,-38.2526], Tmin=(913.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CJCO) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]COC=C=O(4625)',
    structure = SMILES('[CH2]COC=C=O'),
    E0 = (-1.23474,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH][CH]OC[C]=O(4627)',
    structure = SMILES('[CH][CH]OC[C]=O'),
    E0 = (443.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36855,0.060075,-7.66385e-05,5.05557e-08,-1.32415e-11,53419.2,23.7766], Tmin=(100,'K'), Tmax=(932.984,'K')), NASAPolynomial(coeffs=[11.3206,0.0174084,-8.0432e-06,1.54199e-09,-1.08222e-13,51562.1,-23.5464], Tmin=(932.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CsCJ=O) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CO[CH][C]=O(4622)'],
    products = ['[CH2][CH]OC[C]=O(4226)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][CH]OC[C]=O(4226)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(71.0707,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 69.6 to 71.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2][CH]O[CH][C]=O(4624)'],
    products = ['[CH2][CH]OC[C]=O(4226)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][CH]O[CH2](417)', '[C-]#[O+](374)'],
    products = ['[CH2][CH]OC[C]=O(4226)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C[C]=O(1736)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC[C]=O(4226)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C]=O(1149)', '[CH2][CH]O[CH2](417)'],
    products = ['[CH2][CH]OC[C]=O(4226)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH][CH]OC[C]=O(4627)'],
    products = ['[CH2][CH]OC[C]=O(4226)'],
