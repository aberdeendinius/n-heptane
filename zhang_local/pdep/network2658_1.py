...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3444.32,'J/mol'), sigma=(6.09713,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=537.99 K, Pc=34.48 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH]C([CH2])([O])O[CH2](10510)',
    structure = SMILES('[CH]C([CH2])([O])O[CH2]'),
    E0 = (596.263,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.816359,0.0714281,-9.38802e-05,6.22557e-08,-1.61575e-11,71827.4,25.1322], Tmin=(100,'K'), Tmax=(947.597,'K')), NASAPolynomial(coeffs=[13.7692,0.016753,-7.33454e-06,1.36957e-09,-9.46941e-14,69372.5,-36.661], Tmin=(947.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOCH3) + radical(CJC(C)OC) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC([CH2])=O(1012)', 'CH2(T)(28)'],
    products = ['[CH2]OC([CH2])([CH2])[O](9563)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]OC([CH2])=C(6270)'],
    products = ['[CH2]OC([CH2])([CH2])[O](9563)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]C([CH2])([O])O[CH2](10510)'],
    products = ['[CH2]OC([CH2])([CH2])[O](9563)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH]OC([CH2])([CH2])[O](10511)'],
    products = ['[CH2]OC([CH2])([CH2])[O](9563)'],
