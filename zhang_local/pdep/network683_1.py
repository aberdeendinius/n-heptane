...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25135,0.0565575,-4.94763e-05,2.17657e-08,-3.83909e-12,4406.45,29.1075], Tmin=(100,'K'), Tmax=(1350.29,'K')), NASAPolynomial(coeffs=[13.63,0.0198877,-8.74057e-06,1.65356e-09,-1.1539e-13,1063.52,-34.3298], Tmin=(1350.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.7886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(C=OCOJ) + radical(CJCO) + radical(CsJOC(O)C)"""),
)

species(
    label = '[CH2]C([O])C(=O)C[O](2257)',
    structure = SMILES('[CH2]C([O])C(=O)C[O]'),
    E0 = (125.726,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,375,552.5,462.5,1710,180,180,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0238136,'amu*angstrom^2'), symmetry=1, barrier=(18.2199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.792404,'amu*angstrom^2'), symmetry=1, barrier=(18.2189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0137373,'amu*angstrom^2'), symmetry=1, barrier=(18.2199,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25889,0.0606413,-6.56041e-05,3.76032e-08,-8.6657e-12,15219.8,29.8003], Tmin=(100,'K'), Tmax=(1050.3,'K')), NASAPolynomial(coeffs=[11.6607,0.0210267,-9.02792e-06,1.69202e-09,-1.17839e-13,13034.8,-20.8928], Tmin=(1050.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(C=OCOJ) + radical(C=OCOJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.335909,0.0698182,-7.71785e-05,4.35024e-08,-9.19371e-12,15431.5,24.8309], Tmin=(100,'K'), Tmax=(1351.45,'K')), NASAPolynomial(coeffs=[15.7536,0.0128563,-1.38099e-06,-9.12442e-11,1.79688e-14,12298.9,-50.3662], Tmin=(1351.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][C]([O])C1(O)CO1(2261)',
    structure = SMILES('[CH2][C]([O])C1(O)CO1'),
    E0 = (106.729,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.31485,0.0880958,-0.00010598,5.81906e-08,-1.13523e-11,13052.8,30.1191], Tmin=(100,'K'), Tmax=(1555.24,'K')), NASAPolynomial(coeffs=[22.5724,-0.00117134,6.95801e-06,-1.72715e-09,1.28794e-13,8988.53,-84.8516], Tmin=(1555.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])C1(O)[CH]O1(2262)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14295,0.0917356,-0.000107329,5.61542e-08,-1.03015e-11,13948.7,33.8983], Tmin=(100,'K'), Tmax=(1688.31,'K')), NASAPolynomial(coeffs=[23.2587,-0.00368281,8.75192e-06,-2.04475e-09,1.46956e-13,10393.3,-87.0814], Tmin=(1688.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.383176,0.0723484,-7.53669e-05,3.82277e-08,-7.07229e-12,16322.1,28.2057], Tmin=(100,'K'), Tmax=(1611.8,'K')), NASAPolynomial(coeffs=[17.9813,0.00834505,1.34693e-06,-5.95826e-10,4.97236e-14,12795.9,-61.7332], Tmin=(1611.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CC(C)OJ) + radical(CCsJO)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13549,0.0447182,1.9227e-05,-8.22578e-08,4.4025e-11,-24865.1,22.1598], Tmin=(100,'K'), Tmax=(865.083,'K')), NASAPolynomial(coeffs=[22.8119,-0.0020381,7.58234e-06,-1.83249e-09,1.34152e-13,-30616.3,-90.8394], Tmin=(865.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-207.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide) + radical(C=OCOJ)"""),
)

species(
    label = 'C=C([O])C1(O)CO1(2269)',
    structure = SMILES('C=C([O])C1(O)CO1'),
    E0 = (-289.484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.83269,0.0824012,-9.16643e-05,4.67602e-08,-8.34295e-12,-34566.9,31.1649], Tmin=(100,'K'), Tmax=(1760.13,'K')), NASAPolynomial(coeffs=[18.7139,0.00120582,6.93424e-06,-1.72166e-09,1.24971e-13,-36455.4,-64.3954], Tmin=(1760.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-289.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=C(C)OJ)"""),
)
...
species(
    label = '[O]C1(CO1)C1CO1(1800)',
    structure = SMILES('[O]C1(CO1)C1CO1'),
    E0 = (-90.2943,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.624116,0.0666921,-6.56136e-05,3.34574e-08,-6.06317e-12,-10662.9,26.1105], Tmin=(100,'K'), Tmax=(1754.64,'K')), NASAPolynomial(coeffs=[10.567,0.0143756,2.02494e-06,-9.47754e-10,7.93055e-14,-10464,-22.4144], Tmin=(1754.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.2943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29863,0.0403536,2.39966e-05,-7.18856e-08,3.35626e-11,-9717.16,18.6828], Tmin=(100,'K'), Tmax=(940.986,'K')), NASAPolynomial(coeffs=[20.2461,0.00792755,-1.01628e-06,1.77356e-10,-2.04303e-14,-15413.3,-82.8949], Tmin=(940.986,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.7471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + polycyclic(s1_3_4_ane) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]O[C]([O])C([CH2])[O](2270)',
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.782769,0.0787146,-0.000127337,1.13899e-07,-4.01743e-11,51640.7,31.2443], Tmin=(100,'K'), Tmax=(817.419,'K')), NASAPolynomial(coeffs=[7.79977,0.0311352,-1.5727e-05,3.05362e-09,-2.12154e-13,50935.9,1.51203], Tmin=(817.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCO) + radical(CsJOCH3) + radical(CCOJ) + radical(CC(C)OJ) + radical(Cs_P)"""),
)
...
species(
    label = '[CH2]C([O])[C]([O])C[O](2271)',
    structure = SMILES('[CH2]C([O])[C]([O])C[O]'),
    E0 = (425.571,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,360,370,350,198.664,201.498,204.291,1415.07,1416.65],'cm^-1')),
        HinderedRotor(inertia=(0.132229,'amu*angstrom^2'), symmetry=1, barrier=(3.8335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12568,'amu*angstrom^2'), symmetry=1, barrier=(3.86169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126522,'amu*angstrom^2'), symmetry=1, barrier=(3.80008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.590303,0.0856074,-0.000148768,1.36668e-07,-4.79292e-11,51297,29.7958], Tmin=(100,'K'), Tmax=(861.104,'K')), NASAPolynomial(coeffs=[7.22702,0.0320117,-1.57486e-05,2.98041e-09,-2.02265e-13,50998.1,3.67113], Tmin=(861.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.571,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CJCO) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH]C([O])C1([O])CO1(2273)',
    structure = SMILES('[CH]C([O])C1([O])CO1'),
    E0 = (398.718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0739137,0.068351,-7.40524e-05,3.92583e-08,-7.62928e-12,48111.5,27.356], Tmin=(100,'K'), Tmax=(1517.36,'K')), NASAPolynomial(coeffs=[17.0173,0.0080379,1.03942e-06,-5.30318e-10,4.60304e-14,44771.1,-55.5149], Tmin=(1517.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C([CH2])[O](2256)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(127.211,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C([O])C(=O)C[O](2257)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=C([O])C1([O])CO1(2258)', 'H(8)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(28)', '[O]C1(C=O)CO1(2044)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(T)(63)', 'C=CC1([O])CO1(1780)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][C]1CO1(1828)', 'C=C[O](594)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([O])C1([O])CO1(1787)'],
    products = ['[CH2][C](O)C1([O])CO1(2259)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])C1([O])CO1(1787)'],
    products = ['[CH2][C]([O])C1(O)CO1(2261)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([O])C1([O])CO1(1787)'],
    products = ['[CH2]C([O])C1(O)[CH]O1(2262)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([O])C1([O])CO1(1787)'],
    products = ['[CH2]C(O)C1([O])[CH]O1(2263)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C]([O])C1([O])CO1(2265)', 'H(8)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])C1([O])[CH]O1(2266)', 'H(8)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(S)(14)', '[CH2]C([O])C([O])=O(2267)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([O])C(=C)[O](1083)', 'O(S)(1732)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]O[C]([O])C([CH2])[O](2270)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([O])[C]([O])C[O](2271)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(T)(63)', '[CH2]C([O])[C]1CO1(2272)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(T)(63)', '[CH2][CH]C1([O])CO1(1840)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[O][CH]C1([O])CO1(2050)', 'CH2(T)(28)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C([O])C1([O])CO1(2273)', 'H(8)'],
    products = ['[CH2]C([O])C1([O])CO1(1787)'],
