...
species(
    label = '[CH]=CC(O)=C=C(28209)',
    structure = SMILES('[CH]=CC(O)=C=C'),
    E0 = (267.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,540,610,2055,350,440,435,1725,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655],'cm^-1')),
        HinderedRotor(inertia=(1.17908,'amu*angstrom^2'), symmetry=1, barrier=(27.1093,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC(O)C#C(28211)',
    structure = SMILES('[CH]=CC(O)C#C'),
    E0 = (323.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,750,770,3400,2100,2175,525,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3615,1277.5,1000],'cm^-1')),
        HinderedRotor(inertia=(0.947515,'amu*angstrom^2'), symmetry=1, barrier=(21.7852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947139,'amu*angstrom^2'), symmetry=1, barrier=(21.7766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947433,'amu*angstrom^2'), symmetry=1, barrier=(21.7833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44132,0.051441,-4.62302e-05,1.84281e-08,-1.78384e-12,39060.2,23.104], Tmin=(100,'K'), Tmax=(964.953,'K')), NASAPolynomial(coeffs=[12.758,0.0147049,-4.94092e-06,8.2928e-10,-5.53463e-14,36402.5,-33.5431], Tmin=(964.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370872,0.0624699,-6.02271e-05,2.90702e-08,-5.26006e-12,19515.9,23.2331], Tmin=(100,'K'), Tmax=(1584.45,'K')), NASAPolynomial(coeffs=[16.3192,0.0113328,-1.52045e-06,3.73137e-11,4.32473e-15,15827.1,-56.7409], Tmin=(1584.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C) + radical(C=CC=CCJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.07798,'amu*angstrom^2'), symmetry=1, barrier=(47.7768,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07245,'amu*angstrom^2'), symmetry=1, barrier=(47.6498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.07857,'amu*angstrom^2'), symmetry=1, barrier=(47.7904,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489814,0.0667301,-6.76864e-05,3.51165e-08,-7.01035e-12,49889.9,22.3472], Tmin=(100,'K'), Tmax=(1350.05,'K')), NASAPolynomial(coeffs=[16.1137,0.0148234,-3.77504e-06,4.75416e-10,-2.50328e-14,46183,-55.8229], Tmin=(1350.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(C=CJC=C)"""),
)
...
species(
    label = '[CH]=[C]C(O)C=[CH](28216)',
    structure = SMILES('[CH]=[C]C(O)C=[CH]'),
    E0 = (642.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3115,3125,620,680,785,800,1600,1700,1685,370,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435],'cm^-1')),
        HinderedRotor(inertia=(0.475783,'amu*angstrom^2'), symmetry=1, barrier=(12.5505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485246,'amu*angstrom^2'), symmetry=1, barrier=(12.5517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519118,'amu*angstrom^2'), symmetry=1, barrier=(12.5517,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62871,0.0534188,-5.68536e-05,3.22286e-08,-7.41859e-12,77413.5,25.698], Tmin=(100,'K'), Tmax=(1044.7,'K')), NASAPolynomial(coeffs=[10.3193,0.0201438,-9.0769e-06,1.74043e-09,-1.22694e-13,75597.7,-16.6094], Tmin=(1044.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=C=C(O)C=C(28217)',
    structure = SMILES('C=C=C(O)C=C'),
    E0 = (20.607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=CC(O)=C=C(28209)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CC(O)[C]=C(28210)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH]=CC(O)C#C(28211)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH]=CC=C=C(17757)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['OH(D)(132)', '[CH]C=C[C]=C(17762)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C=C(O)[C]=C(28214)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]=[C]C(O)[C]=C(28215)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=[C]C(O)C=[CH](28216)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[C]=C(584)', '[CH]C=CO(5264)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[C]=CC(O)[C]=C(28219)'],
    products = ['[CH]=CC(O)[C]=C(13775)'],
