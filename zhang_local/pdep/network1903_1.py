...
species(
    label = 'C[CH]CC=CCO[O](7127)',
    structure = SMILES('C[CH]CC=CCO[O]'),
    E0 = (188.493,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69355,0.0614962,2.7296e-07,-1.17798e-07,1.15783e-10,22742.2,30.6479], Tmin=(100,'K'), Tmax=(453.181,'K')), NASAPolynomial(coeffs=[5.01905,0.0502857,-2.26697e-05,4.28946e-09,-2.9797e-13,22254.5,15.1809], Tmin=(453.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(ROOJ)"""),
)

species(
    label = 'CC=CC[CH]CO[O](7128)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.526925,0.0821968,-8.73572e-05,5.95226e-08,-1.78182e-11,22703.3,33.1412], Tmin=(100,'K'), Tmax=(789.682,'K')), NASAPolynomial(coeffs=[7.34123,0.0476784,-2.17862e-05,4.16336e-09,-2.91489e-13,21627.1,1.87552], Tmin=(789.682,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CCC=CO[O](7129)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.727357,0.0746963,-6.44615e-05,3.30539e-08,-7.36941e-12,23938,33.7183], Tmin=(100,'K'), Tmax=(1039.52,'K')), NASAPolynomial(coeffs=[9.05958,0.0426347,-1.81977e-05,3.38408e-09,-2.33985e-13,22205.7,-6.80285], Tmin=(1039.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(ROOJ)"""),
)
...
species(
    label = 'C=CCC[CH]C(161)',
    structure = SMILES('C=CCC[CH]C'),
    E0 = (130.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,2750,2800,2850,1350,1500,750,1050,1375,1000,316.556,1188.24,1188.65],'cm^-1')),
        HinderedRotor(inertia=(0.0944295,'amu*angstrom^2'), symmetry=1, barrier=(6.70214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0916654,'amu*angstrom^2'), symmetry=1, barrier=(6.67689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0926807,'amu*angstrom^2'), symmetry=1, barrier=(6.7045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0939248,'amu*angstrom^2'), symmetry=1, barrier=(6.66989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.145339,0.093361,-0.000123443,1.07169e-07,-3.838e-11,30781.5,35.0374], Tmin=(100,'K'), Tmax=(820.371,'K')), NASAPolynomial(coeffs=[5.0217,0.0545152,-2.48624e-05,4.66733e-09,-3.20117e-13,30488.5,15.5679], Tmin=(820.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CCC[CH]CO[O](7131)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.567943,0.0849141,-7.46443e-05,1.86009e-08,1.3965e-11,33487.6,34.8186], Tmin=(100,'K'), Tmax=(565.644,'K')), NASAPolynomial(coeffs=[7.51765,0.0506383,-2.31824e-05,4.42242e-09,-3.08938e-13,32463.6,3.14743], Tmin=(565.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC[CH][CH]OO(7132)',
    structure = SMILES('C[CH]CC[CH][CH]OO'),
    E0 = (303.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0870981,0.0989107,-0.000134471,1.16994e-07,-4.19608e-11,36611.8,37.4176], Tmin=(100,'K'), Tmax=(806.729,'K')), NASAPolynomial(coeffs=[5.88835,0.0548358,-2.56581e-05,4.87448e-09,-3.36723e-13,36117.8,12.7866], Tmin=(806.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH][CH]CCCO[O](7133)',
...
species(
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209793,0.0930639,-0.000127539,1.14576e-07,-4.18918e-11,32202.6,36.7894], Tmin=(100,'K'), Tmax=(825.966,'K')), NASAPolynomial(coeffs=[4.00867,0.0558482,-2.5778e-05,4.85672e-09,-3.33332e-13,32217,23.0742], Tmin=(825.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCC[CH][CH]O[O](7135)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848726,0.0814151,-4.89726e-05,-4.76472e-08,6.89308e-11,31470.1,32.2664], Tmin=(100,'K'), Tmax=(498.515,'K')), NASAPolynomial(coeffs=[7.21723,0.0516687,-2.37191e-05,4.50497e-09,-3.12805e-13,30569.8,3.31409], Tmin=(498.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2][CH]CCCCO[O](7136)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205112,0.0910346,-0.000115892,9.7863e-08,-3.46249e-11,32784.5,36.461], Tmin=(100,'K'), Tmax=(808.349,'K')), NASAPolynomial(coeffs=[5.55564,0.0530526,-2.40613e-05,4.5196e-09,-3.1067e-13,32295.4,14.1113], Tmin=(808.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C[CH][CH]COO(7137)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.154394,0.0967679,-0.000142072,1.33816e-07,-5.00194e-11,37306.7,38.9637], Tmin=(100,'K'), Tmax=(836.114,'K')), NASAPolynomial(coeffs=[2.47443,0.0594186,-2.79738e-05,5.2913e-09,-3.62932e-13,37836.3,33.6732], Tmin=(836.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][CH]C[CH]COO(7138)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.154401,0.0967678,-0.000142072,1.33815e-07,-5.00191e-11,37306.7,38.9636], Tmin=(100,'K'), Tmax=(836.115,'K')), NASAPolynomial(coeffs=[2.47441,0.0594186,-2.79738e-05,5.2913e-09,-3.62932e-13,37836.3,33.6732], Tmin=(836.115,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][CH]CC[CH]COO(7139)',
    structure = SMILES('[CH2][CH]CC[CH]COO'),
    E0 = (319.921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29876,0.0743105,-1.19507e-06,-1.7995e-07,1.91033e-10,38559,34.4268], Tmin=(100,'K'), Tmax=(435.734,'K')), NASAPolynomial(coeffs=[6.72161,0.0528052,-2.45031e-05,4.63836e-09,-3.19634e-13,37818,9.68937], Tmin=(435.734,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.658444,0.0783796,-6.53964e-05,3.26159e-08,-7.25683e-12,-1404.66,30.3605], Tmin=(100,'K'), Tmax=(1021.96,'K')), NASAPolynomial(coeffs=[8.2585,0.0486329,-2.17356e-05,4.13452e-09,-2.89552e-13,-2958.07,-6.4706], Tmin=(1021.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.6454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CCC=COO(7145)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431524,0.0787752,-6.1837e-05,2.67224e-08,-4.90652e-12,5668.52,34.012], Tmin=(100,'K'), Tmax=(1250.02,'K')), NASAPolynomial(coeffs=[11.8477,0.0422438,-1.79998e-05,3.3428e-09,-2.30643e-13,2814.45,-23.612], Tmin=(1250.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.0662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC)"""),
)

species(
    label = 'CCCCC=CO[O](7146)',
...
species(
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.565521,0.0788138,-6.35134e-05,2.91674e-08,-5.83048e-12,72.7306,31.1237], Tmin=(100,'K'), Tmax=(1139.22,'K')), NASAPolynomial(coeffs=[9.9388,0.0459024,-2.0179e-05,3.80816e-09,-2.65389e-13,-2062.9,-15.3186], Tmin=(1139.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.400066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC=CCOO(7148)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.789633,0.076631,-6.37026e-05,3.365e-08,-8.28577e-12,4498.96,32.926], Tmin=(100,'K'), Tmax=(912.242,'K')), NASAPolynomial(coeffs=[6.30283,0.0524558,-2.39497e-05,4.5974e-09,-3.23597e-13,3493.12,6.83455], Tmin=(912.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04482,0.0599151,-2.11224e-05,-1.40531e-08,1.11664e-11,2477.65,26.84], Tmin=(100,'K'), Tmax=(862.154,'K')), NASAPolynomial(coeffs=[9.51857,0.0376636,-1.20952e-05,1.92177e-09,-1.22253e-13,382.364,-16.4618], Tmin=(862.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5836,0.0670481,-2.41432e-05,-1.60586e-08,1.22296e-11,9383.38,30.3585], Tmin=(100,'K'), Tmax=(906.749,'K')), NASAPolynomial(coeffs=[12.1941,0.0378481,-1.22628e-05,1.98644e-09,-1.29026e-13,6372.65,-29.5103], Tmin=(906.749,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.9327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC[CH]C[O](7151)',
    structure = SMILES('C[CH]CC[CH]C[O]'),
    E0 = (268.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,202.312,442.874,934.213,1747.52,3472],'cm^-1')),
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59292,0.0534857,-2.44504e-05,4.6399e-09,-3.19986e-13,32302.8,27.7991], Tmin=(100,'K'), Tmax=(2939.27,'K')), NASAPolynomial(coeffs=[43.5121,0.00397751,-2.33764e-06,3.39528e-10,-1.504e-14,5579.62,-218.269], Tmin=(2939.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC[C]CO[O](7152)',
    structure = SMILES('C[CH]CC[C]CO[O]'),
    E0 = (514.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.096212,0.0935837,-0.000125729,1.06203e-07,-3.68851e-11,62010.7,34.9706], Tmin=(100,'K'), Tmax=(818.387,'K')), NASAPolynomial(coeffs=[6.76229,0.0490873,-2.23343e-05,4.18625e-09,-2.86854e-13,61318.6,6.58435], Tmin=(818.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(ROOJ)"""),
)

species(
    label = 'C[C]CC[CH]CO[O](7153)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.372681,0.0888308,-9.15637e-05,4.14031e-08,1.61846e-12,62717.5,33.6194], Tmin=(100,'K'), Tmax=(590.979,'K')), NASAPolynomial(coeffs=[8.77368,0.0465773,-2.1395e-05,4.07383e-09,-2.83796e-13,61469.5,-4.65007], Tmin=(590.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(520.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(CCJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C[CH]CC=CCO[O](7127)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'CC=CC[CH]CO[O](7128)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.46e+08,'cm^3/(mol*s)'), n=1.64, Ea=(5.73208,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2555 used for Cds-CsH_Cds-CsH;HJ
Exact match found for rate rule [Cds-CsH_Cds-CsH;HJ]
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C[CH]CCC=CO[O](7129)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C=CCC[CH]CO[O](6976)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['CC[CH]C[CH]CO[O](7092)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]CCC[CH]CO[O](7131)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]CC[CH][CH]OO(7132)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C[CH][CH]COO(7137)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH][CH]C[CH]COO(7138)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CC[CH]COO(7139)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH2][CH]CC[CH]C(163)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', 'C[CH]C[CH][CH]CO[O](7140)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C[CH][CH]C[CH]CO[O](7141)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'C[CH]CC[CH][CH]O[O](7142)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH2][CH]CC[CH]CO[O](6978)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C[CH]CC[CH]CO[O](6808)'],
    products = ['C=CCC[CH]C(161)', 'O2(S)(5486)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]CC[CH]CO[O](6808)'],
    products = ['O(T)(63)', 'C[CH]CCC1CO1(7149)'],
...
reaction(
    label = 'reaction39',
    reactants = ['O(T)(63)', 'C[CH]CC[CH]C[O](7151)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C[CH]C(38)', '[CH]CO[O](7037)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]C(32)', '[CH2]C[CH]CO[O](6922)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]CC[CH]C(131)', '[CH2]O[O](61)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH3](11)', '[CH]CC[CH]CO[O](7039)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(8)', 'C[CH]CC[C]CO[O](7152)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(8)', 'C[C]CC[CH]CO[O](7153)'],
    products = ['C[CH]CC[CH]CO[O](6808)'],
