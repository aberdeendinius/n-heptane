...
species(
    label = '[CH]=[C]C[CH]C[CH2](19186)',
    structure = SMILES('[CH]=[C]C[CH]C[CH2]'),
    E0 = (820.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3120,650,792.5,1650,3025,407.5,1350,352.5,1572.06,1572.22],'cm^-1')),
        HinderedRotor(inertia=(0.192288,'amu*angstrom^2'), symmetry=1, barrier=(4.42107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192313,'amu*angstrom^2'), symmetry=1, barrier=(4.42165,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192281,'amu*angstrom^2'), symmetry=1, barrier=(4.42093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.192296,'amu*angstrom^2'), symmetry=1, barrier=(4.42126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56583,0.0589343,-7.22178e-05,6.2709e-08,-2.30865e-11,98773,28.5318], Tmin=(100,'K'), Tmax=(805.296,'K')), NASAPolynomial(coeffs=[3.73302,0.0389245,-1.77256e-05,3.34128e-09,-2.30293e-13,98723.8,20.4069], Tmin=(805.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(820.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJCC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.35827,0.0381358,-1.63815e-05,2.79833e-09,-1.61988e-13,93468.2,24.1928], Tmin=(100,'K'), Tmax=(2997.18,'K')), NASAPolynomial(coeffs=[40.5724,-0.00395749,8.95337e-07,-2.01634e-10,1.79337e-14,67759.7,-201.867], Tmin=(2997.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(777.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(RCCJ) + radical(RCCJCC) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]=[C]CC[C][CH2](19195)',
    structure = SMILES('[CH]=[C]CC[C][CH2]'),
    E0 = (1074.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,290.616,290.648,290.72],'cm^-1')),
        HinderedRotor(inertia=(0.00199088,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00199677,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13115,'amu*angstrom^2'), symmetry=1, barrier=(7.86178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477512,'amu*angstrom^2'), symmetry=1, barrier=(28.6501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42136,0.059464,-5.98421e-05,3.45503e-08,-8.40503e-12,129301,26.4012], Tmin=(100,'K'), Tmax=(974.695,'K')), NASAPolynomial(coeffs=[8.85189,0.0289693,-1.29112e-05,2.44979e-09,-1.71319e-13,127853,-9.25617], Tmin=(974.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1074.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJ2_triplet) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH][CH]CC[C]=[CH](19196)',
    structure = SMILES('[CH][CH]CC[C]=[CH]'),
    E0 = (1063.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3120,650,792.5,1650,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43272,0.0608366,-7.61786e-05,6.16419e-08,-2.10035e-11,128000,28.3999], Tmin=(100,'K'), Tmax=(800.698,'K')), NASAPolynomial(coeffs=[5.98685,0.0330894,-1.48376e-05,2.7756e-09,-1.90544e-13,127431,8.4413], Tmin=(800.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1063.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)

species(
    label = '[C]=[C]CC[CH][CH2](19197)',
    structure = SMILES('[C]=[C]CC[CH][CH2]'),
    E0 = (1131.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,1587.71,1590.27],'cm^-1')),
        HinderedRotor(inertia=(0.153042,'amu*angstrom^2'), symmetry=1, barrier=(3.51875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152674,'amu*angstrom^2'), symmetry=1, barrier=(3.51027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153803,'amu*angstrom^2'), symmetry=1, barrier=(3.53623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153701,'amu*angstrom^2'), symmetry=1, barrier=(3.5339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52492,0.0618204,-8.9454e-05,8.29668e-08,-3.06639e-11,136177,28.8234], Tmin=(100,'K'), Tmax=(837.493,'K')), NASAPolynomial(coeffs=[3.42068,0.0371481,-1.72921e-05,3.25726e-09,-2.22965e-13,136407,23.2836], Tmin=(837.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1131.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(RCCJ) + radical(RCCJC) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=[C]CC=C[CH2](19184)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(48.2755,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 43.8 to 48.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]C[CH]C[CH2](19186)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]CC[CH][CH2](17740)'],
    products = ['[CH]=CC[CH][CH][CH2](19189)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]CC[CH][CH2](17740)'],
    products = ['[CH2][CH][CH]C[C]=C(17738)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]C[CH][CH][CH2](19190)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH][CH2](721)', '[CH]=[C]C[CH2](5188)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C[CH2](103)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[CH]=[C]CC[C][CH2](19195)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH][CH]CC[C]=[CH](19196)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[C]=[C]CC[CH][CH2](19197)'],
    products = ['[CH]=[C]CC[CH][CH2](17740)'],
