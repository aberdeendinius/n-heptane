...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.978743,0.0666773,-5.92857e-05,2.7147e-08,-5.09702e-12,-9371.97,31.1946], Tmin=(100,'K'), Tmax=(1250.71,'K')), NASAPolynomial(coeffs=[13.0088,0.0282029,-1.31422e-05,2.55101e-09,-1.80571e-13,-12381.2,-29.5345], Tmin=(1250.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.8246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + radical(CsJOC(O)C) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C(O)C(=O)C[O](29044)',
    structure = SMILES('C=[C]C(O)C(=O)C[O]'),
    E0 = (11.1129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,375,552.5,462.5,1710,1685,370,1380,1390,370,380,2900,435,404.452,404.455,404.474,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00103053,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108262,'amu*angstrom^2'), symmetry=1, barrier=(12.5669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108263,'amu*angstrom^2'), symmetry=1, barrier=(12.5669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108251,'amu*angstrom^2'), symmetry=1, barrier=(12.5668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853882,0.0721968,-7.9882e-05,4.80793e-08,-1.18325e-11,1447.38,32.3711], Tmin=(100,'K'), Tmax=(977.329,'K')), NASAPolynomial(coeffs=[11.4886,0.0286721,-1.3082e-05,2.51406e-09,-1.77178e-13,-631.393,-18.6916], Tmin=(977.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.1129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=OCOJ) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=C(O)C1([O])CO1(29045)',
    structure = SMILES('C=C=C(O)C1([O])CO1'),
    E0 = (-53.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,540,610,2055,3615,1277.5,1000,350,440,435,1725,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.58653,0.0929903,-0.000110283,6.04343e-08,-1.17976e-11,-6227.34,30.4714], Tmin=(100,'K'), Tmax=(1553.29,'K')), NASAPolynomial(coeffs=[23.0422,0.000724536,6.66997e-06,-1.71606e-09,1.29441e-13,-10399,-87.9935], Tmin=(1553.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = 'C#CC(O)C1([O])CO1(29046)',
    structure = SMILES('C#CC(O)C1([O])CO1'),
    E0 = (-10.2422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,750,770,3400,2100,3615,1277.5,1000,2175,525,1380,1390,370,380,2900,435,180,1022.05,1022.05,1022.05,1022.05,1022.05,1022.05,1022.05,1022.05,1022.05,2294.4],'cm^-1')),
        HinderedRotor(inertia=(0.0672714,'amu*angstrom^2'), symmetry=1, barrier=(1.5467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0672714,'amu*angstrom^2'), symmetry=1, barrier=(1.5467,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0672714,'amu*angstrom^2'), symmetry=1, barrier=(1.5467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.730499,0.0804622,-8.73257e-05,4.62405e-08,-8.90838e-12,-1041.21,30.6744], Tmin=(100,'K'), Tmax=(1550.27,'K')), NASAPolynomial(coeffs=[19.0428,0.00875551,2.07257e-06,-8.11495e-10,6.74318e-14,-4686.01,-65.3716], Tmin=(1550.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.2422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Ethylene_oxide) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2][C]=C(O)C1(O)CO1(29047)',
    structure = SMILES('[CH2][C]=C(O)C1(O)CO1'),
    E0 = (-73.9736,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.76889,0.102992,-0.00011814,6.14117e-08,-1.12669e-11,-8613.5,35.5668], Tmin=(100,'K'), Tmax=(1676.97,'K')), NASAPolynomial(coeffs=[25.6126,-0.00161084,8.43528e-06,-2.03067e-09,1.474e-13,-12943.2,-100.558], Tmin=(1676.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.9736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C(O)C1(O)[CH]O1(29048)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.54933,0.099734,-0.000112781,5.79316e-08,-1.05362e-11,1883.64,39.021], Tmin=(100,'K'), Tmax=(1685.16,'K')), NASAPolynomial(coeffs=[25.271,-0.000841367,7.48767e-06,-1.81076e-09,1.31221e-13,-2588.53,-95.1632], Tmin=(1685.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.3816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCsJO)"""),
)
...
species(
    label = '[CH]=[C]C(O)C1(O)CO1(29049)',
    structure = SMILES('[CH]=[C]C(O)C1(O)CO1'),
    E0 = (76.7554,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,3150,900,1100,3580,3650,1210,1345,900,1100,3120,650,792.5,1650,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.10459,0.0961027,-0.000108251,5.61562e-08,-1.03788e-11,9484.33,37.6141], Tmin=(100,'K'), Tmax=(1645.89,'K')), NASAPolynomial(coeffs=[24.2816,0.00120931,6.27111e-06,-1.5886e-09,1.17402e-13,4965.89,-90.172], Tmin=(1645.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.7554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C]=C(O)C1([O])CO1(29050)',
    structure = SMILES('[CH2][C]=C(O)C1([O])CO1'),
    E0 = (159.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1685,370,3615,1277.5,1000,350,440,435,1725,2750,3150,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.55071,0.0942377,-0.000113496,6.31064e-08,-1.25178e-11,19355.9,32.0391], Tmin=(100,'K'), Tmax=(1523.14,'K')), NASAPolynomial(coeffs=[23.3216,0.000552161,6.70192e-06,-1.73105e-09,1.31259e-13,15069.6,-87.6192], Tmin=(1523.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(C=CC(C)(O)OJ) + radical(Cds_S) + radical(Allyl_P)"""),
)

species(
    label = 'C=[C]C(O)C1([O])[CH]O1(29051)',
    structure = SMILES('C=[C]C(O)C1([O])[CH]O1'),
    E0 = (245.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,1000,2950,3100,1380,975,1025,1650,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.682774,0.0827042,-9.16298e-05,4.88229e-08,-9.54776e-12,29697.5,33.5634], Tmin=(100,'K'), Tmax=(1490.39,'K')), NASAPolynomial(coeffs=[20.9211,0.00743523,1.5233e-06,-6.28097e-10,5.26905e-14,25177.8,-72.8424], Tmin=(1490.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CC(C)(O)OJ) + radical(CCsJO)"""),
)

species(
    label = '[CH]=[C]C(O)C1([O])CO1(29052)',
    structure = SMILES('[CH]=[C]C(O)C1([O])CO1'),
    E0 = (308.746,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.300201,0.0797007,-8.88687e-05,4.88373e-08,-9.97445e-12,37301.2,32.3874], Tmin=(100,'K'), Tmax=(1401.91,'K')), NASAPolynomial(coeffs=[19.1748,0.0104538,-1.39623e-07,-3.17571e-10,3.25084e-14,33185,-63.3531], Tmin=(1401.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(CC(C)(O)OJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.83434,0.102037,-0.000115721,5.95104e-08,-1.07869e-11,-34195.3,34.1098], Tmin=(100,'K'), Tmax=(1703.14,'K')), NASAPolynomial(coeffs=[25.0945,-0.00116154,8.2874e-06,-1.9948e-09,1.44209e-13,-38254.7,-99.4904], Tmin=(1703.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-286.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432915,0.0861137,-0.000131066,1.14127e-07,-4.0133e-11,39573.1,36.1602], Tmin=(100,'K'), Tmax=(785.028,'K')), NASAPolynomial(coeffs=[8.49177,0.0360206,-1.8095e-05,3.53629e-09,-2.47805e-13,38586.1,1.00365], Tmin=(785.028,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsOsH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCOJ) + radical(Cs_P) + radical(CsJOCH3)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.217957,0.0932842,-0.000153508,1.38208e-07,-4.84118e-11,39230.4,34.7915], Tmin=(100,'K'), Tmax=(842.004,'K')), NASAPolynomial(coeffs=[8.0256,0.0367071,-1.80032e-05,3.43563e-09,-2.35596e-13,38606.4,2.56872], Tmin=(842.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    E0 = (190.888,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,1685,370,2750,3150,900,1100,180,1039.63,1039.63,1039.63,1039.63,1039.63,1039.63,1039.63,1039.63,1039.63,2275.93],'cm^-1')),
        HinderedRotor(inertia=(0.0962554,'amu*angstrom^2'), symmetry=1, barrier=(2.2131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0962554,'amu*angstrom^2'), symmetry=1, barrier=(2.2131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0962554,'amu*angstrom^2'), symmetry=1, barrier=(2.2131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0962554,'amu*angstrom^2'), symmetry=1, barrier=(2.2131,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=O)C(O)[C]=C(29043)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(140.607,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction3',
    reactants = ['C=[C]C(O)C(=O)C[O](29044)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=C=C(O)C1([O])CO1(29045)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CC(O)C1([O])CO1(29046)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', 'C=C=CC1([O])CO1(17989)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]C(O)C1([O])CO1(15048)'],
    products = ['[CH2][C]=C(O)C1(O)CO1(29047)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]C(O)C1([O])CO1(15048)'],
    products = ['C=[C]C(O)C1(O)[CH]O1(29048)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(O)C1(O)CO1(29049)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', 'C=[C][CH]C1([O])CO1(17996)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C]=C(O)C1([O])CO1(29050)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', 'C=[C]C(O)C1([O])[CH]O1(29051)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]=[C]C(O)C1([O])CO1(29052)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', 'C=[C]C(O)C([O])=O(14651)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(S)(1732)', 'C=[C]C(O)C(=C)[O](14497)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]C(O)C1([O])CO1(15048)'],
    products = ['C=C=C(O)C1(O)CO1(29053)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]O[C]([O])C(O)[C]=C(29054)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C=[C]C(O)[C]([O])C[O](29055)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=[C][CH]C1(CO1)OO(20690)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(T)(63)', 'C=[C]C(O)[C]1CO1(28326)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[C]=C(584)', '[O]C1([CH]O)CO1(2045)'],
    products = ['C=[C]C(O)C1([O])CO1(15048)'],
