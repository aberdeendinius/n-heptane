...
species(
    label = 'CC([O])[CH]C[O](3850)',
    structure = SMILES('CC([O])[CH]C[O]'),
    E0 = (179.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,398.487,398.488,1693.11,1693.12],'cm^-1')),
        HinderedRotor(inertia=(0.00106162,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0666793,'amu*angstrom^2'), symmetry=1, barrier=(7.51383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0666797,'amu*angstrom^2'), symmetry=1, barrier=(7.51388,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95203,0.0491499,-4.0383e-05,2.13645e-08,-5.35058e-12,21643,25.1974], Tmin=(100,'K'), Tmax=(890.631,'K')), NASAPolynomial(coeffs=[5.18251,0.0346417,-1.59492e-05,3.07557e-09,-2.17076e-13,21067.5,9.98626], Tmin=(890.631,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34027,0.0664659,-9.91934e-05,9.2307e-08,-3.41126e-11,18861.6,24.3038], Tmin=(100,'K'), Tmax=(831.777,'K')), NASAPolynomial(coeffs=[3.84131,0.0379503,-1.8035e-05,3.42687e-09,-2.35673e-13,19015.9,16.127], Tmin=(831.777,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCOJ)"""),
)
...
species(
    ...
    E0 = (359.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,242.966,247.752,251.745,1435.46],'cm^-1')),
        HinderedRotor(inertia=(0.00274334,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(8.18494e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141225,'amu*angstrom^2'), symmetry=1, barrier=(6.15231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.7085,0.0356906,-1.52108e-05,2.18328e-09,-6.02726e-14,-23150.4,15.4207], Tmin=(100,'K'), Tmax=(2776.2,'K')), NASAPolynomial(coeffs=[38.6912,-0.00349239,-1.02587e-07,1.11204e-11,4.22917e-15,-46898.3,-196.859], Tmin=(2776.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'CC(=O)C[CH][O](1108)'],
    products = ['CC([O])C[CH][O](3604)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', '[O][CH]CC=O(1049)'],
    products = ['CC([O])C[CH][O](3604)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH][O](605)', 'C=C[O](594)'],
    products = ['CC([O])C[CH][O](3604)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', '[O][CH]C[CH][O](1055)'],
    products = ['CC([O])C[CH][O](3604)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', 'C[C]([O])C[CH][O](1098)'],
    products = ['CC([O])C[CH][O](3604)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'CC([O])[CH][CH][O](1101)'],
    products = ['CC([O])C[CH][O](3604)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', '[O][CH]CC[O](679)'],
    products = ['CC([O])C[CH][O](3604)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O(T)(63)', 'C[CH]C[CH][O](479)'],
    products = ['CC([O])C[CH][O](3604)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C)[O](442)', '[CH][O](751)'],
    products = ['CC([O])C[CH][O](3604)'],
