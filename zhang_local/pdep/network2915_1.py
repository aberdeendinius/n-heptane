species(
    label = '[CH2][C]([CH2])OO[CH]O[O](10230)',
    structure = SMILES('[CH2][C]([CH2])OO[CH]O[O]'),
    E0 = (612.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,492.5,1135,1000,350,500,795,815,3025,407.5,1350,352.5,360,370,350,200],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.383651,0.107738,-0.000187965,1.67145e-07,-5.69604e-11,73861.1,34.915], Tmin=(100,'K'), Tmax=(855.9,'K')), NASAPolynomial(coeffs=[11.1203,0.0318327,-1.61334e-05,3.07802e-09,-2.09552e-13,72702.8,-14.0568], Tmin=(855.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(612.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(C2CsJOOC) + radical(ROOJ) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C]([CH2])OOC=O(11031)',
    structure = SMILES('[CH2][C]([CH2])OOC=O'),
    E0 = (150.014,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2782.5,750,1395,475,1775,1000,350,500,795,815,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.109749,'amu*angstrom^2'), symmetry=1, barrier=(37.5992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0412531,'amu*angstrom^2'), symmetry=1, barrier=(37.5922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63531,'amu*angstrom^2'), symmetry=1, barrier=(37.599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.63534,'amu*angstrom^2'), symmetry=1, barrier=(37.5997,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0412508,'amu*angstrom^2'), symmetry=1, barrier=(37.5999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.748395,0.0615136,-5.14378e-05,2.06418e-08,-3.25064e-12,18168,30.1896], Tmin=(100,'K'), Tmax=(1526.43,'K')), NASAPolynomial(coeffs=[17.8807,0.0166182,-7.31938e-06,1.373e-09,-9.47604e-14,12937.7,-59.7097], Tmin=(1526.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCOOH) + radical(C2CsJOOC) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C]([CH2])OOC1OO1(11032)',
    structure = SMILES('[CH2][C]([CH2])OOC1OO1'),
    E0 = (404.911,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.08,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.751447,0.0768613,-9.86056e-05,7.22303e-08,-2.18692e-11,48811.6,30.8884], Tmin=(100,'K'), Tmax=(798.691,'K')), NASAPolynomial(coeffs=[9.56451,0.0327251,-1.57171e-05,3.04531e-09,-2.1411e-13,47403.7,-9.6488], Tmin=(798.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsOsH) + ring(dioxirane) + radical(C2CsJOOC) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C]([CH2])OO[CH][O](11033)',
    structure = SMILES('[CH2][C]([CH2])OO[CH][O]'),
    E0 = (616.782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,360,370,350,350,500,795,815,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.203091,'amu*angstrom^2'), symmetry=1, barrier=(4.66947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00444803,'amu*angstrom^2'), symmetry=1, barrier=(4.64104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0044411,'amu*angstrom^2'), symmetry=1, barrier=(4.61447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0511318,'amu*angstrom^2'), symmetry=1, barrier=(52.9445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.30257,'amu*angstrom^2'), symmetry=1, barrier=(52.9406,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.603153,0.0913424,-0.00017596,1.78281e-07,-6.73726e-11,74288,30.324], Tmin=(100,'K'), Tmax=(848.393,'K')), NASAPolynomial(coeffs=[2.44912,0.0438676,-2.34726e-05,4.58989e-09,-3.1722e-13,75370.1,29.9452], Tmin=(848.393,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(616.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCOOH) + radical(C2CsJOOC) + radical(CJCOOH) + radical(OCJO) + radical(OCOJ)"""),
)
...
species(
    label = '[CH][C]([CH2])OO[CH]O[O](11034)',
    structure = SMILES('[CH][C]([CH2])OO[CH]O[O]'),
    E0 = (847.146,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,492.5,1135,1000,350,500,795,815,3025,407.5,1350,352.5,360,370,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.368679,0.108052,-0.000194251,1.74154e-07,-5.94143e-11,102034,34.5631], Tmin=(100,'K'), Tmax=(860.772,'K')), NASAPolynomial(coeffs=[11.3041,0.0296038,-1.53668e-05,2.94087e-09,-1.99871e-13,100921,-14.7928], Tmin=(860.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(847.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(C2CsJOOC) + radical(CCJ2_triplet) + radical(CJCOOH) + radical(OCJO) + radical(ROOJ)"""),
)

species(
    label = '[CH2][C]([CH2])OO[C]O[O](11035)',
    structure = SMILES('[CH2][C]([CH2])OO[C]O[O]'),
    E0 = (884.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,492.5,1135,1000,350,500,795,815,360,370,350,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.472843,0.0963712,-0.000128713,8.06197e-08,-1.92933e-11,106594,34.1817], Tmin=(100,'K'), Tmax=(1036.07,'K')), NASAPolynomial(coeffs=[21.6792,0.0108464,-4.89021e-06,9.4328e-10,-6.73039e-14,102004,-73.4737], Tmin=(1036.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(884.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CJCOOH) + radical(C2CsJOOC) + radical(CH2_triplet) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
...
reaction(
    label = 'reaction2',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])OOC=O(11031)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
    products = ['[CH2][C]([CH2])OOC1OO1(11032)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]O[CH]O[O](8054)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]O[O](2819)', '[CH2][C]([CH2])O[O](10040)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])OO[CH][O](11033)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O2(2)', '[CH]OO[C]([CH2])[CH2](10504)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH][C]([CH2])OO[CH]O[O](11034)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][C]([CH2])OO[C]O[O](11035)'],
    products = ['[CH2][C]([CH2])OO[CH]O[O](10230)'],
