...
species(
    label = '[CH2]CC1CC1[O](12924)',
    structure = SMILES('[CH2]CC1CC1[O]'),
    E0 = (248.607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76641,0.0339392,3.09985e-05,-6.51229e-08,2.74674e-11,29994.7,22.3985], Tmin=(100,'K'), Tmax=(966.091,'K')), NASAPolynomial(coeffs=[13.8713,0.0212064,-7.27963e-06,1.34829e-09,-9.93541e-14,25911.1,-44.6126], Tmin=(966.091,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60214,0.0486719,-3.01546e-05,9.42708e-09,-1.21164e-12,17950.3,26.6397], Tmin=(100,'K'), Tmax=(1744.86,'K')), NASAPolynomial(coeffs=[11.7303,0.0254534,-1.01942e-05,1.80067e-09,-1.18933e-13,14415.9,-27.8609], Tmin=(1744.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)[C]=O(12929)',
    structure = SMILES('[CH2]CC(C)[C]=O'),
    E0 = (107.291,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66028,0.0504135,-3.38999e-05,1.20077e-08,-1.79709e-12,12988.8,25.0802], Tmin=(100,'K'), Tmax=(1490.57,'K')), NASAPolynomial(coeffs=[9.80313,0.0285616,-1.19095e-05,2.17222e-09,-1.47454e-13,10561.3,-17.4545], Tmin=(1490.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CC(C)CJ=O)"""),
)
...
species(
    label = '[CH2]CC([CH2])[C]=O(12932)',
    structure = SMILES('[CH2]CC([CH2])[C]=O'),
    E0 = (317.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3157.08],'cm^-1')),
        HinderedRotor(inertia=(0.00207117,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163079,'amu*angstrom^2'), symmetry=1, barrier=(9.41018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.556863,'amu*angstrom^2'), symmetry=1, barrier=(32.0831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.163206,'amu*angstrom^2'), symmetry=1, barrier=(9.4132,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48321,0.0589466,-6.37413e-05,4.14149e-08,-1.1453e-11,38310.2,26.0826], Tmin=(100,'K'), Tmax=(861.354,'K')), NASAPolynomial(coeffs=[7.68726,0.0301343,-1.35635e-05,2.57645e-09,-1.79897e-13,37241.5,-2.92203], Tmin=(861.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CC(C)CJ=O) + radical(CJC(C)C=O)"""),
)

species(
    label = '[CH2]CC1[CH]OC1(12933)',
    structure = SMILES('[CH2]CC1[CH]OC1'),
    E0 = (232.781,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70512,0.0386076,2.13335e-05,-6.39231e-08,3.16702e-11,28091.1,21.157], Tmin=(100,'K'), Tmax=(866.419,'K')), NASAPolynomial(coeffs=[13.6107,0.0179808,-2.40419e-06,8.42857e-11,2.59955e-15,24739.2,-42.0114], Tmin=(866.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.781,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C([CH2])C[O](12937)',
    structure = SMILES('[CH2][CH]C([CH2])C[O]'),
    E0 = (496.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,1419.16,1419.37,1419.53],'cm^-1')),
        HinderedRotor(inertia=(0.174411,'amu*angstrom^2'), symmetry=1, barrier=(4.01005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174145,'amu*angstrom^2'), symmetry=1, barrier=(4.00394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00279036,'amu*angstrom^2'), symmetry=1, barrier=(3.99037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17425,'amu*angstrom^2'), symmetry=1, barrier=(4.00635,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6525,0.0578252,-7.2287e-05,6.55046e-08,-2.46619e-11,59850.2,29.6831], Tmin=(100,'K'), Tmax=(825.66,'K')), NASAPolynomial(coeffs=[2.51784,0.0409335,-1.85278e-05,3.46888e-09,-2.3762e-13,60140.2,28.2954], Tmin=(825.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCOJ) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]C(C=O)C[CH2](12941)',
    structure = SMILES('[CH]C(C=O)C[CH2]'),
    E0 = (396.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2782.5,750,1395,475,1775,1000,208.297,1114.04,1114.04,1114.04],'cm^-1')),
        HinderedRotor(inertia=(0.00388546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133796,'amu*angstrom^2'), symmetry=1, barrier=(4.11945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133798,'amu*angstrom^2'), symmetry=1, barrier=(4.11944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133797,'amu*angstrom^2'), symmetry=1, barrier=(4.11948,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70667,0.052862,-4.44594e-05,2.14294e-08,-4.48482e-12,47806.6,24.7702], Tmin=(100,'K'), Tmax=(1096.42,'K')), NASAPolynomial(coeffs=[7.93168,0.0301519,-1.33901e-05,2.53814e-09,-1.7737e-13,46441.6,-5.83498], Tmin=(1096.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(177207,'s^-1'), n=1.88643, Ea=(84.9111,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 80.3 to 84.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH2]C(C=C)C=O(12631)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=O(373)', '[CH2]CC=C(102)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
    transitionState = 'TS7',
...
reaction(
    ...
    products = ['[CH2]CC([CH2])C=O(12584)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.00310793,'m^3/(mol*s)'), n=2.49201, Ea=(26.6707,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-HH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 24.6 to 26.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC(C)=C[O](12926)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=O(373)', '[CH2][CH]C[CH2](103)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][CH]C([CH2])C=O(12931)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]CC([CH2])[C]=O(12932)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]C([CH2])C[O](12937)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[C-]#[O+](374)', '[CH2]CC[CH2](24)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C(C=O)C[CH2](12941)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(8)', '[CH]CC([CH2])C=O(12942)'],
    products = ['[CH2]CC([CH2])C=O(12584)'],
