...
species(
    label = '[O]C(=O)C=C=CO(28467)',
    structure = SMILES('[O]C(=O)C=C=CO'),
    E0 = (-96.3534,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,3615,1277.5,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,366.728,367.27,368.171,368.302,369.08,369.232],'cm^-1')),
        HinderedRotor(inertia=(0.0937698,'amu*angstrom^2'), symmetry=1, barrier=(8.91064,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0924374,'amu*angstrom^2'), symmetry=1, barrier=(8.89014,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38675,0.0614582,-8.43053e-05,6.16522e-08,-1.81058e-11,-11498.1,22.2487], Tmin=(100,'K'), Tmax=(830.948,'K')), NASAPolynomial(coeffs=[9.95351,0.020219,-9.86057e-06,1.92442e-09,-1.35771e-13,-12921.8,-17.4944], Tmin=(830.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.3534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-Cd)H) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(CCOJ)"""),
)

species(
    label = '[O]C(=O)CC#CO(28468)',
    structure = SMILES('[O]C(=O)CC#CO'),
    E0 = (-114.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,2100,2250,500,550,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38795,0.0338686,-1.38789e-05,-6.4257e-10,9.2618e-13,-13736.9,21.1682], Tmin=(100,'K'), Tmax=(1602.23,'K')), NASAPolynomial(coeffs=[12.601,0.0191204,-1.01348e-05,1.98663e-09,-1.37379e-13,-18389.3,-37.224], Tmin=(1602.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-CtH) + group(Cs-(Cds-O2d)CtHH) + group(Cds-OdCsOs) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.790951,0.0557851,-2.48542e-05,-1.83009e-08,1.30303e-11,-25472.4,22.0243], Tmin=(100,'K'), Tmax=(999.128,'K')), NASAPolynomial(coeffs=[20.8544,0.008608,-3.79044e-06,8.49002e-10,-6.97993e-14,-31136,-83.0322], Tmin=(999.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.859,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(Cds_S) + radical(C=CCJCO)"""),
)
...
species(
    label = 'O=C(O)C[C]=[C]O(28470)',
    structure = SMILES('O=C(O)C[C]=[C]O'),
    E0 = (-90.0318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3580,3650,1210,1345,900,1100,1670,1700,300,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07292,0.0550205,-4.76056e-05,1.92939e-08,-3.03762e-12,-10715.1,26.9606], Tmin=(100,'K'), Tmax=(1535.74,'K')), NASAPolynomial(coeffs=[17.5308,0.0121542,-5.73704e-06,1.11875e-09,-7.8922e-14,-15770.2,-59.4999], Tmin=(1535.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.0318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(Cds_S)"""),
)
...
species(
    label = '[O]C([O])=C[C]=CO(28471)',
    structure = SMILES('[O]C([O])=C[C]=CO'),
    E0 = (1.11992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1277.5,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.4095,'amu*angstrom^2'), symmetry=1, barrier=(32.4072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41453,'amu*angstrom^2'), symmetry=1, barrier=(32.5229,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408156,0.0771193,-9.38264e-05,5.1063e-08,-1.00374e-11,310.504,25.7352], Tmin=(100,'K'), Tmax=(1483.89,'K')), NASAPolynomial(coeffs=[22.8164,-0.0028867,4.63853e-06,-1.07709e-09,7.8379e-14,-4666.23,-89.0206], Tmin=(1483.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.11992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=CJC=C) + radical(C=COJ) + radical(C=COJ)"""),
)

species(
    label = '[O]C(=O)C[C]=[C]O(28472)',
    structure = SMILES('[O]C(=O)C[C]=[C]O'),
    E0 = (135.673,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3615,1277.5,1000,1670,1700,300,440,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14504,0.0443029,-3.35422e-05,1.17636e-08,-1.67895e-12,16380.8,23.2497], Tmin=(100,'K'), Tmax=(1564.11,'K')), NASAPolynomial(coeffs=[11.222,0.0210901,-1.1281e-05,2.27529e-09,-1.62391e-13,13541.3,-24.6015], Tmin=(1564.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + radical(C=CJO) + radical(CCOJ) + radical(Cds_S)"""),
)

species(
    label = 'OC=[C]C[C]1OO1(28473)',
    structure = SMILES('OC=[C]C[C]1OO1'),
    E0 = (251.926,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929115,0.0500816,-2.8545e-06,-5.59936e-08,3.26583e-11,30426.8,25.5361], Tmin=(100,'K'), Tmax=(890.742,'K')), NASAPolynomial(coeffs=[23.8297,-0.00403434,6.22796e-06,-1.38315e-09,9.59386e-14,24414.3,-93.1463], Tmin=(890.742,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(dioxirane) + radical(Cs_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.880621,0.0660406,-7.90614e-05,4.65516e-08,-1.06075e-11,-38620.1,23.8883], Tmin=(100,'K'), Tmax=(1082.32,'K')), NASAPolynomial(coeffs=[15.3509,0.0125611,-4.94262e-06,8.96751e-10,-6.18137e-14,-41752.4,-47.067], Tmin=(1082.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-322.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(O2s-(Cds-Cd)H) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cdd-CdsCds)"""),
)

species(
    label = '[O]C([O])[CH][C]=CO(28474)',
    structure = SMILES('[O]C([O])[CH][C]=CO'),
    E0 = (220.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3615,1277.5,1000,1380,1390,370,380,2900,435,394.425,394.425,394.426,394.429],'cm^-1')),
        HinderedRotor(inertia=(0.163425,'amu*angstrom^2'), symmetry=1, barrier=(18.0418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.511244,'amu*angstrom^2'), symmetry=1, barrier=(56.4391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240085,'amu*angstrom^2'), symmetry=1, barrier=(26.5044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972527,0.070211,-8.99332e-05,6.02057e-08,-1.61367e-11,26661.5,25.3802], Tmin=(100,'K'), Tmax=(908.651,'K')), NASAPolynomial(coeffs=[11.8708,0.0222347,-1.07325e-05,2.09609e-09,-1.4853e-13,24681,-26.1532], Tmin=(908.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=CCJCO) + radical(Cds_S) + radical(CCOJ) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]C(=O)C=C=CO(28467)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C(=O)CC#CO(28468)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[O]C(=O)C[C]=CO(14634)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8.04,'m^3/(mol*s)'), n=1.68, Ea=(112.344,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cdd_Od;CJ] for rate rule [CO2;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C#CCC([O])=O(17931)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['OH(D)(132)', 'C#CC[C]([O])[O](5453)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[O]C([O])=C[C]=CO(28471)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[O]C(=O)C[C]=[C]O(28472)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=C([O])[O](1172)', '[C]=CO(27807)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(T)(63)', 'O=[C]C[C]=CO(28268)'],
    products = ['[O]C(=O)C[C]=CO(14634)'],
