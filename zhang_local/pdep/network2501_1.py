...
species(
    label = '[CH2]OC(=C)O[C]=O(9700)',
    structure = SMILES('[CH2]OC(=C)O[C]=O'),
    E0 = (-44.1959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,180,180,902.66,903.514],'cm^-1')),
        HinderedRotor(inertia=(0.0712584,'amu*angstrom^2'), symmetry=1, barrier=(16.6068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44767,'amu*angstrom^2'), symmetry=1, barrier=(33.2848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.718148,'amu*angstrom^2'), symmetry=1, barrier=(16.5116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.717016,'amu*angstrom^2'), symmetry=1, barrier=(16.4856,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04832,0.067118,-8.13904e-05,5.03494e-08,-1.23899e-11,-5211.03,22.265], Tmin=(100,'K'), Tmax=(989.114,'K')), NASAPolynomial(coeffs=[12.7815,0.0196693,-9.43447e-06,1.85116e-09,-1.31997e-13,-7532.13,-34.2123], Tmin=(989.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.1959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=COCJ) + radical((O)CJOC)"""),
)
...
species(
    label = 'CC1([CH]O1)O[C]=O(9702)',
    structure = SMILES('CC1([CH]O1)O[C]=O'),
    E0 = (-86.4736,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.794993,0.0481294,2.15904e-05,-9.40464e-08,5.02257e-11,-10263.6,20.6363], Tmin=(100,'K'), Tmax=(874.533,'K')), NASAPolynomial(coeffs=[27.3438,-0.00946489,1.0884e-05,-2.41759e-09,1.71552e-13,-17348.2,-117.844], Tmin=(874.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.4736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical((O)CJOC) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C1([CH]O1)OC=O(9703)',
    structure = SMILES('[CH2]C1([CH]O1)OC=O'),
    E0 = (-72.4121,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.644355,0.0532319,5.80705e-06,-7.70196e-08,4.39235e-11,-8568.61,22.3015], Tmin=(100,'K'), Tmax=(873.297,'K')), NASAPolynomial(coeffs=[27.2262,-0.00893783,1.02481e-05,-2.28177e-09,1.62374e-13,-15483.5,-115.348], Tmin=(873.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.4121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C1([CH]O1)O[C]=O(9704)',
    structure = SMILES('[CH2]C1([CH]O1)O[C]=O'),
    E0 = (124.036,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3100,440,815,1455,1000,1855,455,950,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.40645,0.0827608,-9.90843e-05,5.26401e-08,-9.81637e-12,15144.1,28.2879], Tmin=(100,'K'), Tmax=(1652.9,'K')), NASAPolynomial(coeffs=[21.9818,-0.00463289,8.17082e-06,-1.89064e-09,1.36145e-13,11619,-83.5752], Tmin=(1652.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=[C]O[C]1CCO1(9705)',
    structure = SMILES('O=[C]O[C]1CCO1'),
    E0 = (-45.9026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98315,0.0353736,6.44569e-06,-3.81148e-08,1.9382e-11,-5439.73,21.5894], Tmin=(100,'K'), Tmax=(894.154,'K')), NASAPolynomial(coeffs=[11.5633,0.017112,-4.17965e-06,5.70386e-10,-3.53437e-14,-8136.18,-29.0557], Tmin=(894.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.9026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-OdOsH) + ring(Oxetane) + radical(Cs_P) + radical((O)CJOC)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])O[C]=O(9706)',
    structure = SMILES('[CH2]O[C]([CH2])O[C]=O'),
    E0 = (214.052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22109,0.0661102,-8.53942e-05,6.01055e-08,-1.73063e-11,25840.2,27.4453], Tmin=(100,'K'), Tmax=(840.248,'K')), NASAPolynomial(coeffs=[9.75559,0.0254804,-1.28602e-05,2.55388e-09,-1.82356e-13,24406,-12.2429], Tmin=(840.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-OdOsH) + radical(CJCO) + radical(CsJOCH3) + radical((O)CJOC) + radical(Cs_P)"""),
)
...
species(
    label = '[CH]C1(CO1)O[C]=O(9709)',
    structure = SMILES('[CH]C1(CO1)O[C]=O'),
    E0 = (178.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,1855,455,950,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.941326,0.0476338,1.13523e-05,-7.89176e-08,4.40045e-11,21539.8,20.9132], Tmin=(100,'K'), Tmax=(868.999,'K')), NASAPolynomial(coeffs=[25.6584,-0.00892585,1.02249e-05,-2.29021e-09,1.63943e-13,15083.7,-107.291], Tmin=(868.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + ring(Ethylene_oxide) + radical((O)CJOC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C1(CO1)O[C]=O(9295)'],
...
reaction(
    ...
    products = ['[CH2]C1(CO1)O[C]=O(9295)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(55.1378,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 52.1 to 55.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]C1(CO1)O[C]=O(9295)'],
    products = ['CC1([CH]O1)O[C]=O(9702)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C1(CO1)O[C]=O(9295)'],
    products = ['[CH2]C1([CH]O1)OC=O(9703)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH2]C1([CH]O1)O[C]=O(9704)'],
    products = ['[CH2]C1(CO1)O[C]=O(9295)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(S)(14)', '[CH2]C(=O)O[C]=O(3204)'],
    products = ['[CH2]C1(CO1)O[C]=O(9295)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O(S)(1732)', '[CH2]C(=C)O[C]=O(6540)'],
    products = ['[CH2]C1(CO1)O[C]=O(9295)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]O[C]([CH2])O[C]=O(9706)'],
    products = ['[CH2]C1(CO1)O[C]=O(9295)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]C1(CO1)O[C]=O(9709)'],
    products = ['[CH2]C1(CO1)O[C]=O(9295)'],
