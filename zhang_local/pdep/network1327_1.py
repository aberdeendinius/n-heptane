...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.5132,'amu*angstrom^2'), symmetry=1, barrier=(34.7913,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51568,'amu*angstrom^2'), symmetry=1, barrier=(34.8485,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.950776,'amu*angstrom^2'), symmetry=1, barrier=(21.8602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.950259,'amu*angstrom^2'), symmetry=1, barrier=(21.8483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    label = '[CH]=[C]OC[O](4561)',
    structure = SMILES('[CH]=[C]OC[O]'),
    E0 = (374.322,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,1685,370,343.894,343.903,343.926],'cm^-1')),
        HinderedRotor(inertia=(0.305694,'amu*angstrom^2'), symmetry=1, barrier=(25.6529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305704,'amu*angstrom^2'), symmetry=1, barrier=(25.6529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06181,0.0312166,-7.99465e-08,-3.27376e-08,1.75837e-11,45100.9,19.7282], Tmin=(100,'K'), Tmax=(935.129,'K')), NASAPolynomial(coeffs=[15.7359,0.00172308,7.16098e-07,-1.45191e-10,5.3337e-15,41275.6,-52.1033], Tmin=(935.129,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P) + radical(OCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OC=O(4555)'],
    products = ['C=[C]OC[O](4207)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction15',
    reactants = ['O(T)(63)', '[CH2]O[C]=C(4272)'],
    products = ['C=[C]OC[O](4207)'],
