...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17224,'amu*angstrom^2'), symmetry=1, barrier=(26.9522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17236,'amu*angstrom^2'), symmetry=1, barrier=(26.9549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17321,'amu*angstrom^2'), symmetry=1, barrier=(26.9743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]OC=C(4212)'],
    products = ['[CH2]CO[C]=C(4189)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][CH]O[C]=C(4303)'],
    products = ['[CH2]CO[C]=C(4189)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]OC[CH2](4304)'],
    products = ['[CH2]CO[C]=C(4189)'],
