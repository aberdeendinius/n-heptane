...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84757,0.0205151,-1.01709e-06,-1.20079e-08,5.67756e-12,-38821.5,14.1642], Tmin=(100,'K'), Tmax=(1016.05,'K')), NASAPolynomial(coeffs=[7.68238,0.0122604,-4.74373e-06,8.78359e-10,-6.21408e-14,-40360.3,-11.976], Tmin=(1016.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-323.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH)"""),
)
