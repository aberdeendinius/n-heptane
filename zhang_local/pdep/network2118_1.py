...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00267388,'amu*angstrom^2'), symmetry=1, barrier=(3.13624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0297424,'amu*angstrom^2'), symmetry=1, barrier=(34.8862,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51746,'amu*angstrom^2'), symmetry=1, barrier=(34.8893,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2][CH]OCO[O](8199)',
    structure = SMILES('[CH2][CH]OCO[O]'),
    E0 = (187.773,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0566306,0.0730059,-8.55648e-05,4.59684e-08,-9.05625e-12,22743.9,27.2244], Tmin=(100,'K'), Tmax=(1444.82,'K')), NASAPolynomial(coeffs=[21.4166,0.00096881,2.29239e-06,-6.0086e-10,4.5145e-14,17852.8,-79.7265], Tmin=(1444.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(ROOJ) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[CH]OO(8200)',
    structure = SMILES('[CH2][CH]O[CH]OO'),
    E0 = (224.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.315281,0.0848249,-0.000132737,1.02859e-07,-3.085e-11,27157.7,24.9245], Tmin=(100,'K'), Tmax=(851.008,'K')), NASAPolynomial(coeffs=[14.5027,0.0158511,-7.12814e-06,1.29894e-09,-8.65318e-14,24825.9,-40.7458], Tmin=(851.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCJO) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COC1OO1(8204)',
    structure = SMILES('[CH2]COC1OO1'),
    E0 = (-11.7055,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82274,0.0458498,-3.87796e-05,1.7835e-08,-3.38218e-12,-1327.81,20.8582], Tmin=(100,'K'), Tmax=(1245.83,'K')), NASAPolynomial(coeffs=[9.72764,0.0204694,-8.22108e-06,1.48253e-09,-1.00724e-13,-3297.44,-19.0158], Tmin=(1245.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.7055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]CO[CH][O](1006)',
    structure = SMILES('[CH2]CO[CH][O]'),
    E0 = (200.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,1142.99,1143.3],'cm^-1')),
        HinderedRotor(inertia=(0.121911,'amu*angstrom^2'), symmetry=1, barrier=(2.80299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121863,'amu*angstrom^2'), symmetry=1, barrier=(2.80186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121813,'amu*angstrom^2'), symmetry=1, barrier=(2.80073,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87681,0.057725,-0.000106032,1.09469e-07,-4.21849e-11,24140.1,19.583], Tmin=(100,'K'), Tmax=(849.902,'K')), NASAPolynomial(coeffs=[1.36328,0.0337806,-1.72474e-05,3.33097e-09,-2.29274e-13,25179.5,27.5781], Tmin=(849.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCO) + radical(OCJO) + radical(OCOJ)"""),
)
...
species(
    label = '[CH2]CO[C]O[O](8206)',
    structure = SMILES('[CH2]CO[C]O[O]'),
    E0 = (468.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,290.72,290.726,290.737,290.743],'cm^-1')),
        HinderedRotor(inertia=(0.283155,'amu*angstrom^2'), symmetry=1, barrier=(16.9812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283108,'amu*angstrom^2'), symmetry=1, barrier=(16.9812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283091,'amu*angstrom^2'), symmetry=1, barrier=(16.9813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283128,'amu*angstrom^2'), symmetry=1, barrier=(16.9813,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.200299,0.0699285,-8.44031e-05,4.59968e-08,-9.22417e-12,56472.7,25.5895], Tmin=(100,'K'), Tmax=(1392.02,'K')), NASAPolynomial(coeffs=[21.3288,-0.000587831,2.14673e-06,-5.12823e-10,3.73083e-14,51540.2,-79.9199], Tmin=(1392.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(468.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CJCO) + radical(CH2_triplet) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CO[CH]O[O](8052)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', '[CH2]COC=O(1009)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2]CO[CH]O[O](8013)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(8000,'m^3/(mol*s)'), n=1.39, Ea=(78.647,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_CO-NdH;YJ] for rate rule [Od_CO-NdH;CJ]
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][CH]O[CH]O[O](8202)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C[O](419)', '[CH]O[O](2819)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O(T)(63)', '[CH2]CO[CH][O](1006)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', '[CH2]O[CH]O[O](8127)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]CO[CH]O[O](8205)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]CO[C]O[O](8206)'],
    products = ['[CH2]CO[CH]O[O](8013)'],
