...
species(
    label = '[CH][C](C)OC([CH2])=C(18321)',
    structure = SMILES('[CH][C](C)OC([CH2])=C'),
    E0 = (543.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0224515,0.0823386,-8.73098e-05,4.67963e-08,-9.80561e-12,65533.1,28.8309], Tmin=(100,'K'), Tmax=(1170.24,'K')), NASAPolynomial(coeffs=[18.1984,0.0200558,-7.47406e-06,1.31375e-09,-8.87989e-14,61268.7,-61.9381], Tmin=(1170.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(CCJ2_triplet) + radical(C2CsJOC(O))"""),
)

species(
    label = '[CH]C(=C)OC([CH2])[CH2](18322)',
    structure = SMILES('[CH]C(=C)OC([CH2])[CH2]'),
    E0 = (527.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.405479,0.0941273,-0.000104849,6.07193e-08,-1.39009e-11,63662.8,28.322], Tmin=(100,'K'), Tmax=(1068.06,'K')), NASAPolynomial(coeffs=[17.5191,0.0269967,-1.0568e-05,1.86973e-09,-1.25842e-13,59833.9,-59.3337], Tmin=(1068.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(527.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)O[C]([CH2])C(18323)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0275111,0.0876577,-9.4184e-05,5.4145e-08,-1.25648e-11,62406.4,29.2111], Tmin=(100,'K'), Tmax=(1042.11,'K')), NASAPolynomial(coeffs=[14.6437,0.031555,-1.34299e-05,2.48391e-09,-1.71325e-13,59360.1,-41.9062], Tmin=(1042.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(517.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(AllylJ2_triplet) + radical(C2CsJOC(O))"""),
)
...
species(
    label = '[CH2][C]1CC[C]([CH2])O1(18325)',
    structure = SMILES('[CH2][C]1CC[C]([CH2])O1'),
    E0 = (511.019,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546762,0.0815602,-0.00011438,9.15221e-08,-2.80342e-11,61580.6,23.1041], Tmin=(100,'K'), Tmax=(977.851,'K')), NASAPolynomial(coeffs=[7.90359,0.0328706,-1.11659e-05,1.70634e-09,-9.9644e-14,61030.9,-7.6776], Tmin=(977.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5.17159e+11,'s^-1'), n=-0.0562706, Ea=(104.65,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.8852e+11,'s^-1'), n=0.481, Ea=(126.813,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][C](C)OC([CH2])=C(18321)'],
    products = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C(=C)OC([CH2])[CH2](18322)'],
    products = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    products = ['[CH]C(=C)O[C]([CH2])C(18323)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.504e+06,'s^-1'), n=1.7613, Ea=(160.143,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Estimated using template [R5Hall;C_rad_out_2H;Cd_H_out_singleH] for rate rule [R5HJ_1;C_rad_out_2H;Cd_H_out_singleH]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 16.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH]C(=C)O[C]([CH2])[CH2](18324)'],
    products = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    products = ['[CH2][C]([CH2])O[C]1CC1(11851)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
    products = ['[CH2][C]1CC[C]([CH2])O1(18325)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(1.79784e+11,'s^-1'), n=0.314866, Ea=(116.337,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_linear;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(6.48e+12,'s^-1'), n=-0.305, Ea=(8.28432,'kJ/mol'), T0=(1,'K'), Tmin=(600,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R4_SSS;Y_rad_out;Cpri_rad_out_2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(=C)[O](4273)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(28)', '[CH2][C]OC([CH2])=C(6490)'],
    products = ['[CH2][C]([CH2])OC([CH2])=C(10838)'],
