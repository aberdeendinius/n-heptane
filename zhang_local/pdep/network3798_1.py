...
species(
    label = 'C=C=CC[CH]CO[O](18677)',
    structure = SMILES('C=C=CC[CH]CO[O]'),
    E0 = (364.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,540,610,2055,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,273.965,274.054,274.125],'cm^-1')),
        HinderedRotor(inertia=(0.306897,'amu*angstrom^2'), symmetry=1, barrier=(16.3489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128526,'amu*angstrom^2'), symmetry=1, barrier=(6.84654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128497,'amu*angstrom^2'), symmetry=1, barrier=(6.84598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128558,'amu*angstrom^2'), symmetry=1, barrier=(6.84524,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490518,0.0828011,-0.000100077,7.31532e-08,-2.2552e-11,43945.3,32.3207], Tmin=(100,'K'), Tmax=(780.029,'K')), NASAPolynomial(coeffs=[8.74916,0.0404528,-1.86452e-05,3.55973e-09,-2.48424e-13,42656.8,-5.47127], Tmin=(780.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C#CCC[CH]CO[O](18679)',
    structure = SMILES('C#CCC[CH]CO[O]'),
    E0 = (366.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,750,770,3400,2100,2175,525,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.207591,0.0886168,-0.000118625,9.32506e-08,-2.97138e-11,44165.4,32.5529], Tmin=(100,'K'), Tmax=(844.817,'K')), NASAPolynomial(coeffs=[9.56504,0.0375899,-1.60911e-05,2.92047e-09,-1.96167e-13,42824.2,-9.59371], Tmin=(844.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.21382,0.0900228,-0.000119217,9.80253e-08,-3.35329e-11,51368.8,33.006], Tmin=(100,'K'), Tmax=(790.774,'K')), NASAPolynomial(coeffs=[7.71958,0.0451008,-2.08125e-05,3.94182e-09,-2.72362e-13,50399.2,-0.0680003], Tmin=(790.774,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(ROOJ) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[CH][CH]OO(18681)',
    structure = SMILES('C=[C]CC[CH][CH]OO'),
    E0 = (474.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,1685,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0060429,0.0954089,-0.0001296,1.06913e-07,-3.66732e-11,57198.6,35.3421], Tmin=(100,'K'), Tmax=(769.339,'K')), NASAPolynomial(coeffs=[8.54532,0.0454958,-2.16532e-05,4.15999e-09,-2.89906e-13,56044.2,-2.62228], Tmin=(769.339,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][C]=CCCCO[O](18682)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.50451,0.081851,-8.61558e-05,5.41009e-08,-1.44981e-11,45427.6,31.6707], Tmin=(100,'K'), Tmax=(885.625,'K')), NASAPolynomial(coeffs=[9.2674,0.0422736,-1.91245e-05,3.64337e-09,-2.54968e-13,43875.4,-9.54107], Tmin=(885.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(ROOJ) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=[C]CCCCO[O](18683)',
    structure = SMILES('[CH]=[C]CCCCO[O]'),
    E0 = (484.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,3120,650,792.5,1650,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168841,0.0903856,-0.000117374,9.29328e-08,-3.07146e-11,58408.6,33.4237], Tmin=(100,'K'), Tmax=(773.101,'K')), NASAPolynomial(coeffs=[8.74791,0.0430215,-1.9702e-05,3.72789e-09,-2.5784e-13,57171.1,-5.18237], Tmin=(773.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[CH][CH]COO(18684)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.201239,0.0937092,-0.000138942,1.26268e-07,-4.59311e-11,57894.9,37.0083], Tmin=(100,'K'), Tmax=(823.567,'K')), NASAPolynomial(coeffs=[5.23509,0.0498909,-2.38557e-05,4.54921e-09,-3.13771e-13,57722.7,17.688], Tmin=(823.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(CCJCOOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=CC[CH]COO(18685)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321476,0.0867604,-9.4636e-05,6.00867e-08,-1.61509e-11,51255.8,33.8772], Tmin=(100,'K'), Tmax=(885.163,'K')), NASAPolynomial(coeffs=[10.0698,0.0427095,-1.99891e-05,3.86723e-09,-2.72987e-13,49530,-11.9639], Tmin=(885.163,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(Allyl_P) + radical(CCJCOOH)"""),
)

species(
    label = '[CH]=[C]CC[CH]COO(18686)',
    structure = SMILES('[CH]=[C]CC[CH]COO'),
    E0 = (532.948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,1685,370,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.318974,0.0903167,-0.000102001,5.45237e-08,-4.41769e-12,64222.6,34.493], Tmin=(100,'K'), Tmax=(593.349,'K')), NASAPolynomial(coeffs=[9.33091,0.043888,-2.08407e-05,4.02114e-09,-2.81916e-13,62901,-6.40528], Tmin=(593.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.951304,0.067762,-5.00987e-05,2.00545e-08,-3.4272e-12,14914.1,30.8446], Tmin=(100,'K'), Tmax=(1320.86,'K')), NASAPolynomial(coeffs=[10.7396,0.0381201,-1.64369e-05,3.06476e-09,-2.1157e-13,12328.3,-19.1021], Tmin=(1320.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C=C=CCCCO[O](18692)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.617546,0.0789334,-7.74684e-05,4.47807e-08,-1.11077e-11,19837.7,29.563], Tmin=(100,'K'), Tmax=(948.294,'K')), NASAPolynomial(coeffs=[9.39618,0.0419049,-1.88982e-05,3.6056e-09,-2.52876e-13,18172.7,-12.323], Tmin=(948.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]CCC=COO(18693)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258709,0.0782805,-6.75582e-05,3.0509e-08,-5.60188e-12,26266.3,32.8464], Tmin=(100,'K'), Tmax=(1291.58,'K')), NASAPolynomial(coeffs=[15.3805,0.0314489,-1.31697e-05,2.43575e-09,-1.68001e-13,22360.1,-43.9765], Tmin=(1291.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C=CCCC=CO[O](18694)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266943,0.0733919,-5.85886e-05,2.44104e-08,-4.1061e-12,15946.2,33.1087], Tmin=(100,'K'), Tmax=(1413.5,'K')), NASAPolynomial(coeffs=[16.1454,0.0284582,-1.09054e-05,1.92097e-09,-1.28502e-13,11457.3,-48.9907], Tmin=(1413.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]CC=CCOO(18695)',
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.262163,0.0666042,-5.20748e-05,2.28816e-08,-3.97958e-12,23102.2,27.8643], Tmin=(100,'K'), Tmax=(1587.31,'K')), NASAPolynomial(coeffs=[13.3884,0.0260688,-6.72176e-06,8.73557e-10,-4.71606e-14,19874.6,-38.5674], Tmin=(1587.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629342,0.0639995,-2.10255e-05,-2.36489e-08,1.63765e-11,29971.6,28.4072], Tmin=(100,'K'), Tmax=(901.222,'K')), NASAPolynomial(coeffs=[14.9789,0.0282776,-8.11927e-06,1.23822e-09,-7.93474e-14,26249.4,-45.6301], Tmin=(901.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxetane) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[CH]C[O](18698)',
    structure = SMILES('C=[C]CC[CH]C[O]'),
    E0 = (439.539,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04077,0.0522351,2.67687e-06,-9.98823e-08,9.59835e-11,52925.4,28.3256], Tmin=(100,'K'), Tmax=(447.458,'K')), NASAPolynomial(coeffs=[4.30255,0.0456959,-2.12602e-05,4.10582e-09,-2.89497e-13,52586,17.7024], Tmin=(447.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[C]CO[O](18699)',
    structure = SMILES('C=[C]CC[C]CO[O]'),
    E0 = (685.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,492.5,1135,1000,2950,3100,1380,975,1025,1650,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.595325,0.0838721,-9.12065e-05,4.08479e-08,3.40946e-12,82579.5,31.4658], Tmin=(100,'K'), Tmax=(582.416,'K')), NASAPolynomial(coeffs=[9.22897,0.0401226,-1.85688e-05,3.53248e-09,-2.45343e-13,81310.2,-7.78304], Tmin=(582.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(685.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]CC=CCO[O](18676)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=CC[CH]CO[O](18677)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C=[C]CCC=CO[O](18678)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CCC[CH]CO[O](18679)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'C=[C]CCC=C(17493)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C=[C]CC[CH]CO[O](17499)'],
    products = ['[CH2]C=CC[CH]CO[O](7948)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=CCC[CH]CO[O](17381)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]CC[CH][CH]OO(18681)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=[C]C[CH][CH]COO(18684)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=[C]CC[CH]CO[O](17499)'],
    products = ['[CH2][C]=CC[CH]COO(18685)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=[C]CC[CH]COO(18686)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH2][CH]CC[C]=C(17495)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', 'C=[C]C[CH][CH]CO[O](18687)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH2][C]=CC[CH]CO[O](18688)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', 'C=[C]CC[CH][CH]O[O](18689)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(8)', '[CH]=[C]CC[CH]CO[O](18690)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C=[C]CC[CH]CO[O](17499)'],
    products = ['O2(S)(5486)', 'C=[C]CCC=C(17493)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=[C]CC[CH]CO[O](17499)'],
    products = ['O(T)(63)', 'C=[C]CCC1CO1(18696)'],
...
reaction(
    label = 'reaction38',
    reactants = ['O(T)(63)', 'C=[C]CC[CH]C[O](18698)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C[C]=C(4316)', '[CH]CO[O](7037)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[C]=C(584)', '[CH2]C[CH]CO[O](6922)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]O[O](61)', '[CH]CC[C]=C(17535)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(8)', 'C=[C]CC[C]CO[O](18699)'],
    products = ['C=[C]CC[CH]CO[O](17499)'],
