...
species(
    label = '[CH2]C=[C]C([CH2])[CH2](19210)',
    structure = SMILES('[CH2]C=[C]C([CH2])[CH2]'),
    E0 = (715.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1607.12],'cm^-1')),
        HinderedRotor(inertia=(0.0879562,'amu*angstrom^2'), symmetry=1, barrier=(8.28041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0893846,'amu*angstrom^2'), symmetry=1, barrier=(8.18052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.767308,'amu*angstrom^2'), symmetry=1, barrier=(69.3502,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0375725,'amu*angstrom^2'), symmetry=1, barrier=(69.3681,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02621,0.0573666,-4.72317e-05,2.18689e-08,-4.10209e-12,86133.3,28.1831], Tmin=(100,'K'), Tmax=(1338.12,'K')), NASAPolynomial(coeffs=[11.9781,0.0231448,-7.2067e-06,1.09931e-09,-6.69153e-14,83335.1,-27.3469], Tmin=(1338.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(715.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C([CH2])[C]=[C]C(19211)',
    structure = SMILES('[CH2]C([CH2])[C]=[C]C'),
    E0 = (801.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180],'cm^-1')),
        HinderedRotor(inertia=(0.114299,'amu*angstrom^2'), symmetry=1, barrier=(2.62795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11404,'amu*angstrom^2'), symmetry=1, barrier=(2.62201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113312,'amu*angstrom^2'), symmetry=1, barrier=(2.60527,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33146,0.0605012,-6.68892e-05,4.70609e-08,-1.37988e-11,96498.4,27.2801], Tmin=(100,'K'), Tmax=(902.131,'K')), NASAPolynomial(coeffs=[7.25838,0.0307556,-1.16672e-05,1.99357e-09,-1.2943e-13,95570,0.0782796], Tmin=(902.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(801.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([CH2])=C[C]C(19212)',
    structure = SMILES('[CH2]C([CH2])=C[C]C'),
    E0 = (659.611,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08388,0.0541821,-2.34743e-05,-9.53586e-09,7.84323e-12,79446.6,23.5746], Tmin=(100,'K'), Tmax=(1006.33,'K')), NASAPolynomial(coeffs=[14.2138,0.0231482,-8.74939e-06,1.59913e-09,-1.12608e-13,75732.8,-45.1746], Tmin=(1006.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(659.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([CH2])C=[C][CH2](19217)',
    structure = SMILES('[CH]C([CH2])C=[C][CH2]'),
    E0 = (958.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,410.068,410.116,410.122,410.151],'cm^-1')),
        HinderedRotor(inertia=(0.00100225,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00100255,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00100206,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00100208,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06167,0.0574779,-4.97888e-05,2.31845e-08,-4.33239e-12,115373,27.9722], Tmin=(100,'K'), Tmax=(1293.13,'K')), NASAPolynomial(coeffs=[12.9682,0.0206483,-7.06783e-06,1.16026e-09,-7.45053e-14,112294,-32.531], Tmin=(1293.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(958.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(170.395,'m^3/(mol*s)'), n=1.5621, Ea=(49.4538,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds_Cds;HJ]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C#CC([CH2])[CH2](19209)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH2]C=C[C]=C(17761)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C=[C]C([CH2])[CH2](19210)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]=[C]C([CH2])C(18902)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])[C]=[C]C(19211)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=CC([CH2])[CH2](17719)'],
    products = ['[CH2]C([CH2])=C[C]C(19212)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][C]=C[C]([CH2])[CH2](19213)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]=[C]C([CH2])[CH2](19214)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', '[CH2][C]=C[CH][CH2](18852)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C([CH2])C=[C][CH2](19217)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', 'C#C[CH]C([CH2])[CH2](19176)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C]([CH2])C[C]=C(17718)'],
    products = ['[CH2][C]=CC([CH2])[CH2](17719)'],
