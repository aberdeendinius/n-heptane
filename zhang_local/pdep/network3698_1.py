...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]CC=C(17455)'],
    products = ['[CH2]CC[C]=C(17447)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]CC=C=C(17529)'],
    products = ['[CH2]CC[C]=C(17447)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH2][CH]C[C]=C(6432)'],
    products = ['[CH2]CC[C]=C(17447)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]=CC[CH2](17532)'],
    products = ['[CH2]CC[C]=C(17447)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]=[C]CC[CH2](6433)'],
    products = ['[CH2]CC[C]=C(17447)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[C]=C(584)', '[CH2]C[CH2](21)'],
    products = ['[CH2]CC[C]=C(17447)'],
