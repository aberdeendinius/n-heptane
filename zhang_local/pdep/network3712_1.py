...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7543,0.0209199,8.09393e-05,-1.49782e-07,6.84645e-11,12497.3,17.1554], Tmin=(100,'K'), Tmax=(891.375,'K')), NASAPolynomial(coeffs=[26.9339,-0.0154673,1.32612e-05,-2.75185e-09,1.87168e-13,4965.12,-118.497], Tmin=(891.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63485,0.0234464,1.81912e-05,-4.42244e-08,2.14043e-11,16947.9,14.3309], Tmin=(100,'K'), Tmax=(844.815,'K')), NASAPolynomial(coeffs=[8.54886,0.0153563,-2.79765e-06,2.36703e-10,-8.46132e-15,15238.1,-17.4088], Tmin=(844.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(C2CsJOO)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(8)', '[CH]=C(C)O[O](18725)'],
    products = ['C=C(C)O[O](7975)'],
    transitionState = 'TS8',
