...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.309165,0.0897067,-0.000127942,1.11898e-07,-3.93816e-11,52319.3,29.7261], Tmin=(100,'K'), Tmax=(833.947,'K')), NASAPolynomial(coeffs=[6.16453,0.0459588,-2.1081e-05,3.9505e-09,-2.69883e-13,51887.4,5.80611], Tmin=(833.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Tertalkyl) + radical(CJCO) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(C)[CH]C([CH2])[O](10327)',
    structure = SMILES('[CH2]C(C)[CH]C([CH2])[O]'),
    E0 = (476.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.206813,0.074434,-6.26037e-05,2.82705e-08,-5.14526e-12,57502.5,34.5097], Tmin=(100,'K'), Tmax=(1320.78,'K')), NASAPolynomial(coeffs=[15.5355,0.0280104,-9.88033e-06,1.65809e-09,-1.07962e-13,53453.4,-43.7072], Tmin=(1320.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CC(C)OJ) + radical(CJCO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]([O])[CH]C(C)C(10328)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.515079,0.0758699,-6.77846e-05,3.32743e-08,-6.76535e-12,54062.2,30.3506], Tmin=(100,'K'), Tmax=(1163.28,'K')), NASAPolynomial(coeffs=[12.5708,0.0344156,-1.4331e-05,2.64046e-09,-1.81838e-13,51257.4,-29.6348], Tmin=(1163.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C](C)CC([CH2])[O](10329)',
    structure = SMILES('[CH2][C](C)CC([CH2])[O]'),
    E0 = (462.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,360,370,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,245.128,884.616,1961.03],'cm^-1')),
        HinderedRotor(inertia=(0.100073,'amu*angstrom^2'), symmetry=1, barrier=(3.45636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100073,'amu*angstrom^2'), symmetry=1, barrier=(3.45636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100073,'amu*angstrom^2'), symmetry=1, barrier=(3.45636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100073,'amu*angstrom^2'), symmetry=1, barrier=(3.45636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100073,'amu*angstrom^2'), symmetry=1, barrier=(3.45636,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.477613,0.0826445,-0.000102998,8.09725e-08,-2.6478e-11,55738.8,32.1749], Tmin=(100,'K'), Tmax=(828.944,'K')), NASAPolynomial(coeffs=[7.52525,0.0421842,-1.81078e-05,3.31031e-09,-2.23965e-13,54792.1,0.833507], Tmin=(828.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](O)[CH]C([CH2])C(10330)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.278468,0.0825893,-8.96833e-05,5.52269e-08,-1.38571e-11,51029.2,33.8697], Tmin=(100,'K'), Tmax=(965.529,'K')), NASAPolynomial(coeffs=[12.1869,0.0332548,-1.30392e-05,2.30626e-09,-1.54499e-13,48729.7,-23.1636], Tmin=(965.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(Isobutyl) + radical(CCJCO) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(C)[CH][C](C)[O](10331)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576906,0.0736519,-6.50698e-05,3.25456e-08,-6.7719e-12,53278.2,31.969], Tmin=(100,'K'), Tmax=(1139.69,'K')), NASAPolynomial(coeffs=[11.727,0.0345184,-1.35649e-05,2.41792e-09,-1.63232e-13,50736.6,-23.282], Tmin=(1139.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJCO) + radical(C2CsJOH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C([CH2])CC([CH2])[O](10332)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224003,0.0791329,-7.64498e-05,4.14243e-08,-9.09493e-12,58120.8,33.035], Tmin=(100,'K'), Tmax=(1102.81,'K')), NASAPolynomial(coeffs=[13.5006,0.0309766,-1.09485e-05,1.8272e-09,-1.1839e-13,55192.5,-32.3161], Tmin=(1102.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Isobutyl) + radical(CJCO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C)C[C]([CH2])O(10333)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.110522,0.0959962,-0.000148276,1.31405e-07,-4.50902e-11,49284.5,33.1064], Tmin=(100,'K'), Tmax=(881.956,'K')), NASAPolynomial(coeffs=[6.45972,0.0436231,-1.91024e-05,3.45234e-09,-2.28832e-13,49081.5,8.47126], Tmin=(881.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CJCO) + radical(C2CsJOH) + radical(Tertalkyl)"""),
)

species(
    label = '[CH2][C](C)C[C](C)[O](10334)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448754,0.0865411,-0.000121695,1.06108e-07,-3.69315e-11,51531.9,31.067], Tmin=(100,'K'), Tmax=(859.01,'K')), NASAPolynomial(coeffs=[5.4416,0.0458523,-2.01922e-05,3.69856e-09,-2.48811e-13,51317.5,11.4833], Tmin=(859.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](O)CC([CH2])[CH2](10335)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0169836,0.0909414,-0.00011611,8.43548e-08,-2.44578e-11,51661,33.5183], Tmin=(100,'K'), Tmax=(915.66,'K')), NASAPolynomial(coeffs=[11.8264,0.0334659,-1.25555e-05,2.11505e-09,-1.35428e-13,49732.7,-21.2619], Tmin=(915.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(C2CsJOH) + radical(CJCO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C[C](C)[O](10336)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.370021,0.0808659,-8.71257e-05,5.55493e-08,-1.45997e-11,53906.4,31.3067], Tmin=(100,'K'), Tmax=(920.323,'K')), NASAPolynomial(coeffs=[10.7319,0.0358307,-1.3726e-05,2.38073e-09,-1.57047e-13,51999.1,-17.8234], Tmin=(920.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Isobutyl) + radical(Isobutyl) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.500338,0.0731451,-5.937e-05,2.56705e-08,-4.56576e-12,22995.5,28.4408], Tmin=(100,'K'), Tmax=(1320.39,'K')), NASAPolynomial(coeffs=[13.8731,0.0326339,-1.33486e-05,2.43441e-09,-1.66329e-13,19464,-39.7918], Tmin=(1320.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])=CC(C)C(10340)',
    structure = SMILES('[CH2]C([O])=CC(C)C'),
    E0 = (-2.13663,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH]C(C)C[C]([CH2])[O](10341)',
    structure = SMILES('[CH]C(C)C[C]([CH2])[O]'),
    E0 = (696.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35452,0.0829977,-9.14389e-05,5.60799e-08,-1.4101e-11,83930.2,30.1368], Tmin=(100,'K'), Tmax=(958.084,'K')), NASAPolynomial(coeffs=[12.0727,0.0340735,-1.48411e-05,2.78001e-09,-1.92883e-13,81684.8,-25.895], Tmin=(958.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(696.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CJCO) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH][C]([O])CC([CH2])C(10342)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409463,0.0808939,-8.92519e-05,5.61673e-08,-1.44938e-11,83146.4,31.0843], Tmin=(100,'K'), Tmax=(936.537,'K')), NASAPolynomial(coeffs=[11.4287,0.0338302,-1.38726e-05,2.50909e-09,-1.70228e-13,81082.4,-21.3546], Tmin=(936.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(690.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([O])CC(=C)C(10324)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([O])=CC([CH2])C(10325)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', '[CH2][CH]CC(=C)[O](4399)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(10000,'cm^3/(mol*s)'), n=2.41, Ea=(35.6124,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 417 used for Cds-CsH_Cds-HH;CsJ-HHH
Exact match found for rate rule [Cds-CsH_Cds-HH;CsJ-HHH]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 31.2 to 35.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.246938,'m^3/(mol*s)'), n=2.00579, Ea=(86.298,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 83.8 to 86.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2][C]([O])C[C](C)C(10326)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)[CH]C([CH2])[O](10327)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2][C]([O])[CH]C(C)C(10328)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C](C)CC([CH2])[O](10329)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2][C](O)[CH]C([CH2])C(10330)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2]C(C)[CH][C](C)[O](10331)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])CC([CH2])[O](10332)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2][C](C)C[C]([CH2])O(10333)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2][C](C)C[C](C)[O](10334)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2][C](O)CC([CH2])[CH2](10335)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2]C([CH2])C[C](C)[O](10336)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH3](11)', '[CH2][CH]C[C]([CH2])[O](6386)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C](C)C[C]([CH2])[O](10337)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]([O])[CH]C([CH2])C(10338)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C]([O])CC([CH2])[CH2](10191)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(14)', '[CH2]CC[C]([CH2])[O](6383)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C]([O])CC([CH2])C(10003)'],
    products = ['[CH2]C1([O])CC(C)C1(10004)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]([O])C[CH]C(832)', 'CH2(T)(28)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C([CH2])C(118)', '[CH2][C][O](2305)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH]C(C)C[C]([CH2])[O](10341)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[CH][C]([O])CC([CH2])C(10342)'],
    products = ['[CH2][C]([O])CC([CH2])C(10003)'],
