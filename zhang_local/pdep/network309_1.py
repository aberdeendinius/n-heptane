...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56989,0.0556621,-3.94378e-05,1.53513e-08,-2.61216e-12,5831.38,23.4412], Tmin=(100,'K'), Tmax=(1295.46,'K')), NASAPolynomial(coeffs=[8.37473,0.0346506,-1.51086e-05,2.83091e-09,-1.95938e-13,4068.32,-11.1498], Tmin=(1295.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.64998,0.0765696,-9.29918e-05,6.19924e-08,-1.66998e-11,65438.8,25.2486], Tmin=(100,'K'), Tmax=(902.804,'K')), NASAPolynomial(coeffs=[11.6401,0.0278751,-1.20844e-05,2.24566e-09,-1.54628e-13,63454.5,-26.6483], Tmin=(902.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCJ2_triplet) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=CO[CH][CH]C(767)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH2][CH]OC[CH]C(644)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(40.9285,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][CH]O[CH][CH]C(774)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C[O](425)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]O[CH2](417)', '[CH]C(32)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]CO[CH][CH2](723)', '[CH3](11)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][CH]OC[C]C(778)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH2][C]OC[CH]C(779)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[CH][CH]OC[CH]C(780)'],
    products = ['[CH2][CH]OC[CH]C(644)'],
