species(
    label = 'C=[C]CO[C]1CC1(17517)',
    structure = SMILES('C=[C]CO[C]1CC1'),
    E0 = (380.905,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60128,0.0567277,-4.18864e-05,1.77244e-08,-3.37938e-12,45895.2,24.575], Tmin=(100,'K'), Tmax=(1150.57,'K')), NASAPolynomial(coeffs=[7.13064,0.0375046,-1.68251e-05,3.20325e-09,-2.24157e-13,44622.8,-2.87651], Tmin=(1150.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.905,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.770396,0.0476497,3.4167e-05,-9.31476e-08,4.32156e-11,35495.6,24.2891], Tmin=(100,'K'), Tmax=(934.074,'K')), NASAPolynomial(coeffs=[23.5105,0.00984603,-7.97724e-07,9.05156e-11,-1.47326e-14,28648.4,-97.7802], Tmin=(934.074,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]COC1CC1(18085)',
    structure = SMILES('[CH]=[C]COC1CC1'),
    E0 = (447.297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,2950,3050,3150,900,950,1000,1050,1100,3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0394,0.0563998,-3.15154e-05,3.84996e-09,1.63386e-12,53911.3,27.0515], Tmin=(100,'K'), Tmax=(1149.83,'K')), NASAPolynomial(coeffs=[13.0327,0.0278135,-1.13592e-05,2.09868e-09,-1.45513e-13,50284.9,-36.2595], Tmin=(1149.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=COC1CC1(18089)',
    structure = SMILES('C=C=COC1CC1'),
    E0 = (81.245,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842661,0.045191,4.13429e-05,-1.00607e-07,4.58379e-11,9907.52,22.3291], Tmin=(100,'K'), Tmax=(934.604,'K')), NASAPolynomial(coeffs=[23.6094,0.00954327,-6.16287e-07,6.45644e-11,-1.37006e-14,2953.26,-100.405], Tmin=(934.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclopropane)"""),
)

species(
    label = 'C=CCOC1=CC1(18090)',
    structure = SMILES('C=CCOC1=CC1'),
    E0 = (150.788,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928451,0.0515765,2.91825e-06,-4.69291e-08,2.32654e-11,18260.6,24.4036], Tmin=(100,'K'), Tmax=(962.358,'K')), NASAPolynomial(coeffs=[18.191,0.0185729,-6.03466e-06,1.11086e-09,-8.30002e-14,13143.8,-67.5381], Tmin=(962.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]COC1=CC1(18080)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=CO[C]1CC1(18081)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CCO[C]1CC1(18082)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C=[C]COC1[CH]C1(18083)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]COC1=CC1(11866)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(3.37e+07,'s^-1'), n=1.41, Ea=(177.82,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [RnH;C_rad_out_H/NonDeC;Cd_H_out_doubleC] for rate rule [R5HJ_1;C_rad_out_H/NonDeC;Cd_H_out_doubleC]
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', 'C=[C]CO[C]1[CH]C1(18086)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', 'C=[C][CH]O[C]1CC1(18087)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]CO[C]1CC1(18088)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=[C]C[O](4571)', '[C]1CC1(11616)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[C]=C(584)', '[CH2]O[C]1CC1(11545)'],
    products = ['C=[C]CO[C]1CC1(17517)'],
