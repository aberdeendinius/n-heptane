species(
    label = 'O=[C]OO[C]1CC1(11549)',
    structure = SMILES('O=[C]OO[C]1CC1'),
    E0 = (81.1341,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50124,0.0405143,7.1939e-06,-4.21596e-08,1.94625e-11,9860.97,22.3528], Tmin=(100,'K'), Tmax=(994.474,'K')), NASAPolynomial(coeffs=[16.1703,0.0155006,-6.34334e-06,1.2828e-09,-9.80916e-14,5262.66,-56.786], Tmin=(994.474,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.1341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(C2CsJOOC) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=[C]OOC1=CC1(12013)',
    structure = SMILES('O=[C]OOC1=CC1'),
    E0 = (138.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,350,500,795,815,1855,455,950,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44374,0.0417313,-5.61928e-07,-3.77823e-08,1.92769e-11,16774.1,23.4515], Tmin=(100,'K'), Tmax=(972.139,'K')), NASAPolynomial(coeffs=[17.9409,0.00858004,-2.99582e-06,6.3456e-10,-5.27704e-14,11925.6,-64.1119], Tmin=(972.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclopropene) + radical((O)CJOC)"""),
)
...
species(
    label = 'O=COO[C]1[CH]C1(12015)',
    structure = SMILES('O=COO[C]1[CH]C1'),
    E0 = (85.1006,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73578,0.0347585,1.95502e-05,-5.16293e-08,2.18329e-11,10330,25.8828], Tmin=(100,'K'), Tmax=(1007.37,'K')), NASAPolynomial(coeffs=[15.1932,0.017121,-7.49248e-06,1.54448e-09,-1.18147e-13,5802.3,-48.156], Tmin=(1007.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.1006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(CCJCOOH) + radical(C2CsJOOC)"""),
)
...
species(
    label = 'O=[C]OO[C]1[CH]C1(12016)',
    structure = SMILES('O=[C]OO[C]1[CH]C1'),
    E0 = (281.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,350,500,795,815,1855,455,950,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52211,0.0425806,-8.79422e-06,-2.29891e-08,1.23011e-11,33962.2,25.2767], Tmin=(100,'K'), Tmax=(1013.06,'K')), NASAPolynomial(coeffs=[15.4977,0.0140813,-6.10373e-06,1.23904e-09,-9.37428e-14,29761.4,-49.0864], Tmin=(1013.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(C2CsJOOC) + radical((O)CJOC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(=C)OO[C]=O(10144)',
    structure = SMILES('[CH2]C(=C)OO[C]=O'),
    E0 = (28.9835,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,350,500,795,815,1855,455,950,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(1.22219,'amu*angstrom^2'), symmetry=1, barrier=(38.1271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22209,'amu*angstrom^2'), symmetry=1, barrier=(38.1297,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2235,'amu*angstrom^2'), symmetry=1, barrier=(38.1277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21957,'amu*angstrom^2'), symmetry=1, barrier=(38.1285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06831,0.0538682,-3.16222e-05,-4.84074e-09,7.4075e-12,3600.91,25.2064], Tmin=(100,'K'), Tmax=(989.155,'K')), NASAPolynomial(coeffs=[16.9603,0.0129049,-4.83925e-06,9.23577e-10,-6.84973e-14,-682.969,-57.0522], Tmin=(989.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.9835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=C(O)CJ) + radical((O)CJOC)"""),
)

species(
    label = 'O=COOC1=CC1(12017)',
    structure = SMILES('O=COOC1=CC1'),
    E0 = (-57.8541,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65138,0.0339818,2.75224e-05,-6.60778e-08,2.86589e-11,-6857.82,24.0791], Tmin=(100,'K'), Tmax=(976.671,'K')), NASAPolynomial(coeffs=[17.66,0.0115797,-4.36148e-06,9.34546e-10,-7.67229e-14,-12043.4,-63.3144], Tmin=(976.671,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-57.8541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdOsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=[C]OOC1=CC1(12013)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O=[C]OOC1[CH]C1(12014)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O=[C]OO[C]1CC1(11549)'],
    products = ['O=COO[C]1[CH]C1(12015)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(759167,'s^-1'), n=1.54051, Ea=(43.2505,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5Hall;Y_rad_out;Cs_H_out_H/NonDeC] for rate rule [R5HJ_3;CO_rad_out;Cs_H_out_H/NonDeC]
...
reaction(
    label = 'reaction6',
    reactants = ['H(8)', 'O=[C]OO[C]1[CH]C1(12016)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)OO[C]=O(10144)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[C-]#[O+](374)', '[O]O[C]1CC1(11497)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CO3t2(1168)', '[C]1CC1(11616)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]=O(1149)', '[O]O[C]1CC1(11497)'],
    products = ['O=[C]OO[C]1CC1(11549)'],
