...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.983742,0.0760032,-0.000137294,1.26367e-07,-4.40384e-11,22877.4,25.0229], Tmin=(100,'K'), Tmax=(865.611,'K')), NASAPolynomial(coeffs=[7.49051,0.0249949,-1.26151e-05,2.39649e-09,-1.62349e-13,22535.4,-0.897906], Tmin=(865.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CCOJ) + radical(CC(C)(O)OJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC([O])([O])[CH][O](2625)',
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75336,0.0641313,-0.00012769,1.36875e-07,-5.34899e-11,24721.9,22.565], Tmin=(100,'K'), Tmax=(856.743,'K')), NASAPolynomial(coeffs=[-0.677294,0.0391762,-2.04373e-05,3.95833e-09,-2.71988e-13,26470.7,41.6913], Tmin=(856.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438722,0.0621567,-6.94431e-05,3.56239e-08,-6.70756e-12,-15018.8,26.2929], Tmin=(100,'K'), Tmax=(1515.89,'K')), NASAPolynomial(coeffs=[19.2474,0.00145956,1.56829e-06,-4.21793e-10,3.13079e-14,-19449.7,-68.0786], Tmin=(1515.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(O)2C) + radical(C=OCOJ)"""),
)

species(
    label = 'CC([O])([O])C=O(2628)',
    ...
    molecularWeight = (88.0621,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49757,0.0422066,-8.61015e-06,-3.42693e-08,2.07862e-11,-11769.2,22.3068], Tmin=(100,'K'), Tmax=(908.923,'K')), NASAPolynomial(coeffs=[18.6522,0.00116776,2.25411e-06,-5.31171e-10,3.50086e-14,-16311,-66.6458], Tmin=(908.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.7041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C=OCOJ) + radical(C=OCOJ)"""),
)
...
species(
    label = '[CH]C([O])([O])C[O](2630)',
    structure = SMILES('[CH]C([O])([O])C[O]'),
    E0 = (472.912,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93387,0.0588853,-0.000117582,1.26403e-07,-4.96398e-11,56939.6,23.3716], Tmin=(100,'K'), Tmax=(851.927,'K')), NASAPolynomial(coeffs=[-0.247108,0.0360312,-1.90728e-05,3.71738e-09,-2.56505e-13,58512.2,40.5925], Tmin=(851.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])([O])C=O(2622)'],
    products = ['[CH2]C([O])([O])C[O](2053)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[O]CC([O])=O(2051)'],
    products = ['[CH2]C([O])([O])C[O](2053)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH2]C([O])([O])C[O](2053)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(96.4341,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 93.0 to 96.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C([O])([O])[CH][O](2626)'],
    products = ['[CH2]C([O])([O])C[O](2053)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O(T)(63)', '[CH2][C]([O])C[O](1039)'],
    products = ['[CH2]C([O])([O])C[O](2053)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', '[CH2]C([CH2])([O])[O](2328)'],
    products = ['[CH2]C([O])([O])C[O](2053)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C([O])([O])C[O](2630)'],
    products = ['[CH2]C([O])([O])C[O](2053)'],
