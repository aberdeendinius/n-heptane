species(
    label = 'O=[C]CO[C]=O(4279)',
    structure = SMILES('O=[C]CO[C]=O'),
    E0 = (-121.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1850,1860,440,470,900,1000,180,744.526],'cm^-1')),
        HinderedRotor(inertia=(0.00646147,'amu*angstrom^2'), symmetry=1, barrier=(2.54211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948701,'amu*angstrom^2'), symmetry=1, barrier=(21.8125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.948699,'amu*angstrom^2'), symmetry=1, barrier=(21.8125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'O=[C]OC=C=O(4773)',
    structure = SMILES('O=[C]OC=C=O'),
    E0 = (-125.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1855,455,950,3010,987.5,1337.5,450,1655,2120,512.5,787.5,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.40877,'amu*angstrom^2'), symmetry=1, barrier=(32.3903,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.40811,'amu*angstrom^2'), symmetry=1, barrier=(32.3752,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87808,0.0402373,-3.73354e-05,1.64042e-08,-2.79347e-12,-14935.1,21.5894], Tmin=(100,'K'), Tmax=(1431.03,'K')), NASAPolynomial(coeffs=[13.3863,0.00806889,-3.61581e-06,6.95087e-10,-4.9039e-14,-18228.8,-38.0555], Tmin=(1431.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical(CsCJ=O)"""),
)
...
species(
    label = 'O=[C][CH]O[C]=O(4775)',
    structure = SMILES('O=[C][CH]O[C]=O'),
    E0 = (72.8243,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,1850,1860,440,470,900,1000,462.633,462.633],'cm^-1')),
        HinderedRotor(inertia=(0.106216,'amu*angstrom^2'), symmetry=1, barrier=(16.1326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106194,'amu*angstrom^2'), symmetry=1, barrier=(16.1326,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10622,'amu*angstrom^2'), symmetry=1, barrier=(16.1326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0382,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71336,0.046063,-5.67497e-05,3.13486e-08,-6.3394e-12,8844.8,21.8058], Tmin=(100,'K'), Tmax=(1021.06,'K')), NASAPolynomial(coeffs=[14.3025,0.0023372,-7.29298e-07,1.36026e-10,-1.05483e-14,5982.43,-40.6195], Tmin=(1021.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.8243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + group(Cds-OdOsH) + radical(CCsJOC(O)H) + radical(CsCJ=O) + radical((O)CJOCC)"""),
)

species(
    label = 'O=C=COC=O(4274)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=[C]OC=C=O(4773)'],
    products = ['O=[C]CO[C]=O(4279)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['O=[C]CO[C]=O(4279)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(120.369,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 116.5 to 120.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O=[C]CO[C]=O(4279)'],
    products = ['[O]C=CO[C]=O(3225)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', 'O=[C][CH]O[C]=O(4775)'],
    products = ['O=[C]CO[C]=O(4279)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[C]=O(1735)', '[C-]#[O+](374)'],
    products = ['O=[C]CO[C]=O(4279)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C[C]=O(1736)', '[C-]#[O+](374)'],
    products = ['O=[C]CO[C]=O(4279)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]=O(1149)', '[O]C[C]=O(1736)'],
    products = ['O=[C]CO[C]=O(4279)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[C]=O(1149)', '[CH2]O[C]=O(1735)'],
    products = ['O=[C]CO[C]=O(4279)'],
