...
species(
    label = '[CH2]CC(=O)C[CH2](11618)',
    structure = SMILES('[CH2]CC(=O)C[CH2]'),
    E0 = (139.567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,202.798,1858.89],'cm^-1')),
        HinderedRotor(inertia=(0.00412176,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.264129,'amu*angstrom^2'), symmetry=1, barrier=(7.54809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.279196,'amu*angstrom^2'), symmetry=1, barrier=(7.50653,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25836,'amu*angstrom^2'), symmetry=1, barrier=(7.51673,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0082,0.0725379,-0.000103531,9.02512e-08,-3.17757e-11,16887.3,23.6262], Tmin=(100,'K'), Tmax=(825.216,'K')), NASAPolynomial(coeffs=[6.02783,0.0365562,-1.69495e-05,3.19629e-09,-2.19321e-13,16455.5,2.77726], Tmin=(825.216,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.567,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CJCC=O) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]CC1(O)[CH]C1(11620)',
    structure = SMILES('[CH2]CC1(O)[CH]C1'),
    E0 = (209.206,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51006,0.0402651,1.57109e-05,-5.41123e-08,2.5138e-11,25264.6,24.7471], Tmin=(100,'K'), Tmax=(946.218,'K')), NASAPolynomial(coeffs=[15.5443,0.0171194,-4.95481e-06,8.59788e-10,-6.33841e-14,20989,-50.7431], Tmin=(946.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C1(O)CC1(11621)',
...
species(
    label = 'CCC1([O])[CH]C1(11622)',
    structure = SMILES('CCC1([O])[CH]C1'),
    E0 = (232.876,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]CC1([O])[CH]C1(11623)',
    structure = SMILES('[CH2]CC1([O])[CH]C1'),
    E0 = (438.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72969,0.0319276,4.3059e-05,-8.47809e-08,3.66838e-11,-8988.56,21.5753], Tmin=(100,'K'), Tmax=(936.301,'K')), NASAPolynomial(coeffs=[16.3478,0.0152377,-3.51353e-06,5.78434e-10,-4.53186e-14,-13731.8,-58.6977], Tmin=(936.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.5522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)
...
species(
    label = '[CH2]C[C]1CC1(11627)',
    structure = SMILES('[CH2]C[C]1CC1'),
    E0 = (376.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,258.02,953.536,980.966,1061.53,1167.68,1273.84,1369.84,1583.77,1696.9,1810.03],'cm^-1')),
        HinderedRotor(inertia=(0.128432,'amu*angstrom^2'), symmetry=1, barrier=(3.35325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128432,'amu*angstrom^2'), symmetry=1, barrier=(3.35325,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.40945,0.0278204,1.2888e-05,-2.7667e-08,1.022e-11,45302.4,19.7557], Tmin=(100,'K'), Tmax=(1070.57,'K')), NASAPolynomial(coeffs=[6.70953,0.0284927,-1.15068e-05,2.12862e-09,-1.48343e-13,43422.5,-5.76295], Tmin=(1070.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJ) + radical(Tertalkyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C[CH2](11618)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(7.87042e+09,'s^-1'), n=0.743095, Ea=(98.653,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 94.8 to 98.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=CC1([O])CC1(11496)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C=C(18)', '[O][C]1CC1(9172)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC1([O])CC1(10281)'],
    products = ['[CH2]CC1(O)[CH]C1(11620)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]CC1([O])CC1(10281)'],
    products = ['[CH2][CH]C1(O)CC1(11621)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]CC1([O])[CH]C1(11623)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][CH]C1([O])CC1(11624)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
...
reaction(
    label = 'reaction18',
    reactants = ['O(T)(63)', '[CH2]C[C]1CC1(11627)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH2]C1([O])CC1(4307)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]CC1([O])CC1(11628)'],
    products = ['[CH2]CC1([O])CC1(10281)'],
