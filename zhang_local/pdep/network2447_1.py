...
species(
    label = '[CH2]O[C]([CH2])OC=C(10966)',
    structure = SMILES('[CH2]O[C]([CH2])OC=C'),
    E0 = (239.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0896722,0.0746215,-6.05733e-05,1.24654e-08,3.94571e-12,28982,30.0201], Tmin=(100,'K'), Tmax=(967.87,'K')), NASAPolynomial(coeffs=[21.2724,0.0125888,-3.97188e-06,7.11202e-10,-5.23831e-14,23686.7,-77.6553], Tmin=(967.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(CJCO) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2][CH]OC1(C)[CH]O1(10968)',
    structure = SMILES('[CH2][CH]OC1(C)[CH]O1'),
    E0 = (243.368,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.43374,0.0999583,-0.000113583,5.90331e-08,-1.08874e-11,29538,33.1402], Tmin=(100,'K'), Tmax=(1657.42,'K')), NASAPolynomial(coeffs=[25.0471,4.87858e-05,7.23471e-06,-1.79065e-09,1.31338e-13,25041.9,-99.4066], Tmin=(1657.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(243.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(CCsJO) + radical(CJCO)"""),
)

species(
    label = '[CH2]COC1([CH2])[CH]O1(10969)',
    structure = SMILES('[CH2]COC1([CH2])[CH]O1'),
    E0 = (273.422,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.88433,0.0989223,-0.000115388,6.2279e-08,-1.20598e-11,33123.3,31.454], Tmin=(100,'K'), Tmax=(1548.47,'K')), NASAPolynomial(coeffs=[25.067,0.00149669,5.92269e-06,-1.54529e-09,1.16761e-13,28110.1,-99.5919], Tmin=(1548.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CJC(C)OC) + radical(CCsJO)"""),
)
...
species(
    label = '[CH2][CH]OC1([CH2])[CH]O1(10970)',
    structure = SMILES('[CH2][CH]OC1([CH2])[CH]O1'),
    E0 = (453.878,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2950,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.11567,0.105302,-0.000133175,7.53658e-08,-1.51635e-11,54834.4,31.7173], Tmin=(100,'K'), Tmax=(1493.68,'K')), NASAPolynomial(coeffs=[27.4446,-0.00513725,9.14245e-06,-2.17325e-09,1.60809e-13,49492.9,-111.075], Tmin=(1493.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.878,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(CCsJO) + radical(CJC(C)OC) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]O[C]1CCO1(10971)',
    structure = SMILES('[CH2][CH]O[C]1CCO1'),
    E0 = (283.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.264549,0.0695165,-6.70217e-05,3.43451e-08,-6.75284e-12,34295.3,28.6627], Tmin=(100,'K'), Tmax=(1421.21,'K')), NASAPolynomial(coeffs=[15.2818,0.0184764,-3.89182e-06,3.87997e-10,-1.54674e-14,30912.8,-45.9483], Tmin=(1421.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(Cs_P) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]O[C]([CH2])O[CH2](10972)',
    structure = SMILES('[CH2][CH]O[C]([CH2])O[CH2]'),
    E0 = (543.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0355085,0.0937736,-0.000134999,9.91601e-08,-2.76603e-11,65552,31.9237], Tmin=(100,'K'), Tmax=(698.16,'K')), NASAPolynomial(coeffs=[13.3555,0.027182,-1.28167e-05,2.43715e-09,-1.68389e-13,63455.1,-29.2486], Tmin=(698.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOCs) + radical(CJCO) + radical(CJCO) + radical(CsJOCH3) + radical(Cs_P)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3824.52,'J/mol'), sigma=(6.72477,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=597.38 K, Pc=28.54 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH]C1(CO1)O[CH][CH2](10974)',
    structure = SMILES('[CH]C1(CO1)O[CH][CH2]'),
    E0 = (507.861,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.95658,0.095761,-0.000111716,5.95177e-08,-1.12709e-11,61326.5,32.2157], Tmin=(100,'K'), Tmax=(1605.35,'K')), NASAPolynomial(coeffs=[24.4017,-0.000665497,7.11484e-06,-1.76228e-09,1.30319e-13,56826,-95.0831], Tmin=(1605.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.861,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCsJOCs) + radical(CJCO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]OC1([CH2])CO1(10975)',
    structure = SMILES('[CH2][C]OC1([CH2])CO1'),
    E0 = (550.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60999,0.0980306,-0.00012024,6.72627e-08,-1.35051e-11,66456.4,28.9915], Tmin=(100,'K'), Tmax=(1480.95,'K')), NASAPolynomial(coeffs=[25.4983,-0.00114646,6.50486e-06,-1.62881e-09,1.22558e-13,61273.8,-102.825], Tmin=(1480.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(550.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CJC(C)OC) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][CH]OC1([CH2])CO1(10976)',
    structure = SMILES('[CH][CH]OC1([CH2])CO1'),
    E0 = (506.782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,3150,900,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.76017,0.0988979,-0.000120923,6.74664e-08,-1.34482e-11,61183.2,30.6131], Tmin=(100,'K'), Tmax=(1505.6,'K')), NASAPolynomial(coeffs=[25.2323,-0.00124423,7.17083e-06,-1.7943e-09,1.34829e-13,56277.5,-99.9541], Tmin=(1505.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(506.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CCsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[C]([CH2])OC=C(10966)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]OC1([CH2])CO1(9243)'],
    products = ['[CH2][CH]OC1(C)[CH]O1(10968)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]COC1([CH2])[CH]O1(10969)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]OC1([CH2])CO1(9243)'],
    products = ['[CH2]C1([CH]O1)O[CH]C(9607)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[CH2][CH]OC1([CH2])[CH]O1(10970)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(S)(14)', '[CH2][CH]OC([CH2])=O(1060)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O(S)(1732)', '[CH2][CH]OC([CH2])=C(6355)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]O[C]1CCO1(10971)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]O[C]([CH2])O[CH2](10972)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', '[CH2][CH]O[C]1CO1(1830)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]C1(CO1)O[CH][CH2](10974)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2][C]OC1([CH2])CO1(10975)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH][CH]OC1([CH2])CO1(10976)'],
    products = ['[CH2][CH]OC1([CH2])CO1(9243)'],
