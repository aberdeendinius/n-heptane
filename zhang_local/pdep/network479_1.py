...
species(
    label = '[CH2]CC(=O)OO(1387)',
    structure = SMILES('[CH2]CC(=O)OO'),
    E0 = (-259.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(=C)OO(1388)',
    structure = SMILES('[CH2]CC(=C)OO'),
    E0 = (98.6609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.0144037,'amu*angstrom^2'), symmetry=1, barrier=(18.8783,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00618891,'amu*angstrom^2'), symmetry=1, barrier=(8.11829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.353266,'amu*angstrom^2'), symmetry=1, barrier=(8.12228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.821162,'amu*angstrom^2'), symmetry=1, barrier=(18.8801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.983776,0.0903494,-0.000100299,5.18117e-08,-9.95376e-12,19702.6,36.5324], Tmin=(100,'K'), Tmax=(1442.84,'K')), NASAPolynomial(coeffs=[25.6815,0.00495024,4.12704e-07,-2.34447e-10,1.9307e-14,13202.3,-97.7487], Tmin=(1442.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][CH]C(C)([O])OO(1391)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.678881,0.0734163,-7.44096e-05,3.93982e-08,-8.44474e-12,21794.2,29.8384], Tmin=(100,'K'), Tmax=(1118.77,'K')), NASAPolynomial(coeffs=[13.6495,0.0270421,-1.22336e-05,2.34833e-09,-1.65671e-13,18891.9,-34.1932], Tmin=(1118.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]CC([CH2])(O)O[O](1392)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.848706,0.0859518,-9.33957e-05,4.76403e-08,-8.99975e-12,13876.5,34.502], Tmin=(100,'K'), Tmax=(1495.02,'K')), NASAPolynomial(coeffs=[24.1503,0.00562511,6.83896e-07,-3.25568e-10,2.67498e-14,7903.79,-91.1333], Tmin=(1495.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CC(C)([O])O[O](1393)',
    structure = SMILES('[CH2]CC(C)([O])O[O]'),
    E0 = (131.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834375,0.0688148,-6.69305e-05,3.4617e-08,-7.27216e-12,15967.1,27.7319], Tmin=(100,'K'), Tmax=(1140.26,'K')), NASAPolynomial(coeffs=[12.8789,0.0265629,-1.13486e-05,2.1205e-09,-1.47376e-13,13220.3,-31.9572], Tmin=(1140.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(RCCJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C([O])(CC)O[O](1394)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.673022,0.0714994,-7.21092e-05,3.81915e-08,-8.12394e-12,17022,28.5192], Tmin=(100,'K'), Tmax=(1134.73,'K')), NASAPolynomial(coeffs=[13.922,0.0247962,-1.03728e-05,1.92098e-09,-1.32989e-13,14015.2,-37.0742], Tmin=(1134.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.17438,0.0876776,-9.2293e-05,4.49e-08,-8.04545e-12,-13842.2,32.9468], Tmin=(100,'K'), Tmax=(1594.26,'K')), NASAPolynomial(coeffs=[25.7814,0.00424232,1.07803e-06,-3.62261e-10,2.72442e-14,-20428.8,-103.373], Tmin=(1594.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-116.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)

species(
    label = 'C=CC(C)([O])OO(1399)',
...
species(
    label = '[CH2]CC1([CH2])OO1(1400)',
    structure = SMILES('[CH2]CC1([CH2])OO1'),
    E0 = (284.478,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08481,0.0371759,5.38814e-05,-1.25552e-07,6.00339e-11,34345.3,23.5888], Tmin=(100,'K'), Tmax=(894.626,'K')), NASAPolynomial(coeffs=[27.8491,-0.00969665,1.04184e-05,-2.2106e-09,1.50192e-13,26643.4,-118.834], Tmin=(894.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(RCCJ) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]CC1(CO1)OO(1403)',
    structure = SMILES('[CH2]CC1(CO1)OO'),
    E0 = (-62.6265,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.342647,0.0611461,-5.68553e-07,-6.94777e-08,4.02997e-11,-7382.08,24.5143], Tmin=(100,'K'), Tmax=(875.937,'K')), NASAPolynomial(coeffs=[25.6061,0.00163447,5.69318e-06,-1.44588e-09,1.05737e-13,-13950.7,-106.252], Tmin=(875.937,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.6265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1(CCO1)OO(1218)',
    structure = SMILES('[CH2]C1(CCO1)OO'),
    E0 = (-59.4421,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.63859,0.0502128,3.31405e-05,-1.05633e-07,5.33246e-11,-7005.66,24.0284], Tmin=(100,'K'), Tmax=(884.289,'K')), NASAPolynomial(coeffs=[26.3562,-0.000244732,6.9907e-06,-1.6777e-09,1.1916e-13,-14129.6,-111.444], Tmin=(884.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.4421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJCOOH)"""),
)

species(
    label = '[O]C1(CCC1)OO(1221)',
    structure = SMILES('[O]C1(CCC1)OO'),
    E0 = (-67.2692,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19628,0.0444415,1.83062e-05,-5.89439e-08,2.61868e-11,-7974.28,23.4533], Tmin=(100,'K'), Tmax=(982.129,'K')), NASAPolynomial(coeffs=[17.3706,0.0199487,-7.48826e-06,1.46671e-09,-1.11129e-13,-13147.1,-64.4473], Tmin=(982.129,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-67.2692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]CC([O])([O])CO(1404)',
    structure = SMILES('[CH2]CC([O])([O])CO'),
    E0 = (-19.5421,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02293,0.0740051,-0.000109878,1.02062e-07,-3.8033e-11,-2251.45,28.8089], Tmin=(100,'K'), Tmax=(814.787,'K')), NASAPolynomial(coeffs=[4.17861,0.0419607,-2.04124e-05,3.92792e-09,-2.72523e-13,-2216.25,17.6026], Tmin=(814.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.5421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([O])([O])CCO(1405)',
    structure = SMILES('[CH2]C([O])([O])CCO'),
    E0 = (-8.40607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.779111,0.0831722,-0.000139464,1.36246e-07,-5.12352e-11,-906.972,28.1651], Tmin=(100,'K'), Tmax=(838.847,'K')), NASAPolynomial(coeffs=[2.97195,0.0452646,-2.25913e-05,4.35043e-09,-3.00141e-13,-309.042,23.7281], Tmin=(838.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.40607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)

species(
    label = '[CH2]C[C]([CH2])OO(1406)',
    structure = SMILES('[CH2]C[C]([CH2])OO'),
    E0 = (360.839,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,288.7],'cm^-1')),
        HinderedRotor(inertia=(0.00829713,'amu*angstrom^2'), symmetry=1, barrier=(37.8511,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110718,'amu*angstrom^2'), symmetry=1, barrier=(6.54687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.643173,'amu*angstrom^2'), symmetry=1, barrier=(37.8649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00143534,'amu*angstrom^2'), symmetry=1, barrier=(6.55573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.64336,'amu*angstrom^2'), symmetry=1, barrier=(37.8659,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18254,0.0668983,-8.72062e-05,7.01611e-08,-2.37699e-11,43495.7,26.9165], Tmin=(100,'K'), Tmax=(752.502,'K')), NASAPolynomial(coeffs=[7.13545,0.0331265,-1.56444e-05,3.00324e-09,-2.09557e-13,42660,0.290268], Tmin=(752.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJ) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.517738,0.0754458,-8.15915e-05,4.46634e-08,-9.69784e-12,51604.8,29.1148], Tmin=(100,'K'), Tmax=(1118.12,'K')), NASAPolynomial(coeffs=[15.4667,0.0219663,-9.84618e-06,1.88576e-09,-1.33124e-13,48261.8,-44.6744], Tmin=(1118.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])([O])OO(1216)'],
    products = ['C=C(18)', '[CH2]C(=O)OO(1167)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])(C=C)OO(1283)', 'H(8)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(28)', '[CH2]CC(=O)OO(1387)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.0366254,'m^3/(mol*s)'), n=1.743, Ea=(71.974,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-NdNd_O;YJ] for rate rule [CO-NdNd_O;CH2_triplet]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 71.4 to 72.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['O(T)(63)', '[CH2]CC(=C)OO(1388)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=O)OO(1167)', '[CH2][CH2](22)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(114.131,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 112.5 to 114.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['C=C(18)', '[CH2][C]([O])OO(1352)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]CC(=C)[O](725)', '[O]O(16)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC([CH2])([O])OO(1216)'],
    products = ['[CH2][CH]C([CH2])(O)OO(1390)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC([CH2])([O])OO(1216)'],
    products = ['[CH2]CC([CH2])(O)O[O](1392)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(D)(132)', '[CH2]CC([CH2])([O])[O](1395)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[C]([CH2])[O](732)', '[O]O(16)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]CC([CH2])([O])O[O](1396)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C]([O])OO(1352)', '[CH2][CH2](22)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][CH]C([CH2])([O])OO(1397)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]CC([CH2])([O])OO(1216)'],
    products = ['OH(D)(132)', '[CH2]CC1([CH2])OO1(1400)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([CH2])([O])OO(1216)'],
    products = ['OH(D)(132)', '[CH2]CC1([O])CO1(1401)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC([CH2])([O])OO(1216)'],
    products = ['OH(D)(132)', '[CH2]C1([O])CCO1(1402)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(T)(63)', '[CH2]C[C]([CH2])OO(1406)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C[C]([O])OO(1371)', 'CH2(T)(28)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])OO(1407)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(8)', '[CH]C([O])(C[CH2])OO(1408)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]CC([CH2])([O])OO(1409)', 'H(8)'],
    products = ['[CH2]CC([CH2])([O])OO(1216)'],
...
network(
    label = '479',
    isomers = [
        '[CH2]CC([CH2])([O])OO(1216)',
    ],
    reactants = [
        ('C=C(18)', '[CH2]C(=O)OO(1167)'),
    ],
    bathGas = {
        'N2': 0.25,
        'Ne': 0.25,
