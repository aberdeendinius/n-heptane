...
species(
    label = '[CH]C(=C)C=CC(18909)',
    structure = SMILES('[CH]C(=C)C=CC'),
    E0 = (390.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.12982,'amu*angstrom^2'), symmetry=1, barrier=(48.9686,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12935,'amu*angstrom^2'), symmetry=1, barrier=(48.9579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12983,'amu*angstrom^2'), symmetry=1, barrier=(48.9689,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH]C(=[CH])CCC(18910)',
    structure = SMILES('[CH]C(=[CH])CCC'),
    E0 = (538.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,442.478,442.479,442.479,442.481],'cm^-1')),
        HinderedRotor(inertia=(0.379297,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379298,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379298,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3793,'amu*angstrom^2'), symmetry=1, barrier=(52.6981,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.807914,0.0614692,-3.86347e-05,1.23668e-08,-1.62276e-12,64879.6,25.3773], Tmin=(100,'K'), Tmax=(1737.02,'K')), NASAPolynomial(coeffs=[14.4117,0.0301423,-1.15822e-05,1.98406e-09,-1.28409e-13,60153.6,-47.7645], Tmin=(1737.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94482,0.0337535,2.48826e-05,-4.8207e-08,1.85464e-11,70066.4,22.6184], Tmin=(100,'K'), Tmax=(1023.86,'K')), NASAPolynomial(coeffs=[9.32932,0.0322044,-1.28448e-05,2.40199e-09,-1.70223e-13,67123.3,-20.1697], Tmin=(1023.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])[CH][CH]C(18914)',
    structure = SMILES('[CH]C([CH2])[CH][CH]C'),
    E0 = (844.727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,218.457,799.169,1698.83,2518.62,3498.19],'cm^-1')),
        HinderedRotor(inertia=(0.0930948,'amu*angstrom^2'), symmetry=1, barrier=(2.14272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930948,'amu*angstrom^2'), symmetry=1, barrier=(2.14272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930948,'amu*angstrom^2'), symmetry=1, barrier=(2.14272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930948,'amu*angstrom^2'), symmetry=1, barrier=(2.14272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930948,'amu*angstrom^2'), symmetry=1, barrier=(2.14272,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06568,0.0491364,-1.19752e-05,-4.79654e-08,4.7095e-11,101660,28.948], Tmin=(100,'K'), Tmax=(506.782,'K')), NASAPolynomial(coeffs=[4.78345,0.0392051,-1.66776e-05,3.07521e-09,-2.1096e-13,101237,16.224], Tmin=(506.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(844.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cs_S) + radical(RCCJC)"""),
)
...
species(
    label = '[CH]C(=C)C[C]C(18915)',
    structure = SMILES('[CH]C(=C)C[C]C'),
    E0 = (739.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.865689,0.060656,-4.06414e-05,1.40133e-08,-1.98135e-12,89066.1,25.3595], Tmin=(100,'K'), Tmax=(1629.26,'K')), NASAPolynomial(coeffs=[13.9418,0.0285525,-1.10846e-05,1.91905e-09,-1.25537e-13,84805.2,-44.1079], Tmin=(1629.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(739.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2746,0.0514162,-1.32735e-05,-1.04125e-08,5.34702e-12,50642.9,22.4326], Tmin=(100,'K'), Tmax=(1140.17,'K')), NASAPolynomial(coeffs=[9.81314,0.0371558,-1.51607e-05,2.76412e-09,-1.89413e-13,47675.7,-24.3547], Tmin=(1140.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59256,0.0448992,-9.29392e-06,-1.36617e-08,6.86306e-12,46231.9,24.0471], Tmin=(100,'K'), Tmax=(1068.7,'K')), NASAPolynomial(coeffs=[9.69044,0.030729,-1.20573e-05,2.19288e-09,-1.5137e-13,43579.5,-19.8705], Tmin=(1068.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC)"""),
)
...
species(
    label = '[C]C(=C)C[CH]C(18920)',
    structure = SMILES('[C]C(=C)C[CH]C'),
    E0 = (784.567,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2800,2850,1350,1500,750,1050,1375,1000,326.389,326.398,1567.13],'cm^-1')),
        HinderedRotor(inertia=(0.00158243,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15013,'amu*angstrom^2'), symmetry=1, barrier=(11.3488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15012,'amu*angstrom^2'), symmetry=1, barrier=(11.3489,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(108.028,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH]C(=C)C=CC(18909)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH]C(=C)CC=C(17957)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH]C([CH2])=C[CH]C(18911)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C(=[CH])C[CH]C(18912)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C([CH2])[CH][CH]C(18914)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C(32)', '[CH]C([CH2])=C(18776)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', '[CH]CC([CH])=C(18840)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C(=C)C[C]C(18915)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(28)', 'C#CC[CH]C(5208)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(8)', '[C]C(=C)C[CH]C(18920)'],
    products = ['[CH]C(=C)C[CH]C(17584)'],
