...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.191538,0.0927964,-0.000148833,1.31287e-07,-4.5491e-11,67284.3,35.3088], Tmin=(100,'K'), Tmax=(831.866,'K')), NASAPolynomial(coeffs=[8.82337,0.0356122,-1.74488e-05,3.33803e-09,-2.29696e-13,66390.6,-1.48522], Tmin=(831.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30526,0.0906888,-0.000145762,1.30618e-07,-4.5977e-11,66231.5,33.5929], Tmin=(100,'K'), Tmax=(830.44,'K')), NASAPolynomial(coeffs=[7.83954,0.0372792,-1.83677e-05,3.5242e-09,-2.42983e-13,65570.4,2.19827], Tmin=(830.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cs_P) + radical(Cds_S) + radical(ROOJ)"""),
)

species(
    label = '[CH]=CCO[C]([CH2])O[O](20587)',
    structure = SMILES('[CH]=CCO[C]([CH2])O[O]'),
    E0 = (525.77,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293945,0.0885262,-0.000132977,1.12176e-07,-3.80349e-11,63362.2,35.1572], Tmin=(100,'K'), Tmax=(798.791,'K')), NASAPolynomial(coeffs=[9.6601,0.0340768,-1.65563e-05,3.18342e-09,-2.20875e-13,62106.7,-6.41767], Tmin=(798.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(525.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(Cs_P) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.978813,0.0945077,-0.000107193,5.75036e-08,-1.16163e-11,23619.3,33.9575], Tmin=(100,'K'), Tmax=(1324.75,'K')), NASAPolynomial(coeffs=[25.1971,0.00822852,-1.29989e-06,8.6929e-11,-2.12343e-15,17319.5,-97.2889], Tmin=(1324.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CJCOOH) + radical(C=C=CJ)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.269595,0.0968152,-0.00017494,1.67383e-07,-6.01722e-11,45560.2,34.8636], Tmin=(100,'K'), Tmax=(870.597,'K')), NASAPolynomial(coeffs=[4.95455,0.041135,-2.01578e-05,3.79474e-09,-2.56089e-13,46038.8,20.3444], Tmin=(870.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsOs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=[C]CO[C]([CH2])OO(20594)',
    structure = SMILES('[C]=[C]CO[C]([CH2])OO'),
    E0 = (922.613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,360,370,350,3000,3100,440,815,1455,1000,2750,2850,1437.5,1250,1305,750,350,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0209182,0.100271,-0.000176292,1.62087e-07,-5.73733e-11,111098,35.9736], Tmin=(100,'K'), Tmax=(837.109,'K')), NASAPolynomial(coeffs=[8.79653,0.0351617,-1.84534e-05,3.59774e-09,-2.48951e-13,110427,-0.189303], Tmin=(837.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(922.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(Cs_P) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(231.121,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 229.3 to 231.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['OH(D)(132)', 'C#CCO[C]([CH2])[O](18564)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.12189e+07,'m^3/(mol*s)'), n=-0.377333, Ea=(138.767,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;OJ_pri] for rate rule [Od_R;OJ_pri]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 134.0 to 138.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH][C]=COC([CH2])OO(20583)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH]=[C]COC([CH2])O[O](20584)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH]=[C]CO[C](C)O[O](20586)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH]=CCO[C]([CH2])O[O](20587)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH2][C](O[O])OC[C]=C(18439)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(D)(132)', '[CH]=[C]CO[C]([CH2])[O](18569)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH]=[C]CO[C]([CH2])O[O](20588)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH]=C=COC([CH2])OO(20590)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
    products = ['[CH]=[C]COC([CH2])([O])O(20592)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C]OO(1383)', '[CH]=[C]C[O](5268)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O]O(16)', '[CH]=[C]CO[C][CH2](19501)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]O[C]([CH2])OO(1384)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH][C](OO)OC[C]=[CH](20593)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(8)', '[C]=[C]CO[C]([CH2])OO(20594)'],
    products = ['[CH]=[C]CO[C]([CH2])OO(18441)'],
