...
species(
    label = '[CH2][C]1OC([CH2])([CH2])O1(10718)',
    structure = SMILES('[CH2][C]1OC([CH2])([CH2])O1'),
    E0 = (464.425,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0752522,0.0726605,-4.26351e-05,-1.85899e-08,1.83118e-11,56019.8,26.1763], Tmin=(100,'K'), Tmax=(931.622,'K')), NASAPolynomial(coeffs=[26.5207,0.00180757,1.66446e-06,-3.55956e-10,1.88294e-14,49183.5,-110.344], Tmin=(931.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJC(C)OC) + radical(CJCO) + radical(CJC(C)OC) + radical(Cs_P)"""),
)

species(
    label = '[CH2][C]1CO[C]([CH2])O1(10719)',
    structure = SMILES('[CH2][C]1CO[C]([CH2])O1'),
    E0 = (399.805,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.412867,0.0747559,-0.000103176,7.00374e-08,-1.72669e-11,48218.4,25.0918], Tmin=(100,'K'), Tmax=(1212.3,'K')), NASAPolynomial(coeffs=[14.2365,0.00965334,1.49325e-06,-7.84834e-10,7.30118e-14,46299,-38.3533], Tmin=(1212.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(1,3-Dioxolane) + radical(CJC(C)OC) + radical(Cs_P) + radical(CJCO) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH]C(=O)O[C]([CH2])[CH2](10721)',
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.465653,0.0893721,-0.000159311,1.49038e-07,-5.32579e-11,68684.9,30.2805], Tmin=(100,'K'), Tmax=(846.92,'K')), NASAPolynomial(coeffs=[7.11329,0.0336125,-1.74045e-05,3.36771e-09,-2.31702e-13,68432.6,4.47231], Tmin=(846.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(570.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJC(C)OC) + radical(C2CsJOC(O)C) + radical(CCJ2_triplet) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH][C](C)OC([CH2])=O(10723)',
    structure = SMILES('[CH][C](C)OC([CH2])=O'),
    E0 = (360.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29178,0.0655276,-7.85552e-05,5.94648e-08,-1.9705e-11,43472.1,28.4622], Tmin=(100,'K'), Tmax=(717.191,'K')), NASAPolynomial(coeffs=[6.43592,0.036838,-1.8553e-05,3.69131e-09,-2.63997e-13,42734.2,5.35455], Tmin=(717.191,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(CJCO) + radical(C2CsJOC(O)C)"""),
)

species(
    label = '[CH]C(=C)OC([CH2])[O](10724)',
    structure = SMILES('[CH]C(=C)OC([CH2])[O]'),
    E0 = (380.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,350,440,435,1725,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722112,0.070505,-6.38153e-05,3.02204e-08,-5.84709e-12,45876.7,28.2177], Tmin=(100,'K'), Tmax=(1224.94,'K')), NASAPolynomial(coeffs=[13.5124,0.0287383,-1.26694e-05,2.38425e-09,-1.65911e-13,42743.3,-36.0829], Tmin=(1224.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(CCOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)O[C]([CH2])O(10725)',
    structure = SMILES('[CH]C(=C)O[C]([CH2])O'),
    E0 = (359.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,360,370,350,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0125256,0.078795,-7.87652e-05,3.92784e-08,-7.64196e-12,43449.3,31.3764], Tmin=(100,'K'), Tmax=(1259.54,'K')), NASAPolynomial(coeffs=[19.0263,0.0183339,-6.76347e-06,1.16937e-09,-7.81048e-14,38653.1,-64.8686], Tmin=(1259.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(AllylJ2_triplet) + radical(Cs_P)"""),
)

species(
    label = '[CH][C]([CH2])OC(C)=O(10726)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.890826,0.0757477,-0.000112923,1.00975e-07,-3.67919e-11,43355.1,29.0027], Tmin=(100,'K'), Tmax=(781.622,'K')), NASAPolynomial(coeffs=[6.45528,0.036944,-1.86371e-05,3.65202e-09,-2.56529e-13,42800.7,5.54642], Tmin=(781.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(C2CsJOC(O)C)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48856,0.0569559,-6.17668e-05,4.38234e-08,-1.28563e-11,46628,23.5292], Tmin=(100,'K'), Tmax=(951.249,'K')), NASAPolynomial(coeffs=[6.34128,0.0306845,-1.10908e-05,1.82569e-09,-1.15189e-13,45970.1,1.75511], Tmin=(951.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(386.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(Cs_P) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0677031,0.0787218,-8.73794e-05,4.67418e-08,-9.52721e-12,46442.2,30.1371], Tmin=(100,'K'), Tmax=(1262.65,'K')), NASAPolynomial(coeffs=[20.7689,0.0100854,-2.71984e-06,3.94534e-10,-2.43447e-14,41389.8,-74.4177], Tmin=(1262.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cs_P) + radical(CCJ2_triplet) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]C(=O)OC([CH2])[CH2](10731)',
    structure = SMILES('[CH]C(=O)OC([CH2])[CH2]'),
    E0 = (369.325,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788811,0.0768878,-9.93085e-05,6.70286e-08,-1.61868e-11,44529.4,27.1077], Tmin=(100,'K'), Tmax=(655.444,'K')), NASAPolynomial(coeffs=[10.0529,0.0299795,-1.39922e-05,2.66333e-09,-1.84822e-13,43108.1,-15.2506], Tmin=(655.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH]C(=O)O[C]([CH2])C(10732)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.890882,0.0757469,-0.00011292,1.0097e-07,-3.67892e-11,43355.1,29.0025], Tmin=(100,'K'), Tmax=(781.645,'K')), NASAPolynomial(coeffs=[6.4552,0.0369442,-1.86372e-05,3.65205e-09,-2.56531e-13,42800.7,5.54689], Tmin=(781.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + radical(C2CsJOC(O)C) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1([CH2])OC(=C)O1(10733)',
    structure = SMILES('[CH2]C1([CH2])OC(=C)O1'),
    E0 = (176.488,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.268057,0.0642642,1.19592e-05,-9.87407e-08,5.32159e-11,21408,19.4791], Tmin=(100,'K'), Tmax=(907.523,'K')), NASAPolynomial(coeffs=[35.6558,-0.0148287,1.17076e-05,-2.3376e-09,1.5349e-13,11624.4,-168.326], Tmin=(907.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.82776e+08,'s^-1'), n=1.18372, Ea=(118.894,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    ...
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.81675,'m^3/(mol*s)'), n=2.00263, Ea=(84.3364,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 83.5 to 84.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2][C]([CH2])O[C]1CO1(6581)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2][C]1OC([CH2])([CH2])O1(10718)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2][C]1CO[C]([CH2])O1(10719)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['C=C([O])[O](1172)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(28)', '[CH2][C]([CH2])O[C]=O(6542)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH][C]([CH2])OC([CH2])=O(10720)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]C(=O)O[C]([CH2])[CH2](10721)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH][C](C)OC([CH2])=O(10723)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(=C)OC([CH2])[O](10724)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C(=C)O[C]([CH2])O(10725)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH][C]([CH2])OC(C)=O(10726)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2][C]([O])O[C]1CC1(10727)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2][C]1CC[C]([O])O1(10728)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2]C(=C)OC([CH2])=O(10162)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH2][C]OC([CH2])=O(4639)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH][C](O)OC([CH2])=C(10730)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]C(=O)OC([CH2])[CH2](10731)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]C(=O)O[C]([CH2])C(10732)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
    products = ['[CH2]C1([CH2])OC(=C)O1(10733)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O(T)(63)', '[CH2][C]OC([CH2])=C(6490)'],
    products = ['[CH2][C]([CH2])OC([CH2])=O(6724)'],
