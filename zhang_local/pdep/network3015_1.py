...
species(
    label = '[CH2]CC(=O)C[CH][O](12079)',
    structure = SMILES('[CH2]CC(=O)C[CH][O]'),
    E0 = (174.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,180,180,1856.79,1857.4],'cm^-1')),
        HinderedRotor(inertia=(0.242757,'amu*angstrom^2'), symmetry=1, barrier=(5.58146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2432,'amu*angstrom^2'), symmetry=1, barrier=(5.59164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243109,'amu*angstrom^2'), symmetry=1, barrier=(5.58955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243025,'amu*angstrom^2'), symmetry=1, barrier=(5.58763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.519535,0.0932087,-0.000173202,1.72686e-07,-6.40657e-11,21055.2,28.5508], Tmin=(100,'K'), Tmax=(866.555,'K')), NASAPolynomial(coeffs=[2.18265,0.0459548,-2.28985e-05,4.34838e-09,-2.9517e-13,22252.9,29.3394], Tmin=(866.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + radical(CCOJ) + radical(CJCC=O) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17245,0.0541998,-3.41444e-05,8.74967e-09,-3.02692e-13,36040.2,27.8087], Tmin=(100,'K'), Tmax=(1231.77,'K')), NASAPolynomial(coeffs=[12.7801,0.025607,-1.04086e-05,1.90175e-09,-1.30303e-13,32490.1,-33.4137], Tmin=(1231.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[O][CH]CC1(O)[CH]C1(12081)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936051,0.0641022,-5.83835e-05,2.82259e-08,-5.52214e-12,30197.4,28.1355], Tmin=(100,'K'), Tmax=(1224.13,'K')), NASAPolynomial(coeffs=[13.0616,0.0244801,-9.83176e-06,1.78422e-09,-1.21991e-13,27228.8,-32.8154], Tmin=(1224.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCsJOH) + radical(CCJCO) + radical(CCOJ)"""),
)

species(
    label = '[O][CH][CH]C1(O)CC1(12082)',
...
species(
    label = '[O]CCC1([O])[CH]C1(12083)',
    structure = SMILES('[O]CCC1([O])[CH]C1'),
    E0 = (298.754,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17245,0.0541998,-3.41444e-05,8.74967e-09,-3.02692e-13,36040.2,27.8087], Tmin=(100,'K'), Tmax=(1231.77,'K')), NASAPolynomial(coeffs=[12.7801,0.025607,-1.04086e-05,1.90175e-09,-1.30303e-13,32490.1,-33.4137], Tmin=(1231.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ) + radical(CCOJ)"""),
)
...
species(
    label = '[O][CH]CC1([O])[CH]C1(12084)',
    structure = SMILES('[O][CH]CC1([O])[CH]C1'),
    E0 = (479.052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2950,3150,900,1000,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27066,0.0587529,-5.13863e-05,2.3866e-08,-4.55207e-12,57715.9,26.996], Tmin=(100,'K'), Tmax=(1237.62,'K')), NASAPolynomial(coeffs=[11.6197,0.0253043,-1.08462e-05,2.0282e-09,-1.40781e-13,55154.2,-25.1387], Tmin=(1237.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCsJOH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[O][CH][CH]C1([O])CC1(12085)',
    structure = SMILES('[O][CH][CH]C1([O])CC1'),
    E0 = (479.052,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27066,0.0587529,-5.13863e-05,2.3866e-08,-4.55206e-12,57715.9,26.9959], Tmin=(100,'K'), Tmax=(1237.62,'K')), NASAPolynomial(coeffs=[11.6198,0.0253043,-1.08462e-05,2.02819e-09,-1.40781e-13,55154.2,-25.1387], Tmin=(1237.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCOJ) + radical(CCsJOH) + radical(CC(C)2OJ)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10244,0.0407264,4.19903e-05,-9.98761e-08,4.60452e-11,-17059.1,25.0968], Tmin=(100,'K'), Tmax=(921.668,'K')), NASAPolynomial(coeffs=[22.8482,0.00597878,1.49799e-06,-3.9285e-10,2.07262e-14,-23600.2,-91.7792], Tmin=(921.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[O][CH]CC1([O])CC1(10949)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C[CH][O](12079)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]C=CC1([O])CC1(11951)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[O]C[CH]C1([O])CC1(12080)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[O][CH]CC1([O])CC1(10949)'],
    products = ['[O][CH]CC1(O)[CH]C1(12081)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[O][CH]CC1([O])CC1(10949)'],
    products = ['[O][CH][CH]C1(O)CC1(12082)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[O][CH]CC1([O])CC1(10949)'],
    products = ['[O]C1([CH][CH]O)CC1(11933)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]CCC1([O])[CH]C1(12083)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O][CH]CC1([O])CC1(10949)'],
    products = ['[O]C1([CH]C1)C[CH]O(11932)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[O][CH]CC1([O])[CH]C1(12084)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[O][CH][CH]C1([O])CC1(12085)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O(T)(63)', '[O][CH]C[C]1CC1(12088)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH][O](751)', '[CH2]C1([O])CC1(4307)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[O][C]CC1([O])CC1(12089)'],
    products = ['[O][CH]CC1([O])CC1(10949)'],
