...
species(
    label = '[O]C1CC1O[C]1CC1(15686)',
    structure = SMILES('[O]C1CC1O[C]1CC1'),
    E0 = (217.568,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.76058,0.0576862,-1.18608e-05,-2.68741e-08,1.44594e-11,26295.9,26.9391], Tmin=(100,'K'), Tmax=(1005.47,'K')), NASAPolynomial(coeffs=[16.2651,0.0262626,-1.0121e-05,1.90144e-09,-1.36882e-13,21648.6,-55.5517], Tmin=(1005.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C(C=O)OC1=CC1(15688)',
    structure = SMILES('[CH2]C(C=O)OC1=CC1'),
    E0 = (135.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2782.5,750,1395,475,1775,1000,1380,1390,370,380,2900,435,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.145882,0.0687183,-3.04494e-05,-2.23668e-08,1.67373e-11,16402.7,30.2493], Tmin=(100,'K'), Tmax=(960.9,'K')), NASAPolynomial(coeffs=[22.5924,0.0135405,-4.04259e-06,7.51028e-10,-5.84821e-14,10322.6,-86.338], Tmin=(960.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclopropene) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.549103,0.0662666,-4.54608e-05,1.24685e-08,-3.36887e-13,9372.93,31.9837], Tmin=(100,'K'), Tmax=(1149.88,'K')), NASAPolynomial(coeffs=[15.3972,0.0272295,-1.0992e-05,2.02444e-09,-1.40346e-13,5124.33,-45.3495], Tmin=(1149.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C([C]=O)OC1CC1(15693)',
    structure = SMILES('[CH2]C([C]=O)OC1CC1'),
    E0 = (106.637,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.361219,0.067659,-3.64815e-05,-5.72569e-09,8.11507e-12,12967.4,32.4578], Tmin=(100,'K'), Tmax=(1005.8,'K')), NASAPolynomial(coeffs=[18.1653,0.0229296,-8.6631e-06,1.61181e-09,-1.15579e-13,8066.95,-60.0964], Tmin=(1005.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(CCCJ=O)"""),
)

species(
    label = 'CC(C=O)O[C]1[CH]C1(15694)',
    structure = SMILES('CC(C=O)O[C]1[CH]C1'),
    E0 = (116.772,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.859495,0.0576307,-2.04495e-05,-1.26193e-08,8.11351e-12,14167.3,33.2376], Tmin=(100,'K'), Tmax=(1062.08,'K')), NASAPolynomial(coeffs=[14.6464,0.0285982,-1.17763e-05,2.23e-09,-1.58615e-13,9947.66,-40.185], Tmin=(1062.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]C(C=O)O[C]1[CH]C1(15695)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.613335,0.0691533,-5.95615e-05,2.62542e-08,-4.65337e-12,39489.2,33.8725], Tmin=(100,'K'), Tmax=(1344.47,'K')), NASAPolynomial(coeffs=[15.3769,0.0252293,-1.05559e-05,1.95423e-09,-1.3484e-13,35519.4,-41.723], Tmin=(1344.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJCO) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C([C]=O)O[C]1CC1(15697)',
    structure = SMILES('[CH2]C([C]=O)O[C]1CC1'),
    E0 = (287.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1855,455,950,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557428,0.0748566,-7.47348e-05,3.93429e-08,-8.36389e-12,34683.9,31.7024], Tmin=(100,'K'), Tmax=(1130.98,'K')), NASAPolynomial(coeffs=[13.9899,0.0273483,-1.17241e-05,2.19995e-09,-1.53392e-13,31645.6,-34.7547], Tmin=(1130.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(CCCJ=O) + radical(C2CsJOCs)"""),
)

species(
    label = '[CH]1OCC1O[C]1CC1(15698)',
    structure = SMILES('[CH]1OCC1O[C]1CC1'),
    E0 = (201.741,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.312959,0.0742306,-6.30505e-05,2.87136e-08,-5.02263e-12,24436.9,29.3362], Tmin=(100,'K'), Tmax=(1628.26,'K')), NASAPolynomial(coeffs=[16.0026,0.0225877,-4.82443e-06,5.12829e-10,-2.31506e-14,20656.3,-52.6247], Tmin=(1628.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Oxetane) + radical(CCsJOCs) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]C(=C)OC([CH2])C=O(12865)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.226821,0.0808262,-6.14259e-05,1.04977e-08,4.88422e-12,3229.37,31.9943], Tmin=(100,'K'), Tmax=(970.164,'K')), NASAPolynomial(coeffs=[21.5827,0.0179135,-5.91326e-06,1.0464e-09,-7.47305e-14,-2273.44,-79.1143], Tmin=(970.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.4945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(C=C(O)CJ)"""),
)
...
species(
    label = 'CC(C=O)OC1=CC1(15701)',
    structure = SMILES('CC(C=O)OC1=CC1'),
    E0 = (-75.4047,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508495,0.0558234,1.3521e-05,-6.77334e-08,3.23916e-11,-8924.37,29.1958], Tmin=(100,'K'), Tmax=(959.234,'K')), NASAPolynomial(coeffs=[22.3664,0.016118,-4.83211e-06,9.29193e-10,-7.44113e-14,-15484.4,-87.6824], Tmin=(959.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.4047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclopropene)"""),
)
...
species(
    label = '[O]C=CO[C]1CC1(11942)',
    structure = SMILES('[O]C=CO[C]1CC1'),
    E0 = (73.5519,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.735473,0.0471131,2.96055e-05,-9.43536e-08,4.57752e-11,8986.71,23.929], Tmin=(100,'K'), Tmax=(922.597,'K')), NASAPolynomial(coeffs=[26.7264,-0.00149599,4.45746e-06,-9.02266e-10,5.35133e-14,1463.83,-114.147], Tmin=(922.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.5519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(C=COJ)"""),
)

species(
    label = '[CH]C(C=O)O[C]1CC1(15704)',
    structure = SMILES('[CH]C(C=O)O[C]1CC1'),
    E0 = (365.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459444,0.0674698,-5.29767e-05,2.06667e-08,-3.20543e-12,44045.8,32.5033], Tmin=(100,'K'), Tmax=(1536.27,'K')), NASAPolynomial(coeffs=[17.6897,0.0226068,-9.17261e-06,1.65771e-09,-1.12043e-13,38751.7,-58.0208], Tmin=(1536.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJ2_triplet) + radical(C2CsJOCs)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    products = ['[O]C1CC1O[C]1CC1(15686)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(413769,'s^-1'), n=1.87624, Ea=(104.604,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS;multiplebond_intra;radadd_intra_cs] for rate rule [R5_SS_CO;carbonylbond_intra_H;radadd_intra_csNdNd]
Euclidian distance = 2.44948974278
family: Intra_R_Add_Exocyclic
Ea raised from 104.5 to 104.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C(C=O)OC1=CC1(15688)'],
...
reaction(
    ...
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(32300,'cm^3/(mol*s)'), n=2.98, Ea=(35.2899,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-CsCs;YJ] for rate rule [Od_CO-CsCs;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 33.1 to 35.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH]=O(373)', 'C=CO[C]1CC1(11495)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C=O)OC1[CH]C1(15342)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    products = ['CC([C]=O)O[C]1CC1(15692)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    products = ['[CH2]C([C]=O)OC1CC1(15693)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(444.917,'s^-1'), n=2.50637, Ea=(74.1397,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS;C_rad_out_single;XH_out] for rate rule [R4H_SSS_OCs;C_rad_out_Cs2_cy3;CO_H_out]
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    products = ['CC(C=O)O[C]1[CH]C1(15694)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C(C=O)O[C]1[CH]C1(15695)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=O(373)', '[CH2][CH]O[C]1CC1(11613)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]C([C]=O)O[C]1CC1(15697)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    products = ['[CH]1OCC1O[C]1CC1(15698)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(=C)OC([CH2])C=O(12865)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[C-]#[O+](374)', '[CH2]CO[C]1CC1(11476)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C=O)O[C]1CC1(12895)'],
    products = ['O=CC[CH]O[C]1CC1(15702)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([O])C=O(1032)', '[C]1CC1(11616)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2(T)(28)', '[O]C=CO[C]1CC1(11942)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH]C(C=O)O[C]1CC1(15704)'],
    products = ['[CH2]C(C=O)O[C]1CC1(12895)'],
