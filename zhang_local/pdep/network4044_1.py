...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4251,0.0583029,-5.59494e-05,3.01885e-08,-6.81612e-12,53169,23.5645], Tmin=(100,'K'), Tmax=(1048.45,'K')), NASAPolynomial(coeffs=[9.47037,0.0276087,-1.20355e-05,2.26528e-09,-1.57847e-13,51482,-15.6298], Tmin=(1048.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_P) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7643,0.0407162,-8.84449e-06,-1.17887e-08,5.35795e-12,12004.7,21.7015], Tmin=(100,'K'), Tmax=(1200.6,'K')), NASAPolynomial(coeffs=[11.6906,0.0254813,-1.20947e-05,2.38999e-09,-1.71091e-13,8335.73,-33.3555], Tmin=(1200.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.0866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=[C]CC(C)[O](19136)',
    structure = SMILES('[C]=[C]CC(C)[O]'),
    E0 = (813.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,338.63,338.644,338.718],'cm^-1')),
        HinderedRotor(inertia=(0.00146959,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11257,'amu*angstrom^2'), symmetry=1, barrier=(9.16139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112568,'amu*angstrom^2'), symmetry=1, barrier=(9.16148,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5824,0.0569407,-6.3532e-05,4.19109e-08,-1.17006e-11,97929.1,24.0305], Tmin=(100,'K'), Tmax=(855.033,'K')), NASAPolynomial(coeffs=[7.74213,0.0281238,-1.29772e-05,2.49283e-09,-1.75137e-13,96875.7,-4.72182], Tmin=(855.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(813.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet) + radical(CC(C)OJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=[C]CC(C)=O(17902)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['[CH]=[C]CC(C)[O](17709)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(0.0201871,'m^3/(mol*s)'), n=2.2105, Ea=(65.7826,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 62.3 to 65.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH3](11)', 'C#CC[CH][O](5304)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', '[CH]=[C]C[CH][O](5311)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]=[C]C[C](C)[O](19131)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', '[CH]=[C]CC[O](5306)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(T)(63)', '[CH]=[C]C[CH]C(5215)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(C)[O](442)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[C]=[C]CC(C)[O](19136)'],
    products = ['[CH]=[C]CC(C)[O](17709)'],
