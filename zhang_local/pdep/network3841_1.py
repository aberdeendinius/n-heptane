...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=[C]CC=C=C(17944)'],
    products = ['C=[C]CC[C]=C(17528)'],
    transitionState = 'TS2',
...
reaction(
    ...
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(4.08e+11,'s^-1'), n=0.627, Ea=(245.433,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_Cd;Cd_H_out_singleH] for rate rule [R5HJ_3;Cd_rad_out_Cd;Cd_H_out_singleH]
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][C]=CC[C]=C(17947)'],
    products = ['C=[C]CC[C]=C(17528)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]CC[C]=C(17948)'],
    products = ['C=[C]CC[C]=C(17528)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=C(584)', '[CH2]C[C]=C(4316)'],
    products = ['C=[C]CC[C]=C(17528)'],
