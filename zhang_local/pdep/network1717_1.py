...
species(
    label = '[CH2]C([CH2])C=CC(6180)',
    structure = SMILES('[CH2]C([CH2])C=CC'),
    E0 = (325.865,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,2037.69],'cm^-1')),
        HinderedRotor(inertia=(0.00254756,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179865,'amu*angstrom^2'), symmetry=1, barrier=(8.44532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179845,'amu*angstrom^2'), symmetry=1, barrier=(8.44561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.51317,'amu*angstrom^2'), symmetry=1, barrier=(71.0556,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34613,0.0586593,-4.2982e-05,1.90788e-08,-3.76994e-12,78294.4,28.8608], Tmin=(100,'K'), Tmax=(1144.4,'K')), NASAPolynomial(coeffs=[7.50754,0.0371234,-1.47541e-05,2.63465e-09,-1.77615e-13,76884.2,-1.69542], Tmin=(1144.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(650.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(Isobutyl) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C(=C)C[CH]C(6179)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C([CH2])C=CC(6180)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C([CH2])CC=C(6127)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C=CC[CH]C(122)', 'CH2(T)(28)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])[CH]CC(6161)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C]([CH2])C[CH]C(6182)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH2]C([CH2])[CH][CH]C(6183)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C(32)', '[CH2]C([CH2])[CH2](6116)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH3](11)', '[CH]CC([CH2])[CH2](6143)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH2]C([CH2])C[C]C(6186)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([CH2])C[CH]C(6187)'],
    products = ['[CH2]C([CH2])C[CH]C(153)'],
