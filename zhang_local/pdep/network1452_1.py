...
species(
    label = '[CH]=CC(=C)CC(5220)',
    structure = SMILES('[CH]=CC(=C)CC'),
    E0 = (280.781,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2950,3100,1380,975,1025,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,180],'cm^-1')),
        HinderedRotor(inertia=(0.74922,'amu*angstrom^2'), symmetry=1, barrier=(17.226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749083,'amu*angstrom^2'), symmetry=1, barrier=(17.2229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.749939,'amu*angstrom^2'), symmetry=1, barrier=(17.2426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH]C=C(C)CC(5222)',
    structure = SMILES('[CH]C=C(C)CC'),
    E0 = (279.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,350,440,435,1725,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,421.876,422.167,422.56,422.95],'cm^-1')),
        HinderedRotor(inertia=(0.418077,'amu*angstrom^2'), symmetry=1, barrier=(53.0371,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.420011,'amu*angstrom^2'), symmetry=1, barrier=(53.0204,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.417873,'amu*angstrom^2'), symmetry=1, barrier=(53.018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.418093,'amu*angstrom^2'), symmetry=1, barrier=(53.0209,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    label = '[CH]=[C]C(C)CC(5224)',
    structure = SMILES('[CH]=[C]C(C)CC'),
    E0 = (412.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180.544],'cm^-1')),
        HinderedRotor(inertia=(0.000978171,'amu*angstrom^2'), symmetry=1, barrier=(11.1062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483585,'amu*angstrom^2'), symmetry=1, barrier=(11.1186,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.918058,'amu*angstrom^2'), symmetry=1, barrier=(21.1361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.13074,'amu*angstrom^2'), symmetry=1, barrier=(26.1404,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    label = '[CH]=CC(C)C[CH2](5227)',
    structure = SMILES('[CH]=CC(C)C[CH2]'),
    E0 = (380.288,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,180],'cm^-1')),
        HinderedRotor(inertia=(1.0677,'amu*angstrom^2'), symmetry=1, barrier=(24.5486,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144853,'amu*angstrom^2'), symmetry=1, barrier=(6.49373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06794,'amu*angstrom^2'), symmetry=1, barrier=(24.554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00128197,'amu*angstrom^2'), symmetry=1, barrier=(14.5555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    label = '[CH]=CC([CH2])[CH]C(5230)',
    structure = SMILES('[CH]=CC([CH2])[CH]C'),
    E0 = (574.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,323.821],'cm^-1')),
        HinderedRotor(inertia=(0.0474608,'amu*angstrom^2'), symmetry=1, barrier=(86.7859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000967003,'amu*angstrom^2'), symmetry=1, barrier=(7.01343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307422,'amu*angstrom^2'), symmetry=1, barrier=(22.8687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0942762,'amu*angstrom^2'), symmetry=1, barrier=(7.01268,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23767,0.054047,-3.56759e-05,1.25545e-08,-1.83236e-12,69221.3,28.9874], Tmin=(100,'K'), Tmax=(1573.59,'K')), NASAPolynomial(coeffs=[11.7813,0.0272457,-1.0128e-05,1.73092e-09,-1.12788e-13,65903.1,-26.6594], Tmin=(1573.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(574.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC([CH2])C[CH2](5231)',
    structure = SMILES('[CH]=CC([CH2])C[CH2]'),
    E0 = (585.371,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3120,650,792.5,1650,3010,987.5,1337.5,450,1655,4000],'cm^-1')),
        HinderedRotor(inertia=(0.607412,'amu*angstrom^2'), symmetry=1, barrier=(13.9656,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121007,'amu*angstrom^2'), symmetry=1, barrier=(2.78219,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161064,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19462,0.054856,-3.15236e-05,3.62642e-09,2.39188e-12,70510.8,28.3622], Tmin=(100,'K'), Tmax=(1021.6,'K')), NASAPolynomial(coeffs=[11.3902,0.0275929,-1.00776e-05,1.75865e-09,-1.1874e-13,67767.1,-24.2762], Tmin=(1021.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(585.371,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (318.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,382.322,382.391,382.585,383.038],'cm^-1')),
        HinderedRotor(inertia=(0.493998,'amu*angstrom^2'), symmetry=1, barrier=(51.5164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.497387,'amu*angstrom^2'), symmetry=1, barrier=(51.5358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.494124,'amu*angstrom^2'), symmetry=1, barrier=(51.5259,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
...
species(
    label = '[CH]C(C=[CH])CC(5236)',
    structure = SMILES('[CH]C(C=[CH])CC'),
    E0 = (623.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1173.87,2974.81],'cm^-1')),
        HinderedRotor(inertia=(0.0188696,'amu*angstrom^2'), symmetry=1, barrier=(18.4519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0184002,'amu*angstrom^2'), symmetry=1, barrier=(5.28164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.802566,'amu*angstrom^2'), symmetry=1, barrier=(18.4526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.80255,'amu*angstrom^2'), symmetry=1, barrier=(18.4522,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07592,0.0555965,-2.8321e-05,-1.32672e-09,4.08884e-12,75073.3,26.2258], Tmin=(100,'K'), Tmax=(1053.02,'K')), NASAPolynomial(coeffs=[12.881,0.026892,-1.04208e-05,1.89485e-09,-1.31373e-13,71692.3,-35.585], Tmin=(1053.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(623.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH]=CC(=C)CC(5220)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CC([CH2])CC(5221)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH2](6)', '[CH]=CC=C(5156)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH2](6)', '[CH]C=C[CH2](5187)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C=C([CH2])CC(5229)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH3](11)', '[CH]=CC([CH2])[CH2](5199)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH]=CC([CH2])[CH]C(5230)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH]=CC([CH2])C[CH2](5231)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]C([CH2])CC(5232)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', '[CH]=CC([CH2])C(5150)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH]C=CCC(5202)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH]C(C=[CH])CC(5236)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[C]=CC([CH2])CC(5237)'],
    products = ['[CH]=CC([CH2])CC(5152)'],
