...
species(
    label = 'O=[C]CC=C=O(4717)',
    structure = SMILES('O=[C]CC=C=O'),
    E0 = (-22.7318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2120,512.5,787.5,3010,987.5,1337.5,450,1655,1855,455,950,328.891],'cm^-1')),
...
species(
    label = 'O=[C][CH]C[C]=O(4718)',
    structure = SMILES('O=[C][CH]C[C]=O'),
    E0 = (209.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1850,1860,440,470,900,1000,3025,407.5,1350,352.5,294.154],'cm^-1')),
        HinderedRotor(inertia=(0.000934872,'amu*angstrom^2'), symmetry=1, barrier=(7.47405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122665,'amu*angstrom^2'), symmetry=1, barrier=(7.4604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121975,'amu*angstrom^2'), symmetry=1, barrier=(7.46761,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95487,0.0510086,-8.46725e-05,7.67323e-08,-2.66758e-11,25315.5,25.1423], Tmin=(100,'K'), Tmax=(869.65,'K')), NASAPolynomial(coeffs=[5.67676,0.0207037,-9.65804e-06,1.79184e-09,-1.20388e-13,25166.7,10.573], Tmin=(869.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(CCCJ=O) + radical(CCCJ=O)"""),
)

species(
    label = 'O=C=CCC=O(4719)',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'O=[C]CC=C=O(4717)'],
    products = ['O=[C]CC[C]=O(4292)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(8)', 'O=[C][CH]C[C]=O(4718)'],
    products = ['O=[C]CC[C]=O(4292)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[C-]#[O+](374)', '[CH2]C[C]=O(3064)'],
    products = ['O=[C]CC[C]=O(4292)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[C]=O(1149)', '[CH2]C[C]=O(3064)'],
    products = ['O=[C]CC[C]=O(4292)'],
