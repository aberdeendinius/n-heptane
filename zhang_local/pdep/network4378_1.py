...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67422,0.0413865,5.83201e-06,-4.64503e-08,2.5226e-11,69726.1,20.3169], Tmin=(100,'K'), Tmax=(858.629,'K')), NASAPolynomial(coeffs=[13.3146,0.016685,-2.59641e-06,1.4305e-10,-1.0247e-15,66638.7,-40.4049], Tmin=(858.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(578.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(=[CH])C([CH])[O](21630)',
    structure = SMILES('[CH]C(=[CH])C([CH])[O]'),
    E0 = (1067.97,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1380,1390,370,380,2900,435,350,440,435,1725,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11255,0.0577067,-5.33711e-05,2.51831e-08,-4.72543e-12,128556,26.0992], Tmin=(100,'K'), Tmax=(1288.06,'K')), NASAPolynomial(coeffs=[13.8804,0.0180564,-7.19609e-06,1.28384e-09,-8.67513e-14,125267,-38.73], Tmin=(1288.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1067.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJ2_triplet) + radical(CC(C)OJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[C]C(=[CH])C([CH2])[O](21631)',
    structure = SMILES('[C]C(=[CH])C([CH2])[O]'),
    E0 = (1130.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,3120,650,792.5,1650,1380,1390,370,380,2900,435,350,440,435,1725,348.725,349.006],'cm^-1')),
        HinderedRotor(inertia=(0.198492,'amu*angstrom^2'), symmetry=1, barrier=(17.1579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198605,'amu*angstrom^2'), symmetry=1, barrier=(17.157,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03646,0.061168,-7.12985e-05,4.02584e-08,-8.75404e-12,136035,24.0375], Tmin=(100,'K'), Tmax=(1135.77,'K')), NASAPolynomial(coeffs=[15.5211,0.0101553,-3.92635e-06,7.12659e-10,-4.94187e-14,132744,-47.6866], Tmin=(1135.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1130.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CJ3) + radical(Cds_P) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    ...
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH](2815)', 'C#CC([CH2])[O](5294)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH]C(=[CH])C=O(21223)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', '[CH]C(=[CH])C=C(19261)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])C([CH2])[O](19456)'],
    products = ['[CH]C([CH])=C([CH2])O(19462)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=[CH])C([CH2])[O](19456)'],
    products = ['[CH]C([CH2])=C([CH2])[O](19546)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH]C([CH])=C([CH2])[O](21628)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(T)(63)', '[CH]C([CH])=C[CH2](21258)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(28)', '[CH]C([CH])=C[O](21383)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]C(=[CH])C([CH])[O](21630)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(8)', '[C]C(=[CH])C([CH2])[O](21631)'],
    products = ['[CH]C(=[CH])C([CH2])[O](19456)'],
