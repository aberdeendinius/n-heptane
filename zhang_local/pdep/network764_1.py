...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20235,0.0683343,-8.41667e-05,7.63503e-08,-3.00554e-11,33111.4,25.4111], Tmin=(100,'K'), Tmax=(758.931,'K')), NASAPolynomial(coeffs=[2.98236,0.048301,-2.35191e-05,4.5825e-09,-3.2254e-13,33148,19.3355], Tmin=(758.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CC(C)(O)OJ) + radical(CJC(O)2C) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][C](C)C([CH2])([O])O(2407)',
    structure = SMILES('[CH2][C](C)C([CH2])([O])O'),
    E0 = (247.613,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.523543,0.0735487,-7.12885e-05,3.71398e-08,-7.81072e-12,29908.6,29.7486], Tmin=(100,'K'), Tmax=(1146.61,'K')), NASAPolynomial(coeffs=[13.7999,0.0272329,-1.06972e-05,1.91013e-09,-1.29347e-13,26864.1,-36.1184], Tmin=(1146.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.613,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CCJ(C)CO) + radical(CC(C)(O)OJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C)C(C)([O])[O](2408)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9263,0.0524,-1.79363e-05,-3.36685e-08,3.50311e-11,31726.2,25.1198], Tmin=(100,'K'), Tmax=(511.456,'K')), NASAPolynomial(coeffs=[4.15274,0.0440638,-2.01068e-05,3.85771e-09,-2.71675e-13,31379.7,14.7108], Tmin=(511.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CC(C)(O)OJ) + radical(Isobutyl) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2]C([CH2])C([CH2])([O])O(2409)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.213705,0.0825404,-9.74313e-05,6.23683e-08,-1.58396e-11,36233.2,31.7544], Tmin=(100,'K'), Tmax=(965.902,'K')), NASAPolynomial(coeffs=[13.9124,0.0258101,-9.3301e-06,1.55962e-09,-1.00496e-13,33586.9,-33.8586], Tmin=(965.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(CJC(O)2C)"""),
)

species(
    label = '[CH2]C([CH2])C(C)([O])[O](2410)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05201,0.069796,-8.44713e-05,6.80638e-08,-2.30216e-11,38074.8,29.0541], Tmin=(100,'K'), Tmax=(835.972,'K')), NASAPolynomial(coeffs=[5.54662,0.040342,-1.73604e-05,3.17167e-09,-2.14366e-13,37601.1,9.83653], Tmin=(835.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(Isobutyl) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.426333,0.0850065,-9.17085e-05,4.89017e-08,-9.94165e-12,798.614,30.0435], Tmin=(100,'K'), Tmax=(1305.7,'K')), NASAPolynomial(coeffs=[21.0654,0.0135419,-3.1472e-06,3.84598e-10,-2.0443e-14,-4334.25,-77.5382], Tmin=(1305.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.22724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CC(O)2CJ) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = 'C=C(C)C(C)([O])[O](2414)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.493131,0.077692,-9.14907e-05,5.98701e-08,-1.56993e-11,3101.7,26.0078], Tmin=(100,'K'), Tmax=(932.23,'K')), NASAPolynomial(coeffs=[12.2643,0.0271856,-1.02257e-05,1.75649e-09,-1.15155e-13,906.953,-29.9556], Tmin=(932.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.7435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C([O])([O])[CH]C(2322)',
    structure = SMILES('[CH2]C([O])([O])[CH]C'),
    E0 = (351.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7024,0.058177,-8.53516e-05,8.33388e-08,-3.27137e-11,42329.7,24.6443], Tmin=(100,'K'), Tmax=(804.144,'K')), NASAPolynomial(coeffs=[2.38266,0.0387641,-1.92401e-05,3.74177e-09,-2.61464e-13,42738.6,24.7332], Tmin=(804.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]C(C)[C]([O])[O](2416)',
    structure = SMILES('[CH2]C(C)[C]([O])[O]'),
    E0 = (348.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180,1605.61,1610.17],'cm^-1')),
        HinderedRotor(inertia=(0.00173373,'amu*angstrom^2'), symmetry=1, barrier=(3.19922,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140497,'amu*angstrom^2'), symmetry=1, barrier=(3.23031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139398,'amu*angstrom^2'), symmetry=1, barrier=(3.20503,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84379,0.0558691,-8.43615e-05,8.34866e-08,-3.22169e-11,41964.5,26.4228], Tmin=(100,'K'), Tmax=(841.573,'K')), NASAPolynomial(coeffs=[1.42676,0.0382939,-1.81773e-05,3.44389e-09,-2.36129e-13,42727.2,32.4775], Tmin=(841.573,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Isobutyl) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = '[CH]C([O])([O])C([CH2])C(2417)',
    structure = SMILES('[CH]C([O])([O])C([CH2])C'),
    E0 = (558.862,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02759,0.0706348,-8.97531e-05,7.33623e-08,-2.52468e-11,67317.6,29.0574], Tmin=(100,'K'), Tmax=(793.509,'K')), NASAPolynomial(coeffs=[6.27874,0.038281,-1.74721e-05,3.29179e-09,-2.26867e-13,66669.4,6.10528], Tmin=(793.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet) + radical(Isobutyl) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH]C(C)C([CH2])([O])[O](2418)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.818395,0.0787421,-0.000117377,1.08376e-07,-4.03187e-11,68680.7,28.2905], Tmin=(100,'K'), Tmax=(806.061,'K')), NASAPolynomial(coeffs=[4.71401,0.0432784,-2.13627e-05,4.13683e-09,-2.88174e-13,68576.8,13.5871], Tmin=(806.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(570.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsOs) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(O)2C) + radical(CCJ2_triplet) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])([O])C(=C)C(2405)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)C(=C)[O](782)', 'O(T)(63)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH2]C(C)C([O])=O(1892)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(7.99363,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 8.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([O])([O])C=C(2117)', '[CH3](11)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(88.8378,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 85.7 to 88.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2]C([O])([O])[C](C)C(2406)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2][C](C)C([CH2])([O])O(2407)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([CH2])C([CH2])([O])O(2409)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2]C([CH2])C(C)([O])[O](2410)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](11)', '[CH2][CH]C([CH2])([O])[O](2325)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2][C](C)C([CH2])([O])[O](2411)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])C([CH2])([O])[O](2412)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]CC([CH2])([O])[O](1395)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2]C([O])([O])C[CH]C(1538)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
    products = ['[CH2]C(C)C1([CH2])OO1(1495)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([O])([O])[CH]C(2322)', 'CH2(T)(28)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]([O])C([CH2])C(792)', 'O(T)(63)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(28)', '[CH2]C(C)[C]([O])[O](2416)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(8)', '[CH]C([O])([O])C([CH2])C(2417)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]C(C)C([CH2])([O])[O](2418)', 'H(8)'],
    products = ['[CH2]C(C)C([CH2])([O])[O](1489)'],
