...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64126,0.0348558,-4.06421e-06,-4.34039e-08,4.04757e-11,35579.9,24.2948], Tmin=(100,'K'), Tmax=(491.497,'K')), NASAPolynomial(coeffs=[4.32387,0.0294104,-1.26185e-05,2.34393e-09,-1.61667e-13,35314.9,16.3588], Tmin=(491.497,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.463,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]C[O](478)',
    structure = SMILES('C[CH][CH]C[O]'),
    E0 = (315.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,1865.17,1866.53,1866.63],'cm^-1')),
        HinderedRotor(inertia=(0.105256,'amu*angstrom^2'), symmetry=1, barrier=(2.42005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104773,'amu*angstrom^2'), symmetry=1, barrier=(2.40895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104961,'amu*angstrom^2'), symmetry=1, barrier=(2.41326,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48285,0.0387955,-4.31594e-05,4.38475e-08,-1.86106e-11,38046,23.8442], Tmin=(100,'K'), Tmax=(816.476,'K')), NASAPolynomial(coeffs=[0.05703,0.037702,-1.73081e-05,3.27175e-09,-2.25672e-13,38874.7,37.7045], Tmin=(816.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][CH][CH]C[O](6295)',
    structure = SMILES('[CH2][CH][CH]C[O]'),
    E0 = (521.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,1685.03,1685.26,1686.06],'cm^-1')),
        HinderedRotor(inertia=(0.122447,'amu*angstrom^2'), symmetry=1, barrier=(2.81529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122696,'amu*angstrom^2'), symmetry=1, barrier=(2.82102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00139382,'amu*angstrom^2'), symmetry=1, barrier=(2.81409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50174,0.0397464,-5.4354e-05,5.69805e-08,-2.33524e-11,62729.4,25.5626], Tmin=(100,'K'), Tmax=(838.394,'K')), NASAPolynomial(coeffs=[-0.0457546,0.0352257,-1.64321e-05,3.10327e-09,-2.12888e-13,63742.6,40.8988], Tmin=(838.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(521.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJC) + radical(CCOJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6582,0.0445172,-2.40033e-05,3.59548e-10,2.75834e-12,-7057.81,18.3876], Tmin=(100,'K'), Tmax=(1064.76,'K')), NASAPolynomial(coeffs=[11.3259,0.0207331,-8.15558e-06,1.4934e-09,-1.03874e-13,-9827.1,-32.1968], Tmin=(1064.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-59.4326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO)"""),
)
...
species(
    label = '[CH2][C]CC[O](6297)',
    structure = SMILES('[CH2][C]CC[O]'),
    E0 = (575.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,180,908.454,909.06,909.087],'cm^-1')),
        HinderedRotor(inertia=(0.202432,'amu*angstrom^2'), symmetry=1, barrier=(4.65432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20236,'amu*angstrom^2'), symmetry=1, barrier=(4.65265,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202339,'amu*angstrom^2'), symmetry=1, barrier=(4.65217,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05666,0.0477871,-6.29139e-05,5.73374e-08,-2.17115e-11,69225.8,21.8346], Tmin=(100,'K'), Tmax=(802.91,'K')), NASAPolynomial(coeffs=[3.44121,0.0314778,-1.48618e-05,2.83974e-09,-1.96953e-13,69306.9,17.348], Tmin=(802.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)

species(
    label = '[CH][CH]CC[O](6298)',
    structure = SMILES('[CH][CH]CC[O]'),
    E0 = (564.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,180,180,1515.19,1516.28,1516.43,1518.62],'cm^-1')),
        HinderedRotor(inertia=(0.152919,'amu*angstrom^2'), symmetry=1, barrier=(3.51592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00217583,'amu*angstrom^2'), symmetry=1, barrier=(3.53795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152687,'amu*angstrom^2'), symmetry=1, barrier=(3.51057,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.09309,0.027359,-1.00928e-05,8.8152e-10,6.31521e-14,67827.6,16.3914], Tmin=(100,'K'), Tmax=(2771.61,'K')), NASAPolynomial(coeffs=[34.7453,-0.00481096,7.86737e-07,-1.64478e-10,1.58055e-14,46201.4,-171.097], Tmin=(2771.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(564.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C[CH]C[O](6293)'],
    products = ['[CH2][CH]CC[O](480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][O](357)', '[CH2]C=C(87)'],
    products = ['[CH2][CH]CC[O](480)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][CH][CH]C[O](6295)'],
    products = ['[CH2][CH]CC[O](480)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[O](419)', '[CH][CH2](721)'],
    products = ['[CH2][CH]CC[O](480)'],
