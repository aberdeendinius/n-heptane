...
species(
    label = 'C[C]([O])C(C)[O](3810)',
    structure = SMILES('C[C]([O])C(C)[O]'),
    E0 = (148.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,360,370,350,358.835,359.862,360.21],'cm^-1')),
        HinderedRotor(inertia=(0.00130087,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0928755,'amu*angstrom^2'), symmetry=1, barrier=(8.5516,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0929026,'amu*angstrom^2'), symmetry=1, barrier=(8.55086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32922,0.0606586,-6.10067e-05,3.44884e-08,-8.11035e-12,17907.5,22.9543], Tmin=(100,'K'), Tmax=(1012.93,'K')), NASAPolynomial(coeffs=[9.70094,0.0275991,-1.20505e-05,2.26747e-09,-1.57931e-13,16211.5,-17.5419], Tmin=(1012.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    label = 'CC(=O)C(C)[O](3619)',
    structure = SMILES('CC(=O)C(C)[O]'),
    E0 = (-184.342,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1380,1390,370,380,2900,435,375,552.5,462.5,1710,898.125,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00193472,'amu*angstrom^2'), symmetry=1, barrier=(21.9669,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.677211,'amu*angstrom^2'), symmetry=1, barrier=(15.5704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.954878,'amu*angstrom^2'), symmetry=1, barrier=(21.9545,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
...
species(
    label = '[CH]C([O])C(C)[O](3837)',
    structure = SMILES('[CH]C([O])C(C)[O]'),
    E0 = (419.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,180,180,180,742.429,742.44,742.447],'cm^-1')),
        HinderedRotor(inertia=(0.00956244,'amu*angstrom^2'), symmetry=1, barrier=(3.74055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00956288,'amu*angstrom^2'), symmetry=1, barrier=(3.74055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.027667,'amu*angstrom^2'), symmetry=1, barrier=(10.8218,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17873,0.0580284,-5.44074e-05,2.63814e-08,-5.11059e-12,50582.2,25.0678], Tmin=(100,'K'), Tmax=(1244.84,'K')), NASAPolynomial(coeffs=[13.2178,0.0193437,-7.79355e-06,1.41772e-09,-9.71616e-14,47584.8,-35.6505], Tmin=(1244.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([O])C(C)=O(1090)', 'H(8)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=C([O])C(C)[O](1092)', 'H(8)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', 'CC([O])C=O(1045)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH3](11)', '[CH2]C([O])C=O(1032)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['[CH3](11)', '[CH2]C([O])[CH][O](1040)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([O])[C](C)[O](1085)', 'H(8)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C]([O])C(C)[O](1087)', 'H(8)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(S)(14)', '[CH2]C([O])C[O](680)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(T)(63)', '[CH2]C([O])[CH]C(728)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(T)(63)', '[CH2][CH]C(C)[O](730)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC([O])[CH][O](1037)', 'CH2(T)(28)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH]C([O])C(C)[O](3837)'],
    products = ['[CH2]C([O])C(C)[O](3606)'],
