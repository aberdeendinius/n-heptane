...
species(
    label = '[CH2]OC(=C)C([CH2])([CH2])[O](11380)',
    structure = SMILES('[CH2]OC(=C)C([CH2])([CH2])[O]'),
    E0 = (413.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0698284,0.0859962,-8.8972e-05,4.74484e-08,-1.00425e-11,49939.1,34.9317], Tmin=(100,'K'), Tmax=(1148.07,'K')), NASAPolynomial(coeffs=[17.1435,0.026023,-1.06144e-05,1.94719e-09,-1.34332e-13,45986.7,-50.4894], Tmin=(1148.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=CC(C)2OJ) + radical(C=CC(C)(O)CJ) + radical(C=CC(C)(O)CJ) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])C1(C)[CH]O1(11382)',
    structure = SMILES('[CH2]C([CH2])([O])C1(C)[CH]O1'),
    E0 = (453.462,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.33242,0.11179,-0.000146625,9.55883e-08,-2.34812e-11,54735.7,29.7609], Tmin=(100,'K'), Tmax=(1128.75,'K')), NASAPolynomial(coeffs=[21.5803,0.0171115,-2.89121e-06,1.14133e-10,8.50211e-15,50422,-79.7503], Tmin=(1128.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)2OJ) + radical(CCsJO) + radical(CJC(C)2O) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]C([CH2])(O)C1([CH2])[CH]O1(11383)',
    structure = SMILES('[CH2]C([CH2])(O)C1([CH2])[CH]O1'),
    E0 = (435.056,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84633,0.127874,-0.00019004,1.35502e-07,-3.5905e-11,52536.4,31.2962], Tmin=(100,'K'), Tmax=(1073.67,'K')), NASAPolynomial(coeffs=[22.8497,0.0143859,-1.47608e-06,-2.1641e-10,3.56437e-14,48471.5,-83.8374], Tmin=(1073.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical(CJC(C)2O) + radical(CJC(C)2O)"""),
)

species(
    label = '[CH2]C(C)([O])C1([CH2])[CH]O1(11384)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.3881,0.114157,-0.00015411,1.02875e-07,-2.57876e-11,54555.6,30.5669], Tmin=(100,'K'), Tmax=(1115.37,'K')), NASAPolynomial(coeffs=[21.5063,0.0167755,-2.60232e-06,3.78016e-11,1.5002e-14,50398.7,-78.1252], Tmin=(1115.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CCsJO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])C1([CH2])[CH]O1(11385)',
    structure = SMILES('[CH2]C([CH2])([O])C1([CH2])[CH]O1'),
    E0 = (663.972,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,1000,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08647,0.11637,-0.000154962,8.22051e-08,-6.5803e-12,80036.8,28.6969], Tmin=(100,'K'), Tmax=(698.614,'K')), NASAPolynomial(coeffs=[22.2686,0.0138243,-1.7237e-06,-1.4797e-10,3.10619e-14,76012.8,-81.0466], Tmin=(698.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(663.972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)2O) + radical(CCsJO) + radical(CJC(C)OC) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])[C]1CCO1(11386)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.33806,0.0982762,-0.000133553,9.88906e-08,-2.83597e-11,55826.9,29.2392], Tmin=(100,'K'), Tmax=(979.238,'K')), NASAPolynomial(coeffs=[13.068,0.0306627,-1.02946e-05,1.57302e-09,-9.25761e-14,53817.6,-32.0094], Tmin=(979.238,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C([CH2])([CH2])[O](11388)',
    structure = SMILES('[CH2]O[C]([CH2])C([CH2])([CH2])[O]'),
    E0 = (722.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3014.29,3028.57,3042.86,3057.14,3071.43,3085.71,3100,415,431.667,448.333,465,780,803.333,826.667,850,1435,1448.33,1461.67,1475,900,966.667,1033.33,1100,180,180,180,397.893,765.703,1600,1828.57,2971.43,3200],'cm^-1')),
        HinderedRotor(inertia=(0.155552,'amu*angstrom^2'), symmetry=1, barrier=(3.57644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155552,'amu*angstrom^2'), symmetry=1, barrier=(3.57644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155552,'amu*angstrom^2'), symmetry=1, barrier=(3.57644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155552,'amu*angstrom^2'), symmetry=1, barrier=(3.57644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155552,'amu*angstrom^2'), symmetry=1, barrier=(3.57644,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.72409,0.144494,-0.000270599,2.45767e-07,-8.3147e-11,87136.1,34.3758], Tmin=(100,'K'), Tmax=(894.64,'K')), NASAPolynomial(coeffs=[12.503,0.0374044,-1.8147e-05,3.32152e-09,-2.17188e-13,86330.5,-22.953], Tmin=(894.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(722.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)2O) + radical(CJC(C)2O) + radical(CJC(C)OC) + radical(CC(C)2OJ) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2][C]([CH2])C1([CH2])CO1(9926)',
    structure = SMILES('[CH2][C]([CH2])C1([CH2])CO1'),
    E0 = (571.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,360,370,350,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.154928,0.0802682,-8.85207e-05,5.21608e-08,-1.14666e-11,68889.1,28.6881], Tmin=(100,'K'), Tmax=(1341.11,'K')), NASAPolynomial(coeffs=[14.5375,0.0196627,-1.9627e-06,-1.99005e-10,3.34838e-14,66457.6,-40.8796], Tmin=(1341.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(571.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(Isobutyl) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]C([CH2])([O])C1([CH2])CO1(11390)',
    structure = SMILES('[CH]C([CH2])([O])C1([CH2])CO1'),
    E0 = (716.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16576,0.112736,-0.000160973,1.13436e-07,-2.99815e-11,86355.7,30.5732], Tmin=(100,'K'), Tmax=(1068.02,'K')), NASAPolynomial(coeffs=[19.75,0.0174524,-3.34774e-06,1.86687e-10,5.54237e-15,82854.6,-67.1843], Tmin=(1068.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(716.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)2O) + radical(CJC(C)OC) + radical(CC(C)2OJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1(CO1)C([CH2])([CH2])[O](11391)',
    structure = SMILES('[CH]C1(CO1)C([CH2])([CH2])[O]'),
    E0 = (717.954,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.10014,0.110252,-0.000153087,1.05638e-07,-2.7462e-11,86535.3,29.7315], Tmin=(100,'K'), Tmax=(1074.58,'K')), NASAPolynomial(coeffs=[19.7992,0.017831,-3.66135e-06,2.68872e-10,-1.44364e-15,82888.2,-68.6698], Tmin=(1074.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(717.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C([CH2])([CH2])[O](11380)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(70.6831,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[CH2]C1(CO1)C(=C)[O](9302)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(13.708,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 13.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction5',
    reactants = ['O(T)(63)', '[CH2]C(=C)C1([CH2])CO1(9923)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    transitionState = 'TS5',
...
reaction(
    ...
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(104.054,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    products = ['[CH2]C([CH2])([O])C1(C)[CH]O1(11382)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    products = ['[CH2]C([CH2])(O)C1([CH2])[CH]O1(11383)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    products = ['[CH2]C(C)([O])C1([CH2])[CH]O1(11384)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C([CH2])([O])C1([CH2])[CH]O1(11385)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(14)', '[CH2]C([CH2])([O])C(=C)[O](9826)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C([CH2])([CH2])[O](10852)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
    products = ['[CH2]C([CH2])([O])[C]1CCO1(11386)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[C]([CH2])C([CH2])([CH2])[O](11388)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(T)(28)', '[CH2]C([CH2])([O])[C]1CO1(10785)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(T)(63)', '[CH2][C]([CH2])C1([CH2])CO1(9926)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(28)', '[CH2][C]([O])C1([CH2])CO1(10991)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH]C([CH2])([O])C1([CH2])CO1(11390)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(8)', '[CH]C1(CO1)C([CH2])([CH2])[O](11391)'],
    products = ['[CH2]C([CH2])([O])C1([CH2])CO1(10243)'],
