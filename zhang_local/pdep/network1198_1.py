...
species(
    ...
    E0 = (-224.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,348.139,348.682,1425.94,1426.14,1426.24,1426.61],'cm^-1')),
        HinderedRotor(inertia=(0.0713498,'amu*angstrom^2'), symmetry=1, barrier=(6.15561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.367866,'amu*angstrom^2'), symmetry=1, barrier=(31.8294,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369505,'amu*angstrom^2'), symmetry=1, barrier=(31.8292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.19876,'amu*angstrom^2'), symmetry=1, barrier=(4.56988,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
...
species(
    ...
    E0 = (182.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,360,370,350,180,1450.44,1450.49],'cm^-1')),
        HinderedRotor(inertia=(0.120323,'amu*angstrom^2'), symmetry=1, barrier=(2.76647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120472,'amu*angstrom^2'), symmetry=1, barrier=(2.76989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120365,'amu*angstrom^2'), symmetry=1, barrier=(2.76743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
...
species(
    ...
    E0 = (25.0348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,421.558,421.571,421.577],'cm^-1')),
        HinderedRotor(inertia=(0.000948547,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000948602,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(C)=O(1018)', 'H(8)'],
    products = ['[CH2]OC(C)[O](3596)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH3](11)', '[CH2]O[CH][O](556)'],
    products = ['[CH2]OC(C)[O](3596)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[C](C)[O](1014)', 'H(8)'],
    products = ['[CH2]OC(C)[O](3596)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', '[CH2]OC[O](410)'],
    products = ['[CH2]OC(C)[O](3596)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH2(T)(28)', 'CC([O])[O](3601)'],
    products = ['[CH2]OC(C)[O](3596)'],
