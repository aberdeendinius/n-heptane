species(
    label = 'C[CH]OC1([O])CC1(10548)',
    structure = SMILES('C[CH]OC1([O])CC1'),
    E0 = (53.0795,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625911,0.0595061,-1.5679e-05,-2.96113e-08,1.75107e-11,6518.72,25.0923], Tmin=(100,'K'), Tmax=(966.838,'K')), NASAPolynomial(coeffs=[18.9635,0.0185077,-6.16751e-06,1.13079e-09,-8.34376e-14,1343.16,-71.1852], Tmin=(966.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.0795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939965,0.0721692,-7.61555e-05,4.74889e-08,-1.26573e-11,-9923.24,26.2764], Tmin=(100,'K'), Tmax=(888.564,'K')), NASAPolynomial(coeffs=[8.68364,0.0373099,-1.73088e-05,3.33759e-09,-2.3523e-13,-11299.4,-10.1675], Tmin=(888.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.3879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCsJOC(O)) + radical(CJCC=O)"""),
)
...
species(
    label = 'C=COC1([O])CC1(11499)',
    structure = SMILES('C=COC1([O])CC1'),
    E0 = (-39.5106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.851307,0.0413901,5.52967e-05,-1.21321e-07,5.49553e-11,-4612.88,22.5363], Tmin=(100,'K'), Tmax=(928.066,'K')), NASAPolynomial(coeffs=[26.6088,0.002031,3.09535e-06,-6.27456e-10,3.22569e-14,-12479.7,-116.431], Tmin=(928.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.5106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH2]COC1([O])CC1(11796)',
    structure = SMILES('[CH2]COC1([O])CC1'),
    E0 = (84.2126,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760159,0.0578398,-1.67643e-05,-2.36052e-08,1.40434e-11,10257,25.7991], Tmin=(100,'K'), Tmax=(990.69,'K')), NASAPolynomial(coeffs=[17.2377,0.0217043,-8.07138e-06,1.5131e-09,-1.09979e-13,5500.62,-61.0693], Tmin=(990.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.2126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJCO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = 'C[CH]OC1(O)[CH]C1(11797)',
    structure = SMILES('C[CH]OC1(O)[CH]C1'),
    E0 = (20.9913,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265725,0.0562143,2.32747e-05,-9.53996e-08,4.78953e-11,2683.28,27.6136], Tmin=(100,'K'), Tmax=(916.413,'K')), NASAPolynomial(coeffs=[28.8484,-0.000544043,4.87294e-06,-1.0414e-09,6.48989e-14,-5410.82,-123.366], Tmin=(916.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.9913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CCsJOCs)"""),
)

species(
    label = 'CCOC1([O])[CH]C1(11798)',
    structure = SMILES('CCOC1([O])[CH]C1'),
    E0 = (72.5256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11328,0.0473662,1.1836e-05,-5.2504e-08,2.41291e-11,8841.19,26.3942], Tmin=(100,'K'), Tmax=(975.761,'K')), NASAPolynomial(coeffs=[16.9062,0.0213266,-7.6287e-06,1.44302e-09,-1.07174e-13,3916.76,-58.851], Tmin=(975.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.5256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)

species(
    label = '[CH2][CH]OC1(O)CC1(11799)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0729035,0.0665192,-4.75363e-06,-6.72021e-08,3.80846e-11,4098.46,26.9664], Tmin=(100,'K'), Tmax=(914.761,'K')), NASAPolynomial(coeffs=[29.0895,-1.418e-05,4.34311e-06,-9.50836e-10,6.04019e-14,-3788.48,-125.074], Tmin=(914.761,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.6784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
species(
    label = 'C[CH]OC1([O])[CH]C1(11800)',
    structure = SMILES('C[CH]OC1([O])[CH]C1'),
    E0 = (252.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2950,3150,900,1000,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.822601,0.0542698,-6.99193e-06,-3.91486e-08,2.136e-11,30555.2,26.8827], Tmin=(100,'K'), Tmax=(954.533,'K')), NASAPolynomial(coeffs=[19.4574,0.0143301,-4.17953e-06,7.58192e-10,-5.82804e-14,25259.7,-71.2562], Tmin=(954.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CCJCO) + radical(CC(C)(O)OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.27975,0.0434985,8.50503e-05,-1.77031e-07,8.13338e-11,-32484.2,23.3204], Tmin=(100,'K'), Tmax=(911.313,'K')), NASAPolynomial(coeffs=[36.1187,-0.0130444,1.22635e-05,-2.45431e-09,1.57694e-13,-43200.5,-169.21], Tmin=(911.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-271.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane)"""),
)
...
species(
    label = 'C[C]OC1([O])CC1(11803)',
    structure = SMILES('C[C]OC1([O])CC1'),
    E0 = (333.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717246,0.0583798,-2.13474e-05,-2.06931e-08,1.35309e-11,40254.7,24.0518], Tmin=(100,'K'), Tmax=(989.411,'K')), NASAPolynomial(coeffs=[18.6416,0.0172264,-6.42632e-06,1.23824e-09,-9.24533e-14,35175.2,-69.9771], Tmin=(989.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(333.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CH2_triplet) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]OC1([O])CC1(10548)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)O[CH]C(11795)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(136.467,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 134.5 to 136.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=COC1([O])CC1(11499)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]COC1([O])CC1(11796)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C[CH]OC1([O])CC1(10548)'],
    products = ['C[CH]OC1(O)[CH]C1(11797)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]OC1([O])CC1(10548)'],
    products = ['[CH2][CH]OC1(O)CC1(11799)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', 'C[CH]OC1([O])[CH]C1(11800)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2][CH]OC1([O])CC1(10907)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C(32)', '[O]C1([O])CC1(3057)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH3](11)', '[CH]OC1([O])CC1(11768)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', 'C[C]OC1([O])CC1(11803)'],
    products = ['C[CH]OC1([O])CC1(10548)'],
