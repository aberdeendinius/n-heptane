...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0359977,0.0795567,-7.41117e-05,3.46504e-08,-6.37452e-12,17579.4,35.0444], Tmin=(100,'K'), Tmax=(1320.27,'K')), NASAPolynomial(coeffs=[19.0115,0.0218486,-8.54774e-06,1.54399e-09,-1.0564e-13,12549.9,-62.1409], Tmin=(1320.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C1(CO1)C(O)=C=C(30088)',
    structure = SMILES('[CH2]C1(CO1)C(O)=C=C'),
    E0 = (87.9453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,540,610,2055,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,2750,3150,900,1100,180,180,180,180,528.641,1600,1677.04,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.138691,'amu*angstrom^2'), symmetry=1, barrier=(3.18879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138691,'amu*angstrom^2'), symmetry=1, barrier=(3.18879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138691,'amu*angstrom^2'), symmetry=1, barrier=(3.18879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.32601,0.096369,-0.000111327,6.22799e-08,-1.27246e-11,10787.1,30.6813], Tmin=(100,'K'), Tmax=(1440.05,'K')), NASAPolynomial(coeffs=[22.3261,0.00885586,2.55257e-06,-9.60238e-10,8.04673e-14,6236.98,-84.1981], Tmin=(1440.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.9453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)

species(
    label = 'C#CC(O)C1([CH2])CO1(30089)',
    structure = SMILES('C#CC(O)C1([CH2])CO1'),
    E0 = (138.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,1380,1390,370,380,2900,435,3615,1277.5,1000,2750,3150,900,1100,2175,525,3000,3100,440,815,1455,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.868186,0.0954873,-0.000116419,7.05507e-08,-1.58089e-11,16864.9,29.8213], Tmin=(100,'K'), Tmax=(1293.1,'K')), NASAPolynomial(coeffs=[19.8169,0.0131939,2.7816e-07,-5.61803e-10,5.6334e-14,13045.9,-69.3712], Tmin=(1293.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Ethylene_oxide) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]=C(O)C1(C)CO1(30090)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.56259,0.0918104,-9.36428e-05,4.7295e-08,-8.73621e-12,11071.8,33.5022], Tmin=(100,'K'), Tmax=(1616.93,'K')), NASAPolynomial(coeffs=[20.8626,0.0130248,1.0694e-06,-6.70876e-10,5.84818e-14,6866.86,-76.0401], Tmin=(1616.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.1718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C(O)C1(C)[CH]O1(30091)',
    structure = SMILES('C=[C]C(O)C1(C)[CH]O1'),
    E0 = (183.785,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.937685,0.0903098,-9.50898e-05,5.04593e-08,-1.00205e-11,22297.7,33.391], Tmin=(100,'K'), Tmax=(1439.23,'K')), NASAPolynomial(coeffs=[20.6345,0.0154053,-1.44154e-06,-1.36893e-10,2.19536e-14,17636.5,-73.1583], Tmin=(1439.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CCsJO) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]C(O)C1(C)CO1(30092)',
    structure = SMILES('[CH]=[C]C(O)C1(C)CO1'),
    E0 = (247.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,3150,900,1100,1685,370,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.571247,0.0874777,-9.28472e-05,5.10433e-08,-1.06499e-11,29902.1,32.2742], Tmin=(100,'K'), Tmax=(1342.62,'K')), NASAPolynomial(coeffs=[18.6524,0.0187502,-3.26539e-06,2.07354e-10,-7.7604e-16,25772.6,-62.2877], Tmin=(1342.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C]=C(O)C1([CH2])CO1(30093)',
    structure = SMILES('[CH2][C]=C(O)C1([CH2])CO1'),
    E0 = (300.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,3615,1277.5,1000,350,440,435,1725,2750,3150,900,1100,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.312,0.097842,-0.000115197,6.56406e-08,-1.36777e-11,36371.4,32.3295], Tmin=(100,'K'), Tmax=(1407.06,'K')), NASAPolynomial(coeffs=[22.4138,0.00892926,2.4712e-06,-9.52836e-10,8.06775e-14,31819.5,-82.6855], Tmin=(1407.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Ethylene_oxide) + radical(Allyl_P) + radical(Cds_S) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH]O1)C(O)[C]=C(30094)',
    structure = SMILES('[CH2]C1([CH]O1)C(O)[C]=C'),
    E0 = (394.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,1000,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1685,370,1380,1390,370,380,2900,435,180,180,180,180,584.994,1600,1628.25,1800,3000,3200],'cm^-1')),
        HinderedRotor(inertia=(0.145616,'amu*angstrom^2'), symmetry=1, barrier=(3.348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145616,'amu*angstrom^2'), symmetry=1, barrier=(3.348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145616,'amu*angstrom^2'), symmetry=1, barrier=(3.348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145616,'amu*angstrom^2'), symmetry=1, barrier=(3.348,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342158,0.0914884,-9.57866e-05,3.56241e-08,2.21922e-12,47583.4,31.032], Tmin=(100,'K'), Tmax=(803.456,'K')), NASAPolynomial(coeffs=[20.999,0.012938,-8.46178e-07,-2.48053e-10,3.10706e-14,43260,-72.8201], Tmin=(803.456,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]C(O)C1([CH2])CO1(30095)',
    structure = SMILES('[CH]=[C]C(O)C1([CH2])CO1'),
    E0 = (457.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,3150,900,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1685,370,3615,1277.5,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.635695,0.0968827,-0.000124734,8.09132e-08,-1.97739e-11,55216.2,32.2564], Tmin=(100,'K'), Tmax=(1145.25,'K')), NASAPolynomial(coeffs=[18.6512,0.0166448,-2.77958e-06,1.05887e-10,8.50379e-15,51642.9,-59.7214], Tmin=(1145.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(457.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P) + radical(Cds_S) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.62011,0.0907778,-9.10163e-05,4.5195e-08,-8.19531e-12,-14510.4,32.0155], Tmin=(100,'K'), Tmax=(1654.62,'K')), NASAPolynomial(coeffs=[20.5245,0.0132453,1.02658e-06,-6.55746e-10,5.67825e-14,-18553.5,-76.0439], Tmin=(1654.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Ethylene_oxide)"""),
)
...
species(
    label = 'C=[C]C(O)[C]1CCO1(30097)',
    structure = SMILES('C=[C]C(O)[C]1CCO1'),
    E0 = (193.218,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.754291,0.0684582,-5.22152e-05,1.39359e-08,2.73356e-12,23358.6,30.3729], Tmin=(100,'K'), Tmax=(833.202,'K')), NASAPolynomial(coeffs=[12.076,0.0293256,-9.16623e-06,1.41528e-09,-8.78875e-14,20943.6,-25.3521], Tmin=(833.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C(O)[C]=C(30099)',
    structure = SMILES('[CH2]O[C]([CH2])C(O)[C]=C'),
    E0 = (449.899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3615,1277.5,1000,2950,3100,1380,975,1025,1650,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,1380,1390,370,380,2900,435,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.771776,0.1165,-0.000196551,1.71807e-07,-5.7554e-11,54271.2,36.0014], Tmin=(100,'K'), Tmax=(871.643,'K')), NASAPolynomial(coeffs=[11.6297,0.0358413,-1.68781e-05,3.12884e-09,-2.0949e-13,53011.4,-16.9498], Tmin=(871.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CsJOCC2) + radical(CJC(C)OC) + radical(C2CsJOCs)"""),
)
...
species(
    ...
    E0 = (221.931,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH]C1(CO1)C(O)[C]=C(30100)',
    structure = SMILES('[CH]C1(CO1)C(O)[C]=C'),
    E0 = (448.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.547381,0.0870018,-9.57785e-05,5.35898e-08,-1.12893e-11,54090.3,32.7882], Tmin=(100,'K'), Tmax=(1339.38,'K')), NASAPolynomial(coeffs=[19.1007,0.0158357,-2.09255e-06,-2.84365e-12,1.32934e-14,49947.2,-63.5623], Tmin=(1339.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C(O)[C]=C(30087)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(CO1)C(O)=C=C(30088)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', 'C#CC(O)C1([CH2])CO1(30089)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['OH(D)(132)', '[CH2]C1(C=C=C)CO1(18508)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    products = ['[CH2][C]=C(O)C1(C)CO1(30090)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    products = ['C=[C]C(O)C1(C)[CH]O1(30091)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    products = ['C=[C]C([O])C1(C)CO1(16251)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]C(O)C1(C)CO1(30092)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction17',
    reactants = ['OH(D)(132)', '[CH2]C1([CH][C]=C)CO1(18515)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C]=C(O)C1([CH2])CO1(30093)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C(O)[C]=C(30094)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(8)', '[CH]=[C]C(O)C1([CH2])CO1(30095)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(S)(14)', 'C=[C]C(O)C(=C)[O](14497)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C(O)[C]=C(18301)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    products = ['C=C=C(O)C1(C)CO1(30096)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
    products = ['C=[C]C(O)[C]1CCO1(30097)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]O[C]([CH2])C(O)[C]=C(30099)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH2(T)(28)', 'C=[C]C(O)[C]1CO1(28326)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[C]=C(584)', '[CH2]C1([CH]O)CO1(9580)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(8)', '[CH]C1(CO1)C(O)[C]=C(30100)'],
    products = ['[CH2]C1(CO1)C(O)[C]=C(16249)'],
