species(
    label = '[CH2]OC[C]=O(4210)',
    structure = SMILES('[CH2]OC[C]=O'),
    E0 = (40.0284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,239.322,239.334],'cm^-1')),
        HinderedRotor(inertia=(0.00294265,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.2146e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.672915,'amu*angstrom^2'), symmetry=1, barrier=(27.3493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35724,0.0326478,-2.40798e-05,9.12778e-09,-1.40843e-12,4876.24,19.6339], Tmin=(100,'K'), Tmax=(1513,'K')), NASAPolynomial(coeffs=[9.37819,0.0140859,-5.67723e-06,1.01907e-09,-6.85755e-14,2751.72,-17.1454], Tmin=(1513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.0284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(CsCJ=O) + radical(CsJOCC)"""),
)
...
species(
    label = '[CH2]OC=C=O(4531)',
    structure = SMILES('[CH2]OC=C=O'),
    E0 = (16.7315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,330.093,331.219],'cm^-1')),
        HinderedRotor(inertia=(0.25846,'amu*angstrom^2'), symmetry=1, barrier=(19.9631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254974,'amu*angstrom^2'), symmetry=1, barrier=(19.9647,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = '[CH2]OC=[C][O](4533)',
    structure = SMILES('[CH2]OC=[C][O]'),
    E0 = (216.462,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,397.991,402.335,402.534],'cm^-1')),
        HinderedRotor(inertia=(0.188881,'amu*angstrom^2'), symmetry=1, barrier=(21.694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189746,'amu*angstrom^2'), symmetry=1, barrier=(21.6784,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.091,0.0287765,1.00802e-05,-4.80236e-08,2.47328e-11,26115.5,20.5902], Tmin=(100,'K'), Tmax=(909.221,'K')), NASAPolynomial(coeffs=[17.1663,-0.00241154,3.57071e-06,-7.50879e-10,4.89539e-14,21921.9,-58.6909], Tmin=(909.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]OC=C=O(4531)'],
    products = ['[CH2]OC[C]=O(4210)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[CH2](420)', '[C-]#[O+](374)'],
    products = ['[CH2]OC[C]=O(4210)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.52739e+06,'m^3/(mol*s)'), n=0.364815, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;C_pri_rad] for rate rule [COm;C_rad/H2/O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction12',
    reactants = ['[C]=O(1149)', '[CH2]O[CH2](420)'],
    products = ['[CH2]OC[C]=O(4210)'],
