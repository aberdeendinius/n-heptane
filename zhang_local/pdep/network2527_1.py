species(
    label = '[CH2]C(O)C1([CH2])CO1(9319)',
    structure = SMILES('[CH2]C(O)C1([CH2])CO1'),
    E0 = (80.6541,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.395237,0.0902333,-0.000111478,7.04532e-08,-1.67323e-11,9864.38,27.5198], Tmin=(100,'K'), Tmax=(1195.66,'K')), NASAPolynomial(coeffs=[17.3283,0.0171352,-2.45477e-06,7.98388e-12,1.6217e-14,6612.93,-57.0263], Tmin=(1195.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.6541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]OC(=C)C([CH2])O(9856)',
    structure = SMILES('[CH2]OC(=C)C([CH2])O'),
    E0 = (18.3937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,3615,1277.5,1000,350,440,435,1725,1380,1390,370,380,2900,435,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35897,0.0688947,-4.748e-05,3.60982e-09,5.89045e-12,2353.36,31.2245], Tmin=(100,'K'), Tmax=(976.938,'K')), NASAPolynomial(coeffs=[19.0529,0.0170512,-5.79959e-06,1.04407e-09,-7.49616e-14,-2477.76,-64.5584], Tmin=(976.938,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.3937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.239671,0.091855,-0.000121732,8.39021e-08,-2.18645e-11,5649.5,25.7568], Tmin=(100,'K'), Tmax=(1092.62,'K')), NASAPolynomial(coeffs=[15.2143,0.0209177,-4.62987e-06,4.21771e-10,-1.09978e-14,3129.69,-46.2456], Tmin=(1092.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.6928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C](O)C1(C)CO1(9859)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142341,0.0855221,-0.000102508,6.44672e-08,-1.53872e-11,5779.41,26.2863], Tmin=(100,'K'), Tmax=(1180.22,'K')), NASAPolynomial(coeffs=[15.8261,0.0196416,-3.83046e-06,2.85028e-10,-3.42194e-15,2829.2,-49.9284], Tmin=(1180.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.7718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)C1(C)[CH]O1(9860)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.65121,0.0858123,-9.38843e-05,5.16607e-08,-1.05592e-11,6660.32,28.8897], Tmin=(100,'K'), Tmax=(1416.26,'K')), NASAPolynomial(coeffs=[19.2088,0.0136391,-4.11216e-07,-3.56729e-10,3.82138e-14,2647.75,-68.1413], Tmin=(1416.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.8664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCsJO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.590977,0.0903733,-0.000107305,6.41163e-08,-1.42964e-11,6523.41,27.789], Tmin=(100,'K'), Tmax=(1281.32,'K')), NASAPolynomial(coeffs=[18.9584,0.0144569,-1.00358e-06,-2.59837e-10,3.34161e-14,2735.7,-66.6027], Tmin=(1281.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.7874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO)"""),
)

species(
    label = '[CH2]C([O])C1(C)CO1(9634)',
    structure = SMILES('[CH2]C([O])C1(C)CO1'),
    E0 = (100.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.28914,0.0781838,-7.80524e-05,4.07413e-08,-8.02287e-12,12256.2,27.2017], Tmin=(100,'K'), Tmax=(1457.86,'K')), NASAPolynomial(coeffs=[16.9016,0.0179229,-2.5772e-06,6.63924e-11,8.7084e-15,8635.38,-57.4415], Tmin=(1457.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690236,0.0554807,9.22983e-06,-7.47506e-08,4.16218e-11,-31513,22.8612], Tmin=(100,'K'), Tmax=(861.827,'K')), NASAPolynomial(coeffs=[22.3774,0.0065686,4.29996e-06,-1.27057e-09,9.77126e-14,-37172.7,-89.6906], Tmin=(861.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-263.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.639546,0.0688576,-6.90073e-05,3.99493e-08,-9.16261e-12,7738.52,27.3008], Tmin=(100,'K'), Tmax=(1183.92,'K')), NASAPolynomial(coeffs=[11.6394,0.0258665,-7.15566e-06,9.63286e-10,-5.2336e-14,5542.32,-25.8993], Tmin=(1183.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.2996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C([CH2])O(9865)',
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.555837,0.112743,-0.000197476,1.75036e-07,-5.85992e-11,38637,31.759], Tmin=(100,'K'), Tmax=(890.815,'K')), NASAPolynomial(coeffs=[10.8603,0.0330014,-1.52461e-05,2.76989e-09,-1.81879e-13,37733.1,-15.6549], Tmin=(890.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CsJOCC2) + radical(CJC(C)OC) + radical(CJCO)"""),
)
...
species(
    label = '[CH]C1(CO1)C([CH2])O(9868)',
    structure = SMILES('[CH]C1(CO1)C([CH2])O'),
    E0 = (318.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,3150,900,1100,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.277773,0.0826812,-9.50973e-05,5.53521e-08,-1.2022e-11,38453.7,28.349], Tmin=(100,'K'), Tmax=(1321.21,'K')), NASAPolynomial(coeffs=[17.7526,0.0139432,-9.92065e-07,-2.38753e-10,3.08541e-14,34924.4,-58.9854], Tmin=(1321.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C1([CH2])CO1(9869)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287273,0.088007,-0.000110936,7.05957e-08,-1.68043e-11,38319.9,27.5025], Tmin=(100,'K'), Tmax=(1197.71,'K')), NASAPolynomial(coeffs=[17.3237,0.0149806,-1.68077e-06,-1.23842e-10,2.48349e-14,35120.6,-56.3826], Tmin=(1197.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC(=C)C([CH2])O(9856)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH2]C1(CO1)C(=C)O(9858)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', '[CH2]C1(C=C)CO1(9227)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    products = ['[CH2]C1(CO1)[C](C)O(9630)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    products = ['[CH2][C](O)C1(C)CO1(9859)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    products = ['[CH2]C(O)C1(C)[CH]O1(9860)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    products = ['[CH2]C1([CH]O1)C(C)O(9633)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(O)C1([CH2])CO1(9319)'],
    products = ['[CH2]C([O])C1(C)CO1(9634)'],
...
reaction(
    label = 'reaction14',
    reactants = ['OH(D)(132)', '[CH2][CH]C1([CH2])CO1(9363)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(8)', '[CH2]C([O])C1([CH2])CO1(9235)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][C](O)C1([CH2])CO1(9861)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2]C(O)C1([CH2])[CH]O1(9862)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(S)(14)', '[CH2]C(O)C(=C)[O](1091)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C([CH2])O(6376)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]O[C]([CH2])C([CH2])O(9865)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(28)', '[CH2]C(O)[C]1CO1(5843)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(28)', '[CH2]C1([CH]O)CO1(9580)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C1(CO1)C([CH2])O(9868)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(8)', '[CH]C(O)C1([CH2])CO1(9869)'],
    products = ['[CH2]C(O)C1([CH2])CO1(9319)'],
