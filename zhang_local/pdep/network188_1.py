species(
    ...
    E0 = (92.2517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1869.36,1869.56,1869.78],'cm^-1')),
        HinderedRotor(inertia=(0.205015,'amu*angstrom^2'), symmetry=1, barrier=(4.71369,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205136,'amu*angstrom^2'), symmetry=1, barrier=(4.71648,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205114,'amu*angstrom^2'), symmetry=1, barrier=(4.71597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205167,'amu*angstrom^2'), symmetry=1, barrier=(4.7172,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (13.3303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,304.761,304.761,2253.46],'cm^-1')),
        HinderedRotor(inertia=(0.121498,'amu*angstrom^2'), symmetry=1, barrier=(8.00788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121499,'amu*angstrom^2'), symmetry=1, barrier=(8.00788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121499,'amu*angstrom^2'), symmetry=1, barrier=(8.00788,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (20.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,190.606,190.792,2193.22],'cm^-1')),
        HinderedRotor(inertia=(0.00463171,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241007,'amu*angstrom^2'), symmetry=1, barrier=(6.21442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240511,'amu*angstrom^2'), symmetry=1, barrier=(6.21304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    label = '[CH2]CCCC[O](538)',
    structure = SMILES('[CH2]CCCC[O]'),
    E0 = (103.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,270.925,270.958,1581.59,1581.6],'cm^-1')),
        HinderedRotor(inertia=(0.00229372,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0956097,'amu*angstrom^2'), symmetry=1, barrier=(4.98058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0955894,'amu*angstrom^2'), symmetry=1, barrier=(4.98067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0956236,'amu*angstrom^2'), symmetry=1, barrier=(4.98077,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    label = 'C[CH][CH]CC[O](543)',
    structure = SMILES('C[CH][CH]CC[O]'),
    E0 = (286.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1904.76,1904.79,1904.82,1905.04],'cm^-1')),
        HinderedRotor(inertia=(0.172303,'amu*angstrom^2'), symmetry=1, barrier=(3.96159,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17247,'amu*angstrom^2'), symmetry=1, barrier=(3.96543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172836,'amu*angstrom^2'), symmetry=1, barrier=(3.97383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172345,'amu*angstrom^2'), symmetry=1, barrier=(3.96254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85487,0.0597792,-9.15356e-05,1.00387e-07,-4.12662e-11,34546.8,28.409], Tmin=(100,'K'), Tmax=(851.789,'K')), NASAPolynomial(coeffs=[-3.72979,0.0541486,-2.55215e-05,4.81373e-09,-3.28786e-13,36653.9,61.2395], Tmin=(851.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(CCOJ)"""),
)

species(
    label = 'CC[CH][CH]C[O](544)',
    structure = SMILES('CC[CH][CH]C[O]'),
    E0 = (292.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1720.03,1720.1,1720.18],'cm^-1')),
        HinderedRotor(inertia=(0.195411,'amu*angstrom^2'), symmetry=1, barrier=(4.49288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195404,'amu*angstrom^2'), symmetry=1, barrier=(4.49273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0021398,'amu*angstrom^2'), symmetry=1, barrier=(4.49262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195377,'amu*angstrom^2'), symmetry=1, barrier=(4.49211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84426,0.0544234,-6.36614e-05,6.25993e-08,-2.58323e-11,35208.8,28.2089], Tmin=(100,'K'), Tmax=(808.662,'K')), NASAPolynomial(coeffs=[-0.0559816,0.0479676,-2.22764e-05,4.23519e-09,-2.93171e-13,36034.5,40.1783], Tmin=(808.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C[CH]CC[O](546)',
    structure = SMILES('[CH2]C[CH]CC[O]'),
    E0 = (297.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,1937.84,1937.98,1937.98],'cm^-1')),
        HinderedRotor(inertia=(0.102714,'amu*angstrom^2'), symmetry=1, barrier=(2.36161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102634,'amu*angstrom^2'), symmetry=1, barrier=(2.35976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102691,'amu*angstrom^2'), symmetry=1, barrier=(2.36107,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102579,'amu*angstrom^2'), symmetry=1, barrier=(2.35849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67834,0.0604799,-8.31444e-05,8.4864e-08,-3.43123e-11,35855.2,28.0938], Tmin=(100,'K'), Tmax=(829.86,'K')), NASAPolynomial(coeffs=[-0.753941,0.0498391,-2.34858e-05,4.46219e-09,-3.07433e-13,37029,44.0144], Tmin=(829.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (116.02,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,2131.7,2131.89],'cm^-1')),
        HinderedRotor(inertia=(0.111962,'amu*angstrom^2'), symmetry=1, barrier=(2.57422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111901,'amu*angstrom^2'), symmetry=1, barrier=(2.57283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111906,'amu*angstrom^2'), symmetry=1, barrier=(2.57293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30045,0.0438719,-5.13451e-05,5.28543e-08,-2.23048e-11,14008.8,22.0021], Tmin=(100,'K'), Tmax=(821.271,'K')), NASAPolynomial(coeffs=[-0.551059,0.0420728,-1.94072e-05,3.67055e-09,-2.52999e-13,15006.2,38.4184], Tmin=(821.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(116.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(C)CC[O](550)',
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29608,0.0466145,1.77848e-05,-1.35486e-07,1.29044e-10,41666.9,21.662], Tmin=(100,'K'), Tmax=(424.349,'K')), NASAPolynomial(coeffs=[4.2311,0.0428158,-1.9834e-05,3.81127e-09,-2.67506e-13,41372.7,12.4533], Tmin=(424.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['[CH3](11)', '[CH2][CH]CC[O](480)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', 'C[CH][CH]CC[O](543)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'CC[CH][CH]C[O](544)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]C[CH][O](545)', 'H(8)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C[CH]CC[O](546)', 'H(8)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH2(S)(14)', 'C[CH]CC[O](391)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[O](419)', '[CH]CC(45)'],
    products = ['CC[CH]CC[O](397)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O(T)(63)', '[CH2]C[CH]CC(23)'],
    products = ['CC[CH]CC[O](397)'],
