species(
    label = 'C=[C]CO[C]=O(17482)',
    structure = SMILES('C=[C]CO[C]=O'),
    E0 = (137.465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,1855,455,950,2950,3100,1380,975,1025,1650,282.583,763.057,4000],'cm^-1')),
        HinderedRotor(inertia=(0.370282,'amu*angstrom^2'), symmetry=1, barrier=(20.4767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237106,'amu*angstrom^2'), symmetry=1, barrier=(12.9557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676773,'amu*angstrom^2'), symmetry=1, barrier=(37.8434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', 'C=C=CO[C]=O(17918)'],
    products = ['C=[C]CO[C]=O(17482)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]CO[C]=O(17482)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(46.7986,'m^3/(mol*s)'), n=2.021, Ea=(145.087,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd-O2d;CJ]
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', 'C=[C][CH]O[C]=O(17922)'],
    products = ['C=[C]CO[C]=O(17482)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]CO[C]=O(17923)'],
    products = ['C=[C]CO[C]=O(17482)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[C-]#[O+](374)', 'C=[C]C[O](4571)'],
    products = ['C=[C]CO[C]=O(17482)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=O(1149)', 'C=[C]C[O](4571)'],
    products = ['C=[C]CO[C]=O(17482)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[C]=C(584)', '[CH2]O[C]=O(1735)'],
    products = ['C=[C]CO[C]=O(17482)'],
