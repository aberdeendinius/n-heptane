species(
    label = '[CH2]OC[C]=C(17454)',
    structure = SMILES('[CH2]OC[C]=C'),
    E0 = (299.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,345.655,345.656,1595.67],'cm^-1')),
        HinderedRotor(inertia=(0.00141096,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0706805,'amu*angstrom^2'), symmetry=1, barrier=(5.99258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0706802,'amu*angstrom^2'), symmetry=1, barrier=(5.99253,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4457,0.0361967,-2.50638e-05,1.02845e-08,-1.94375e-12,36057.4,20.002], Tmin=(100,'K'), Tmax=(1144.58,'K')), NASAPolynomial(coeffs=[5.54159,0.0253775,-1.0885e-05,2.02612e-09,-1.39957e-13,35348.6,4.64807], Tmin=(1144.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CsJOCC)"""),
)
...
species(
    label = '[CH]=[C]COC(17669)',
    structure = SMILES('[CH]=[C]COC'),
    E0 = (358.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3120,650,792.5,1650,2750,2800,2850,1350,1500,750,1050,1375,1000,258.635,1906.24],'cm^-1')),
        HinderedRotor(inertia=(0.171568,'amu*angstrom^2'), symmetry=1, barrier=(8.15227,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17157,'amu*angstrom^2'), symmetry=1, barrier=(8.15128,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171379,'amu*angstrom^2'), symmetry=1, barrier=(8.15293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17128,0.0446626,-5.64007e-05,5.04133e-08,-1.89506e-11,43199.8,19.698], Tmin=(100,'K'), Tmax=(802.055,'K')), NASAPolynomial(coeffs=[3.52071,0.0299318,-1.38877e-05,2.63904e-09,-1.82653e-13,43240.7,15.0897], Tmin=(802.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77353,0.0356765,9.57055e-06,-4.68135e-08,2.3125e-11,-795.252,15.7047], Tmin=(100,'K'), Tmax=(931.042,'K')), NASAPolynomial(coeffs=[16.0099,0.00848051,-1.33852e-06,1.83009e-10,-1.61369e-14,-4918.39,-59.8666], Tmin=(931.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.3805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C1COC1(17673)',
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.01887,0.00829231,6.32672e-05,-8.19949e-08,3.01055e-11,1197.01,13.8043], Tmin=(100,'K'), Tmax=(981.569,'K')), NASAPolynomial(coeffs=[8.17183,0.0211226,-8.0361e-06,1.54469e-09,-1.14266e-13,-1444.27,-19.2613], Tmin=(981.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.56025,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[C]=C(17454)'],
    products = ['C=O(355)', 'C=C=C(6077)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]OC=C=C(17666)'],
    products = ['[CH2]OC[C]=C(17454)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['C=O(355)', '[CH2][C]=C(6078)'],
    products = ['[CH2]OC[C]=C(17454)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](357)', '[CH2][C]=C(6078)'],
    products = ['[CH2]OC[C]=C(17454)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(8)', '[CH2][C]=CO[CH2](17670)'],
    products = ['[CH2]OC[C]=C(17454)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]=[C]CO[CH2](17671)'],
    products = ['[CH2]OC[C]=C(17454)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(28)', 'C=[C]C[O](4571)'],
    products = ['[CH2]OC[C]=C(17454)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=C(584)', '[CH2]O[CH2](420)'],
    products = ['[CH2]OC[C]=C(17454)'],
