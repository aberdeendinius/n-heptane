...
species(
    label = '[CH2]CC(=O)C[C]=CO(27775)',
    structure = SMILES('[CH2]CC(=O)C[C]=CO'),
    E0 = (67.2118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,3010,987.5,1337.5,450,1655,375,552.5,462.5,1710,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.158863,0.0850924,-8.2023e-05,3.90013e-08,-7.31087e-12,8238.72,30.4848], Tmin=(100,'K'), Tmax=(1290.35,'K')), NASAPolynomial(coeffs=[19.7176,0.0234765,-1.0396e-05,1.99469e-09,-1.40977e-13,3109.21,-70.4744], Tmin=(1290.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(67.2118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(CJCC=O)"""),
)
...
species(
    label = '[O]C1(C=C=CO)CC1(29735)',
    structure = SMILES('[O]C1(C=C=CO)CC1'),
    E0 = (85.3365,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([540,610,2055,2995,3025,975,1000,1300,1375,400,500,1630,1680,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437708,0.0569533,1.09737e-05,-7.20526e-08,3.66481e-11,10411.7,28.1457], Tmin=(100,'K'), Tmax=(927.507,'K')), NASAPolynomial(coeffs=[24.3719,0.00878119,-1.45478e-07,-7.18402e-11,-1.02187e-15,3604.04,-98.286], Tmin=(927.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.3365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Cyclopropane) + radical(C=CC(C)2OJ)"""),
)

species(
    label = '[O]C1(CC#CO)CC1(29736)',
    structure = SMILES('[O]C1(CC#CO)CC1'),
    E0 = (161.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,2100,2250,500,550,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.700054,0.0612034,-2.78504e-05,-1.20926e-08,1.03314e-11,19566.6,27.3316], Tmin=(100,'K'), Tmax=(975.039,'K')), NASAPolynomial(coeffs=[16.4802,0.0223187,-7.80094e-06,1.39141e-09,-9.80383e-14,15260.5,-54.7014], Tmin=(975.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CtH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Ct-CtCs) + group(Ct-CtOs) + ring(Cyclopropane) + radical(CC(C)2OJ)"""),
)
...
species(
    label = 'OC=[C]CC1(O)[CH]C1(29737)',
    structure = SMILES('OC=[C]CC1(O)[CH]C1'),
    E0 = (137.011,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00512219,0.0677062,-1.0267e-05,-5.60008e-08,3.26325e-11,16641.8,31.4516], Tmin=(100,'K'), Tmax=(916.604,'K')), NASAPolynomial(coeffs=[26.212,0.00701166,1.15428e-06,-3.73286e-10,2.24869e-14,9579.21,-105.057], Tmin=(916.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Cds_S) + radical(CCJCO)"""),
)

species(
    label = 'OC=[C][CH]C1(O)CC1(29738)',
    structure = SMILES('OC=[C][CH]C1(O)CC1'),
    E0 = (54.0259,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.411986,0.0768059,-2.64092e-05,-4.29511e-08,2.85028e-11,6675.45,27.6145], Tmin=(100,'K'), Tmax=(921.275,'K')), NASAPolynomial(coeffs=[27.7768,0.00728912,6.89072e-07,-2.64433e-10,1.43755e-14,-762.275,-118.246], Tmin=(921.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.0259,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'O[C]=[C]CC1(O)CC1(29739)',
    structure = SMILES('O[C]=[C]CC1(O)CC1'),
    E0 = (176.853,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3580,3650,1210,1345,900,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0143418,0.0746416,-4.57239e-05,-7.64804e-09,1.24488e-11,21426,32.0131], Tmin=(100,'K'), Tmax=(930.776,'K')), NASAPolynomial(coeffs=[21.5102,0.015428,-3.74498e-06,5.66103e-10,-3.96361e-14,15987.9,-77.8674], Tmin=(930.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = '[O]C1([CH]C1)C[C]=CO(29740)',
    structure = SMILES('[O]C1([CH]C1)C[C]=CO'),
    E0 = (365.927,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2950,3150,900,1000,1100,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205111,0.0638334,-8.50732e-06,-5.34034e-08,3.05352e-11,44165.7,30.7579], Tmin=(100,'K'), Tmax=(924.073,'K')), NASAPolynomial(coeffs=[24.9844,0.00747597,3.45272e-07,-1.77452e-10,7.6634e-15,37412.8,-98.5908], Tmin=(924.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(CCJCO) + radical(Cds_S) + radical(CC(C)2OJ)"""),
)

species(
    label = '[O]C1([CH][C]=CO)CC1(29741)',
    structure = SMILES('[O]C1([CH][C]=CO)CC1'),
    E0 = (282.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3010,987.5,1337.5,450,1655,3615,1277.5,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.202373,0.0729392,-2.46635e-05,-4.03495e-08,2.64116e-11,34199.4,26.923], Tmin=(100,'K'), Tmax=(929.241,'K')), NASAPolynomial(coeffs=[26.5573,0.00773968,-1.12055e-07,-7.04502e-11,-2.94948e-16,27067.8,-111.826], Tmin=(929.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(Cds_S) + radical(C=CCJCO)"""),
)

species(
    label = '[O]C1(C[C]=[C]O)CC1(29742)',
    structure = SMILES('[O]C1(C[C]=[C]O)CC1'),
    E0 = (405.769,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1670,1700,300,440,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218824,0.0708337,-4.41719e-05,-4.82204e-09,1.02782e-11,48950.2,31.3401], Tmin=(100,'K'), Tmax=(946.019,'K')), NASAPolynomial(coeffs=[20.3251,0.0158205,-4.51265e-06,7.52193e-10,-5.36526e-14,43803.5,-71.6404], Tmin=(946.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(C=CJO) + radical(CC(C)2OJ) + radical(Cds_S)"""),
)
...
species(
    label = 'OC=C=CC1(O)CC1(29743)',
    structure = SMILES('OC=C=CC1(O)CC1'),
    E0 = (-143.766,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0718391,0.063047,8.56869e-06,-7.88014e-08,4.15882e-11,-17127.9,28.246], Tmin=(100,'K'), Tmax=(914.1,'K')), NASAPolynomial(coeffs=[27.4036,0.00508058,2.54989e-06,-6.49456e-10,4.06904e-14,-24699.7,-115.244], Tmin=(914.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-143.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + ring(Cyclopropane)"""),
)
...
species(
    label = 'OC=[C]C[C]1CC1(28611)',
    structure = SMILES('OC=[C]C[C]1CC1'),
    E0 = (303.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.912367,0.0551372,-1.3138e-05,-2.8665e-08,1.691e-11,36678.9,26.39], Tmin=(100,'K'), Tmax=(948.71,'K')), NASAPolynomial(coeffs=[16.8447,0.0192568,-5.88677e-06,1.00872e-09,-7.17132e-14,32247.5,-57.0575], Tmin=(948.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C[C]=CO(27775)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[O]C1(C=C=CO)CC1(29735)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[O]C1(CC#CO)CC1(29736)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C#CCC1([O])CC1(18104)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[O]C1(C[C]=CO)CC1(15814)'],
    products = ['[O]C1(CC=[C]O)CC1(15811)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[O]C1(C[C]=CO)CC1(15814)'],
    products = ['OC=[C]CC1(O)[CH]C1(29737)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[O]C1(C[C]=CO)CC1(15814)'],
    products = ['OC=[C][CH]C1(O)CC1(29738)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C1(C[C]=CO)CC1(15814)'],
    products = ['[O]C1([CH]C1)CC=CO(15818)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O[C]=[C]CC1(O)CC1(29739)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[O]C1(C[C]=CO)CC1(15814)'],
    products = ['[O]C=[C]CC1(O)CC1(15815)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH]=[C]CC1([O])CC1(18111)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[O]C1([CH]C1)C[C]=CO(29740)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[O]C1([CH][C]=CO)CC1(29741)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[O]C1(C[C]=[C]O)CC1(29742)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(S)(14)', 'C=C([O])C[C]=CO(14467)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', 'OC=[C]C[C]1CC1(28611)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C1([O])CC1(4307)', '[C]=CO(27807)'],
    products = ['[O]C1(C[C]=CO)CC1(15814)'],
