...
species(
    label = '[C]=[C]CC[C]=[CH](19881)',
    structure = SMILES('[C]=[C]CC[C]=[CH]'),
    E0 = (1344.58,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1670,1700,300,440,324.811,325.757],'cm^-1')),
        HinderedRotor(inertia=(0.111559,'amu*angstrom^2'), symmetry=1, barrier=(8.36931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115199,'amu*angstrom^2'), symmetry=1, barrier=(8.35274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114764,'amu*angstrom^2'), symmetry=1, barrier=(8.33365,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (77.1039,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45443,0.0616193,-9.27258e-05,8.07075e-08,-2.80629e-11,161802,25.9061], Tmin=(100,'K'), Tmax=(822.626,'K')), NASAPolynomial(coeffs=[6.70104,0.0269571,-1.28364e-05,2.44197e-09,-1.6813e-13,161248,3.50053], Tmin=(822.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1344.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CdCdJ2_triplet) + radical(Cds_S) + radical(Cds_S)"""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CC[C]=[CH](18823)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(0.00755369,'m^3/(mol*s)'), n=2.43138, Ea=(90.4451,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds_Cdd;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 85.6 to 90.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]C[CH2](5188)', '[C]=[CH](18830)'],
    products = ['[CH]=[C]CC[C]=[CH](18823)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[C]=[C]CC[C]=[CH](19881)'],
    products = ['[CH]=[C]CC[C]=[CH](18823)'],
