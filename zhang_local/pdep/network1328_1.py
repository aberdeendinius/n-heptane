...
species(
    label = '[O]C[CH][C]=O(4552)',
    structure = SMILES('[O]C[CH][C]=O'),
    E0 = (222.417,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,3025,407.5,1350,352.5,2155.88,2155.96],'cm^-1')),
        HinderedRotor(inertia=(0.237866,'amu*angstrom^2'), symmetry=1, barrier=(5.469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23784,'amu*angstrom^2'), symmetry=1, barrier=(5.46842,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60078,0.0383029,-6.83094e-05,7.07147e-08,-2.72259e-11,26793.7,21.2918], Tmin=(100,'K'), Tmax=(860.672,'K')), NASAPolynomial(coeffs=[1.68419,0.0242377,-1.1859e-05,2.25067e-09,-1.53351e-13,27630.2,29.5192], Tmin=(860.672,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCOJ) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[O]CC=C=O(4548)'],
    products = ['[O]CC[C]=O(4208)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction18',
    reactants = ['[C]=O(1149)', '[CH2]C[O](419)'],
    products = ['[O]CC[C]=O(4208)'],
