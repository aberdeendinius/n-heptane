...
species(
    label = '[CH2]CC(=O)C(O)[C]=C(27774)',
    structure = SMILES('[CH2]CC(=O)C(O)[C]=C'),
    E0 = (98.8057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2950,3100,1380,975,1025,1650,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1685,370,375,552.5,462.5,1710,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.465728,0.0831049,-9.75507e-05,6.57104e-08,-1.84194e-11,12006.1,32.988], Tmin=(100,'K'), Tmax=(857.483,'K')), NASAPolynomial(coeffs=[10.2965,0.0372457,-1.73283e-05,3.33949e-09,-2.34944e-13,10320.2,-12.9283], Tmin=(857.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(98.8057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CJCC=O)"""),
)
...
species(
    label = 'C=C=C(O)C1([O])CC1(29744)',
    structure = SMILES('C=C=C(O)C1([O])CC1'),
    E0 = (79.5705,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,540,610,2055,3615,1277.5,1000,350,440,435,1725,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480156,0.0598499,-6.85049e-06,-4.63848e-08,2.55575e-11,9712.94,28.1912], Tmin=(100,'K'), Tmax=(941.829,'K')), NASAPolynomial(coeffs=[21.7163,0.0135934,-3.15237e-06,5.26755e-10,-4.1805e-14,3764.2,-83.3328], Tmin=(941.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.5705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclopropane) + radical(C=CC(C)2OJ)"""),
)

species(
    label = 'C#CC(O)C1([O])CC1(29745)',
    structure = SMILES('C#CC(O)C1([O])CC1'),
    E0 = (130.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([750,770,3400,2100,1380,1390,370,380,2900,435,3615,1277.5,1000,2175,525,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378442,0.0659101,-2.89323e-05,-2.12472e-08,1.64121e-11,15792.8,28.1898], Tmin=(100,'K'), Tmax=(934.81,'K')), NASAPolynomial(coeffs=[20.208,0.0157168,-4.00167e-06,6.31912e-10,-4.51882e-14,10571.1,-74.2389], Tmin=(934.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Ct-CtCs) + group(Ct-CtH) + ring(Cyclopropane) + radical(CC(C)2OJ)"""),
)
...
species(
    label = 'C=[C]C(O)C1(O)[CH]C1(29746)',
    structure = SMILES('C=[C]C(O)C1(O)[CH]C1'),
    E0 = (172.997,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.332566,0.0665666,-2.89326e-05,-1.94155e-08,1.48089e-11,20951.6,33.646], Tmin=(100,'K'), Tmax=(958.269,'K')), NASAPolynomial(coeffs=[20.0202,0.0180264,-5.60877e-06,9.91738e-10,-7.23117e-14,15633.8,-68.5555], Tmin=(958.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C]=C(O)C1(O)CC1(29747)',
    structure = SMILES('[CH2][C]=C(O)C1(O)CC1'),
    E0 = (63.2046,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0462235,0.0683574,-1.63035e-05,-4.57832e-08,2.78886e-11,7761.37,30.2361], Tmin=(100,'K'), Tmax=(921.782,'K')), NASAPolynomial(coeffs=[24.6074,0.010266,-6.78845e-07,-1.53999e-11,-1.91135e-15,1173.32,-97.431], Tmin=(921.782,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.2046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]C(O)C1(O)CC1(29748)',
    structure = SMILES('[CH]=[C]C(O)C1(O)CC1'),
    E0 = (220.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,1380,1390,370,380,2900,435,3580,3650,1210,1345,900,1100,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.056517,0.0753929,-5.4518e-05,7.82215e-09,4.90653e-12,26635,32.5434], Tmin=(100,'K'), Tmax=(975.503,'K')), NASAPolynomial(coeffs=[19.7941,0.019324,-6.53547e-06,1.15912e-09,-8.20652e-14,21601.2,-68.2534], Tmin=(975.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_P) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]C(O)C1([O])[CH]C1(29749)',
    structure = SMILES('C=[C]C(O)C1([O])[CH]C1'),
    E0 = (401.913,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,3615,1277.5,1000,1380,1390,370,380,2900,435,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.539065,0.0627227,-2.71887e-05,-1.69519e-08,1.28518e-11,48475.6,32.9664], Tmin=(100,'K'), Tmax=(975.637,'K')), NASAPolynomial(coeffs=[18.8766,0.0183511,-6.33862e-06,1.1691e-09,-8.56176e-14,43431.1,-62.5641], Tmin=(975.637,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2][C]=C(O)C1([O])CC1(29750)',
    structure = SMILES('[CH2][C]=C(O)C1([O])CC1'),
    E0 = (292.307,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407756,0.0623103,-1.40338e-05,-3.89143e-08,2.29294e-11,35301.1,30.1516], Tmin=(100,'K'), Tmax=(941.472,'K')), NASAPolynomial(coeffs=[21.6173,0.0138963,-3.33391e-06,5.52728e-10,-4.28387e-14,29459.4,-80.7072], Tmin=(941.472,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(Cds_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=[C]C(O)C1([O])CC1(29751)',
    structure = SMILES('[CH]=[C]C(O)C1([O])CC1'),
    E0 = (449.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1685,370,1380,1390,370,380,2900,435,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254391,0.0716431,-5.30607e-05,1.05811e-08,2.86341e-12,54159.4,31.8953], Tmin=(100,'K'), Tmax=(1005.36,'K')), NASAPolynomial(coeffs=[18.7303,0.0195165,-7.19044e-06,1.31903e-09,-9.39383e-14,49363.8,-62.7132], Tmin=(1005.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.11746,0.065912,-9.17933e-06,-5.31661e-08,3.04739e-11,-17826.7,28.2798], Tmin=(100,'K'), Tmax=(923.06,'K')), NASAPolynomial(coeffs=[24.7075,0.00996089,-4.95996e-07,-4.16986e-11,-8.49626e-16,-24522.3,-100.063], Tmin=(923.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclopropane)"""),
)
...
species(
    label = 'C=[C][CH]C1(CC1)OO(29753)',
    structure = SMILES('C=[C][CH]C1(CC1)OO'),
    E0 = (334.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.154337,0.0791666,-5.70484e-05,1.14292e-08,2.63243e-12,40370,27.5934], Tmin=(100,'K'), Tmax=(1033.76,'K')), NASAPolynomial(coeffs=[19.9883,0.0237574,-9.34067e-06,1.74565e-09,-1.24378e-13,35001.6,-76.0747], Tmin=(1033.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CCJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (307.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1685,370,2950,3100,1380,975,1025,1650,1380,1390,370,380,2900,435,3615,1277.5,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C(O)[C]=C(27774)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(103.205,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 100.9 to 103.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C=C=C(O)C1([O])CC1(29744)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', 'C#CC(O)C1([O])CC1(29745)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['OH(D)(132)', 'C=C=CC1([O])CC1(18103)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['C=[C]C(O)C1([O])CC1(15837)'],
    products = ['C=[C]C(O)C1(O)[CH]C1(29746)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]C(O)C1([O])CC1(15837)'],
    products = ['[CH2][C]=C(O)C1(O)CC1(29747)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]C(O)C1(O)CC1(29748)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', 'C=[C][CH]C1([O])CC1(18110)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', 'C=[C]C(O)C1([O])[CH]C1(29749)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(8)', '[CH2][C]=C(O)C1([O])CC1(29750)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(8)', '[CH]=[C]C(O)C1([O])CC1(29751)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=[C]C(O)C1([O])CC1(15837)'],
    products = ['C=C=C(O)C1(O)CC1(29752)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=[C][CH]C1(CC1)OO(29753)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O(T)(63)', 'C=[C]C(O)[C]1CC1(28617)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[C]=C(584)', '[O]C1([CH]O)CC1(11778)'],
    products = ['C=[C]C(O)C1([O])CC1(15837)'],
