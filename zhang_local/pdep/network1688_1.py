...
species(
    ...
    E0 = (-206.633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,3615,1277.5,1000,3025,407.5,1350,352.5,200.479,200.492],'cm^-1')),
        HinderedRotor(inertia=(0.161131,'amu*angstrom^2'), symmetry=1, barrier=(4.59557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161107,'amu*angstrom^2'), symmetry=1, barrier=(4.59542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161144,'amu*angstrom^2'), symmetry=1, barrier=(4.59543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161091,'amu*angstrom^2'), symmetry=1, barrier=(4.59551,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    label = 'O[CH]CC=CO(5809)',
    structure = SMILES('O[CH]CC=CO'),
    E0 = (-204.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,3580,3650,1210,1345,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.728908,'amu*angstrom^2'), symmetry=1, barrier=(16.759,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.728961,'amu*angstrom^2'), symmetry=1, barrier=(16.7602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.728707,'amu*angstrom^2'), symmetry=1, barrier=(16.7544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729043,'amu*angstrom^2'), symmetry=1, barrier=(16.7621,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
...
species(
    label = '[O]CCC[CH]O(5810)',
    structure = SMILES('[O]CCC[CH]O'),
    E0 = (-57.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3615,1277.5,1000,3025,407.5,1350,352.5,291.564,291.576,1773.14,1773.14],'cm^-1')),
        HinderedRotor(inertia=(0.127516,'amu*angstrom^2'), symmetry=1, barrier=(7.69291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127515,'amu*angstrom^2'), symmetry=1, barrier=(7.69262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12753,'amu*angstrom^2'), symmetry=1, barrier=(7.69308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127523,'amu*angstrom^2'), symmetry=1, barrier=(7.6928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02545,0.0685249,-8.27596e-05,5.77917e-08,-1.65589e-11,-9969.59,27.7399], Tmin=(100,'K'), Tmax=(846.402,'K')), NASAPolynomial(coeffs=[9.44389,0.0287391,-1.22486e-05,2.25204e-09,-1.53758e-13,-11394.6,-11.4701], Tmin=(846.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.7591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCsJOH) + radical(CCJCO)"""),
)

species(
    label = 'O[CH][CH]CCO(5812)',
...
species(
    ...
    E0 = (96.5388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3580,3650,1210,1345,900,1100,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O[C]CC[CH]O(5816)',
    structure = SMILES('O[C]CC[CH]O'),
    E0 = (177.327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3580,3650,1210,1345,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.552506,0.0805382,-0.000119907,9.54864e-08,-3.0035e-11,21447.2,25.6675], Tmin=(100,'K'), Tmax=(838.104,'K')), NASAPolynomial(coeffs=[11.3276,0.0243667,-1.08808e-05,2.00672e-09,-1.3558e-13,19807.7,-23.419], Tmin=(838.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CH2_triplet) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(8)', '[O][CH]CC[CH]O(5524)'],
    products = ['O[CH]CC[CH]O(5582)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', 'O[CH][CH]C[CH]O(5781)'],
    products = ['O[CH]CC[CH]O(5582)'],
...
reaction(
    label = 'reaction16',
    reactants = ['OH(D)(132)', '[CH]CC[CH]O(5597)'],
    products = ['O[CH]CC[CH]O(5582)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C[CH]O(426)', '[CH]O(5471)'],
    products = ['O[CH]CC[CH]O(5582)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', 'O[C]CC[CH]O(5816)'],
    products = ['O[CH]CC[CH]O(5582)'],
