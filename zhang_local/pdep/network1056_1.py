...
species(
    label = 'CC=CC([O])=O(3099)',
    structure = SMILES('CC=CC([O])=O'),
    E0 = (-64.1651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180,180,180,2090.7,2091.03,2091.26],'cm^-1')),
        HinderedRotor(inertia=(0.289206,'amu*angstrom^2'), symmetry=1, barrier=(6.64941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289157,'amu*angstrom^2'), symmetry=1, barrier=(6.64828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11668,0.0420035,-2.56983e-05,7.67254e-09,-9.45071e-13,-10474.3,23.9786], Tmin=(100,'K'), Tmax=(1761.03,'K')), NASAPolynomial(coeffs=[9.9507,0.0242095,-1.0542e-05,1.93494e-09,-1.30557e-13,-13233.5,-18.2493], Tmin=(1761.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-87.6414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJCC=O) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C=C([O])[O](3102)',
    structure = SMILES('C[CH]C=C([O])[O]'),
    E0 = (41.5868,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,3025,407.5,1350,352.5,461.648,461.808,462.517],'cm^-1')),
        HinderedRotor(inertia=(0.000791407,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191021,'amu*angstrom^2'), symmetry=1, barrier=(28.9988,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69631,0.0431358,-2.29583e-05,-1.47347e-09,3.59714e-12,5091.14,19.7088], Tmin=(100,'K'), Tmax=(1055.75,'K')), NASAPolynomial(coeffs=[12.1314,0.0178296,-7.22138e-06,1.35624e-09,-9.61659e-14,2094.74,-34.9564], Tmin=(1055.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.5868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + radical(C=COJ) + radical(C=COJ) + radical(Allyl_S)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92611,0.0373482,-1.65394e-06,-2.65148e-08,1.39469e-11,34906,23.8827], Tmin=(100,'K'), Tmax=(927.469,'K')), NASAPolynomial(coeffs=[11.1308,0.0187514,-5.70434e-06,9.27211e-10,-6.23596e-14,32291.1,-24.724], Tmin=(927.469,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(Cs_P) + radical(RCCJC)"""),
)

species(
    label = 'CC1C[C]([O])O1(3104)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34038,0.029211,1.59198e-05,-4.04165e-08,1.83764e-11,11850.6,20.0387], Tmin=(100,'K'), Tmax=(894.708,'K')), NASAPolynomial(coeffs=[8.09926,0.0231107,-6.79042e-06,1.04771e-09,-6.72638e-14,10033.8,-11.4983], Tmin=(894.708,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.9779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_P) + radical(CCOJ)"""),
)

species(
    label = 'CC=CC(=O)O(2975)',
    structure = SMILES('CC=CC(=O)O'),
    E0 = (-289.87,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C[CH][CH]C([O])[O](3105)',
    structure = SMILES('C[CH][CH]C([O])[O]'),
    E0 = (341.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,180,1648.27,1648.32,1649.72],'cm^-1')),
        HinderedRotor(inertia=(0.00264633,'amu*angstrom^2'), symmetry=1, barrier=(5.11088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220948,'amu*angstrom^2'), symmetry=1, barrier=(5.08003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00262223,'amu*angstrom^2'), symmetry=1, barrier=(5.06146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17183,0.0510008,-8.28589e-05,9.178e-08,-3.81316e-11,41115.8,28.2847], Tmin=(100,'K'), Tmax=(835.425,'K')), NASAPolynomial(coeffs=[-2.06759,0.0441611,-2.18521e-05,4.21343e-09,-2.91606e-13,42771.2,53.6431], Tmin=(835.425,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCOJ) + radical(RCCJC) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.35557,0.0342889,-1.62435e-05,2.85262e-09,-1.56005e-13,21787.4,15.2259], Tmin=(100,'K'), Tmax=(2717.7,'K')), NASAPolynomial(coeffs=[31.3942,0.000556547,-1.78468e-06,3.26105e-10,-1.74509e-14,3764.36,-153.197], Tmin=(2717.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)H) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet) + radical(CCOJ)"""),
)
...
reaction(
    ...
    products = ['C[CH]CC([O])=O(1926)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(8.04,'m^3/(mol*s)'), n=1.68, Ea=(56.8582,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cdd_Od;CJ] for rate rule [CO2;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 54.2 to 56.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', 'C[CH]C=C([O])[O](3102)'],
    products = ['C[CH]CC([O])=O(1926)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH]CC([O])=O(1926)'],
    products = ['C[CH]C[C]1OO1(3103)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(2.29014e+11,'s^-1'), n=0.514092, Ea=(356.724,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
...
reaction(
    label = 'reaction21',
    reactants = ['C=C([O])[O](1172)', '[CH]C(32)'],
    products = ['C[CH]CC([O])=O(1926)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](11)', '[CH]CC([O])=O(3065)'],
    products = ['C[CH]CC([O])=O(1926)'],
