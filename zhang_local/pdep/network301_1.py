...
species(
    label = 'CC=CC[CH][O](844)',
    structure = SMILES('CC=CC[CH][O]'),
    E0 = (193.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2750,2800,2850,1350,1500,750,1050,1375,1000,257.508,257.524,1965.87],'cm^-1')),
        HinderedRotor(inertia=(0.166136,'amu*angstrom^2'), symmetry=1, barrier=(7.82133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16602,'amu*angstrom^2'), symmetry=1, barrier=(7.82075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166058,'amu*angstrom^2'), symmetry=1, barrier=(7.82044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53382,0.0596909,-7.22154e-05,6.29198e-08,-2.36223e-11,23371.6,23.8497], Tmin=(100,'K'), Tmax=(781.522,'K')), NASAPolynomial(coeffs=[3.69954,0.0402207,-1.87509e-05,3.58326e-09,-2.49322e-13,23289.2,15.5736], Tmin=(781.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCsJOH) + radical(CCOJ)"""),
)
...
species(
    label = 'C[CH]C[CH]C[O](847)',
    structure = SMILES('C[CH]C[CH]C[O]'),
    E0 = (292.142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,1614.22,1614.5,1614.83],'cm^-1')),
        HinderedRotor(inertia=(0.205428,'amu*angstrom^2'), symmetry=1, barrier=(4.72318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204171,'amu*angstrom^2'), symmetry=1, barrier=(4.69429,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0025607,'amu*angstrom^2'), symmetry=1, barrier=(4.72303,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204877,'amu*angstrom^2'), symmetry=1, barrier=(4.71053,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81496,0.0538452,-5.80732e-05,5.36537e-08,-2.17359e-11,35209.6,28.4866], Tmin=(100,'K'), Tmax=(796.478,'K')), NASAPolynomial(coeffs=[0.995303,0.0460901,-2.11107e-05,4.00169e-09,-2.77136e-13,35716.7,34.6183], Tmin=(796.478,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC) + radical(CCOJ)"""),
)
...
species(
    label = 'CCC[CH][CH][O](849)',
    structure = SMILES('CCC[CH][CH][O]'),
    E0 = (277.993,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,342.889,342.903,1713.17,1713.17],'cm^-1')),
        HinderedRotor(inertia=(0.00143377,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0801158,'amu*angstrom^2'), symmetry=1, barrier=(6.68414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0801093,'amu*angstrom^2'), symmetry=1, barrier=(6.68411,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0801089,'amu*angstrom^2'), symmetry=1, barrier=(6.68418,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25898,0.0474147,1.23442e-05,-1.25632e-07,1.21482e-10,33487.9,23.9271], Tmin=(100,'K'), Tmax=(431.583,'K')), NASAPolynomial(coeffs=[4.53932,0.0413498,-1.89527e-05,3.6173e-09,-2.52571e-13,33150.7,13.216], Tmin=(431.583,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(CCOJ) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07901,0.0470706,-2.35534e-05,5.22033e-09,-4.44166e-13,3139.76,22.7635], Tmin=(100,'K'), Tmax=(2690.68,'K')), NASAPolynomial(coeffs=[21.2434,0.0185803,-7.67055e-06,1.28505e-09,-7.85236e-14,-7173.26,-88.6626], Tmin=(2690.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(25.5756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09044,0.0707385,-9.81381e-05,8.63808e-08,-3.10831e-11,63398.3,25.3104], Tmin=(100,'K'), Tmax=(813.399,'K')), NASAPolynomial(coeffs=[5.20793,0.0389533,-1.82469e-05,3.464e-09,-2.38964e-13,63110.1,8.64234], Tmin=(813.399,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CC=CC[CH][O](844)', 'H(8)'],
    products = ['C[CH]CC[CH][O](636)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', 'C[CH][CH]C[CH][O](854)'],
    products = ['C[CH]CC[CH][O](636)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C[CH]C[CH][CH][O](855)', 'H(8)'],
    products = ['C[CH]CC[CH][O](636)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C[CH][O](430)', '[CH]C(32)'],
    products = ['C[CH]CC[CH][O](636)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C[CH]C(38)', '[CH][O](751)'],
    products = ['C[CH]CC[CH][O](636)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH3](11)', '[CH]CC[CH][O](753)'],
    products = ['C[CH]CC[CH][O](636)'],
