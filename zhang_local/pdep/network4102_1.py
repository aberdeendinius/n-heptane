...
species(
    label = '[CH]C1([CH2])C[CH]COO1(21047)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.402969,0.0630597,-3.76259e-06,-5.61006e-08,3.20918e-11,75669.7,28.739], Tmin=(100,'K'), Tmax=(886.527,'K')), NASAPolynomial(coeffs=[20.8032,0.0163788,-1.53549e-06,-5.43264e-11,9.49426e-15,70269.9,-77.2776], Tmin=(886.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(CCJCOOH) + radical(CCJ2_triplet) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH]C(=C)C=CCO[O](21048)',
    structure = SMILES('[CH]C(=C)C=CCO[O]'),
    E0 = (461.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.338715,0.0753376,-6.3983e-05,2.9037e-08,-5.3832e-12,58839.3,32.4924], Tmin=(100,'K'), Tmax=(1280.91,'K')), NASAPolynomial(coeffs=[14.4261,0.0313456,-1.24662e-05,2.22425e-09,-1.50011e-13,55230.4,-38.9585], Tmin=(1280.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.25401,0.0879665,-0.000100649,7.23914e-08,-2.23837e-11,65508.8,32.0197], Tmin=(100,'K'), Tmax=(773.184,'K')), NASAPolynomial(coeffs=[8.15209,0.0471043,-2.1371e-05,4.03183e-09,-2.79283e-13,64287.5,-4.0519], Tmin=(773.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)C[CH][CH]OO(21051)',
    structure = SMILES('[CH]C(=C)C[CH][CH]OO'),
    E0 = (592.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3615,1310,387.5,850,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0685425,0.0928916,-0.000109119,7.82653e-08,-2.39425e-11,71337.2,34.2357], Tmin=(100,'K'), Tmax=(782.481,'K')), NASAPolynomial(coeffs=[8.93089,0.0475857,-2.22643e-05,4.26291e-09,-2.97929e-13,69950.3,-6.34584], Tmin=(782.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(CCJCOOH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])CCCO[O](21052)',
    structure = SMILES('[CH]C(=[CH])CCCO[O]'),
    E0 = (602.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,492.5,1135,1000,350,440,435,1725,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.229256,0.0880835,-9.79019e-05,6.6025e-08,-1.89532e-11,72547.8,31.6721], Tmin=(100,'K'), Tmax=(832.2,'K')), NASAPolynomial(coeffs=[9.19332,0.0449977,-2.02423e-05,3.81311e-09,-2.64334e-13,71055.8,-9.92784], Tmin=(832.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]C([CH2])=C[CH]COO(21053)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120198,0.0898573,-8.10522e-05,3.86913e-08,-7.60721e-12,55375,29.4856], Tmin=(100,'K'), Tmax=(1200.42,'K')), NASAPolynomial(coeffs=[15.2056,0.038789,-1.72387e-05,3.25149e-09,-2.26454e-13,51695.5,-47.2517], Tmin=(1200.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(AllylJ2_triplet) + radical(Allyl_P)"""),
)

species(
    label = '[CH]C(=[CH])C[CH]COO(21054)',
    structure = SMILES('[CH]C(=[CH])C[CH]COO'),
    E0 = (650.516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3615,1310,387.5,850,1000,350,440,435,1725,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0442276,0.0930129,-0.000106436,7.20587e-08,-2.06178e-11,78376.1,33.886], Tmin=(100,'K'), Tmax=(836.202,'K')), NASAPolynomial(coeffs=[9.98785,0.0454487,-2.11165e-05,4.03939e-09,-2.82563e-13,76713.1,-12.3078], Tmin=(836.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(650.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCOOH) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C([CH2])=C[CH]CO[O](21055)',
    structure = SMILES('[CH]C([CH2])=C[CH]CO[O]'),
    E0 = (611.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.192752,0.0856211,-8.32947e-05,4.46972e-08,-9.97994e-12,73643.6,29.1271], Tmin=(100,'K'), Tmax=(1062.45,'K')), NASAPolynomial(coeffs=[12.6211,0.0388295,-1.72324e-05,3.24413e-09,-2.25735e-13,71002.7,-31.5853], Tmin=(1062.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(611.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(ROOJ) + radical(C=CCJCO) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)C[CH][CH]O[O](21056)',
    structure = SMILES('[CH]C(=C)C[CH][CH]O[O]'),
    E0 = (744.007,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14161,0.0917821,-0.000123654,1.02085e-07,-3.47354e-11,89615.7,34.7173], Tmin=(100,'K'), Tmax=(810.654,'K')), NASAPolynomial(coeffs=[7.7905,0.0451137,-2.07838e-05,3.90277e-09,-2.67656e-13,88668.9,1.23053], Tmin=(810.654,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(744.007,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH]C(=[CH])C[CH]CO[O](21057)',
    structure = SMILES('[CH]C(=[CH])C[CH]CO[O]'),
    E0 = (802.521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,350,440,435,1725,3120,650,792.5,1650,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0854604,0.0922934,-0.000122418,9.79214e-08,-3.2386e-11,96656,34.4809], Tmin=(100,'K'), Tmax=(800.385,'K')), NASAPolynomial(coeffs=[8.84416,0.042988,-1.96452e-05,3.68191e-09,-2.52542e-13,95431.2,-4.71741], Tmin=(800.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(802.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCJCOOH) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]1CC(CO[O])C1(21058)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14974,0.0628971,-4.28279e-05,1.52826e-08,-2.31521e-12,77743.6,29.6876], Tmin=(100,'K'), Tmax=(1462.86,'K')), NASAPolynomial(coeffs=[10.845,0.036387,-1.5645e-05,2.89473e-09,-1.98162e-13,74907,-20.7744], Tmin=(1462.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(645.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(CCJ2_triplet) + radical(ROOJ)"""),
)

species(
    label = '[CH][C]1C[CH]COOC1(21059)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27238,0.00978729,0.000192082,-2.90282e-07,1.22182e-10,77169.2,34.0768], Tmin=(100,'K'), Tmax=(911.434,'K')), NASAPolynomial(coeffs=[36.2432,-0.0129501,1.43376e-05,-2.89005e-09,1.83725e-13,65364.2,-161.184], Tmin=(911.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(640.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(C2CJCOOH) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)CC=COO(21060)',
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0767846,0.0825903,-7.0329e-05,3.17388e-08,-5.87912e-12,37351.5,30.1096], Tmin=(100,'K'), Tmax=(1273.98,'K')), NASAPolynomial(coeffs=[15.0706,0.0355136,-1.49006e-05,2.73354e-09,-1.87301e-13,33531.1,-45.8575], Tmin=(1273.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])[CH][CH]CO[O](21062)',
    structure = SMILES('[CH]C([CH2])[CH][CH]CO[O]'),
    E0 = (914.378,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,492.5,1135,1000,3000,3100,440,815,1455,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,201.391,801.373,1001.72,1200.97,1409.61,1610.99],'cm^-1')),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0899405,0.0939664,-0.000137973,1.17144e-07,-3.95098e-11,110107,39.7191], Tmin=(100,'K'), Tmax=(851.743,'K')), NASAPolynomial(coeffs=[8.37194,0.0405225,-1.82297e-05,3.3646e-09,-2.27172e-13,109224,4.19038], Tmin=(851.743,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(914.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(ROOJ) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(CCJCOOH)"""),
)
...
species(
    label = '[CH]C(=C)CC1CO1(18556)',
    structure = SMILES('[CH]C(=C)CC1CO1'),
    E0 = (308.421,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,180,966.896,966.896,966.896,966.896,966.896,966.896,966.896,966.896,966.896,966.896,966.896,2314.75],'cm^-1')),
        HinderedRotor(inertia=(0.0144582,'amu*angstrom^2'), symmetry=1, barrier=(0.332423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144582,'amu*angstrom^2'), symmetry=1, barrier=(0.332423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144582,'amu*angstrom^2'), symmetry=1, barrier=(0.332423,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.992595,0.0566202,-6.69929e-06,-3.63322e-08,2.10109e-11,37211.8,24.3867], Tmin=(100,'K'), Tmax=(876.397,'K')), NASAPolynomial(coeffs=[13.0559,0.029518,-8.16165e-06,1.17859e-09,-7.22808e-14,34023.7,-38.3455], Tmin=(876.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.557912,0.0634144,-8.40471e-06,-4.02516e-08,2.29946e-11,44116.4,27.8117], Tmin=(100,'K'), Tmax=(899.559,'K')), NASAPolynomial(coeffs=[15.6708,0.0298103,-8.39338e-06,1.25876e-09,-8.03606e-14,40038.1,-51.0553], Tmin=(899.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(12dioxetane) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=C)C[C]CO[O](21064)',
    structure = SMILES('[CH]C(=C)C[C]CO[O]'),
    E0 = (803.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233699,0.087831,-0.000101581,6.94791e-08,-1.99467e-11,96736.8,31.8506], Tmin=(100,'K'), Tmax=(836.633,'K')), NASAPolynomial(coeffs=[9.88505,0.0416864,-1.88472e-05,3.5515e-09,-2.46064e-13,95121.9,-12.9899], Tmin=(836.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(803.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.256974,0.0872311,-8.82154e-05,5.2735e-08,-1.35166e-11,55417.5,28.6256], Tmin=(100,'K'), Tmax=(921.001,'K')), NASAPolynomial(coeffs=[9.78356,0.0458563,-2.08299e-05,3.95811e-09,-2.76476e-13,53662.7,-16.5507], Tmin=(921.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(C)C[CH][CH]O[O](21066)',
    structure = SMILES('[CH]=C(C)C[CH][CH]O[O]'),
    E0 = (620.419,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3120,650,792.5,1650,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,286.781,2319.04],'cm^-1')),
        HinderedRotor(inertia=(0.135299,'amu*angstrom^2'), symmetry=1, barrier=(7.89634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1353,'amu*angstrom^2'), symmetry=1, barrier=(7.89626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135304,'amu*angstrom^2'), symmetry=1, barrier=(7.89625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135308,'amu*angstrom^2'), symmetry=1, barrier=(7.89624,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.880003,'amu*angstrom^2'), symmetry=1, barrier=(51.3569,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0243989,0.0959257,-0.000142768,1.22972e-07,-4.22649e-11,74754.1,34.4304], Tmin=(100,'K'), Tmax=(832.127,'K')), NASAPolynomial(coeffs=[8.33211,0.0417665,-1.9499e-05,3.67146e-09,-2.51152e-13,73864,-1.16363], Tmin=(832.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_P) + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.42434,0.080658,-8.50677e-05,4.98838e-08,-1.20144e-11,40752.1,28.9234], Tmin=(100,'K'), Tmax=(997.355,'K')), NASAPolynomial(coeffs=[12.1274,0.0337218,-1.44771e-05,2.6989e-09,-1.86946e-13,38417.6,-27.5064], Tmin=(997.355,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651723,0.0753903,-7.13752e-05,3.74548e-08,-8.19504e-12,54634.6,31.2218], Tmin=(100,'K'), Tmax=(1080.96,'K')), NASAPolynomial(coeffs=[11.5648,0.0350075,-1.53375e-05,2.89422e-09,-2.0199e-13,52275.3,-22.2768], Tmin=(1080.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = '[C]C(=C)C[CH]CO[O](21070)',
    structure = SMILES('[C]C(=C)C[CH]CO[O]'),
    E0 = (854.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,492.5,1135,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,396.097,396.987,397.001,397.413],'cm^-1')),
        HinderedRotor(inertia=(0.0763094,'amu*angstrom^2'), symmetry=1, barrier=(8.54769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0768421,'amu*angstrom^2'), symmetry=1, barrier=(8.5532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0765666,'amu*angstrom^2'), symmetry=1, barrier=(8.55976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0921375,'amu*angstrom^2'), symmetry=1, barrier=(10.314,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.323692,0.087909,-0.000112743,7.64245e-08,-1.88091e-11,102865,31.2888], Tmin=(100,'K'), Tmax=(659.029,'K')), NASAPolynomial(coeffs=[10.7939,0.0349246,-1.61929e-05,3.08043e-09,-2.13852e-13,101255,-16.5984], Tmin=(659.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(854.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CJ3) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(102.06,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH]C1([CH2])C[CH]COO1(21047)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(8)', '[CH]C(=C)C=CCO[O](21048)'],
...
reaction(
    label = 'reaction5',
    reactants = ['H(8)', '[CH]C(=C)CC=CO[O](21049)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['O2(2)', '[CH]C(=C)CC=C(17957)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH]C(=C)CC[CH]O[O](21050)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=C)C[CH][CH]OO(21051)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(=[CH])CCCO[O](21052)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH]C([CH2])=C[CH]COO(21053)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C(=[CH])C[CH]COO(21054)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O2(2)', '[CH]C(=C)C[CH][CH2](17752)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(8)', '[CH]C([CH2])=C[CH]CO[O](21055)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH]C(=C)C[CH][CH]O[O](21056)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH]C(=[CH])C[CH]CO[O](21057)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH][C]1CC(CO[O])C1(21058)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH][C]1C[CH]COOC1(21059)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C([CH2])[CH][CH]CO[O](21062)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['O2(S)(5486)', '[CH]C(=C)CC=C(17957)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['O(T)(63)', '[CH]C(=C)CC1CO1(18556)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O(T)(63)', '[CH]C(=C)C[CH]C[O](18271)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]CO[O](7037)', '[CH]C([CH2])=C(18776)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]O[O](61)', '[CH]CC([CH])=C(18840)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(8)', '[CH]C(=C)C[C]CO[O](21064)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH2(T)(28)', 'C#CC[CH]CO[O](7755)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH]C(C)=C[CH]CO[O](21065)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH2]C([CH2])=C[CH]CO[O](18711)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=C(C)C[CH][CH]O[O](21066)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH2]C(=C)C[CH][CH]O[O](18712)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH2]C(=C)C=CCO[O](18701)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[CH2]C(=C)CC=CO[O](18702)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]C(=C)C[CH]CO[O](18713)'],
    products = ['[O]OC[CH]CC1=CC1(21069)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(8)', '[C]C(=C)C[CH]CO[O](21070)'],
    products = ['[CH]C(=C)C[CH]CO[O](18713)'],
