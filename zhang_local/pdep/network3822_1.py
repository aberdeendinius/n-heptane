species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.157264,0.108592,-0.00020178,1.92473e-07,-6.8248e-11,77278.5,30.1392], Tmin=(100,'K'), Tmax=(885.15,'K')), NASAPolynomial(coeffs=[5.48955,0.0422968,-2.03313e-05,3.76559e-09,-2.50346e-13,77876.3,12.609], Tmin=(885.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(641.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH2])OC[C]=C(17515)'],
...
reaction(
    ...
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', 'C#CCO[C]([CH2])[CH2](18327)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.63349,'m^3/(mol*s)'), n=2.00263, Ea=(158.082,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    products = ['[CH2][CH][CH]OC([CH2])=C(10843)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=CCO[C]([CH2])[CH2](15914)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    products = ['[CH2][C]=COC([CH2])[CH2](14066)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    products = ['[CH2][C](C)O[CH][C]=C(18221)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2][C]([CH2])O[CH][C]=C(18330)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH]=[C]CO[C]([CH2])[CH2](18331)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([CH2])OC[C]=C(17515)'],
    products = ['[CH2]C([CH2])OC=C=C(14063)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=[C]C[O](4571)', '[CH2][C][CH2](10272)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[C]=C(584)', '[CH2]O[C]([CH2])[CH2](6272)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH][C]([CH2])OC[C]=C(18333)'],
    products = ['[CH2][C]([CH2])OC[C]=C(17515)'],
