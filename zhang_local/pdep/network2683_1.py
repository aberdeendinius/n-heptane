...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.599707,0.0814626,-0.000119052,1.00937e-07,-3.44419e-11,65961.8,32.4634], Tmin=(100,'K'), Tmax=(818.063,'K')), NASAPolynomial(coeffs=[8.17219,0.0349537,-1.6386e-05,3.10167e-09,-2.13234e-13,65040.1,-0.609428], Tmin=(818.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(547.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCsJOH) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])[CH]CC[O](10955)',
    structure = SMILES('[CH2][C]([O])[CH]CC[O]'),
    E0 = (543.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.66268,0.0821009,-0.000127293,1.14207e-07,-4.03881e-11,65516.1,32.1109], Tmin=(100,'K'), Tmax=(838.679,'K')), NASAPolynomial(coeffs=[6.42776,0.0377909,-1.79709e-05,3.4021e-09,-2.32973e-13,65140.5,8.83737], Tmin=(838.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](O)[CH]C[CH][O](10956)',
    structure = SMILES('[CH2][C](O)[CH]C[CH][O]'),
    E0 = (493.74,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.241238,0.0946949,-0.000163811,1.50505e-07,-5.25744e-11,59507,33.365], Tmin=(100,'K'), Tmax=(871.375,'K')), NASAPolynomial(coeffs=[7.12085,0.0363689,-1.73671e-05,3.24053e-09,-2.17841e-13,59323.5,6.94841], Tmin=(871.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH) + radical(CJCO) + radical(C2CsJOH)"""),
)

species(
    label = 'C[C]([O])[CH]C[CH][O](10957)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575046,0.0853009,-0.000137495,1.25646e-07,-4.46566e-11,61754.6,31.3409], Tmin=(100,'K'), Tmax=(849.033,'K')), NASAPolynomial(coeffs=[6.09506,0.0386107,-1.84641e-05,3.48841e-09,-2.37956e-13,61562.8,10.0038], Tmin=(849.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(C2CsJOH) + radical(CCOJ) + radical(CCsJOH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.241238,0.0946949,-0.000163811,1.50505e-07,-5.25744e-11,59507,33.365], Tmin=(100,'K'), Tmax=(871.375,'K')), NASAPolynomial(coeffs=[7.12085,0.0363689,-1.73671e-05,3.24053e-09,-2.17841e-13,59323.5,6.94841], Tmin=(871.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(C2CsJOH) + radical(CCJCO) + radical(CJCO) + radical(CCOJ)"""),
)

species(
    label = 'C[C]([O])C[CH][CH][O](10959)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575074,0.0853006,-0.000137494,1.25644e-07,-4.46556e-11,61754.6,31.3408], Tmin=(100,'K'), Tmax=(849.039,'K')), NASAPolynomial(coeffs=[6.095,0.0386108,-1.84641e-05,3.48843e-09,-2.37958e-13,61562.8,10.0041], Tmin=(849.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCsJOH) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2][C]([O])[CH]C[CH][O](10960)',
    structure = SMILES('[CH2][C]([O])[CH]C[CH][O]'),
    E0 = (724.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401916,0.0907315,-0.000158043,1.45713e-07,-5.11097e-11,87207.7,32.5961], Tmin=(100,'K'), Tmax=(866.94,'K')), NASAPolynomial(coeffs=[7.03687,0.0346085,-1.68002e-05,3.15755e-09,-2.13232e-13,87015.9,7.06256], Tmin=(866.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(724.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CCsJOH) + radical(C2CsJOH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCJCO)"""),
)

species(
    label = '[CH2][C]([O])C[CH][CH][O](10961)',
    structure = SMILES('[CH2][C]([O])C[CH][CH][O]'),
    E0 = (724.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,360,370,350,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.40201,0.0907303,-0.000158039,1.45706e-07,-5.11064e-11,87207.7,32.5958], Tmin=(100,'K'), Tmax=(866.959,'K')), NASAPolynomial(coeffs=[7.03666,0.0346089,-1.68004e-05,3.15761e-09,-2.13237e-13,87016,7.06375], Tmin=(866.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(724.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCOJ) + radical(CCsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])=CCC[O](10962)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14085,0.0659975,-7.2549e-05,4.77961e-08,-1.32353e-11,11585.4,27.9681], Tmin=(100,'K'), Tmax=(866.135,'K')), NASAPolynomial(coeffs=[8.49108,0.0320527,-1.37627e-05,2.54838e-09,-1.75129e-13,10312.1,-6.4362], Tmin=(866.135,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.4932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(C=C(C)OJ) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.259324,0.0932117,-0.000160863,1.46576e-07,-5.12402e-11,96930,29.794], Tmin=(100,'K'), Tmax=(853.668,'K')), NASAPolynomial(coeffs=[8.16835,0.033676,-1.67576e-05,3.19431e-09,-2.17976e-13,96398.6,-2.31428], Tmin=(853.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(804.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(C2CsJOH) + radical(CH2_triplet) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH][C]([O])CC[CH][O](10965)',
    structure = SMILES('[CH][C]([O])CC[CH][O]'),
    E0 = (760.825,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321245,0.0936499,-0.000165896,1.55084e-07,-5.49445e-11,91626.3,30.7594], Tmin=(100,'K'), Tmax=(866.131,'K')), NASAPolynomial(coeffs=[6.49831,0.0367039,-1.80577e-05,3.40889e-09,-2.30665e-13,91622.3,7.99996], Tmin=(866.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(760.825,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(CCOJ) + radical(CCsJOH) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2][C]([O])[CH]CC=O(10748)'],
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])C[CH][CH][O](10954)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]([O])[CH]CC[O](10955)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([O])CC[CH][O](10047)'],
    products = ['[CH2][C](O)[CH]C[CH][O](10956)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([O])CC[CH][O](10047)'],
    products = ['C[C]([O])[CH]C[CH][O](10957)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([O])CC[CH][O](10047)'],
    products = ['[CH2][C]([O])C[CH][CH]O(10696)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]([O])CC[CH][O](10047)'],
    products = ['[CH2][C](O)C[CH][CH][O](10958)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([O])CC[CH][O](10047)'],
    products = ['C[C]([O])C[CH][CH][O](10959)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]([O])CC[CH][O](10047)'],
    products = ['[CH2][C]([O])[CH]C[CH]O(10695)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(8)', '[CH2][C]([O])[CH]C[CH][O](10960)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(8)', '[CH2][C]([O])C[CH][CH][O](10961)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C]([O])CC([CH2])[O](10049)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C[CH][O](430)', '[CH2][C][O](2305)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C[C]([CH2])[O](732)', '[CH][O](751)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH2][C]([O])CC[C][O](10964)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(8)', '[CH][C]([O])CC[CH][O](10965)'],
    products = ['[CH2][C]([O])CC[CH][O](10047)'],
