...
species(
    label = '[CH]=C(C)O[CH]C(17698)',
    structure = SMILES('[CH]=C(C)O[CH]C'),
    E0 = (213.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3025,407.5,1350,352.5,196.269,196.319],'cm^-1')),
        HinderedRotor(inertia=(0.54739,'amu*angstrom^2'), symmetry=1, barrier=(14.9597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.542669,'amu*angstrom^2'), symmetry=1, barrier=(14.9558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552962,'amu*angstrom^2'), symmetry=1, barrier=(14.9593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55539,'amu*angstrom^2'), symmetry=1, barrier=(14.9562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.457258,0.0695832,-6.10348e-05,2.14098e-08,-9.60158e-13,25840.1,23.2802], Tmin=(100,'K'), Tmax=(988.768,'K')), NASAPolynomial(coeffs=[17.6267,0.0166296,-5.7394e-06,1.00856e-09,-7.01396e-14,21638.1,-63.4379], Tmin=(988.768,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cds_P) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]C(=C)OCC(17699)',
...
species(
    label = '[CH2]C(=C)O[C]C(17701)',
    structure = SMILES('[CH2]C(=C)O[C]C'),
    E0 = (392.607,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,350,440,435,1725,3000,3100,440,815,1455,1000,345.484,346.604,347.738,348.792],'cm^-1')),
        HinderedRotor(inertia=(0.200288,'amu*angstrom^2'), symmetry=1, barrier=(16.855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196888,'amu*angstrom^2'), symmetry=1, barrier=(16.8459,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201769,'amu*angstrom^2'), symmetry=1, barrier=(16.8536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195512,'amu*angstrom^2'), symmetry=1, barrier=(16.8579,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.676518,0.0628266,-4.46668e-05,2.18916e-09,6.73543e-12,47348.7,21.3454], Tmin=(100,'K'), Tmax=(949.344,'K')), NASAPolynomial(coeffs=[18.5713,0.0120759,-3.42364e-06,5.75137e-10,-4.15023e-14,42840.3,-69.9063], Tmin=(949.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)O[CH]C(6321)'],
    products = ['[CH2]C1([CH2])OC1C(17697)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(8.15385e+14,'s^-1'), n=-0.537569, Ea=(114.908,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['H(8)', '[CH2]C(=C)OC=C(6492)'],
    products = ['[CH2]C(=C)O[CH]C(6321)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH]C(=C)O[CH]C(17700)'],
    products = ['[CH2]C(=C)O[CH]C(6321)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH3](11)', '[CH]OC([CH2])=C(17678)'],
    products = ['[CH2]C(=C)O[CH]C(6321)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(8)', '[CH2]C(=C)O[C]C(17701)'],
    products = ['[CH2]C(=C)O[CH]C(6321)'],
