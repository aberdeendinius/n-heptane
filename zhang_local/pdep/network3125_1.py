...
species(
    label = '[CH2]CC(=O)C1([CH2])CO1(12265)',
    structure = SMILES('[CH2]CC(=O)C1([CH2])CO1'),
    E0 = (124.263,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2750,2850,1437.5,1250,1305,750,350,2750,3150,900,1100,375,552.5,462.5,1710,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.630149,0.103064,-0.000142292,1.02645e-07,-2.82121e-11,15110.9,28.3962], Tmin=(100,'K'), Tmax=(1027.45,'K')), NASAPolynomial(coeffs=[15.5349,0.0253142,-7.15118e-06,9.2174e-10,-4.55737e-14,12571.3,-46.2226], Tmin=(1027.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CJCC=O)"""),
)

species(
    label = '[CH2]OC(=C)C1([O])CC1(12377)',
    structure = SMILES('[CH2]OC(=C)C1([O])CC1'),
    E0 = (149.684,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,350,440,435,1725,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.665745,0.0545203,1.04891e-05,-6.07819e-08,2.93069e-11,18139.9,30.7855], Tmin=(100,'K'), Tmax=(956.106,'K')), NASAPolynomial(coeffs=[20.3063,0.0185771,-5.64301e-06,1.03438e-09,-7.89542e-14,12271.3,-74.1366], Tmin=(956.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CC(C)2OJ) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]C1(CO1)C1(O)[CH]C1(12379)',
    structure = SMILES('[CH2]C1(CO1)C1(O)[CH]C1'),
    E0 = (189.8,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.43314,0.0910687,-9.37836e-05,4.79199e-08,-8.96745e-12,23047.7,32.6883], Tmin=(100,'K'), Tmax=(1590.7,'K')), NASAPolynomial(coeffs=[20.7423,0.0129195,1.01967e-06,-6.5978e-10,5.79777e-14,18825.1,-75.686], Tmin=(1590.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(CCJCO)"""),
)

species(
    label = 'CC1([CH]O1)C1([O])CC1(12380)',
    structure = SMILES('CC1([CH]O1)C1([O])CC1'),
    E0 = (192.026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205099,0.0657475,-4.53914e-06,-6.22904e-08,3.64109e-11,23248.9,24.8296], Tmin=(100,'K'), Tmax=(878.9,'K')), NASAPolynomial(coeffs=[23.4506,0.0110867,1.48191e-06,-6.63206e-10,5.24843e-14,17187.9,-95.5512], Tmin=(878.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CCsJO) + radical(CC(C)2OJ)"""),
)

species(
    label = 'CC1(CO1)C1([O])[CH]C1(12381)',
    structure = SMILES('CC1(CO1)C1([O])[CH]C1'),
    E0 = (208.205,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58198,0.0571947,1.25206e-05,-7.50547e-08,3.97706e-11,25181.5,25.7703], Tmin=(100,'K'), Tmax=(881.303,'K')), NASAPolynomial(coeffs=[21.4367,0.0134007,4.94448e-07,-4.7511e-10,3.91681e-14,19530.5,-83.4122], Tmin=(881.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CCJCO) + radical(CC(C)2OJ)"""),
)

species(
    label = '[CH2]C1([CH]O1)C1(O)CC1(12382)',
    structure = SMILES('[CH2]C1([CH]O1)C1(O)CC1'),
    E0 = (173.62,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.69884,0.098441,-0.000107287,5.68302e-08,-1.09945e-11,21110,31.3393], Tmin=(100,'K'), Tmax=(1528.55,'K')), NASAPolynomial(coeffs=[23.161,0.0101206,2.21498e-06,-8.8596e-10,7.38269e-14,16228.1,-90.2528], Tmin=(1528.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(CCsJO)"""),
)
...
species(
    label = '[CH2]C1(CO1)C1([O])[CH]C1(12383)',
    structure = SMILES('[CH2]C1(CO1)C1([O])[CH]C1'),
    E0 = (418.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1209,0.0859526,-8.7467e-05,4.42663e-08,-8.23167e-12,50567.2,31.6311], Tmin=(100,'K'), Tmax=(1594.35,'K')), NASAPolynomial(coeffs=[19.9025,0.012841,4.79661e-07,-5.20368e-10,4.74117e-14,46452,-71.4833], Tmin=(1594.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(418.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(CCJCO) + radical(CC(C)2OJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C1([CH]O1)C1([O])CC1(12384)',
    structure = SMILES('[CH2]C1([CH]O1)C1([O])CC1'),
    E0 = (402.536,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.38543,0.0933136,-0.00010094,5.31483e-08,-1.02502e-11,48629.4,30.2777], Tmin=(100,'K'), Tmax=(1526.74,'K')), NASAPolynomial(coeffs=[22.2956,0.0100793,1.65597e-06,-7.42456e-10,6.2945e-14,43868.2,-85.9016], Tmin=(1526.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CCsJO) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[O]C1(CC1)[C]1CCO1(12385)',
    structure = SMILES('[O]C1(CC1)[C]1CCO1'),
    E0 = (201.459,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.970791,0.0551119,-2.46306e-06,-4.32062e-08,2.40397e-11,24349.9,25.1168], Tmin=(100,'K'), Tmax=(886.585,'K')), NASAPolynomial(coeffs=[14.9667,0.0245384,-5.84373e-06,7.73877e-10,-4.65754e-14,20588.1,-47.9398], Tmin=(886.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + ring(Oxetane) + radical(CC(C)2OJ) + radical(C2CsJOCs)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C1([O])CC1(12386)',
    structure = SMILES('[CH2]O[C]([CH2])C1([O])CC1'),
    E0 = (458.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,360,370,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.363016,0.100679,-0.00013709,1.00393e-07,-2.93201e-11,55254.3,30.0687], Tmin=(100,'K'), Tmax=(838.893,'K')), NASAPolynomial(coeffs=[14.0701,0.0318595,-1.40369e-05,2.60408e-09,-1.78041e-13,52832.8,-37.0272], Tmin=(838.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CJC(C)OC) + radical(C2CsJOCs) + radical(CC(C)2OJ) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]C([CH2])([O])C1([O])CC1(11324)',
    structure = SMILES('[CH2]C([CH2])([O])C1([O])CC1'),
    E0 = (471.688,'kJ/mol'),
    modes = [
    ...
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4535.24,'J/mol'), sigma=(7.74315,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=708.39 K, Pc=22.17 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.446995,0.0940013,-0.000102946,5.72548e-08,-1.25147e-11,56894.4,28.9679], Tmin=(100,'K'), Tmax=(1118.83,'K')), NASAPolynomial(coeffs=[18.969,0.0245865,-9.88305e-06,1.80267e-09,-1.24156e-13,52549.7,-66.8832], Tmin=(1118.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(471.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CJC(C)2O) + radical(CC(C)2OJ) + radical(CJC(C)2O) + radical(CC(C)2OJ)"""),
)
...
species(
    label = '[CH]C1(CO1)C1([O])CC1(12390)',
    structure = SMILES('[CH]C1(CO1)C1([O])CC1'),
    E0 = (456.519,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28754,0.084376,-8.11222e-05,3.88903e-08,-6.85276e-12,55124.5,31.0047], Tmin=(100,'K'), Tmax=(1694.61,'K')), NASAPolynomial(coeffs=[19.3383,0.0143408,-2.32232e-07,-3.66617e-10,3.54671e-14,51199.4,-70.3376], Tmin=(1694.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(456.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + ring(Ethylene_oxide) + radical(CCJ2_triplet) + radical(CC(C)2OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CC(=O)C1([CH2])CO1(12265)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(3.93521e+09,'s^-1'), n=0.743095, Ea=(94.5508,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra_Nd;radadd_intra_cs2H]
Euclidian distance = 2.2360679775
family: Intra_R_Add_Exocyclic
Ea raised from 91.5 to 94.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction3',
    reactants = ['[CH2]OC(=C)C1([O])CC1(12377)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.32e+10,'s^-1'), n=0.35, Ea=(72.2831,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_D;doublebond_intra_2H_secNd;radadd_intra_cs2H]
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    products = ['[CH2]C1(CO1)C1(O)[CH]C1(12379)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    products = ['CC1([CH]O1)C1([O])CC1(12380)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    products = ['CC1(CO1)C1([O])[CH]C1(12381)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    products = ['[CH2]C1([CH]O1)C1(O)CC1(12382)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(8)', '[CH2]C1(CO1)C1([O])[CH]C1(12383)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2]C1([CH]O1)C1([O])CC1(12384)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(14)', 'C=C([O])C1([O])CC1(10788)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(S)(1732)', '[CH2]C(=C)C1([O])CC1(11856)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
    products = ['[O]C1(CC1)[C]1CCO1(12385)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]O[C]([CH2])C1([O])CC1(12386)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])([O])C1([O])CC1(11324)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(T)(63)', '[CH2]C1(CO1)[C]1CC1(12389)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(28)', '[O]C1(CC1)[C]1CO1(12002)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(8)', '[CH]C1(CO1)C1([O])CC1(12390)'],
    products = ['[CH2]C1(CO1)C1([O])CC1(11387)'],
