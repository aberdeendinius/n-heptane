...
species(
    label = '[CH2][CH]O[C]1OO1(3193)',
    structure = SMILES('[CH2][CH]O[C]1OO1'),
    E0 = (373.997,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52452,0.0540047,-6.98719e-05,4.58955e-08,-1.17159e-11,45071,22.0629], Tmin=(100,'K'), Tmax=(967.753,'K')), NASAPolynomial(coeffs=[11.7598,0.0116995,-4.29999e-06,7.2454e-10,-4.69467e-14,43089.9,-26.9812], Tmin=(967.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCO) + radical(CCsJOCs) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C1O[C]([O])O1(3194)',
    structure = SMILES('[CH2]C1O[C]([O])O1'),
    E0 = (175.26,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.16048,0.018098,3.59566e-06,-8.07612e-09,1.84077e-12,21053.8,14.7733], Tmin=(100,'K'), Tmax=(1953.54,'K')), NASAPolynomial(coeffs=[14.7993,0.0165346,-1.07299e-05,2.11103e-09,-1.40956e-13,13038.7,-53.5526], Tmin=(1953.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-OsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CJCO) + radical(Cs_P) + radical(OCOJ)"""),
)

species(
    label = '[O][C]1O[CH]CO1(3195)',
    structure = SMILES('[O][C]1O[CH]CO1'),
    E0 = (97.377,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53018,0.0367396,-5.60462e-05,4.82538e-08,-1.5071e-11,11760.8,15.9145], Tmin=(100,'K'), Tmax=(1031.82,'K')), NASAPolynomial(coeffs=[3.80013,0.0165144,-4.39875e-06,5.11119e-10,-2.09861e-14,12313.3,13.6952], Tmin=(1031.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsOsOsH) + ring(1,3-Dioxolane) + radical(CCsJOCs) + radical(Cs_P) + radical(OCOJ)"""),
)

species(
    label = '[CH2]C1OC(=O)O1(3196)',
...
species(
    label = '[CH][CH]OC([O])=O(3198)',
    structure = SMILES('[CH][CH]OC([O])=O'),
    E0 = (240.89,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (86.0462,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68478,0.0490049,-5.71742e-05,3.20387e-08,-6.95645e-12,29057.4,21.7163], Tmin=(100,'K'), Tmax=(1131.44,'K')), NASAPolynomial(coeffs=[12.9879,0.00904477,-4.19716e-06,8.23484e-10,-5.91991e-14,26499.6,-34.2103], Tmin=(1131.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(OC=OOJ) + radical(CCsJOC(O)) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29763,0.0516506,-4.87394e-05,1.82713e-08,-1.6085e-12,3420.7,22.2113], Tmin=(100,'K'), Tmax=(1060.75,'K')), NASAPolynomial(coeffs=[16.3839,0.00712551,-3.26058e-06,6.76849e-10,-5.15681e-14,-475.462,-54.74], Tmin=(1060.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.5763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CH2_triplet) + radical(CJCO)"""),
)

species(
    label = '[CH]=COC([O])[O](3201)',
    structure = SMILES('[CH]=COC([O])[O]'),
    E0 = (172.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3120,650,792.5,1650,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,180,1032.04,1032.05,1032.35],'cm^-1')),
        HinderedRotor(inertia=(0.154328,'amu*angstrom^2'), symmetry=1, barrier=(3.5483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153378,'amu*angstrom^2'), symmetry=1, barrier=(3.52646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24816,0.0531303,-0.000111034,1.30526e-07,-5.52416e-11,20766,19.4981], Tmin=(100,'K'), Tmax=(824.627,'K')), NASAPolynomial(coeffs=[-3.43445,0.0430182,-2.41061e-05,4.84323e-09,-3.41513e-13,22984.2,53.585], Tmin=(824.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(O2s-CsH) + group(Cs-OsOsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(OCOJ) + radical(OCOJ)"""),
)

species(
    label = '[CH][CH]OC(=O)O(3202)',
    structure = SMILES('[CH][CH]OC(=O)O'),
    E0 = (-2.85862,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24136,0.0530112,-5.05226e-05,1.87913e-08,-1.40085e-12,-237.783,22.8307], Tmin=(100,'K'), Tmax=(1029.96,'K')), NASAPolynomial(coeffs=[16.5511,0.00693629,-2.91092e-06,5.89049e-10,-4.48088e-14,-4101.29,-54.9278], Tmin=(1029.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.85862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-O2d)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsOs) + radical(CCJ2_triplet) + radical(CCsJOC(O))"""),
)
...
reaction(
    ...
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(1.63927e+10,'s^-1'), n=0.514573, Ea=(174.696,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][CH]OC([O])=O(2238)'],
    products = ['[O]C1([O])C[CH]O1(3192)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(9.1388e+07,'s^-1'), n=1.18372, Ea=(150.674,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5;carbonylbond_intra;radadd_intra_cs2H]
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]OC([O])=O(2238)'],
    products = ['[CH2][CH]O[C]1OO1(3193)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(2.29014e+11,'s^-1'), n=0.514092, Ea=(369.951,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3_linear;multiplebond_intra;radadd_intra] for rate rule [R3_CO;carbonyl_intra_Nd;radadd_intra_O]
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][CH]OC([O])=O(2238)'],
    products = ['[O][C]1O[CH]CO1(3195)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(2.38312e+09,'s^-1'), n=0.64013, Ea=(93.1134,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_linear;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5_linear;carbonyl_intra;radadd_intra_cs2H]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction11',
    reactants = ['CO3t1(3006)', '[CH][CH2](721)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O(T)(63)', '[CH2][CH]O[C]=O(3054)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(8)', '[CH2][C]OC([O])=O(3197)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(8)', '[CH][CH]OC([O])=O(3198)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CO3t1(3006)', '[CH]=C(64)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(2.66747,'m^3/(mol*s)'), n=1.94798, Ea=(13.5635,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;CdsJ-H] for rate rule [Od_R;CdsJ-H]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C(64)', '[O][C]([O])[O](3203)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.16528e+08,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_pri_rad;Y_rad]
Euclidian distance = 0
Multiplied by reaction path degeneracy 3.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['[O][C][O](2319)', 'C=C[O](594)'],
    products = ['[CH2][CH]OC([O])=O(2238)'],
