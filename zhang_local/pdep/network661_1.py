...
species(
    ...
    E0 = (-69.4654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3010,987.5,1337.5,450,1655,2120,512.5,787.5],'cm^-1')),
        HinderedRotor(inertia=(1.00909,'amu*angstrom^2'), symmetry=1, barrier=(23.2009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00896,'amu*angstrom^2'), symmetry=1, barrier=(23.1979,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'O=[C][CH]OO(2588)',
    structure = SMILES('O=[C][CH]OO'),
    E0 = (41.5008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1855,455,950,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(2.02863,'amu*angstrom^2'), symmetry=1, barrier=(46.6422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154968,'amu*angstrom^2'), symmetry=1, barrier=(38.2462,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0355,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O=C=COO(2587)', 'H(8)'],
    products = ['O=[C]COO(1143)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['OH(D)(132)', '[O]C[C]=O(1736)'],
    products = ['O=[C]COO(1143)'],
    transitionState = 'TS6',
