...
species(
    label = '[CH2]C([O])([O])C=C=O(5113)',
    structure = SMILES('[CH2]C([O])([O])C=C=O'),
    E0 = (196.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2120,512.5,787.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,343.08,343.16,343.221,343.233,343.238,343.258,343.43,3641.02],'cm^-1')),
        HinderedRotor(inertia=(0.149898,'amu*angstrom^2'), symmetry=1, barrier=(12.5114,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15011,'amu*angstrom^2'), symmetry=1, barrier=(12.5106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.944252,0.0702173,-9.8714e-05,6.2532e-08,-1.2464e-11,23733,25.8041], Tmin=(100,'K'), Tmax=(718.576,'K')), NASAPolynomial(coeffs=[14.0097,0.0110558,-3.53974e-06,5.10341e-10,-2.82008e-14,21505,-35.3488], Tmin=(718.576,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ)"""),
)
...
species(
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.800768,0.0747449,-0.0001137,9.03493e-08,-2.83223e-11,23743.9,30.1608], Tmin=(100,'K'), Tmax=(811.164,'K')), NASAPolynomial(coeffs=[11.4387,0.0203505,-9.53255e-06,1.79482e-09,-1.22768e-13,22081.8,-18.5421], Tmin=(811.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(O)2C) + radical(CCCJ=O) + radical(CC(C)(O)OJ) + radical(CCJCO)"""),
)

species(
    label = 'CC([O])([O])[CH][C]=O(5115)',
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54475,0.0632078,-0.000105435,1.02873e-07,-3.87775e-11,25589.5,27.7929], Tmin=(100,'K'), Tmax=(834.242,'K')), NASAPolynomial(coeffs=[3.3206,0.0344418,-1.73005e-05,3.34344e-09,-2.31285e-13,25997.9,23.7709], Tmin=(834.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCCJ=O) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([O])([O])[CH][C]=O(5116)',
    structure = SMILES('[CH2]C([O])([O])[CH][C]=O'),
    E0 = (428.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1855,455,950,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34225,0.073049,-0.000145205,1.48856e-07,-5.61687e-11,51616.5,28.788], Tmin=(100,'K'), Tmax=(860.368,'K')), NASAPolynomial(coeffs=[1.91372,0.0354422,-1.87062e-05,3.62228e-09,-2.4821e-13,52811.7,33.6344], Tmin=(860.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(O)2C) + radical(CC(C)(O)OJ) + radical(CC(C)(O)OJ) + radical(CCJCO) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C([O])(O)C=C=O(5117)',
    structure = SMILES('[CH2]C([O])(O)C=C=O'),
    E0 = (-36.6119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.1713,0.0746393,-9.26234e-05,5.37616e-08,-1.16303e-11,-4257.26,28.3661], Tmin=(100,'K'), Tmax=(1262.86,'K')), NASAPolynomial(coeffs=[20.0823,0.00386754,5.90268e-07,-2.77766e-10,2.40087e-14,-8671.78,-69.9069], Tmin=(1262.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.6119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(C=CC(O)2CJ) + radical(C=CC(C)(O)OJ)"""),
)

species(
    label = 'CC([O])([O])C=C=O(5118)',
    ...
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9264,0.0692322,-9.89121e-05,7.2893e-08,-2.07385e-11,-1947.02,24.9218], Tmin=(100,'K'), Tmax=(945.546,'K')), NASAPolynomial(coeffs=[12.1894,0.0160118,-5.64149e-06,8.97182e-10,-5.45566e-14,-3827.78,-27.4673], Tmin=(945.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.0957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + radical(C=CC(C)(O)OJ) + radical(C=CC(C)(O)OJ)"""),
)
...
species(
    label = '[CH]C([O])([O])C[C]=O(5119)',
    structure = SMILES('[CH]C([O])([O])C[C]=O'),
    E0 = (460.415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1855,455,950,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.0648,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2915,0.0715442,-0.000133754,1.32126e-07,-4.89386e-11,55461.2,27.2097], Tmin=(100,'K'), Tmax=(854.94,'K')), NASAPolynomial(coeffs=[3.74205,0.0325034,-1.68757e-05,3.25952e-09,-2.23626e-13,56049.9,21.6651], Tmin=(854.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CC(C)(O)OJ) + radical(CCJ2_triplet) + radical(CCCJ=O) + radical(CC(C)(O)OJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H(8)', '[CH2]C([O])([O])C=C=O(5113)'],
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(T)(63)', 'C=C([O])C[C]=O(4289)'],
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(28)', '[O]C(=O)C[C]=O(4277)'],
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(53.4257,'m^3/(mol*s)'), n=1.6025, Ea=(0.0220796,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cd_R;Y_1centerbirad] for rate rule [CO_O;CH2_triplet]
Euclidian distance = 1.41421356237
family: R_Addition_MultipleBond
Ea raised from -5.8 to 0.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(108.573,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 106.2 to 108.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C([O])([O])C[C]=O(4260)'],
    products = ['[CH2]C([O])(O)[CH][C]=O(5114)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(8)', '[CH2]C([O])([O])[CH][C]=O(5116)'],
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])([O])C[C]=O(4260)'],
    products = ['[CH2]C1(C[C]=O)OO1(5000)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O(T)(63)', '[CH2][C]([O])C[C]=O(4654)'],
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(8)', '[CH]C([O])([O])C[C]=O(5119)'],
    products = ['[CH2]C([O])([O])C[C]=O(4260)'],
